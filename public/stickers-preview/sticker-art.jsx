// Sticker SVG library — one function per sticker. All are viewBox="0 0 200 200".
// Style: chunky rounded shapes, thick strokes, soft faces. Kid-friendly.

const S = {}; // sticker components keyed by id
...
const face = (cx, cy, s = 1) => (
  <g>
    ...
    {/* smile */}
    <path d={`M ${cx - 6 * s} ${cy + 6 * s} Q ${cx} ${cy + 11 * s} ${cx + 6 * s} ${cy + 6 * s}`}
          stroke={stroke} strokeWidth={2.2 * s} strokeLinecap="round" fill="none" />
    {/* cheeks */}
...
// Base planet body (circle with shading + face)
const planetBody = (color1, color2, shadow, highlight) => (
  <g>
    <circle cx="100" cy="100" r="72" fill={color1} />
    <path d="M 40 120 A 72 72 0 0 0 160 120 Q 160 170 100 172 Q 40 170 40 120 Z"
          fill={color2} opacity="0.85" />
    {shadow}
    {/* highlight */}
...
S.saturn = () => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* back of ring */}
    <ellipse cx="100" cy="105" rx="90" ry="20" fill="none" stroke="#d4a54a" strokeWidth="8" strokeDasharray="none" />
...
S.pluto = () => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* famous heart */}
    <path d="M 100 95 C 92 82 76 82 76 98 C 76 114 100 130 100 130 C 100 130 124 114 124 98 C 124 82 108 82 100 95 Z"
          fill="#f3e4c8" stroke={stroke} strokeWidth="2" opacity="0.95" />
    {sleepyFace(100, 100, 0.9)}
    {/* Charon moon */}
...
S.asteroid = () => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    <path d="M 50 90 Q 42 70 62 55 Q 85 42 115 48 Q 150 48 160 80 Q 170 115 145 140 Q 115 165 80 155 Q 48 140 50 90 Z"
          fill="#8a7a6a" stroke={stroke} strokeWidth="3" />
    <path d="M 52 100 Q 50 130 80 150 Q 115 162 140 150 Q 160 140 160 115"
          fill="#5d4f44" opacity="0.5" />
    {/* craters */}
...
S.rakete = () => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    {/* body */}
    <path d="M 100 20 Q 130 60 130 130 L 130 155 L 70 155 L 70 130 Q 70 60 100 20 Z"
    ...
    {/* flame */}
    <path d="M 80 155 Q 85 180 100 195 Q 115 180 120 155 Q 110 170 100 165 Q 90 170 80 155 Z"
          fill="#ffcc2a" stroke={stroke} strokeWidth="2" />
...
S.satellit = () => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ...
    {[0, 1, 2].map(i => <line key={i} x1={10 + (i + 1) * 13.75} y1="80" x2={10 + (i + 1) * 13.75} y2="120" stroke={stroke} strokeWidth="1.2" />)}
    ...
    {[0, 1, 2].map(i => <line key={i} x1={135 + (i + 1) * 13.75} y1="80" x2={135 + (i + 1) * 13.75} y2="120" stroke={stroke} strokeWidth="1.2" />)}
