...
function mat(color: string, isGhost?: boolean) {
  return { color, transparent: !!isGhost, opacity: isGhost ? 0.55 : 1 } as const;
}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.60, 0]}>
        ...
        <meshLambertMaterial {...mat(WL, isGhost)} />
      </mesh>
      {/* Drawer divider */}
      ...
      <mesh position={[0, 0.38, 0.42]}>
        ...
        <meshLambertMaterial {...mat(AC1, isGhost)} />
      </mesh>
      {/* Legs */}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.03, 0]}>
        ...
        <meshLambertMaterial {...mat(DG, isGhost)} />
      </mesh>
      {/* Pole */}
      ...
      <mesh position={[0, 1.42, 0]}>
        ...
        <meshLambertMaterial {...mat(LY, isGhost)} />
      </mesh>
      {/* Shade inner (light) */}
      <mesh position={[0, 1.38, 0]}>
        <cylinderGeometry args={[0.22, 0.12, 0.26, 12]} />
        <meshLambertMaterial color="#FFFAE0" transparent opacity={isGhost ? 0.4 : 0.9} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[-0.55, 0.84, -0.24]}>
        ...
        <meshLambertMaterial {...mat(BK, isGhost)} />
      </mesh>
      <mesh position={[-0.55, 0.84, -0.22]}>
        <boxGeometry args={[0.44, 0.30, 0.02]} />
        <meshLambertMaterial {...mat(AC3, isGhost)} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.26, 0.10]}>
        ...
        <meshLambertMaterial {...mat(FT, isGhost)} />
      </mesh>
      {/* Back */}
      ...
      <mesh position={[-0.44, 0.38, 0.12]}>
        ...
        <meshLambertMaterial {...mat(FL, isGhost)} />
      </mesh>
      <mesh position={[0.44, 0.38, 0.12]}>
        <boxGeometry args={[0.76, 0.10, 0.58]} />
        <meshLambertMaterial {...mat(FL, isGhost)} />
      ...
      {[0.20, 0.58, 0.96].map((sy, si) =>
        shelfColors.slice(0, si === 1 ? 5 : 4).map((c, bi) => (
          <mesh key={`${si}-${bi}`} position={[0.42, sy + 0.14, -0.78 + bi * 0.30]}>
            ...
            <meshLambertMaterial {...mat(c, isGhost)} />
          </mesh>
        ))
      )}
    </group>
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.14, 0]}>
        ...
        <meshLambertMaterial {...mat(PT, isGhost)} />
      </mesh>
      {/* Pot rim */}
      ...
      <mesh position={[0, 0.30, 0]}>
        ...
        <meshLambertMaterial {...mat("#4A3018", isGhost)} />
      </mesh>
      {/* Stem */}
      <mesh position={[0, 0.52, 0]}>
        <cylinderGeometry args={[0.04, 0.04, 0.44, 8]} />
        <meshLambertMaterial {...mat(PD, isGhost)} />
      </mesh>
      {/* Foliage lower */}
      ...
      <mesh position={[0.05, 0.98, -0.05]}>
        ...
        <meshLambertMaterial {...mat(PL, isGhost)} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.01, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <meshLambertMaterial {...mat("#C4825A", isGhost)} />
      </mesh>
      {/* Inner pattern */}
      <mesh position={[0, 0.025, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <cylinderGeometry args={[0.60, 0.60, 0.01, 24]} />
        <meshLambertMaterial {...mat("#8A4A28", isGhost)} />
      </mesh>
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.55, 0]}>
        ...
        <meshLambertMaterial {...mat(AC2, isGhost)} />
      </mesh>
      {/* Opening recess */}
      ...
      <mesh position={[0.46, 0.30, 0]}>
        ...
        <meshLambertMaterial color={OR} transparent opacity={isGhost ? 0.3 : 0.85} />
      </mesh>
      {/* Fire (red) */}
      <mesh position={[0.46, 0.18, 0]}>
        <boxGeometry args={[0.70, 0.16, 0.04]} />
        <meshLambertMaterial color={RD} transparent opacity={isGhost ? 0.3 : 0.75} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.56, 0]}>
        ...
        <meshLambertMaterial color={AW} transparent opacity={isGhost ? 0.25 : 0.5} />
      </mesh>
      {/* Gravel / bottom */}
      <mesh position={[0, 0.36, 0]}>
        <boxGeometry args={[1.72, 0.04, 0.64]} />
        <meshLambertMaterial {...mat("#6A5A3A", isGhost)} />
      </mesh>
      {/* Top lid */}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.75, 0]}>
        ...
        <meshLambertMaterial {...mat(WH, isGhost)} />
      </mesh>
      {/* Door split */}
      <mesh position={[0.41, 0.90, 0]}>
        <boxGeometry args={[0.02, 1.26, 0.76]} />
        <meshLambertMaterial {...mat(LG, isGhost)} />
      </mesh>
      {/* Freezer door handle */}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.40, 0]}>
        ...
        <meshLambertMaterial color={AW} transparent opacity={isGhost ? 0.2 : 0.4} />
      </mesh>
      {/* Faucet */}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.63, 0]}>
        ...
        <meshLambertMaterial color={AW} transparent opacity={isGhost ? 0.2 : 0.35} />
      </mesh>
      {/* Faucet */}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[0, 0.19, 0]}>
        ...
        <meshLambertMaterial color={AW} transparent opacity={isGhost ? 0.2 : 0.5} />
      </mesh>
      {/* Middle column */}
      <mesh position={[0, 0.42, 0]}>
      ...
      <mesh position={[0, 1.06, 0]}>
        ...
        <meshLambertMaterial color={AW} transparent opacity={isGhost ? 0.2 : 0.6} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position} scale={rotation === 1 ? [-1, 1, 1] : [1, 1, 1]}>
      ...
      <mesh position={[-0.14, 0.88, 0.08]}>
        ...
        <meshLambertMaterial {...mat(FG, isGhost)} />
      </mesh>
    </group>
  );
}
      ...
      {[[-0.65, 0], [-0.22, 0], [0.22, 0], [0.65, 0]].map(([fx, fz], i) => (
        <group key={i} position={[fx as number, 0.26, fz as number]}>
          ...
          <mesh position={[0, 0.22, 0]}>
            ...
            <meshLambertMaterial {...mat(flowerColors[i], isGhost)} />
          </mesh>
        </group>
      ))}
    </group>
