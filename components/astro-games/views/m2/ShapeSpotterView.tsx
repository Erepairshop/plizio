...
export type ShapeSpotterRound = { id: string; target: { label: LocalizedText; img?: string; colorHex?: string }; distractors: { id: string; label?: LocalizedText; img?: string; colorHex?: string; isTarget: boolean }[]; requiredFinds: number; timePerItemMs: number; };

export default function ShapeSpotterView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<ShapeSpotterRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 ShapeSpotterView Task</div>
