...
export type BubbleChoiceRound = { id: string; question: LocalizedText; bubbles: { id: string; label: LocalizedText; isCorrect: boolean; colorHex?: string }[]; lives: number; timeLimitMs: number; };

export default function BubbleChoiceView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<BubbleChoiceRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 BubbleChoiceView Task</div>
