...
export type WordChainRound = { id: string; rule: LocalizedText; start: { label: LocalizedText }; steps: { options: { id: string; label: LocalizedText; isValid: boolean }[]; timeLimitMs: number; }[]; };

export default function WordChainView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<WordChainRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 WordChainView Task</div>
