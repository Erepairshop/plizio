...
export type QuickTapRound = { id: string; criterion: LocalizedText; stream: { id: string; label: LocalizedText; isCorrect: boolean; spawnMs: number }[]; durationMs: number; lives: number; };

export default function QuickTapView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<QuickTapRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 QuickTapView Task</div>
