...
export type MemoryPairsRound = { id: string; gridSize: 3 | 4 | 6; pairs: { id: string; a: { label: LocalizedText; img?: string }; b: { label: LocalizedText; img?: string } }[]; timeLimitMs: number; };

export default function MemoryPairsView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<MemoryPairsRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 MemoryPairsView Task</div>
