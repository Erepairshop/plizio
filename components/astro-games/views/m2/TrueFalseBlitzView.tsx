...
export type TrueFalseBlitzRound = { id: string; statements: { id: string; text: LocalizedText; isTrue: boolean; explanation?: LocalizedText; }[]; perItemMs: number; };

export default function TrueFalseBlitzView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<TrueFalseBlitzRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 TrueFalseBlitzView Task</div>
