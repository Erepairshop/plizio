...
export type MCQ4ExplanationRound = { id: string; questions: { id: string; prompt: LocalizedText; img?: string; answerOptions: { id: string; label: LocalizedText }[]; correctAnswerId: string; explanationOptions: { id: string; label: LocalizedText; isCorrect: boolean }[]; }[]; };

export default function MCQ4ExplanationView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<MCQ4ExplanationRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 MCQ4ExplanationView Task</div>
