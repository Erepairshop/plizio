...
export type PatternFinishRound = { id: string; sequence: ({ label: LocalizedText; img?: string } | null)[]; nextOptions: { id: string; label: LocalizedText; img?: string; isCorrect: boolean }[]; ruleOptions: { id: string; label: LocalizedText; isCorrect: boolean }[]; };

export default function PatternFinishView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<PatternFinishRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 PatternFinishView Task</div>
