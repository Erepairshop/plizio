...
export type SortPuzzleRound = { id: string; dimensions: { x: { label: LocalizedText; values: (string | number)[] }; y: { label: LocalizedText; values: (string | number)[] }; }; items: { id: string; label: LocalizedText; img?: string; correctX: string | number; correctY: string | number; }[]; };

export default function SortPuzzleView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<SortPuzzleRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 SortPuzzleView Task</div>
