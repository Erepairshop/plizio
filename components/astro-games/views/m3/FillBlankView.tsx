...
export type FillBlankRound = { id: string; sentences: { id: string; template: LocalizedText; blanks: { index: number; correct: string; alternatives?: string[] }[]; wordBank: string[]; explanationOptions: { label: LocalizedText; isCorrect: boolean }[]; }[]; };

export default function FillBlankView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<FillBlankRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 FillBlankView Task</div>
