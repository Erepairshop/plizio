...
export type SoundMatchRound = { id: string; audio: { text?: string; ttsLang?: "hu"|"de"|"en"|"ro"; assetUrl?: string }; sourceOptions: { id: string; label: LocalizedText; img?: string; isCorrect: boolean }[]; categoryOptions: { id: string; label: LocalizedText; isCorrect: boolean }[]; };

export default function SoundMatchView({ rounds, color, lang, mode, onDone, onCorrect, onWrong }: AstroGameProps<SoundMatchRound>) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
      <div className="w-full bg-black/40 p-4 rounded-xl mb-4 text-center border-2 border-white/10">
        <div className="text-xl font-black text-white mb-2">🎯 SoundMatchView Task</div>
