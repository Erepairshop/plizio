...
interface SuccessorFinderProps {
  lang?: 'hu' | 'de' | 'en' | 'ro';
  embedded?: boolean;
...
const LABELS = {
  hu: {
    title: 'Mi a következő szám?',
    hint: 'A következő szám 1-gyel nagyobb',
    correct: 'Helyes! ✓',
    incorrect: 'Nem jó. Próbáld újra!',
  },
  de: {
    title: 'Welche Zahl kommt danach?',
    hint: 'Die Nachfolgerzahl ist 1 größer',
    correct: 'Richtig! ✓',
    incorrect: 'Falsch. Versuche nochmal!',
  },
  en: {
    title: 'What number comes after?',
    hint: 'The successor is 1 more',
    correct: 'Correct! ✓',
    incorrect: 'Wrong. Try again!',
  },
  ro: {
    title: 'Ce număr vine după?',
    hint: 'Succesorul este cu 1 mai mare',
    correct: 'Corect! ✓',
    incorrect: 'Greșit. Încearcă din nou!',
  },
};

const SuccessorFinder: React.FC<SuccessorFinderProps> = ({
  lang = 'en',
  embedded = false,
  onValueChange,
  onAnswer,
  ...
  return (
    <motion.div
      className={`w-full flex flex-col items-center gap-6 ${embedded ? 'p-3' : 'p-8 bg-gradient-to-br from-violet-50 to-purple-50 rounded-2xl shadow-lg'}`}
      ...
      <div className="w-full max-w-md px-4">
        <div className="relative h-20 flex items-center">
          ...
          <div className="relative w-full flex justify-between items-center">
            {Array.from({ length: Math.max(givenNumber + 3, 5) }, (_, i) => {
...
export default SuccessorFinder;
