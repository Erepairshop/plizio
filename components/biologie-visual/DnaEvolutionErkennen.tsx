...
export default function DnaEvolutionErkennen({ svgName, options, correctIndex, userAnswer, submitted, onAnswer }: Props) {
  ...
  return (
    <div className="px-1 py-1.5">
      <div className="flex items-center gap-2 mb-1.5">
        ...
        <span className="text-sm font-bold text-slate-800">Was ist hier abgebildet?</span>
      </div>
