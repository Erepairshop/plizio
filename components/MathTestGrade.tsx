...
const GRADE_DATA: Record<number, {
  ...
  4: {
    ...
    topics: [
      ...
      { icon: "🔢", label: "Decimals basics" },
      { icon: "📏", label: "Measurement & conversion" },
    ],
    intro: `The free online math test for 4th grade targets the core US Common Core standards for students ages 9–10. Fourth graders tackle multi-digit multiplication, long division, fraction addition and subtraction with like denominators, an introduction to decimals, angle measurement, and unit conversions. Our randomized test provides unlimited practice for each topic with immediate feedback — no account needed, works on any device.`,
    deepDive: [
