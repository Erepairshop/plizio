...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/airhockey", label: "Air Hockey" },
      { href: "/pingpong", label: "Ping Pong" },
  ...
  },
  {
    title: "Logic & Puzzle",
    links: [
      { href: "/deductiongrid", label: "Deduction Grid" },
      { href: "/deductiongrid2", label: "Deduction Grid 2" },
      { href: "/minisudoku", label: "Mini Sudoku" },
      { href: "/nonogram", label: "Nonogram" },
      { href: "/lightout", label: "Lights Out" },
      { href: "/mazerush", label: "Maze Rush" },
      { href: "/numbermerge", label: "Number Merge" },
      { href: "/numberpath", label: "Number Path" },
      { href: "/pathbuilder", label: "Path Builder" },
      { href: "/pipeflow", label: "Pipe Flow" },
      { href: "/shadowswitch", label: "Shadow Switch" },
      { href: "/signaldecoder", label: "Signal Decoder" },
      { href: "/timeecho", label: "Time Echo" },
      { href: "/topicsort", label: "Topic Sort" },
      { href: "/gravitas", label: "Gravitas" },
      { href: "/starhold", label: "Starhold" },
    ],
  },
  {
    title: "About",
