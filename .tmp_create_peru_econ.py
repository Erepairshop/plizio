...
pois = [
    ...
    },
    {
        ...
        "coords": [-72.10, -16.99],
        "name": {
            "de": "Hafen von Matarani",
            "hu": "Matarani kikötője",
            "ro": "Portul Matarani",
            "en": "Port of Matarani"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-78.98, -8.22],
        "name": {
            "de": "Hafen von Salaverry",
            "hu": "Salaverry kikötője",
            "ro": "Portul Salaverry",
            "en": "Port of Salaverry"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-75.16, -15.35],
        "name": {
            "de": "Hafen von San Juan de Marcona",
            "hu": "San Juan de Marcona kikötője",
            "ro": "Portul San Juan de Marcona",
            "en": "Port of San Juan de Marcona"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-81.03, -5.79],
        "name": {
            "de": "Terminal Portuario de Bayóvar",
            "hu": "Bayóvar kikötői terminál",
            "ro": "Terminalul Portuar Bayóvar",
            "en": "Bayóvar Port Terminal"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-77.27, -11.58],
        "name": {
            "de": "Megapuerto de Chancay",
            "hu": "Chancay megakikötő",
            "ro": "Megaportul Chancay",
            "en": "Chancay Megaport"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-74.53, -8.38],
        "name": {
            "de": "Hafen von Pucallpa",
            "hu": "Pucallpa kikötője",
            "ro": "Portul Pucallpa",
            "en": "Port of Pucallpa"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-76.11, -5.90],
        "name": {
            "de": "Hafen von Yurimaguas",
            "hu": "Yurimaguas kikötője",
            "ro": "Portul Yurimaguas",
            "en": "Port of Yurimaguas"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-78.23, -7.94],
        "name": {
            "de": "Lagunas Norte-Mine",
            "hu": "Lagunas Norte bánya",
            "ro": "Mina Lagunas Norte",
            "en": "Lagunas Norte Mine"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-80.82, -6.08],
        "name": {
            "de": "Phosphatmine von Bayóvar",
            "hu": "Bayóvar foszfátbánya",
            "ro": "Mina de fosfați Bayóvar",
            "en": "Bayóvar Phosphate Mine"
        },
        "description": {
    ...
    },
    {
        ...
        "name": {
            ...
            "hu": "Camisea gázprojekt",
            "ro": "Proiectul de gaze Camisea",
            "en": "Camisea Gas Project"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-77.13, -11.92],
        "name": {
            "de": "Raffinerie La Pampilla",
            "hu": "La Pampilla finomító",
            "ro": "Rafinăria La Pampilla",
            "en": "La Pampilla Refinery"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-78.59, -9.06],
        "name": {
            "de": "Stahlwerk Siderperu",
            "hu": "Siderperu acélmű",
            "ro": "Oțelăria Siderperu",
            "en": "Siderperu Steelworks"
        },
        "description": {
    ...
    },
    {
        ...
        "name": {
            ...
            "hu": "Ilo rézkohó",
            "ro": "Topitoria de cupru Ilo",
            "en": "Ilo Copper Smelter"
        },
        "description": {
    ...
    },
    {
        ...
        "coords": [-76.89, -11.98],
        "name": {
            "de": "Zinkraffinerie Cajamarquilla",
            "hu": "Cajamarquilla cinkfinomító",
            "ro": "Rafinăria de zinc Cajamarquilla",
            "en": "Cajamarquilla Zinc Refinery"
        },
        "description": {
...
for i, p in enumerate(pois):
    ...
    for lang in ['de', 'hu', 'ro', 'en']:
        val = p['name'][lang].replace('"', '\\"')
        langs.append(f'{lang}: "{val}"')
    out += ', '.join(langs) + ' },\n'
    
    # description
    out += '    description: {\n'
    for lang in ['de', 'hu', 'ro', 'en']:
        val = p['description'][lang].replace('"', '\\"')
        out += f'      {lang}: "{val}"' + (',' if lang != 'en' else '') + '\n'
    out += '    },\n'
    
    # facts
    out += '    facts: {\n'
    for lang in ['de', 'hu', 'ro', 'en']:
        f_vals = [f'"{f.replace("`", "")}"' for f in p['facts'][lang]]
        f_str = ', '.join(f_vals)
        out += f'      {lang}: [{f_str}]' + (',' if lang != 'en' else '') + '\n'
    out += '    }\n'
    
    out += '  }' + (',' if i < len(pois)-1 else '') + '\n'

out += '];\n'

with open('lib/visualLab/data/poiExtraPeruEconomicV2.ts', 'w', encoding='utf-8') as f:
    f.write(out)
