...
export const metadata: Metadata = {
  ...
  keywords: [
    `Mathe Test Klasse 1`, `Mathe 1. Klasse`, `Mathe Klasse 1 kostenlos`,
    `Mathematik Klasse 1`, `Mathe Test 1 online`, `Mathe Übungen Klasse 1`,
    `Rechentest Klasse 1`, `Mathe Klassenarbeit 1. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/mathe-test/klasse-1/`,
    languages: {
      "de": `https://plizio.com/mathe-test/klasse-1/`,
      "de-AT": `https://plizio.com/mathe-test/klasse-1/`,
      "de-CH": `https://plizio.com/mathe-test/klasse-1/`,
      "x-default": `https://plizio.com/mathe-test/klasse-1/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/mathe-test/klasse-1/`,
    images: [{ url: "/og/mathe-klasse-1.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <MatheTestKlasse grade={1} />;
}
