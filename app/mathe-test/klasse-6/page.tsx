...
export const metadata: Metadata = {
  ...
  keywords: [
    `Mathe Test Klasse 6`, `Mathe 6. Klasse`, `Mathe Klasse 6 kostenlos`,
    `Mathematik Klasse 6`, `Mathe Test 6 online`, `Mathe Übungen Klasse 6`,
    `Rechentest Klasse 6`, `Mathe Klassenarbeit 6. Klasse`,
  ],
  alternates: {
...
export default function KlassePage() {
  return <MatheTestKlasse grade={6} />;
}
