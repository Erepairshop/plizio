...
export const metadata: Metadata = {
  ...
  keywords: [
    `Mathe Test Klasse 5`, `Mathe 5. Klasse`, `Mathe Klasse 5 kostenlos`,
    `Mathematik Klasse 5`, `Mathe Test 5 online`, `Mathe Übungen Klasse 5`,
    `Rechentest Klasse 5`, `Mathe Klassenarbeit 5. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/mathe-test/klasse-5/`,
    languages: {
      "de": `https://plizio.com/mathe-test/klasse-5/`,
      "de-AT": `https://plizio.com/mathe-test/klasse-5/`,
      "de-CH": `https://plizio.com/mathe-test/klasse-5/`,
      "x-default": `https://plizio.com/mathe-test/klasse-5/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/mathe-test/klasse-5/`,
    images: [{ url: "/og/mathe-klasse-5.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <MatheTestKlasse grade={5} />;
}
