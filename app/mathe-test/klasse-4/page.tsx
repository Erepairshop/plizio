...
export const metadata: Metadata = {
  ...
  keywords: [
    `Mathe Test Klasse 4`, `Mathe 4. Klasse`, `Mathe Klasse 4 kostenlos`,
    `Mathematik Klasse 4`, `Mathe Test 4 online`, `Mathe Übungen Klasse 4`,
    `Rechentest Klasse 4`, `Mathe Klassenarbeit 4. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/mathe-test/klasse-4/`,
    languages: {
      "de": `https://plizio.com/mathe-test/klasse-4/`,
      "de-AT": `https://plizio.com/mathe-test/klasse-4/`,
      "de-CH": `https://plizio.com/mathe-test/klasse-4/`,
      "x-default": `https://plizio.com/mathe-test/klasse-4/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/mathe-test/klasse-4/`,
    images: [{ url: "/og/mathe-klasse-4.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <MatheTestKlasse grade={4} />;
}
