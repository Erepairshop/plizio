...
export const metadata: Metadata = {
  ...
  keywords: [
    `Mathe Test Klasse 8`, `Mathe 8. Klasse`, `Mathe Klasse 8 kostenlos`,
    `Mathematik Klasse 8`, `Mathe Test 8 online`, `Mathe Übungen Klasse 8`,
    `Rechentest Klasse 8`, `Mathe Klassenarbeit 8. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/mathe-test/klasse-8/`,
    languages: {
      "de": `https://plizio.com/mathe-test/klasse-8/`,
      "de-AT": `https://plizio.com/mathe-test/klasse-8/`,
      "de-CH": `https://plizio.com/mathe-test/klasse-8/`,
      "x-default": `https://plizio.com/mathe-test/klasse-8/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/mathe-test/klasse-8/`,
    images: [{ url: "/og/mathe-klasse-8.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <MatheTestKlasse grade={8} />;
}
