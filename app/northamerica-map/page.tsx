...
const TITLE: Record<Lang, string> = {
  de: "Nordamerika Karte",
  hu: "Észak-Amerika térkép",
  ro: "Harta Americii de Nord",
  en: "North America Map",
};

export default function NorthAmericaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      <header className="flex items-center gap-3 px-4 pt-4 pb-2 shrink-0">
        <button onClick={() => router.push("/")} className="w-9 h-9 rounded-full bg-white/10 text-white/70 flex items-center justify-center hover:bg-white/20 transition">
          <ChevronLeft size={18} />
        </button>
