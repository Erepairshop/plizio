...
import { Trophy, Layers, ArrowLeft, Crosshair, Zap, Brain, Calendar, Mountain, Star, Info, ChevronDown, ChevronUp, GitBranch, Grid3x3, Navigation, Shuffle, Rocket, Timer, type LucideIcon } from "lucide-react";
...
const GAME_NAMES: Record<Language, Record<string, string>> = {
  hu: {
    ...
    milliomos: "Milliomos", racetrack: "Versenyút", citydrive: "Városvezetés", numberpath: "Számút", pathbuilder: "Útvonalépítő", topicsort: "Témarendező", pipeflow: "Csőáramlás", deductiongrid: "Dedukciós rács", deductiongrid2: "Galaktikus Dedukció", timeecho: "Idővisszhang",
  },
  de: {
    quickpick: "Quick Pick", reflexgrid: "Reflex Grid", memoryflash: "Memory Flash",
    ...
    milliomos: "Milliomos", racetrack: "Rennstrecke", citydrive: "Stadtfahrt", numberpath: "Zahlenpfad", pathbuilder: "Pfadbauer", topicsort: "Themen-Sortierung", pipeflow: "Rohrfluss", deductiongrid: "Deduktionsraster", deductiongrid2: "Galaktische Deduktion", timeecho: "Zeitecho",
  },
  en: {
    quickpick: "Quick Pick", reflexgrid: "Reflex Grid", memoryflash: "Memory Flash",
    ...
    milliomos: "Milliomos", racetrack: "Racetrack", citydrive: "City Drive", numberpath: "Number Path", pathbuilder: "Path Builder", topicsort: "Topic Sort", pipeflow: "Pipe Flow", deductiongrid: "Deduction Grid", deductiongrid2: "Galactic Deduction", timeecho: "Time Echo",
  },
  ro: {
    quickpick: "Quick Pick", reflexgrid: "Reflex Grid", memoryflash: "Memory Flash",
    ...
    milliomos: "Milliomos", racetrack: "Circuit", citydrive: "Condus prin oraș", numberpath: "Calea Numerelor", pathbuilder: "Constructor de Trasee", topicsort: "Sortare teme", pipeflow: "Fluxul Conductelor", deductiongrid: "Grilă de deducție", deductiongrid2: "Deducție Galactică", timeecho: "Ecou Temporal",
  },
};
...
const GAME_ICONS: Record<string, LucideIcon> = {
  ...
  daily: Calendar, skyclimb: Mountain, numberpath: Grid3x3, pathbuilder: Navigation, topicsort: Shuffle, pipeflow: GitBranch, deductiongrid: Grid3x3, deductiongrid2: Rocket, timeecho: Timer,
};

const GAME_COLORS: Record<string, string> = {
  quickpick: "#FF2D78", reflexgrid: "#00D4FF", memoryflash: "#B44DFF",
  daily: "#FFD700", skyclimb: "#00FF88", mathtest: "#FF8C00", numberpath: "#00FF88", pathbuilder: "#2DD4BF", topicsort: "#14B8A6", pipeflow: "#22C55E", deductiongrid: "#8B5CF6", deductiongrid2: "#6366F1", timeecho: "#00FFFF",
