// AUTO-GENERATED — capeverde-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Kap Verde – Karte",
  hu: "Zöld-foki Köztársaság – térkép",
  ro: "Harta Capul Verde",
  en: "Cape Verde Map",
};

export default function CapeverdeMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="capeverde" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
