...
const TITLE: Record<Lang, string> = {
  de: "Kosovo Karte — Plizio",
  hu: "Koszovó térkép — Plizio",
  ro: "Harta Kosovo — Plizio",
  en: "Kosovo Map — Plizio",
};
...
export default function KosovoMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      <header className="flex items-center gap-3 px-4 pt-4 pb-2 shrink-0 z-10 relative">
        <button
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"xk" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
