...
export const metadata: Metadata = {
  ...
  keywords: [
    `Sachkunde Test Klasse 4`, `Sachkunde 4. Klasse`, `Sachkunde Klasse 4 kostenlos`,
    `Sachkundetest Klasse 4`, `Sachkunde Test 4 online`, `Sachkunde Übungen Klasse 4`,
    `Organe Klasse 4`, `Ökosysteme Klasse 4`, `Sachkunde Klassenarbeit 4. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/sachkunde-test/klasse-4/`,
    languages: {
      "de": `https://plizio.com/sachkunde-test/klasse-4/`,
      "de-AT": `https://plizio.com/sachkunde-test/klasse-4/`,
      "de-CH": `https://plizio.com/sachkunde-test/klasse-4/`,
      "x-default": `https://plizio.com/sachkunde-test/klasse-4/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/sachkunde-test/klasse-4/`,
    images: [{ url: "/og/sachkunde-klasse-4.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <SachkundeTestKlasse grade={4} />;
}
