...
export const metadata: Metadata = {
  ...
  keywords: [
    `Sachkunde Test Klasse 1`, `Sachkunde 1. Klasse`, `Sachkunde Klasse 1 kostenlos`,
    `Sachkundetest Klasse 1`, `Sachkunde Test 1 online`, `Sachkunde Übungen Klasse 1`,
    `Körper Klasse 1`, `Tiere Klasse 1`, `Sachkunde Klassenarbeit 1. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/sachkunde-test/klasse-1/`,
    languages: {
      "de": `https://plizio.com/sachkunde-test/klasse-1/`,
      "de-AT": `https://plizio.com/sachkunde-test/klasse-1/`,
      "de-CH": `https://plizio.com/sachkunde-test/klasse-1/`,
      "x-default": `https://plizio.com/sachkunde-test/klasse-1/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/sachkunde-test/klasse-1/`,
    images: [{ url: "/og/sachkunde-klasse-1.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <SachkundeTestKlasse grade={1} />;
}
