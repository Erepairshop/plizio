...
export default function VerbenVortexGame({ grade, lang, round, onDone }: VerbenVortexGameProps) {
  ...
  return (
    <div className="relative w-full h-[500px] bg-slate-950 overflow-hidden flex items-center justify-center rounded-xl border border-cyan-900 shadow-[0_0_30px_rgba(0,255,255,0.15)]">
      ...
      {/* Timer Bar */}
      <div className="absolute top-6 left-1/2 -translate-x-1/2 w-64 h-2 bg-slate-800 rounded-full overflow-hidden shadow-[0_0_10px_rgba(0,0,0,0.5)]">
        <motion.div
      ...
      <motion.div 
        className="absolute z-10 flex items-center justify-center w-32 h-32 rounded-full bg-slate-900/80 backdrop-blur-md border border-fuchsia-500 shadow-[0_0_40px_rgba(217,70,239,0.5)]"
        animate={{
      ...
      >
        ...
        <span className="text-4xl font-black text-white z-20 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
          {pronoun}
        </span>
      </motion.div>
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-30">
        <circle cx="50%" cy="50%" r="200" fill="none" stroke="currentColor" strokeWidth="1" className="text-cyan-500" strokeDasharray="4 8" />
        <circle cx="50%" cy="50%" r="250" fill="none" stroke="currentColor" strokeWidth="1" className="text-fuchsia-500" strokeDasharray="2 12" />
      </svg>
    </div>
  );
}
