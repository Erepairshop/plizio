// AUTO-GENERATED — azerbaijan-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Aserbaidschan – Karte",
  hu: "Azerbajdzsán – térkép",
  ro: "Harta Azerbaidjan",
  en: "Azerbaijan Map",
};

export default function AzerbaijanMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="azerbaijan" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
