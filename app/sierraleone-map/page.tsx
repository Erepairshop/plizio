// AUTO-GENERATED — sierraleone-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Sierra Leone – Karte",
  hu: "Sierra Leone – térkép",
  ro: "Harta Sierra Leone",
  en: "Sierra Leone Map",
};

export default function SierraleoneMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="sierraleone" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
