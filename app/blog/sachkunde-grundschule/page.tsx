  ...
  return (
    <main style={{ background: "#0A0A1A", color: "white", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 16px 64px" }}>
        ...
        <p style={styles.p}>Im Sachunterricht geht es darum, die Welt um uns herum systematisch zu begreifen. Kinder sind von Natur aus neugierig – der Sachunterricht kanalisiert diese Neugier in strukturiertes Wissen. Dabei lernen sie nicht nur nackte Fakten, sondern auch, wie sie die Welt beobachten, hinterfragen und neue Zusammenhänge entdecken können. Es geht um die Entwicklung einer forschenden Grundhaltung, die für den weiteren Bildungsweg entscheidend ist. Anstatt Antworten nur vorgekaut zu bekommen, lernen die Kinder, eigene Fragen zu formulieren und selbstständig nach Erklärungen zu suchen – eine Fähigkeit, die in der weiterführenden Schule Gold wert ist.</p>
        
        <h2 style={styles.h2}>Die großen Themenbereiche im Überblick</h2>
        <ul style={styles.ul}>
          <li style={styles.li}><strong>Natur & Umwelt:</strong> Tiere im Wald, Pflanzen auf der Wiese, Wetterphänomene – die Natur ist ein riesiges Labor. Schüler lernen hier auch den respektvollen Umgang mit Ressourcen, die Bedeutung von Umweltschutz, Mülltrennung und den Wasserkreislauf der Erde.</li>
          <li style={styles.li}><strong>Verkehrserziehung:</strong> Ein lebenswichtiger Teil, in dem Kinder lernen, wie sie sich sicher im Straßenverkehr bewegen, Verkehrsschilder lesen und Gefahrensituationen richtig einschätzen. Die Krönung ist meist die offizielle Fahrradprüfung in der 4. Klasse.</li>
          <li style={styles.li}><strong>Technik & Geschichte:</strong> Von der Erfindung des Rades bis hin zum modernen Internet – Kinder erfahren, wie Technik unseren Alltag erleichtert und verändert. Auch lokale Geschichte (Wie lebten die Menschen früher in unserem Ort? Welche Berufe gab es?) ist oft ein sehr greifbares und beliebtes Thema.</li>
          <li style={styles.li}><strong>Raum & Orientierung:</strong> Erste Kartenarbeit, der sichere Umgang mit dem Kompass, das Lesen von Stadtplänen und das Kennenlernen der eigenen Heimatregion sowie der Bundesländer Deutschlands sind zentrale Bestandteile, die die Basis für das spätere Fach Geographie legen.</li>
        </ul>
        
        <h2 style={styles.h2}>Praktische Methoden für Eltern und Lehrkräfte</h2>
        <p style={styles.p}>Erfolgreicher Sachunterricht lebt vom Mitmachen, Anfassen und Selbermachen. Ausflüge ins Museum, in den Zoo oder auf den Bauernhof, kleine physikalische Experimente (z.B. eine Bohne keimen lassen oder den Wasserkreislauf in einem Einmachglas nachbauen) oder gezielte Beobachtungsspaziergänge machen das Wissen greifbar. Die Theorie im Schulheft ist wichtig, aber ohne den direkten Bezug zur Realität bleibt sie oft abstrakt und wird nach dem Test schnell wieder vergessen.</p>
        <p style={styles.p}>Ergänzen Sie dieses praktische Lernen zu Hause mit unserer interaktiven Plattform <Link href="/astro-sachkunde" style={{color: "#00D4FF"}}>AstroSachkunde</Link>. Hier können Kinder ihre Neugier in einem geschützten, digitalen Raum weiter erforschen und das in der Schule Gehörte in motivierenden, spielerischen Formaten festigen. Für die gezielte Vorbereitung auf Tests bieten wir den <Link href="/sachkundetest" style={{color: "#00D4FF"}}>Sachkundetest</Link> an, der den Lernstoff spielerisch und komplett ohne Leistungsdruck abfragt. Auch unser <Link href="/sachkunde-test" style={{color: "#00D4FF"}}>allgemeiner Sachkunde-Test</Link> ist ein hervorragendes Tool zur Selbstkontrolle, bei dem falsche Antworten direkt, verständlich und kindgerecht erklärt werden.</p>
