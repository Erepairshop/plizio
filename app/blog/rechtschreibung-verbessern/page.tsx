  ...
  return (
    <main style={{ background: "#0A0A1A", color: "white", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 16px 64px" }}>
        ...
        <p style={styles.p}>Rechtschreibung ist kein angeborenes Talent, sondern ein handwerkliches Können, das mit Zeit, Geduld und den richtigen Strategien erworben wird. Während manche Kinder intuitive Schreiber sind und sich Wörter wie Fotografien im Gehirn abspeichern, brauchen andere klare Strukturen, Erklärungen und visuelle Anker. Entscheidend ist, dass die Angst vor Fehlern abgebaut wird. Fehler sind keine Misserfolge, sondern notwendige Zwischenschritte auf dem Weg zur Meisterschaft. Wenn ein Kind "Fater" statt "Vater" schreibt, hat es die phonetische Regel (wie es klingt) perfekt angewandt – es fehlt lediglich das Wissen über die orthografische Ausnahme (V statt F). Diesen Perspektivwechsel sollten Eltern aktiv begleiten.</p>
        
        <h2 style={styles.h2}>Die 7 goldenen Tipps für mehr Sicherheit</h2>
        <ol style={styles.ol}>
          <li style={styles.li}><strong>Viel Lesen:</strong> Visuelles Lernen ist der wichtigste Baustein. Lesen speichert Wortbilder direkt im Langzeitgedächtnis. Regelmäßiges Lesen, egal ob spannende Abenteuergeschichten, Sachbücher oder sogar hochwertige Comics, schult das Auge für die korrekte Schreibweise und den intuitiven Satzbau.</li>
          <li style={styles.li}><strong>Regelmäßiges Training:</strong> Kurze Übungen mit <Link href="/astrodeutsch" style={{color: "#00D4FF"}}>AstroDeutsch</Link> festigen die Struktur. Konsistenz ist hier deutlich wichtiger als Quantität. Zehn Minuten tägliches Training sind effektiver als zwei Stunden einmal pro Woche, da das Gehirn in den Pausen das Gelernte verknüpft.</li>
          <li style={styles.li}><strong>Wortbausteine lernen:</strong> Die deutsche Sprache ist modular aufgebaut. Wer Wortstämme, Vorsilben (Präfixe) und Endungen (Suffixe) erkennt, versteht die Logik hinter der Schreibweise. Das Ableiten von Wörtern (z.B. „Häuser“ kommt von „Haus“, deshalb mit ä und nicht mit e) hilft enorm.</li>
          ...
          <li style={styles.li}><strong>Spielerisches Üben:</strong> Unsere <Link href="/deutschtest" style={{color: "#00D4FF"}}>Deutsch-Tests</Link> machen das Üben zum interaktiven Erlebnis. Wenn Lernen Spaß macht, schüttet das Gehirn Botenstoffe aus, die das Behalten von Informationen fördern. Druck und Stress blockieren hingegen die Lernzentren.</li>
          <li style={styles.li}><strong>Laut Lesen:</strong> Geschriebenes laut vorzulesen deckt oft Fehler auf, die das Auge im stillen Lesen übergeht. Besonders bei der Wortendung oder bei fehlenden Buchstaben (wie dem Dehnungs-h) hilft das Gehör als Korrekturinstanz.</li>
          <li style={styles.li}><strong>Detektivarbeit statt Strafe:</strong> Machen Sie die Rechtschreibung zu einem Spiel. „Warum schreiben wir das wohl mit 'ie'?“ Wenn Kinder anfangen, die Logik hinter dem Wort zu suchen (z.B. langes 'i'), entwickeln sie ein tieferes Verständnis für die Sprachstruktur.</li>
        </ol>
