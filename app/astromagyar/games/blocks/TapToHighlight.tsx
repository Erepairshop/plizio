...
//        checkLabel (button label, e.g. "Ellenőrzés"), onDone (correct: boolean) => void
...
interface TapToHighlightProps {
  ...
  color: string;
  label: string;              // parent provides localized instruction
  checkLabel: string;         // parent provides localized button label
