// AUTO-GENERATED — afghanistan-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Afghanistan – Karte",
  hu: "Afganisztán – térkép",
  ro: "Harta Afganistan",
  en: "Afghanistan Map",
};

export default function AfghanistanMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="afghanistan" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
