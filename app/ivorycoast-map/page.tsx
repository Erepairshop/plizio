// AUTO-GENERATED — ivorycoast-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Elfenbeinküste – Karte",
  hu: "Elefántcsontpart – térkép",
  ro: "Harta Coasta de Fildeș",
  en: "Ivory Coast Map",
};
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="ivorycoast" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
