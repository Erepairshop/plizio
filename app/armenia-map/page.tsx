// AUTO-GENERATED — armenia-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Armenien – Karte",
  hu: "Örményország – térkép",
  ro: "Harta Armenia",
  en: "Armenia Map",
};

export default function ArmeniaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="armenia" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
