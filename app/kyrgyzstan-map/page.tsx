// AUTO-GENERATED — kyrgyzstan-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Kirgisistan – Karte",
  hu: "Kirgizisztán – térkép",
  ro: "Harta Kîrgîzstan",
  en: "Kyrgyzstan Map",
};

export default function KyrgyzstanMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="kyrgyzstan" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
