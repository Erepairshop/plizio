...
const TITLE: Record<Lang, string> = {
  de: "Nordmazedonien Karte",
  hu: "Észak-Macedónia térkép",
  ro: "Harta Macedoniei de Nord",
  en: "North Macedonia Map",
};

export default function NorthMacedoniaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        {/* Pass custom center coordinates: [41.6086, 21.7453] via defaultCoord, but wait InteractiveMap might not accept it directly.
            The map resolver handles the map loading. */}
        <InteractiveMap lang={"mk" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
