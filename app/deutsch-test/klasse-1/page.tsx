...
export const metadata: Metadata = {
  ...
  keywords: [
    `Deutsch Test Klasse 1`, `Deutsch 1. Klasse`, `Deutsch Klasse 1 kostenlos`,
    `Deutschtest Klasse 1`, `Deutsch Test 1 online`, `Deutsch Übungen Klasse 1`,
    `Grammatik Klasse 1`, `Deutsch Klassenarbeit 1. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/deutsch-test/klasse-1/`,
    languages: {
      "de": `https://plizio.com/deutsch-test/klasse-1/`,
      "de-AT": `https://plizio.com/deutsch-test/klasse-1/`,
      "de-CH": `https://plizio.com/deutsch-test/klasse-1/`,
      "x-default": `https://plizio.com/deutsch-test/klasse-1/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/deutsch-test/klasse-1/`,
    images: [{ url: "/og/deutsch-klasse-1.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <DeutschTestKlasse grade={1} />;
}
