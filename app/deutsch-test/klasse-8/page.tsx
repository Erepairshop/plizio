...
export const metadata: Metadata = {
  ...
  keywords: [
    `Deutsch Test Klasse 8`, `Deutsch 8. Klasse`, `Deutsch Klasse 8 kostenlos`,
    `Deutschtest Klasse 8`, `Deutsch Test 8 online`, `Deutsch Übungen Klasse 8`,
    `Grammatik Klasse 8`, `Deutsch Klassenarbeit 8. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/deutsch-test/klasse-8/`,
    languages: {
      "de": `https://plizio.com/deutsch-test/klasse-8/`,
      "de-AT": `https://plizio.com/deutsch-test/klasse-8/`,
      "de-CH": `https://plizio.com/deutsch-test/klasse-8/`,
      "x-default": `https://plizio.com/deutsch-test/klasse-8/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/deutsch-test/klasse-8/`,
    images: [{ url: "/og/deutsch-klasse-8.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <DeutschTestKlasse grade={8} />;
}
