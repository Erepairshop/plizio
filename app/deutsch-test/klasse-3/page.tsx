...
export const metadata: Metadata = {
  ...
  keywords: [
    `Deutsch Test Klasse 3`, `Deutsch 3. Klasse`, `Deutsch Klasse 3 kostenlos`,
    `Deutschtest Klasse 3`, `Deutsch Test 3 online`, `Deutsch Übungen Klasse 3`,
    `Grammatik Klasse 3`, `Deutsch Klassenarbeit 3. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/deutsch-test/klasse-3/`,
    languages: {
      "de": `https://plizio.com/deutsch-test/klasse-3/`,
      "de-AT": `https://plizio.com/deutsch-test/klasse-3/`,
      "de-CH": `https://plizio.com/deutsch-test/klasse-3/`,
      "x-default": `https://plizio.com/deutsch-test/klasse-3/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/deutsch-test/klasse-3/`,
    images: [{ url: "/og/deutsch-klasse-3.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <DeutschTestKlasse grade={3} />;
}
