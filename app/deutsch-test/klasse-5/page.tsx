...
export const metadata: Metadata = {
  ...
  keywords: [
    `Deutsch Test Klasse 5`, `Deutsch 5. Klasse`, `Deutsch Klasse 5 kostenlos`,
    `Deutschtest Klasse 5`, `Deutsch Test 5 online`, `Deutsch Übungen Klasse 5`,
    `Grammatik Klasse 5`, `Deutsch Klassenarbeit 5. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/deutsch-test/klasse-5/`,
    languages: {
      "de": `https://plizio.com/deutsch-test/klasse-5/`,
      "de-AT": `https://plizio.com/deutsch-test/klasse-5/`,
      "de-CH": `https://plizio.com/deutsch-test/klasse-5/`,
      "x-default": `https://plizio.com/deutsch-test/klasse-5/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/deutsch-test/klasse-5/`,
    images: [{ url: "/og/deutsch-klasse-5.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <DeutschTestKlasse grade={5} />;
}
