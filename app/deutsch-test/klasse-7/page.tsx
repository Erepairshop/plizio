...
export const metadata: Metadata = {
  ...
  keywords: [
    `Deutsch Test Klasse 7`, `Deutsch 7. Klasse`, `Deutsch Klasse 7 kostenlos`,
    `Deutschtest Klasse 7`, `Deutsch Test 7 online`, `Deutsch Übungen Klasse 7`,
    `Grammatik Klasse 7`, `Deutsch Klassenarbeit 7. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/deutsch-test/klasse-7/`,
    languages: {
      "de": `https://plizio.com/deutsch-test/klasse-7/`,
      "de-AT": `https://plizio.com/deutsch-test/klasse-7/`,
      "de-CH": `https://plizio.com/deutsch-test/klasse-7/`,
      "x-default": `https://plizio.com/deutsch-test/klasse-7/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/deutsch-test/klasse-7/`,
    images: [{ url: "/og/deutsch-klasse-7.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <DeutschTestKlasse grade={7} />;
}
