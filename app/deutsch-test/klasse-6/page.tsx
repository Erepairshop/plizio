...
export const metadata: Metadata = {
  ...
  keywords: [
    `Deutsch Test Klasse 6`, `Deutsch 6. Klasse`, `Deutsch Klasse 6 kostenlos`,
    `Deutschtest Klasse 6`, `Deutsch Test 6 online`, `Deutsch Übungen Klasse 6`,
    `Grammatik Klasse 6`, `Deutsch Klassenarbeit 6. Klasse`,
  ],
  alternates: {
    canonical: `https://plizio.com/deutsch-test/klasse-6/`,
    languages: {
      "de": `https://plizio.com/deutsch-test/klasse-6/`,
      "de-AT": `https://plizio.com/deutsch-test/klasse-6/`,
      "de-CH": `https://plizio.com/deutsch-test/klasse-6/`,
      "x-default": `https://plizio.com/deutsch-test/klasse-6/`,
    },
  },
  openGraph: {
    title: meta.title,
    description: meta.desc,
    url: `https://plizio.com/deutsch-test/klasse-6/`,
    images: [{ url: "/og/deutsch-klasse-6.png", width: 1200, height: 630 }],
  },
};

export default function KlassePage() {
  return <DeutschTestKlasse grade={6} />;
}
