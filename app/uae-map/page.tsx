...
const TITLE: Record<Lang, string> = {
  de: "VAE – Karte",
  hu: "Egyesült Arab Emírségek – térkép",
  ro: "Harta Emiratele Arabe Unite",
  en: "United Arab Emirates Map",
};
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="uae" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
