// AUTO-GENERATED — uzbekistan-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Usbekistan – Karte",
  hu: "Üzbegisztán – térkép",
  ro: "Harta Uzbekistan",
  en: "Uzbekistan Map",
};

export default function UzbekistanMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="uzbekistan" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
