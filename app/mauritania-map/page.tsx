// AUTO-GENERATED — mauritania-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Mauretanien – Karte",
  hu: "Mauritánia – térkép",
  ro: "Harta Mauritania",
  en: "Mauritania Map",
};

export default function MauritaniaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="mauritania" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
