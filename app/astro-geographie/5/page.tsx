...
} from "@/lib/astroGeographie5";

import VisualLab, { VisualLabFab } from "@/components/VisualLab";
const AvatarCompanion = dynamic(() => import("@/components/AvatarCompanion"), { ssr: false });
const GeographieK5Explorer = dynamic(() => import("@/app/astro-geographie/games/k5/GeographieK5Explorer"), { ssr: false });
...
export default function AstroGeographieK5Page() {
  ...
  useEffect(() => {
    const p = loadK5Progress(variant.id);
    setProgress(p);
  ...
  const handleMissionDone = useCallback((score: number, total: number) => {
    ...
    saveK5Progress(newProgress, variant.id);
    ...
    return (
      <div className="min-h-screen flex flex-col relative overflow-hidden bg-[#060614]">
        ...
        <div className="relative z-10 flex-1">
          ...
          {screen === "geographie-explore" && activeIsland && <GeographieK5Explorer island={activeIsland} grade={5} color={bgColor} lang={lang} variantId={variant.id} onDone={handleMissionDone} />}
        </div>
