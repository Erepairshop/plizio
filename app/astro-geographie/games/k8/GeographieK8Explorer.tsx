...
export default function GeographieK8Explorer({ island, color = "#06B6D4", lang: langProp, variantId, onDone, onClose }: Props) {
  ...
  return (
    <DynamicExplorer
      ...
      icon="🗺️"
      count={5}
      explorerId={buildGeographieExplorerId(`geographie_k8_${islandId}`, variantId ?? variant.id)}
      subject="geographie"
      color={color}
      lang={lang}
      grade={8}
