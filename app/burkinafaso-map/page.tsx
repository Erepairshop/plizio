// AUTO-GENERATED — burkinafaso-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Burkina Faso – Karte",
  hu: "Burkina Faso – térkép",
  ro: "Harta Burkina Faso",
  en: "Burkina Faso Map",
};
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="burkinafaso" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
