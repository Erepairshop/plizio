// AUTO-GENERATED — saotome-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "São Tomé und Príncipe – Karte",
  hu: "São Tomé és Príncipe – térkép",
  ro: "Harta São Tomé și Príncipe",
  en: "São Tomé and Príncipe Map",
};

export default function SaotomeMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="saotome" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
