...
const TITLE: Record<Lang, string> = {
  de: "Großbritannien Karte",
  hu: "Egyesült Királyság térkép",
  ro: "Harta Regatului Unit",
  en: "United Kingdom Map",
};

export default function UnitedKingdomMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"gb" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
