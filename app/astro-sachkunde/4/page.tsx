...
const LABELS: Record<string, Record<string, string>> = {
  en: {
    ...
    subtitle: "Grade 4 – Explore Science in Space!",
    grade: "Grade",
    comingSoon: "Coming soon",
    back: "Back",
    description: "Organe, Ökosysteme, Energie, Stromkreis, Geographie und Klima",
  },
  hu: {
    title: "AstroSachkunde",
    subtitle: "4. osztály – Fedezd fel a természetet az űrben!",
    grade: "Osztály",
    comingSoon: "Hamarosan",
    back: "Vissza",
    description: "Szervek, ökoszisztémák, energia, áramkör, földrajz és éghajlat",
  },
  de: {
    title: "AstroSachkunde",
    subtitle: "Klasse 4 – Entdecke Sachkunde im Weltraum!",
    grade: "Klasse",
  ...
  ro: {
    title: "AstroSachkunde",
    subtitle: "Clasa 4 – Explorează Științele în Spațiu!",
    grade: "Clasa",
    comingSoon: "În curând",
    back: "Înapoi",
    description: "Organe, ecosisteme, energie, circuit electric, geografie și climă",
  },
};
    ...
    <div className="min-h-screen bg-[#060614] flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 pb-6">
        ...
        >
          ...
          <h2 className="text-xl font-bold text-white mb-2">Grade 4 Coming Soon</h2>
          <p className="text-white/60 mb-4">Progress: {g4Done}/9 islands</p>
          <button
            onClick={() => router.push("/astro-sachkunde")}
            className="px-6 py-2 rounded-lg bg-[#F7DC6F] text-white font-bold hover:opacity-90 transition-opacity"
          >
            Back to Hub
          </button>
        </motion.div>
