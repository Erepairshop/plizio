...
const SK_G2_LABEL: Record<string, Record<string, string | Record<string, string>>> = {
  en: { title: "AstroPhysik", grade: "Grade 6", back: "Back", start: "Start", next: "Next Island",
        ...
        testTopics: { test1: "Density & Pressure", test2: "Machines & Electricity", test3: "Waves & Sound" },
  ...
  hu: { title: "AstroPhysik", grade: "6. osztály", back: "Vissza", start: "Indítás", next: "Következő sziget",
        ...
        testTopics: { test1: "Sűrűség és nyomás", test2: "Gépek és elektromosság", test3: "Hullámok és hang" },
  ...
  de: { title: "AstroPhysik", grade: "Klasse 6", back: "Zurück", start: "Start", next: "Nächste Insel",
        ...
        testTopics: { test1: "Dichte & Druck", test2: "Maschinen & Elektrizität", test3: "Wellen & Schall" },
  ...
  ro: { title: "AstroPhysik", grade: "Clasa 6", back: "Înapoi", start: "Start", next: "Insula următoare",
        ...
        testTopics: { test1: "Densitate și presiune", test2: "Mașini și electricitate", test3: "Unde și sunet" },
  ...
  if (screen === "island-map") {
    ...
    return (
      <div className="min-h-screen bg-[#060614] flex flex-col relative overflow-hidden">
        ...
        <VisualLab subject="physik" grade={6} lang={lang} open={visualLabOpen} onClose={() => setVisualLabOpen(false)} />
      </div>
    );
  }
