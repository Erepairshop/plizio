...
import {
  ...
  loadPhysikK5Progress as loadProgress, savePhysikK5Progress as saveProgress,
  isMissionDonePhysikK5 as isMissionDone, isIslandDonePhysikK5 as isIslandDone,
  isIslandUnlockedPhysikK5 as isIslandUnlocked, isCheckpointUnlockedPhysikK5 as isCheckpointUnlocked,
  isCheckpointDonePhysikK5 as isCheckpointDone,
  completeMissionPhysikK5 as completeMission, completeTestPhysikK5 as completeTest,
  islandTotalStarsPhysikK5 as islandTotalStars,
  generateIslandQuestionsPhysikK5 as generateIslandQuestions, generateCheckpointQuestionsPhysikK5 as generateCheckpointQuestions,
} from "@/lib/astroPhysik5";
...
const SK_G2_LABEL: Record<string, Record<string, string | Record<string, string>>> = {
  en: { title: "AstroPhysik", grade: "Grade 5", back: "Back", start: "Start", next: "Next Island",
        ...
        testTopics: { test1: "Forces & Energy", test2: "Light & Heat", test3: "Sound & Magnetism" },
  ...
  hu: { title: "AstroPhysik", grade: "5. osztály", back: "Vissza", start: "Indítás", next: "Következő sziget",
        ...
        testTopics: { test1: "Erők és energia", test2: "Fény és hő", test3: "Hang és mágnesesség" },
  ...
  de: { title: "AstroPhysik", grade: "Klasse 5", back: "Zurück", start: "Start", next: "Nächste Insel",
        ...
        testTopics: { test1: "Kräfte & Energie", test2: "Licht & Wärme", test3: "Schall & Magnetismus" },
  ...
  ro: { title: "AstroPhysik", grade: "Clasa 5", back: "Înapoi", start: "Start", next: "Insula următoare",
        ...
        testTopics: { test1: "Forțe și energie", test2: "Lumină și căldură", test3: "Sunet și magnetism" },
...
// ─── Main Page ─────────────────────────────────────────────────────────────────
export default function AstroPhysikK5Page() {
  const { lang } = useLang();
      ...
      <div className="min-h-screen bg-[#060614] flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 mb-2 flex-shrink-0">
          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
            <motion.div className="h-full rounded-full" style={{ background: "linear-gradient(90deg, #6B4CE6, #81C784)" }}
        ...
        <VisualLab subject="physik" grade={5} lang={lang} open={visualLabOpen} onClose={() => setVisualLabOpen(false)} />
      </div>
    );
  }
