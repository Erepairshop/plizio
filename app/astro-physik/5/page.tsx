...
const SK_G2_LABEL: Record<string, Record<string, string | Record<string, string>>> = {
  en: { title: "AstroSachkunde", grade: "Grade 5", back: "Back", start: "Start", next: "Next Island",
  ...
  hu: { title: "AstroSachkunde", grade: "5. osztály", back: "Vissza", start: "Indítás", next: "Következő sziget",
  ...
  de: { title: "AstroSachkunde", grade: "Klasse 5", back: "Zurück", start: "Start", next: "Nächste Insel",
  ...
  ro: { title: "AstroSachkunde", grade: "Clasa 5", back: "Înapoi", start: "Start", next: "Insula următoare",
