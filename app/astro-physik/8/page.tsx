...
const SK_G2_LABEL: Record<string, Record<string, string | Record<string, string>>> = {
  en: { title: "AstroPhysik", grade: "Grade 8", back: "Back", start: "Start", next: "Next Island",
        ...
        testTopics: { test1: "Electricity & Electromagnetism", test2: "Nuclear & Modern Physics", test3: "Energy & Environment" },
  ...
  hu: { title: "AstroPhysik", grade: "8. osztály", back: "Vissza", start: "Indítás", next: "Következő sziget",
        ...
        testTopics: { test1: "Elektromosság és elektromágnesség", test2: "Atommag és modern fizika", test3: "Energia és környezet" },
  ...
  de: { title: "AstroPhysik", grade: "Klasse 8", back: "Zurück", start: "Start", next: "Nächste Insel",
        ...
        testTopics: { test1: "Elektrizität & Elektromagnetismus", test2: "Kern- & moderne Physik", test3: "Energie & Umwelt" },
  ...
  ro: { title: "AstroPhysik", grade: "Clasa 8", back: "Înapoi", start: "Start", next: "Insula următoare",
        ...
        testTopics: { test1: "Electricitate și electromagnetism", test2: "Fizică nucleară și modernă", test3: "Energie și mediu" },
