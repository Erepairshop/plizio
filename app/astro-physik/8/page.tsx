...
import {
  ...
  isIslandUnlockedPhysikK8 as isIslandUnlocked, isCheckpointUnlockedPhysikK8 as isCheckpointUnlocked,
  isCheckpointDonePhysikK8 as isCheckpointDone,
  completeMissionPhysikK8 as completeMission, completeTestPhysikK8 as completeTest,
  islandTotalStarsPhysikK8 as islandTotalStars,
  generateIslandQuestionsPhysikK8 as generateIslandQuestions, generateCheckpointQuestionsPhysikK8 as generateCheckpointQuestions,
} from "@/lib/astroPhysik8";
...
const SK_G2_LABEL: Record<string, Record<string, string | Record<string, string>>> = {
  en: { title: "AstroSachkunde", grade: "Grade 8", back: "Back", start: "Start", next: "Next Island",
  ...
  hu: { title: "AstroSachkunde", grade: "8. osztály", back: "Vissza", start: "Indítás", next: "Következő sziget",
  ...
  de: { title: "AstroSachkunde", grade: "Klasse 8", back: "Zurück", start: "Start", next: "Nächste Insel",
  ...
  ro: { title: "AstroSachkunde", grade: "Clasa 8", back: "Înapoi", start: "Start", next: "Insula următoare",
...
// ─── Main Page ─────────────────────────────────────────────────────────────────
export default function AstroPhysikK8Page() {
  const { lang } = useLang();
      ...
      <div className="min-h-screen bg-[#060614] flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 mb-2 flex-shrink-0">
          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
            <motion.div className="h-full rounded-full" style={{ background: "linear-gradient(90deg, #EF4444, #81C784)" }}
