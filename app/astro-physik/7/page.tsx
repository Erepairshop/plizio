...
import {
  ...
  loadPhysikK7Progress as loadProgress, savePhysikK7Progress as saveProgress,
  isMissionDonePhysikK7 as isMissionDone, isIslandDonePhysikK7 as isIslandDone,
  isIslandUnlockedPhysikK7 as isIslandUnlocked, isCheckpointUnlockedPhysikK7 as isCheckpointUnlocked,
  isCheckpointDonePhysikK7 as isCheckpointDone,
  completeMissionPhysikK7 as completeMission, completeTestPhysikK7 as completeTest,
  islandTotalStarsPhysikK7 as islandTotalStars,
  generateIslandQuestionsPhysikK7 as generateIslandQuestions, generateCheckpointQuestionsPhysikK7 as generateCheckpointQuestions,
} from "@/lib/astroPhysik7";
...
const SK_G2_LABEL: Record<string, Record<string, string | Record<string, string>>> = {
  en: { title: "AstroPhysik", grade: "Grade 7", back: "Back", start: "Start", next: "Next Island",
        ...
        testTopics: { test1: "Forces & Work", test2: "Waves & Thermodynamics", test3: "Optics & Space" },
  ...
  hu: { title: "AstroPhysik", grade: "7. osztály", back: "Vissza", start: "Indítás", next: "Következő sziget",
        ...
        testTopics: { test1: "Erők és munka", test2: "Hullámok és termodinamika", test3: "Optika és űr" },
  ...
  de: { title: "AstroPhysik", grade: "Klasse 7", back: "Zurück", start: "Start", next: "Nächste Insel",
        ...
        testTopics: { test1: "Kräfte & Arbeit", test2: "Wellen & Thermodynamik", test3: "Optik & Weltall" },
  ...
  ro: { title: "AstroPhysik", grade: "Clasa 7", back: "Înapoi", start: "Start", next: "Insula următoare",
        ...
        testTopics: { test1: "Forțe și lucru", test2: "Unde și termodinamică", test3: "Optică și spațiu" },
...
// ─── Main Page ─────────────────────────────────────────────────────────────────
export default function AstroPhysikK7Page() {
  const { lang } = useLang();
      ...
      <div className="min-h-screen bg-[#060614] flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 mb-2 flex-shrink-0">
          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
            <motion.div className="h-full rounded-full" style={{ background: "linear-gradient(90deg, #10B981, #81C784)" }}
        ...
        <VisualLab subject="physik" grade={7} lang={lang} open={visualLabOpen} onClose={() => setVisualLabOpen(false)} />
      </div>
    );
  }
