// AUTO-GENERATED — madagascar-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Madagaskar – Karte",
  hu: "Madagaszkár – térkép",
  ro: "Harta Madagascar",
  en: "Madagascar Map",
};

export default function MadagascarMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="madagascar" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
