...
const TITLE: Record<Lang, string> = {
  de: "Andorra Karte — Plizio",
  hu: "Andorra térkép — Plizio",
  ro: "Harta Andorrei — Plizio",
  en: "Andorra Map — Plizio",
};

export default function AndorraMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"ad" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
