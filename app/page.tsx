...
import { Crosshair, Zap, Brain, Trophy, Layers, BookOpen, Search, Hash, Shuffle, Crown, Calculator, Swords, PenLine, Puzzle, Rocket, Languages, Microscope, Leaf, GitBranch, Cpu, Sparkles, GraduationCap, Gamepad2, ChevronDown, Map as MapIcon, Radio, Grid3x3, History as HistoryIcon, Ghost, Lightbulb, Merge, Navigation, type LucideIcon } from "lucide-react";
...
const HOME_T = {
  de: { karte: "Karte", karteSub: "6 Kontinente spielerisch erkunden", lernen: "Lernen", lernenSub: "Fächer, Astro-Spiele und Tests", spiele: "Spiele", spieleSub: "Quiz, Logik und Lernspiele", allSubjects: "Alle Fächer öffnen", visualLab: "Visual Lab", visualLabSub: "Interaktive Lernspiele starten" },
  en: { karte: "Maps", karteSub: "Explore 6 continents through play", lernen: "Learn", lernenSub: "Subjects, astro games and tests", spiele: "Games", spieleSub: "Quiz, logic and learning games", allSubjects: "Open all subjects", visualLab: "Visual Lab", visualLabSub: "Start interactive learning games" },
  hu: { karte: "Térkép", karteSub: "6 kontinens játékos felfedezése", lernen: "Tanulás", lernenSub: "Tantárgyak, astro játékok és tesztek", spiele: "Játékok", spieleSub: "Kvíz, logika és tanulós játékok", allSubjects: "Összes tantárgy", visualLab: "Visual Lab", visualLabSub: "Interaktív tanulós játékok indítása" },
  ro: { karte: "Hartă", karteSub: "Explorează 6 continente prin joc", lernen: "Învățare", lernenSub: "Materii, jocuri astro și teste", spiele: "Jocuri", spieleSub: "Quiz, logică și jocuri educative", allSubjects: "Toate materiile", visualLab: "Visual Lab", visualLabSub: "Pornește jocurile educative interactive" },
} as const;
