// AUTO-GENERATED — saudiarabia-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Saudi-Arabien – Karte",
  hu: "Szaúd-Arábia – térkép",
  ro: "Harta Arabia Saudită",
  en: "Saudi Arabia Map",
};
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="saudiarabia" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
