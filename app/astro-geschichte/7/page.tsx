...
export default function AstroGeschichteK7Page() {
  ...
  const startCheckpoint = useCallback((testId: string) => {
    ...
    setAvatarMood("focused");
    const qs = generateCheckpointQuestionsK7(testId, lang as Lang, 10);
    setQuestions(qs);
    ...
    return (
      <div className="min-h-screen flex flex-col relative overflow-hidden bg-[#060614]">
        ...
        <div className="relative z-10 flex-1">
          ...
          {screen === "geschichte-explore" && activeIsland && <K7Explorer island={activeIsland} grade={7} color={bgColor} lang={lang} onDone={handleMissionDone} />}
        </div>
