...
export default function K7Explorer({ island, onDone, color = "#3B82F6", lang: langProp, variantId }: Props) {
  ...
  if (cfg) {
    return (
      <DynamicExplorer
        ...
        count={5}
        explorerId={buildGeschichteExplorerId(`geschichte_k7_${island.id}`, variantId ?? variant.id)}
        subject="geschichte"
