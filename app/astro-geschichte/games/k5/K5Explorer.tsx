...
const ISLAND_CONFIG: Record<string, IslandConfig> = {
  ...
  i2: { pool: GESCHICHTE_K5_I2_POOL, labels: GESCHICHTE_K5_I2_LABELS, title: "explorer_title", icon: "☥" },
  ...
  i6: { pool: GESCHICHTE_K5_I6_POOL, labels: GESCHICHTE_K5_I6_LABELS, title: "explorer_title", icon: "🛡️" },
  i7: { pool: GESCHICHTE_K5_I7_POOL, labels: GESCHICHTE_K5_I7_LABELS, title: "explorer_title", icon: "🐎" },
  i8: { pool: GESCHICHTE_K5_I8_POOL, labels: GESCHICHTE_K5_I8_LABELS, title: "explorer_title", icon: "🏰" },
  i9: { pool: GESCHICHTE_K5_I9_POOL, labels: GESCHICHTE_K5_I9_LABELS, title: "explorer_title", icon: "🌟" },
};
