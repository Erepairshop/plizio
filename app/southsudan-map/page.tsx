// AUTO-GENERATED — southsudan-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Südsudan – Karte",
  hu: "Dél-Szudán – térkép",
  ro: "Harta Sudanul de Sud",
  en: "South Sudan Map",
};

export default function SouthsudanMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="southsudan" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
