// AUTO-GENERATED — turkmenistan-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Turkmenistan – Karte",
  hu: "Türkmenisztán – térkép",
  ro: "Harta Turkmenistan",
  en: "Turkmenistan Map",
};

export default function TurkmenistanMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="turkmenistan" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
