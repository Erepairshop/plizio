// AUTO-GENERATED — philippines-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Philippinen – Karte",
  hu: "Fülöp-szigetek – térkép",
  ro: "Harta Filipine",
  en: "Philippines Map",
};

export default function PhilippinesMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="philippines" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
