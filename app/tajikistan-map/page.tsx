// AUTO-GENERATED — tajikistan-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Tadschikistan – Karte",
  hu: "Tádzsikisztán – térkép",
  ro: "Harta Tadjikistan",
  en: "Tajikistan Map",
};

export default function TajikistanMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="tajikistan" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
