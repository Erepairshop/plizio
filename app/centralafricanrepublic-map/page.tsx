// AUTO-GENERATED — centralafricanrepublic-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Zentralafr. Rep. – Karte",
  hu: "Közép-afrikai Közt. – térkép",
  ro: "Harta Rep. Centrafricană",
  en: "Central African Rep. Map",
};

export default function CentralafricanrepublicMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="centralafricanrepublic" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
