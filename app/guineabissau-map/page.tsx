// AUTO-GENERATED — guineabissau-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Guinea-Bissau – Karte",
  hu: "Bissau-Guinea – térkép",
  ro: "Harta Guineea-Bissau",
  en: "Guinea-Bissau Map",
};

export default function GuineabissauMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="guineabissau" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
