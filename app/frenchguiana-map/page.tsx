// AUTO-GENERATED — frenchguiana-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Französisch-Guayana – Karte",
  hu: "Francia Guyana – térkép",
  ro: "Harta Guyana Franceză",
  en: "French Guiana Map",
};

export default function FrenchguianaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="frenchguiana" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
