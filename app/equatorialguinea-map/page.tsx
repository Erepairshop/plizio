// AUTO-GENERATED — equatorialguinea-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Äquatorialguinea – Karte",
  hu: "Egyenlítői-Guinea – térkép",
  ro: "Harta Guineea Ecuatorială",
  en: "Equatorial Guinea Map",
};

export default function EquatorialguineaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="equatorialguinea" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
