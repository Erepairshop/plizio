// SVG Island illustrations for AstroDeutsch K1 map
// Each island is a unique floating fantasy landmass matching its theme
// viewBox: "0 0 80 80", renders at 48-60px on mobile

type IP = { size?: number };

// i1 — Buchstabeninsel: Pink floating island with A B C letters
export function IslandBuchstaben({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      ...
      <text x="18" y="28" fontSize="7" fill="rgba(255,45,120,0.7)">✦</text>
...
// i2 — Silbeninsel: Cyan crystal island with split word fragments
export function IslandSilben({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
      ...
      {/* Crystal formations */}
      <polygon points="34,48 36,36 38,48" fill="#00B8D9" opacity="0.9" />
      <polygon points="42,48 44,33 46,48" fill="#00D4FF" opacity="0.85" />
      <polygon points="28,48 30,40 32,48" fill="#0091B5" opacity="0.8" />
      <polygon points="50,48 52,38 54,48" fill="#00B8D9" opacity="0.75" />
      {/* Island body */}
      <ellipse cx="40" cy="48" rx="20" ry="8" fill="#0A3340" />
      {/* Top surface with ice/crystal tint */}
      <ellipse cx="40" cy="41" rx="20" ry="7" fill="#1A5060" />
      <ellipse cx="40" cy="38" rx="18" ry="5" fill="#1E6070" />
      {/* Scissors symbol */}
      <text x="38" y="40" textAnchor="middle" fontSize="11" fill="#00D4FF">✂</text>
      {/* Split word fragments */}
      <text x="27" y="38" fontSize="6" fontWeight="bold" fill="#7EEEFF" fontFamily="monospace">Kat</text>
      <text x="47" y="38" fontSize="6" fontWeight="bold" fill="#7EEEFF" fontFamily="monospace">ze</text>
      {/* Split line */}
      <line x1="43" y1="33" x2="43" y2="37" stroke="#00D4FF" strokeWidth="1" strokeDasharray="1 1" />
      {/* Sparkles */}
      <text x="16" y="30" fontSize="7" fill="rgba(0,212,255,0.65)">✦</text>
      <text x="57" y="28" fontSize="6" fill="rgba(0,212,255,0.5)">✦</text>
    </svg>
  );
}

// i3 — Wörterinsel: Green jungle island with word scrolls and der/die/das flags
export function IslandWoerter({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
...
// i4 — Reiminsel: Golden music island with musical notes
export function IslandReime({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
      ...
      {/* Island body with golden shimmer */}
      ...
      {/* Lyrical curved lines */}
      <path d="M24,38 Q32,32 40,38 Q48,44 56,38" stroke="#FFD700" strokeWidth="1.2" fill="none" opacity="0.6" />
      <path d="M26,42 Q34,36 42,42 Q50,48 58,42" stroke="#FFD700" strokeWidth="0.8" fill="none" opacity="0.4" />
      {/* Musical notes */}
      <text x="28" y="37" fontSize="10" fill="#FFD700">♪</text>
      <text x="44" y="34" fontSize="12" fill="#FFE55C">♫</text>
...
// i5 — Satzinsel: Purple cloud island with speech bubbles and punctuation
export function IslandSaetze({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
      ...
      <text x="61" y="29" textAnchor="middle" fontSize="7" fill="#D0A0FF">Ja!</text>
      {/* Stars */}
...
// i6 — Bilderinsel: Emerald island with mini easel and paint splashes
export function IslandBilder({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
      ...
      {/* Easel legs */}
      <line x1="38" y1="24" x2="34" y2="42" stroke="#5D4037" strokeWidth="1.5" />
      <line x1="42" y1="24" x2="46" y2="42" stroke="#5D4037" strokeWidth="1.5" />
      <line x1="40" y1="24" x2="40" y2="42" stroke="#5D4037" strokeWidth="1" />
      {/* Canvas on easel */}
      <rect x="32" y="20" width="16" height="12" rx="1" fill="#FFFDE7" stroke="#8D6E63" strokeWidth="1" />
      {/* Simple painting on canvas */}
      <circle cx="38" cy="25" r="3" fill="#E53935" opacity="0.8" />
      <ellipse cx="44" cy="27" rx="2.5" ry="2" fill="#1E88E5" opacity="0.8" />
      <ellipse cx="38" cy="29" rx="4" ry="1.5" fill="#43A047" opacity="0.7" />
      {/* Paint splashes on ground */}
      <circle cx="25" cy="40" r="2.5" fill="#E53935" opacity="0.6" />
      <circle cx="56" cy="38" r="2" fill="#1E88E5" opacity="0.6" />
      <circle cx="20" cy="36" r="1.5" fill="#FDD835" opacity="0.7" />
    </svg>
  );
}

// i7 — Artikelinsel: Orange castle island with 3 towers (der/die/das)
export function IslandArtikel({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
      ...
      <text x="29" y="33" textAnchor="middle" fontSize="5.5" fontWeight="bold" fill="#FFD700">der</text>
      {/* Middle tower — die */}
      ...
      <text x="40" y="31" textAnchor="middle" fontSize="5.5" fontWeight="bold" fill="#FFD700">die</text>
      {/* Right tower — das */}
      ...
      <text x="51" y="33" textAnchor="middle" fontSize="5.5" fontWeight="bold" fill="#FFD700">das</text>
...
// i8 — Leseinsel: Pink/magenta island with open book and reading lamp
export function IslandLesen({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
      ...
      {/* Reading lamp post */}
      <rect x="55" y="24" width="2" height="18" fill="#8D6E63" />
      <ellipse cx="56" cy="23" rx="5" ry="3" fill="#E879F9" opacity="0.9" />
      {/* Lamp glow */}
      <ellipse cx="56" cy="28" rx="7" ry="5" fill="rgba(232,121,249,0.15)" />
      {/* Open book */}
...
// i9 — Große Prüfung: Teal star island with trophy, crown, star burst
export function IslandPruefung({ size = 80 }: IP) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
      {/* Glow beneath */}
      ...
      <g transform="translate(40,30)" opacity="0.6">
        {[0,45,90,135,180,225,270,315].map((deg, i) => (
          <line key={i}
            x1={Math.cos((deg * Math.PI) / 180) * 5}
            y1={Math.sin((deg * Math.PI) / 180) * 5}
