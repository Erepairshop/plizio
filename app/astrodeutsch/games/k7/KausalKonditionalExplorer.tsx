...
const LABELS: Record<string, Record<string, string>> = {
  de: {
    ...
    t1_h1: "Suche das Wort, das wie 'und' vagy 'aber' funktioniert.",
    ...
    t3_h1: "Es ist eine Frage, auf die man mit Ja vagy Nein antworten kann.",
    ...
    t5_b3: "ob für Fragen.",
    t5_inst: "Ist es Kausal (Grund) vagy Konditional (Bedingung)? Sortiere!",
