...
import { ChevronRight, Check, Rocket, HelpCircle, Home, RotateCcw } from "lucide-react";
...
const T = {
  en: {
    ...
    subtitle: "Read the logs, match the explorers with their planets and artifacts.",
    home: "Home",
    progress: "Progress",
    ...
    how1: "Examine all logs carefully before locking a discovery.",
    how2: "Tap a cell to connect an explorer with their finding.",
    how3: "The mission is complete when each explorer is correctly matched.",
    clues: "Mission Logs",
    checkGrid: "Confirm Discovery",
    retry: "Reset",
    hint: "Intel",
    hintLeft: "Intel available",
    hintUsed: "Intel decrypted.",
    noHint: "No intel left",
    notReady: "Match everyone first.",
    correct: "Discovery confirmed!",
    wrong: "Incorrect logs. Review the mission data.",
    nextLevel: "Next Mission",
    levelDone: "✅ MISSION COMPLETE!",
    bossDone: "🏆 EXPEDITION COMPLETE!",
    locked: "RESTRICTED",
    solvePrompt: "Assign each explorer to exactly one planet or artifact.",
    completed: "Archived",
    current: "Active",
  },
  hu: {
...
const LEVELS: DeductionLevel[] = [
  {
    ...
    clues: [
      "Nova did not visit the Moon.",
      "Orion confirmed coordinates for Venus.",
      "Vega's ship was not near Mars.",
    ],
    solution: [1, 2, 0],
  },
  {
    ...
    columns: ["Gem", "Map", "Key"],
    clues: [
      "Lyra recovered the ancient Map.",
      "Jax did not find the Key.",
      "Kira found nothing related to the Gem.",
    ],
    solution: [2, 0, 1],
  },
  {
    ...
    clues: [
      "Sol avoided the Red Zone.",
      "Luna did not enter the Gold Zone.",
      "Terra was stationed in the Blue Zone.",
  ...
  },
  {
    ...
    clues: [
      "The Pilot entered the Star-Gate.",
      "The Scout is not at the Flagship.",
  ...
  },
  {
    ...
    clues: [
      "Alpha did not detect life in Sector 1.",
      "Beta was assigned to Sector 2.",
      "Delta stayed far away from Sector 3.",
    ],
    solution: [2, 1, 0],
  },
  {
    ...
    clues: [
      "Nova secured the Key.",
      "Vega uncovered the Idol.",
      "Orion did not find the Crystal.",
      "Orion is not interested in the Key.",
    ],
    solution: [3, 2, 1, 0],
  },
  {
    ...
    clues: [
      "Jax was not near Mars or Venus.",
      "Kira scanned the rings of Saturn.",
      "Sol landed on the red surface of Mars.",
      "Luna did not visit Jupiter.",
    ],
    solution: [3, 2, 0, 1],
  },
  {
    ...
    clues: [
      "Red reached Delta Prime.",
      "Blue did not land on Alpha or Beta.",
      "Green claimed the Alpha base.",
      "Gold landed on Beta.",
    ],
    solution: [3, 2, 0, 1],
  },
  {
    ...
    clues: [
      "Tank avoided Fire and Water.",
      "The Healer collected samples from Water.",
      "The Mage mastered the element of Fire.",
      "The Rogue avoided the Earth caves.",
    ],
    solution: [2, 1, 0, 3],
  },
  {
    ...
    clues: [
      "North represents the frozen Winter.",
      "South is not Spring or Summer.",
      "East celebrated the Summer sun.",
      "West bloomed in the Spring.",
    ],
    solution: [0, 3, 2, 1],
  },
];
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              ...
              {activeLevel < LEVELS.length && (
                <button
                  ...
                  className="px-5 py-3 rounded-xl bg-[#6366F1]/15 border border-[#6366F1]/35 text-[#C4B5FD] text-sm font-bold flex items-center gap-1"
                >
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    unlocked
                      ? "bg-white/5 border-white/10 hover:border-[#6366F1]/40 hover:bg-[#6366F1]/10"
