...
import K6Explorer from "@/app/astroenglish/games/k6/K6Explorer";
...
export default function AstroEnglishK6Page() {
  ...
  const startMission = useCallback((mission: MissionDef) => {
    ...
    const isExplorer = ["fill-gap", "category-rush", "grammar-match", "word-sort", "sentence-builder", "spell-race", "phonics", "picture-vocab", "rhyme-match", "word-build", "reading-comp", "tense-explorer", "memory-pair", "pronunciation", "english-k6-explore"].includes(mission.gameType);
  ...
  const gameScreen = (
    <div className="min-h-screen flex flex-col relative overflow-hidden"
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center px-4 pb-6">
        ...
        {screen === "english-k6-explore" && activeIsland && (
  ...
  if (["orbit-quiz", "black-hole", "gravity-sort", "star-match", "speed-round", "m2", "m3", "fill-gap", "category-rush", "grammar-match", "word-sort", "sentence-builder", "spell-race", "phonics", "picture-vocab", "rhyme-match", "word-build", "reading-comp", "tense-explorer", "memory-pair", "pronunciation", "english-k6-explore"].includes(screen)) return (
    <>
      {gameScreen}
