...
const BigTestK3Explorer = memo(function BigTestK3Explorer({
  color = "#4ECDC4",
  onDone,
  lang = "en",
}: {
  ...
  return (
    <ExplorerEngine
      def={DEF}
      grade={3}
      explorerId="english_k3_big_test"
      color={color}
      lang="en"
      onDone={onDone}
    />
...
export default BigTestK3Explorer;
