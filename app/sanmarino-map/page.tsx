...
const TITLE: Record<Lang, string> = {
  de: "San Marino Karte — Plizio",
  hu: "San Marino térkép — Plizio",
  ro: "Harta San Marino — Plizio",
  en: "San Marino Map — Plizio",
};

export default function SanMarinoMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"sm" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
