// AUTO-GENERATED — timorleste-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Osttimor – Karte",
  hu: "Kelet-Timor – térkép",
  ro: "Harta Timorul de Est",
  en: "Timor-Leste Map",
};

export default function TimorlesteMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="timorleste" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
