...
const TITLE: Record<Lang, string> = {
  de: "DominicanRepublic Karte",
  hu: "DominicanRepublic térkép",
  ro: "Harta DominicanRepublic",
  en: "DominicanRepublic Map",
};
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"do" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
