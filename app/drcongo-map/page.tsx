// AUTO-GENERATED — drcongo-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "DR Kongo – Karte",
  hu: "Kongói Dem. Közt. – térkép",
  ro: "Harta RD Congo",
  en: "DR Congo Map",
};

export default function DrcongoMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="drcongo" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
