// AUTO-GENERATED — southafrica-map page
"use client";
...
const TITLE: Record<Lang, string> = {
  de: "Südafrika – Karte",
  hu: "Dél-Afrika – térkép",
  ro: "Harta Africa de Sud",
  en: "South Africa Map",
};

export default function SouthafricaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap countryId="southafrica" subject="geographie" grade={5} />
      </main>
    </div>
  );
}
