...
const TITLE: Record<Lang, string> = {
  de: "Bosnien und Herzegowina Karte",
  hu: "Bosznia-Hercegovina térkép",
  ro: "Harta Bosniei și Herțegovinei",
  en: "Bosnia and Herzegovina Map",
};

export default function BosniaMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"ba" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
