...
const TITLE: Record<Lang, string> = {
  de: "Montenegro Karte — Plizio",
  hu: "Montenegró térkép — Plizio",
  ro: "Harta Muntenegrului — Plizio",
  en: "Montenegro Map — Plizio",
};

export default function MontenegroMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"me" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
