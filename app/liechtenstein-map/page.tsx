...
const TITLE: Record<Lang, string> = {
  de: "Liechtenstein Karte",
  hu: "Liechtenstein térkép",
  ro: "Harta Liechtenstein",
  en: "Liechtenstein Map",
};

export default function LiechtensteinMapPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[#060614] flex flex-col">
      ...
      <main className="flex-1 min-h-0 relative">
        <InteractiveMap lang={"li" as any} subject="geographie" grade={5} />
      </main>
    </div>
  );
}
