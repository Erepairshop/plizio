#!/usr/bin/env python3
"""Translate exact-key German grade-6 informatics batches through Azure OpenAI."""
...
INSTRUCTIONS = """Translate every supplied German school informatics string into natural {language_name}.
The strings belong to grade 6 test questions, answer choices, short answers and topic labels.
Translate faithfully and use standard age-appropriate school informatics terminology. Do not add, remove or
simplify technical facts. Preserve source code, HTML, CSS, SQL and Python syntax, identifiers, file extensions,
URLs, keyboard shortcuts, numbers, units, abbreviations, mathematical notation and placeholders exactly.
Proper product names may use their established target-language form. Never proofread, correct or rewrite a
German sentence in German. Every German phrase
