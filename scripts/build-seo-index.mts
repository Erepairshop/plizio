...
const OUT = path.resolve("public/data/_seo-index.json");
...
async function main() {
  ...
  const out = { pois: lite, regions, generatedAt: new Date().toISOString(), counts: { pois: lite.length, regions: regions.length } };
