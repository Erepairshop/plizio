...
const RP_COPY: Record<string, Record<string, string>> = {
  ...
  es: { h: "Planificador de rutas - Coche y autocaravana", sub: "Indica el origen y el destino. Calculamos la ruta con paradas e información de los países.", to: "Destino", from: "Origen", fromPh: "p. ej. Madrid", via: "Vía (opcional)", viaPh: "p. ej. Zaragoza", nights: "Paradas nocturnas", vehicle: "Vehículo", car: "🚗 Coche", camper: "🚐 Autocaravana", filter: "Paradas con (opcional):", water: "💧 Agua", dump: "♻️ Vaciado", power: "🔌 Electricidad", wc: "🚻 Aseo", shower: "🚿 Ducha", tierAB: "Áreas + campings", tierA: "Solo áreas", tierB: "Solo campings", tierABC: "También descanso/naturaleza", b10: "Desvío máx. 10 km", b20: "máx. 20 km", b30: "máx. 30 km", b50: "máx. 50 km", plan: "🧭 Calcular ruta" },
  pt: { h: "Planeador de rotas - Carro e autocaravana", sub: "Indique a origem e o destino. Calculamos a rota com paragens e informações dos países.", to: "Destino", from: "Origem", fromPh: "ex. Lisboa", via: "Via (opcional)", viaPh: "ex. Porto", nights: "Paragens noturnas", vehicle: "Veículo", car: "🚗 Carro", camper: "🚐 Autocaravana", filter: "Paragens com (opcional):", water: "💧 Água", dump: "♻️ Descarga", power: "🔌 Eletricidade", wc: "🚻 WC", shower: "🚿 Duche", tierAB: "Áreas + campismos", tierA: "Só áreas", tierB: "Só campismos", tierABC: "Também descanso/natureza", b10: "Desvio máx. 10 km", b20: "máx. 20 km", b30: "máx. 30 km", b50: "máx. 50 km", plan: "🧭 Calcular rota" },
  nl: { h: "Routeplanner - Auto en camper", sub: "Vul vertrek en bestemming in. We berekenen de route met stops en landinformatie.", to: "Bestemming", from: "Vertrek", fromPh: "bijv. Amsterdam", via: "Via (optioneel)", viaPh: "bijv. Keulen", nights: "Overnachtingsstops", vehicle: "Voertuig", car: "🚗 Auto", camper: "🚐 Camper", filter: "Stops met (optioneel):", water: "💧 Water", dump: "♻️ Afvoer", power: "🔌 Stroom", wc: "🚻 Toilet", shower: "🚿 Douche", tierAB: "Camperplaatsen + campings", tierA: "Alleen camperplaatsen", tierB: "Alleen campings", tierABC: "Ook rust-/natuurplaatsen", b10: "Omweg max. 10 km", b20: "max. 20 km", b30: "max. 30 km", b50: "max. 50 km", plan: "🧭 Route plannen" },
  hr: { h: "Planer rute - Automobil i kamper", sub: "Unesite polazište i odredište. Izračunat ćemo rutu sa stajanjima i informacijama o državama.", to: "Odredište", from: "Polazište", fromPh: "npr. Zagreb", via: "Preko (neobavezno)", viaPh: "npr. Ljubljana", nights: "Noćna stajanja", vehicle: "Vozilo", car: "🚗 Automobil", camper: "🚐 Kamper", filter: "Stajanja s uslugama (neobavezno):", water: "💧 Voda", dump: "♻️ Pražnjenje", power: "🔌 Struja", wc: "🚻 WC", shower: "🚿 Tuš", tierAB: "Kamper odmorišta + kampovi", tierA: "Samo kamper odmorišta", tierB: "Samo kampovi", tierABC: "I odmorišta/priroda", b10: "Obilazak maks. 10 km", b20: "maks. 20 km", b30: "maks. 30 km", b50: "maks. 50 km", plan: "🧭 Izračunaj rutu" },
  tr: { h: "Rota planlayıcı - Otomobil ve motokaravan", sub: "Başlangıç ve varış noktasını girin. Duraklar ve ülke bilgileriyle rotayı hesaplayalım.", to: "Varış", from: "Başlangıç", fromPh: "örn. İstanbul", via: "Üzerinden (isteğe bağlı)", viaPh: "örn. Ankara", nights: "Geceleme durakları", vehicle: "Araç", car: "🚗 Otomobil", camper: "🚐 Motokaravan", filter: "Şu hizmetlere sahip duraklar:", water: "💧 Su", dump: "♻️ Atık boşaltma", power: "🔌 Elektrik", wc: "🚻 Tuvalet", shower: "🚿 Duş", tierAB: "Karavan alanları + kampingler", tierA: "Yalnız karavan alanları", tierB: "Yalnız kampingler", tierABC: "Dinlenme/doğa alanları da", b10: "Sapma en fazla 10 km", b20: "en fazla 20 km", b30: "en fazla 30 km", b50: "en fazla 50 km", plan: "🧭 Rotayı hesapla" },
  pl: { h: "Planer trasy - Samochód i kamper", sub: "Podaj początek i cel. Obliczymy trasę z postojami i informacjami o krajach.", to: "Cel", from: "Początek", fromPh: "np. Warszawa", via: "Przez (opcjonalnie)", viaPh: "np. Kraków", nights: "Postoje nocne", vehicle: "Pojazd", car: "🚗 Samochód", camper: "🚐 Kamper", filter: "Postoje z udogodnieniami:", water: "💧 Woda", dump: "♻️ Zrzut", power: "🔌 Prąd", wc: "🚻 Toaleta", shower: "🚿 Prysznic", tierAB: "Miejsca dla kamperów + kempingi", tierA: "Tylko miejsca dla kamperów", tierB: "Tylko kempingi", tierABC: "Także miejsca odpoczynku/natura", b10: "Objazd maks. 10 km", b20: "maks. 20 km", b30: "maks. 30 km", b50: "maks. 50 km", plan: "🧭 Oblicz trasę" },
};
const RP_VEHICLE_COPY: Record<string, Record<string, string>> = {
  ...
  es: { title: "Dimensiones de la autocaravana", compact: "Furgoneta compacta", standard: "Autocaravana de 3,5 t", large: "Autocaravana grande", custom: "Medidas propias", length: "Longitud", width: "Anchura", height: "Altura", weight: "Peso" },
  pt: { title: "Dimensões da autocaravana", compact: "Furgão compacto", standard: "Autocaravana de 3,5 t", large: "Autocaravana grande", custom: "Medidas próprias", length: "Comprimento", width: "Largura", height: "Altura", weight: "Peso" },
  nl: { title: "Afmetingen camper", compact: "Compacte bus", standard: "Camper van 3,5 t", large: "Grote camper", custom: "Eigen maten", length: "Lengte", width: "Breedte", height: "Hoogte", weight: "Gewicht" },
  hr: { title: "Dimenzije kampera", compact: "Kompaktni kombi", standard: "Kamper od 3,5 t", large: "Veliki kamper", custom: "Vlastite dimenzije", length: "Duljina", width: "Širina", height: "Visina", weight: "Masa" },
  tr: { title: "Motokaravan ölçüleri", compact: "Kompakt panelvan", standard: "3,5 t motokaravan", large: "Büyük motokaravan", custom: "Özel ölçüler", length: "Uzunluk", width: "Genişlik", height: "Yükseklik", weight: "Ağırlık" },
  pl: { title: "Wymiary kampera", compact: "Kompaktowy van", standard: "Kamper 3,5 t", large: "Duży kamper", custom: "Własne wymiary", length: "Długość", width: "Szerokość", height: "Wysokość", weight: "Masa" },
};
const RP_DYN: Record<string, Record<string, string>> = {
  ...
  es: { notFound: "Lugar no encontrado", needOrigin: "Introduce un punto de origen.", searching: "📍 Buscando lugares…", routing: "🛣️ Calculando la ruta…", km: "km", hrs: "h", nights: "noches", matchStops: "paradas compatibles", mapsAll: "Ruta completa en Maps", advisory: "Información por países", toll: "Peaje", lez: "Zona de bajas emisiones", overnight: "Pernocta", mandatory: "Obligatorio", keepStop: "conservar esta parada", day: "DÍA", dest: "DESTINO", swipe: "← desliza las tarjetas →", regen: "Regenerar conservando las paradas", regenKept: "🔄 Ruta con paradas conservadas…", regenNew: "🔄 Nueva variante…" },
  pt: { notFound: "Local não encontrado", needOrigin: "Introduza um ponto de partida.", searching: "📍 A procurar locais…", routing: "🛣️ A calcular a rota…", km: "km", hrs: "h", nights: "noites", matchStops: "paragens compatíveis", mapsAll: "Rota completa no Maps", advisory: "Informações dos países", toll: "Portagem", lez: "Zona de baixas emissões", overnight: "Pernoita", mandatory: "Obrigatório", keepStop: "manter esta paragem", day: "DIA", dest: "DESTINO", swipe: "← deslize os cartões →", regen: "Recalcular mantendo as paragens", regenKept: "🔄 Rota com paragens mantidas…", regenNew: "🔄 Nova variante…" },
  nl: { notFound: "Plaats niet gevonden", needOrigin: "Vul een vertrekpunt in.", searching: "📍 Plaatsen zoeken…", routing: "🛣️ Route berekenen…", km: "km", hrs: "uur", nights: "nachten", matchStops: "geschikte stops", mapsAll: "Volledige route in Maps", advisory: "Landeninformatie", toll: "Tol", lez: "Milieuzone", overnight: "Overnachten", mandatory: "Verplicht", keepStop: "deze stop behouden", day: "DAG", dest: "DOEL", swipe: "← veeg door de kaarten →", regen: "Opnieuw berekenen met behouden stops", regenKept: "🔄 Route met behouden stops…", regenNew: "🔄 Nieuwe variant…" },
  hr: { notFound: "Mjesto nije pronađeno", needOrigin: "Unesite polazište.", searching: "📍 Traženje mjesta…", routing: "🛣️ Izračun rute…", km: "km", hrs: "h", nights: "noći", matchStops: "odgovarajuća stajanja", mapsAll: "Cijela ruta u Mapsu", advisory: "Informacije o državama", toll: "Cestarina", lez: "Zona niskih emisija", overnight: "Noćenje", mandatory: "Obavezno", keepStop: "zadrži ovo stajanje", day: "DAN", dest: "CILJ", swipe: "← povucite kartice →", regen: "Ponovno izračunaj sa zadržanim stajanjima", regenKept: "🔄 Ruta sa zadržanim stajanjima…", regenNew: "🔄 Nova varijanta…" },
  tr: { notFound: "Yer bulunamadı", needOrigin: "Bir başlangıç noktası girin.", searching: "📍 Yerler aranıyor…", routing: "🛣️ Rota hesaplanıyor…", km: "km", hrs: "sa", nights: "gece", matchStops: "uygun durak", mapsAll: "Tüm rota Maps'te", advisory: "Ülke bilgileri", toll: "Geçiş ücreti", lez: "Düşük emisyon bölgesi", overnight: "Geceleme", mandatory: "Zorunlu", keepStop: "bu durağı koru", day: "GÜN", dest: "HEDEF", swipe: "← kartları kaydırın →", regen: "Korunan duraklarla yeniden hesapla", regenKept: "🔄 Korunan duraklarla rota…", regenNew: "🔄 Yeni seçenek…" },
  pl: { notFound: "Nie znaleziono miejsca", needOrigin: "Podaj punkt początkowy.", searching: "📍 Wyszukiwanie miejsc…", routing: "🛣️ Obliczanie trasy…", km: "km", hrs: "godz.", nights: "noce", matchStops: "pasujące postoje", mapsAll: "Cała trasa w Maps", advisory: "Informacje o krajach", toll: "Opłata drogowa", lez: "Strefa niskiej emisji", overnight: "Nocleg", mandatory: "Obowiązkowe", keepStop: "zachowaj ten postój", day: "DZIEŃ", dest: "CEL", swipe: "← przesuń karty →", regen: "Przelicz z zachowanymi postojami", regenKept: "🔄 Trasa z zachowanymi postojami…", regenNew: "🔄 Nowy wariant…" },
};
...
const PG_TABS: Record<string, { dest: string; day: string }> = {
  ...
  es: { dest: "Destino", day: "Un día en la ciudad" },
  pt: { dest: "Destino", day: "Um dia na cidade" },
  nl: { dest: "Bestemming", day: "Een dag in de stad" },
  hr: { dest: "Odredište", day: "Jedan dan u gradu" },
  tr: { dest: "Varış", day: "Şehirde bir gün" },
  pl: { dest: "Cel", day: "Jeden dzień w mieście" },
};
...
function renderRouteInfo(poi: POI, lang: Lang, countryName: string, regionName: string): string {
  ...
  const L: Record<string, { title: (n: string) => string; lead: (n: string, l: string) => string; nearest: string; modes: (n: string) => string; mlead: string; car: string; camper: string; hike: string }> = {
    ...
    ro: { title: (n) => `Cum ajungi & planificarea rutei – ${n}`, lead: (n, l) => `${n} se află în ${l}. Planifică-ți călătoria și explorează împrejurimile.`, nearest: "În apropiere", modes: (n) => `Planifică ruta spre ${n} – cu mașina, cu autorulota sau pe jos.`, mlead: "Pornește ruta", car: "Mașină", camper: "Autorulotă", hike: "Drumeție" },
