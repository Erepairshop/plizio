...
lib/visualLab/data/poiExtraUganda*V2.ts files.
...
FILES = [
    "poiExtraUgandaCitiesV2.ts",
    "poiExtraUgandaEconomicV2.ts",
    "poiExtraUgandaHistoryV2.ts",
    "poiExtraUgandaLandmarksV2.ts",
    "poiExtraUgandaLifeV2.ts",
    "poiExtraUgandaNatureV2.ts",
    "poiExtraUgandaReliefV2.ts",
]
LANGS = ("de", "hu", "ro", "en")
...
CLOSERS = {
    "de": "Damit zählt der Ort zu den charakteristischen Punkten Ugandas — eines ostafrikanischen Binnenstaates, der vom Nordufer des Viktoriasees, von der Quellregion des Nils bei Jinja, vom Ruwenzori-Gebirge an der Grenze zum Kongo, von den Berggorillas im Bwindi-Nationalpark, den Murchison Falls am Weißen Nil sowie vom Reichtum an Kaffee, Bananen (Matoke) und Tee geprägt ist — und bietet einen Einblick in die regionale Identität.",
    "hu": "Ezzel a hely Uganda egyik jellegzetes pontja — egy olyan kelet-afrikai, tengerparttal nem rendelkező országé, amelyet a Viktória-tó északi partvidéke, a Nílus forrásvidéke Jinja közelében, a kongói határ menti Ruwenzori-hegység, a Bwindi Nemzeti Park hegyi gorillái, a Fehér-Níluson zúgó Murchison-vízesés, valamint a kávé, a banán (matoke) és a tea gazdagsága formált —, és betekintést nyújt a regionális identitásba.",
    "ro": "Astfel, locul se numără printre punctele caracteristice ale Ugandei — o țară est-africană fără ieșire la mare, modelată de țărmul nordic al Lacului Victoria, de regiunea izvoarelor Nilului din apropiere de Jinja, de munții Ruwenzori la granița cu Congo, de gorilele de munte din Parcul Național Bwindi, de cascada Murchison de pe Nilul Alb, precum și de bogăția în cafea, banane (matoke) și ceai — și oferă o imagine asupra identității regionale.",
    "en": "Thus, the site is among the characteristic points of Uganda — a landlocked East African country shaped by the northern shore of Lake Victoria, the source of the Nile near Jinja, the Rwenzori Mountains on the Congolese border, the mountain gorillas of Bwindi National Park, the Murchison Falls on the White Nile, and its wealth in coffee, bananas (matoke) and tea — and offers insight into the regional identity.",
}

EXTRA_FACT_TEMPLATES = {
    "de": [
        "Liegt im ostafrikanischen Binnenstaat Uganda nördlich des Viktoriasees.",
        "Die Region zählt zum tropischen Hochlandklima mit zwei Regen- und zwei Trockenzeiten pro Jahr.",
        "Erreichbar über das nationale Straßennetz, das von der Hauptstadt Kampala und vom Drehkreuz Entebbe ausgeht.",
        "Spielt eine Rolle in der ugandischen Wirtschaft, die von Kaffee-, Tee-, Bananen- (Matoke) und Fischerei­export geprägt ist.",
        "Repräsentativ für die landschaftliche Vielfalt zwischen Viktoriasee, Nilquellgebiet bei Jinja, Ruwenzori-Gebirge und Murchison Falls.",
        "Bedeutendes Element des kulturellen Erbes, das von den Königreichen Buganda, Bunyoro, Toro und Ankole sowie der Bantu- und Niloten-Tradition geformt ist.",
    ],
    "hu": [
        "A kelet-afrikai, tengerparttal nem rendelkező Uganda területén fekszik, a Viktória-tótól északra.",
        "A régiót trópusi magaslati éghajlat jellemzi, két esős és két száraz évszakkal.",
        "A fővárosból, Kampalából és az entebbei közlekedési csomópontból kiinduló közúthálózaton keresztül érhető el.",
        "Szerepet játszik a kávé-, tea-, banán- (matoke) és halászati exportra épülő ugandai gazdaságban.",
        "A Viktória-tó, a Jinja melletti Nílus-forrásvidék, a Ruwenzori-hegység és a Murchison-vízesés közötti tájak sokszínűségét képviseli.",
        "A Buganda, Bunyoro, Toro és Ankole királyságok, valamint a bantu és niloti hagyományok formálta ugandai örökség fontos eleme.",
    ],
    "ro": [
        "Este situat în statul est-african Uganda, fără ieșire la mare, la nord de Lacul Victoria.",
        "Regiunea aparține zonei climatice tropicale de altitudine, cu două sezoane ploioase și două secetoase pe an.",
        "Accesibil prin rețeaua națională de drumuri care pornește din capitala Kampala și din nodul de la Entebbe.",
        "Joacă un rol în economia ugandeză, bazată pe exportul de cafea, ceai, banane (matoke) și pește.",
        "Reprezentativ pentru diversitatea peisajului dintre Lacul Victoria, izvoarele Nilului de lângă Jinja, munții Ruwenzori și cascada Murchison.",
        "Element important al patrimoniului ugandez, modelat de regatele Buganda, Bunyoro, Toro și Ankole, precum și de tradițiile bantu și nilotice.",
    ],
    "en": [
        "Located in the landlocked East African state of Uganda, north of Lake Victoria.",
        "The region lies within the tropical highland climate belt, with two rainy and two dry seasons per year.",
        "Accessible via the national road network radiating from the capital Kampala and the Entebbe transport hub.",
        "Plays a role in the Ugandan economy, driven by coffee, tea, banana (matoke) and fisheries exports.",
        "Representative of the diversity between Lake Victoria, the source of the Nile near Jinja, the Rwenzori Mountains and Murchison Falls.",
        "An important element of Ugandan heritage, shaped by the Buganda, Bunyoro, Toro and Ankole kingdoms and by Bantu and Nilotic traditions.",
    ],
}
...
def process_poi(poi_text: str) -> tuple[str, dict]:
    ...
    for lang in LANGS:
        if not merged_desc[lang].strip():
            ...
            bn = (base_name.get(lang) or "").strip() or "Uganda"
            if bd or bf:
