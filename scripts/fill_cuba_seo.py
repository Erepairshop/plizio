...
lib/visualLab/data/poiExtraCuba*.ts files.
...
FILES = [
    "poiExtraCubaCitiesV2.ts",
    "poiExtraCubaEconomicV2.ts",
    "poiExtraCubaHistoryV2.ts",
    "poiExtraCubaLandmarksV2.ts",
    "poiExtraCubaLifeV2.ts",
    "poiExtraCubaNatureV2.ts",
    "poiExtraCubaReliefV2.ts",
]
LANGS = ("de", "hu", "ro", "en")
...
CLOSERS = {
    "de": "Damit zählt der Ort zu den charakteristischen Punkten der karibischen Inselrepublik Kuba und spiegelt die Verbindung von Geschichte, Tabak- und Zuckerrohranbau sowie tropischer Natur wider.",
    "hu": "Ezzel a hely Kuba, a karibi szigetállam egyik jellegzetes pontja, amely a történelem, a dohány- és cukornádtermesztés, valamint a trópusi természet összefonódását tükrözi.",
    "ro": "Astfel, locul se numără printre punctele caracteristice ale Cubei, statul insular caraibian, reflectând împletirea dintre istorie, cultivarea tutunului și a trestiei de zahăr și natura tropicală.",
    "en": "Thus, the site is among the characteristic points of Cuba, the Caribbean island nation, reflecting the interplay of history, tobacco and sugarcane cultivation, and tropical nature.",
}

EXTRA_FACT_TEMPLATES = {
    "de": [
        "Liegt im karibischen Inselstaat Kuba.",
        "Tropisch-feuchtes Klima mit ausgeprägter Regen- und Trockenzeit.",
        "Hauptstadt Havanna ist das politische und kulturelle Zentrum des Landes.",
        "Region ist eng mit dem Anbau von Tabak, Zuckerrohr und Kaffee verbunden.",
        "Sierra Maestra im Südosten prägt die Topografie der Insel.",
        "Wirtschaft und Kultur tragen Spuren der spanischen Kolonialzeit.",
        "Karibische Lebensart, Musik (Son, Rumba) und Architektur prägen den Alltag.",
        "Bedeutendes Element des kubanischen Natur- und Kulturerbes.",
    ],
    "hu": [
        "A karibi térség legnagyobb szigetországában, Kubában fekszik.",
        "Trópusi-nedves éghajlat jellemzi, kifejezett esős és száraz évszakkal.",
        "Az ország politikai és kulturális központja a főváros, Havanna.",
        "A régió szorosan kötődik a dohány-, cukornád- és kávétermesztéshez.",
        "A délkeleti Sierra Maestra hegység meghatározza a sziget domborzatát.",
        "Gazdaságában és kultúrájában mély nyomot hagyott a spanyol gyarmati múlt.",
        "A karibi életérzés, a son és rumba zene, valamint a gyarmati építészet jellemzi a mindennapokat.",
        "A kubai természeti és kulturális örökség fontos eleme.",
    ],
    "ro": [
        "Este situat în Cuba, cel mai mare stat insular din Caraibe.",
        "Climat tropical-umed, cu sezon ploios și sezon secetos bine conturate.",
        "Capitala Havana este centrul politic și cultural al țării.",
        "Regiunea este strâns legată de cultura tutunului, a trestiei de zahăr și a cafelei.",
        "Lanțul Sierra Maestra din sud-est definește relieful insulei.",
        "Economia și cultura poartă amprenta perioadei coloniale spaniole.",
        "Stilul de viață caraibian, muzica son și rumba și arhitectura colonială marchează viața de zi cu zi.",
        "Element important al patrimoniului natural și cultural cubanez.",
    ],
    "en": [
        "Located in Cuba, the largest island state in the Caribbean.",
        "Tropical-humid climate with distinct wet and dry seasons.",
        "Havana, the capital, is the country's political and cultural hub.",
        "The region is closely tied to tobacco, sugarcane and coffee cultivation.",
        "The Sierra Maestra range in the southeast shapes the island's topography.",
        "Its economy and culture bear strong traces of the Spanish colonial era.",
        "Caribbean lifestyle, son and rumba music, and colonial architecture define daily life.",
        "An important element of Cuba's natural and cultural heritage.",
    ],
}
...
def process_poi(poi_text: str) -> tuple[str, dict]:
    ...
    for lang in LANGS:
        if not merged_desc[lang].strip():
            ...
            bn = (base_name.get(lang) or "").strip() or "Cuba"
            if bd or bf:
