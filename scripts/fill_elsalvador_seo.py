...
FILES = [
    "poiExtraElsalvadorCitiesV2.ts",
    "poiExtraElsalvadorEconomicV2.ts",
    "poiExtraElsalvadorHistoryV2.ts",
    "poiExtraElsalvadorLandmarksV2.ts",
    "poiExtraElsalvadorLifeV2.ts",
    "poiExtraElsalvadorNatureV2.ts",
    "poiExtraElsalvadorReliefV2.ts",
]
LANGS = ("de", "hu", "ro", "en")
...
CLOSERS = {
    "de": "Damit zählt der Ort zu den charakteristischen Punkten der mittelamerikanischen Republik El Salvador und spiegelt die Verbindung von pazifischer Küste, vulkanischer Landschaft, Kaffee- und Zuckerrohranbau sowie dem Wiederaufbau nach dem Bürgerkrieg wider.",
    "hu": "Ezzel a hely El Salvador, a közép-amerikai köztársaság egyik jellegzetes pontja, amely a csendes-óceáni partvidék, a vulkanikus tájak, a kávé- és cukornádtermesztés, valamint a polgárháború utáni helyreállítás összefonódását tükrözi.",
    "ro": "Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil.",
    "en": "Thus, the site is among the characteristic points of El Salvador, the Central American republic, reflecting the interplay of Pacific coastline, volcanic landscapes, coffee and sugarcane cultivation, and post-civil-war reconstruction.",
}

EXTRA_FACT_TEMPLATES = {
    "de": [
        "Liegt in El Salvador, dem kleinsten Staat Mittelamerikas am Pazifik.",
        "Tropisches Klima mit ausgeprägter Regen- und Trockenzeit prägt die Region.",
        "Hauptstadt San Salvador ist das politische, wirtschaftliche und kulturelle Zentrum des Landes.",
        "Vulkane wie Izalco, Santa Ana und San Vicente prägen die Topografie El Salvadors.",
        "Die Wirtschaft ist eng mit Kaffee-, Zuckerrohr- und Maisanbau verbunden.",
        "Suchitoto und die Kolonialarchitektur erinnern an die spanische Vergangenheit.",
        "Der lange Bürgerkrieg (1980–1992) prägt bis heute Gesellschaft und Erinnerungskultur.",
        "Bedeutendes Element des salvadorianischen Natur- und Kulturerbes.",
    ],
    "hu": [
        "El Salvadorban, Közép-Amerika legkisebb országában, a Csendes-óceán partján fekszik.",
        "Trópusi éghajlat jellemzi, kifejezett esős és száraz évszakkal.",
        "Az ország politikai, gazdasági és kulturális központja a főváros, San Salvador.",
        "A táj képét vulkánok – például az Izalco, a Santa Ana és a San Vicente – határozzák meg.",
        "A gazdaságot hagyományosan a kávé-, cukornád- és kukoricatermesztés tartja fenn.",
        "Suchitoto és a gyarmati építészet a spanyol múltra emlékeztet.",
        "Az 1980–1992 közötti polgárháború mély nyomot hagyott a társadalmon és az emlékezetkultúrán.",
        "A salvadori természeti és kulturális örökség fontos eleme.",
    ],
    "ro": [
        "Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului.",
        "Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
        "Capitala San Salvador este centrul politic, economic și cultural al țării.",
        "Vulcani precum Izalco, Santa Ana și San Vicente modelează relieful Salvadorului.",
        "Economia este strâns legată de cultivarea cafelei, a trestiei de zahăr și a porumbului.",
        "Suchitoto și arhitectura colonială amintesc de trecutul spaniol.",
        "Lungul război civil (1980–1992) marchează până astăzi societatea și memoria colectivă.",
        "Element important al patrimoniului natural și cultural salvadorian.",
    ],
    "en": [
        "Located in El Salvador, the smallest country in Central America, on the Pacific coast.",
        "Tropical climate with distinct wet and dry seasons shapes the region.",
        "San Salvador, the capital, is the country's political, economic and cultural hub.",
        "Volcanoes such as Izalco, Santa Ana and San Vicente shape El Salvador's topography.",
        "The economy is closely tied to coffee, sugarcane and maize cultivation.",
        "Suchitoto and colonial architecture recall the country's Spanish past.",
        "The long civil war (1980–1992) still shapes society and collective memory.",
        "An important element of El Salvador's natural and cultural heritage.",
    ],
}
...
def process_poi(poi_text: str) -> tuple[str, dict]:
    ...
    for lang in LANGS:
        if not merged_desc[lang].strip():
            ...
            bn = (base_name.get(lang) or "").strip() or "El Salvador"
            if bd or bf:
