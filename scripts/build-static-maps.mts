...
const COUNTRIES: Country[] = [
  ...
  { iso:"af", slug:"afghanistan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Afghanistan", hu:"Afganisztán", ro:"Afganistan", en:"Afghanistan" } },
  { iso:"am", slug:"armenia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Armenien", hu:"Örményország", ro:"Armenia", en:"Armenia" } },
  { iso:"az", slug:"azerbaijan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Aserbaidschan", hu:"Azerbajdzsán", ro:"Azerbaidjan", en:"Azerbaijan" } },
  { iso:"bh", slug:"bahrain", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Bahrain", hu:"Bahrein", ro:"Bahrain", en:"Bahrain" } },
  { iso:"bd", slug:"bangladesh", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Bangladesch", hu:"Banglades", ro:"Bangladesh", en:"Bangladesh" } },
  { iso:"bt", slug:"bhutan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Bhutan", hu:"Bhután", ro:"Bhutan", en:"Bhutan" } },
  { iso:"bn", slug:"brunei", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Brunei", hu:"Brunei", ro:"Brunei", en:"Brunei" } },
  { iso:"kh", slug:"cambodia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Kambodscha", hu:"Kambodzsa", ro:"Cambodgia", en:"Cambodia" } },
  { iso:"cn", slug:"china", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"China", hu:"Kína", ro:"China", en:"China" } },
  { iso:"ge", slug:"georgia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Georgien", hu:"Grúzia", ro:"Georgia", en:"Georgia" } },
  { iso:"in", slug:"india", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Indien", hu:"India", ro:"India", en:"India" } },
  { iso:"id", slug:"indonesia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Indonesien", hu:"Indonézia", ro:"Indonezia", en:"Indonesia" } },
  { iso:"ir", slug:"iran", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Iran", hu:"Irán", ro:"Iran", en:"Iran" } },
  { iso:"iq", slug:"iraq", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Irak", hu:"Irak", ro:"Irak", en:"Iraq" } },
  { iso:"il", slug:"israel", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Israel", hu:"Izrael", ro:"Israel", en:"Israel" } },
  { iso:"jp", slug:"japan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Japan", hu:"Japán", ro:"Japonia", en:"Japan" } },
  { iso:"jo", slug:"jordan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Jordanien", hu:"Jordánia", ro:"Iordania", en:"Jordan" } },
  { iso:"kz", slug:"kazakhstan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Kasachstan", hu:"Kazahsztán", ro:"Kazahstan", en:"Kazakhstan" } },
  { iso:"kw", slug:"kuwait", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Kuwait", hu:"Kuvait", ro:"Kuwait", en:"Kuwait" } },
  { iso:"kg", slug:"kyrgyzstan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Kirgisistan", hu:"Kirgizisztán", ro:"Kârgâzstan", en:"Kyrgyzstan" } },
  { iso:"la", slug:"laos", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Laos", hu:"Laosz", ro:"Laos", en:"Laos" } },
  { iso:"lb", slug:"lebanon", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Libanon", hu:"Libanon", ro:"Liban", en:"Lebanon" } },
  { iso:"my", slug:"malaysia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Malaysia", hu:"Malajzia", ro:"Malaezia", en:"Malaysia" } },
  { iso:"mv", slug:"maldives", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Malediven", hu:"Maldív-szigetek", ro:"Maldive", en:"Maldives" } },
  { iso:"mn", slug:"mongolia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Mongolei", hu:"Mongólia", ro:"Mongolia", en:"Mongolia" } },
  { iso:"mm", slug:"myanmar", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Myanmar", hu:"Mianmar", ro:"Myanmar", en:"Myanmar" } },
  { iso:"np", slug:"nepal", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Nepal", hu:"Nepál", ro:"Nepal", en:"Nepal" } },
  { iso:"kp", slug:"northkorea", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Nordkorea", hu:"Észak-Korea", ro:"Coreea de Nord", en:"North Korea" } },
  { iso:"om", slug:"oman", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Oman", hu:"Omán", ro:"Oman", en:"Oman" } },
  { iso:"pk", slug:"pakistan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Pakistan", hu:"Pakisztán", ro:"Pakistan", en:"Pakistan" } },
  { iso:"ps", slug:"palestine", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Palästina", hu:"Palesztina", ro:"Palestina", en:"Palestine" } },
  { iso:"ph", slug:"philippines", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Philippinen", hu:"Fülöp-szigetek", ro:"Filipine", en:"Philippines" } },
  { iso:"qa", slug:"qatar", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Katar", hu:"Katar", ro:"Qatar", en:"Qatar" } },
  { iso:"ru", slug:"russia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Russland", hu:"Oroszország", ro:"Rusia", en:"Russia" } },
  { iso:"sa", slug:"saudiarabia", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Saudi-Arabien", hu:"Szaúd-Arábia", ro:"Arabia Saudită", en:"Saudi Arabia" } },
  { iso:"sg", slug:"singapore", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Singapur", hu:"Szingapúr", ro:"Singapore", en:"Singapore" } },
  { iso:"kr", slug:"southkorea", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Südkorea", hu:"Dél-Korea", ro:"Coreea de Sud", en:"South Korea" } },
  { iso:"lk", slug:"srilanka", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Sri Lanka", hu:"Srí Lanka", ro:"Sri Lanka", en:"Sri Lanka" } },
  { iso:"sy", slug:"syria", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Syrien", hu:"Szíria", ro:"Siria", en:"Syria" } },
  { iso:"tw", slug:"taiwan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Taiwan", hu:"Tajvan", ro:"Taiwan", en:"Taiwan" } },
  { iso:"tj", slug:"tajikistan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Tadschikistan", hu:"Tádzsikisztán", ro:"Tadjikistan", en:"Tajikistan" } },
  { iso:"th", slug:"thailand", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Thailand", hu:"Thaiföld", ro:"Thailanda", en:"Thailand" } },
  { iso:"tl", slug:"timorleste", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Osttimor", hu:"Kelet-Timor", ro:"Timorul de Est", en:"Timor-Leste" } },
  { iso:"tr", slug:"turkey", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Türkei", hu:"Törökország", ro:"Turcia", en:"Turkey" } },
  { iso:"tm", slug:"turkmenistan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Turkmenistan", hu:"Türkmenisztán", ro:"Turkmenistan", en:"Turkmenistan" } },
  { iso:"ae", slug:"uae", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"VAE", hu:"EAE", ro:"EAU", en:"UAE" } },
  { iso:"uz", slug:"uzbekistan", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Usbekistan", hu:"Üzbegisztán", ro:"Uzbekistan", en:"Uzbekistan" } },
  { iso:"vn", slug:"vietnam", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
    names:{ de:"Vietnam", hu:"Vietnám", ro:"Vietnam", en:"Vietnam" } },
  { iso:"ye", slug:"yemen", svgFile:"asia.svg.ts", mapVar:"asiaMap", vbVar:"asiaViewBox", projFn:"projectCoordsAS",
