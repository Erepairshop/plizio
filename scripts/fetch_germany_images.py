...
POI_MAP = {
    ...
    # Batch 2
    "burg-cochem":            ("de", "Reichsburg_Cochem"),
    "festung-marienberg":     ("de", "Festung_Marienberg"),
    "schloss-schwerin":       ("de", "Schweriner_Schloss"),
    "schloss-nordkirchen":    ("de", "Schloss_Nordkirchen"),
    "schloss-pfaueninsel":    ("de", "Pfaueninsel"),
    "burg-frankenstein":      ("de", "Burg_Frankenstein_(Bergstraße)"),
    "burg-rheinstein":        ("de", "Burg_Rheinstein"),
    "burg-katz":              ("de", "Burg_Katz"),
    "schloss-ludwigsburg":    ("de", "Residenzschloss_Ludwigsburg"),
    "burg-trausnitz":         ("de", "Burg_Trausnitz"),
    "insel-usedom":           ("de", "Usedom"),
    "saarschleife":           ("de", "Saarschleife"),
    "lechfall":               ("de", "Lechfall"),
    "triberg-wasserfaelle":   ("de", "Triberger_Wasserfälle"),
    "berchtesgaden-np":       ("de", "Nationalpark_Berchtesgaden"),
    "zugspitzplatt":          ("de", "Zugspitzplatt"),
    "altmuhltal":             ("de", "Altmühltal"),
    "heiligenhafen":          ("de", "Heiligenhafen"),
    "edersee":                ("de", "Edersee"),
    "wilseder-berg":          ("de", "Wilseder_Berg"),
    "legoland-guenzburg":     ("de", "Legoland_Deutschland"),
    "heide-park-soltau":      ("de", "Heide_Park"),
    "phantasialand":          ("de", "Phantasialand"),
    "deutsches-museum":       ("de", "Deutsches_Museum"),
    "schokoladenmuseum":      ("de", "Schokoladenmuseum_Köln"),
    "dresden-frauenkirche":   ("de", "Frauenkirche_(Dresden)"),
    "pergamonmuseum":         ("de", "Pergamonmuseum"),
    "east-side-gallery":      ("de", "East_Side_Gallery"),
    "beatles-museum":         ("de", "Beatlemania_Hamburg"),
}
