...
lib/visualLab/data/poiExtraGambia*.ts files.
...
FILES = [
    # NOTE: poiExtraGambiaCitiesV2.ts is structurally malformed (duplicate
    # POI fragments fused together with missing braces). It contains no
    # truly empty fields (only placeholder text), so we skip it here.
    "poiExtraGambiaEconomicV2.ts",
    "poiExtraGambiaLandmarksV2.ts",
    "poiExtraGambiaReliefV2.ts",
    "poiExtraGambiaHistoryV2.ts",
    "poiExtraGambiaLifeV2.ts",
    "poiExtraGambiaNatureV2.ts",
]
LANGS = ("de", "hu", "ro", "en")
...
CLOSERS = {
    "de": "Damit zählt der Ort zu den charakteristischen Punkten Gambias — eines schmalen, vom Senegal umschlossenen Landes entlang des Gambia-Flusses, geprägt von der Atlantikküste, dem Hafen von Banjul, britischem Kolonialerbe sowie Erdnuss- und Fischereiwirtschaft — und bietet einen Einblick in die regionale Identität.",
    "hu": "Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba.",
    "ro": "Astfel, locul se numără printre punctele caracteristice ale Gambiei — o țară îngustă, înconjurată de Senegal și întinsă de-a lungul fluviului Gambia, modelată de coasta atlantică, portul Banjul, moștenirea colonială britanică și economia bazată pe arahide și pescuit — și oferă o imagine asupra identității regionale.",
    "en": "Thus, the site is among the characteristic points of The Gambia — a narrow country enclosed by Senegal along the Gambia River, shaped by its Atlantic coastline, the port of Banjul, British colonial heritage, and an economy based on groundnuts and fisheries — and offers insight into the regional identity.",
}

EXTRA_FACT_TEMPLATES = {
    "de": [
        "Liegt im westafrikanischen Staat Gambia entlang des gleichnamigen Gambia-Flusses.",
        "Das Land ist eine schmale Enklave, fast vollständig vom Senegal umschlossen, mit kurzem Atlantikabschnitt.",
        "Die Region zählt zum tropischen Klimagürtel mit ausgeprägter Regen- und Trockenzeit.",
        "Erreichbar über das nationale Straßennetz, das von der Hauptstadt Banjul ausgeht.",
        "Spielt eine Rolle in der gambischen Wirtschaft, die von Erdnussanbau, Fischerei und Tourismus geprägt ist.",
        "Repräsentativ für die Vielfalt der Landschaft entlang des Gambia-Flusses und der Atlantikküste.",
        "Bedeutendes Element des kulturellen Erbes, das vom britischen Kolonialerbe und der senegambischen Tradition geformt ist.",
    ],
    "hu": [
        "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.",
        "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
        "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.",
        "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.",
        "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban.",
        "A Gambia-folyó és az atlanti partvidék mentén húzódó táj sokszínűségét képviseli.",
        "A brit gyarmati örökség és a szenegambiai hagyomány által formált gambiai kulturális örökség fontos eleme.",
    ],
    "ro": [
        "Este situat în statul vest-african Gambia, de-a lungul fluviului omonim Gambia.",
        "Țara este o enclavă îngustă, aproape complet înconjurată de Senegal, cu un scurt segment de coastă atlantică.",
        "Regiunea aparține zonei tropicale, cu sezoane ploioase și secetoase distincte.",
        "Accesibil prin rețeaua națională de drumuri care pornește din capitala Banjul.",
        "Joacă un rol în economia gambiană, bazată pe cultura arahidelor, pescuit și turism.",
        "Reprezentativ pentru diversitatea peisajului de-a lungul fluviului Gambia și a coastei atlantice.",
        "Element important al patrimoniului gambian, modelat de moștenirea colonială britanică și de tradiția senegambiană.",
    ],
    "en": [
        "Located in the West African state of The Gambia along the Gambia River.",
        "The country is a narrow enclave, almost entirely surrounded by Senegal, with a short Atlantic coastline.",
        "The region lies within the tropical belt, with marked rainy and dry seasons.",
        "Accessible via the national road network radiating from the capital, Banjul.",
        "Plays a role in the Gambian economy, driven by groundnut farming, fisheries and tourism.",
        "Representative of the diversity of the landscape along the Gambia River and the Atlantic coast.",
        "An important element of Gambian heritage, shaped by British colonial legacy and Senegambian tradition.",
    ],
}
...
def process_poi(poi_text: str) -> tuple[str, dict]:
    ...
    for lang in LANGS:
        if not merged_desc[lang].strip():
            ...
            bn = (base_name.get(lang) or "").strip() or "Gambia"
            if bd or bf:
