...
lib/visualLab/data/poiExtraIvorycoast*V2.ts files.

Identical strategy to scripts/fill_ghana_seo.py — only the
country-specific narrative templates differ. Ivory Coast (Côte d'Ivoire)
themes: Atlantic coast on the Gulf of Guinea, Abidjan / Yamoussoukro,
Comoé river, tropical rainforest, cocoa / coffee / palm oil exports,
French colonial heritage.

Idempotent: re-runs will merge existing advanced blocks and skip POIs
that already have non-empty per-language values.

Usage:
  python scripts/fill_ivorycoast_seo.py
"""
...
FILES = [
    "poiExtraIvorycoastCitiesV2.ts",
    "poiExtraIvorycoastEconomicV2.ts",
    "poiExtraIvorycoastLandmarksV2.ts",
    "poiExtraIvorycoastReliefV2.ts",
    "poiExtraIvorycoastHistoryV2.ts",
    "poiExtraIvorycoastLifeV2.ts",
    "poiExtraIvorycoastNatureV2.ts",
]
LANGS = ("de", "hu", "ro", "en")
...
# ---------- Ivory Coast specific narrative templates ----------

CLOSERS = {
    "de": "Damit zählt der Ort zu den charakteristischen Punkten der Elfenbeinküste — eines Landes, das von der Atlantikküste am Golf von Guinea, von Abidjan und der politischen Hauptstadt Yamoussoukro, vom Comoé-Fluss, dem tropischen Regenwald, dem Reichtum an Kakao, Kaffee und Palmöl sowie dem französischen Kolonialerbe geprägt ist — und bietet einen Einblick in die regionale Identität.",
    "hu": "Ezzel a hely Elefántcsontpart egyik jellegzetes pontja — egy olyan országé, amelyet a Guineai-öbölre nyíló atlanti partvidék, Abidjan és a politikai főváros Yamoussoukro, a Comoé folyó, a trópusi esőerdő, a kakaó-, kávé- és pálmaolaj-gazdagság, valamint a francia gyarmati örökség formált —, és betekintést nyújt a regionális identitásba.",
    "ro": "Astfel, locul se numără printre punctele caracteristice ale Coastei de Fildeș — o țară modelată de coasta atlantică la Golful Guineei, de Abidjan și capitala politică Yamoussoukro, de râul Comoé, de pădurea tropicală, de bogăția în cacao, cafea și ulei de palmier, precum și de moștenirea colonială franceză — și oferă o imagine asupra identității regionale.",
    "en": "Thus, the site is among the characteristic points of Ivory Coast — a country shaped by its Atlantic coastline on the Gulf of Guinea, by Abidjan and the political capital Yamoussoukro, by the Comoé river, the tropical rainforest, its wealth in cocoa, coffee and palm oil, and by its French colonial heritage — and offers insight into the regional identity.",
}

EXTRA_FACT_TEMPLATES = {
    "de": [
        "Liegt im westafrikanischen Staat Elfenbeinküste am Golf von Guinea.",
        "Die Region zählt zum tropischen Klimagürtel mit ausgeprägter Regen- und Trockenzeit.",
        "Erreichbar über das nationale Straßennetz, das von Abidjan und Yamoussoukro ausgeht.",
        "Spielt eine Rolle in der ivorischen Wirtschaft, die vom Kakao-, Kaffee- und Palmölexport geprägt ist.",
        "Repräsentativ für die Vielfalt der Landschaft zwischen Atlantikküste, Comoé-Becken und tropischem Regenwald.",
        "Bedeutendes Element des kulturellen Erbes, das vom französischen Kolonialerbe und den westafrikanischen Traditionen geformt ist.",
    ],
    "hu": [
        "A nyugat-afrikai Elefántcsontpart területén fekszik, a Guineai-öböl partvidékén.",
        "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.",
        "Az Abidjanból és Yamoussoukróból kiinduló közúthálózaton keresztül érhető el.",
        "Szerepet játszik a kakaó-, kávé- és pálmaolaj-exportra épülő elefántcsontparti gazdaságban.",
        "Az atlanti partvidék, a Comoé-medence és a trópusi esőerdő sokszínűségét képviseli.",
        "A francia gyarmati örökség és a nyugat-afrikai hagyományok formálta elefántcsontparti örökség fontos eleme.",
    ],
    "ro": [
        "Este situat în statul vest-african Coasta de Fildeș, pe coasta Golfului Guineei.",
        "Regiunea aparține zonei tropicale, cu sezoane ploioase și secetoase distincte.",
        "Accesibil prin rețeaua națională de drumuri care pornește din Abidjan și Yamoussoukro.",
        "Joacă un rol în economia ivoriană, bazată pe exportul de cacao, cafea și ulei de palmier.",
        "Reprezentativ pentru diversitatea peisajului dintre coasta atlantică, bazinul Comoé și pădurea tropicală.",
        "Element important al patrimoniului ivorian, modelat de moștenirea colonială franceză și de tradițiile vest-africane.",
    ],
    "en": [
        "Located in the West African state of Ivory Coast along the Gulf of Guinea coast.",
        "The region lies within the tropical belt, with marked rainy and dry seasons.",
        "Accessible via the national road network radiating from Abidjan and Yamoussoukro.",
        "Plays a role in the Ivorian economy, driven by cocoa, coffee and palm oil exports.",
        "Representative of the diversity between Atlantic coast, Comoé basin and tropical rainforest.",
        "An important element of Ivorian heritage, shaped by French colonial legacy and West African traditions.",
    ],
}
...
def process_poi(poi_text: str) -> tuple[str, dict]:
    ...
    for lang in LANGS:
        if not merged_desc[lang].strip():
            ...
            bn = (base_name.get(lang) or "").strip() or "Côte d'Ivoire"
            if bd or bf:
