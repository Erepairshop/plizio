-- ============================================================================
-- 006: KLASSENARBEIT SAFEGUARDS – Enhanced validation & fallback protection
-- ============================================================================
-- Problem: Edge cases in Klassenarbeit generation (no questions, null notes, etc)
-- Solution: Enhanced RPC validation + safe fallback logic
-- ============================================================================

-- ──────────────────────────────────────────────────────────────────────────────
-- 1. Enhanced submit_test RPC with klassenarbeit_data validation
-- ──────────────────────────────────────────────────────────────────────────────
...
BEGIN
  ...
  UPDATE test_instances SET
    ...
    stars_earned = COALESCE(v_stars, 0), -- SAFEGUARD: ensure not NULL
    xp_earned = v_xp,
...
-- ============================================================================
-- 006 MIGRATION COMPLETE
-- ============================================================================
-- Changes:
-- 1. Enhanced submit_test RPC with klassenarbeit_data validation
-- 2. Safeguards for stars_earned (never NULL)
-- 3. COALESCE defaults on all aggregations
