...
import type { PhysicsGameId, PhysicsLevel } from "./physicsCurriculum";

export type LegacyPhysicsRound =
  | MeteorCatchRound
  | OrbitSortRound
  | SignalRunnerRound
  | ConstellationBuilderRound
...
export function prepareLegacyPhysicsRounds<T extends LegacyPhysicsRound>(
