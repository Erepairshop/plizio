...
import { romaniaAllPois } from "../data/romaniaPoi.lite"; // Tartalmazza: romaniaCulture, romaniaTraditions, romaniaWildlife, romaniaFolk
import { poiExtraRo1 } from "../data/poiExtraRo1.lite";
import { poiExtraRo2 } from "../data/poiExtraRo2.lite";
import { hungaryAllPoi } from "../data/hungaryPoi.lite";
import { poiExtraHu1 } from "../data/poiExtraHu1.lite";
import { poiExtraHu2 } from "../data/poiExtraHu2.lite";
import { poiExtraHu3 } from "../data/poiExtraHu3.lite";
import { franceCitiesExtra } from "../data/francePoi.lite";
import { poiExtraFranceCities } from "../data/poiExtraFranceCities.lite";
import { italyAllPoi } from "../data/italyPoi.lite";
import { polandAllPoi } from "../data/polandPoi.lite";
import { poiExtraPolandCities } from "../data/poiExtraPolandCities.lite";
import { spainMap, spainViewBox, projectCoordsES } from "./spain.svg";
import { spainAllPoi } from "../data/spainPoi.lite";
import { unitedkingdomMap, unitedkingdomViewBox, projectCoordsUK } from "./unitedkingdom.svg";
import { unitedkingdomAllPoi } from "../data/unitedkingdomPoi.lite";
import { netherlandsMap, netherlandsViewBox, projectCoordsNL } from "./netherlands.svg";
import { netherlandsAllPoi } from "../data/netherlandsPoi.lite";
import { poiExtraNetherlandsCities } from "../data/poiExtraNetherlandsCities.lite";
import { austriaMap, austriaViewBox, projectCoordsAT } from "./austria.svg";
import { austriaAllPoi } from "../data/austriaPoi.lite";
import { poiExtraAustriaHistorical } from "../data/poiExtraAustriaHistorical.lite";
import { poiExtraAustriaIndustry } from "../data/poiExtraAustriaIndustry.lite";
import { poiExtraAustriaLife } from "../data/poiExtraAustriaLife.lite";
import { poiExtraAustriaNature } from "../data/poiExtraAustriaNature.lite";
import { belgiumMap, belgiumViewBox, projectCoordsBE } from "./belgium.svg";
import { belgiumAllPoi } from "../data/belgiumPoi.lite";
import { portugalMap, portugalViewBox, projectCoordsPT } from "./portugal.svg";
import { portugalAllPoi } from "../data/portugalPoi.lite";
import { poiExtraPortugalHistorical } from "../data/poiExtraPortugalHistorical.lite";
import { poiExtraPortugalNature } from "../data/poiExtraPortugalNature.lite";
import { greeceMap, greeceViewBox, projectCoordsGR } from "./greece.svg";
import { greeceAllPoi } from "../data/greecePoi.lite";
import { poiExtraGreeceCities } from "../data/poiExtraGreeceCities.lite";
import { irelandMap, irelandViewBox, projectCoordsIE } from "./ireland.svg";
import { irelandAllPoi } from "../data/irelandPoi.lite";
import { poiExtraIrelandCities } from "../data/poiExtraIrelandCities.lite";
import { denmarkMap, denmarkViewBox, projectCoordsDK } from "./denmark.svg";
import { denmarkAllPoi } from "../data/denmarkPoi.lite";
import { swedenMap, swedenViewBox, projectCoordsSE } from "./sweden.svg";
import { swedenAllPoi } from "../data/swedenPoi.lite";
import { norwayMap, norwayViewBox, projectCoordsNO } from "./norway.svg";
import { norwayAllPoi } from "../data/norwayPoi.lite";
import { finlandMap, finlandViewBox, projectCoordsFI } from "./finland.svg";
import { finlandAllPoi } from "../data/finlandPoi.lite";
...
import { switzerlandAllPoi } from "../data/switzerlandPoi.lite";
...
import { poiExtraCzechRepublicCities } from "../data/poiExtraCzechRepublicCities.lite";
...
import { ukrainePois } from "../data/ukrainePoi.lite";
import { belarusAllPoi } from "../data/belarusPoi.lite";
import { andorraMap, andorraViewBox, projectCoordsAD } from "./andorra.svg";
import { andorraAllPoi } from "../data/andorraPoi.lite";
import { poiExtraAndorraCities } from "../data/poiExtraAndorraCities.lite";
import { monacoMap, monacoViewBox, projectCoordsMC } from "./monaco.svg";
import { monacoAllPoi } from "../data/monacoPoi.lite";
import { vaticanMap, vaticanViewBox, projectCoordsVA } from "./vatican.svg";
import { vaticanPois } from "../data/vaticanPoi.lite";
// ─── North America ────────────────────────────────────────────────────────
  ...
  switch (lang) {
    ...
    case "at":
      return {
        ...
        pois: [...austriaAllPoi, ...poiExtraAustriaHistorical, ...poiExtraAustriaIndustry, ...poiExtraAustriaLife, ...poiExtraAustriaNature],
    ...
    case "mt":
      return {
        ...
        pois: [...maltaAllPoi, ...poiExtraMaltaCities],
        subregions: {},
      };
    case "cy":
      return {
