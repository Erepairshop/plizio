...
import type { BiologyGameId, BiologyLevel } from "./biologyCurriculum";

export type LegacyBiologyRound =
  | MeteorCatchRound
  | OrbitSortRound
  | SignalRunnerRound
  | ConstellationBuilderRound
...
export function prepareLegacyBiologyRounds<T extends LegacyBiologyRound>(
