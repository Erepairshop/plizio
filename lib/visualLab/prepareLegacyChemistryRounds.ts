...
import type { ChemistryGameId, ChemistryLevel } from "./chemistryCurriculum";

export type LegacyChemistryRound =
  | MeteorCatchRound
  | OrbitSortRound
  | SignalRunnerRound
  | ConstellationBuilderRound
...
export function prepareLegacyChemistryRounds<T extends LegacyChemistryRound>(
  gameId: ChemistryGameId,
  rounds: T[],
  grade: number,
