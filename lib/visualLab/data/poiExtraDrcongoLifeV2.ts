...
export const poiExtraDrcongoLifeV2: POI[] = [
  {
    ...
    description: { de: "Afrikas ältester Nationalpark, berühmt für seine Berggorillas.", hu: "Afrika legrégebbi nemzeti parkja, híres hegyi gorilláiról.", ro: "Cel mai vechi parc național din Africa, faimos pentru gorilele de munte.", en: "Africa's oldest national park, famous for its mountain gorillas." },
    facts: {
      de: ["Beheimatet Berggorillas", "Gegründet 1925", "Vulkanisches Gebiet", "UNESCO-Welterbe"],
    ...
    factsAdvanced: {
      de: ["1925 gegründet", "Nord-Kivu", "Albertine Rift", "Nyiragongo", "Nyamulagira", "Berggorillas", "UNESCO-Welterbe", "Grenzraum zu Uganda und Ruanda"],
  ...
  },
  {
    ...
    description: { de: "Ein geschütztes Gebiet, das für seine Östlichen Flachlandgorillas bekannt ist.", hu: "Védett terület, amely a keleti síkvidéki gorilláiról ismert.", ro: "O zonă protejată cunoscută pentru gorilele de câmpie estice.", en: "A protected area known for its Eastern Lowland gorillas." },
    facts: {
      de: ["Flachlandgorillas", "Vulkan Kahuzi", "Vulkan Biega", "Tropischer Regenwald"],
  ...
  },
  {
    ...
    description: { de: "Ein Schutzgebiet für Okapis im Ituri-Regenwald.", hu: "Az okapi védelmére létrehozott rezervátum az Ituri-esőerdőben.", ro: "O rezervație pentru protejarea okapi-lor în pădurea tropicală Ituri.", en: "A reserve dedicated to protecting okapis in the Ituri Rainforest." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Afrikas größtes tropisches Regenwaldreservat.", hu: "Afrika legnagyobb trópusi esőerdő rezervátuma.", ro: "Cea mai mare rezervație de pădure tropicală din Africa.", en: "Africa's largest tropical rainforest reserve." },
    facts: {
      de: ["Bonobos", "Regenwald", "Flussbecken", "Großes Schutzgebiet"],
    ...
    factsAdvanced: {
      de: ["1970 gegründet", "Kongo-Becken", "Bonobos", "Salonga-Fluss", "UNESCO-Welterbe", "gr??tes tropisches Waldschutzgebiet Afrikas", "schwer zugänglicher Regenwald", "Fluss- und Sumpflandschaft"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    description: { de: "Ein Park, der für seine Giraffen und Elefanten bekannt ist.", hu: "Park, amely zsiráfjairól és elefántjairól híres.", ro: "Un parc cunoscut pentru girafele și elefanții săi.", en: "A park known for its giraffes and elephants." },
    facts: {
      de: ["Giraffen", "Elefanten", "Savanne", "UNESCO-Welterbe"],
    ...
    factsAdvanced: {
      de: ["1938 gegründet", "Nordosten der DR Kongo", "nahe der Grenze zum S?dsudan", "UNESCO-Welterbe", "Giraffen", "Elefanten", "Savannenraum", "Schutzgebiet mit langer Ranger-Geschichte"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    description: { de: "Ein Park mit einer vielfältigen Landschaft aus Seen und Bergen.", hu: "Park változatos tavakból és hegyekből álló tájjal.", ro: "Un parc cu un peisaj divers de lacuri și munți.", en: "A park with a diverse landscape of lakes and mountains." },
    facts: {
      de: ["Seen", "Berge", "Vielfältige Fauna", "Große Fläche"],
  ...
  },
  {
    ...
    description: { de: "Bekannt für seine Wasserfälle und die weite Hochebene.", hu: "Híres vízeséseiről és a kiterjedt fennsíkról.", ro: "Cunoscut pentru cascadele sale și podișul întins.", en: "Known for its waterfalls and the extensive plateau." },
    facts: {
      de: ["Wasserfälle", "Fennsík", "Savanne", "Wandern"],
  ...
  },
  {
    ...
    description: { de: "Ein relativ neuer Nationalpark mit einzigartiger Artenvielfalt.", hu: "Relatíve új nemzeti park egyedi biológiai sokféleséggel.", ro: "Un parc național relativ nou, cu o biodiversitate unică.", en: "A relatively new national park with unique biodiversity." },
    facts: {
      de: ["Bonobos", "Okapi", "Regenwald", "Neuer Schutzstatus"],
    ...
    factsAdvanced: {
      de: ["2016 gegründet", "Lomami-Fluss", "Bonobos", "zentrale DR Kongo", "abgelegene Waldgebiete", "Prim?rwald", "Forschungsgebiet", "Schutzraum f?r seltene Arten"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    description: { de: "Ein abgelegener Nationalpark in einem der dichtesten Regenwälder.", hu: "Távoli nemzeti park az egyik legsűrűbb esőerdőben.", ro: "Un parc național izolat într-una dintre cele mai dense păduri tropicale.", en: "A remote national park in one of the densest rainforests." },
    facts: {
      de: ["Regenwald", "Gorillas", "Okapi", "Abgelegen"],
  ...
  },
  {
    ...
    description: { de: "Schützt die Mangrovenwälder an der Kongomündung.", hu: "Védi a mangrove-erdőket a Kongó torkolatánál.", ro: "Protejează pădurile de mangrove de la gura fluviului Congo.", en: "Protects the mangrove forests at the Congo River mouth." },
    facts: {
      de: ["Mangroven", "Küstengebiet", "Artenreich", "Kongomündung"],
  ...
  },
  {
    ...
    description: { de: "Eine typische landwirtschaftliche Region für den Kakaoanbau.", hu: "Tipikus mezőgazdasági régió a kakaótermesztéshez.", ro: "O regiune agricolă tipică pentru cultivarea cacao-ului.", en: "A typical agricultural region for cocoa cultivation." },
    facts: {
      de: ["Kakaoanbau", "Landwirtschaft", "Export", "Tropenklima"],
  ...
  },
  {
    ...
    description: { de: "Ein beliebter Park für Familien in Kinshasa.", hu: "Népszerű park a családoknak Kinshasában.", ro: "Un parc popular pentru familii în Kinshasa.", en: "A popular park for families in Kinshasa." },
    facts: {
      de: ["Spielplatz", "Freizeit", "Familien", "Kinshasa"],
  ...
  },
  {
    ...
    description: { de: "Anbaugebiet für hochwertigen Kaffee in den Bergen.", hu: "Minőségi kávé termesztőterülete a hegyekben.", ro: "Regiune de cultivare a cafelei de înaltă calitate în munți.", en: "Cultivation area for high-quality coffee in the mountains." },
    facts: {
      de: ["Kaffeeanbau", "Bergregion", "Exportprodukt", "Landwirtschaft"],
    ...
    factsAdvanced: {
      de: ["Coffea arabica", "Coffea canephora", "3 bis 4 Jahre bis zur ersten Ernte", "Höhenlage", "Handernte", "Sortierung und Trocknung", "Exportprodukt", "gut entw?sserte H?nge"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    description: { de: "Großflächiger Anbau von Ölpalmen zur Gewinnung von Palmöl.", hu: "Olajpálmák nagyüzemi termesztése pálmaolaj előállításához.", ro: "Cultivarea la scară largă a palmierilor de ulei pentru producția de ulei de palmier.", en: "Large-scale cultivation of oil palms for palm oil production." },
    facts: {
      de: ["Palmöl", "Landwirtschaft", "Großbetrieb", "Tropen"],
  ...
  },
  {
    ...
    description: { de: "Ein Freizeitort für Kinder in der Stadt Lubumbashi.", hu: "Szabadidős helyszín gyerekeknek Lubumbashi városában.", ro: "Un loc de recreere pentru copii în orașul Lubumbashi.", en: "A recreational place for children in the city of Lubumbashi." },
    facts: {
      de: ["Spielplatz", "Freizeit", "Lubumbashi", "Familien"],
  ...
  },
  {
    ...
    description: { de: "Regionale Anbaufläche für Erdnüsse.", hu: "Regionális földimogyoró-termesztőterület.", ro: "Zonă regională de cultivare a arahidelor.", en: "Regional cultivation area for peanuts." },
    facts: {
      de: ["Erdnüsse", "Landwirtschaft", "Regionalprodukt", "Boden"],
  ...
  },
  {
    ...
    description: { de: "Anbau von Zuckerrohr zur Zuckerproduktion.", hu: "Cukornád termesztése cukorgyártáshoz.", ro: "Cultivarea trestiei de zahăr pentru producția de zahăr.", en: "Cultivation of sugarcane for sugar production." },
    facts: {
      de: ["Zuckerrohr", "Zucker", "Landwirtschaft", "Tropisch"],
  ...
  },
  {
    ...
    description: { de: "Ein kleiner Park für Familien in Goma.", hu: "Kis park családoknak Gomában.", ro: "Un parc mic pentru familii în Goma.", en: "A small park for families in Goma." },
    facts: {
      de: ["Spielplatz", "Goma", "Familien", "Freizeit"],
  ...
  },
  {
    ...
    description: { de: "Großflächiger Anbau von Bananen.", hu: "Banán nagyüzemi termesztése.", ro: "Cultivarea la scară largă a bananelor.", en: "Large-scale cultivation of bananas." },
    facts: {
      de: ["Bananen", "Landwirtschaft", "Tropenfrucht", "Export"],
  ...
  },
  {
    ...
    description: { de: "Ein Treffpunkt für Familien in Kisangani.", hu: "Találkozóhely családoknak Kisanganiban.", ro: "Un punct de întâlnire pentru familii în Kisangani.", en: "A meeting place for families in Kisangani." },
    facts: {
      de: ["Spielplatz", "Kisangani", "Freizeit", "Kinder"],
  ...
  },
  {
    ...
    description: { de: "Anbaugebiet für Reis zur lokalen Versorgung.", hu: "Rizstermesztő terület a helyi ellátáshoz.", ro: "Regiune de cultivare a orezului pentru aprovizionarea locală.", en: "Cultivation area for rice for local supply." },
    facts: {
      de: ["Reis", "Landwirtschaft", "Grundnahrungsmittel", "Feld"],
  ...
  },
  {
    ...
    description: { de: "Ein schöner Ort für Kinder in Bukavu.", hu: "Szép hely gyerekeknek Bukavuban.", ro: "Un loc frumos pentru copii în Bukavu.", en: "A nice place for kids in Bukavu." },
    facts: {
      de: ["Bukavu", "Spielplatz", "Familien", "Freizeit"],
  ...
  },
  {
    ...
    description: { de: "Landwirtschaftliche Fläche für Maniokanbau.", hu: "Mezőgazdasági terület maniókatermesztéshez.", ro: "Zonă agricolă pentru cultivarea maniocului.", en: "Agricultural area for cassava cultivation." },
    facts: {
      de: ["Maniok", "Landwirtschaft", "Nahrung", "Feld"],
  ...
  },
  {
    ...
    description: { de: "Teeanbau in den Hochlandregionen.", hu: "Teatermesztés a felföldi régiókban.", ro: "Cultivarea ceaiului în regiunile de podiș.", en: "Tea cultivation in the highland regions." },
    facts: {
      de: ["Tee", "Landwirtschaft", "Bergland", "Export"],
  ...
  },
  {
    ...
    description: { de: "Ein kleiner Park für Familien in Matadi.", hu: "Kis park családoknak Matadiban.", ro: "Un parc mic pentru familii în Matadi.", en: "A small park for families in Matadi." },
    facts: {
      de: ["Matadi", "Spielplatz", "Freizeit", "Kinder"],
  ...
  },
  {
    ...
    description: { de: "Anbau von Ananas für den lokalen Markt.", hu: "Ananásztermesztés a helyi piacra.", ro: "Cultivarea ananasului pentru piața locală.", en: "Cultivation of pineapples for the local market." },
    facts: {
      de: ["Ananas", "Landwirtschaft", "Tropenfrucht", "Markt"],
  ...
  },
  {
    ...
    description: { de: "Ein kleiner Freizeitort in Mbandaka.", hu: "Kis szabadidős helyszín Mbandakában.", ro: "Un mic loc de recreere în Mbandaka.", en: "A small recreational place in Mbandaka." },
    facts: {
      de: ["Mbandaka", "Spielplatz", "Freizeit", "Kinder"],
  ...
  },
  {
    ...
    description: { de: "Landwirtschaftliche Anbaufläche für Mais.", hu: "Mezőgazdasági művelésű kukoricaföld.", ro: "Teren agricol pentru cultivarea porumbului.", en: "Agricultural field for corn cultivation." },
    facts: {
      de: ["Mais", "Landwirtschaft", "Nahrung", "Feld"],
  ...
  },
  {
    ...
    description: { de: "Anbau von Kautschukbäumen zur Kautschukgewinnung.", hu: "Gumifák termesztése kaucsuk kinyerésére.", ro: "Cultivarea arborilor de cauciuc pentru producția de cauciuc.", en: "Cultivation of rubber trees for rubber production." },
    facts: {
      de: ["Kautschuk", "Gummi", "Landwirtschaft", "Industrie"],
  ...
  },
  {
    ...
    description: { de: "Ein Freizeitort für Kinder in Kolwezi.", hu: "Szabadidős helyszín gyerekeknek Kolweziben.", ro: "Un loc de recreere pentru copii în Kolwezi.", en: "A recreational place for kids in Kolwezi." },
    facts: {
      de: ["Kolwezi", "Spielplatz", "Freizeit", "Kinder"],
