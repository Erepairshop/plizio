...
export const poiExtraGambiaNatureV2: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Kiang West Nationalpark ist das größte und ökologisch vielfältigste Schutzgebiet in Gambia und erstreckt sich über 11.000 Hektar in der Lower River Region. Der Park weist einen beeindruckenden Übergang von Landschaften auf, von dichten, undurchdringlichen Mangrovenbächen entlang des Flussufers bis hin zu trockener, weitläufiger Guinea-Savanne und Laterit-Böschungen im Landesinneren. Er ist ein entscheidendes Refugium für westafrikanische Wildtiere und beherbergt seltene Arten wie Sitatunga, Buschböcke und eine sich erholende Population von Hyänen und Leoparden. Aufgrund seiner abgelegenen Lage und seiner riesigen Größe bleibt er für den Massentourismus weitgehend unerschlossen und bietet engagierten Naturforschern und Forschern ein wirklich wildes, raues Erlebnis. (Naturwissenschaften K7 – Biodiversität und Savannenökosysteme)",
      hu: "Gambia egyik legnagyobb és legfontosabb vadrezervátuma, rendkívül gazdag növény- és állatvilággal. Több mint 11 000 hektár. Számos ragadozómadár-faj. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Das größte geschützte Wildreservat in Gambia mit über 11.000 Hektar.", "Befindet sich im abgelegenen Distrikt Kiang West in der Lower River Region.", "Weist sehr vielfältige Ökosysteme auf, von Flussmangroven bis zu trockener Savanne.", "Ein entscheidendes Refugium für seltene Säugetiere wie Sitatunga, Hyänen und Leoparden.", "Bleibt rau, wild und für den kommerziellen Massentourismus weitgehend unerschlossen.", "Ein erstklassiger Ort für engagierte ökologische Forschung und ernsthafte Naturforscher."],
      hu: ["Gambia egyik legnagyobb és legfontosabb vadrezervátuma, rendkívül gazdag növény- és állatvilággal.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Bao Bolong Wetland Reserve ist ein riesiges, international anerkanntes Ramsar-Schutzgebiet am Nordufer des Gambia-Flusses, direkt gegenüber dem Kiang West Nationalpark. Auf über 22.000 Hektar besteht es aus einem riesigen, komplexen Netzwerk von Gezeitenbächen (Bolongs), weitläufigen Salzwiesen und saisonalen Süßwassersümpfen. Das Reservat ist ein absolut entscheidendes Refugium für Zugvögel auf dem Ostatlantischen Vogelzugweg und beherbergt in den Wintermonaten Zehntausende von Wasservögeln. Die dichten Mangrovenwälder dienen auch als lebenswichtige Aufzuchtgebiete für Meeresfische und bieten den umliegenden lokalen Gemeinschaften eine nachhaltige Quelle für Austern und Holz. (Naturwissenschaften K8 – Ramsar-Feuchtgebiete und Zugvogelrouten)",
      hu: "Hatalmas mocsárvidék a Gambia-folyó északi partján, amely a madármegfigyelők paradicsoma. Ramsari terület. Fontos mangroveerdők. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein riesiges 22.000 Hektar großes Reservat, das als internationales Ramsar-Feuchtgebiet anerkannt ist.", "Befindet sich am Nordufer des Flusses, gegenüber dem Kiang West Nationalpark.", "Besteht aus einem komplexen Netzwerk von Gezeitenbächen, Salzwiesen und Mangrovenwäldern.", "Ein kritisch wichtiger Überwinterungsort für Zugvögel auf dem ostatlantischen Vogelzugweg.", "Die Mangroven dienen als wesentliche Brutstätten für das regionale Meeresleben.", "Bringt strengen ökologischen Schutz mit nachhaltiger lokaler Nahrungssuche in Einklang."],
      hu: ["Hatalmas mocsárvidék a Gambia-folyó északi partján, amely a madármegfigyelők paradicsoma.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Tanji Vogelschutzgebiet, offiziell der Karinti Tanji Nationalpark, ist ein kompaktes, aber unglaublich reiches Küstenreservat südlich der Haupttouristengebiete. Es umfasst Sandstrände, Küstenlagunen und dichten Buschwald und schützt ein sehr dynamisches Übergangsökosystem. Das Reservat ist ein Paradies für Ornithologen und beherbergt über 300 erfasste Vogelarten, was es zu einem der am dichtesten besiedelten Vogelhabitate in Westafrika macht. Die vorgelagerten Bijol-Inseln, die innerhalb der Grenzen des Reservats liegen, dienen als entscheidende, ungestörte Brutgebiete für Meeresschildkröten und riesige Kolonien von Raubseeschwalben, die stark vor menschlichen Eingriffen geschützt sind. (Naturwissenschaften K6 – Küstenlagunen und Vogelbiodiversität)",
      hu: "Parti védett terület, amely különféle élőhelyeket, például dűnéket, lagúnákat és száraz erdőket foglal magában. Több mint 300 madárfaj. Közvetlenül az Atlanti-parton. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein sehr zugängliches Küstenreservat südlich der städtischen Haupttouristenzonen.", "Umfasst vielfältige Lebensräume wie Sandstrände, Lagunen und Buschland.", "International bekannt bei Ornithologen mit über 300 erfassten Vogelarten.", "Umfasst die vorgelagerten Bijol-Inseln, ein wichtiges Brutgebiet für Raubseeschwalben.", "Bietet lebenswichtige, geschützte Niststrände für gefährdete Meeresschildkröten.", "Ein Paradebeispiel für reiche Biodiversität am Rande der Zersiedelung."],
      hu: ["Parti védett terület, amely különféle élőhelyeket, például dűnéket, lagúnákat és száraz erdőket foglal magában.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Bijilo Forest Park, liebevoll 'Monkey Park' genannt, ist ein kleines, sehr beliebtes Reservat, das auf den Küstenklippen direkt neben dem belebten Senegambia-Touristenstreifen liegt. Er stellt eines der allerletzten überlebenden Flecken einheimischen Küstengaleriewaldes in der Region dar. Der Park ist durch hoch aufragende Rhun-Palmen und dichtes, schattiges Unterholz gekennzeichnet. Er ist vor allem für seine großen, sehr an den Menschen gewöhnten Trupps von Grünen Meerkatzen und Westlichen Roten Colobus-Affen bekannt, die frei mit den Besuchern auf den deutlich markierten Wanderwegen interagieren. Trotz seiner geringen Größe bietet er eine entscheidende, zugängliche grüne Lunge für die stark bebaute Küste. (Geographie K6 – städtische Waldreservate und Primatengewöhnung)",
      hu: "Kicsi tengerparti erdőpark, amelyet gyakran 'Majomparknak' is neveznek a benne élő számos majom miatt. Népszerű a turisták körében. Sűrű pálmaerdők. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein kleines, stark besuchtes Waldreservat neben dem Senegambia-Touristenstreifen.", "Schützt einen seltenen, überlebenden Flecken einheimischen Küstengalerie- und Palmenwaldes.", "Weithin als 'Monkey Park' bekannt wegen seiner großen Primatenpopulationen.", "Heimat von sehr an den Menschen gewöhnten Trupps von Grünen Meerkatzen und Westlichen Roten Colobus-Affen.", "Verfügt über gut gepflegte, schattige Wanderwege zu Aussichtspunkten auf den Klippen.", "Dient als entscheidende, zugängliche 'grüne Lunge' inmitten intensiver städtischer Küstenentwicklung."],
      hu: ["Kicsi tengerparti erdőpark, amelyet gyakran 'Majomparknak' is neveznek a benne élő számos majom miatt.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Abuko-Naturschutzgebiet ist das älteste geschützte Wildtiergebiet in Gambia und wurde 1968 offiziell eingerichtet. Trotz seiner relativ geringen Größe von etwas mehr als 100 Hektar ist es einer der artenreichsten Orte des Landes. Das Reservat umfasst ein entscheidendes Wassereinzugsgebiet, das einen seltenen Abschnitt dichten, immergrünen Galeriewaldes unterstützt, ein starker Kontrast zur umgebenden trockenen Savanne. Abuko ist bekannt für seine Primatenpopulationen, darunter Rote Colobus- und Callithrix-Affen, sowie eine unglaubliche Vielfalt an Vogelarten und eine kleine Population von Nilkrokodilen. Es dient als wichtige, zugängliche Bildungsressource für lokale Schulen und als erstklassiges Einführungserlebnis in die Tierwelt für internationale Touristen. (Naturwissenschaften K6 – Galeriewälder und städtische Naturschutzgebiete)",
      hu: "Gambia első természetvédelmi területe, amely az állatok lenyűgöző változatosságának ad otthont egy védett erdőben. 1968-ban alapították. Krokodilmedence is található itt. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Das erste offiziell geschützte Wildreservat in Gambia, gegründet 1968.", "Umfasst etwas mehr als 100 Hektar, weist aber eine bemerkenswert hohe Biodiversität auf.", "Schützt ein lebenswichtiges Wassereinzugsgebiet und ein seltenes immergrünes Galeriewald-Ökosystem.", "Bekannt für leicht zugängliche Sichtungen von Roten Colobus- und Callithrix-Affen.", "Dient als primäres Umweltbildungszentrum für lokale gambische Schulen.", "Ein sehr beliebtes, leicht zugängliches Ökotourismus-Ziel in der Nähe der Hauptstadt."],
      hu: ["Gambia első természetvédelmi területe, amely az állatok lenyűgöző változatosságának ad otthont egy védett erdőben.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Insel Janjanbureh, historisch bekannt als MacCarthy Island, ist eine bedeutende Flusslandmasse tief in der Central River Region. Mit einer Länge von etwa 10 Kilometern teilt sie den massiven Gambia-Fluss in zwei getrennte Kanäle. Die Insel ist durch eine Mischung aus historischen kolonialen Siedlungen, kleinen Erdnussfarmen und dichten, verworrenen Flusswäldern an ihren Ufern gekennzeichnet. Sie dient als entscheidender Ausgangspunkt für Ökotouristen, die weiter flussaufwärts zu den Baboon Islands fahren. Die umliegenden Gewässer sind reich an Flusspferden und westafrikanischen Manatis, was die Insel zu einem wesentlichen geografischen und ökologischen Zentrum für die mittleren Flussabschnitte macht. (Geographie K6 – Flussinseln und Binnenökologie)",
      hu: "Sziget a Gambia-folyón, amely történelmi jelentőségéről és természeti szépségéről ismert. Korábban MacCarthy-sziget. A folyó öleli körül. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Eine große Flussinsel in der Mitte des Gambia-Flusses.", "Historisch als MacCarthy Island während der Kolonialzeit bezeichnet.", "Teilt den Hauptlauf des Gambia-Flusses in zwei getrennte schiffbare Kanäle.", "Weist eine Mischung aus historischen städtischen Siedlungen, Landwirtschaft und Flusswald auf.", "Dient als primärer Ausgangspunkt für den Ökotourismus ins tiefe Landesinnere.", "Die umliegenden Flusskanäle sind von Flusspferden und westafrikanischen Manatis bevölkert."],
      hu: ["Sziget a Gambia-folyón, amely történelmi jelentőségéről és természeti szépségéről ismert.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Kunta Kinteh Island, früher bekannt als James Island, ist eine winzige, aber zutiefst bedeutsame Landmasse in der Mitte der breiten Mündung des Gambia-Flusses. Kaum 3 Kilometer vom Nordufer entfernt, erodiert die Insel langsam durch raue Gezeitenströmungen und den steigenden Meeresspiegel. Trotz ihrer geringen Größe ist sie stark mit den Ruinen einer Kolonialfestung befestigt, die während des Höhepunkts des transatlantischen Sklavenhandels mehrmals zwischen den Briten, Franzosen und Niederländern den Besitzer wechselte. Als UNESCO-Weltkulturerbe ausgewiesen, wirkt ihre fragile, erodierende Ökologie als ergreifende Metapher für die verblassende, traumatische Geschichte, die sie repräsentiert. (Geschichte K8 – Kolonialfestungen und der transatlantische Sklavenhandel)",
      hu: "Kicsi sziget a folyón, amely a rabszolga-kereskedelemben betöltött szerepe miatt az UNESCO Világörökség része. UNESCO Világörökség. Korábban James-sziget. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Eine winzige, historisch bedeutsame Insel in der Mündung des Gambia-Flusses.", "Früher als James Island bekannt, bevor sie zu Ehren von Kunta Kinte umbenannt wurde.", "Zeigt die stark verfallenen Überreste einer umkämpften Sklavenfestung aus der Kolonialzeit.", "Leidet derzeit unter schwerer Küstenerosion und steigendem Mündungswasserstand.", "Ein zentraler Bestandteil eines großen senegambischen UNESCO-Weltkulturerbes.", "Ein kraftvolles, wenn auch physisch fragiles Denkmal für den transatlantischen Sklavenhandel."],
      hu: ["Kicsi sziget a folyón, amely a rabszolga-kereskedelemben betöltött szerepe miatt az UNESCO Világörökség része.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Baboon Islands bilden den undurchdringlichen Kern des River Gambia Nationalparks. Dieser dichte Archipel aus fünf stark bewaldeten Inseln liegt im Süßwasserabschnitt des zentralen Flusses. Sie sind weltweit bekannt als Standort des Schimpansen-Rehabilitationsprojekts, einer wegweisenden Naturschutzmaßnahme, die verwaiste Schimpansen erfolgreich in eine wilde, raubtierfreie Umgebung einführte. Da Schimpansen nicht schwimmen können, fungiert der Fluss als natürliche Einzäunung. Um den Schutz der Primaten und des unberührten Galeriewaldes zu gewährleisten, ist es Menschen strengstens verboten, die Inseln zu betreten; alle Beobachtungen müssen von Booten aus erfolgen, die die umliegenden Kanäle befahren. (Naturwissenschaften K8 – Primatenschutz und strenge Reservate)",
      hu: "Szigetcsoport, ahol a csimpánzokat természetes környezetükben lehet megfigyelni. A belépés tilos. Egy nemzeti park része. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein Archipel aus fünf dicht bewaldeten Inseln in der Central River Region.", "Bildet den streng geschützten Kern des River Gambia Nationalparks.", "Weltweit bekannt für das sehr erfolgreiche Schimpansen-Rehabilitationsprojekt.", "Die umliegenden tiefen Flussgewässer dienen als natürliche Einzäunung für die Primaten.", "Menschlicher Zutritt ist strengstens verboten, um das fragile Ökosystem zu schützen.", "Besucher können die Tierwelt nur von autorisierten Booten in den Kanälen aus beobachten."],
      hu: ["Szigetcsoport, ahol a csimpánzokat természetes környezetükben lehet megfigyelni.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Jinack Island ist eine atemberaubende, niedrig gelegene Barriereinsel am äußersten nördlichen Rand der Mündung des Gambia-Flusses, an der Grenze zum Senegal. Als entscheidender Teil des Niumi-Nationalparks ist sie vom Festland durch einen schmalen, dichten Mangrovenbach getrennt. Die Insel weist unglaublich vielfältige Mikroökosysteme auf, darunter unberührte, verlassene Sandstrände am Atlantik, weitläufige Salinen und Küstenbuschland. Jinack ist ein weltweit anerkanntes Paradies für Vogelbeobachter und dient als lebenswichtiges Nistgebiet für gefährdete grüne Meeresschildkröten. Ihre extreme Isolation, die nur mit kleinen Booten erreichbar ist, bewahrt eine einzigartig wilde und unberührte Küstenumgebung. (Geographie K7 – Barriereinseln und Küstenbiodiversität)",
      hu: "Békés sziget a Gambia-folyó torkolatánál, érintetlen strandokkal és mangrovékkal. Madárparadicsom. Szenegállal határos. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal. A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.",
    ...
    factsAdvanced: {
      de: ["Eine niedrig gelegene Barriereinsel am nördlichen Mündungsrand des Flusses.", "Bildet einen lebenswichtigen, stark geschützten Bestandteil des Niumi-Nationalparks.", "Vom gambischen Festland durch dichte, gewundene Mangrovenbäche getrennt.", "Weist unberührte Atlantikstrände, weitläufige Salinen und Küstenbuschland auf.", "Ein international anerkanntes Paradies für Zugvögel und nistende Meeresschildkröten.", "Nur mit kleinen Booten erreichbar, was eine wilde, unberührte Atmosphäre bewahrt."],
      hu: ["Békés sziget a Gambia-folyó torkolatánál, érintetlen strandokkal és mangrovékkal.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "St. Mary's Island ist die sehr strategische Landmasse, auf der die Hauptstadt Banjul erbaut ist. An der Mündung des Gambia-Flusses gelegen, ist sie im Wesentlichen eine große Sandbank, die in den letzten zwei Jahrhunderten ausgiebig stabilisiert und urbanisiert wurde. Die Insel ist geografisch durch ihre prekäre Beziehung zum Wasser definiert; sie liegt an den tiefen, turbulenten Strömungen des Atlantischen Ozeans und der Flussmündung auf der einen Seite und dem weitläufigen, überschwemmungsgefährdeten Tanbi-Feuchtgebietskomplex auf der anderen. Die geringe Höhe der Insel macht sie sehr anfällig für den Anstieg des Meeresspiegels und extreme saisonale Überschwemmungen, was ständige infrastrukturelle Herausforderungen für die Hauptstadt schafft. (Geographie K7 – städtische Inseln und Anfälligkeit für den Meeresspiegelanstieg)",
      hu: "A Gambia-folyó torkolatánál fekvő sziget, amelyen a főváros, Banjul található. Banjul helyszíne. Homokpadok és mocsarak. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Die strategische Insellandmasse, auf der sich die Hauptstadt Banjul befindet.", "Genau dort gelegen, wo die Mündung des Gambia-Flusses auf den Atlantischen Ozean trifft.", "Ursprünglich eine große Sandbank, die ausgiebig urbanisiert und stabilisiert wurde.", "An der Landseite vom weitläufigen Tanbi-Feuchtgebietskomplex begrenzt.", "Gekennzeichnet durch extrem geringe Höhe, was sie sehr anfällig für Überschwemmungen macht.", "Stellt bedeutende, andauernde städtebauliche und entwässerungstechnische Herausforderungen dar."],
      hu: ["A Gambia-folyó torkolatánál fekvő sziget, amelyen a főváros, Banjul található.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Kartong Beach ist der südlichste Küstenabschnitt in Gambia, der abrupt dort endet, wo die Mündung des Allahein-Flusses die Grenze zum Senegal bildet. Im Gegensatz zu den stark entwickelten Touristenstränden im Norden ist Kartong Beach wild, breit und weitgehend verlassen. Er zeichnet sich durch seine dynamischen, sich verlagernden Sandbänke aus, wo der Fluss auf den Ozean trifft und eine nährstoffreiche Umgebung schafft, die immense Schwärme von Seevögeln und Watvögeln anzieht. Der Strand ist ein Schwerpunkt für Ökotourismus und nachhaltige Praktiken, frei von großen Resorts, und bekannt für seine spektakulären Sonnenuntergänge und seine ruhige, unberührte natürliche Schönheit. (Geographie K6 – wilde Küstenlinien und Mündungsgrenzen)",
      hu: "Csendes és elszigetelt strand Gambia legdélebbi részén, a szenegáli határ közelében. Legdélibb pont. Nagyon természetközeli. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Der absolut südlichste Abschnitt der Atlantikküste in Gambia.", "Endet an der Mündung des Allahein-Flusses, der die Grenze zum Senegal bildet.", "Gekennzeichnet durch eine wilde, unentwickelte und weitgehend verlassene Landschaft.", "Weist dynamische, sich verlagernde Sandbänke auf, die durch das Zusammentreffen von Fluss und Ozean entstehen.", "Ein erstklassiger Ort für sanften Ökotourismus und intensive Vogelbeobachtung.", "Bewahrt eine ruhige Atmosphäre, weit entfernt von den nördlichen Resort-Zentren."],
      hu: ["Csendes és elszigetelt strand Gambia legdélebbi részén, a szenegáli határ közelében.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Sanyang Beach, weithin bekannt als Paradise Beach, ist einer der berühmtesten und visuell beeindruckendsten Abschnitte der gambischen Küste. Im Bezirk Kombo South gelegen, bietet er strahlend weißen Sand, der von einem dichten Saum schwankender Kokospalmen gesäumt wird. Der Strand ist bemerkenswert breit und relativ flach, was ihn ideal für die massiven täglichen Anlandungen traditioneller handwerklicher Fischerpirogen macht. Während das nördliche Ende von dieser intensiven, rauchigen Fischereiindustrie dominiert wird, beherbergen die südlichen Abschnitte eine wachsende Anzahl von Öko-Lodges und Strandbars und bieten einen perfekten, belebten Querschnitt des gambischen Küstenlebens und der natürlichen Schönheit. (Geographie K6 – Küstenwirtschaft und tropische Strände)",
      hu: "Gambia egyik legszebb strandjaként ismert, aranyló homokkal és tiszta vízzel várja a látogatókat. Híres haléttermek. Magas pálmafák. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Lokal und international weithin als 'Paradise Beach' bekannt.", "Bietet ausgedehnten, strahlend weißen Sand, gesäumt von dichten Kokospalmenhainen.", "Der nördliche Abschnitt beherbergt eine intensive, massive traditionelle Fischereiindustrie.", "Der südliche Abschnitt wird zunehmend beliebter für Öko-Lodges und Strandbars.", "Bietet eine dynamische Mischung aus roher Meeresindustrie und entspannendem tropischem Tourismus.", "Gilt als einer der visuell spektakulärsten Abschnitte der nationalen Küste."],
      hu: ["Gambia egyik legszebb strandjaként ismert, aranyló homokkal és tiszta vízzel várja a látogatókat.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Kotu Beach ist ein erstklassiger, stark entwickelter Küstenabschnitt im Herzen der nationalen Tourismuszone. Im Gegensatz zu den wilden Stränden im Süden wird Kotu sorgfältig gepflegt und bietet breiten, goldenen Sand, der sanft in die Atlantikbrandung abfällt. Er wird von einer durchgehenden Reihe großer Luxusresorthotels und einem beliebten Küstengolfplatz gesäumt. Das natürliche Highlight des Strandes ist die Mündung des Kotu-Bachs, der durch den Sand schneidet, um ins Meer zu münden, und direkt neben den Sonnenliegen ein kleines, aber lebendiges Feuchtgebiet-Habitat schafft, das von Vogelbeobachtern stark frequentiert wird. (Geographie K6 – Resort-Küstenlinien und Küstenbäche)",
      hu: "Népszerű tengerparti szakasz számos szállodával, amely kiváló lehetőségeket kínál madármegfigyelésre is. Nyüzsgő turistaközpont. Széles homokos part. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein stark entwickelter, erstklassiger Touristenstrand in der Region Kombo.", "Gekennzeichnet durch sorgfältig gepflegten, breiten goldenen Sand.", "Gesäumt von einem durchgehenden Streifen großer Luxusresorts und einem prominenten Golfplatz.", "Weist die Mündung des Kotu-Bachs auf, die ein einzigartiges Küstenfeuchtgebiet schafft.", "Das Bachgebiet ist ein wichtiger, sehr zugänglicher Hotspot für städtische Vogelbeobachtung.", "Stellt den Kern des traditionellen 'Sonne und Sand'-Tourismuspakets von Gambia dar."],
      hu: ["Népszerű tengerparti szakasz számos szállodával, amely kiváló lehetőségeket kínál madármegfigyelésre is.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Kololi Beach grenzt an den berühmten Senegambia Strip und ist damit der am stärksten genutzte und kommerziell intensivste Sandabschnitt in Gambia. Der Strand hier ist dynamisch; er hat in der Vergangenheit unter schwerer Küstenerosion gelitten, was massive, nationale Ingenieurprojekte zur Folge hatte, um Sand zurück an die Küste zu pumpen und die millionenschwere Hotelinfrastruktur zu schützen, die gefährlich nahe an der Hochwasserlinie liegt. Trotz der Erosionsprobleme bleibt er das energetische Herz der Tourismusindustrie, vollgepackt mit Wassersport, Strandverkäufern und Touristen. Er bietet eine eindringliche Lektion über den komplexen, teuren Kampf zwischen Küstenimmobilienentwicklung und natürlichen ozeanischen Kräften. (Naturwissenschaften K8 – Küstenerosion und Meerestechnik)",
      hu: "Gambia turizmusának központja, élénk éjszakai élettel és széles tengerparttal. A Bijilo Park közelében. Számos szabadidős lehetőség. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Der kommerziell intensivste und am stärksten genutzte Strand in Gambia.", "Direkt neben dem belebten Senegambia-Touristenstreifen gelegen.", "Historisch von schweren, bedrohlichen Raten der Küstenerosion geplagt.", "War Gegenstand massiver, teurer nationaler Sandpump-Ingenieurprojekte.", "Der Strand dient als primärer Spielplatz für die angrenzenden Luxusresorts.", "Hebt den andauernden infrastrukturellen Kampf gegen den Anstieg des Meeresspiegels und der Gezeiten hervor."],
      hu: ["Gambia turizmusának központja, élénk éjszakai élettel és széles tengerparttal.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Cape Point, an der äußersten Nordspitze der Bakau-Küste gelegen, ist ein dramatisches geografisches Merkmal, wo der Atlantische Ozean physisch auf die Mündung des Gambia-Flusses trifft. Die Küste geht hier scharf von Sandstränden zu schroffen, roten Lateritklippen über, die steil ins turbulente Wasser abfallen. Diese Klippen bieten weite, erhöhte Ausblicke über die breite Mündung nach Barra am Nordufer. Die einzigartige Hydrodynamik des Punktes, wo ozeanische Dünung auf ausgehende Flussströmungen trifft, schafft eine nährstoffreiche Meeresumwelt, die von lokalen Leinenfischern und einer vielfältigen Auswahl an Seevögeln stark bevorzugt wird. (Geographie K7 – Küstenklippen und Mündungshydrodynamik)",
      hu: "Jellegzetes pont a parton, ahol a Gambia-folyó és az Atlanti-óceán találkozik. Szép kilátópontok. Népszerű horgászhely. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["An der äußersten Nordspitze des Küstenbezirks Bakau gelegen.", "Markiert den genauen geografischen Punkt, an dem der Atlantik auf die Flussmündung trifft.", "Gekennzeichnet durch schroffe, auffällige rote Lateritklippen, die ins Wasser abfallen.", "Bietet weite, erhöhte Ausblicke über die massive Mündung in Richtung Barra.", "Die aufeinanderprallenden Ozean- und Flussströmungen schaffen eine turbulente, nährstoffreiche Meereszone.", "Ein sehr beliebter Ort für lokale Leinenfischer und Mündungsvogelbeobachtung."],
      hu: ["Jellegzetes pont a parton, ahol a Gambia-folyó és az Atlanti-óceán találkozik.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Brufut Woods ist ein relativ kleiner, aber absolut entscheidender, von der Gemeinde geschützter Wald, der etwas landeinwärts von der Küste von Brufut liegt. Im Gegensatz zu den von der Regierung geführten Nationalparks wird dieses Waldgebiet von lokalen Umweltgruppen und Vogelbeobachtungsvereinen vehement geschützt. Es dient als lebenswichtiges Refugium für Vogelarten, die auf dichte Guinea-Savannen- und Waldlebensräume angewiesen sind, die aufgrund der umgebenden Zersiedelung rapide verschwinden. Die Wälder sind bei internationalen Vogelbeobachtern besonders berühmt als einer der zuverlässigsten Orte in Westafrika, um schwer fassbare Arten wie den Verreaux-Uhu und den Langschwanz-Nachtschwalbe zu beobachten, und bieten ruhige, schattige Wanderwege. (Naturwissenschaften K7 – Gemeinschaftsschutz und Waldvögel)",
      hu: "Fontos erdőterület a madárvédelem szempontjából, amely számos ritka fajnak ad otthont. Vezetett madárlesek. Sűrű száraz erdő. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein sehr bedeutendes, von der Gemeinde geschütztes Waldgebiet etwas landeinwärts von Brufut.", "Von lokalen Umweltgruppen vehement gegen städtische Eingriffe verteidigt.", "Schützt einen lebenswichtigen, schrumpfenden Flecken authentischen Guinea-Savannen- und Waldlebensraums.", "International bekannt als erstklassiges Ziel für spezialisierte Vogelbeobachtung.", "Ein sehr zuverlässiger Ort zur Beobachtung seltener Arten wie dem Verreaux-Uhu.", "Bietet ruhige, gut gepflegte schattige Wanderwege für Ökotouristen."],
      hu: ["Fontos erdőterület a madárvédelem szempontjából, amely számos ritka fajnak ad otthont.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Pirang Forest im Bezirk Kombo East ist ein kleiner, aber unglaublich dichter Flecken ausgereiften Galeriewaldes, ein seltenes Ökosystem in einer von trockener Savanne und Landwirtschaft dominierten Region. Dieser Wald ist durch hoch aufragende einheimische Bäume gekennzeichnet, die ein dichtes, dunkles Kronendach bilden, das das ganze Jahr über Feuchtigkeit speichert. Er wird von Ökologen und Ornithologen als isolierte 'Insel' der Biodiversität hoch geschätzt und beherbergt Primatentrupps und seltene waldbewohnende Vogelarten wie den Grünen Turako. Historisch für nachhaltige traditionelle Medizin und Nahrungssuche genutzt, steht er heute als geschützter Ökotourismus-Standort, der die üppige, alte Umgebung demonstriert, die einst einen Großteil des Flussbeckens bedeckte. (Naturwissenschaften K6 – Galeriewälder und Kronendach-Ökosysteme)",
      hu: "Egy trópusi esőerdő maradványa, amely egyedülálló növény- és állatvilágot kínál. Ritka fafajok. Madarakban gazdag terület. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein kleiner, unglaublich dichter Flecken ausgereiften Galeriewaldes im Bezirk Kombo East.", "Gekennzeichnet durch ein hoch aufragendes, dunkles Kronendach, das ganzjährig Feuchtigkeit speichert.", "Stellt ein seltenes, überlebendes Beispiel des alten Waldökosystems der Region dar.", "Eine isolierte 'Insel' der Biodiversität, die Primaten und seltene Waldvögel beherbergt.", "Historisch von Einheimischen für nachhaltige Nahrungssuche und traditionelle Medizin genutzt.", "Heute stark als spezialisierter Ökotourismus- und ökologischer Studienstandort geschützt."],
      hu: ["Egy trópusi esőerdő maradványa, amely egyedülálló növény- és állatvilágot kínál.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Niumi-Nationalpark nimmt die äußerste nordwestliche Küstenecke von Gambia ein und bildet eine zusammenhängende grenzüberschreitende ökologische Zone mit dem senegalesischen Nationalpark Delta du Saloum. Auf einer Fläche von rund 5.000 Hektar ist der Park ein komplexes Mosaik verschiedener Ökosysteme, darunter unberührte Atlantikstrände, weitläufige Salinen, dichte Mangrovenbäche und trockenes Küstenbuschland. Diese immense Umweltvielfalt macht ihn zu einem der wichtigsten Ramsar-Feuchtgebiete in Westafrika. Er dient als massives Überwinterungsgebiet für europäische Zugvögel und als lebenswichtiges Brutgebiet für gefährdete Meeresarten wie die Grüne Meeresschildkröte und den Westafrikanischen Manati. (Naturwissenschaften K8 – Ramsar-Feuchtgebiete und grenzüberschreitender Schutz)",
      hu: "Az északi parton fekvő park mangrovékat, mocsarakat és homokdűnéket foglal magában. Határokon átnyúló. Fontos ökoszisztéma. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Ein massiver 5.000 Hektar großer Nationalpark in der äußersten nordwestlichen Küstenregion.", "Bildet ein zusammenhängendes, grenzüberschreitendes ökologisches Reservat mit dem benachbarten Senegal.", "Weist ein vielfältiges Mosaik aus Atlantikstränden, Salinen und Mangrovenbächen auf.", "Als weltweit bedeutendes Ramsar-Feuchtgebiet für Zugvögel ausgewiesen.", "Ein kritisches Refugium für gefährdete Grüne Meeresschildkröten und Westafrikanische Manatis.", "Bietet eine weitläufige, stark geschützte Wildnis weit entfernt von großen städtischen Zentren."],
      hu: ["Az északi parton fekvő park mangrovékat, mocsarakat és homokdűnéket foglal magában.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Allahein-Fluss, auch als San Pedro River bekannt, ist ein relativ kurzer, aber sehr bedeutender Wasserlauf, der die endgültige südliche Grenze zwischen Gambia und der Casamance-Region des Senegal bildet. Der Fluss schlängelt sich durch dichte, unberührte Mangrovenwälder, bevor er in der Nähe des Dorfes Kartong in den Atlantischen Ozean mündet. Die Mündung ist eine dynamische, nährstoffreiche Umgebung, berühmt für ihre sich verlagernden Sandbänke und riesigen Austernbänke. Sie unterstützt eine blühende traditionelle Wirtschaft; lokale Frauen ernten Austern von den Mangrovenwurzeln, während Männer kleine Fischerpirogen betreiben. Der Fluss ist ein Modell für grenzüberschreitende ökologische Harmonie und nachhaltigen, sanften Ökotourismus. (Geographie K6 – Grenzflüsse und Mündungs-Nahrungssuche)",
      hu: "Kicsi folyó délen, amely a természetes határt alkotja Gambia és Szenegál között. Határfolyó. Madármegfigyelés lehetséges. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Bildet die endgültige südliche Grenze zwischen Gambia und Senegal (Casamance).", "Ein gewundener Wasserlauf, der stark von unberührten, dichten Mangrovenwäldern gesäumt ist.", "Mündet in den Atlantischen Ozean in der Nähe des Ökotourismus-Zentrums von Kartong.", "Die Mündung weist sehr dynamische, sich verlagernde Sandbänke und nährstoffreiche Gewässer auf.", "Unterstützt eine massive traditionelle Wirtschaft, die auf der Ernte von Mangrovenaustern durch Frauen basiert.", "Ein erstklassiger Ort für sanfte Kanusafaris und grenzüberschreitende Vogelbeobachtung."],
      hu: ["Kicsi folyó délen, amely a természetes határt alkotja Gambia és Szenegál között.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Bintang Bolong ist der größte und längste Nebenfluss (Bolong) des Gambia-Flusses und gräbt einen massiven, gewundenen Pfad tief in die Foni-Distrikte am Südufer. Mit einer Länge von über 130 Kilometern sind seine unteren Abschnitte stark salzhaltig und von hoch aufragenden, undurchdringlichen Mangrovenwäldern flankiert, während sich seine oberen Abschnitte in Süßwasser-Ackerlandebenen erstrecken. Der Bolong ist eine absolute Lebensader für das ländliche Binnenland, da er eine wesentliche Bewässerung, eine massive lokale Fischerei und eine lebenswichtige Transportarterie für abgelegene Dörfer bietet. Es ist ein atemberaubendes, weitläufiges Ökosystem, das vom Massentourismus weitgehend unberührt bleibt und durch seine schiere Größe und wilde Natur vehement geschützt wird. (Geographie K7 – Flussnebenflüsse und Mangrovenökologie)",
      hu: "A Gambia-folyó legnagyobb mellékfolyója, amely hatalmas mangrove-tájairól ismert. Nagy mellékfolyó. Ideális csónaktúrákhoz. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal. A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.",
    ...
    factsAdvanced: {
      de: ["Der größte und längste Nebenfluss (Bolong), der in den Gambia-Fluss mündet.", "Erstreckt sich über 130 Kilometer tief in die ländlichen Foni-Distrikte am Südufer.", "Die unteren Abschnitte sind stark salzhaltig und von massiven Mangrovenwäldern flankiert.", "Bietet eine wesentliche Transportarterie und Fischerei für Dutzende von abgelegenen Dörfern.", "Die oberen Abschnitte gehen in kritische Süßwasser-Bewässerungszonen für die Landwirtschaft über.", "Bleibt ein massives, wildes Ökosystem, das vom kommerziellen Tourismus weitgehend unberührt ist."],
      hu: ["A Gambia-folyó legnagyobb mellékfolyója, amely hatalmas mangrove-tájairól ismert.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Tanbi Wetland Complex ist ein weitläufiges, 6.000 Hektar großes Labyrinth aus Mangrovenbächen, Watten und Salzwiesen, das die südlichen und westlichen Flanken der Hauptstadt Banjul vollständig umschließt. Offiziell als Ramsar-Schutzgebiet ausgewiesen, fungiert dieses immense Feuchtgebiet als lebenswichtige 'Lunge und Nieren' des Großraums Banjul. Es filtert auf natürliche Weise städtische Abflüsse, absorbiert massive saisonale Überschwemmungen und schützt die niedrig gelegene Hauptstadt vor katastrophaler Küstenerosion. Über seine infrastrukturelle Bedeutung hinaus ist das Tanbi ein labyrinthartiges Refugium für Hunderte von Vogelarten, Affen und eine immense traditionelle Austernernte-Industrie, auf die Tausende von städtischen Frauen angewiesen sind. (Naturwissenschaften K8 – städtische Feuchtgebiete und ökologische Infrastruktur)",
      hu: "Mangroveerdők és csatornák kiterjedt rendszere a fővárostól délre. Banjul védelme. Osztrigák élőhelye. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal. A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.",
    ...
    factsAdvanced: {
      de: ["Ein massiver 6.000 Hektar großer Mangroven- und Feuchtgebietskomplex, der die Hauptstadt umgibt.", "Offiziell als Feuchtgebiet von internationaler Bedeutung (Ramsar-Schutzgebiet) ausgewiesen.", "Entscheidend für die Aufnahme saisonaler Überschwemmungen und den Schutz von Banjul vor Küstenerosion.", "Wirkt als massiver natürlicher Filter für städtische Abflüsse aus der Metropole Serekunda.", "Unterstützt eine riesige, traditionelle Austernernte-Wirtschaft, die überwiegend von Frauen betrieben wird.", "Ein labyrinthartiges Refugium für Biodiversität, das buchstäblich an die Zersiedelung angrenzt."],
      hu: ["Mangroveerdők és csatornák kiterjedt rendszere a fővárostól délre.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Gunjur Beach ist ein markanter, weitläufiger Abschnitt der südlichen Atlantikküste, bekannt für seine raue, kraftvolle Schönheit und tiefe Verbundenheit mit der Gemeinde. Im Gegensatz zu den gepflegten Touristenstränden wird Gunjur stark von der lokalen Bevölkerung genutzt. Das nördliche Ende wird von einem riesigen, chaotischen traditionellen Fischerhafen verankert, während die südlichen Abschnitte in ruhige, unberührte Sandflächen übergehen, die von Küstenbuschwerk und Dünen gesäumt sind. Der Strand ist ein Schwerpunkt intensiver lokaler Naturschutzbemühungen, die sich besonders auf den Schutz der Nistplätze von Meeresschildkröten vor Wilderern und der schleichenden Bedrohung durch unregulierten Sandabbau konzentrieren. (Geographie K6 – Gemeinschaftsstrände und Küstenschutz)",
      hu: "Hagyományos halászpart színesre festett csónakokkal és nyugodt légkörrel. Aktív halpiac. Hosszú homokos part. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal. A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.",
    ...
    factsAdvanced: {
      de: ["Ein rauer, weitläufiger Abschnitt der südlichen Atlantikküste in der Region Kombo.", "Stark von der lokalen Gemeinde und nicht von internationalen Touristen genutzt.", "Verfügt über einen massiven, chaotischen traditionellen Fischerhafen am nördlichen Ende.", "Die südlichen Abschnitte gehen in ruhige, unberührte Dünen und Küstenbuschland über.", "Ein wichtiger Schwerpunkt für basisdemokratischen Meeresschildkrötenschutz und Strandpatrouillen.", "Hebt die Spannung zwischen lokalen Industrien, Naturschutz und natürlicher Schönheit hervor."],
      hu: ["Hagyományos halászpart színesre festett csónakokkal és nyugodt légkörrel.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Elephant Island ist eine massive, unbewohnte und intensiv wilde Landmasse in der Mitte des Gambia-Flusses, etwa 150 Kilometer flussaufwärts vom Atlantik. Die Insel markiert eine kritische ökologische Übergangszone, in der der Fluss von salzhaltigen Mündungsbedingungen zu vollständig Süßwasser wechselt. Sie ist vollständig mit dichten, undurchdringlichen Mangrovensümpfen und überfluteten Galeriewäldern bedeckt. Obwohl Elefanten in Gambia seit über einem Jahrhundert ausgestorben sind, bleibt die Insel ein beeindruckendes Refugium für große Krokodile, Flusspferde und unzählige Wasservögel. Ihre schiere Dichte und das Fehlen von trockenem Land machen sie zu Fuß völlig unzugänglich und bewahren so ihren urzeitlichen Zustand. (Geographie K7 – Flussübergangszonen und unbewohnte Inseln)",
      hu: "Nagy sziget a Gambia-folyón, amely nevét az elefántra emlékeztető alakjáról kapta. Lakatlan. Sok érintetlen természet. Ezzel a hely Gambia egyik jellegzetes pontja — egy keskeny, Szenegál által körülvett országé a Gambia-folyó mentén, amelyet az atlanti partvidék, Banjul kikötője, a brit gyarmati örökség, valamint a földimogyoró- és halászati gazdaság formált —, és betekintést nyújt a regionális identitásba. A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén. Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.",
    ...
    factsAdvanced: {
      de: ["Eine massive, vollständig unbewohnte wilde Insel, 150 km den Gambia-Fluss hinauf.", "Markiert die kritische ökologische Übergangszone von Salz- zu Süßwasser.", "Vollständig bedeckt von dichten, undurchdringlichen Mangrovensümpfen und überfluteten Wäldern.", "Trotz ihres Namens sind Elefanten in der Region seit über einem Jahrhundert ausgestorben.", "Ein beeindruckendes, stark geschütztes Refugium für Flusspferde, Krokodile und Wasservögel.", "Zu Fuß völlig unzugänglich, was die Erhaltung seines urzeitlichen Ökosystems gewährleistet."],
      hu: ["Nagy sziget a Gambia-folyón, amely nevét az elefántra emlékeztető alakjáról kapta.", "A nyugat-afrikai Gambia területén fekszik, az azonos nevű Gambia-folyó mentén.", "Az ország keskeny enklávé, szinte teljes egészében Szenegál veszi körül, rövid atlanti partszakasszal.", "A régiót trópusi éghajlat jellemzi, határozott esős és száraz évszakkal.", "A fővárosból, Banjulból kiinduló közúthálózaton keresztül érhető el.", "Szerepet játszik a földimogyoró-termesztésre, halászatra és turizmusra épülő gambiai gazdaságban."],
