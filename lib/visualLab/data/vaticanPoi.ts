...
export const vaticanPois: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Vatikanstaat, offiziell Staat der Vatikanstadt genannt, stellt die kleinste anerkannte staatliche Einheit der Welt dar und ist als souveräne Enklave vollständig vom Stadtgebiet Roms umschlossen. Die Entstehung des heutigen Staates geht auf die Lateranverträge von 1929 zurück, die zwischen dem Heiligen Stuhl und dem damaligen Königreich Italien unterzeichnet wurden. Diese Verträge beendeten den langjährigen Konflikt um den Status des Kirchenstaates und sicherten dem Papst die volle Souveränität über ein Territorium von lediglich 0,44 Quadratkilometern zu. Geografisch erstreckt sich das Staatsgebiet über den Vatikanischen Hügel, der westlich des Tibers liegt. Das Herzstück bildet der Petersplatz mit dem Petersdom, einer der größten Sakralbauten der Welt, dessen Bauzeit über 100 Jahre in Anspruch nahm und an dem bedeutende Künstler wie Michelangelo und Bernini mitwirkten. Hinter der Basilika erstrecken sich die Vatikanischen Gärten, die etwa die Hälfte der Staatsfläche einnehmen und eine reiche Flora sowie historische Brunnen beherbergen. Politisch ist der Vatikan eine absolute Wahlmonarchie, wobei der Papst das Oberhaupt der Exekutive, Legislative und Judikative ist. Die Verwaltung wird durch die Kurie und das Staatssekretariat wahrgenommen. Ein markantes Merkmal der inneren Sicherheit ist die Päpstliche Schweizergarde, die seit 1506 für den Schutz des Papstes zuständig ist und für ihre traditionellen Uniformen bekannt ist. Kulturell ist der Vatikan von unschätzbarem Wert; die Vatikanischen Museen beherbergen eine der bedeutendsten Kunstsammlungen weltweit, darunter die Sixtinische Kapelle mit den Fresken Michelangelos. Trotz seiner geringen Größe verfügt der Staat über eine eigene Post, einen Bahnhof, eine Währung und einen Radiosender (Radio Vatikan). Die UNESCO hat den gesamten Staat 1984 zum Weltkulturerbe erklärt, was seine Bedeutung als geistiges und kulturelles Zentrum der katholischen Kirche unterstreicht. Die Wirtschaft basiert primär auf dem Verkauf von Briefmarken, Münzen, touristischen Dienstleistungen und Spenden der Gläubigen weltweit.",
      hu: "Vatikánváros Állam a világ legkisebb területű és népességű független állama, amely Róma városának szívében, egy fallal körülvett enklávéként helyezkedik el. Létrejötte a modern formájában az 1929-es lateráni egyezménynek köszönhető, amely rendezte a Szentszék és az Olasz Királyság közötti évtizedes feszültséget. A mindössze 44 hektáros terület a Vatikán-dombon fekszik, és bár mérete csekély, politikai és vallási súlya világszerte meghatározó. Az állam abszolút teokratikus monarchia, ahol az uralkodó a pápa, akit a bíborosok testülete választ meg életfogytiglanra. A Vatikán saját alkotmánnyal, jogrendszerrel és diplomáciai hálózattal rendelkezik, amely független az olasz államtól. Építészetileg a Szent Péter-bazilika uralja a látképet, amely a kereszténység egyik legszentebb helye, és állítólag Szent Péter apostol sírja fölé épült. A bazilika előtti hatalmas Szent Péter teret Bernini tervezte, és híres monumentális oszlopsorairól, amelyek a látogatókat szimbolikusan átölelik. A Vatikáni Múzeumok a világ egyik leggazdagabb művészeti gyűjteményét őrzik, beleértve a Sixtus-kápolnát, amelynek mennyezetfreskóit Michelangelo festette. Az állam területének jelentős részét a vatikáni kertek teszik ki, amelyek a reneszánsz és barokk kertépítészet remekművei. A Vatikán gazdasága egyedülálló; nincs adózás, a bevételek nagy része a turizmusból, kegytárgyak árusításából, bélyegek és vatikáni euróérmék kibocsátásából, valamint a hívők adományaiból származik. A svájci gárda, amelynek tagjai ma is középkori mintájú egyenruhát viselnek, 1506 óta látja el a pápa személyi védelmét. Az állam saját vasútállomással, helikopter-leszállóval és világszerte sugárzó rádióadóval is rendelkezik. 1984 óta az egész Vatikán az UNESCO Világörökség részét képezi, mint az egyetlen olyan ország, amelynek teljes területe védettség alatt áll. Kultúrtörténeti szempontból a Vatikán a nyugati civilizáció egyik legfontosabb kincstára, ahol a középkori kéziratoktól a modern művészetig minden korszak emlékei megtalálhatóak a Vatikáni Apostoli Könyvtárban és az Archívumban.",
      ro: "Statul Cetății Vaticanului este cel mai mic stat independent din lume, situat ca o enclavă în interiorul orașului Roma, Italia. Suveranitatea sa a fost stabilită oficial prin Tratatul de la Lateran din 11 februarie 1929, punând capăt „chestiunii romane” și recunoscând Sfântul Scaun ca entitate suverană de drept internațional. Teritoriul său se întinde pe doar 44 de hectare, fiind situat pe Colina Vaticanului, pe malul drept al Tibrului. Vaticanul este o monarhie absolută teocratică, condusă de Papă, care exercită puterea legislativă, executivă și judecătorească supremă. Din punct de vedere arhitectural, centrul spiritual este reprezentat de Bazilica Sfântul Petru, una dintre cele mai mari biserici din lume, construită pe locul unde tradiția afirmă că a fost martirizat Sfântul Petru. Interiorul bazilicii și Piața Sfântul Petru sunt capodopere ale Renașterii și Barocului, realizate de maeștri precum Bramante, Michelangelo și Bernini. Muzeele Vaticane găzduiesc colecții de artă de o valoare inestimabilă, acumulate de papi de-a lungul secolelor, punctul culminant fiind Capela Sixtină, celebră pentru frescele lui Michelangelo care înfățișează Creația și Judecata de Apoi. Grădinile Vaticanului ocupă aproximativ jumătate din suprafața statului și oferă un spațiu de liniște și rugăciune, fiind împodobite cu monumente și fântâni istorice. Securitatea statului este asigurată de Garda Elvețiană Pontificală, înființată în 1506, unitatea militară cu cea mai lungă existență continuă din lume. Deși nu are o economie industrială, Vaticanul emite propria monedă euro, are sistem poștal propriu, ziar oficial (L'Osservatore Romano) și un post de radio (Radio Vaticana). Populația este formată aproape exclusiv din clerici și membri ai Gărzii Elvețiene, cetățenia fiind acordată doar pe durata funcției exercitate în stat. Vaticanul este singurul stat din lume inclus în întregime pe lista Patrimoniului Mondial UNESCO. Rolul său diplomatic este imens, Sfântul Scaun menținând relații oficiale cu majoritatea statelor lumii, acționând ca un mediator influent în crizele internaționale și promovând pacea și drepturile omului la nivel global.",
      en: "Vatican City State is the smallest sovereign state in the world, both by area and population, uniquely situated as a walled enclave within the city of Rome, Italy. Established in its current form by the Lateran Treaty in 1929, it serves as the spiritual and administrative headquarters of the Roman Catholic Church. The territory spans approximately 44 hectares (110 acres) on the Vatican Hill, historically separate from the Seven Hills of Rome. As an absolute elective monarchy, the Pope holds supreme authority, elected for life by the College of Cardinals. The state's landscape is dominated by St. Peter's Basilica, a masterpiece of Renaissance architecture that stands over the burial site of Saint Peter. St. Peter's Square, designed by Gian Lorenzo Bernini, is world-renowned for its elliptical shape and massive colonnades that symbolize the open arms of the church. The Vatican Museums contain some of the most important artistic treasures in history, including ancient Roman sculptures and the Sistine Chapel, famous for Michelangelo's ceiling frescoes and 'The Last Judgment'. Beyond the buildings, the Vatican Gardens cover more than half the state, featuring meticulously landscaped lawns, medieval fortifications, and Renaissance fountains. The security of the Pope is the traditional duty of the Pontifical Swiss Guard, established in 1506, whose members are easily identified by their colorful Renaissance-style uniforms. Economically, the Vatican is unique, as it does not tax its inhabitants; revenue is generated through the sale of postage stamps, coins, tourist souvenirs, and museum admission fees, alongside voluntary contributions known as Peter's Pence. The state operates its own banking system, pharmacy, newspaper, and radio station, broadcasting in dozens of languages. It is the only entire state to be designated as a UNESCO World Heritage site, reflecting its immense contribution to global culture, art, and history. The Vatican Apostolic Library and the Secret Archives house one of the world's most significant collections of historical documents and manuscripts, attracting scholars from across the globe.",
    },
    factsAdvanced: {
      de: ["Fläche: 0,44 Quadratkilometer (kleinster Staat der Welt).", "Gründung: 11. Februar 1929 durch die Lateranverträge.", "Einwohner: Etwa 800 Personen, meist Geistliche und Gardisten.", "UNESCO-Status: Einziger Staat, der komplett als Welterbe gelistet ist.", "Währung: Der Staat nutzt den Euro mit eigenen Prägungen.", "Amtssprachen: Latein (für offizielle Dokumente) und Italienisch.", "Sicherheit: Die Schweizergarde besteht aus 135 Soldaten.", "Eisenbahn: Besitzt das kürzeste nationale Schienennetz der Welt (ca. 300 m)."],
      hu: ["Terület: 0,44 km2, ezzel a világ legkisebb független állama.", "Alapítás: 1929. február 11., a lateráni egyezmény aláírásával.", "Népesség: Kb. 800 fő, a vatikáni állampolgárság funkcióhoz kötött.", "Vallás: A római katolikus egyház központja és a pápa székhelye.", "UNESCO: Az egyetlen állam, amely teljes egészében világörökség.", "Művészet: A Vatikáni Múzeumok hossza meghaladja a 14 kilométert.", "Védelem: A Svájci Gárda tagjai csak svájci, katolikus nőtlen férfiak lehetnek.", "Pénznem: Saját euróérméket bocsát ki, amelyek ritka gyűjtői darabok."],
      ro: ["Suprafață: 0,44 km pătrați, fiind cel mai mic stat suveran.", "Tratatul de la Lateran: Semnat în 1929 între Sfântul Scaun și Italia.", "Populație: Aproximativ 800 de locuitori, în principal clerici.", "Grădinile Vaticanului: Ocupă 23 de hectare din suprafața totală.", "Garda Elvețiană: Înființată în 1506 de către Papa Iuliu al II-lea.", "Patrimoniu UNESCO: Înscris integral pe listă din anul 1984.", "Calea ferată: Are o stație proprie conectată la rețeaua feroviară italiană.", "Instituții: Deține propria bancă, numită Institutul pentru Lucrările Religioase."],
      en: ["Area: 44 hectares (0.17 sq miles), the smallest in the world.", "Sovereignty: Recognized as a state by Italy on February 11, 1929.", "Government: The world's only remaining absolute elective monarchy.", "Guard: The Swiss Guard has protected the Pope since January 1506.", "UNESCO: Designated as a World Heritage Site in 1984.", "Currency: Although not in the EU, it uses the Euro by agreement.", "Official Languages: Italian is the administrative language, Latin is used for law.", "Museums: House over 70,000 works of art in 54 galleries."],
    },
  },
  {
