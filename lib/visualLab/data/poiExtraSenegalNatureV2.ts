...
export const poiExtraSenegalNatureV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      de: "Der Senegal-Fluss prägt den Norden des Landes als Grenzfluss zu Mauretanien und als Lebensader zwischen Sahel und Atlantik. Aus dem Fouta-Djallon-Gebiet kommend, sammelt er auf seinem langen Weg Wasser, Menschen und Handelsrouten und erreicht bei Saint-Louis das Meer. Am Fluss hängen Bewässerungsprojekte, Fischerei und die Feuchtgebiete des Djoudj eng zusammen. Die OMVS koordiniert viele Eingriffe, darunter Diama und Manantali, damit Landwirtschaft, Energie und Wasserhaushalt im Gleichgewicht bleiben. Für das Plizio-Geografie K7 verbindet der Fluss Relief, Klima und Nutzung zu einem einzigen Lernraum.",
      ...
      en: "The Senegal River forms the natural border between Senegal and Mauritania. Length approx. 1080 km. Important water source for agriculture. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Grenzfluss zu Mauretanien", "Quelle im Fouta Djallon in Guinea", "Mündung bei Saint-Louis in den Atlantik", "OMVS koordiniert die Wasserwirtschaft", "Diama bremst den Salzeintrag", "Manantali reguliert Abfluss und Energie", "Djoudj liegt am Delta", "Bewässerungszonen prägen Richard Toll"],
  ...
  },
  {
    ...
    description: { de: "Ein durch Mikroorganismen pink gefärbter Salzsee nahe Dakar.", hu: "A mikroorganizmusok által rózsaszínre festett sós tó Dakar közelében.", ro: "Un lac sărat colorat în roz de microorganisme, aproape de Dakar.", en: "A salt lake colored pink by microorganisms, near Dakar." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Lac Rose, auch Retba genannt, liegt nur wenige Kilometer nordöstlich von Dakar und ist vor allem durch seine rosa Färbung bekannt. Diese entsteht, wenn Mikroorganismen wie Dunaliella salina im sehr salzhaltigen Wasser Pigmente bilden, besonders in der Trockenzeit. Neben dem Farbspiel ist der See ein Arbeitsraum: Salz wird seit Jahrzehnten traditionell gewonnen, und die Ufer sind von Lasten, Piroggen und Sammelstellen geprägt. Dazwischen stehen Dünen, Atlantikwind und die Erinnerung an die Dakar-Rallye, die hier lange ihr Ziel hatte. Geografie und Biologie lassen sich hier direkt am Wasser lesen.",
      ...
      en: "A salt lake colored pink by microorganisms, near Dakar. Very high salinity. Known for the Dakar Rally. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Liegt nahe Dakar an der Petite Côte", "Die Farbe stammt von Dunaliella salina", "Der Salzgehalt ist extrem hoch", "Traditionelle Salzgewinnung prägt das Ufer", "Früheres Ziel der Rallye Dakar", "Von Dünen und Atlantik getrennt", "In der Trockenzeit ist die Färbung am stärksten"],
      ...
      en: ["A salt lake colored pink by microorganisms, near Dakar.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein weitläufiges Schutzgebiet mit Galeriewäldern und Savannen.", hu: "Kiterjedt védett terület galériaerdőkkel és szavannákkal.", ro: "O zonă protejată vastă cu păduri galerii și savane.", en: "A vast protected area with gallery forests and savannas." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Niokolo-Koba-Nationalpark ist Senegals großes Wildnisreservat im Südosten und eines der letzten weiträumigen Schutzgebiete Westafrikas. Zwischen Savanne, Galeriewäldern und Flusstälern des Gambia entsteht hier ein Mosaik aus Lebensräumen, das Elefanten, Löwen, Leoparden und zahlreiche Vogelarten trägt. Der Park ist UNESCO-Welterbe und bietet mit dem Mount Assirik sogar einen markanten Höhenpunkt in einer sonst flacheren Region. Wer in der Trockenzeit unterwegs ist, erlebt offene Sichtachsen und konzentrierte Tierbeobachtung; in der Regenzeit wirkt alles dichter, grüner und schwer zugänglich. Für Plizio-Geografie K7 ist das ein Schlüsselraum für Schutz und Biodiversität.",
      ...
      en: "A vast protected area with gallery forests and savannas. UNESCO World Heritage site. Home to lions and elephants. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["UNESCO-Welterbe seit 1981", "Fläche von rund 9.130 Quadratkilometern", "Im Südosten Senegals am Gambia-Fluss", "Mount Assirik ist der höchste Punkt im Park", "Mehr als 330 Vogelarten wurden registriert", "Elefanten, Löwen und Leoparden leben hier", "Die Trockenzeit ist die beste Beobachtungszeit"],
      ...
      en: ["A vast protected area with gallery forests and savannas.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein komplexes Mangroven-Ökosystem an der Mündung des Saloum.", hu: "Komplex mangrove ökoszisztéma a Saloum torkolatánál.", ro: "Un ecosistem complex de mangrove la vărsarea râului Saloum.", en: "A complex mangrove ecosystem at the mouth of the Saloum." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Das Saloum-Delta ist ein weit verzweigter Küstenraum, in dem sich Flussarme, Mangroven, Salzwiesen und Inseln gegenseitig durchdringen. An den Mündungen von Sine und Saloum bildet sich ein System aus Kanälen und Lagunen, das sowohl ökologisch als auch kulturell eng mit den Küstengemeinden verbunden ist. Das Gebiet ist als Biosphärenreservat geschützt und bekannt für seine Muschelhügel, die von jahrtausendelanger Nutzung erzählen. Piroggen, Fischfang und Salzpflanzen gehören ebenso zum Bild wie stille Wasserläufe und Vogelkolonien. Für Plizio-Geografie K7 zeigt das Delta, wie Gezeiten und menschliche Nutzung eine Landschaft gemeinsam formen.",
      ...
      en: "A complex mangrove ecosystem at the mouth of the Saloum. Biosphere reserve. Rich in bird species. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Biosphärenreservat im Südwesten Senegals", "Rund 180.000 Hektar groß", "Mündungen von Sine und Saloum", "Mangroven prägen den Landschaftsraum", "Muschelhügel belegen lange Besiedlung", "Piroggen sind das wichtigste Verkehrsmittel", "Fischerei und Sammelwirtschaft sind zentral"],
      ...
      en: ["A complex mangrove ecosystem at the mouth of the Saloum.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Eine kleine Insel vor der Küste Dakars mit maritimer Vegetation.", hu: "Egy kis sziget Dakar partjainál, tengeri vegetációval.", ro: "O insulă mică în largul coastei Dakar, cu vegetație maritimă.", en: "A small island off the coast of Dakar, with maritime vegetation." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Gorée ist eine kleine Vulkaninsel vor Dakar, deren Natur vor allem durch Basalt, Wind und Meer bestimmt wird. Das Eiland liegt nur wenige Kilometer vor der Küste, ist autofrei und deshalb erstaunlich ruhig, obwohl es so nah an der Hauptstadt liegt. Zwischen schmalen Gassen wachsen Bougainvillea, Palmen und andere tropische Pflanzen, während die Küste aus Fels, Brandung und kleinen Buchten besteht. Der Castel-Hügel öffnet den Blick über den Atlantik und macht sofort klar, wie kompakt diese Insel ist. Für Sachkunde K3 ist Gorée ein gutes Beispiel für Mikroklima und Schutzraum im städtischen Umfeld.",
      ...
      en: "A small island off the coast of Dakar, with maritime vegetation. UNESCO World Heritage site. Small rocky island. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Vulkanische Insel vor Dakar", "Etwa 3 Kilometer vom Festland entfernt", "Die Insel ist autofrei", "Die Fläche liegt bei rund 28 Hektar", "Basalt bestimmt den Untergrund", "Der Castel-Hügel ist der höchste Punkt", "Das Mikroklima ist milder als in Dakar"],
      ...
      en: ["A small island off the coast of Dakar, with maritime vegetation.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein bedeutender Fluss im Süden Senegals mit ausgedehnten Mangrovenwäldern.", hu: "Jelentős folyó Szenegál déli részén, kiterjedt mangroveerdőkkel.", ro: "Un râu important în sudul Senegalului cu păduri extinse de mangrove.", en: "A significant river in southern Senegal with extensive mangrove forests." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Casamance-Fluss ist die grüne Lebensader des Südens und begleitet eine der feuchtesten Regionen Senegals auf ihrem Weg zum Atlantik. Sein Mündungsraum ist von Mangroven, Lagunen und den typischen Bolongs durchzogen, also von schmalen Wasserarmen, die tief in die Vegetation hineinreichen. Entlang des Flusses liegen Reisfelder, Dörfer und wichtige Verbindungen nach Ziguinchor; Piroggen sind hier kein touristisches Bild, sondern Alltag. Die Uferzonen sind zugleich Lebensraum für Vögel, Krokodile und andere Wasserbewohner. Plizio-Geografie K7 kann hier Wasser, Landwirtschaft und Mobilität in einer einzigen Flusslandschaft zeigen.",
      ...
      en: "A significant river in southern Senegal with extensive mangrove forests. Flows through Casamance region. Important transport route. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Fluss im Süden Senegals", "Entwässert die Region Casamance", "Mündungsraum mit Mangroven und Bolongs", "Ziguinchor liegt am Flusssystem", "Reisanbau nutzt die Uferzonen", "Piroggen sind ein zentrales Verkehrsmittel", "Der Fluss verbindet Küstendörfer und Inseln"],
      ...
      en: ["A significant river in southern Senegal with extensive mangrove forests.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein wichtiges Feuchtgebiet mit einem großen See und Marschland.", hu: "Fontos vizes élőhely egy nagy tóval és mocsárvidékkel.", ro: "O zonă umedă importantă cu un lac mare și mlaștini.", en: "An important wetland with a large lake and marshlands." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Das Djoudj-Vogelreservat liegt im Senegal-Delta und gehört zu den wichtigsten Feuchtgebieten Afrikas. Nach der Saharaüberquerung finden Zugvögel hier den ersten großen Rast- und Futterplatz mit Süßwasser, Schilf und flachen Lagunen. Pelikane, Flamingos, Reiher und viele weitere Arten machen das Gebiet in der Saison zu einem der eindrucksvollsten Vogelräume des Kontinents. Die Wasserführung wird durch den Diama-Damm stabilisiert, damit Salzwasser nicht zu weit vordringt. Das Reservat steht unter UNESCO- und Ramsar-Schutz und eignet sich hervorragend für Geografie K7 mit Schwerpunkt Feuchtgebiete und Migration.",
      ...
      en: "An important wetland with a large lake and marshlands. UNESCO World Heritage site. Home to millions of migratory birds. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["UNESCO-Welterbe seit 1981", "Ramsar-Feuchtgebiet von internationaler Bedeutung", "Mehr als 3 Millionen Zugvögel pro Jahr", "Etwa 16.000 Hektar groß", "Diama hält Salz aus dem System fern", "Pelikane und Flamingos sind besonders bekannt", "Beste Besuchszeit ist November bis April"],
      ...
      en: ["An important wetland with a large lake and marshlands.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein Teil des Gambia-Flusses, der durch den Südosten des Senegals fließt.", hu: "A Gambia folyó egy része, amely Szenegál délkeleti részén folyik át.", ro: "O parte a fluviului Gambia care traversează sud-estul Senegalului.", en: "A part of the Gambia River that flows through southeastern Senegal." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der senegalesische Abschnitt des Gambia-Flusses ist ein wilder Grenz- und Naturkorridor im Südosten des Landes. Zwischen Kédougou und Tambacounda schneidet sich der Fluss durch Felslandschaften, bevor er das breitere Tiefland erreicht. Galerie­wälder rahmen das Wasser ein und geben Hippos, Krokodilen und einer großen Zahl von Vögeln Raum. Ein Teil des Niokolo-Koba-Systems liegt direkt an diesem Flussabschnitt, deshalb wirkt die Landschaft hier besonders geschlossen und ungestört. Für Plizio-Geografie K7 zeigt der Abschnitt, wie ein Fluss einen ganzen Naturraum ordnen kann.",
      ...
      en: "A part of the Gambia River that flows through southeastern Senegal. Originates in Fouta Djallon. Habitat for hippos. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Quelle im Fouta Djallon", "Gesamtlänge des Gambia-Flusses rund 1.120 Kilometer", "Senegalesischer Abschnitt in Kédougou und Tambacounda", "Teile des Niokolo-Koba liegen am Fluss", "Hippos leben in diesem System", "Krokodile sind hier häufig", "Galeriewälder säumen die Ufer"],
      ...
      en: ["A part of the Gambia River that flows through southeastern Senegal.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Lac de Guiers ist Senegals wichtigster Süßwasserspeicher und für die Wasserversorgung der Hauptstadt unverzichtbar. Das flache Gewässer liegt im Norden des Landes und ist über den Taouey-Kanal mit dem Senegal-Flusssystem verbunden. Über ein langes Leitungsnetz gelangt ein erheblicher Teil des Trinkwassers nach Dakar, während am Ufer Zuckerrohr, Gemüse und andere Kulturen von der Nähe zum Wasser profitieren. Der See ist zugleich ein bedeutender Lebensraum für Wasservögel und andere Arten der Feuchtzone. Für Plizio-Geografie K7 ist er ein gutes Beispiel für Versorgung, Landwirtschaft und ökologische Abhängigkeit.",
      ...
      en: "The largest freshwater lake in Senegal, important for drinking water supply. Supplies Dakar with water. Low salinity. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Größter Süßwassersee Senegals", "Mit dem Senegal-Flusssystem verbunden", "Der Taouey-Kanal speist den See", "Richard Toll nutzt das Wasser für Zuckerrohr", "Der See ist sehr flach", "Zahlreiche Wasservögel nutzen das Ufer"],
      ...
      en: ["The largest freshwater lake in Senegal, important for drinking water supply.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Der westlichste Punkt des afrikanischen Festlandes am Atlantik.", hu: "Az afrikai kontinens legnyugatibb pontja az Atlanti-óceánnál.", ro: "Cel mai vestic punct al continentului african la Oceanul Atlantic.", en: "The westernmost point of the African mainland on the Atlantic." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die Pointe des Almadies markiert den äußersten Westen des afrikanischen Festlands und liegt auf der Cap-Vert-Halbinsel in Dakar. Der Ort ist kein klassischer Strand, sondern eine schroffe Küste aus dunklem Vulkangestein, die den Atlantik direkt aufnimmt. Brandung, Wind und salzige Luft bestimmen das Bild; deshalb ist der Raum für Küstenprozesse und Erosion besonders aufschlussreich. Zugleich gehört er zum urbanen Alltagsraum der Hauptstadt, wo Spaziergänge, Surfen und der Blick auf den offenen Ozean eng zusammengehören. Für Geografie K7 ist das ein klarer Marker für Randlage und Meereskontakt.",
      ...
      en: "The westernmost point of the African mainland on the Atlantic. Atlantic coast. Rocky headland. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Westlichster Punkt des afrikanischen Festlands", "Liegt in Dakar auf der Cap-Vert-Halbinsel", "Die Küste besteht aus dunklem Vulkangestein", "Atlantische Brandung prägt den Ort", "Beliebter Raum für Surfen und Küstenbeobachtung", "Markiert die extreme Randlage des Kontinents"],
      ...
      en: ["The westernmost point of the African mainland on the Atlantic.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Dichte Waldgebiete in der Region Casamance, geprägt durch tropisches Klima.", hu: "Sűrű erdőségek Casamance régióban, trópusi klímával.", ro: "Zone forestiere dense în regiunea Casamance, caracterizate de un climat tropical.", en: "Dense forest areas in the Casamance region, characterized by a tropical climate." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Das Casamance-Massiv ist eine grüne Hügellandschaft im äußersten Süden Senegals und hebt sich deutlich von den trockeneren Teilen des Landes ab. Sanfte Rücken, kleine Täler und dichterer Bewuchs schaffen dort ein Relief, das in der Regenzeit schnell auflebt und in der Trockenzeit dennoch Wasser speichert. Die Nähe zu Guinea-Bissau und Guinea macht das Gebiet zu einem Übergangsraum zwischen Küstenwelt und feuchterer Guineazone. Genau dieser Wechsel von Lage, Klima und Form erklärt, warum hier andere Pflanzen und Nutzungen dominieren als im Norden. Für Plizio-Geografie K7 ist es ein Reliefbeispiel mit klarer ökologischer Wirkung.",
      ...
      en: "Dense forest areas in the Casamance region, characterized by a tropical climate. High biodiversity. Tropical rainforest. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Landschaft im Süden Senegals", "Übergang zu Guinea und Guinea-Bissau", "Deutlich grüner als der Norden", "Sanfte Hügelformen statt Ebenen", "Feuchte Bedingungen begünstigen Waldreste", "Regenzeit verändert das Bild stark", "Ein klassischer Übergangsraum zwischen Zonen"],
      ...
      en: ["Dense forest areas in the Casamance region, characterized by a tropical climate.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein kleiner Nationalpark aus vulkanischen Felsen vor der Küste von Dakar.", hu: "Vulkáni sziklákból álló kis nemzeti park Dakar partjainál.", ro: "Un mic parc național format din roci vulcanice în largul coastei Dakar.", en: "A small national park made of volcanic rocks off the coast of Dakar." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die Madeleine-Inseln liegen wenige Kilometer westlich von Dakar und bilden ein kleines, unbewohntes Vulkanarchipel im Atlantik. Der Raum ist rau, kompakt und stark vom Meer geformt: Basalt, Steilkanten und Seevögel bestimmen den Eindruck stärker als Strände oder Siedlungen. Als Nationalpark stehen die Inseln unter Schutz, weil sie Brut- und Rastplatz für Küstenvögel sind und zugleich ein seltenes Beispiel für marine Vulkanlandschaft bieten. Wer vom Festland herübersieht, erkennt sofort, wie eng Natur und Schutzpolitik hier verbunden sind. Für Sachkunde K3 ist das ein guter Zugang zu Küstenökologie und Inselräumen.",
      ...
      en: "A small national park made of volcanic rocks off the coast of Dakar. Uninhabited. Bird sanctuary. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Kleines Vulkanarchipel westlich von Dakar", "Der Nationalpark schützt den Meeresraum", "Basalt und Steilkanten prägen die Inseln", "Die größte Insel ist Sarpan", "Seevögel nutzen den Raum als Brutplatz", "Etwa 4 Kilometer vor der Küste gelegen"],
      ...
      en: ["A small national park made of volcanic rocks off the coast of Dakar.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein wichtiges Waldgebiet nahe Dakar, wichtig zur Erholung.", hu: "Fontos erdőterület Dakar közelében, fontos a kikapcsolódáshoz.", ro: "O zonă forestieră importantă aproape de Dakar, importantă pentru recreere.", en: "An important forest area near Dakar, important for recreation." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Mbao-Wald ist Dakars wichtigste grüne Pufferzone am Rand der Cap-Vert-Halbinsel. In einer schnell wachsenden Metropole hält der geschützte Wald Staub, Wind und Hitze ein Stück zurück und verbessert damit spürbar das Mikroklima. Zwischen den Bäumen entstehen Wege für Spaziergänge, kleine Beobachtungsräume und Rückzugsorte für Vögel und andere Tiere. Als klassierter Wald zeigt Mbao, dass Stadtnatur nicht nur schön, sondern auch funktional ist: Sie schützt Luft, Boden und Alltagsqualität. Für Plizio-Sachkunde K3 ist er ein sehr greifbares Beispiel für den Wert urbaner Wälder.",
      ...
      en: "An important forest area near Dakar, important for recreation. Lungs of Dakar. Threatened by urbanization. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Liegt am Stadtrand von Dakar", "Geschützter klassierter Wald", "Mehr als 800 Hektar groß", "Wirkt als grüne Pufferzone", "Verbessert das Mikroklima", "Schützt vor Wind und Staub", "Bietet Lebensraum für Vögel und Kleintiere"],
      ...
      en: ["An important forest area near Dakar, important for recreation.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein bedeutender Nebenfluss des Senegal-Flusses im Osten des Landes.", hu: "A Szenegál folyó jelentős mellékfolyója az ország keleti részén.", ro: "Un afluent important al fluviului Senegal în estul țării.", en: "An important tributary of the Senegal River in the east of the country." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die Falémé ist der östliche Grenzfluss Senegals und zugleich der wichtigste Nebenfluss des Senegal-Flusses. Aus dem Fouta-Djallon kommend, zieht sie entlang der Grenze zu Mali und prägt dort einen Raum aus Galeriewäldern, offenen Savannen und saisonal stark wechselndem Wasserstand. Der Fluss ist für den Osten des Landes wichtig, weil er die Landschaft gliedert, kleine Siedlungen versorgt und ökologisch als Korridor wirkt. Gerade in Grenzräumen zeigt sich an der Falémé, wie sehr Wasser die Nutzung von Land und die Bewegung von Menschen steuert. Für Geografie K7 ist das ein gutes Fluss- und Grenzbeispiel.",
      ...
      en: "An important tributary of the Senegal River in the east of the country. Border river with Mali. Gold deposits in the riverbed. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Wichtigster Nebenfluss des Senegal-Flusses", "Bildet die Grenze zu Mali", "Quelle im Fouta Djallon", "Verläuft durch den Osten Senegals", "Galeriewälder begleiten die Ufer", "Saisonale Wasserführung prägt den Lauf", "Mündet in das Senegal-Flusssystem"],
      ...
      en: ["An important tributary of the Senegal River in the east of the country.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Eine schmale Landzunge zwischen Atlantik und Senegal-Fluss.", hu: "Keskeny földnyelv az Atlanti-óceán és a Szenegál folyó között.", ro: "Un promontoriu îngust între Oceanul Atlantic și fluviul Senegal.", en: "A narrow sandspit between the Atlantic Ocean and the Senegal River." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die Langue de Barbarie ist ein schmaler Sandstreifen südlich von Saint-Louis, der den Senegal-Fluss vom Atlantik trennt. Hier treffen Brandung, Sedimente und Flusswasser direkt aufeinander, weshalb sich die Küstenlinie ständig verändert und der Raum zugleich fragil und dynamisch bleibt. Der Nationalpark schützt diesen schmalen Gürtel aus Dünen, Vogelhabitaten und offenen Wasserflächen. Er ist besonders interessant, weil man an einem einzigen Ort Küstenerosion, Flussmündung und Vogelschutz beobachten kann. Für Plizio-Geografie K7 ist die Langue de Barbarie ein sehr anschauliches Beispiel für Küstenformen und ihre Gefährdung.",
      ...
      en: "A narrow sandspit between the Atlantic Ocean and the Senegal River. Breeding ground for birds. Sandy landscape. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Sandstreifen südlich von Saint-Louis", "Trennt Senegal-Fluss und Atlantik", "Nationalpark mit Schutzfunktion", "Rund 2.000 Hektar groß", "Wichtiger Lebensraum für Vögel", "Die Küste ist erosionsgefährdet", "Dünen prägen den Raum"],
      ...
      en: ["A narrow sandspit between the Atlantic Ocean and the Senegal River.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Die Ausläufer des guineischen Hochlands im Südosten Senegals.", hu: "A guineai felföld nyúlványai Szenegál délkeleti részén.", ro: "Prelungirile podișului guineez în sud-estul Senegalului.", en: "The outliers of the Guinean highlands in southeastern Senegal." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die Ausläufer des Fouta-Djallon bilden im Südosten Senegals die markanteste Berg- und Hügellandschaft des Landes. Rund um Kédougou treten Plateaus, Felsrippen und steilere Hänge hervor, sodass der Wechsel von Ebene zu Relief sofort sichtbar wird. Diese Zone ist nicht nur landschaftlich auffällig, sondern auch hydrologisch wichtig, weil hier die Quellgebiete und Oberläufe mehrerer westafrikanischer Flüsse liegen. Für Senegal ist das ein Raum, der trotz kleiner Fläche enorme Bedeutung für Wasser, Landschaftsform und Grenzlage hat. Plizio-Geografie K7 kann hier Relief als Ursache von Flussbildung zeigen.",
      ...
      en: "The outliers of the Guinean highlands in southeastern Senegal. Hilly landscape. West Africa's water tower. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Im Südosten Senegals bei Kédougou", "Markanteste Berglandschaft des Landes", "Ausläufer des Fouta Djallon", "Sandsteinplateaus und Felsrippen", "Quellräume mehrerer Flüsse", "Übergang zur feuchteren Sudanzone", "Grenzraum zu Guinea"],
      ...
      en: ["The outliers of the Guinean highlands in southeastern Senegal.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein großes Delta-System an der Küste, das von Sine und Saloum gebildet wird.", hu: "Nagy deltarendszer a parton, amelyet a Sine és a Saloum alkot.", ro: "Un sistem mare de deltă pe coastă, format de râurile Sine și Saloum.", en: "A large delta system on the coast formed by the Sine and Saloum rivers." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Das Sine-Saloum-Delta ist ein komplexer Küstenraum aus Gezeitenkanälen, Inseln, Mangroven und Muschelhügeln. Im Gegensatz zu einer geradlinigen Flussmündung wirkt diese Landschaft wie ein organisches Netzwerk, das sich über Jahrhunderte aus Salz, Sediment und menschlicher Nutzung gebildet hat. Die traditionellen Dörfer der Serer und Niominka leben bis heute mit Piroggen, Fischfang und den Rhythmen der Tide. Zugleich ist das Gebiet ein wichtiger Brut- und Rastplatz für Wasservögel und gehört zu den bekanntesten Biosphärenräumen Senegals. Für Plizio-Geografie K7 zeigt es, wie Kultur- und Naturraum ineinandergreifen.",
      ...
      en: "A large delta system on the coast formed by the Sine and Saloum rivers. UNESCO Biosphere Reserve. Mangrove forests. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Biosphärenraum im Südwesten Senegals", "Mündungsraum von Sine und Saloum", "Mangroven und Bolongs bestimmen das Bild", "Muschelhügel sind historisch sehr alt", "Piroggen sind für die Fortbewegung zentral", "Serer und Niominka leben in der Region", "Tiden formen den Landschaftsraum"],
      ...
      en: ["A large delta system on the coast formed by the Sine and Saloum rivers.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Eine trockene Savannenregion in Nord-Zentral-Senegal.", hu: "Száraz szavannarégió Szenegál észak-középső részén.", ro: "O regiune de savană uscată în centrul-nordul Senegalului.", en: "A dry savanna region in north-central Senegal." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die Ferlo-Ebene ist der trockenste große Landschaftsraum im nördlichen Zentrum Senegals. Weite Dornstrauchsavannen, Akazien, Baobabs und saisonale Wasserstellen prägen ein Gebiet, das mehr nach Weidewirtschaft als nach Ackerbau verlangt. Hier folgen Fulɓe-Hirten den Regenzeiten, und die Landschaft zeigt sehr klar, wie Leben im Sahel an Wasser gekoppelt ist. Für Plizio-Geografie ist Ferlo das Gegenbild zu den grünen Südregionen: große Räume, wenig Schatten und ein Klima, das jede Nutzung bestimmt. Genau diese Strenge macht die Ebene so lehrreich.",
      ...
      en: "A dry savanna region in north-central Senegal. Semi-arid climate. Livestock farming area. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Lage im nördlich-zentralen Senegal", "Teil der Sahelzone", "Weidewirtschaft ist hier zentral", "Akazien und Baobabs prägen die Landschaft", "Saisonale Wasserstellen sind entscheidend", "Die Region ist stark semiarid", "Fulɓe-Hirten nutzen transhumante Routen"],
      ...
      en: ["A dry savanna region in north-central Senegal.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein kleinerer See in der Nähe des Senegal-Flusses im Norden.", hu: "Kisebb tó a Szenegál folyó közelében, északon.", ro: "Un lac mai mic în apropierea fluviului Senegal în nord.", en: "A smaller lake near the Senegal River in the north." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Kassack-See gehört zu den kleineren Feuchtgebieten im Norden Senegals, ist dort aber für Natur und Nutzung spürbar wichtig. Als flaches Süßwasserbecken im Senegal-Tal reagiert er stark auf Hochwasser, Bewässerung und Trockenzeiten. Genau diese Wechselwirkung macht ihn für Fische, Wasservögel und lokale Landwirtschaft wertvoll. In einem Raum, in dem Wasser nie selbstverständlich ist, zeigen solche Nebenseen, wie eng Ökologie und Alltag verbunden sind. Für Plizio-Geografie K7 ist Kassack ein gutes Beispiel für ein Feuchtgebiet mit regionaler Versorgungsfunktion.",
      ...
      en: "A smaller lake near the Senegal River in the north. Seasonal lake. Important for local fauna. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Liegt im Senegal-Tal im Norden", "Kleines, aber ökologisch wichtiges Feuchtgebiet", "Süßwasserbecken mit flacher Uferzone", "Reagiert stark auf Hochwasser", "Wichtig für Fische und Wasservögel", "Unterstützt Bewässerung und lokale Nutzung", "Teil des nordsenegalesischen Wassernetzes"],
      ...
      en: ["A smaller lake near the Senegal River in the north.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Der weite Atlantische Ozean vor der Küste des Senegals.", hu: "A hatalmas Atlanti-óceán Szenegál partjainál.", ro: "Vastul Ocean Atlantic în largul coastei Senegalului.", en: "The vast Atlantic Ocean off the coast of Senegal." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die atlantische Küstenzone Senegals erstreckt sich über Hunderte Kilometer und verbindet Dakar, die Grande Côte und Saint-Louis zu einem einzigen maritimen Raum. Kalte Auftriebsströmungen liefern Nährstoffe, deshalb ist die Küste besonders fischreich und für die Fischerei von zentraler Bedeutung. Zwischen Stränden, Dünen, Steilküsten und Flussmündungen entscheidet der Ozean täglich über Erosion, Transport und Nutzung. Zugvögel, Fischerorte und Küstenmärkte gehören genauso dazu wie Wind und Brandung. Für Plizio-Geografie K7 ist das ein klarer Raum, in dem Ozeanographie und Alltag ineinandergreifen.",
      ...
      en: "The vast Atlantic Ocean off the coast of Senegal. Rich fishing grounds. Important ocean currents. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Über 700 Kilometer Atlantikküste", "Upwelling macht die Küste nährstoffreich", "Dakar, Grande Côte und Saint-Louis gehören dazu", "Fischerei ist ein zentraler Wirtschaftszweig", "Erosion verändert ständig die Küstenlinie", "Flussmündungen strukturieren den Raum", "Zugvögel nutzen die Küstenzone"],
      ...
      en: ["The vast Atlantic Ocean off the coast of Senegal.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein fruchtbares Tal entlang des Senegal-Flusses.", hu: "Termékeny völgy a Szenegál folyó mentén.", ro: "O vale fertilă de-a lungul fluviului Senegal.", en: "A fertile valley along the Senegal River." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Das Senegal-Flusstal bildet im Norden des Landes eine fruchtbare Aue, die in starkem Kontrast zur umgebenden Sahelzone steht. Wenn der Fluss anschwillt, lagern sich Nährstoffe ab und schaffen Felder für Reis, Gemüse und Futterpflanzen. Historische Siedlungen, Bewässerungssysteme und alte Herrschaftsräume liegen dicht an diesem grünen Band. Gerade hier sieht man, wie ein Flusstal ganze Wirtschaftsweisen tragen kann, obwohl das Umland trocken bleibt. Für Plizio-Geografie K7 ist das Tal ein Lehrbuchfall für Nutzung, Siedlung und Anpassung an Wasserknappheit.",
      ...
      en: "A fertile valley along the Senegal River. Important for agriculture. Periodic flooding. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Fruchtbare Aue im Norden Senegals", "Entsteht durch jährliche Überschwemmungen", "Reis- und Gemüseanbau sind wichtig", "Kontrast zur trockenen Sahelzone", "Historische Waalo-Räume liegen hier", "Bewässerung prägt die Nutzung", "Das Tal folgt dem Senegal-Fluss"],
      ...
      en: ["A fertile valley along the Senegal River.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein geschütztes Waldgebiet in der Region Thiès.", hu: "Védett erdőterület Thiès régióban.", ro: "O zonă forestieră protejată în regiunea Thiès.", en: "A protected forest area in the Thiès region." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der klassierte Wald von Thiès ist ein geschützter Restraum im Übergang zwischen Stadt, Verkehrsachsen und trockenerem Binnenland. Gerade in einer Region mit wachsendem Siedlungsdruck bekommt ein solcher Wald eine doppelte Funktion: Er schützt Biodiversität und liefert zugleich Schatten, Windschutz und ein Stück lokales Mikroklima. Statt einer großen Wildnis ist er eher eine grüne Insel, die zeigt, wie empfindlich Naturräume im Umfeld von Städten sind. Für Plizio-Sachkunde K3 ist Thiès ein gutes Beispiel dafür, warum selbst kleinere Schutzflächen im Alltag viel bewirken können.",
      ...
      en: "A protected forest area in the Thiès region. Reforestation projects. Typical Sahel vegetation. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Geschützter Wald nahe Thiès", "Klassierter Wald mit Schutzstatus", "Wichtige grüne Insel im Siedlungsraum", "Bietet Windschutz und Schatten", "Hilft dem lokalen Mikroklima", "Biodiversität steht unter Druck", "Relevanz für Stadt- und Randlandschaft"],
      ...
      en: ["A protected forest area in the Thiès region.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein bedeutender Fluss, der durch den Osten und Süden des Senegals fließt.", hu: "Jelentős folyó, amely Szenegál keleti és déli részén folyik át.", ro: "Un râu important care traversează estul și sudul Senegalului.", en: "A major river flowing through eastern and southern Senegal." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Gambia-Fluss ist im Senegal vor allem ein östlicher Naturkorridor: In Kédougou und Tambacounda schneidet er sich durch Felslandschaften, bevor er weiter westlich in das breitere Flusssystem übergeht. In seinem senegalesischen Abschnitt tragen Galeriewälder, Hippos und Krokodile die eigentliche Charakteristik, nicht große Städte. Wer hier unterwegs ist, erlebt Flussgeografie als Mischung aus Grenzraum, Wildnis und traditioneller Nutzung mit Piroggen, Fischerei und Dorfwirtschaft. Genau deshalb ist dieser Abschnitt für Plizio-Geografie K7 so wertvoll.",
      ...
      en: "A major river flowing through eastern and southern Senegal. Navigable. Rich riparian vegetation. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Senegalesischer Abschnitt im Südosten", "Quelle im Fouta Djallon", "Gesamtlänge rund 1.120 Kilometer", "Niokolo-Koba liegt am Fluss", "Hippos und Krokodile kommen vor", "Galeriewälder säumen die Ufer", "Piroggen sind wichtige Alltagsboote"],
      ...
      en: ["A major river flowing through eastern and southern Senegal.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein Waldgebiet in Zentral-Senegal.", hu: "Erdőterület Közép-Szenegálban.", ro: "O zonă forestieră în centrul Senegalului.", en: "A forest area in central Senegal." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die Forêt de Patar ist ein seltener Waldrest in der Region Kaffrine und damit ein wichtiges Gegenbild zur offenen Sahel-Savanne. Akazien, Baobabs und andere hartnäckige Baumarten halten hier eine Landschaft zusammen, die sonst durch Beweidung und Trockenheit schnell ausdünnt. Als klassierter Wald ist Patar ein Rückzugsraum für Vögel, Reptilien und kleine Säuger, aber auch ein Beispiel dafür, wie stark lokale Gemeinden auf Schutz und Nutzung zugleich angewiesen sind. Für Plizio-Geografie K7 lässt sich hier Waldschutz im Trockengebiet sehr gut erklären.",
      ...
      en: "A forest area in central Senegal. Seasonally dry. Home to savanna animals. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Liegt in der Region Kaffrine", "Seltener Waldrest in der Sahelzone", "Akazien und Baobabs prägen den Bestand", "Klassierter Wald mit Schutzstatus", "Wichtig für Vögel und kleine Tiere", "Beweidung und Trockenheit setzen Druck", "Ein Beispiel für Wald im Trockengebiet"],
      ...
      en: ["A forest area in central Senegal.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Ein kleiner Sumpfsee nahe der mauretanischen Grenze.", hu: "Kis mocsaras tó a mauritániai határ közelében.", ro: "Un mic lac mlăștinos aproape de granița cu Mauritania.", en: "A small marshy lake near the Mauritanian border." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Panal-See ist ein saisonales Feuchtgebiet im Ferlo und zeigt, wie eng Wasser, Regenzeit und Weidewirtschaft im Norden Senegals verbunden sind. Sobald die Regenfälle einsetzen, füllt sich die flache Senke mit Wasser, Tiere und Hirten kehren zurück und die Umgebung wird für kurze Zeit zu einem Hotspot für Vögel und Vieh. Danach schrumpft der See wieder auf seine Linien im Sand zusammen. Genau diese Wechselhaftigkeit macht ihn für das Verständnis des Sahel so wichtig. Plizio-Geografie K7 kann hier den Rhythmus des Tropen- und Trockengebiets direkt ablesen.",
      ...
      en: "A small marshy lake near the Mauritanian border. Important bird habitat. Fluctuating water level. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Saisonaler See im Ferlo", "Füllt sich in der Regenzeit", "Wichtige Wasserstelle für Herden", "Zieht Zugvögel an", "Die Uferfläche schwankt stark", "Teil der nordsenegalesischen Sahelräume", "Regenzeit bestimmt die Nutzung"],
      ...
      en: ["A small marshy lake near the Mauritanian border.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Hügellandschaft im Süden, die sich von der Küste ins Inland erstreckt.", hu: "Déli dombvidék, amely a parttól a belsejéig nyúlik.", ro: "Peisaj deluros în sud, care se extinde de la coastă spre interior.", en: "Hilly landscape in the south extending from the coast inland." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die H?gel von Casamance bilden im ?u?ersten S?den Senegals eine weiche, grüne Reliefzone, die sich deutlich von den flachen und trockeneren Landesteilen absetzt. Zwischen Guinea und Guinea-Bissau liegt ein Raum mit mehr Regen, dichterer Vegetation und kleineren T?lern, in denen sich Wasser l?nger h?lt als anderswo. Genau deshalb wirken hier W?lder, Felder und Siedlungen anders organisiert als im Norden. Die Monts de Casamance sind kein Hochgebirge, aber ein wichtiger ?bergangsraum, in dem Relief, Klima und Nutzung sehr eng zusammenhängen. F?r Plizio-Geografie K7 ist das ein klarer Beispielraum f?r feuchte Randlagen.",
      ...
      en: "Hilly landscape in the south extending from the coast inland. Forested slopes. Milder climate than in the north. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Lage im ?u?ersten S?den Senegals", "Grenzraum zu Guinea und Guinea-Bissau", "Grüne H?gellandschaft statt Ebene", "Mehr Niederschlag als im Norden", "Kleine T?ler speichern Wasser l?nger", "?bergang zwischen Küsten- und Guinearäumen", "Relief beeinflusst Siedlungen und Felder"],
      ...
      en: ["Hilly landscape in the south extending from the coast inland.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Waldgebiet rund um die Stadt Tambacounda.", hu: "Erdőterület Tambacounda város körül.", ro: "Zonă forestieră în jurul orașului Tambacounda.", en: "Forest area around the city of Tambacounda." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die For?t de Tambacounda steht f?r den großen Wald- und Savannenraum im Osten Senegals, wo sich trockene und etwas feuchtere Zonen ?berlappen. Zwischen Baobabs, Akazien und offenen Lichtungen liegt eine Landschaft, die nicht dicht besiedelt ist und deshalb noch viel von ihrem ursprünglichen Charakter behalten hat. Als ?bergangsraum zwischen Sahel und Sudan-Zone ist der Wald ?kologisch wertvoll, weil er Wildtieren, V?geln und den Wegen der Hirten Platz bietet. Gleichzeitig zeigt er, wie stark Feuer, Weide und Jahreszeiten diese Räume formen. F?r Plizio-Geografie K7 ist das ein gutes Beispiel f?r Schutz und Nutzung im Osten des Landes.",
      ...
      en: "Forest area around the city of Tambacounda. Dry forest. Part of Niokolo-Koba ecosystem. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Liegt im Osten Senegals bei Tambacounda", "?bergang zwischen Sahel und Sudan-Zone", "Baobabs und Akazien prägen den Bestand", "Relativ d?nn besiedelter Naturraum", "Wichtig f?r V?gel und Wildtiere", "Weide und Feuer beeinflussen die Vegetation", "Teil einer ?kologischen Korridorzone"],
      ...
      en: ["Forest area around the city of Tambacounda.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Das Mündungsgebiet des Senegal-Flusses in den Atlantik.", hu: "A Szenegál folyó torkolata az Atlanti-óceánba.", ro: "Zona de vărsare a fluviului Senegal în Oceanul Atlantic.", en: "The mouth of the Senegal River into the Atlantic Ocean." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Das Senegal-Delta am Nordrand des Landes ist der Raum, in dem der Fluss, die Lagunen und der Atlantik direkt aufeinandertreffen. Nahe Saint-Louis verzweigt sich das Wasser in S??- und Brackzonen, w?hrend D?nen, Schilfflächen und offene Ufer das Bild bestimmen. Dieses M?ndungsgebiet ist f?r V?gel, Fische und Küstennutzung gleicherma?en wichtig und verbindet den Flusslauf mit dem maritimen Raum. Die N?he zu Djoudj und zur Langue de Barbarie macht das Delta zu einem Kernst?ck der nordsenegalesischen Feuchtgebiete. F?r Plizio-Geografie K7 ist es ein Musterfall f?r Flussm?ndung und Küsten?kologie.",
      ...
      en: "The mouth of the Senegal River into the Atlantic Ocean. Great biodiversity. Sandbars. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["M?ndungsraum des Senegal-Flusses", "Liegt nahe Saint-Louis", "S??- und Brackwasser treffen aufeinander", "D?nen und Lagunen prägen das Delta", "Wichtiger Raum f?r Zugv?gel", "Verkn?pft Fluss und Atlantikküste", "Djoudj und Langue de Barbarie liegen in Reichweite"],
      ...
      en: ["The mouth of the Senegal River into the Atlantic Ocean.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Grünflächen im urbanen Raum von Dakar.", hu: "Zöldterületek Dakar városi térségében.", ro: "Spații verzi în zona urbană a Dakar-ului.", en: "Green spaces in the urban area of Dakar." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Der Wald von Dakar ist als grüner G?rtel am Rand der Hauptstadt zu verstehen und damit ein Gegenbild zur dichten Bebauung der Metropole. In einem Raum mit viel Verkehr, Hitze und Flächenverbrauch wirken die geschützten B?ume als Puffer gegen Staub und Wind und verbessern das Mikroklima spürbar. Die N?he zum Stadtgebiet macht den Wald zugleich zu einem Alltagsraum f?r Spazierg?nge, Beobachtung und kurze Naturpausen. Unter dem Namen Mbao wird dieser Bestand oft mitgedacht, aber als Dakar-Waldg?rtel steht er vor allem f?r die ?kologische Grenze der Stadt. F?r Sachkunde K3 ist das ein sehr anschauliches Stadtnatur-Beispiel.",
      ...
      en: "Green spaces in the urban area of Dakar. Important for microclimate. Urban park-like. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Grüner G?rtel am Rand von Dakar", "Klassierter Schutzwald", "Verbessert das Mikroklima der Hauptstadt", "Schützt vor Staub und Wind", "Wichtige Barriere gegen städtischen Druck", "Mbao wird häufig mit dem Wald verbunden", "Erholungsraum f?r Anwohner"],
      ...
      en: ["Green spaces in the urban area of Dakar.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  },
  {
    ...
    description: { de: "Lange Sandstrände und Bänke entlang der Nordküste.", hu: "Hosszú homokos strandok és padok az északi parton.", ro: "Plaje lungi cu nisip și bancuri de-a lungul coastei de nord.", en: "Long sandy beaches and sandbanks along the north coast." },
    facts: {
    ...
    descriptionAdvanced: {
      de: "Die küstennahe Sandzone Senegals, oft als Grande Cște wahrgenommen, zieht sich zwischen Dakar und Saint-Louis als langer Streifen aus D?nen, Strandw?llen und beweglichem Sand. Der Wind verschiebt hier st?ndig Material, w?hrend hinter den D?nen die Niayes als feuchte Senken und Gartenräume liegen. Diese Nachbarschaft aus trockener Küste und fruchtbaren Einschnitten erklärt, warum Siedlungen, Landwirtschaft und Verkehrsachsen hier so dicht aufeinander reagieren. Die Zone ist auch f?r Küstenschutz, Fischerd?rfer und Vogelzug wichtig. F?r Plizio-Geografie K7 zeigt sie, wie Sand, Wind und Wasser den Norden der Atlantikküste ordnen.",
      ...
      en: "Long sandy beaches and sandbanks along the north coast. Tide-dependent. Important for sea turtles. Thus, the site is among the characteristic points of Senegal and offers insight into the regional identity. Located in the West African state of Senegal. The region is marked by a tropical-dry climate. Accessible via the national road network. Plays a role in the local economy and culture. Representative of the diversity of the Senegalese landscape. An important element of Senegalese heritage."
    },
    factsAdvanced: {
      de: ["Liegt zwischen Dakar und Saint-Louis", "Die Grande Cște gehört dazu", "D?nen und Strandw?lle prägen den Raum", "Niayes liegen als feuchte Senken dahinter", "Wind verlagert st?ndig Sand", "Küstenorte und Landwirtschaft reagieren auf das Relief", "Wichtiger Raum f?r Küstenschutz und Vogelzug"],
      ...
      en: ["Long sandy beaches and sandbanks along the north coast.", "Located in the West African state of Senegal.", "The region is marked by a tropical-dry climate.", "Accessible via the national road network.", "Plays a role in the local economy and culture.", "Representative of the diversity of the Senegalese landscape."]
    }
  }
];
