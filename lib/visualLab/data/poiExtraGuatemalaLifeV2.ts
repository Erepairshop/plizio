...
export const poiExtraGuatemalaLifeV2: POI[] = [
    ...
    factsAdvanced: { de: ["Über 10 verschiedene Kolibriarten können an den Futterstationen des Reservats gesichtet werden.", "Die Wanderung zum Gipfel des Hügels bietet einen der besten Fotopunkte für Antigua.", "Das Reservat ist ein wichtiger Teil des biologischen Korridors um die Vulkane.", "Die Kaffeeproduktion auf der Finca folgt ökologischen und nachhaltigen Prinzipien."], hu: [], ro: [], en: [] }, image: "/poi-images/gt-finca-el-pilar-life-v2.webp"},
  {
    ...
    descriptionAdvanced: { de: "Das ChocoMuseo in Antigua ist ein interaktives Zentrum, das sich der Geschichte, dem Anbau und der Verarbeitung von Kakao in Guatemala widmet. Guatemala gilt als eine der Wiegen der Schokolade, und das Museum vermittelt dieses Erbe auf spielerische und genussvolle Weise. Besucher können an Workshops teilnehmen, in denen sie von der Bohne bis zur fertigen Tafel ihre eigene Schokolade herstellen und dabei traditionelle Maya-Methoden kennenlernen. Das Museum bietet zudem Verkostungen verschiedener Kakaoprodukte an, von heißer Schokolade nach alten Rezepten bis hin zu modernen Kreationen. Es ist ein beliebter Anlaufpunkt für Familien und Schokoladenliebhaber, die mehr über die Bedeutung des 'Speise der Götter' in der guatemaltekischen Kultur erfahren möchten.", hu: "", ro: "", en: "" },
