...
export const poiExtraDrcongoHistoryV2: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Nyangwe war im späten 19. Jahrhundert einer der wichtigsten swahili-arabischen Handelsorte am Lualaba und damit ein Schl?sselpunkt der Flussrouten im Osten des Kongo. Hier trafen Elfenbeinhandel, regionale Macht und die Spannung zwischen lokalen Herrschaften und ausw?rtigen H?ndlern aufeinander. Der Ort ist f?r den Geschichtsunterricht n?tzlich, weil er zeigt, wie weit die Handelsnetze reichten und wie schnell ein Flussknoten politisch bedeutsam werden konnte. Die Verbindung zu David Livingstone macht Nyangwe zus?tzlich zu einem klassischen Kontaktpunkt zwischen afrikanischer und europäischer Erkundungsgeschichte.",
    ...
    factsAdvanced: {
      de: ["Handelsstadt am Lualaba im 19. Jahrhundert", "wichtiger swahili-arabischer St?tzpunkt", "gegr?ndet um 1860", "mit dem Elfenbeinhandel verbunden", "von David Livingstone besucht", "später vom Kongo-Freistaat erobert"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Kasongo war als Hauptstadt des Handelsimperiums von Tippu Tip ein Brennpunkt des ?stlichen Kongo im 19. Jahrhundert. Der Ort steht f?r die Zeit, in der Zanzibari-H?ndler, lokale Machtgruppen und militärische Gewalt den Handel ?ber weite Strecken organisierten. F?r die historische Einordnung ist Kasongo wichtig, weil sich dort der ?bergang von Handelsdominanz zu kolonialer Eroberung besonders deutlich verfolgen l?sst. Der Name verbindet sich mit dem Kongo-Araber-Krieg, mit Karawanen und mit der Frage, wer Flüsse, M?rkte und Abgaben kontrollierte.",
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["1879 von Henry Morton Stanley gegr?ndet", "erstes Hauptquartier von Stanley in der Region", "nahe Matadi gelegen", "frühes administratives Zentrum", "mit den Interessen Leopolds II. verbunden", "wichtig f?r die Kontrolle des Unterkongo"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Stanley-Falls-Station wurde 1883 gegr?ndet und entwickelte sich zu einem zentralen Handels- und Verwaltungsort am oberen Kongo. Aus diesem frühen St?tzpunkt entstand das heutige Kisangani, weshalb der Ort ein Schl?ssel zum Verst?ndnis der Stadtgeschichte ist. Hier b?ndeln sich Erkundung, Flusshandel und koloniale Infrastruktur in einem einzigen Namen. F?r Geschichte K7 und K8 ist der Ort wertvoll, weil er den Wandel von einer Station der Expedition zu einer dauerhaften Stadt und regionalen Drehscheibe nachvollziehbar macht.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Standort der Lovanium-Universit?t steht f?r den Beginn der modernen Hochschulbildung im unabhängiger werdenden Kongo, denn die Einrichtung wurde 1954 er?ffnet. Besonders bekannt wurde der Campus, als dort 1959 der erste Atomreaktor Afrikas in Betrieb war. Heute gehört der Ort zur Universit?t von Kinshasa und bleibt ein Symbol f?r Wissenschaft, Mission, Politik und die Entwicklung der höheren Bildung. Der Platz ist deshalb f?r Geschichte und Sachkunde gleicherma?en interessant, weil er Technikgeschichte und Bildungswandel zusammenf?hrt.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Baudouinville, das heutige Moba, entstand als katholische Missionsstation am Tanganjikasee und wurde von den Wei?en V?tern gepr?gt. Der Ort zeigt, wie Mission, Seeverkehr und Kolonialverwaltung im Osten des Kongo zusammenwirkten. Mit der späteren Umbenennung in Moba verschob sich die historische Erz?hlung, aber die Missionsgeschichte blieb sichtbar. F?r den Unterricht ist der Ort hilfreich, wenn es um Religion, Bildung und die Ausbreitung katholischer Strukturen im Seengebiet geht.",
    ...
    factsAdvanced: {
      de: ["von den Wei?en V?tern gegr?ndet", "katholische Missionsstation", "liegt am Tanganjikasee", "früher Baudouinville genannt", "heute Moba", "Teil der Missionsgeschichte im Osten des Kongo"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Albertville, das heutige Kalemie, wurde 1892 als strategischer Posten am Tanganjikasee gegr?ndet und war ein wichtiger Punkt f?r Verkehr und Kontrolle im Osten des Kongo. Die Lage am See machte den Ort zu einem natürlichen Umschlagplatz f?r Handel, Verwaltung und militärische Pr?senz. Der heutige Name Kalemie erinnert an die spätere Entwicklung der Stadt, doch die koloniale Gründung bleibt zentral. F?r den Unterricht ist der Ort gut geeignet, um Seeverbindungen, Grenzr?ume und die Entstehung einer Hafenstadt zu erkl?ren.",
    ...
    factsAdvanced: {
      de: ["1892 gegr?ndet", "früher Albertville genannt", "heute Kalemie", "strategischer Posten am Tanganjikasee", "wichtiger Hafen- und Verwaltungsort", "Teil der kolonialen Pr?senz im Osten"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Matupi-H?hle ist eine bedeutende Fundstelle f?r die Steinzeitforschung und zeigt, dass Menschen den Raum im Osten des Kongo schon sehr früh nutzten. Mit Mikrolithen und langen Besiedlungsspuren liefert der Ort Material f?r die Frage, wie Werkzeuge, Jagd und Mobilit?t in pr?historischen Gesellschaften zusammenhingen. Die H?hle ist damit kein Randfund, sondern ein Fenster in sehr alte Lebenswelten. F?r den Unterricht l?sst sich Matupi gut mit Themen wie Altsteinzeit, Werkzeugtechnik und der Rekonstruktion früher Siedlungsr?ume verbinden.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Dimba-H?hle ist eine pr?historische Fundstelle, an der frühe menschliche Spuren und m?glicherweise Felskunst untersucht werden k?nnen. Der Ort ist f?r Kongo Central wichtig, weil er zeigt, dass die Region nicht nur aus kolonialer und moderner Geschichte besteht, sondern auch aus sehr alten Besiedlungsphasen. Solche H?hlen sind f?r die regionale Archäologie besonders wertvoll, weil sich an ihnen Wanderungen, Alltag und symbolische Ausdrucksformen früher Gemeinschaften ablesen lassen. Dimba verbindet Landschaft, Forschung und Urgeschichte in einem einzigen Ort.",
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["militärischer Au?enposten", "im Norden des Landes gelegen", "Teil der kolonialen Verwaltung", "wichtig f?r Grenzr?ume und Kontrolle", "historisches Zentrum der Pr?senzpolitik", "mit dem Norden des ehemaligen Kongo verbunden"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["früher Orientierungspunkt am Fluss", "natürliche Barriere im Gel?nde", "geistige Bedeutung f?r Einheimische", "mit dem Ort Zongo verbunden", "Teil der Wasserlandschaft am Ubangi", "wichtig f?r historische Orientierung und Wege"],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
