...
export const poiExtraCanadaRefill: POI[] = [
{
    ...
    description: {
      ...
      es: "Un archipiélago de más de 1.800 islas en el río San Lorenzo, en la frontera entre Estados Unidos y Canadá.",
      pt: "Um arquipélago de mais de 1.800 ilhas no rio São Lourenço, na fronteira entre os EUA e o Canadá.",
      fr: "Un archipel de plus de 1 800 îles sur le fleuve Saint-Laurent, à la frontière entre les États-Unis et le Canada.",
    },
    facts: {
      ...
      es: ["Destino turístico popular para paseos en barco", "Hogar del Boldt Castle y del Singer Castle"],
      pt: ["Destino turístico popular para passeios de barco", "Lar do Boldt Castle e do Singer Castle"],
      fr: ["Destination touristique prisée pour les croisières", "Abrite le château Boldt et le château Singer"],
    }, image: "/poi-images/thousand-islands-refill.webp",
    descriptionAdvanced: {
      de: "Die Thousand Islands bilden ein Archipel aus insgesamt 1.864 Inseln, die im Sankt-Lorenz-Strom an der Grenze zwischen den USA und Kanada liegen. Das Gebiet erstreckt sich über etwa 80 Kilometer stromabwärts von Kingston, Ontario, und umfasst Inseln unterschiedlichster Größe, von kleinen Felsen bis zu bewohnten Landmassen. Die Region ist Teil des Frontenac Arch, einem geologischen Ausläufer des Kanadischen Schildes, der eine wichtige ökologische Brücke bildet. Historisch dienten die Inseln als Rückzugsort für den nordamerikanischen Adel während des Gilded Age, was zum Bau beeindruckender Villen wie Boldt Castle auf Heart Island führte. Heute ist die Region als UNESCO-Biosphärenreservat anerkannt und schützt die vielfältigen marinen und terrestrischen Ökosysteme. Touristen besuchen das Gebiet vor allem für Bootsrundfahrten, Wassersport und zur Erkundung der Nationalparks, wie dem Thousand Islands National Park auf kanadischer Seite. Die Inseln sind zudem ein wichtiges Habitat für Zugvögel und zahlreiche Fischarten des Sankt-Lorenz-Systems.",
      hu: "Az Ezer-sziget (Thousand Islands) egy 1864 szigetből álló szigetcsoport, amely a Szent Lőrinc-folyón terül el az Amerikai Egyesült Államok és Kanada határán. A terület mintegy 80 kilométer hosszan húzódik Kingston városától lefelé a folyón, és a legkülönfélébb méretű szigeteket foglalja magában, a puszta szikláktól a lakott területekig. Geológiailag a Frontenac Arch részét képezik, amely a Kanadai-pajzs egyik nyúlványa és fontos ökológiai folyosót alkot. A szigetek a 19. század végén váltak népszerűvé az észak-amerikai elit körében, ekkor épültek az olyan lenyűgöző építmények, mint a Boldt-kastély a Heart-szigeten. Napjainkban a régió UNESCO Bioszféra-rezervátumként védett, elismerve gazdag vízi és szárazföldi ökoszisztémáját. A látogatók számára a sétahajózás, a kajakozás és a kanadai oldalon található Thousand Islands Nemzeti Park felfedezése jelenti a fő vonzerőt. A szigetvilág kritikus állomása a vonuló madaraknak és számos őshonos halfajnak ad otthont a Szent Lőrinc-folyó rendszerében.",
      ro: "Arhipelagul Thousand Islands cuprinde un număr de 1.864 de insule situate pe fluviul Sfântul Laurențiu, la granița dintre Statele Unite și Canada. Regiunea se întinde pe aproximativ 80 de kilometri în aval de orașul Kingston, Ontario, incluzând insule de dimensiuni variate, de la simple stânci până la suprafețe locuite extinse. Din punct de vedere geologic, insulele fac parte din Frontenac Arch, o extensie a Scutului Canadian care servește drept punte ecologică vitală. Istoric, zona a fost o destinație de vacanță preferată pentru elita nord-americană în timpul „Epocii de Aur”, ducând la construcția unor vile impunătoare precum Castelul Boldt de pe Heart Island. Astăzi, regiunea este recunoscută ca Rezervație a Biosferei UNESCO, protejând ecosistemele acvatice și terestre diverse. Turiștii vizitează zona pentru croaziere, sporturi nautice și pentru a explora Parcul Național Thousand Islands din partea canadiană. Insulele reprezintă, de asemenea, un habitat important pentru păsările migratoare și pentru numeroase specii de pești din sistemul Sfântul Laurențiu.",
      en: "The Thousand Islands comprise an archipelago of 1,864 islands scattered across the Saint Lawrence River on the border between the United States and Canada. The region extends for about 80 kilometers (50 miles) downstream from Kingston, Ontario, featuring islands of all sizes, from small rock outcrops to large inhabited landmasses. Geologically, the islands are part of the Frontenac Arch, a strip of Precambrian rock from the Canadian Shield that serves as a vital ecological corridor. During the Gilded Age at the end of the 19th century, the islands became a fashionable summer retreat for the wealthy, leading to the construction of grand estates like Boldt Castle on Heart Island. Today, the area is designated as a UNESCO World Biosphere Reserve, recognizing its diverse aquatic and terrestrial ecosystems. Visitors are drawn to the region for scenic boat tours, kayaking, and exploring the Thousand Islands National Park on the Canadian side. The islands also provide crucial nesting grounds for migratory birds and support a rich variety of fish species within the Saint Lawrence waterway.",
      es: "Las Mil Islas son un grupo de islas en el río San Lorenzo, en la frontera entre EE. UU. y Canadá. El archipiélago consta de más de 1.800 islas, que van desde pequeñas rocas hasta grandes masas de tierra habitadas. La zona es conocida por su pintoresco paisaje, castillos históricos como el Boldt Castle y es un destino popular para excursiones en barco y pescadores.",
      pt: "As Mil Ilhas são um grupo de ilhas no rio São Lourenço, na fronteira entre os EUA e o Canadá. O arquipélago consiste em mais de 1.800 ilhas, que variam de pequenos rochedos a grandes massas de terra habitadas. A área é conhecida pela sua paisagem pitoresca, castelos históricos como o Boldt Castle e é um destino popular para passeios de barco e pescadores.",
      fr: "Les Mille-Îles sont un archipel du fleuve Saint-Laurent, situé à la frontière entre les États-Unis et le Canada. Il compte plus de 1 800 îles, allant de simples rochers à de grandes masses de terre habitées. La région est réputée pour ses paysages pittoresques, ses châteaux historiques comme le château Boldt, et constitue une destination prisée pour les excursions en bateau et la pêche.",
    },
    factsAdvanced: {
      de: ["Die Region umfasst genau 1.864 kartierte Inseln im Fluss.", "Um als Insel zu gelten, muss das Land das ganze Jahr über über Wasser liegen.", "Boldt Castle wurde von George Boldt für seine Frau Louise erbaut.", "Der Frontenac Arch verbindet den Kanadischen Schild mit den Adirondacks.", "Die Region ist seit 2002 ein UNESCO-Biosphärenreservat.", "Wolfe Island ist mit einer Fläche von 124 km² die größte Insel des Archipels."],
      hu: ["A szigetcsoport összesen 1864 darab szigetből áll.", "Szigetnek az számít, amely egész évben a víz felett van és legalább két élő fája van.", "A Boldt-kastélyt George Boldt építtette felesége, Louise számára a 19. század végén.", "A terület 2002 óta az UNESCO világméretű bioszféra-rezervátum hálózatának tagja.", "A Frontenac Arch geológiai kapocsként szolgál két nagy hegység között.", "Wolfe Island a legnagyobb sziget, területe körülbelül 124 négyzetkilométer."],
      ro: ["Arhipelagul numără oficial 1.864 de insule de diferite dimensiuni.", "Pentru a fi numită insulă, trebuie să fie deasupra apei tot anul și să aibă doi copaci vii.", "Castelul Boldt a fost construit de George Boldt pe Heart Island.", "Regiunea a fost desemnată Rezervație a Biosferei UNESCO în anul 2002.", "Frontenac Arch este o structură geologică veche de un miliard de ani.", "Cea mai mare insulă este Wolfe Island, aflată în apropiere de Kingston."],
      en: ["The archipelago contains exactly 1,864 islands by official count.", "An island must stay above water year-round and support at least two living trees.", "Boldt Castle was commissioned by George Boldt as a tribute to his wife.", "The area was recognized as a UNESCO World Biosphere Reserve in 2002.", "The Frontenac Arch connects the Canadian Shield to the Adirondack Mountains.", "Wolfe Island is the largest in the group, covering 124 square kilometers."],
      es: ["Consta exactamente de 1.864 islas", "Se extiende por unos 80 kilómetros", "La construcción del Boldt Castle comenzó en 1900", "Wolfe Island es la isla más grande", "La frontera atraviesa el canal", "Parte de la Reserva de la Biosfera de la UNESCO"],
      pt: ["Composto por exatamente 1.864 ilhas", "Estende-se por cerca de 80 quilómetros", "O Boldt Castle começou a ser construído em 1900", "Wolfe Island é a maior ilha", "A fronteira atravessa o canal", "Parte da Reserva da Biosfera da UNESCO"],
      fr: ["Comprend exactement 1 864 îles", "S'étend sur environ 80 kilomètres", "La construction du château Boldt a débuté en 1900", "L'île Wolfe est la plus grande", "La frontière passe par le chenal", "Fait partie d'une réserve de biosphère de l'UNESCO"],
    },
  },
  {
    ...
    description: {
      ...
      es: "Un gran jardín botánico con jardines temáticos e invernaderos, considerado uno de los más importantes del mundo.",
      pt: "Um grande jardim botânico com jardins temáticos e estufas, considerado um dos mais importantes do mundo.",
      fr: "Un vaste jardin botanique comprenant des jardins thématiques et des serres, considéré comme l'un des plus importants au monde.",
    },
    facts: {
      ...
      es: ["Incluye el Jardín Chino, el Jardín Japonés y el Jardín Alpino", "Sitio histórico nacional de Canadá"],
      pt: ["Inclui o Jardim Chinês, o Jardim Japonês e o Jardim Alpino", "Sítio histórico nacional do Canadá"],
      fr: ["Comprend le Jardin de Chine, le Jardin japonais et le Jardin alpin", "Lieu historique national du Canada"],
    },
    descriptionAdvanced: {
      de: "Der Botanische Garten von Montreal ist mit einer Fläche von 75 Hektar einer der bedeutendsten botanischen Gärten der Welt. Er wurde 1931 inmitten der Weltwirtschaftskrise durch die Bemühungen des Botanikers Bruder Marie-Victorin und des Landschaftsarchitekten Henry Teuscher gegründet. Der Garten beherbergt eine beeindruckende Sammlung von über 22.000 Pflanzenarten und -sorten, die in 10 großen Ausstellungsgewächshäusern und 20 Themengärten präsentiert werden. Zu den herausragenden Teilen gehören der Chinesische Garten, der größte seiner Art außerhalb Asiens, und der Japanische Garten, der zur Kontemplation einlädt. Ein weiterer Schwerpunkt ist der First Nations Garden, der die enge Beziehung zwischen den indigenen Völkern und der Natur thematisiert. Der Garten ist als National Historic Site of Canada anerkannt und dient als wichtiges Zentrum für Forschung, Naturschutz und Bildung. Besucher können zudem das angeschlossene Insektarium besuchen, das eine riesige Sammlung von Präparaten und lebenden Insekten zeigt.",
      hu: "A Montreali Botanikus Kert 75 hektáros területével a világ egyik legjelentősebb és legnagyobb botanikai gyűjteménye. 1931-ben alapították a nagy gazdasági világválság idején, Marie-Victorin testvér botanikus és Henry Teuscher tájépítész kitartó munkájának köszönhetően. A kertben több mint 22 000 növényfaj és -fajta található meg, amelyeket 10 nagyméretű kiállítási üvegházban és 20 különböző tematikus kertben mutatnak be. A legnépszerűbb részek közé tartozik a Kínai kert, amely Ázsián kívül a legnagyobb ilyen jellegű létesítmény, valamint a japán kert a hozzá tartozó teaházzal. Külön figyelmet érdemel az Első Nemzetek Kertje, amely az őslakos népek és a növényvilág mély kapcsolatát mutatja be. A kert Kanada nemzeti történelmi emlékhelye, és fontos szerepet játszik a tudományos kutatásban, a fajmegőrzésben és az oktatásban. A látogatók számára a kert mellett az Insektárium is elérhető, amely rovarok hatalmas gyűjteményét vonultatja fel.",
      ro: "Grădina Botanică din Montreal, cu o suprafață de 75 de hectare, este recunoscută ca fiind una dintre cele mai importante și mai mari grădini botanice din lume. A fost fondată în anul 1931, în timpul Marii Depresiuni, prin eforturile botanistului Fratele Marie-Victorin și ale arhitectului peisagist Henry Teuscher. Grădina găzduiește o colecție impresionantă de peste 22.000 de specii și varietăți de plante, prezentate în 10 sere expoziționale mari și 20 de grădini tematice. Printre cele mai remarcabile atracții se numără Grădina Chineză, cea mai mare de acest tip din afara Asiei, și Grădina Japoneză, care oferă un spațiu de liniște și meditație. Un alt punct de interes major este Grădina Națiunilor Prime, dedicată relației dintre popoarele indigene și lumea vegetală. Instituția este desemnată Loc Istoric Național al Canadei și servește drept centru de cercetare, conservare și educație botanică. Vizitatorii pot explora, de asemenea, Insectarul adiacent, care deține o colecție vastă de exemplare vii și conservate.",
      en: "The Montreal Botanical Garden covers 75 hectares and is globally recognized as one of the most important botanical gardens in the world. It was founded in 1931 during the Great Depression through the tireless efforts of botanist Brother Marie-Victorin and landscape architect Henry Teuscher. The garden is home to an impressive collection of over 22,000 plant species and cultivars, displayed across 10 large exhibition greenhouses and 20 diverse thematic gardens. Key highlights include the Chinese Garden, the largest of its kind outside of Asia, and the Japanese Garden, which features traditional landscaping and a tea house. The First Nations Garden is another significant area, focusing on the deep relationship between indigenous peoples and the plant world. Designated as a National Historic Site of Canada, the garden serves as a vital hub for scientific research, conservation, and education. Visitors can also explore the integrated Insectarium, which showcases a massive collection of live and preserved insects.",
      es: "El Jardín Botánico de Montreal es uno de los más destacados del mundo y se extiende sobre 75 hectáreas. Fue fundado en 1931 por el hermano Marie-Victorin y alberga más de 22.000 especies de plantas en numerosos jardines temáticos e invernaderos. Destacan especialmente el Jardín Chino, el más grande de su tipo fuera de Asia, y el Jardín Japonés.",
      pt: "O Jardim Botânico de Montreal é um dos mais importantes do mundo e estende-se por 75 hectares. Foi fundado em 1931 pelo irmão Marie-Victorin e abriga mais de 22.000 espécies de plantas em numerosos jardins temáticos e estufas. Destacam-se o Jardim Chinês, o maior do género fora da Ásia, e o Jardim Japonês.",
      fr: "Le Jardin botanique de Montréal est l'un des plus importants au monde, s'étendant sur 75 hectares. Fondé en 1931 par le frère Marie-Victorin, il abrite plus de 22 000 espèces de plantes réparties dans de nombreux jardins thématiques et serres. Le Jardin de Chine, le plus grand du genre hors d'Asie, et le Jardin japonais sont particulièrement remarquables.",
    },
    factsAdvanced: {
      de: ["Der Garten wurde am 9. Juni 1931 offiziell gegründet.", "Die Gesamtfläche beträgt etwa 75 Hektar (185 Morgen).", "Es gibt über 22.000 verschiedene Pflanzenarten in der Sammlung.", "Der Chinesische Garten wurde von Meistern aus Shanghai gestaltet.", "Der Garten ist seit 2008 eine National Historic Site of Canada.", "Die Gewächshäuser umfassen insgesamt eine Fläche von 1,2 Hektar."],
      hu: ["A kertet hivatalosan 1931. június 9-én alapították.", "A gyűjtemény teljes területe körülbelül 75 hektárt tesz ki.", "Több mint 22 000 különböző növényfaj látható a területen.", "A Kínai kertet sanghaji mesterek tervezték és építették.", "2008-ban Kanada nemzeti történelmi emlékhelyévé nyilvánították.", "A kertben 10 nagy kiállító üvegház található különböző klímákkal."],
      ro: ["Grădina a fost înființată oficial pe data de 9 iunie 1931.", "Suprafața totală a grădinii este de aproximativ 75 de hectare.", "Colecția botanică include peste 22.000 de specii de plante.", "Grădina Chineză a fost realizată de meșteri aduși din Shanghai.", "A fost declarată Loc Istoric Național al Canadei în anul 2008.", "Include 10 sere mari care recreează diverse climate globale."],
      en: ["The garden was officially established on June 9, 1931.", "It spans an area of approximately 75 hectares (185 acres).", "The facility houses more than 22,000 different plant species.", "The Chinese Garden was designed by master craftsmen from Shanghai.", "It was designated a National Historic Site of Canada in 2008.", "The exhibition greenhouses cover a total area of 1.2 hectares."],
      es: ["Fundado el 9 de junio de 1931", "Superficie de 75 hectáreas", "Alberga 22.000 especies de plantas", "Cuenta con 10 invernaderos de exposición", "El Jardín Chino ocupa 2,5 hectáreas", "National Historic Site of Canada"],
      pt: ["Fundado em 9 de junho de 1931", "Área de 75 hectares", "Abriga 22.000 espécies de plantas", "Possui 10 estufas de exposição", "O Jardim Chinês ocupa 2,5 hectares", "National Historic Site of Canada"],
      fr: ["Fondé le 9 juin 1931", "Superficie de 75 hectares", "Abrite 22 000 espèces de plantes", "Possède 10 serres d'exposition", "Le Jardin de Chine couvre 2,5 hectares", "Lieu historique national du Canada"],
    },
