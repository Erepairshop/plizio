...
export const poiExtraIvorycoastReliefV2: POI[] = [
  {
    ...
    facts: {
      ...
      hu: ["1752 méter magas csúcs", "UNESCO Világörökségi helyszín", "Különleges vasérc-formációk"],
      ro: ["Înălțime 1752 metri", "Parte a patrimoniului UNESCO", "Biodiversitate bogată", "Masiv de granit"],
      en: ["Highest peak at 1,752m", "UNESCO World Heritage site", "Unique mountain savanna", "Shared international border"]
    },
    ...
    }, image: "/poi-images/mont-nimba-relief-v2.webp"},
  {
    ...
    description: { de: "Ein ausgedehntes Hochplateau in der Mitte des Landes, geprägt durch Savannen.", hu: "Kiterjedt fennsík az ország közepén, szavannákkal borítva.", ro: "Podișul Baoulé ocupă centrul Coastei de Fildeș, fiind o regiune vastă de savană situată la o altitudine medie de 300 de metri.", en: "An extensive high plateau in the center of the country, characterized by savannas." },
    facts: {
      ...
      ro: ["Altitudine 200-400 m", "Peisaj de savană deschisă", "Inima agricolă a țării", "Teren ușor ondulat"],
    ...
    }, image: "/poi-images/plateau-baoule-relief-v2.webp"},
  {
    ...
    description: { de: "Eine große Lagune entlang der Küste bei Abidjan.", hu: "Nagy lagúna a tengerpart mentén, Abidjan közelében.", ro: "O lagună mare de-a lungul coastei, lângă Abidjan.", en: "A large lagoon along the coast near Abidjan." },
    facts: {
    ...
    }, image: "/poi-images/ebrie-kuestenebene-relief-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Fontos folyóvölgyi ökoszisztéma", "Mélyen bevágódó folyómeder", "Mezőgazdasági művelés alatt áll"],
      ro: ["Valea râului Sassandra", "Păduri tropicale de joasă altitudine", "Potențial hidroenergetic", "Biodiversitate ridicată"],
      en: ["Major river basin", "Rolling hilly terrain", "Southwestern rainforest", "Hydroelectric potential"]
    ...
    }, image: "/poi-images/becken-von-bouake-relief-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Fontos tengeri kijárat", "Mocsaras parti övezetek", "Kakaóexport központja"],
      ro: ["Relief de coastă plat", "Păduri tropicale umede", "Zona portului San Pedro", "Ieșire strategică la mare"],
      en: ["Southwestern coastal zone", "Rocky coastline features", "Major port gateway", "Industrial and maritime hub"]
    }, image: "/poi-images/kuestenebene-san-pedro-relief-v2.webp"},
  {
    ...
    description: { de: "Eine weitläufige Savannenlandschaft im Nordosten, die durch isolierte Granitfelsen und Trockenvegetation geprägt ist.", hu: "Az északi Ferké régió száraz szavannája, amelyre a hatalmas nyílt terek és az állattenyésztés jellemző.", ro: "Savana Ferké din nordul îndepărtat este o câmpie plată și aridă, renumită pentru culturile sale de trestie de zahăr și creșterea vitelor.", en: "The Fere savanna relief consists of open plains in the north-central part of the country. It is dominated by lateritic plateaus and seasonal watercourses known as marigots." },
    facts: {
      de: ["Region Bounkani", "Nähe zum Comoé-Nationalpark", "Sudano-Sahel-Klima"],
      hu: ["Szudáni típusú szavanna", "Cukornádültetvények vidéke", "Forró, száraz éghajlat"],
      ro: ["Savana aridă de nord", "Culturi de trestie de zahăr", "Creșterea tradițională a vitelor", "Câmpii plate nesfârșite"],
      en: ["North-central savanna", "Lateritic plateau relief", "Seasonal river channels", "Scattered woodland cover"]
    }, image: "/poi-images/savanne-fere-relief-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Egyedülálló vízi építészet", "Gazdag halállomány", "Turisztikai látványosság"],
      ro: ["Sistem lagunar protejat", "Ape salmastre liniștite", "Bariere naturale de nisip", "Ecosistem de mangrove"],
      en: ["Section of Ebrie lagoon", "Famous for stilt villages", "Coastal wetland ecosystem", "Traditional fishing grounds"]
    }, image: "/poi-images/lagune-tiagba-relief-v2.webp"},
  {
    ...
    parent: "CI-06",
    coords: [-4.2, 6.6],
    name: { de: "Bongouanou-Plateau", hu: "Bongouanou-fennsík", ro: "Podișul Bongouanou", en: "Bongouanou Plateau" },
    description: { de: "Ein sanft gewelltes Plateau im Osten des Landes, das als eines der Hauptanbaugebiete für Kakao gilt.", hu: "A kelet-középső országrész hullámos fennsíkja, amely az ország egyik legfontosabb kávé- és kakaótermő vidéke.", ro: "Podișul Bongouanou este o zonă înaltă și fertilă din estul centrului țării, renumită pentru marile sale plantații de cacao și cafea.", en: "The Bongouanou plateau is a fertile upland area in south-central Ivory Coast. It is a key agricultural zone characterized by rolling hills and extensive cocoa plantations." },
    facts: {
      de: ["Region Iffou", "Höhenlage ca. 200m", "Fruchtbare Eisenböden"],
      hu: ["Termékeny dombvidék", "Sűrű erdőfoltokkal tarkított", "Fontos mezőgazdasági régió"],
      ro: ["Podiș fertil în est", "Altitudine medie 200 m", "Zonă majoră de cacao", "Relief ușor vălurit"],
      en: ["South-central highlands", "Productive cocoa region", "Rolling hill topography", "Lush tropical vegetation"]
    }
  },
  {
    id: "massif-man-relief-v2",
    type: "mountain",
    parent: "CI-11",
    coords: [-7.5, 7.4],
    name: { de: "Man-Gebirge", hu: "Man-hegység", ro: "Munții Man", en: "Man Mountains" },
    description: { de: "Die Bergregion um die Stadt Man ist berühmt für ihre markanten Gipfel, Wasserfälle und üppige Vegetation.", hu: "Az 'ezer domb városa', Man környékén emelkedő hegyvonulat, amely Elefántcsontpart leglátványosabb magaslatait foglalja magában.", ro: "Munții Man reprezintă cel mai spectaculos relief muntos al țării, cu vârfuri ce depășesc 1000 de metri și cascade impresionante.", en: "The Man Massif is the most prominent mountain range in western Ivory Coast, containing several peaks over 1,000 meters. The relief is marked by deep canyons and dramatic waterfalls." },
    facts: {
      de: ["Westliche Elfenbeinküste", "Zentrum des Tourismus", "Zahlreiche Wasserfälle"],
      hu: ["Nyugati hegyvidéki bástya", "Vízesésekben gazdag vidék", "Ködbe burkolózó csúcsok"],
      ro: ["Munții celor 18 vârfuri", "Altitudini peste 1000 m", "Peisaj montan cu cascade", "Vegetație alpină tropicală"],
      en: ["Major western mountain range", "Peaks over 1,000 meters", "Dramatic vertical relief", "Cool mountain microclimate"]
    }, image: "/poi-images/massif-man-relief-v2.webp"},
  {
    ...
    description: { de: "Ein bedeutendes Waldreservat im Süden, das wertvolle Reste des ursprünglichen tropischen Regenwaldes bewahrt.", hu: "A délkeleti országrész egyik jelentős erdős területe, amely Agboville közelében őrizte meg természetes állapotát.", ro: "Pădurea Yapo este o rezervație forestieră crucială în sud, protejând un relief colinar acoperit de păduri tropicale secundare bogate.", en: "The Yapo forest relief is a protected rainforest area situated on a low plateau near Agboville. It serves as a vital green lung and biodiversity corridor in the south." },
    facts: {
      de: ["Region Agnéby-Tiassa", "Nahe Agboville", "Hohe Artenvielfalt"],
      hu: ["Sűrű trópusi növényzet", "Ritka fafajok élőhelye", "Természetvédelmi zóna"],
      ro: ["Rezervație forestieră sudică", "Relief colinar împădurit", "Biodiversitate ridicată", "Plămânul verde al regiunii"],
      en: ["Southern forest plateau", "High canopy rainforest", "Located near Agboville", "Critical wildlife habitat"]
    }, image: "/poi-images/wald-von-yapo-relief-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Keleti határmenti síkság", "Sokszínű kulturális örökség", "Szavannás-erdős átmeneti zóna"],
      ro: ["Câmpie deluroasă în est", "Tranziție spre savană", "Aproape de granița cu Ghana", "Zonă de cultură a anacardului"],
      en: ["Eastern border plains", "Transitional dry forest", "Ancient trade route hub", "Gently undulating terrain"]
    }, image: "/poi-images/ebene-von-bondoukou-relief-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Városi vízi utak rendszere", "Mélyvízi kikötési lehetőségek", "Gazdasági ütőér"],
      ro: ["Inima lagunei Ébrié", "Activitate portuară intensă", "Ecosistem urban vital", "Braț navigabil extins"],
      en: ["Central urban lagoon", "Deep-water navigation channels", "Divides Abidjan districts", "Industrialized waterfront"]
    ...
    }, image: "/poi-images/hochland-von-khorogo-relief-v2.webp"},
  {
    ...
    description: { de: "Das Tal des N'Zi-Flusses erstreckt sich durch das Zentrum des Landes und ist ein wichtiger Zufluss des Bandama.", hu: "A N'zi-folyó völgye, amely fontos mezőgazdasági területeken halad keresztül, mielőtt a Bandamába torkollna.", ro: "Valea râului Nzi formează un culoar fertil în centrul țării, fiind o câmpie aluvionară esențială pentru agricultură în sezonul ploios.", en: "The N'zi river valley is a long, narrow depression that runs through central Ivory Coast. It is known for its fertile soils and seasonal flooding patterns that support agriculture." },
    facts: {
      de: ["Zentralregion", "Nebenfluss des Bandama", "Wichtiger Wasserlieferant"],
      hu: ["Központi folyami folyosó", "Időszakos áradások jellemzik", "Változatos élővilág"],
      ro: ["Culoar fluvial central", "Câmpie aluvionară fertilă", "Afluent major al Bandama", "Zone inundabile sezoniere"],
      en: ["Central river depression", "Fertile alluvial plains", "Tributary of the Bandama", "Seasonal flood cycles"]
    }, image: "/poi-images/flusstal-nzi-relief-v2.webp"},
  {
    ...
    parent: "CI-09",
    coords: [-4.3, 5.2],
    name: { de: "West-Abidjan-Lagune", hu: "Nyugat-Abidjan-lagúna", ro: "Laguna Abidjan de Vest", en: "West Abidjan Lagoon" },
    description: { de: "Der westliche Ausläufer der Ebrié-Lagune bietet ruhige Gewässer und ist von landwirtschaftlichen Flächen umgeben.", hu: "Az abidjani lagúnarendszer nyugati nyúlványa, ahol a városiasodás és a természetes vizes élőhelyek találkoznak.", ro: "Laguna Abidjan de Vest este o extensie liniștită a sistemului lagunar, caracterizată prin ape mai puțin poluate și zone bogate în mangrove.", en: "The western Abidjan lagoon relief extends from the city toward the town of Dabou. It is a shallow, calm waterway lined with coconut groves and traditional fishing villages." },
    facts: {
      de: ["Westliches Ebrié-System", "Ruhige Küstenzone", "Fischfang und Landwirtschaft"],
      hu: ["Kiterjedt lagúna-ágak", "Mocsaras tengerparti sáv", "Fejlődő városi peremterület"],
      ro: ["Extensie vestică liniștită", "Mlaștini de mangrove", "Ape de coastă bogate", "Peisaj lagunar natural"],
      en: ["Western Ebrie lagoon extension", "Shallow coastal waters", "Coconut-lined shores", "Calm inland navigation"]
      }
  }
];
