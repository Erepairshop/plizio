...
export const poiExtraBhutanLifeV2: POI[] = [
    ...
    }, image: "/poi-images/simply-bhutan-living-museum-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      multi4: ["Eröffnet 2008 zum 100-jährigen Jubiläum der Wangchuck-Dynastie.", "Größter Bauernmarkt in Bhutan.", "Über zwei Etagen in einem speziell errichteten Gebäude.", "Hauptmarkttage sind von Freitag bis Sonntag.", "Bauern aus dem ganzen Land verkaufen hier ihre Produkte.", "Einheimische Produkte wie roter Reis, Yak-Käse und getrocknete Chilis sind erhältlich.", "Ein Bereich ist für Nicht-Holz-Waldprodukte wie Weihrauch reserviert.", "Ein wichtiger sozialer Treffpunkt in der Hauptstadt."]
    }
  }
];
