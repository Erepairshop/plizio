...
export const poiExtraRwandaCitiesV2: POI[] = [
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["Történelmileg gyakran Kibungo néven hivatkoztak rá.", "A régió híres a különleges helyi banánsörről."],
      ro: ["A fost numit adesea istoric Kibungo.", "Regiunea este faimoasă pentru berea sa specială din banane."],
      en: ["Was historically often called Kibungo.", "The region is famous for its special banana beer."]
    }
  },
  {
    id: "rwanda-nyagatare-cities-v2",
    type: "city",
    parent: "RW-05",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["Fontos helyszín a koltán bányászatában.", "A közúti megközelítés a meredek terep miatt kihívást jelent."],
      ro: ["Locație importantă pentru extracția de coltan.", "Infrastructura rutieră este dificilă din cauza terenului abrupt."],
      en: ["Important location for coltan mining.", "Road access is challenging due to the steep terrain."]
    }
  },
  {
    id: "rwanda-nyabihu-cities-v2",
    type: "city",
    parent: "RW-04",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["Az ország egyetlen nagy kiterjedésű rizstermesztő területe.", "A hőmérséklet itt jóval melegebb, mint máshol."],
      ro: ["Singura zonă din țară unde se cultivă orez pe suprafețe mari.", "Temperaturile sunt considerabil mai ridicate aici."],
      en: ["The only area in the country that grows rice on a large scale.", "Temperatures are significantly hotter here."]
    }
  },
  {
    id: "rwanda-bweyeye-cities-v2",
    type: "city",
    parent: "RW-04",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["A terep túlságosan meredek a gépesített műveléshez.", "A teraszos gazdálkodás véd a heves erózió ellen."],
      ro: ["Terenul este prea abrupt pentru cultivarea mecanizată.", "Agricultura pe terase protejează împotriva eroziunii puternice."],
      en: ["The terrain is too steep for mechanized cultivation.", "Terrace farming protects against severe erosion."]
    }
  },
  {
    id: "rwanda-miyove-cities-v2",
    type: "city",
    parent: "RW-03",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["A régió egyik legrégebbi katolikus plébániájával rendelkezik.", "A környék domborzatát teraszok borítják."],
      ro: ["Are una dintre cele mai vechi parohii catolice din nord.", "Peisajul regiunii este puternic terasat."],
      en: ["Has one of the oldest Catholic parishes in the north.", "The landscape of the region is heavily terraced."]
    }
  },
  {
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["Az Akagera park nem hivatalos kapujaként tartják számon.", "A virágzó kereskedelmi piacoknak köszönhetően gyorsan növekszik."],
      ro: ["Este considerată poarta neoficială către parcul Akagera.", "Crește rapid datorită piețelor comerciale înfloritoare."],
      en: ["Considered the unofficial gateway to the Akagera Park.", "Is growing rapidly due to flourishing commercial markets."]
    }
  },
  {
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["A Kiziguro Kórház lakosok ezreinek biztosít ellátást.", "A vörös talaj rendkívül jellemző erre a vidékre."],
      ro: ["Spitalul Kiziguro deservește mii de locuitori.", "Pământul roșu este tipic pentru această regiune."],
      en: ["The Kiziguro Hospital serves thousands of residents.", "The red soil is typical for this region."]
    }
  }
];
