...
export const poiExtraGabonEconomicV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      de: "Das Gamba Ölterminal fungiert als entscheidender Knotenpunkt für den Export von Rohöl im Süden Gabuns. Die Anlage dient primär als Verladestation für die umliegenden Onshore-Ölfelder, deren Produktion einen signifikanten Teil des nationalen Bruttoinlandsprodukts ausmacht. Aufgrund der strategischen Küstenlage ermöglicht das Terminal den direkten Weitertransport mittels Öltankern auf den internationalen Markt. Diese Infrastruktur ist essenziell für die wirtschaftliche Stabilität der Region, da sie den Abfluss der geförderten Ressourcen gewährleistet und lokale Arbeitsplätze schafft. Die technische Instandhaltung des Terminals ist dabei ein fortlaufender Prozess, der technologische Standards erfordert. Geografie K7 — Rohstoffexport und küstennahe Infrastruktur.",
      hu: "A Gamba olajterminál kulcsfontosságú csomópontként szolgál a gaboni nyersolajexportban az ország déli részén. A létesítmény elsősorban a környező szárazföldi olajmezők termelését továbbítja, amely a nemzeti GDP jelentős részét adja. Stratégiai tengerparti elhelyezkedése lehetővé teszi a kőolaj közvetlen szállítását tankhajókkal a nemzetközi piacokra. Ez az infrastruktúra létfontosságú a régió gazdasági stabilitása szempontjából, mivel biztosítja az erőforrások kitermelését és helyi munkahelyeket teremt. A terminál karbantartása folyamatos technológiai korszerűsítést igényel. Földrajz K7 — Nyersanyagexport és part menti infrastruktúra.",
      ro: "Terminalul petrolier Gamba funcționează ca un nod crucial pentru exportul de țiței în sudul Gabonului. Facilitatea servește în principal ca stație de încărcare pentru câmpurile petroliere onshore din jur, a căror producție reprezintă o parte semnificativă din PIB-ul național. Datorită poziției strategice la coastă, terminalul permite transportul direct prin petroliere către piețele internaționale. Această infrastructură este esențială pentru stabilitatea economică a regiunii, asigurând exportul resurselor și creând locuri de muncă. Întreținerea tehnică a terminalului necesită standarde tehnologice riguroase. Geografie K7 — Exportul de materii prime și infrastructura de coastă.",
      en: "The Gamba Oil Terminal serves as a critical hub for crude oil exports in southern Gabon. The facility primarily acts as a loading station for surrounding onshore oil fields, whose output accounts for a significant portion of the national GDP. Due to its strategic coastal location, the terminal enables the direct transport of crude oil via tankers to international markets. This infrastructure is essential for the region's economic stability, ensuring the flow of resources and creating local jobs. Maintenance of the terminal involves continuous technological upgrading. Geography K7 — Resource export and coastal infrastructure."
    },
    factsAdvanced: {
      de: ["Verarbeitet Rohöl von Onshore-Feldern.", "Entscheidend für Gabuns Handelsbilanz.", "Teil der nationalen Öl-Infrastruktur.", "Strategisch an der Küste gelegen.", "Betrieb seit mehreren Jahrzehnten.", "Unterstützt durch internationale Energiekonzerne."],
