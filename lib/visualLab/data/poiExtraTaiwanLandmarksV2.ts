...
,
  {
    ...
    description: {
      ...
      ro: "O clădire monumentală dedicată tatălui fondator al Republicii Chinei, găzduind evenimente culturale.",
      en: "A monumental building dedicated to the founding father of the Republic of China, hosting cultural events.",
    },
    facts: {
      de: ["Eröffnet im Jahr 1972", "Architekt war Wang Da-hong", "Stündlicher Wachwechsel der Ehrengarde", "Parkfläche umfasst etwa 11 Hektar"],
      hu: ["1972-ben nyitották meg", "Wang Da-hong tervezte az épületet", "Óránkénti őrségváltás látható", "A park területe kb. 11 hektár"],
      ro: ["Inaugurată în anul 1972", "Arhitectul a fost Wang Da-hong", "Schimbarea gărzii are loc orar", "Parcul se întinde pe 11 hectare"],
      en: ["Opened in the year 1972", "Designed by architect Wang Da-hong", "Hourly changing of the honor guard", "Park covers about 11 hectares"],
    },
    imageHint: "Sun Yat-sen Memorial Hall Taipei exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Această chapelă modernistă din campusul Universității Tunghai este cunoscută pentru structura sa sub formă de cort.",
      en: "This modernist chapel on the Tunghai University campus is famous for its tent-like structure.",
    },
    facts: {
      de: ["Entworfen von I. M. Pei", "Fertigstellung im Jahr 1963", "Höhe von 19,2 Metern", "Besteht aus vier Betonplatten"],
      hu: ["I. M. Pei tervezte az épületet", "1963-ban készült el", "Magassága 19,2 méter", "Négy betonlapból áll a szerkezet"],
      ro: ["Proiectată de I. M. Pei", "Finalizată în anul 1963", "Înălțime de 19,2 metri", "Constat din patru plăci de beton"],
      en: ["Designed by I. M. Pei", "Completed in the year 1963", "Height of 19.2 meters", "Structure consists of four concrete slabs"],
    },
    imageHint: "Luce Memorial Chapel Taichung",
  },
  {
    ...
    description: {
      ...
      ro: "O casă de operă de avangardă, celebră pentru pereții săi curbi și designul izolat fonic.",
      en: "An avant-garde opera house famous for its curved walls and sound-insulated design.",
    },
    facts: {
      de: ["Entworfen von Toyo Ito", "Eröffnet im Jahr 2016", "Fläche von 58.000 Quadratmetern", "Keine einzige rechtwinklige Wand im Inneren"],
      hu: ["Toyo Ito japán építész tervezte", "2016-ban nyitották meg", "Területe 58 000 négyzetméter", "Nincs egyetlen derékszögű fal sem belül"],
      ro: ["Proiectat de Toyo Ito", "Deschis în anul 2016", "Suprafață de 58.000 metri pătrați", "Nu există pereți în unghi drept în interior"],
      en: ["Designed by Toyo Ito", "Opened in the year 2016", "Area of 58,000 square meters", "No single right-angled wall inside"],
    },
    imageHint: "National Taichung Theater exterior night",
  },
  {
    ...
    description: {
      ...
      ro: "Un hotel majestuos în stil de palat chinezesc, situat pe un deal deasupra orașului Taipei.",
      en: "A majestic Chinese palace-style hotel perched on a hill overlooking Taipei.",
    },
    facts: {
      de: ["Gegründet im Jahr 1952", "Höhe von 87 Metern", "Verfügt über geheime Fluchttunnel", "Eines der höchsten Gebäude der 1970er"],
      hu: ["1952-ben alapították", "Magassága 87 méter", "Titkos menekülőalagutakkal rendelkezik", "Az 1970-es évek egyik legmagasabb épülete"],
      ro: ["Fondat în anul 1952", "Înălțime de 87 de metri", "Dispune de tuneluri secrete de evacuare", "Una dintre cele mai înalte clădiri din anii '70"],
      en: ["Founded in the year 1952", "Height of 87 meters", "Features secret escape tunnels", "One of the tallest buildings in the 1970s"],
    },
    imageHint: "Grand Hotel Taipei red exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Două clădiri magnifice în stil tradițional chinezesc în Piața Libertății din Taipei.",
      en: "Two magnificent traditional Chinese-style buildings located on Liberty Square in Taipei.",
    },
    facts: {
      de: ["Fertiggestellt im Jahr 1987", "Sitz des Nationalen Sinfonieorchesters", "Das Theater hat 1.522 Sitzplätze", "Die Konzerthalle hat 2.074 Sitzplätze"],
      hu: ["1987-ben készültek el", "A Nemzeti Szimfonikus Zenekar székhelye", "A színház 1522 férőhelyes", "A koncertterem 2074 férőhelyes"],
      ro: ["Finalizate în anul 1987", "Sediul Orchestrei Simfonice Naționale", "Teatrul are 1.522 de locuri", "Sala de concerte are 2.074 de locuri"],
      en: ["Completed in the year 1987", "Home of the National Symphony Orchestra", "The theater has 1,522 seats", "The concert hall has 2,074 seats"],
    },
    imageHint: "National Theater and Concert Hall Taipei Liberty Square",
  },
  {
    ...
    description: {
      ...
      ro: "Cel mai vechi muzeu din Taiwan, găzduit într-o clădire neoclasică în Parcul Păcii 2-28.",
      en: "The oldest museum in Taiwan, housed in a neoclassical building within the 2-28 Peace Park.",
    },
    facts: {
      de: ["Gegründet im Jahr 1908", "Architekt war Ichiro Nomura", "Fokus auf Naturgeschichte Taiwans", "Eindrucksvolle Glaskuppel im Inneren"],
      hu: ["1908-ban alapították", "Ichiro Nomura volt az építész", "Fókuszban Tajvan természetrajza áll", "Lenyűgöző üvegkupola a belső térben"],
      ro: ["Fondat în anul 1908", "Arhitectul a fost Ichiro Nomura", "Focus pe istoria naturală a Taiwanului", "Cupolă de sticlă impresionantă în interior"],
      en: ["Founded in the year 1908", "Designed by architect Ichiro Nomura", "Focus on natural history of Taiwan", "Impressive glass dome in the interior"],
    },
    imageHint: "National Taiwan Museum neoclassical building",
  },
  {
    ...
    description: {
      ...
      ro: "Un templu taoist splendid restaurat în Taipei, cunoscut pentru sculpturile sale artistice.",
      en: "A magnificently restored Taoist temple in Taipei, known for its elaborate carvings and artwork.",
    },
    facts: {
      de: ["Baubeginn im Jahr 1804", "UNESCO-Kulturerbepreis im Jahr 2003", "Gewidmet dem Gott der Medizin", "Berühmt für Steinsäulenschnitzereien"],
      hu: ["Az építés 1804-ben kezdődött", "2003-ban UNESCO-díjat kapott", "Az orvoslás istenének szentelték", "Híres a kőoszlop-faragványairól"],
      ro: ["Construcția a început în 1804", "Premiat de UNESCO în anul 2003", "Dedicat zeului medicinei", "Renumit pentru sculpturile în piatră"],
      en: ["Construction began in 1804", "UNESCO heritage award in 2003", "Dedicated to the God of Medicine", "Famous for stone dragon pillars"],
    },
    imageHint: "Dalongdong Baoan Temple architecture",
  },
  {
    ...
    description: {
      ...
      ro: "Un zgârie-nori distinctiv în Kaohsiung, a cărui formă seamănă cu caracterul chinezesc pentru „înalt”.",
      en: "A distinctive skyscraper in Kaohsiung, with a shape resembling the Chinese character for 'high'.",
    },
    facts: {
      de: ["Höhe von 347,5 Metern", "Fertiggestellt im Jahr 1997", "War bis 2004 das höchste in Taiwan", "Besteht aus zwei separaten Beinen"],
      hu: ["Magassága 347,5 méter", "1997-ben készült el", "2004-ig Tajvan legmagasabbja volt", "Két különálló lábból áll az alapja"],
      ro: ["Înălțime de 347,5 metri", "Finalizat în anul 1997", "Cea mai înaltă din Taiwan până în 2004", "Structură formată din două „picioare”"],
      en: ["Height of 347.5 meters", "Completed in the year 1997", "Tallest in Taiwan until 2004", "Consists of two separate lower legs"],
    },
    imageHint: "85 Sky Tower Kaohsiung skyscraper",
  },
  {
    ...
    description: {
      ...
      ro: "Unul dintre cele mai vizitate muzee din Taichung, cunoscut pentru expoziția de dinozauri și centrul botanic.",
      en: "One of the most visited museums in Taichung, famous for its dinosaur exhibits and Botanical Garden.",
    },
    facts: {
      de: ["Eröffnet im Jahr 1986", "Besucherzahl über 3 Millionen jährlich", "Umfasst sechs Ausstellungsbereiche", "Besitzt ein IMAX-Kino"],
      hu: ["1986-ban nyitották meg", "Évente több mint 3 millió látogató", "Hat kiállítási területet foglal magában", "Rendelkezik egy IMAX mozival"],
      ro: ["Deschis în anul 1986", "Peste 3 milioane de vizitatori anual", "Cuprinde șase zone de expoziție", "Deține un cinematograf IMAX"],
      en: ["Opened in the year 1986", "Over 3 million visitors annually", "Includes six venue complexes", "Features an IMAX Space Theater"],
    },
    imageHint: "National Museum of Natural Science Taichung exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Un centru pentru artă contemporană, găzduit într-o fostă clădire școlară din epoca colonială.",
      en: "A center for contemporary art housed in a former colonial-era elementary school building.",
    },
    facts: {
      de: ["Erstes MOCA in Taiwan", "Eröffnet im Jahr 2001", "Gebäude stammt aus dem Jahr 1921", "War früher das Rathaus von Taipeh"],
      hu: ["Az első kortárs múzeum Tajvanon", "2001-ben nyitották meg", "Az épület 1921-ből származik", "Korábban Tajpej városházája volt"],
      ro: ["Primul MOCA din Taiwan", "Deschis în anul 2001", "Clădirea datează din 1921", "A fost anterior primăria din Taipei"],
      en: ["First MOCA in Taiwan", "Opened in the year 2001", "Building dates back to 1921", "Formerly the Taipei City Hall"],
    },
    imageHint: "Museum of Contemporary Art Taipei brick building",
  },
  {
    ...
    description: {
      ...
      ro: "Cel mai mare muzeu în aer liber din Taiwan, prezentând lucrările celebrului sculptor Ju Ming.",
      en: "The largest outdoor art museum in Taiwan, showcasing the works of famous sculptor Ju Ming.",
    },
    facts: {
      de: ["Eröffnet im Jahr 1999", "Fläche von 11 Hektar", "Bekannt für die Taichi-Serie", "Liegt an der Nordküste bei Jinshan"],
      hu: ["1999-ben nyitották meg", "Területe 11 hektár", "Híres a Taichi-sorozatról", "Az északi parton, Csinshan közelében van"],
      ro: ["Deschis în anul 1999", "Suprafață de 11 hectare", "Cunoscut pentru seria Taichi", "Situat pe coasta de nord, lângă Jinshan"],
      en: ["Opened in the year 1999", "Area of 11 hectares", "Famous for the Taichi series", "Located on the north coast in Jinshan"],
    },
    imageHint: "Ju Ming Museum outdoor sculptures",
  },
  {
    ...
    description: {
      ...
      ro: "Un acvariu și centru de cercetare imens în sudul Taiwanului, celebru pentru tunelul său subacvatic.",
      en: "A massive aquarium and research center in southern Taiwan, famous for its underwater tunnel.",
    },
    facts: {
      de: ["Eröffnet im Jahr 2000", "Fläche von 96 Hektar", "Beherbergt einen Walhai", "Drei große Hauptpavillons"],
      hu: ["2000-ben nyitották meg", "Területe 96 hektár", "Otthont ad egy cetcápának", "Három nagy főpavilont tartalmaz"],
      ro: ["Deschis în anul 2000", "Suprafață de 96 de hectare", "Găzduiește un rechin balenă", "Trei pavilioane principale mari"],
      en: ["Opened in the year 2000", "Area of 96 hectares", "Houses a whale shark", "Three major main pavilions"],
    },
    imageHint: "National Museum of Marine Biology Taiwan aquarium",
  },
  {
    ...
    description: {
      ...
      ro: "Un pod pietonal distinctiv care leagă continentul de insula Sansiantai de pe coasta de est.",
      en: "A distinctive pedestrian bridge connecting the mainland to Sansiantai Island on the east coast.",
    },
    facts: {
      de: ["Fertiggestellt im Jahr 1987", "Länge von etwa 400 Metern", "Form erinnert an einen Drachen", "Besteht aus acht Wellenbögen"],
      hu: ["1987-ben készült el", "Hossza kb. 400 méter", "Formája egy sárkányra emlékeztet", "Nyolc hullámívből áll"],
      ro: ["Finalizat în anul 1987", "Lungime de aproximativ 400 metri", "Forma seamănă cu un dragon", "Format din opt arcuri ondulate"],
      en: ["Completed in the year 1987", "Length of about 400 meters", "Shape resembles a dragon", "Consists of eight wave-like arches"],
    },
    imageHint: "Sansiantai Bridge of Eight Arches",
  },
  {
    ...
    description: {
      ...
      ro: "Cel mai lung pod peste mare din Taiwan, care leagă insulele Siyu și Baisha din arhipelagul Penghu.",
      en: "The longest sea-crossing bridge in Taiwan, connecting Siyu and Baisha islands in the Penghu archipelago.",
    },
    facts: {
      de: ["Gesamtlänge von 2.494 Metern", "Ursprünglich 1970 fertiggestellt", "Neu gebaut im Jahr 1996", "Wichtigste Verbindung der Inseln"],
      hu: ["Teljes hossza 2494 méter", "Eredetileg 1970-ben készült el", "1996-ban újjáépítették", "A szigetek legfontosabb összeköttetése"],
      ro: ["Lungime totală de 2.494 metri", "Finalizat inițial în 1970", "Reconstruit în anul 1996", "Cea mai importantă legătură între insule"],
      en: ["Total length of 2,494 meters", "Originally completed in 1970", "Rebuilt in the year 1996", "Main link between the islands"],
    },
    imageHint: "Penghu Great Bridge sea view",
  },
  {
    ...
    description: {
      ...
      ro: "Un pod elegant cu hobane în portul pescăresc din Tamsui, cunoscut pentru iluminarea romantică nocturnă.",
      en: "An elegant cable-stayed bridge in Tamsui Fisherman's Wharf, famous for its romantic night lighting.",
    },
    facts: {
      de: ["Eröffnet am Valentinstag 2003", "Länge von 196 Metern", "Häufiger Drehort für Filme", "Bietet Blick auf den Sonnenuntergang"],
      hu: ["2003 Valentin-napján nyitották meg", "Hossza 196 méter", "Gyakori filmforgatási helyszín", "Kiváló kilátást nyújt a naplementére"],
      ro: ["Inaugurat de Ziua Îndrăgostiților 2003", "Lungime de 196 de metri", "Locație frecventă pentru filmări", "Oferă vedere spre apusul soarelui"],
      en: ["Opened on Valentine's Day 2003", "Length of 196 meters", "Frequent filming location for movies", "Provides views of the sunset"],
    },
    imageHint: "Tamsui Lover's Bridge night",
  },
  {
    ...
    description: {
      ...
      ro: "Un muzeu modern în Chiayi, specializat în arta și cultura asiatică.",
      en: "A modern museum in Chiayi County specializing in Asian art and culture.",
    },
    facts: {
      de: ["Eröffnet im Jahr 2015", "Architekt war Kris Yao", "Fläche von 70 Hektar", "Verfügt über eine Brücke ohne Pfeiler"],
      hu: ["2015-ben nyitották meg", "Kris Yao tervezte az épületet", "Területe 70 hektár", "Rendelkezik egy tartóoszlop nélküli híddal"],
      ro: ["Deschis în anul 2015", "Arhitectul a fost Kris Yao", "Suprafață de 70 de hectare", "Dispune de un pod fără piloni"],
      en: ["Opened in the year 2015", "Designed by architect Kris Yao", "Area of 70 hectares", "Features a pierless bridge"],
    },
    imageHint: "Southern Branch of the National Palace Museum Chiayi",
  },
  {
    ...
    description: {
      ...
      ro: "O mănăstire budistă monumentală în Nantou, care îmbină arhitectura modernă cu elemente tradiționale.",
      en: "A monumental Buddhist monastery in Nantou, combining modern architecture with traditional elements.",
    },
    facts: {
      de: ["Fertiggestellt im Jahr 2001", "Höhe von 136 Metern", "Größtes buddhistisches Kloster Taiwans", "Entworfen von C.Y. Lee"],
      hu: ["2001-ben készült el", "Magassága 136 méter", "Tajvan legnagyobb buddhista kolostora", "C.Y. Lee tervezte az épületet"],
      ro: ["Finalizată în anul 2001", "Înălțime de 136 de metri", "Cea mai mare mănăstire budistă din Taiwan", "Proiectată de C.Y. Lee"],
      en: ["Completed in the year 2001", "Height of 136 meters", "Largest Buddhist monastery in Taiwan", "Designed by C.Y. Lee"],
    },
    imageHint: "Chung Tai Chan Monastery Nantou",
  },
  {
    ...
    description: {
      ...
      ro: "Unul dintre cele mai vizitate temple din Taipei, dedicat zeului războiului și al comerțului.",
      en: "One of the most visited temples in Taipei, dedicated to Guan Yu, the God of War and Commerce.",
    },
    facts: {
      de: ["Erbaut im Jahr 1967", "Verbietet das Verbrennen von Räucherstäbchen", "Täglich über 10.000 Besucher", "Bekannt für Segnungsrituale"],
      hu: ["1967-ben épült", "Tiltja a füstölők égetését", "Naponta több mint 10 000 látogató", "Áldási rituáléiról ismert"],
      ro: ["Construit în anul 1967", "Interzice arderea tămâiei", "Peste 10.000 de vizitatori zilnic", "Cunoscut pentru ritualurile de binecuvântare"],
      en: ["Built in the year 1967", "Bans the burning of incense sticks", "Over 10,000 visitors daily", "Known for its blessing rituals"],
    },
    imageHint: "Xingtian Temple Taipei entrance",
  },
  {
    ...
    description: {
      ...
      ro: "Cea mai veche biserică catolică din Taiwan, o clădire magnifică în Kaohsiung, în stil neogotic și neoromanic.",
      en: "The oldest Catholic church in Taiwan, a magnificent building in Kaohsiung featuring Gothic and Romanesque styles.",
    },
    facts: {
      de: ["Ursprünglich im Jahr 1859 gegründet", "Heutiges Gebäude von 1928", "Sitz des Bischofs von Kaohsiung", "Wichtiger Ort für religiöse Feiern"],
      hu: ["Eredetileg 1859-ben alapították", "A mai épület 1928-ból származik", "A kaohsziungi püspök székhelye", "Vallási ünnepségek fontos helyszíne"],
      ro: ["Fondată inițial în 1859", "Clădirea actuală datează din 1928", "Sediul episcopului de Kaohsiung", "Loc important pentru celebrări religioase"],
      en: ["Originally founded in 1859", "Present building dates to 1928", "Seat of the Bishop of Kaohsiung", "Important site for religious festivals"],
    },
    imageHint: "Holy Rosary Cathedral Kaohsiung exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Una dintre cele mai bine conservate case rezidențiale din dinastia Qing din Taipei, înconjurată de o grădină tradițională.",
      en: "One of the best-preserved Qing Dynasty residential houses in Taipei, surrounded by a traditional garden.",
    },
    facts: {
      de: ["Erbaut im Jahr 1783", "Vollständig versetzt im Jahr 1986", "Traditioneller Fujian-Architekturstil", "Besteht aus über 30 Räumen"],
      hu: ["1783-ban épült", "1986-ban teljesen áttelepítették", "Hagyományos fucsieni építészeti stílus", "Több mint 30 szobából áll"],
      ro: ["Construită în anul 1783", "Relocată complet în anul 1986", "Stil arhitectural tradițional Fujian", "Formată din peste 30 de camere"],
      en: ["Built in the year 1783", "Relocated entirely in the year 1986", "Traditional Fujian architectural style", "Consists of over 30 rooms"],
    },
    imageHint: "Lin Antai Historical House garden",
  },
  {
    ...
    description: {
      ...
      ro: "Un muzeu modern în Tainan, care documentează istoria diversă și dezvoltarea culturală a insulei.",
      en: "A modern museum in Tainan documenting the diverse history and cultural development of the island.",
    },
    facts: {
      de: ["Eröffnet im Jahr 2011", "Fläche von 20 Hektar", "Markante Solarpanel-Wand", "Fokus auf Alltagsgeschichte"],
      hu: ["2011-ben nyitották meg", "Területe 20 hektár", "Jellegzetes napelem-fal", "Fókuszban a mindennapi történelem"],
      ro: ["Deschis în anul 2011", "Suprafață de 20 de hectare", "Perete distinctiv cu panouri solare", "Focus pe istoria vieții cotidiene"],
      en: ["Opened in the year 2011", "Area of 20 hectares", "Distinctive solar panel wall", "Focus on everyday history"],
    },
    imageHint: "National Museum of Taiwan History Tainan",
  },
  {
    ...
    description: {
      ...
      ro: "Un reper futurist în portul Kaohsiung, reflectând identitatea maritimă a orașului.",
      en: "A futuristic landmark in the Port of Kaohsiung, reflecting the city's maritime identity.",
    },
    facts: {
      de: ["Eröffnet im Jahr 2021", "Wabenförmige Fassadenstruktur", "Besteht aus mehreren Gebäuden", "Liegt an der Mündung des Liebesflusses"],
      hu: ["2021-ben nyitották meg", "Méhsejt alakú homlokzati szerkezet", "Több épületből álló komplexum", "A Szerelem-folyó torkolatánál található"],
      ro: ["Deschis în anul 2021", "Structură de fațadă în formă de fagure", "Format din mai multe clădiri", "Situat la gura de vărsare a Râului Iubirii"],
      en: ["Opened in the year 2021", "Honeycomb facade structure", "Consists of multiple buildings", "Located at the mouth of Love River"],
    },
    imageHint: "Kaohsiung Music Center architecture",
  }
];
