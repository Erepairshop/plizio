...
export const poiExtraBurkinafasoEconomicV2: POI[] = [
  {
    id: "essakane-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-SEN",
    coords: [-0.0633, 14.3831],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Essakane-Goldmine ist die größte Goldmine in Burkina Faso und liegt in der nordöstlichen Grenzregion, etwa 330 Kilometer von Ouagadougou entfernt. Sie erstreckt sich über die Provinzen Oudalan und Séno und wird mehrheitlich von der kanadischen Firma IAMGOLD betrieben. Die Mine nahm ihren kommerziellen Betrieb im Jahr 2010 auf und hat seitdem die nationale Goldproduktion massiv gesteigert. Es handelt sich um eine Tagebaumine, die über moderne Verarbeitungsanlagen zur Gewinnung von Gold durch Cyanidlaugung verfügt. Geografisch liegt die Mine in einer extrem trockenen Sahel-Zone, was komplexe Herausforderungen an das Wassermanagement stellt. Essakane ist ein bedeutender Arbeitgeber in der Region und trägt wesentlich zu den Exporteinnahmen des Landes bei. Das Projekt umfasst auch umfangreiche Programme zur sozialen Verantwortung, einschließlich der Umsiedlung von Dörfern und Investitionen in die lokale Infrastruktur. Die Goldreserven von Essakane gelten als eine der bedeutendsten im westafrikanischen Birimian-Grünsteingürtel.",
      ...
      es: "La mina de oro de Essakane es una de las más importantes de Burkina Faso y un factor decisivo para la economía local. Situada en la región del Sahel, la mina ha contribuido al desarrollo de infraestructuras en las comunidades circundantes.",
      pt: "A mina de ouro de Essakane é uma das mais importantes do Burkina Faso e um factor decisivo para a economia local. Situada na região do Sahel, a mina contribuiu para o desenvolvimento de infraestruturas nas comunidades circundantes.",
      fr: "La mine d'or d'Essakane est l'une des plus importantes mines d'or du Burkina Faso et un facteur décisif pour l'économie locale. Située dans la région du Sahel, elle a contribué au développement des infrastructures dans les communes environnantes.",
    },
    factsAdvanced: {
  ...
  {
    id: "houndé-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-TUI",
    coords: [-3.4249, 11.4589],
    name: {
      de: "Houndé Gold Mine",
      hu: "Houndé Gold Mine",
      ro: "Houndé Gold Mine",
      en: "Houndé Gold Mine"},
    descriptionAdvanced: {
      de: "Die Houndé-Goldmine ist ein bedeutender Bergbaustandort im Südwesten von Burkina Faso, etwa 250 Kilometer südwestlich der Hauptstadt Ouagadougou. Die Mine wird von der britisch-kanadischen Firma Endeavour Mining betrieben und nahm ihren Betrieb im Jahr 2017 auf. Sie gilt als eine der kostengünstigsten und effizientesten Minen Westafrikas. Geografisch liegt Houndé in der Provinz Tuy, einer Region, die für ihre geologische Reichhaltigkeit innerhalb des Birimian-Grünsteingürtels bekannt ist. Das Projekt besteht aus mehreren Tagebauen und einer modernen Verarbeitungsanlage mit einer Kapazität von mehreren Millionen Tonnen Erz pro Jahr. Houndé hat die wirtschaftliche Dynamik in der Region stark verändert und Tausende von direkten und indirekten Arbeitsplätzen geschaffen. Die Mine nutzt modernste Technologien zur Erzgewinnung und legt Wert auf hohe Umweltstandards. Durch gezielte Investitionen in kommunale Projekte, wie Schulen und Brunnen, wird die lokale Entwicklung gefördert. Die prognostizierte Minenlebensdauer erstreckt sich über mehr als ein Jahrzehnt und sichert somit langfristige Steuereinnahmen für den Staat.",
      ...
      es: "La mina de oro de Houndé, en el suroeste del país, es un proyecto minero moderno que crea empleos significativos en la región de Hauts-Bassins. La extracción se realiza en una zona geológicamente rica, que también se utiliza intensamente para la agricultura.",
      pt: "A mina de ouro de Houndé, no sudoeste do país, é um projeto mineiro moderno que cria postos de trabalho significativos na região de Hauts-Bassins. A extração ocorre numa área geologicamente rica, que também é utilizada intensamente para a agricultura.",
      fr: "La mine d'or de Houndé, dans le sud-ouest du pays, est un projet minier moderne qui crée des emplois significatifs dans la région des Hauts-Bassins. L'extraction a lieu dans une zone géologiquement riche, qui est également utilisée de manière intensive pour l'agriculture.",
    },
    factsAdvanced: {
  ...
  {
    id: "boungou-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-GOU",
    coords: [0.6978, 11.9161],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Boungou-Goldmine, früher als Natougou bekannt, liegt im Osten von Burkina Faso in der Provinz Tapoa. Die Mine wird von Endeavour Mining betrieben und begann 2018 mit der kommerziellen Produktion. Geologisch befindet sie sich in der Birimian-Formation, die reich an hochwertigen Goldvorkommen ist. Boungou ist als Tagebau konzipiert und nutzt eine Zerkleinerungs- und Laugungsanlage zur Goldextraktion. Aufgrund ihrer Lage in einer entlegenen Region des Landes war der Bau der Mine eine logistische Meisterleistung, die auch die Verbesserung der lokalen Verkehrswege erforderte. Die Mine zeichnet sich durch überdurchschnittlich hohe Goldgehalte im Erz aus, was sie wirtschaftlich besonders attraktiv macht. In den letzten Jahren stand die Mine aufgrund der regionalen Sicherheitslage vor operativen Herausforderungen, blieb aber ein Eckpfeiler der nationalen Bergbauindustrie. Endeavour Mining investiert kontinuierlich in Sicherheit und soziale Projekte, um die Akzeptanz in der lokalen Gourmantché-Bevölkerung zu sichern. Das Projekt trägt durch Lizenzgebühren und Steuern massiv zur Staatskasse bei.",
      ...
      es: "La mina de Boungou es un importante proyecto de extracción de oro en el este de Burkina Faso que, a pesar de los desafíos logísticos, desempeña un papel clave en la economía regional. La región se caracteriza por sabanas secas, lo que convierte a la minería en el medio de vida de muchos habitantes.",
      pt: "A mina de Boungou é um importante projeto de extração de ouro no leste do Burkina Faso que, apesar dos desafios logísticos, desempenha um papel fundamental na economia regional. A região é caracterizada por savanas secas, tornando a mineração o sustento de muitos habitantes.",
      fr: "La mine de Boungou est un projet d'extraction d'or majeur dans l'est du Burkina Faso qui, malgré les défis logistiques, joue un rôle clé dans l'économie régionale. La région est caractérisée par des savanes sèches, ce qui fait de l'exploitation minière le moyen de subsistance de nombreux habitants.",
    },
    factsAdvanced: {
  ...
  {
    id: "perkoa-zinc-mine-economic-v2",
    type: "industry",
    parent: "BF-SAN",
    coords: [-2.6953, 12.3392],
    name: {
      de: "Perkoa Zinc Mine",
      hu: "Perkoa Zinc Mine",
      ro: "Perkoa Zinc Mine",
      en: "Perkoa Zinc Mine"},
    descriptionAdvanced: {
      de: "Die Perkoa-Zinkmine ist das einzige Bergwerk seiner Art in Burkina Faso und liegt in der Provinz Sanguié, etwa 120 Kilometer westlich von Ouagadougou. Die Mine wurde primär zur Gewinnung von Zinkkonzentrat betrieben, wobei auch geringe Mengen Silber anfielen. Perkoa galt lange Zeit als Vorzeigeprojekt für die Diversifizierung des burkinischen Bergbausektors weg vom reinen Goldbergbau. Geologisch handelt es sich um eine vulkanogene Massivsulfidlagerstätte (VMS), die eine hohe Zinkkonzentration aufweist. Im Jahr 2022 erlangte die Mine traurige Berühmtheit durch ein schweres Flutereignis, das zum Tod mehrerer Bergleute und zur Einstellung des Betriebs führte. Die Mine wurde zuletzt von der kanadischen Firma Trevali Mining betrieben, bevor finanzielle Schwierigkeiten infolge des Unglücks zur Schließung führten. Trotz der aktuellen Inaktivität bleibt das geologische Potenzial der Lagerstätte ein Thema für zukünftige Sanierungs- oder Wiedereröffnungspläne. Die Anlage umfasste eine Untertagemine und eine moderne Flotationsanlage zur Aufbereitung des Erzes. Der Einfluss der Mine auf die lokale Wirtschaft von Kordié und Réo war über Jahre hinweg signifikant.",
      ...
      es: "Perkoa es la única mina de zinc de Burkina Faso y ocupa una posición especial en el sector minero. Situada en la región Centre-Ouest, ha diversificado el sector exportador del país con un metal industrial importante.",
      pt: "Perkoa é a única mina de zinco em Burkina Faso e ocupa uma posição especial no setor mineiro. Localizada na região Centre-Ouest, diversificou o setor de exportação do país com um metal industrial importante.",
      fr: "Perkoa est la seule mine de zinc du Burkina Faso et occupe une place particulière dans le secteur minier. Située dans la région Centre-Ouest, elle a diversifié le secteur des exportations du pays grâce à un métal industriel important.",
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Bobointer ist der wichtigste Trockenhafen in Bobo-Dioulasso und fungiert als eine entscheidende multimodale Logistikplattform für den internationalen Handel von Burkina Faso. Strategisch an der Eisenbahnlinie Abidjan-Niger gelegen, erleichtert die Anlage den effizienten Warenverkehr zwischen der Atlantikküste der Elfenbeinküste und dem burkinischen Hinterland. Das Areal umfasst etwa 19 Hektar und wird von der Industrie- und Handelskammer Burkina Fasos (CCI-BF) verwaltet. Es verfügt über moderne Zolllager, spezialisierte Containerterminals und integrierte Zollabfertigungsdienste, wodurch die Transitzeiten für Importe und Exporte erheblich verkürzt werden können. Die umfassende Modernisierung des Hafens im letzten Jahrzehnt hat seine Kapazität auf über 1,2 Millionen Tonnen Fracht pro Jahr erhöht und unterstützt maßgeblich die regionale Wirtschaft der Hauts-Bassins. Als Binnenland ist Burkina Faso auf solche Trockenhäfen angewiesen, um wettbewerbsfähige Lieferketten aufrechtzuerhalten und die ständige Verfügbarkeit lebenswichtiger Güter auf dem lokalen Markt sicherzustellen.",
      ...
      es: "El puerto seco intermodal Bobointer es un centro logístico para la importación y exportación de mercancías en Burkina Faso. Gracias a su conexión con la línea ferroviaria, es de vital importancia para el tráfico de mercancías con Costa de Marfil.",
      pt: "O porto seco intermodal Bobointer é um centro logístico para a importação e exportação de mercadorias no Burkina Faso. Devido à sua ligação à linha ferroviária, é de importância vital para o tráfego de mercadorias com a Costa do Marfim.",
      fr: "Le port sec intermodal Bobointer est une plaque tournante logistique pour l'importation et l'exportation de marchandises au Burkina Faso. Grâce à sa liaison ferroviaire, il est d'une importance capitale pour le trafic de marchandises avec la Côte d'Ivoire.",
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Ouagarinter ist der wichtigste Trockenhafen und Zollterminal der Hauptstadt Ouagadougou. Er dient als primärer Knotenpunkt für den Überlandfrachtverkehr, der über große regionale Häfen wie Lomé, Cotonou und Tema in das Land gelangt. Die Anlage ist für die Verteilung von Waren in Zentral- und Nord-Burkina Faso unverzichtbar und bietet eine spezialisierte Infrastruktur für die Containerlagerung und das Logistikmanagement. Ouagarinter wird von der Industrie- und Handelskammer verwaltet und wurde in mehreren Phasen erweitert, um dem wachsenden Volumen des internationalen Handels gerecht zu werden. Der Hafen bietet integrierte Dienstleistungen an, darunter technische Inspektionen, Wägungen und die administrative Bearbeitung von Importgütern. Durch die Zentralisierung der Zollvorgänge hilft der Hafen, den Handelsverkehr zu regulieren und trägt erheblich zu den Steuereinnahmen des Staates bei. Seine Rolle ist entscheidend für die Stabilisierung der Preise importierter Materialien und unterstützt die industrielle Entwicklung der Hauptstadtregion.",
      ...
      es: "El puerto seco de Uagadugú funciona como el centro principal para el despacho de mercancías de la capital. Es un punto central para el comercio entre los países costeros y el interior de Burkina Faso.",
      pt: "O porto seco de Ouagadougou funciona como o principal centro de despacho de mercadorias da capital. É um ponto central para o comércio entre os países costeiros e o interior de Burkina Faso.",
      fr: "Le port sec de Ouagadougou fait office de centre principal pour le traitement des marchandises de la capitale. C'est un point central pour le commerce entre les pays côtiers et l'intérieur du Burkina Faso.",
    },
    factsAdvanced: {
  ...
  {
    id: "tambao-manganese-mine-economic-v2",
    type: "industry",
    parent: "BF-OUD",
    coords: [-0.0667, 14.85],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Manganmine Tambao befindet sich in der Provinz Oudalan im äußersten Norden von Burkina Faso, nahe der Grenzen zu Mali und Niger. Sie gilt als eines der größten unerschlossenen Manganvorkommen der Welt mit geschätzten Reserven von über 100 Millionen Tonnen hochwertigem Erz. Mangan ist eine wesentliche Komponente in der Stahlproduktion und der Batterieherstellung, was diesen Standort zu einem strategischen Aktivposten für die nationale Wirtschaft macht. Trotz ihres Potenzials war die Erschließung der Mine über Jahrzehnte hinweg mit zahlreichen Verzögerungen konfrontiert, die auf Rechtsstreitigkeiten, logistische Herausforderungen und regionale Sicherheitsprobleme zurückzuführen sind. Das Projekt erfordert den Bau oder die Sanierung von hunderten Kilometern Eisenbahnstrecke, um das Erz zu den Küstenhäfen zu transportieren. Sobald die Mine voll betriebsbereit ist, wird erwartet, dass sie tausende Arbeitsplätze schafft und erhebliche Exporteinnahmen generiert. Sie bleibt ein zentraler Schwerpunkt der langfristigen Industrialisierungsstrategie der Regierung.",
      ...
      es: "El proyecto de manganeso de Tambao, en el extremo noreste, se considera una de las mayores reservas sin explotar del mundo. El desafío logístico del transporte a través del Sahel ha retrasado su desarrollo hasta ahora; sin embargo, es un tema central de futuro para la economía nacional.",
      pt: "O projeto de manganês de Tambao, no extremo nordeste, é considerado uma das maiores reservas não exploradas do mundo. O desafio logístico do transporte através do Sahel atrasou o desenvolvimento até agora; no entanto, é um tema central para o futuro da economia nacional.",
      fr: "Le projet de manganèse de Tambao, à l'extrême nord-est, est considéré comme l'une des plus grandes réserves inexploitées au monde. Le défi logistique du transport à travers le Sahel a retardé son développement jusqu'à présent ; il s'agit néanmoins d'un enjeu futur central pour l'économie nationale.",
    },
    factsAdvanced: {
  ...
  {
    id: "sofitex-bobo-dioulasso-economic-v2",
    type: "industry",
    parent: "BF-HOU",
    coords: [-4.297, 11.18],
    name: {
    ...
    descriptionAdvanced: {
      de: "SOFITEX (Société des Fibres Textiles) ist das größte Baumwollunternehmen in Burkina Faso mit administrativem und industriellem Hauptsitz in Bobo-Dioulasso. Gegründet im Jahr 1979 nach der Umstrukturierung der CFDT aus der Kolonialzeit, verwaltet das Unternehmen die Produktion, Verarbeitung und Vermarktung von Baumwolle, die oft als das „weiße Gold“ des Landes bezeichnet wird. Das Unternehmen betreibt zahlreiche Entkörnungsanlagen in den westlichen und südlichen Regionen und verarbeitet Rohbaumwolle zu exportfähigen Fasern. SOFITEX bietet hunderttausenden von Kleinbauern, die in Kooperativen organisiert sind, technische Unterstützung und landwirtschaftliche Betriebsmittel. Der Baumwollsektor sichert den Lebensunterhalt von etwa vier Millionen Menschen in Burkina Faso und trägt einen erheblichen Teil zu den Deviseneinnahmen des Landes bei. Trotz der Konkurrenz durch synthetische Fasern spielt SOFITEX weiterhin eine wichtige sozioökonomische Rolle, indem es die ländliche Entwicklung vorantreibt und industrielle Arbeitsplätze schafft.",
      ...
      es: "SOFITEX es la empresa líder en el sector del algodón en Burkina Faso. La planta principal en Bobo-Dioulasso procesa el algodón de las áreas de cultivo circundantes, conocidas por el 'oro blanco' del país.",
      pt: "A SOFITEX é a empresa líder no setor do algodão em Burkina Faso. A fábrica principal em Bobo-Dioulasso processa o algodão das áreas de cultivo circundantes, conhecidas pelo 'ouro branco' do país.",
      fr: "La SOFITEX est l'entreprise leader de la filière coton au Burkina Faso. L'usine principale de Bobo-Dioulasso transforme le coton des zones de culture environnantes, réputées pour l' \"or blanc\" du pays.",
    },
    factsAdvanced: {
  ...
  {
    id: "sn-sosuco-banfora-economic-v2",
    type: "industry",
    parent: "BF-COM",
    coords: [-4.75, 10.6333],
    name: {
    ...
    descriptionAdvanced: {
      de: "SN-SOSUCO (Société Nouvelle Société Sucrière de la Comoé) ist Burkina Fasos wichtigster industrieller Zuckerproduzent mit Sitz in der Nähe von Banfora. Das Unternehmen bewirtschaftet weitläufige Zuckerrohrplantagen auf einer Fläche von etwa 4.000 Hektar, die durch das Wasser des Comoé-Flusses und nahegelegener Staudämme bewässert werden. Der Industriekomplex wurde 1965 gegründet und später umstrukturiert; er umfasst eine Verarbeitungsanlage, die geerntetes Rohr in Kristall- und Würfelzucker für den Inlandsmarkt raffiniert. Es ist einer der größten Arbeitgeber in der Region Cascades und bietet tausenden Einheimischen sowohl Dauerarbeitsplätze als auch saisonale Beschäftigung. Der Produktionszyklus ist saisonabhängig und findet in der Regel von November bis Mai statt. SN-SOSUCO produziert zudem Melasse als Nebenprodukt, die für Tierfutter und industrielle Anwendungen genutzt wird. Das Unternehmen ist von zentraler Bedeutung für die Ernährungssicherheit des Landes und die Bemühungen, die Abhängigkeit von importiertem Zucker zu verringern.",
      ...
      es: "SN-SOSUCO en Banfora es el mayor productor de azúcar del país. La fábrica procesa la caña de azúcar cultivada en las plantaciones cercanas y es una empresa clave para la economía regional en las Cascades.",
      pt: "A SN-SOSUCO em Banfora é o maior produtor de açúcar do país. A fábrica processa a cana-de-açúcar cultivada nas plantações próximas e é uma empresa fundamental para a economia regional nas Cascades.",
      fr: "La SN-SOSUCO à Banfora est le plus grand producteur de sucre du pays. L'usine transforme la canne à sucre cultivée dans les plantations voisines et constitue une entreprise clé pour l'économie régionale dans les Cascades.",
    },
    factsAdvanced: {
  ...
  {
    id: "cimburkina-ouagadougou-economic-v2",
    type: "industry",
    parent: "BF-KAD",
    coords: [-1.52, 12.38],
    name: {
    ...
    descriptionAdvanced: {
      de: "CIMBURKINA ist ein großes Zementmahlwerk in der Industriezone Kossodo in Ouagadougou. Als Tochtergesellschaft des deutschen multinationalen Konzerns Heidelberg Materials wurde die Anlage 2015 eingeweiht, um die wachsende Nachfrage nach Baumaterialien in den städtischen Zentren Burkina Fasos zu decken. Das Werk ist auf die Herstellung von hochwertigem Zement spezialisiert, indem importierter Klinker mit lokal gewonnenem oder importiertem Gips und Kalkstein vermahlen wird. Mit einer jährlichen Produktionskapazität von etwa 1 Million Tonnen hat CIMBURKINA erheblich zur Stabilisierung der Zementpreise und zur Verfügbarkeit von Baustoffen für nationale Infrastrukturprojekte beigetragen. Die Anlage nutzt moderne, umweltbewusste Technologien, um Staubemissionen und Energieverbrauch zu minimieren. Ihre Präsenz in der Hauptstadt erleichtert die Logistik am Bau, senkt die Transportkosten für Bauherren und unterstützt die rasche Urbanisierung der Region.",
      ...
      es: "CimBurkina es un fabricante líder de cemento en Burkina Faso. Con su planta en Uagadugú, apoyan el fuerte auge de la construcción en la creciente capital del país.",
      pt: "A CimBurkina é um fabricante líder de cimento no Burkina Faso. Com a sua fábrica em Uagadugu, apoiam o forte boom da construção na crescente capital do país.",
      fr: "CimBurkina est un producteur de ciment leader au Burkina Faso. Avec son usine à Ouagadougou, ils soutiennent le fort essor de la construction dans la capitale croissante du pays.",
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Solarkraftwerk Zagtouli ist ein wegweisendes Projekt für erneuerbare Energien am Stadtrand von Ouagadougou. Es wurde im November 2017 in Betrieb genommen und war zu diesem Zeitpunkt mit einer Fläche von 60 Hektar und über 129.000 Solarmodulen das größte Photovoltaikkraftwerk in Westafrika. Die Anlage verfügt über eine Spitzenkapazität von 33 Megawatt und liefert sauberen Strom für zehntausende Haushalte, wodurch die Abhängigkeit des Landes von teuren Importen fossiler Brennstoffe aus den Nachbarländern verringert wird. Das Projekt wurde primär von der Europäischen Union und der französischen Entwicklungsbehörde (AFD) finanziert. Zagtouli dient als Modell für nachhaltige Entwicklung im Sahel und demonstriert die Machbarkeit von großflächiger Solarenergie in Regionen mit hoher Sonneneinstrahlung. Es hilft dabei, jährlich etwa 26.000 Tonnen CO2-Emissionen einzusparen und unterstützt den Ausbau des nationalen Stromnetzes in unterversorgte Gebiete.",
      hu: "A Zagtouli napelemes erőmű egy mérföldkőnek számító megújuló energia projekt Ouagadougou külvárosában. 2017 novemberében adták át, és abban az időben Nyugat-Afrika legnagyobb fotovoltaikus erőműve volt, amely 60 hektáros területen több mint 129 000 napelemet foglal magában. A létesítmény 33 megawattos csúcskapacitással rendelkezik, tiszta villamos energiát biztosítva több tízezer otthon számára, és csökkentve az ország függőségét a szomszédos országokból származó drága fosszilis tüzelőanyag-importtól. A projektet elsősorban az Európai Unió és a Francia Fejlesztési Ügynökség (AFD) finanszírozta a nemzeti energiamix zöldítésére irányuló stratégia részeként. Zagtouli a fenntartható fejlődés modelljeként szolgál a Száhel-övezetben, bizonyítva a nagyüzemi napenergia életképességét a magas napsugárzású régiókban. Évente körülbelül 26 000 tonna CO2-kibocsátást vált ki.",
      ro: "Centrala solară Zagtouli este un proiect de referință în domeniul energiei regenerabile, situat la periferia orașului Ouagadougou. Pusă în funcțiune în noiembrie 2017, aceasta era la acea vreme cea mai mare centrală solară fotovoltaică din Africa de Vest, acoperind o suprafață de 60 de hectare cu peste 129.000 de panouri solare. Instalația are o capacitate maximă de 33 de megawați, oferind energie electrică curată pentru zeci de mii de locuințe și reducând dependența țării de importurile costisitoare de combustibili fosili din țările vecine. Proiectul a fost finanțat în principal de Uniunea Europeană și de Agenția Franceză de Dezvoltare (AFD). Zagtouli servește ca model pentru dezvoltarea durabilă în Sahel, demonstrând viabilitatea energiei solare la scară largă în regiuni cu radiație solară ridicată. Ajută la atenuarea emisiilor de gaze cu efect de seră cu aproximativ 26.000 de tone de CO2 anual.",
      en: "The Zagtouli Solar Power Plant is a landmark renewable energy project located on the outskirts of Ouagadougou. Commissioned in November 2017, it was at the time the largest solar photovoltaic plant in West Africa, covering an area of 60 hectares with over 129,000 solar panels. The facility has a peak capacity of 33 megawatts, providing clean electricity to tens of thousands of homes and reducing the country's dependence on expensive fossil fuel imports from neighboring countries. The project was primarily funded by the European Union and the French Development Agency (AFD) as part of a broader strategy to increase the share of renewables in the national energy mix. Zagtouli serves as a model for sustainable development in the Sahel, demonstrating the viability of large-scale solar power in regions with high solar radiation. It helps mitigate greenhouse gas emissions by approximately 26,000 tons of CO2 annually.",
    },
    factsAdvanced: {
      de: ["Inbetriebnahme im Jahr 2017 nahe der Hauptstadt Ouagadougou.", "Die Spitzenleistung der Anlage beträgt 33,7 Megawatt.", "Besteht aus exakt 129.584 Photovoltaik-Solarmodulen.", "Die Gesamtkosten des Projekts beliefen sich auf etwa 47,5 Millionen Euro.", "Gefördert durch die EU (25 Mio.) und die AFD (22,5 Mio.).", "Die Anlage erstreckt sich über eine Gesamtfläche von 60 Hektar."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Depot Bingo ist das größte strategische Lager für Kohlenwasserstoffe in Burkina Faso und wird von der Société Nationale Burkinabè d'Hydrocarbures (SONABHY) betrieben. Etwa 30 Kilometer westlich von Ouagadougou gelegen, dient das Depot als primäres Reservoir für Benzin, Diesel und Kerosin, das in das Binnenland importiert wird. Es ist über Straßentankwagen mit den Lieferketten verbunden, die von Häfen in der Elfenbeinküste, Togo und Benin ausgehen. Die Anlage verfügt über massive Lagertanks mit einer Gesamtkapazität von mehreren hunderttausend Kubikmetern, wodurch eine nationale Reserve für mehrere Wochen sichergestellt wird, um Versorgungsunterbrechungen abzufedern. Bingo ist mit modernen Sicherheitssystemen, automatisierten Verladestationen für Verteiler-Lkw und Laboreinrichtungen zur Qualitätskontrolle des Kraftstoffs ausgestattet. Als Herzstück der Energielogistik des Landes ist der Betrieb des Depots für Transport, Industrie und Stromerzeugung von entscheidender Bedeutung.",
      hu: "A Bingo Depot Burkina Faso legnagyobb stratégiai szénhidrogén-tároló létesítménye, amelyet a Nemzeti Szénhidrogén Társaság (SONABHY) üzemeltet. Az Ouagadougoutól mintegy 30 kilométerre nyugatra található depó az országba importált benzin, gázolaj és kerozin elsődleges tárolóhelyeként szolgál. Közúti tartálykocsikon keresztül kapcsolódik az Elefántcsontpart, Togo és Benin kikötőiből induló ellátási láncokhoz. A létesítmény hatalmas tárolótartályokkal rendelkezik, amelyek több százezer köbméteres összkapacitása több hétre elegendő nemzeti tartalékot biztosít az ellátási zavarok elleni védelem érdekében. Bingo modern biztonsági rendszerekkel, automatizált töltőállomásokkal és az üzemanyag minőség-ellenőrzésére szolgáló laboratóriumokkal van felszerelve. Az ország energialogisztikájának központjaként a depó működése kritikus fontosságú a közlekedés, az ipar és a villamosenergia-termelés szempontjából.",
      ro: "Depozitul Bingo este cea mai mare facilitate strategică de stocare a hidrocarburilor din Burkina Faso, operată de Société Nationale Burkinabè d'Hydrocarbures (SONABHY). Situat la aproximativ 30 de kilometri vest de Ouagadougou, depozitul servește ca rezervor principal pentru benzină, motorină și combustibil pentru avioane importate în țară. Este conectat prin autocisterne la lanțurile de aprovizionare care pornesc din porturile din Coasta de Fildeș, Togo și Benin. Instalația dispune de rezervoare masive de stocare cu o capacitate totală de câteva sute de mii de metri cubi, asigurând o rezervă națională de câteva săptămâni pentru a atenua eventualele perturbări ale aprovizionării. Bingo este echipat cu sisteme moderne de siguranță, rampe automate de încărcare pentru camioanele de distribuție și laboratoare pentru controlul calității combustibilului. Managementul SONABHY asupra acestei facilități este vital pentru securitatea energetică națională.",
      en: "The Bingo Depot is the largest strategic hydrocarbon storage facility in Burkina Faso, operated by the Société Nationale Burkinabè d'Hydrocarbures (SONABHY). Located about 30 kilometers west of Ouagadougou, the depot serves as the primary reservoir for gasoline, diesel, and jet fuel imported into the landlocked country. It is connected via road tankers to supply chains originating from ports in Ivory Coast, Togo, and Benin. The facility features massive storage tanks with a total capacity of several hundred thousand cubic meters, ensuring a national reserve of several weeks to buffer against supply chain disruptions. Bingo is equipped with modern safety systems, automated loading bays for distribution trucks, and laboratory facilities for fuel quality control. As the heart of the country's energy logistics, the depot's operations are critical for transport, industry, and electricity generation. SONABHY's management of this facility is vital for maintaining price stability and national energy security.",
    },
    factsAdvanced: {
      de: ["Zentrale strategische Treibstofflagerstätte seit dem Jahr 2003.", "Lagerkapazität übersteigt 100.000 Kubikmeter Kraftstoff.", "Befindet sich 32 Kilometer vom Zentrum Ouagadougous entfernt.", "Wird täglich von etwa 300 bis 500 Tanklastwagen angefahren.", "Lebenswichtig für den Betrieb der nationalen Wärmekraftwerke.", "Verfügt über ein spezialisiertes Labor zur Analyse von Erdölprodukten."],
  ...
  {
    id: "brakina-ouagadougou-economic-v2",
    type: "industry",
    parent: "BF-KAD",
    coords: [-1.4988, 12.385],
    name: {
    ...
    descriptionAdvanced: {
      de: "BRAKINA (Brasseries du Burkina) ist der führende Hersteller von Bier und kohlensäurehaltigen Erfrischungsgetränken des Landes mit seinem industriellen Hauptwerk in Ouagadougou. Das 1960 gegründete Unternehmen ist eine Tochtergesellschaft der Castel-Gruppe und hat sich zu einem der erfolgreichsten und größten Steuerzahler in Burkina Faso entwickelt. Die Brauerei produziert bekannte lokale Marken wie Brakina und So.B.Bra sowie internationale Marken unter Lizenz, wie Beaufort und Castel. Das Werk in Ouagadougou nutzt fortschrittliche Brau- und Abfülltechnologien, um hohe Produktionsvolumina und Qualitätsstandards aufrechtzuerhalten. Über seine industrielle Wirkung hinaus unterstützt BRAKINA ein riesiges Netzwerk von Distributoren, Großhändlern und Einzelhandelsverkaufsstellen im ganzen Land, wodurch tausende indirekte Arbeitsplätze entstehen. Das Unternehmen engagiert sich zudem für den lokalen Bezug von Rohstoffen wie Mais und Sorghum durch Partnerschaften mit burkinischen Bauern.",
      hu: "A BRAKINA (Brasseries du Burkina) az ország vezető sör- és szénsavas üdítőital-gyártója, amelynek elsődleges ipari üzeme Ouagadougouban található. Az 1960-ban alapított vállalat a Castel-csoport leányvállalata, és Burkina Faso egyik legsikeresebb vállalatává és legnagyobb adófizetőjévé vált. A sörfőzde olyan ikonikus helyi márkákat gyárt, mint a Brakina és a So.B.Bra, valamint licenc alapján nemzetközi márkákat, például a Beaufortot és a Castelt. Az ouagadougoui üzem fejlett főzési és palackozási technológiát alkalmaz a magas termelési volumen és a minőségi szabványok fenntartása érdekében. Ipari hatásán túl a BRAKINA disztribútorok, nagykereskedők és kiskereskedelmi egységek (maquis-k és bárok) hatalmas hálózatát támogatja az ország egész területén, több ezer közvetett munkahelyet generálva. A vállalat részt vesz a nyersanyagok, például a kukorica és a cirok helyi beszerzésében is.",
      ro: "BRAKINA (Brasseries du Burkina) este cel mai important producător de bere și băuturi răcoritoare carbogazoase din țară, având principala fabrică industrială în Ouagadougou. Înființată în 1960, compania este o filială a Grupului Castel și a devenit unul dintre cei mai de succes și mai mari contribuabili la bugetul Burkinei Faso. Fabrica de bere produce mărci locale emblematice precum Brakina și So.B.Bra, precum și mărci internaționale sub licență, cum ar fi Beaufort și Castel. Fabrica din Ouagadougou utilizează tehnologie avansată de fabricare și îmbuteliere pentru a menține volume mari de producție și standarde de calitate ridicate. Dincolo de impactul său industrial, BRAKINA susține o rețea vastă de distribuitori, angrosiști și puncte de vânzare cu amănuntul în întreaga țară, generând mii de locuri de muncă indirecte. Compania este, de asemenea, implicată în aprovizionarea locală cu materii prime precum porumbul și sorgul.",
      en: "BRAKINA, the Brasseries du Burkina, is the country's leading producer of beer and carbonated soft drinks, with its primary industrial plant located in Ouagadougou. Established in 1960, the company is a subsidiary of the Castel Group and has become one of the most successful and largest taxpayers in Burkina Faso. The brewery produces iconic local brands like Brakina and So.B.Bra, as well as international brands under license, such as Beaufort and Castel. The Ouagadougou plant utilizes advanced brewing and bottling technology to maintain high production volumes and quality standards. Beyond its industrial impact, BRAKINA supports a vast network of distributors, wholesalers, and retail outlets across the country, generating thousands of indirect jobs. The company is also involved in the local sourcing of raw materials, such as corn and sorghum, through partnerships with Burkinabè farmers.",
    },
    factsAdvanced: {
      de: ["Gegründet im Jahr 1960, zeitgleich mit der nationalen Unabhängigkeit.", "Mehrheitlich im Besitz der Castel-Gruppe (BGI).", "Marktanteil im Biersektor übersteigt lokal 90 %.", "Produziert jährlich über 1,5 Millionen Hektoliter an Getränken.", "Bedeutende Quelle für Steuereinnahmen des burkinischen Staates.", "Unterstützt ein Netzwerk von über 10.000 lokalen Einzelhandelspunkten."],
  ...
  {
    id: "sanbrado-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-GAN",
    coords: [-0.9167, 12.2333],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Goldmine Sanbrado ist ein hochgradiger Goldabbaubetrieb in der Provinz Ganzourgou, etwa 170 Kilometer südöstlich von Ouagadougou. Die vom australischen Unternehmen West African Resources betriebene Mine erzielte im März 2020 ihren ersten Goldguss, früher als geplant und unter dem veranschlagten Budget. Das Projekt umfasst sowohl Tagebau- als auch Untertagebauaktivitäten und zielt auf mehrere hochgradige Lagerstätten ab, darunter M1 South. Sanbrado ist einer der kosteneffizientesten Goldproduzenten der Region mit einer anfänglichen Minenlebensdauer von über 10 Jahren und einer jährlichen Produktion von mehr als 200.000 Unzen. Gold ist Burkina Fasos wichtigstes Exportgut, und Minen wie Sanbrado leisten durch Lizenzgebühren, Steuern und lokale Beschäftigung einen erheblichen Beitrag zum nationalen BIP. Das Unternehmen setzt umfassende Sozial- und Umweltprogramme um, die sich auf die Gesundheit der Gemeinschaft, Bildung und Wasserinfrastruktur in den umliegenden Dörfern konzentrieren.",
      hu: "A Sanbrado aranybánya egy kiváló minőségű aranybányászati tevékenység Ganzourgou tartományban, körülbelül 170 kilométerre délkeletre Ouagadougoutól. Az ausztrál West African Resources vállalat által üzemeltetett bánya 2020 márciusában érte el az első aranyöntést, a tervezettnél korábban és a költségvetésen belül. A projekt nyíltszíni és földalatti bányászati műveletekből áll, több magas aranytartalmú lelőhelyet célozva meg, köztük az M1 South-t. A Sanbrado a régió egyik legalacsonyabb költségű aranytermelője, kezdeti élettartamát több mint 10 évre becsülik, éves termelése pedig meghaladja a 200 000 unciát. Az arany Burkina Faso vezető exportcikke, és az olyan bányák, mint a Sanbrado, jelentősen hozzájárulnak a nemzeti GDP-hez jogdíjakon, adókon és a helyi foglalkoztatáson keresztül. A vállalat átfogó társadalmi és környezetvédelmi programokat hajt végre a környező falvakban.",
      ro: "Mina de aur Sanbrado este o operațiune de exploatare a aurului de înaltă puritate situată în provincia Ganzourgou, la aproximativ 170 de kilometri sud-est de Ouagadougou. Operată de compania australiană West African Resources, mina a realizat prima turnare de aur în martie 2020, înainte de termen și sub bugetul stabilit. Proiectul constă atât în operațiuni miniere la suprafață, cât și în subteran, vizând mai multe zăcăminte de înaltă calitate, inclusiv M1 South. Sanbrado este unul dintre producătorii de aur cu cele mai mici costuri din regiune, cu o durată de viață inițială a minei estimată la peste 10 ani și o producție anuală care depășește 200.000 de uncii. Aurul este principala marfă de export a Burkinei Faso, iar mine precum Sanbrado contribuie semnificativ la PIB-ul național prin redevențe, taxe și ocuparea forței de muncă locale.",
      en: "The Sanbrado Gold Mine is a high-grade gold mining operation located in the Ganzourgou Province, approximately 170 kilometers southeast of Ouagadougou. Operated by the Australian company West African Resources, the mine achieved its first gold pour in March 2020, ahead of schedule and under budget. The project consists of both open-pit and underground mining operations, targeting several high-grade deposits including M1 South. Sanbrado is one of the lowest-cost gold producers in the region, with an initial mine life estimated at over 10 years and annual production exceeding 200,000 ounces. Gold is Burkina Faso's leading export commodity, and mines like Sanbrado contribute significantly to the national GDP through royalties, taxes, and local employment. The company implements comprehensive social and environmental programs, focusing on community health, education, and water infrastructure in the surrounding villages.",
    },
    factsAdvanced: {
      de: ["Kommerzielle Produktion startete offiziell im März 2020.", "Betrieben durch das australische Unternehmen West African Resources.", "Jährliche Goldproduktion auf rund 220.000 Unzen ausgelegt.", "Minenlebensdauer wird auf mindestens 14 Jahre geschätzt.", "Enthält hochgradige Untertage-Reserven von ca. 10 g/t.", "Lizenzgebühren und Steuern übersteigen jährlich 50 Millionen USD."],
  ...
  {
    id: "filsah-textile-mill-economic-v2",
    type: "industry",
    parent: "BF-HOU",
    coords: [-4.3, 11.16],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Filature du Sahel (FILSAH) ist ein Eckpfeiler der burkinischen Industrie und befindet sich in Bobo-Dioulasso, dem wirtschaftlichen Zentrum des Landes. Das im Jahr 1999 gegründete Unternehmen nahm 2000 den Betrieb auf und hat sich auf die Verarbeitung von lokal angebauter Baumwolle spezialisiert. Als eines der wenigen Unternehmen in Westafrika, das die gesamte Wertschöpfungskette von der Entkörnung bis zum Spinnen abdeckt, trägt FILSAH maßgeblich zur Wertschöpfung innerhalb Burkina Fasos bei. Die Fabrik ist mit modernen Maschinen ausgestattet, die es ermöglichen, Baumwollgarne für den lokalen und internationalen Markt herzustellen. Angesichts der Tatsache, dass Baumwolle das wichtigste Agrarexportgut des Landes ist, spielt diese Spinnerei eine strategische Rolle bei der Reduzierung der Abhängigkeit von Rohstoffexporten. Das Werk bietet hunderten Menschen direkte Arbeitsplätze und unterstützt indirekt tausende Baumwollbauern in der Region Hauts-Bassins. Durch kontinuierliche Investitionen in Technologie und Ausbildung hat sich FILSAH als Modell für die industrielle Entwicklung in der Sahelzone etabliert und fördert die textile Souveränität des Landes.",
      hu: "A Filature du Sahel (FILSAH) Burkina Faso iparának meghatározó szereplője, amely az ország gazdasági fővárosában, Bobo-Dioulassóban található. Az 1999-ben alapított vállalat 2000-ben kezdte meg működését, és elsődleges célja a helyben termelt gyapot ipari feldolgozása. Ez a gyár az egyik legjelentősebb textilipari létesítmény Nyugat-Afrikában, amely képes a nyersgyapotot kiváló minőségű fonallá alakítani, növelve ezzel az ország exportbevételeit. A létesítmény stratégiai fontosságú, mivel Burkina Faso Afrika egyik legnagyobb gyapottermelője, de a termés nagy részét korábban feldolgozatlanul exportálták. A FILSAH modern technológiát alkalmaz a fonási folyamatok során, és termékeit nemcsak a hazai piacon, hanem nemzetközi szinten is értékesítik. A vállalat több száz közvetlen munkahelyet teremt, és közvetve több ezer gyapottermelő család megélhetését biztosítja a Hauts-Bassins régióban. Az üzem folyamatos bővítése és a fenntartható energiagazdálkodás irányába tett lépései példaként szolgálnak a térség többi ipari vállalata számára is, hozzájárulva az ország gazdasági diverzifikációjához.",
      ro: "Filature du Sahel (FILSAH) este o unitate industrială de referință din Burkina Faso, situată în orașul Bobo-Dioulasso, inima economică a țării. Fondată în 1999 și operațională din anul 2000, această fabrică de textile este specializată în transformarea bumbacului local în fire de înaltă calitate. Într-o țară care este unul dintre principalii producători de bumbac din Africa, FILSAH joacă un rol crucial prin adăugarea de valoare produsului brut înainte de export. Fabrica utilizează tehnologii moderne de filare și contribuie semnificativ la reducerea dependenței țării de importurile de textile. Din punct de vedere economic, întreprinderea susține mii de fermieri locali din regiunea Hauts-Bassins, oferind în același timp locuri de muncă directe pentru sute de muncitori calificați. FILSAH este un exemplu de succes al industrializării în Sahel, reușind să mențină standarde internaționale de calitate și să concureze pe piața globală a firelor de bumbac. Investițiile constante în infrastructură și formarea profesională a personalului reflectă angajamentul companiei față de dezvoltarea durabilă și consolidarea sectorului manufacturier național.",
      en: "The Filature du Sahel (FILSAH) is a cornerstone of Burkinabe industry, located in Bobo-Dioulasso, the nation's economic hub. Established in 1999 and operational since 2000, this textile mill specializes in the processing of locally grown cotton into high-quality yarn. As one of the few facilities in West Africa to cover the value chain from ginning to spinning, FILSAH significantly contributes to domestic value addition. The factory is equipped with modern machinery that produces cotton yarn for both local weavers and international markets. Given that cotton is Burkina Faso's primary agricultural export, this mill plays a strategic role in reducing the country's reliance on raw material exports. The plant provides direct employment to hundreds of people and indirectly supports thousands of cotton farmers in the Hauts-Bassins region. Through continuous investments in technology and vocational training, FILSAH has established itself as a model for industrial development in the Sahel, promoting the country's textile sovereignty and economic diversification in a competitive global landscape.",
    },
    factsAdvanced: {
      de: ["Das Unternehmen wurde 1999 gegründet und nahm 2000 die Produktion auf.", "Der Sitz befindet sich in Bobo-Dioulasso, der zweitgrößten Stadt Burkina Fasos.", "FILSAH verarbeitet jährlich mehrere tausend Tonnen Rohbaumwolle zu Garn.", "Es ist einer der größten privaten Arbeitgeber in der Region Hauts-Bassins.", "Die Fabrik exportiert ihre Produkte in verschiedene afrikanische und europäische Länder.", "Das Werk nutzt spezialisierte Spinnereitechnologien zur Herstellung verschiedener Garnstärken."],
  ...
  },
  {
    ...
    name: {
      ...
      en: "Mana Gold Mine"},
    descriptionAdvanced: {
      de: "Die Mana-Goldmine ist eine der bedeutendsten Bergbauoperationen in Burkina Faso und liegt in der Region Mouhoun, etwa 200 Kilometer westlich der Hauptstadt Ouagadougou. Die kommerzielle Produktion begann im Jahr 2008 unter der Leitung von SEMAFO, einem Unternehmen, das später von Endeavour Mining übernommen wurde. Die Anlage umfasst mehrere Tagebaue sowie eine große Verarbeitungsanlage, die modernste Carbon-in-Leach-Technologie (CIL) nutzt, um Gold aus dem Erz zu gewinnen. Mana hat sich als äußerst produktiv erwiesen und trägt wesentlich zu den Exporterlösen und dem Bruttoinlandsprodukt des Landes bei. Ein besonderer Meilenstein war die Entdeckung und Integration der hochgradigen Siou-Lagerstätte, die die Lebensdauer der Mine erheblich verlängerte. Das Unternehmen investiert zudem in soziale Projekte und Infrastruktur in den umliegenden Gemeinden, um die lokale Entwicklung zu fördern. Trotz der Herausforderungen durch die Sicherheitslage in der Sahelzone bleibt Mana ein Eckpfeiler des burkinischen Bergbausektors und ein Beispiel für großflächige industrielle Rohstoffgewinnung in Westafrika.",
      hu: "A Mana aranybánya Burkina Faso egyik legfontosabb bányászati létesítménye, amely a Mouhoun régióban, Ouagadougoutól mintegy 200 kilométerre nyugatra található. A kereskedelmi termelés 2008-ban kezdődött meg a SEMAFO irányítása alatt, amelyet később az Endeavour Mining vásárolt fel. A komplexum több külszíni fejtésből és egy nagy kapacitású feldolgozóüzemből áll, amely szén-kilúgozási (CIL) technológiát alkalmaz az arany kinyerésére. A Mana bánya kiemelkedő szerepet játszik az ország gazdaságában, jelentős exportbevételt és adóbevételt generálva az állam számára. A bánya életciklusát jelentősen meghosszabbította a Siou nevű, magas aranytartalmú műholdas lelőhely felfedezése és kiaknázása. A bányatársaság nagy hangsúlyt fektet a társadalmi felelősségvállalásra, támogatva a helyi oktatást, egészségügyet és vízellátást. A térség biztonsági kihívásai ellenére a Mana továbbra is a modern burkinai bányászat egyik zászlóshajója, amely nemzetközi standardok szerint működik és több száz embernek ad munkát.",
      ro: "Mina de aur Mana este una dintre cele mai importante operațiuni miniere din Burkina Faso, situată în regiunea Mouhoun, la aproximativ 200 de kilometri vest de capitala Ouagadougou. Producția comercială a început în anul 2008 sub administrarea companiei SEMAFO, care a fost ulterior achiziționată de Endeavour Mining. Facilitatea cuprinde mai multe cariere deschise și o unitate de procesare de mare capacitate care utilizează tehnologia de lixiviere cu carbon (CIL) pentru extragerea aurului. Mana a demonstrat o productivitate remarcabilă, contribuind substanțial la veniturile din export și la produsul intern brut al țării. Un moment cheie în istoria minei a fost integrarea zăcământului de înaltă puritate Siou, care a prelungit semnificativ durata de viață a exploatării. Pe lângă activitatea industrială, compania investește în proiecte de dezvoltare comunitară, îmbunătățind infrastructura locală și serviciile de sănătate. În ciuda contextului regional dificil, mina Mana rămâne un pilon al sectorului extractiv național, reprezentând un model de exploatare la scară largă în Africa de Vest.",
      en: "The Mana Gold Mine is a significant industrial gold mining operation located in the Mouhoun region of western Burkina Faso, approximately 200 kilometers west of the capital, Ouagadougou. Commercial production at the site commenced in 2008 under the management of SEMAFO, which was later acquired by Endeavour Mining. The facility consists of several open-pit mines and a large processing plant that utilizes carbon-in-leach (CIL) technology to extract gold from the ore. It plays a crucial role in the national economy, contributing substantially to export revenues and providing employment for hundreds of local workers. The mine has undergone multiple expansions to increase its processing capacity and extend its operational life, notably through the integration of the high-grade Siou satellite deposit. Environmental monitoring and community development programs are integral parts of its operations, reflecting modern standards in the Burkinabe mining sector. Despite regional security challenges, Mana remains a flagship project that demonstrates the potential of large-scale mineral resource management in the Sahel.",
    },
    factsAdvanced: {
      de: ["Die kommerzielle Produktion in der Mana-Mine begann im März 2008.", "Sie liegt etwa 200 km westlich der Hauptstadt Ouagadougou.", "Seit 2020 gehört die Mine zum Portfolio von Endeavour Mining.", "Die Verarbeitungsanlage hat eine Kapazität von etwa 2,4 Millionen Tonnen Erz pro Jahr.", "Die Mine nutzt das Carbon-in-Leach-Verfahren zur Goldgewinnung.", "In Spitzenjahren produzierte Mana über 200.000 Unzen Gold jährlich."],
  ...
  {
    id: "taparko-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-NAM",
    coords: [-0.4283, 13.5606],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Taparko-Goldmine in der Provinz Namantenga ist historisch bedeutsam, da sie die erste moderne Goldmine war, die nach der Unabhängigkeit Burkina Fasos in Betrieb genommen wurde. Die Mine, die etwa 200 Kilometer nordöstlich von Ouagadougou liegt, begann ihre kommerzielle Produktion im Jahr 2007. Sie wurde ursprünglich von der Somita SA betrieben, einer Tochtergesellschaft von High River Gold, bevor sie Teil des Portfolios der Nordgold-Gruppe wurde. Die Anlage umfasst mehrere Tagebaue und eine spezialisierte Mühle zur Erzverarbeitung. Taparko spielte eine Pionierrolle bei der Etablierung des modernen Bergbaurechts in Burkina Faso und diente als Vorbild für spätere Großprojekte. Über die Jahre hat die Mine wesentlich zu den Staatseinnahmen beigetragen und Infrastrukturprojekte in der Region unterstützt. In jüngster Zeit sah sich der Betrieb jedoch mit erheblichen Sicherheitsherausforderungen aufgrund der instabilen Lage im Norden des Landes konfrontiert. Dennoch bleibt Taparko ein Symbol für den Beginn des Goldbergbau-Booms, der Burkina Faso zu einem der führenden Goldproduzenten Afrikas gemacht hat.",
      hu: "A Taparko aranybánya a Namantenga tartományban található, és történelmi jelentőségű létesítmény, mivel ez volt az első modern, nagyüzemi aranybánya, amely Burkina Faso függetlenné válása után megnyílt. A kereskedelmi termelés 2007-ben indult meg, mérföldkövet jelentve az ország ipari fejlődésében. A bánya Ouagadougoutól mintegy 200 kilométerre északkeletre fekszik, és eredetileg a Somita SA (a High River Gold leányvállalata) üzemeltette, mielőtt az orosz Nordgold csoporthoz került volna. A létesítmény több külszíni fejtési területet foglal magában, és saját feldolgozóüzemmel rendelkezik. Taparko úttörő szerepet játszott a burkinai bányászati jogszabályok és környezetvédelmi előírások gyakorlati alkalmazásában. Az üzem az évek során jelentős mennyiségű nemesfémet termelt ki, hozzájárulva a nemzeti költségvetéshez és a helyi gazdaság élénkítéséhez. Bár a közelmúltban a régió biztonsági helyzete nehézségeket okozott az üzemeltetésben, a Taparko bánya továbbra is a modern burkinai aranybányászat kezdetének szimbóluma marad.",
      ro: "Mina de aur Taparko, situată în provincia Namantenga, deține o importanță istorică deosebită, fiind prima mină de aur modernă deschisă în Burkina Faso după obținerea independenței. Situată la aproximativ 200 de kilometri nord-est de capitala Ouagadougou, exploatarea a început producția comercială în anul 2007. Proiectul a fost dezvoltat inițial de Somita SA, o filială a High River Gold, și a trecut ulterior în portofoliul grupului internațional Nordgold. Facilitatea cuprinde diverse cariere deschise și o unitate de măcinare și procesare a minereului. Taparko a servit drept pionier pentru sectorul minier național, stabilind standarde pentru proiectele ulterioare de mare anvergură. Pe parcursul funcționării sale, mina a generat venituri fiscale majore pentru stat și a sprijinit dezvoltarea infrastructurii în zonele rurale învecinate. Deși în ultimii ani s-a confruntat cu provocări legate de securitatea regională, Taparko rămâne un punct de referință în transformarea Burkinei Faso într-unul dintre principalii producători de aur de pe continentul african.",
      en: "The Taparko Gold Mine, located in the Namantenga Province, holds significant historical importance as the first modern, large-scale gold mine to be commissioned in Burkina Faso following the country's independence. Situated approximately 200 kilometers northeast of Ouagadougou, the mine commenced commercial production in 2007. It was originally operated by Somita SA, a subsidiary of High River Gold, before becoming part of the Nordgold Group's portfolio. The facility includes several open-pit operations and a dedicated ore processing mill. Taparko played a pioneering role in establishing modern mining regulations and environmental standards in the country. Over its lifespan, the mine has contributed substantially to national tax revenues and local economic growth. Although operations have faced recent challenges due to regional security issues in northern Burkina Faso, Taparko remains a symbol of the beginning of the mining boom that elevated the nation to its current status as a leading African gold producer.",
    },
    factsAdvanced: {
      de: ["Taparko war die erste moderne Goldmine Burkina Fasos (Start 2007).", "Die Mine liegt in der Provinz Namantenga, nordöstlich von Ouagadougou.", "Das Unternehmen Nordgold übernahm die Mehrheitsanteile an der Mine.", "Die Anlage verarbeitet Erz aus den Lagerstätten Taparko und Bouroum.", "In ihrer Blütezeit beschäftigte die Mine über 600 Festangestellte.", "Die Mine leistete Pionierarbeit bei der Einführung von CSR-Programmen im Land."],
  ...
  {
    id: "bissa-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-BAM",
    coords: [-1.4881, 13.1678],
    name: {
      de: "Bissa Gold Mine",
      hu: "Bissa Gold Mine",
      ro: "Bissa Gold Mine",
      en: "Bissa Gold Mine"},
    descriptionAdvanced: {
      de: "Die Bissa-Goldmine ist ein bedeutendes Bergbauprojekt in der Provinz Bam in Burkina Faso, etwa 85 Kilometer nördlich von Ouagadougou. Die Mine wurde im Jahr 2013 offiziell eingeweiht und wird von der Bissa Gold SA betrieben, die zur internationalen Nordgold-Gruppe gehört. Als moderne Tagebauanlage konzipiert, verfügt Bissa über eine hocheffiziente Verarbeitungsanlage, die Gold mittels des Carbon-in-Leach-Verfahrens gewinnt. Seit ihrer Inbetriebnahme hat sich Bissa zu einem der leistungsstärksten Standorte des Landes entwickelt und trägt massiv zu den nationalen Exporterträgen bei. Das Projekt zeichnet sich durch seine strategische Lage und die Nähe zur Hauptstadt aus, was die Logistik und Versorgung erleichtert. Nordgold hat zudem in die Erschließung benachbarter Lagerstätten wie Bouly investiert, um die Kapazitäten des Standorts weiter zu optimieren. Die Mine engagiert sich stark in der lokalen Gemeinschaft, insbesondere durch den Bau von Schulen, Brunnen und Gesundheitszentren, wodurch sie einen wichtigen Beitrag zur regionalen sozioökonomischen Entwicklung leistet.",
      hu: "A Bissa aranybánya Burkina Faso Bam tartományában található, mintegy 85 kilométerre északra a fővárostól, Ouagadougoutól. A bányát 2013-ban helyezték üzembe, és a nemzetközi Nordgold csoporthoz tartozó Bissa Gold SA üzemelteti. A létesítmény egy modern külszíni fejtésű komplexum, amelynek saját, nagy hatékonyságú feldolgozóüzeme van, ahol szén-kilúgozási technológiával nyerik ki az aranyat. Megnyitása óta a Bissa az ország egyik legnagyobb termelékenységű bányájává vált, jelentős devizabevételt biztosítva az államnak. A bánya közelsége a fővároshoz logisztikai előnyt jelent, megkönnyítve a szakemberek és az alapanyagok mozgását. A Nordgold a kapacitások maximalizálása érdekében a szomszédos Bouly lelőhelyet is bevonta a termelésbe, közös infrastruktúrát használva. A vállalat aktívan részt vesz a környező falvak életének javításában, oktatási és egészségügyi projekteket finanszírozva, ami segít fenntartani a jó kapcsolatot a helyi közösségekkel.",
      ro: "Mina de aur Bissa este un proiect minier major situat în provincia Bam din Burkina Faso, la aproximativ 85 de kilometri nord de Ouagadougou. Inaugurată oficial în 2013, mina este operată de Bissa Gold SA, membră a grupului internațional Nordgold. Concepută ca o exploatare modernă la suprafață, Bissa dispune de o unitate de procesare extrem de eficientă care utilizează metoda de lixiviere cu carbon. De la punerea sa în funcțiune, Bissa s-a impus ca una dintre cele mai productive mine din țară, având o contribuție masivă la veniturile naționale din export. Poziția sa strategică, relativ aproape de capitală, facilitează logistica și aprovizionarea cu resurse esențiale. Grupul Nordgold a extins operațiunile prin integrarea zăcământului adiacent Bouly, optimizând utilizarea infrastructurii existente. Pe lângă impactul economic, mina este recunoscută pentru inițiativele sale de responsabilitate socială, investind în construcția de școli, fântâni și centre de sănătate pentru populația locală din regiunea Centru-Nord.",
      en: "The Bissa Gold Mine is a major mining project located in the Bam Province of Burkina Faso, approximately 85 kilometers north of the capital, Ouagadougou. Officially inaugurated in 2013, the mine is operated by Bissa Gold SA, a subsidiary of the international Nordgold Group. Designed as a modern open-pit operation, Bissa features a highly efficient processing plant that extracts gold using the carbon-in-leach (CIL) method. Since its commencement, Bissa has become one of the highest-performing mines in the country, contributing significantly to national export revenues. Its strategic location near the capital provides logistical advantages for supply chains and workforce management. Nordgold has further optimized the site by integrating the nearby Bouly deposit, sharing infrastructure to increase overall output. The mine is deeply involved in local community development, funding the construction of schools, water wells, and health centers, thus playing a vital role in the socio-economic advancement of the North-Central region.",
    },
    factsAdvanced: {
      de: ["Bissa wurde im Januar 2013 nach nur 15 Monaten Bauzeit eröffnet.", "Die Mine liegt etwa 85 km nördlich von Ouagadougou in der Provinz Bam.", "Eigentümer ist das Unternehmen Nordgold mit einer Beteiligung von 90%.", "Die jährliche Goldproduktion überstieg oft 200.000 Unzen.", "Bissa teilt sich Infrastruktur mit der benachbarten Bouly-Lagerstätte.", "Über 95% der Belegschaft in der Mine sind burkinische Staatsbürger."],
  ...
  {
    id: "karma-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-YAT",
    coords: [-2.4833, 13.7833],
    name: {
      de: "Karma Gold Mine",
      hu: "Karma Gold Mine",
      ro: "Karma Gold Mine",
    ...
    descriptionAdvanced: {
      de: "Die Karma-Goldmine befindet sich in der Provinz Yatenga im Norden Burkina Fasos, nahe der Stadt Ouahigouya. Die kommerzielle Produktion begann im Jahr 2016 und wurde ursprünglich von Riverstone Resources und später von Teranga Gold vorangetrieben, bevor sie in den Besitz von Endeavour Mining überging. Karma unterscheidet sich von vielen anderen Minen im Land durch die Nutzung der Haufenlaugungstechnologie (Heap Leach), die besonders effizient für die Verarbeitung von oxidischem Erz bei geringeren Betriebskosten ist. Die Anlage umfasst mehrere flache Tagebaue, was einen relativ einfachen Abbau ermöglicht. Geografisch liegt die Mine in einer halbtrockenen Region, was innovative Lösungen für das Wassermanagement erforderte. Karma hat sich als wichtiger lokaler Arbeitgeber etabliert und trägt zur Stabilisierung der Wirtschaft in der Nordregion bei. Das Unternehmen legt großen Wert auf die Einbindung der lokalen Gemeinschaft, um die Akzeptanz des Bergbaus in der historisch bedeutsamen Yatenga-Provinz zu sichern und nachhaltige Entwicklungschancen zu schaffen.",
      hu: "A Karma aranybánya Burkina Faso északi részén, Yatenga tartományban található, Ouahigouya városa közelében. A bánya 2016-ban kezdte meg a kereskedelmi termelést, eredetileg a Riverstone Resources fejlesztette, majd a Teranga Gold, végül pedig az Endeavour Mining tulajdonába került. A Karma különlegessége, hogy a legtöbb burkinai bányával ellentétben halom-kilúgozási (heap leach) technológiát alkalmaz, amely költséghatékonyabb megoldást kínál az oxidált ércek feldolgozására. A komplexum több sekély külszíni fejtésből áll, amelyek elszórtan helyezkednek el a bányaterületen. Az üzemeltetés során nagy figyelmet fordítanak a vízgazdálkodásra, mivel a régió száraz éghajlatú. A bánya jelentős mértékben hozzájárul Yatenga tartomány gazdasági fejlődéséhez, munkahelyeket teremtve és támogatva a helyi infrastruktúrát. A társadalmi felelősségvállalás keretében a vállalat számos projektet indított a helyi mezőgazdaság és oktatás korszerűsítésére, törekedve a bányászat és a közösségi érdekek összehangolására.",
      ro: "Mina de aur Karma este situată în provincia Yatenga din nordul Burkinei Faso, în apropierea orașului Ouahigouya. Producția comercială a debutat în anul 2016, proiectul fiind dezvoltat inițial de Riverstone Resources și Teranga Gold, înainte de a fi preluat de Endeavour Mining. Karma se distinge de alte exploatări din țară prin utilizarea tehnologiei de lixiviere în grămezi (heap leach), o metodă eficientă din punct de vedere al costurilor pentru procesarea minereurilor oxidate. Facilitatea include mai multe cariere deschise de mică adâncime, repartizate pe o suprafață extinsă. Având în vedere locația sa într-o zonă semiaridă, mina implementează sisteme riguroase de gestionare a resurselor de apă. Din punct de vedere economic, Karma este un motor important pentru regiunea de nord, oferind locuri de muncă și contracte furnizorilor locali. Compania colaborează strâns cu autoritățile tradiționale și locale din Yatenga pentru a asigura beneficii pe termen lung comunității, inclusiv în domeniul educației și al securității alimentare.",
      en: "The Karma Gold Mine is located in the Yatenga Province of northern Burkina Faso, near the city of Ouahigouya. Commercial production began in 2016, with the project developed initially by Riverstone Resources and Teranga Gold before its acquisition by Endeavour Mining. Karma is unique among Burkinabe mines for its use of heap leach technology, which is particularly cost-effective for processing oxide ores. The operation comprises several shallow open pits distributed across a large permitted area. Situated in a semi-arid region, the mine employs innovative water management strategies to maintain operations while respecting local environmental constraints. Karma has become a vital economic pillar for the northern region, providing stable employment and supporting regional infrastructure. The company emphasizes strong community engagement and has implemented various social programs aimed at agricultural development and education, ensuring that the benefits of mining are shared with the residents of the historically significant Yatenga Province.",
    },
    factsAdvanced: {
      de: ["Die kommerzielle Produktion der Karma-Mine startete im Jahr 2016.", "Sie nutzt die Haufenlaugungstechnologie, was in Burkina Faso selten ist.", "Die Mine befindet sich etwa 20 km von der Stadt Ouahigouya entfernt.", "Karma wurde 2022 von Endeavour Mining an Néré Mining verkauft.", "Das Projekt umfasst sechs verschiedene Lagerstätten (z.B. Kao, Goulagou).", "Die jährliche Produktionskapazität liegt bei etwa 100.000 Unzen Gold."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Yaramoko-Goldmine, gelegen in der Gemeinde Bagassi in der Provinz Balé, ist eine der außergewöhnlichsten Bergbauoperationen in Burkina Faso. Im Gegensatz zu den meisten anderen Minen des Landes handelt es sich hierbei primär um eine hochgradige Untertagemine. Die kommerzielle Produktion begann im Jahr 2016 unter der Leitung von Roxgold, das später von Fortuna Silver Mines übernommen wurde. Yaramoko zeichnet sich durch extrem hohe Goldgehalte im Erz aus, was die Mine trotz ihrer kleineren physischen Ausdehnung zu einer der profitabelsten des Landes macht. Die Anlage nutzt modernste Bergbautechnologie für den Tiefbau und eine kompakte, hocheffiziente Verarbeitungsanlage. Der Betrieb hat die wirtschaftliche Dynamik der Bagassi-Region grundlegend verändert und bietet hochqualifizierte Arbeitsplätze für burkinische Bergleute. Das Unternehmen engagiert sich vorbildlich im Umweltschutz und in der kommunalen Entwicklung, wobei der Fokus auf nachhaltiger Landwirtschaft und Bildung liegt. Yaramoko gilt als Musterbeispiel dafür, wie durch technologische Exzellenz auch tief liegende Ressourcen sicher und wirtschaftlich gewonnen werden können.",
      hu: "A Yaramoko aranybánya Balé tartományban, Bagassi település közelében található, és Burkina Faso egyik legkülönlegesebb bányászati létesítménye. Eltérően az ország legtöbb bányájától, a Yaramoko elsősorban mélyművelésű (föld alatti) bánya, amely rendkívül magas aranytartalmú ércet termel ki. A kereskedelmi termelés 2016-ban indult meg a Roxgold vezetésével, amelyet később a Fortuna Silver Mines vásárolt fel. A bánya hatékonysága kimagasló: viszonylag kis mennyiségű kőzet feldolgozásával is jelentős mennyiségű aranyat képes előállítani. A létesítmény modern technológiát alkalmaz a föld alatti vájatok biztosítására és az érc felszínre hozatalára. Yaramoko megnyitása fellendítette Bagassi gazdaságát, számos helyi vállalkozásnak és szakembernek adva munkát. A bányatársaság híres szigorú biztonsági előírásairól és fenntarthatósági programjairól, amelyek segítik a helyi közösségek hosszú távú fejlődését. Ez a projekt bizonyítja, hogy a burkinai bányászat a külszíni fejtéseken túl is komoly potenciállal rendelkezik a mélyebb rétegekben.",
      ro: "Mina de aur Yaramoko, situată în comuna Bagassi din provincia Balé, reprezintă una dintre cele mai performante operațiuni miniere din Burkina Faso. Spre deosebire de majoritatea minelor din țară, Yaramoko este în principal o exploatare subterană, vizând zăcăminte cu o puritate extrem de ridicată. Producția comercială a început în 2016 sub egida companiei Roxgold, care a fost ulterior preluată de Fortuna Silver Mines. Mina este recunoscută pentru eficiența sa operațională remarcabilă, producând volume mari de aur dintr-o cantitate relativ mică de minereu procesat. Facilitatea utilizează tehnici avansate de foraj subteran și o uzină de procesare compactă, dar foarte modernă. Impactul economic asupra regiunii Bagassi a fost transformator, generând locuri de muncă specializate și oportunități de afaceri pentru furnizorii locali. Yaramoko este adesea citată ca un model de excelență tehnică și responsabilitate socială, implementând standarde riguroase de siguranță și investind constant în programe de educație și sănătate pentru comunitatea înconjurătoare.",
      en: "The Yaramoko Gold Mine, located in the Bagassi commune of Balé Province, is one of the most distinctive mining operations in Burkina Faso. Unlike the majority of the country's mines, Yaramoko is primarily a high-grade underground operation. Commercial production commenced in 2016 under the management of Roxgold, which was later acquired by Fortuna Silver Mines. The mine is renowned for its exceptional ore grades, making it one of the most profitable operations in the nation despite its relatively small physical footprint. The facility employs advanced underground mining techniques and a compact, high-efficiency processing plant. The opening of Yaramoko has fundamentally altered the economic landscape of the Bagassi region, providing highly skilled employment for Burkinabe miners. The company maintains an exemplary record in environmental stewardship and community development, focusing on sustainable agriculture and education initiatives. Yaramoko serves as a prime example of how technological excellence can enable the safe and economic extraction of deep-seated mineral resources in West Africa.",
    },
    factsAdvanced: {
      de: ["Yaramoko begann im Juni 2016 mit der kommerziellen Goldproduktion.", "Es ist eine der wenigen reinen Untertageminen in Burkina Faso.", "Die Mine gehört seit 2021 zum Unternehmen Fortuna Silver Mines.", "Das Erz am Standort Bagassi South hat einen Goldgehalt von über 10g/t.", "Die Verarbeitungsanlage erreicht eine Goldgewinnungsrate von fast 99%.", "Die Mine wurde innerhalb des Budgets und vor dem Zeitplan fertiggestellt."],
  ...
  {
    id: "ziga-water-treatment-economic-v2",
    type: "industry",
    parent: "BF-OUB",
    coords: [-1.0833, 12.6167],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Ziga-Wasseraufbereitungsanlage ist eine lebenswichtige Infrastruktureinrichtung für die Hauptstadt Burkina Fasos, Ouagadougou. Sie befindet sich etwa 50 Kilometer nordöstlich der Stadt am Ziga-Staudamm, der den Nakambé-Fluss staut. Das Projekt wurde in mehreren Phasen realisiert, wobei Ziga I im Jahr 2004 in Betrieb ging und Ziga II im Jahr 2017 fertiggestellt wurde, um der schnell wachsenden Bevölkerung gerecht zu werden. Die Anlage wird von der staatlichen Wassergesellschaft ONEA betrieben und nutzt moderne Filter- und Reinigungstechnologien, um Trinkwasser nach internationalen Standards zu produzieren. Durch groß angelegte Leitungssysteme wird das aufbereitete Wasser in die Hauptstadt transportiert, wodurch die Abhängigkeit von unsicheren Grundwasserquellen verringert wurde. Die Finanzierung dieses strategischen Großprojekts erfolgte durch eine Kooperation der burkinischen Regierung mit internationalen Partnern wie der Weltbank und der Agence Française de Développement (AFD). Ziga ist nicht nur ein technologisches Meisterwerk der Wasserbaukunst in der Sahelzone, sondern auch ein entscheidender Faktor für die öffentliche Gesundheit und die wirtschaftliche Stabilität der Metropolregion.",
      hu: "A Ziga víztisztító mű Burkina Faso fővárosa, Ouagadougou ivóvízellátásának legfontosabb pillére. A létesítmény mintegy 50 kilométerre északkeletre található a várostól, a Nakambé folyón kialakított Ziga-gát mellett. A projekt több szakaszban valósult meg: a Ziga I. ütem 2004-ben kezdte meg működését, míg a Ziga II. bővítést 2017-ben adták át a gyorsan növekvő lakossági igények kielégítésére. Az üzemet az állami ONEA (Office National de l'Eau et de l'Assainissement) kezeli, és modern szűrési és fertőtlenítési technológiákat alkalmaz az ivóvíz minőségének biztosítására. A megtisztított vizet hatalmas csővezetékeken keresztül juttatják el a fővárosba, ami radikálisan javította Ouagadougou vízellátásának biztonságát és csökkentette a vízszegénységet. A beruházást nemzetközi szervezetek, köztük a Világbank és a Francia Fejlesztési Ügynökség (AFD) támogatták. A Ziga projekt sikere létfontosságú a közegészségügy szempontjából, és alapvető feltétele a főváros további gazdasági fejlődésének a száraz Sahel-övezetben.",
      ro: "Stația de tratare a apei de la Ziga este o infrastructură vitală pentru aprovizionarea cu apă potabilă a capitalei Burkinei Faso, Ouagadougou. Situată la aproximativ 50 de kilometri nord-est de oraș, stația utilizează resursele acumulate de barajul Ziga pe râul Nakambé. Proiectul a fost implementat în mai multe etape, Ziga I fiind inaugurat în 2004, iar Ziga II fiind finalizat în 2017 pentru a face față creșterii rapide a populației urbane. Operată de compania națională ONEA, stația dispune de procese moderne de sedimentare, filtrare și dezinfecție, asigurând apă conform standardelor internaționale de sănătate. Apa tratată este transportată prin conducte magistrale către capitală, reducând drastic dependența de puțurile de mare adâncime și ameliorând crizele recurente de apă. Finanțarea acestui proiect strategic a fost asigurată prin parteneriate cu instituții internaționale precum Banca Mondială și Agenția Franceză de Dezvoltare (AFD). Ziga reprezintă un succes major în gestionarea resurselor de apă într-o regiune aridă, fiind esențială pentru stabilitatea socială și economică a metropolei.",
      en: "The Ziga Water Treatment Plant is a vital infrastructure facility dedicated to supplying potable water to Burkina Faso's capital, Ouagadougou. Located approximately 50 kilometers northeast of the city, the plant is fed by the Ziga Dam on the Nakambé River. The project was realized in multiple phases, with Ziga I commencing operations in 2004 and the Ziga II expansion completed in 2017 to meet the demands of a rapidly growing urban population. Managed by the national water utility ONEA, the plant employs modern sedimentation, filtration, and disinfection technologies to ensure water quality meets international standards. Treated water is transported via large-scale pipelines to the capital, significantly reducing reliance on seasonal groundwater and mitigating water shortages. This strategic project was funded through cooperation between the Burkinabe government and international partners such as the World Bank and the Agence Française de Développement (AFD). Ziga stands as a monumental achievement in water resource management in the Sahel, playing a critical role in public health and the economic stability of the metropolitan region.",
    },
    factsAdvanced: {
      de: ["Die Ziga-Talsperre hat ein Fassungsvermögen von etwa 200 Millionen Kubikmetern.", "Die erste Phase des Projekts (Ziga I) wurde im Jahr 2004 eingeweiht.", "Mit Ziga II verdoppelte sich die Trinkwasserproduktion im Jahr 2017.", "Die Anlage versorgt über 2 Millionen Menschen in Ouagadougou mit Wasser.", "Die Hauptleitung von Ziga in die Stadt ist über 50 km lang.", "ONEA nutzt die Anlage zur Reduzierung wasserbedingter Krankheiten in der Region."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Zementwerk CIMFASO (Ciments du Faso) ist eine moderne Industrieanlage in der Industriezone Kossodo von Ouagadougou. Das Werk wurde 2015 offiziell eingeweiht und ist ein Projekt der Cim Metal Group, unter der Leitung des Unternehmers Inoussa Kanazoé. Mit einer beeindruckenden Produktionskapazität spielt CIMFASO eine zentrale Rolle beim Bauboom in Burkina Faso und reduziert die Abhängigkeit des Landes von teuren Zementimporten aus den Nachbarländern. Die Fabrik nutzt fortschrittliche Mahltechnologie, um hochwertigen Zement für private und öffentliche Infrastrukturprojekte herzustellen. Durch die Schaffung hunderter direkter und indirekter Arbeitsplätze trägt das Werk wesentlich zur industriellen Entwicklung und zur Stärkung der lokalen Wirtschaft bei. Das Unternehmen legt Wert auf Qualitätssicherung und hält verschiedene internationale Zertifizierungen ein. CIMFASO ist ein Beispiel für den Erfolg lokaler Investitionen in den Industriesektor Burkina Fasos und unterstützt die nationale Strategie zur Förderung der heimischen Produktion und Urbanisierung.",
      hu: "A CIMFASO (Ciments du Faso) cementgyár egy modern ipari létesítmény, amely Ouagadougou Kossodo nevű ipari negyedében található. A gyárat 2015-ben adták át, és a Cim Metal Group részeként jött létre, amely Burkina Faso egyik jelentős vállalatbirodalma. A létesítmény éves szinten több mint egymillió tonna cement előállítására képes, ami kulcsfontosságú az országban zajló építkezési hullám és urbanizáció fenntartásához. A CIMFASO megalapítása jelentősen csökkentette az ország függőségét az importált építőanyagoktól, stabilizálva a piaci árakat. A gyár modern őrlési technológiát alkalmaz, és többféle minőségi kategóriájú cementet állít elő a lakossági és az ipari felhasználók számára. Az üzem több száz embernek ad munkát, és hozzájárul a helyi mérnöki szaktudás fejlődéséhez. A vállalat elkötelezett a környezetvédelmi előírások betartása mellett, és folyamatosan fejleszti logisztikai hálózatát, hogy az ország minden részébe eljuttassa termékeit.",
      ro: "Fabrica de ciment CIMFASO (Ciments du Faso) este o unitate industrială modernă situată în zona industrială Kossodo din Ouagadougou. Inaugurată oficial în 2015, fabrica este o investiție majoră a Cim Metal Group, sub conducerea omului de afaceri Inoussa Kanazoé. Cu o capacitate de producție impresionantă, CIMFASO joacă un rol central în susținerea sectorului construcțiilor din Burkina Faso, reducând dependența țării de importurile costisitoare de ciment din statele vecine. Fabrica utilizează tehnologii avansate de măcinare a clincherului pentru a produce ciment de înaltă calitate, esențial pentru proiectele de infrastructură publică și privată. Prin crearea a sute de locuri de muncă directe și indirecte, unitatea contribuie semnificativ la dezvoltarea industrială și la consolidarea economiei locale. Compania pune un accent deosebit pe controlul calității și respectă diverse certificări internaționale. CIMFASO reprezintă un exemplu de succes al investițiilor private autohtone în sectorul manufacturier, sprijinind strategia națională de industrializare și urbanizare.",
      en: "The CIMFASO (Ciments du Faso) cement plant is a modern industrial facility located in the Kossodo industrial zone of Ouagadougou. Officially inaugurated in 2015, the plant is a flagship project of the Cim Metal Group, led by entrepreneur Inoussa Kanazoé. Boasting a high production capacity, CIMFASO plays a central role in supporting the construction boom in Burkina Faso and reducing the country's reliance on expensive cement imports from neighboring nations. The factory utilizes advanced grinding technology to produce high-quality cement suitable for both residential and large-scale public infrastructure projects. By creating hundreds of direct and indirect jobs, the plant significantly contributes to industrial development and the strengthening of the local economy. The company prioritizes quality control and adheres to various international standards and certifications. CIMFASO serves as a prime example of successful local investment in Burkina Faso's industrial sector, aligning with national goals for self-sufficiency and urbanization.",
    },
    factsAdvanced: {
      de: ["CIMFASO wurde im März 2015 offiziell in Betrieb genommen.", "Die Fabrik befindet sich in der Industriezone Kossodo in Ouagadougou.", "Die Produktionskapazität beträgt etwa 1,2 Millionen Tonnen Zement pro Jahr.", "Das Unternehmen gehört zur burkinischen Cim Metal Group.", "Das Werk produziert verschiedene Zementsorten (z. B. CPJ 35 und CPJ 45).", "Die Investitionssumme für das Werk belief sich auf über 30 Milliarden FCFA."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die SOFITEX-Anlage in Koudougou ist eine zentrale Entkörnungsfabrik der Société des Fibres Textiles, des größten Baumwollunternehmens in Burkina Faso. Koudougou, historisch als Stadt der Textilien bekannt, beherbergt diese wichtige industrielle Einheit, die die Ernten der Baumwollbauern aus der Region Centre-Ouest verarbeitet. Der Prozess umfasst die Trennung der Baumwollfasern von den Samen, wonach die Fasern zu Ballen gepresst und für den Export oder die lokale Weiterverarbeitung vorbereitet werden. SOFITEX spielt eine entscheidende Rolle für das wirtschaftliche Überleben von Millionen von Burkinabé, da Baumwolle das Hauptexportgut des Landes ist. Die Fabrik in Koudougou ist ein Symbol für die industrielle Tradition der Stadt, die einst das Zentrum der nationalen Textilindustrie (Faso Fani) war. Trotz des Niedergangs einiger Fabriken bleibt der SOFITEX-Standort ein wichtiger Arbeitgeber und Motor für die lokale Logistik und den Handel. Das Unternehmen investiert kontinuierlich in die Modernisierung der Maschinen, um die Qualität der Fasern zu sichern und die Wettbewerbsfähigkeit auf dem Weltmarkt zu erhalten.",
      hu: "A koudougoui SOFITEX üzem a Société des Fibres Textiles, Burkina Faso legnagyobb gyapotvállalatának egyik kulcsfontosságú magozó és feldolgozó egysége. Koudougou városa, amelyet hagyományosan a textilek városaként ismernek, stratégiai helyszín a Centre-Ouest régió gyapottermésének begyűjtésére és elsődleges feldolgozására. Az üzemben történik a gyapotrostok elválasztása a magoktól, majd a rostokat bálákba préselik az exportra vagy a helyi gyárak számára. A SOFITEX tevékenysége létfontosságú az ország gazdasága számára, mivel a gyapot Burkina Faso legfontosabb mezőgazdasági exportcikke. A koudougoui gyár fenntartja a város ipari hagyományait, amelyek a néhai Faso Fani textilgyár örökségéhez kötődnek. Az üzem több száz idénymunkásnak és állandó alkalmazottnak ad munkát, fellendítve a helyi kereskedelmet és szállítmányozást. A vállalat szorosan együttműködik a termelői szövetkezetekkel, technikai segítséget és vetőmagot biztosítva a gazdáknak, ezzel garantálva a nyersanyag utánpótlását és a rostok kiváló minőségét.",
      ro: "Unitatea SOFITEX din Koudougou este o fabrică strategică de egrenare a bumbacului, operată de Société des Fibres Textiles, cea mai mare companie de profil din Burkina Faso. Orașul Koudougou, cunoscut istoric drept capitala textilă a țării, găzduiește această unitate industrială care procesează recoltele fermierilor din regiunea Centru-Vest. Procesul de egrenare constă în separarea fibrelor de bumbac de semințe, fibrele fiind ulterior presate în baloți pentru export sau pentru industria locală. SOFITEX joacă un rol determinant în economia națională, bumbacul fiind principala sursă de valută din sectorul agricol. Fabrica din Koudougou este un simbol al rezilienței industriale a orașului, care a fost în trecut inima industriei textile naționale (prin fabrica Faso Fani). Unitatea oferă locuri de muncă pentru sute de persoane și stimulează activitățile conexe de transport și servicii în regiune. Prin investiții în modernizarea echipamentelor, SOFITEX se asigură că fibrele produse îndeplinesc standardele internaționale de calitate cerute pe piețele globale de profil.",
      en: "The SOFITEX facility in Koudougou is a crucial cotton ginning plant operated by the Société des Fibres Textiles, the largest cotton company in Burkina Faso. Koudougou, historically recognized as the nation's textile capital, hosts this significant industrial unit that processes harvests from cotton farmers across the Centre-Ouest region. The ginning process involves separating cotton fibers from the seeds, after which the fibers are pressed into bales for export or local processing. SOFITEX plays a vital role in the economic livelihood of millions of Burkinabes, as cotton remains the country's primary agricultural export. The Koudougou plant embodies the city's industrial heritage, which was once anchored by the famous Faso Fani textile factory. The facility provides employment to hundreds of permanent and seasonal workers, driving local commerce and logistics. The company continuously invests in upgrading its machinery to maintain fiber quality and ensure competitiveness in the global commodities market, while also providing essential support to rural farming cooperatives.",
    },
    factsAdvanced: {
      de: ["SOFITEX ist das größte halbstaatliche Unternehmen im Baumwollsektor.", "Die Fabrik in Koudougou ist auf die Entkörnung von Rohbaumwolle spezialisiert.", "Koudougou liegt etwa 100 km westlich der Hauptstadt Ouagadougou.", "Baumwolle wird in Burkina Faso oft als 'Weißes Gold' bezeichnet.", "Die Anlage verarbeitet jährlich tausende Tonnen Baumwollsaat.", "SOFITEX stellt den Bauern Saatgut und Düngemittel auf Kredit zur Verfügung."],
  ...
  {
    id: "wahgnion-gold-mine-economic-v2",
    type: "industry",
    parent: "BF-LER",
    coords: [-4.85, 10.45],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Wahgnion-Goldmine ist ein modernes Bergbauprojekt im Südwesten Burkina Fasos, gelegen in der Provinz Léraba, nahe der Grenze zur Elfenbeinküste. Die kommerzielle Produktion begann im Jahr 2019 und wurde ursprünglich von Teranga Gold entwickelt, bevor sie durch eine Fusion Teil des Portfolios von Endeavour Mining wurde. Die Anlage umfasst mehrere Tagebaue (wie Nogbele und Fourkoura) und eine hochmoderne Verarbeitungsanlage, die das Carbon-in-Leach-Verfahren (CIL) nutzt. Geografisch liegt die Mine in einer Region mit höherem Niederschlag im Vergleich zum Norden, was spezielle Anforderungen an das Umweltmanagement und die Infrastruktur stellt. Wahgnion hat sich schnell zu einem bedeutenden Wirtschaftsfaktor in der Kascades-Region entwickelt und bietet Arbeitsplätze in einer bisher wenig industrialisierten Zone. Das Unternehmen engagiert sich stark in der lokalen Gemeinschaft, insbesondere bei der Förderung der Landwirtschaft und der beruflichen Bildung für Jugendliche. Wahgnion unterstreicht das enorme Potenzial des Banfora-Grünsteingürtels und trägt zur Diversifizierung der Bergbaustandorte innerhalb Burkina Fasos bei.",
      hu: "A Wahgnion aranybánya Burkina Faso délnyugati részén, Léraba tartományban található, nem messze az elefántcsontparti határtól és Banfora városától. A kereskedelmi termelés 2019 végén indult meg, a projektet eredetileg a Teranga Gold fejlesztette ki, majd az Endeavour Mining tulajdonába került. Ez a komplexum több külszíni fejtésből és egy modern feldolgozóüzemből áll, amely szén-kilúgozási (CIL) technológiával nyeri ki a nemesfémet. A régió csapadékosabb éghajlata miatt a bánya üzemeltetése során kiemelt figyelmet fordítanak a vízelvezetésre és a környezeti hatások minimalizálására. A Wahgnion bánya megjelenése komoly gazdasági lökést adott a Cascade régió számára, amely korábban főként a mezőgazdaságból élt. A bányatársaság számos társadalmi projektet támogat, többek között iskolák felújítását és helyi egészségügyi központok felszerelését. A projekt sikere rávilágított a délnyugati területek ásványkincs-gazdagságára, és tovább erősítette Burkina Faso pozícióját a globális aranypiacon.",
      ro: "Mina de aur Wahgnion este o operațiune minieră modernă situată în sud-vestul Burkinei Faso, în provincia Léraba, aproape de granița cu Coasta de Fildeș. Producția comercială a început în 2019, proiectul fiind dezvoltat inițial de Teranga Gold înainte de integrarea sa în portofoliul Endeavour Mining. Facilitatea include mai multe cariere deschise (precum Nogbele, Fourkoura și Stinger) și o uzină de procesare performantă care utilizează tehnologia CIL. Situată într-o regiune cu vegetație mai densă și precipitații mai bogate decât în nordul țării, mina implementează standarde riguroase de management de mediu. Din punct de vedere economic, Wahgnion a devenit cel mai mare angajator industrial din regiunea Cascades, oferind oportunități de formare profesională pentru tinerii localnici. Compania investește în programe de dezvoltare a agriculturii locale, sprijinind fermierii pentru a aproviziona mina cu produse alimentare. Wahgnion demonstrează potențialul geologic ridicat al centurii de roci verzi din zona Banfora, contribuind la creșterea producției naționale de aur.",
      en: "The Wahgnion Gold Mine is a modern mining project located in southwestern Burkina Faso, in the Léraba Province, near the border with Côte d'Ivoire. Commercial production commenced in 2019, with the project originally developed by Teranga Gold before it became part of Endeavour Mining's assets through a merger. The operation consists of several open pits (including Nogbele and Fourkoura) and a state-of-the-art processing plant utilizing carbon-in-leach (CIL) technology. Situated in a region with higher rainfall compared to the northern Sahelian areas, the mine employs specialized environmental management and infrastructure design to ensure sustainability. Wahgnion has quickly become a major economic engine in the Cascades region, providing employment in a previously under-industrialized area. The company is actively involved in community development, focusing on agricultural support and vocational training for local youth. The success of Wahgnion highlights the significant potential of the Banfora greenstone belt and contributes to the geographical diversification of mining operations within Burkina Faso.",
    },
    factsAdvanced: {
      de: ["Wahgnion nahm die kommerzielle Goldproduktion im November 2019 auf.", "Die Mine liegt etwa 510 km südwestlich der Hauptstadt Ouagadougou.", "Im Jahr 2021 wurde Wahgnion von Endeavour Mining übernommen.", "Die Verarbeitungsanlage hat eine Kapazität von 2,4 Millionen Tonnen pro Jahr.", "Das Projekt umfasst mehrere Lagerstätten innerhalb eines 110 km² großen Areals.", "Die Mine trägt wesentlich zum Infrastrukturausbau in der Provinz Léraba bei."],
  ...
  {
    id: "pouytenga-cattle-market-economic-v2",
    type: "industry",
    parent: "BF-KOU",
    coords: [-0.4, 12.25],
    name: {
    ...
    descriptionAdvanced: {
      de: "Der Viehmarkt von Pouytenga in der Provinz Kouritenga ist einer der bedeutendsten Handelsplätze Westafrikas und ein zentraler Pfeiler der burkinischen Exportwirtschaft. Gelegen an einem strategischen Knotenpunkt, der Ouagadougou mit den Nachbarländern Togo, Ghana und Niger verbindet, zieht der Markt wöchentlich Tausende von Händlern und Viehzüchtern an. Hier werden Rinder, Schafe und Ziegen in riesigen Mengen gehandelt, die oft bis in die Küstenstädte am Golf von Guinea transportiert werden. Die wirtschaftliche Bedeutung von Pouytenga reicht weit über den reinen Viehhandel hinaus, da der Markt das Wachstum von Transportdienstleistungen, Gastgewerbe und lokalem Handwerk massiv fördert. Trotz der informellen Natur vieler Transaktionen spielt der Standort eine entscheidende Rolle für die Ernährungssicherheit und die Deviseneinnahmen des Landes. In den letzten Jahren wurden Anstrengungen unternommen, die Infrastruktur des Marktes zu modernisieren, um den hygienischen Anforderungen und dem steigenden Handelsvolumen gerecht zu werden.",
      hu: "A Kouritenga tartományban található Pouytenga állatpiaca Nyugat-Afrika egyik legnagyobb és legfontosabb kereskedelmi csomópontja, amely kulcsszerepet játszik Burkina Faso gazdaságában. Az ország keleti részén, stratégiai útvonalak kereszteződésében fekvő város piaca mágnesként vonzza a kereskedőket Togóból, Ghánából és Nigerből is. Hetente több ezer szarvasmarhát, juhot és kecskét értékesítenek itt, amelyeket gyakran lábon vagy teherautókon szállítanak a tengerparti országok nagyvárosaiba. A piac nem csupán az állattenyésztőknek ad megélhetést, hanem egy egész szolgáltatási szektort is fenntart, beleértve a szállítmányozást, a takarmánykereskedelmet és a helyi vendéglátást. Pouytenga dinamikus kereskedelmi élete a régió gazdasági motorja, amely jelentősen hozzájárul az ország devizabevételeihez. A modernizációs törekvések célja a higiéniai körülmények javítása és a logisztikai folyamatok hatékonyabbá tétele a növekvő forgalom mellett.",
      ro: "Piața de vite din Pouytenga, situată în provincia Kouritenga, reprezintă unul dintre cele mai mari centre comerciale de acest tip din Africa de Vest, fiind vitală pentru economia statului Burkina Faso. Localizată la o intersecție strategică de drumuri care leagă capitala Ouagadougou de Togo, Ghana și Niger, piața atrage săptămânal mii de comercianți și crescători de animale. Tranzacțiile implică un număr masiv de bovine, ovine și caprine, care sunt ulterior exportate către marile centre urbane de pe coasta Golfului Guineei. Această activitate comercială intensă susține o întreagă rețea economică locală, de la servicii de transport și logistică până la unități de cazare și alimentație publică. Importanța pieței depășește granițele locale, influențând prețurile cărnii în întreaga regiune și asigurând venituri esențiale pentru mii de familii. Recent, autoritățile au început implementarea unor proiecte de modernizare a infrastructurii pentru a gestiona mai eficient fluxul constant de animale și oameni.",
      en: "The Pouytenga Cattle Market, located in the Kouritenga Province, is one of West Africa's most significant commercial hubs and a cornerstone of Burkina Faso's livestock economy. Situated at a strategic crossroads connecting the capital to Togo, Ghana, and Niger, the market attracts thousands of traders and pastoralists every week. It serves as a primary collection point for cattle, sheep, and goats, which are often transported to major coastal cities along the Gulf of Guinea. The economic impact of Pouytenga extends beyond livestock trading, stimulating growth in transportation services, local hospitality, and artisanal crafts. This bustling market is a major source of foreign exchange and plays a crucial role in regional food security and the livelihoods of rural populations. In recent years, there have been ongoing efforts to modernize the market's facilities to better handle the high volume of trade and meet increasing sanitary standards.",
    },
    factsAdvanced: {
      de: ["Der Markt ist ein zentraler Umschlagplatz für den Export nach Ghana und Togo.", "Tausende Tiere werden an jedem Markttag gehandelt.", "Pouytenga liegt etwa 150 Kilometer östlich der Hauptstadt Ouagadougou.", "Der Viehhandel macht einen erheblichen Teil des burkinischen BIP aus.", "Die Stadt dient als wichtiger Logistikknotenpunkt an der Nationalstraße 4.", "Der Markt fördert die grenzüberschreitende Integration in der ECOWAS-Region."],
  ...
  {
    id: "sonabhy-péni-depot-economic-v2",
    type: "industry",
    parent: "BF-HOU",
    coords: [-4.4833, 10.95],
    name: {
    ...
    descriptionAdvanced: {
      de: "Das Brennstoffdepot der SONABHY (Société Nationale Burkinabè d'Hydrocarbures) in Péni, nahe Bobo-Dioulasso, ist eine strategische Infrastrukturanlage zur Sicherung der Energieversorgung Burkina Fasos. Als Binnenland ist das Land vollständig auf Importe angewiesen, und dieses Depot dient als entscheidender Puffer für den Westen des Landes. Die Anlage verfügt über großvolumige Lagertanks für Benzin, Diesel und Flüssiggas, die per Tankwagen aus den Küstenhäfen von Elfenbeinküste und Togo beliefert werden. Durch die Lage in Péni wird die logistische Anbindung an die zweitgrößte Stadt des Landes und das industrielle Herz des Westens optimiert. Die SONABHY nutzt modernste Sicherheitssysteme, um die Brandgefahr und Umweltrisiken zu minimieren, während sie gleichzeitig die Preisstabilität am Kraftstoffmarkt überwacht. Das Depot spielt eine unverzichtbare Rolle bei der Aufrechterhaltung des Verkehrs, der Stromerzeugung und der industriellen Produktion in der gesamten Region Hauts-Bassins.",
      hu: "A SONABHY (Société Nationale Burkinabè d'Hydrocarbures) Péniben található üzemanyagraktára, amely Bobo-Dioulasso közelében fekszik, Burkina Faso energiabiztonságának egyik legfontosabb stratégiai létesítménye. Mivel az ország nem rendelkezik tengerparttal, teljes mértékben az importra utaltság jellemzi, így ez a tárolókapacitás döntő jelentőségű az ország nyugati részének ellátásában. A létesítmény hatalmas tartályokkal rendelkezik benzin, gázolaj és cseppfolyósított gáz (LPG) tárolására, amelyeket főként az elefántcsontparti és togói kikötőkből érkező tartálykocsik töltenek fel. Péni elhelyezkedése lehetővé teszi a gyors elosztást az ország második legnagyobb városa és a nyugati ipari övezet felé. A SONABHY korszerű biztonsági rendszereket alkalmaz a tűzveszély és a környezeti kockázatok minimalizálása érdekében, miközben biztosítja a piaci árak stabilitását. A raktár elengedhetetlen a közlekedés, az áramtermelés és az ipari termelés folyamatosságához a Hauts-Bassins régióban.",
      ro: "Depozitul de combustibil SONABHY (Société Nationale Burkinabè d'Hydrocarbures) din Péni, situat în apropiere de Bobo-Dioulasso, este o infrastructură strategică esențială pentru securitatea energetică a statului Burkina Faso. Fiind o țară fără ieșire la mare, Burkina Faso depinde în totalitate de importuri, iar acest depozit servește ca un nod logistic vital pentru aprovizionarea regiunii de vest. Facilitatea dispune de rezervoare de mare capacitate pentru benzină, motorină și gaz petrolier lichefiat (GPL), care sosesc prin camioane cisternă din porturile Coastei de Fildeș și statului Togo. Amplasarea sa în Péni facilitează distribuția rapidă către cel de-al doilea oraș ca mărime al țării și către zona industrială din jur. SONABHY utilizează sisteme de siguranță avansate pentru a preveni incendiile și riscurile de mediu, monitorizând totodată stabilitatea prețurilor pe piața carburanților. Depozitul este indispensabil pentru menținerea transportului, generarea de electricitate și funcționarea industriei în întreaga regiune Hauts-Bassins.",
      en: "The SONABHY (Société Nationale Burkinabè d'Hydrocarbures) fuel depot in Péni, located near Bobo-Dioulasso, is a critical strategic infrastructure for Burkina Faso's energy security. As a landlocked country entirely dependent on imports, this facility serves as a vital buffer for the nation's western region. The depot features large-capacity storage tanks for gasoline, diesel, and liquefied petroleum gas (LPG), primarily supplied by tankers arriving from coastal ports in Ivory Coast and Togo. Its location in Péni optimizes logistics for the country's second-largest city and the industrial heartland of the west. SONABHY employs modern safety systems to minimize fire and environmental risks while ensuring price stability in the fuel market. The depot is indispensable for maintaining transportation, power generation, and industrial production across the Hauts-Bassins region.",
    },
    factsAdvanced: {
      de: ["SONABHY hält das staatliche Monopol auf den Import von Kohlenwasserstoffen.", "Das Depot in Péni versorgt den gesamten Westen Burkina Fasos.", "Die Anlage dient als strategische Reserve für Krisenzeiten.", "Die Kraftstoffe kommen überwiegend aus den Häfen von Abidjan und Lomé.", "Moderne Sicherheitsstandards schützen vor Brandgefahren in der Anlage.", "Péni liegt verkehrsgünstig an der Hauptverbindungsstraße nach Bobo-Dioulasso."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "CIMASSO ist ein modernes Zementwerk in Bobo-Dioulasso und gehört zur CIMAF-Gruppe, die in mehreren afrikanischen Ländern tätig ist. Die Fabrik spielt eine zentrale Rolle für die Bauindustrie Burkina Fasos und trägt dazu bei, die Abhängigkeit des Landes von teuren Zementimporten zu verringern. Mit einer installierten Produktionskapazität von rund zwei Millionen Tonnen pro Jahr versorgt CIMASSO Großbauprojekte, den Wohnungsbau und die öffentliche Infrastruktur im ganzen Land. Das Werk nutzt fortschrittliche Mahltechnologien, um hochwertigen Portlandzement herzustellen, der den internationalen Qualitätsstandards entspricht. Neben der wirtschaftlichen Bedeutung ist CIMASSO ein wichtiger Arbeitgeber in der Region Hauts-Bassins und fördert die Ausbildung lokaler Fachkräfte. Das Unternehmen investiert zudem in Umweltschutzmaßnahmen, wie Staubfilteranlagen, um die ökologischen Auswirkungen der Produktion zu minimieren. Durch seine Präsenz in Bobo-Dioulasso stärkt das Werk die Position der Stadt als industrielles Zentrum Burkina Fasos.",
      hu: "A CIMASSO egy modern cementgyár Bobo-Dioulasso városában, amely a több afrikai országban is jelen lévő CIMAF-csoport része. A gyár központi szerepet játszik Burkina Faso építőiparában, jelentősen csökkentve az ország függőségét a drága cementimporttól. Az évi mintegy kétmillió tonnás beépített termelési kapacitásával a CIMASSO nagy horderejű építkezéseket, lakásépítési projekteket és közúti infrastruktúra-fejlesztéseket lát el alapanyaggal országszerte. Az üzem fejlett őrlési technológiát alkalmaz a nemzetközi szabványoknak megfelelő, kiváló minőségű portlandcement előállításához. Gazdasági jelentősége mellett a CIMASSO a Hauts-Bassins régió egyik legnagyobb foglalkoztatója, amely nagy hangsúlyt fektet a helyi szakemberek képzésére. A vállalat környezetvédelmi beruházásokat is eszközöl, például porszűrő berendezéseket telepít a termelés ökológiai lábnyomának csökkentése érdekében. Jelenlétével a gyár tovább erősíti Bobo-Dioulasso pozícióját mint Burkina Faso ipari központját.",
      ro: "CIMASSO este o fabrică modernă de ciment situată în Bobo-Dioulasso, făcând parte din grupul CIMAF, activ în mai multe țări africane. Fabrica joacă un rol central în industria construcțiilor din Burkina Faso, contribuind la reducerea dependenței țării de importurile costisitoare de ciment. Cu o capacitate de producție instalată de aproximativ două milioane de tone pe an, CIMASSO aprovizionează mari proiecte de infrastructură, construcții rezidențiale și lucrări publice în întreaga țară. Uzina utilizează tehnologii avansate de măcinare pentru a produce ciment Portland de înaltă calitate, conform standardelor internaționale. Pe lângă importanța sa economică, CIMASSO este un angajator major în regiunea Hauts-Bassins, promovând formarea profesională a forței de muncă locale. Compania investește, de asemenea, în măsuri de protecție a mediului, cum ar fi sisteme de filtrare a prafului, pentru a minimiza impactul ecologic al producției. Prezența sa în Bobo-Dioulasso consolidează statutul orașului de centru industrial principal al țării.",
      en: "CIMASSO is a modern cement plant in Bobo-Dioulasso and is part of the CIMAF Group, which operates in several African countries. The factory plays a central role in Burkina Faso's construction industry, helping to reduce the country's reliance on expensive cement imports. With an installed production capacity of approximately two million tons per year, CIMASSO supplies major construction projects, housing developments, and public infrastructure nationwide. The plant utilizes advanced grinding technologies to produce high-quality Portland cement that meets international standards. In addition to its economic significance, CIMASSO is a major employer in the Hauts-Bassins region, promoting the vocational training of local specialists. The company also invests in environmental protection measures, such as dust filtration systems, to minimize the ecological impact of its production. Its presence in Bobo-Dioulasso strengthens the city's position as the industrial heart of Burkina Faso.",
    },
    factsAdvanced: {
      de: ["Die Produktionskapazität liegt bei etwa 2 Millionen Tonnen Zement pro Jahr.", "CIMASSO ist Teil der marokkanischen Unternehmensgruppe CIMAF.", "Das Werk wurde im Jahr 2018 offiziell eingeweiht.", "Es befindet sich im Industriegebiet von Bobo-Dioulasso.", "Die Fabrik trägt zur Senkung der lokalen Baukosten bei.", "Moderne Filteranlagen reduzieren die Staubemissionen während der Produktion."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Solarkraftwerk Zina, gelegen in der Provinz Mouhoun, ist ein wegweisendes Projekt für die Energiewende in Burkina Faso. Mit einer installierten Leistung von 26,6 Megawatt-Peak (MWp) ist es eines der größten Photovoltaik-Kraftwerke des Landes und trägt maßgeblich zur Diversifizierung des Energiemixes bei. Burkina Faso verfügt über eines der höchsten Solarpotenziale weltweit, und Anlagen wie Zina nutzen diese natürliche Ressource, um die Abhängigkeit von fossilen Brennstoffen und teuren Energieimporten zu verringern. Das Kraftwerk speist sauberen Strom in das nationale Netz der SONABEL ein und versorgt damit Zehntausende von Haushalten. Das Projekt wurde durch eine öffentlich-private Partnerschaft realisiert und von internationalen Finanzinstitutionen unterstützt. Neben der Reduzierung von CO2-Emissionen fördert das Kraftwerk die lokale wirtschaftliche Entwicklung durch die Schaffung von Arbeitsplätzen während des Baus und Betriebs. Zina ist ein Paradebeispiel für den Ausbau erneuerbarer Energien in der Sahelzone zur Bekämpfung von Energiearmut.",
      hu: "A Mouhoun tartományban található Zina naperőmű Burkina Faso energiaátmenetének egyik úttörő projektje. A 26,6 megawattos (MWp) beépített teljesítményével ez az ország egyik legnagyobb fotovoltaikus létesítménye, amely jelentősen hozzájárul az energiamix diverzifikálásához. Burkina Faso a világ egyik legmagasabb napenergia-potenciáljával rendelkező országa, és az olyan erőművek, mint a zina-i, ezt a természeti erőforrást használják fel a fosszilis tüzelőanyagoktól és a drága energiaimporttól való függőség csökkentésére. Az erőmű tiszta villamos energiát táplál a SONABEL nemzeti hálózatába, több tízezer háztartást látva el árammal. A projekt állami-magán partnerség keretében valósult meg, nemzetközi pénzügyi intézmények támogatásával. A szén-dioxid-kibocsátás csökkentése mellett az erőmű a helyi gazdasági fejlődést is ösztönzi az építés és az üzemeltetés során létrehozott munkahelyek révén. Zina kiváló példa a megújuló energiaforrások térnyerésére a Száhel-övezetben az energiaszegénység elleni küzdelemben.",
      ro: "Centrala solară Zina, situată în provincia Mouhoun, este un proiect de referință pentru tranziția energetică din Burkina Faso. Cu o capacitate instalată de 26,6 megawați-peak (MWp), aceasta este una dintre cele mai mari centrale fotovoltaice din țară, contribuind semnificativ la diversificarea mixului energetic național. Burkina Faso deține unul dintre cele mai ridicate potențiale solare din lume, iar facilități precum cea de la Zina utilizează această resursă naturală pentru a reduce dependența de combustibilii fosili și de importurile scumpe de energie. Centrala injectează energie regenerabilă în rețeaua națională gestionată de SONABEL, alimentând zeci de mii de gospodării. Proiectul a fost realizat printr-un parteneriat public-privat, beneficiind de sprijinul instituțiilor financiare internaționale. Pe lângă reducerea emisiilor de CO2, centrala stimulează dezvoltarea economică locală prin crearea de locuri de muncă în etapele de construcție și operare. Zina reprezintă un model de succes pentru extinderea energiei verzi în regiunea Sahel.",
      en: "The Zina Solar Power Station, located in the Mouhoun Province, is a pioneering project for Burkina Faso's energy transition. With an installed capacity of 26.6 megawatts-peak (MWp), it is one of the country's largest photovoltaic plants, significantly contributing to the diversification of the national energy mix. Burkina Faso possesses some of the highest solar potential in the world, and facilities like Zina harness this natural resource to reduce reliance on fossil fuels and expensive energy imports. The power station feeds clean electricity into the national grid operated by SONABEL, providing power to tens of thousands of households. The project was realized through a public-private partnership with the support of international financial institutions. Beyond reducing carbon emissions, the plant stimulates local economic development by creating jobs during both construction and operation phases. Zina serves as a prime example of renewable energy expansion in the Sahel to combat energy poverty.",
    },
    factsAdvanced: {
      de: ["Die installierte Leistung des Kraftwerks beträgt 26,6 MWp.", "Zina liegt in der Region Boucle du Mouhoun.", "Die Anlage besteht aus über 70.000 Photovoltaik-Modulen.", "Das Projekt wurde 2023 offiziell in Betrieb genommen.", "Es spart jährlich etwa 13.000 Tonnen CO2-Emissionen ein.", "Internationale Investoren wie die IFC unterstützten die Finanzierung."],
  ...
  {
    id: "dédougou-cotton-gin-economic-v2",
    type: "industry",
    parent: "BF-MOU",
    coords: [-3.4667, 12.4667],
    name: {
    ...
    descriptionAdvanced: {
      de: "Die Baumwollentkörnungsanlage in Dédougou ist ein zentraler Bestandteil der burkinischen Textilindustrie und ein wichtiger Motor der regionalen Wirtschaft in der Provinz Mouhoun. Burkina Faso gehört zu den größten Baumwollproduzenten Afrikas, wobei Baumwolle oft als 'weißes Gold' bezeichnet wird, da sie eine der Haupteinnahmequellen für Devisen ist. In der Anlage von Dédougou werden die Fasern der Rohbaumwolle von den Samen getrennt, ein entscheidender Schritt vor dem Export oder der Weiterverarbeitung. Die Fabrik wird von der SOFITEX betrieben, dem führenden Unternehmen im Baumwollsektor des Landes. Während der Erntesaison bietet die Anlage Hunderten von Menschen Arbeit und sichert das Einkommen tausender Kleinbauern in der Umgebung. Dédougou liegt im fruchtbaren Becken des Mouhoun-Flusses, das ideale Bedingungen für den großflächigen Baumwollanbau bietet. Die Modernisierung der Entkörnungsanlagen ist von strategischer Bedeutung, um die Effizienz zu steigern und die Wettbewerbsfähigkeit der burkinischen Baumwolle auf dem Weltmarkt zu erhalten.",
      hu: "A dédougou-i gyapotfeldolgozó üzem (gin) Burkina Faso textiliparának központi eleme és a Mouhoun tartomány regionális gazdaságának egyik legfontosabb motorja. Burkina Faso Afrika egyik legnagyobb gyapottermelője; a gyapotot gyakran nevezik az ország 'fehér aranyának', mivel az egyik legfontosabb devizabevételi forrást jelenti. A dédougou-i létesítményben választják el a nyersgyapot szálait a magoktól, ami a feldolgozás és az export előtti legfontosabb lépés. Az üzemet a SOFITEX, az ország vezető gyapotipari vállalata működteti. A betakarítási szezonban a gyár több száz embernek ad munkát, és több ezer környékbeli kistermelő megélhetését biztosítja. Dédougou a Mouhoun-folyó termékeny völgyében fekszik, ahol a természeti adottságok ideálisak a nagyüzemi gyapottermesztéshez. A feldolgozó üzemek modernizálása stratégiai fontosságú a hatékonyság növelése és a burkinai gyapot világpiaci versenyképességének megőrzése érdekében.",
      ro: "Instalația de egrenare a bumbacului din Dédougou este o componentă centrală a industriei textile din Burkina Faso și un motor economic major pentru provincia Mouhoun. Burkina Faso se numără printre cei mai mari producători de bumbac din Africa, această resursă fiind supranumită 'aurul alb' datorită rolului său crucial în generarea veniturilor din export. În fabrica din Dédougou, fibrele de bumbac brut sunt separate de semințe, un proces esențial înainte ca bumbacul să fie exportat sau prelucrat ulterior. Uzina este operată de SOFITEX, principala companie din sectorul bumbacului din țară. În timpul sezonului de recoltare, facilitatea oferă locuri de muncă pentru sute de persoane și asigură veniturile a mii de mici fermieri din regiune. Dédougou este situat în bazinul fertil al râului Mouhoun, zonă care oferă condiții ideale pentru cultivarea extensivă a bumbacului. Modernizarea acestor unități de producție este de importanță strategică pentru a menține competitivitatea bumbacului burkinabez pe piața mondială.",
      en: "The cotton ginning plant in Dédougou is a central component of Burkina Faso's textile industry and a major economic engine for the Mouhoun Province. Burkina Faso is one of Africa's top cotton producers, with cotton often referred to as 'white gold' due to its significance as a primary source of foreign exchange. At the Dédougou facility, raw cotton fibers are separated from their seeds, a critical step before the cotton is exported or further processed. The plant is operated by SOFITEX, the country's leading company in the cotton sector. During the harvest season, the facility provides employment to hundreds of people and secures the livelihoods of thousands of small-scale farmers in the surrounding area. Dédougou is situated in the fertile basin of the Mouhoun River, which provides ideal conditions for large-scale cotton cultivation. Modernizing these ginning plants is of strategic importance to increase efficiency and maintain the competitiveness of Burkinabè cotton on the global market.",
    },
    factsAdvanced: {
      de: ["SOFITEX ist der Hauptbetreiber der Baumwollindustrie in der Region.", "Baumwolle ist eines der wichtigsten Exportgüter Burkina Fasos.", "Dédougou liegt in der fruchtbaren Region Boucle du Mouhoun.", "Die Entkörnungsanlage trennt die Baumwollfasern von den Samen.", "Hunderte Saisonarbeiter finden während der Erntezeit Beschäftigung.", "Burkina Faso ist bekannt für die Produktion hochwertiger Baumwolle."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Reismühlen im Kou-Tal, etwa 25 Kilometer von Bobo-Dioulasso entfernt, sind das Zentrum eines der bedeutendsten Bewässerungsprojekte Burkina Fasos. Das Tal wurde in den 1970er Jahren mit internationaler Unterstützung erschlossen, um die nationale Reisproduktion zu steigern und die Abhängigkeit von Importen zu verringern. Auf über 1.200 Hektar bewässertem Land wird hier Reis im Doppelanbau kultiviert, was durch die ganzjährige Wasserführung des Kou-Flusses ermöglicht wird. Die Reismühlen übernehmen die Verarbeitung der Ernte, indem sie den Rohreis (Paddy) entspelzen, polieren und verpacken. Dieses landwirtschaftliche Großprojekt ist nicht nur für die Ernährungssicherheit wichtig, sondern bietet auch Tausenden von Kleinbauern eine stabile Lebensgrundlage. In den letzten Jahren wurden die Mühlen modernisiert, um die Qualität des lokalen Reises zu verbessern und ihn wettbewerbsfähiger gegenüber Importware zu machen. Das Kou-Tal gilt heute als Vorzeigemodell für die erfolgreiche Verbindung von Wasserbau und industrieller Verarbeitung in Westafrika.",
      hu: "A Kou-völgyben található rizsmalmok, amelyek mintegy 25 kilométerre fekszenek Bobo-Dioulassótól, Burkina Faso egyik legfontosabb öntözéses mezőgazdasági projektjének központjai. A völgyet az 1970-es években nemzetközi segítséggel fejlesztették ki, hogy növeljék az ország rizstermelését és csökkentsék az importfüggőséget. Több mint 1200 hektárnyi öntözött területen folyik itt intenzív gazdálkodás, amelyet a Kou-folyó egész éves vízhozama tesz lehetővé. A rizsmalmok felelősek a betakarított termés feldolgozásáért, beleértve a hántolást, a fényezést és a csomagolást. Ez a nagyszabású agrárprojekt nemcsak az élelmiszerbiztonság szempontjából kulcsfontosságú, hanem több ezer kistermelő család számára nyújt biztos megélhetést. Az elmúlt években a malmokat modernizálták, hogy javítsák a helyi rizs minőségét és versenyképesebbé tegyék az importált árukkal szemben. A Kou-völgy ma Nyugat-Afrika egyik sikeres példája a vízgazdálkodás és az ipari feldolgozás ötvözésének.",
      ro: "Morile de orez din Valea Kou, situate la aproximativ 25 km de Bobo-Dioulasso, reprezintă inima unuia dintre cele mai importante proiecte de irigații din Burkina Faso. Valea a fost dezvoltată în anii 1970 cu sprijin internațional pentru a crește producția națională de orez și a reduce dependența de importuri. Pe o suprafață de peste 1.200 de hectare de teren irigat, se practică o agricultură intensivă, facilitată de debitul constant al râului Kou. Morile prelucrează recolta, ocupându-se de decorticarea, lustruirea și ambalarea orezului paddy. Acest proiect agricol de anvergură este esențial pentru securitatea alimentară și oferă mijloace de subzistență stabile pentru mii de mici fermieri. În ultimii ani, unitățile de procesare au fost modernizate pentru a ridica standardele de calitate ale orezului local, făcându-l mai competitiv pe piață față de produsele importate. Valea Kou este considerată un model de succes în regiunea Sahel pentru integrarea managementului apei cu prelucrarea industrială.",
      en: "The rice mills in the Kou Valley, located about 25 kilometers from Bobo-Dioulasso, are the hub of one of Burkina Faso's most significant irrigation projects. The valley was developed in the 1970s with international support to boost national rice production and decrease reliance on imports. Spanning over 1,200 hectares of irrigated land, the area supports intensive rice cultivation made possible by the year-round flow of the Kou River. The rice mills handle the processing of the harvest, including dehusking, polishing, and packaging the paddy rice. This large-scale agricultural initiative is not only vital for national food security but also provides a stable livelihood for thousands of smallholder farmers. Recently, the mills have undergone modernization to improve the quality of local rice and make it more competitive against imported varieties. The Kou Valley today stands as a flagship model for successful water management and industrial processing in West Africa.",
    },
    factsAdvanced: {
      de: ["Das Kou-Tal-Projekt wurde in den 1970er Jahren initiiert.", "Über 1.200 Hektar Land werden für den Reisanbau bewässert.", "Der Kou-Fluss liefert das ganze Jahr über Wasser für die Felder.", "Die Reismühlen verarbeiten jährlich Tausende Tonnen Reis.", "Es ist eines der größten Reisanbaugebiete in Burkina Faso.", "Das Projekt sichert das Einkommen von über 1.000 Bauernfamilien."],
