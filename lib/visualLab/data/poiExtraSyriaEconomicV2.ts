...
,
  {
    ...
    description: {
      ...
      ro: "Bursa de Valori din Damasc este locul central de tranzacționare pentru acțiuni și valori mobiliare din Siria.",
      en: "The Damascus Securities Exchange is the central marketplace for trading stocks and securities in Syria.",
    },
    facts: {
      de: ["Gründung im Jahr 2009", "Sitz im Stadtteil Barzeh", "Überwachung durch die SCFMS", "Handel von Bank- und Versicherungsaktien"],
      hu: ["2009-ben alapították", "A Barzeh negyedben található", "Az SCFMS felügyelete alatt áll", "Banki és biztosítási részvények kereskedése"],
      ro: ["Fondată în anul 2009", "Sediul în cartierul Barzeh", "Supravegheată de SCFMS", "Tranzacționează acțiuni bancare și de asigurări"],
      en: ["Established in 2009", "Located in Barzeh district", "Regulated by the SCFMS", "Trades banking and insurance stocks"],
    },
    imageHint: "Modern office building interior with stock tickers",
  },
  {
    ...
    description: {
      ...
      ro: "Acest centru expozițional vast de lângă aeroport servește ca principală vitrină pentru economia siriană.",
      en: "This large-scale exhibition ground near the airport serves as the primary showcase for the Syrian economy.",
    },
    facts: {
      de: ["Fläche von 1,2 Millionen Quadratmetern", "Eröffnung des neuen Geländes 2003", "Jährliche internationale Messe", "Wichtigster Handelsplatz der Region"],
      hu: ["1,2 millió négyzetméteres terület", "Az új helyszín 2003-as megnyitása", "Évente megrendezett nemzetközi vásár", "A régió legfontosabb kereskedelmi csomópontja"],
      ro: ["Suprafață de 1,2 milioane metri pătrați", "Deschiderea noului sediu în 2003", "Târg internațional anual", "Principalul nod comercial din regiune"],
      en: ["Area of 1.2 million square meters", "Opening of the new site in 2003", "Annual international trade fair", "Most important trade hub in the region"],
    },
    imageHint: "Large modern exhibition halls and flags",
  },
  {
    ...
    description: {
      ...
      ro: "Centrala electrică Muhardeh este una dintre cele mai mari instalații de generare a energiei termice din provincia Hama.",
      en: "The Muhardeh Power Plant is one of the largest thermal power generation facilities in the Hama Governorate.",
    },
    facts: {
      de: ["Nennleistung von 660 Megawatt", "Betrieb mit Schweröl und Gas", "Kühlung durch das Wasser des Orontes", "Vier Haupterzeugungseinheiten"],
      hu: ["660 megawattos névleges teljesítmény", "Nehézolajjal és gázzal működik", "Az Orontesz folyó vizével hűtik", "Négy fő termelőegység"],
      ro: ["Capacitate nominală de 660 megawați", "Funcționează cu păcură și gaz", "Răcire prin apa râului Orontes", "Patru unități principale de generare"],
      en: ["Nominal capacity of 660 megawatts", "Operates on heavy fuel oil and gas", "Cooled by Orontes River water", "Four main generation units"],
    },
    imageHint: "Large industrial power plant with smoking chimneys",
  },
  {
    ...
    description: {
      ...
      ro: "Acest baraj de lângă Latakia formează un rezervor utilizat pentru irigații și generarea de energie.",
      en: "This dam near Latakia forms a reservoir used for irrigation and power generation in the coastal region.",
    },
    facts: {
      de: ["Stauvolumen von 210 Millionen Kubikmetern", "Fertigstellung im Jahr 1985", "Wichtige Quelle für Trinkwasser", "Versorgung von 14.000 Hektar Ackerland"],
      hu: ["210 millió köbméter tározókapacitás", "1985-ben fejezték be", "Fontos ivóvízforrás", "14 000 hektár termőföldet lát el"],
      ro: ["Volum de stocare de 210 milioane metri cubi", "Finalizat în anul 1985", "Sursă importantă de apă potabilă", "Alimentează 14.000 hectare de teren agricol"],
      en: ["Storage volume of 210 million cubic meters", "Completed in 1985", "Important source of drinking water", "Supplies 14,000 hectares of farmland"],
    },
    imageHint: "Large dam structure and turquoise water reservoir",
  },
  {
    ...
    description: {
      ...
      ro: "Fabrica de zahăr de stat din Homs este un pilon al industriei alimentare siriene.",
      en: "The state-owned sugar factory in Homs is a cornerstone of the Syrian food processing industry.",
    },
    facts: {
      de: ["Gegründet im Jahr 1946", "Verarbeitung von Zuckerrüben", "Produktion von Würfelzucker und Sirup", "Zugehöriger Hefeproduktionszweig"],
      hu: ["1946-ban alapították", "Cukorrépa feldolgozása", "Kockacukor és szirup gyártása", "Kapcsolódó élesztőgyártó részleg"],
      ro: ["Fondată în anul 1946", "Procesarea sfeclei de zahăr", "Producție de zahăr cuburi și sirop", "Ramură asociată de producție a drojdiei"],
      en: ["Founded in 1946", "Processes sugar beets", "Produces sugar cubes and syrup", "Associated yeast production branch"],
    },
    imageHint: "Old industrial factory building with silos",
  },
  {
    ...
    description: {
      ...
      ro: "Această zonă economică specială din portul Latakia oferă stimulente fiscale pentru comerțul internațional.",
      en: "This special economic zone in Latakia port offers fiscal incentives for international trade and logistics.",
    },
    facts: {
      de: ["Gegründet im Jahr 1971", "Lagerhäuser für Import-Export", "Zollfreie Warenlagerung", "Zentrum für die Automobilindustrie-Logistik"],
      hu: ["1971-ben alapították", "Import-export raktárak", "Vámmentes árutárolás", "Az autóipari logisztika központja"],
      ro: ["Fondată în anul 1971", "Depozite pentru import-export", "Depozitare de mărfuri fără taxe vamale", "Centru pentru logistica industriei auto"],
      en: ["Established in 1971", "Warehouses for import-export", "Duty-free goods storage", "Hub for automotive industry logistics"],
    },
    imageHint: "Port containers and large warehouse buildings",
  },
  {
    ...
    description: {
      ...
      ro: "Instalația de gaze Hayan, la est de Homs, este crucială pentru alimentarea cu gaze naturale a rețelei electrice siriene.",
      en: "The Hayan gas plant east of Homs is critical for the natural gas supply to the Syrian electricity grid.",
    },
    facts: {
      de: ["Produziert 3,7 Mio. Kubikmeter Gas täglich", "Gewinnung von Flüssiggas (LPG)", "Wichtige Pipeline-Anbindung", "Betrieb durch die Hayan Petroleum Company"],
      hu: ["Napi 3,7 millió köbméter gázt termel", "Cseppfolyósított gáz (LPG) előállítása", "Fontos csővezetéki kapcsolat", "A Hayan Petroleum Company üzemelteti"],
      ro: ["Produce 3,7 milioane metri cubi de gaz zilnic", "Extracție de gaz petrolier lichefiat (GPL)", "Conexiune importantă prin conducte", "Operată de Hayan Petroleum Company"],
      en: ["Produces 3.7 million cubic meters of gas daily", "Extraction of liquefied petroleum gas (LPG)", "Important pipeline connection", "Operated by the Hayan Petroleum Company"],
    },
    imageHint: "Complex natural gas processing facility with pipes",
  },
  {
    ...
    description: {
      ...
      ro: "Această centrală situată pe coastă alimentează cu energie rafinăria din Baniyas și regiunea de coastă.",
      en: "This coastal power station provides electricity to the Baniyas refinery and the Mediterranean coastal region.",
    },
    facts: {
      de: ["Installierte Leistung von 680 MW", "Direkte Meereswasserkühlung", "Vier Dampfturbineneinheiten", "Fertigstellung der ersten Phase 1980"],
      hu: ["680 MW beépített teljesítmény", "Közvetlen tengervizes hűtés", "Négy gőzturbina egység", "Az első fázis 1980-as befejezése"],
      ro: ["Putere instalată de 680 MW", "Răcire directă cu apă de mare", "Patru unități cu turbine cu abur", "Finalizarea primei faze în 1980"],
      en: ["Installed capacity of 680 MW", "Direct seawater cooling system", "Four steam turbine units", "Completion of the first phase in 1980"],
    },
    imageHint: "Power plant on the Mediterranean coast",
  },
  {
    ...
    description: {
      ...
      ro: "Această zonă montană din Idlib este centrul producției de ulei de măsline, cu numeroase prese moderne și tradiționale.",
      en: "This mountainous area in Idlib is a hub for olive oil production, featuring numerous modern and traditional mills.",
    },
    facts: {
      de: ["Hunderte registrierte Mühlen", "Haupterzeugungsgebiet für 'Surani'-Öl", "Export von nativem Olivenöl extra", "Erntezeit zwischen Oktober und Dezember"],
      hu: ["Több száz regisztrált malom", "A 'Surani' olaj fő termőterülete", "Extra szűz olívaolaj exportja", "Betakarítás október és december között"],
      ro: ["Sute de prese înregistrate", "Principala zonă de producție pentru uleiul 'Surani'", "Export de ulei de măsline extravirgin", "Sezon de recoltare între octombrie și decembrie"],
      en: ["Hundreds of registered mills", "Main production area for 'Surani' oil", "Exports of extra virgin olive oil", "Harvest season between October and December"],
    },
    imageHint: "Olive groves and small industrial oil press buildings",
  },
  {
    ...
    description: {
      ...
      ro: "Proiectul Maskaneh utilizează apa Eufratului pentru a transforma zonele vaste de deșert în teren agricol fertil.",
      en: "The Maskaneh project utilizes Euphrates water to transform vast desert areas into productive agricultural land.",
    },
    facts: {
      de: ["Bewässerung von 75.000 Hektar", "Große Pumpstationen am Assad-See", "Hauptanbau von Baumwolle und Weizen", "Finanzierung durch internationale Kredite"],
      hu: ["75 000 hektár öntözése", "Nagy szivattyúállomások az Aszad-tavon", "Főként gyapot és búza termesztése", "Nemzetközi hitelekből finanszírozták"],
      ro: ["Irigarea a 75.000 de hectare", "Stații mari de pompare pe lacul Assad", "Culturi principale de bumbac și grâu", "Finanțat prin credite internaționale"],
      en: ["Irrigation of 75,000 hectares", "Large pumping stations on Lake Assad", "Primary crops: cotton and wheat", "Funded through international loans"],
    },
    imageHint: "Large irrigation canals through green fields",
  },
  {
    ...
    description: {
      ...
      ro: "Alep este istoric centrul industriei textile siriene, cunoscut pentru firele de bumbac și țesăturile de înaltă calitate.",
      en: "Aleppo is historically the hub of the Syrian textile industry, famous for cotton yarns and high-quality fabrics.",
    },
    facts: {
      de: ["Hunderte von Fabriken in Sheikh Najjar", "Export in die EU und arabische Länder", "Verarbeitung heimischer Baumwolle", "Spezialisierung auf Seide und Brokat"],
      hu: ["Több száz gyár Sheikh Najjarban", "Export az EU-ba és arab országokba", "Hazai gyapot feldolgozása", "Selyem és brokát specializáció"],
      ro: ["Sute de fabrici în Sheikh Najjar", "Export în UE și țări arabe", "Procesarea bumbacului autohton", "Specializare în mătase și brocart"],
      en: ["Hundreds of factories in Sheikh Najjar", "Export to EU and Arab countries", "Processes domestic cotton", "Specialization in silk and brocade"],
    },
    imageHint: "Large industrial looms and colorful fabric rolls",
  },
  {
    ...
    description: {
      ...
      ro: "Fabrica de ciment din Tartus este unul dintre cei mai importanți producători de materiale de construcții pentru reconstrucția Siriei.",
      en: "The Tartus cement factory is one of the most important producers of construction materials for Syrian reconstruction.",
    },
    facts: {
      de: ["Produktion von über 1 Mio. Tonnen jährlich", "Staatliches Unternehmen", "Export über den Hafen von Tartus", "Eigener Kalksteinbruch direkt vor Ort"],
      hu: ["Évi több mint 1 millió tonna termelés", "Állami tulajdonú vállalat", "Export a tartuszi kikötőn keresztül", "Saját mészkőbánya a helyszínen"],
      ro: ["Producție de peste 1 milion de tone anual", "Companie deținută de stat", "Export prin portul Tartus", "Carieră proprie de calcar la fața locului"],
      en: ["Production of over 1 million tons annually", "State-owned enterprise", "Exports via Tartus port", "Own limestone quarry on site"],
    },
    imageHint: "Large industrial cement plant with silos and conveyors",
  },
  {
    ...
    description: {
      ...
      ro: "Zona din jurul aeroportului Damasc servește ca punct central de transfer pentru mărfurile aeriene și serviciile internaționale de curierat.",
      en: "The area around Damascus Airport serves as the central transit point for air freight and international courier services.",
    },
    facts: {
      de: ["Zollfreies Lagergebiet", "Hauptsitz der Syrian Air Cargo", "Anbindung an die Autobahn nach Amman", "Kühlhäuser für Agrarexporte"],
      hu: ["Vámmentes raktárterület", "A Syrian Air Cargo székhelye", "Kapcsolat az ammani autópályával", "Hűtőházak mezőgazdasági exporthoz"],
      ro: ["Zonă de depozitare fără taxe", "Sediul Syrian Air Cargo", "Conexiune la autostrada spre Amman", "Depozite frigorifice pentru exporturi agricole"],
      en: ["Duty-free storage area", "Headquarters of Syrian Air Cargo", "Connection to the Amman highway", "Cold storage for agricultural exports"],
    },
    imageHint: "Cargo planes and airport warehouse facility",
  },
  {
    ...
    description: {
      ...
      ro: "Câmpia Akkar de pe coastă este una dintre cele mai fertile regiuni ale Siriei, specializată în culturi de seră.",
      en: "The Akkar Plain on the coast is one of Syria's most fertile regions, specializing in greenhouse cultivation.",
    },
    facts: {
      de: ["Zentrum der Tomaten- und Gurkenproduktion", "Ganzjähriger Anbau möglich", "Intensive Nutzung von Bewässerung", "Wichtiger Lieferant für den Libanon"],
      hu: ["A paradicsom- és uborkatermelés központja", "Egész évben lehetséges termesztés", "Intenzív öntözés alkalmazása", "Fontos beszállító Libanon számára"],
      ro: ["Centrul producției de roșii și castraveți", "Cultivare posibilă tot anul", "Utilizare intensivă a irigațiilor", "Furnizor important pentru Liban"],
      en: ["Center of tomato and cucumber production", "Year-round cultivation possible", "Intensive use of irrigation", "Important supplier for Lebanon"],
    },
    imageHint: "Vast fields with white plastic greenhouses",
  },
  {
    ...
    description: {
      ...
      ro: "Salamiyah este un centru important pentru cultivarea cepei și chimionului în zona de tranziție spre deșert.",
      en: "Salamiyah is a major center for onion and cumin cultivation in the transition zone to the desert.",
    },
    facts: {
      de: ["Größter Zwiebelmarkt des Landes", "Zentrum für Viehhandel", "Anbau von Pistazien in der Umgebung", "Wichtiges Forschungszentrum für Trockenlandwirtschaft"],
      hu: ["Az ország legnagyobb hagymapiaca", "Állatkereskedelmi központ", "Pisztácia termesztése a környéken", "Fontos szárazföldi mezőgazdasági kutatóközpont"],
      ro: ["Cea mai mare piață de ceapă din țară", "Centru pentru comerțul cu animale", "Cultivarea fisticului în împrejurimi", "Centru important de cercetare pentru agricultura aridă"],
      en: ["Largest onion market in the country", "Hub for livestock trade", "Pistachio cultivation in the vicinity", "Important research center for dryland agriculture"],
    },
    imageHint: "Agricultural market with sacks of produce",
  },
  {
    ...
    description: {
      ...
      ro: "Deir Ali este o centrală modernă cu ciclu combinat la sud de Damasc, care alimentează o mare parte din capitală.",
      en: "Deir Ali is a state-of-the-art combined cycle power plant south of Damascus, supplying a major portion of the capital.",
    },
    facts: {
      de: ["Kapazität von 750 Megawatt", "Gas- und Dampfturbinentechnik", "Wichtiger Knotenpunkt im Stromnetz", "Finanzierung durch europäische Banken"],
      hu: ["750 megawattos kapacitás", "Gáz- és gőzturbina technológia", "Fontos csomópont az elektromos hálózatban", "Európai bankok finanszírozták"],
      ro: ["Capacitate de 750 megawați", "Tehnologie cu turbină cu gaz și abur", "Nod important în rețeaua electrică", "Finanțată de bănci europene"],
      en: ["Capacity of 750 megawatts", "Combined cycle gas turbine technology", "Critical node in the national grid", "Funded by European investment banks"],
    },
    imageHint: "Modern industrial power facility with gas turbines",
  },
  {
    ...
    description: {
      ...
      ro: "Punctul de trecere Nasib este cea mai importantă poartă economică între Siria, Iordania și statele din Golf.",
      en: "The Nasib border crossing is the primary economic gateway between Syria, Jordan, and the Gulf states.",
    },
    facts: {
      de: ["Täglich hunderte Lastwagen", "Wichtigster Transitpunkt für Obst und Gemüse", "Großes Zollabfertigungszentrum", "Strategische Lage an der M5-Autobahn"],
      hu: ["Naponta több száz teherautó", "A zöldség- és gyümölcsszállítás fő pontja", "Nagy vámkezelési központ", "Stratégiai elhelyezkedés az M5-ös autópályán"],
      ro: ["Sute de camioane zilnic", "Principalul punct de tranzit pentru fructe și legume", "Centru mare de vămuire", "Locație strategică pe autostrada M5"],
      en: ["Hundreds of trucks daily", "Primary transit point for fruits and vegetables", "Large customs clearance facility", "Strategic location on the M5 highway"],
    },
    imageHint: "Border terminal with many trucks in line",
  },
  {
    ...
    description: {
      ...
      ro: "Instalația de gaze Ebla procesează gaze naturale din câmpurile Ash-Shaer pentru a alimenta centralele din țară.",
      en: "The Ebla gas plant processes natural gas from the Ash-Shaer fields to feed power plants across the country.",
    },
    facts: {
      de: ["Bau durch die kanadische Firma Petro-Canada", "Kapazität von 2,5 Mio. m³ täglich", "Produktion von Erdgas und Schwefel", "Fertigstellung im Jahr 2010"],
      hu: ["A kanadai Petro-Canada építette", "Napi 2,5 millió m³ kapacitás", "Földgáz és kén előállítása", "2010-ben fejezték be"],
      ro: ["Construită de firma canadiană Petro-Canada", "Capacitate de 2,5 milioane m³ zilnic", "Producție de gaze naturale și sulf", "Finalizată în anul 2010"],
      en: ["Built by the Canadian firm Petro-Canada", "Capacity of 2.5 million m³ daily", "Produces natural gas and sulfur", "Completed in 2010"],
    },
    imageHint: "Industrial gas refinery with flare stack",
  },
  {
    ...
    description: {
      ...
      ro: "Această instalație prelucrează fosfații bruti din minele din deșertul sirian în îngrășăminte pentru export.",
      en: "This plant processes raw phosphates from the Syrian Desert mines into fertilizers for export.",
    },
    facts: {
      de: ["Produktion von Superphosphat", "Zentrum der syrischen Düngemittelindustrie", "Direkte Bahnanbindung zu den Minen", "Wichtiger Devisenbringer für das Land"],
      hu: ["Szuperfoszfát gyártása", "A szíriai műtrágyaipar központja", "Közvetlen vasúti kapcsolat a bányákkal", "Fontos devizaforrás az ország számára"],
      ro: ["Producție de superfosfat", "Centrul industriei siriene de îngrășăminte", "Conexiune feroviară directă cu minele", "Sursă importantă de valută pentru țară"],
      en: ["Production of superphosphate", "Hub of the Syrian fertilizer industry", "Direct rail link to the desert mines", "Major source of foreign currency for the state"],
    },
    imageHint: "Large industrial chemical plant with conveyor belts",
  },
  {
    ...
    description: {
      ...
      ro: "Zona industrială Al-Kiswa, la sud de Damasc, găzduiește numeroase industrii ușoare și unități metalurgice.",
      en: "The Al-Kiswa industrial area south of Damascus hosts numerous light industries and metalworking facilities.",
    },
    facts: {
      de: ["Zentrum für Lebensmittelverpackung", "Produktion von Haushaltsgeräten", "Wichtiger Arbeitgeber der Region", "Günstige Lage an der Straße nach Jordanien"],
      hu: ["Élelmiszer-csomagolási központ", "Háztartási gépek gyártása", "A régió fontos munkaadója", "Kedvező elhelyezkedés a Jordániába vezető úton"],
      ro: ["Centru pentru ambalarea alimentelor", "Producție de aparate electrocasnice", "Angajator important în regiune", "Locație favorabilă pe drumul spre Iordania"],
      en: ["Center for food packaging", "Production of household appliances", "Major regional employer", "Favorable location on the road to Jordan"],
    },
    imageHint: "Modern industrial warehouses and small factories",
  },
  {
    ...
    description: {
      ...
      ro: "În acest centru modern, citricele din regiunea de coastă sunt pregătite pentru exportul internațional.",
      en: "In this modern facility, citrus fruits from the coastal region are sorted and packed for international export.",
    },
    facts: {
      de: ["Kapazität von 500 Tonnen täglich", "Modernste Sortieranlagen", "Export hauptsächlich nach Russland", "Wichtig für die Küstenlandwirtschaft"],
      hu: ["Napi 500 tonnás kapacitás", "Legmodernebb válogatóberendezések", "Export főként Oroszországba", "Fontos a partmenti mezőgazdaság számára"],
      ro: ["Capacitate de 500 de tone zilnic", "Instalații de sortare de ultimă generație", "Export în principal către Rusia", "Important pentru agricultura de coastă"],
      en: ["Capacity of 500 tons daily", "State-of-the-art sorting equipment", "Exports primarily to Russia", "Vital for coastal agriculture"],
    },
    imageHint: "Boxes of oranges and lemons in a large warehouse",
  }
];
