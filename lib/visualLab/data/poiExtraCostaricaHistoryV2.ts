...
export const poiExtraCostaricaHistoryV2: POI[] = [
  {
    ...
    factsAdvanced: {
      en: ["Battle occurred on March 20, 1856.", "Crucial defense of national sovereignty.", "William Walker's forces defeated here.", "Symbolizes Costa Rican national pride.", "Key site for national independence history."]
    }, 
    description: {
  ...
  },
  {
    ...
    factsAdvanced: {
      en: ["Features mysterious Diquis stone spheres.", "Located in the Diquis Delta region.", "Evidence of complex pre-Columbian life.", "Archaeological site of international importance.", "Represents advanced ancient craftsmanship."]
    }, 
    description: {
...
,
  {
    ...
    description: {
      ...
      ro: "Acesta este cel mai important sit arheologic din Costa Rica. Așezarea a fost locuită între 1000 î.Hr. și 1400 d.Hr.",
      en: "This is the most significant archaeological site in Costa Rica. The settlement was inhabited between 1000 BC and 1400 AD.",
    },
    facts: {
      de: ["Erklärt als Nationaldenkmal", "Entdeckt im 19. Jahrhundert", "Komplexe Aquädukt-Systeme", "Runde Steinbasen gefunden"],
      hu: ["Nemzeti emlékként nyilvántartva", "A 19. században fedezték fel", "Komplex vízvezeték-rendszerek", "Kerek kőalapokat találtak"],
      ro: ["Declarat monument național", "Descoperit în secolul al XIX-lea", "Sisteme complexe de apeducte", "Baze circulare din piatră"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O structură istorică în fosta capitală Cartago. Clădirea a supraviețuit mai multor cutremure din secolul al XIX-lea.",
      en: "A historic structure in the old capital of Cartago. The building has survived multiple earthquakes since the 19th century.",
    },
    facts: {
      de: ["Einstiges Verwaltungszentrum", "Koloniale Architektur", "Teilweise restauriert", "In Cartago gelegen"],
      hu: ["Egykori közigazgatási központ", "Gyarmati építészet", "Részben restaurált", "Cartago-ban található"],
      ro: ["Fost centru administrativ", "Arhitectură colonială", "Parțial restaurat", "Situat în Cartago"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un sit istoric de fortificație pe coasta Caraibilor. A servit în secolul al XVIII-lea pentru apărarea împotriva atacurilor piraților.",
      en: "A historic fortification site on the Caribbean coast. Served in the 18th century to defend against pirate raids.",
    },
    facts: {
      de: ["Karibische Küstenverteidigung", "Erbaut im 18. Jahrhundert", "Strategischer Beobachtungspunkt", "Heute ein Denkmal"],
      hu: ["Karibi partvédelem", "A 18. században épült", "Stratégiai megfigyelőpont", "Ma emlékmű"],
      ro: ["Apărarea coastei Caraibilor", "Construit în secolul al XVIII-lea", "Punct de observare strategic", "Astăzi un monument"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Locul unei bătălii importante în timpul războaielor de independență. Zona este astăzi desemnată zonă istorică protejată.",
      en: "Site of an important engagement during the wars of independence. The area is now designated as a historic protected zone.",
    },
    facts: {
      de: ["Historische Stätte", "Unabhängigkeitskriege", "Gedenktafel vorhanden", "In Guanacaste gelegen"],
      hu: ["Történelmi helyszín", "Függetlenségi háborúk", "Emléktábla található", "Guanacaste-ban"],
      ro: ["Sit istoric", "Războaiele de independență", "Placă comemorativă prezentă", "Situat în Guanacaste"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Rămășițele unei misiuni spaniole din secolul al XVII-lea. Acestea marchează încercarea de colonizare a zonei.",
      en: "Remains of a 17th-century Spanish mission station. They mark the attempt at colonizing the area.",
    },
    facts: {
      de: ["Gegründet im 17. Jahrhundert", "Spanisches Kolonialerbe", "Archäologische Überreste", "Abgelegene Lage"],
      hu: ["A 17. században alapítva", "Spanyol gyarmati örökség", "Régészeti maradványok", "Távoli fekvés"],
      ro: ["Fondată în secolul al XVII-lea", "Moștenire colonială spaniolă", "Rămășițe arheologice", "Locație izolată"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Fosta închisoare din capitală, care servește astăzi drept centru cultural. Construită la începutul secolului al XX-lea.",
      en: "Former prison in the capital, now serving as a cultural center. Built at the beginning of the 20th century.",
    },
    facts: {
      de: ["Architektonisch bedeutsam", "20. Jahrhundert", "Umbau zum Museum", "Stadtzentrum San José"],
      hu: ["Építészetileg jelentős", "20. század", "Múzeummá alakítva", "San José belvárosa"],
      ro: ["Semnificativ din punct de vedere arhitectural", "Secolul al XX-lea", "Transformată în muzeu", "Centrul orașului San José"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Fundațiile rămase ale unei clădiri istorice de justiție. Distrusă de un cutremur sever acum câteva decenii.",
      en: "The remaining foundations of a historic justice building. Destroyed in a severe earthquake decades ago.",
    },
    facts: {
      de: ["Zerstört 1910", "Historische Fundamente", "Cartago Zentrum", "Architektonisches Erbe"],
      hu: ["1910-ben pusztult el", "Történelmi alapok", "Cartago központ", "Építészeti örökség"],
      ro: ["Distrusă în 1910", "Fundații istorice", "Centrul Cartago", "Moștenire arhitecturală"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O biserică istorică bine conservată în stil colonial. Construită pentru comunitatea locală de cultivatori de cafea în secolul al XIX-lea.",
      en: "A well-preserved historic church in colonial style. Built for the local coffee-farming community in the 19th century.",
    },
    facts: {
      de: ["Erbaut im 19. Jahrhundert", "Koloniale Architektur", "Kulturelles Zentrum", "Religiöses Erbe"],
      hu: ["A 19. században épült", "Gyarmati építészet", "Kulturális központ", "Vallási örökség"],
      ro: ["Construită în secolul al XIX-lea", "Arhitectură colonială", "Centru cultural", "Moștenire religioasă"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Rămășițele vechilor operațiuni miniere de aur din Las Juntas. Acest sit stă mărturie pentru boom-ul economic de la sfârșitul secolului al XIX-lea.",
      en: "Remains of the old gold mining operations in Las Juntas. This site bears witness to the late 19th-century economic boom.",
    },
    facts: {
      de: ["Goldrausch-Ära", "Industrielles Erbe", "Spätes 19. Jahrhundert", "Archäologische Überreste"],
      hu: ["Aranyláz korszaka", "Ipari örökség", "19. század vége", "Régészeti maradványok"],
      ro: ["Era goanei după aur", "Moștenire industrială", "Sfârșitul secolului al XIX-lea", "Rămășițe arheologice"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O piață centrală istorică în San Vicente. Înconjurată de clădiri care arată dezvoltarea orașului la începutul secolului al XX-lea.",
      en: "A central historic plaza in San Vicente. Surrounded by buildings showcasing the city's development in the early 20th century.",
    },
    facts: {
      de: ["Frühes 20. Jahrhundert", "Stadtentwicklung", "Zentraler Treffpunkt", "Architektonisches Ensemble"],
      hu: ["20. század eleje", "Városfejlesztés", "Központi találkozóhely", "Építészeti együttes"],
      ro: ["Începutul secolului al XX-lea", "Dezvoltare urbană", "Loc de întâlnire central", "Ansamblu arhitectural"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Unul dintre primele mari proiecte hidroenergetice ale țării. Pus în funcțiune în anii 1960, decisiv pentru electrificare.",
      en: "One of the country's first major hydroelectric projects. Commissioned in the 1960s, crucial for electrification.",
    },
    facts: {
      de: ["Inbetriebnahme 1966", "Wasserkraft-Pionier", "Wirtschaftsgeschichte", "Prägend für die Region"],
      hu: ["Üzembe helyezés 1966", "Vízerőmű úttörő", "Gazdaságtörténet", "Meghatározó a régióban"],
      ro: ["Punere în funcțiune 1966", "Pionier hidroenergetic", "Istorie economică", "Decisiv pentru regiune"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O biserică marcantă, neutilizată, în Puriscal. Cunoscută pentru stilul său unic din lemn care o distinge de alte clădiri.",
      en: "A striking, no longer used church in Puriscal. Known for its unique wooden style that sets it apart from other buildings.",
    },
    facts: {
      de: ["Historische Holzkonstruktion", "Nicht mehr genutzt", "Architektonisches Merkmal", "Bau im frühen 20. Jahrhundert"],
      hu: ["Történelmi faszerkezet", "Már nem használt", "Építészeti jellegzetesség", "A 20. század elején épült"],
      ro: ["Construcție istorică din lemn", "Nu mai este utilizată", "Caracteristică arhitecturală", "Construită la începutul secolului al XX-lea"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un centru istoric al artizanatului. Aici a fost stabilită tradiția căruțelor de boi viu colorate.",
      en: "A historic center of artisan crafts. This is where the tradition of brightly painted oxcarts was established.",
    },
    facts: {
      de: ["Zentrum des Kunsthandwerks", "Tradition seit 19. Jh.", "Ochsenkarren-Herkunft", "Kulturelles Wahrzeichen"],
      hu: ["Kézműves központ", "Hagyomány a 19. század óta", "Ökörszekér-eredet", "Kulturális mérföldkő"],
      ro: ["Centru de artizanat", "Tradiție din sec. XIX", "Originea căruțelor cu boi", "Repere culturale"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Fost depou feroviar în San José. A jucat un rol cheie în construcția liniei ferate către coasta Caraibilor.",
      en: "Former railway depot in San Jose. It played a key role in the construction of the railway line to the Caribbean coast.",
    },
    facts: {
      de: ["Erbaut um 1900", "Eisenbahngeschichte", "Industrielle Bedeutung", "Heute Kulturraum"],
      hu: ["1900 körül épült", "Vasúttörténet", "Ipari jelentőség", "Ma kulturális tér"],
      ro: ["Construit în jurul anului 1900", "Istoria căilor ferate", "Semnificație industrială", "Astăzi spațiu cultural"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O fântână istorică din perioada colonială spaniolă în Nicoya. A servit mult timp ca sursă centrală de apă a orașului.",
      en: "A historic well from the Spanish colonial period in Nicoya. Served for a long time as the city's central water source.",
    },
    facts: {
      de: ["Koloniale Zeit", "Stadtzentrum", "Kulturelles Erbe", "Historische Wasserversorgung"],
      hu: ["Gyarmati korszak", "Városközpont", "Kulturális örökség", "Történelmi vízellátás"],
      ro: ["Perioada colonială", "Centrul orașului", "Moștenire culturală", "Alimentare istorică cu apă"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un far istoric mic la capătul sudic al peninsulei Nicoya. Construit pentru a sprijini navigația timpurie de coastă.",
      en: "A small, historic lighthouse at the southern tip of the Nicoya Peninsula. Built to support early coastal shipping.",
    },
    facts: {
      de: ["Küstenwahrzeichen", "Frühes 20. Jahrhundert", "Navigation", "Historisches Denkmal"],
      hu: ["Parti mérföldkő", "20. század eleje", "Navigáció", "Történelmi emlékmű"],
      ro: ["Reper de coastă", "Începutul secolului al XX-lea", "Navigație", "Monument istoric"],
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O clădire istorică de piață care a format centrul social al orașului în secolul al XX-lea.",
      en: "A historic market building that formed the social center of the city in the 20th century.",
    },
    facts: {
      de: ["Soziale Geschichte", "Handelszentrum", "Frühes 20. Jahrhundert", "Stadtarchitektur"],
      hu: ["Társadalomtörténet", "Kereskedelmi központ", "20. század eleje", "Városépítészet"],
      ro: ["Istorie socială", "Centru comercial", "Începutul secolului al XX-lea", "Arhitectură urbană"],
