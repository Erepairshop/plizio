...
export const netherlandsRegions: POI[] = [
  ...
  facts: {
    ...
    ro: ["Gelderland este cea mai mare provincie din Olanda după suprafață.","Arnhem este capitala și Nijmegen este cel mai mare oraș.","Parcul Național De Hoge Veluwe se află aici.","Nijmegen este considerat cel mai vechi oraș din Olanda.","Locul Operațiunii Market Garden din timpul celui de-al Doilea Război Mondial.","Fluviul Rin traversează provincia.","Cunoscută pentru pomicultură în regiunea Betuwe.","Muzeul Kröller-Müller este o atracție principală a provinciei."],
...
export const netherlandsCities: POI[] = [
  ...
  },
  {
    ...
    facts: {
      de: ["Es gibt noch 52 erhaltene Hünengräber in den Niederlanden.", "Die meisten befinden sich in der Provinz Drenthe.", "Errichtet aus Findlingen, die während der Eiszeit aus Skandinavien kamen.", "Člter als Stonehenge und die Pyramiden.", "In Borger befindet sich das größte Hünengrab (D27) und das Hunebedcentrum.", "Dienten als kollektive Grabstätten."],
