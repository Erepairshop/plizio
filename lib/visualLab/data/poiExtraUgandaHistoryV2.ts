...
,
  {
    ...
    description: {
      ...
      ro: "Acest sit memorial comemorează masacrul din 2004 în timpul războiului civil din nordul Ugandei. Este un loc de doliu și reflecție.",
      en: "This memorial site commemorates the 2004 massacre during the civil war in Northern Uganda. It serves as a place of mourning and reflection.",
    },
    facts: {
      de: ["Massaker am 21. Februar 2004", "Über 300 zivile Opfer", "Angriff durch die LRA-Rebellen", "Liegt im Bezirk Lira"],
      hu: ["2004. február 21-i mészárlás", "Több mint 300 civil áldozat", "Az LRA lázadók támadása", "Lira kerületben található"],
      ro: ["Masacrul din 21 februarie 2004", "Peste 300 de victime civile", "Atac comis de rebelii LRA", "Situat în districtul Lira"],
      en: ["Massacre occurred Feb 21, 2004", "Over 300 civilian victims", "Attack by LRA rebel group", "Located in Lira District"],
    },
    imageHint: "Barlonyo massacre memorial monument Northern Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "Pe acest deal sunt încoronați regii din Buganda de secole. Situl păstrează ritualurile tradiționale ale monarhiei locale.",
      en: "Kings of Buganda have been crowned on this hill for centuries. The site preserves the traditional rituals of the monarchy.",
    },
    facts: {
      de: ["Ort der Kabaka-Krönung", "Über 700 Jahre Geschichte", "Zeremonielle Buganda-Häuser", "Begann mit Kabaka Kintu"],
      hu: ["A Kabaka koronázási helye", "Több mint 700 éves múlt", "Szertartási Buganda házak", "Kintu királlyal kezdődött"],
      ro: ["Locul încoronării lui Kabaka", "Peste 700 de ani de istorie", "Case ceremoniale Buganda", "A început cu Kabaka Kintu"],
      en: ["Site of Kabaka coronation", "Over 700 years of history", "Ceremonial Buganda houses", "Started with Kabaka Kintu"],
    },
    imageHint: "Naggalabi Buddo coronation site traditional houses",
  },
  {
    ...
    description: {
      ...
      ro: "Munsa este un sit arheologic important cu șanțuri concentrice din secolul XV. A fost un centru al imperiului Bachwezi.",
      en: "Munsa is a significant archaeological site featuring concentric ditches from the 15th century. It was a center of the Bachwezi Empire.",
    },
    facts: {
      de: ["Zweitgrößte Anlage Ugandas", "Tiefe Verteidigungsgräben", "Funde von Eisenwerkzeugen", "Datiert auf 1400-1650 n.Chr."],
      hu: ["Uganda második legnagyobbja", "Mély védelmi árkok", "Vaseszköz leletek", "I.sz. 1400-1650-re datálható"],
      ro: ["Al doilea sit ca mărime", "Șanțuri adânci de apărare", "Artefacte din fier găsite", "Datat între 1400 și 1650"],
      en: ["Second largest site in Uganda", "Deep defensive ditches", "Iron tool artifacts found", "Dated to 1400-1650 AD"],
    },
    imageHint: "Munsa earthworks archaeological ditches Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "Acest șanț circular a fost folosit ca închisoare de Kabaka Kalema la sfârșitul secolului XIX. Servea pentru rivalii politici.",
      en: "This circular ditch was used as a prison by Kabaka Kalema in the late 19th century. It served to imprison political rivals.",
    },
    facts: {
      de: ["Erbaut im Jahr 1888", "Massive Erdarbeiten", "Hunderte Gefangene starben", "Ort blutiger Erbfolgestreite"],
      hu: ["1888-ban építették", "Hatalmas földsáncok", "Rabok százai haltak meg", "Véres trónviszályok helyszíne"],
      ro: ["Construit în anul 1888", "Lucrări masive de pământ", "Sute de prizonieri au murit", "Locul conflictelor de succesiune"],
      en: ["Built in the year 1888", "Massive earthworks", "Hundreds of prisoners died", "Site of bloody succession"],
    },
    imageHint: "Katereke prison ditch earthworks Buganda history",
  },
  {
    ...
    description: {
      ...
      ro: "Acest sit marchează locul unde episcopul anglican James Hannington a fost ucis în 1885. A fost primul episcop al Africii Ecuatoriale.",
      en: "This site marks the spot where Anglican Bishop James Hannington was killed in 1885. He was the first Bishop of Equatorial Africa.",
    },
    facts: {
      de: ["Ermordet am 29. Oktober 1885", "Hannington-Höhle vor Ort", "Befehl von Kabaka Mwanga II.", "Liegt im Bezirk Mayuge"],
      hu: ["1885. október 29-én ölték meg", "Hannington-barlang a helyszínen", "Mwanga II. király parancsára", "Mayuge kerületben található"],
      ro: ["Ucis pe 29 octombrie 1885", "Peștera Hannington la sit", "Ordinul lui Kabaka Mwanga II", "Situat în districtul Mayuge"],
      en: ["Martyred Oct 29, 1885", "Hannington Cave on site", "Ordered by Kabaka Mwanga II", "Located in Mayuge District"],
    },
    imageHint: "Bishop Hannington memorial site cave Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "Insula Dolwe găzduiește picturi rupestre preistorice și modele geometrice. Stâncile de granit prezintă arta civilizațiilor timpurii.",
      en: "Dolwe Island houses prehistoric rock paintings and geometric patterns. The granite rocks display artwork from early civilizations.",
    },
    facts: {
      de: ["Einzigartige Felsformationen", "Rote geometrische Motive", "Liegt im Viktoriasee", "Alter auf Jahrtausende geschätzt"],
      hu: ["Egyedülálló sziklaalakzatok", "Vörös geometrikus motívumok", "A Viktória-tóban található", "Életkora több évezredes"],
      ro: ["Formațiuni stâncoase unice", "Motive geometrice roșii", "Situată în Lacul Victoria", "Vârstă estimată la milenii"],
      en: ["Unique rock formations", "Red geometric motifs", "Located in Lake Victoria", "Age estimated at millennia"],
    },
    imageHint: "Dolwe Island rock paintings geometric patterns Lake Victoria",
  },
  {
    ...
    description: {
      ...
      ro: "Această casă istorică a aparținut lui Hamu Mukasa, un important modernizator și scrib din Buganda. Prezintă arhitectură colonială.",
      en: "This historic residence belonged to Hamu Mukasa, a prominent modernizer and scribe of Buganda. It showcases early colonial architecture.",
    },
    facts: {
      de: ["Erbaut im frühen 20. Jahrhundert", "Erster Ugander mit Auto", "Enthält historische Dokumente", "In der Nähe von Kampala"],
      hu: ["A 20. század elején épült", "Az első ugandai autó tulajdonosa", "Történelmi dokumentumokat őriz", "Kampala közelében található"],
      ro: ["Construită la începutul sec. XX", "Primul ugandez cu automobil", "Conține documente istorice", "Lângă orașul Kampala"],
      en: ["Built in early 20th century", "First Ugandan to own a car", "Contains historic documents", "Located near Kampala"],
    },
    imageHint: "Hamu Mukasa house historical building Kampala",
  },
  {
    ...
    description: {
      ...
      ro: "Dealul Kagulu este un loc sacru pentru poporul Basoga și locul așezării lor timpurii. Oferă o vedere spre Lacul Kyoga.",
      en: "Kagulu Hill is a sacred site for the Basoga people and the location of their early settlement. It offers a panoramic view of Lake Kyoga.",
    },
    facts: {
      de: ["Erster Siedlungsplatz in Busoga", "Hügel der Könige", "Höhe von ca. 1000 Metern", "Jährliche Kulturfestivals"],
      hu: ["Az első település Busogában", "A királyok dombja", "Kb. 1000 méter magas", "Éves kulturális fesztiválok"],
      ro: ["Prima așezare din Busoga", "Dealul regilor locali", "Înălțime de aprox. 1000 metri", "Festivaluri culturale anuale"],
      en: ["First settlement in Busoga", "Hill of the kings", "Height of approx 1000 meters", "Annual cultural festivals"],
    },
    imageHint: "Kagulu Hill rock formation view Lake Kyoga",
  },
  {
    ...
    description: {
      ...
      ro: "Acest monument de pe malul Lacului Victoria marchează locul debarcării primilor misionari catolici în 1879. Au sosit la invitația lui Mutesa I.",
      en: "This monument on Lake Victoria's shore marks the 1879 landing site of the first Catholic missionaries. They arrived by invitation of Mutesa I.",
    },
    facts: {
      de: ["Landung am 17. Februar 1879", "Pater Lourdel und Bruder Amans", "Start der katholischen Mission", "Denkmal direkt am Wasser"],
      hu: ["Kikötés 1879. február 17-én", "Lourdel atya és Amans testvér", "A katolikus misszió kezdete", "Emlékmű a vízparton"],
      ro: ["Debarcare la 17 februarie 1879", "Părintele Lourdel și fratele Amans", "Începutul misiunii catolice", "Monument situat pe mal"],
      en: ["Landing on Feb 17, 1879", "Fr. Lourdel and Bro. Amans", "Start of Catholic mission", "Monument directly on shoreline"],
    },
    imageHint: "White Fathers memorial monument Kazi Lake Victoria",
  },
  {
    ...
    description: {
      ...
      ro: "Moscheea veche din Masaka este un simbol religios important al comunității musulmane din regiune. Reflectă istoria locală.",
      en: "The old mosque of Masaka is a significant religious landmark for the region's Muslim community. It reflects the local history and community growth.",
    },
    facts: {
      de: ["Zentrum des Islam in Masaka", "Traditioneller Baustil", "Historischer Versammlungsort", "Wichtiger Punkt der Stadt"],
      hu: ["Az iszlám központja Masakában", "Hagyományos építészeti stílus", "Történelmi gyülekezőhely", "A város fontos pontja"],
      ro: ["Centrul islamului în Masaka", "Stil arhitectural tradițional", "Loc istoric de adunare", "Punct important al orașului"],
      en: ["Center of Islam in Masaka", "Traditional architectural style", "Historic gathering place", "Important city landmark"],
    },
    imageHint: "Masaka old mosque building Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "Kisubi a fost fondată la sfârșitul sec. XIX ca centru pionier pentru educație și religie. Găzduiește școli vechi din Uganda.",
      en: "Kisubi was established in the late 19th century as a pioneer education and religious hub. It houses some of Uganda's oldest schools.",
    },
    facts: {
      de: ["Gegründet von Weißen Vätern", "Bekannt für St. Mary's College", "Liegt an der Entebbe Road", "Wichtiges katholisches Zentrum"],
      hu: ["A Fehér Atyák alapították", "A St. Mary's College-ról híres", "Az Entebbe úton található", "Fontos katolikus központ"],
      ro: ["Fondată de Părinții Albi", "Faimoasă pentru St. Mary's College", "Situată pe drumul spre Entebbe", "Centru catolic important"],
      en: ["Founded by White Fathers", "Famous for St. Mary's College", "Located on Entebbe Road", "Key Catholic educational hub"],
    },
    imageHint: "Kisubi mission station school buildings Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "Acest memorial comemorează atacul tragic asupra Colegiului Tehnic Kichwamba din 1998. Este un monument al păcii.",
      en: "This memorial commemorates the tragic attack on Kichwamba Technical College in 1998. it serves as a monument for peace.",
    },
    facts: {
      de: ["Angriff am 8. Juni 1998", "Durch ADF-Rebellen verübt", "Über 80 Studenten getötet", "Liegt im Bezirk Kabarole"],
      hu: ["1998. június 8-i támadás", "Az ADF lázadók követték el", "Több mint 80 diák halt meg", "Kabarole kerületben található"],
      ro: ["Atacul din 8 iunie 1998", "Comis de rebelii ADF", "Peste 80 de studenți uciși", "Situat în districtul Kabarole"],
      en: ["Attack on June 8, 1998", "Committed by ADF rebels", "Over 80 students killed", "Located in Kabarole District"],
    },
    imageHint: "Kichwamba technical college memorial site Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "Dealul Arua a fost un centru administrativ în timpul perioadei coloniale sub dominație belgiană și britanică. Definește peisajul orașului Arua.",
      en: "Arua Hill was an administrative center during the colonial period under Belgian and British rule. It defines the skyline of Arua town.",
    },
    facts: {
      de: ["Einst belgisches Territorium", "Britisches Boma-Zentrum", "Blick auf West-Nil-Region", "Historische Regierungsbauten"],
      hu: ["Egykor belga terület volt", "Brit Boma központ", "Kilátás a Nyugat-Nílusra", "Történelmi kormányzati épületek"],
      ro: ["Fost teritoriu belgian", "Centru britanic tip Boma", "Vedere spre regiunea Nilul de Vest", "Clădiri guvernamentale istorice"],
      en: ["Once Belgian territory", "British Boma center", "View of West Nile region", "Historic government buildings"],
    },
    imageHint: "Arua Hill landscape historical buildings West Nile",
  },
  {
    ...
    description: {
      ...
      ro: "Muzeul este situat în complexul închisorii Luzira și documentează istoria sistemului penal din Uganda încă din perioada colonială.",
      en: "The museum is located within the Luzira Prison complex and documents the history of Uganda's penal system since the colonial era.",
    },
    facts: {
      de: ["Hauptgefängnis des Landes", "Gegründet um 1920", "Zeigt Reformen des Systems", "Nahe dem Viktoriasee"],
      hu: ["Az ország fő börtöne", "1920 körül alapították", "A rendszer reformjait mutatja", "A Viktória-tó közelében"],
      ro: ["Principala închisoare a țării", "Fondată în jurul anului 1920", "Prezintă reformele sistemului", "Lângă Lacul Victoria"],
      en: ["Main prison of the country", "Established around 1920", "Showcases system reforms", "Near Lake Victoria shore"],
    },
    imageHint: "Luzira prison museum building Kampala",
  },
  {
    ...
    description: {
      ...
      ro: "Această casă a aparținut lui Sir Apollo Kaggwa, premierul de lungă durată din Buganda. A fost o figură centrală a politicii ugandeze în 1900.",
      en: "This house belonged to Sir Apollo Kaggwa, the long-serving Prime Minister of Buganda. He was a central figure in Ugandan politics around 1900.",
    },
    facts: {
      de: ["Katikiro (Premier) von Buganda", "Unterstützte moderne Bildung", "Wichtiger Verbündeter Britanniens", "Residenz in Kampala"],
      hu: ["Buganda Katikiroja (főminiszter)", "Támogatta a modern oktatást", "Britannia fontos szövetségese", "Kampalai rezidencia"],
      ro: ["Katikiro (premier) din Buganda", "A susținut educația modernă", "Aliat important al Marii Britanii", "Rezidență în Kampala"],
      en: ["Katikiro (Premier) of Buganda", "Supported modern education", "Key British ally in Uganda", "Residence located in Kampala"],
    },
    imageHint: "Sir Apollo Kaggwa house historical site Kampala",
  },
  {
    ...
    description: {
      ...
      ro: "Nalukolongo este o stație importantă pe drumul martirilor din Uganda. Aici au suferit persecuții și moarte unii dintre primii creștini.",
      en: "Nalukolongo is an important station on the trail of the Uganda Martyrs. Here, some of the early Christians suffered persecution and death.",
    },
    facts: {
      de: ["Teil des Märtyrer-Pilgerwegs", "Ort religiöser Bedeutung", "Denkmal für Andrea Kaggwa", "In der Nähe von Kampala"],
      hu: ["A mártírok zarándokútjának része", "Vallási jelentőségű hely", "Andrea Kaggwa emlékműve", "Kampala közelében"],
      ro: ["Parte din pelerinajul martirilor", "Loc cu semnificație religioasă", "Monument pentru Andrea Kaggwa", "Situat lângă Kampala"],
      en: ["Part of the Martyrs' trail", "Site of religious significance", "Memorial to Andrea Kaggwa", "Located near Kampala"],
    },
    imageHint: "Nalukolongo martyrs shrine church Kampala",
  },
  {
    ...
    description: {
      ...
      ro: "Palatul Karuziika este sediul oficial al Omukama (regele) din Bunyoro-Kitara. Este un simbol al identității culturale a regatului.",
      en: "Karuziika Palace is the official seat of the Omukama (King) of Bunyoro-Kitara. It is a symbol of the kingdom's cultural identity.",
    },
    facts: {
      de: ["Sitz des Bunyoro-Königreichs", "Erbaut im 20. Jahrhundert", "Königliches Regalia-Museum", "Hauptstadt Hoima"],
      hu: ["A Bunyoro királyság székhelye", "A 20. században épült", "Királyi jelvények múzeuma", "Hoima fővárosban"],
      ro: ["Sediul regatului Bunyoro", "Construit în sec. XX", "Muzeu cu însemne regale", "Situat în orașul Hoima"],
      en: ["Seat of Bunyoro Kingdom", "Built in the 20th century", "Royal regalia museum inside", "Located in Hoima city"],
    },
    imageHint: "Karuziika palace Bunyoro kingdom Hoima Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "Pubungu este locul unde, conform legendei, frații Luo, Nyipir și Labongo s-au despărțit. Marchează începutul diverselor grupuri etnice.",
      en: "Pubungu is the site where, according to legend, the Luo brothers Nyipir and Labongo parted ways. It marks the origin of various ethnic groups.",
    },
    facts: {
      de: ["Ort der Luo-Migration", "Legende vom verlorenen Speer", "Liegt nahe Pakwach", "Heilige Stätte am Nil"],
      hu: ["A Luo vándorlás helyszíne", "Az elveszett lándzsa legendája", "Pakwach közelében található", "Szent hely a Nílusnál"],
      ro: ["Locul migrației Luo", "Legenda suliței pierdute", "Situat lângă Pakwach", "Sit sacru pe malul Nilului"],
      en: ["Site of Luo migration", "Legend of the lost spear", "Located near Pakwach", "Sacred site on the Nile"],
    },
    imageHint: "Pubungu cultural site Nile river Pakwach Uganda",
  },
  {
    ...
    description: {
      ...
      ro: "În Banda se afla unul dintre palatele principale ale lui Kabaka Mutesa I înainte de mutarea la Kasubi. A fost un centru de putere în sec. XIX.",
      en: "Banda was home to one of Kabaka Mutesa I's primary palaces before he moved to Kasubi. It was a significant center of power in the 19th century.",
    },
    facts: {
      de: ["Residenz von Mutesa I.", "Ort wichtiger Verträge", "Vorläufer von Kasubi", "In einem Vorort von Kampala"],
      hu: ["Mutesa I. rezidenciája", "Fontos szerződések helyszíne", "A Kasubi sírok elődje", "Kampala egyik külvárosában"],
      ro: ["Rezidența lui Mutesa I", "Locul unor tratate importante", "Predecesorul mormintelor Kasubi", "Într-o suburbie a Kampalei"],
      en: ["Residence of Mutesa I", "Site of important treaties", "Predecessor to Kasubi site", "Located in Kampala suburb"],
    },
    imageHint: "Banda hill historical site Kampala Buganda history",
  }
];
