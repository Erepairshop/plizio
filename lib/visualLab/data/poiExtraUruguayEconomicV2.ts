...
export const poiExtraUruguayEconomicV2: POI[] = [
  {
    ...
    factsAdvanced: {
      de: [
        "Der Hafen wurde bereits 1724 von den Spaniern als strategischer Stützpunkt gegründet.",
        "Er verfügt über ein spezielles Freihafen-Gesetz, das die steuerfreie Lagerung von Waren ermöglicht.",
        "Die Bucht von Montevideo bietet einen natürlichen Schutz vor den starken Winden des Südatlantiks.",
  ...
  {
    id: "port-of-nueva-palmira-economic-v2",
    type: "port",
    parent: "UY-CO",
    ...
    factsAdvanced: {
      de: [
        "Nueva Palmira ist nach Montevideo der Hafen mit dem höchsten Umschlagvolumen in Uruguay.",
        "Der Hafen liegt genau dort, wo sich der Uruguay-Fluss und der Paraná zum Río de la Plata vereinen.",
  ...
  {
    id: "upm-fray-bentos-economic-v2",
    type: "industry",
    parent: "UY-RN",
    ...
    factsAdvanced: {
      de: [
        "Die Fabrik produziert jährlich etwa 1,3 Millionen Tonnen gebleichten Eukalyptus-Zellstoff.",
        "Der Bau des Werks war die bis dahin größte ausländische Investition in der Geschichte Uruguays.",
    ...
    }, image: "/poi-images/upm-fray-bentos-economic-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Das Werk hat eine Produktionskapazität von rund 1,4 Millionen Tonnen Zellstoff pro Jahr.",
        "Es wurde 2014 offiziell eingeweiht und kostete über 2 Milliarden US-Dollar.",
  ...
  {
    id: "upm-paso-de-los-toros-economic-v2",
    type: "industry",
    parent: "UY-DU",
    ...
    factsAdvanced: {
      de: [
        "Die Anlage hat eine enorme Kapazität von 2,1 Millionen Tonnen Zellstoff pro Jahr.",
        "Für den Transport des Zellstoffs wurde die 273 km lange 'Ferrocarril Central' modernisiert.",
  ...
  {
    id: "ancap-la-teja-refinery-economic-v2",
    type: "industry",
    parent: "UY-MO",
    ...
    factsAdvanced: {
      de: [
        "Die Raffinerie wurde bereits 1937 eingeweiht und ist ein industrielles Denkmal der Stadt.",
        "Sie kann täglich bis zu 50.000 Barrel Rohöl verarbeiten.",
    ...
    }, image: "/poi-images/salto-grande-dam-economic-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "In Zonamerica arbeiten über 10.000 Menschen in mehr als 500 verschiedenen Firmen.",
        "Der Park wurde mehrfach als beste Freihandelszone in Amerika ausgezeichnet.",
  ...
  {
    id: "conaprole-plant-florida-economic-v2",
    type: "industry",
    parent: "UY-FD",
    ...
    factsAdvanced: {
      de: [
        "Conaprole ist die größte Molkereigenossenschaft in ganz Südamerika.",
        "Das Werk in Florida ist besonders auf die Herstellung von Milchpulver für den Export spezialisiert.",
  ...
  {
    id: "port-of-colonia-economic-v2",
    type: "port",
    parent: "UY-CO",
    ...
    factsAdvanced: {
      de: [
        "Jährlich nutzen über 2 Millionen Menschen diesen Hafen, was ihn zum meistbesuchten Terminal Uruguays macht.",
        "Die Überfahrt nach Buenos Aires ist eine der am stärksten frequentierten Fährverbindungen weltweit.",
  ...
  {
    id: "marfrig-tacuarembo-economic-v2",
    type: "industry",
    parent: "UY-TA",
    ...
    factsAdvanced: {
      de: [
        "Uruguay ist eines der wenigen Länder weltweit, in denen die Anzahl der Rinder die der Menschen bei weitem übersteigt.",
        "Der Betrieb in Tacuarembó gehört zur Marfrig Global Foods, einem der größten Fleischkonzerne weltweit.",
  ...
  {
    id: "port-of-fray-bentos-economic-v2",
    type: "port",
    parent: "UY-RN",
    ...
    factsAdvanced: {
      de: [
        "Der Hafen kann Schiffe mit einem Tiefgang von bis zu 34 Fuß (ca. 10 Meter) abfertigen.",
        "Er verfügt über hochmoderne Getreidesilos, die direkt mit den Verladestationen am Kai verbunden sind.",
  ...
  {
    id: "pando-science-park-economic-v2",
    type: "industry",
    parent: "UY-CA",
    ...
    factsAdvanced: {
      de: [
        "Der Park wurde mit starker Unterstützung der Fakultät für Chemie der Universität der Republik (Udelar) gegründet.",
        "Er bietet ein Inkubator-Programm für junge Unternehmer im Bereich der Biowissenschaften.",
  ...
  {
    id: "salus-water-plant-economic-v2",
    type: "industry",
    parent: "UY-LA",
    ...
    factsAdvanced: {
      de: [
        "Die Marke Salus wurde offiziell im Jahr 1892 ins Leben gerufen.",
        "Das Symbol der Marke ist der Puma, der laut Legende die Quellen in den Bergen bewachte.",
  ...
  {
    id: "port-of-paysandu-economic-v2",
    type: "port",
    parent: "UY-PA",
    ...
    factsAdvanced: {
      de: [
        "Der Hafen liegt etwa 300 Kilometer flussaufwärts von der Mündung in den Río de la Plata.",
        "Er verfügt über spezialisierte Verladeanlagen für Massengüter wie Weizen, Mais und Gerste.",
  ...
  {
    id: "boreal-hemp-facility-economic-v2",
    type: "industry",
    parent: "UY-SA",
    ...
    factsAdvanced: {
      de: [
        "Die Anlage umfasste bei ihrer Eröffnung über 5.000 Quadratmeter hochmoderner Labor- und Trocknungsflächen.",
        "Uruguay war 2013 das weltweit erste Land, das Cannabis vollständig legalisierte und regulierte.",
  ...
  {
    id: "parque-tecnologico-industrial-cerro-economic-v2",
    type: "industry",
    parent: "UY-MO",
    ...
    factsAdvanced: {
      de: [
        "Der Park wurde 1998 von der Stadtverwaltung von Montevideo (Intendencia) ins Leben gerufen.",
        "Er erstreckt sich über eine Fläche von rund 20 Hektar im traditionellen Arbeiterviertel Cerro.",
  ...
  {
    id: "megal-lpg-plant-economic-v2",
    type: "industry",
    parent: "UY-SJ",
    ...
    factsAdvanced: {
      de: [
        "Megal ist eines der führenden privaten Unternehmen im uruguayischen Gasmarkt.",
        "Die Anlage füllt täglich Tausende von Gasflaschen verschiedener Größen ab.",
  ...
  {
    id: "tannat-winery-bouza-economic-v2",
    type: "industry",
    parent: "UY-MO",
    ...
    factsAdvanced: {
      de: [
        "Tannat ist die Nationaltraube Uruguays und wurde im 19. Jahrhundert von Basken eingeführt.",
        "Das Weingut nutzt kleine Betontanks und Eichenfässer für eine besonders schonende Reifung.",
    ...
    }, image: "/poi-images/tannat-winery-bouza-economic-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Fanapel wurde 1898 gegründet und war einer der Pioniere der Papierindustrie in der Region.",
        "Die Fabrik war bekannt für ihre Fähigkeit, Papier aus lokalen Eukalyptusfasern herzustellen.",
  ...
  {
    id: "cristalerias-del-uruguay-economic-v2",
    type: "industry",
    parent: "UY-MO",
    ...
    factsAdvanced: {
      de: [
        "Die Fabrik war berühmt für ihre mundgeblasenen Glaswaren, die heute als Sammlerstücke gelten.",
        "Das Unternehmen bot seinen Arbeitern für die damalige Zeit fortschrittliche Sozialleistungen.",
  ...
  {
    id: "isusa-fertilizer-plant-economic-v2",
    type: "industry",
    parent: "UY-SJ",
    ...
    factsAdvanced: {
      de: [
        "ISUSA wurde 1947 gegründet und hat die Entwicklung der uruguayischen Landwirtschaft maßgeblich begleitet.",
        "Das Unternehmen produziert jährlich Hunderttausende Tonnen Superphosphat.",
  ...
  {
    id: "minas-cement-plant-ancap-economic-v2",
    type: "industry",
    parent: "UY-LA",
    ...
    factsAdvanced: {
      de: [
        "Die Region um Minas beherbergt einige der bedeutendsten Kalksteinbrüche des Landes.",
        "Der hier produzierte Zement wird unter der Marke 'Portland ANCAP' vertrieben.",
  ...
  },
  {
    ...
    factsAdvanced: {
      de: [
        "Uruguay verfügt über ein gesetzlich vorgeschriebenes Rückverfolgbarkeitssystem für jedes einzelne Rind.",
        "Der Betrieb in Canelones ist für den Export in die anspruchsvollsten Märkte der Welt zertifiziert.",
  ...
  {
    id: "carrau-winery-colon-economic-v2",
    type: "industry",
    parent: "UY-MO",
    ...
    factsAdvanced: {
      de: [
        "Die Familie Carrau blickt auf über 260 Jahre Weinbautradition zurück, die 1752 in Spanien begann.",
        "Das Weingut in Montevideo wurde in einem historischen Park mit altem Baumbestand errichtet.",
  ...
  {
    id: "montevideo-free-port-economic-v2",
    type: "port",
    parent: "UY-MO",
    ...
    factsAdvanced: {
      de: [
        "Es ist das einzige Freihafenregime in Südamerika, das an einem Tiefwasserhafen am Atlantik liegt.",
        "Waren können unbegrenzt lange im Hafen verbleiben, ohne dass Zölle anfallen.",
  ...
  {
    id: "port-of-maldonado-punta-del-este-economic-v2",
    type: "port",
    parent: "UY-MA",
    ...
    factsAdvanced: {
      de: [
        "Der Hafen verfügt über etwa 500 Liegeplätze, die in der Hochsaison Monate im Voraus ausgebucht sind.",
        "Punta del Este wird oft als das 'St. Tropez Südamerikas' bezeichnet.",
  ...
  {
    id: "parque-de-las-ciencias-economic-v2",
    type: "industry",
    parent: "UY-CA",
    ...
    factsAdvanced: {
      de: [
        "Der Park beherbergt die größte und modernste pharmazeutische Produktionsanlage des Landes.",
        "Uruguay hat sich durch diesen Standort zu einem bedeutenden Exporteur von Medikamenten in der Region entwickelt.",
  ...
  {
    id: "botnia-upm-nursery-guichon-economic-v2",
    type: "industry",
    parent: "UY-PA",
    ...
    factsAdvanced: {
      de: [
        "Die Baumschule produziert jährlich über 10 Millionen Setzlinge für die Wiederaufforstung.",
        "UPM investiert massiv in die genetische Forschung, um Bäume mit optimalen Fasereigenschaften zu entwickeln.",
  ...
  {
    id: "port-of-la-paloma-economic-v2",
    type: "port",
    parent: "UY-RO",
    ...
    factsAdvanced: {
      de: [
        "La Paloma ist ein wichtiger Stützpunkt für die handwerkliche Küstenfischerei Uruguays.",
        "Der Hafen bietet Schutz für Yachten, die entlang der südatlantischen Küste segeln.",
