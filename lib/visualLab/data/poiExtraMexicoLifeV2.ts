...
export const poiExtraMexicoLifeV2: POI[] = [
  {
    ...
    description: {
      de: "Ein zentraler Zoo in Mexiko-Stadt mit starker Bildungs- und Artenschutzrolle.",
      hu: "Kozponti allatkert Mexikovarosban, erosen oktatasi es termeszetvedelmi szereppel.",
      ro: "O gradina zoologica centrala din Mexico City, cu un rol puternic educational si de conservare.",
      en: "A central zoo in Mexico City with a strong educational and conservation role."
    },
    facts: {
      de: ["Im Chapultepec-Park", "Beliebt bei Familien", "Viele einheimische Arten"],
      hu: ["A Chapultepec parkban", "Csaladok kedvence", "Sok helyi faj"],
      ro: ["In parcul Chapultepec", "Popular pentru familii", "Multe specii locale"],
  ...
  },
  {
    ...
    description: {
      de: "Ein großer Stadtzoo im Nordosten von Mexiko-Stadt mit breiten Freigehegen.",
      hu: "Nagy varosi allatkert Mexikovaros eszakkeleti reszen, tag kifutokkal.",
      ro: "O gradina zoologica mare in nord-estul orasului Mexico City, cu spatii largi pentru animale.",
      en: "A large city zoo in northeast Mexico City with wide open enclosures."
    },
    facts: {
      de: ["Nahe dem Lago de San Juan de Aragon", "Starke Umweltbildung", "Viel Platz fuer Tiere"],
      hu: ["A San Juan de Aragon-to mellett", "Eros kornyezeti neveles", "Sok hely az allatoknak"],
      ro: ["Langa Lacul San Juan de Aragon", "Educatie ecologica puternica", "Mult spatiu pentru animale"],
  ...
  },
  {
    ...
    description: {
      de: "Einer der groessten Zoos Mexikos, bekannt fuer seine Vielfalt und Familienangebote.",
      hu: "Mexiko egyik legnagyobb allatkertje, sokfele fajjal es csaladi programokkal.",
      ro: "Una dintre cele mai mari gradini zoologice din Mexic, cunoscuta pentru diversitate si programe de familie.",
      en: "One of Mexico's largest zoos, known for its variety and family activities."
    },
    facts: {
      de: ["Grosse Tierbereiche", "Aussichtsrad und Aquarium", "Wichtiger Lernort"],
      hu: ["Nagy allatbemutato teruletek", "Kilato es akvarium", "Fontos oktatasi helyszin"],
      ro: ["Zone mari pentru animale", "Roata panoramica si acvariu", "Loc important de invatare"],
  ...
  },
  {
    ...
    description: {
      de: "Ein modernes Aquarium in Mexiko-Stadt mit Fokus auf Meeresleben und Bildung.",
      hu: "Modern akvarium Mexikovarosban, a tengeri eletre es az oktatasra fokuszalva.",
      ro: "Un acvariu modern din Mexico City, axat pe viata marina si educatie.",
      en: "A modern aquarium in Mexico City focused on marine life and education."
    },
    facts: {
      de: ["Beliebt bei Kindern", "Unterwasser-Ausstellungen", "Innenstadtlage"],
      hu: ["Nepszeru gyerekeknek", "Vizi bemutato terek", "Belvarosi elhelyezkedes"],
      ro: ["Popular pentru copii", "Expozitii subacvatice", "Locatie centrala"],
  ...
  },
  {
    ...
    description: {
      de: "Ein Natur- und Kulturpark an der Riviera Maya mit vielen Wasser- und Tierbereichen.",
      hu: "Termeszeti es kulturpark a Riviera Mayan, sok vizes es allatvilagi resszel.",
      ro: "Un parc natural si cultural pe Riviera Maya, cu multe zone de apa si animale.",
      en: "A nature and culture park on the Riviera Maya with many water and animal areas."
    },
    facts: {
      de: ["Unterirdische Fluesse", "Marine Shows", "Starker Fokus auf Oekologie"],
      hu: ["Fold alatti folyok", "Tengeri bemutatok", "Eros ekologiai fokusz"],
      ro: ["Rauri subterane", "Spectacole marine", "Accent puternic pe ecologie"],
  ...
  },
  {
    ...
    description: {
      de: "Ein grosser Safaripark bei Puebla, in dem Tiere in offenen Habitaten leben.",
      hu: "Nagy szafaripark Puebla mellett, ahol az allatok nyitott elhelyezesben elnek.",
      ro: "Un mare parc safari langa Puebla, unde animalele traiesc in habitate deschise.",
      en: "A large safari park near Puebla where animals live in open habitats."
    },
    facts: {
      de: ["Drive-through-Erlebnis", "Viele afrikanische Arten", "Beliebtes Ausflugsziel"],
      hu: ["Autos szafari", "Sok afrikai faj", "Nepszeru kirandulohely"],
      ro: ["Safari cu masina", "Multe specii africane", "Destinatie populara de excursie"],
  ...
  },
  {
    ...
    description: {
      de: "Ein Tier- und Freizeitpark im Bundesstaat Mexiko mit grossen offenen Anlagen.",
      hu: "Allat- es szorakoztato park Mexiko allamban, nagy nyitott kifutokkal.",
      ro: "Un parc zoologic si de agrement in Statul Mexic, cu incinte mari deschise.",
      en: "A zoo and leisure park in the State of Mexico with large open enclosures."
    },
    facts: {
      de: ["Safaris und Shows", "Familienfreundlich", "Naturnahe Anlagen"],
      hu: ["Szafari es bemutatok", "Csaladbarat", "Termeszetkozeli kialakitas"],
      ro: ["Safari si spectacole", "Prietenos pentru familii", "Amenajari apropiate de natura"],
  ...
  },
  {
    ...
    description: {
      de: "Ein Bergwaldgebiet, in dem Millionen Monarchfalter uberwintern.",
      hu: "Hegyi erdos terulet, ahol millio szamra telelnek at a monarch pillangok.",
      ro: "O zona montana impadurita unde ierneaza milioane de fluturi monarh.",
      en: "A mountain forest area where millions of monarch butterflies overwinter."
    },
    facts: {
      de: ["UNESCO-Welterbe", "Nur Winterkolonien", "Bedeutender Naturschutz"],
      hu: ["UNESCO vilagorokseg", "Csak teli koloniak", "Fontos termeszetvedelem"],
      ro: ["Patrimoniu Mondial UNESCO", "Coloniile apar doar iarna", "Conservare importanta"],
  ...
  },
  {
    ...
    description: {
      de: "Ein riesiges Biosphaerenreservat mit Regenwald, Mangroven und Lagunen.",
      hu: "Hatalmas bioszfera-rezervatum esovedokkel, mangroveval es lagunakkal.",
      ro: "O rezervatie uriasa a biosferei cu padure tropicala, mangrove si lagune.",
      en: "A vast biosphere reserve with rainforest, mangroves, and lagoons."
    },
    facts: {
      de: ["UNESCO-Welterbe", "Reich an Wildtieren", "Wichtige Karstlandschaft"],
      hu: ["UNESCO vilagorokseg", "Gazdag allatvilag", "Fontos karsztterulet"],
      ro: ["Patrimoniu Mondial UNESCO", "Fauna bogata", "Peisaj carstic important"],
  ...
  },
  {
    ...
    description: {
      de: "Eines der groessten geschuetzten Waldgebiete Mexikos mit Maya-Erbe.",
      hu: "Mexiko egyik legnagyobb vedett erdos terulete maja orokseggel.",
      ro: "Una dintre cele mai mari zone forestiere protejate din Mexic, cu mostenire maya.",
      en: "One of Mexico's largest protected forest areas with Maya heritage."
    },
    facts: {
      de: ["Tropischer Wald", "Jaguare leben hier", "Nahe antiker Stadt"],
      hu: ["Trópusi erdo", "Jaguarok elohelye", "Egy osdi varos mellett"],
      ro: ["Padure tropicala", "Habitat pentru jaguari", "Langa un oras antic"],
  ...
  },
  {
    ...
    description: {
      de: "Ein artenreicher Regenwald in Chiapas with wichtigen Maya-Spuren.",
      hu: "Fajgazdag esovedo Chiapasban, fontos maja emlekekkel.",
      ro: "O padure tropicala foarte bogata in specii din Chiapas, cu urme maya importante.",
      en: "A species-rich rainforest in Chiapas with important Maya traces."
    },
    facts: {
      de: ["Hohe Biodiversitaet", "Regenwaldgebiet", "Maya-Kulturraum"],
      hu: ["Magas biodiverzitas", "Esovedo terulet", "Maja kultura videke"],
      ro: ["Biodiversitate ridicata", "Zona de padure tropicala", "Spatiu cultural maya"],
  ...
  },
  {
    ...
    description: {
      de: "Ein riesiges Schutzgebiet in Baja California Sur mit Walen, Wuesten und Lagunen.",
      hu: "Hatalmas vedett terulet Baja California Surban, bálnakkal, sivataggal es lagunakkal.",
      ro: "O arie protejata uriasa din Baja California Sur, cu balene, desert si lagune.",
      en: "A huge protected area in Baja California Sur with whales, desert, and lagoons."
    },
    facts: {
      de: ["Wichtige Walfangstopp-Region", "UNESCO-Welterbe", "Auch Wuestenlebensraum"],
      hu: ["Fontos bálnavandorlasi terulet", "UNESCO vilagorokseg", "Sivatagi elohelyek is vannak"],
      ro: ["Zona importanta pentru balene", "Patrimoniu Mondial UNESCO", "Include si habitate desertice"],
  ...
  },
  {
    ...
    description: {
      de: "Ein Kuesten- und Lagunengebiet, beruehmt fuer Flamingos und Mangroven.",
      hu: "Parti es lagunas terulet, amely flamingoirol es mangrovejairol ismert.",
      ro: "O zona de coasta si lagune faimoasa pentru flamingi si mangrove.",
      en: "A coastal and lagoon area famous for flamingos and mangroves."
    },
    facts: {
      de: ["Grosses Flamingovorkommen", "Bootstouren", "Mangrovenwälder"],
      hu: ["Nagy flamingo-allas", "Hajoturak", "Mangroverdok"],
      ro: ["Populatie mare de flamingi", "Tururi cu barca", "Paduri de mangrove"],
  ...
  },
  {
    ...
    description: {
      de: "Ein Kuetenschutzgebiet in Oaxaca mit Mangroven, Schildkroeten und Krokodilen.",
      hu: "Oaxacai parti vedett terulet mangroveval, teknosokkel es krokodilokkal.",
      ro: "O zona protejata de coasta in Oaxaca, cu mangrove, testoase si crocodili.",
      en: "A coastal reserve in Oaxaca with mangroves, turtles, and crocodiles."
    },
    facts: {
      de: ["Schildkroeten-Nester", "Krokodil-Lagune", "Gemeindebasierter Schutz"],
      hu: ["Teknosfeszkeles", "Krokodil-laguna", "Kozossegi vedelem"],
      ro: ["Cuiburi de testoase", "Laguna cu crocodili", "Protectie comunitara"],
  ...
  },
  {
    ...
    description: {
      de: "Ein tropisches Waldgebiet in Veracruz mit Vulkanen und sehr hoher Artenvielfalt.",
      hu: "Trópusi erdo Veracruzban, vulkanokkal es kiemelkedo fajgazdagsaggal.",
      ro: "O zona de padure tropicala din Veracruz, cu vulcani si biodiversitate foarte ridicata.",
      en: "A tropical forest area in Veracruz with volcanoes and very high biodiversity."
    },
    facts: {
      de: ["Feuchter Regenwald", "Vulkanische Huetten", "Wichtiger Forschungsraum"],
      hu: ["Nedves esovedo", "Vulkanikus taj", "Fontos kutatasi terulet"],
      ro: ["Padure tropicala umeda", "Relief vulcanic", "Zona importanta de cercetare"],
  ...
  },
  {
    ...
    description: {
      de: "Ein Bergschutzgebiet in Queretaro mit Wäldern, Schluchten und grosser Oekovielfalt.",
      hu: "Hegyi vedett terulet Queretaroban, erdokkel, szurdokokkal es nagy okovaltozatossaggal.",
      ro: "O zona montana protejata in Queretaro, cu paduri, canioane si mare diversitate ecologica.",
      en: "A mountain reserve in Queretaro with forests, canyons, and great ecological diversity."
    },
    facts: {
      de: ["UNESCO-Biosphaere", "Sehr unterschiedliche Klimae", "Grosser Naturtourismus"],
      hu: ["UNESCO bioszfera", "Nagyon valtozatos klima", "Erős termeszetturizmus"],
      ro: ["Biosfera UNESCO", "Clime foarte diverse", "Turism natural puternic"],
  ...
  },
  {
    ...
    description: {
      de: "Eine ruhige Insel im Norden von Quintana Roo, bekannt fuer Voegel und flaches Wasser.",
      hu: "Csendes sziget Quintana Roo eszaki reszen, madarakkal es sekely vizekkel.",
      ro: "O insula linistita in nordul statului Quintana Roo, cunoscuta pentru pasari si ape putin adanci.",
      en: "A quiet island in northern Quintana Roo known for birds and shallow waters."
    },
    facts: {
      de: ["Teil eines Schutzgebiets", "Kein Autoverkehr", "Beliebt fuer Naturbeobachtung"],
      hu: ["Védett terulet resze", "Nincs autozas", "Nepszeru termeszetmegfigyelesre"],
      ro: ["Parte dintr-o arie protejata", "Fara trafic auto", "Populara pentru observarea naturii"],
  ...
  },
  {
    ...
    description: {
      de: "Eine kleine Karibikinsel mit Stränden, Riffen und starkem Meeresbezug.",
      hu: "Kis karibi sziget strandokkal, zatonnyal es eros tengeri kapcsolattal.",
      ro: "O mica insula caraibiana cu plaje, recife si o puternica legatura cu marea.",
      en: "A small Caribbean island with beaches, reefs, and a strong marine identity."
    },
    facts: {
      de: ["Beliebt bei Schnorchlern", "Nahe Cancun", "Reiche Korallenwelt"],
      hu: ["Nepszeru snorkelinghez", "Cancun kozeleben", "Gazdag korallvilag"],
      ro: ["Populara pentru snorkeling", "Langa Cancun", "Lume bogata de corali"],
  ...
  },
  {
    ...
    description: {
      de: "Die bekannteste Insel im Patzcuaro-See, eng mit der Purhepecha-Kultur verbunden.",
      hu: "A Patzcuaro-to legismertebb szigete, szorosan kotodik a purhepecha kulturahoz.",
      ro: "Cea mai cunoscuta insula din lacul Patzcuaro, legata strans de cultura Purhepecha.",
      en: "The best-known island in Lake Patzcuaro, closely tied to Purhepecha culture."
    },
    facts: {
      de: ["Beruehmte Fischeroffnungen", "Blick auf den See", "Wichtiger Kulturort"],
      hu: ["Hires halaszati hagyomany", "Kilatas a tora", "Fontos kulturhely"],
      ro: ["Traditii de pescuit celebre", "Priveliste spre lac", "Loc cultural important"],
  ...
  },
  {
    ...
    description: {
      de: "Eine geschuetzte Insel vor La Paz mit Buchten, Seeloewen und klarem Wasser.",
      hu: "Vedett sziget La Paz mellett, oblokkel, oroszlanfokakkal es tiszta vizekkel.",
      ro: "O insula protejata langa La Paz, cu golfuri, lei de mare si ape limpezi.",
      en: "A protected island off La Paz with coves, sea lions, and clear water."
    },
    facts: {
      de: ["UNESCO-Region", "Beliebt zum Kajakfahren", "Seeloewen-Kolonien"],
      hu: ["UNESCO-regio", "Nepszeru kajakozasra", "Oroszlanfoka-koloniak"],
      ro: ["Regiune UNESCO", "Populara pentru caiac", "Colonii de lei de mare"],
  ...
  },
  {
    ...
    description: {
      de: "Die groesste Insel Mexikos, ein wichtiges Schutzgebiet im Golf von Kalifornien.",
      hu: "Mexiko legnagyobb szigete, fontos vedett terulet a Kaliforniai-obolben.",
      ro: "Cea mai mare insula din Mexic, o zona protejata importanta in Golful Californiei.",
      en: "Mexico's largest island, an important protected area in the Gulf of California."
    },
    facts: {
      de: ["Heimat der Seri", "Wichtig fuer Wuestenfauna", "Stark geschuetzt"],
      hu: ["A seri nep otthona", "Fontos sivatagi elohely", "Erosen vedett"],
      ro: ["Casa poporului Seri", "Important pentru fauna desertica", "Strict protejata"],
  ...
  },
  {
    ...
    description: {
      de: "Unbewohnte Inseln vor Nayarit mit Meeresvoegeln und einer geschuetzten Bucht.",
      hu: "Lakhatatlan szigetek Nayarit partjainal tengeri madarakkal es vedett obollel.",
      ro: "Insule nelocuite in largul statului Nayarit, cu pasari marine si golf protejat.",
      en: "Uninhabited islands off Nayarit with seabirds and a protected bay."
    },
    facts: {
      de: ["Bekannt fuer den Hidden Beach", "Nationales Schutzgebiet", "Reiche Vogelwelt"],
      hu: ["A Hidden Beach-rol hires", "Nemzeti vedett terulet", "Gazdag madarvilag"],
      ro: ["Faimoase pentru Hidden Beach", "Arie protejata nationala", "Fauna aviară bogata"],
  ...
  },
  {
    ...
    description: {
      de: "Eine kleine Schutzinsel nordlich von Cancun, wichtig fuer Seevoegel und Schildkroeten.",
      hu: "Kis vedett sziget Cancun eszaki reszen, fontos tengeri madaraknak es teknosoknek.",
      ro: "O mica insula protejata la nord de Cancun, importanta pentru pasari marine si testoase.",
      en: "A small protected island north of Cancun, important for seabirds and turtles."
    },
    facts: {
      de: ["Strenges Schutzgebiet", "Bootsbesuche nur begrenzt", "Brutplatz fuer Voegel"],
      hu: ["Szigoru vedett terulet", "Hajozas csak korlatozottan", "Madarak feszkeloi helye"],
      ro: ["Zona strict protejata", "Acces limitat cu barca", "Loc de cuibarit pentru pasari"],
  ...
  },
  {
    ...
    description: {
      de: "Die blaue Agave wird hier fuer die Herstellung von Tequila angebaut.",
      hu: "Itt termesztik a keki agavet a tequila eloallitasahoz.",
      ro: "Aici se cultiva agava albastra pentru producerea tequilei.",
      en: "Blue agave is grown here for tequila production."
    },
    facts: {
      de: ["UNESCO-Kulturlandschaft", "Typische rote Erde", "Starke Tradition"],
      hu: ["UNESCO kulturales tajar", "Jellegzetes voros fold", "Eros hagyomany"],
      ro: ["Peisaj cultural UNESCO", "Sol rosu caracteristic", "Traditie puternica"],
  ...
  },
  {
    ...
    description: {
      de: "Mexikos bekanntestes Weinbaugebiet in Baja California mit vielen Weinbergen.",
      hu: "Mexiko legismertebb borvideke Baja Californiaban, sok szolobirtokkal.",
      ro: "Cea mai cunoscuta regiune viticola din Mexic, in Baja California, cu multe podgorii.",
      en: "Mexico's best-known wine region in Baja California with many vineyards."
    },
    facts: {
      de: ["Weinverkostungen", "Trockene Sonnenlage", "Gourmet-Tourismus"],
      hu: ["Borostalas", "Száraz, napos eghajlat", "Gourmet turizmus"],
      ro: ["Degustari de vin", "Clima uscata si insorita", "Turism gastronomic"],
  ...
  },
  {
    ...
    description: {
      de: "Die Berge von Veracruz liefern ideale Bedingungen fuer mexikanischen Kaffee.",
      hu: "Veracruz hegyei idealis felteteleket adnak a mexikai kave termesztesehez.",
      ro: "Muntii din Veracruz ofera conditii ideale pentru cafeaua mexicana.",
      en: "The mountains of Veracruz provide ideal conditions for Mexican coffee."
    },
    facts: {
      de: ["Arabica-Anbau", "Schattenplantagen", "Traditionelle Ernte"],
      hu: ["Arabica termesztese", "Arnyekplantazsak", "Hagyomanyos szuret"],
      ro: ["Cultivare de arabica", "Plantatii umbrite", "Recoltare traditionala"],
  ...
  },
  {
    ...
    description: {
      de: "Hochlandfincas in Chiapas mit starkem Bezug zu Fair-Trade und Schattenkaffee.",
      hu: "Chiapas hegyvideki fincai, eros Fair Trade es arnyekkave kapcsolattal.",
      ro: "Fincas de munte in Chiapas, cu legatura puternica la comert echitabil si cafea de umbra.",
      en: "Mountain fincas in Chiapas with a strong link to fair trade and shade coffee."
    },
    facts: {
      de: ["Kleinstaendige Farmen", "Fruchtbares Hochland", "Kultur des Kaffeeanbaus"],
      hu: ["Kisgazdasagi farmok", "Termekeny hegyvidek", "Kavekultura"],
      ro: ["Ferme mici", "Platou fertil", "Cultura cafelei"],
  ...
  },
  {
    ...
    description: {
      de: "Agavenfelder und kleine Brennereien bilden die Grundlage des Mezcal-Erbes.",
      hu: "Agave-foldelek es kis fozdak adjak a mezcal oroksegenek alapjat.",
      ro: "Campurile de agave si distileriile mici sustin mostenirea mezcalului.",
      en: "Agave fields and small distilleries form the basis of the mezcal heritage."
    },
    facts: {
      de: ["Traditionelle Oaxaqueno-Region", "Agaven auf steinigem Boden", "Handwerkliche Produktion"],
      hu: ["Hagyomanyos oaxacai videk", "Koves talaju agave", "Kezi gyartas"],
      ro: ["Regiune traditionala oaxaqueña", "Agave pe sol pietros", "Productie artizanala"],
  ...
  },
  {
    ...
    description: {
      de: "Michoacan ist das wichtigste Avocado-Gebiet Mexikos und ein globales Exportzentrum.",
      hu: "Michoacan Mexiko legfontosabb avokado-terulete es globalis exportkozpont.",
      ro: "Michoacan este cea mai importanta zona de avocado din Mexic si un centru global de export.",
      en: "Michoacan is Mexico's most important avocado region and a global export hub."
    },
    facts: {
      de: ["Alltagsszene des Hochlands", "Wichtiger Export", "Starke Obstwirtschaft"],
      hu: ["A hegyvidek mindennapjai", "Fontos exportcikk", "Eros gyumolcstermeles"],
      ro: ["Peisaj cotidian montan", "Export important", "Pomicultura puternica"],
  ...
  },
  {
    ...
    description: {
      de: "Die warmen Ebenen Sinaloas eignen sich hervorragend fuer den Mangoanbau.",
      hu: "Sinaloa meleg siksagai kivalloan alkalmasak a mango termesztesere.",
      ro: "Campiile calde din Sinaloa sunt excelente pentru cultivarea mangoului.",
      en: "The warm plains of Sinaloa are excellent for mango cultivation."
    },
    facts: {
      de: ["Reiche Obstproduktion", "Saisonale Ernte", "Wichtiger Inlandmarkt"],
      hu: ["Gazdag gyumolcstermeles", "Szezonalis betakaritas", "Fontos belfoldi piac"],
      ro: ["Productie bogata de fructe", "Recolta sezoniera", "Piata interna importanta"],
