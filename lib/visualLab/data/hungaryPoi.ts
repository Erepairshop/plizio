...
export const hungaryCities: POI[] = [
  ...
  },
  {
    ...
    parent: "bacs-kiskun",
    coords: [18.95, 46.1833],
    name: {"de": "Baja", "hu": "Baja", "ro": "Baja", "en": "Baja"},
    image: "/geo-images/hungary/baja.webp",
    description: {"de": "Stadt an der Donau, berühmt für ihre Fischsuppe und die Sugovica.", "hu": "Duna-parti város, halászlevéről és a Sugovicáról híres.", "ro": "Oraș pe Dunăre, faimos pentru ciorba de pește și Sugovica.", "en": "City on the Danube, famous for its fish soup and the Sugovica."},
    facts: {"de": ["Veranstaltet jährlich ein riesiges Fischsuppen-Festival.", "Hat einen mediterran anmutenden Hauptplatz."], "hu": ["Évente hatalmas halászlé-fesztivált rendeznek.", "Mediterrán hangulatú főtérrel rendelkezik."], "ro": ["Găzduiește anual un festival imens de ciorbă de pește.", "Are o piață centrală cu aspect mediteranean."], "en": ["Hosts a massive fish soup festival annually.", "Has a Mediterranean-style main square."]},
  },
  {
    id: "bonyhad",
    type: "city",
    parent: "tolna",
    coords: [18.5333, 46.3333],
    name: {"de": "Bonyhád", "hu": "Bonyhád", "ro": "Bonyhád", "en": "Bonyhád"},
    image: "/geo-images/hungary/bonyhad.webp",
    description: {"de": "Zentrum der Region Völgység, bekannt für ihre multiethnische Geschichte.", "hu": "A Völgység központja, sokszínű etnikai múltjáról ismert.", "ro": "Centrul regiunii Völgység, cunoscut pentru istoria sa multietnică.", "en": "Center of the Völgység region, known for its multi-ethnic history."},
    facts: {"de": ["Bekannt als die 'Stadt der Emaille'.", "Wichtiges Zentrum der ungarndeutschen Kultur."], "hu": ["A 'zománc városa' néven is ismert.", "A magyarországi német kultúra fontos központja."], "ro": ["Cunoscut ca 'orașul emailului'.", "Centru important al culturii germane din Ungaria."], "en": ["Known as the 'City of Enamel'.", "Important center of the Hungarian-German culture."]},
  },
  {
    id: "mor",
    type: "city",
    ...
    description: {"de": "Historische Stadt und Zentrum einer berühmten Weißweinregion.", "hu": "Történelmi város és egy híres fehérborvidék központja.", "ro": "Oraș istoric și centrul unei faimoase regiuni de vin alb.", "en": "Historic town and center of a famous white wine region."},
    facts: {"de": ["Bekannt für die Rebsorte 'Ezerjó'.", "Beherbergt das Schloss Lamberg."], "hu": ["Az 'Ezerjó' szőlőfajtáról ismert.", "Itt található a Lamberg-kastély."], "ro": ["Cunoscut pentru soiul de struguri 'Ezerjó'.", "Găzduiește Castelul Lamberg."], "en": ["Known for the 'Ezerjó' grape variety.", "Home to the Lamberg Castle."]},
  },
  {
    id: "martonvasar",
    type: "city",
    parent: "fejer",
    coords: [18.7833, 47.3167],
    name: {"de": "Martonvásár", "hu": "Martonvásár", "ro": "Martonvásár", "en": "Martonvásár"},
    description: {"de": "Stadt bekannt für das neugotische Schloss Brunszvik und Beethoven.", "hu": "A neogótikus Brunszvik-kastélyról és Beethovenről ismert város.", "ro": "Oraș cunoscut pentru Castelul Brunszvik în stil neogotic și Beethoven.", "en": "Town known for the Neo-Gothic Brunszvik Castle and Beethoven."},
    facts: {"de": ["Ludwig van Beethoven war oft Gast im Schloss.", "Beherbergt das Beethoven-Gedenkmuseum."], "hu": ["Ludwig van Beethoven gyakori vendég volt a kastélyban.", "Itt található a Beethoven Emlékmúzeum."], "ro": ["Ludwig van Beethoven a fost adesea oaspete la castel.", "Găzduiește Muzeul Memorial Beethoven."], "en": ["Ludwig van Beethoven was a frequent guest at the castle.", "Home to the Beethoven Memorial Museum."]},
  },
  {
    id: "mosonmagyarovar",
    type: "city",
    ...
    coords: [17.2667, 47.8667],
    name: {"de": "Wieselburg-Ungarisch Altenburg", "hu": "Mosonmagyaróvár", "ro": "Mosonmagyaróvár", "en": "Mosonmagyaróvár"},
    description: {"de": "Stadt im Nordwesten, bekannt für ihre Universität und das Thermalbad.", "hu": "Északnyugati város, egyeteméről és termálfürdőjéről ismert.", "ro": "Oraș în nord-vest, cunoscut pentru universitatea sa și baia termală.", "en": "Northwestern city, known for its university and thermal bath."},
    facts: {"de": ["Das Thermalwasser gehört zu den fünf besten in Europa.", "Wichtiges Zentrum der Agrarwissenschaften."], "hu": ["Termálvize Európa öt legjobb hatású vize közé tartozik.", "Az agrártudományok fontos központja."], "ro": ["Apa termală este printre cele mai bune cinci din Europa.", "Centru important al științelor agricole."], "en": ["The thermal water is among the five best in Europe.", "Important center of agricultural sciences."]},
  },
  {
    id: "fertod",
    type: "city",
    ...
    image: "/geo-images/hungary/fertod.webp",
    description: {"de": "Stadt bekannt für das Schloss Esterházy, das 'ungarische Versailles'.", "hu": "Az Esterházy-kastélyról, a 'magyar Versailles'-ról ismert város.", "ro": "Oraș cunoscut pentru Castelul Esterházy, 'Versailles-ul maghiar'.", "en": "Town known for the Esterházy Palace, the 'Hungarian Versailles'."},
    facts: {"de": ["Joseph Haydn lebte und arbeitete hier viele Jahre.", "Das Schloss ist das größte Rokoko-Bauwerk Ungarns."], "hu": ["Joseph Haydn sok éven át élt és alkotott itt.", "A kastély Magyarország legnagyobb rokokó építménye."], "ro": ["Joseph Haydn a trăit și a lucrat aici mulți ani.", "Castelul este cea mai mare construcție rococo din Ungaria."], "en": ["Joseph Haydn lived and worked here for many years.", "The palace is the largest Rococo building in Hungary."]},
  },
  {
    id: "hajduboszormeny",
    type: "city",
    ...
    coords: [21.5167, 47.6667],
    name: {"de": "Hajdúböszörmény", "hu": "Hajdúböszörmény", "ro": "Hajdúböszörmény", "en": "Hajdúböszörmény"},
    description: {"de": "Größte der Hajdú-Städte mit einer einzigartigen kreisförmigen Struktur.", "hu": "A hajdúvárosok legnagyobbika, egyedülálló körgyűrűs szerkezettel.", "ro": "Cel mai mare dintre orașele Hajdú, cu o structură circulară unică.", "en": "Largest of the Hajdú towns with a unique circular structure."},
    facts: {"de": ["Bewahrt das Erbe der Hajduken-Krieger.", "Bekannt für das Bocskai-Heilbad."], "hu": ["A hajdú vitézek örökségét őrzi.", "A Bocskai-gyógyfürdőről is ismert."], "ro": ["Păstrează moștenirea războinicilor haiduci.", "Cunoscut și pentru baia curativă Bocskai."], "en": ["Preserves the heritage of the Hajdú warriors.", "Known for the Bocskai medicinal bath."]},
  },
  {
    id: "parad",
    type: "city",
    ...
    name: {"de": "Parád", "hu": "Parád", "ro": "Parád", "en": "Parád"},
    image: "/geo-images/hungary/parad.webp",
    description: {"de": "Berühmter Kurort im Mátra-Gebirge, bekannt für seine Heilwässer.", "hu": "Híres üdülőhely a Mátrában, gyógyvizeiről ismert.", "ro": "Stațiune faimoasă în munții Mátra, cunoscută pentru apele sale curative.", "en": "Famous resort in the Mátra Mountains, known for its medicinal waters."},
    facts: {"de": ["Beherbergt das berühmte Kutschenmuseum.", "Bekannt für das schwefelhaltige 'Csevice'-Wasser."], "hu": ["Itt található a híres Kocsimúzeum.", "Kénes 'Csevice' vizéről is nevezetes."], "ro": ["Găzduiește faimosul Muzeu al Trăsurilor.", "Cunoscut și pentru apa sulfuroasă 'Csevice'."], "en": ["Home to the famous Carriage Museum.", "Known for the sulfurous 'Csevice' water."]},
  },
  {
    id: "belapatfalva",
    type: "city",
    ...
    coords: [20.35, 48.05],
    name: {"de": "Bélapátfalva", "hu": "Bélapátfalva", "ro": "Bélapátfalva", "en": "Bélapátfalva"},
    description: {"de": "Stadt am Fuße des Bükk-Gebirges, bekannt für ihre Zisterzienserabtei.", "hu": "Város a Bükk lábánál, ciszterci apátságáról ismert.", "ro": "Oraș la poalele munților Bükk, cunoscut pentru abația sa cisterciană.", "en": "Town at the foot of the Bükk, known for its Cistercian abbey."},
    facts: {"de": ["Die Abteikirche ist die einzige intakte romanische Zisterzienserkirche Ungarns.", "Malerische Lage am Fuße des Bél-Steins."], "hu": ["Az apátsági templom Magyarország egyetlen épen maradt román kori ciszterci temploma.", "Festői fekvés a Bél-kő lábánál."], "ro": ["Biserica abației este singura biserică cisterciană romanică intactă din Ungaria.", "Locație pitorească la poalele muntelui Bél-kő."], "en": ["The abbey church is the only intact Romanesque Cistercian church in Hungary.", "Picturesque location at the foot of the Bél-kő mountain."]},
  },
  {
    id: "jaszapati",
    type: "city",
