...
export const poiExtraPortugalIndustry: POI[] = [
  {
    id: "industry-lisnave-shipyards-setubal-extra",
    type: "industry",
    parent: "PT-15",
    coords: [-8.788, 38.496],
    name: { de: "Lisnave-Werften, Setúbal", hu: "Lisnave hajógyárak, Setúbal", ro: "Șantierele Navale Lisnave, Setúbal", en: "Lisnave Shipyards, Setúbal" },
    description: {
      de: "Einst eine der größten Schiffswerften der Welt, ist Lisnave heute ein führendes Unternehmen für Schiffsreparatur und -wartung.",
      hu: "Valaha a világ egyik legnagyobb hajógyára volt, ma a Lisnave vezető hajójavító és -karbantartó vállalat.",
    ...
    "factsAdvanced": {
      "de": [
        "Lisnave verfügt über Trockendocks, die Schiffe bis zu einer Million Tonnen Tragfähigkeit aufnehmen können.",
        "Die Werft wickelt jährlich Reparaturen und Umbauten von über 100 großen Hochseeschiffen ab.",
        "Der Standort profitiert von seiner Nähe zu den wichtigsten Schifffahrtsrouten zwischen Europa, Afrika und den Amerikas.",
        "Lisnave war maßgeblich an der Entwicklung moderner Schiffsumbau-Techniken in den 1970er Jahren beteiligt."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "port-port-of-aveiro-extra",
    type: "port",
    parent: "PT-01",
    coords: [-8.74, 40.64],
    name: { de: "Hafen von Aveiro", hu: "Aveiro kikötője", ro: "Portul Aveiro", en: "Port of Aveiro" },
    description: {
      de: "Ein wichtiger Seehafen in Portugal, der eine entscheidende Rolle für die Wirtschaft der Zentralregion spielt und verschiedene Arten von Fracht umschlägt.",
      hu: "Fontos tengeri kikötő Portugáliában, amely döntő szerepet játszik a központi régió gazdaságában, különféle típusú rakományokat kezelve.",
    ...
    "factsAdvanced": {
      "de": [
        "Der Hafen von Aveiro ist bekannt für seine Spezialisierung auf Projektladungen und Schüttgüter.",
        "Die Hafeneinfahrt musste im Laufe der Geschichte mehrfach durch künstliche Kanäle stabilisiert werden.",
        "Die Lagune von Aveiro um den Hafen ist eines der wichtigsten Feuchtgebiete für Zugvögel in Europa.",
        "Er zeichnet sich durch einen hohen Automatisierungsgrad im Umschlag von Flüssigchemikalien aus."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "agriculture-alentejo-cork-forests-extra",
    type: "agriculture",
    parent: "PT-07",
    coords: [-8.0, 38.5],
    name: { de: "Korkeichenwälder des Alentejo", hu: "Alentejo parafaerdői", ro: "Pădurile de plută din Alentejo", en: "Alentejo Cork Forests" },
    description: {
      de: "Der Alentejo ist die größte Korkproduktionsregion der Welt und Heimat ausgedehnter Korkeichenhaine (Montados), einem nachhaltigen Agroforstsystem.",
      hu: "Az Alentejo a világ legnagyobb parafa-termelő régiója, hatalmas parafatölgy-ligeteknek (montados) ad otthont, amelyek egy fenntartható agrár-erdészeti rendszert alkotnak.",
    ...
    "factsAdvanced": {
      "de": [
        "Portugal produziert etwa 50 % des weltweiten Korks, der Großteil davon stammt aus dem Alentejo.",
        "Eine Korkeiche darf laut Gesetz nur alle neun Jahre geschält werden, um den Baum nicht zu beschädigen.",
        "Die 'Montados' sind Heimat vieler gefährdeter Arten, darunter der Iberische Luchs und der Spanische Kaiseradler.",
        "Die Korkgewinnung ist eines der am besten bezahlten landwirtschaftlichen Handwerke in der Welt."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "industry-the-navigator-company-cacia-extra",
    type: "industry",
    parent: "PT-01",
    coords: [-8.65, 40.68],
    name: { de: "The Navigator Company, Cacia", hu: "The Navigator Company, Cacia", ro: "The Navigator Company, Cacia", en: "The Navigator Company, Cacia" },
    description: {
      de: "Eine große Zellstoff- und Papierfabrik in der Nähe von Aveiro, Teil von The Navigator Company, einem führenden europäischen Hersteller von gebleichtem Eukalyptus-Kraftzellstoff (BEKP).",
      hu: "Egy nagy cellulóz- és papírgyár Aveiro közelében, a The Navigator Company része, amely Európa vezető fehérített eukaliptusz-kraftcellulóz (BEKP) gyártója.",
    ...
    "factsAdvanced": {
      "de": [
        "Die Anlage produziert große Mengen an ungebleichtem und gebleichtem Eukalyptus-Zellstoff für den globalen Markt.",
        "Das Werk ist auch einer der größten Erzeuger erneuerbarer Energien aus forstwirtschaftlicher Biomasse in Portugal.",
        "Eukalyptusbäume, der Hauptrohstoff, wurden im 19. Jahrhundert in Portugal eingeführt und prägen heute die Landschaft.",
        "Die Papierprodukte der Navigator Company werden in über 130 Länder weltweit exportiert."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "agriculture-vinho-verde-wine-region-extra",
    type: "agriculture",
    parent: "PT-03",
    coords: [-8.4, 41.5],
    name: { de: "Weinregion Vinho Verde", hu: "Vinho Verde borrégió", ro: "Regiunea viticolă Vinho Verde", en: "Vinho Verde Wine Region" },
    description: {
      de: "Die größte DOC-Weinregion Portugals, bekannt für die Herstellung des charakteristischen, leicht spritzigen Weins Vinho Verde (Grüner Wein).",
      hu: "Portugália legnagyobb DOC borrégiója, amely a jellegzetes, enyhén szénsavas Vinho Verde (Zöld Bor) bor előállításáról ismert.",
    ...
    "factsAdvanced": {
      "de": [
        "Die Vinho Verde-Region ist das größte zusammenhängende DOC-Weinbaugebiet in Portugal.",
        "Der Wein hat oft einen natürlichen, leichten Kohlensäuregehalt, der ihm seine Spritzigkeit verleiht.",
        "Alvarinho und Loureiro sind die bekanntesten weißen Rebsorten dieser traditionsreichen Region.",
        "In den traditionellen Anbaumethoden wurden Reben an Pergolen gezogen, damit sie vor der Bodenfeuchtigkeit geschützt waren."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "port-port-of-funchal-extra",
    type: "port",
    parent: "PT-30",
    coords: [-16.91, 32.64],
    name: { de: "Hafen von Funchal", hu: "Funchal kikötője", ro: "Portul Funchal", en: "Port of Funchal" },
    description: {
      de: "Ein wichtiger Hafen auf der Insel Madeira, der ein beliebtes Ziel für Kreuzfahrtschiffe und ein wichtiges Tor für Waren ist.",
      hu: "Fontos kikötő Madeira szigetén, népszerű célpont a tengerjáró hajók számára és fontos árukapu.",
    ...
    "factsAdvanced": {
      "de": [
        "Der Hafen ist besonders berühmt für sein spektakuläres Neujahrsfeuerwerk, das zahlreiche Kreuzfahrtschiffe anlockt.",
        "Bereits im 15. Jahrhundert war der Hafen ein Zentrum für den lukrativen Export von Madeira-Zucker.",
        "Funchal war der erste Hafen, in dem der berühmte Entdecker Christoph Kolumbus bei seinen Reisen Zwischenstopps einlegte.",
        "Der moderne Ausbau konzentriert sich fast ausschließlich auf den Tourismus und Passagierverkehr."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "industry-vista-alegre-porcelain-factory-extra",
    type: "industry",
    parent: "PT-01",
    coords: [-8.718, 40.62],
    name: { de: "Porzellanmanufaktur Vista Alegre", hu: "Vista Alegre porcelángyár", ro: "Fabrica de porțelan Vista Alegre", en: "Vista Alegre Porcelain Factory" },
    description: {
      de: "Eine prestigeträchtige Porzellanmanufaktur, die 1824 gegründet wurde und für ihr hochwertiges Geschirr und ihre dekorativen Stücke bekannt ist.",
      hu: "Egy tekintélyes porcelángyár, amelyet 1824-ben alapítottak, és amely a kiváló minőségű étkészleteiről és dísztárgyairól ismert.",
    ...
    "factsAdvanced": {
      "de": [
        "Vista Alegre wurde 1824 von dem Unternehmer José Ferreira Pinto Basto gegründet.",
        "Die Fabrik belieferte das portugiesische Königshaus und produziert heute für Monarchien und Präsidenten weltweit.",
        "Das Gelände umfasst eine Kapelle aus dem 17. Jahrhundert, die als nationales Monument klassifiziert ist.",
        "Viele der aufwendigen Porzellanstücke werden nach fast 200 Jahren immer noch handbemalt."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "agriculture-alqueva-dam-irrigation-extra",
    type: "agriculture",
    parent: "PT-02",
    coords: [-7.49, 38.2],
    name: { de: "Bewässerung durch den Alqueva-Staudamm", hu: "Alqueva-gát öntözés", ro: "Irigația barajului Alqueva", en: "Alqueva Dam Irrigation" },
    description: {
      de: "Der Alqueva-Staudamm schuf den größten künstlichen See Westeuropas und revolutionierte die Landwirtschaft im trockenen Alentejo durch ein riesiges Bewässerungssystem.",
      hu: "Az Alqueva-gát létrehozta Nyugat-Európa legnagyobb mesterséges tavát, és egy hatalmas öntözőrendszer révén forradalmasította a mezőgazdaságot a száraz Alentejo régióban.",
    ...
    "factsAdvanced": {
      "de": [
        "Der Alqueva-Stausee bedeckt eine Fläche von rund 250 Quadratkilometern und erstreckt sich über 80 Kilometer Länge.",
        "Das System bewässert über 120.000 Hektar Landwirtschaftsfläche, die zuvor stark unter Wassermangel litt.",
        "Für den Bau des Staudamms musste das Dorf Luz vollständig umgesiedelt und originalgetreu wieder aufgebaut werden.",
        "Die Region um den See ist heute auch eines der weltweit besten Gebiete für Sternenbeobachtung (Dark Sky Reserve)."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "industry-renova-paper-factory-torres-novas-extra",
    type: "industry",
    parent: "PT-14",
    coords: [-8.54, 39.48],
    name: { de: "Renova Papierfabrik, Torres Novas", hu: "Renova papírgyár, Torres Novas", ro: "Fabrica de hârtie Renova, Torres Novas", en: "Renova Paper Factory, Torres Novas" },
    description: {
      de: "Der Hauptsitz und die Hauptproduktionsstätte der Marke Renova, die für ihre innovativen und farbenfrohen Hygienepapiere wie schwarzes Toilettenpapier bekannt ist.",
      hu: "A Renova márka székhelye és fő gyártóüzeme, amely innovatív és színes higiéniai papírjairól, például a fekete WC-papírról ismert.",
    ...
    "factsAdvanced": {
      "de": [
        "Renova machte Schlagzeilen, als es 2005 das weltweit erste schwarze Toilettenpapier auf den Markt brachte.",
        "Die Fabrik ist über den Almonda-Höhlen erbaut, einem wichtigen archäologischen Höhlensystem Portugals.",
        "Produkte von Renova werden häufig als 'das sexieste Toilettenpapier der Erde' vermarktet.",
        "Das Unternehmen ist heute eine globale Marke und exportiert in über 60 Länder."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "port-fishing-port-of-peniche-extra",
    type: "port",
    parent: "PT-10",
    coords: [-9.38, 39.36],
    name: { de: "Fischereihafen von Peniche", hu: "Peniche halászkikötője", ro: "Portul de pescuit din Peniche", en: "Fishing Port of Peniche" },
    description: {
      de: "Einer der wichtigsten Fischereihäfen Portugals, besonders bekannt für seinen Sardinenfang. Die Fischereitradition der Stadt prägt ihre Kultur und Gastronomie.",
      hu: "Portugália egyik legfontosabb halászkikötője, különösen híres a szardíniafogásáról. A város halászati hagyománya meghatározza kultúráját és gasztronómiáját.",
    ...
    "factsAdvanced": {
      "de": [
        "Peniche ist traditionell der portugiesische Hafen mit den größten Anlandungen von pelagischen Fischen wie Sardinen.",
        "Die Festung von Peniche überblickt den Hafen und diente lange der Verteidigung gegen Piraten.",
        "Der Hafen ist auch der Ausgangspunkt für Fährverbindungen zu den streng geschützten Berlengas-Inseln.",
        "Trotz moderner Technologien setzen viele Fischer hier noch auf handwerkliche und nachhaltige Fangmethoden."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "agriculture-mirandesa-cattle-breeding-extra",
    type: "agriculture",
    parent: "PT-04",
    coords: [-6.7, 41.6],
    name: { de: "Mirandesa-Rinderzucht", hu: "Mirandesa szarvasmarha tenyésztés", ro: "Creșterea vitelor Mirandesa", en: "Mirandesa Cattle Breeding" },
    description: {
      de: "Die Region Trás-os-Montes ist die Heimat der Mirandesa, einer einheimischen Rinderrasse, die für ihr hochwertiges Fleisch mit geschützter Ursprungsbezeichnung (g.U.) geschätzt wird.",
      hu: "A Trás-os-Montes régió ad otthont a Mirandesa szarvasmarhának, egy őshonos fajtának, amelyet kiváló minőségű, oltalom alatt álló eredetmegjelöléssel (OEM) ellátott húsáért becsülnek.",
    ...
    "factsAdvanced": {
      "de": [
        "Das Mirandesa-Rind ist leicht an seinem kastanienbraunen Fell und der markanten, ausladenden Hornform zu erkennen.",
        "Die Rasse ist als DOP (Denominação de Origem Protegida) klassifiziert, was ihre Qualität und Herkunft garantiert.",
        "Die Tiere werden oft auf gemeinschaftlich genutzten Weiden der traditionellen Dörfer gehalten.",
        "Ein typisches lokales Gericht ist die 'Posta Mirandesa', ein dickes, über offenen Kohlen gegrilltes Rindersteak."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "industry-ceiiia-automotive-research-extra",
    type: "industry",
    parent: "PT-13",
    coords: [-8.68, 41.22],
    name: { de: "CEiiA Automobilforschung", hu: "CEiiA autóipari kutatás", ro: "Cercetare auto CEiiA", en: "CEiiA Automotive Research" },
    description: {
      de: "Ein Zentrum für Ingenieur- und Produktentwicklung in der Nähe von Porto, das sich auf die Automobil- und Luftfahrtindustrie spezialisiert hat und an Projekten für nachhaltige Mobilität arbeitet.",
      hu: "Egy mérnöki és termékfejlesztési központ Porto közelében, amely az autó- és repülőgiparra szakosodott, és fenntartható mobilitási projekteken dolgozik.",
    ...
    "factsAdvanced": {
      "de": [
        "Das CEiiA war an der Entwicklung von 'mobi.e', einem der weltweit ersten landesweiten Netzwerke für Elektroauto-Ladestationen beteiligt.",
        "Das Zentrum entwickelt nicht nur Autos, sondern auch Drohnen, U-Boote und Bauteile für Flugzeuge.",
        "Es spielt eine Schlüsselrolle bei der Positionierung Portugals im europäischen Luftfahrtsektor.",
        "Architektonisch ist das Gebäude in Matosinhos für sein innovatives und energieeffizientes Design bekannt."
      ],
      "hu": [],
      "ro": [],
      "en": []
  ...
  {
    id: "agriculture-pera-rocha-do-oeste-orchards-extra",
    type: "agriculture",
    parent: "PT-10",
    coords: [-9.1, 39.2],
    name: { de: "Pera Rocha do Oeste Obstgärten", hu: "Pera Rocha do Oeste gyümölcsösök", ro: "Livezile Pera Rocha do Oeste", en: "Pera Rocha do Oeste Orchards" },
    description: {
      de: "Die Westregion Portugals ist das Herzstück des Anbaus der Pera Rocha, einer einheimischen Birnensorte mit g.g.A.-Status (geschützte geografische Angabe).",
      hu: "Portugália nyugati régiója a Pera Rocha, egy oltalom alatt álló földrajzi jelzéssel (OFJ) rendelkező őshonos körtefajta termesztésének központja.",
    ...
    "factsAdvanced": {
      "de": [
        "Die 'Pera Rocha' hat seit 2003 eine geschützte Ursprungsbezeichnung (DOP) in der Europäischen Union.",
        "Portugal exportiert jährlich zehntausende Tonnen dieser Birnensorte, hauptsächlich nach Europa und Südamerika.",
        "Die Birne ist berühmt für ihr festes, knackiges Fruchtfleisch, was ihr eine besonders lange Haltbarkeit verleiht.",
        "Die Entdeckung der Mutterpflanze wird dem Bauern Pedro António Rocha im Jahr 1836 zugeschrieben."
      ],
      "hu": [],
      "ro": [],
      "en": []
