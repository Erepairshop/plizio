...
,
  {
    ...
    descriptionAdvanced: {
      de: "Maaya Thila (ohne Marine-Life-Suffix) ist dasselbe Riff im Ari-Atoll, das aufgrund seiner geologischen Formation eine besondere Rolle spielt. Der Thila ist ein ehemaliger Vulkanfelsen, der vor etwa 10.000 Jahren nach dem Meeresspiegelanstieg überflutet wurde. Die Gesteinszusammensetzung ist überwiegend Basalt. Die Riffstruktur bietet Lebensraum für endemische Schwämme und Weichtiere. Der Ort ist eine wichtige Referenz für geologische Studien zur Korallenrifforganese.",
      hu: "A Maaya Thila (természetvédelmi fókusszal) az Ari-atoll egyik geológiai érdekessége. Ez a víz alatti csúcs egy ősi vulkáni képződmény, amely a tengerszint emelkedésekor került víz alá. A kőzet bazalt. A zátony élővilága endemikus szivacsokat és puhatestűeket foglal magában. Fontos a korallzátonyok fejlődésének kutatásában.",
      ro: "Maaya Thila (variantă naturală) este un recif din Atolul Ari, format dintr-o fostă rocă vulcanică bazaltică. A fost inundat acum 10.000 de ani. Adăpostește bureți endemici și moluște. Este un sit de referință pentru studiile geologice asupra formării recifelor de corali.",
      en: "Maaya Thila (natural history focus) is a submerged volcanic pinnacle in Ari Atoll, flooded about 10,000 years ago. The rock is primarily basalt. It hosts endemic sponges and mollusks. The site is used for geological research on coral reef development.",
    },
    factsAdvanced: {
      de: ["Alter der Überflutung: ca. 10.000 Jahre", "Gesteinsart: Basalt", "Endemische Schwämme: mehrere Arten", "Höhe des Thila: ca. 37 Meter (von 3 auf 40 m)", "Bildungsprozess: vulkanisch", "Forschungsnutzen: Rifforganese"],
      hu: ["Elárasztás kora: kb. 10 000 év", "Kőzettípus: bazalt", "Endemikus szivacsok: több faj", "Thila magassága: kb. 37 méter (3–40 m)", "Képződés: vulkáni", "Kutatási jelentőség: zátonyfejlődés"],
      ro: ["Vârsta inundării: aprox. 10.000 de ani", "Tip rocă: bazalt", "Bureți endemici: mai multe specii", "Înălțimea thilei: aprox. 37 de metri (de la 3 la 40 m)", "Proces de formare: vulcanic", "Utilizare științifică: geneza recifurilor"],
      en: ["Age of flooding: approx. 10,000 years", "Rock type: basalt", "Endemic sponges: multiple species", "Thila height: approx. 37 meters (from 3 to 40 m)", "Formation process: volcanic", "Scientific use: reef genesis"],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Fish Head (Mushimasmingili) liegt im Ari-Atoll und ist ein bekannter Tauchplatz mit einer hohen Dichte an Grauen Riffhaien. Die Formation besteht aus einem Korallenkopf, der bis auf 5 Meter unter der Oberfläche reicht und auf 40 Meter abfällt. Täglich werden hier über 50 Haie gesichtet. Das Gebiet wurde 2009 als Meeresschutzgebiet ausgewiesen. Die Strömung ist moderat. Neben Haien sieht man auch Napoleon-Lippfische und Makrelen.",
      hu: "A Fish Head (Mushimasmingili) az Ari-atoll egyik híres búvárhelye, ahol nagyszámú szürke zátonycápa él. A korallfej 5 méterig emelkedik, majd 40 méterig ereszkedik. Naponta több mint 50 cápát figyelnek meg. 2009 óta védett. Áramlása mérsékelt. Itt él a nápolyi ajakoshal is.",
      ro: "Fish Head (Mushimasmingili) se află în Atolul Ari și este renumit pentru densitatea mare de rechini de recif. Reciful se ridică la 5 metri și coboară la 40 de metri. Zilnic se observă peste 50 de rechini. Desemnat arie protejată în 2009. Curenții sunt moderati. Se întâlnesc și pești Napoleon.",
      en: "Fish Head (Mushimasmingili) in Ari Atoll is a dive site known for a high density of grey reef sharks. The coral pinnacle rises from 40 to 5 meters. Over 50 sharks are seen daily. It was designated a marine protected area in 2009. Currents are moderate. Other species include Napoleon wrasse and mackerel.",
    },
    factsAdvanced: {
      de: ["Schutzgebietsausweisung: 2009", "Tiefe: 5–40 Meter", "Tägliche Hai-Sichtungen: über 50", "Haiart: Grauer Riffhai (Carcharhinus amblyrhynchos)", "Strömung: moderat (1–2 Knoten)", "Typische Größe der Haie: 1,5–2 Meter"],
      hu: ["Védetté nyilvánítás éve: 2009", "Mélység: 5–40 méter", "Napi cápa megfigyelések: több mint 50", "Cápa faj: szürke zátonycápa (Carcharhinus amblyrhynchos)", "Áramlás: mérsékelt (1–2 csomó)", "Cápák tipikus mérete: 1,5–2 méter"],
      ro: ["Anul desemnării: 2009", "Adâncime: 5–40 de metri", "Observări zilnice de rechini: peste 50", "Specie de rechin: rechin de recif cenușiu (Carcharhinus amblyrhynchos)", "Curenți: moderati (1–2 noduri)", "Dimensiunea tipică a rechinilor: 1,5–2 metri"],
      en: ["Year of designation: 2009", "Depth: 5–40 meters", "Daily shark sightings: over 50", "Shark species: Grey reef shark (Carcharhinus amblyrhynchos)", "Current: moderate (1–2 knots)", "Typical shark size: 1.5–2 meters"],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Fotteyo Kandu ist ein Kanal im Felidhoo-Atoll, der für seine starken Strömungen und große Fischschwärme bekannt ist. Der Kanal ist etwa 150 Meter breit und bis zu 50 Meter tief. Er verbindet das offene Meer mit dem inneren Atoll. Die Strömungsgeschwindigkeit kann 3 Knoten erreichen. Hier werden häufig Thunfische, Barrakudas und Makrelen gesichtet. Das Gebiet ist nicht offiziell geschützt, aber aufgrund seiner ökologischen Bedeutung wird eine nachhaltige Nutzung empfohlen.",
      hu: "A Fotteyo Kandu a Felidhoo-atoll egyik csatornája, erős áramlatokkal és nagy halrajokkal. Szélessége 150 méter, mélysége 50 méter. Az áramlás elérheti a 3 csomót. Gyakoriak a tonhalak, barrakudák és makrélák. Nem védett, de fenntartható használatra javasolt.",
      ro: "Fotteyo Kandu este un canal din Atolul Felidhoo, cu curenți puternici și bancuri mari de pești. Lățimea de 150 de metri, adâncimea de 50 de metri. Curenții pot atinge 3 noduri. Tonul, baracuda și macroul sunt comune. Nu este protejat oficial, dar se recomandă utilizarea sustenabilă.",
      en: "Fotteyo Kandu is a channel in Felidhoo Atoll, known for strong currents and large fish schools. It is 150 meters wide and 50 meters deep. Currents can reach 3 knots. Tuna, barracuda, and mackerel are common. While not officially protected, sustainable use is encouraged.",
    },
    factsAdvanced: {
      de: ["Kanalbreite: 150 Meter", "Maximale Tiefe: 50 Meter", "Strömungsgeschwindigkeit: bis zu 3 Knoten", "Häufige Arten: Thunfisch, Barrakuda, Makrele", "Schutzstatus: keiner offizieller", "Länge des Kanals: ca. 1 km"],
      hu: ["Csatorna szélessége: 150 méter", "Legnagyobb mélység: 50 méter", "Áramlási sebesség: akár 3 csomó", "Gyakori fajok: tonhal, barrakuda, makréla", "Védettségi státusz: nincs hivatalos", "Csatorna hossza: kb. 1 km"],
      ro: ["Lățime canal: 150 de metri", "Adâncime maximă: 50 de metri", "Viteza curenților: până la 3 noduri", "Specii frecvente: ton, baracudă, macrou", "Statut de protecție: niciunul oficial", "Lungimea canalului: aprox. 1 km"],
      en: ["Channel width: 150 meters", "Maximum depth: 50 meters", "Current speed: up to 3 knots", "Common species: tuna, barracuda, mackerel", "Protection status: no official", "Channel length: approx. 1 km"],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Madivaru Corner im Nord-Malé-Atoll ist ein Plateau mit einer Tiefe von 10 bis 25 Metern, bekannt für Mantarochen, die hier zur Reinigung kommen. Das Gebiet ist Teil einer saisonalen Migrationsroute. Die beste Zeit ist von Januar bis April. Es gibt keine offizielle Schutzausweisung, aber Tauchverbände empfehlen Verhaltensregeln. Die Wassertemperatur liegt bei 26–29 °C. Auch Adlerrochen und Schildkröten werden gesichtet.",
      hu: "A Madivaru Corner a Malé-északi atoll fennsíkja 10–25 méter mélységgel, ahol manta ráják tisztítják magukat. A legjobb időszak január–április. Nincs hivatalos védelem, de etikai kódex vonatkozik rá. Vízhőmérséklet 26–29 °C. Sástány és teknősök is előfordulnak.",
      ro: "Madivaru Corner este un platou în Atolul Malé de Nord, la 10–25 de metri adâncime, frecventat de raze manta pentru curățare. Sezonul optim ianuarie–aprilie. Nu este protejat oficial, dar există reguli de conduită. Temperatura apei 26–29 °C. Se observă și raze vultur și broaște țestoase.",
      en: "Madivaru Corner in North Malé Atoll is a plateau at 10–25 meters depth, known as a cleaning station for manta rays. Best season is January to April. No official protection, but dive operators follow guidelines. Water temperature 26–29 °C. Eagle rays and turtles are also seen.",
    },
    factsAdvanced: {
      de: ["Tiefe: 10–25 Meter", "Beste Sichtungszeit: Januar–April", "Wassertemperatur: 26–29 °C", "Häufigste Art: Mantarochen (Manta alfredi)", "Schutzstatus: kein offizieller", "Plateaufläche: ca. 500 m²"],
      hu: ["Mélység: 10–25 méter", "Legjobb megfigyelés: január–április", "Vízhőmérséklet: 26–29 °C", "Leggyakoribb faj: manta rája (Manta alfredi)", "Védettség: nincs hivatalos", "Fennsík területe: kb. 500 m²"],
      ro: ["Adâncime: 10–25 de metri", "Sezon optim: ianuarie–aprilie", "Temperatura apei: 26–29 °C", "Specie frecventă: raza manta (Manta alfredi)", "Statut de protecție: niciunul oficial", "Suprafața platoului: aprox. 500 m²"],
      en: ["Depth: 10–25 meters", "Best sighting season: January–April", "Water temperature: 26–29 °C", "Most common species: Manta ray (Manta alfredi)", "Protection status: none official", "Plateau area: approx. 500 m²"],
    },
  }
];
