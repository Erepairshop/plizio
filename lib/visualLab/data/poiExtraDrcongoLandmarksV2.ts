...
export const poiExtraDrcongoLandmarksV2: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Palais du Peuple ist das politische Herzst?ck der DR Kongo in Kinshasa. Hier tagen Nationalversammlung und Senat, und genau deshalb wirkt das Gebäude nicht wie ein blo?es Verwaltungsobjekt, sondern wie eine B?hne staatlicher Entscheidungen. Seine Entstehung mit chinesischer Unterst?tzung und die Fertigstellung im Jahr 1979 verankern es fest in der späten Mobutu-Zeit. Im Stadtbild steht es f?r Repr?sentation, Macht und ?ffentliche Ordnung. F?r den Unterricht eignet es sich gut f?r Geografie K7 sowie Politik und Staatsaufbau.",
    ...
    factsAdvanced: {
      de: ["Sitz von Nationalversammlung und Senat.", "Fertiggestellt 1979.", "Mit Unterst?tzung Chinas erbaut.", "Liegt in Kinshasa.", "Wichtiges Gebäude f?r Staatszeremonien.", "Zentrales Symbol der parlamentarischen Macht."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["Turmh?he: 210 Meter.", "Baubeginn 1970.", "Standort: Limete in Kinshasa.", "Unvollendeter Turm und Verkehrsknotenpunkt.", "Mit Patrice Lumumba verbunden.", "Ein prägnantes Wahrzeichen der Hauptstadt."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["Errichtet nach der Ermordung 2001.", "Erinnert an Laurent-D?sir? Kabila.", "Standort: Kinshasa.", "Wird von einer großen Bronzestatue gepr?gt.", "Teil der politischen Erinnerungskultur.", "Gedenkort f?r einen ehemaligen Pr?sidenten."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["Standort: Kinshasa.", "Wichtige Kunsthochschule der DR Kongo.", "Ausbildung in Malerei, Bildhauerei und Design.", "1943 gegr?ndet.", "Prägt die Kunstszene der Hauptstadt.", "Ort f?r Ausstellungen und Werkst?tten."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Monument de l'Ind?pendance in Kinshasa erinnert an den Bruch mit der Kolonialherrschaft und an den 30. Juni 1960. Als städtisches Erinnerungszeichen b?ndelt es die nationale Erz?hlung in einer einzigen Form: Unabhängigkeit wird hier nicht als abstrakter Begriff gezeigt, sondern als sichtbarer Teil des ?ffentlichen Raums. Gerade in einer Hauptstadt, in der politische Geschichte st?ndig pr?sent ist, erf?llt das Denkmal eine doppelte Funktion. Es ist Mahnmal und Treffpunkt zugleich. F?r Geschichte K8 und Staatsb?rgerkunde ist es ein sehr passender Bezugspunkt.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die ?glise Sainte-Anne in Kinshasa ist ein religiöser Ort, der durch seine städtische Lage und seine lange Gemeindepr?senz auff?llt. Anders als große Monumentalbauten wirkt sie st?rker als lebendige Pfarrkirche im Alltag der Hauptstadt. Genau darin liegt ihr Wert: Sie zeigt, wie sich Glauben nicht nur in Kathedralen, sondern auch in regelm??igen Gottesdiensten, Gemeindearbeit und lokaler Musik ausdr?ckt. F?r einen Lernkontext ist sie deshalb interessant, weil sie Religion als Teil des Stadtlebens sichtbar macht. Das passt gut zu Sachkunde, Religion und urbaner Alltagskultur.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Pont Mar?chal ist in Kinshasa weniger als einzelnes Bauwerk zu verstehen als als Teil des städtischen Bewegungsraums. Br?cken sind in einer riesigen Metropole wie dieser nie blo? technische Verbindungen; sie ordnen Verkehrsstr?me, verk?rzen Wege und strukturieren ganze Viertel. Genau das macht den Pont Mar?chal interessant: Er steht f?r den Alltag einer Stadt, in der Mobilit?t ein zentrales Thema bleibt. Die Bezeichnung verweist zudem auf die politische Geschichte des Landes und auf die starke Pr?senz von Namen im ?ffentlichen Raum. F?r Plizio eignet er sich f?r Verkehr und Stadtplanung.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Chukudu-Monument in Goma macht ein schlichtes Transportmittel zu einem städtischen Symbol. Der Chukudu, dieser robuste Holzroller f?r schwere Lasten, steht im Osten der DR Kongo f?r Einfallsreichtum, Handel und Alltagstauglichkeit. Als Monument erh?lt er eine zus?tzliche Bedeutung: Was sonst auf M?rkten und Straßen arbeitet, wird hier in Erinnerung und ?ffentlichkeit ?berf?hrt. Genau deshalb ist der Ort so spannend. Er zeigt, wie lokale Mobilit?t selbst zu Kultur werden kann. F?r Plizio ist das ein gutes Beispiel f?r Alltags?konomie und städtische Identit?t in Geografie K7.",
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["Standort: Goma.", "Katholische Kathedrale.", "Wichtiger Mittelpunkt des kirchlichen Lebens.", "Liegt in der Region des Kivu-Sees.", "Tr?gt den Namen des heiligen Joseph.", "Prägt die religiöse Identit?t der Stadt."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["Standort: Lubumbashi.", "Heimst?tte von TP Mazembe.", "TP Mazembe wurde 1939 gegr?ndet.", "Liegt im Stadtteil Kamalondo.", "Wichtiger Ort f?r Fu?ballwettbewerbe.", "Prägt das Sportimage von Lubumbashi."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Universit? de Kisangani ist eines der wichtigsten akademischen Zentren im Norden der DR Kongo. In einer Stadt am Kongofluss erf?llt sie eine doppelte Rolle: Sie bildet Fachkr?fte aus und verankert wissenschaftliche Arbeit in einer Region, die weit vom politischen Zentrum entfernt liegt. Dadurch bekommt die Universit?t eine besondere Bedeutung f?r soziale Mobilit?t, Forschung und regionale Entwicklung. Universit?ten sind in afrikanischen Städten oft mehr als Lehranstalten; sie wirken auch als ?ffentliche Räume f?r Debatten und Zukunftsentw?rfe. F?r Plizio eignet sich die Universit?t besonders f?r Bildung und urbane Entwicklung.",
    ...
    factsAdvanced: {
      de: ["Standort: Kisangani.", "Wichtige staatliche Universit?t.", "1963 gegr?ndet.", "Liegt in einer Stadt am Kongofluss.", "Zentrum f?r Ausbildung und Forschung.", "Prägt die akademische Landschaft des Nordostens."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Pont de Kongolo ist eines der bekanntesten Ingenieurbauwerke im Osten der DR Kongo, weil er Straße und Schiene ?ber den Lualaba führt. Die Konstruktion bei Kongolo macht sofort deutlich, wie sehr Flüsse hier Infrastruktur bestimmen. Mit seiner L?nge von rund 495,7 Metern und dem Baujahr 1939 gehört er zu den historischen Gro?br?cken des Landes. Besonders markant ist seine Rolle als Verbindung zwischen beiden Ufern und als Teil einer wichtigen Verkehrsachse. F?r den Plizio-Unterricht ist der Pont de Kongolo ein starkes Beispiel f?r Verkehr, Technik und Flusslandschaften.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Barrage d'Inga steht f?r eines der bedeutendsten Wasserkraftsysteme Afrikas. Am Unterlauf des Kongo-Flusses nutzt das Kraftwerk die gewaltige Str?mung der Inga-F?lle und zeigt damit, wie eng Geografie und Energieproduktion zusammenhängen. Inga I wurde 1972 fertiggestellt, Inga II 1982. Zusammen bilden sie einen Schl?sselort der kongolesischen Stromversorgung, auch wenn die Anlagen lange unter Verschlei? und unzureichender Wartung litten. Der Standort in Kongo Central macht den Barrage d'Inga zu einem Lehrbeispiel f?r Energiegeografie, Rohstoffinfrastruktur und staatliche Gro?projekte.",
