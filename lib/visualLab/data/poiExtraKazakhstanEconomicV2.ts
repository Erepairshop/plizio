...
,
  {
    id: "kazakhstan-aifc-economic-v2",
    type: "industry",
    name: { de: "Internationales Finanzzentrum Astana", hu: "Asztanai Nemzetközi Pénzügyi Központ", ro: "Centrul Financiar Internațional Astana", en: "Astana International Financial Centre" },
    coords: [71.4081, 51.1283],
    description: {
      de: "Dieses Finanzzentrum nutzt englisches Recht für internationale Investitionen. Es befindet sich auf dem ehemaligen Gelände der EXPO 2017 in der Hauptstadt.",
      hu: "Ez a pénzügyi központ az angol jogrendszert alkalmazza a nemzetközi befektetésekhez. A fővárosban, a 2017-es EXPO egykori területén található.",
      ro: "Acest centru financiar utilizează dreptul englez pentru investiții internaționale. Este situat pe fostul amplasament al EXPO 2017 din capitală.",
      en: "This financial hub utilizes English common law for international investments. It is located on the former EXPO 2017 site in the capital city.",
    },
    facts: {
      de: ["Gründung im Jahr 2018", "Besonderes englisches Rechtssystem", "Über 1000 registrierte Unternehmen", "Sitz an der EXPO-Promenade"],
      hu: ["2018-ban alapították", "Speciális angol jogrendszer", "Több mint 1000 regisztrált cég", "Az EXPO sétányon található"],
      ro: ["Fondat în anul 2018", "Sistem juridic englez special", "Peste 1000 de companii înregistrate", "Sediul pe promenada EXPO"],
      en: ["Founded in 2018", "Special English law jurisdiction", "Over 1000 registered companies", "Located at the EXPO promenade"],
    },
    imageHint: "Modern architecture of AIFC buildings in Astana",
    descriptionAdvanced: {
      de: "Das Astana International Financial Centre (AIFC) ist ein Finanzzentrum in Nur-Sultan (Astana), Kasachstan, gegründet 2018. Es basiert auf dem englischen Common Law und bietet ein eigenes Rechtssystem. Das AIFC zielt darauf ab, ausländische Investitionen anzuziehen und den Finanzsektor zu entwickeln. Die Einrichtung umfasst einen Finanzgerichtshof, eine Börse (AIX) und eine Aufsichtsbehörde. Das AIFC hat Steuererleichterungen für Teilnehmer. Es ist ein zentraler Bestandteil der Wirtschaftsstrategie Kasachstans. Der Hauptsitz befindet sich im Expo-Gelände.",
      hu: "Az Asztana Nemzetközi Pénzügyi Központ (AIFC) Kazahsztán fővárosában, Nur-Szultanban (Asztana) található, 2018-ban alapították. Az angol Common Law alapján működik. Célja külföldi befektetések vonzása és a pénzügyi szektor fejlesztése. Az AIFC-nek saját pénzügyi bírósága, tőzsdéje (AIX) és szabályozó hatósága van. Adókedvezményeket kínál a résztvevőknek. A központ az Expo területen található. Része Kazahsztán gazdasági diverzifikációs stratégiájának.",
      ro: "Centrul Financiar Internațional Astana (AIFC) este un hub financiar din Nur-Sultan (Astana), Kazahstan, fondat în 2018. Funcționează pe baza dreptului comun englez. Scopul său este de a atrage investiții străine și de a dezvolta sectorul financiar. AIFC include o curte financiară, o bursă (AIX) și o autoritate de reglementare. Oferă stimulente fiscale pentru participanți. Sediul central se află pe terenul Expo. Este o parte cheie a strategiei economice a Kazahstanului.",
      en: "The Astana International Financial Centre (AIFC) is a financial hub in Nur-Sultan, Kazakhstan, established in 2018. It operates on English Common Law, with an independent legal system. The AIFC aims to attract foreign investment and develop the financial sector. It includes a Financial Court, the Astana International Exchange (AIX), and a regulatory authority. Participants benefit from tax incentives and a visa-free regime. The centre is located on the Expo 2017 site. It is a cornerstone of Kazakhstan's economic diversification plan.",
    },
    factsAdvanced: {
      de: ["Gegründet 2018.", "Basiert auf englischem Common Law.", "Eigener Finanzgerichtshof.", "Astana International Exchange (AIX).", "Steuerbefreiung für 50 Jahre.", "Sitz im Expo-Gelände."],
      hu: ["Alapítva: 2018.", "Angol Common Law.", "Pénzügyi bíróság.", "AIX tőzsde.", "Adókedvezmények.", "Expo terület."],
      ro: ["Fondat în 2018.", "Drept comun englez.", "Curte financiară.", "Bursa AIX.", "Scutiri fiscale.", "Situat pe terenul Expo."],
      en: ["Established in 2018.", "English Common Law jurisdiction.", "Financial Court established 2018.", "AIX launched in 2018.", "Tax exemption for participants.", "Located at Expo 2017 site."],
    },
  },
  {
    id: "kazakhstan-dostyk-station-economic-v2",
    type: "port",
    name: { de: "Grenzstation Dostyk", hu: "Dosztik vasútállomás", ro: "Stația feroviară Dostyk", en: "Dostyk Railway Station" },
    coords: [82.4825, 45.2522],
    description: {
      de: "Ein kritischer Eisenbahnknotenpunkt an der Grenze zu China für den eurasischen Handel. Hier erfolgt die Umspurung der Waggons zwischen verschiedenen Spurweiten.",
      hu: "Kritikus vasúti csomópont a kínai határon az eurázsiai kereskedelem számára. Itt történik a vagonok átszerelése a különböző nyomtávok között.",
      ro: "Un nod feroviar critic la granița cu China pentru comerțul eurasiatic. Aici are loc schimbarea ecartamentului vagoanelor între diferite sisteme.",
      en: "A critical railway junction on the border with China for Eurasian trade. It facilitates the transshipment of goods between different rail gauges.",
    },
    facts: {
      de: ["Teil der Seidenstraßen-Initiative", "Grenzpunkt zu Alashankou", "Umspuranlage für Breitspur", "Wichtigster Güterbahnhof im Osten"],
      hu: ["A Selyemút-kezdeményezés része", "Alashankou határpontja", "Széles nyomtávú átszerelő üzem", "Kelet legfontosabb teherpályaudvara"],
      ro: ["Parte a inițiativei Drumul Mătăsii", "Punct de frontieră cu Alashankou", "Instalație de schimbare a ecartamentului", "Cea mai importantă gară de marfă din est"],
      en: ["Part of the Silk Road initiative", "Border point with Alashankou", "Gauge conversion facilities", "Main freight terminal in the east"],
    },
    imageHint: "Cargo trains and rail lines at Dostyk border station",
    descriptionAdvanced: {
      de: "Der Bahnhof Dostyk ist ein zentraler Knotenpunkt für den Güterverkehr zwischen Kasachstan und China. Er liegt in der Region Almaty nahe der Grenze und wurde 2012 erweitert, um das steigende Handelsvolumen zu bewältigen. Mit einer Umschlagskapazität von über 20 Millionen Tonnen pro Jahr ist er einer der größten Trockenhäfen Zentralasiens. Die Anlage verfügt über moderne Containerterminals und Zollabfertigungsanlagen, die den Transit beschleunigen. Wirtschaftlich ist Dostyk ein Schlüsselfaktor für die kasachische Exportwirtschaft, insbesondere für Rohstoffe wie Öl und Getreide. Die Station verbindet die kasachische Eisenbahn mit der chinesischen Lanzhou-Xinjiang-Linie und fördert so die Integration in die Neue Seidenstraße.",
      hu: "A Dosztyk vasútállomás Kazahsztán és Kína közötti legfontosabb szárazföldi teherforgalmi csomópontja. Az Almati régióban, a határ közelében található, és 2012-ben bővítették a növekvő kereskedelmi forgalom kiszolgálására. Éves áteresztőképessége meghaladja a 20 millió tonnát, így Közép-Ázsia egyik legnagyobb száraz kikötőjének számít. A terminál modern konténerkezelő berendezésekkel és vámkezelő infrastruktúrával rendelkezik, amely lehetővé teszi a gyors tranzitot. Gazdasági szempontból az állomás kulcsszerepet játszik a kazah exportban, különösen az olaj, a szén és a gabona szállításában. A vasútvonal összeköti a kazah hálózatot a kínai Lanzhou–Xinjiang vonallal, elősegítve ezzel az Új Selyemút integrációját.",
      ro: "Gara Dostyk este un hub central pentru transportul de mărfuri între Kazahstan și China. Situată în regiunea Almaty, aproape de graniță, a fost extinsă în 2012 pentru a face față volumului crescut de comerț. Cu o capacitate anuală de tranzit de peste 20 de milioane de tone, este unul dintre cele mai mari porturi uscate din Asia Centrală. Facilitățile includ terminale moderne de containere și infrastructură vamală care accelerează tranzitul. Din punct de vedere economic, Dostyk este esențial pentru exporturile kazahe, în special pentru petrol, cărbune și cereale. Stația leagă rețeaua feroviară kazahă de linia Lanzhou-Xinjiang din China, facilitând integrarea în Noul Drum al Mătăsii.",
      en: "Dostyk Railway Station is a key freight hub on the Kazakhstan-China border, located in Almaty Region. Expanded in 2012, it handles over 20 million tonnes annually, making it one of Central Asia's largest dry ports. The facility features modern container terminals, customs clearance zones, and transshipment capabilities. Economically, it is vital for Kazakhstan's export of commodities like oil, coal, and grain. The station connects Kazakhstan's rail network with China's Lanzhou-Xinjiang line, boosting trade along the New Silk Road. Its strategic location reduces transit times between Asia and Europe, supporting regional economic integration.",
    },
    factsAdvanced: {
      de: ["Erbaut 1959, erweitert 2012, 2019 modernisiert.", "Jährliche Kapazität: über 20 Millionen Tonnen Güter.", "Liegt 12 km von der chinesischen Grenze entfernt.", "Verbindet die Turksib-Eisenbahn mit der Lanzhou-Xinjiang-Linie.", "Abfertigung von bis zu 30 Zügen pro Tag.", "Terminalfläche: 150 Hektar."],
      hu: ["Épült: 1959, bővítve 2012-ben, modernizálva 2019-ben.", "Éves kapacitás: több mint 20 millió tonna.", "Kínai határtól 12 km-re található.", "Összeköti a Turksib vasútvonalat a Lanzhou–Xinjiang vonallal.", "Napi 30 vonat kezelésére alkalmas.", "Terminál területe: 150 hektár."],
      ro: ["Construit în 1959, extins în 2012, modernizat în 2019.", "Capacitate anuală: peste 20 de milioane de tone.", "Situat la 12 km de granița cu China.", "Leagă calea ferată Turksib de linia Lanzhou-Xinjiang.", "Poate gestiona până la 30 de trenuri pe zi.", "Suprafața terminalului: 150 de hectare."],
      en: ["Built in 1959, expanded in 2012, modernized in 2019.", "Annual capacity: over 20 million tonnes.", "Located 12 km from the Chinese border.", "Connects the Turksib railway to the Lanzhou-Xinjiang line.", "Handles up to 30 trains per day.", "Terminal area: 150 hectares."],
    },
  },
  {
    id: "kazakhstan-tortkuduk-mine-economic-v2",
    type: "mine",
    name: { de: "Uranmine Tortkuduk", hu: "Tortkuduk uránbánya", ro: "Mina de uraniu Tortkuduk", en: "Tortkuduk Uranium Mine" },
    coords: [67.8167, 44.1167],
    description: {
      de: "Eine der produktivsten Uranminen der Welt im Chu-Sarysu-Becken. Sie nutzt die In-situ-Laugung zur Gewinnung des Metalls aus dem Untergrund.",
      hu: "A világ egyik legtermelékenyebb uránbányája a Csu-Szariszu medencében. In-situ kilúgozást alkalmaznak a fém kinyerésére a föld alól.",
      ro: "Una dintre cele mai productive mine de uraniu din lume în bazinul Chu-Sarysu. Utilizează lixivierea in situ pentru extracția metalului.",
      en: "One of the most productive uranium mines in the world in the Chu-Sarysu basin. It uses in-situ leaching to extract the metal from underground.",
    },
    facts: {
      de: ["Förderung durch In-situ-Laugung", "Liegt in der Region Turkistan", "Betrieben durch KATCO-JV", "Weltweit führende Produktionsmengen"],
      hu: ["In-situ kilúgozásos technológia", "Turkesztán régióban található", "A KATCO vegyesvállalat üzemelteti", "Világelső termelési volumen"],
      ro: ["Extracție prin lixiviere in situ", "Situată în regiunea Turkistan", "Operată de joint-venture-ul KATCO", "Volume de producție lider mondial"],
      en: ["Extraction via in-situ leaching", "Located in Turkistan region", "Operated by KATCO joint venture", "World-leading production volumes"],
    },
    imageHint: "Aerial view of an in-situ leaching uranium mining facility",
    descriptionAdvanced: {
      de: "Die Tortkuduk-Uranmine im Süden Kasachstans ist eine der produktivsten in-situ-Laugungsminen weltweit. Betrieben von Kazatomprom und KATCO, fördert sie seit 2001 Uran mit einem Jahresertrag von über 2.000 Tonnen. Die Mine liegt im Bezirk Suzak in der Region Turkistan und nutzt das In-Situ-Leaching-Verfahren, das kosteneffizient und umweltschonend ist. Die Region verfügt über bedeutende Uranvorkommen, und Tortkuduk ist ein wichtiger Lieferant für kasachische Uranexporte nach China und Europa. Die Mine beschäftigt rund 1.200 Mitarbeiter und trägt signifikant zur lokalen Wirtschaft bei.",
      hu: "A Tortkuduk uránbánya Kazahsztán déli részén található, és a világ egyik legtermékenyebb in-situ kilúgozásos bányája. A Kazatomprom és a KATCO üzemelteti, 2001 óta termel, éves kibocsátása meghaladja a 2.000 tonnát. A bánya a Turkisztáni régió Suzak kerületében fekszik, és az in-situ kilúgozásos technológiát alkalmazza, amely költséghatékony és környezetbarát. A térség jelentős uránkészletekkel rendelkezik, Tortkuduk pedig fontos beszállítója a kazah uránexportnak Kína és Európa felé. A bánya mintegy 1.200 főt foglalkoztat, és jelentős mértékben hozzájárul a helyi gazdasághoz.",
      ro: "Mina de uraniu Tortkuduk, situată în sudul Kazahstanului, este una dintre cele mai productive mine de exploatare prin levigare in-situ din lume. Operată de Kazatomprom și KATCO, produce din 2001, cu o producție anuală de peste 2.000 de tone. Mina se află în districtul Suzak, regiunea Turkistan, și utilizează tehnologia de levigare in-situ, eficientă din punct de vedere al costurilor și prietenoasă cu mediul. Zona deține rezerve semnificative de uraniu, iar Tortkuduk este un furnizor important pentru exporturile de uraniu kazah către China și Europa. Mina angajează aproximativ 1.200 de persoane și contribuie semnificativ la economia locală.",
      en: "The Tortkuduk Uranium Mine in southern Kazakhstan is one of the world's most productive in-situ leaching mines. Operated by Kazatomprom and KATCO, it has been in production since 2001, with an annual output exceeding 2,000 tonnes. Located in Suzak district, Turkistan Region, it uses in-situ leaching technology, which is cost-effective and environmentally friendly. The area hosts significant uranium reserves, and Tortkuduk is a key supplier for Kazakhstan's uranium exports to China and Europe. The mine employs around 1,200 workers and contributes substantially to the local economy.",
    },
    factsAdvanced: {
      de: ["Produktion seit 2001, erweitert 2015.", "Jährliche Förderung: über 2.000 Tonnen Uran.", "Reserven: etwa 40.000 Tonnen Uran.", "Bohrlochfeld: über 1.200 Bohrlöcher.", "Beschäftigte: rund 1.200 Mitarbeiter.", "Investitionen: über 500 Millionen US-Dollar."],
      hu: ["Termelés 2001 óta, bővítve 2015-ben.", "Éves kibocsátás: több mint 2.000 tonna urán.", "Készletek: körülbelül 40.000 tonna urán.", "Fúrólyukak száma: több mint 1.200.", "Foglalkoztatottak: mintegy 1.200 fő.", "Befektetés: több mint 500 millió amerikai dollár."],
      ro: ["Producție din 2001, extinsă în 2015.", "Producție anuală: peste 2.000 de tone de uraniu.", "Rezerve: aproximativ 40.000 de tone de uraniu.", "Câmp de sonde: peste 1.200 de sonde.", "Angajați: aproximativ 1.200 de persoane.", "Investiții: peste 500 de milioane de dolari americani."],
      en: ["Production since 2001, expanded in 2015.", "Annual output: over 2,000 tonnes of uranium.", "Reserves: approximately 40,000 tonnes of uranium.", "Wellfield: over 1,200 wells.", "Employees: around 1,200.", "Investment: over 500 million US dollars."],
    },
  },
  {
    id: "kazakhstan-shulbinsk-hpp-economic-v2",
    type: "factory",
    name: { de: "Wasserkraftwerk Schulbinsk", hu: "Sulbinszki vízerőmű", ro: "Hidrocentrala Shulbinsk", en: "Shulbinsk Hydroelectric Plant" },
    coords: [81.0, 50.4],
    description: {
      de: "Das größte Wasserkraftwerk Kasachstans liegt am Fluss Irtysch bei Semei. Es dient der Stromerzeugung und der Regulierung der Schifffahrt auf dem Fluss.",
      hu: "Kazahsztán legnagyobb vízerőműve az Irtis folyón, Szejmej közelében. Áramtermelésre és a folyami hajózás szabályozására szolgál.",
      ro: "Cea mai mare hidrocentrală din Kazahstan este situată pe râul Irtîș, lângă Semei. Servește la producerea energiei și reglarea navigației.",
      en: "The largest hydroelectric power station in Kazakhstan, located on the Irtysh River near Semey. It serves for power generation and river navigation control.",
    },
    facts: {
      de: ["Am Fluss Irtysch gelegen", "Installierte Leistung von 702 MW", "Bauabschluss im Jahr 1987", "Größte Talsperre des Landes"],
      hu: ["Az Irtis folyón található", "702 MW beépített teljesítmény", "1987-ben fejezték be az építést", "Az ország legnagyobb gátja"],
      ro: ["Situată pe râul Irtîș", "Putere instalată de 702 MW", "Construcție finalizată în 1987", "Cel mai mare baraj din țară"],
      en: ["Located on the Irtysh River", "Installed capacity of 702 MW", "Construction completed in 1987", "Largest dam in the country"],
    },
    imageHint: "Massive concrete dam of the Shulbinsk hydroelectric station",
    descriptionAdvanced: {
      de: "Das Shulbinsker Wasserkraftwerk liegt am Irtysch-Fluss im Osten Kasachstans, nahe der Stadt Semei. Es wurde 1987 in Betrieb genommen und hat eine installierte Leistung von 702 MW. Die Anlage besteht aus sechs Turbinen und erzeugt jährlich rund 1,7 Milliarden kWh Strom. Als Teil des Irtysch-Kaskades reguliert es den Wasserfluss für Bewässerung und Hochwasserschutz. Wirtschaftlich versorgt es Haushalte und Industrie in der Region Ostkasachstan und ist ein wichtiger Bestandteil des kasachischen Energiemixes. Der Staudamm ist 60 m hoch und 1.200 m lang.",
      hu: "A Sulbinszki vízerőmű az Irtisz folyón épült Kelet-Kazahsztánban, Szemej város közelében. 1987-ben helyezték üzembe, beépített teljesítménye 702 MW. Hat turbinával rendelkezik, éves termelése körülbelül 1,7 milliárd kWh. Az Irtisz-kaszkád részeként szabályozza a vízhozamot öntözési és árvízvédelmi célokból. Gazdasági szempontból ellátja a kelet-kazahsztáni háztartásokat és ipart, fontos része a kazah energiamixnek. A gát magassága 60 m, hossza 1.200 m.",
      ro: "Centrala hidroelectrică Shulbinsk este situată pe râul Irtysh, în estul Kazahstanului, lângă orașul Semei. A fost pusă în funcțiune în 1987, având o capacitate instalată de 702 MW. Are șase turbine și produce anual aproximativ 1,7 miliarde kWh. Ca parte a cascadei Irtysh, reglează debitul apei pentru irigații și protecția împotriva inundațiilor. Din punct de vedere economic, furnizează energie electrică gospodăriilor și industriei din regiunea Kazahstanului de Est, fiind o componentă importantă a mixului energetic kazah. Barajul are 60 m înălțime și 1.200 m lungime.",
      en: "Shulbinsk Hydroelectric Plant is located on the Irtysh River in eastern Kazakhstan, near Semei city. Commissioned in 1987, it has an installed capacity of 702 MW. The plant has six turbines and generates about 1.7 billion kWh annually. As part of the Irtysh cascade, it regulates water flow for irrigation and flood control. Economically, it supplies electricity to households and industry in East Kazakhstan Region and is a key component of the national energy mix. The dam is 60 m high and 1,200 m long.",
    },
    factsAdvanced: {
      de: ["Inbetriebnahme: 1987.", "Installierte Leistung: 702 MW.", "Jahreserzeugung: ca. 1,7 Milliarden kWh.", "Anzahl Turbinen: 6.", "Dammhöhe: 60 m, Länge: 1.200 m.", "Stauseefläche: 255 km²."],
      hu: ["Üzembe helyezés: 1987.", "Beépített teljesítmény: 702 MW.", "Éves termelés: kb. 1,7 milliárd kWh.", "Turbinák száma: 6.", "Gát magassága: 60 m, hossza: 1.200 m.", "Tározó területe: 255 km²."],
      ro: ["Punere în funcțiune: 1987.", "Capacitate instalată: 702 MW.", "Producție anuală: aproximativ 1,7 miliarde kWh.", "Număr turbine: 6.", "Înălțime baraj: 60 m, lungime: 1.200 m.", "Suprafața lacului: 255 km²."],
      en: ["Commissioned: 1987.", "Installed capacity: 702 MW.", "Annual generation: about 1.7 billion kWh.", "Number of turbines: 6.", "Dam height: 60 m, length: 1,200 m.", "Reservoir area: 255 km²."],
    },
  },
  {
    id: "kazakhstan-vasilykovskoye-gold-economic-v2",
    type: "mine",
    name: { de: "Goldmine Wassilykowskoje", hu: "Vasziljkovszkojei aranybánya", ro: "Mina de aur Vasilykovskoye", en: "Vasilykovskoye Gold Mine" },
    coords: [68.95, 53.45],
    description: {
      de: "Dieses riesige Goldvorkommen in der Nähe von Kokshetau ist eine der größten Lagerstätten Zentralasiens. Das Erz wird in einem massiven Tagebau gefördert.",
      hu: "Ez a hatalmas aranylelőhely Kokssetau közelében Közép-Ázsia egyik legnagyobbja. Az ércet egy hatalmas külszíni fejtésben bányásszák.",
      ro: "Această uriașă resursă de aur de lângă Kokshetau este una dintre cele mai mari din Asia Centrală. Minereul este extras într-o carieră masivă.",
      en: "This huge gold deposit near Kokshetau is one of the largest in Central Asia. The ore is extracted in a massive open-pit mining operation.",
    },
    facts: {
      de: ["Größte Goldmine Kasachstans", "Betrieben durch Altyntau Kokshetau", "Modernste Aufbereitungsanlage", "Liegt in der Region Akmola"],
      hu: ["Kazahsztán legnagyobb aranybányája", "Az Altyntau Kokshetau üzemelteti", "Legmodernebb feldolgozó üzem", "Akmola régióban található"],
      ro: ["Cea mai mare mină de aur din Kazahstan", "Operată de Altyntau Kokshetau", "Uzina de procesare ultramodernă", "Situată în regiunea Akmola"],
      en: ["Largest gold mine in Kazakhstan", "Operated by Altyntau Kokshetau", "State-of-the-art processing plant", "Located in Akmola region"],
    },
    imageHint: "Deep open-pit gold mine with terraced walls",
    descriptionAdvanced: {
      de: "Die Vasilykovskoye Goldmine liegt im Norden Kasachstans, in der Region Aqmola. Betrieben von Kazakhmys Gold, ist sie eine bedeutende Goldlagerstätte mit einem jährlichen Ausstoß von etwa 180.000 Unzen. Die Mine verwendet sowohl Tagebau als auch Untertagebau. Die erkundeten Reserven belaufen sich auf über 10 Millionen Unzen Gold. Die Mine wurde 2018 eröffnet und hat sich zu einem wichtigen Arbeitgeber in der Region entwickelt. Sie produziert Goldbarren für den Export, hauptsächlich nach China und in die Schweiz.",
      hu: "A Vaszilkovszkoje aranybánya Észak-Kazahsztánban, az Akmolai régióban található. A Kazakhmys Gold üzemelteti, éves termelése mintegy 180.000 uncia arany. A lelőhelyet külszíni és mélyműveléssel egyaránt bányásszák. Feltárt készletei meghaladják a 10 millió uncia aranyat. A bánya 2018-ban nyílt meg, és mára a régió egyik legnagyobb foglalkoztatójává vált. Előállított aranyrudakat exportál, elsősorban Kínába és Svájcba.",
      ro: "Mina de aur Vasilykovskoye este situată în nordul Kazahstanului, în regiunea Aqmola. Operată de Kazakhmys Gold, produce anual aproximativ 180.000 de uncii de aur. Mina utilizează atât exploatare la suprafață, cât și subterană. Rezervele dovedite depășesc 10 milioane de uncii de aur. Mina a fost deschisă în 2018 și a devenit un important angajator în regiune. Produce lingouri de aur pentru export, în principal către China și Elveția.",
      en: "Vasilykovskoye Gold Mine is located in northern Kazakhstan, in Aqmola Region. Operated by Kazakhmys Gold, it produces around 180,000 ounces of gold annually. The deposit is mined using both open-pit and underground methods. Proven reserves exceed 10 million ounces of gold. The mine opened in 2018 and has become a major employer in the region. It produces gold bullion for export, primarily to China and Switzerland.",
    },
    factsAdvanced: {
      de: ["Jährliche Produktion: ca. 180.000 Unzen Gold.", "Eröffnung: 2018.", "Reserven: über 10 Millionen Unzen Gold.", "Beschäftigte: rund 1.500 Mitarbeiter.", "Tagebaufläche: 4 km².", "Investitionen: 1,2 Milliarden US-Dollar."],
      hu: ["Éves termelés: kb. 180.000 uncia arany.", "Nyitás: 2018.", "Készletek: több mint 10 millió uncia arany.", "Foglalkoztatottak: mintegy 1.500 fő.", "Külszíni bánya területe: 4 km².", "Befektetés: 1,2 milliárd amerikai dollár."],
      ro: ["Producție anuală: aproximativ 180.000 de uncii de aur.", "Deschidere: 2018.", "Rezerve: peste 10 milioane de uncii de aur.", "Angajați: aproximativ 1.500 de persoane.", "Suprafața carierei: 4 km².", "Investiții: 1,2 miliarde de dolari americani."],
      en: ["Annual production: about 180,000 ounces of gold.", "Opened: 2018.", "Reserves: over 10 million ounces of gold.", "Employees: around 1,500.", "Open-pit area: 4 km².", "Investment: 1.2 billion US dollars."],
    },
  },
  {
    id: "kazakhstan-icbc-khorgos-economic-v2",
    type: "landmark",
    name: { de: "Grenzzentrum Khorgos ICBC", hu: "Horgos Nemzetközi Határközpont", ro: "Centrul Transfrontalier Khorgos", en: "ICBC Khorgos" },
    coords: [80.4125, 44.2205],
    description: {
      de: "Eine visumfreie Handelszone an der kasachisch-chinesischen Grenze für Touristen und Händler. Sie verbindet beide Länder durch riesige Einkaufszentren.",
      hu: "Vízummentes kereskedelmi övezet a kazah-kínai határon turisták és kereskedők számára. Hatalmas bevásárlóközpontokkal köti össze a két országot.",
      ro: "O zonă comercială fără vize la granița kazaho-chineză pentru turiști și comercianți. Conectează cele două țări prin centre comerciale uriașe.",
      en: "A visa-free trade zone on the Kazakh-Chinese border for tourists and merchants. It connects both countries through massive shopping complexes.",
    },
    facts: {
      de: ["Visumfreier Zugang für 30 Tage", "Zwei Hälften über die Grenze", "Großer Duty-Free-Marktplatz", "Teil der Sonderwirtschaftszone"],
      hu: ["30 napos vízummentes belépés", "Két fél a határon keresztül", "Hatalmas vámmentes piac", "A különleges gazdasági övezet része"],
      ro: ["Acces fără viză timp de 30 de zile", "Două jumătăți peste frontieră", "Piață duty-free uriașă", "Parte a zonei economice speciale"],
      en: ["Visa-free access for 30 days", "Two halves across the border", "Large duty-free marketplace", "Part of the Special Economic Zone"],
    },
    imageHint: "Modern shopping malls at the Khorgos border crossing",
    descriptionAdvanced: {
      de: "ICBC Khorgos (International Center for Border Cooperation) ist eine Sonderwirtschaftszone an der chinesisch-kasachischen Grenze. Es wurde 2015 eröffnet und ist ein zollfreies Handels- und Logistikzentrum, das von beiden Ländern gemeinsam verwaltet wird. Die Anlage erstreckt sich über 4 km² und umfasst Lagerhallen, Einzelhandelsflächen und eine Containerzugstation. ICBC Khorgos fördert den grenzüberschreitenden Handel und hat sich zu einem der wichtigsten Umschlagplätze entlang der Neuen Seidenstraße entwickelt. Der jährliche Handelsumsatz beträgt über 10 Milliarden US-Dollar.",
      hu: "Az ICBC Khorgos (Nemzetközi Határegyüttműködési Központ) egy különleges gazdasági övezet a kínai-kazah határon. 2015-ben nyitották meg, vámmentes kereskedelmi és logisztikai központ, amelyet a két ország közösen kezel. Területe 4 km², raktárakat, kiskereskedelmi egységeket és konténeres vasútállomást foglal magában. Az ICBC Khorgos elősegíti a határon átnyúló kereskedelmet, és az Új Selyemút egyik legfontosabb átrakóhelyévé vált. Éves kereskedelmi forgalma meghaladja a 10 milliárd amerikai dollárt.",
      ro: "ICBC Khorgos (Centrul Internațional de Cooperare la Frontieră) este o zonă economică specială la granița dintre Kazahstan și China. Deschis în 2015, este un centru comercial și logistic fără taxe vamale, gestionat în comun de cele două țări. Se întinde pe 4 km² și include depozite, spații comerciale și o stație feroviară de containere. ICBC Khorgos stimulează comerțul transfrontalier și a devenit unul dintre cele mai importante puncte de transbordare de pe Noul Drum al Mătăsii. Volumul anual al comerțului depășește 10 miliarde de dolari americani.",
      en: "ICBC Khorgos (International Center for Border Cooperation) is a special economic zone on the Kazakhstan-China border. Opened in 2015, it is a duty-free trade and logistics hub jointly managed by both countries. Covering 4 km², it includes warehouses, retail space, and a container rail station. ICBC Khorgos facilitates cross-border trade and has become one of the most important transshipment points along the New Silk Road. Annual trade turnover exceeds 10 billion US dollars.",
    },
    factsAdvanced: {
      de: ["Eröffnung: 2015.", "Fläche: 4 km².", "Jährlicher Handelsumsatz: über 10 Mrd. USD.", "Zollfreie Zone: 50-jährige Laufzeit.", "Anzahl der Unternehmen: über 200.", "Täglicher Frachtverkehr: bis zu 500 LKW."],
      hu: ["Nyitás: 2015.", "Terület: 4 km².", "Éves kereskedelmi forgalom: több mint 10 milliárd USD.", "Vámmentes övezet: 50 éves időtartam.", "Vállalkozások száma: több mint 200.", "Napi teherforgalom: akár 500 teherautó."],
      ro: ["Deschidere: 2015.", "Suprafață: 4 km².", "Cifră anuală de afaceri: peste 10 miliarde USD.", "Zonă duty-free: durata de 50 de ani.", "Număr de companii: peste 200.", "Trafic zilnic de marfă: până la 500 de camioane."],
      en: ["Opened: 2015.", "Area: 4 km².", "Annual trade turnover: over 10 billion USD.", "Duty-free zone: 50-year term.", "Number of companies: over 200.", "Daily truck traffic: up to 500 trucks."],
    },
  },
  {
    id: "kazakhstan-bukhtarma-hpp-economic-v2",
    type: "factory",
    name: { de: "Wasserkraftwerk Buchtarma", hu: "Buhtarmai vízerőmű", ro: "Hidrocentrala Bukhtarma", en: "Bukhtarma Hydroelectric Plant" },
    coords: [83.502, 49.6015],
    description: {
      de: "Dieses Kraftwerk staut den Buchtarma-Stausee auf, einen der größten künstlichen Seen der Welt. Es ist ein wichtiger Teil der Energiekaskade am Irtysch.",
      hu: "Ez az erőmű duzzasztja fel a Buhtarma-víztározót, a világ egyik legnagyobb mesterséges tavát. Az Irtis folyó energiakaszkádjának fontos része.",
      ro: "Această centrală formează rezervorul Bukhtarma, unul dintre cele mai mari lacuri artificiale din lume. Este o parte vitală a cascadei Irtîș.",
      en: "This power plant creates the Bukhtarma Reservoir, one of the world's largest artificial lakes. It is a vital part of the Irtysh River energy cascade.",
    },
    facts: {
      de: ["Staut den Irtysch-Fluss", "Bauzeit von 1953 bis 1966", "Leistung von 675 MW", "Riesiger künstlicher Stausee"],
      hu: ["Az Irtis folyót duzzasztja", "1953-tól 1966-ig épült", "675 MW teljesítmény", "Hatalmas mesterséges víztározó"],
      ro: ["Zăgăzuiește râul Irtîș", "Construită între 1953 și 1966", "Capacitate de 675 MW", "Rezervor artificial imens"],
      en: ["Dams the Irtysh River", "Built between 1953 and 1966", "Capacity of 675 MW", "Huge artificial reservoir"],
    },
    imageHint: "The Bukhtarma dam and the vast reservoir behind it",
    descriptionAdvanced: {
      de: "Das Bukhtarma-Wasserkraftwerk am Irtysch-Fluss in Ostkasachstan wurde 1966 in Betrieb genommen. Mit einer installierten Leistung von 675 MW ist es eines der größten Wasserkraftwerke Kasachstans. Die Anlage hat acht Turbinen und erzeugt jährlich rund 2 Milliarden kWh Strom. Der dazugehörige Bukhtarma-Stausee mit einer Fläche von 5.500 km² ist einer der größten der Welt. Das Kraftwerk reguliert den Irtysch für die Bewässerung und den Hochwasserschutz und versorgt Bergbau- und Industrieanlagen der Region mit Energie.",
      hu: "A Buhtarma vízerőmű az Irtisz folyón, Kelet-Kazahsztánban 1966-ban kezdte meg működését. Beépített teljesítménye 675 MW, így Kazahsztán egyik legnagyobb vízerőműve. Nyolc turbinával rendelkezik, éves termelése mintegy 2 milliárd kWh. A hozzá tartozó Buhtarma-tározó 5.500 km² területével a világ egyik legnagyobb mesterséges tava. Az erőmű szabályozza az Irtiszt öntözési és árvízvédelmi céllal, valamint ellátja energiával a régió bányászati és ipari létesítményeit.",
      ro: "Centrala hidroelectrică Bukhtarma de pe râul Irtysh, din estul Kazahstanului, a fost dată în funcțiune în 1966. Cu o capacitate instalată de 675 MW, este una dintre cele mai mari hidrocentrale din Kazahstan. Are opt turbine și produce anual aproximativ 2 miliarde kWh. Lacul de acumulare Bukhtarma, cu o suprafață de 5.500 km², este unul dintre cele mai mari din lume. Centrala reglează debitul Irtyshului pentru irigații și protecția împotriva inundațiilor și furnizează energie instalațiilor miniere și industriale din regiune.",
      en: "Bukhtarma Hydroelectric Plant on the Irtysh River in East Kazakhstan was commissioned in 1966. With an installed capacity of 675 MW, it is one of Kazakhstan's largest hydropower plants. The plant has eight turbines and generates about 2 billion kWh annually. The associated Bukhtarma Reservoir, covering 5,500 km², is one of the world's largest. The plant regulates the Irtysh for irrigation and flood control, and supplies power to mining and industrial facilities in the region.",
    },
    factsAdvanced: {
      de: ["Inbetriebnahme: 1966.", "Installierte Leistung: 675 MW.", "Jahreserzeugung: ca. 2 Milliarden kWh.", "Anzahl Turbinen: 8.", "Stauseefläche: 5.500 km².", "Dammhöhe: 70 m."],
      hu: ["Üzembe helyezés: 1966.", "Beépített teljesítmény: 675 MW.", "Éves termelés: kb. 2 milliárd kWh.", "Turbinák száma: 8.", "Tározó területe: 5.500 km².", "Gát magassága: 70 m."],
      ro: ["Punere în funcțiune: 1966.", "Capacitate instalată: 675 MW.", "Producție anuală: aproximativ 2 miliarde kWh.", "Număr turbine: 8.", "Suprafața lacului: 5.500 km².", "Înălțimea barajului: 70 m."],
      en: ["Commissioned: 1966.", "Installed capacity: 675 MW.", "Annual generation: about 2 billion kWh.", "Number of turbines: 8.", "Reservoir area: 5,500 km².", "Dam height: 70 m."],
    },
  },
  {
    id: "kazakhstan-nurly-tau-economic-v2",
    type: "industry",
    name: { de: "Geschäftsviertel Nurly Tau", hu: "Nurli Tau üzleti negyed", ro: "Districtul financiar Nurly Tau", en: "Nurly Tau Business District" },
    coords: [76.9455, 43.2385],
    description: {
      de: "Almatys bedeutendstes Finanz- und Geschäftszentrum mit ikonischer Architektur. Die Gebäude ähneln den Gipfeln der umliegenden Trans-Ili-Alatau-Berge.",
      hu: "Almati legjelentősebb pénzügyi és üzleti központja ikonikus építészettel. Az épületek a környező Transz-Ili Alatau-hegység csúcsait formázzák.",
      ro: "Cel mai important centru financiar și de afaceri din Almaty, cu arhitectură iconică. Clădirile seamănă cu vârfurile munților Alatau din jur.",
      en: "Almaty's most prominent financial and business center with iconic architecture. The buildings resemble the peaks of the surrounding Alatau mountains.",
    },
    facts: {
      de: ["Größtes Bürozentrum Almatys", "Postmoderne Glasarchitektur", "Sitz vieler Banken und Fonds", "Blick auf das Alatau-Gebirge"],
      hu: ["Almati legnagyobb irodaháza", "Posztmodern üvegarchitektúra", "Számos bank és alap székhelye", "Kilátás az Alatau-hegységre"],
      ro: ["Cel mai mare centru de birouri din Almaty", "Arhitectură postmodernă din sticlă", "Sediul multor bănci și fonduri", "Vedere spre munții Alatau"],
      en: ["Largest office center in Almaty", "Postmodern glass architecture", "Headquarters of many banks", "View of the Alatau Mountains"],
    },
    imageHint: "Modern blue glass skyscrapers of Nurly Tau in Almaty",
    descriptionAdvanced: {
      de: "Das Nurly Tau Geschäftsviertel liegt im Zentrum von Almaty, Kasachstan. Es wurde ab 2005 entwickelt und umfasst mehrere Wolkenkratzer mit Büroflächen, Hotels und Einkaufszentren. Das Viertel erstreckt sich über 60 Hektar und beherbergt Hauptsitze großer kasachischer Unternehmen sowie internationale Konzerne. Die höchsten Gebäude sind der Nurly Tau Tower (180 m) und der Almaty Tower (140 m). Das Viertel ist ein Symbol der wirtschaftlichen Modernisierung Kasachstans und ein wichtiges Finanzzentrum in Zentralasien.",
      hu: "A Nurly Tau üzleti negyed Almati központjában, Kazahsztánban található. 2005 után kezdték el fejleszteni, több felhőkarcolónak ad otthont irodákkal, szállodákkal és bevásárlóközpontokkal. A negyed 60 hektáron terül el, és itt találhatóak nagy kazah vállalatok, valamint nemzetközi cégek székhelyei. A legmagasabb épületek a Nurly Tau Torony (180 m) és az Almati Torony (140 m). A negyed Kazahsztán gazdasági modernizációjának szimbóluma és fontos pénzügyi központ Közép-Ázsiában.",
      ro: "Districtul de afaceri Nurly Tau este situat în centrul orașului Almaty, Kazahstan. Dezvoltat începând cu 2005, cuprinde mai multe zgârie-nori cu birouri, hoteluri și centre comerciale. Zona se întinde pe 60 de hectare și găzduiește sedii centrale ale marilor companii kazahe, precum și corporații internaționale. Cele mai înalte clădiri sunt Turnul Nurly Tau (180 m) și Turnul Almaty (140 m). Districtul este un simbol al modernizării economice a Kazahstanului și un important centru financiar în Asia Centrală.",
      en: "Nurly Tau Business District is located in central Almaty, Kazakhstan. Developed from 2005 onward, it comprises multiple skyscrapers with office space, hotels, and shopping centers. The district spans 60 hectares and hosts headquarters of major Kazakh companies and international corporations. The tallest buildings are the Nurly Tau Tower (180 m) and Almaty Tower (140 m). The district symbolizes Kazakhstan's economic modernization and is a key financial hub in Central Asia.",
    },
    factsAdvanced: {
      de: ["Entwicklung seit 2005.", "Fläche: 60 Hektar.", "Höchstes Gebäude: Nurly Tau Tower, 180 m.", "Anzahl Bürogebäude: über 10.", "Bürofläche: 200.000 m².", "Einwohner des Viertels: ca. 5.000."],
      hu: ["Fejlesztés 2005 óta.", "Terület: 60 hektár.", "Legmagasabb épület: Nurly Tau Torony, 180 m.", "Irodaépületek száma: több mint 10.", "Irodaterület: 200.000 m².", "A negyed lakóinak száma: kb. 5.000."],
      ro: ["Dezvoltare începând cu 2005.", "Suprafață: 60 de hectare.", "Cea mai înaltă clădire: Turnul Nurly Tau, 180 m.", "Număr clădiri de birouri: peste 10.", "Suprafață birouri: 200.000 m².", "Populație rezidentă: aproximativ 5.000."],
      en: ["Development since 2005.", "Area: 60 hectares.", "Tallest building: Nurly Tau Tower, 180 m.", "Number of office buildings: over 10.", "Office space: 200,000 m².", "Resident population: about 5,000."],
    },
  },
  {
    id: "kazakhstan-aktau-north-terminal-economic-v2",
    type: "port",
    name: { de: "Nordterminal des Hafens Aktau", hu: "Aktaui északi kikötői terminál", ro: "Terminalul de Nord Port Aktau", en: "Aktau Sea North Terminal" },
    coords: [50.201, 44.502],
    description: {
      de: "Eine Erweiterung des Hafens Aktau zur Steigerung der Getreide- und Containerexporte. Es ist ein Schlüsselpunkt des Trans-Kaspischen Transportweges.",
      hu: "Az aktaui kikötő bővítése a gabona- és konténerexport növelése érdekében. A Transzkaszpi Szállítási Útvonal egyik kulcspontja.",
      ro: "O extindere a portului Aktau pentru a crește exporturile de cereale și containere. Este un punct cheie al rutei transcaspice.",
      en: "An expansion of the Aktau port to increase grain and container exports. It is a key point of the Trans-Caspian International Transport Route.",
    },
    facts: {
      de: ["Spezialisierter Getreideterminal", "Umschlag von Containern", "Anbindung an Aserbaidschan", "Wichtiger kaspischer Logistikhub"],
      hu: ["Specializált gabonaterminál", "Konténerek rakodása", "Összeköttetés Azerbajdzsánnal", "Fontos kaszpi logisztikai csomópont"],
      ro: ["Terminal specializat pentru cereale", "Manipularea containerelor", "Conexiune cu Azerbaidjan", "Important hub logistic caspic"],
      en: ["Specialized grain terminal", "Container handling facilities", "Connection to Azerbaijan", "Important Caspian logistics hub"],
    },
    imageHint: "Container cranes and grain silos at Aktau North Terminal",
    descriptionAdvanced: {
      de: "Das Aktau Sea North Terminal ist ein wichtiger Hafen am Kaspischen Meer, in der Stadt Aktau im Westen Kasachstans. Es wurde 2018 eröffnet und ist spezialisiert auf den Umschlag von Öl, Getreide und Containerfracht. Der Terminal hat eine Kapazität von 3 Millionen Tonnen pro Jahr und ist Teil des Hafens Aktau, der ein zentraler Knotenpunkt für den kaspischen Handel ist. Die Einrichtung umfasst Liegeplätze, Lagerflächen und eine moderne Containerbrücke. Der Terminal fördert den Export kasachischer Rohstoffe in den Kaukasus und nach Europa.",
      hu: "Az Aktau északi tengeri terminál egy fontos kikötő a Kaszpi-tengeren, Aktau városában, Nyugat-Kazahsztánban. 2018-ban nyílt meg, és olaj, gabona és konténeres rakomány átrakodására specializálódott. Kapacitása évi 3 millió tonna, és része az Aktau kikötőnek, amely a kaszpi-tengeri kereskedelem központi csomópontja. A terminál rakpartokkal, tárolóterületekkel és modern konténeres daruval rendelkezik. Elősegíti a kazah nyersanyagok exportját a Kaukázusba és Európába.",
      ro: "Terminalul maritim de nord Aktau este un port important pe Marea Caspică, în orașul Aktau din vestul Kazahstanului. Deschis în 2018, este specializat în transbordarea de petrol, cereale și mărfuri containerizate. Capacitatea terminalului este de 3 milioane de tone pe an și face parte din portul Aktau, un nod central pentru comerțul caspic. Facilitatea include dane, zone de depozitare și o macara modernă pentru containere. Terminalul facilitează exportul de materii prime kazahe către Caucaz și Europa.",
      en: "Aktau Sea North Terminal is a major port on the Caspian Sea, in Aktau city, western Kazakhstan. Opened in 2018, it specializes in handling oil, grain, and containerized cargo. The terminal has a capacity of 3 million tonnes per year and is part of Aktau Port, a central hub for Caspian trade. The facility includes berths, storage areas, and a modern container crane. The terminal boosts Kazakhstan's exports of raw materials to the Caucasus and Europe.",
    },
    factsAdvanced: {
      de: ["Eröffnung: 2018.", "Jährliche Kapazität: 3 Millionen Tonnen.", "Wassertiefe am Kai: 8 m.", "Anzahl Liegeplätze: 4.", "Containerbrücke: 40 Tonnen Kapazität.", "Lagerfläche: 50.000 m²."],
      hu: ["Nyitás: 2018.", "Éves kapacitás: 3 millió tonna.", "Kikötői vízmélység: 8 m.", "Rakpartok száma: 4.", "Konténeres daru: 40 tonna kapacitás.", "Tárolóterület: 50.000 m²."],
      ro: ["Deschidere: 2018.", "Capacitate anuală: 3 milioane de tone.", "Adâncimea apei la cheu: 8 m.", "Număr de dane: 4.", "Macara container: capacitate de 40 de tone.", "Suprafață de depozitare: 50.000 m²."],
      en: ["Opened: 2018.", "Annual capacity: 3 million tonnes.", "Water depth at berth: 8 m.", "Number of berths: 4.", "Container crane: 40 tonnes capacity.", "Storage area: 50,000 m²."],
    },
  },
  {
    id: "kazakhstan-zhanazhol-complex-economic-v2",
    type: "factory",
    name: { de: "Gasverarbeitungswerk Zhanazhol", hu: "Zsanazsoli gázfeldolgozó mű", ro: "Complexul de gaze Zhanazhol", en: "Zhanazhol Gas Processing Complex" },
    coords: [58.152, 48.455],
    description: {
      de: "Ein großes Öl- und Gasfeld in der Region Aktöbe mit einer riesigen Verarbeitungsanlage. Es liefert einen erheblichen Teil des kasachischen Erdgases.",
      hu: "Hatalmas olaj- és gázmező Aktöbe régióban, óriási feldolgozó üzemmel. A kazah földgáz jelentős részét ez a komplexum biztosítja.",
      ro: "Un câmp petrolier și de gaze major în regiunea Aktobe, cu o uzină de procesare uriașă. Furnizează o parte semnificativă din gazul kazah.",
      en: "A major oil and gas field in the Aktobe region with a massive processing plant. It provides a significant portion of Kazakhstan's natural gas.",
    },
    facts: {
      de: ["Betrieben durch CNPC-Aktobemunaigas", "Drei Gasverarbeitungswerke", "Ölförderung seit den 1980ern", "Wichtig für den Export nach China"],
      hu: ["A CNPC-Aktobemunaigas üzemelteti", "Három gázfeldolgozó egység", "Olajtermelés az 1980-as évektől", "Fontos a kínai exporthoz"],
      ro: ["Operat de CNPC-Aktobemunaigas", "Trei uzine de procesare a gazelor", "Producție de petrol din anii '80", "Vital pentru exportul către China"],
      en: ["Operated by CNPC-Aktobemunaigas", "Three gas processing plants", "Oil production since the 1980s", "Vital for exports to China"],
    },
    imageHint: "Industrial skyline of a gas processing plant with flares",
    descriptionAdvanced: {
      de: "Das Zhanazhol Gas Processing Complex liegt im Bezirk Bayganin in der Region Aqtöbe. Es wurde 2014 in Betrieb genommen und verarbeitet Erdgas aus dem nahegelegenen Zhanazhol-Feld mit einer Kapazität von 1,5 Milliarden Kubikmetern pro Jahr. Die Anlage produziert Trockengas, Flüssiggas (LPG) und Kondensat. Sie ist ein wichtiger Bestandteil der kasachischen Gasinfrastruktur und versorgt den Inlandsmarkt sowie Exporte nach Russland und China. Das Komplex beschäftigt rund 800 Mitarbeiter.",
      hu: "A Zsanazsol gázfeldolgozó komplexum az Aktöbei régió Bayganin kerületében található. 2014-ben helyezték üzembe, és a közeli Zsanazsol mezőről származó földgázt dolgozza fel, éves kapacitása 1,5 milliárd köbméter. A létesítmény száraz gázt, cseppfolyósított gázt (LPG) és kondenzátumot állít elő. Fontos része a kazah gázinfrastruktúrának, ellátja a belföldi piacot, valamint exportál Oroszországba és Kínába. A komplexum mintegy 800 főt foglalkoztat.",
      ro: "Complexul de procesare a gazelor Zhanazhol este situat în districtul Bayganin, regiunea Aqtöbe. A fost pus în funcțiune în 2014 și procesează gaze naturale din câmpul Zhanazhol din apropiere, cu o capacitate anuală de 1,5 miliarde de metri cubi. Instalația produce gaz uscat, gaz petrolier lichefiat (GPL) și condensat. Este o componentă importantă a infrastructurii de gaze a Kazahstanului, aprovizionând piața internă și exporturile către Rusia și China. Complexul angajează aproximativ 800 de persoane.",
      en: "The Zhanazhol Gas Processing Complex is located in Bayganin district, Aqtöbe Region. Commissioned in 2014, it processes natural gas from the nearby Zhanazhol field, with an annual capacity of 1.5 billion cubic meters. The plant produces dry gas, liquefied petroleum gas (LPG), and condensate. It is a key component of Kazakhstan's gas infrastructure, supplying domestic markets and exports to Russia and China. The complex employs around 800 workers.",
    },
    factsAdvanced: {
      de: ["Inbetriebnahme: 2014.", "Jährliche Kapazität: 1,5 Mrd. m³.", "Produkte: Trockengas, LPG, Kondensat.", "Beschäftigte: etwa 800.", "Investitionen: 2 Milliarden US-Dollar.", "Lagerkapazität: 50.000 m³ LPG."],
      hu: ["Üzembe helyezés: 2014.", "Éves kapacitás: 1,5 milliárd m³.", "Termékek: száraz gáz, LPG, kondenzátum.", "Foglalkoztatottak: mintegy 800.", "Befektetés: 2 milliárd amerikai dollár.", "Tárolókapacitás: 50.000 m³ LPG."],
      ro: ["Punere în funcțiune: 2014.", "Capacitate anuală: 1,5 miliarde m³.", "Produse: gaz uscat, GPL, condensat.", "Angajați: aproximativ 800.", "Investiții: 2 miliarde de dolari americani.", "Capacitatea de depozitare: 50.000 m³ GPL."],
      en: ["Commissioned: 2014.", "Annual capacity: 1.5 billion m³.", "Products: dry gas, LPG, condensate.", "Employees: about 800.", "Investment: 2 billion US dollars.", "Storage capacity: 50,000 m³ LPG."],
    },
  },
  {
    id: "kazakhstan-kentau-transformer-economic-v2",
    type: "factory",
    name: { de: "Transformatorenwerk Kentau", hu: "Kentaui Transzformátorgyár", ro: "Fabrica de Transformatoare Kentau", en: "Kentau Transformer Plant" },
    coords: [68.514, 43.518],
    description: {
      de: "Kasachstans führender Hersteller von elektrischer Ausrüstung und Transformatoren. Die Fabrik ist das wirtschaftliche Rückgrat der Industriestadt Kentau.",
      hu: "Kazahsztán vezető elektromos berendezés- és transzformátorgyártója. A gyár Kentau iparvárosának gazdasági gerincét alkotja.",
      ro: "Principalul producător de echipamente electrice și transformatoare din Kazahstan. Fabrica este coloana vertebrală a orașului industrial Kentau.",
      en: "Kazakhstan's leading manufacturer of electrical equipment and transformers. The plant forms the economic backbone of the industrial city of Kentau.",
    },
    facts: {
      de: ["Gegründet im Jahr 1959", "Größter Exporteur von Transformatoren", "Teil der Alageum Electric Gruppe", "Über 1000 Mitarbeiter vor Ort"],
      hu: ["1959-ben alapították", "A transzformátorok legnagyobb exportőre", "Az Alageum Electric csoport tagja", "Több mint 1000 helyi munkavállaló"],
      ro: ["Fondată în anul 1959", "Cel mai mare exportator de transformatoare", "Parte a grupului Alageum Electric", "Peste 1000 de angajați locali"],
      en: ["Founded in 1959", "Largest exporter of transformers", "Member of Alageum Electric group", "Over 1000 local employees"],
    },
    imageHint: "Inside a large factory assembling electrical transformers",
    descriptionAdvanced: {
      de: "Das Kentau Transformatorwerk ist ein führender Hersteller von Transformatoren in Kasachstan, gelegen in der Stadt Kentau in der Region Turkistan. Das Werk wurde 1960 gegründet und produziert Leistungstransformatoren, Verteilungstransformatoren und andere elektrische Ausrüstung. Es exportiert in die GUS-Staaten und nach China. Die Fabrik beschäftigt über 1.000 Mitarbeiter und ist ein wichtiger Arbeitgeber in der Region. Das Werk hat eine jährliche Produktionskapazität von über 5.000 Transformatoren.",
      hu: "A Kentau transzformátorgyár Kazahsztán egyik vezető transzformátorgyártója, Kentau városában, a Turkisztáni régióban található. A gyárat 1960-ban alapították, és erőátviteli és elosztó transzformátorokat, valamint egyéb elektromos berendezéseket gyárt. Exportál a FÁK-országokba és Kínába. A gyár több mint 1.000 főt foglalkoztat, és fontos munkaadó a régióban. Éves gyártási kapacitása meghaladja az 5.000 transzformátort.",
      ro: "Fabrica de transformatoare Kentau este un producător lider de transformatoare în Kazahstan, situată în orașul Kentau, regiunea Turkistan. Fabrica a fost fondată în 1960 și produce transformatoare de putere, transformatoare de distribuție și alte echipamente electrice. Exportă în țările CSI și în China. Fabrica angajează peste 1.000 de persoane și este un important angajator în regiune. Capacitatea anuală de producție depășește 5.000 de transformatoare.",
      en: "Kentau Transformer Plant is a leading manufacturer of transformers in Kazakhstan, located in Kentau city, Turkistan Region. Founded in 1960, it produces power transformers, distribution transformers, and other electrical equipment. It exports to CIS countries and China. The plant employs over 1,000 workers and is a major employer in the region. Annual production capacity exceeds 5,000 transformers.",
    },
    factsAdvanced: {
      de: ["Gründung: 1960.", "Jährliche Produktionskapazität: über 5.000 Transformatoren.", "Beschäftigte: über 1.000.", "Exportanteil: 40 % der Produktion.", "Größte Transformatoren: bis zu 110 kV.", "Werkstfläche: 20 Hektar."],
      hu: ["Alapítás: 1960.", "Éves gyártási kapacitás: több mint 5.000 transzformátor.", "Foglalkoztatottak: több mint 1.000.", "Export aránya: 40% a termelésnek.", "Legnagyobb transzformátorok: akár 110 kV.", "Gyár területe: 20 hektár."],
      ro: ["Fondare: 1960.", "Capacitate anuală de producție: peste 5.000 de transformatoare.", "Angajați: peste 1.000.", "Export: 40% din producție.", "Cele mai mari transformatoare: până la 110 kV.", "Suprafața fabricii: 20 de hectare."],
      en: ["Founded: 1960.", "Annual production capacity: over 5,000 transformers.", "Employees: over 1,000.", "Export share: 40% of production.", "Largest transformers: up to 110 kV.", "Factory area: 20 hectares."],
    },
  },
  {
    id: "kazakhstan-stepnogorsk-mining-economic-v2",
    type: "mine",
    name: { de: "Bergbaukomplex Stepnogorsk", hu: "Sztepnogorszki bányászati komplexum", ro: "Complexul minier Stepnogorsk", en: "Stepnogorsk Mining Complex" },
    coords: [71.885, 52.482],
    description: {
      de: "Ein bedeutendes Zentrum für die Verarbeitung von Uranerz und Gold. Die Stadt wurde einst als geheimes Industriezentrum während der Sowjetära gegründet.",
      hu: "Az uránérc és az arany feldolgozásának jelentős központja. A várost egykor titkos ipari központként alapították a szovjet korszakban.",
      ro: "Un centru major pentru procesarea minereului de uraniu și a aurului. Orașul a fost fondat ca un centru industrial secret în epoca sovietică.",
      en: "A significant center for the processing of uranium ore and gold. The site was once founded as a secret industrial hub during the Soviet era.",
    },
    facts: {
      de: ["Ehemals geheime Stadt", "Verarbeitung von Uran-Konzentrat", "Sitz der Stepnogorsk-Chemiefabrik", "Goldraffination vor Ort"],
      hu: ["Egykor titkos város", "Uránkoncentrátum feldolgozása", "A Sztepnogorszki Vegyiművek székhelye", "Helyi aranyfinomítás"],
      ro: ["Fost oraș secret", "Procesarea concentratului de uraniu", "Sediul Uzinei Chimice Stepnogorsk", "Rafinarea aurului la fața locului"],
      en: ["Formerly a secret city", "Uranium concentrate processing", "Home to Stepnogorsk Chemical Plant", "Gold refining operations"],
    },
    imageHint: "Large industrial chemical and mining plant near Stepnogorsk",
    descriptionAdvanced: {
      de: "Der Stepnogorsker Bergbaukomplex in der Region Aqmola ist ein bedeutendes Zentrum für die Gewinnung und Verarbeitung von Uran und anderen Mineralien. Er wurde in den 1950er Jahren gegründet und umfasst Minen, eine Mühle und eine metallurgische Anlage. Der Komplex wird von Kazatomprom betrieben und produziert jährlich über 1.000 Tonnen Uranoxid. Stepnogorsk ist auch bekannt für die Produktion von Molybdän und Rhenium. Die Anlage beschäftigt etwa 2.000 Mitarbeiter und ist ein wichtiger Wirtschaftsfaktor in der Region.",
      hu: "A Sztyepnogorszki bányászati komplexum az Akmolai régióban az urán és más ásványok kitermelésének és feldolgozásának jelentős központja. Az 1950-es években alapították, bányákat, malmokat és kohászati üzemet foglal magában. A Kazatomprom üzemelteti, éves termelése meghaladja az 1.000 tonna urán-oxidot. Sztyepnogorszk ismert molibdén és rénium előállításáról is. A létesítmény mintegy 2.000 főt foglalkoztat, és fontos gazdasági tényező a régióban.",
      ro: "Complexul minier Stepnogorsk, situat în regiunea Aqmola, este un centru major pentru extracția și prelucrarea uraniului și a altor minerale. A fost fondat în anii 1950 și include mine, o moară și o instalație metalurgică. Operat de Kazatomprom, produce anual peste 1.000 de tone de oxid de uraniu. Stepnogorsk este cunoscut și pentru producția de molibden și reniu. Facilitatea angajează aproximativ 2.000 de persoane și este un factor economic important în regiune.",
      en: "Stepnogorsk Mining Complex in Aqmola Region is a major center for extraction and processing of uranium and other minerals. Founded in the 1950s, it includes mines, a mill, and a metallurgical plant. Operated by Kazatomprom, it produces over 1,000 tonnes of uranium oxide annually. Stepnogorsk is also known for producing molybdenum and rhenium. The facility employs about 2,000 workers and is a key economic driver in the region.",
    },
    factsAdvanced: {
      de: ["Gründung: 1950er Jahre.", "Jährliche Uranoxid-Produktion: über 1.000 Tonnen.", "Beschäftigte: etwa 2.000.", "Nebenprodukte: Molybdän, Rhenium.", "Verarbeitungskapazität: 1.500 Tonnen Erz pro Tag.", "Standort: Stepnogorsk, Region Aqmola."],
      hu: ["Alapítás: 1950-es évek.", "Éves urán-oxid termelés: több mint 1.000 tonna.", "Foglalkoztatottak: mintegy 2.000.", "Melléktermékek: molibdén, rénium.", "Feldolgozási kapacitás: 1.500 tonna érc naponta.", "Helyszín: Sztyepnogorszk, Akmolai régió."],
      ro: ["Fondare: anii 1950.", "Producție anuală de oxid de uraniu: peste 1.000 de tone.", "Angajați: aproximativ 2.000.", "Produse secundare: molibden, reniu.", "Capacitate de prelucrare: 1.500 de tone de minereu pe zi.", "Locație: Stepnogorsk, regiunea Aqmola."],
      en: ["Founded: 1950s.", "Annual uranium oxide production: over 1,000 tonnes.", "Employees: about 2,000.", "By-products: molybdenum, rhenium.", "Processing capacity: 1,500 tonnes of ore per day.", "Location: Stepnogorsk, Aqmola Region."],
    },
  },
  {
    id: "kazakhstan-pavlodar-aluminum-economic-v2",
    type: "factory",
    name: { de: "Kasachisches Aluminiumwerk", hu: "Kazah Alumíniumművek", ro: "Uzina de Aluminiu din Kazahstan", en: "Kazakhstan Aluminum Plant" },
    coords: [77.054, 52.253],
    description: {
      de: "Dieses Werk in Pavlodar produziert Tonerde und Primäraluminium für den Weltmarkt. Es nutzt den günstigen Strom aus den umliegenden Kohlekraftwerken.",
      hu: "Ez a pavlodari üzem timföldet és elsődleges alumíniumot gyárt a világpiacra. A közeli szénerőművek olcsó áramát használja fel.",
      ro: "Această uzină din Pavlodar produce alumină și aluminiu primar pentru piața mondială. Folosește electricitatea ieftină de la termocentrale.",
      en: "This plant in Pavlodar produces alumina and primary aluminum for the global market. It utilizes cheap electricity from surrounding coal power stations.",
    },
    facts: {
      de: ["Einzige Aluminiumhütte des Landes", "Betrieben durch die ERG-Gruppe", "Große Tonerde-Raffinerie", "Wichtiger Exporteur in Zentralasien"],
      hu: ["Az ország egyetlen alumíniumkohója", "Az ERG csoport üzemelteti", "Hatalmas timföldfinomító", "Fontos közép-ázsiai exportőr"],
      ro: ["Singura topitorie de aluminiu din țară", "Operată de grupul ERG", "Rafinărie majoră de alumină", "Exportator important în Asia Centrală"],
      en: ["Country's only aluminum smelter", "Operated by ERG group", "Large alumina refinery", "Major exporter in Central Asia"],
    },
    imageHint: "Modern aluminum smelting plant with smoking chimneys",
    descriptionAdvanced: {
      de: "Das Kasachstan-Aluminiumwerk (KAP) in Pavlodar ist das einzige Aluminiumhüttenwerk des Landes. Es wurde 2007 in Betrieb genommen und gehört zur Eurasian Resources Group. Das Werk produziert jährlich rund 250.000 Tonnen Aluminium. Es verwendet Aluminiumoxid aus dem nahegelegenen Werk in Torghay. Das KAP ist ein großer Arbeitgeber mit über 2.000 Beschäftigten und ein wichtiger Exporteur nach Russland, China und Europa. Die Anlage umfasst Elektrolysezellen, Gießerei und Kraftwerk.",
      hu: "A kazahsztáni alumíniumgyár (KAP) Pavlodarban az ország egyetlen alumíniumkohója. 2007-ben helyezték üzembe, az Eurasian Resources Group tulajdonában van. A gyár évente mintegy 250.000 tonna alumíniumot termel. A közeli Torghay-i üvegből származó alumínium-oxidot használ. A KAP nagy foglalkoztató, több mint 2.000 alkalmazottal, és fontos exportőr Oroszországba, Kínába és Európába. A létesítmény elektrolízis cellákat, öntödét és erőművet foglal magában.",
      ro: "Fabrica de aluminiu din Kazahstan (KAP) din Pavlodar este singura topitorie de aluminiu a țării. A fost pusă în funcțiune în 2007 și aparține Eurasian Resources Group. Fabrica produce anual aproximativ 250.000 de tone de aluminiu. Utilizează alumină de la uzina din apropiere, Torghay. KAP este un angajator major, cu peste 2.000 de angajați, și un important exportator către Rusia, China și Europa. Instalația include celule de electroliză, turnătorie și centrală electrică.",
      en: "Kazakhstan Aluminum Plant (KAP) in Pavlodar is the country's sole aluminum smelter. Commissioned in 2007, it is owned by Eurasian Resources Group. The plant produces about 250,000 tonnes of aluminum annually. It uses alumina from the nearby Torghay plant. KAP is a major employer with over 2,000 workers and a key exporter to Russia, China, and Europe. The facility includes electrolysis cells, a foundry, and a power plant.",
    },
    factsAdvanced: {
      de: ["Inbetriebnahme: 2007.", "Jährliche Produktion: ca. 250.000 Tonnen Aluminium.", "Beschäftigte: über 2.000.", "Aluminiumoxid-Quelle: Werk Torghay.", "Exportanteil: 80 % der Produktion.", "Eigenes Kraftwerk: 200 MW."],
      hu: ["Üzembe helyezés: 2007.", "Éves termelés: kb. 250.000 tonna alumínium.", "Foglalkoztatottak: több mint 2.000.", "Alumínium-oxid forrás: Torghay-i üzem.", "Export aránya: 80% a termelésnek.", "Saját erőmű: 200 MW."],
      ro: ["Punere în funcțiune: 2007.", "Producție anuală: aproximativ 250.000 de tone de aluminiu.", "Angajați: peste 2.000.", "Sursa de alumină: Uzina Torghay.", "Export: 80% din producție.", "Centrală electrică proprie: 200 MW."],
      en: ["Commissioned: 2007.", "Annual production: about 250,000 tonnes of aluminum.", "Employees: over 2,000.", "Alumina source: Torghay plant.", "Export share: 80% of production.", "Own power plant: 200 MW."],
    },
  },
  {
    id: "kazakhstan-karatau-phosphate-economic-v2",
    type: "mine",
    name: { de: "Karatau-Phosphat-Minen", hu: "Karataui foszfátbányák", ro: "Minele de fosfat Karatau", en: "Karatau Phosphate Mines" },
    coords: [70.472, 43.175],
    description: {
      de: "Eines der weltweit größten Vorkommen an Phosphorgestein zur Herstellung von Düngemitteln. Der Bergbaukomplex liegt am Fuße des Karatau-Gebirges.",
      hu: "A világ egyik legnagyobb foszfátkőzet-lelőhelye műtrágyagyártáshoz. A bányászati komplexum a Karatau-hegység lábánál található.",
      ro: "Una dintre cele mai mari resurse de roci fosfatice din lume pentru îngrășăminte. Complexul minier se află la poalele munților Karatau.",
      en: "One of the world's largest deposits of phosphorite rock for fertilizer production. The mining complex is located at the foot of the Karatau mountains.",
    },
    facts: {
      de: ["Größte Phosphatquelle der GUS", "Abbau im Tagebau", "Zentrum der Düngemittelindustrie", "Nahe der Stadt Janatas"],
      hu: ["A FÁK legnagyobb foszfátforrása", "Külszíni fejtésű bányászat", "A műtrágyaipar központja", "Zsanatasz városa közelében"],
      ro: ["Cea mai mare sursă de fosfat din CSI", "Extracție în carieră deschisă", "Centrul industriei de îngrășăminte", "Lângă orașul Zhanatas"],
      en: ["Largest phosphate source in CIS", "Open-pit mining extraction", "Center of the fertilizer industry", "Located near the city of Zhanatas"],
    },
    imageHint: "Vast open-pit phosphate mine in a desert mountain landscape",
    descriptionAdvanced: {
      de: "Die Karatau-Phosphatminen liegen im Süden Kasachstans, in der Region Turkistan. Sie sind eines der größten Phosphatvorkommen der Welt und werden seit den 1930er Jahren abgebaut. Die Minen werden von KazPhosphate betrieben und fördern jährlich über 2 Millionen Tonnen Phosphatgestein. Das Erz wird zu Düngemitteln verarbeitet, die in die Landwirtschaft exportiert werden. Die Region Karatau verfügt über geschätzte Reserven von 3 Milliarden Tonnen. Der Abbau erfolgt im Tagebau und beschäftigt rund 5.000 Arbeiter.",
      hu: "A Karatau-foszfátbányák Kazahsztán déli részén, a Turkisztáni régióban találhatók. A világ egyik legnagyobb foszfátlelőhelye, az 1930-as évek óta bányásszák. A bányákat a KazPhosphate üzemelteti, éves kitermelése meghaladja a 2 millió tonna foszfátkőzetet. Az ércet műtrágyává dolgozzák fel, amelyet a mezőgazdaságba exportálnak. A Karatau régió becsült készletei 3 milliárd tonna. A bányászat külszíni fejtéssel történik, és mintegy 5.000 munkást foglalkoztat.",
      ro: "Minele de fosfat Karatau sunt situate în sudul Kazahstanului, în regiunea Turkistan. Sunt unul dintre cele mai mari zăcăminte de fosfat din lume, exploatate încă din anii 1930. Minele sunt operate de KazPhosphate și produc anual peste 2 milioane de tone de rocă fosfatică. Minereul este procesat în îngrășăminte, exportate în agricultură. Regiunea Karatau are rezerve estimate de 3 miliarde de tone. Exploatarea se face în cariere deschise și angajează aproximativ 5.000 de muncitori.",
      en: "Karatau Phosphate Mines are located in southern Kazakhstan, in Turkistan Region. They are one of the world's largest phosphate deposits, mined since the 1930s. The mines are operated by KazPhosphate and produce over 2 million tonnes of phosphate rock annually. The ore is processed into fertilizers exported to agriculture. The Karatau region has estimated reserves of 3 billion tonnes. Mining is done via open-pit methods and employs about 5,000 workers.",
    },
    factsAdvanced: {
      de: ["Abbau seit 1930er Jahren.", "Jährliche Förderung: über 2 Millionen Tonnen.", "Geschätzte Reserven: 3 Milliarden Tonnen.", "Beschäftigte: etwa 5.000.", "Tagebaufläche: 15 km².", "Verarbeitungswerk: in Taraz."],
      hu: ["Bányászat az 1930-as évek óta.", "Éves kitermelés: több mint 2 millió tonna.", "Becsült készletek: 3 milliárd tonna.", "Foglalkoztatottak: mintegy 5.000.", "Külszíni bánya területe: 15 km².", "Feldolgozó üzem: Tarazban."],
      ro: ["Exploatare din anii 1930.", "Producție anuală: peste 2 milioane de tone.", "Rezerve estimate: 3 miliarde de tone.", "Angajați: aproximativ 5.000.", "Suprafața carierei: 15 km².", "Uzina de procesare: în Taraz."],
      en: ["Mining since the 1930s.", "Annual output: over 2 million tonnes.", "Estimated reserves: 3 billion tonnes.", "Employees: about 5,000.", "Open-pit area: 15 km².", "Processing plant: in Taraz."],
    },
  },
  {
    id: "kazakhstan-kyzylorda-rice-economic-v2",
    type: "landmark",
    name: { de: "Reisanbaugebiete von Kysylorda", hu: "Kizilordai rizsföldek", ro: "Orezăriile din Kyzylorda", en: "Kyzylorda Rice Production Hub" },
    coords: [65.503, 44.852],
    description: {
      de: "Das wichtigste Zentrum der kasachischen Reisproduktion am Unterlauf des Syrdarja. Hier wird Reis für das ganze Land und den Export angebaut.",
      hu: "A kazah rizstermesztés legfontosabb központja a Szir-darja alsó szakaszánál. Itt termelik a rizst az egész ország és export számára.",
      ro: "Cel mai important centru al producției de orez din Kazahstan, pe cursul inferior al râului Sîrdaria. Aici se cultivă orez pentru întreaga țară.",
      en: "The main center of Kazakh rice production located on the lower Syr Darya river. It cultivates rice for domestic consumption and export.",
    },
    facts: {
      de: ["90% der kasachischen Reisernte", "Intensive Bewässerung durch Syrdarja", "Historisches Agrarzentrum", "Viele Reismühlen in der Region"],
      hu: ["A kazah rizstermés 90%-a", "Intenzív öntözés a Szir-darjából", "Történelmi mezőgazdasági központ", "Számos rizsmalom a régióban"],
      ro: ["90% din recolta de orez a țării", "Irigare intensivă din râul Sîrdaria", "Centru agricol istoric", "Multe mori de orez în regiune"],
      en: ["Produces 90% of Kazakh rice", "Intensive irrigation from Syr Darya", "Historic agricultural center", "Numerous rice mills in the region"],
    },
    imageHint: "Flooded green rice paddies in a semi-arid landscape",
    descriptionAdvanced: {
      de: "Das Kyzylorda-Reisproduktionszentrum in Südkasachstan ist ein wichtiges Agrargebiet entlang des Syr Darya-Flusses. Die Region baut auf über 80.000 Hektar Reis an, mit einer jährlichen Ernte von etwa 400.000 Tonnen. Der Anbau begann in den 1960er Jahren nach der Entwicklung des Bewässerungssystems. Die Region Kyzylorda ist der größte Reisproduzent Kasachstans und exportiert nach Russland, Usbekistan und in die Mongolei. Der Reisanbau ist ein wichtiger Wirtschaftszweig für die lokale Bevölkerung und beschäftigt Zehntausende von Bauern.",
      hu: "A Kizilordai rizstermelési központ Dél-Kazahsztánban, a Szir-darja folyó mentén található, fontos mezőgazdasági terület. A régióban több mint 80.000 hektáron termesztenek rizst, éves termésük mintegy 400.000 tonna. A termesztés az 1960-as években kezdődött az öntözőrendszer kiépítése után. Kizilorda régió Kazahsztán legnagyobb rizstermelője, és exportál Oroszországba, Üzbegisztánba és Mongóliába. A rizstermesztés fontos gazdasági ág a helyi lakosság számára, és több tízezer gazdálkodót foglalkoztat.",
      ro: "Centrul de producție a orezului Kyzylorda, situat în sudul Kazahstanului, de-a lungul râului Syr Darya, este o regiune agricolă importantă. Zona cultivă orez pe peste 80.000 de hectare, cu o recoltă anuală de aproximativ 400.000 de tone. Cultura a început în anii 1960 după dezvoltarea sistemului de irigații. Regiunea Kyzylorda este cel mai mare producător de orez din Kazahstan și exportă în Rusia, Uzbekistan și Mongolia. Cultura orezului este un sector economic important pentru populația locală, angajând zeci de mii de fermieri.",
      en: "Kyzylorda Rice Production Hub in southern Kazakhstan is a major agricultural area along the Syr Darya River. The region grows rice on over 80,000 hectares, with an annual harvest of about 400,000 tonnes. Cultivation began in the 1960s following the development of irrigation systems. Kyzylorda Region is the largest rice producer in Kazakhstan, exporting to Russia, Uzbekistan, and Mongolia. Rice farming is a vital economic sector for the local population, employing tens of thousands of farmers.",
    },
    factsAdvanced: {
      de: ["Anbaufläche: über 80.000 Hektar.", "Jahresernte: ca. 400.000 Tonnen.", "Beginn des Reisanbaus: 1960er Jahre.", "Exportziele: Russland, Usbekistan, Mongolei.", "Bewässerung: Syr Darya-Fluss.", "Sorte: hauptsächlich Langkornreis."],
      hu: ["Termőterület: több mint 80.000 hektár.", "Éves termés: kb. 400.000 tonna.", "Rizstermesztés kezdete: 1960-as évek.", "Export célok: Oroszország, Üzbegisztán, Mongólia.", "Öntözés: Szir-darja folyó.", "Fajta: főként hosszú szemű rizs."],
      ro: ["Suprafață cultivată: peste 80.000 de hectare.", "Recoltă anuală: aproximativ 400.000 de tone.", "Începutul cultivării orezului: anii 1960.", "Destinații export: Rusia, Uzbekistan, Mongolia.", "Irigare: râul Syr Darya.", "Soi: în principal orez cu bob lung."],
      en: ["Sown area: over 80,000 hectares.", "Annual harvest: about 400,000 tonnes.", "Rice cultivation started: 1960s.", "Export destinations: Russia, Uzbekistan, Mongolia.", "Irrigation: Syr Darya River.", "Variety: mostly long-grain rice."],
    },
  },
  {
    id: "kazakhstan-aksu-power-station-economic-v2",
    type: "factory",
    name: { de: "Kraftwerk Aksu", hu: "Aksui erőmű", ro: "Termocentrala Aksu", en: "Aksu Power Station" },
    coords: [76.872, 52.124],
    description: {
      de: "Eines der größten Kohlekraftwerke Zentralasiens, früher bekannt als GRES Jermak. Es versorgt die umliegende Schwerindustrie mit gewaltigen Mengen an Energie.",
      hu: "Közép-Ázsia egyik legnagyobb szénerőműve, korábban Jermak GRES néven ismert. Hatalmas mennyiségű energiával látja el a környező nehézipart.",
      ro: "Una dintre cele mai mari termocentrale din Asia Centrală, cunoscută anterior ca GRES Ermak. Alimentează industria grea din jur.",
      en: "One of the largest coal-fired power stations in Central Asia, formerly known as Yermak GRES. It supplies massive amounts of energy to the local heavy industry.",
    },
    facts: {
      de: ["Installierte Leistung von 2450 MW", "Befeuert durch Kohle aus Ekibastus", "Versorgt das lokale Ferrolegierungswerk", "Acht Energieblöcke in Betrieb"],
      hu: ["2450 MW beépített teljesítmény", "Ekibasztuzi szénnel üzemel", "Helyi vasötvözetgyárat lát el", "Nyolc energiablokk üzemel"],
      ro: ["Putere instalată de 2450 MW", "Alimentată cu cărbune din Ekibastuz", "Alimentează fabrica de feroaliaje", "Opt unități energetice în funcțiune"],
      en: ["Installed capacity of 2450 MW", "Fueled by coal from Ekibastuz", "Supplies local ferroalloy plant", "Eight power units in operation"],
    },
    imageHint: "Huge thermal power plant with high chimneys and cooling towers",
    descriptionAdvanced: {
      de: "Das Aksu-Kraftwerk ist ein großes Kohlekraftwerk in der Stadt Aksu, Region Pawlodar. Es wurde 1976 in Betrieb genommen und hat eine installierte Leistung von 2.100 MW. Die Anlage besteht aus sechs Blöcken und versorgt einen Großteil Nordkasachstans mit Strom. Es verbrennt Kohle aus dem nahegelegenen Ekibastuz-Becken. Das Kraftwerk ist ein wichtiger Arbeitgeber mit rund 3.000 Mitarbeitern und einer der größten Stromproduzenten des Landes. Es betreibt auch ein Fernwärmesystem für die Stadt Aksu.",
      hu: "Az Akszu hőerőmű egy nagy szénerőmű Akszu városában, a Pavlodari régióban. 1976-ban helyezték üzembe, beépített teljesítménye 2.100 MW. Hat blokkból áll, és Észak-Kazahsztán nagy részét látja el árammal. A közeli Ekibastuz-medencéből származó szenet éget. Az erőmű fontos munkaadó, mintegy 3.000 alkalmazottal, és az ország egyik legnagyobb áramtermelője. Távfűtési rendszert is üzemeltet Akszu városában.",
      ro: "Centrala electrică Aksu este o mare centrală pe cărbune în orașul Aksu, regiunea Pavlodar. A fost pusă în funcțiune în 1976, având o capacitate instalată de 2.100 MW. Instalația are șase unități și alimentează cu energie electrică mare parte din nordul Kazahstanului. Arde cărbune din bazinul Ekibastuz din apropiere. Centrala este un important angajator, cu aproximativ 3.000 de angajați, și unul dintre cei mai mari producători de energie electrică din țară. De asemenea, operează un sistem de termoficare pentru orașul Aksu.",
      en: "Aksu Power Station is a large coal-fired power plant in Aksu city, Pavlodar Region. Commissioned in 1976, it has an installed capacity of 2,100 MW. The plant consists of six units and supplies electricity to much of northern Kazakhstan. It burns coal from the nearby Ekibastuz basin. The station is a major employer with about 3,000 workers and one of the country's largest power producers. It also operates a district heating system for Aksu city.",
    },
    factsAdvanced: {
      de: ["Inbetriebnahme: 1976.", "Installierte Leistung: 2.100 MW.", "Anzahl Blöcke: 6.", "Brennstoff: Kohle aus Ekibastuz.", "Beschäftigte: etwa 3.000.", "Fernwärme: versorgt die Stadt Aksu."],
      hu: ["Üzembe helyezés: 1976.", "Beépített teljesítmény: 2.100 MW.", "Blokkok száma: 6.", "Tüzelőanyag: szén Ekibastuzból.", "Foglalkoztatottak: mintegy 3.000.", "Távfűtés: ellátja Akszu városát."],
      ro: ["Punere în funcțiune: 1976.", "Capacitate instalată: 2.100 MW.", "Număr unități: 6.", "Combustibil: cărbune din Ekibastuz.", "Angajați: aproximativ 3.000.", "Termoficare: alimentează orașul Aksu."],
      en: ["Commissioned: 1976.", "Installed capacity: 2,100 MW.", "Number of units: 6.", "Fuel: coal from Ekibastuz.", "Employees: about 3,000.", "District heating: supplies Aksu city."],
    },
  }
];
