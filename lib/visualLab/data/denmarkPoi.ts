...
export const denmarkCulture: POI[] = [
  ...
  },
  {
    ...
    description: {
      ...
      de: "Die Wikingerfestung Trelleborg ist eine bedeutende archäologische Stätte und ein starkes SEO-Thema für Wikingertourismus in Dänemark. Ihre kreisförmigen Erdwerke zeigen die militärische Planung der Wikingerzeit und verbinden Besucher mit der Ära von König Harald Blauzahn. Die Anlage umfasst rekonstruierte Gebäude und Erklärungen, die die Festung leicht verständlich machen. Trelleborg ist besonders nützlich für Inhalte über Wikinger-Dänemark, Archäologie und frühe Staatsmacht.",
...
export const denmarkNature: POI[] = [
  ...
  },
  {
    ...
    name: { de: "Skjern Å", hu: "Skjern Å", ro: "Skjern Å", en: "Skjern Å" },
    description: {
      ...
      de: "Skjern Å ist eine der bekanntesten Flussrenaturierungs-Geschichten Dänemarks und ein nützliches SEO-Thema für Feuchtgebiete, Vogelwelt und die Natur Westjütlands. Der Fluss und seine Umgebung wurden zu einem reichhaltigen Lebensraum umgestaltet, der Wildtiere und Naturerlebnisse unterstützt. Er bietet einen ruhigeren und ökologischeren Kontrast zu den städtischen Höhepunkten des Landes. Skjern Å ist ideal für naturbezogene Inhalte, die eine echte dänische Erfolgsgeschichte im Naturschutz erzählen wollen.",
      hu: "A Skjern Å Dánia egyik legismertebb folyó-helyreállítási története, és hasznos SEO-kulcsszó a vizes élőhelyek, a madárvilág és Nyugat-Jütland természete témájában. A folyót és környezetét gazdag élőhellyé alakították át, amely támogatja a vadon élő állatokat és a szabadtéri felfedezést. Csendesebb és ökológiaibb kontrasztot ad az ország városi csúcspontjaihoz képest. A Skjern Å ideális a természetközpontú tartalomhoz, ha valódi dán természetvédelmi sikertörténetet szeretnénk bemutatni.",
      ro: "Skjern Å este una dintre cele mai cunoscute povești de restaurare a unui râu din Danemarca și un cuvânt-cheie SEO util pentru zone umede, păsări și natura din vestul Iutlandei. Râul și peisajul din jur au fost transformate într-un habitat bogat care susține fauna și explorarea în aer liber. Oferă un contrast mai liniștit și mai ecologic față de reperele urbane ale țării. Skjern Å este ideal pentru conținutul axat pe natură care dorește o poveste autentică de succes a conservării daneze."
    },
    facts: {
      ...
      de: ["Skjern Å ist ein großer Erfolg der Flussrenaturierung.", "Sie liegt in Westjütland.", "Das Gebiet ist wichtig für Vögel und Feuchtgebiete.", "Es bietet ruhigen Natur- und Ökotourismus.", "Der Fluss ist eine bekannte Naturschutzgeschichte."],
      hu: ["A Skjern Å nagy sikerű folyó-rehabilitációs példa.", "Nyugat-Jütlandban található.", "A terület fontos a madarak és a vizes élőhelyek számára.", "Csendes természet- és ökoturizmust kínál.", "A folyó jól ismert természetvédelmi történet."],
      ro: ["Skjern Å este un mare succes de restaurare a râului.", "Se află în vestul Iutlandei.", "Zona este importantă pentru păsări și zone umede.", "Oferă turism liniștit în natură și ecologic.", "Râul este o poveste bine-cunoscută de conservare."]
    },
