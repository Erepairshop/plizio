...
export const poiExtraDrcongoNatureV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      de: "Der Kongo-Fluss ist das pulsierende Herz Zentralafrikas und die wichtigste geografische und kulturelle Lebensader der Demokratischen Republik Kongo. Mit einer L?nge von 4.700 km ist er der zweitgr??te Strom der Welt nach Wasserf?hrung und der tiefste Fluss der Erde, mit Abschnitten von ?ber 220 Metern Tiefe. Als einziger gro?er Strom kreuzt er zweimal den ?quator und speist mit seinem gigantischen Einzugsgebiet die Regenw?lder des Kongo-Beckens. Er ist die wichtigste Transportroute durch den undurchdringlichen Dschungel und besitzt ein enormes Wasserkraftpotenzial, besonders an den Inga-F?llen. Erdkunde K8 ? Der Kongo als logistisches und ?kologisches R?ckgrat Zentralafrikas.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Tanganjikasee ist einer der beeindruckendsten Seen der Gro?en Seen Afrikas und liegt im tiefen Graben des Ostafrikanischen Grabenbruchs. Er bildet die ?stliche Grenze des Kongo zu Burundi, Tansania und Sambia. Mit einer L?nge von 673 km ist er der l?ngste und nach dem Baikalsee der zweittiefste (1.470 m) und ?lteste S??wassersee der Welt. Seine Artenvielfalt ist evolution?r mit den Gal?pagos-Inseln vergleichbar, mit ?ber 250 endemischen Buntbarscharten. Zudem ist der See eine kritische Handels- und Transportroute f?r St?dte wie Kalemie und Uvira. Erdkunde K8 ? ?kologie und Limnologie der Seen des Gro?en Grabenbruchs.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Virunga-Vulkane sind eine Kette von acht Vulkanen im Osten der DR Kongo an der Grenze zu Ruanda und Uganda. Die Region beheimatet die ber?hmten Berggorillas und ist ein Brennpunkt f?r den Naturschutz im Virunga-Nationalpark. Die geologische Aktivit?t und die H?henlage schaffen ein einzigartiges Klima, das die afro-alpine Vegetation gedeihen l?sst. Die Vulkane wie der Nyiragongo sind auch f?r ihre geologischen Ausbr?che bekannt. Erdkunde K8 ? Vulkansysteme und gef?hrdete Arten.",
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["Gelegen in einer riesigen Sumpflandschaft der Provinz Lualaba.", "Teil des Upemba-Nationalparks.", "Bedeutender Lebensraum f?r eine reiche Vogelwelt.", "?kologisch wichtig f?r den Wasserhaushalt der Region.", "Arch?ologisch bedeutsame Fundst?tte der Eisenzeit-Kultur.", "Zentraler Bestandteil des Upemba-Beckens."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
