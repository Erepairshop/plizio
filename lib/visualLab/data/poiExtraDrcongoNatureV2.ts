...
export const poiExtraDrcongoNatureV2: POI[] = [
  {
    ...
    description: { de: "Der Kongo ist der tiefste Fluss der Welt.", hu: "A Kongó a világ legmélyebb folyója.", ro: "Fluviul Congo este cel mai adânc din lume.", en: "The Congo River is the deepest river in the world." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Einer der tiefsten und ältesten Seen der Welt.", hu: "A világ egyik legmélyebb és legöregebb tava.", ro: "Unul dintre cele mai adânci și vechi lacuri din lume.", en: "One of the deepest and oldest lakes in the world." },
    facts: {
      de: ["Großer Grabenbruch-See", "Hohe Artenvielfalt", "Sehr tief", "Rift Valley Lage"],
  ...
  },
  {
    ...
    description: { de: "Eine Kette von Vulkanen an der Grenze zwischen Ruanda, Uganda und DR Kongo.", hu: "Vulkánlánc Ruanda, Uganda és a Kongói Demokratikus Köztársaság határán.", ro: "Un lanț de vulcani la granița dintre Rwanda, Uganda și RD Congo.", en: "A chain of volcanoes on the border of Rwanda, Uganda, and the DRC." },
    facts: {
      de: ["Vulkangebiet", "Lebensraum der Berggorillas", "Hohe Gipfel", "Aktive Vulkane"],
  ...
  },
  {
    ...
    description: { de: "Ein geschütztes Regenwaldgebiet im Osten der DR Kongo.", hu: "Védett esőerdő-terület a Kongói Demokratikus Köztársaság keleti részén.", ro: "O zonă protejată de pădure tropicală în estul RD Congo.", en: "A protected rainforest area in eastern DRC." },
    facts: {
      de: ["Geschütztes Gebiet", "Reiche Flora", "Seltene Tiere", "Regenwald"],
  ...
  },
  {
    ...
    description: { de: "Der Hauptquellfluss des Kongos.", hu: "A Kongó fő forrásfolyója.", ro: "Principalul afluent al fluviului Congo.", en: "The main headstream of the Congo River." },
    facts: {
      de: ["Quellfluss des Kongos", "Wichtiger Wasserweg", "Fließt durch den Kongo", "Große Länge"],
      hu: ["A Kongó forrásfolyója", "Fontos vízi út", "Átfolyik Kongón", "Nagy hosszúság"],
      ro: ["Afluent principal al fluviului Congo", "Cale navigabilă importantă", "Curge prin Congo", "Lungime mare"],
      en: ["Headstream of the Congo", "Important waterway", "Flows through Congo", "Great length"]
    },
    descriptionAdvanced: {
  ...
  },
  {
    ...
    description: { de: "Ein großer See an der Grenze zu Ruanda.", hu: "Nagy tó Ruanda határán.", ro: "Un lac mare la granița cu Rwanda.", en: "A large lake on the border with Rwanda." },
    facts: {
      de: ["Großer See", "Im Grabenbruch", "Vulkanschutz", "Schöne Umgebung"],
  ...
  },
  {
    ...
    description: { de: "Ein wichtiger Nebenfluss des Kongos.", hu: "A Kongó fontos mellékfolyója.", ro: "Un afluent important al fluviului Congo.", en: "An important tributary of the Congo River." },
    facts: {
      de: ["Nebenfluss des Kongos", "Großes Becken", "Wasserreich", "Schifffahrtsweg"],
  ...
  },
  {
    ...
    description: { de: "Ein flacher See im Upemba-Nationalpark.", hu: "Sekély tó az Upemba Nemzeti Parkban.", ro: "Un lac puțin adânc în Parcul Național Upemba.", en: "A shallow lake in Upemba National Park." },
    facts: {
      de: ["Flacher See", "Sumpfige Region", "Nationalparkgebiet", "Große Artenvielfalt"],
  ...
  },
  {
    ...
    description: { de: "Das 'Mondgebirge' mit eisbedeckten Gipfeln.", hu: "A 'Holdhegység' jéggel borított csúcsokkal.", ro: "\"Munții Lunii\" cu vârfuri acoperite de gheață.", en: "The 'Mountains of the Moon' with ice-capped peaks." },
    facts: {
      de: ["Hochgebirge", "Eisbedeckte Gipfel", "Mondgebirge", "Grenzgebirge"],
  ...
  },
  {
    ...
    description: { de: "Das weltweit zweitgrößte tropische Regenwaldgebiet.", hu: "A világ második legnagyobb trópusi esőerdője.", ro: "A doua cea mai mare zonă de pădure tropicală din lume.", en: "The world's second-largest tropical rainforest area." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Der größte tropische Regenwald-Nationalpark Afrikas.", hu: "Afrika legnagyobb trópusi esőerdő nemzeti parkja.", ro: "Cel mai mare parc național de pădure tropicală din Africa.", en: "The largest tropical rainforest national park in Africa." },
    facts: {
      de: ["Riesiger Nationalpark", "Primärwald", "Heimat gefährdeter Arten", "Regenwaldschutz"],
  ...
  },
  {
    ...
    description: { de: "Der einzige Abfluss des Tanganjikasees.", hu: "A Tanganyika-tó egyetlen kifolyása.", ro: "Singura ieșire a lacului Tanganyika.", en: "The only outlet of Lake Tanganyika." },
    facts: {
      de: ["Seeabfluss", "Nebenfluss des Kongo", "Wichtige Entwässerung", "Wasserscheide"],
  ...
  },
  {
    ...
    description: { de: "Ein See im Virunga-Nationalpark.", hu: "Tó a Virunga Nemzeti Parkban.", ro: "Un lac în Parcul Național Virunga.", en: "A lake in Virunga National Park." },
    facts: {
      de: ["Nationalpark-See", "Im Grabenbruch", "Vielfältiges Leben", "Schützenswert"],
  ...
  },
  {
    ...
    description: { de: "Ein bedeutender rechter Nebenfluss des Kongos.", hu: "A Kongó jelentős jobb oldali mellékfolyója.", ro: "Un afluent important de pe malul drept al fluviului Congo.", en: "A major right tributary of the Congo River." },
    facts: {
      de: ["Nebenfluss des Kongo", "Grenzfluss", "Großes Einzugsgebiet", "Wasserreich"],
  ...
  },
  {
    ...
    description: { de: "Ein Fluss im Westen der Region.", hu: "Folyó a régió nyugati részén.", ro: "Un râu în vestul regiunii.", en: "A river in the west of the region." },
    facts: {
      de: ["Westfluss", "Wichtige Entwässerung", "Durchfließt Täler", "Kurzverlauf"],
  ...
  },
  {
    ...
    description: { de: "Ein großer See in der Nähe der Grenze zu Uganda.", hu: "Nagy tó Uganda határának közelében.", ro: "Un lac mare lângă granița cu Uganda.", en: "A large lake near the Ugandan border." },
    facts: {
      de: ["Großer See", "Im Grabenbruch", "Fischreich", "Naturreservat"],
  ...
  },
  {
    ...
    description: { de: "Ein bedeutender Nebenfluss des Kongos.", hu: "A Kongó jelentős mellékfolyója.", ro: "Un afluent important al fluviului Congo.", en: "A major tributary of the Congo River." },
    facts: {
      de: ["Nebenfluss des Kongo", "Verläuft parallel zum Kongo", "Langer Fluss", "Wichtige Wasserstraße"],
  ...
  },
  {
    ...
    description: { de: "Ein wichtiger Nebenfluss des Kasai.", hu: "A Kasai fontos mellékfolyója.", ro: "Un afluent important al râului Kasai.", en: "An important tributary of the Kasai River." },
    facts: {
      de: ["Nebenfluss des Kasai", "Wasserreich", "Schifffahrt", "Großes Becken"],
  ...
  },
  {
    ...
    description: { de: "Ein wichtiger Fluss im Regenwaldgebiet.", hu: "Jelentős folyó az esőerdő területén.", ro: "Un râu important în zona pădurii tropicale.", en: "An important river in the rainforest area." },
    facts: {
      de: ["Regenwaldfluss", "Nebenfluss des Kongo", "Großes Einzugsgebiet", "Wasserreich"],
  ...
  },
  {
    ...
    description: { de: "Ein großer See an der Grenze zu Sambia.", hu: "Nagy tó Zambia határán.", ro: "Un lac mare la granița cu Zambia.", en: "A large lake on the border with Zambia." },
    facts: {
      de: ["Großer See", "Fischreich", "Grenzsee", "Schöne Natur"],
  ...
  },
  {
    ...
    description: { de: "Ein wichtiger Nebenfluss des Kasai.", hu: "A Kasai fontos mellékfolyója.", ro: "Un afluent important al râului Kasai.", en: "An important tributary of the Kasai River." },
    facts: {
      de: ["Nebenfluss des Kasai", "Wasserreich", "Schifffahrt", "Wichtiger Wasserweg"],
  ...
  },
  {
    ...
    description: { de: "Ein Nebenfluss des Kwango.", hu: "A Kwango mellékfolyója.", ro: "Un afluent al râului Kwango.", en: "A tributary of the Kwango River." },
    facts: {
      de: ["Nebenfluss des Kwango", "Wasserreich", "Wichtiger Flusslauf", "Regenwaldregion"],
  ...
  },
  {
    ...
    description: { de: "Ein Fluss, der die Grenze zwischen Kongo-Brazzaville und DR Kongo markiert.", hu: "Folyó, amely a Kongó-Brazzaville és a Kongói Demokratikus Köztársaság közötti határt jelzi.", ro: "Un râu care marchează granița dintre Congo-Brazzaville și RD Congo.", en: "A river marking the border between Congo-Brazzaville and the DRC." },
    facts: {
      de: ["Grenzfluss", "Nebenfluss des Kongo", "Wasserreich", "Regenwald"],
  ...
  },
  {
    ...
    description: { de: "Ein Fluss an der Grenze zu Sambia.", hu: "Folyó Zambia határán.", ro: "Un râu la granița cu Zambia.", en: "A river on the border with Zambia." },
    facts: {
      de: ["Grenzfluss", "Wichtige Entwässerung", "Wasserreich", "Durchfließt Seen"],
  ...
  },
  {
    ...
    description: { de: "Ein Fluss im Ituri-Regenwald.", hu: "Folyó az Ituri-esőerdőben.", ro: "Un râu în pădurea tropicală Ituri.", en: "A river in the Ituri Rainforest." },
    facts: {
      de: ["Regenwaldfluss", "Wasserreich", "Wichtiges Ökosystem", "Teil des Kongosystems"],
  ...
  },
  {
    ...
    description: { de: "Ein Nebenfluss des Kwango.", hu: "A Kwango mellékfolyója.", ro: "Un afluent al râului Kwango.", en: "A tributary of the Kwango River." },
    facts: {
      de: ["Nebenfluss des Kwango", "Wasserreich", "Durchfließt Regenwald", "Kurzer Verlauf"],
  ...
  },
  {
    ...
    description: { de: "Ein Nebenfluss des Lualaba.", hu: "A Lualaba mellékfolyója.", ro: "Un afluent al râului Lualaba.", en: "A tributary of the Lualaba River." },
    facts: {
      de: ["Nebenfluss des Lualaba", "Wasserreich", "Durchfließt ein Tal", "Wichtiger Wasserweg"],
  ...
  },
  {
    ...
    coords: [28.90, -10.10],
    name: { de: "Luapula", hu: "Luapula folyó", ro: "Râul Luapula", en: "Luapula River" },
    description: { de: "Ein wichtiger Fluss in der südöstlichen Region.", hu: "Jelentős folyó a délkeleti régióban.", ro: "Un râu important în regiunea de sud-est.", en: "An important river in the southeastern region." },
    facts: {
      de: ["Nebenfluss", "Wichtige Entwässerung", "Wasserreich", "Grenzfluss"],
  ...
  },
  {
    ...
    description: { de: "Ein bedeutender Nebenfluss des Kasai.", hu: "A Kasai jelentős mellékfolyója.", ro: "Un afluent important al râului Kasai.", en: "A major tributary of the Kasai River." },
    facts: {
      de: ["Nebenfluss des Kasai", "Durchfließt Regenwald", "Schifffahrt", "Großes Becken"],
      hu: ["A Kasai mellékfolyója", "Átfolyik az esőerdőn", "Hajózás", "Nagy medence"],
      ro: ["Afluent al râului Kasai", "Curge prin pădurea tropicală", "Navigație", "Bazin mare"],
      en: ["Tributary of the Kasai", "Flows through rainforest", "Navigation", "Large basin"]
    },
    descriptionAdvanced: {
    ...
    factsAdvanced: {
      de: ["Weit geschwungener Fluss im zentralen Kongobecken.", "Nebenfluss des Kasai.", "D?rfer sind oft nur per Wasserweg verbunden.", "Läuft durch W?lder, S?mpfe und Alluvialflächen.", "Stark von Regen und Hochwasser geprägt.", "Gutes Beispiel f?r Isolation im tropischen Tiefland."],
      hu: ["Fontos földrajzi vagy gazdasági csomópont.", "Történelmi jelentősége a régióban kiemelkedő.", "Környezeti adottságai meghatározóak az élővilág számára.", "A helyi infrastruktúra része.", "Kulturális öröksége gazdag.", "Központi szerepet tölt be a helyi közösség életében."],
