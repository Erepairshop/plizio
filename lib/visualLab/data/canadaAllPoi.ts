...
export const canadaAllPoi: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Cu cei 3.954 de metri ai săi, Muntele Robson este punctul cel mai înalt din Munții Stâncoși canadieni și inima parcului provincial cu același nume. Peretele său nordic distinctiv se ridică la aproape 2.500 de metri deasupra lacului Berg, fiind unul dintre cei mai mari pereți abrupți din America de Nord.",
      en: ""
    },
    factsAdvanced: {
      de: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Fluviul Fraser izvorăște din Munții Stâncoși și curge pe mai mult de 1.300 de kilometri până la vărsarea sa la sud de Vancouver. Este faimos mondial pentru migrațiile masive ale somonului și a jucat un rol central în timpul goanei după aur din Cariboo.",
      en: ""
    },
    factsAdvanced: {
      de: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Lacul Marele Urs din Teritoriile de Nord-Vest este al patrulea lac ca mărime din America de Nord și este situat direct pe Cercul Arctic. Apa sa este extraordinar de clară și rece, iar lacul este acoperit de gheață în cea mai mare parte a anului.",
      en: ""
    },
    factsAdvanced: {
      de: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Parcul Algonquin este o sălbăticie vastă formată din păduri de arțar, creste stâncoase și mii de lacuri în centrul provinciei Ontario. Este un paradis pentru pasionații de canoe și drumeții, inspirând numeroși artiști canadieni, în special celebrul grup Group of Seven.",
      en: ""
    },
    factsAdvanced: {
      de: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Muntele Edith Cavell este unul dintre cei mai impresionanți munți din Parcul Național Jasper, cunoscut pentru pereții săi verticali de cuarțit. La poalele sale se află ghețarul Cavell și ghețarul Angel, cu formă de aripi de înger, care atârnă spectaculos deasupra stâncilor.",
      en: ""
    },
    factsAdvanced: {
      de: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Fortăreața Louisbourg este o fortificație colonială franceză din secolul al XVIII-lea, parțial reconstruită. A fost cândva unul dintre cele mai ocupate porturi din America de Nord și un centru important pentru pescuitul de cod, precum și un punct militar strategic în lupta pentru controlul continentului.",
      en: ""
    },
    factsAdvanced: {
      de: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "L'Anse aux Meadows este singura așezare vikingă autentificată din America de Nord, în afara Groenlandei. Acest sit inclus în Patrimoniul Mondial UNESCO demonstrează că navigatorii scandinavi au ajuns în America cu 500 de ani înaintea lui Columb și au ridicat clădiri din brazde de iarbă.",
      en: ""
    },
    factsAdvanced: {
      de: [],
