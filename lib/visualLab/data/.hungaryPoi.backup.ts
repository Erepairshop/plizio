...
export const hungaryCountry: POI[] = [
  {
    ...
    factsAdvanced: {
      de: [
        ...
        "Das Land verfügt mit dem Hévízer See über den weltweit größten biologisch aktiven Thermalsee.",
      ...
      hu: [
        ...
        "Az ország területének több mint 80%-a alatt található különböző hőmérsékletű és összetételű termálvíz."
      ],
      ro: [],
      en: []
    },
...
export const hungaryRegions: POI[] = [
  {
    ...
    factsAdvanced: {
      de: [
        "Budapest entstand im Jahr 1873 durch die feierliche Zusammenlegung der Städte Buda, Pest und Óbuda.",
        "Die Stadt beherbergt mit der Linie M1 die älteste elektrische U-Bahn-Linie auf dem europäischen Festland.",
        "Das ungarische Parlamentsgebäude ist das flächenmäßig größte Bauwerk des Landes und ein Wahrzeichen der Stadt.",
        "Budapest ist die einzige Hauptstadt weltweit, die über mehr als 120 warme Thermalquellen verfügt.",
        "Die Große Synagoge in der Dohány-Straße ist das größte jüdische Gotteshaus in ganz Europa."
      ],
      "hu": [
        "Budapest alatt több mint 120 termálforrás található, amelyek naponta mintegy 70 millió liter vizet adnak a fürdőknek.",
        ...
        "Az Országház építésekor 40 kilogramm 24 karátos aranyat használtak fel a belső terek díszítéséhez.",
        "A városban közlekedő 2-es villamos vonalát a National Geographic a világ egyik legszebb villamosvonalának választotta."
      ],
      ro: [],
      en: []
    },
...
export const hungaryCities: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      "de": "",
      "hu": "A Balaton, a 'magyar tenger', Közép-Európa legnagyobb édesvízi tava, és Magyarország legfontosabb turisztikai régiója. A tó 77 kilométer hosszan nyúlik el, északi partját vulkanikus hegyek és történelmi városok (Tihany, Balatonfüred), déli partját pedig sekély víz és pezsgő üdülővárosok (Siófok, Balatonföldvár) jellemzik. A Balaton nemcsak a fürdőzésről szól: a környék borvidékei, a Balaton-felvidéki Nemzeti Park természeti kincsei és a számtalan vitorlásverseny (mint a Kékszalag) mind a tó vonzerejét növelik. A víz tiszta és nyáron kellemesen felmelegszik, ideális feltételeket biztosítva a családoknak. A Balaton minden évszakban más arcát mutatja, télen a befagyott tó és a korcsolyázás élménye vonzza a látogatókat.",
      "ro": "",
      "en": ""
    },
    ...
    factsAdvanced: {
      ...
      "hu": [
        ...
        "A tó medre körülbelül 15-20 ezer évvel ezelőtt alakult ki tektonikai mozgások következtében.",
        ...
        "Évente itt rendezik meg a Kékszalag nemzetközi vitorlásversenyt, Európa legnagyobb tókerülő versenyét."
      ],
      "ro": [],
      "en": []
    },
    ...
    descriptionAdvanced: {
      "de": "",
      "hu": "A Tisza Magyarország második legnagyobb folyója, amelyet a magyar néplélek és költészet (különösen Petőfi Sándor) gyakran a 'legmagyarabb folyóként' emleget. A Tisza kanyargós útja során érinti az Alföld szinte minden fontosabb városát, s élete elválaszthatatlan a magyar mezőgazdaságtól és kultúrától. A folyó híres a 'tiszavirágzásról', a kérészek násztáncáról, amely minden év júniusában látványos természeti jelenség. A Tisza partja mentén számtalan szabadstrand, horgászhely és vízitúra-útvonal található. A folyó felső szakasza gyors és tiszta, míg az alsóbb szakaszokon lassúvá és méltóságossá válik. A Tisza nemcsak vízi út, hanem egy különleges ökoszisztéma is, amely ártéri erdőivel és gazdag élővilágával a természetvédelem egyik legfontosabb színtere hazánkban.",
      "ro": "",
      "en": ""
    },
    ...
    factsAdvanced: {
      "de": [],
      "hu": [
        "A Tisza teljes hossza 962 kilométer, ebből közel 600 kilométer esik Magyarország területére.",
        "A tiszavirágzás egy egyedülálló jelenség, amikor kérészek milliói rajzanak a víz felett néhány napig.",
        "A folyót a 19. században Széchenyi István kezdeményezésére szabályozták, jelentősen lerövidítve az útját.",
        "A Tisza-tó Magyarország legnagyobb mesterséges tava, amely a Tisza szabályozása során jött létre.",
        "A Tisza mentén található a Gemenci erdő egy része, amely az ország legvadregényesebb tájai közé tartozik."
      ],
      "ro": [],
      "en": []
    },
    ...
    descriptionAdvanced: {
      "de": "",
      "hu": "A Duna Európa második leghosszabb folyója és Magyarország legfontosabb vízi útja, amely észak-déli irányban szeli ketté az országot. A folyó mentén épült fel a főváros, Budapest, amelynek panorámája a Dunával együtt a világörökség része. A Duna magyarországi szakasza rendkívül változatos: a Dunakanyar szűk völgyétől a Kisalföld rónaságáig és a déli ártéri erdőkig számos tájegységet érint. A folyó nemcsak a gazdaság és a közlekedés alapja, hanem a turizmusé is: szállodahajók, vízitúrázók és horgászok ezrei élvezik a vizét. A Duna menti gátak és sétányok a városi kikapcsolódás legfontosabb színterei. Történelmi szempontból a Duna mindig is összekötő kapocs volt Európa nemzetei között, s ma is fontos stratégiai és környezetvédelmi tengely.",
      "ro": "",
      "en": ""
    },
    ...
    factsAdvanced: {
      ...
      "hu": [
        ...
        "A folyó a Fekete-erdőben ered és a Fekete-tengerbe torkollik, 10 országot érintve.",
        ...
        "A Duna-Dráva Nemzeti Park őrzi a folyó menti legértékesebb vizes élőhelyeket és ártéri erdőket."
      ],
      "ro": [],
      "en": []
    },
