...
export const poiExtraSingaporeCitiesV2: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Kampong Glam ist Singapurs sichtbarstes malaiisch-muslimisches Kulturviertel. Rund um die Sultan Mosque, Bussorah Street und Arab Street stehen historische Shophouses, CafÃ©s, TextilgeschÃ¤fte und kleine LÃ¤den dicht nebeneinander. Haji Lane bringt Street-Art und junge Gastronomie hinein, ohne den alten Kern zu Ã¼berdecken. Das Viertel zeigt sehr deutlich, wie kulturelles Erbe im Alltag weiterlebt, statt nur museal zu sein. Es bleibt tagsÃ¼ber auch ein ruhiger Bezugspunkt fÃ¼r lokale Wege und Wege. FÃ¼r Plizio passt das zu Geschichte K8 und zu Stadtquartieren mit IdentitÃ¤t.",
      hu: "",
      ro: "",
    ...
    factsAdvanced: {
      de: ["Die Sultan Mosque ist der wichtigste religiÃ¶se Anker des Viertels.", "Arab Street steht fÃ¼r Stoffe, GewÃ¼rze und kleine FachgeschÃ¤fte.", "Haji Lane ist fÃ¼r Street-Art und CafÃ©s bekannt.", "Das Malay Heritage Centre liegt im historischen Kern von Kampong Glam.", "Bussorah Street verbindet die wichtigsten StraÃŸenzÃ¼ge des Quartiers.", "Kampong Glam war historisch mit dem malaiischen Herrscherhof verbunden."],
      hu: [],
      ro: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Bukit Timah ist der grÃ¼nste und reliefstÃ¤rkste Teil des Zentrums. Hier liegt der hÃ¶chste natÃ¼rliche Punkt Singapurs, daneben der Bukit Timah Nature Reserve und Wege, die direkt in den sekundÃ¤ren Regenwald fÃ¼hren. In der Umgebung verbinden Upper Bukit Timah Road, Beauty World und Hindhede Nature Park Natur, Wohnen und Verkehr. Der Bezirk wirkt dadurch deutlich ruhiger als die Ã¼brige Metropole. Wer hier steht, versteht schnell, dass Singapur nicht nur aus KÃ¼stenebene und HochhÃ¤usern besteht. Passt zu Geografie K7 und Relief.",
      hu: "",
      ro: "",
    ...
    factsAdvanced: {
      de: ["Der Bukit Timah Hill ist der hÃ¶chste natÃ¼rliche Punkt Singapurs.", "Das Bukit Timah Nature Reserve schÃ¼tzt einen der letzten PrimÃ¤rwaldreste.", "Hindhede Nature Park liegt direkt am Rand des Reservats.", "Beauty World ist ein bekannter lokaler Bezugspunkt im Viertel.", "Upper Bukit Timah Road bildet eine wichtige Verkehrsachse.", "Der Rail Corridor verlÃ¤uft in Reichweite des Gebiets."],
      hu: [],
      ro: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Serangoon ist ein dicht vernetzter Wohn- und Handelsbezirk, in dem groÃŸe Infrastruktur und Nachbarschaft nahe zusammenliegen. NEX dominiert das Zentrum, Serangoon MRT verbindet Nordost- und Circle Line, und Serangoon Gardens liefert mit seinen StraÃŸen und Essensorten einen viel bekannteren Alltagscharakter als es von auÃŸen wirkt. Rundherum liegen Chomp Chomp Food Centre, Lorong Chuan und Wohncluster, die den Ort wie ein Bindeglied zwischen mehreren nÃ¶rdlichen und Ã¶stlichen Towns wirken lassen. Gerade diese Mischung macht den Bezirk fÃ¼r Familien sehr alltagstauglich. Das passt zu Geografie K7 und urbanem Netzdenken.",
      hu: "",
      ro: "",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Downtown Core ist der konzentrierte Kern des Finanz- und Verwaltungsraums Singapurs. Zwischen Raffles Place, Marina Bay, City Hall, Fullerton und der Esplanade liegen RegierungsgebÃ¤ude, Banken, Hotels und Kulturorte auf engstem Raum. Hier wird besonders deutlich, wie Singapur reprÃ¤sentative Architektur, Verkehr und Wasserfront zusammenfÃ¼hrt. Abends Ã¤ndern sich die Wege, wenn BÃ¼ros leer werden und die Bay als Ã¶ffentlicher Stadtraum sichtbar wird. Der Bezirk ist das beste Beispiel fÃ¼r die urbane Dichte des Stadtstaats. Passt zu Geografie K7 und Wirtschaft K8.",
      hu: "",
      ro: "",
    ...
    factsAdvanced: {
      de: ["Raffles Place ist ein Kern des Finanzdistrikts.", "Marina Bay Financial Centre prÃ¤gt die moderne Skyline.", "City Hall ist ein historisch und politisch wichtiges Bezugselement.", "Die Esplanade steht fÃ¼r Kultur direkt am Wasser.", "Der Merlion gehÃ¶rt zu den bekanntesten Symbolen des Bezirks.", "Bayfront MRT verknÃ¼pft die Uferzone mit dem Netz."],
      hu: [],
      ro: [],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Sembawang liegt im Norden und wirkt durch seine KÃ¼ste, seinen alten MilitÃ¤rhintergrund und seine Wohngebiete eigenstÃ¤ndig. Sembawang Park, die Ufer am Johor-StraÃŸenraum, Canberra MRT und die Wohnsiedlungen zeigen einen Bezirk, der lange weniger verdichtet war als andere Towns. Heute verbindet er Familienwohnen, GrÃ¼nrÃ¤ume und die Erinnerung an den frÃ¼heren Marinestandort. Das Viertel zeigt, dass Singapur nicht nur aus innerstÃ¤dtischer Verdichtung besteht, sondern auch aus Randlagen mit eigener Geschichte. Die offenen Ufer und die weiten WohnflÃ¤chen geben ihm viel Luft. Passt zu Geografie K7 und KÃ¼stenraum.",
      hu: "",
      ro: "",
    ...
    factsAdvanced: {
      de: ["Sembawang Park ist das bekannteste Freizeitgebiet des Bezirks.", "Canberra MRT und Sembawang MRT sichern die Anbindung.", "Die frÃ¼here Marinebasis prÃ¤gte die historische Entwicklung des Ortes.", "Sungei Sembawang verlÃ¤uft als wichtiger Wasserlauf durch das Gebiet.", "Der Bezirk liegt im nÃ¶rdlichen KÃ¼stenraum Singapurs.", "Sembawang verbindet Wohnsiedlungen mit einem stark geprÃ¤gten Uferraum."],
      hu: [],
      ro: [],
