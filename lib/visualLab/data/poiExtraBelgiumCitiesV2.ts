...
export const belgiumCitiesV2: POI[] = [

  {
    ...
    descriptionAdvanced: {
      de: "Antwerpen ist nicht nur die zweitgrößte Stadt Belgiens, sondern auch ein globales Wirtschaftszentrum, das stark durch seinen Seehafen geprägt ist, welcher der zweitgrößte in Europa ist. Die Metropole an der Schelde hat eine reiche Geschichte, die sich in ihrer beeindruckenden Architektur, insbesondere der gotischen Liebfrauenkathedrale, widerspiegelt. Antwerpen ist das weltweite Zentrum des Diamantenhandels; etwa 80 Prozent aller Rohdiamanten weltweit werden hier gehandelt. Darüber hinaus ist die Stadt berühmt für ihr kulturelles Erbe als Heimatstadt des berühmten Barockmalers Peter Paul Rubens. Sein Wohn- und Atelierhaus, das Rubenshaus, ist heute ein wichtiges Museum. Die Stadt bietet eine dynamische Mischung aus historischem Charme, moderner Modeindustrie und einer lebendigen kulinarischen Szene, die Touristen aus aller Welt anzieht.",
      hu: "Antwerpen nemcsak Belgium második legnagyobb városa, hanem egy globális gazdasági központ is, amelyet erősen meghatároz tengeri kikötője, amely Európában a második legnagyobb. A Schelde folyó partján fekvő metropolisz gazdag történelemmel rendelkezik, amely lenyűgöző építészetében, különösen a gótikus Miasszonyunk-székesegyházban tükröződik. Antwerpen a gyémántkereskedelem globális központja; a világ nyersgyémántjainak mintegy 80 százaléka itt cserél gazdát. Emellett a város híres kulturális örökségéről is, mint a híres barokk festő, Peter Paul Rubens szülővárosa. Egykori lakó- és műteremháza, a Rubens-ház, ma jelentős múzeum. A város a történelmi báj, a modern divatipar és az élénk gasztronómiai élet dinamikus keverékét kínálja, amely a világ minden tájáról vonzza a turistákat.",
      ro: "Anvers nu este doar al doilea oraș ca mărime din Belgia, ci și un hub economic global, profund influențat de portul său maritim, al doilea ca mărime din Europa. Metropola de pe râul Scheldt are o istorie bogată, reflectată în arhitectura sa impresionantă, în special în Catedrala gotică a Maicii Domnului. Anvers este centrul mondial al comerțului cu diamante; aproximativ 80% din toate diamantele brute din lume sunt tranzacționate aici. În plus, orașul este faimos pentru moștenirea sa culturală, fiind orașul natal al celebrului pictor baroc Peter Paul Rubens. Fosta sa casă și atelier, Casa Rubens, este astăzi un muzeu important. Orașul oferă un amestec dinamic de farmec istoric, industrie modernă a modei și o scenă culinară vibrantă, care atrage turiști din întreaga lume.",
      en: "Antwerp is not only Belgium's second-largest city but also a global economic hub heavily defined by its seaport, which is the second largest in Europe. The metropolis on the Scheldt River has a rich history reflected in its impressive architecture, particularly the Gothic Cathedral of Our Lady. Antwerp is the undisputed global center of the diamond trade; approximately 80 percent of all rough diamonds worldwide are traded here. Furthermore, the city is famous for its cultural heritage as the home of the renowned Baroque painter Peter Paul Rubens. His former residence and studio, the Rubenshuis, is now a major museum. The city offers a dynamic blend of historic charm, a modern fashion industry, and a vibrant culinary scene that attracts tourists from all over the world."
    },
    factsAdvanced: {
      de: ["Second largest seaport in Europe by freight volume", "Over 80% of the world's rough diamonds are traded here", "Home to the 123-meter high Gothic Cathedral of Our Lady", "Birthplace and home of Baroque painter Peter Paul Rubens", "World's first purpose-built commodity exchange founded in 1531", "Recognized globally as a major fashion and design hub", "Antwerp Central Station is considered one of the most beautiful railway stations"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-antwerp-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Gent ist eine dynamische und historische Universitätsstadt in Flandern, die für ihr außergewöhnlich gut erhaltenes mittelalterliches Stadtzentrum berühmt ist. Die Stadt, die am Zusammenfluss der Flüsse Schelde und Leie liegt, erlebte im Mittelalter eine Blütezeit als eines der wichtigsten und reichsten Zentren der europäischen Tuchindustrie. Das architektonische Erbe aus dieser Zeit, darunter die mächtige Wasserburg Gravensteen aus dem 12. Jahrhundert und die beeindruckenden Gildehäuser entlang der Graslei, zeugen von diesem Wohlstand. Gent ist zudem die Heimat des weltberühmten Genter Altars der Brüder van Eyck, eines Meisterwerks der flämischen Malerei. Heute ist Gent nicht nur eine Museumsstadt, sondern eine lebendige Metropole mit dem drittgrößten Hafen Belgiens, einer blühenden Kulturszene und einer der größten autofreien Innenstädte Europas.",
      hu: "Gent egy dinamikus és történelmi egyetemi város Flandriában, amely kivételesen jól megőrzött középkori városközpontjáról híres. A Schelde és a Leie folyók találkozásánál fekvő település a középkorban élte virágkorát, mint az európai posztóipar egyik legfontosabb és leggazdagabb központja. Az ebből az időből származó építészeti örökség, köztük a 12. századi hatalmas vízivár, a Gravensteen, valamint a Graslei mentén sorakozó lenyűgöző céhházak mind e gazdagságról tanúskodnak. Gent ad otthont a világhírű Genti Oltárnak is, a van Eyck fivérek remekművének. Ma Gent nem pusztán egy múzeumváros, hanem egy élénk metropolisz is, amely Belgium harmadik legnagyobb kikötőjével, virágzó kulturális élettel és Európa egyik legnagyobb autómentes belvárosával büszkélkedhet.",
      ro: "Gent este un oraș universitar dinamic și istoric din Flandra, renumit pentru centrul său medieval excepțional de bine conservat. Orașul, situat la confluența râurilor Scheldt și Leie, a înflorit în Evul Mediu ca unul dintre cele mai importante și bogate centre ale industriei textile europene. Moștenirea arhitecturală din acea perioadă, inclusiv puternicul castel pe apă Gravensteen din secolul al XII-lea și casele impresionante ale breslelor de-a lungul Graslei, stau mărturie a acestei bogății. Gent găzduiește, de asemenea, faimosul Altar din Gent al fraților van Eyck, o capodoperă a picturii flamande. Astăzi, Gent nu este doar un oraș-muzeu, ci o metropolă vibrantă, cu al treilea port ca mărime din Belgia, o scenă culturală înfloritoare și una dintre cele mai mari zone pietonale din Europa.",
      en: "Ghent is a dynamic and historic university city in Flanders, renowned for its exceptionally well-preserved medieval city center. Situated at the confluence of the Scheldt and Leie rivers, the city flourished during the Middle Ages as one of the most important and wealthiest centers of the European cloth industry. The architectural heritage from this era, including the formidable 12th-century Gravensteen water castle and the impressive guild halls along the Graslei, bear witness to this prosperity. Ghent is also home to the world-famous Ghent Altarpiece by the van Eyck brothers, a masterpiece of Flemish painting. Today, Ghent is not merely a museum city but a lively metropolis boasting Belgium's third-largest port, a thriving cultural scene, and one of Europe's largest car-free city centers."
    },
    factsAdvanced: {
      de: ["Features the 12th-century Gravensteen, a formidable medieval water castle", "Home to the renowned 1432 Ghent Altarpiece by the van Eyck brothers", "Boasts the third-largest port in Belgium by cargo volume", "Maintains one of the largest car-free city centers in Europe", "Historically one of Europe's largest and wealthiest cities in the 13th century", "Host to the ten-day Gentse Feesten, a massive annual music and theater festival", "Major university city with over 70,000 students enrolled"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-ghent-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Brügge, die Hauptstadt der Provinz Westflandern, ist eine der faszinierendsten historischen Städte Europas. Bekannt als das \"Venedig des Nordens\" wegen seiner zahlreichen, malerischen Kanäle, zieht die Stadt jährlich Millionen von Besuchern an. Ihr historisches Zentrum, das vollständig als UNESCO-Welterbe geschützt ist, bewahrt den mittelalterlichen Charakter der Stadt nahezu perfekt. Im 13. und 14. Jahrhundert war Brügge ein überragendes Handelszentrum der Hanse und eine der reichsten Städte des Kontinents, berühmt für die Produktion von luxuriösen flämischen Tuchen. Sehenswürdigkeiten wie der 83 Meter hohe Belfried auf dem Marktplatz, die gotische Liebfrauenkirche mit einer echten Michelangelo-Skulptur und die Beginenhöfe machen die Stadt einzigartig. Heute ist Brügge auch für seine feine Schokolade und das traditionelle Spitzenklöppeln weltweit renommiert.",
      hu: "Brugge, Nyugat-Flandria tartomány fővárosa, Európa egyik leglenyűgözőbb történelmi városa. A számos festői csatornája miatt \"Észak Velencéjeként\" is emlegetett település évente több millió látogatót vonz. Történelmi központja, amely teljes egészében az UNESCO Világörökség része, szinte tökéletesen őrzi a város középkori arculatát. A 13. és 14. században Brugge a Hanza-szövetség kiemelkedő kereskedelmi központja és a kontinens egyik leggazdagabb városa volt, híres a luxus minőségű flamand posztó gyártásáról. Az olyan látnivalók, mint a piactéren álló 83 méter magas harangtorony (Belfry), a gótikus Miasszonyunk-templom egy eredeti Michelangelo-szoborral, és a beginaudvarok teszik a várost egyedülállóvá. Ma Brugge finom csokoládéjáról és a hagyományos csipkeverésről is világhírű.",
      ro: "Bruges, capitala provinciei Flandra de Vest, este unul dintre cele mai fascinante orașe istorice din Europa. Cunoscut drept \"Veneția Nordului\" datorită numeroaselor sale canale pitorești, orașul atrage milioane de vizitatori anual. Centrul său istoric, protejat în întregime ca sit al Patrimoniului Mondial UNESCO, își păstrează aproape perfect caracterul medieval. În secolele al XIII-lea și al XIV-lea, Bruges a fost un centru comercial remarcabil al Ligii Hanseatice și unul dintre cele mai bogate orașe de pe continent, faimos pentru producția de pânze flamande de lux. Atracții precum turnul Belfry înalt de 83 de metri din piața principală, Biserica gotică Notre-Dame cu o sculptură originală de Michelangelo și curțile Beguinage fac orașul unic. Astăzi, Bruges este renumit la nivel mondial și pentru ciocolata sa fină și fabricarea tradițională a dantelei.",
      en: "Bruges, the capital of the West Flanders province, is one of Europe's most captivating historic cities. Known as the \"Venice of the North\" due to its numerous picturesque canals, the city attracts millions of visitors annually. Its historic center, entirely protected as a UNESCO World Heritage site, preserves the city's medieval character almost perfectly. During the 13th and 14th centuries, Bruges was a paramount commercial hub of the Hanseatic League and one of the wealthiest cities on the continent, famous for the production of luxurious Flemish cloths. Landmarks such as the 83-meter high Belfry on the market square, the Gothic Church of Our Lady housing an original Michelangelo sculpture, and the Beguinages make the city unique. Today, Bruges is also globally renowned for its fine chocolate and traditional lace-making."
    },
    factsAdvanced: {
      de: ["Historic city center is entirely recognized as a UNESCO World Heritage site", "Features an 83-meter tall medieval Belfry with a 47-bell carillon", "Church of Our Lady contains 'Madonna and Child', a genuine Michelangelo sculpture", "Contains over 80 bridges crossing its extensive network of canals", "Was a major commercial hub for the Hanseatic League in the Middle Ages", "Famous globally for its traditional handmade bobbin lace craftsmanship", "Important center for Flemish Primitive painting in the 15th century"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-bruges-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Lüttich ist die unangefochtene Wirtschafts- und Kulturmetropole der Wallonie und die wichtigste Stadt an der Maas. Historisch gesehen wurde die Stadt jahrhundertelang vom mächtigen Fürstbistum Lüttich regiert, dessen beeindruckender Palast der Fürstbischöfe noch heute das Stadtbild dominiert. Im 19. Jahrhundert entwickelte sich Lüttich zu einem der ersten und größten Zentren der industriellen Revolution auf dem europäischen Festland, getrieben von Kohlebergbau und einer florierenden Stahlindustrie. Das moderne Lüttich ist eine Stadt im Wandel, die ihre industrielle Vergangenheit mit zeitgenössischer Entwicklung verbindet, symbolisiert durch den futuristischen Bahnhof Liège-Guillemins des Architekten Santiago Calatrava. Die Stadt ist zudem für ihr pulsierendes Nachtleben im Viertel Le Carré, den sonntäglichen Markt La Batte am Maasufer und die berühmten, süßen Lütticher Waffeln bekannt.",
      hu: "Liège Vallónia vitathatatlan gazdasági és kulturális metropolisza, egyben a Meuse folyó legfontosabb városa. Történelmileg a várost évszázadokon át a hatalmas Liège-i Püspökség irányította, amelynek lenyűgöző püspöki palotája ma is meghatározza a városképet. A 19. században Liège az európai kontinens ipari forradalmának egyik első és legnagyobb központjává fejlődött, amelyet a szénbányászat és a virágzó acélipar hajtott. A modern Liège egy átalakulóban lévő város, amely ötvözi ipari múltját a kortárs fejlődéssel, amit Santiago Calatrava építész futurisztikus Liège-Guillemins pályaudvara is szimbolizál. A város ezenkívül pezsgő éjszakai életéről a Le Carré negyedben, a Meuse partján vasárnaponként megrendezett La Batte piacról és a híres, édes liège-i gofriról is ismert.",
      ro: "Liège este metropola economică și culturală incontestabilă a Valoniei și cel mai important oraș de pe râul Meuse. Din punct de vedere istoric, orașul a fost condus timp de secole de puternicul Principat-Episcopat de Liège, al cărui impresionant Palat al Prinților-Episcopi domină și astăzi peisajul urban. În secolul al XIX-lea, Liège s-a dezvoltat într-unul dintre primele și cele mai mari centre ale Revoluției Industriale de pe continentul european, impulsionat de mineritul cărbunelui și de o industrie siderurgică înfloritoare. Liège-ul modern este un oraș în tranziție, care îmbină trecutul său industrial cu dezvoltarea contemporană, simbolizat de gara futuristă Liège-Guillemins proiectată de arhitectul Santiago Calatrava. Orașul este cunoscut, de asemenea, pentru viața de noapte vibrantă din cartierul Le Carré, piața duminicală La Batte de pe malul râului Meuse și faimoasele vafe dulci de Liège.",
      en: "Liège is the undisputed economic and cultural metropolis of Wallonia and the most important city on the Meuse River. Historically, the city was ruled for centuries by the powerful Prince-Bishopric of Liège, whose impressive Palace of the Prince-Bishops still dominates the cityscape today. In the 19th century, Liège developed into one of the first and largest centers of the Industrial Revolution on the European mainland, driven by coal mining and a thriving steel industry. Modern Liège is a city in transition, blending its industrial past with contemporary development, symbolized by the futuristic Liège-Guillemins railway station designed by architect Santiago Calatrava. The city is also known for its vibrant nightlife in the Le Carré district, the Sunday La Batte market along the banks of the Meuse, and the famous, sweet Liège waffles."
    },
    factsAdvanced: {
      de: ["Features the iconic Montagne de Bueren, a steep staircase with exactly 374 steps", "The futuristic Liège-Guillemins railway station was designed by Santiago Calatrava", "Was a major center of the Industrial Revolution in continental Europe", "Hosts La Batte, one of the largest and oldest Sunday markets in Belgium", "Historically ruled as an independent Prince-Bishopric for over 800 years", "Home to the third-largest inland river port in Europe", "Birthplace of the internationally famous, sugar-crusted Liège waffle"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-liege-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Namur, die politische Hauptstadt der Wallonie, besticht durch ihre strategisch und landschaftlich reizvolle Lage am Zusammenfluss von Sambre und Maas. Hoch über der Stadt thront die imposante Zitadelle von Namur, eine der größten und am besten erhaltenen Festungsanlagen Europas, deren Geschichte bis in die römische Zeit zurückreicht. Diese Festung war im Laufe der Jahrhunderte Schauplatz zahlreicher Belagerungen und ist heute das wichtigste Wahrzeichen der Stadt. Das historische Zentrum von Namur bezaubert mit seinen charmanten Fußgängerzonen, eleganten Bürgerhäusern aus dem 18. Jahrhundert und der beeindruckenden klassizistischen St.-Auban-Kathedrale. Namur ist auch Sitz des wallonischen Parlaments und der Regionalregierung. Die Stadt strahlt eine entspannte Atmosphäre aus und ist ein hervorragender Ausgangspunkt, um die landschaftliche Schönheit der Ardennenregion zu erkunden.",
      hu: "Namur, Vallónia politikai fővárosa, lenyűgözi a látogatókat stratégiai és festői fekvésével a Sambre és a Meuse folyók találkozásánál. A város fölé magasodik az impozáns namuri citadella, Európa egyik legnagyobb és legépszerűbben fennmaradt erődítménye, amelynek története egészen a római korig nyúlik vissza. Ez az erőd az évszázadok során számos ostrom helyszíne volt, ma pedig a város legfontosabb jelképe. Namur történelmi központja elvarázsolja a látogatókat hangulatos sétálóutcáival, elegáns 18. századi polgárházaival és a lenyűgöző klasszicista Szent Albin-székesegyházzal. Namur egyben a vallon parlament és a regionális kormány székhelye is. A város nyugodt légkört áraszt, és kiváló kiindulópont az Ardennek régió természeti szépségeinek felfedezéséhez.",
      ro: "Namur, capitala politică a Valoniei, impresionează prin locația sa strategică și pitorească la confluența râurilor Sambre și Meuse. Deasupra orașului tronează impunătoarea Citadelă din Namur, una dintre cele mai mari și mai bine conservate fortificații din Europa, a cărei istorie datează din perioada romană. De-a lungul secolelor, această fortăreață a fost scena a numeroase asedii și este astăzi cel mai important punct de reper al orașului. Centrul istoric al orașului Namur fascinează cu străzile sale pietonale fermecătoare, casele elegante ale burghezilor din secolul al XVIII-lea și impresionanta Catedrală neoclasică Saint-Aubain. Namur este, de asemenea, sediul Parlamentului Valon și al guvernului regional. Orașul emană o atmosferă relaxată și este un punct de plecare excelent pentru explorarea frumuseții peisajistice a regiunii Ardeni.",
      en: "Namur, the political capital of Wallonia, captivates visitors with its strategic and scenic location at the confluence of the Sambre and Meuse rivers. Towering high above the city is the imposing Citadel of Namur, one of the largest and most well-preserved fortresses in Europe, with a history dating back to Roman times. Over the centuries, this fortress was the site of numerous sieges and stands today as the city's most prominent landmark. The historic center of Namur charms with its delightful pedestrian zones, elegant 18th-century merchant houses, and the impressive neoclassical Saint Aubin's Cathedral. Namur also serves as the seat of the Walloon Parliament and the regional government. The city exudes a relaxed atmosphere and serves as an excellent starting point for exploring the scenic beauty of the Ardennes region."
    },
    factsAdvanced: {
      de: ["Dominated by the massive Citadel of Namur, occupying 80 hectares", "Serves as the official political capital of the Wallonia region", "Located strategically at the confluence of the Sambre and Meuse rivers", "Saint Aubin's Cathedral is the only late-Baroque/Neoclassical cathedral in Belgium", "The Royal Theatre of Namur dates back to the mid-19th century", "Hosts the annual FIFF (Festival International du Film Francophone)", "The citadel features an extensive network of underground tunnels, dubbed the 'Termite Mound of Europe'"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-namur-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Löwen ist eine dynamische und historische Universitätsstadt östlich von Brüssel, die für ihr jugendliches Flair und ihre reiche Geschichte bekannt ist. Sie ist die Heimat der KU Leuven, der ältesten Universität der Benelux-Länder, die 1425 gegründet wurde und der Stadt ihren intellektuellen Charakter verleiht. Das absolute architektonische Highlight ist das spätgotische Rathaus auf dem Grote Markt, dessen Fassade mit über 200 Statuen verziert ist und als eines der schönsten Rathäuser der Welt gilt. Darüber hinaus ist Löwen als Hauptstadt des belgischen Bieres berühmt. Hier befindet sich der Hauptsitz von AB InBev, der größten Brauereigruppe der Welt, sowie der Oude Markt, ein Platz, der aufgrund seiner lückenlosen Aneinanderreihung von Cafés und Bars oft als \"die längste Theke der Welt\" bezeichnet wird.",
      hu: "Leuven egy dinamikus és történelmi egyetemi város Brüsszeltől keletre, amely fiatalos hangulatáról és gazdag történelméről ismert. Itt található a KU Leuven, a Benelux-államok legrégebbi egyeteme, amelyet 1425-ben alapítottak, és amely megadja a város intellektuális karakterét. Az abszolút építészeti fénypont a Grote Markton álló késő gótikus városháza, amelynek homlokzatát több mint 200 szobor díszíti, és a világ egyik legszebb városházájaként tartják számon. Emellett Leuven a belga sör fővárosaként is világhírű. Itt található a világ legnagyobb sörfőzde-csoportja, az AB InBev központja, valamint az Oude Markt (Öreg Piac), amelyet a kávézók és bárok megszakítás nélküli sora miatt gyakran \"a világ leghosszabb bárpultjának\" is neveznek.",
      ro: "Louvain este un oraș universitar dinamic și istoric la est de Bruxelles, recunoscut pentru atmosfera sa tinerească și istoria bogată. Găzduiește KU Leuven, cea mai veche universitate din regiunea Benelux, fondată în 1425, care conferă orașului caracterul său intelectual. Punctul de atracție arhitectural absolut este primăria în stil gotic târziu din Grote Markt, a cărei fațadă este decorată cu peste 200 de statui și este considerată una dintre cele mai frumoase primării din lume. Mai mult, Louvain este faimos ca fiind capitala berii belgiene. Aici se află sediul central al AB InBev, cel mai mare grup de berării din lume, precum și Oude Markt (Piața Veche), o piață adesea numită \"cel mai lung bar din lume\" datorită șirului neîntrerupt de cafenele și baruri.",
      en: "Leuven is a dynamic and historic university city east of Brussels, renowned for its youthful flair and rich history. It is home to KU Leuven, the oldest university in the Low Countries, founded in 1425, which gives the city its intellectual character. The absolute architectural highlight is the late Gothic town hall on the Grote Markt, whose facade is decorated with over 200 statues and is considered one of the most beautiful town halls in the world. Furthermore, Leuven is famous as the capital of Belgian beer. It hosts the headquarters of AB InBev, the largest brewery group in the world, as well as the Oude Markt (Old Market), a square often referred to as \"the longest bar in the world\" due to its continuous row of cafes and bars."
    },
    factsAdvanced: {
      de: ["KU Leuven was founded in 1425, making it the oldest Catholic university still in existence", "Home to AB InBev, the largest beer brewer in the world", "The Town Hall on the Grote Markt is adorned with exactly 236 statues", "The Oude Markt features over 40 bars in continuous succession", "Stella Artois brewery has been producing beer here since 1366", "Features the Grand Beguinage, recognized as a UNESCO World Heritage site", "Major center of student life with a highly youthful population demographic"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-leuven-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Mons, die kulturelle Hauptstadt der Provinz Hennegau, ist eine charmante historische Stadt in der Wallonie. Im Jahr 2015 erlangte sie internationale Bekanntheit als Kulturhauptstadt Europas. Das Herz der Stadt bildet der malerische Grand Place mit dem eleganten Rathaus. Darüber hinaus ragt der barocke Belfried, der als einziger seiner Art in Belgien von der UNESCO als Welterbe geschützt ist, weithin sichtbar über die Stadt. Ein weiteres architektonisches Juwel ist die beeindruckende Kollegiatkirche Sainte-Waudru, die zahlreiche Kunstschätze beherbergt. Ein jährliches Highlight ist die Ducasse de Mons (lokal Doudou genannt), ein faszinierendes traditionelles Fest mit einem inszenierten Drachenkampf, das von der UNESCO als Meisterwerk des mündlichen und immateriellen Erbes der Menschheit anerkannt wurde. Die nahe gelegenen prähistorischen Feuersteinminen von Spiennes gehören ebenfalls zum UNESCO-Welterbe.",
      hu: "Mons, Hainaut tartomány kulturális fővárosa, egy bájos történelmi város Vallóniában. 2015-ben Európa Kulturális Fővárosaként szerzett nemzetközi hírnevet. A város szívét a festői Grand Place (Főtér) alkotja az elegáns városházával. Ezen felül a barokk harangtorony (Belfry) - amely egyetlen ilyen stílusú toronyként élvez UNESCO világörökségi védelmet Belgiumban - messziről láthatóan magasodik a város fölé. Egy másik építészeti ékszerdoboz a lenyűgöző Szent Valtrúd-társszékesegyház, amely számos művészeti kincset rejt. Az év egyik fénypontja a Ducasse de Mons (helyi nevén Doudou), egy lenyűgöző hagyományos fesztivál megrendezett sárkányöléssel, amelyet az UNESCO az emberiség szellemi kulturális örökségének mesterműveként ismert el. A közeli spiennes-i történelem előtti kovakőbányák szintén az UNESCO Világörökség részét képezik.",
      ro: "Mons, capitala culturală a provinciei Hainaut, este un oraș istoric fermecător din Valonia. În anul 2015 a câștigat recunoaștere internațională ca și Capitală Europeană a Culturii. Inima orașului este pitoreasca Grand Place (Piața Mare), cu eleganta sa primărie. Deasupra orașului se înalță turnul baroc Belfry, care este vizibil de departe și este singurul de acest fel din Belgia protejat ca sit al Patrimoniului Mondial UNESCO. O altă bijuterie arhitecturală este impresionanta Biserică Colegială Sainte-Waudru, care adăpostește numeroase comori de artă. Un punct culminant anual este Ducasse de Mons (numit local Doudou), un festival tradițional fascinant cu o luptă pusă în scenă cu un dragon, recunoscut de UNESCO drept o capodoperă a patrimoniului oral și imaterial al umanității. Minele preistorice de silex din apropiere, de la Spiennes, fac, de asemenea, parte din Patrimoniul Mondial.",
      en: "Mons, the cultural capital of the Hainaut province, is a charming historic city in Wallonia. In 2015, it gained international prominence as the European Capital of Culture. The heart of the city is the picturesque Grand Place with its elegant town hall. Rising above the city and visible from afar is the Baroque Belfry, the only one of its kind in Belgium to be protected as a UNESCO World Heritage site. Another architectural jewel is the impressive Collegiate Church of Sainte-Waudru, which houses numerous art treasures. An annual highlight is the Ducasse de Mons (locally known as the Doudou), a fascinating traditional festival featuring a staged dragon fight, which has been recognized by UNESCO as a Masterpiece of the Oral and Intangible Heritage of Humanity. The nearby prehistoric flint mines of Spiennes are also a UNESCO World Heritage site."
    },
    factsAdvanced: {
      de: ["European Capital of Culture in 2015 alongside Plzeň", "The Baroque Belfry stands 87 meters high and is a UNESCO site", "Hosted the first battle between British and German forces in WWI in 1914", "Supreme Headquarters Allied Powers Europe (SHAPE) has been located near Mons since 1967", "The Ducasse de Mons (Doudou) festival dates back to the 14th century", "The Neolithic flint mines of Spiennes span over 100 hectares", "Birthplace of the influential composer Orlande de Lassus"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-mons-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Charleroi ist die größte Stadt der Wallonie und das wichtigste wirtschaftliche Zentrum der Region. Historisch als Herzstück des \"Pays Noir\" (Schwarzes Land) bekannt, spielte die Stadt eine entscheidende Rolle in der belgischen industriellen Revolution, geprägt durch intensiven Kohlebergbau und Schwerindustrie. Die alten Zechentürme und Fabrikanlagen zeugen noch heute von dieser Ära; besonders das ehemalige Bergwerk Bois du Cazier, heute ein UNESCO-Welterbe und Museum, erinnert eindrucksvoll an die industrielle Vergangenheit und die tragische Bergbaukatastrophe von 1956. In den letzten Jahrzehnten hat Charleroi jedoch einen massiven Wandel durchlaufen und entwickelt sich zunehmend zu einem Zentrum für Technologie und Luftfahrt. Darüber hinaus ist Charleroi als bedeutendes Zentrum der europäischen Comic-Kultur bekannt, eng verbunden mit dem traditionsreichen Verlag Dupuis, der legendäre Figuren wie Spirou, Lucky Luke und die Schlümpfe hervorbrachte.",
      hu: "Charleroi Vallónia legnagyobb városa és a régió legfontosabb gazdasági központja. A \"Fekete vidék\" (Pays Noir) szíveként ismert település döntő szerepet játszott a belga ipari forradalomban, amelyet az intenzív szénbányászat és a nehézipar jellemzett. A régi aknatornyok és gyárépületek még ma is tanúskodnak erről a korszakról; különösen a Bois du Cazier egykori bányatelep - ma UNESCO világörökségi helyszín és múzeum - emlékeztet lenyűgözően az ipari múltra és az 1956-os tragikus bányaszerencsétlenségre. Az elmúlt évtizedekben azonban Charleroi hatalmas átalakuláson ment keresztül, és egyre inkább a technológia és a légiközlekedés központjává fejlődik. Ezen túlmenően Charleroi az európai képregénykultúra jelentős központjaként is ismert, szorosan kötődve a nagy múltú Dupuis kiadóhoz, amely olyan legendás figurákat teremtett, mint Spirou, Lucky Luke és a Hupikék törpikék.",
      ro: "Charleroi este cel mai mare oraș din Valonia și cel mai important centru economic al regiunii. Cunoscut istoric ca inima „Țării Negre” (Pays Noir), orașul a jucat un rol crucial în revoluția industrială belgiană, fiind caracterizat prin minerit intens de cărbune și industrie grea. Vechile turnuri miniere și fabrici încă stau mărturie a acelei epoci; în special fosta mină Bois du Cazier, astăzi sit UNESCO și muzeu, amintește impresionant de trecutul industrial și de tragicul dezastru minier din 1956. În ultimele decenii, însă, Charleroi a trecut printr-o transformare masivă și se dezvoltă din ce în ce mai mult într-un centru pentru tehnologie și aviație. În plus, Charleroi este renumit ca un centru major al culturii benzilor desenate europene, fiind strâns legat de tradiționala editură Dupuis, care a produs personaje legendare precum Spirou, Lucky Luke și Ștrumfii.",
      en: "Charleroi is the largest city in Wallonia and the region's most important economic center. Historically known as the heart of the \"Black Country\" (Pays Noir), the city played a crucial role in the Belgian Industrial Revolution, characterized by intensive coal mining and heavy industry. The old mine towers and factory sites still bear witness to this era; in particular, the former Bois du Cazier colliery, now a UNESCO World Heritage site and museum, serves as a poignant reminder of the industrial past and the tragic mining disaster of 1956. In recent decades, however, Charleroi has undergone a massive transformation and is increasingly developing into a hub for technology and aviation. Furthermore, Charleroi is recognized as a major center of European comic culture, closely associated with the traditional publishing house Dupuis, which produced legendary characters such as Spirou, Lucky Luke, and the Smurfs."
    },
    factsAdvanced: {
      de: ["Largest city in the Walloon Region by both area and population", "Bois du Cazier mining site saw a tragic disaster in 1956 claiming 262 lives", "Brussels South Charleroi Airport is the second busiest airport in Belgium", "Hub of the Dupuis comic publishing house since 1922", "Often referred to as the 'Capital of the Black Country' due to coal mining", "Hosts the Museum of Photography, one of the largest in Europe", "Currently undergoing a major urban renewal project called 'Charleroi District Center'"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-charleroi-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Mechelen ist eine historisch überaus bedeutende flämische Stadt, die strategisch günstig am Fluss Dijle zwischen Antwerpen und Brüssel liegt. Im frühen 16. Jahrhundert erlebte die Stadt ihre größte Blütezeit, als sie unter Margarete von Österreich zur Hauptstadt der habsburgischen Niederlande ernannt wurde, was ihr eine Fülle prachtvoller Renaissance-Gebäude und Paläste bescherte. Überragt wird die Stadt von der monumentalen St.-Rombouts-Kathedrale mit ihrem gewaltigen, unvollendeten Turm, der zum UNESCO-Welterbe gehört. Mechelen ist international vor allem für seine jahrhundertealte Tradition des Glockenspiels (Carillon) berühmt und beherbergt die älteste und größte Glockenspielschule der Welt. Darüber hinaus zieht die Stadt mit ihren malerischen Beginenhöfen, der traditionsreichen Wandteppichweberei De Wit und einer angenehm ruhigen, historischen Altstadt viele Kulturinteressierte an.",
      hu: "Mechelen történelmileg kiemelkedően fontos flandriai város, amely stratégiailag kedvező helyen, a Dijle folyó mentén, Antwerpen és Brüsszel között fekszik. A város a 16. század elején élte fénykorát, amikor Ausztriai Margit uralkodása alatt a Habsburg Németalföld fővárosává nevezték ki, aminek köszönhetően pompás reneszánsz épületekkel és palotákkal gazdagodott. A város fölé magasodik a monumentális Szent Rumbold-székesegyház hatalmas, befejezetlen tornyával, amely az UNESCO Világörökség része. Mechelen nemzetközileg elsősorban a harangjáték (carillon) évszázados hagyományáról híres, és itt található a világ legrégebbi és legnagyobb harangjáték-iskolája. Emellett a város festői beginaudvaraival, a nagy múltú De Wit faliszőnyeg-szövő műhellyel és kellemesen nyugodt, történelmi óvárosával sok kultúra iránt érdeklődőt vonz.",
      ro: "Mechelen este un oraș flamand cu o semnificație istorică majoră, situat strategic pe râul Dijle, între Anvers și Bruxelles. La începutul secolului al XVI-lea, orașul a cunoscut perioada sa de maximă înflorire când, sub conducerea Margaretei de Austria, a fost desemnat capitala Țărilor de Jos Habsburgice, ceea ce l-a înzestrat cu o multitudine de clădiri și palate renascentiste splendide. Orașul este dominat de monumentala Catedrală Sfântul Rumbold, cu turnul său masiv, neterminat, care face parte din Patrimoniul Mondial UNESCO. Mechelen este faimos la nivel internațional mai ales pentru tradiția sa seculară a carillonului (joc de clopote) și găzduiește cea mai veche și mai mare școală de carillon din lume. În plus, orașul atrage mulți entuziaști ai culturii cu curțile sale pitorești Beguinage, manufactura tradițională de tapiserii De Wit și un centru istoric plăcut și liniștit.",
      en: "Mechelen is a historically significant Flemish city strategically located on the Dijle River between Antwerp and Brussels. In the early 16th century, the city experienced its golden age when, under Margaret of Austria, it was designated the capital of the Habsburg Netherlands, gracing it with a wealth of magnificent Renaissance buildings and palaces. The city is dominated by the monumental St. Rumbold's Cathedral with its massive, unfinished tower, which is recognized as a UNESCO World Heritage site. Mechelen is internationally famous primarily for its centuries-old carillon tradition and is home to the oldest and largest carillon school in the world. Furthermore, the city attracts many cultural enthusiasts with its picturesque Beguinages, the historic De Wit tapestry weaving mill, and a pleasantly quiet, historic old town."
    },
    factsAdvanced: {
      de: ["Served as the capital of the Habsburg Netherlands under Margaret of Austria in the early 16th century", "St. Rumbold's Cathedral features an unfinished tower standing 97 meters tall", "Home to the Royal Carillon School 'Jef Denyn', founded in 1922", "The city center contains over 300 protected historical monuments", "Historically famous for Mechelen lace and wood carving", "De Wit Royal Manufacturers restores tapestries for museums worldwide", "The Kazerne Dossin transit camp museum memorializes WWII deportation"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-mechelen-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Aalst ist eine charmante flämische Stadt an den Ufern der Dender, die vor allem für ihren überaus lebendigen und satirischen Karneval bekannt ist, der zum immateriellen Weltkulturerbe der UNESCO zählt. Jedes Jahr vor der Fastenzeit verwandelt sich die Stadt in ein farbenfrohes Spektakel, bei dem humorvolle und oft scharfzüngige Festwagen durch die Straßen ziehen. Historisch war Aalst ein überregional bedeutendes Zentrum des Hopfenanbaus und -handels, weshalb noch heute Hopfendolden das Stadtwappen schmücken. Das historische Herz der Stadt bildet der Grote Markt, an dem sich das älteste erhaltene Schöffenhaus Belgiens aus dem 13. Jahrhundert befindet, gekrönt von einem beeindruckenden Belfried. In der benachbarten spätgotischen St.-Martin-Kirche können Besucher nicht nur herrliche Architektur, sondern auch ein authentisches Gemälde des Meisters Peter Paul Rubens bewundern, das den Heiligen Rochus darstellt.",
      hu: "Aalst egy bájos flandriai város a Dender folyó partján, amely elsősorban rendkívül élénk és szatirikus karneváljáról ismert, ami az UNESCO szellemi világörökségének része. A város minden évben, a nagyböjtöt megelőzően színes látványossággá változik, amikor humoros és gyakran csípős nyelvű karneváli kocsik vonulnak végig az utcákon. Történelmileg Aalst a komlótermesztés és -kereskedelem kiemelkedő központja volt, ezért a város címerét ma is komlótobozok díszítik. A város történelmi szívét a Grote Markt (Főtér) alkotja, ahol Belgium legrégebbi fennmaradt, 13. századi városháza található, egy lenyűgöző harangtoronnyal (Belfry) megkoronázva. A szomszédos, késő gótikus Szent Márton-templomban a látogatók nemcsak a csodálatos építészetet csodálhatják meg, hanem a mester, Peter Paul Rubens egy eredeti, Szent Rókust ábrázoló festményét is.",
      ro: "Aalst este un oraș flamand fermecător pe malurile râului Dender, renumit în primul rând pentru carnavalul său extrem de plin de viață și satiric, care este inclus în patrimoniul cultural imaterial mondial UNESCO. În fiecare an, înainte de Postul Mare, orașul se transformă într-un spectacol colorat, cu care alegorice umoristice și adesea tăioase care defilează pe străzi. Istoric vorbind, Aalst a fost un centru important la nivel național pentru cultivarea și comerțul cu hamei, motiv pentru care conurile de hamei încă împodobesc stema orașului. Inima istorică a orașului este Grote Markt, unde se află cea mai veche clădire din Belgia destinată consilierilor locali, datând din secolul al XIII-lea, încoronată de un turn Belfry impresionant. În învecinata biserică gotică târzie Sfântul Martin, vizitatorii pot admira nu doar arhitectura superbă, ci și o pictură autentică a maestrului Peter Paul Rubens, reprezentându-l pe Sfântul Rochus.",
      en: "Aalst is a charming Flemish city on the banks of the Dender River, renowned primarily for its highly vibrant and satirical carnival, which is recognized as an intangible cultural heritage of humanity by UNESCO. Every year before Lent, the city transforms into a colorful spectacle as humorous and often sharp-witted floats parade through the streets. Historically, Aalst was a nationally significant center for hop cultivation and trade, which is why hop cones still adorn the city's coat of arms today. The historic heart of the city is the Grote Markt, home to the oldest surviving alderman's house in Belgium, dating back to the 13th century and crowned by an impressive belfry. In the adjacent late Gothic St. Martin's Church, visitors can admire not only splendid architecture but also an authentic painting by the master Peter Paul Rubens depicting Saint Roch."
    },
    factsAdvanced: {
      de: ["The Aalst Carnival was recognized by UNESCO in 2010 for its unique satirical nature", "The alderman's house dates back to 1225, making it Belgium's oldest", "Historically known as the capital of the Flemish hop-growing region", "St. Martin's Church houses a 17th-century masterpiece by Peter Paul Rubens", "Aalst was captured by the French army in 1667 during the War of Devolution", "Dirk Martens, who established the first printing press in the Southern Netherlands, was from Aalst", "The belfry on the Grote Markt houses a carillon with 52 bells"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-aalst-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "La Louvière ist eine bedeutende Industriestadt in der wallonischen Provinz Hennegau, die im Herzen der früheren Kohlebergbauregion \"Centre\" liegt. Die Stadt erlebte im 19. Jahrhundert dank des Bergbaus und der Schwerindustrie ein rasantes Wachstum. Obwohl die Zechen längst geschlossen sind, ist das industrielle Erbe allgegenwärtig und prägt die Identität der Stadt. Weltberühmt ist La Louvière für seine vier historischen hydraulischen Schiffshebewerke am Canal du Centre, die Ende des 19. Jahrhunderts erbaut wurden und heute als Meisterwerke der Ingenieurskunst zum UNESCO-Welterbe zählen. Neben der Industrie hat die Stadt auch eine reiche kulturelle Tradition, insbesondere in der Keramikherstellung (Boch) und im Surrealismus. Das lebendige Folklorefest, der Karneval von La Louvière mit seinen traditionellen \"Gilles\", zeugt von der starken lokalen Gemeinschaft.",
      hu: "La Louvière jelentős iparváros a vallóniai Hainaut tartományban, amely a korábbi \"Centre\" szénbányászati régió szívében fekszik. A város a 19. században a bányászatnak és a nehéziparnak köszönhetően gyors növekedésnek indult. Bár a bányákat már régen bezárták, az ipari örökség mindenütt jelen van, és meghatározza a város identitását. La Louvière világhírű a Canal du Centre (Középső-csatorna) négy történelmi hidraulikus hajóemelőjéről, amelyek a 19. század végén épültek, és ma a mérnöki tudomány mesterműveiként az UNESCO Világörökség részét képezik. Az ipar mellett a város gazdag kulturális hagyományokkal is rendelkezik, különösen a kerámiagyártás (Boch) és a szürrealizmus terén. Az élénk folklórfesztivál, a La Louvière-i karnevál hagyományos \"Gilles\" figuráival az erős helyi közösség bizonyítéka.",
      ro: "La Louvière este un important oraș industrial din provincia valonă Hainaut, situat în inima fostei regiuni miniere de cărbune „Centre”. Orașul a cunoscut o creștere rapidă în secolul al XIX-lea datorită mineritului și industriei grele. Deși minele au fost închise de mult, moștenirea industrială este omniprezentă și modelează identitatea orașului. La Louvière este renumit în întreaga lume pentru cele patru elevatoare hidraulice istorice pentru ambarcațiuni de pe Canal du Centre, construite la sfârșitul secolului al XIX-lea, care sunt acum recunoscute ca capodopere inginerești și incluse în Patrimoniul Mondial UNESCO. Pe lângă industrie, orașul are și o bogată tradiție culturală, în special în producția de ceramică (Boch) și suprarealism. Festivalul folcloric plin de viață, Carnavalul din La Louvière cu tradiționalii săi „Gilles”, este o dovadă a comunității locale puternice.",
      en: "La Louvière is a major industrial city in the Walloon province of Hainaut, situated in the heart of the former \"Centre\" coal mining region. The city experienced rapid growth in the 19th century thanks to mining and heavy industry. Although the collieries have long since closed, the industrial heritage is omnipresent and shapes the city's identity. La Louvière is world-famous for its four historic hydraulic boat lifts on the Canal du Centre, built at the end of the 19th century and now recognized as engineering masterpieces and a UNESCO World Heritage site. In addition to industry, the city also has a rich cultural tradition, particularly in ceramics production (Boch) and surrealism. The lively folklore festival, the Carnival of La Louvière with its traditional \"Gilles\", is a testament to the strong local community."
    },
    factsAdvanced: {
      de: ["Features four historic hydraulic boat lifts from the late 19th century", "The boat lifts on the Canal du Centre are a UNESCO World Heritage site", "Historically a major hub for coal mining and heavy steel industry", "Birthplace of Maurice Grevisse, author of 'Le Bon Usage'", "Home to the Royal Boch faience factory, a key ceramics producer", "Carnival of La Louvière is recognized by UNESCO for its folklore", "Dragone, a world-renowned entertainment production company, is based here"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-la-louviere-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Kortrijk ist eine charmante und geschichtsträchtige Stadt in der flämischen Provinz Westflandern, malerisch an den Ufern der Leie gelegen. Die Stadt erlangte historische Berühmtheit durch die \"Sporenschlacht\" (Guldensporenslag) am 11. Juli 1302, bei der ein flämisches Fußheer ein französisches Ritterheer besiegte – ein Schlüsselmoment der flämischen Identität, der jährlich gefeiert wird. Jahrhundertelang florierte Kortrijk durch die Leinen- und Textilindustrie, gestützt auf das weiche Wasser der Leie, das ideal zum Flachsrösten war. Die reiche Vergangenheit spiegelt sich im Stadtbild wider: Die mittelalterlichen Broeltürme (Broeltorens) an der Leie sind das Wahrzeichen der Stadt. Ebenso sehenswert ist der außergewöhnlich gut erhaltene Beginenhof, der zum UNESCO-Welterbe gehört. Heute ist Kortrijk eine moderne, designorientierte Universitätsstadt, die Teil des UNESCO Creative Cities Network für Design ist.",
      hu: "Kortrijk egy bájos és nagy múltú város a flandriai Nyugat-Flandria tartományban, festői környezetben, a Leie folyó partján. A város történelmi hírnevét az 1302. július 11-i \"aranysarkantyús csatának\" (Guldensporenslag) köszönheti, amelyben a flamand gyalogos sereg legyőzte a francia lovagokat – ez a flamand identitás egyik kulcspillanata, amelyet minden évben megünnepelnek. Kortrijk évszázadokon át virágzott a len- és textiliparnak köszönhetően, amely a Leie lágy vizére épült, ami ideális volt a len áztatására. A gazdag múlt a városképben is tükröződik: a Leie folyó mentén álló középkori Broel-tornyok a város szimbólumai. Ugyancsak érdemes megnézni a kivételesen jó állapotban fennmaradt, UNESCO világörökségi védelem alatt álló beginaudvart. Ma Kortrijk egy modern, dizájn-orientált egyetemi város, amely az UNESCO Kreatív Városok Hálózatának (Design) is tagja.",
      ro: "Courtrai (Kortrijk) este un oraș fermecător și bogat în istorie din provincia flamandă Flandra de Vest, situat pitoresc pe malurile râului Leie. Orașul a câștigat faimă istorică prin \"Bătălia Pintenilor de Aur\" (Guldensporenslag) din 11 iulie 1302, în care o armată de infanterie flamandă a învins o armată de cavaleri francezi – un moment cheie al identității flamande, sărbătorit anual. Timp de secole, Courtrai a prosperat datorită industriei inului și a textilelor, bazându-se pe apa moale a râului Leie, ideală pentru topirea inului. Trecutul bogat se reflectă în peisajul urban: turnurile medievale Broel de pe râul Leie sunt simbolul orașului. De asemenea, merită vizitată curtea Beguinage, excepțional de bine conservată, care face parte din Patrimoniul Mondial UNESCO. Astăzi, Courtrai este un oraș universitar modern, orientat spre design, care face parte din Rețeaua Orașelor Creative UNESCO pentru design.",
      en: "Kortrijk is a charming and historically rich city in the Flemish province of West Flanders, picturesquely situated on the banks of the Leie River. The city gained historical fame through the \"Battle of the Golden Spurs\" (Guldensporenslag) on July 11, 1302, in which a Flemish infantry army defeated a French knightly army—a key moment in Flemish identity that is celebrated annually. For centuries, Kortrijk flourished due to the linen and textile industry, supported by the soft water of the Leie, which was ideal for retting flax. The rich past is reflected in the cityscape: the medieval Broel Towers on the Leie are the symbol of the city. Also worth seeing is the exceptionally well-preserved Beguinage, which is a UNESCO World Heritage site. Today, Kortrijk is a modern, design-oriented university city that is part of the UNESCO Creative Cities Network for Design."
    },
    factsAdvanced: {
      de: ["Site of the historic Battle of the Golden Spurs in 1302", "Broel Towers are medieval fortifications dating back to 1385 and 1415", "The city's Beguinage is a protected UNESCO World Heritage site", "Grew wealthy through the flax and linen industry in the Middle Ages", "Part of the UNESCO Creative Cities Network for Design", "Located only 9 kilometers from the French border", "Kortrijk Xpo is one of Belgium's largest exhibition and convention centers"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-kortrijk-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Hasselt ist die lebendige Hauptstadt der belgischen Provinz Limburg und präsentiert sich als eine der gemütlichsten und freundlichsten Städte des Landes. Bekannt als die „Hauptstadt des guten Geschmacks“, ist Hasselt ein überregionales Einkaufszentrum mit zahlreichen Boutiquen, Haute-Couture-Geschäften und dem Modemuseum. Historisch gesehen ist die Stadt untrennbar mit der Produktion von Jenever (dem belgischen Wacholderschnaps) verbunden, dessen Geschichte im faszinierenden Nationalen Jenevermuseum hautnah erlebbar wird. Ein weiteres absolutes Highlight ist der Japanische Garten von Hasselt – der größte seiner Art in ganz Europa. Er wurde 1992 in Zusammenarbeit mit der japanischen Partnerstadt Itami angelegt und bietet eine Oase der Ruhe. Mit seiner autofreien Innenstadt, hervorragenden Restaurants und einer modernen Street-Art-Szene verbindet Hasselt gekonnt Tradition mit zeitgenössischem Lifestyle.",
      hu: "Hasselt a belga Limburg tartomány pezsgő fővárosa, amely az ország egyik legbarátságosabb és leghangulatosabb városaként tartják számon. A „jó ízlés fővárosaként” is ismert Hasselt egy régiókon átívelő bevásárlóközpont, számos butikkal, haute couture üzlettel és egy Divatmúzeummal. Történelmileg a város elválaszthatatlanul összekapcsolódik a jenever (a belga borókaszeder-pálinka) gyártásával, amelynek története a lenyűgöző Nemzeti Jenever Múzeumban testközelből is átélhető. Egy másik abszolút fénypont a Hasselti Japánkert – amely egész Európában a legnagyobb a maga nemében. A kertet 1992-ben alakították ki a japán testvérváros, Itami közreműködésével, és a béke igazi oázisát nyújtja. Autómentes belvárosával, kiváló éttermeivel és modern street-art színterével Hasselt mesterien ötvözi a hagyományokat a kortárs életmóddal.",
      ro: "Hasselt este capitala plină de viață a provinciei belgiene Limburg și se prezintă ca unul dintre cele mai primitoare și prietenoase orașe din țară. Cunoscut drept „capitala bunului gust”, Hasselt este un centru comercial supraregional, cu numeroase buticuri, magazine haute couture și Muzeul Modei. Din punct de vedere istoric, orașul este inseparabil legat de producția de Jenever (băutura tradițională belgiană cu aromă de ienupăr), a cărui poveste prinde viață în fascinantul Muzeu Național Jenever. Un alt punct de atracție absolut este Grădina Japoneză din Hasselt – cea mai mare de acest fel din întreaga Europă. A fost creată în 1992 în colaborare cu orașul japonez înfrățit Itami și oferă o oază de liniște. Cu centrul său pietonal, restaurantele excelente și o scenă modernă de artă stradală, Hasselt combină cu măiestrie tradiția cu un stil de viață contemporan.",
      en: "Hasselt is the vibrant capital of the Belgian province of Limburg and presents itself as one of the coziest and friendliest cities in the country. Known as the \"capital of good taste,\" Hasselt is a supra-regional shopping destination featuring numerous boutiques, haute couture shops, and the Fashion Museum. Historically, the city is inextricably linked to the production of Jenever (the traditional Belgian juniper-flavored liquor), the history of which can be experienced up close in the fascinating National Jenever Museum. Another absolute highlight is the Japanese Garden of Hasselt—the largest of its kind in all of Europe. It was created in 1992 in collaboration with the Japanese sister city of Itami and offers a true oasis of peace. With its car-free city center, excellent restaurants, and modern street art scene, Hasselt skillfully combines tradition with a contemporary lifestyle."
    },
    factsAdvanced: {
      de: ["Features the largest authentic Japanese Garden in Europe, spanning 2.5 hectares", "Known as the capital of Jenever (Belgian gin) with a dedicated National Museum", "Capital and largest city of the Belgian province of Limburg", "Recognized regionally as a major high-end fashion and shopping destination", "Pukkelpop, a major annual European music festival, takes place in nearby Kiewit", "Features a massive, highly successful car-free zone implemented in the city center", "Hasselt University is a young, innovative institution driving regional research"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-hasselt-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Sint-Niklaas ist eine charmante flämische Stadt im Herzen der Waasland-Region, strategisch günstig zwischen den Metropolen Antwerpen und Gent gelegen. Die Stadt ist vor allem berühmt für ihren Grote Markt, der mit einer Fläche von 3,2 Hektar der größte Marktplatz in ganz Belgien ist und das historische, soziale und kommerzielle Zentrum der Stadt bildet. Jeden Donnerstagmorgen findet hier einer der lebhaftesten und traditionsreichsten Märkte der Region statt. Ein jährliches Highlight auf diesem Platz ist das „Vredefeesten“, ein internationales Heißluftballon-Festival, das Zuschauer aus dem In- und Ausland anzieht. Sint-Niklaas ist auch für sein reiches kulturelles Erbe bekannt, darunter das Mercatormuseum, das dem berühmten Kartographen Gerardus Mercator gewidmet ist, der in der Nähe geboren wurde. Zudem beeindruckt das neoklassizistische Rathaus am Rande des Marktplatzes.",
      hu: "Sint-Niklaas egy bájos flandriai város a Waasland régió szívében, stratégiailag kedvező helyen, Antwerpen és Gent metropoliszai között. A város elsősorban a Grote Marktról (Főtér) híres, amely 3,2 hektáros területével egész Belgium legnagyobb piaca, és a város történelmi, társadalmi, valamint kereskedelmi központját alkotja. Itt tartják minden csütörtök reggel a régió egyik legélettelibb és leghagyományosabb piacát. A tér egyik éves fénypontja a „Vredefeesten”, egy nemzetközi hőlégballon-fesztivál, amely belföldről és külföldről egyaránt vonzza a nézőket. Sint-Niklaas gazdag kulturális örökségéről is ismert, ide tartozik a Mercator Múzeum, amelyet a közelben született híres térképésznek, Gerardus Mercatornak szenteltek. Ezenkívül a piactér szélén álló neoklasszicista városháza is lenyűgözi a látogatókat.",
      ro: "Sint-Niklaas este un oraș flamand fermecător din inima regiunii Waasland, situat strategic între metropolele Anvers și Gent. Orașul este renumit în primul rând pentru Grote Markt, care, cu o suprafață de 3,2 hectare, este cea mai mare piață din întreaga Belgie și formează centrul istoric, social și comercial al orașului. În fiecare joi dimineața, aici are loc una dintre cele mai pline de viață și tradiționale piețe din regiune. Un punct de atracție anual în această piață este „Vredefeesten”, un festival internațional de baloane cu aer cald care atrage spectatori din țară și din străinătate. Sint-Niklaas este cunoscut și pentru moștenirea sa culturală bogată, inclusiv Muzeul Mercator, dedicat celebrului cartograf Gerardus Mercator, care s-a născut în apropiere. În plus, primăria neoclasică de la marginea pieței este o prezență impresionantă.",
      en: "Sint-Niklaas is a charming Flemish city in the heart of the Waasland region, strategically located between the metropolises of Antwerp and Ghent. The city is primarily famous for its Grote Markt, which, with an area of 3.2 hectares, is the largest market square in all of Belgium and forms the historical, social, and commercial center of the town. Every Thursday morning, it hosts one of the liveliest and most traditional markets in the region. An annual highlight on this square is the \"Vredefeesten,\" an international hot air balloon festival that attracts spectators from home and abroad. Sint-Niklaas is also known for its rich cultural heritage, including the Mercator Museum, dedicated to the famous cartographer Gerardus Mercator, who was born nearby. Furthermore, the neoclassical town hall on the edge of the market square is an impressive architectural sight."
    },
    factsAdvanced: {
      de: ["The Grote Markt is the largest market square in Belgium at 3.2 hectares", "Capital city of the historical Waasland region in East Flanders", "Hosts the Vredefeesten, a major international hot air balloon festival", "Mercator Museum is dedicated to Gerardus Mercator, born in neighboring Rupelmonde", "Home to the largest St. Nicholas (Sinterklaas) statue in the country", "During the 19th century, it was a significant center for the textile and knitting industry", "The city hall was built in 1878 in a striking neo-Gothic and neo-Renaissance style"],
      hu: [],
      ro: [],
      en: []
    }, image: "/poi-images/belgium-sint-niklaas-cities-v2.webp"},
...
imageHint: "Eupen town hall and Vesdre dam",
    ...
    image: "/poi-images/belgium-herstal-cities-v2.webp",
    descriptionAdvanced: {
      de: "Herstal liegt an der Maas in der Provinz Lüttich. Die Stadt ist weltweit durch die historische Rüstungsindustrie und die Herstal Group bekannt geworden.",
      hu: "Herstal a Meuse folyó partján, Liège tartományban található. A település elsősorban történelmi fegyvergyártó iparáról és a Herstal Groupról híres.",
      ro: "Herstal este situat pe malul râului Meuse, în provincia Liège. Orașul este cunoscut la nivel mondial pentru industria istorică de armament.",
      en: "Herstal is situated on the Meuse River in the province of Liège. The city is globally recognized for its deep roots in the arms manufacturing industry.",
    },
    factsAdvanced: {
      de: ["Bevölkerung: ca. 40.000", "Industrie: Metallverarbeitung", "Provinz: Lüttich", "Lage: Maas-Tal"],
      hu: ["Népesség: kb. 40 000", "Ipar: fémfeldolgozás", "Tartomány: Liège", "Fekvés: Meuse-völgy"],
      ro: ["Populație: aprox. 40.000", "Industrie: prelucrarea metalelor", "Provincie: Liège", "Amplasare: Valea Meuse"],
      en: ["Population: approx. 40,000", "Industry: metal processing", "Province: Liège", "Location: Meuse valley"],
    },
  },
  {
...
,
  {
    id: "belgium-aarschot-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Aarschot", hu: "Aarschot", ro: "Aarschot", en: "Aarschot" },
    coordinates: { lat: 50.9833, lng: 4.8333 },
    description: {
      de: "Aarschot ist eine Stadt in der Provinz Flämisch-Brabant. Sie liegt am Ufer des Flusses Demer.",
      hu: "Aarschot város a belgiumi Flamand-Brabant tartományban. A Demer folyó partján fekszik.",
      ro: "Aarschot este un oraș în provincia Brabantul Flamand din Belgia. Acesta este situat pe malul râului Demer.",
      en: "Aarschot is a city in the Belgian province of Flemish Brabant. It is located on the banks of the Demer River.",
    },
    facts: {
      de: ["Gehört zur Provinz Flämisch-Brabant", "Am Fluss Demer gelegen", "Historischer Kern vorhanden", "Wichtiger Verkehrsknotenpunkt"],
      hu: ["Flamand-Brabant tartományhoz tartozik", "A Demer folyónál található", "Történelmi központtal rendelkezik", "Fontos közlekedési csomópont"],
      ro: ["Face parte din provincia Brabantul Flamand", "Situat pe râul Demer", "Centru istoric prezent", "Important nod rutier"],
      en: ["Located in Flemish Brabant province", "Situated on the Demer river", "Features a historic center", "Key transport node"],
    },
    imageHint: "Aarschot church tower view",
    descriptionAdvanced: {
      de: "Aarschot ist eine Stadt in der Provinz Flämisch-Brabant am Fluss Demer. Bekannt ist sie für ihre gotische Liebfrauenkirche aus lokalem braunem Eisenstein.",
      hu: "Aarschot Flamand-Brabant tartományban, a Demer folyó mentén fekszik. Városa a helyi barna vasércből épült gótikus Miasszonyunk-templomról nevezetes.",
      ro: "Aarschot este un oraș în provincia Brabantul Flamand, pe râul Demer. Este renumit pentru biserica gotică construită din piatră de fier locală.",
      en: "Aarschot is located in the province of Flemish Brabant on the Demer River. It is famous for its Gothic Church of Our Lady made of local ironstone.",
    },
    factsAdvanced: {
      de: ["Fluss: Demer", "Wahrzeichen: Liebfrauenkirche", "Provinz: Flämisch-Brabant", "Architektur: Eisenstein-Gotik"],
      hu: ["Folyó: Demer", "Nevezetesség: Miasszonyunk-templom", "Tartomány: Flamand-Brabant", "Építészet: vasérc gótika"],
      ro: ["Râu: Demer", "Obiectiv: Biserica Maicii Domnului", "Provincie: Brabantul Flamand", "Arhitectură: gotic din piatră"],
      en: ["River: Demer", "Landmark: Church of Our Lady", "Province: Flemish Brabant", "Architecture: ironstone Gothic"],
    },
  },
  {
    id: "belgium-andenne-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Andenne", hu: "Andenne", ro: "Andenne", en: "Andenne" },
    coordinates: { lat: 50.4908, lng: 5.0967 },
    description: {
      de: "Andenne liegt in der wallonischen Provinz Namur an der Maas. Die Stadt ist bekannt für ihre historische Keramikindustrie.",
      hu: "Andenne a vallon Namur tartományban, a Meuse folyó mentén fekszik. Város a kerámiaiparáról ismert.",
      ro: "Andenne este situat în provincia valonă Namur, pe râul Meuse. Orașul este cunoscut pentru industria sa istorică de ceramică.",
      en: "Andenne is located in the Walloon province of Namur along the Meuse River. The city is known for its historic ceramics industry.",
    },
    facts: {
      de: ["In der Provinz Namur gelegen", "Direkt an der Maas", "Historische Keramiktradition", "Regionales Verwaltungszentrum"],
      hu: ["Namur tartományban fekszik", "Közvetlenül a Meuse folyónál", "Történelmi kerámiahagyományok", "Regionális adminisztrációs központ"],
      ro: ["Situat în provincia Namur", "Direct pe râul Meuse", "Tradiție istorică în ceramică", "Centru administrativ regional"],
      en: ["Located in Namur province", "On the Meuse River", "Historic ceramics tradition", "Regional administrative center"],
    },
    imageHint: "Andenne Meuse river landscape",
    descriptionAdvanced: {
      de: "Andenne liegt an der Maas in der Provinz Namur. Die Stadt ist berühmt für ihre archäologischen Funde aus der Altsteinzeit und die Produktion von Keramik.",
      hu: "Andenne Namur tartományban, a Meuse folyó mentén fekszik. A város régészeti leleteiről az őskőkorszakból és kerámiaiparáról vált híressé.",
      ro: "Andenne este situat pe râul Meuse în provincia Namur. Orașul este celebru pentru descoperirile arheologice din paleolitic și industria ceramicii.",
      en: "Andenne is located on the Meuse River in the Namur province. The city is famous for its archaeological finds from the Paleolithic era and ceramic production.",
    },
    factsAdvanced: {
      de: ["Region: Namur", "Fundort: Scladina-Höhle", "Hauptindustrie: Keramik", "Fluss: Maas"],
      hu: ["Régió: Namur", "Lelőhely: Scladina-barlang", "Főipar: kerámia", "Folyó: Meuse"],
      ro: ["Regiune: Namur", "Locație: Peștera Scladina", "Industrie principală: ceramică", "Râu: Meuse"],
      en: ["Region: Namur", "Site: Scladina Cave", "Main industry: ceramics", "River: Meuse"],
    },
  },
  {
    ...
    coordinates: { lat: 50.6253, lng: 3.7742 },
    description: {
      de: "Ath ist eine Stadt in der Provinz Hennegau in der Wallonie. Sie liegt am Zusammenfluss der Dender-Quellflüsse.",
      hu: "Ath város a belgiumi Hainaut tartományban, Vallóniában található. A Dender folyó forráságainak összefolyásánál fekszik.",
      ro: "Ath este un oraș în provincia Hainaut din regiunea Valonia. Acesta este situat la confluența râurilor care formează Dender.",
      en: "Ath is a city in the province of Hainaut in Wallonia. It is situated at the confluence of the rivers that form the Dender.",
    },
    facts: {
      de: ["In der Provinz Hennegau", "An den Flüssen Dender", "Bekannt für das Riesen-Festival", "Historische Festungsstadt"],
      hu: ["Hainaut tartományban", "A Dender folyónál", "Óriások fesztiválja", "Történelmi erődváros"],
      ro: ["În provincia Hainaut", "Pe râurile Dender", "Cunoscut pentru festivalul uriașilor", "Oraș fortificat istoric"],
      en: ["In Hainaut province", "On the Dender rivers", "Known for giants festival", "Historic fortified town"],
    },
    imageHint: "Ath city square street view",
    descriptionAdvanced: {
      de: "Ath liegt in der Provinz Hennegau. Die Stadt ist weltweit für ihre traditionelle 'Ducasse d'Ath'-Prozession bekannt, die zum UNESCO-Erbe gehört.",
      hu: "Ath a Hainaut tartományban található. A város világszerte a 'Ducasse d'Ath' hagyományos felvonulásáról ismert, amely az UNESCO örökség része.",
      ro: "Ath este situat în provincia Hainaut. Orașul este cunoscut la nivel mondial pentru procesiunea tradițională 'Ducasse d'Ath', parte a patrimoniului UNESCO.",
      en: "Ath is located in the province of Hainaut. The city is globally known for its traditional 'Ducasse d'Ath' procession, recognized as UNESCO heritage.",
    },
    factsAdvanced: {
      de: ["UNESCO-Erbe: Ducasse d'Ath", "Provinz: Hennegau", "Gründung: 12. Jahrhundert", "Fluss: Dender"],
      hu: ["UNESCO-örökség: Ducasse d'Ath", "Tartomány: Hainaut", "Alapítás: 12. század", "Folyó: Dender"],
      ro: ["Patrimoniu UNESCO: Ducasse d'Ath", "Provincie: Hainaut", "Fondare: secolul XII", "Râu: Dender"],
      en: ["UNESCO heritage: Ducasse d'Ath", "Province: Hainaut", "Founded: 12th century", "River: Dender"],
    },
  },
  {
    id: "belgium-beveren-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Beveren", hu: "Beveren", ro: "Beveren", en: "Beveren" },
    coordinates: { lat: 51.2167, lng: 4.25 },
    description: {
      de: "Beveren ist eine Gemeinde in der Provinz Ostflandern. Sie liegt nordwestlich von Antwerpen nahe der niederländischen Grenze.",
      hu: "Beveren település Kelet-Flandria tartományban található. Antwerpentől északnyugatra, a holland határ közelében fekszik.",
      ro: "Beveren este o comună în provincia Flandra de Est. Este situată la nord-vest de Anvers, aproape de granița cu Țările de Jos.",
      en: "Beveren is a municipality in the province of East Flanders. It is located northwest of Antwerp near the Dutch border.",
    },
    facts: {
      de: ["Provinz Ostflandern", "Nahe niederländischer Grenze", "Industriell geprägt", "Verwaltungssitz"],
      hu: ["Kelet-Flandria tartomány", "Holland határ közelében", "Ipari jellegű", "Adminisztrációs központ"],
      ro: ["Provincia Flandra de Est", "Aproape de granița olandeză", "Caracter industrial", "Sediul administrativ"],
      en: ["East Flanders province", "Near Dutch border", "Industrial character", "Administrative center"],
    },
    imageHint: "Beveren town hall building",
    descriptionAdvanced: {
      de: "Beveren liegt in Ostflandern bei Antwerpen. Die Stadt beherbergt einen bedeutenden Teil des Hafens von Antwerpen und ist ein wichtiges logistisches Zentrum.",
      hu: "Beveren Kelet-Flandriában, Antwerpen közelében található. A város az antwerpeni kikötő jelentős részének ad otthont és fontos logisztikai központ.",
      ro: "Beveren este situat în Flandra de Est, lângă Anvers. Orașul găzduiește o parte semnificativă a portului Anvers și este un centru logistic major.",
      en: "Beveren is located in East Flanders near Antwerp. The city houses a significant part of the Port of Antwerp and serves as a vital logistics hub.",
    },
    factsAdvanced: {
      de: ["Provinz: Ostflandern", "Logistik: Hafengebiet Antwerpen", "Status: Großgemeinde", "Lage: Schelde-Region"],
      hu: ["Tartomány: Kelet-Flandria", "Logisztika: Antwerpeni kikötő", "Státusz: nagyváros", "Fekvés: Schelde-régió"],
      ro: ["Provincie: Flandra de Est", "Logistică: zona portuară Anvers", "Statut: municipiu", "Amplasare: Regiunea Schelde"],
      en: ["Province: East Flanders", "Logistics: Antwerp port area", "Status: municipality", "Location: Schelde region"],
    },
  },
  {
    id: "belgium-boussu-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Boussu", hu: "Boussu", ro: "Boussu", en: "Boussu" },
    coordinates: { lat: 50.4489, lng: 3.7972 },
    description: {
      de: "Boussu ist eine Gemeinde in der Provinz Hennegau. Sie liegt westlich von Mons im ehemaligen Kohlerevier.",
      hu: "Boussu település Hainaut tartományban található. Mons-tól nyugatra, az egykori szénbányászati területen fekszik.",
      ro: "Boussu este o comună în provincia Hainaut. Este situată la vest de Mons, în fosta regiune minieră de cărbune.",
      en: "Boussu is a municipality in the province of Hainaut. It is located west of Mons in the former coal mining region.",
    },
    facts: {
      de: ["In der Provinz Hennegau", "Westlich von Mons", "Ehemaliges Bergbaugebiet", "Regionale Geschichte"],
      hu: ["Hainaut tartományban", "Mons-tól nyugatra", "Egykori bányászvidék", "Regionális történelem"],
      ro: ["În provincia Hainaut", "La vest de Mons", "Fostă zonă minieră", "Istorie regională"],
      en: ["In Hainaut province", "West of Mons", "Former mining area", "Regional history"],
    },
    imageHint: "Boussu old industrial building",
    descriptionAdvanced: {
      de: "Boussu liegt in der Provinz Hennegau nahe der französischen Grenze. Die Stadt hat eine reiche Geschichte im Bergbau und industriellen Erbe.",
      hu: "Boussu a Hainaut tartományban, a francia határ közelében fekszik. A város gazdag történelemmel rendelkezik a bányászat és az ipari örökség terén.",
      ro: "Boussu este situat în provincia Hainaut, lângă granița cu Franța. Orașul are o istorie bogată în minerit și patrimoniu industrial.",
      en: "Boussu is located in the Hainaut province near the French border. The city has a rich history in coal mining and industrial heritage.",
    },
    factsAdvanced: {
      de: ["Region: Borinage", "Provinz: Hennegau", "Industrie: Früherer Bergbau", "Sprache: Französisch"],
      hu: ["Régió: Borinage", "Tartomány: Hainaut", "Ipar: egykori bányászat", "Nyelv: francia"],
      ro: ["Regiune: Borinage", "Provincie: Hainaut", "Industrie: minerit istoric", "Limbă: franceză"],
      en: ["Region: Borinage", "Province: Hainaut", "Industry: former mining", "Language: French"],
    },
  },
  {
    id: "belgium-brakel-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Brakel", hu: "Brakel", ro: "Brakel", en: "Brakel" },
    coordinates: { lat: 50.8333, lng: 3.7667 },
    description: {
      de: "Brakel ist eine Gemeinde in der Provinz Ostflandern. Die Region ist Teil der hügeligen flämischen Ardennen.",
      hu: "Brakel település Kelet-Flandria tartományban található. A régió a dombos Flamand-Ardennek része.",
      ro: "Brakel este o comună în provincia Flandra de Est. Regiunea face parte din dealurile Ardenilor flamanzi.",
      en: "Brakel is a municipality in the province of East Flanders. The region is part of the hilly Flemish Ardennes.",
    },
    facts: {
      de: ["Provinz Ostflandern", "Flämische Ardennen", "Ländlich geprägt", "Hügelige Landschaft"],
      hu: ["Kelet-Flandria tartomány", "Flamand-Ardennek", "Vidéki jelleg", "Dombvidéki táj"],
      ro: ["Provincia Flandra de Est", "Ardenii flamanzi", "Caracter rural", "Peisaj deluros"],
      en: ["East Flanders province", "Flemish Ardennes", "Rural character", "Hilly landscape"],
    },
    imageHint: "Brakel landscape Flemish Ardennes",
    descriptionAdvanced: {
      de: "Brakel liegt in den flämischen Ardennen in der Provinz Ostflandern. Die hügelige Landschaft ist bei Radsportlern für ihre steilen Anstiege sehr geschätzt.",
      hu: "Brakel a flamand Ardennekben, Kelet-Flandria tartományban fekszik. A dombos tájat a kerékpárosok nagyra értékelik a meredek emelkedői miatt.",
      ro: "Brakel este situat în Ardenii flamanzi, în provincia Flandra de Est. Peisajul deluros este foarte apreciat de bicicliști pentru urcările abrupte.",
      en: "Brakel is located in the Flemish Ardennes in East Flanders. The hilly landscape is highly appreciated by cyclists for its steep climbs.",
    },
    factsAdvanced: {
      de: ["Landschaft: Flämische Ardennen", "Provinz: Ostflandern", "Sport: Radsportzentrum", "Relief: hügelig"],
      hu: ["Táj: Flamand Ardennek", "Tartomány: Kelet-Flandria", "Sport: kerékpáros központ", "Domborzat: dombos"],
      ro: ["Peisaj: Ardenii flamanzi", "Provincie: Flandra de Est", "Sport: centru de ciclism", "Relief: deluros"],
      en: ["Landscape: Flemish Ardennes", "Province: East Flanders", "Sport: cycling hub", "Relief: hilly"],
    },
  },
  {
    id: "belgium-ciney-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Ciney", hu: "Ciney", ro: "Ciney", en: "Ciney" },
    coordinates: { lat: 50.2931, lng: 5.1017 },
    description: {
      de: "Ciney ist eine Stadt in der Provinz Namur in der Region Condroz. Sie ist als landwirtschaftliches Zentrum bekannt.",
      hu: "Ciney város Namur tartományban, a Condroz régióban található. Mezőgazdasági központként ismert.",
      ro: "Ciney este un oraș în provincia Namur, situat în regiunea Condroz. Este cunoscut ca un centru agricol.",
      en: "Ciney is a city in the province of Namur in the Condroz region. It is known as an agricultural center.",
    },
    facts: {
      de: ["In der Provinz Namur", "Condroz-Region", "Landwirtschaftszentrum", "Lokaler Wochenmarkt"],
      hu: ["Namur tartományban", "Condroz régió", "Mezőgazdasági központ", "Helyi piac"],
      ro: ["În provincia Namur", "Regiunea Condroz", "Centru agricol", "Piață săptămânală locală"],
      en: ["In Namur province", "Condroz region", "Agricultural center", "Local weekly market"],
    },
    imageHint: "Ciney market square",
    descriptionAdvanced: {
      de: "Ciney liegt in der Provinz Namur und ist als Zentrum des 'Condroz'-Gebiets bekannt. Die Stadt ist vor allem für ihre landwirtschaftlichen Messen berühmt.",
      hu: "Ciney Namur tartományban található, a 'Condroz' régió központja. A város főként mezőgazdasági vásárairól nevezetes.",
      ro: "Ciney este situat în provincia Namur și este cunoscut ca centru al regiunii 'Condroz'. Orașul este celebru pentru târgurile agricole.",
      en: "Ciney is located in the Namur province and is the center of the 'Condroz' region. The city is famous primarily for its agricultural fairs.",
    },
    factsAdvanced: {
      de: ["Region: Condroz", "Provinz: Namur", "Wirtschaft: Landwirtschaft", "Bekanntheit: Messestadt"],
      hu: ["Régió: Condroz", "Tartomány: Namur", "Gazdaság: mezőgazdaság", "Ismertség: vásárváros"],
      ro: ["Regiune: Condroz", "Provincie: Namur", "Economie: agricultură", "Renume: târguri"],
      en: ["Region: Condroz", "Province: Namur", "Economy: agriculture", "Fame: fair city"],
    },
  },
  {
    id: "belgium-courcelles-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Courcelles", hu: "Courcelles", ro: "Courcelles", en: "Courcelles" },
    coordinates: { lat: 50.4578, lng: 4.3739 },
    description: {
      de: "Courcelles liegt in der Provinz Hennegau nahe Charleroi. Die Stadt hat eine lange industrielle Tradition.",
      hu: "Courcelles a belgiumi Hainaut tartományban, Charleroi közelében fekszik. A város hosszú ipari hagyományokkal rendelkezik.",
      ro: "Courcelles este situat în provincia Hainaut, aproape de Charleroi. Orașul are o lungă tradiție industrială.",
      en: "Courcelles is located in the province of Hainaut near Charleroi. The city has a long industrial tradition.",
    },
    facts: {
      de: ["Provinz Hennegau", "Nahe Charleroi", "Industriegeschichte", "Ballungsraum"],
      hu: ["Hainaut tartomány", "Charleroi közelében", "Ipartörténet", "Városi agglomeráció"],
      ro: ["Provincia Hainaut", "Aproape de Charleroi", "Istorie industrială", "Zona urbană"],
      en: ["Hainaut province", "Near Charleroi", "Industrial history", "Urban area"],
    },
    imageHint: "Courcelles town view",
    descriptionAdvanced: {
      de: "Courcelles liegt in der Provinz Hennegau bei Charleroi. Die Stadt ist stark vom ehemaligen Kohlebergbau und der industriellen Entwicklung der Region geprägt.",
      hu: "Courcelles Hainaut tartományban, Charleroi közelében fekszik. A várost erősen meghatározta az egykori szénbányászat és a régió ipari fejlődése.",
      ro: "Courcelles este situat în provincia Hainaut, lângă Charleroi. Orașul este puternic marcat de fostele mine de cărbune și de dezvoltarea industrială.",
      en: "Courcelles is located in the Hainaut province near Charleroi. The city is strongly marked by the former coal mining and the industrial development.",
    },
    factsAdvanced: {
      de: ["Provinz: Hennegau", "Nähe: Charleroi", "Historie: Kohleförderung", "Sprache: Französisch"],
      hu: ["Tartomány: Hainaut", "Közelség: Charleroi", "Történelem: szénbányászat", "Nyelv: francia"],
      ro: ["Provincie: Hainaut", "Proximitate: Charleroi", "Istoric: minerit cărbune", "Limbă: franceză"],
      en: ["Province: Hainaut", "Proximity: Charleroi", "History: coal mining", "Language: French"],
    },
  },
  {
    id: "belgium-deinze-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Deinze", hu: "Deinze", ro: "Deinze", en: "Deinze" },
    coordinates: { lat: 50.9833, lng: 3.5333 },
    description: {
      de: "Deinze liegt in der Provinz Ostflandern am Fluss Leie. Die Stadt ist ein regionales Einkaufs- und Verwaltungszentrum.",
      hu: "Deinze Kelet-Flandria tartományban, a Leie folyó mentén fekszik. A város regionális kereskedelmi és közigazgatási központ.",
      ro: "Deinze este situat în provincia Flandra de Est, pe râul Leie. Orașul este un centru regional de comerț și administrație.",
      en: "Deinze is located in the province of East Flanders on the Leie River. The city is a regional retail and administrative hub.",
    },
    facts: {
      de: ["Provinz Ostflandern", "Am Fluss Leie", "Regionales Zentrum", "Verwaltungssitz"],
      hu: ["Kelet-Flandria tartomány", "A Leie folyónál", "Regionális központ", "Közigazgatási székhely"],
      ro: ["Provincia Flandra de Est", "Pe râul Leie", "Centru regional", "Sediul administrativ"],
      en: ["East Flanders province", "On the Leie River", "Regional hub", "Administrative center"],
    },
    imageHint: "Deinze Leie river bank",
    descriptionAdvanced: {
      de: "Deinze liegt an der Leie in der Provinz Ostflandern. Die Stadt ist für ihre historische Architektur und die Nähe zum Schloss Ooidonk bekannt.",
      hu: "Deinze a Leie folyó mentén, Kelet-Flandria tartományban fekszik. A város történelmi építészetéről és az Ooidonk kastély közelségéről ismert.",
      ro: "Deinze este situat pe râul Leie, în provincia Flandra de Est. Orașul este cunoscut pentru arhitectura sa istorică și proximitatea de castelul Ooidonk.",
      en: "Deinze is located on the Leie River in East Flanders. The city is known for its historic architecture and proximity to the Ooidonk Castle.",
    },
    factsAdvanced: {
      de: ["Fluss: Leie", "Wahrzeichen: Schloss Ooidonk", "Provinz: Ostflandern", "Status: Stadt"],
      hu: ["Folyó: Leie", "Nevezetesség: Ooidonk kastély", "Tartomány: Kelet-Flandria", "Státusz: város"],
      ro: ["Râu: Leie", "Obiectiv: Castelul Ooidonk", "Provincie: Flandra de Est", "Statut: oraș"],
      en: ["River: Leie", "Landmark: Ooidonk Castle", "Province: East Flanders", "Status: city"],
    },
  },
  {
    ...
    coordinates: { lat: 51.0333, lng: 2.8667 },
    description: {
      de: "Diksmuide liegt in der Provinz Westflandern am Fluss Yser. Die Stadt ist historisch durch den Ersten Weltkrieg geprägt.",
      hu: "Diksmuide Nyugat-Flandria tartományban, az Yser folyó mentén található. A várost történelmileg az első világháború határozta meg.",
      ro: "Diksmuide este situat în provincia Flandra de Vest, pe râul Yser. Orașul este marcat istoric de Primul Război Mondial.",
      en: "Diksmuide is located in the province of West Flanders on the Yser River. The city is historically shaped by the First World War.",
    },
    facts: {
      de: ["Provinz Westflandern", "Am Fluss Yser", "Erster Weltkrieg Gedenken", "Historisch bedeutsam"],
      hu: ["Nyugat-Flandria tartomány", "Yser folyó", "I. világháborús emlékek", "Történelmileg jelentős"],
      ro: ["Provincia Flandra de Vest", "Râul Yser", "Comemorarea primului război mondial", "Semnificație istorică"],
      en: ["West Flanders province", "Yser River", "WWI memorial site", "Historically significant"],
    },
    imageHint: "Diksmuide Yser tower view",
    descriptionAdvanced: {
      de: "Diksmuide liegt in Westflandern. Die Stadt ist ein historischer Ort des Ersten Weltkriegs, bekannt durch das Denkmal 'IJzertoren' als Symbol des Friedens.",
      hu: "Diksmuide Nyugat-Flandriában található. Az első világháború történelmi helyszíne, az 'IJzertoren' emlékmű a béke szimbólumaként ismert.",
      ro: "Diksmuide este situat în Flandra de Vest. Orașul este un sit istoric al Primului Război Mondial, cunoscut pentru monumentul 'IJzertoren' ca simbol al păcii.",
      en: "Diksmuide is located in West Flanders. The city is a historic site of World War I, known for the 'IJzertoren' monument as a symbol of peace.",
    },
    factsAdvanced: {
      de: ["Ereignis: Erster Weltkrieg", "Denkmal: IJzertoren", "Provinz: Westflandern", "Landschaft: Polder"],
      hu: ["Esemény: első világháború", "Emlékmű: IJzertoren", "Tartomány: Nyugat-Flandria", "Táj: polderek"],
      ro: ["Eveniment: Primul Război Mondial", "Monument: IJzertoren", "Provincie: Flandra de Vest", "Peisaj: poldere"],
      en: ["Event: World War I", "Monument: IJzertoren", "Province: West Flanders", "Landscape: polders"],
    },
  },
  {
    id: "belgium-dilsen-stokkem-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Dilsen-Stokkem", hu: "Dilsen-Stokkem", ro: "Dilsen-Stokkem", en: "Dilsen-Stokkem" },
    coordinates: { lat: 51.0333, lng: 5.7333 },
    description: {
      de: "Dilsen-Stokkem liegt in der Provinz Limburg in der Maasregion. Es ist bekannt für seine natürliche Umgebung.",
      hu: "Dilsen-Stokkem Limburg tartományban, a Meuse régióban fekszik. Természeti környezetéről ismert.",
      ro: "Dilsen-Stokkem este situat în provincia Limburg, în regiunea Meuse. Este cunoscut pentru mediul său natural.",
      en: "Dilsen-Stokkem is located in the province of Limburg in the Meuse region. It is known for its natural environment.",
    },
    facts: {
      de: ["Provinz Limburg", "Nahe Maas", "Naturschutzgebiete", "Flusslandschaft"],
      hu: ["Limburg tartomány", "Meuse közelében", "Természetvédelmi területek", "Folyóparti táj"],
      ro: ["Provincia Limburg", "Aproape de Meuse", "Rezervații naturale", "Peisaj fluvial"],
      en: ["Limburg province", "Near Meuse", "Nature reserves", "River landscape"],
    },
    imageHint: "Dilsen-Stokkem Maas landscape",
    descriptionAdvanced: {
      de: "Dilsen-Stokkem liegt in der Provinz Limburg an der Maas. Die Stadt zeichnet sich durch die Maas-Auen und eine reiche Naturlandschaft aus.",
      hu: "Dilsen-Stokkem Limburg tartományban, a Meuse mentén fekszik. A várost a Meuse ártéri területei és a gazdag természeti környezet jellemzi.",
      ro: "Dilsen-Stokkem este situat în provincia Limburg, pe râul Meuse. Orașul se remarcă prin luncile Meusei și un peisaj natural bogat.",
      en: "Dilsen-Stokkem is located in the province of Limburg on the Meuse. The city is characterized by the Meuse floodplains and a rich natural landscape.",
    },
    factsAdvanced: {
      de: ["Fluss: Maas", "Provinz: Limburg", "Natur: Maas-Auen", "Status: Stadt"],
      hu: ["Folyó: Meuse", "Tartomány: Limburg", "Természet: Meuse-ártér", "Státusz: város"],
      ro: ["Râu: Meuse", "Provincie: Limburg", "Natură: Lunca Meusei", "Statut: oraș"],
      en: ["River: Meuse", "Province: Limburg", "Nature: Meuse wetlands", "Status: city"],
    },
  },
  {
    id: "belgium-edegem-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Edegem", hu: "Edegem", ro: "Edegem", en: "Edegem" },
    coordinates: { lat: 51.15, lng: 4.45 },
    description: {
      de: "Edegem liegt in der Provinz Antwerpen. Es ist eine Vorstadt von Antwerpen mit Wohngebieten.",
      hu: "Edegem Antwerpen tartományban található. Antwerpen egyik lakóövezeti külvárosa.",
      ro: "Edegem este situat în provincia Anvers. Este o suburbie a Anversului, cu zone rezidențiale.",
      en: "Edegem is located in the province of Antwerp. It is a suburb of Antwerp with residential areas.",
    },
    facts: {
      de: ["Provinz Antwerpen", "Vorort von Antwerpen", "Wohngebiet", "Gute Verkehrslage"],
      hu: ["Antwerpen tartomány", "Antwerpen külvárosa", "Lakóterület", "Jó közlekedés"],
      ro: ["Provincia Anvers", "Suburbie a Anversului", "Zonă rezidențială", "Poziție bună"],
      en: ["Antwerp province", "Antwerp suburb", "Residential area", "Well-connected"],
    },
    imageHint: "Edegem town residential street",
    descriptionAdvanced: {
      de: "Edegem liegt in der Provinz Antwerpen. Die Gemeinde ist als grüne Vorstadt bekannt, mit dem historischen Schloss 'Hof Ter Linden'.",
      hu: "Edegem Antwerpen tartományban található. A település zöld elővárosként ismert, történelmi 'Hof Ter Linden' kastélyával.",
      ro: "Edegem este situat în provincia Anvers. Comuna este cunoscută ca o suburbie verde, cu castelul istoric 'Hof Ter Linden'.",
      en: "Edegem is located in the province of Antwerp. The municipality is known as a green suburb, featuring the historic 'Hof Ter Linden' castle.",
    },
    factsAdvanced: {
      de: ["Region: Antwerpen", "Provinz: Antwerpen", "Wahrzeichen: Hof Ter Linden", "Charakter: Vorstadt"],
      hu: ["Régió: Antwerpen", "Tartomány: Antwerpen", "Nevezetesség: Hof Ter Linden", "Karakter: előváros"],
      ro: ["Regiune: Anvers", "Provincie: Anvers", "Obiectiv: Hof Ter Linden", "Caracter: suburbie"],
      en: ["Region: Antwerp", "Province: Antwerp", "Landmark: Hof Ter Linden", "Character: suburb"],
    },
  },
  {
    ...
    coordinates: { lat: 51.1833, lng: 3.5667 },
    description: {
      de: "Eeklo ist eine Stadt in der Provinz Ostflandern. Sie liegt im Meetjesland, einer Region in Flandern.",
      hu: "Eeklo város Kelet-Flandria tartományban. Flandria egyik régiójában, a Meetjeslandban fekszik.",
      ro: "Eeklo este un oraș în provincia Flandra de Est. Este situat în Meetjesland, o regiune din Flandra.",
      en: "Eeklo is a city in the province of East Flanders. It is located in Meetjesland, a region in Flanders.",
    },
    facts: {
      de: ["Provinz Ostflandern", "Meetjesland Region", "Handelszentrum", "Historischer Kern"],
      hu: ["Kelet-Flandria tartomány", "Meetjesland régió", "Kereskedelmi központ", "Történelmi központ"],
      ro: ["Provincia Flandra de Est", "Regiunea Meetjesland", "Centru comercial", "Centru istoric"],
      en: ["East Flanders province", "Meetjesland region", "Commercial hub", "Historic center"],
    },
    imageHint: "Eeklo main town square",
    descriptionAdvanced: {
      de: "Eeklo liegt im Meetjesland in Ostflandern. Die Stadt ist das kulturelle und administrative Zentrum dieser Region und bekannt für ihre Markttradition.",
      hu: "Eeklo a kelet-flandriai Meetjesland régióban fekszik. A város a régió kulturális és adminisztratív központja, ismert vásári hagyományairól.",
      ro: "Eeklo este situat în Meetjesland, în Flandra de Est. Orașul este centrul cultural și administrativ al acestei regiuni, renumit pentru tradițiile de piață.",
      en: "Eeklo is located in Meetjesland in East Flanders. The city serves as the cultural and administrative center of this region and is known for its market tradition.",
    },
    factsAdvanced: {
      de: ["Region: Meetjesland", "Provinz: Ostflandern", "Status: Verwaltungszentrum", "Tradition: Wochenmarkt"],
      hu: ["Régió: Meetjesland", "Tartomány: Kelet-Flandria", "Státusz: közigazgatási központ", "Hagyomány: heti vásár"],
      ro: ["Regiune: Meetjesland", "Provincie: Flandra de Est", "Statut: centru administrativ", "Tradiție: piață săptămânală"],
      en: ["Region: Meetjesland", "Province: East Flanders", "Status: administrative center", "Tradition: market"],
    },
  },
  {
    ...
    coordinates: { lat: 50.6931, lng: 4.0397 },
    description: {
      de: "Enghien liegt in der Provinz Hennegau. Die Stadt ist für ihren großen Park und historische Gärten bekannt.",
      hu: "Enghien Hainaut tartományban fekszik. A város a nagy parkjáról és történelmi kertjeiről ismert.",
      ro: "Enghien este situat în provincia Hainaut. Orașul este cunoscut pentru parcul său mare și grădinile istorice.",
      en: "Enghien is located in the province of Hainaut. The city is known for its large park and historical gardens.",
    },
    facts: {
      de: ["Provinz Hennegau", "Historischer Park", "Gartenkultur", "Wallonische Stadt"],
      hu: ["Hainaut tartomány", "Történelmi park", "Kertkultúra", "Vallon város"],
      ro: ["Provincia Hainaut", "Parc istoric", "Cultura grădinilor", "Oraș valon"],
      en: ["Hainaut province", "Historic park", "Garden culture", "Walloon city"],
    },
    imageHint: "Enghien park landscape",
    descriptionAdvanced: {
      de: "Enghien liegt in der Provinz Hennegau. Die Stadt ist berühmt für ihren weitläufigen Schlosspark, der als eine der schönsten Gartenanlagen Belgiens gilt.",
      hu: "Enghien a Hainaut tartományban található. A város kiterjedt kastélyparkjáról híres, amelyet Belgium egyik legszebb kertjeként tartanak számon.",
      ro: "Enghien este situat în provincia Hainaut. Orașul este faimos pentru parcul său castel, considerat una dintre cele mai frumoase grădini din Belgia.",
      en: "Enghien is located in the province of Hainaut. The city is famous for its extensive castle park, considered one of the most beautiful gardens in Belgium.",
    },
    factsAdvanced: {
      de: ["Attraktion: Schlosspark", "Provinz: Hennegau", "Sprache: Zweisprachig", "Gartenkunst: Historisch"],
      hu: ["Látványosság: kastélypark", "Tartomány: Hainaut", "Nyelv: kétnyelvű", "Kertművészet: történelmi"],
      ro: ["Atracție: Parcul castelului", "Provincie: Hainaut", "Limbă: bilingv", "Arhitectură peisageră: istorică"],
      en: ["Attraction: Castle park", "Province: Hainaut", "Language: bilingual", "Landscape art: historic"],
    },
  },
  {
    id: "belgium-esneux-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Esneux", hu: "Esneux", ro: "Esneux", en: "Esneux" },
    coordinates: { lat: 50.5233, lng: 5.5683 },
    description: {
      de: "Esneux liegt in der Provinz Lüttich an der Ourthe. Die Stadt ist durch ihre grüne Lage bekannt.",
      hu: "Esneux a Liège tartományban, az Ourthe folyó mentén fekszik. A város a zöld környezetéről ismert.",
      ro: "Esneux este situat în provincia Liège pe râul Ourthe. Orașul este cunoscut pentru locația sa verde.",
      en: "Esneux is located in the province of Liège on the Ourthe River. The city is known for its green location.",
    },
    facts: {
      de: ["Provinz Lüttich", "Am Fluss Ourthe", "Grüne Umgebung", "Naherholungsgebiet"],
      hu: ["Liège tartomány", "Ourthe folyó", "Zöld környezet", "Rekreációs terület"],
      ro: ["Provincia Liège", "Râul Ourthe", "Mediu verde", "Zona de recreere"],
      en: ["Liège province", "Ourthe river", "Green environment", "Recreational area"],
    },
    imageHint: "Esneux Ourthe river valley",
    descriptionAdvanced: {
      de: "Esneux liegt im Tal der Ourthe in der Provinz Lüttich. Die Gemeinde ist bekannt für ihre felsige Topografie und ihre Lage an der Ardennen-Schwelle, was sie zu einem beliebten Ziel für Wanderer und Naturliebhaber macht.",
      hu: "Esneux a Liège tartományban, az Ourthe folyó völgyében fekszik. A település sziklás domborzatáról és az Ardennek kapujában betöltött helyzetéről ismert, így a túrázók és a természet szerelmeseinek közkedvelt célpontja.",
      ro: "Esneux este situat în valea râului Ourthe din provincia Liège. Localitatea este cunoscută pentru topografia sa stâncoasă și poziția la granița Ardenilor, fiind o destinație populară pentru drumeții și activități în aer liber.",
      en: "Esneux is situated in the Ourthe valley in the province of Liège. The municipality is noted for its rocky topography and location at the gateway to the Ardennes, making it a popular destination for hikers and nature enthusiasts.",
    },
    factsAdvanced: {
      de: ["Lage im Ourthe-Tal", "Fläche ca. 34 km²", "Nähe zu Lüttich", "Ardennen-Randlage"],
      hu: ["Az Ourthe völgyében fekszik", "Területe kb. 34 km²", "Liège közelsége", "Ardennek peremén"],
      ro: ["Situat în valea Ourthe", "Suprafață de cca. 34 km²", "Apropierea de Liège", "Poziție la marginea Ardenilor"],
      en: ["Located in Ourthe Valley", "Area approx. 34 km²", "Proximity to Liège", "Ardennes fringe location"],
    },
  },
  {
    id: "belgium-fleurus-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Fleurus", hu: "Fleurus", ro: "Fleurus", en: "Fleurus" },
    coordinates: { lat: 50.4828, lng: 4.5492 },
    description: {
      de: "Fleurus liegt in der Provinz Hennegau. Die Stadt ist historisch durch mehrere bedeutende Schlachten bekannt.",
      hu: "Fleurus Hainaut tartományban található. A várost történelmileg több jelentős csata tette ismertté.",
      ro: "Fleurus este situat în provincia Hainaut. Orașul este cunoscut istoric prin mai multe bătălii importante.",
      en: "Fleurus is located in the province of Hainaut. The city is historically known for several significant battles.",
    },
    facts: {
      de: ["Provinz Hennegau", "Schlachtort Geschichte", "Industrieller Standort", "Regionale Geschichte"],
      hu: ["Hainaut tartomány", "Csaták története", "Ipari helyszín", "Regionális történelem"],
      ro: ["Provincia Hainaut", "Istoria bătăliilor", "Locație industrială", "Istorie regională"],
      en: ["Hainaut province", "Battle history", "Industrial site", "Regional history"],
    },
    imageHint: "Fleurus historic battlefield memorial",
    descriptionAdvanced: {
      de: "Fleurus liegt in der Provinz Hennegau und hat eine lange militärhistorische Tradition. Die Stadt war Schauplatz bedeutender europäischer Schlachten in den Jahren 1622, 1690, 1794 und 1815, die den Verlauf der Geschichte prägten.",
      hu: "Fleurus a Hainaut tartományban található, hosszú katonai történelmi hagyományokkal. A város négy jelentős európai csata helyszíne volt 1622-ben, 1690-ben, 1794-ben és 1815-ben, amelyek alapvetően meghatározták Európa történelmét.",
      ro: "Fleurus este situat în provincia Hainaut și are o lungă tradiție militară. Orașul a fost locul unor bătălii europene semnificative în anii 1622, 1690, 1794 și 1815, care au influențat cursul istoriei continentale.",
      en: "Fleurus is located in the Hainaut province and holds a long military historical tradition. The city was the site of significant European battles in 1622, 1690, 1794, and 1815, which shaped the course of continental history.",
    },
    factsAdvanced: {
      de: ["Schlachtort 1815", "Provinz Hennegau", "Industrielle Wurzeln", "Wichtiger Verkehrsknoten"],
      hu: ["1815-ös csata helyszíne", "Hainaut tartomány", "Ipari gyökerek", "Fontos közlekedési csomópont"],
      ro: ["Locul bătăliei din 1815", "Provincia Hainaut", "Rădăcini industriale", "Nod rutier important"],
      en: ["Battle site of 1815", "Hainaut province", "Industrial roots", "Key transport junction"],
    },
  },
  {
    id: "belgium-fleron-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Fléron", hu: "Fléron", ro: "Fléron", en: "Fléron" },
    coordinates: { lat: 50.6133, lng: 5.6833 },
    description: {
      de: "Fléron liegt in der Provinz Lüttich. Die Stadt ist ein Vorort der Stadt Lüttich im Herver Land.",
      hu: "Fléron a Liège tartományban található. Liège város külvárosa a Herve-fennsíkon.",
      ro: "Fléron este situat în provincia Liège. Orașul este o suburbie a orașului Liège în platoul Herve.",
      en: "Fléron is located in the province of Liège. The city is a suburb of the city of Liège on the Herve plateau.",
    },
    facts: {
      de: ["Provinz Lüttich", "Vorort von Lüttich", "Herve-Plateau", "Wohnort"],
      hu: ["Liège tartomány", "Liège külvárosa", "Herve-fennsík", "Lakóhely"],
      ro: ["Provincia Liège", "Suburbie a Liège", "Platoul Herve", "Zona rezidențială"],
      en: ["Liège province", "Suburb of Liège", "Herve plateau", "Residential area"],
    },
    imageHint: "Fleron street view",
    descriptionAdvanced: {
      de: "Fléron liegt im Osten Belgiens nahe Lüttich. Die Stadt entwickelte sich aus einem alten Bergbaugebiet zu einem modernen Wohnzentrum mit einer gut ausgebauten Infrastruktur und grünen Erholungsgebieten.",
      hu: "Fléron Kelet-Belgiumban, Liège közelében található. A város egykori bányászati területből modern lakóközponttá fejlődött, amely jól kiépített infrastruktúrával és zöld pihenőövezetekkel rendelkezik.",
      ro: "Fléron este situat în estul Belgiei, lângă Liège. Orașul s-a dezvoltat dintr-o fostă zonă minieră într-un centru rezidențial modern, beneficiind de infrastructură bine dezvoltată și zone verzi pentru recreere.",
      en: "Fléron is situated in eastern Belgium near Liège. The town evolved from an old mining area into a modern residential center with well-developed infrastructure and green recreational areas.",
    },
    factsAdvanced: {
      de: ["Region Lüttich", "Einstiges Bergbaugebiet", "Hohe Bevölkerungsdichte", "Wohnvorort-Charakter"],
      hu: ["Liège régió", "Egykori bányászterület", "Magas népsűrűség", "Lakóövezeti jelleg"],
      ro: ["Regiunea Liège", "Fostă zonă minieră", "Densitate ridicată", "Caracter rezidențial"],
      en: ["Liège region", "Former mining area", "High population density", "Residential suburb character"],
    },
  },
  {
    ...
    coordinates: { lat: 50.4333, lng: 4.3 },
    description: {
      de: "Fontaine-l'Évêque liegt in der Provinz Hennegau. Es ist eine ehemalige Bergbaustadt nahe Charleroi.",
      hu: "Fontaine-l'Évêque Hainaut tartományban fekszik. Egykori bányászváros Charleroi közelében.",
      ro: "Fontaine-l'Évêque este situat în provincia Hainaut. Este un fost oraș minier aproape de Charleroi.",
      en: "Fontaine-l'Évêque is located in the province of Hainaut. It is a former mining town near Charleroi.",
    },
    facts: {
      de: ["Provinz Hennegau", "Nahe Charleroi", "Ehemalige Bergbaustadt", "Regionale Geschichte"],
      hu: ["Hainaut tartomány", "Charleroi közelében", "Egykori bányászváros", "Regionális történelem"],
      ro: ["Provincia Hainaut", "Aproape de Charleroi", "Fost oraș minier", "Istorie regională"],
      en: ["Hainaut province", "Near Charleroi", "Former mining town", "Regional history"],
    },
    imageHint: "Fontaine-l'Eveque town building",
    descriptionAdvanced: {
      de: "Fontaine-l'Évêque liegt in der wallonischen Provinz Hennegau. Die Stadt ist für ihr historisches Schloss aus dem 12. Jahrhundert bekannt, das die reiche feudale Vergangenheit dieser Region am Rande des Kohlebeckens bezeugt.",
      hu: "Fontaine-l'Évêque a vallon Hainaut tartományban fekszik. A város a 12. századi történelmi kastélyáról ismert, amely tanúskodik a szénmedence szélén fekvő régió gazdag feudális múltjáról.",
      ro: "Fontaine-l'Évêque este situat în provincia valonă Hainaut. Orașul este cunoscut pentru castelul său istoric din secolul al XII-lea, care mărturisește trecutul feudal bogat al acestei regiuni de la marginea bazinului carbonifer.",
      en: "Fontaine-l'Évêque is located in the Walloon province of Hainaut. The city is noted for its 12th-century historical castle, which bears witness to the rich feudal past of this region on the edge of the coal basin.",
    },
    factsAdvanced: {
      de: ["Schloss aus dem 12. Jh.", "Provinz Hennegau", "Kohlebecken-Randlage", "Kulturelles Erbe"],
      hu: ["12. századi kastély", "Hainaut tartomány", "Szénmedence pereme", "Kulturális örökség"],
      ro: ["Castel din sec. XII", "Provincia Hainaut", "Marginea bazinului carbonifer", "Patrimoniu cultural"],
      en: ["12th-century castle", "Hainaut province", "Coal basin edge", "Cultural heritage"],
    },
  },
  {
    id: "belgium-frameries-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Frameries", hu: "Frameries", ro: "Frameries", en: "Frameries" },
    coordinates: { lat: 50.4167, lng: 3.8833 },
    description: {
      de: "Frameries liegt in der Provinz Hennegau nahe Mons. Die Stadt hat eine bedeutende Industrievergangenheit.",
      hu: "Frameries Hainaut tartományban, Mons közelében található. A városnak jelentős ipari múltja van.",
      ro: "Frameries este situat în provincia Hainaut aproape de Mons. Orașul are un trecut industrial semnificativ.",
      en: "Frameries is located in the province of Hainaut near Mons. The city has a significant industrial past.",
    },
    facts: {
      de: ["Provinz Hennegau", "Nahe Mons", "Industriegeschichte", "Region Borinage"],
      hu: ["Hainaut tartomány", "Mons közelében", "Ipartörténet", "Borinage régió"],
      ro: ["Provincia Hainaut", "Aproape de Mons", "Istorie industrială", "Regiunea Borinage"],
      en: ["Hainaut province", "Near Mons", "Industrial history", "Borinage region"],
    },
    imageHint: "Frameries urban view",
    descriptionAdvanced: {
      de: "Frameries liegt im Herzen des Borinage-Gebiets. Die industrielle Identität der Stadt ist eng mit dem Kohleabbau verbunden, der heute durch Museen und Denkmäler wie das 'Pass' als Wissenschaftszentrum gewürdigt wird.",
      hu: "Frameries a Borinage terület szívében található. A város ipari identitása szorosan összefonódik a szénbányászattal, amelyet ma múzeumok és emlékművek, például a 'Pass' tudományos központ őriz meg.",
      ro: "Frameries este situat în inima regiunii Borinage. Identitatea industrială a orașului este strâns legată de mineritul cărbunelui, onorat astăzi prin muzee și monumente precum centrul științific 'Pass'.",
      en: "Frameries is located in the heart of the Borinage area. The town's industrial identity is closely linked to coal mining, which is commemorated today through museums and landmarks like the 'Pass' science center.",
    },
    factsAdvanced: {
      de: ["Region Borinage", "Wissenschaftszentrum Pass", "Bergbau-Vergangenheit", "Hennegau"],
      hu: ["Borinage régió", "Pass tudományos központ", "Bányászati múlt", "Hainaut"],
      ro: ["Regiunea Borinage", "Centrul științific Pass", "Trecut minier", "Hainaut"],
      en: ["Borinage region", "Pass science center", "Mining past", "Hainaut"],
    },
  },
  {
    id: "belgium-gembloux-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Gembloux", hu: "Gembloux", ro: "Gembloux", en: "Gembloux" },
    coordinates: { lat: 50.5594, lng: 4.6933 },
    description: {
      de: "Gembloux liegt in der Provinz Namur. Die Stadt ist berühmt für ihre Landwirtschaftliche Fakultät.",
      hu: "Gembloux Namur tartományban fekszik. A város a Mezőgazdasági Karáról híres.",
      ro: "Gembloux este situat în provincia Namur. Orașul este celebru pentru Facultatea sa de Agricultură.",
      en: "Gembloux is located in the province of Namur. The city is famous for its Agricultural Faculty.",
    },
    facts: {
      de: ["Provinz Namur", "Universitätsstadt", "Landwirtschaftsforschung", "Historischer Turm"],
      hu: ["Namur tartomány", "Egyetemi város", "Mezőgazdasági kutatás", "Történelmi torony"],
      ro: ["Provincia Namur", "Oraș universitar", "Cercetare agricolă", "Turn istoric"],
      en: ["Namur province", "University city", "Agricultural research", "Historic tower"],
    },
    imageHint: "Gembloux medieval tower",
    descriptionAdvanced: {
      de: "Gembloux in der Provinz Namur ist berühmt für seine landwirtschaftliche Universität und sein historisches Stadtbild. Die ehemalige Abtei beherbergt heute die renommierte Agrarfakultät der Universität Lüttich.",
      hu: "A Namur tartománybeli Gembloux mezőgazdasági egyeteméről és történelmi városképéről híres. Az egykori apátság épülete ad otthont a Liège-i Egyetem neves agrárkarának.",
      ro: "Gembloux, în provincia Namur, este faimos pentru universitatea sa agricolă și peisajul urban istoric. Fosta mănăstire găzduiește astăzi renumita facultate de agronomie a Universității din Liège.",
      en: "Gembloux in the province of Namur is famous for its agricultural university and historic townscape. The former abbey today houses the renowned agricultural faculty of the University of Liège.",
    },
    factsAdvanced: {
      de: ["Agrar-Universität", "Provinz Namur", "Ehemalige Abtei", "Traditionelle Architektur"],
      hu: ["Agrártudományi Egyetem", "Namur tartomány", "Egykori apátság", "Hagyományos építészet"],
      ro: ["Universitate agricolă", "Provincia Namur", "Fosta mănăstire", "Arhitectură tradițională"],
      en: ["Agricultural University", "Namur province", "Former abbey", "Traditional architecture"],
    },
  },
  {
    ...
    coordinates: { lat: 50.4167, lng: 4.4833 },
    description: {
      de: "Gilly ist ein Stadtteil von Charleroi in der Provinz Hennegau. Es ist ein dicht besiedeltes Wohngebiet.",
      hu: "Gilly Charleroi egyik városrésze Hainaut tartományban. Sűrűn lakott lakóövezet.",
      ro: "Gilly este un district al orașului Charleroi în provincia Hainaut. Este o zonă rezidențială dens populată.",
      en: "Gilly is a district of Charleroi in the province of Hainaut. It is a densely populated residential area.",
    },
    facts: {
      de: ["Teil von Charleroi", "Provinz Hennegau", "Dichtes Wohngebiet", "Städtisch"],
      hu: ["Charleroi része", "Hainaut tartomány", "Sűrű lakóhely", "Városi"],
      ro: ["Parte din Charleroi", "Provincia Hainaut", "Zonă densă", "Urban"],
      en: ["Part of Charleroi", "Hainaut province", "Dense residential area", "Urban"],
    },
    imageHint: "Gilly urban cityscape",
    descriptionAdvanced: {
      de: "Gilly ist ein bedeutender Teil der Stadt Charleroi in der Wallonie. Die Gegend ist durch ihre industrielle Entwicklung und die dichte urbane Bebauung geprägt, die eng mit der Geschichte der Stahlerzeugung verbunden ist.",
      hu: "Gilly a vallóniai Charleroi városának jelentős része. A területet az ipari fejlődés és a sűrű városi beépítés jellemzi, amely szorosan összefügg az acélgyártás történetével.",
      ro: "Gilly este o parte importantă a orașului Charleroi din Valonia. Zona este marcată de dezvoltarea sa industrială și de densitatea urbană, fiind strâns legată de istoria producției de oțel.",
      en: "Gilly is a significant part of the city of Charleroi in Wallonia. The area is characterized by its industrial development and dense urban landscape, closely linked to the history of steel production.",
    },
    factsAdvanced: {
      de: ["Stadtteil von Charleroi", "Industrielles Erbe", "Stahlerzeugung", "Dichte Bebauung"],
      hu: ["Charleroi kerülete", "Ipari örökség", "Acélgyártás", "Sűrű beépítés"],
      ro: ["Cartier al Charleroi", "Patrimoniu industrial", "Producția de oțel", "Densitate urbană"],
      en: ["District of Charleroi", "Industrial heritage", "Steel production", "Dense urban area"],
    },
  },
  {
    id: "belgium-grace-hollogne-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Grâce-Hollogne", hu: "Grâce-Hollogne", ro: "Grâce-Hollogne", en: "Grâce-Hollogne" },
    coordinates: { lat: 50.6333, lng: 5.4833 },
    description: {
      de: "Grâce-Hollogne liegt in der Provinz Lüttich nahe dem Lütticher Flughafen. Es ist ein wichtiger Logistikstandort.",
      hu: "Grâce-Hollogne Liège tartományban, a Liège-i repülőtér közelében fekszik. Fontos logisztikai csomópont.",
      ro: "Grâce-Hollogne este situat în provincia Liège, aproape de aeroportul din Liège. Este un important centru logistic.",
      en: "Grâce-Hollogne is located in the province of Liège near Liège Airport. It is an important logistics hub.",
    },
    facts: {
      de: ["Provinz Lüttich", "Nahe Lüttich Flughafen", "Logistikzentrum", "Verkehrsknoten"],
      hu: ["Liège tartomány", "Liège reptér közelében", "Logisztikai központ", "Közlekedési csomópont"],
      ro: ["Provincia Liège", "Aproape de aeroportul Liège", "Centru logistic", "Nod de transport"],
      en: ["Liège province", "Near Liège airport", "Logistics hub", "Transport node"],
    },
    imageHint: "Grace-Hollogne logistics center",
    descriptionAdvanced: {
      de: "Grâce-Hollogne liegt westlich von Lüttich und ist ein logistischer Knotenpunkt. Die Stadt ist vor allem als Standort des internationalen Flughafens Lüttich bekannt, der eine zentrale Rolle für den Luftfrachtverkehr in Europa spielt.",
      hu: "Grâce-Hollogne Liège-től nyugatra fekszik, fontos logisztikai csomópont. A város elsősorban a Liège-i nemzetközi repülőtér otthonaként ismert, amely központi szerepet játszik az európai légi teherszállításban.",
      ro: "Grâce-Hollogne este situat la vest de Liège și reprezintă un nod logistic important. Orașul este cunoscut mai ales pentru găzduirea Aeroportului Internațional Liège, esențial pentru transportul aerian de mărfuri în Europa.",
      en: "Grâce-Hollogne is situated west of Liège and serves as a logistical hub. The town is primarily known as the location of Liège International Airport, which plays a central role in European air freight traffic.",
    },
    factsAdvanced: {
      de: ["Flughafen Lüttich", "Logistik-Standort", "Region Lüttich", "Verkehrsknotenpunkt"],
      hu: ["Liège-i repülőtér", "Logisztikai központ", "Liège régió", "Közlekedési csomópont"],
      ro: ["Aeroportul Liège", "Centru logistic", "Regiunea Liège", "Nod rutier"],
      en: ["Liège Airport", "Logistics hub", "Liège region", "Transport junction"],
    },
  },
  {
    id: "belgium-heusden-zolder-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Heusden-Zolder", hu: "Heusden-Zolder", ro: "Heusden-Zolder", en: "Heusden-Zolder" },
    coordinates: { lat: 51.0167, lng: 5.2667 },
    description: {
      de: "Heusden-Zolder liegt in der Provinz Limburg. Es ist bekannt für seine ehemalige Kohlezeche und die Rennstrecke.",
      hu: "Heusden-Zolder Limburg tartományban található. Az egykori szénbányájáról és a versenypályájáról ismert.",
      ro: "Heusden-Zolder este situat în provincia Limburg. Este cunoscut pentru fosta sa mină de cărbune și circuitul de curse.",
      en: "Heusden-Zolder is located in the province of Limburg. It is known for its former coal mine and the racetrack.",
    },
    facts: {
      de: ["Provinz Limburg", "Rennstrecke Zolder", "Ehemalige Kohlemine", "Industrieerbe"],
      hu: ["Limburg tartomány", "Zolder versenypálya", "Egykori szénbánya", "Ipari örökség"],
      ro: ["Provincia Limburg", "Circuitul Zolder", "Fosta mină de cărbune", "Moștenire industrială"],
      en: ["Limburg province", "Zolder racetrack", "Former coal mine", "Industrial heritage"],
    },
    imageHint: "Heusden-Zolder Zolder racetrack",
    descriptionAdvanced: {
      de: "Heusden-Zolder liegt in der Provinz Limburg. Die Stadt ist für ihre ehemalige Zeche und den Circuit Zolder bekannt, eine weltberühmte Rennstrecke, die regelmäßig bedeutende internationale Motorsportveranstaltungen ausrichtet.",
      hu: "Heusden-Zolder Limburg tartományban található. A város egykori bányájáról és a Circuit Zolder autóverseny-pályáról ismert, amely rendszeresen rangos nemzetközi autósport-rendezvényeknek ad otthont.",
      ro: "Heusden-Zolder este situat în provincia Limburg. Localitatea este cunoscută pentru fosta sa mină și Circuit Zolder, un circuit de curse celebru la nivel mondial, care găzduiește constant evenimente internaționale de motorsport.",
      en: "Heusden-Zolder is situated in the province of Limburg. The town is known for its former coal mine and Circuit Zolder, a world-famous racetrack that regularly hosts major international motorsport events.",
    },
    factsAdvanced: {
      de: ["Rennstrecke Circuit Zolder", "Ehemalige Mine", "Provinz Limburg", "Motorsport-Zentrum"],
      hu: ["Circuit Zolder versenypálya", "Egykori bányatelep", "Limburg tartomány", "Autósport központ"],
      ro: ["Circuitul Zolder", "Fosta mină", "Provincia Limburg", "Centru de motorsport"],
      en: ["Circuit Zolder race track", "Former coal mine", "Limburg province", "Motorsport hub"],
    },
  },
  {
    id: "belgium-huy-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Huy", hu: "Huy", ro: "Huy", en: "Huy" },
    coordinates: { lat: 50.5167, lng: 5.2333 },
    description: {
      de: "Huy liegt in der Provinz Lüttich an der Maas. Die Stadt ist für ihre Zitadelle und die gotische Kirche bekannt.",
      hu: "Huy a Liège tartományban, a Meuse folyó mentén fekszik. A város a fellegváráról és gótikus templomáról ismert.",
      ro: "Huy este situat în provincia Liège pe râul Meuse. Orașul este cunoscut pentru cetatea sa și biserica gotică.",
      en: "Huy is located in the province of Liège on the Meuse River. The city is known for its citadel and Gothic church.",
    },
    facts: {
      de: ["Provinz Lüttich", "An der Maas", "Zitadelle von Huy", "Historisches Stadtbild"],
      hu: ["Liège tartomány", "Meuse folyó", "Huy fellegvára", "Történelmi városkép"],
      ro: ["Provincia Liège", "Pe râul Meuse", "Cetatea Huy", "Peisaj urban istoric"],
      en: ["Liège province", "On the Meuse", "Citadel of Huy", "Historic cityscape"],
    },
    imageHint: "Huy citadel view",
    descriptionAdvanced: {
      de: "Huy liegt an der Maas in der Provinz Lüttich. Die Stadt ist für ihre mittelalterliche Zitadelle und die gotische Stiftskirche bekannt, die das malerische Flussufer dominieren und eine lange historische Bedeutung markieren.",
      hu: "Huy a Meuse folyó mentén, Liège tartományban fekszik. A város középkori fellegváráról és gótikus templomáról ismert, amelyek uralják a festői folyópartot és a régió hosszú történelmi jelentőségét tanúsítják.",
      ro: "Huy este situat pe malul fluviului Meuse în provincia Liège. Orașul este renumit pentru citadela sa medievală și biserica gotică, care domină malul pitoresc al fluviului, marcând o importanță istorică îndelungată.",
      en: "Huy is located on the Meuse river in the province of Liège. The city is famous for its medieval citadel and Gothic collegiate church, which dominate the picturesque riverbank, marking a long historical significance.",
    },
    factsAdvanced: {
      de: ["Lage an der Maas", "Zitadelle von Huy", "Gotische Architektur", "Provinz Lüttich"],
      hu: ["Meuse folyópart", "Huy fellegvára", "Gótikus építészet", "Liège tartomány"],
      ro: ["Situat pe Meuse", "Citadela din Huy", "Arhitectură gotică", "Provincia Liège"],
      en: ["Meuse river location", "Citadel of Huy", "Gothic architecture", "Liège province"],
    },
  },
  {
    id: "belgium-jodoigne-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Jodoigne", hu: "Jodoigne", ro: "Jodoigne", en: "Jodoigne" },
    coordinates: { lat: 50.7333, lng: 4.8667 },
    description: {
      de: "Jodoigne liegt in der Provinz Wallonisch-Brabant. Es ist eine ländliche Stadt in der Region Hespengau.",
      hu: "Jodoigne Vallon-Brabant tartományban található. Vidéki város a Hespengau régióban.",
      ro: "Jodoigne este situat în provincia Brabantul Valon. Este un oraș rural în regiunea Haspengouw.",
      en: "Jodoigne is located in the province of Walloon Brabant. It is a rural town in the Haspengouw region.",
    },
    facts: {
      de: ["Provinz Wallonisch-Brabant", "Hespengau Region", "Landwirtschaftlich", "Historische Bauten"],
      hu: ["Vallon-Brabant tartomány", "Hespengau régió", "Mezőgazdasági", "Történelmi épületek"],
      ro: ["Provincia Brabantul Valon", "Regiunea Haspengouw", "Agricol", "Clădiri istorice"],
      en: ["Walloon Brabant province", "Haspengouw region", "Agricultural", "Historic buildings"],
    },
    imageHint: "Jodoigne town center",
    descriptionAdvanced: {
      de: "Jodoigne liegt in der Provinz Wallonisch-Brabant. Die Stadt ist ein historisches Zentrum mit gut erhaltenen Gebäuden aus dem 17. und 18. Jahrhundert, die den Wohlstand der Region als Marktort für landwirtschaftliche Erzeugnisse widerspiegeln.",
      hu: "Jodoigne Vallon-Brabant tartományban fekszik. A város egy történelmi központ, jól megőrzött 17. és 18. századi épületekkel, amelyek tükrözik a régió mezőgazdasági termények piachelyeként elért gazdagságát.",
      ro: "Jodoigne este situat în provincia Brabantul Valon. Orașul este un centru istoric cu clădiri bine conservate din secolele al XVII-lea și al XVIII-lea, reflectând prosperitatea regiunii ca punct de desfacere pentru produse agricole.",
      en: "Jodoigne is situated in the province of Walloon Brabant. The town is a historic center with well-preserved 17th and 18th-century buildings, reflecting the region's prosperity as a marketplace for agricultural produce.",
    },
    factsAdvanced: {
      de: ["Wallonisch-Brabant", "Historischer Marktort", "Architektur 17. Jh.", "Landwirtschaftliche Wurzeln"],
      hu: ["Vallon-Brabant", "Történelmi piachely", "17. századi építészet", "Mezőgazdasági gyökerek"],
      ro: ["Brabantul Valon", "Piață istorică", "Arhitectură din sec. XVII", "Rădăcini agricole"],
      en: ["Walloon Brabant", "Historic market town", "17th-century architecture", "Agricultural roots"],
    },
  },
  {
    id: "belgium-kapellen-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Kapellen", hu: "Kapellen", ro: "Kapellen", en: "Kapellen" },
    coordinates: { lat: 51.3, lng: 4.4333 },
    description: {
      de: "Kapellen liegt nördlich von Antwerpen in der Provinz Antwerpen. Es ist eine grüne Wohngemeinde.",
      hu: "Kapellen Antwerpentől északra, Antwerpen tartományban fekszik. Zöld lakóövezeti település.",
      ro: "Kapellen este situat la nord de Anvers, în provincia Anvers. Este o comună rezidențială verde.",
      en: "Kapellen is located north of Antwerp in the province of Antwerp. It is a green residential municipality.",
    },
    facts: {
      de: ["Provinz Antwerpen", "Grüne Wohngemeinde", "Nahe Antwerpen", "Parklandschaft"],
      hu: ["Antwerpen tartomány", "Zöld lakótelepülés", "Antwerpen közelében", "Parkos táj"],
      ro: ["Provincia Anvers", "Comună rezidențială verde", "Aproape de Anvers", "Peisaj cu parcuri"],
      en: ["Antwerp province", "Green residential area", "Near Antwerp", "Park landscape"],
    },
    imageHint: "Kapellen green suburb",
    descriptionAdvanced: {
      de: "Kapellen liegt nördlich von Antwerpen. Die Gemeinde ist bekannt für ihre bewaldeten Gebiete und gehobenen Wohngebiete, die der Stadt einen grünen und exklusiven Charakter verleihen, der sie als Wohnort sehr beliebt macht.",
      hu: "Kapellen Antwerpen-től északra található. A község erdős területeiről és előkelő lakóövezeteiről ismert, amelyek zöld és exkluzív jelleget kölcsönöznek a városnak, vonzó lakóhellyé téve azt.",
      ro: "Kapellen este situat la nord de Anvers. Comuna este cunoscută pentru zonele sale împădurite și cartierele rezidențiale selecte, care conferă orașului un caracter verde și exclusivist, făcându-l foarte popular ca reședință.",
      en: "Kapellen is situated north of Antwerp. The municipality is known for its wooded areas and upscale residential neighborhoods, which give the town a green and exclusive character that makes it a very popular place to live.",
    },
    factsAdvanced: {
      de: ["Region Antwerpen", "Waldreiche Gemeinde", "Wohnvorort", "Hohe Lebensqualität"],
      hu: ["Antwerpen régió", "Erdős község", "Lakóövezet", "Magas életminőség"],
      ro: ["Regiunea Anvers", "Comună împădurită", "Zona rezidențială", "Calitate ridicată a vieții"],
      en: ["Antwerp region", "Wooded municipality", "Residential suburb", "High quality of life"],
    },
  },
  {
    id: "belgium-la-roche-en-ardenne-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "La Roche-en-Ardenne", hu: "La Roche-en-Ardenne", ro: "La Roche-en-Ardenne", en: "La Roche-en-Ardenne" },
    coordinates: { lat: 50.1833, lng: 5.5667 },
    description: {
      de: "La Roche-en-Ardenne liegt in der Provinz Luxemburg. Die Stadt ist ein beliebtes Touristenziel in den Ardennen.",
      hu: "La Roche-en-Ardenne Luxemburg tartományban fekszik. A város az Ardennek egyik népszerű turisztikai célpontja.",
      ro: "La Roche-en-Ardenne este situat în provincia Luxemburg. Orașul este o destinație turistică populară în Ardeni.",
      en: "La Roche-en-Ardenne is located in the province of Luxembourg. The city is a popular tourist destination in the Ardennes.",
    },
    facts: {
      de: ["Provinz Luxemburg", "Ardennen Region", "Tourismus", "Ruine der Burg"],
      hu: ["Luxemburg tartomány", "Ardennek régió", "Turizmus", "Várrom"],
      ro: ["Provincia Luxemburg", "Regiunea Ardeni", "Turism", "Ruinele castelului"],
      en: ["Luxembourg province", "Ardennes region", "Tourism", "Castle ruins"],
    },
    imageHint: "La Roche-en-Ardenne castle ruins",
    descriptionAdvanced: {
      de: "La Roche-en-Ardenne liegt im Ourthe-Tal und ist ein touristisches Zentrum. Die Stadt ist berühmt für ihre markante Burgruine, die majestätisch über dem Ort thront und eine Geschichte bis ins Mittelalter aufweist.",
      hu: "La Roche-en-Ardenne az Ourthe völgyében található, jelentős turisztikai központ. A város a fenséges várromjáról híres, amely a település felett tornyosul, története egészen a középkorig nyúlik vissza.",
      ro: "La Roche-en-Ardenne este situat în valea râului Ourthe și reprezintă un centru turistic. Orașul este celebru pentru ruinele sale impresionante ale castelului, care domină maiestuos localitatea, având o istorie ce datează din evul mediu.",
      en: "La Roche-en-Ardenne is located in the Ourthe valley and serves as a tourism hub. The town is famous for its striking castle ruins, which majestically overlook the site, with history dating back to the Middle Ages.",
    },
    factsAdvanced: {
      de: ["Burgruine La Roche", "Tourismus in den Ardennen", "Ourthe-Tal", "Mittelalterliche Geschichte"],
      hu: ["La Roche várrom", "Ardenneki turizmus", "Ourthe völgy", "Középkori történelem"],
      ro: ["Ruinele castelului", "Turism în Ardeni", "Valea Ourthe", "Istorie medievală"],
      en: ["La Roche castle ruins", "Ardennes tourism", "Ourthe valley", "Medieval history"],
    },
  },
  {
    ...
    coordinates: { lat: 50.85, lng: 3.1333 },
    description: {
      de: "Ledegem liegt in Westflandern. Es ist eine landwirtschaftlich geprägte Gemeinde nahe Roeselare.",
      hu: "Ledegem Nyugat-Flandriában található. Roeselare közelében fekvő, mezőgazdasági jellegű település.",
      ro: "Ledegem este situat în Flandra de Vest. Este o comună cu caracter agricol, aproape de Roeselare.",
      en: "Ledegem is located in West Flanders. It is an agricultural municipality near Roeselare.",
    },
    facts: {
      de: ["Provinz Westflandern", "Landwirtschaft", "Nahe Roeselare", "Ruhige Lage"],
      hu: ["Nyugat-Flandria tartomány", "Mezőgazdaság", "Roeselare közelében", "Csendes helyszín"],
      ro: ["Provincia Flandra de Vest", "Agricultură", "Aproape de Roeselare", "Poziție liniștită"],
      en: ["West Flanders province", "Agriculture", "Near Roeselare", "Quiet location"],
    },
    imageHint: "Ledegem fields landscape",
    descriptionAdvanced: {
      de: "Ledegem liegt in der flämischen Provinz Westflandern. Die Gemeinde ist eine ländlich geprägte Region, die für ihre ruhige Atmosphäre und die traditionelle flämische Lebensart inmitten weitläufiger Felder bekannt ist.",
      hu: "Ledegem a flamand Nyugat-Flandria tartományban fekszik. A község egy mezőgazdasági jellegű régió, amely nyugodt légköréről és a kiterjedt mezők közepette folytatott hagyományos flamand életmódról ismert.",
      ro: "Ledegem este situat în provincia flamandă Flandra de Vest. Comuna este o regiune predominant rurală, cunoscută pentru atmosfera sa liniștită și modul de viață tradițional flamand, în mijlocul unor câmpuri întinse.",
      en: "Ledegem is situated in the Flemish province of West Flanders. The municipality is a rural region, known for its tranquil atmosphere and traditional Flemish lifestyle set amongst sprawling fields.",
    },
    factsAdvanced: {
      de: ["Westflandern", "Ländliche Atmosphäre", "Traditionelle Landwirtschaft", "Flämische Region"],
      hu: ["Nyugat-Flandria", "Vidéki hangulat", "Hagyományos mezőgazdaság", "Flamand régió"],
      ro: ["Flandra de Vest", "Atmosferă rurală", "Agricultură tradițională", "Regiunea flamandă"],
      en: ["West Flanders", "Rural atmosphere", "Traditional agriculture", "Flemish region"],
    },
  },
  {
    ...
    coordinates: { lat: 50.8, lng: 4.1167 },
    description: {
      de: "Lennik liegt in der Provinz Flämisch-Brabant im Pajottenland. Es ist eine grüne, hügelige Region.",
      hu: "Lennik Flamand-Brabant tartományban, a Pajottenland régióban fekszik. Zöld, dombos régió.",
      ro: "Lennik este situat în provincia Brabantul Flamand, în Pajottenland. Este o regiune verde și deluroasă.",
      en: "Lennik is located in the province of Flemish Brabant in the Pajottenland. It is a green, hilly region.",
    },
    facts: {
      de: ["Provinz Flämisch-Brabant", "Pajottenland Region", "Ländlich", "Hügelig"],
      hu: ["Flamand-Brabant tartomány", "Pajottenland régió", "Vidéki", "Dombos"],
      ro: ["Provincia Brabantul Flamand", "Regiunea Pajottenland", "Rural", "Deluros"],
      en: ["Flemish Brabant province", "Pajottenland region", "Rural", "Hilly"],
    },
    imageHint: "Lennik countryside landscape",
    descriptionAdvanced: {
      de: "Lennik liegt in der flämischen Provinz Flämisch-Brabant. Die Gegend ist Teil des hügeligen Pajottenlandes, das für seine reizvolle Landschaft und den traditionellen Anbau von Lambic-Bier berühmt ist.",
      hu: "Lennik a flamand Flamand-Brabant tartományban található. A terület a dombos Pajottenland része, amely festői tájairól és a hagyományos Lambic sörfőzéséről híres.",
      ro: "Lennik este situat în provincia flamandă Brabantul Flamand. Zona face parte din regiunea deluroasă Pajottenland, celebră pentru peisajul său pitoresc și pentru producția tradițională de bere Lambic.",
      en: "Lennik is situated in the Flemish province of Flemish Brabant. The area is part of the hilly Pajottenland, famous for its attractive landscape and the traditional brewing of Lambic beer.",
    },
    factsAdvanced: {
      de: ["Pajottenland", "Flämisch-Brabant", "Lambic-Bier-Tradition", "Hügellandschaft"],
      hu: ["Pajottenland", "Flamand-Brabant", "Lambic sörhagyomány", "Dombvidék"],
      ro: ["Pajottenland", "Brabantul Flamand", "Tradiția berii Lambic", "Regiune deluroasă"],
      en: ["Pajottenland", "Flemish Brabant", "Lambic beer tradition", "Hilly landscape"],
    },
  },
  {
    id: "belgium-leuze-en-hainaut-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Leuze-en-Hainaut", hu: "Leuze-en-Hainaut", ro: "Leuze-en-Hainaut", en: "Leuze-en-Hainaut" },
    coordinates: { lat: 50.5833, lng: 3.6167 },
    description: {
      de: "Leuze-en-Hainaut liegt in der Provinz Hennegau. Die Stadt ist ein lokaler Handelspunkt.",
      hu: "Leuze-en-Hainaut Hainaut tartományban fekszik. A város egy helyi kereskedelmi csomópont.",
      ro: "Leuze-en-Hainaut este situat în provincia Hainaut. Orașul este un centru comercial local.",
      en: "Leuze-en-Hainaut is located in the province of Hainaut. The city is a local commercial hub.",
    },
    facts: {
      de: ["Provinz Hennegau", "Lokaler Handel", "Regionale Geschichte", "Wallonisch"],
      hu: ["Hainaut tartomány", "Helyi kereskedelem", "Regionális történelem", "Vallon"],
      ro: ["Provincia Hainaut", "Comerț local", "Istorie regională", "Valon"],
      en: ["Hainaut province", "Local trade", "Regional history", "Walloon"],
    },
    imageHint: "Leuze-en-Hainaut town street",
    descriptionAdvanced: {
      de: "Bekannt für die Brauerei Dubuisson und die St. Peter-Stiftskirche, ist die Stadt ein Zentrum wallonischer Tradition im Hennegau mit fruchtbaren Böden.",
      hu: "Hainaut tartomány egyik jelentős városa, amely híres sörfőzési hagyományairól és a Szent Péter-templom lenyűgöző barokk orgonájáról.",
      ro: "Situat în provincia Hainaut, orașul este renumit pentru industria sa berii și arhitectura religioasă, fiind un nod feroviar important între Lille și Tournai.",
      en: "A historic town in Hainaut known for its long-standing brewing heritage, particularly the Dubuisson brewery, and its impressive collegiate church.",
    },
    factsAdvanced: {
      de: ["Fläche von 77,53 km²", "Bevölkerungszahl ca. 13.900", "Heimat des Bieres Bush (Scaldis)", "St. Peter Kirche aus 1745", "Nodpunkt der Bahnlinie 94", "60 km südwestlich von Brüssel"],
      hu: ["77,53 négyzetkilométer terület", "Lakosok száma 13 873 fő", "A Bush sört 1933 óta főzik itt", "Szent Péter templom barokk stílusú", "Tournai és Ath között fekszik", "Wallónia régió része"],
      ro: ["Suprafață totală de 77,53 km²", "Populație de aproximativ 13.900", "Berăria Dubuisson fondată în 1769", "Biserica Saint-Pierre (sec. XVIII)", "Situat la 48 m altitudine", "Provincia Hainaut, Belgia"],
      en: ["Total area of 77.53 sq km", "Population approximately 13,900", "Home to Dubuisson Brewery (1769)", "St. Peter's Church built in 1745", "Contains 10 former municipalities", "Located in the Hainaut province"],
    },
  },
  {
    ...
    coordinates: { lat: 50.8667, lng: 4.0833 },
    description: {
      de: "Liedekerke liegt in der Provinz Flämisch-Brabant an der Dender. Es ist eine Wohngemeinde nahe Brüssel.",
      hu: "Liedekerke Flamand-Brabant tartományban, a Dender folyó mentén fekszik. Lakóövezeti település Brüsszel közelében.",
      ro: "Liedekerke este situat în provincia Brabantul Flamand pe râul Dender. Este o comunitate rezidențială aproape de Bruxelles.",
      en: "Liedekerke is located in the province of Flemish Brabant on the Dender River. It is a residential municipality near Brussels.",
    },
    facts: {
      de: ["Provinz Flämisch-Brabant", "An der Dender", "Pendlerort", "Wohngebiet"],
      hu: ["Flamand-Brabant tartomány", "Dender folyó", "Ingázó település", "Lakóövezet"],
      ro: ["Provincia Brabantul Flamand", "Pe râul Dender", "Localitate de navetă", "Zonă rezidențială"],
      en: ["Flemish Brabant province", "On the Dender", "Commuter town", "Residential area"],
    },
    imageHint: "Liedekerke Dender river view",
    descriptionAdvanced: {
      de: "Die flämische Gemeinde am Rande des Pajottenlandes ist für ihren Waldreichtum und die Nähe zum Fluss Dender bekannt, ideal für Pendler nach Brüssel.",
      hu: "Flaman-Brabant tartományban fekvő település, amely a Dender folyó mentén helyezkedik el, és gazdag természeti értékekkel, mint a Liedekerkebos rendelkezik.",
      ro: "O municipalitate situată în Brabantul Flamand, faimoasă pentru pădurile sale și castelul istoric, oferind un refugiu verde în apropierea capitalei Bruxelles.",
      en: "Located in Flemish Brabant, this town serves as a green gateway near the Dender river, featuring the significant Liedekerkebos nature reserve.",
    },
    factsAdvanced: {
      de: ["Fläche von nur 10,08 km²", "Einwohnerzahl ca. 13.200", "Liedekerkebos umfasst 72 Hektar", "Bahnhof an der Linie Gent-Brüssel", "Region Pajottenland", "Postleitzahl ist 1770"],
      hu: ["Területe mindössze 10,08 km²", "Lakossága megközelíti a 13 300 főt", "Liedekerkebos erdő területe 72 ha", "Dender folyó keleti partján", "18 km-re Brüsszeltől", "Flamand-Brabant tartomány"],
      ro: ["Suprafață de 10,08 km²", "Populație de circa 13.250 locuitori", "Rezervația Liedekerkebos (72 ha)", "Altitudine maximă de 45 metri", "Situat în regiunea Flandra", "Cod poștal 1770"],
      en: ["Land area of 10.08 sq km", "Population around 13,300 people", "Liedekerkebos covers 72 hectares", "Located 18 km west of Brussels", "East of the Dender river", "Part of Flemish Brabant province"],
    },
  },
  {
    id: "belgium-lochristi-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Lochristi", hu: "Lochristi", ro: "Lochristi", en: "Lochristi" },
    coordinates: { lat: 51.0833, lng: 3.8333 },
    description: {
      de: "Lochristi liegt in Ostflandern nahe Gent. Es ist bekannt für seine Gartenbauindustrie.",
      hu: "Lochristi Kelet-Flandriában, Gent közelében fekszik. A kertészeti iparáról ismert.",
      ro: "Lochristi este situat în Flandra de Est aproape de Gent. Este cunoscut pentru industria horticolă.",
      en: "Lochristi is located in East Flanders near Ghent. It is known for its horticulture industry.",
    },
    facts: {
      de: ["Provinz Ostflandern", "Gartenbau", "Nahe Gent", "Blumenindustrie"],
      hu: ["Kelet-Flandria tartomány", "Kertészet", "Gent közelében", "Virágipar"],
      ro: ["Provincia Flandra de Est", "Horticultură", "Aproape de Gent", "Industria florilor"],
      en: ["East Flanders province", "Horticulture", "Near Ghent", "Flower industry"],
    },
    imageHint: "Lochristi plant nursery",
    descriptionAdvanced: {
      de: "Als Zentrum der belgischen Floristik ist Lochristi weltberühmt für den Anbau von Azaleen und Begonien sowie für seine historischen Parkanlagen.",
      hu: "Kelet-Flandria virágoskertjeként ismert város, ahol az azálea- és begónia-termesztés évszázados múltra tekint vissza a termékeny homoktalajon.",
      ro: "Renumit pentru horticultură, în special pentru cultivarea azaleelor, Lochristi este un centru economic vital în apropierea orașului Gent din Flandra de Est.",
      en: "Famous for its ornamental plant cultivation, particularly azaleas, this East Flemish town boasts a rich horticultural history and beautiful estates.",
    },
    factsAdvanced: {
      de: ["Fläche von 60,34 km²", "Einwohnerzahl ca. 22.800", "Zentrum der Azaleenzucht", "Schloss Beervelde (Park 25 ha)", "Gegründet um das Jahr 1200", "Provinz Ostflandern"],
      hu: ["60,34 négyzetkilométeres terület", "22 800 fős lakosság", "Az azálea-termesztés központja", "Beervelde kastélypark (25 ha)", "Genttől 10 km-re északkeletre", "Minden 4. évben virágfesztivál"],
      ro: ["Suprafață de 60,34 km²", "Peste 22.800 de locuitori", "Capitala azaleelor din Belgia", "Parcul Beervelde de 25 hectare", "Înființat oficial în 1977 (fuziune)", "Regiunea Flandra de Est"],
      en: ["Total area of 60.34 sq km", "Population of 22,830 (2022)", "Global center for Azalea breeding", "Park of Beervelde covers 25 ha", "Formed from 4 smaller villages", "Located in East Flanders"],
    },
  },
  {
    id: "belgium-malmedy-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Malmedy", hu: "Malmedy", ro: "Malmedy", en: "Malmedy" },
    coordinates: { lat: 50.4167, lng: 6.0333 },
    description: {
      de: "Malmedy liegt in der Provinz Lüttich in den Ardennen. Die Stadt ist für ihre historischen Feste und Lage bekannt.",
      hu: "Malmedy a Liège tartományban, az Ardennekben fekszik. A város a történelmi fesztiváljairól és elhelyezkedéséről ismert.",
      ro: "Malmedy este situat în provincia Liège în Ardeni. Orașul este cunoscut pentru festivalurile sale istorice și locația sa.",
      en: "Malmedy is located in the province of Liège in the Ardennes. The city is known for its historic festivals and location.",
    },
    facts: {
      de: ["Provinz Lüttich", "Ardennen Region", "Karnevalstradition", "Tourismus"],
      hu: ["Liège tartomány", "Ardennek régió", "Karneváli hagyomány", "Turizmus"],
      ro: ["Provincia Liège", "Regiunea Ardeni", "Tradiția carnavalului", "Turism"],
      en: ["Liège province", "Ardennes region", "Carnival tradition", "Tourism"],
    },
    imageHint: "Malmedy town center",
    descriptionAdvanced: {
      de: "Die Stadt im Osten Belgiens liegt am Fuße des Hohen Venns und ist bekannt für ihre historische Abtei sowie den traditionellen Karneval Cwarmê.",
      hu: "Az Ardennek szívében fekvő város, amely német-belga kulturális hatásairól, barokk katedrálisáról és a világháborús emlékműveiről nevezetes.",
      ro: "Situat în provicia Liège, orașul Malmedy este celebru pentru carnavalul său multisecular și proximitatea față de rezervația naturală Hautes Fagnes.",
      en: "A key cultural hub in the East Cantons, Malmedy is renowned for its cathedral, historic abbey complex, and its vibrant folklore traditions.",
    },
    factsAdvanced: {
      de: ["Fläche von 99,96 km²", "Einwohnerzahl ca. 12.800", "Abtei Malmedy (648 n. Chr.)", "Karneval Cwarmê (4 Tage lang)", "Ehemaliges Preußen (1815-1920)", "Warche-Fluss durchquert die Stadt"],
      hu: ["99,96 négyzetkilométer terület", "Lakosok száma 12 800 fő", "648-ban alapított bencés apátság", "Cwarmê karnevál (450 éves múlt)", "Hohes Venn természetvédelmi terület", "Német nyelvű közösség határán"],
      ro: ["Suprafață de 99,96 km²", "Populație de circa 12.850", "Catedrala Sfinților Petru și Pavel", "Carnavalul Cwarmê în limba valonă", "Masacrul de la Malmedy (1944)", "Parte din Cantoanele de Est"],
      en: ["Total area of 99.96 sq km", "Population around 12,800", "Abbey founded in 648 AD", "Cwarmê carnival lasts 4 days", "Massacre site memorial nearby", "Located in the Liège province"],
    },
  },
  {
    ...
    coordinates: { lat: 50.2333, lng: 5.35 },
    description: {
      de: "Marche-en-Famenne liegt in der Provinz Luxemburg. Es ist ein regionales Zentrum in der Famenne-Region.",
      hu: "Marche-en-Famenne Luxemburg tartományban fekszik. Regionális központ a Famenne régióban.",
      ro: "Marche-en-Famenne este situat în provincia Luxemburg. Este un centru regional în regiunea Famenne.",
      en: "Marche-en-Famenne is located in the province of Luxembourg. It is a regional center in the Famenne region.",
    },
    facts: {
      de: ["Provinz Luxemburg", "Famenne Region", "Regionales Zentrum", "Historischer Kern"],
      hu: ["Luxemburg tartomány", "Famenne régió", "Regionális központ", "Történelmi központ"],
      ro: ["Provincia Luxemburg", "Regiunea Famenne", "Centru regional", "Centru istoric"],
      en: ["Luxembourg province", "Famenne region", "Regional center", "Historic center"],
    },
    imageHint: "Marche-en-Famenne street",
    descriptionAdvanced: {
      de: "Diese modernisierte Stadt in der Provinz Luxemburg gilt als Tor zu den Ardennen und bewahrt ein mittelalterliches Zentrum mit reichem Kulturerbe.",
      hu: "Luxemburg tartomány egyik legdinamikusabb városa, amely sikeres városrehabilitációjáról, csipkeverő hagyományairól és az Ardennek kapujaként ismert.",
      ro: "O bijuterie a regiunii Famenne, orașul îmbină armonios arhitectura medievală cu modernismul, fiind un punct strategic pentru turismul montan belgian.",
      en: "Known as the capital of the Famenne region, this town is celebrated for its award-winning urban restoration and its strategic position in the Ardennes.",
    },
    factsAdvanced: {
      de: ["Fläche von 121,40 km²", "Einwohnerzahl ca. 17.600", "Tor zu den Ardennen", "St. Remaklus Kirche", "Spitzenklöppel-Tradition", "Renovierungspreis 2011 (EDDEN)"],
      hu: ["121,4 négyzetkilométeres terület", "Lakosok száma 17 600 fő", "Famenne régió központja", "Híres a Marche-i csipkéről", "Szent Remaclus templom", "Középkori városfal maradványok"],
      ro: ["Suprafață de 121,40 km²", "Populație de 17.600 locuitori", "Poarta de intrare în Ardeni", "Biserica Saint-Remacle", "Muzeul Familiei (Famenne)", "Altitudine medie de 200 m"],
      en: ["Total area of 121.4 sq km", "Population about 17,600", "Capital of the Famenne area", "Famous for handmade lace", "St. Remaclus Collegiate Church", "Strategic military camp nearby"],
    },
  },
  {
    id: "belgium-mortsel-cities-v2",
    type: "city",
    parent: "BE",
    name: { de: "Mortsel", hu: "Mortsel", ro: "Mortsel", en: "Mortsel" },
    coordinates: { lat: 51.1667, lng: 4.45 },
    description: {
      de: "Mortsel liegt in der Provinz Antwerpen südlich von Antwerpen. Es ist eine dicht besiedelte Vorstadt.",
      hu: "Mortsel Antwerpen tartományban, Antwerpentől délre fekszik. Sűrűn lakott külváros.",
      ro: "Mortsel este situat în provincia Anvers la sud de Anvers. Este o suburbie dens populată.",
      en: "Mortsel is located in the province of Antwerp south of Antwerp. It is a densely populated suburb.",
    },
    facts: {
      de: ["Provinz Antwerpen", "Vorstadt", "Wohngebiet", "Verkehrsgünstig"],
      hu: ["Antwerpen tartomány", "Külváros", "Lakóhely", "Jó közlekedés"],
      ro: ["Provincia Anvers", "Suburbie", "Zonă rezidențială", "Accesibil"],
      en: ["Antwerp province", "Suburb", "Residential area", "Accessible"],
    },
    imageHint: "Mortsel town view",
    descriptionAdvanced: {
      de: "Die dicht besiedelte Stadt bei Antwerpen beherbergt das historische Fort IV und ist der Hauptsitz des weltbekannten Industrieunternehmens Agfa-Gevaert.",
      hu: "Antwerpen közvetlen közelében fekvő iparváros, amely az Agfa-Gevaert gyárnak ad otthont, és területén található a Brialmont-védvonal egyik erődje.",
      ro: "Un centru industrial și rezidențial dens în provincia Anvers, Mortsel este marcat de istoria Fortului IV și de moștenirea fotografică a companiei Agfa.",
      en: "A highly urbanized municipality in Antwerp, Mortsel is defined by its industrial prowess, the historic Fort IV, and its significant transit infrastructure.",
    },
    factsAdvanced: {
      de: ["Fläche nur 7,78 km²", "Bevölkerung ca. 26.200", "Hauptsitz von Agfa-Gevaert", "Fort IV (Brialmont-Gürtel)", "Bombenangriff am 5. April 1943", "Provinz Antwerpen"],
      hu: ["Területe 7,78 négyzetkilométer", "Népsűrűség: 3360 fő/km²", "Agfa-Gevaert központja", "Fort IV erődrendszer", "1943-as szövetséges légitámadás", "Antwerpen elővárosa"],
      ro: ["Suprafață mică de 7,78 km²", "Populație de peste 26.200", "Sediu Agfa-Gevaert (foto/tech)", "Fortul IV construit în 1860-1864", "Bombardamentul din 5 aprilie 1943", "Situat în provincia Anvers"],
      en: ["Compact area of 7.78 sq km", "Population of 26,170 (2021)", "HQ of Agfa-Gevaert Group", "Fort IV (built 1860-1864)", "Site of WWII air raid tragedy", "Part of the Antwerp province"],
    },
  }
];
