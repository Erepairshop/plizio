...
const extraSpainPoi: POI[] = [
{
  ...
  "description": {
    ...
    "hu": "A sevillai Alcazar egy királyi palotaegyüttes erős mór és keresztény hatással. Kertjei, udvarai és díszes belső terei Andalúzia egyik leglátványosabb helyévé teszik.",
    "ro": "Alcazarul din Sevilla este un complex palatin regal cu puternice influențe maure și creștine. Grădinile, curțile și interioarele sale ornamentate îl fac unul dintre cele mai impresionante locuri din Andaluzia.",
  ...
  "facts": {
    ...
    "ro": ["Încă este reședință folosită de familia regală spaniolă la vizite.", "Patrimoniu Mondial UNESCO.", "Unul dintre cele mai vechi palate aflate încă în uz din Europa.", "A fost decor pentru numeroase producții de film."],
...
},
{
  ...
  "description": {
    ...
    "hu": "A Coca kastélya egy feltűnő téglavár Kasztíliában és Leónban. Évérével és bütykös falaival látványosan mutatja be a késő középkori katonai építészetet.",
    "ro": "Castelul Coca este o fortăreață impresionantă din cărămidă în Castilia și León. Cu șanțul și crenelurile sale, arată spectaculos arhitectura militară târziu medievală.",
  ...
  "facts": {
    ...
    "hu": ["A gótika és a mudéjar stílus keverékéről híres.", "A 15. században a Fonseca család számára épült.", "Spanyolország egyik legjobb állapotban fennmaradt téglavára.", "Az évér fontos védelmi elem."],
    "ro": ["Celebru pentru amestecul de gotic și mudéjar.", "A fost construit în secolul al XV-lea pentru familia Fonseca.", "Este unul dintre cele mai bine păstrate castele de cărămidă din Spania.", "Șanțul este un element defensiv important."],
...
},
{
  ...
  "description": {
    ...
    "hu": "A segoviai Alcazar látványosan magasodik két folyó találkozásánál. Az erődszerű királyi rezidencia Kasztília egyik legismertebb jelképe, és mesebeli kastélyra emlékeztet.",
    "ro": "Alcazarul din Segovia se ridică dramatic deasupra confluenței a două râuri. Reședința regală cu aspect de fortăreață este unul dintre cele mai cunoscute simboluri ale Castiliei și amintește de un castel de poveste.",
  ...
  "facts": {
    ...
    "hu": ["Évszázadokon át királyi palotaként szolgált.", "Segovia óvárosának UNESCO világörökségi része.", "Jellegzetes sziluettje Disney-ihletést is adott.", "Képízű tornyairól híres."],
    "ro": ["A servit secole drept palat regal.", "Face parte din patrimoniul UNESCO al vechiului oraș Segovia.", "Silueta sa distinctivă a inspirat ilustrații Disney.", "Este faimos pentru turnurile sale conice."],
...
},
{
  ...
  "description": {
    "de": "Der Königspalast in Madrid ist die offizielle Residenz der spanischen Monarchie bei Zeremonien. Mit seinen repräsentativen Sälen und der großen Fassade zählt er zu den bedeutendsten Palästen Europas.",
    "hu": "A madridi királyi palota a spanyol monarchia hivatalos ceremoniális rezidenciája. Pompás termeivel és nagy homlokzatával Európa egyik legjelentősebb palotája.",
    "ro": "Palatul Regal din Madrid este reședința oficială ceremonială a monarhiei spaniole. Cu sălile sale reprezentative și fațada impunătoare, este unul dintre cele mai importante palate ale Europei.",
  ...
  "facts": {
    "de": ["Größter Königspalast Westeuropas nach Grundfläche.", "Heute hauptsächlich für Staatszeremonien genutzt.", "Mehr als 3.000 Räume im gesamten Komplex.", "Die Wachablösung zieht viele Besucher an."],
    "hu": ["Nyugat-Európa legnagyobb alapterületű királyi palotája.", "Ma főként állami ceremóniákra használják.", "Több mint 3000 helyiség tartozik az együtteshez.", "Az őrségváltás sok látogatót vonz."],
    "ro": ["Cel mai mare palat regal din Europa de Vest ca suprafață.", "Astăzi este folosit mai ales pentru ceremonii de stat.", "Ansamblul are peste 3.000 de camere.", "Schimbarea gărzii atrage mulți vizitatori."],
...
},
{
  ...
  "description": {
    ...
    "hu": "A zaragozai Aljaferia egy pompás iszlám palota, amelyet később királyi székhellyé átalakítottak. Észak-Spanyolország egyik legfontosabb mór művészeti emléke.",
    "ro": "Aljaferia din Zaragoza este un palat islamic splendid, transformat ulterior în reședință regală. Este unul dintre cele mai importante exemple de artă maură din nordul Spaniei.",
  ...
  "facts": {
    ...
    "hu": ["UNESCO világörökség Aragónia mudéjar építészetének részeként.", "A 11. században épült.", "Később az aragóniai királyok székhelye lett.", "Ma Aragónia regionális parlamentjének ad otthont."],
    "ro": ["Patrimoniu Mondial UNESCO ca parte a arhitecturii mudéjar din Aragon.", "Construit în secolul al XI-lea.", "A devenit ulterior reședința regilor Aragonului.", "Astăzi găzduiește parlamentul regional din Aragon."],
...
},
{
  ...
  "description": {
    "de": "Der Teide ist Spaniens höchster Berg und ein aktiver Vulkan auf Teneriffa. Die markante Gipfellandschaft prägt die Kanarischen Inseln und zieht Naturliebhaber und Wanderer gleichermaßen an.",
    "hu": "A Teide Spanyolország legmagasabb hegye és egy aktív vulkán Tenerifén. Jellegzetes csúcskörnyezete meghatározza a Kanári-szigetek képét, és a természetkedvelőket és a túrázókat is vonzza.",
    "ro": "Teide este cel mai înalt munte din Spania și un vulcan activ din Tenerife. Peisajul său vulcanic distinctiv definește Insulele Canare și atrage deopotrivă iubitori ai naturii și drumeți.",
  ...
  "facts": {
    ...
    "ro": ["Cu 3.718 metri, este cel mai înalt munte din Spania.", "Parcul Național Teide este patrimoniu UNESCO.", "Unul dintre cele mai vizitate parcuri naționale din Europa.", "Peisajul vulcanic pare uneori lunar."],
...
},
{
  ...
  "description": {
    ...
    "ro": "Cabo de Gata este o zonă costieră și naturală protejată din Almería. Peisajul vulcanic arid se întâlnește aici cu golfuri, stânci și Marea Mediterană limpede.",
  ...
  "facts": {
    ...
    "hu": ["A Cabo de Gata-Níjar természeti park része.", "Európa egyik legszárazabb régiója.", "Érintetlen strandjai és snorkelezési helyei népszerűek.", "A táj gyakori filmforgatóhelyszín."],
    "ro": ["Face parte din Parcul Natural Cabo de Gata-Níjar.", "Una dintre cele mai aride regiuni din Europa.", "Populară pentru plajele sălbatice și snorkeling.", "Peisajul a fost adesea folosit ca platou de filmare."],
...
},
{
  ...
  "parent": "ES-AN",
  "coords": [-2.456, 37.005],
  "name": {"de": "Tabernas Wüste", "hu": "Tabernas sivatag", "ro": "Deșertul Tabernas", "en": "Tabernas Desert"},
  "description": {
    ...
    "hu": "Az andalúziai Tabernas sivatag Európa egyetlen igazi félsivataga. Száraz völgyeivel és kopasz dombjaival erősen emlékeztet a klasszikus westernek tájaira.",
    "ro": "Deșertul Tabernas din Andaluzia este singurul semi-deșert adevărat al Europei. Cu văile sale uscate și colinele golașe, seamănă mult cu peisajele western clasice.",
  ...
  "facts": {
    ...
    "ro": ["Climă foarte uscată, cu puține precipitații.", "Cunoscut ca loc de filmare pentru westernuri.", "Face parte din provincia Almería.", "Vegetația este foarte rară."],
...
},
{
  ...
  "description": {
    "de": "Die Playa de las Catedrales in Galicien ist für ihre natürlichen Felsbögen und Höhlen bekannt. Bei Ebbe lässt sich die beeindruckende Steilküste besonders gut zu Fuß erkunden.",
    "hu": "A galiciai Playa de las Catedrales természetes sziklaíveiről és barlangjairól híres. Apály idején a lenyűgöző sziklás part különösen jól bejárható gyalog.",
    "ro": "Playa de las Catedrales din Galicia este cunoscută pentru arcadele naturale de piatră și peșteri. La reflux, coasta impresionantă poate fi explorată foarte bine pe jos.",
  ...
  "facts": {
    ...
    "ro": ["Numele vine de la formațiunile stâncoase asemănătoare catedralelor.", "Se vizitează cel mai bine la reflux.", "Destinație naturală populară pe coasta Galiciei.", "Face parte din comuna Ribadeo."],
...
},
{
  ...
  "parent": "ES-AN",
  "coords": [-6.433, 37.05],
  "name": {"de": "Doñana Nationalpark", "hu": "Doñana Nemzeti Park", "ro": "Parcul Național Doñana", "en": "Doñana National Park"},
  "description": {
    ...
    "hu": "A Doñana Nemzeti Park Európa egyik legfontosabb vizes élőhelye. Mocsarai, dünéi és ártérei kulcsfontosságúak a vonuló madarak és a veszélyeztetett fajok számára.",
    "ro": "Parcul Național Doñana este una dintre cele mai importante zone umede din Europa. Mlaștinile, dunele și zonele inundabile sunt esențiale pentru păsările migratoare și speciile amenințate.",
...
},
{
  ...
  "name": {"de": "Costa Brava", "hu": "Costa Brava", "ro": "Costa Brava", "en": "Costa Brava"},
  "description": {
    "de": "Die Costa Brava ist der wilde, felsige Küstenabschnitt Kataloniens. Zwischen Buchten, Stränden und Fischerdörfern verbindet sie Natur, Meer und mediterranes Lebensgefühl.",
    "hu": "A Costa Brava Katalónia vad, sziklás partszakasza. Öblök, strandok és halászfalvak között ötvözi a természetet, a tengert és a mediterrán hangulatot.",
    "ro": "Costa Brava este sectorul sălbatic și stâncos al coastei Cataloniei. Între golfuri, plaje și sate de pescari, combină natura, marea și atmosfera mediteraneană.",
...
},
{
  ...
  "name": {"de": "Prado Museum", "hu": "Prado Múzeum", "ro": "Muzeul Prado", "en": "Prado Museum"},
  "description": {
    "de": "Das Prado Museum ist Spaniens bedeutendstes Kunstmuseum und ein Kernstück des Madrider Kunstdreiecks. Es beherbergt einige der wichtigsten Werke der europäischen Malerei.",
    "hu": "A Prado Múzeum Spanyolország legfontosabb művészeti múzeuma és a madridi művészeti háromszög központi eleme. Az európai festészet néhány legjelentősebb alkotásának ad otthont.",
    "ro": "Muzeul Prado este cel mai important muzeu de artă din Spania și o piesă centrală a Triunghiului de Aur al artei din Madrid. Adăpostește unele dintre cele mai importante opere ale picturii europene.",
  ...
  "facts": {
    "de": ["Berühmt für Gemälde von Velázquez, Goya und El Greco.", "Geöffnet wurde es 1819.", "Eines der meistbesuchten Museen Europas.", "Teil des Paseo del Arte."],
    "hu": ["Velázquez, Goya és El Greco festményeiről híres.", "1819-ben nyították meg.", "Európa egyik legtöbbet látogatott múzeuma.", "A Paseo del Arte része."],
    "ro": ["Celebru pentru picturi de Velázquez, Goya și El Greco.", "A fost inaugurat în 1819.", "Unul dintre cele mai vizitate muzee din Europa.", "Face parte din Paseo del Arte."],
    "en": ["Famous for paintings by Velázquez, Goya, and El Greco.", "Opened in 1819.", "One of Europe's most visited museums.", "Part of the Paseo del Arte."]
  }
},
{
  ...
  "description": {
    ...
    "ro": "Muzeul Guggenheim din Bilbao este un simbol al arhitecturii și artei moderne. Clădirea futuristă din titan a schimbat radical silueta orașului și imaginea internațională a Bilbao.",
...
},
{
  ...
  "description": {
    ...
    "hu": "A Plaza Mayor Madrid híres történelmi főtere. Zárt árkádsora és hosszú homlokzatai a város egyik központi találkozóhelyévé teszik.",
    "ro": "Plaza Mayor este celebra piață istorică principală a Madridului. Forma sa închisă cu arcade și fațadele lungi o fac un punct central de întâlnire al orașului.",
  ...
  "facts": {
    ...
    "ro": ["S-a format în secolul al XVII-lea.", "A fost scena piețelor, festivalurilor și evenimentelor publice.", "Este înconjurată de clădiri rezidențiale cu trei etaje.", "Una dintre cele mai cunoscute imagini de carte poștală ale Madridului."],
...
},
{
  ...
  "description": {
    "de": "Die Mezquita-Catedral von Cordoba vereint eine ehemalige Moschee und eine christliche Kathedrale in einem einzigartigen Bauwerk. Die rot-weißen Bögen im Inneren gehören zu den berühmtesten Bildern Spaniens.",
    "hu": "A cordobai Mezquita-Katedrális egykori mecsetet és keresztény katedrálist egyesít egyedülálló építményben. A belső tér vörös-fehér ívei Spanyolország legismertebb képei közé tartoznak.",
    "ro": "Mezquita-Catedral din Cordoba unește într-o singură clădire unică o fostă moschee și o catedrală creștină. Arcadele roșu-alb din interior sunt printre cele mai faimoase imagini din Spania.",
  ...
  "facts": {
    ...
    "hu": ["UNESCO világörökség.", "Eredetileg a 8. században mecsetként épült.", "Később katedrálissá alakították.", "Híres a számtalan oszlopból álló csarnokról."],
    "ro": ["Patrimoniu Mondial UNESCO.", "Construită inițial în secolul al VIII-lea ca moschee.", "Ulterior transformată în catedrală.", "Faimoasă pentru sala hipostilă cu sute de coloane."],
...
},
{
  ...
  "description": {
    ...
    "ro": "Catedrala din Santiago de Compostela este destinația celebrului Camino de Santiago. Ca centru spiritual al Galiciei, domină centrul vechi și viața pelerinilor.",
  ...
  "facts": {
    ...
    "hu": ["Egész Európából érkező zándokok célpontja a Szent Jakab-úton.", "Az óváros UNESCO világörökség.", "Az apostol Jakab sírhelyének tartják.", "A barokk homlokzat meghatározza a városképet."],
    "ro": ["Destinație pentru pelerini din întreaga Europă pe Camino de Santiago.", "Patrimoniu UNESCO al centrului istoric.", "Este considerată locul de înmormântare al apostolului Iacob.", "Fațada barocă domină imaginea orașului."],
...
export const spainProvinces: POI[] = [
  ...
  { id: "ES-AL", type: "region", parent: "ES-AN", coords: [-2.4598, 37.1825], name: { de: "Almería", hu: "Almería", ro: "Almeria", en: "Almería" }, description: { de: "Wüstenlandschaft im Südosten Andalusiens.", hu: "Sivatagi táj Andalúzia délkeleti részén.", ro: "Peisaj deșertic în sud-estul Andaluziei.", en: "Desert landscape in southeastern Andalusia." } },
  { id: "ES-CA", type: "region", parent: "ES-AN", coords: [-5.9845, 36.5271], name: { de: "Cádiz", hu: "Cádiz", ro: "Cadiz", en: "Cádiz" }, description: { de: "Küstenprovinz mit historischer Hafenstadt.", hu: "Tengerparti tartomány történelmi kikötővárossal.", ro: "Provincie costieră cu oraș-port istoric.", en: "Coastal province with a historic port city." } },
  { id: "ES-CO", type: "region", parent: "ES-AN", coords: [-4.7794, 37.8927], name: { de: "Córdoba", hu: "Córdoba", ro: "Córdoba", en: "Córdoba" }, description: { de: "Heimat der berühmten Mezquita.", hu: "A famous Mezquita otthona.", ro: "Patria faimoasei Mezquita.", en: "Home of the famous Mezquita." } },
  { id: "ES-GR", type: "region", parent: "ES-AN", coords: [-3.5986, 37.1773], name: { de: "Granada", hu: "Granada", ro: "Granada", en: "Granada" }, description: { de: "Provinz mit der Alhambra.", hu: "Az Alhambra tartománya.", ro: "Provincie cu Alhambra.", en: "Province home to the Alhambra." } },
  { id: "ES-H",  type: "region", parent: "ES-AN", coords: [-6.9447, 37.2614], name: { de: "Huelva", hu: "Huelva", ro: "Huelva", en: "Huelva" }, description: { de: "Ausgangspunkt von Kolumbus' Reise.", hu: "Kolumbusz útjának kiindulópontja.", ro: "Punctul de plecare al lui Columb.", en: "Starting point of Columbus's voyage." } },
  { id: "ES-J",  type: "region", parent: "ES-AN", coords: [-3.7905, 37.7796], name: { de: "Jaén", hu: "Jaén", ro: "Jaén", en: "Jaén" }, description: { de: "Weltgrößter Olivenölproduzent.", hu: "A világ legnagyobb olívaolaj-termelője.", ro: "Cel mai mare producător de ulei de măsline din lume.", en: "World's largest olive oil producer." } },
  { id: "ES-MA", type: "region", parent: "ES-AN", coords: [-4.4214, 36.7213], name: { de: "Málaga", hu: "Málaga", ro: "Malaga", en: "Málaga" }, description: { de: "Geburtsort Picassos und Costa del Sol.", hu: "Picasso szülőhelye és a Costa del Sol.", ro: "Locul nașterii lui Picasso și Costa del Sol.", en: "Birthplace of Picasso and the Costa del Sol." } },
  { id: "ES-SE", type: "region", parent: "ES-AN", coords: [-5.9845, 37.3891], name: { de: "Sevilla", hu: "Sevilla", ro: "Sevilla", en: "Sevilla" }, description: { de: "Hauptstadt Andalusiens mit Kathedrale und Alcázar.", hu: "Andalúzia fővárosa katedrálissal és Alcázarral.", ro: "Capitala Andaluziei cu catedrala și Alcázar.", en: "Capital of Andalusia with its cathedral and Alcázar." } },
  // Aragón (ES-AR) — 3 provinces
  { id: "ES-HU", type: "region", parent: "ES-AR", coords: [-0.4083, 42.1401], name: { de: "Huesca", hu: "Huesca", ro: "Huesca", en: "Huesca" }, description: { de: "Pyrenäenprovinz im Norden Aragóns.", hu: "Pireneusi tartomány Aragónia északi részén.", ro: "Provincie pireneeană în nordul Aragonului.", en: "Pyrenean province in northern Aragon." } },
  { id: "ES-TE", type: "region", parent: "ES-AR", coords: [-1.1065, 40.3456], name: { de: "Teruel", hu: "Teruel", ro: "Teruel", en: "Teruel" }, description: { de: "Bekannt für Mudéjar-Architektur.", hu: "Mudéjar-építészetéről ismert.", ro: "Cunoscut pentru arhitectura mudéjar.", en: "Known for its Mudéjar architecture." } },
  { id: "ES-Z",  type: "region", parent: "ES-AR", coords: [-0.8773, 41.6561], name: { de: "Zaragoza", hu: "Zaragoza", ro: "Zaragoza", en: "Zaragoza" }, description: { de: "Hauptprovinz Aragóns mit der Basilika del Pilar.", hu: "Aragónia fő tartománya a Pilar-bazilikával.", ro: "Provincia principală a Aragonului cu Basilica del Pilar.", en: "Main province of Aragon with the Basilica del Pilar." } },
  // Asturias (ES-AS) — 1 province
  { id: "ES-O",  type: "region", parent: "ES-AS", coords: [-5.9630, 43.3614], name: { de: "Asturien", hu: "Asztúria", ro: "Asturia", en: "Asturias" }, description: { de: "Grüne Küstenregion im Norden.", hu: "Zöld tengerparti régió az északi részen.", ro: "Regiune costieră verde în nord.", en: "Green coastal region in the north." } },
  // Baleares (ES-IB) — 1 province
  { id: "ES-PM", type: "region", parent: "ES-IB", coords: [2.9002, 39.6953], name: { de: "Balearen", hu: "Baleárok", ro: "Baleare", en: "Balearic Islands" }, description: { de: "Mittelmeerinselgruppe mit Mallorca, Menorca, Ibiza.", hu: "Földközi-tengeri szigetcsoport Mallorcával, Menorcával, Ibizával.", ro: "Arhipelag mediteranean cu Mallorca, Menorca, Ibiza.", en: "Mediterranean island group with Mallorca, Menorca, Ibiza." } },
  // Canarias (ES-CN) — 2 provinces
  { id: "ES-GC", type: "region", parent: "ES-CN", coords: [-15.5701, 28.1235], name: { de: "Las Palmas", hu: "Las Palmas", ro: "Las Palmas", en: "Las Palmas" }, description: { de: "Östliche Kanarische Inseln.", hu: "Keleti Kanári-szigetek.", ro: "Insulele Canare de est.", en: "Eastern Canary Islands." } },
  ...
  { id: "ES-S",  type: "region", parent: "ES-CB", coords: [-3.9940, 43.1828], name: { de: "Kantabrien", hu: "Kantábria", ro: "Cantabria", en: "Cantabria" }, description: { de: "Küstenregion mit Altamira-Höhlen.", hu: "Tengerparti régió az Altamira-barlangokkal.", ro: "Regiune costieră cu peșterile Altamira.", en: "Coastal region with the Altamira caves." } },
  // Castilla-La Mancha (ES-CM) — 5 provinces
  { id: "ES-AB", type: "region", parent: "ES-CM", coords: [-1.8654, 38.9942], name: { de: "Albacete", hu: "Albacete", ro: "Albacete", en: "Albacete" }, description: { de: "Bekannt für Messerherstellung.", hu: "Késkészítéséről ismert.", ro: "Renumit pentru fabricarea cuțitelor.", en: "Known for its knife-making industry." } },
  { id: "ES-CR", type: "region", parent: "ES-CM", coords: [-3.9272, 38.9848], name: { de: "Ciudad Real", hu: "Ciudad Real", ro: "Ciudad Real", en: "Ciudad Real" }, description: { de: "Herz der La-Mancha-Ebene.", hu: "La Mancha síkságának szíve.", ro: "Inima câmpiei La Mancha.", en: "Heart of the La Mancha plain." } },
  { id: "ES-CU", type: "region", parent: "ES-CM", coords: [-2.1319, 40.0699], name: { de: "Cuenca", hu: "Cuenca", ro: "Cuenca", en: "Cuenca" }, description: { de: "UNESCO-Altstadt mit hängenden Häusern.", hu: "UNESCO óváros függő házakkal.", ro: "Centrul vechi UNESCO cu casele suspendate.", en: "UNESCO old town with hanging houses." } },
  { id: "ES-GU", type: "region", parent: "ES-CM", coords: [-2.6325, 40.6321], name: { de: "Guadalajara", hu: "Guadalajara", ro: "Guadalajara", en: "Guadalajara" }, description: { de: "Provinz östlich von Madrid.", hu: "Tartomány Madridtól keletre.", ro: "Provincie la est de Madrid.", en: "Province east of Madrid." } },
  { id: "ES-TO", type: "region", parent: "ES-CM", coords: [-3.9272, 39.8628], name: { de: "Toledo", hu: "Toledo", ro: "Toledo", en: "Toledo" }, description: { de: "Historische Kaiserstadt mit gotischer Kathedrale.", hu: "Történelmi császárváros gótikus katedrálissal.", ro: "Oraș imperial istoric cu catedrală gotică.", en: "Historic imperial city with Gothic cathedral." } },
  // Castilla y León (ES-CL) — 9 provinces
  { id: "ES-AV", type: "region", parent: "ES-CL", coords: [-4.6976, 40.6566], name: { de: "Ávila", hu: "Ávila", ro: "Avila", en: "Ávila" }, description: { de: "Komplett erhaltene mittelalterliche Stadtmauer.", hu: "Teljesen fennmaradt középkori városfal.", ro: "Zid medieval complet conservat.", en: "Completely preserved medieval city walls." } },
  { id: "ES-BU", type: "region", parent: "ES-CL", coords: [-3.7038, 42.3440], name: { de: "Burgos", hu: "Burgos", ro: "Burgos", en: "Burgos" }, description: { de: "Gotische Kathedrale und Heimat El Cids.", hu: "Gótikus katedrális és El Cid szülővárosa.", ro: "Catedrala gotică și patria lui El Cid.", en: "Gothic cathedral and birthplace of El Cid." } },
  { id: "ES-LE", type: "region", parent: "ES-CL", coords: [-5.5597, 42.5987], name: { de: "León", hu: "León", ro: "León", en: "León" }, description: { de: "Mittelalterliche Königsstadt im Nordwesten.", hu: "Középkori királyváros az északnyugati részen.", ro: "Oraș regal medieval în nord-vest.", en: "Medieval royal city in the northwest." } },
  { id: "ES-P",  type: "region", parent: "ES-CL", coords: [-4.5288, 42.0100], name: { de: "Palencia", hu: "Palencia", ro: "Palencia", en: "Palencia" }, description: { de: "Kleine Provinz mit romanischer Kunst.", hu: "Kis tartomány román stílusú művészettel.", ro: "Provincie mică cu artă romanică.", en: "Small province with Romanesque art." } },
  { id: "ES-SA", type: "region", parent: "ES-CL", coords: [-5.6640, 40.9701], name: { de: "Salamanca", hu: "Salamanca", ro: "Salamanca", en: "Salamanca" }, description: { de: "Universität und UNESCO-Altstadt.", hu: "Egyetemi város és UNESCO óváros.", ro: "Universitate și centru vechi UNESCO.", en: "University city and UNESCO old town." } },
  { id: "ES-SG", type: "region", parent: "ES-CL", coords: [-4.1180, 40.9429], name: { de: "Segovia", hu: "Segovia", ro: "Segovia", en: "Segovia" }, description: { de: "Römisches Aquädukt und Alcázar.", hu: "Római vízvezeték és Alcázar.", ro: "Apeduct roman și Alcázar.", en: "Roman aqueduct and Alcázar." } },
  { id: "ES-SO", type: "region", parent: "ES-CL", coords: [-2.4652, 41.7640], name: { de: "Soria", hu: "Soria", ro: "Soria", en: "Soria" }, description: { de: "Dünnstbesiedelte Provinz mit romanischem Erbe.", hu: "A legelmaradottabb tartomány román örökséggel.", ro: "Provincie slab populată cu moștenire romanică.", en: "Sparsely populated province with Romanesque heritage." } },
  { id: "ES-VA", type: "region", parent: "ES-CL", coords: [-4.7245, 41.6523], name: { de: "Valladolid", hu: "Valladolid", ro: "Valladolid", en: "Valladolid" }, description: { de: "Einstige Hauptstadt Spaniens.", hu: "Spanyolország egykori fővárosa.", ro: "Fosta capitală a Spaniei.", en: "Former capital of Spain." } },
  { id: "ES-ZA", type: "region", parent: "ES-CL", coords: [-5.7448, 41.5034], name: { de: "Zamora", hu: "Zamora", ro: "Zamora", en: "Zamora" }, description: { de: "Romanische Kathedrale am Duero.", hu: "Roman stílusú katedrális a Duero mentén.", ro: "Catedrală romanică pe Duero.", en: "Romanesque cathedral on the Duero." } },
  // Cataluña (ES-CT) — 4 provinces
  { id: "ES-B",  type: "region", parent: "ES-CT", coords: [2.1734, 41.3851], name: { de: "Barcelona", hu: "Barcelona", ro: "Barcelona", en: "Barcelona" }, description: { de: "Metropolprovinz mit Gaudís Meisterwerken.", hu: "Nagyvárosi tartomány Gaudí remekműveivel.", ro: "Provincie metropolitană cu capodoperele lui Gaudí.", en: "Metropolitan province with Gaudí's masterpieces." } },
  { id: "ES-GI", type: "region", parent: "ES-CT", coords: [2.8214, 41.9794], name: { de: "Girona", hu: "Girona", ro: "Girona", en: "Girona" }, description: { de: "Grenzprovinz zu Frankreich mit Costa Brava.", hu: "Franciaországgal határos tartomány a Costa Bravával.", ro: "Provincie la frontiera cu Franța, cu Costa Brava.", en: "Border province with France and the Costa Brava." } },
  { id: "ES-L",  type: "region", parent: "ES-CT", coords: [0.6273, 41.6175], name: { de: "Lleida", hu: "Lleida", ro: "Lleida", en: "Lleida" }, description: { de: "Inland-Pyrenäenprovinz.", hu: "Belső pireneusi tartomány.", ro: "Provincie interioară pireneeană.", en: "Inland Pyrenean province." } },
  { id: "ES-T",  type: "region", parent: "ES-CT", coords: [1.2493, 41.1189], name: { de: "Tarragona", hu: "Tarragona", ro: "Tarragona", en: "Tarragona" }, description: { de: "Römische Ruinen und Costa Daurada.", hu: "Római romok és a Costa Daurada.", ro: "Ruine romane și Costa Daurada.", en: "Roman ruins and the Costa Daurada." } },
  // Extremadura (ES-EX) — 2 provinces
  { id: "ES-BA", type: "region", parent: "ES-EX", coords: [-6.9706, 38.8794], name: { de: "Badajoz", hu: "Badajoz", ro: "Badajoz", en: "Badajoz" }, description: { de: "Größte Provinz Spaniens.", hu: "Spanyolország legnagyobb tartománya.", ro: "Cea mai mare provincie a Spaniei.", en: "Largest province in Spain." } },
  { id: "ES-CC", type: "region", parent: "ES-EX", coords: [-6.3724, 39.4753], name: { de: "Cáceres", hu: "Cáceres", ro: "Cáceres", en: "Cáceres" }, description: { de: "UNESCO-Altstadt mit Kolonialarchitektur.", hu: "UNESCO óváros gyarmati építészettel.", ro: "Centru vechi UNESCO cu arhitectură colonială.", en: "UNESCO old town with colonial architecture." } },
  // Galicia (ES-GA) — 4 provinces
  { id: "ES-C",  type: "region", parent: "ES-GA", coords: [-8.4110, 43.0097], name: { de: "A Coruña", hu: "A Coruña", ro: "A Coruña", en: "A Coruña" }, description: { de: "Atlantikküste mit Santiago de Compostela.", hu: "Atlanti partvonal Santiago de Compostelával.", ro: "Coastă atlantică cu Santiago de Compostela.", en: "Atlantic coast home to Santiago de Compostela." } },
  { id: "ES-LU", type: "region", parent: "ES-GA", coords: [-7.5560, 43.0097], name: { de: "Lugo", hu: "Lugo", ro: "Lugo", en: "Lugo" }, description: { de: "Komplette römische Stadtmauer.", hu: "Teljes római városfal.", ro: "Zid roman complet intact.", en: "Complete Roman city walls." } },
  { id: "ES-OR", type: "region", parent: "ES-GA", coords: [-7.8641, 42.3359], name: { de: "Ourense", hu: "Ourense", ro: "Ourense", en: "Ourense" }, description: { de: "Binnenlandprovinz mit Thermalquellen.", hu: "Belső tartomány termálforrásokkal.", ro: "Provincie interioară cu izvoare termale.", en: "Inland province with thermal springs." } },
  { id: "ES-PO", type: "region", parent: "ES-GA", coords: [-8.6440, 42.4330], name: { de: "Pontevedra", hu: "Pontevedra", ro: "Pontevedra", en: "Pontevedra" }, description: { de: "Küstenprovinz mit Rias Baixas.", hu: "Tengerparti tartomány a Rias Baixas öblökkel.", ro: "Provincie costieră cu Rias Baixas.", en: "Coastal province with the Rias Baixas." } },
  // La Rioja (ES-RI) — 1 province
  { id: "ES-LO", type: "region", parent: "ES-RI", coords: [-2.4452, 42.2871], name: { de: "La Rioja", hu: "La Rioja", ro: "La Rioja", en: "La Rioja" }, description: { de: "Weinbauprovinz weltberühmter Qualität.", hu: "Világhírű minőségű borvidék.", ro: "Provincie viticolă de renume mondial.", en: "Wine province of world-renowned quality." } },
  // Madrid (ES-MD) — 1 province
  { id: "ES-M",  type: "region", parent: "ES-MD", coords: [-3.7038, 40.4168], name: { de: "Madrid", hu: "Madrid", ro: "Madrid", en: "Madrid" }, description: { de: "Hauptstadtprovinz.", hu: "Fővárosi tartomány.", ro: "Provincia capitalei.", en: "Capital province." } },
  // Murcia (ES-MU) — 1 province
  { id: "ES-MC", type: "region", parent: "ES-MU", coords: [-1.1300, 37.9922], name: { de: "Murcia", hu: "Murcia", ro: "Murcia", en: "Murcia" }, description: { de: "Agrarprovinz im Südosten.", hu: "Mezőgazdasági tartomány délkeleten.", ro: "Provincie agricolă în sud-est.", en: "Agricultural province in the southeast." } },
  // Navarra (ES-NC) — 1 province
  { id: "ES-NA", type: "region", parent: "ES-NC", coords: [-1.6462, 42.6954], name: { de: "Navarra", hu: "Navarra", ro: "Navarra", en: "Navarre" }, description: { de: "Provinz mit dem berühmten Stierlauf in Pamplona.", hu: "Tartomány a pamplonai bikafuttatással.", ro: "Provincie cu alergarea taurilor la Pamplona.", en: "Province home to the famous Running of the Bulls in Pamplona." } },
  // País Vasco (ES-PV) — 3 provinces
  { id: "ES-BI", type: "region", parent: "ES-PV", coords: [-2.9349, 43.2630], name: { de: "Biskaya", hu: "Vizcaya", ro: "Vizcaya", en: "Biscay" }, description: { de: "Industrieprovinz mit Bilbao und Guggenheim.", hu: "Ipari tartomány Bilbaóval és a Guggenheimmel.", ro: "Provincie industrială cu Bilbao și Guggenheim.", en: "Industrial province with Bilbao and the Guggenheim." } },
  { id: "ES-SS", type: "region", parent: "ES-PV", coords: [-2.0038, 43.3183], name: { de: "Gipuzkoa", hu: "Gipuzkoa", ro: "Gipuzkoa", en: "Gipuzkoa" }, description: { de: "Baskenprovinz mit San Sebastián und Pincho-Küche.", hu: "Baszk tartomány San Sebastiánnal és pintxos konyhával.", ro: "Provincie bască cu San Sebastián și bucătăria pintxos.", en: "Basque province with San Sebastián and pintxos cuisine." } },
  { id: "ES-VI", type: "region", parent: "ES-PV", coords: [-2.6732, 42.8467], name: { de: "Álava", hu: "Álava", ro: "Alava", en: "Álava" }, description: { de: "Binnenbaskische Provinz mit Vitoria-Gasteiz.", hu: "Belső baszk tartomány Vitoria-Gasteizzel.", ro: "Provincie bască interioară cu Vitoria-Gasteiz.", en: "Inland Basque province with Vitoria-Gasteiz." } },
  // Comunitat Valenciana (ES-VC) — 3 provinces
  { id: "ES-A",  type: "region", parent: "ES-VC", coords: [-0.4907, 38.3452], name: { de: "Alicante", hu: "Alicante", ro: "Alicante", en: "Alicante" }, description: { de: "Costa Blanca und touristisches Zentrum.", hu: "Costa Blanca és turisztikai központ.", ro: "Costa Blanca și centru turistic.", en: "Costa Blanca and tourist center." } },
  { id: "ES-CS", type: "region", parent: "ES-VC", coords: [-0.0513, 39.9864], name: { de: "Castellón", hu: "Castellón", ro: "Castellon", en: "Castellón" }, description: { de: "Nördliche Valenciaküste.", hu: "Északi valenciai part.", ro: "Coasta valenciană de nord.", en: "Northern Valencia coast." } },
  { id: "ES-V",  type: "region", parent: "ES-VC", coords: [-0.3763, 39.4699], name: { de: "Valencia", hu: "Valencia", ro: "Valencia", en: "Valencia" }, description: { de: "Heimat der Paella und der Ciudad de las Artes.", hu: "A paella és a Ciudad de las Artes hazája.", ro: "Patria paellei și a Ciudad de las Artes.", en: "Home of paella and the Ciudad de las Artes." } },
];
