...
export const spainCountry: POI[] = [
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Spanyolország egy lenyűgöző ország az Ibériai-félszigeten, amely gazdag történelemmel és sokszínű kultúrával rendelkezik. A Földközi-tenger napsütötte strandjaitól a fenséges Pireneusokig az ország lélegzetelállító tájakat kínál. A spanyol kultúrát mélyen áthatja a római és a mór múlt öröksége, amely mind az építészetben, mind a mindennapi életben megmutatkozik. Gasztronómiailag Spanyolország világszerte ismert a tapaszokról, a paelláról és a kiváló minőségű borokról. A hagyományok és a modernitás tökéletes keveréke teszi a világ egyik legkedveltebb turisztikai célpontjává. Földrajz K7 – hegységek és folyók.",
...
export const spainRegions: POI[] = [
  {
    ...
    descriptionAdvanced: {
      de: "Galicien ist eine Region im Nordwesten Spaniens, die sich durch grüne Landschaften und eine keltisch geprägte Kultur auszeichnet.",
      hu: "Galícia Spanyolország legészaknyugatibb részén fekszik, és zord atlanti partvidékéről, mély tölcsértorkolatairól (ríák) és buja zöld tájairól ismert. A régiónak erős kelta öröksége van, amely visszaköszön a hagyományos dudás (gaitas) zenében és a misztikus helyi legendákban. A főváros, Santiago de Compostela a híres El Camino (Szent Jakab-út) végállomása és a keresztény zarándoklatok egyik legfontosabb központja.",
      ro: "Galicia este o comunitate autonomă situată în colțul de nord-vest al Spaniei, caracterizată prin peisajele sale verzi luxuriante, coasta accidentată și golfuri adânci. Spre deosebire de imaginea tipică a Spaniei însorite, Galicia împărtășește o moștenire celtică puternică, care rezonează în muzica sa tradițională cu cimpoi și în folclorul local. Regiunea este faimoasă ca fiind destinația finală a pelerinajului Camino de Santiago, atrăgând milioane de călători către capitala sa istorică.",
      en: "Galicia is an autonomous community in the northwest corner of Spain, distinctly characterized by its lush green landscapes, rugged coastline, and deep rías (coastal inlets). Unlike the typical sunny image of Spain, Galicia shares a stronger Celtic heritage, which resonates in its traditional music featuring the gaita (bagpipes) and local folklore. The region is famously the ultimate destination of the Camino de Santiago pilgrimage, drawing millions of walkers to its historic capital."
    },
    factsAdvanced: {
      de: [
        "Die galicische Küste (Costa da Morte) gilt als gefährliche Schifffahrtsroute.",
        "Die Region hat eine eigene Sprache, das Galicische (Galego), das dem Portugiesischen nahesteht.",
        "Der Herkulesturm in A Coruña ist einer der ältesten funktionierenden Leuchttürme der Welt.",
        "Santiago de Compostela ist seit 1985 UNESCO-Welterbe."
      ],
      hu: [
        "A galíciai partvonal (Costa da Morte) az egyik legveszélyesebb hajózási útvonal, innen ered a 'Halálpart' elnevezés is.",
        "A régió saját nyelvvel rendelkezik, a galíciai (galego) nyelv közelebbi rokonságban áll a portugállal, mint a spanyollal.",
        "A világ egyik legrégebbi máig működő világítótornya, a római kori Herkules-torony A Coruña városában található.",
        "A Santiago de Compostela-i óváros 1985 óta az UNESCO világörökség része."
      ],
      ro: [
        "Linia de coastă galiciană (Costa da Morte) este una dintre cele mai periculoase rute maritime, de aici provenind și numele de 'Coasta Morții'.",
        "Regiunea are propria sa limbă, galiciana (galego), care este mai strâns înrudită cu portugheza decât cu spaniola.",
        "Unul dintre cele mai vechi faruri din lume care funcționează și astăzi, Turnul lui Hercule din epoca romană, se află în orașul A Coruña.",
        "Centrul istoric al orașului Santiago de Compostela a fost declarat sit al Patrimoniului Mondial UNESCO în 1985."
      ],
      en: [
        ...
        "The Cíes Islands, part of a national park, are famous for pristine beaches and diverse marine life."
      ]
    },
    facts: {
