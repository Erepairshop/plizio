...
export const poiExtraIrelandCities: POI[] = [
  {
    ...
    factsAdvanced: {
      de: [
        "Ursprung als Wikinger-Siedlung im 10. Jahrhundert.",
        "Schauplatz der Belagerung von Drogheda 1649.",
        "Das St. Laurence Gate gilt als besterhaltenes Stadttor Irlands.",
        "Der River Boyne war zentral für den mittelalterlichen Handel.",
        "Teil des historischen Boyne Valley archäologischen Komplexes.",
        "Die Stadt erstreckt sich über zwei Grafschaften (Louth und Meath).",
        "Ehemals eine der bedeutendsten Handelsstädte der Pale-Region."
      ],
      hu: [
        "Viking településként jött létre a 10. században.",
        "Az 1649-es droghedai ostrom színhelye volt.",
        "A St. Laurence kapu az ország legjobb állapotú városkapuja.",
        "A Boyne folyó a középkori kereskedelem fő ütőere volt.",
        "A történelmi Boyne-völgy régészeti komplexum része.",
    ...
    }, image: "/poi-images/city-drogheda-extra.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Entwicklung zum Seebad ab Mitte des 19. Jahrhunderts.",
        "Bray Head erreicht eine Höhe von 241 Metern über dem Meer.",
        "Der Bray to Greystones Cliff Walk ist eine berühmte Wanderroute.",
        "Die Stadt liegt an der Grenze der Grafschaften Dublin und Wicklow.",
        "Historisch bedeutender Endpunkt der Dublin and Wicklow Railway.",
        "Jährlicher Austragungsort des populären Bray Air Display.",
        "Besitzt eine bedeutende maritime Geschichte seit dem 18. Jahrhundert."
      ],
      hu: [
        "A 19. század közepétől fejlődött fürdővárossá.",
        "A Bray Head 241 méter magasra emelkedik a tenger fölé.",
        "A Bray és Greystones közötti sziklasétány híres túraútvonal.",
        "A város Dublin és Wicklow megye határán fekszik.",
        "A Dublin-Wicklow vasútvonal történelmileg jelentős végpontja.",
    ...
    }, image: "/poi-images/city-bray-extra.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Ursprung als klösterliche Siedlung um 560 n. Chr.",
        "Swords Castle diente als Sitz des Erzbischofs von Dublin.",
        "Der Name Swords bedeutet 'reine Quelle'.",
      ...
      hu: [
        ...
        "A Swords-kastély a dublini érsek székhelyeként szolgált.",
        "A Swords név jelentése 'tiszta forrás'.",
        "Fontos helyszín a dublini nemzetközi repülőtér közelében.",
        "Az 1990-es évek óta erőteljes népességnövekedést mutat.",
