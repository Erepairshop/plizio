...
,
  {
    ...
    description: {
      ...
      ro: "Tal Moreeb este una dintre cele mai înalte dune de nisip din lume, situată în regiunea oazei Liwa din Abu Dhabi. Se ridică la peste 300 de metri.",
      en: "Tal Moreeb is one of the world's tallest sand dunes, located in the Liwa Oasis region of Abu Dhabi. It reaches a height of over 300 meters.",
    },
    facts: {
      de: ["Höchste Düne in den VAE mit ca. 300 m Höhe.", "Besitzt eine extreme Steigung von etwa 50 Grad.", "Austragungsort jährlicher Wüsten-Motorsportrennen.", "Gehört zum Leere Viertel (Rub al-Khali) Wüstensystem."],
      hu: ["Az Egyesült Arab Emírségek legmagasabb dűnéje, kb. 300 méter.", "Mereredek, mintegy 50 fokos lejtéssel rendelkezik.", "Évente rendeznek itt sivatagi autóversenyeket.", "A Rub el-Háli sivatagi rendszer része."],
      ro: ["Cea mai înaltă dună din EAU, având aproximativ 300 m înălțime.", "Are o pantă extremă de aproximativ 50 de grade.", "Găzduiește competiții anuale de sporturi cu motor în deșert.", "Face parte din sistemul de deșert Rub al-Khali."],
      en: ["Highest dune in the UAE at approximately 300 meters high.", "Features an extreme slope of about 50 degrees.", "Host to annual desert motorsport racing events.", "Part of the Empty Quarter (Rub al-Khali) desert system."],
    },
    imageHint: "Giant Tal Moreeb sand dune in Liwa desert",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Ham este cel mai lung wadi din Emiratele Arabe Unite, întinzându-se pe 30 de kilometri prin Munții Hajar până lângă orașul Fujairah.",
      en: "Wadi Ham is the longest wadi in the United Arab Emirates, stretching over 30 kilometers through the Hajar Mountains towards Fujairah city.",
    },
    facts: {
      de: ["Längstes Flusstal des Landes mit 30 km Ausdehnung.", "Verläuft von der Masafi-Hochebene bis zum Golf von Oman.", "Wichtiger Entwässerungskanal für winterliche Regenfälle.", "Standort des historischen Wadi-Ham-Staudamms."],
      hu: ["Az ország leghosszabb völgye, 30 km-es kiterjedéssel.", "A Masafi-fennsíktól az Ománi-öbölig húzódik.", "Fontos vízelvezető csatorna a téli esőzések idején.", "Itt található a történelmi Wadi Ham gát."],
      ro: ["Cea mai lungă vale de râu din țară, cu o întindere de 30 km.", "Se desfășoară de la platoul Masafi până la Golful Oman.", "Canal important de drenaj pentru ploile de iarnă.", "Locul unde se află barajul istoric Wadi Ham."],
      en: ["Longest river valley in the country at 30 km in length.", "Runs from the Masafi plateau to the Gulf of Oman.", "Major drainage channel for winter rainfall runoff.", "Site of the historic Wadi Ham reservoir dam."],
    },
    imageHint: "Aerial view of Wadi Ham riverbed in Hajar mountains",
  },
  {
    ...
    description: {
      ...
      ro: "Big Red, cunoscută și sub numele de Tal Al Hammar, este o dună de nisip roșu proeminentă în deșertul Dubaiului, având o înălțime de 100 de metri.",
      en: "Big Red, also known as Tal Al Hammar, is a prominent red sand dune in the Dubai desert that rises approximately 100 meters high.",
    },
    facts: {
      de: ["Berühmt für seine tiefrote Färbung durch Eisenoxid.", "Steigt bis auf eine Höhe von ca. 100 Metern an.", "Beliebtes Ziel für 'Dune Bashing' und Sandsurfen.", "Liegt direkt an der Autobahn Dubai-Hatta."],
      hu: ["Híres a vas-oxid okozta mélyvörös színéről.", "Körülbelül 100 méteres magasságig emelkedik.", "Népszerű helyszín a dűneautózás és a homokszörf számára.", "Közvetlenül a Dubaj-Hatta autópálya mellett található."],
      ro: ["Celebră pentru culoarea sa roșu intens datorată oxidului de fier.", "Se ridică până la o înălțime de aproximativ 100 de metri.", "Destinație populară pentru 'dune bashing' și sandboarding.", "Situată chiar lângă autostrada Dubai-Hatta."],
      en: ["Famous for its deep red color caused by iron oxide.", "Rises to a height of approximately 100 meters.", "Popular destination for dune bashing and sandboarding.", "Located right next to the Dubai-Hatta highway."],
    },
    imageHint: "Large red sand dune Big Red in Dubai desert",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Siji este o vale importantă în Munții Hajar, între Fujairah și Ras Al Khaimah, cunoscută pentru resursele de apă și agricultură.",
      en: "Wadi Siji is a significant river valley in the Hajar Mountains between Fujairah and Ras Al Khaimah, known for its water resources and agriculture.",
    },
    facts: {
      de: ["Standort eines der ältesten Staudämme der VAE (1970er).", "Wichtiges landwirtschaftliches Zentrum in den Bergen.", "Führt nach starken Regenfällen erhebliche Wassermengen.", "Umgeben von steilen, zerklüfteten Kalksteingipfeln."],
      hu: ["Az Egyesült Arab Emírségek egyik legrégebbi gátjának helyszíne.", "Fontos hegyvidéki mezőgazdasági központ.", "Heves esőzések után jelentős mennyiségű vizet szállít.", "Meredek, szaggatott mészkőcsúcsok veszik körül."],
      ro: ["Locația unuia dintre cele mai vechi baraje din EAU (anii 1970).", "Centru agricol important în regiunea muntoasă.", "Transportă volume mari de apă după ploi torențiale.", "Înconjurat de vârfuri de calcar abrupte și zimțate."],
      en: ["Site of one of the oldest dams in the UAE (built in 1970s).", "Important agricultural hub in the mountain region.", "Carries significant water volumes after heavy rains.", "Surrounded by steep, rugged limestone peaks."],
    },
    imageHint: "Wadi Siji dam and surrounding mountain relief",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Abadilah este o vale populară pentru drumeții în nordul Munților Hajar, cunoscută pentru firul de apă permanent și vegetația bogată.",
      en: "Wadi Abadilah is a popular hiking valley in the northern Hajar Mountains, known for its year-round trickle of water and lush vegetation.",
    },
    facts: {
      de: ["Bietet eine vielfältige Flora wie Schilf und Farne.", "Beliebtes Ziel für Wanderer wegen des kühleren Mikroklimas.", "Enthält kleine natürliche Wasserbecken zwischen Felsen.", "Liegt an der Grenze zwischen Fujairah und Ras Al Khaimah."],
      hu: ["Változatos flórával, például náddal és páfrányokkal rendelkezik.", "Népszerű túracélpont a hűvösebb mikroklímája miatt.", "Kisebb természetes medencék találhatók a sziklák között.", "Fudzsejra és Rász el-Haima határán található."],
      ro: ["Oferă o floră diversă, cum ar fi trestia și ferigile.", "Destinație de drumeție populară datorită microclimatului răcoros.", "Conține bazine naturale mici între stânci.", "Situată la granița dintre Fujairah și Ras Al Khaimah."],
      en: ["Features diverse flora including reeds and ferns.", "Popular hiking spot due to its cooler microclimate.", "Contains small natural pools among the rocks.", "Located on the border between Fujairah and Ras Al Khaimah."],
    },
    imageHint: "Greenery and stream in Wadi Abadilah rocky valley",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Munay este o vale cu importanță istorică în sudul Ras Al Khaimah, caracterizată prin formațiuni montane accidentate și situri arheologice.",
      en: "Wadi Munay is a historically significant valley in southern Ras Al Khaimah, characterized by rugged mountain formations and archaeological sites.",
    },
    facts: {
      de: ["Bekannt für eisenzeitliche Petroglyphen (Felsritzungen).", "Wichtiger Passweg durch das Gebirge zur Ostküste.", "Besitzt dramatische geologische Schichtungen.", "Wird oft für Geländewagentouren genutzt."],
      hu: ["Vaskori petroglyfákról (sziklarajzokról) híres.", "Fontos hágó a hegységen át a keleti part felé.", "Drámai geológiai rétegződésekkel rendelkezik.", "Gyakran használják terepjárós túrákhoz."],
      ro: ["Cunoscută pentru petroglifele din epoca fierului.", "Trecătoare importantă prin munți spre coasta de est.", "Prezintă straturi geologice dramatice.", "Este adesea folosită pentru trasee off-road."],
      en: ["Known for Iron Age petroglyphs found on rocks.", "Important mountain pass leading to the East Coast.", "Features dramatic geological layering.", "Commonly used for off-road driving expeditions."],
    },
    imageHint: "Rugged mountains and rocky terrain of Wadi Munay",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Hayl este o vale proeminentă în Fujairah, tăiată adânc în Munții Hajar, cunoscută pentru fortul său istoric și arta rupestră.",
      en: "Wadi Hayl is a prominent valley in Fujairah, cutting deep into the Hajar Mountains, known for its historical fort and ancient rock art.",
    },
    facts: {
      de: ["Standort des restaurierten Al Hayl Forts.", "Enthält zahlreiche prähistorische Petroglyphen.", "Geprägt durch steile Hänge und saisonale Wasserläufe.", "Wichtiger Teil des Kulturerbes von Fujairah."],
      hu: ["Itt található a restaurált Al Hayl erőd.", "Számos prehisztorikus sziklarajzot tartalmaz.", "Meredek lejtők és időszakos vízfolyások jellemzik.", "Fudzsejra kulturális örökségének fontos része."],
      ro: ["Locația fortului restaurat Al Hayl.", "Conține numeroase petroglife preistorice.", "Caracterizată prin pante abrupte și cursuri de apă sezoniere.", "Parte importantă a patrimoniului cultural din Fujairah."],
      en: ["Site of the restored Al Hayl Fort.", "Contains numerous prehistoric petroglyphs.", "Characterized by steep slopes and seasonal streams.", "Important part of Fujairah's cultural heritage."],
    },
    imageHint: "Wadi Hayl mountains with Al Hayl Fort on a hill",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Tayyibah este o vale pitorească care forma anterior ruta principală între Masafi și Dibba, fiind acum cunoscută pentru grădinile sale terasate.",
      en: "Wadi Tayyibah is a scenic valley that formerly served as the main route between Masafi and Dibba, now known for its terraced gardens.",
    },
    facts: {
      de: ["War bis zur neuen Autobahn die Hauptverbindung nach Dibba.", "Verfügt über traditionelle Berglandwirtschaft auf Terrassen.", "Bekannt für seine steilen Felswände und engen Kurven.", "Beliebter Ort für Picknicks und Naturbeobachtungen."],
      hu: ["Az új autópályáig ez volt a Dibba felé vezető főút.", "Hagyományos hegyvidéki mezőgazdasági teraszokkal rendelkezik.", "Meredek sziklafalairól és szűk kanyarjairól ismert.", "Népszerű helyszín piknikezéshez és természetjáráshoz."],
      ro: ["A fost principala legătură spre Dibba până la noua autostradă.", "Dispune de agricultură tradițională montană pe terase.", "Cunoscută pentru pereții de stâncă abrupți și curbele strânse.", "Loc popular pentru picnicuri și observarea naturii."],
      en: ["Was the main road to Dibba before the new highway.", "Features traditional mountain terrace farming.", "Known for its steep cliff faces and tight bends.", "Popular location for picnics and nature walks."],
    },
    imageHint: "Narrow road winding through Wadi Tayyibah valley",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Shi este o vale pitorească situată deasupra orașului Khor Fakkan, marcată de barajul Wadi Shi și satul istoric Al Rafisah.",
      en: "Wadi Shi is a scenic valley located above Khor Fakkan, defined by the Wadi Shi Dam and the historic Al Rafisah village area.",
    },
    facts: {
      de: ["Standort des Al Rafisah Damms und Sees.", "Beinhaltet restaurierte historische Turmanlagen.", "Bietet Wanderwege mit Blick auf den Stausee.", "Wichtiger Wasserspeicher für die Küstenregion."],
      hu: ["Itt található az Al Rafisah gát és tó.", "Restaurált történelmi toronyépületeket tartalmaz.", "Túraútvonalakat kínál kilátással a víztározóra.", "Fontos víztározó a parti régió számára."],
      ro: ["Locația barajului și lacului Al Rafisah.", "Include structuri de turnuri istorice restaurate.", "Oferă trasee de drumeție cu vedere la lacul de acumulare.", "Rezervor de apă important pentru regiunea de coastă."],
      en: ["Location of the Al Rafisah Dam and Lake.", "Contains restored historical watchtower structures.", "Offers hiking trails with views over the reservoir.", "Important water storage facility for the coastal region."],
    },
    imageHint: "Wadi Shi dam and Al Rafisah lake in mountains",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Al-Aimi este o vale montană izolată lângă exclava Ajman Manama, cunoscută pentru frumusețea sa aspră și geologie.",
      en: "Wadi Al-Aimi is a remote mountain valley near the Ajman enclave of Manama, known for its rugged beauty and interesting geology.",
    },
    facts: {
      de: ["Liegt in den westlichen Ausläufern des Hadschar-Gebirges.", "Besteht aus dunklem Ophiolith-Gestein.", "Wenig besuchtes Gebiet, ideal für ruhige Wanderungen.", "Führt direkt in die karge Berglandschaft von Ajman."],
      hu: ["A Hadzsar-hegység nyugati lábainál fekszik.", "Sötét ofiolit kőzetből épül fel.", "Kevesek által látogatott terület, ideális csendes túrákhoz.", "Közvetlenül Adzsmán kopár hegyi tájaiba vezet."],
      ro: ["Situată la poalele vestice ale Munților Hajar.", "Compusă din roci ofiolitice de culoare închisă.", "Zonă puțin vizitată, ideală pentru drumeții liniștite.", "Conduce direct în peisajul montan arid din Ajman."],
      en: ["Located in the western foothills of the Hajar Mountains.", "Composed of dark-colored ophiolite rocks.", "Less visited area, ideal for quiet hiking.", "Leads directly into the barren mountain landscape of Ajman."],
    },
    imageHint: "Dry rocky landscape of Wadi Al-Aimi near Manama",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Lasal este o vale largă și plată la sud de Wadi Shawka, marcând tranziția între deșertul de nisip și Munții Hajar.",
      en: "Wadi Lasal is a wide, flat valley south of Wadi Shawka, marking the transition between the sandy desert and the Hajar Mountains.",
    },
    facts: {
      de: ["Beliebter Ort für Mountainbiking und Wüstencamping.", "Bietet weite Ausblicke auf die Bergspitzen von Ras Al Khaimah.", "Saisonales Graswachstum nach Regenfällen zieht Weidetiere an.", "Einfacheres Gelände im Vergleich zu den tieferen Wadis."],
      hu: ["Népszerű helyszín hegyi kerékpározáshoz és kempingezéshez.", "Tágas kilátást nyújt Rász el-Haima hegycsúcsaira.", "Az esők utáni fűnövekedés vonzza a legelő állatokat.", "Könnyebb terep a mélyebb völgyekhez képest."],
      ro: ["Loc popular pentru mountain biking și camping în deșert.", "Oferă vederi largi asupra vârfurilor montane din Ras Al Khaimah.", "Iarba sezonieră după ploi atrage animalele la pășunat.", "Teren mai accesibil în comparație cu wadi-urile mai adânci."],
      en: ["Popular spot for mountain biking and desert camping.", "Offers wide views of the Ras Al Khaimah mountain peaks.", "Seasonal grass growth after rains attracts grazing animals.", "Easier terrain compared to deeper mountain wadis."],
    },
    imageHint: "Wide flat valley of Wadi Lasal with mountains in background",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Khabb este o vale de calcar adânc tăiată în nordul Ras Al Khaimah, cunoscută pentru stâncile abrupte și apicultura tradițională.",
      en: "Wadi Khabb is a deep limestone valley in northern Ras Al Khaimah, known for its steep cliffs and traditional mountain beekeeping.",
    },
    facts: {
      de: ["Berühmt für die Produktion von hochwertigem Berghonig.", "Besitzt beeindruckende vertikale Felswände.", "Liegt im Ruus Al Jibal Massiv des Hadschar-Gebirges.", "Wichtiger Lebensraum für die Arabische Berggazelle."],
      hu: ["Híres a kiváló minőségű hegyi méz termeléséről.", "Lenyűgöző függőleges sziklafalakkal rendelkezik.", "A Hadzsar-hegység Ruus Al Jibal masszívumában található.", "Az arab hegyi gazella fontos élőhelye."],
      ro: ["Faimoasă pentru producția de miere montană de înaltă calitate.", "Prezintă pereți de stâncă verticali impresionanți.", "Situată în masivul Ruus Al Jibal din Munții Hajar.", "Habitat important pentru gazela arabă de munte."],
      en: ["Famous for the production of high-quality mountain honey.", "Features impressive vertical limestone cliff faces.", "Located in the Ruus Al Jibal massif of the Hajar Mountains.", "Important habitat for the Arabian Mountain Gazelle."],
    },
    imageHint: "Steep limestone cliffs of Wadi Khabb in Ras Al Khaimah",
  }
];
