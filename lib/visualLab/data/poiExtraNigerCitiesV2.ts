...
image: "/poi-images/tahoua-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tahoua is a major city in Niger, serving as the administrative center of the Tahoua Region. It's a significant hub for the Tuareg and Fulani peoples, with a vibrant market that reflects its position as a crossroads of trade routes. The city's economy is primarily based on agriculture, including the cultivation of onions and tobacco, and livestock trading. Tahoua is also known for its unique Sahelian architecture, characterized by mud-brick buildings. The city has seen substantial growth and modernization in recent years, with improvements in infrastructure and public services, yet it retains much of its traditional character and cultural heritage."
    },
    factsAdvanced: {
      ...
      en: ["Serves as the capital of the Tahoua Region.", "A major center for Tuareg and Fulani cultures.", "The economy is driven by agriculture and livestock trade.", "Known for its traditional Sahelian mud-brick architecture.", "The city hosts a large, bustling central market.", "Located on the southern edge of the Sahara Desert.", "An important transportation link in central Niger."]
    }
  },
  {
    id: "agadez-cities-v2",
...
image: "/poi-images/agadez-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Agadez, known as the 'gateway to the Sahara', is the largest city in central Niger and a historical crossroads for trans-Saharan trade. Its old town is a UNESCO World Heritage site, famous for its well-preserved earthen architecture, including the iconic Grand Mosque of Agadez with its 27-meter-high minaret made entirely of mud-brick. The city has a rich history tied to the Tuareg people and various sultanates. The economy has traditionally revolved around trade, particularly salt caravans, and handicrafts such as silver jewelry and leather goods. In recent times, it has also become a focal point for migration routes across the Sahara."
    },
    factsAdvanced: {
      ...
      en: ["The historic centre is a UNESCO World Heritage site.", "Home to the famous Grand Mosque with its mud-brick minaret.", "Historically a key hub for trans-Saharan camel caravans.", "A major center of Tuareg culture and craftsmanship.", "Known for its intricate silver and leather artisanal products.", "The city was founded in the 14th century.", "Agadez serves as the capital of the Agadez Region."]
    }
  },
  {
    id: "arlit-cities-v2",
...
image: "/poi-images/arlit-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Arlit is an industrial town in the Agadez Region of northern Niger, situated in the Aïr Mountains. Its foundation and growth are directly linked to the discovery and exploitation of uranium deposits in the 1960s. The town was developed around the uranium mining industry, which has been the mainstay of its economy for decades, operated by French multinational companies. This industrial activity has attracted a diverse population of workers from across Niger and neighboring countries. The surrounding landscape is harsh Sahara desert, but the area is geologically rich. Arlit's existence is a testament to the economic importance of Niger's mineral resources."
    },
    factsAdvanced: {
      ...
      en: ["Established as a center for uranium mining.", "Located in the Aïr Mountains, a desert highland.", "The economy is almost entirely dependent on uranium extraction.", "Attracts a migrant workforce from various regions.", "The mines are operated primarily by French companies.", "Connected by road to Agadez and the rest of Niger.", "The town features a desert climate with extreme temperatures."]
    }
  },
  {
    id: "dosso-cities-v2",
...
image: "/poi-images/dosso-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Dosso is a city in southwestern Niger that serves as the administrative capital of the Dosso Region. It is the historical seat of the Dosso Kingdom, a pre-colonial Zarma state, and the Djermakoy (ruler of Dosso) still holds a significant ceremonial role. The city is an important commercial center, with its economy based on agriculture, particularly millet and peanut cultivation, and trade. Dosso is situated on a major highway connecting Niamey to Benin, making it a vital transport and trade link. The city's cultural life is rich, with traditions and ceremonies of the Zarma people being prominent."
    },
    factsAdvanced: {
      ...
      en: ["Capital of the Dosso Region in southwest Niger.", "Historical center of the pre-colonial Dosso Kingdom.", "The traditional ruler, the Djermakoy, resides here.", "An important agricultural market for peanuts and millet.", "Located on a key trade route to Benin.", "The population is predominantly from the Zarma ethnic group.", "The Royal Palace of the Djermakoy is a key landmark."]
    }
  },
  {
    id: "diffa-cities-v2",
...
image: "/poi-images/diffa-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Diffa is the administrative capital of the Diffa Region in southeastern Niger, located near the border with Nigeria. The city's strategic position makes it a center for trade and cross-border activities. The primary economic activities are agriculture, with a focus on red sorghum, and livestock breeding, particularly cattle. The Komadougou Yobe river, which forms part of the border, supports local agriculture. The culture of Diffa is heavily influenced by the Kanuri people, who are also prominent in neighboring Nigeria and Chad. In recent years, the region has faced significant security and humanitarian challenges due to its proximity to conflict zones."
    },
    factsAdvanced: {
      ...
      en: ["Administrative capital of the Diffa Region.", "Situated near the Komadougou Yobe river and Nigerian border.", "The economy is based on sorghum cultivation and cattle.", "The Kanuri ethnic group is dominant in the area.", "A center for cross-border trade with Nigeria.", "The region is known for its traditional salt and natron production.", "The city hosts a significant market for regional goods."]
    }
  },
  {
...
image: "/poi-images/birni-nkonni-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Birni-N'Konni is a bustling city in the Tahoua Region of Niger, situated directly on the border with Nigeria. This location has made it one of the most important centers of trade in the country, often referred to as a 'market town'. A wide variety of goods, from agricultural products to manufactured items, pass through its markets. The city is a major hub for the Hausa people, and Hausa is the dominant language. The economy is driven by this cross-border commerce, as well as agriculture, with onions being a major local crop. The city has a dynamic and energetic atmosphere due to the constant flow of people and goods."
    },
    factsAdvanced: {
      ...
      en: ["A major commercial hub on the Nigerian border.", "Known as a significant 'market town' in Niger.", "Predominantly inhabited by the Hausa people.", "Cross-border trade is the primary economic driver.", "Important center for the region's onion production.", "Connects Nigerien and Nigerian road networks.", "The city has a dry port facilitating customs clearance."]
    }
  },
  {
...
image: "/poi-images/tessaoua-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tessaoua is a city in the Maradi Region of south-central Niger. It is a historic town that was once the capital of the small pre-colonial state of Tessaoua, a Katsinawa Hausa kingdom. Today, it serves as an important regional market and administrative center for the surrounding department. The economy is primarily agrarian, focusing on the cultivation of millet, sorghum, peanuts, and cowpeas. The city is also a center for livestock trading. Its historical significance is still visible in the layout of the old town and the presence of traditional Hausa architecture and cultural practices."
    },
    factsAdvanced: {
      ...
      en: ["Located in the Maradi Region of southern Niger.", "Former capital of the pre-colonial Hausa state of Tessaoua.", "An important regional agricultural market.", "Main crops include millet, sorghum, and peanuts.", "The city is a center for local livestock trade.", "Reflects traditional Hausa architectural styles.", "Serves as the seat of the Tessaoua Department."]
    }
  },
  {
...
image: "/poi-images/dogondoutchi-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Dogondoutchi is a city in the Dosso Region of southwestern Niger. It lies in a valley of the same name and is a significant cultural crossroads. The population is diverse, including Hausa, Fulani, and Tuareg peoples, as well as the local Mawri, a subgroup of the Hausa. This mix of cultures is reflected in the city's market and social life. The economy is based on agriculture, with millet, sorghum, and beans being the main crops. The city is also known for its pottery and has a lively weekly market that attracts people from the entire region. The area has been the focus of various development and cultural preservation projects."
    },
    factsAdvanced: {
      ...
      en: ["A culturally diverse city in the Dosso Region.", "Home to Mawri, Hausa, Fulani, and Tuareg communities.", "The economy is centered on subsistence agriculture.", "The city is renowned for its traditional pottery.", "Hosts a large and vibrant weekly market.", "Located in the dry, Sahelian ecological zone.", "The name 'Dogondoutchi' means 'High Hill' in the Hausa language."]
    }
  },
  {
    id: "gaya-cities-v2",
...
image: "/poi-images/gaya-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Gaya is a city in the Dosso Region of Niger, located on the Niger River and on the border with Benin and Nigeria. This strategic tri-border location makes it an extremely important hub for international trade and transport. The city is connected to Benin by a major bridge over the Niger River. Its economy is dominated by commerce, transport, and agriculture. The fertile lands along the river allow for the cultivation of rice and other crops. Gaya is a multicultural city with a mix of Zarma, Hausa, and Fulani populations, along with many people from neighboring countries."
    },
    factsAdvanced: {
      ...
      en: ["Located at the tri-border point of Niger, Benin, and Nigeria.", "A vital international trade and transport hub.", "Situated on the banks of the Niger River.", "Connected to Benin via the Gaya-Malanville bridge.", "The economy is driven by commerce and agriculture.", "Rice cultivation is important in the riverine areas.", "A culturally diverse city with many ethnic groups."]
    }
  },
  {
...
image: "/poi-images/madaoua-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Madaoua is a town in the Tahoua Region of Niger. It is an important market center for a predominantly agricultural region. The main economic activity is the cultivation of crops such as millet, sorghum, and especially black-eyed peas (cowpeas), for which the region is well known. Livestock herding is also a significant part of the local economy. Madaoua is primarily inhabited by Hausa people, and their culture and language are dominant. The town serves as a vital link for collecting and trading agricultural surplus from the surrounding rural areas, connecting them to larger national markets."
    },
    factsAdvanced: {
      ...
      en: ["Located in the Tahoua Region, in the 'breadbasket' area.", "A major market for agricultural produce.", "The region is a leading producer of black-eyed peas (cowpeas).", "Primarily inhabited by the Hausa ethnic group.", "Livestock trading is a key economic activity.", "Serves as the administrative center of the Madaoua Department.", "The climate is typical of the Sahel, with a short rainy season."]
    }
  },
  {
    id: "mayahi-cities-v2",
...
image: "/poi-images/mayahi-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Mayahi is a town located in the Maradi Region of southern Niger. It serves as the administrative center of the Mayahi Department. The economy of Mayahi is primarily based on agriculture and livestock. The area is known for cultivating staple crops like millet and sorghum, as well as cash crops such as peanuts and cowpeas. The town has a significant local market where agricultural products and livestock are traded. The population is predominantly Hausa, and the town is a center of Hausa culture for the surrounding region. The climate is Sahelian, with a short rainy season and a long dry season, which dictates the agricultural cycle."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Mayahi Department.", "Located in the Maradi Region of southern Niger.", "Economy is dominated by agriculture and livestock.", "Major crops are millet, sorghum, peanuts, and cowpeas.", "The population is predominantly of the Hausa ethnic group.", "Features a large weekly market for regional trade.", "The region has a Sahelian climate with a distinct rainy season."]
    }
  },
  {
    id: "tera-cities-v2",
...
image: "/poi-images/tera-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Téra is a town in the Tillabéri Region of southwestern Niger. It is situated in a valley and is known for its market, which is one of the most important in the region. The town is a cultural melting pot, with significant populations of Songhai, Fulani, and Tuareg people. The economy is based on agriculture, livestock, and trade. The surrounding area is suitable for farming, with millet and sorghum being the primary crops. Téra has historical significance and was a point of resistance against French colonial expansion. The town is located on a key route connecting Niamey to the border with Burkina Faso."
    },
    factsAdvanced: {
      ...
      en: ["Located in the Tillabéri Region of southwestern Niger.", "Hosts one of the most important weekly markets in the area.", "A multicultural town with Songhai, Fulani, and Tuareg populations.", "Economy is based on agriculture, livestock, and commerce.", "A site of historical resistance against French colonial forces.", "Situated on a trade route to Burkina Faso.", "The name Téra means 'frog' in the Songhai language."]
    }
  },
  {
...
image: "/poi-images/mirriah-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Mirriah is a town in the Zinder Region of southern Niger. It serves as the administrative center of the Mirriah Department. The town is an important agricultural market for the surrounding rural areas. The economy is heavily reliant on farming, with major crops including millet, sorghum, and peanuts. It is also a center for the trade of livestock. Mirriah has historical roots connected to the Sultanate of Damagaram, based in nearby Zinder. The population is mainly Hausa, and the town reflects the cultural and social traditions of the Hausa people. It is located on the main east-west highway in Niger, connecting it to Zinder and Nigeria."
    },
    factsAdvanced: {
      ...
      en: ["Administrative capital of the Mirriah Department.", "Located in the Zinder Region, near the city of Zinder.", "A major market for agricultural goods and livestock.", "The economy is based on millet, sorghum, and peanut farming.", "Historically part of the Sultanate of Damagaram.", "The population is predominantly Hausa.", "Situated on the main highway linking Niger to Nigeria."]
    }
  },
  {
    id: "tibiri-cities-v2",
...
image: "/poi-images/tibiri-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tibiri is a town in the Maradi Region of southern Niger. It is known for being a traditional center of the Gobirawa, a subgroup of the Hausa people. The town has historical importance as one of the capitals of the pre-colonial Hausa state of Gobir, which was a major power in the region and a rival of the Sokoto Caliphate. The traditional chief of Gobir still resides in Tibiri. The economy is primarily agricultural, based on the cultivation of millet, sorghum, and cowpeas. The town's history and its role as a center of traditional authority give it a unique cultural identity."
    },
    factsAdvanced: {
      ...
      en: ["Located in the Maradi Region of southern Niger.", "A traditional center of the Gobirawa Hausa people.", "Historically one of the capitals of the Gobir kingdom.", "The traditional chief (Sarkin Gobir) resides in the town.", "The economy is based on subsistence agriculture.", "Main crops include millet, sorghum, and cowpeas.", "The town preserves many Gobirawa cultural traditions."]
    }
  },
  {
...
image: "/poi-images/tillaberi-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tillabéri is a city in northwestern Niger, located on the Niger River. It is the administrative capital of the Tillabéri Region. The city is an important port on the river, facilitating trade and transport, particularly for agricultural products from the region. The economy is based on agriculture, with rice being a key crop cultivated in the fertile river valley. Fishing is also an important economic activity. The population is diverse, including Songhai, Djerma, Fulani, and Tuareg peoples. Tillabéri is a significant administrative and commercial center for this part of the country, though the region has faced security challenges in recent years."
    },
    factsAdvanced: {
      ...
      en: ["Capital of the Tillabéri Region in northwestern Niger.", "Located on the banks of the Niger River.", "An important river port for trade and transport.", "The economy is based on agriculture, especially rice, and fishing.", "A multi-ethnic city with Songhai, Djerma, and Fulani populations.", "Serves as a key administrative and commercial hub.", "The region is known for its scenic landscapes along the river."]
    }
  },
  {
...
image: "/poi-images/magaria-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Magaria is a town in the Zinder Region of southern Niger, near the border with Nigeria. It is the seat of the Magaria Department. The town is an important center for trade, especially in agricultural products. The economy is primarily based on farming, with the main crops being millet, sorghum, peanuts, and cowpeas. Livestock herding and trade are also significant economic activities. The population is predominantly Hausa, and the town is a center of Hausa culture. Its proximity to Nigeria influences its economy and culture, with strong cross-border trade links."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Magaria Department.", "Located in the Zinder Region, near the Nigerian border.", "An important market for agricultural trade.", "The economy is based on farming and livestock.", "Main crops include millet, sorghum, and peanuts.", "The population is predominantly Hausa.", "Strong economic and cultural ties to neighboring Nigeria."]
    }
  },
  {
    id: "dakoro-cities-v2",
...
image: "/poi-images/dakoro-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Dakoro is a town in the Maradi Region of Niger. It is the administrative center of the Dakoro Department. The town is a crucial market for the surrounding pastoral and agricultural areas. The economy is driven by livestock trading, with a large and active cattle market, and agriculture, including the cultivation of millet and sorghum. Dakoro is situated in the Sahelian zone, an area that is a transition between the Sahara desert to the north and the savanna to the south. The population is a mix of Hausa, Fulani, and Tuareg peoples, reflecting its position as a cultural and economic crossroads."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Dakoro Department.", "Located in the Maradi Region of Niger.", "A major center for livestock trading in the Sahel.", "The economy is also based on millet and sorghum farming.", "Situated in the transitional Sahel ecological zone.", "A multi-ethnic town with Hausa, Fulani, and Tuareg populations.", "The weekly market is vital for the regional economy."]
    }
  },
  {
...
image: "/poi-images/nguigmi-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "N'guigmi is a city in the Diffa Region of southeastern Niger, located on the northern shore of Lake Chad. It is the administrative capital of the N'guigmi Department. The city's location on the lake has traditionally supported an economy based on fishing and agriculture. However, the dramatic shrinking of Lake Chad has had a severe impact on these livelihoods. The population consists mainly of Kanuri and Daza (Toubou) peoples. The town is an important center for the production of salt and natron from the lake's receding shores. It is one of the most remote and isolated cities in Niger."
    },
    factsAdvanced: {
      ...
      en: ["Located on the northern edge of Lake Chad.", "Administrative capital of the N'guigmi Department.", "The economy was traditionally based on fishing and agriculture.", "The shrinking of Lake Chad has heavily impacted the local economy.", "The population is mainly Kanuri and Daza (Toubou).", "An important center for traditional salt and natron production.", "One of the most isolated and remote urban centers in Niger."]
    }
  },
  {
...
image: "/poi-images/matameye-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Matameye is a town in the Zinder Region of southern Niger. It is the administrative center of the Matameye Department. The town is a significant agricultural market for the region, which is one of the most productive agricultural areas in Niger. The economy is dominated by the farming of staple crops like millet and sorghum, as well as cash crops such as peanuts and cowpeas. Livestock trading also plays a crucial role. The population is primarily Hausa. Matameye is located on an important road that connects the regional capital, Zinder, to the Nigerian border, facilitating trade."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Matameye Department.", "Located in the agriculturally productive Zinder Region.", "A major market for grains, peanuts, and cowpeas.", "The population is predominantly of the Hausa ethnic group.", "Livestock trade is a key part of the local economy.", "Situated on a key trade route to Nigeria.", "The town and department are sometimes spelled 'Matamèye'."]
    }
  },
  {
    id: "illela-cities-v2",
...
image: "/poi-images/illela-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Illéla is a town in the Tahoua Region of Niger. It serves as the administrative center of the Illéla Department. The town is an important market center in a region known for its agricultural production. The economy is based on farming, with key crops being onions, millet, and sorghum. The area is also known for its traditional dykes and water management systems, which support agriculture in this arid region. The population is mainly Hausa. Illéla is located on the main road connecting Tahoua and Birni-N'Konni, making it a point of passage for trade."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Illéla Department.", "Located in the Tahoua Region of Niger.", "An important agricultural market, especially for onions.", "The region uses traditional dykes for water management.", "The population is primarily Hausa.", "Situated on the road between Tahoua and Birni-N'Konni.", "The area has a vibrant tradition of Hausa music and culture."]
    }
  },
  {
    id: "tanout-cities-v2",
...
image: "/poi-images/tanout-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tanout is a town in the Zinder Region of Niger. It is the administrative center of the Tanout Department. Located on the edge of the Sahara Desert, the town is a center for both sedentary agriculturalists and nomadic pastoralists. The economy is a mix of millet and sorghum farming, and livestock herding, primarily camels and goats. Tanout has a significant Tuareg and Fulani population, in addition to Hausa residents. The town has a large weekly market where nomads and farmers trade goods. The area is characterized by a Sahelian climate with very low rainfall."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Tanout Department.", "Located in the Zinder Region, on the edge of the desert.", "A meeting point for nomadic pastoralists and settled farmers.", "The economy is based on agriculture and livestock herding.", "The population includes Tuareg, Fulani, and Hausa peoples.", "Hosts a large weekly market for regional trade.", "The climate is arid, typical of the Sahel."]
    }
  },
  {
    id: "goure-cities-v2",
...
image: "/poi-images/goure-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Gouré is a town in the Zinder Region of southeastern Niger. It is the administrative center of the Gouré Department. The town is a historic center that was once part of the Kanem-Bornu Empire. Today, it is an important market town for the surrounding agricultural and pastoral communities. The economy is based on the cultivation of millet and sorghum, as well as livestock trading. The population is a mix of Kanuri, Hausa, and Fulani peoples. Gouré is located on the main east-west road in Niger and serves as an important stop for travelers and trade."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Gouré Department.", "Located in the Zinder Region of southeastern Niger.", "Historically part of the Kanem-Bornu Empire.", "An important market town for agriculture and livestock.", "The population includes Kanuri, Hausa, and Fulani groups.", "Situated on Niger's main east-west highway.", "The town has a long history as a regional center."]
    }
  },
  {
    id: "abalak-cities-v2",
...
image: "/poi-images/abalak-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Abalak is a town in the Tahoua Region of Niger. It is the administrative center of the Abalak Department. The town is located in a pastoral zone and is a crucial center for Tuareg and Wodaabe-Fulani nomadic herders. The economy is almost entirely based on livestock, including cattle, camels, and goats. Abalak has one of the most important livestock markets in Niger, attracting traders from across the region and from neighboring Nigeria. The town has a small lake, which is a vital water source in this arid area. The annual Cure Salée festival, a major gathering of nomadic peoples, sometimes takes place near Abalak."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Abalak Department.", "A key center for Tuareg and Wodaabe nomadic pastoralists.", "The economy is dominated by the livestock trade.", "Hosts one of the largest livestock markets in Niger.", "Located near a small lake, a vital water source.", "A potential site for the annual Cure Salée festival.", "The population is highly mobile, reflecting its nomadic culture."]
    }
  },
  {
    id: "aguie-cities-v2",
...
image: "/poi-images/aguie-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Aguié is a town in the Maradi Region of southern Niger. It is the administrative center of the Aguié Department. The town is located in a major agricultural zone, and its economy is primarily based on farming. The main crops are millet, sorghum, peanuts, and cowpeas. The town has a bustling market where agricultural products are sold. The population is predominantly Hausa. Aguié is known for its vibrant culture and is the birthplace of Niger's first president, Hamani Diori. The town is located on a key road connecting Maradi to the Nigerian border."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Aguié Department.", "Located in the agriculturally rich Maradi Region.", "The economy is based on farming millet, sorghum, and peanuts.", "The population is mainly of the Hausa ethnic group.", "Birthplace of Hamani Diori, Niger's first president.", "Features a large and active weekly market.", "Situated on a trade route to Nigeria."]
    }
  },
  {
...
image: "/poi-images/ouallam-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Ouallam is a town in the Tillabéri Region of southwestern Niger. It is the administrative center of the Ouallam Department. The town is situated in the Sahelian zone, and its economy is based on agriculture and livestock herding. The primary crops are millet and sorghum. The population is mainly composed of Zarma (Djerma) people. The town has a significant market that serves the surrounding rural communities. In recent years, the Ouallam department has been affected by insecurity spilling over from neighboring Mali, which has impacted the local economy and society."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Ouallam Department.", "Located in the Tillabéri Region of southwestern Niger.", "The economy is based on agriculture and livestock.", "The population is predominantly Zarma (Djerma).", "Hosts an important regional market.", "The region has faced security challenges due to its proximity to Mali.", "The climate is semi-arid with a short rainy season."]
    }
  },
  {
...
image: "/poi-images/filingue-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Filingué is a town in the Tillabéri Region of southwestern Niger. It is the administrative center of the Filingué Department. The town is located in a scenic but dry region characterized by plateaus and valleys. The economy is primarily based on subsistence agriculture, with millet and sorghum as the main crops, and on livestock herding. The population is a mix of Hausa, Zarma, and Fulani peoples. Filingué is known for its large and colorful weekly market, which is a major event for the entire region, attracting traders and customers from hundreds of kilometers away."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Filingué Department.", "Located in the Tillabéri Region of Niger.", "The economy is based on agriculture and livestock.", "The population includes Hausa, Zarma, and Fulani communities.", "Famous for its large and vibrant weekly market.", "The surrounding landscape features striking plateaus and valleys.", "The town is a center of traditional music and dance."]
    }
  },
  {
    id: "bouza-cities-v2",
...
image: "/poi-images/bouza-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Bouza is a town in the Tahoua Region of Niger. It is the administrative center of the Bouza Department. The town is located in an agricultural area, and its economy is based on farming and livestock. The main crops are millet, sorghum, and cowpeas. The region is also known for its onion production. Bouza has a large weekly market that is a center for regional trade. The population is primarily Hausa. The department of Bouza has been the site of various rural development projects aimed at improving food security and water access in this arid region."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Bouza Department.", "Located in the Tahoua Region of Niger.", "The economy is based on agriculture and livestock herding.", "The region is known for its production of onions.", "The population is predominantly of the Hausa ethnic group.", "Hosts a significant weekly market for regional commerce.", "The area has been a focus for rural development initiatives."]
    }
  },
  {
    id: "keita-cities-v2",
...
image: "/poi-images/keita-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Keita is a town in the Tahoua Region of Niger. It is the administrative center of the Keita Department. The town is located in a valley and is known for a major integrated rural development project that was implemented in the 1980s and 1990s. This project involved large-scale reforestation, the building of dams and dykes, and other measures to combat desertification and improve agricultural productivity. The economy is based on this revived agriculture, including the cultivation of millet, sorghum, and vegetables, as well as livestock. The project is considered a model for sustainable development in the Sahel."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Keita Department.", "Located in a valley in the Tahoua Region.", "Site of a famous and successful anti-desertification project.", "The project involved massive reforestation and water management.", "The economy is based on agriculture revived by the project.", "Considered a model for sustainable development in the Sahel.", "The population is primarily Hausa."]
    }
  },
  {
...
image: "/poi-images/tchirozerine-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tchirozérine is a town in the Agadez Region of northern Niger. It is the administrative center of the Tchirozérine Department. The town was developed in the 1980s around a coal mine, which was established to power the uranium mines in nearby Arlit. The coal-fired power station located in the town is a key piece of infrastructure for the region. The economy is thus centered on coal mining and electricity generation. The population is a mix of Tuareg people and workers from other parts of Niger. The town is situated in a desert environment at the foot of the Aïr Mountains."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Tchirozérine Department.", "Located in the Agadez Region, near the Aïr Mountains.", "Developed around a major coal mining operation.", "Home to a coal-fired power station that supplies the region.", "The economy is based on coal and electricity generation.", "The population includes Tuareg and migrant workers.", "The name is sometimes spelled 'Tchighozerine'."]
    }
  },
  {
    id: "say-cities-v2",
...
image: "/poi-images/say-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Say is a town in the Tillabéri Region of southwestern Niger, located on the Niger River. It is the administrative center of the Say Department. The town has a long history as a center of Islamic learning and was the capital of a small Islamic state in the 19th century. The Islamic University of Niger is located in Say. The economy is based on agriculture, particularly rice cultivation in the river valley, as well as fishing and trade. The W National Park, a UNESCO World Heritage site, is located in the department of Say, making the town a gateway to the park. The population is a mix of Songhai-Zarma, Fulani, and Hausa peoples."
    },
    factsAdvanced: {
      ...
      en: ["Located on the Niger River in the Tillabéri Region.", "A historic center of Islamic scholarship.", "Home to the Islamic University of Niger.", "The economy is based on rice farming, fishing, and trade.", "Gateway to the W National Park, a UNESCO World Heritage site.", "Capital of the 19th-century Islamic state of Say.", "The population includes Songhai-Zarma, Fulani, and Hausa groups."]
    }
  },
  {
...
image: "/poi-images/madarounfa-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Madarounfa is a town in the Maradi Region of southern Niger, located near the border with Nigeria. It is the administrative center of the Madarounfa Department. The town is situated next to Madarounfa Lake, which is considered a sacred lake by the local Hausa people and is an important site for traditional ceremonies. The economy is primarily based on agriculture, with millet, sorghum, and cowpeas being the main crops. Fishing in the lake also contributes to the local livelihood. The area is heavily influenced by Hausa culture and its proximity to Nigeria enhances trade and cultural exchange."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Madarounfa Department.", "Located in the Maradi Region, near the Nigerian border.", "Situated next to the sacred Madarounfa Lake.", "The lake is a site for traditional animist ceremonies.", "The economy is based on agriculture and fishing.", "The population is predominantly Hausa.", "Strong cultural and economic links with neighboring Nigeria."]
    }
  },
  {
...
image: "/poi-images/guidan-roumdji-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Guidan Roumdji is a town in the Maradi Region of southern Niger. It is the administrative center of the Guidan Roumdji Department. The town is a major agricultural market for the surrounding region, which is one of the most densely populated and agriculturally productive areas of Niger. The economy is dominated by the cultivation of millet, sorghum, peanuts, and cowpeas. The town has a large and vibrant weekly market that is a center for regional trade. The population is almost entirely Hausa, and the town is a center of Hausa culture and tradition."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Guidan Roumdji Department.", "Located in the densely populated Maradi Region.", "A major market for agricultural produce.", "The economy is based on farming millet, sorghum, and peanuts.", "The population is almost exclusively Hausa.", "Hosts a large and bustling weekly market.", "The name means 'The House of Roumdji' in the Hausa language."]
    }
  },
  {
...
image: "/poi-images/maine-soroa-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Maïné-Soroa is a town in the Diffa Region of southeastern Niger. It is the administrative center of the Maïné-Soroa Department. The town is an important market center for agricultural products and livestock. The economy is based on farming, particularly millet and sorghum, and on herding. The population is a mix of Kanuri, Hausa, and Fulani peoples. The town's location near the border with Nigeria makes it a site of significant cross-border trade. The region has been affected by the security and humanitarian crisis linked to the Lake Chad basin."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Maïné-Soroa Department.", "Located in the Diffa Region of southeastern Niger.", "An important market for agriculture and livestock.", "The population includes Kanuri, Hausa, and Fulani communities.", "Significant cross-border trade with Nigeria.", "The economy is based on farming and pastoralism.", "The region is part of the Lake Chad basin crisis area."]
    }
  },
  {
...
image: "/poi-images/tchin-tabaraden-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tchin-Tabaraden is a town in the Tahoua Region of Niger. It is the administrative center of the Tchin-Tabaraden Department. The town is located in a pastoral region and is a major center for the Tuareg people, particularly the Iwellemmedan confederation. The economy is almost entirely dependent on livestock herding, including camels, goats, and cattle. The town has an important weekly market for livestock and goods. The area is also known for its artisanry, especially Tuareg silver jewelry and leatherwork. The name of the town means 'the valley of the young girls'."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Tchin-Tabaraden Department.", "A major center for the Tuareg people in the Tahoua Region.", "The economy is dominated by nomadic pastoralism.", "Hosts an important weekly livestock market.", "Known for high-quality Tuareg silver and leather crafts.", "The population is primarily Tuareg.", "The name means 'valley of the young girls' in Tamasheq."]
    }
  },
  {
...
image: "/poi-images/goudoumaria-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Goudoumaria is a town in the Diffa Region of southeastern Niger. It is the administrative center of the Goudoumaria Department. The town is located in a semi-arid region and its economy is based on agriculture, particularly the cultivation of millet, and on livestock herding. The population is a mix of Kanuri and Manga (a subgroup of Kanuri) peoples. The town has a local market that is important for the surrounding villages. The region is known for its traditional festivals and the production of dates in the scattered oases."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Goudoumaria Department.", "Located in the Diffa Region of Niger.", "The economy is based on millet farming and livestock.", "The population is mainly composed of Kanuri and Manga peoples.", "Hosts a local market for regional trade.", "The surrounding oases are known for date production.", "The area has a rich tradition of local festivals."]
    }
  },
  {
...
image: "/poi-images/dungass-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Dungass is a town in the Zinder Region of southern Niger, close to the Nigerian border. It is the administrative center of the Dungass Department. The town is an important local market for agricultural goods. The economy is heavily based on farming, with major crops being millet, sorghum, peanuts, and cowpeas. Livestock trading is also a key economic activity. The population is predominantly Hausa, and the town shares strong cultural and economic ties with northern Nigeria. The area has a high population density for Niger."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Dungass Department.", "Located in the Zinder Region, near the Nigerian border.", "The economy is dominated by agriculture.", "Major crops include millet, sorghum, and peanuts.", "The population is predominantly Hausa.", "Strong trade and cultural connections with Nigeria.", "The region is one of the more densely populated in Niger."]
    }
  },
  {
    id: "kollo-cities-v2",
...
image: "/poi-images/kollo-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Kollo is a town in the Tillabéri Region of southwestern Niger, located on the Niger River. It is the administrative center of the Kollo Department. The town is situated relatively close to the capital, Niamey, and serves as a suburb and a market center for the surrounding agricultural area. The economy is based on agriculture, with rice being a major crop in the fertile river valley. Fishing and small-scale trade are also important. The population is mainly Zarma (Djerma). Kollo is home to the Faculty of Agronomy of the Abdou Moumouni University of Niamey."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Kollo Department.", "Located on the Niger River, near the capital Niamey.", "The economy is based on agriculture, especially rice.", "The population is predominantly Zarma (Djerma).", "Hosts the Faculty of Agronomy of Niger's main university.", "Serves as a market town for the surrounding region.", "Fishing in the Niger River is an important activity."]
    }
  },
  {
    id: "ayorou-cities-v2",
...
image: "/poi-images/ayorou-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Ayorou is a town in the Tillabéri Region of southwestern Niger, situated on an island in the Niger River. It is known for its large and vibrant weekly market, held on Sundays, which attracts people from all over the region, as well as from neighboring Mali and Nigeria. The market is particularly famous for its livestock and for the wide variety of goods sold by different ethnic groups, including Songhai, Wodaabe, Tuareg, and Fulani. The economy is based on this trade, as well as on fishing, rice cultivation, and tourism. The river setting and the cultural diversity make Ayorou a unique destination."
    },
    factsAdvanced: {
      ...
      en: ["Located on an island in the Niger River.", "Famous for its large and colorful Sunday market.", "A major center for regional and cross-border trade.", "The market is a meeting point for many ethnic groups.", "The economy is based on trade, fishing, and agriculture.", "A popular tourist destination due to its culture and setting.", "The population is primarily Songhai."]
    }
  },
  {
    id: "bermo-cities-v2",
...
image: "/poi-images/bermo-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Bermo is a town in the Maradi Region of Niger. It is the administrative center of the Bermo Department. The town is located in a pastoral area and is a key center for the Wodaabe (or Bororo) people, a nomadic Fulani group famous for their elaborate ceremonies and traditions, such as the Gerewol festival. The economy is almost entirely based on livestock herding, particularly cattle. Bermo has an important livestock market. The area is arid, and access to water and pasture is a constant challenge for the nomadic population."
    },
    factsAdvanced: {
      ...
      en: ["Administrative seat of the Bermo Department.", "A key center for the nomadic Wodaabe (Bororo) people.", "The economy is dominated by cattle herding.", "Hosts an important livestock market.", "The Wodaabe are famous for the Gerewol festival.", "Located in an arid, pastoral zone in the Maradi Region.", "Life is organized around the seasonal movement of herds."]
    }
  },
  {
...
image: "/poi-images/banibangou-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Banibangou is a town in the Tillabéri Region of northwestern Niger, near the border with Mali. It is the administrative center of the Banibangou Department. The town is located in a remote and arid part of the Sahel. The economy is based on subsistence agriculture, mainly millet cultivation, and livestock herding. The population is a mix of Zarma and Fulani peoples. The department of Banibangou has been severely affected by the cross-border security crisis, with frequent attacks by armed groups, which has had a devastating impact on the local population and economy."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Banibangou Department.", "Located in northwestern Niger, near the Malian border.", "The economy is based on subsistence farming and herding.", "The population includes Zarma and Fulani communities.", "The region has been heavily impacted by armed conflict.", "Considered one of the most insecure areas in Niger.", "The climate is arid with very low rainfall."]
    }
  },
  {
...
image: "/poi-images/ngourti-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "N'Gourti is a small town in the Diffa Region of eastern Niger. It is the administrative center of the N'Gourti Department. The town is located in an extremely remote and arid area on the edge of the Ténéré Desert. The population is primarily composed of nomadic and semi-nomadic peoples, including the Daza (Toubou) and some Tuareg groups. The economy is based almost exclusively on livestock herding, especially camels. N'Gourti is an important stop for the seasonal transhumance of the herds. The area is also known for its salt flats (salines)."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the N'Gourti Department.", "Located in a remote desert area in eastern Niger.", "The population is mainly nomadic Daza (Toubou) people.", "The economy is based almost entirely on camel herding.", "An important point in the transhumance routes.", "The area has significant salt flats.", "One of the most isolated settlements in the country."]
    }
  },
  {
...
image: "/poi-images/tassara-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tassara is a small town in the Tahoua Region of western Niger, near the border with Mali. It is the administrative center of the Tassara Department. The town is situated in a very remote and arid pastoral zone. The population is predominantly Tuareg. The economy is based entirely on livestock herding, primarily camels and goats. Tassara is a gathering point for nomadic communities in the area and has a well that is a crucial water source. The department has been significantly affected by the security crisis in the Sahel, with the presence of armed groups impacting the local population."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Tassara Department.", "Located in a remote pastoral zone near the Malian border.", "The population is predominantly Tuareg.", "The economy is entirely based on livestock.", "A key water point for nomadic communities.", "The area is severely affected by the Sahelian security crisis.", "The name Tassara means 'the pan' in Tamasheq."]
    }
  },
  {
...
image: "/poi-images/bankilare-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Bankilaré is a town in the Tillabéri Region of western Niger, near the borders with Mali and Burkina Faso. It is the administrative center of the Bankilaré Department. The town is located in the 'Liptako-Gourma' tri-border area, which is an epicenter of the Sahelian security crisis. The economy, traditionally based on agriculture and livestock herding, has been severely disrupted by conflict. The population is a mix of Fulani, Tuareg, and Zarma peoples. Bankilaré has a large weekly market, but its activity has been curtailed by the insecurity. The town and surrounding area have experienced numerous attacks and a severe humanitarian crisis."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Bankilaré Department.", "Located in the tri-border area of Niger, Mali, and Burkina Faso.", "The economy is based on agriculture and pastoralism.", "The population includes Fulani, Tuareg, and Zarma groups.", "The region is an epicenter of the Sahelian security crisis.", "The town's large weekly market has been disrupted by conflict.", "The area faces a severe humanitarian situation."]
    }
  },
  {
    id: "tillia-cities-v2",
...
image: "/poi-images/tillia-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Tillia is a town in the Tahoua Region of western Niger, near the border with Mali. It is the administrative center of the Tillia Department. The town is located in a remote and arid pastoral zone. The economy is based almost entirely on livestock herding by its predominantly Tuareg and Fulani population. The area is characterized by vast, sandy plains and is part of the Sahel. Tillia is a crucial administrative and service center for the nomadic communities in this vast department. The region has been significantly impacted by the spillover of the conflict in Mali."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Tillia Department.", "Located in a remote pastoral zone near the Malian border.", "The economy is based on livestock herding.", "The population is mainly Tuareg and Fulani.", "An administrative hub for nomadic communities.", "The region has been affected by the conflict in neighboring Mali.", "The landscape is characterized by Sahelian sandy plains."]
    }
  },
  {
...
image: "/poi-images/belbedji-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Belbédji is a small town in the Zinder Region of Niger. It is the administrative center of the Belbédji Department. The town is situated in a pastoral area in the Sahel. The economy is based on livestock herding, primarily cattle and camels, and some subsistence agriculture. The population is a mix of pastoral groups, including Fulani and Tuareg. Belbédji has a local market that serves the surrounding nomadic and semi-nomadic communities. The area is arid and water is a scarce and vital resource."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Belbédji Department.", "Located in a pastoral zone in the Zinder Region.", "The economy is based on livestock and subsistence farming.", "The population includes Fulani and Tuareg pastoralists.", "Hosts a local market for nomadic communities.", "Water is a scarce resource in this arid region.", "The name is sometimes written as 'Belbéji'."]
    }
  },
  {
...
image: "/poi-images/iferouane-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Iférouane is an oasis town in the Agadez Region of northern Niger. It is located in the Aïr Mountains and is the administrative center of the Iférouane Department. The town is an important center for the Tuareg people. The economy is based on oasis agriculture, including the cultivation of dates, vegetables, and some grains, as well as livestock herding, particularly goats and camels. The town is known for its annual Gani festival, a traditional celebration with music, dance, and camel races. Iférouane is also a gateway to the Aïr and Ténéré Natural Reserves, a UNESCO World Heritage site, although tourism has been severely curtailed by regional insecurity."
    },
    factsAdvanced: {
      ...
      en: ["An oasis town in the Aïr Mountains of northern Niger.", "Administrative center of the Iférouane Department.", "An important cultural center for the Tuareg people.", "The economy is based on oasis farming and livestock.", "Known for its annual Gani festival and camel races.", "A gateway to the Aïr and Ténéré Natural Reserves.", "The name means 'place of hiding' in the Tamasheq language."]
    }
  },
  {
    id: "bilma-cities-v2",
...
image: "/poi-images/bilma-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Bilma is an oasis town in the Agadez Region of northeastern Niger. It is the administrative center of the Bilma Department. The town is located in the Ténéré Desert and is famous for its salt pans, which have been a source of high-quality salt for centuries. Bilma was a key stop on the trans-Saharan trade routes, and salt caravans, or 'azalai', still travel from Agadez to Bilma to transport salt. The economy is dominated by this salt trade. The population is mainly composed of Kanuri and Toubou peoples. The isolation and harsh desert environment define life in Bilma."
    },
    factsAdvanced: {
      ...
      en: ["An oasis town in the Ténéré Desert.", "Famous for its extensive and ancient salt pans.", "A historic stop on trans-Saharan trade routes.", "The destination of the 'azalai' salt caravans from Agadez.", "The economy is dominated by the salt trade.", "The population is mainly Kanuri and Toubou.", "One of the most isolated settlements in the Sahara."]
    }
  },
  {
    id: "fachi-cities-v2",
...
image: "/poi-images/fachi-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Fachi is an oasis village in the Bilma Department of the Agadez Region in Niger. It is located in the middle of the Ténéré Desert, between the Aïr Mountains and the salt pans of Bilma. The village is surrounded by a massive defensive wall, which historically protected its inhabitants and their resources from raiders. The economy is based on oasis agriculture, particularly date palms, and participation in the salt trade. Fachi was another important stop on the trans-Saharan caravan routes. The population is primarily Kanuri. The fortified village is a remarkable example of desert architecture."
    },
    factsAdvanced: {
      ...
      en: ["An oasis village in the heart of the Ténéré Desert.", "Surrounded by a large, ancient defensive wall.", "The economy is based on date cultivation and the salt trade.", "A historic stopping point for trans-Saharan caravans.", "The population is predominantly Kanuri.", "The fortified village is a significant historical monument.", "Located about midway between the Aïr Mountains and Bilma."]
    }
  },
  {
    id: "dirkou-cities-v2",
...
image: "/poi-images/dirkou-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Dirkou is an oasis town in the Bilma Department of the Agadez Region in northeastern Niger. It is an administrative post and a center for the Toubou people. The town is located in the Kaouar escarpment, a line of oases in the Ténéré Desert. The economy is based on oasis agriculture, especially the cultivation of date palms, and on the salt and natron trade, similar to Bilma. Dirkou has a small airport and has served as a military outpost. In recent years, it has become a major transit point for migrants attempting to cross the Sahara to Libya, making it a center of a complex humanitarian situation."
    },
    factsAdvanced: {
      ...
      en: ["An oasis town in the Kaouar escarpment.", "An administrative center for the Toubou people.", "The economy is based on date farming and the salt trade.", "Located in the northeastern Agadez Region.", "Has become a major transit point for migrants heading to Libya.", "Features a small airport and military presence.", "Part of a chain of oases in the Ténéré Desert."]
    }
  },
  {
    id: "ingall-cities-v2",
...
image: "/poi-images/ingall-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Ingall is an oasis town in the Agadez Region of Niger. It is the administrative center of the Ingall Department. The town is located on the western edge of the Aïr Mountains. Ingall is most famous for being the site of the Cure Salée, one of the largest and most important annual festivals for Tuareg and Wodaabe pastoralists in the region. During the festival, herders bring their livestock to graze on the salt-rich pastures. The town has a small permanent population, which swells dramatically during the festival. The economy is based on oasis agriculture and livestock."
    },
    factsAdvanced: {
      ...
      en: ["Host of the famous annual Cure Salée festival.", "A major gathering point for Tuareg and Wodaabe nomads.", "Located on the western edge of the Aïr Mountains.", "The festival celebrates the end of the rainy season.", "The economy is based on oasis farming and pastoralism.", "The population increases massively during the festival.", "The salt-rich pastures are vital for the health of livestock."]
    }
  },
  {
...
image: "/poi-images/kantche-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Kantché is a town in the Zinder Region of southern Niger. It is the administrative center of the Kantché Department. The town is located in a densely populated and agriculturally productive area. The economy is dominated by farming, with millet, sorghum, peanuts, and cowpeas as the main crops. Livestock trade is also an important economic activity. The population is predominantly Hausa. Kantché has a large weekly market that serves as a commercial hub for the surrounding villages. The town is located on a key road linking Zinder with the Nigerian border state of Katsina."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Kantché Department.", "Located in the fertile Zinder Region.", "The economy is based on agriculture and livestock.", "The population is almost entirely Hausa.", "Hosts a large and important weekly market.", "Situated on a trade route to Nigeria's Katsina state.", "The region has one of the highest population densities in Niger."]
    }
  },
  {
...
image: "/poi-images/kornaka-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Kornaka is a town in the Maradi Region of southern Niger. It is the administrative center of the Kornaka Department. The town is located in a primarily agricultural region. The economy is based on the cultivation of millet and sorghum, as well as cash crops like peanuts. The area is also known for a particular type of irrigated agriculture in valley bottoms, known as 'fadama'. The population is mainly Hausa. Kornaka has a local market for the trade of agricultural goods. The department was created recently, in 2011, to bring administration closer to the people."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Kornaka Department.", "Located in the Maradi Region of southern Niger.", "The economy is based on agriculture.", "The region uses 'fadama' valley-bottom irrigation.", "The population is predominantly Hausa.", "Hosts a local market for agricultural trade.", "The department was created in 2011."]
    }
  },
  {
...
image: "/poi-images/malbaza-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Malbaza is a town in the Tahoua Region of Niger. It is the administrative center of the Malbaza Department. The town is an important industrial center for Niger, as it is home to the country's largest cement factory. This factory is a major employer and a key driver of the local economy. In addition to industry, the economy is also based on agriculture, particularly onion cultivation. The population is primarily Hausa. Malbaza is located on the main road linking the regional capital, Tahoua, to the Nigerian border, making it a center for trade and transport."
    },
    factsAdvanced: {
      ...
      en: ["Home to Niger's largest cement factory.", "An important industrial center in the Tahoua Region.", "The cement factory is a major source of employment.", "The economy also includes agriculture, especially onions.", "The population is predominantly Hausa.", "Located on a key highway for national and international trade.", "Administrative center of the Malbaza Department."]
    }
  },
  {
    id: "loga-cities-v2",
...
image: "/poi-images/loga-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Loga is a town in the Dosso Region of southwestern Niger. It is the administrative center of the Loga Department. The town is located in an agricultural region, and its economy is primarily based on the cultivation of millet, sorghum, and cowpeas. Livestock herding is also an important part of the economy. The population is mainly composed of Zarma (Djerma) people. Loga has a significant weekly market that attracts people from the surrounding villages for trade. The town is a local administrative and service center."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Loga Department.", "Located in the Dosso Region of southwestern Niger.", "The economy is based on agriculture and livestock.", "The population is predominantly Zarma (Djerma).", "Hosts a large and active weekly market.", "A local hub for administration and services.", "The main crops are millet, sorghum, and cowpeas."]
    }
  },
  {
...
image: "/poi-images/balleyara-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Balleyara is a town in the Tillabéri Region of southwestern Niger. It is the administrative center of the Balleyara Department. The town is most famous for its large and internationally renowned livestock market, which is one of the biggest in West Africa. The market, held on Sundays, attracts traders from Niger, Nigeria, Benin, and other countries. The economy of the town revolves almost entirely around this market and the trade in cattle, camels, sheep, and goats. The population is a mix of Zarma, Fulani, and Hausa peoples, reflecting its commercial importance."
    },
    factsAdvanced: {
      ...
      en: ["Host of one of the largest livestock markets in West Africa.", "A major international center for the cattle trade.", "The market takes place every Sunday.", "Attracts traders from several neighboring countries.", "The economy is dominated by the livestock trade.", "A multi-ethnic town of Zarma, Fulani, and Hausa.", "Administrative center of the Balleyara Department."]
    }
  },
  {
...
image: "/poi-images/gotheye-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Gothèye is a town in the Tillabéri Region of southwestern Niger, located on the Niger River. It is the administrative center of the Gothèye Department. The economy is based on agriculture, with rice being a major crop in the fertile river valley, and on fishing. The population is primarily Songhai. Gothèye is a local market center for fish and agricultural products. The town has historical significance as the seat of a small pre-colonial chiefdom. The river is central to the life and economy of the town."
    },
    factsAdvanced: {
      ...
      en: ["Located on the banks of the Niger River.", "Administrative center of the Gothèye Department.", "The economy is based on rice cultivation and fishing.", "The population is predominantly Songhai.", "A local market for fish and agricultural goods.", "Historically the seat of a small chiefdom.", "The Niger River is vital for transport and irrigation."]
    }
  },
  {
...
image: "/poi-images/damagaram-takaya-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Damagaram Takaya is a town in the Zinder Region of southern Niger. It is the administrative center of the Damagaram Takaya Department. The town is located in a rural, agricultural area. The economy is based on subsistence farming, with the main crops being millet and sorghum, and on livestock herding. The population is predominantly Hausa. The town has a local market for the exchange of goods. The department is named after the historical Sultanate of Damagaram (based in Zinder) and the Takaya area. The department was created in 2011."
    },
    factsAdvanced: {
      ...
      en: ["Administrative center of the Damagaram Takaya Department.", "Located in the Zinder Region of southern Niger.", "The economy is based on subsistence farming and livestock.", "The population is predominantly Hausa.", "Named after the Sultanate of Damagaram.", "Hosts a local market for regional trade.", "The department was established in 2011."]
    }
  }
];
