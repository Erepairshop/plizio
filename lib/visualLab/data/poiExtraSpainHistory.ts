...
export const spainHistoryExtra: POI[] = [
  {
    id: "ES-ALH",
    type: "historical",
    parent: "ES",
    ...
    description: {
      de: "Ein monumentaler Palastkomplex aus der maurischen Zeit in Granada.",
      hu: "Monumentális palotakomplexum a mór időkből Granadában.",
    ...
    factsAdvanced: {
      ...
      ro: [
        "Numele 'Alhambra' provine din limba arabă și înseamnă 'Cea Roșie', referindu-se probabil la culoarea caldă a zidurilor exterioare ale cetății.",
        "Modelele geometrice complexe și caligrafiile arabe elaborate de pe pereți repetă adesea deviza: 'Nu există învingător în afară de Dumnezeu'.",
        "Alhambra a fost ultimul palat maur care a fost predat regilor catolici ai Spaniei în timpul Reconquistei, în 1492.",
        "În centrul complexului nasrid, regele spaniol Carol al V-lea a construit mai târziu un palat renascentist masiv și izbitor, care creează un contrast stilistic puternic."
      ],
      en: [
