...
export const montenegroOtherExtra = ([
  {
    ...
    descriptionAdvanced: { 
      ...
      ro: "Lacul Skadar este cel mai mare lac din Peninsula Balcanică, întinzându-se la granița dintre Muntenegru și Albania. Zona este un teritoriu protejat, cu o avifaună incomparabilă, insule plutitoare și mănăstiri istorice, oferind o experiență de neuitat pentru iubitorii naturii care vizitează această regiune și admiră flora diversă și peisajele sale neatinse.", 
      en: "Lake Skadar holds the title of the largest lake on the Balkan Peninsula, straddling the international border between Montenegro and Albania. As a protected area of immense ecological importance, it features unparalleled birdlife, unique floating islands, and remote historic monasteries. It offers an unforgettable experience for nature enthusiasts, representing one of the region's most crucial and vibrant wetlands. Geography K5 – ecosystem dynamics and wetlands." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      ro: "Durmitor este un lanț muntos și un parc național din nordul Muntenegrului, cunoscut pentru lacurile sale glaciare, canioanele adânci și vârfurile dramatice. Zona face parte din Patrimoniul Mondial UNESCO și oferă o gamă largă de activități sportive de iarnă și vară, fiind un loc esențial pentru conservarea biodiversității montane și pentru explorarea peisajelor sălbatice ale Muntenegrului.", 
      en: "Durmitor encompasses a majestic mountain range and national park in northern Montenegro, world-renowned for its glacial lakes, deep dramatic canyons, and towering limestone peaks. As an official UNESCO World Heritage site, it provides an expansive wilderness area perfect for a wide range of winter and summer outdoor sports. It remains the centerpiece of Montenegro's rugged mountain geography. Geography K6 – mountain ecosystems and alpine landscapes." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      ro: "Canionul Tara este cel mai adânc din Europa și unul dintre cele mai importante din lume, săpat de apele cristaline ale râului Tara prin munți. Frumusețea naturală a canionului, posibilitățile de rafting și mediul sălbatic fac din acesta una dintre cele mai mari atracții naturale ale Muntenegrului, fiind totodată o zonă de studiu geologic importantă pentru eroziunea fluvială.", 
      en: "The Tara Canyon is recognized as the deepest canyon in Europe and one of the most significant in the world, carved through the limestone mountains by the crystal-clear Tara River. The canyon's pristine natural beauty, coupled with thrilling white-water rafting opportunities and a rugged, untouched environment, makes it one of Montenegro's premier natural attractions. It serves as a textbook example of geological erosion and river dynamics. Geography K7 – river erosion and canyon formation." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      ro: "Lovćen este un munte și un parc național în apropierea Mării Adriatice, fiind un simbol al identității naționale muntenegrene. De pe vârfurile munților se deschide o vedere inegalabilă asupra golfului Kotor și a zonelor înconjurătoare, iar tot aici se află și mausoleul conducătorului Njegoș, făcând din acest munte un centru spiritual și patriotic de o importanță majoră.", 
      en: "Lovćen serves as both a significant mountain range and a national park situated near the Adriatic coast, standing as a primary symbol of Montenegrin national identity. From its high summits, visitors enjoy unparalleled panoramic views spanning the Bay of Kotor and the broader coastal landscape. The mountain is also famous for housing the grand mausoleum of the ruler and poet Njegoš. Geography K5 – mountains as national symbols." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      ro: "Biogradska Gora este un parc național din nord-estul Muntenegrului, care conservă una dintre ultimele trei păduri virgine rămase în Europa. Centrul parcului este frumosul lac Biograd, înconjurat de păduri dese, care asigură frumusețea naturală nealterată a zonei și un mediu protejat pentru numeroase specii de faună și floră rară.", 
      en: "Biogradska Gora is a national park located in northeastern Montenegro, globally significant for preserving one of Europe's last three remaining primary rainforests. The heart of the park is defined by the stunning Biograd Lake, which is enclosed by dense, ancient forests, ensuring the preservation of the area's pristine natural environment. It serves as a vital sanctuary for biodiversity in the Balkans. Geography K6 – protected virgin ecosystems." 
    },
    factsAdvanced: { 
