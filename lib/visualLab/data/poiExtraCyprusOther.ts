...
export const cyprusOtherPoi: POI[] = [
   ...
   */
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "",
      ro: "",
      en: "This location is a fascinating location in Cyprus, offering visitors a unique blend of historical significance and modern charm. The area is known for its beautiful architecture and vibrant local culture, making it an essential stop for any traveler exploring the region. Whether you are interested in ancient history, scenic landscapes, or authentic Cypriot cuisine, This location provides an unforgettable experience. With its well-maintained public spaces and warm, welcoming community, it is the perfect place to immerse yourself in the local way of life. The surrounding area is also full of hidden gems waiting to be discovered, promising adventure at every turn."
    },
    factsAdvanced: {
      ...
      hu: [],
      ro: ["Situl are o relevan?a istorica majora în regiunea sa.", "Arhitectura reflecta influen?e culturale specifice Ciprului.", "Zona a beneficiat de numeroase proiecte de restaurare recente.", "Este o destina?ie preferata pentru studii istorice ?i culturale.", "Comunitatea locala pastreaza vii tradi?iile legate de acest loc.", "Facilita?ile din apropiere ofera un acces facil vizitatorilor."],
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["ERSETZE_MICH_DE_FACT_1", "ERSETZE_MICH_DE_FACT_2", "ERSETZE_MICH_DE_FACT_3", "ERSETZE_MICH_DE_FACT_4", "ERSETZE_MICH_DE_FACT_5", "ERSETZE_MICH_DE_FACT_6"],
      hu: [],
      ro: ["Importan?a acestui sit este recunoscuta în plan local ?i regional.", "Tradi?iile transmise aici au modelat identitatea comunita?ii respective.", "Zona reprezinta un punct de interes pentru cercetarea patrimoniului istoric.", "În cadrul sitului au avut loc multiple evenimente de promovare culturala.", "Infrastructura permite explorarea confortabila a elementelor de interes.", "Situl ramâne un reper pentru cei pasiona?i de istoria Ciprului."],
      en: ["Fact example 1", "Fact example 2", "Fact example 3", "Fact example 4", "Fact example 5", "Fact example 6"]
    },
  },
  {
  ...
  },
  {
    ...
    factsAdvanced: {
      de: ["ERSETZE_MICH_DE_FACT_1", "ERSETZE_MICH_DE_FACT_2", "ERSETZE_MICH_DE_FACT_3", "ERSETZE_MICH_DE_FACT_4", "ERSETZE_MICH_DE_FACT_5", "ERSETZE_MICH_DE_FACT_6"],
      hu: [],
      ro: ["Aceasta loca?ie joaca un rol vital în conservarea patrimoniului na?ional.", "Elementele structurale eviden?iaza tehnicile de construc?ie din perioadele trecute.", "Siturile din vecinatate completeaza contextul istoric al loca?iei.", "Activita?ile educative organizate aici atrag vizitatori din diverse domenii.", "Zona este recunoscuta pentru importan?a sa în dezvoltarea culturala locala.", "Vizitarea acestui loc ofera o experien?a autentica a vie?ii cipriote."],
      en: ["Fact example 1", "Fact example 2", "Fact example 3", "Fact example 4", "Fact example 5", "Fact example 6"]
    },
  },
  {
