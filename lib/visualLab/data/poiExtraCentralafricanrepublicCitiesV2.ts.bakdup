...
export const poiExtraCentralafricanrepublicCitiesV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Bangui, situat pe malul nordic al râului Ubangi, reprezintă inima administrativă și economică a Republicii Centrafricane. Fondat în 1889 ca post militar francez, orașul a evoluat într-un nod comercial esențial pentru transportul fluvial spre bazinul fluviului Congo. Cu o populație ce depășește 800.000 de locuitori, acesta servește drept principal centru de distribuție pentru bunurile de consum și resursele agricole ale țării. Arhitectura urbană reflectă influențele coloniale împletite cu dinamismul piețelor africane tradiționale. Geografie K7 – Sisteme fluviale și centre economice.",
      en: "Bangui, located on the northern bank of the Ubangi River, serves as the primary administrative and economic hub of the Central African Republic. Established in 1889 as a French military post, the city has evolved into a key commercial node, linking the nation to the Congo River basin. It hosts the University of Bangui and remains the heart of the country's trade, processing agricultural products like cotton and coffee for export. Geography K7 — River systems and economic centers."
    },
    factsAdvanced: {
      en: ["Founded by the French in 1889.", "Population exceeds 800,000 residents.", "Primary river port on the Ubangi.", "Home to the University of Bangui.", "Located at an elevation of 340 meters.", "Key transit point for regional trade."]
    },
    factsAdvanced: {
      ro: ["Altitudine medie: aproximativ 340 metri.", "Fondat: 1889 ca post militar.", "Principal port fluvial pe râul Ubangi.", "Populație: peste 800.000 locuitori.", "Conexiune directă cu bazinul fluviului Congo.", "Temperaturi medii anuale: 20 °C – 35 °C."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bangui-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Bimbo, situat strategic la sud-vest de capitala Bangui, constituie un punct focal de dezvoltare urbană și economică în prefectura Ombella-M'Poko. Fiind una dintre cele mai mari zone urbane din afara capitalei, localitatea a cunoscut o expansiune rapidă datorită apropierii de centrul administrativ al țării. Economia locală este diversificată, bazându-se pe comerț și pe valorificarea produselor agricole provenite din regiunile rurale adiacente. Integrarea sa în rețeaua națională de transport facilitează distribuția resurselor către restul țării. Geografie K7 – Procese de urbanizare în Africa Centrală.",
      en: "Bimbo is a rapidly growing urban center situated southwest of Bangui, essentially acting as an extension of the capital's metropolitan area. It has experienced significant population growth due to urbanization trends in the Central African Republic. The town's economy is closely tied to the capital, providing essential services and residential space for those working in the trade hub. Geography K7 — Urban growth and metropolitan expansion."
    },
    factsAdvanced: {
      en: ["Adjacent to the capital, Bangui.", "Experiencing rapid urban expansion.", "Major residential hub for commuters.", "Strategic location in the Ouham-Pendé corridor.", "Integral to the Greater Bangui area.", "Rising importance in local services."]
    },
    factsAdvanced: {
      ro: ["Localizare: la sud-vest de Bangui.", "Prefectură: Ombella-M'Poko.", "Centru urban în expansiune rapidă.", "Economie: bazată pe comerț și agricultură.", "Rol important în aprovizionarea capitalei.", "Conexiune rutieră strategică."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bimbo-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Berbérati, al doilea oraș ca mărime din Republica Centrafricană, se află în regiunea de sud-vest, fiind un centru crucial pentru comerțul cu diamante și producția agricolă. Istoria sa este strâns legată de exploatarea resurselor naturale și de rolul său ca nod rutier important între Bangui și granița cu Camerunul. Orașul găzduște piețe animate și instituții comerciale care susțin economia regională, oferind în același timp servicii esențiale pentru comunitățile rurale din jur. Geografie K7 – Resurse naturale și centre comerciale.",
      en: "Berbérati, the capital of the Mambéré-Kadéï prefecture, is the second-largest city in the Central African Republic. Situated in the western part of the country, it is historically renowned for its significant role in the diamond industry and forestry. The surrounding region is characterized by tropical rainforests, contributing to a diverse agricultural and timber-based local economy. Geography K7 — Resource-rich regional capitals."
    },
    factsAdvanced: {
      en: ["Second-largest city in the nation.", "Capital of Mambéré-Kadéï prefecture.", "Historically significant for diamond mining.", "Key center for the local timber industry.", "Located near the border with Cameroon.", "Region defined by dense tropical forests."]
    },
    factsAdvanced: {
      ro: ["Al doilea oraș ca mărime din țară.", "Centru major pentru comerțul cu diamante.", "Nod rutier strategic către Camerun.", "Economie: agricultură și resurse minerale.", "Populație: centru comercial regional.", "Altitudine: zonă platoului sud-vestic."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/berberati-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Carnot, situat în prefectura Mambéré-Kadéï, a jucat un rol istoric semnificativ în industria minieră, fiind cunoscut pentru rezervele sale de diamante. Orașul a beneficiat de dezvoltarea infrastructurii necesare pentru extracție și comerț, devenind o localitate activă în sectorul resurselor naturale. Peisajul urban este marcat de activitatea comercială intensă, fiind un punct de tranzit pentru produsele agricole și minerale din sud-vestul țării. Geografie K7 – Exploatarea resurselor și dezvoltarea locală.",
      en: "Carnot is an important town in western Central African Republic, located in the Mambéré-Kadéï prefecture. It lies along the main road connecting Berbérati to the rest of the country. Historically associated with gold and diamond mining, the town remains a focal point for artisanal miners and regional trade, reflecting the economic complexities of the country's resource-dependent sectors. Geography K7 — Regional trade nodes and mineral resources."
    },
    factsAdvanced: {
      en: ["Located in Mambéré-Kadéï prefecture.", "Key town along the western trade route.", "Historic hub for artisanal mining.", "Center for gold and diamond distribution.", "Influenced by regional resource extraction.", "Vital link for local transport networks."]
    },
    factsAdvanced: {
      ro: ["Prefectură: Mambéré-Kadéï.", "Istoric industrial: minerit de diamante.", "Nod comercial în sud-vestul țării.", "Activitate: tranzitul mărfurilor agricole.", "Peisaj: zonă de platou.", "Contribuție la exporturile naționale."]
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Bambari se află pe malul râului Ouaka, fiind un centru vital în regiunea centrală a țării și o poartă către resursele agricole și miniere ale zonei. Orașul este un nod rutier major care conectează estul țării cu capitala Bangui. Economia locală se bazează pe prelucrarea bumbacului, producția de cereale și mineritul de aur și diamante, fiind un pilon al stabilității economice regionale. Infrastructura orașului găzduște piețe și puncte comerciale esențiale pentru populația locală. Geografie K7 – Noduri rutiere și dezvoltare regională.",
      en: "Bambari is a major regional city located in the Ouaka prefecture, sitting strategically on the banks of the Ouaka River. Historically, it has been a center for agricultural processing, particularly for cotton, palm oil, and coffee. Its location makes it a crucial crossroads between the northern and eastern parts of the Central African Republic. Geography K7 — Agricultural hubs and crossroads."
    },
    factsAdvanced: {
      en: ["Capital of the Ouaka prefecture.", "Located on the banks of the Ouaka River.", "Major center for agricultural processing.", "Historic hub for cotton and palm oil.", "Strategic crossroads for national transit.", "Supports diverse regional trade flows."]
    },
    factsAdvanced: {
      ro: ["Localizare: pe malul râului Ouaka.", "Rol: nod rutier major pentru estul țării.", "Economie: prelucrarea bumbacului și aur.", "Importanță regională: centrul prefecturii Ouaka.", "Infrastructură: piețe și comerț active.", "Transport: legătură vitală spre Bangui."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bambari-cities-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Bouar, the capital of the Nana-Mambéré prefecture, is located in the highlands of the western Central African Republic. It is well-known for the mysterious megalithic stone circles located nearby, which attract archaeological interest. The city itself acts as a gateway for transit from the neighboring Cameroon, playing a vital role in international trade and regional security. Geography K7 — Highland cities and archaeological sites."
    },
    factsAdvanced: {
      en: ["Capital of Nana-Mambéré prefecture.", "Famous for ancient megalithic sites.", "Situated in the western highland region.", "Key gateway for trade from Cameroon.", "Elevation approximately 1,000 meters.", "Important military and transit hub."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bouar-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Ouham prefecture.", "Historically central to cotton production.", "Key hub in the fertile northern plains.", "Major supplier of local agricultural goods.", "Strategically located for regional logistics.", "Traditional center for livestock trade."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bossangoa-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Haute-Kotto prefecture.", "Located in the eastern mining belt.", "Center for significant diamond deposits.", "Historically critical for mineral wealth.", "Remote hub for eastern regional trade.", "High economic reliance on extraction."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bria-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Mbomou prefecture.", "Situated on the Mbomou River border.", "Historically served as a sultanate seat.", "Trade hub for timber and coffee.", "Gateway to southern forest regions.", "Vital link for trans-river commerce."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bangassou-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of Sangha-Mbaéré prefecture.", "Located at the confluence of two rivers.", "Dominant hub for the timber industry.", "Deeply set in dense tropical forest.", "Crucial for river transport to the Congo.", "Resource-heavy local economy."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/nola-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Lobaye prefecture.", "Major production zone for coffee.", "Key center for the wood industry.", "Located in the Lobaye river basin.", "Gateway to Dzanga-Sangha area.", "Supports significant rural trade."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/mbaiki-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of Nana-Gribizi prefecture.", "Central hub for commercial trade.", "Key market for agricultural produce.", "Supports regional livestock distribution.", "Strategic location in the heart of the country.", "Connects diverse regional economies."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/kaga-bandoro-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Kémo prefecture.", "Strategically located at a road junction.", "Crucial transit point north of Bangui.", "Logistical hub for regional trade routes.", "Features colonial-era architectural sites.", "Supports movement across the country."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/sibut-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Ouham-Pendé prefecture.", "Regional hub for grain production.", "Known for its long-standing mission.", "Historic center for social services.", "Supports western highland agriculture.", "Strategic location in the northwest."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/bozoum-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of Bamingui-Bangoran.", "Located in the northern savanna belt.", "Gateway to Bamingui-Bangoran Park.", "Historic hub on ancient caravan routes.", "Reflects northern climatic diversity.", "Vital for wildlife conservation efforts."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/ndele-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Vakaga prefecture.", "Located in the remote northeastern corner.", "Border town near Chad and Sudan.", "Hub for cross-border livestock trade.", "Situated in a semi-arid climatic zone.", "Historically unique regional trade site."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/birao-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Located on the Ubangi River border.", "Capital of Basse-Kotto prefecture.", "Historic colonial administrative center.", "Key site for regional river transport.", "Fertile soil supports tobacco farming.", "Important cultural and river trade site."]
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    factsAdvanced: {
      en: ["Capital of the Haut-Mbomou prefecture.", "Situated in the extreme southeast.", "One of the country's most remote capitals.", "Outpost for regional administration.", "Located near the South Sudan/DRC border.", "Unique biodiversity in a remote setting."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/obo-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Key town in Ouham-Pendé prefecture.", "Major hub for regional livestock trade.", "Primary center for cereal production.", "Supports northern rural economies.", "Historic site for community trade.", "Strategic position in the northwest."]
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/paoua-cities-v2.webp"},
  {
    ...
    factsAdvanced: {
      en: ["Located on the banks of the Ouham River.", "Historically significant for local fishing.", "Small-scale agriculture hub.", "Vital river access for local transport.", "Essential for regional commodity trade.", "Supports northern riverine communities."]
    },
    factsAdvanced: {
