...
,
  {
    ...
    description: {
      ...
      ro: "Această regiune de coastă este cunoscută pentru producția tradițională de sare prin evaporare solară. Alimentează piețele locale din estul țării cu sare.",
      en: "This coastal area is a significant hub for traditional salt production using natural solar evaporation. It supplies essential table salt to eastern regional markets.",
    },
    facts: {
      de: ["Traditionelle solare Verdunstungstechnik", "Wichtiges Wirtschaftszentrum in Baucau", "Versorgung der östlichen Gemeinden", "Saisonale Produktion in der Trockenzeit"],
      hu: ["Hagyományos napenergiás lepárlás", "Baucau község fontos gazdasági pontja", "A keleti települések fő sóforrása", "Szezonális termelés a száraz évszakban"],
      ro: ["Tehnică tradițională de evaporare solară", "Centru economic important în districtul Baucau", "Aprovizionează comunitățile din est", "Producție sezonieră în perioada secetoasă"],
      en: ["Traditional solar evaporation technique", "Major economic site in Baucau municipality", "Supplies salt to eastern communities", "Seasonal production during dry months"],
    },
    imageHint: "traditional salt pans by the sea in Timor-Leste",
  },
  {
    ...
    description: {
      ...
      ro: "Metinaro servește ca punct central de colectare pentru pescuitul de pe coasta de nord, lângă capitală. Găzduiește facilități de refrigerare și procesare.",
      en: "Metinaro acts as a central hub for fishing activities on the north coast near Dili. It features essential cold storage and fish processing facilities.",
    },
    facts: {
      de: ["Hauptlieferant für den Markt in Dili", "Modernisierte Hafenanlagen", "Zentrum für handwerkliche Fischerei", "Lagerung für Exportprodukte"],
      hu: ["A dili piacok fő beszállítója", "Modernizált kikötői infrastruktúra", "A kézműves halászat központja", "Exporttermékek tárolási helyszíne"],
      ro: ["Principal furnizor pentru piața din Dili", "Infrastructură portuară modernizată", "Centru pentru pescuitul artizanal", "Depozitare pentru produse de export"],
      en: ["Main supplier for Dili fish markets", "Modernized harbor infrastructure", "Hub for artisanal fishing activities", "Storage site for export-grade seafood"],
    },
    imageHint: "local fishing boats and fish market in Metinaro",
  },
  {
    ...
    description: {
      ...
      ro: "Naturbora este un centru semnificativ pentru educația agricolă și cultivarea orezului pe scară largă pe coasta de sud. Găzduiește o școală tehnică importantă.",
      en: "Naturbora is a significant center for agricultural training and large-scale rice cultivation on the south coast. It hosts a key technical vocational school.",
    },
    facts: {
      de: ["Sitz einer Landwirtschaftsschule", "Schwerpunkt auf Reisproduktion", "Strategische Lage an der Südküste", "Forschung zu tropischen Nutzpflanzen"],
      hu: ["Mezőgazdasági szakiskola székhelye", "Fő profilja a rizstermesztés", "Stratégiai elhelyezkedés a déli parton", "Trópusi növények kutatási helyszíne"],
      ro: ["Sediul unei școli agricole", "Accent pe producția de orez", "Locație strategică pe coasta de sud", "Cercetare privind culturile tropicale"],
      en: ["Home to an agricultural vocational school", "Focus on large-scale rice production", "Strategic south coast location", "Research site for tropical cash crops"],
    },
    imageHint: "rice paddies and agricultural school buildings in Naturbora",
  },
  {
    ...
    description: {
      ...
      ro: "Regiunea Fatumean, de la granița de vest, deține rezerve semnificative de mangan. Aceste resurse minerale reprezintă un potențial important pentru sectorul minier.",
      en: "The Fatumean region near the western border holds significant manganese deposits. These mineral resources represent high potential for the country's mining sector.",
    },
    facts: {
      de: ["Vorkommen von hochwertigem Manganerz", "Gelegen in der Gemeinde Cova Lima", "Bedeutung für zukünftige Exporte", "Geologische Erkundungen seit 2010"],
      hu: ["Kiváló minőségű mangánérc található itt", "Cova Lima község területén fekszik", "Fontos a jövőbeli export szempontjából", "Geológiai feltárások 2010 óta"],
      ro: ["Zăcăminte de minereu de mangan de calitate", "Situat în districtul Cova Lima", "Importanță pentru exporturile viitoare", "Explorări geologice active din 2010"],
      en: ["High-grade manganese ore deposits", "Located in Cova Lima municipality", "Strategic importance for future exports", "Active geological surveys since 2010"],
    },
    imageHint: "geological mineral deposits and hills in Fatumean",
  },
  {
    ...
    description: {
      ...
      ro: "Vemasse este o zonă centrală pentru producția de orez din nord, irigată printr-un sistem extins de canale. Asigură aprovizionarea cu alimente a regiunii Baucau.",
      en: "Vemasse is a primary northern hub for rice production, supported by an extensive irrigation canal network. It is crucial for Baucau's regional food security.",
    },
    facts: {
      de: ["Versorgung von Hunderten Hektar Reis", "Wiederaufbau nach der Unabhängigkeit", "Zentrum des regionalen Reishandels", "Nutzung des Vemasse-Flusses"],
      hu: ["Több száz hektár rizsföldet lát el", "A függetlenség után újjáépítették", "A regionális rizskereskedelem központja", "A Vemasse-folyó vizét hasznosítja"],
      ro: ["Irigă sute de hectare de orez", "Reconstruit după obținerea independenței", "Centru al comerțului regional cu orez", "Utilizează apele râului Vemasse"],
      en: ["Provides water to hundreds of hectares", "Reconstructed after independence", "Hub for regional rice trade", "Utilizes water from the Vemasse River"],
    },
    imageHint: "modern irrigation canals and green rice fields in Vemasse",
  },
  {
    ...
    description: {
      ...
      ro: "Bazinul Laleia găzduiește una dintre cele mai productive zone de cultivare a orezului din țară. Un sistem de irigații complex permite mai multe recolte pe an.",
      en: "The Laleia basin hosts one of the most productive rice cultivation areas in the nation. A complex irrigation network enables multiple harvests per year.",
    },
    facts: {
      de: ["Hochproduktive Schwemmlandböden", "Infrastruktur aus der Kolonialzeit", "Zentrales Lager für Getreidevorräte", "Wichtiger Arbeitgeber der Gemeinde"],
      hu: ["Rendkívül termékeny hordalékos talaj", "Gyarmati korból származó infrastruktúra", "Központi gabonaraktárak helyszíne", "A község egyik legfontosabb munkaadója"],
      ro: ["Soluri aluvionare de mare productivitate", "Infrastructură datând din epoca colonială", "Depozit central pentru rezerve de cereale", "Principal angajator din comunitate"],
      en: ["Highly productive alluvial soils", "Infrastructure dating to colonial times", "Site of central grain storage facilities", "Major employer in the local municipality"],
    },
    imageHint: "vast emerald green rice paddies in Laleia valley",
  },
  {
    ...
    description: {
      ...
      ro: "Acest proiect din districtul Viqueque utilizează resursele de apă ale regiunii pentru cultivarea intensivă a orezului. Este un pilon al dezvoltării economice pe coasta de sud.",
      en: "This project in Viqueque municipality harnesses regional water resources for intensive rice farming. It is a cornerstone of economic development on the south coast.",
    },
    facts: {
      de: ["Größtes Bewässerungssystem im Süden", "Unterstützung durch internationale Hilfe", "Fokus auf Ernährungssouveränität", "Mehr als 1.000 Hektar Anbaufläche"],
      hu: ["A déli országrész legnagyobb öntözőrendszere", "Nemzetközi segélyek támogatásával épült", "Cél az élelmiszer-önrendelkezés", "Több mint 1000 hektár termőterület"],
      ro: ["Cel mai mare sistem de irigații din sud", "Sprijinit prin asistență internațională", "Concentrare pe suveranitatea alimentară", "Peste 1.000 de hectare de teren cultivat"],
      en: ["Largest irrigation system in the south", "Supported by international aid projects", "Focus on national food sovereignty", "Covers more than 1,000 hectares of land"],
    },
    imageHint: "irrigation infrastructure and farming in Viqueque",
  },
  {
    ...
    description: {
      ...
      ro: "Platoul Lautém este cel mai important centru pentru creșterea vitelor din Timorul de Est. Pășunile vaste permit o producție semnificativă de carne pentru piața internă.",
      en: "The Lautém plateau is the premier center for cattle ranching in Timor-Leste. Its vast grasslands support a significant livestock industry for the domestic meat market.",
    },
    facts: {
      de: ["Zentrum der nationalen Rinderzucht", "Exportpotential für lebendes Vieh", "Traditionelle und moderne Farmmethoden", "Größte Weideflächen des Landes"],
      hu: ["A nemzeti szarvasmarha-ágazat központja", "Élőállat-export potenciál", "Hagyományos és modern módszerek", "Az ország legnagyobb legelőterületei"],
      ro: ["Centrul sectorului național de bovine", "Potențial de export pentru animale vii", "Metode de creștere tradiționale și moderne", "Cele mai mari suprafețe de pășunat din țară"],
      en: ["Center of the national cattle industry", "Potential for live animal exports", "Blend of traditional and modern ranching", "Largest grazing pastures in the country"],
    },
    imageHint: "cattle grazing on the wide grassy plateau of Lautem",
  },
  {
    ...
    description: {
      ...
      ro: "În regiunile muntoase din Atsabe se află unități specializate de procesare a cafelei Arabica de înaltă calitate. Aceste instalații pregătesc boabele pentru export.",
      en: "The highland regions of Atsabe host specialized processing facilities for premium Arabica coffee. These mills prepare beans for high-value international export.",
    },
    facts: {
      de: ["Schwerpunkt auf Fair-Trade-Kaffee", "Verarbeitung in Höhenlage", "Zusammenarbeit mit lokalen Kooperativen", "Bekannt für gewaschenen Arabica"],
      hu: ["A méltányos kereskedelemre összpontosít", "Magaslati feldolgozási helyszín", "Együttműködés a helyi szövetkezetekkel", "Híres a mosott Arabica kávéjáról"],
      ro: ["Concentrare pe cafeaua Fair Trade", "Procesare la altitudine ridicată", "Parteneriate cu cooperativele locale", "Renumit pentru Arabica spălată"],
      en: ["Focus on Fair Trade coffee production", "High-altitude processing site", "Collaborates with local smallholder co-ops", "Renowned for washed Arabica varieties"],
    },
    imageHint: "coffee beans drying in the sun at a processing station",
  },
  {
    ...
    description: {
      ...
      ro: "Zona de la vest de aeroportul din Dili este principalul centru pentru industria ușoară și logistică. Găzduiește fabrici de materiale de construcții și bunuri de larg consum.",
      en: "The area west of Dili airport is the primary hub for light industry and logistics. It houses factories producing construction materials and consumer goods.",
    },
    facts: {
      de: ["Größtes Gewerbegebiet der Hauptstadt", "Nähe zum internationalen Flughafen", "Produktion von Zementprodukten", "Logistikzentrum für Importwaren"],
      hu: ["A főváros legnagyobb kereskedelmi övezete", "A nemzetközi repülőtér közelében fekszik", "Cementtermékek gyártása itt zajlik", "Importcikkek logisztikai központja"],
      ro: ["Cea mai mare zonă comercială a capitalei", "Proximitate față de aeroportul internațional", "Producție de produse din ciment", "Hub logistic pentru bunuri de import"],
      en: ["Largest commercial zone in the capital", "Proximity to international airport", "Production of cement-based products", "Logistics hub for imported materials"],
    },
    imageHint: "warehouses and light industrial buildings in Dili",
  },
  {
    ...
    description: {
      ...
      ro: "Colmera este inima economică a orașului Dili, unde sunt concentrate bănci, clădiri guvernamentale și centre comerciale. Este locul principal pentru tranzacții comerciale.",
      en: "Colmera is the economic heart of Dili, concentrating banks, government offices, and retail centers. It is the primary location for commercial activity in the nation.",
    },
    facts: {
      de: ["Sitz der Zentralbank von Timor-Leste", "Hauptstandort für Finanzdienstleistungen", "Zentrum des gehobenen Einzelhandels", "Wichtigster Bürostandort in Dili"],
      hu: ["A Timor-Leste-i Központi Bank székhelye", "A pénzügyi szolgáltatások fő helyszíne", "A nívós kiskereskedelem központja", "Dili legfontosabb irodanegyede"],
      ro: ["Sediul Băncii Centrale a Timorului de Est", "Locație principală pentru servicii financiare", "Centru pentru comerțul cu amănuntul modern", "Cea mai importantă zonă de birouri din Dili"],
      en: ["Headquarters of the Central Bank", "Main location for financial services", "Hub for modern retail and services", "Primary office district in Dili"],
    },
    imageHint: "modern office buildings and shops in central Dili",
  },
  {
    ...
    description: {
      ...
      ro: "Viqueque este o zonă majoră de cultivare a palmierilor de cocos pentru producția de copră. Miezul de nucă de cocos uscat este procesat în ulei sau pregătit pentru export.",
      en: "Viqueque is a major area for coconut cultivation used in copra production. The dried coconut meat is processed into oil or prepared for agricultural export.",
    },
    facts: {
      de: ["Wichtige Einkommensquelle für Bauern", "Verarbeitung zu Speiseöl und Seife", "Nutzung weitläufiger Küstenhaine", "Bedeutung für die lokale Industrie"],
      hu: ["Fontos jövedelemforrás a gazdáknak", "Étolaj és szappan alapanyaga", "Kiterjedt parti ültetvények használata", "Meghatározó a helyi ipar számára"],
      ro: ["Sursă importantă de venit pentru fermieri", "Procesare în ulei alimentar și săpun", "Utilizarea plantațiilor de coastă vaste", "Importanță majoră pentru industria locală"],
      en: ["Vital income source for local farmers", "Processing into cooking oil and soap", "Utilizes extensive coastal palm groves", "Significance for regional light industry"],
    },
    imageHint: "coconuts being dried in the sun for copra",
  },
  {
    ...
    description: {
      ...
      ro: "În apropierea lagunei Maubara, sarea este extrasă prin evaporare de generații. Acest produs artizanal este de mare importanță pentru piețele din vestul țării.",
      en: "Near the Maubara lagoon, salt has been extracted through evaporation for generations. This artisanal product is crucial for markets in the western districts.",
    },
    facts: {
      de: ["Handwerkliche Gewinnungsmethoden", "Gelegen an der Küste von Liquiçá", "Verkauf entlang der Hauptstraße", "Kulturelles und ökonomisches Erbe"],
      hu: ["Kézműves kitermelési módszerek", "Liquiçá partvidékén található", "Közvetlen értékesítés a főút mentén", "Kulturális és gazdasági örökség"],
      ro: ["Metode de extracție artizanale", "Situat pe coasta districtului Liquiçá", "Vânzare directă de-a lungul drumului", "Moștenire culturală și economică"],
      en: ["Handcrafted extraction methods", "Located on the Liquiçá coastline", "Sold directly along the main highway", "Cultural and economic heritage site"],
    },
    imageHint: "local people selling bags of salt by the roadside in Maubara",
  },
  {
    ...
    description: {
      ...
      ro: "Lospalos este principala zonă pentru recoltarea și procesarea nucilor de lumânare (candlenut). Uleiul extras este folosit în cosmetică și ca combustibil.",
      en: "Lospalos is a primary area for harvesting and processing candlenuts (kemiri). The oil extracted from these nuts is used in cosmetics and as a sustainable fuel.",
    },
    facts: {
      de: ["Exportgut für die Kosmetikindustrie", "Bedeutender Wirtschaftszweig in Lautém", "Nachhaltige Wildsammlung", "Verarbeitung zu Lampenöl"],
      hu: ["Kozmetikai ipari exportcikk", "Lautém község jelentős ágazata", "Fenntartható vadon gyűjtés", "Lámpaolajként is feldolgozzák"],
      ro: ["Produs de export pentru cosmetică", "Ramură economică majoră în Lautém", "Colectare sustenabilă din sălbăticie", "Procesare pentru ulei de iluminat"],
      en: ["Export product for cosmetics industry", "Major economic sector in Lautém", "Sustainable wild harvesting practices", "Processed into traditional lamp oil"],
    },
    imageHint: "candlenut harvest and drying in Lospalos",
  },
  {
    ...
    description: {
      ...
      ro: "Regiunea din jurul Fatu-Lulic este un centru pentru reîmpădurirea și gestionarea lemnului de santal. Această resursă valoroasă este esențială pentru silvicultura viitoare.",
      en: "The region around Fatu-Lulic is a hub for the reforestation and management of sandalwood trees. This historically prized resource is a key part of future forestry.",
    },
    facts: {
      de: ["Historisch wichtigstes Exportgut", "Staatliche Wiederaufforstungsprogramme", "Hochwertiges ätherisches Öl", "Gelegen im Hochland von Cova Lima"],
      hu: ["Történelmileg a legfontosabb exportcikk", "Állami újratelepítési programok helyszíne", "Kiváló minőségű illóolaj forrása", "Cova Lima felföldjein található"],
      ro: ["Cel mai important produs de export istoric", "Programe guvernamentale de reîmpădurire", "Sursă de ulei esențial de înaltă calitate", "Situat în zonele înalte din Cova Lima"],
      en: ["Historically the primary export of Timor", "Government-led reforestation programs", "Source of high-value essential oils", "Located in the Cova Lima highlands"],
    },
    imageHint: "young sandalwood trees in a nursery or plantation",
  },
  {
    ...
    description: {
      ...
      ro: "Aeroportul Baucau are cea mai lungă pistă din țară și servește ca un important hub logistic. Joacă un rol central în mișcarea mărfurilor în est.",
      en: "Baucau Airport features the longest runway in the country and serves as a vital logistics hub. It plays a central role in cargo movement for the eastern districts.",
    },
    facts: {
      de: ["Längste Startbahn in Timor-Leste", "Strategisches Frachtdrehkreuz", "Basis für Katastrophenschutzlogistik", "Wichtiger Wirtschaftsfaktor für Baucau"],
      hu: ["Timor-Leste leghosszabb kifutópályája", "Stratégiai teherforgalmi csomópont", "Katasztrófavédelmi logisztikai bázis", "Baucau fontos gazdasági tényezője"],
      ro: ["Cea mai lungă pistă din Timorul de Est", "Hub strategic de transport de marfă", "Bază logistică pentru ajutor în caz de dezastru", "Factor economic major pentru Baucau"],
      en: ["Longest runway in Timor-Leste", "Strategic air cargo transshipment point", "Base for disaster relief logistics", "Major economic asset for Baucau municipality"],
    },
    imageHint: "aerial view of the long runway at Baucau Airport",
  },
  {
    ...
    description: {
      ...
      ro: "Aileu este un centru pentru silvicultură sustenabilă și procesarea lemnului în zonele înalte centrale. Aici sunt pregătite lemne locale pentru construcții și mobilă.",
      en: "Aileu is a center for sustainable forestry and timber processing in the central highlands. It prepares local wood for construction and furniture manufacturing.",
    },
    facts: {
      de: ["Fokus auf Teak- und Mahagoniholz", "Zentrum für Tischlereihandwerk", "Versorgung des Marktes in Dili", "Förderung lokaler Waldressourcen"],
      hu: ["Tík- és mahagónifa-feldolgozás", "Az asztalosmesterség központja", "A dili piac kiszolgálása", "Helyi erdei erőforrások hasznosítása"],
      ro: ["Concentrare pe lemn de tec și mahon", "Centru pentru meșteșugul tâmplăriei", "Aprovizionarea pieței din Dili", "Promovarea resurselor forestiere locale"],
      en: ["Focus on teak and mahogany timber", "Regional hub for carpentry crafts", "Supplies wood products to Dili", "Manages local highland forest resources"],
    },
    imageHint: "piles of timber and woodworking workshop in Aileu",
  },
  {
    ...
    description: {
      ...
      ro: "Piața din Bobonaro este unul dintre cele mai mari puncte de comerț cu animale din vestul țării. Fermierii din regiunea de graniță vând aici vite, bivoli și porci.",
      en: "The Bobonaro market is one of the largest livestock trading hubs in western Timor-Leste. Farmers from across the border region trade cattle, buffalo, and pigs here.",
    },
    facts: {
      de: ["Wichtigster Handelsplatz der Region", "Handel mit Wasserbüffeln und Rindern", "Zentrum des grenzüberschreitenden Austauschs", "Wöchentlicher Markttag"],
      hu: ["A régió legfontosabb kereskedelmi helye", "Vízibivaly- és szarvasmarha-kereskedelem", "A határon átnyúló csereforgalom központja", "Heti rendszerességű vásárnap"],
      ro: ["Cel mai important punct comercial regional", "Comerț cu bivoli de apă și vite", "Centru pentru schimburi transfrontaliere", "Zi de târg săptămânală"],
      en: ["Most important regional trading site", "Trade in water buffalo and cattle", "Hub for cross-border economic exchange", "Hosts weekly major market days"],
    },
    imageHint: "traditional livestock market with cattle and buffalo",
  }
];
