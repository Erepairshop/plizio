...
export const poiExtraHu3: POI[] = [
  // HU-BU: Budapest (3G, 1LN, 1W)
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Aquincumi Múzeum lenyűgöző betekintést nyújt a római kori életbe a Duna partján. Pannónia provincia egykori központjaként Aquincum jelentős katonai és polgári központja volt a Római Birodalomnak. A kiterjedt ásatási területen lakóházak, közfürdők, templomok és két lenyűgöző amfiteátrum maradványai láthatók. A látogatók az ókori utcákon sétálva megcsodálhatják a jól megőrzött alapfalakat és a díszes mozaikpadlókat. A múzeum értékes régészeti leleteket őriz, köztük szobrokat, ékszereket, érméket és az Aquincumi Víziorgonát. A romkert szemléletesen mutatja be a fejlett római mérnöki tudást és várostervezést. Az évente megrendezett fesztiválok és történelmi játékok minden korosztály számára életre keltik a múltat, Budapest egyik legfontosabb kulturális helyszínévé téve a múzeumot.",
      ro: "Muzeul și Parcul Arheologic Aquincum reprezintă cea mai importantă fereastră către trecutul roman al Budapestei. Situat în partea de nord a orașului (Óbuda), Aquincum a fost capitala provinciei Pannonia Inferior, un centru militar și civil înfloritor în primele secole ale erei noastre. Muzeul, înființat la sfârșitul secolului al XIX-lea, conservă ruinele extinse ale orașului civil, inclusiv amfiteatrul, băile publice, piețele și numeroase case particulare decorate cu mozaicuri. Punctul de atracție principal este celebra 'Orgă din Aquincum', un instrument muzical antic unic, restaurat. Vizitatorii pot experimenta viața cotidiană a romanilor prin intermediul expozițiilor interactive și al evenimentelor anuale care reconstituie lupte de gladiatori și ceremonii antice.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Aquincum a devenit sediul guvernatorului provinciei Pannonia în anul 106 d.Hr.", "Populația orașului roman la apogeu era estimată la circa 50.000 de locuitori.", "Muzeul a fost deschis publicului în anul 1894, după primele săpături majore.", "Parcul arheologic conservă resturile a două amfiteatre romane diferite.", "Orga hidraulică din secolul III a fost descoperită în anul 1931.", "Situl este inclus pe lista indicativă a patrimoniului mondial UNESCO."],
      en: []
    },
  },
  {
    ...
    factsAdvanced: {
      ...
      hu: ["A csarnok 1897-ben készült el Pecz Samu építész tervei alapján.", "Megnyitásakor kora egyik legmodernebbje volt saját vasúti rakodóval.", "Jellegzetes tetőcserepei a pécsi Zsolnay-gyárból származnak.", "A második világháború alatt az épület súlyos károkat szenvedett.", "Az 1990-es években teljes körű felújításon esett át a csarnok.", "Alapterülete mintegy 10 000 négyzetmétert tesz ki.", "Olyan hírességek is megfordultak itt, mint Diana hercegnő vagy Margaret Thatcher.", "A legalsó szinten találhatók a híres vecsési savanyúságokat kínáló standok."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A kecskeméti Nagytemplom, hivatalos nevén az Urunk Mennybemenetele Társszékesegyház, az Alföld legnagyobb késő barokk stílusú temploma. Szent Miklós tiszteletére szentelték, és 73 méter magas tornyával megkerülhetetlen eleme a város szívének. Az építkezés a 18. század végén kezdődött, Kecskemét gazdasági felemelkedésének idején. Monumentális homlokzata és klasszicizáló elemei tekintélyt parancsolnak. A templom belseje tágas és díszes, lenyűgöző oltárokkal és mennyezeti freskókkal, amelyek a vallási eseményeket örökítik meg. A toronyban régebben tűzfigyelő szolgálat is működött, ma pedig harangjai messzire zengenek a rónaság felett. A Nagytemplom a hívő közösség központja és a város egyik legfontosabb műemléke.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      ...
      hu: ["73 méteres tornya hosszú ideig a legmagasabb volt az egész Alföldön.", "Az építkezés majdnem 30 évig tartott és 1806-ban fejeződött be teljesen.", "Homlokzatát Szent Miklós és más szentek nagyméretű szobrai díszítik.", "A templomban emléktábla őrzi az 1911-es földrengés áldozatainak emlékét.", "Orgonája híres telt hangzásáról, gyakran tartanak benne egyházi koncerteket.", "A toronyból tiszta időben az egész kiskunsági rónaság belátható.", "Harangjai közül a legnagyobb több tonnát nyom, hangja méltóságteljes.", "Az épület országos műemléki védettséget élvez és minden városnézés része."],
      ro: [],
      en: []
    },
  },
  ...
  // HU-KE: Komárom-Esztergom (2G, 2LN, 1W)
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az esztergomi bazilika, hivatalos nevén a Nagyboldogasszony- és Szent Adalbert-főszékesegyház, Magyarország legnagyobb temploma és a katolikus egyház hazai központja. A várhegyen magasodó monumentális épület 100 méter magas kupolájával uralja a Dunakanyar látképét. Klasszicista stílusa tekintélyt parancsoló, belső tere pedig lélegzetelállító méretekkel büszkélkedhet. Itt található a világ legnagyobb, egyetlen vászonra festett oltárképe. Különleges kincse a vörös márványból készült Bakócz-kápolna, amely a magyarországi reneszánsz legszebb fennmaradt emléke. A bazilika kincstára Európa-szerte híres ötvösművészeti gyűjteményével. A kupola körerkélyéről nyíló panoráma felejthetetlen élményt nyújt a Duna felett.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A százhalombattai MOL Olajfinomító, más néven Dunai Finomító, Magyarország legfontosabb ipari létesítménye az energiaellátás szempontjából. Mint az ország legnagyobb kőolaj-feldolgozója, kulcsszerepet játszik a gazdaság motorjának fenntartásában, itt készül a hazai üzemanyagok döntő többsége. A hatalmas komplexum a Duna partján fekszik, és bonyolult csővezeték-hálózattal kapcsolódik a nemzetközi nyersolaj-vezetékekhez. Modern technológiája és szigorú biztonsági rendszerei európai szinten is kiemelkedőek. Az utóbbi években a gyár a fenntartható jövő felé nyit: hatalmas zöldhidrogén-üzemet és napelemparkot építenek, hogy csökkentsék a környezeti lábnyomot, miközben garantálják az ország energiabiztonságát.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A szabolcsi alma Magyarország egyik legismertebb mezőgazdasági terméke és a Nyírség büszkesége. Szabolcs-Szatmár-Bereg vármegye löszös talaja és sajátos mikroklímája ideális feltételeket biztosít a gyümölcstermesztéshez. Különösen híres a Jonatán alma, amely ezen a vidéken nyeri el jellegzetes, lángvörös színét és édes-savanykás ízvilágát. Az almatermesztés évszázados hagyományokra tekint vissza, és ma is több ezer család megélhetését biztosítja a térségben. A szabolcsi alma nemcsak friss gyümölcsként, hanem kiváló minőségű lé- és pálinkaalapanyagként is keresett az európai piacokon, képviselve a magyar minőséget és szaktudást.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A dunaföldvári vár, ismertebb nevén a Csonka-torony, a Duna menti védelmi rendszer egyik fontos láncszeme volt. A 15. században emelt négyszögletes öregtorony stratégiai helyen, a folyó feletti magaslaton őrizte a révátkelőt és a kereskedelmi utakat. A török háborúk idején a vár és a torony súlyos károkat szenvedett, de mindvégig fontos katonai pont maradt. Ma a felújított torony múzeumként várja a látogatókat, bemutatva a város és a dunai hajózás történetét. A legfelső szintről páratlan kilátás nyílik a Duna hömpölygő vizére és az Alföld végtelen rónaságára, összekötve a történelmi múltat a természeti szépséggel.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A nagylengyeli olajmező a magyar kőolajbányászat történelmi jelentőségű bölcsője Zala vármegyében. Az 1950-es évek elején felfedezett lelőhely hosszú ideig az ország leggazdagabb kőolaj-forrása volt, alapjaiban határozva meg a hazai energiaipart. A vidék jellegzetes látképét ma is a 'bólogató' mélységi szivattyúk adják, amelyek a fekete aranyat hozzák a felszínre a mélyből. Az itteni olaj különlegessége a magas bitumentartalom, amely kiválóan alkalmas útépítési alapanyagok gyártására. Bár a kitermelés csúcsidőszaka már elmúlt, Nagylengyel és környéke ma is élő példája az emberi technológia és a természet kincseinek találkozásának, megőrizve az olajmunkások szakmai büszkeségét.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
