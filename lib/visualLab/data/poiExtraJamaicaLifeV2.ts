...
export const poiExtraJamaicaLifeV2: POI[] = [
  ...
  },
  {
    ...
    description: { de: "Jamaikas größter Wasserpark in Negril mit aufregenden Rutschen und einem künstlichen Fluss für Kinder.", hu: "Jamaica legnagyobb víziparkja Negrilben, izgalmas csúszdákkal és egy mesterséges folyóval a gyerekek számára.", ro: "Cel mai mare parc acvatic din Jamaica, situat în Negril, cu tobogane palpitante și un râu leneș pentru copii.", en: "Jamaica's largest water park located in Negril, featuring thrilling slides and a lazy river for kids." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Eine funktionierende Kaffee- und Ananasplantage in den Ausläufern der Catadupa Mountains.", hu: "Működő kávé- és ananászültetvény a Catadupa-hegység lábánál.", ro: "O plantație funcțională de cafea și ananas la poalele Munților Catadupa.", en: "A working coffee and pineapple plantation in the foothills of the Catadupa Mountains." },
    facts: {
  ...
  },
  {
    ...
    type: "agriculture",
    parent: "JM-06",
    coords: [-77.0142, 18.3615],
    name: { de: "Sun Valley Plantage", hu: "Sun Valley Ültetvény", ro: "Plantația Sun Valley", en: "Sun Valley Plantation" },
    description: { de: "Ein aktiver Bauernhof in St. Ann, der den Anbau von Bananen, Kokosnüssen und exotischen Früchten zeigt.", hu: "Egy aktív gazdaság St. Ann-ben, amely banán, kókuszdió és egzotikus gyümölcsök termesztését mutatja be.", ro: "O fermă activă în St. Ann, care prezintă cultivarea bananelor, nucilor de cocos și a fructelor exotice.", en: "An active farm in St. Ann showcasing the cultivation of bananas, coconuts, and exotic fruits." },
    facts: {
      de: ["Bietet lehrreiche Touren zur Botanik an.", "Besucher können frische Früchte probieren."],
      hu: ["Oktató botanikai túrákat kínál.", "A látogatók friss gyümölcsöket kóstolhatnak."],
      ro: ["Oferă tururi botanice educative.", "Vizitatorii pot degusta fructe proaspete."],
      en: ["Offers educational botany tours.", "Visitors can taste fresh fruits."]
    }
  },
  {
    id: "brimmer-hall-estate-life-v2",
    type: "agriculture",
    parent: "JM-05",
  ...
  },
  {
    ...
    description: { de: "Eine hochgelegene Farm, die den weltberühmten jamaikanischen Kaffee produziert.", hu: "Magasan fekvő gazdaság, amely a világhírű jamaicai kávét termeli.", ro: "O fermă la altitudine înaltă care produce renumita cafea jamaicană.", en: "A high-altitude farm that produces the world-famous Jamaican coffee." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Ein botanischer Garten und eine Kunstgalerie in den Hügeln über Montego Bay, beliebt bei Familien und Vogelliebhabern.", hu: "Botanikus kert és művészeti galéria a Montego Bay feletti dombokon, népszerű a családok és a madárbarátok körében.", ro: "O grădină botanică și o galerie de artă în dealurile de deasupra orașului Montego Bay, populară printre familii și iubitorii de păsări.", en: "A botanical garden and art gallery in the hills above Montego Bay, popular with families and bird lovers." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Eine Gruppe von Mangroveninseln in der Bucht von Montego Bay, die als wichtiger Nistplatz für Reiher und Pelikane dienen.", hu: "Mangroveszigetek csoportja a Montego Bay öbölben, amelyek fontos fészkelőhelyként szolgálnak gémek és pelikánok számára.", ro: "Un grup de insule de mangrove în Golful Montego Bay, care servesc drept loc important de cuibărit pentru stârci și pelicani.", en: "A group of mangrove islands in Montego Bay serving as an important nesting site for herons and pelicans." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Eine abgelegene Inselgruppe, auf der jedes Jahr hunderte bedrohte Meeresschildkröten ihre Eier ablegen.", hu: "Félreeső szigetcsoport, ahol minden évben több száz veszélyeztetett tengeri teknős rakja le tojásait.", ro: "Un grup de insule îndepărtate unde sute de broaște țestoase marine pe cale de dispariție își depun ouăle în fiecare an.", en: "A remote island group where hundreds of endangered sea turtles lay their eggs every year." },
    facts: {
  ...
  },
  {
    ...
    description: { de: "Ein üppiges Tal in St. James, das für den großflächigen Anbau von Orangen und Pampelmusen genutzt wird.", hu: "Buja völgy St. James-ben, amelyet nagyüzemi narancs- és pomelótermesztésre használnak.", ro: "O vale luxuriantă în St. James, folosită pentru cultivarea pe scară largă a portocalelor și pomelo.", en: "A lush valley in St. James used for the large-scale cultivation of oranges and pomelos." },
    facts: {
  ...
  },
  {
    ...
    type: "animal-habitat",
    parent: "JM-11",
    coords: [-77.7812, 17.8821],
    name: { de: "Billy's Bay Schildkröten-Schutzgebiet", hu: "Billy's Bay Teknősvédelmi Terület", ro: "Rezervația de Broaște Țestoase Billy's Bay", en: "Billy's Bay Turtle Sanctuary" },
    description: { de: "Ein lokales Projekt an der Südküste, das sich dem Schutz von Meeresschildkrötennestern und dem sicheren Schlüpfen der Babys widmet.", hu: "Helyi projekt a déli parton, amely a tengeri teknősök fészkeinek védelmének és a kicsik biztonságos kikelésének szenteli magát.", ro: "Un proiect local pe coasta de sud, dedicat protejării cuiburilor de broaște țestoase marine și eclozării în siguranță a puilor.", en: "A local project on the south coast dedicated to protecting sea turtle nests and the safe hatching of babies." },
    facts: {
      de: ["Wird von der lokalen Gemeinschaft betrieben.", "Besucher können beim Freilassen der Baby-Schildkröten zusehen."],
      hu: ["A helyi közösség működteti.", "A látogatók megnézhetik a kis teknősök szabadon engedését."],
      ro: ["Operat de comunitatea locală.", "Vizitatorii pot urmări eliberarea puilor de țestoasă."],
      en: ["Operated by the local community.", "Visitors can watch the release of baby turtles."]
    }
  }
];