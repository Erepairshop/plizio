...
export const poiExtraVenezuelaHistoryV2: POI[] = [
    ...
    }, image: "/poi-images/venezuela-campo-de-carabobo-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construită în 1662 pentru a proteja Pampatar.", "Cetatea oferă vedere la Marea Caraibilor.", "Construcția a fost un răspuns direct la amenințarea constantă a piraților asupra rutelor comerciale.", "Este parte a moștenirii naționale a Venezuelei pe Insula Margarita."],
      en: [],
    ...
    }, image: "/poi-images/venezuela-castillo-de-santa-rosa-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construit în 1586 pentru a proteja insula.", "Distrus de pirați în 1626.", "Ruinele de la La Caranta reprezintă un loc valoros pentru cercetarea arheologică.", "Sunt situate într-un golf pitoresc care oferă și astăzi o privire strategică."],
      en: [],
    }, image: "/poi-images/venezuela-fortin-de-la-caranta-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Locul Congresului de la Angostura din 1819.", "Discursul lui Bolívar de la Angostura este unul dintre cele mai importante documente ale istoriei independenței latino-americane.", "Arhitectura clădirii este tipică pentru stilul colonial din câmpiile Orinoco.", "Aici a fost modelată viziunea Marii Columbii."],
      en: [],
    }, image: "/poi-images/venezuela-casa-del-congreso-angostura-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Prima așezare spaniolă din America de Sud.", "Distrusă de un tsunami în 1541.", "Insula Cubagua era faimoasă pentru bogăția sa enormă în perle.", "Săpăturile arheologice dezvăluie viața în primul oraș colonial din America de Sud."],
      en: [],
    }
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Inițial o mănăstire franciscană.", "Mănăstirea a fost fortificată în 1817 pentru a se apăra împotriva trupelor spaniole.", "După victorie, sute de luptători pentru independență au fost uciși în Casa Fuerte.", "Ruinele servesc astăzi ca memorial pentru victimele războaielor de independență venezuelene."],
      en: [],
    }, image: "/poi-images/venezuela-casa-fuerte-barcelona-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construit în 1622 pentru a proteja salinele.", "Grav avariat de un cutremur în 1797.", "Cetatea din Araya a fost un punct de protecție central pentru comerțul cu sare.", "Araya a fost una dintre cele mai disputate regiuni de pe coasta caraibiană."],
      en: [],
    }, image: "/poi-images/venezuela-ruinas-castillo-araya-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construit între 1659 și 1686 în Cumaná.", "Construcția a fost un răspuns la atacurile piraților.", "Cetatea a supraviețuit mai multor cutremure istorice.", "Astăzi este un monument semnificativ și o destinație turistică în Cumaná."],
      en: [],
    ...
    }, image: "/poi-images/venezuela-casa-amarilla-caracas-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construită inițial în 1636.", "Catedrala a fost grav avariată după cutremurul din 1812 și renovată de mai multe ori.", "Astăzi găzduiește opere de artă religioasă importante ale țării.", "Cripta familiei lui Simón Bolívar este un loc memorial istoric semnificativ."],
      en: [],
    }, image: "/poi-images/venezuela-catedral-caracas-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Bolívar a fost proclamat Eliberator aici în 1813.", "Clădirea are una dintre cele mai vechi structuri conservate în centrul orașului Caracas.", "Găzduiește astăzi colecții culturale și istorice semnificative.", "Arhitectura colonială este excelent documentată în această clădire."],
      en: [],
    }, image: "/poi-images/venezuela-convento-san-francisco-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Casă de țară din epoca colonială construită în 1797.", "Muzeul de Artă Colonială este unul dintre cele mai bine dotate de acest fel din Venezuela.", "Quinta de Anauco și-a păstrat arhitectura în mod exemplar de-a lungul secolelor.", "Grădinile proprietății sunt un loc important pentru diversitatea botanică din Caracas."],
      en: [],
    ...
    }, image: "/poi-images/venezuela-casona-ibarra-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construită la începutul secolului al XX-lea.", "Hugo Chávez a condus prima tentativă de lovitură de stat în 1992 din această cazarmă.", "Astăzi mulți vizitează locul pentru a vedea mausoleul.", "Semnificația istorică a clădirii pentru ascensiunea chavismului este incontestabilă."],
      en: [],
    }
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Comemorează o victorie din 1813.", "Victoria de la Taguanes i-a deschis calea lui Bolívar către Caracas.", "Monumentul a fost ridicat în secolul al XX-lea ca sit memorial național.", "Campania din 1813 a fost decisivă pentru primele succese ale republicii."],
      en: [],
    }, image: "/poi-images/venezuela-monumento-batalla-taguanes-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construcția a început în 1583.", "Arhitectural, este un exemplu al stilului colonial din regiune.", "Catedrala formează centrul religios al centrului istoric din Coro.", "Păstrează comori de artă sacră prețioase din perioada colonială timpurie."],
      en: [],
    }, image: "/poi-images/venezuela-catedral-de-coro-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construită în secolul al XVII-lea în Coro.", "Grila din fier forjat de la balcon este unul dintre cele mai bine conservate exemplare din acea vreme în Coro.", "Metoda de construcție este tipică pentru conacele urbane din perioada colonială timpurie.", "Clădirea a fost restaurată exemplar de-a lungul secolelor."],
      en: [],
    }, image: "/poi-images/venezuela-casa-ventanas-hierro-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construită în 1734 de o companie comercială bască.", "Compania Guipuzcoana deținea monopolul comerțului dintre Caracas și Bilbao.", "Clădirea a fost asigurată prin arhitectura sa masivă pentru a servi ca sediu administrativ.", "Astăzi găzduiește arhiva și muzeul despre istoria economică a regiunii."],
      en: [],
    }, image: "/poi-images/venezuela-casa-guipuzcoana-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construit în 1769 pentru a proteja La Guaira.", "Reprezintă un exemplu remarcabil de arhitectură militară din perioada colonială târzie.", "După independență, și-a pierdut funcția militară primară, dar a rămas un monument istoric.", "Astăzi este un loc popular pentru vizitatori pentru a studia fortificațiile de coastă."],
      en: [],
    }, image: "/poi-images/venezuela-fuerte-san-carlos-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Locuită de Simón Bolívar și soția sa în 1802.", "Restaurată recent în Caracas.", "Casa documentează perioada fericită, deși scurtă, a căsătoriei lui Bolívar.", "Interiorul oferă o perspectivă asupra stilului de locuire al familiilor înstărite din Caracas în jurul anului 1800."],
      en: [],
    }, image: "/poi-images/venezuela-casa-del-vinculo-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Plantație istorică de tutun și cafea.", "Astăzi un parc cultural în Caracas.", "Parcurile extinse oferă spațiu pentru o floră diversă și evenimente culturale.", "Facilitatea a fost restaurată cu grijă pentru a-și păstra structura istorică."],
      en: [],
    }, image: "/poi-images/venezuela-hacienda-la-trinidad-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construit la sfârșitul secolului al XIX-lea.", "A jucat un rol în Bătălia de la Ciudad Bolívar din 1903.", "Poziția sa a permis controlul asupra accesului în port.", "Astăzi, ruinele servesc drept memorial pentru istoria militară a orașului Ciudad Bolívar."],
      en: [],
    }, image: "/poi-images/venezuela-fortin-el-zamuro-history-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construită în secolul al XVIII-lea.", "Centrul celebrului festival al Dracilor Dansatori.", "Sărbătoarea Dracilor Dansatori din Yare este Patrimoniu Mondial UNESCO din 2012.", "Originea sincretică a festivalului (amestec de tradiții catolice și africane) îl face unic."],
      en: [],
    }
  }
];
