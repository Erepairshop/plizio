...
export const italyCities: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Padua, eine der ältesten Städte Norditaliens, ist ein bedeutendes religiöses, akademisches und künstlerisches Zentrum in der Region Venetien. Die Stadt ist weltbekannt für die Scrovegni-Kapelle, die einen der wichtigsten Freskenzyklen von Giotto aus dem frühen 14. Jahrhundert beherbergt und als Wendepunkt in der westlichen Kunstgeschichte gilt. Padua ist zudem die Heimat einer der ältesten Universitäten der Welt, die 1222 gegründet wurde und an der Gelehrte wie Galileo Galilei lehrten. Die Basilika des Heiligen Antonius, eine gewaltige byzantinisch-romanisch-gotische Kirche, zieht jährlich Millionen von Pilgern an, die das Grab des Heiligen besuchen. Ein weiteres markantes Wahrzeichen ist der Prato della Valle, einer der größten elliptischen Plätze Europas, der von einem Wasserkanal und 78 Statuen berühmter Persönlichkeiten umgeben ist. Die Stadt beherbergt auch den ältesten akademischen botanischen Garten der Welt, der seit 1545 an seinem ursprünglichen Standort besteht und zum UNESCO-Welterbe gehört. Heute ist Padua ein dynamisches Wirtschaftszentrum, das historische Pracht mit einer lebendigen studentischen Atmosphäre verbindet.",
      hu: "Padova Észak-Olaszország egyik legrégebbi városa, Veneto régió vallási, tudományos és művészeti központja. A város világszerte ismert a Scrovegni-kápolnáról, amely Giotto 14. század eleji freskóciklusának ad otthont; ez a mű az európai festészet egyik legfontosabb mérföldköve, a reneszánsz előfutára. Itt található a világ egyik legrégebbi egyeteme, amelyet 1222-ben alapítottak, és ahol olyan kiválóságok oktattak, mint Galileo Galilei. Szent Antal bazilikája, egy monumentális bizánci-román-gótikus épületegyüttes, hívők millióit vonzza évente a szent sírjához. A város építészeti különlegessége a Prato della Valle, Európa egyik legnagyobb tere, amelyet szobrokkal díszített csatorna ölel körbe. Padova büszkélkedhet a világ legrégebbi, eredeti helyén működő egyetemi botanikus kertjével is, amely 1545 óta várja a látogatókat és az UNESCO Világörökség része. A modern város pezsgő egyetemi életéről és fejlett iparáról is ismert, miközben minden sarkon megelevenedik a középkori és reneszánsz múlt.",
      ro: "Padova, unul dintre cele mai vechi orașe din nordul Italiei, este un centru religios, academic și artistic major din regiunea Veneto. Orașul este celebru în întreaga lume pentru Capela Scrovegni, care adăpostește un ciclu de fresce de Giotto din secolul al XIV-lea, considerat un punct de cotitură în istoria artei occidentale. Padova găzduiește, de asemenea, una dintre cele mai vechi universități din lume, fondată în 1222, unde au predat figuri ilustre precum Galileo Galilei. Bazilica Sfântului Anton, o structură masivă în stil bizantin-romanic-gotic, atrage anual milioane de pelerini la mormântul sfântului. Un alt simbol al orașului este Prato della Valle, una dintre cele mai mari piețe eliptice din Europa, înconjurată de un canal cu apă și 78 de statui ale unor personalități istorice. Orașul deține și cea mai veche grădină botanică universitară din lume, creată în 1545 și inclusă în patrimoniul UNESCO. Astăzi, Padova este un centru economic dinamic care îmbină patrimoniul istoric cu o atmosferă universitară vibrantă.",
      en: "Padua, one of the oldest cities in northern Italy, is a major religious, academic, and artistic center in the Veneto region. The city is world-famous for the Scrovegni Chapel, which houses Giotto's early 14th-century fresco cycle, considered a pivotal masterpiece in the history of Western art. Padua is also home to one of the world's oldest universities, founded in 1222, where scholars like Galileo Galilei once taught. The Basilica of Saint Anthony, a massive Byzantine-Romanesque-Gothic structure, attracts millions of pilgrims annually to the tomb of the saint. Another prominent landmark is the Prato della Valle, one of the largest elliptical squares in Europe, surrounded by a water canal and 78 statues of famous figures. The city also hosts the oldest academic botanical garden in the world, which has remained in its original location since 1545 and is a UNESCO World Heritage site. Modern Padua is a dynamic economic hub that blends its historical grandeur with a lively student atmosphere.",
    },
    factsAdvanced: {
      de: ["Die Universität von Padua wurde 1222 gegründet und ist die zweitälteste Italiens.", "Giotto malte die berühmten Fresken in der Scrovegni-Kapelle zwischen 1303 und 1305.", "Der Prato della Valle ist mit 90.000 Quadratmetern einer der größten Plätze Europas.", "Galileo Galilei verbrachte 18 Jahre als Professor für Mathematik in Padua.", "Der botanische Garten von Padua (1545) ist der älteste universitäre Garten der Welt.", "Die Basilika des Heiligen Antonius ist lokal einfach als \"Il Santo\" bekannt."],
      hu: ["A Padovai Egyetemet 1222-ben alapították, ez Olaszország második legrégebbi egyeteme.", "Giotto 1303 és 1305 között festette meg a Scrovegni-kápolna világhírű freskóit.", "A Prato della Valle 90 000 négyzetméteres területével Európa egyik legnagyobb tere.", "Galileo Galilei 18 éven át volt a matematika professzora a város egyetemén.", "A padovai botanikus kertet 1545-ben alapították, és az UNESCO Világörökség része.", "Szent Antal bazilikáját a helyiek gyakran csak \"Il Santo\" néven emlegetik."],
      ro: ["Universitatea din Padova a fost fondată în 1222, fiind a doua cea mai veche din Italia.", "Giotto a pictat celebrele fresce din Capela Scrovegni între anii 1303 și 1305.", "Prato della Valle este una dintre cele mai mari piețe din Europa, având 90.000 mp.", "Galileo Galilei a predat matematica la Universitatea din Padova timp de 18 ani.", "Grădina Botanică din Padova (1545) este cea mai veche de acest tip din lume.", "Bazilica Sfântului Anton este cunoscută local sub numele de \"Il Santo\"."],
      en: ["The University of Padua was founded in 1222, making it the second oldest in Italy.", "Giotto painted the famous Scrovegni Chapel frescoes between 1303 and 1305.", "Prato della Valle covers 90,000 square meters, making it one of Europe's largest squares.", "Galileo Galilei spent 18 years teaching mathematics at the University of Padua.", "The Botanical Garden of Padua (1545) is the world's oldest academic garden.", "The Basilica of Saint Anthony is locally referred to simply as \"Il Santo\"."],
    },
  },
  {
    id: "it-cremona",
