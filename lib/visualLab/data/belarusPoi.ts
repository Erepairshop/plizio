...
export const belarusCountry: POI = {
  id: "country-belarus",
  type: "country",
  parent: "europe",
  ...
  name: {
    ...
    factsAdvanced: {
        "de": [
            "Belarus gilt als die 'Lunge Europas', da fast 40 Prozent der Landesfläche von dichten Wäldern bedeckt sind.",
            "Die Belovezhskaya Pushcha beherbergt die größte freilebende population des Europäischen Wisents.",
            "Das Land besitzt vier UNESCO-Welterbestätten, darunter die architektonisch bedeutenden Schlösser Mir und Nesvizh.",
            "Die Hauptstadt Minsk wurde nach 1945 fast vollständig im monumentalen sowjetischen Klassizismus wiederaufgebaut.",
            "Mit über 11.000 Seen ist das Land eine der wasserreichsten Regionen Osteuropas."
        ],
        "hu": [
            "Fehéroroszországot Európa tüdejeként emlegetik, mivel területének közel 40 százalékát sűrű erdők borítják.",
            "A Belovezsszkaja Puscsa ad otthont az európai bölény legnagyobb szabadon élő populációjának.",
            "Az ország négy UNESCO Világörökségi helyszínnel büszkélkedhet, köztük a miri és a nyeszvizsi kastélyokkal.",
  ...
  description: {
    ...
    hu: "Fehéroroszország egy kelet-európai szárazföldi ország, amely hatalmas erdőiről, tavairól és a kultúrák találkozásánál kialakult gazdag történelméről ismert.",
    ro: "Belarus este o țară fără ieșire la mare din Europa de Est, cunoscută pentru pădurile sale vaste, lacurile și istoria sa bogată la intersecția culturilor.",
    en: "Belarus is a landlocked country in Eastern Europe, known for its vast forests, lakes, and rich history at the crossroads of cultures."
  },
  descriptionAdvanced: {
    de: "Belarus, offiziell die Republik Belarus, ist ein Land mit einer tiefen Verbundenheit zu seiner Natur und Geschichte. Es beherbergt einige der letzten Urwälder Europas, wie die Belovezhskaya Pushcha, und ist geprägt von einer sanften Hügellandschaft und tausenden von Seen. Die Hauptstadt Minsk ist ein Symbol für den Wiederaufbau nach dem Zweiten Weltkrieg und beeindruckt durch ihre monumentale Architektur. Kulturell ist Belarus durch seine Lage zwischen Ost und West geprägt, was sich in prächtigen Schlössern wie Mir und Nesvizh widerspiegelt. Das Land bewahrt seine Traditionen und ist gleichzeitig ein Ort moderner industrieller und technologischer Entwicklung.",
    hu: "Fehéroroszország, hivatalos nevén a Belarusz Köztársaság, a természethez és a történelemhez fűződő mély kapcsolatáról ismert ország. Itt találhatók Európa utolsó őserdői közül néhány, mint például a Belovezsszkaja Puscsa, táját pedig szelíd dombok és tavak ezrei jellemzik. A főváros, Minszk, a második világháború utáni újjáépítés szimbóluma, és monumentális építészetével nyűgözi le a látogatókat. Kulturális szempontból az országot a Kelet és Nyugat közötti fekvése formálta, ami olyan pompás kastélyokban is megmutatkozik, mint Mir és Nyeszvizs. Az ország őrzi hagyományait, ugyanakkor a modern ipari és technológiai fejlődés helyszíne is.",
    ro: "Belarus, oficial Republica Belarus, este o țară cu o legătură profundă cu natura și istoria sa. Găzduiește unele dintre ultimele păduri virgine din Europa, cum ar fi Belovezhskaya Pushcha, și este caracterizată de un peisaj deluros blând și mii de lacuri. Capitala Minsk este un simbol al reconstrucției după cel de-al Doilea Război Mondial și impresionează prin arhitectura sa monumentală. Din punct de vedere cultural, Belarus este marcat de locația sa între Est și Vest, ceea ce se reflectă în castele magnifice precum Mir și Nesvizh. Țara își păstrează tradițiile, fiind în același timp un loc de dezvoltare industrială și tehnologică modernă.",
    en: "Belarus, officially the Republic of Belarus, is a country with a deep connection to its nature and history. It is home to some of Europe's last primeval forests, such as Belovezhskaya Pushcha, and is characterized by a gentle hilly landscape and thousands of lakes. The capital, Minsk, is a symbol of reconstruction after World War II and impresses with its monumental architecture. Culturally, Belarus is shaped by its location between East and West, reflected in magnificent castles like Mir and Nesvizh. The country preserves its traditions while also being a place of modern industrial and technological development."
  },
  facts: {
    de: [
      "Belarus wird oft als 'Lunge Europas' bezeichnet, da ein Drittel des Landes bewaldet ist.",
      "Im Nationalpark Belovezhskaya Pushcha lebt der Europäische Bison (Wisent).",
      "Minsk wurde im Zweiten Weltkrieg fast vollständig zerstört und im stalinistischen Stil wiederaufgebaut.",
      "Das Land hat über 11.000 Seen, weshalb es auch 'Blauäugiges Belarus' genannt wird.",
      "Die Schlösser Mir und Nesvizh gehören zum UNESCO-Welterbe.",
      "Belarus ist ein weltweit führender Exporteur von Kali-Düngemitteln.",
      "Der höchste Punkt des Landes ist der Dsjarschynskaja Hara mit nur 345 Metern.",
      "In Belarus gibt es zwei Amtssprachen: Belarussisch und Russisch.",
      "Der Nationalpark Braslav-Seen ist für seine einzigartige Gletscherlandschaft bekannt.",
      "Das Marc Chagall Museum befindet sich in seiner Geburtsstadt Vitebsk."
    ],
    hu: [
      "Fehéroroszországot gyakran emlegetik 'Európa tüdejeként', mivel az ország egyharmadát erdő borítja.",
      "A Belovezsszkaja Puscsa Nemzeti Parkban él az európai bölény (vicsent).",
      "Minszk a második világháborúban szinte teljesen elpusztult, és sztálini stílusban építették újjá.",
      "Az országnak több mint 11 000 tava van, ezért 'kék szemű Belarusznak' is nevezik.",
      "A miri és a nyeszvizsi kastélyok az UNESCO Világörökség részét képezik.",
      "Fehéroroszország a világ egyik vezető káliumműtrágya-exportőre.",
      "Az ország legmagasabb pontja a Dzjarzsinszkaja-hara, amely mindössze 345 méter magas.",
      "Fehéroroszországban két hivatalos nyelv van: a fehérorosz és az orosz.",
      "A Braszlavi-tavak Nemzeti Park egyedülálló gleccserformáiról ismert.",
    ...
    ro: [
      ...
      "În Belarus există două limbi oficiale: belarusa și rusa.",
      "Parcul Național Lacurile Braslav este cunoscut pentru peisajul său glaciar unic.",
      "Muzeul Marc Chagall se află în orașul său natal, Vitebsk."
    ],
    en: [
      "Belarus is often called the 'Lungs of Europe' as one-third of the country is forested.",
      "European bison (wisent) live in the Belovezhskaya Pushcha National Park.",
      "Minsk was almost completely destroyed in WWII and rebuilt in the Stalinist style.",
      "The country has over 11,000 lakes, earning it the nickname 'Blue-eyed Belarus'.",
      "Mir and Nesvizh castles are UNESCO World Heritage sites.",
      "Belarus is a top global exporter of potash fertilizers.",
      "The highest point in the country is Dzyarzhynskaya Hara, at only 345 meters.",
      "There are two official languages in Belarus: Belarusian and Russian.",
      "Braslav Lakes National Park is known for its unique glacial landscape.",
      "The Marc Chagall Museum is located in his birthplace, Vitebsk."
    ]
  },
  image: "/geo-images/belarus/country-belarus.webp"
};

export const belarusRegions: POI[] = [
  {
    id: "city-minsk",
    type: "city",
    parent: "country-belarus",
    coords: [27.5667, 53.9000],
    name: {
      de: "Minsk",
      hu: "Minszk",
      ro: "Minsk",
    ...
    factsAdvanced: {
        "de": [
            "Der Unabhängigkeitsboulevard erstreckt sich über 15 Kilometer und ist ein Kandidat für das UNESCO-Welterbe.",
            "Die Stadt wurde für ihre Zerstörung und den heroischen Widerstand im Zweiten Weltkrieg als 'Heldenstadt' ausgezeichnet.",
            "Minsk beherbergt die größte botanische Gartenanlage des Landes mit einer beeindruckenden Pflanzensammlung.",
            "Das Stadtbild wird durch das markante rautenförmige Gebäude der Nationalbibliothek geprägt."
        ],
        "hu": [
            "A Függetlenség sugárút több mint 15 kilométer hosszan nyúlik el, és az UNESCO Világörökség várományosa.",
            "A város elnyerte a 'Hős Város' címet a második világháború alatti pusztítás és a hősies ellenállás emlékére.",
            "Minszk ad otthont az ország legnagyobb botanikus kertjének, amely lenyűgöző növénygyűjteménnyel rendelkezik.",
            "A városképet meghatározza a Nemzeti Könyvtár jellegzetes, rombikuboktaéder alakú épülete."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Fehéroroszország fővárosa, monumentális szovjet építészetéről és kiterjedt parkjairól ismert.",
      ro: "Capitala Belarusului, cunoscută pentru arhitectura sa sovietică monumentală și parcurile vaste.",
      en: "The capital of Belarus, known for its monumental Soviet architecture and expansive parks."
    }
  },
  {
    id: "city-gomel",
    ...
    factsAdvanced: {
        "de": [
            "Der Rumjancev-Paskevitsch-Park gilt als einer der schönsten Landschaftsparks in ganz Osteuropa.",
            "Gomel wurde im Jahr 1142 erstmals urkundlich erwähnt, was sie zu einer der ältesten Städte des Landes macht.",
            "Die Stadt ist ein wichtiger Knotenpunkt für den Schienenverkehr zwischen Osteuropa und den baltischen Staaten.",
            "Jedes Jahr findet hier das internationale Festival für choreografische Kunst 'Goldene Schlager' statt."
        ],
        "hu": [
            "A Rumjancev-Paszkievics-park Kelet-Európa egyik legszebb tájképi parkjának számít.",
            "Homelt 1142-ben említik először írásos dokumentumok, így az ország egyik legrégebbi városa.",
            "A város fontos vasúti csomópont Kelet-Európa és a balti államok között.",
            "Minden évben itt rendezik meg az 'Arany Sláger' nemzetközi koreográfiai művészeti fesztivált."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Az ország második legnagyobb városa, amely a pompás Rumjancev-Paszkievics-palotaegyüttesről híres.",
      ro: "Al doilea oraș ca mărime din țară, renumit pentru magnificul complex al palatului Rumyantsev-Paskevich.",
      en: "The second-largest city in the country, famous for the magnificent Rumyantsev-Paskevich palace complex."
    }
  },
  {
    id: "city-mogilev",
    ...
    factsAdvanced: {
        "de": [
            "Während des Ersten Weltkriegs befand sich in Mogilev das Hauptquartier des russischen Zaren Nikolaus II.",
            "Das Rathaus von Mogilev wurde nach seiner Zerstörung im Jahr 2008 originalgetreu wiederaufgebaut.",
            "Die Stadt ist bekannt für ihr jährliches internationales Theaterfestival 'M.art.kontakt'.",
            "Der Platz der Sterne in der Innenstadt ehrt berühmte Persönlichkeiten der Stadtgeschichte mit Bronzeplatten."
        ],
        "hu": [
            "Az első világháború alatt Mahiljovban volt II. Miklós orosz cár főhadiszállása.",
            "A mahiljovi városházát 2008-ban építették újjá az eredeti tervek alapján, miután korábban elpusztult.",
            "A város híres az évente megrendezett 'M.art.kontakt' nemzetközi színházi fesztiválról.",
            "A belvárosban található Csillagok tere bronz táblákkal tiszteleg a város történelmének híres személyiségei előtt."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Történelmi város a Dnyeper partján, bájos városközponttal és gazdag kulturális örökséggel.",
      ro: "Un oraș istoric pe râul Nipru, cu un centru fermecător și o bogată moștenire culturală.",
      en: "A historic city on the Dnieper River with a charming city center and rich cultural heritage."
    }
  },
  {
    id: "city-vitebsk",
    ...
    factsAdvanced: {
        "de": [
            "In Witebsk gründete Kasimir Malewitsch die berühmte Kunstschule UNOVIS, die den Suprematismus prägte.",
            "Das Rathaus von Witebsk beherbergt eine Uhr, deren Mechanismus seit dem 18. Jahrhundert fast unverändert arbeitet.",
            "Die Stadt wird aufgrund ihrer hügeligen Topographie und der vielen Brücken oft mit Prag verglichen.",
            "Marc Chagall verewigte die Silhouette von Witebsk in zahlreichen seiner weltberühmten Gemälde."
        ],
        "hu": [
            "Vicebszkben alapította Kazimir Malevics a híres UNOVIS művészeti iskolát, amely meghatározta a szuprematizmust.",
            "A vicebszki városháza óraszerkezete a 18. század óta szinte változatlanul működik.",
            "A várost dombos domborzata és számos hídja miatt gyakran hasonlítják Prágához.",
            "Marc Chagall számos világhírű festményén örökítette meg Vicebszk sziluettjét."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Marc Chagall szülővárosa és fontos kulturális központ Fehéroroszország északi részén.",
      ro: "Orașul natal al lui Marc Chagall și un centru cultural important în nordul Belarusului.",
      en: "The birthplace of Marc Chagall and an important cultural center in northern Belarus."
    }
  },
  {
    id: "city-grodno",
    ...
    factsAdvanced: {
        "de": [
            "Grodno beherbergt das Alte Schloss aus dem 14. Jahrhundert und das Neue Schloss aus dem 18. Jahrhundert.",
            "Die Kaloscha-Kirche in Grodno ist eines der ältesten erhaltenen Bauwerke aus der Zeit der Kiewer Rus in Belarus.",
            "Im 18. Jahrhundert war Grodno ein Zentrum der Aufklärung und besaß eine der ersten Apotheken Osteuropas.",
            "Die Stadt ist bekannt für ihr internationales Festival der nationalen Kulturen, das alle zwei Jahre stattfindet."
        ],
        "hu": [
            "Hrodnában található a 14. századi Régi Vár és a 18. századi Új Vár is.",
            "A hrodnai Kalozsa-templom a Kijevi Rusz korából származó egyik legrégebbi fennmaradt építmény Fehéroroszországban.",
            "A 18. században Hrodna a felvilágosodás központja volt, és itt működött Kelet-Európa egyik első gyógyszertára.",
            "A város híres a kétévente megrendezett Nemzeti Kultúrák Fesztiváljáról."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Az egyik legrégebbi város, királyi várairól és jól megőrzött óvárosáról ismert.",
      ro: "Unul dintre cele mai vechi orașe, cunoscut pentru castelele sale regale și centrul vechi bine conservat.",
      en: "One of the oldest cities, known for its royal castles and well-preserved old town."
    }
  },
  {
    id: "city-brest",
    ...
    factsAdvanced: {
        "de": [
            "In Brest wurde 1596 die Union von Brest unterzeichnet, die die unierte griechisch-katholische Kirche begründete.",
            "Der Hauptbahnhof von Brest wurde im 19. Jahrhundert als einer der prächtigsten Bahnhöfe des Russischen Reiches erbaut.",
            "Jeden Abend entzündet ein Laternenwärter in historischer Uniform die Gaslaternen in der Sowjetskaja-Straße.",
            "Die Stadt liegt nur wenige Kilometer vom UNESCO-Welterbe Nationalpark Belovezhskaya Pushcha entfernt."
        ],
        "hu": [
            "Bresztben írták alá 1596-ban a breszti uniót, amely megalapította az unitus görögkatolikus egyházat.",
            "A breszti főpályaudvar a 19. században az Orosz Birodalom egyik legpompásabb állomásaként épült.",
            "Minden este egy történelmi egyenruhába öltözött lámpagyújtó gyújtja meg a gázlámpákat a Szovjetszkaja utcán.",
            "A város mindössze néhány kilomérete található az UNESCO Világörökség részét képező Belovezsszkaja Puscsa Nemzeti Parktól."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Fontos kapu Nyugat felé, amely erődjének 1941-es hősies védelméről híres.",
      ro: "O poartă importantă către vest, faimoasă pentru apărarea eroică a cetății sale în 1941.",
      en: "An important gateway to the West, famous for the heroic defense of its fortress in 1941."
    }
  },
  {
    id: "landmark-mir-castle",
    type: "landmark",
    parent: "country-belarus",
    ...
    factsAdvanced: {
        "de": [
            "Das Schloss überstand zahlreiche Belagerungen, unter anderem während der Napoleonischen Kriege im Jahr 1812.",
            "Um das Schloss ranken sich viele Legenden, darunter Geschichten über geheime Tunnel, die es mit dem Schloss Nesvizh verbinden sollen.",
            "Die angrenzende Kapelle der Familie Swjatopolk-Mirski besticht durch ihre prächtigen Mosaikverzierungen.",
            "Schloss Mir diente bereits als Kulisse für zahlreiche historische Filmproduktionen."
        ],
        "hu": [
            "A vár számos ostromot élt túl, többek között az 1812-es napóleoni háborúk idején is.",
            "A vár körül számos legenda kering, köztük titkos alagutakról, amelyek állítólag összekötik a nyeszvizsi kastéllyal.",
            "A szomszédos Szvjatopolk-Mirszkij család kápolnája pompás mozaikdíszítéseivel nyűgözi le a látogatókat.",
            "A miri vár már számos történelmi filmalkotás díszleteként is szolgált."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "UNESCO Világörökség része, a 16. századi erődépítészet kiemelkedő példája.",
      ro: "Un sit al Patrimoniului Mondial UNESCO și un exemplu remarcabil de arhitectură de fortificație din secolul al XVI-lea.",
      en: "A UNESCO World Heritage site and an outstanding example of 16th-century fortification architecture."
    }
  },
  {
    id: "landmark-nesvizh-castle",
    type: "landmark",
    parent: "country-belarus",
    ...
    factsAdvanced: {
        "de": [
            "Die Radziwills besaßen in Nesvizh eine der größten privaten Kunstsammlungen und Archiven des Großfürstentums Litauen.",
            "Das Schloss war einst eine mächtige Bastionsfestung, was man noch heute an den tiefen Wassergräben erkennt.",
            "Eine Legende besagt, dass der Geist der 'Schwarzen Dame', Barbara Radziwill, noch immer im Schloss spukt.",
            "Die Parkanlage von Nesvizh umfasst verschiedene Bereiche, darunter einen englischen und einen japanischen Garten."
        ],
        "hu": [
            "A Radziwillok Nyeszvizsben a Litván Nagyfejedelemség egyik legnagyobb magán művészeti gyűjteményével és archívumával rendelkeztek.",
            "A kastély egykor hatalmas bástyás erőd volt, ami a mai napig látszik a mély vizesárkokon.",
            "Egy legenda szerint a 'Fekete Hölgy', Radziwill Barbara szelleme még mindig kísért a kastélyban.",
            "A nyeszvizsi parkrendszer különböző részeket foglal magában, köztük angol és japánkertet is."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "A Radziwill család pompás rezidenciája, gyönyörű parkokkal körülvéve.",
      ro: "Splendida reședință a familiei Radziwill, înconjurată de parcuri frumoase.",
      en: "The magnificent residence of the Radziwill family, surrounded by beautiful parklands."
    }
  },
  {
    id: "landmark-brest-fortress",
    type: "landmark",
    parent: "country-belarus",
    ...
    factsAdvanced: {
        "de": [
            "Die Verteidiger der Festung hielten im Sommer 1941 weitaus länger stand, als es die militärische Planung vorgesehen hatte.",
            "Das Haupteingangstor der Festung hat die Form eines riesigen, in Beton geschnittenen Sterns.",
            "In der Festung befindet sich die Nikolaus-Kirche, die trotz schwerer Beschädigungen im Krieg erhalten blieb.",
            "Jedes Jahr am 22. Juni findet in der Festung eine feierliche Gedenkzeremonie zum Kriegsbeginn statt."
        ],
        "hu": [
            "Az erőd védői 1941 nyarán sokkal tovább kitartottak, mint azt a katonai tervezés előrejelezte.",
            "Az erőd főbejárata egy hatalmas, betonba vágott csillag alakot formáz.",
            "Az erődben található a Szent Miklós-templom, amely a háború súlyos pusztításai ellenére is fennmaradt.",
            "Minden évben június 22-én ünnepélyes megemlékezést tartanak az erődben a háború kitörésének napján."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "A második világháború alatti bátorság és ellenállás monumentális emlékműve.",
      ro: "Un monument monumental dedicat curajului și rezistenței din timpul celui de-al Doilea Război Mondial.",
      en: "A monumental memorial to the courage and resistance during the Second World War."
    }
  },
  {
    ...
    name: {
      ...
      hu: "Belovezsszkaja Puscsa",
      ro: "Belovezhskaya Pushcha",
    ...
    factsAdvanced: {
        "de": [
            "In der Belovezhskaya Pushcha wurde 1991 das Abkommen unterzeichnet, das das Ende der Sowjetunion besiegelte.",
            "Einige der Bäume im Nationalpark haben einen Stammumfang von über zwei Metern und sind wahre Naturdenkmäler.",
            "Der Park ist die Heimat von über 900 Pflanzenarten und hunderten von Wirbeltierarten.",
            "Es ist das älteste Naturschutzgebiet in Europa, dessen Schutzstatus bis in das 14. Jahrhundert zurückreicht."
        ],
        "hu": [
            "A Belovezsszkaja Puscsában írták alá 1991-ben azt a megállapodást, amely megpecsételte a Szovjetunió végét.",
            "A nemzeti park egyes fáinak törzskerülete meghaladja a két métert, valódi természeti műemlékek.",
            "A park több mint 900 növényfajnak és több száz gerinces fajnak ad otthont.",
            "Ez Európa legrégebbi természetvédelmi területe, amelynek védelmi státusza a 14. századig nyúlik vissza."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Az egykor az európai síkságot borító hatalmas őserdő egyik utolsó és legnagyobb megmaradt része.",
      ro: "Una dintre ultimele și cele mai mari părți rămase din imensa pădure virgină care acoperea odată Câmpia Europeană.",
      en: "One of the last and largest remaining parts of the vast primeval forest that once covered the European Plain."
    }
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Die Seen entstanden vor etwa 18.000 Jahren durch das Zurückweichen der gewaltigen skandinavischen Gletscher.",
            "Der Berg Majak gilt als einer der besten Aussichtspunkte in Belarus mit einem weiten Panoramablick über die Seenplatte.",
            "Im Nationalpark brüten seltene Vogelarten wie der Höckerschwan und der Fischadler.",
            "Viele der Seen im Park sind durch schmale Kanäle verbunden, was sie ideal für mehrtägige Kajaktouren macht."
        ],
        "hu": [
            "A tavak körülbelül 18 000 évvel ezelőtt alakultak ki a hatalmas skandináv gleccserek visszahúzódásával.",
            "A Majak-hegy Fehéroroszország egyik legjobb kilátópontja, ahonnan széles panoráma nyílik a tóvidékre.",
            "A nemzeti parkban olyan ritka madárfajok fészkelnek, mint a bütykös hattyú és a halászsas.",
            "A park számos tavát keskeny csatornák kötik össze, így ideálisak többnapos kajaktúrákhoz."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Északi nemzeti park, amely festői tavairól és gazdag élővilágáról ismert.",
      ro: "Un parc național în nord, cunoscut pentru lacurile sale pitorești și biodiversitatea bogată.",
      en: "A national park in the north, known for its picturesque lakes and rich biodiversity."
    }
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Der Narotsch-See hat eine Fläche von rund 80 Quadratkilometern und eine maximale Tiefe von etwa 25 Metern.",
            "Das Wasser des Sees ist so klar, dass man an vielen Stellen bis zu zehn Meter tief auf den Grund blicken kann.",
            "In der Nähe des Sees befindet sich das Dorf Nanasy, ein ethnographisches Zentrum, das traditionelles belarussisches Landleben zeigt.",
            "Der See ist ein wichtiger Lebensraum für den Europäischen Aal, der hier besonders geschätzt wird."
        ],
        "hu": [
            "A Narocs-tó területe mintegy 80 négyzetkilométer, maximális mélysége pedig körülbelül 25 méter.",
            "A tó vize olyan tiszta, hogy sok helyen akár tíz méter mélyre is le lehet látni az aljáig.",
            "A tó közelében található Nanaszi falu egy etnográfiai központ, amely a hagyományos belarusz vidéki életet mutatja be.",
            "A tó fontos élőhelye az európai angolnának, amelyet itt különösen nagyra értékelnek."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Fehéroroszország legnagyobb tava, népszerű üdülőhely és az egészségturizmus központja.",
      ro: "Cel mai mare lac din Belarus, o zonă populară de recreere și centru pentru turismul balnear.",
      en: "The largest lake in Belarus, a popular recreation area and center for health tourism."
    }
  },
  {
    id: "city-bobruisk",
    ...
    factsAdvanced: {
        "de": [
            "Die Festung Bobruisk hielt 1812 einer viermonatigen Belagerung durch die Truppen Napoleons stand.",
            "In der ersten Hälfte des 19. Jahrhunderts galt die Stadt als eine der am besten befestigten Orte in ganz Europa.",
            "Bobruisk wird in Ilf und Petrows berühmtem Roman 'Das goldene Kalb' als 'hochkultivierte Stadt' erwähnt.",
            "Das Biber-Denkmal im Stadtzentrum ist ein beliebter Glücksbringer: Das Berühren der Uhrkette soll Wohlstand bringen."
        ],
        "hu": [
            "A babrujszki erőd 1812-ben négy hónapig állt ellen Napóleon csapatainak ostromának.",
            "A 19. század első felében a várost Európa egyik legjobban megerősített helyeként tartották számon.",
            "Babrujszkot Ilf és Petrov híres 'Aranyborjú' című regényében 'magas kultúrájú városként' említik.",
            "A belvárosi hód-szobor népszerű szerencsehozó: az óraláncának megérintése állítólag jólétet hoz."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Történelmi iparváros, amely 19. századi erődjéről ismert.",
      ro: "Un oraș industrial cu o istorie bogată, cunoscut pentru cetatea sa din secolul al XIX-lea.",
      en: "An industrial city steeped in history, known for its 19th-century fortress."
    }
  },
  {
    id: "city-baranovichi",
    ...
    factsAdvanced: {
        "de": [
            "In Baranovichi kreuzten sich erstmals die wichtigen Bahnlinien Moskau-Warschau und Wilna-Rowno.",
            "Das Eisenbahnmuseum der Stadt ist das erste seiner Art in Belarus und zeigt über 40 historische Exponate.",
            "Während des Ersten Weltkriegs wurde in Baranovichi die erste Funkstation der russischen Armee errichtet.",
            "Die Stadt beherbergt eine markante orthodoxe Kathedrale, die für ihre prächtigen Mosaike aus der Warschauer Alexander-Newski-Kathedrale bekannt ist."
        ],
        "hu": [
            "Baranavicsiben keresztezték egymást először a fontos Moszkva-Varsó és Vilna-Rovno vasútvonalak.",
            "A város vasúti múzeuma az első ilyen jellegű intézmény Fehéroroszországban, és több mint 40 történelmi kiállítási tárgyat mutat be.",
            "Az első világháború alatt Baranavicsiben állították fel az orosz hadsereg első rádióállomását.",
            "A városban található egy jellegzetes ortodox székesegyház, amely a varsói Alekszandr Nyevszkij-székesegyházból származó pompás mozaikjairól híres."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Jelentős vasúti csomópont és dinamikus város az ország nyugati részén.",
      ro: "Un nod feroviar important și un oraș dinamic în vestul țării.",
      en: "An important railway junction and a dynamic city in the west of the country."
    }
  },
  {
    id: "city-borisov",
    ...
    factsAdvanced: {
        "de": [
            "Die Überreste der Brücken, über die Napoleon 1812 flüchtete, werden im Dorf Studjanka bei Borisov noch heute archäologisch untersucht.",
            "Das Stadion 'Borisov-Arena' ist ein architektonisch preisgekrönter Neubau, der an eine organische Zellstruktur erinnert.",
            "Die Stadt wurde bereits im Jahr 1102 vom Polozker Fürsten Boris Wseslawitsch gegründet.",
            "In Borisov befindet sich die prächtige Auferstehungskathedrale, die im pseudo-russischen Stil aus rotem Backstein erbaut wurde."
        ],
        "hu": [
            "A hidak maradványait, amelyeken Napóleon 1812-ben menekült, ma is régészeti kutatások tárgyát képezik a közeli Szugyánka faluban.",
            "A 'Bariszav-Aréna' stadion egy építészetileg díjazott új építmény, amely egy szerves sejtstruktúrára emlékeztet.",
            "A várost már 1102-ben megalapította Barisz Vszezlaviics polocki fejedelem.",
            "Bariszavban található a pompás Feltámadás-székesegyház, amely pszeudo-orosz stílusban, vörös téglából épült."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Ipari város a Berezina partján, történelmileg a napóleoni háborúkhoz kötődik.",
      ro: "Un oraș industrial pe Berezina, legat istoric de războaiele napoleoniene.",
      en: "An industrial city on the Berezina, historically linked to the Napoleonic Wars."
    }
  },
  {
    id: "city-pinsk",
    ...
    factsAdvanced: {
        "de": [
            "Pinsk wird oft als das 'Venedig von Belarus' bezeichnet, da es von zahlreichen Wasserwegen und Kanälen umgeben ist.",
            "Das Jesuitenkollegium in Pinsk war im 17. Jahrhundert eine der bedeutendsten Bildungseinrichtungen Osteuropas.",
            "Chaim Weizmann, der erste Präsident des Staates Israel, besuchte in Pinsk das Gymnasium.",
            "Die Stadt ist bekannt für ihre traditionelle Flussschifffahrt, die früher die wichtigste Verbindung im Polesie-Gebiet war."
        ],
        "hu": [
            "Pinszket gyakran emlegetik 'fehérorosz Velenceként', mivel számos vízi út és csatorna veszi körül.",
            "A pinszki jezsuita kollégium a 17. században Kelet-Európa egyik legjelentősebb oktatási intézménye volt.",
            "Chaim Weizmann, Izrael Állam első elnöke, Pinszkben járt gimnáziumba.",
            "A város híres a hagyományos folyami hajózásáról, amely korábban a legfontosabb közlekedési mód volt a Poleszje vidéken."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Poleszje szíve, egy város gyönyörű folyóparti sétánnyal és barokk építészettel.",
      ro: "Inima regiunii Polesie, un oraș cu o faleză frumoasă și arhitectură barocă.",
      en: "The heart of the Polesie region, a city with a beautiful riverfront and Baroque architecture."
    }
  },
  {
    id: "city-orsha",
    ...
    factsAdvanced: {
        "de": [
            "Im Jahr 1514 fand bei der Stadt die Schlacht von Orscha statt, ein bedeutendes Ereignis in der osteuropäischen Militärgeschichte.",
            "Das Kutein-Kloster in Orsha beherbergte im 17. Jahrhundert eine der größten Druckereien des Großfürstentums Litauen.",
            "In Orsha wurde der berühmte Psychologe Lew Wygotski geboren, dessen Theorien bis heute weltweit gelehrt werden.",
            "Die Stadt ist landesweit bekannt für ihr Leinenkombinat, dessen Produkte in viele Länder exportiert werden."
        ],
        "hu": [
            "1514-ben a város mellett zajlott az orsai csata, amely a kelet-európai hadtörténet egyik jelentős eseménye.",
            "A kutyini kolostor a 17. században a Litván Nagyfejedelemség egyik legnagyobb nyomdájának adott otthont.",
            "Orsában született a híres pszichológus, Lev Vigotszkij, akinek elméleteit a mai napig világszerte tanítják.",
            "A város országszerte ismert lenkombinátjáról, amelynek termékeit számos országba exportálják."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Fontos közlekedési csomópont a Dnyeper partján, kereskedelmi központként hosszú múltra tekint vissza.",
      ro: "Un nod important de transport pe Nipru, cu o lungă istorie ca centru comercial.",
      en: "An important transportation hub on the Dnieper with a long history as a trading center."
    }
  },
  {
    id: "landmark-polotsk-cathedral",
    type: "landmark",
    parent: "country-belarus",
    ...
    name: {
      ...
      en: "Saint Sophia Cathedral in Polotsk"
    },
    descriptionAdvanced: {
    ...
    factsAdvanced: {
        "de": [
            "In den Fundamenten der Kathedrale kann man noch heute das Mauerwerk aus dem 11. Jahrhundert besichtigen.",
            "Die Kathedrale war das erste steinerne Gebäude auf dem Territorium des heutigen Belarus.",
            "Jedes Jahr findet in der Sophienkathedrale ein internationales Festival für Orgelmusik statt.",
            "Polozk selbst gilt als das geografische Zentrum Europas, woran ein Denkmal in der Stadt erinnert."
        ],
        "hu": [
            "A székesegyház alapjaiban ma is megtekinthetők a 11. századból származó falazatok.",
            "A székesegyház volt az első kőépület a mai Fehéroroszország területén.",
            "Minden évben nemzetközi orgonazenei fesztivált rendeznek a Szófia-székesegyházban.",
            "Maga Polock Európa földrajzi központjának számít, amire egy emlékmű is emlékeztet a városban."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "A régió egyik legrégebbi temploma, eredetileg a 11. században épült.",
      ro: "Una dintre cele mai vechi biserici din regiune, construită inițial în secolul al XI-lea.",
      en: "One of the oldest churches in the region, originally built in the 11th century."
    }
  },
  {
    id: "landmark-khatyn-memorial",
    type: "landmark",
    parent: "country-belarus",
    ...
    factsAdvanced: {
        "de": [
            "Der Name Chatyn wird oft mit dem Massaker von Katyn verwechselt, was historisch jedoch zwei unterschiedliche Ereignisse sind.",
            "Die einzige große Skulptur in der Anlage zeigt Josif Kaminski, den einzigen Überlebenden des Massakers, mit seinem toten Sohn.",
            "In der Gedenkstätte brennt eine ewige Flamme vor drei Birken, während eine vierte Stelle leer bleibt – ein Symbol dafür, dass jeder vierte Belarusse im Krieg umkam.",
            "Die Anlage wurde 1969 eröffnet und gilt als eines der eindrucksvollsten Beispiele sowjetischer Erinnerungskultur."
        ],
        "hu": [
            "A Hatiny nevet gyakran összetévesztik a katyni mészárlással, bár történelmileg két különböző eseményről van szó.",
            "Az egyetlen nagy szobor az együttesben Joszif Kaminszkijt, a mészárlás egyetlen túlélőjét ábrázolja halott fiával.",
            "Az emlékhelyen örökláng ég három nyírfa előtt, míg a negyedik hely üresen marad – jelképezve, hogy minden negyedik fehérorosz meghalt a háborúban.",
            "Az együttest 1969-ben nyitották meg, és a szovjet emlékezetkultúra egyik legmegrendítőbb példájaként tartják számon."
        ],
        "ro": [
            "Numele Khatyn este adesea confundat cu masacrul de la Katyn, deși istoric sunt două evenimente diferite.",
            "Singura sculptură mare din complex îl înfățișează pe Iosif Kaminski, unicul supraviețuitor al masacrului, ținându-și fiul mort.",
    ...
    description: {
      ...
      hu: "Megható emlékmű a második világháborúban elpusztult fehérorosz falvak százainak emlékére.",
      ro: "Un monument emoționant dedicat sutelor de sate belaruse distruse în al Doilea Război Mondial.",
      en: "A moving memorial to the hundreds of Belarusian villages destroyed during World War II."
    }
  },
  {
    id: "landmark-stalin-line",
    type: "landmark",
    parent: "country-belarus",
    coords: [27.2400, 54.0600],
    name: {
      de: "Stalin-Linie",
      hu: "Sztálin-vonal",
      ro: "Linia Stalin",
    ...
    factsAdvanced: {
        "de": [
            "Viele der Betonbunker sind so konstruiert, dass sie selbst schweren Artillerietreffern standhalten konnten.",
            "Das Museum bietet Besuchern die seltene Möglichkeit, gegen Gebühr in historischen Panzern mitzufahren.",
            "Die Stalin-Linie erstreckte sich ursprünglich über 1.200 Kilometer von der Ostsee bis zum Schwarzen Meer.",
            "In der Sammlung befindet sich unter anderem der berühmte T-34 Panzer, der als einer der besten Panzer des Zweiten Weltkriegs gilt."
        ],
        "hu": [
            "Számos betonbunkert úgy terveztek, hogy még a súlyos tüzérségi találatoknak is ellenálljanak.",
            "A múzeum ritka lehetőséget kínál a látogatóknak, hogy díj ellenében történelmi harckocsikban utazzanak.",
            "A Sztálin-vonal eredetileg több mint 1200 kilométer hosszan húzódott a Balti-tengertől a Fekete-tengerig.",
            "A gyűjteményben megtalálható a híres T-34-es harckocsi is, amelyet a második világháború egyik legjobb tankjának tartanak."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Szabadtéri múzeum az egykori szovjet védelmi rendszer erődítményeivel.",
      ro: "Un muzeu în aer liber cu fortificații care au făcut parte din sistemul de apărare al Uniunii Sovietice.",
      en: "An open-air museum featuring fortifications that were part of the Soviet Union's defense system."
    }
  },
  {
    id: "landmark-national-library",
    type: "landmark",
    parent: "country-belarus",
    ...
    factsAdvanced: {
        "de": [
            "Die geometrische Form der Bibliothek soll die Form eines geschliffenen Diamanten symbolisieren, der das Wissen der Menschheit bewahrt.",
            "Die gesamte Bibliothek kann in der Nacht innerhalb weniger Sekunden ihre Farbe und ihr gesamtes Erscheinungsbild ändern.",
            "Ein automatisches Fördersystem transportiert bestellte Bücher in speziellen Behältern direkt in die jeweiligen Lesesäle.",
            "Die Bibliothek beherbergt eine der weltweit bedeutendsten Sammlungen von Drucken des belarussischen Buchdruckers Franzisk Skaryna."
        ],
        "hu": [
            "A könyvtár geometriai formája egy csiszolt gyémántot hivatott szimbolizálni, amely az emberiség tudását őrzi.",
            "A teljes könyvtár éjszaka néhány másodpercen belül képes megváltoztatni a színét és a teljes megjelenését.",
            "Egy automata szállítórendszer speciális konténerekben juttatja el a megrendelt könyveket közvetlenül az olvasótermekbe.",
            "A könyvtár ad otthont Franziszk Szkarina belarusz könyvnyomtató nyomataiból álló világ egyik legjelentősebb gyűjteményének."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Ikonikus modern épület, amely egy rombikuboktaéder alakját formázza.",
      ro: "O clădire modernă iconică în formă de rombicuboctaedru.",
      en: "An iconic modern building in the shape of a rhombicuboctahedron."
    }
  },
  {
    ...
    name: {
      de: "Nationalpark Pripjat",
      hu: "Pripjatyi Nemzeti Park",
      ro: "Parcul Național Pripyatsky",
      en: "Pripyatsky National Park"
    },
    descriptionAdvanced: {
    ...
    factsAdvanced: {
        "de": [
            "Der Nationalpark beherbergt einige der größten zusammenhängenden Moorgebiete des europäischen Kontinents.",
            "Während der Frühjahrsüberschwemmungen kann die Breite des Flusses Pripjat an manchen Stellen auf bis zu 30 Kilometer ansteigen.",
            "Im Park leben über 250 Vogelarten, darunter der seltene Schreiadler und der Schwarzstorch.",
            "Der Ort Ljaskowitschi dient als Verwaltungszentrum des Parks und beherbergt ein modernes Naturkundemuseum."
        ],
        "hu": [
            "A nemzeti park az európai kontinens egyik legnagyobb összefüggő mocsárvidékének ad otthont.",
            "A tavaszi áradások idején a Pripjaty folyó szélessége egyes helyeken akár a 30 kilométert is elérheti.",
            "A parkban több mint 250 madárfaj él, köztük a ritka békászó sas és a fekete gólya.",
            "Ljaskovicsi település szolgál a park igazgatási központjaként, ahol egy modern természettudományi múzeum is található."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "A 'fehérorosz Amazonas' néven ismert kiterjedt ártéri tájai és mocsárvidékei miatt.",
      ro: "Cunoscut sub numele de „Amazonul Belarusului” datorită peisajelor sale inundabile vaste și mlaștinilor.",
      en: "Known as the 'Belarusian Amazon' for its vast floodplain landscapes and marshlands."
    }
  },
  {
    id: "city-mazyr",
    ...
    factsAdvanced: {
        "de": [
            "Aufgrund der steilen Hügel besitzt Masyr eines der wenigen Skisportzentren des Landes mit künstlicher Beschneiung.",
            "In Masyr befindet sich eine der größten Erdölraffinerien Osteuropas, die über die Druschba-Pipeline versorgt wird.",
            "Die Stadt war historisch ein bedeutendes religiöses Zentrum und beherbergte zahlreiche Klöster verschiedener Orden.",
            "Die Straßenbahn von Masyr führt durch malerische Waldgebiete und verbindet das Stadtzentrum mit den Industriegebieten."
        ],
        "hu": [
            "A meredek domboknak köszönhetően Mazir rendelkezik az ország kevés síközpontjának egyikével, ahol mesterséges hóágyúzás is folyik.",
            "Mazirban található Kelet-Európa egyik legnagyobb olajfinomítója, amelyet a Barátság kőolajvezeték lát el.",
            "A város történelmileg jelentős vallási központ volt, számos különböző rendi kolostornak adott otthont.",
            "A maziri villamos festői erdős területeken halad keresztül, összekötve a városközpontot az ipari negyedekkel."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Festői dombokon fekvő város a Pripjaty partján, az olajipar központja.",
      ro: "Un oraș situat pe dealuri pitorești pe râul Pripyat, un centru al industriei petroliere.",
      en: "A city on picturesque hills by the Pripyat River, a center of the oil industry."
    }
  },
  {
    id: "city-salihorsk",
    ...
    factsAdvanced: {
        "de": [
            "In Salihorsk befindet sich die einzige speläotherapeutische Klinik der GUS, die sich in 420 Metern Tiefe in einem Salzbergwerk befindet.",
            "Die Abraumhalden der Kalibergwerke umgeben die Stadt und erinnern an eine künstliche Gebirgslandschaft, die 'Salihorsker Terrikone'.",
            "Salihorsk hat eine der höchsten Pro-Kopf-Einkommen des Landes aufgrund der profitablen Bergbauindustrie.",
            "Der Salihorsker Stausee ist ein beliebtes Revier für den Segelsport und die Sportfischerei."
        ],
        "hu": [
            "Szalihorszkban található a FÁK egyetlen szpeleoterápiás klinikája, amely 420 méter mélyen, egy sóbányában működik.",
            "A kálisóbányák meddőhányói körülveszik a várost, mesterséges hegyvidéki tájra emlékeztetve.",
            "Szalihorszk az ország egyik legmagasabb egy főre jutó jövedelmével rendelkezik a jövedelmező bányaiparnak köszönhetően.",
            "A szalihorszki víztározó népszerű helyszín a vitorlázás és a sporthorgászat számára."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Fiatal város, amely hatalmas káliműtrágya-bányáiról ismert.",
      ro: "Un oraș tânăr, cunoscut pentru minele sale uriașe de sare de potasiu.",
      en: "A young city known for its massive potash salt mines."
    }
  },
  {
    id: "city-lida",
    ...
    factsAdvanced: {
        "de": [
            "Die Burg von Lida hat eine fast quadratische Form und wurde strategisch auf einer künstlichen Insel zwischen zwei Flüssen erbaut.",
            "Das Unternehmen 'Lidskoe Pivo' braut seit 1876 Bier und ist eine der ältesten kontinuierlich betriebenen Brauereien des Landes.",
            "Lida ist ein bedeutendes Zentrum für die Produktion von Landmaschinen, insbesondere der bekannten 'Lida'-Mähdrescher.",
            "Jedes Jahr findet in und um die Burg das Festival 'Lidbeer' statt, das Musik und lokale Braukunst feiert."
        ],
        "hu": [
            "A lidai vár szinte négyzet alakú, és stratégiailag két folyó közötti mesterséges szigetre épült.",
            "A 'Lidskoe Pivo' vállalat 1876 óta főz sört, és az ország egyik legrégebbi folyamatosan működő sörfőzdéje.",
            "Lida a mezőgazdasági gépek gyártásának jelentős központja, különösen a jól ismert 'Lida' kombájnoké.",
            "Minden évben megrendezik a várban és környékén a 'Lidbeer' fesztivált, amely a zenét és a helyi sörfőzést ünnepli."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Középkori váráról és jelentős sörfőzési hagyományairól híres.",
      ro: "Faimos pentru castelul său medieval și o tradiție importantă de fabricare a berii.",
      en: "Famous for its medieval castle and a significant beer brewing tradition."
    }
  },
  {
    ...
    name: {
      de: "Beresinski-Biosphärenreservat",
      hu: "Berezinszkiji Bioszféra-rezervátum",
      ro: "Rezervația Biosferei Berezinsky",
      en: "Berezinsky Biosphere Reserve"
    },
    descriptionAdvanced: {
    ...
    factsAdvanced: {
        "de": [
            "Im Beresinski-Reservat sind über 60 Prozent der gesamten europäischen Moorgemeinschaften vertreten.",
            "Das Reservat beherbergt eine der größten Populationen des Braunbären in Belarus.",
            "Besucher können im Museum der Natur in Domatschewo die Flora und Fauna des Gebiets in einer umfangreichen Ausstellung kennenlernen.",
            "Ein spezieller Lehrpfad führt durch das Hochmoor und ermöglicht Einblicke in dieses empfindliche Ökosystem, ohne es zu schädigen."
        ],
        "hu": [
            "A Berezinszkiji rezervátumban található az összes európai mocsári közösség több mint 60 százaléka.",
            "A rezervátum Fehéroroszország egyik legnagyobb barna medve populációjának ad otthont.",
            "A látogatók a domacsevói Természeti Múzeumban ismerkedhetnek meg a terület gazdag növény- és állatvilágával.",
            "Egy speciális tanösvény vezet keresztül a mocsáron, lehetővé téve a betekintést ebbe az érzékeny ökoszisztémába."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Érintetlen természeti terület, amely az UNESCO bioszféra-rezervátumok hálózatának része.",
      ro: "O zonă naturală virgină care aparține rețelei UNESCO de rezervații ale biosferei.",
      en: "A pristine natural area that belongs to the UNESCO network of biosphere reserves."
    }
  },
  {
    id: "landmark-kalozha-church",
    type: "landmark",
    parent: "country-belarus",
    coords: [23.8181, 53.6783],
    name: {
      de: "Kaloscha-Kirche",
      hu: "Kalozsa-templom",
      ro: "Biserica Kalozha",
    ...
    factsAdvanced: {
        "de": [
            "In die Wände der Kirche sind Tongefäße (Resonatoren) eingemauert, die für eine außergewöhnliche Akustik im Inneren sorgen.",
            "Die farbigen Steineinlagen an der Außenfassade sind so angeordnet, dass sie trotz der Verwitterung über Jahrhunderte ihre Leuchtkraft behalten haben.",
            "Die Kirche ist das einzige erhaltene Bauwerk der romanisch-byzantinischen Tradition im Westen von Belarus.",
            "Im Inneren befinden sich Reste von Fresken, die Einblicke in die mittelalterliche sakrale Malerei der Region geben."
        ],
        "hu": [
            "A templom falaiba agyagedényeket (rezonátorokat) építettek be, amelyek kivételes akusztikát biztosítanak a belső térben.",
            "A külső homlokzat színes kőbetétei úgy vannak elhelyezve, hogy az évszázadok során az időjárás ellenére is megőrizték fényüket.",
            "A templom a román-bizánci hagyomány egyetlen fennmaradt példája Fehéroroszország nyugati részén.",
            "Odabent freskótöredékek találhatók, amelyek betekintést nyújtanak a régió középkori szakrális festészetébe."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Egyedülálló, 12. századi ortodox templom Hrodnában.",
      ro: "O biserică ortodoxă unică din secolul al XII-lea din Grodno.",
      en: "A unique 12th-century Orthodox church in Grodno."
    }
  },
  {
    id: "city-molodechno",
    ...
    factsAdvanced: {
        "de": [
            "Molodechno ist bekannt als Austragungsort des Nationalen Festivals für belarussische Lieder und Poesie.",
            "Die Stadt war historisch ein bedeutender Stützpunkt an der Eisenbahnlinie zwischen Wilna und Minsk.",
            "Das Regionale Dramentheater in Molodechno genießt landesweit einen hervorragenden Ruf für seine innovativen Inszenierungen.",
            "In der Nähe der Stadt befinden sich die Überreste der Burg von Lebedevo, die auf die mittelalterliche Bedeutung der Region hinweisen."
        ],
        "hu": [
            "Maladzecsna a fehérorosz dalok és költészet nemzeti fesztiváljának állandó helyszíne.",
            "A város történelmileg jelentős állomás volt a Vilna és Minszk közötti vasútvonalon.",
            "A Maladzecsnai Regionális Drámai Színház országszerte kiváló hírnévnek örvend innovatív előadásaiért.",
            "A város közelében találhatók a lebegyevói vár maradványai, amelyek a régió középkori jelentőségére utalnak."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Fontos kulturális és ipari központ a főváros közelében.",
      ro: "Un important centru cultural și industrial nu departe de capitală.",
      en: "An important cultural and industrial center not far from the capital."
    }
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Der Augustów-Kanal war bei seiner Fertigstellung im Jahr 1839 einer der modernsten Wasserwege in ganz Europa.",
            "Die Schleuse 'Nemnowo' ist die größte am gesamten Kanal und besitzt drei Kammern zur Überwindung des Höhenunterschieds.",
            "Seit 2004 gibt es für Touristen am Augustów-Kanal eine visumfreie Zone, um den internationalen Besucherverkehr zu erleichtern.",
            "Entlang des Kanals finden sich noch heute historische Grenzsteine aus der Zeit des Russischen Reiches."
        ],
        "hu": [
            "Az Augustówi-csatorna 1839-es befejezésekor egész Európa egyik legmodernebb víziútja volt.",
            "A 'Nemnovo' zsilip a legnagyobb az egész csatornán, és három kamrával rendelkezik a szintkülönbség leküzdésére.",
            "2004 óta az Augustówi-csatorna mentén vízummentes övezet működik a turisták számára a nemzetközi forgalom megkönnyítése érdekében.",
            "A csatorna mentén ma is láthatók az Orosz Birodalom idejéből származó történelmi határkövek."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "19. századi mérnöki bravúr, amely a Visztula és a Nyeman folyókat köti össze.",
      ro: "O minune de inginerie din secolul al XIX-lea care leagă râurile Vistula și Neman.",
      en: "A 19th-century engineering marvel connecting the Vistula and Neman rivers."
    }
  },
  {
    id: "landmark-trinity-suburb",
    type: "landmark",
    parent: "country-belarus",
    coords: [27.5558, 53.9081],
    name: {
      de: "Dreifaltigkeits-Vorstadt",
      hu: "Szentháromság-negyed",
      ro: "Suburbia Troițkoe",
      en: "Trinity Suburb"
    },
    descriptionAdvanced: {
    ...
    factsAdvanced: {
        "de": [
            "Das Viertel war ursprünglich der Ort, an dem sich die ersten Siedlungen von Minsk im Mittelalter befanden.",
            "In der Dreifaltigkeits-Vorstadt wurde der berühmte belarussische Dichter Maxim Bahdanowitsch geboren.",
            "Die Rekonstruktion erfolgte auf Grundlage historischer Pläne, um das Erscheinungsbild der Stadt vor der Zerstörung im Zweiten Weltkrieg zu bewahren.",
            "Nachts wird das Viertel stimmungsvoll beleuchtet und ist einer der meistfotografierten Orte in der belarussischen Hauptstadt."
        ],
        "hu": [
            "A negyed eredetileg az a hely volt, ahol Minszk első települései kialakultak a középkorban.",
            "A Szentháromság-negyedben született a híres fehérorosz költő, Makszim Bahdanovics.",
            "A rekonstrukció történelmi tervek alapján készült, hogy megőrizzék a város képét a második világháborús pusztítás előtti állapotban.",
            "Éjszaka a negyed hangulatos kivilágítást kap, és a fehérorosz főváros egyik legtöbbet fényképezett helyszíne."
        ],
        "ro": [
    ...
    description: {
      ...
      hu: "Minszk rekonstruált történelmi negyede festői utcákkal.",
      ro: "Un cartier istoric reconstruit din Minsk, cu străzi pitorești.",
      en: "A reconstructed historic district in Minsk with picturesque alleys."
    }
  }
];
...
export const belarusLocalPois: POI[] = [
  {
    ...
    factsAdvanced: {
        "de": [
            "Im Palastmuseum können Besucher die prunkvollen Schlosssäle sowie wertvolle Sammlungen von Gemälden und Porzellan besichtigen.",
            "Der Schlossturm bietet einen weiten Panoramablick über die Stadt Gomel und den Fluss Sosch.",
            "Die Gruft der Familie Paskevitsch, die sich im Park befindet, ist ein architektonisch interessantes Bauwerk im pseudo-russischen Stil.",
            "Im Winter verwandelt sich der Schlosspark in eine märchenhafte Kulisse mit kunstvollen Lichtinstallationen."
        ],
        "hu": [
            "A palotamúzeumban a látogatók megtekinthetik a pompás kastélytermeket, valamint értékes festmény- és porcelángyűjteményeket.",
            "A kastélytoronyból széles panoráma nyílik Homel városára és a Szozs folyóra.",
            "A parkban található Paszkievics család kriptája építészetileg érdekes, pszeudo-orosz stílusú építmény.",
            "Télen a kastélypark mesebeli díszletté változik művészi fényinstallációkkal."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Die Rekonstruktion basiert auf archäologischen Funden und historischen Beschreibungen der ursprünglichen Burg aus dem 15. Jahrhundert.",
            "Vom Burgberg aus hat man den wohl besten Blick auf den 'belarussischen Amazonas', die weiten Auen des Pripjat.",
            "Innerhalb der Burganlage befindet sich eine kleine Kapelle, die der heiligen Barbara gewidmet ist.",
            "Die Burg ist Schauplatz des jährlichen Festivals 'Schätze der Polesie', das lokale Traditionen und Bräuche feiert."
        ],
        "hu": [
            "A rekonstrukció régészeti leleteken és az eredeti, 15. századi vár történelmi leírásain alapul.",
            "A Várhegyről nyílik talán a legjobb kilátás a 'fehérorosz Amazonaszra', a Pripjaty hatalmas ártéri területeire.",
            "A várkomplexumon belül található egy kis kápolna, amelyet Szent Borbálának szenteltek.",
            "A vár ad otthont az évente megrendezett 'Poleszje kincsei' fesztiválnak, amely a helyi hagyományokat ünnepli."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Die Festung liegt auf vier Inseln, die durch die Arme der Flüsse Bug und Muchawez gebildet werden.",
            "In den Kasematten der Festung finden sich noch heute Inschriften der Verteidiger, die ihren Abschied und ihre Treue zum Vaterland verewigten.",
            "Der Bajonett-Obelisk ist über 100 Meter hoch und weithin als Wahrzeichen der Stadt Brest sichtbar.",
            "Das Museum der Verteidigung in der Festung zeigt persönliche Gegenstände und Dokumente der Soldaten und ihrer Familien."
        ],
        "hu": [
            "Az erőd négy szigeten fekszik, amelyeket a Bug és a Muhavec folyók ágai alkotnak.",
            "Az erőd kazamatáiban ma is láthatók a védők feliratai, akik búcsújukat és a haza iránti hűségüket örökítették meg.",
            "A bajonett-obeliszket több mint 100 méter magas, és messziről látható Breszt városának jelképeként.",
            "Az erődben található Védelmi Múzeum a katonák és családjaik személyes tárgyait és dokumentumait mutatja be."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Der Turm hat eine Höhe von 30 Metern und Mauern, die an der Basis bis zu 2,5 Meter dick sind.",
            "Trotz zahlreicher Kriege und Belagerungen wurde der Turm in seiner über 700-jährigen Geschichte nie ernsthaft beschädigt.",
            "Die Bezeichnung 'Weißer Turm' rührt vermutlich von einer fehlerhaften historischen Beschreibung her, da der Turm nie weiß gestrichen war.",
            "Im Inneren des Turms kann man die ursprünglichen Holzbalkenkonstruktionen und die raffinierten Verteidigungsmechanismen besichtigen."
        ],
        "hu": [
            "A torony magassága 30 méter, falai az alapnál akár 2,5 méter vastagok is lehetnek.",
            "Számos háború és ostrom ellenére a torony több mint 700 éves története során soha nem sérült meg komolyabban.",
            "A 'Fehér torony' elnevezés valószínűleg egy téves történelmi leírásból ered, mivel a tornyot soha nem meszelték fehérre.",
            "A torony belsejében megtekinthetők az eredeti fagerenda-szerkezetek és a kifinomult védelmi mechanizmusok."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "In der Kathedrale befindet sich eine Kopie der berühmten 'Kreuz der heiligen Euphrosyne', einer nationalen Reliquie von Belarus.",
            "Die unterirdischen Krypten der Kathedrale beherbergen archäologische Funde, die bis in die Gründungszeit der Stadt zurückreichen.",
            "Die Orgel der Kathedrale wurde von tschechischen Meistern speziell für diesen Raum angefertigt und besitzt 3.000 Pfeifen.",
            "Polozk war das erste bedeutende Zentrum für Bildung und Buchdruck in der gesamten Region der Kiewer Rus."
        ],
        "hu": [
            "A székesegyházban található a híres 'Szent Eufrázina keresztje', Fehéroroszország nemzeti ereklyéjének másolata.",
            "A székesegyház alatti kripták olyan régészeti leleteket őriznek, amelyek a város alapításának idejéig nyúlnak vissza.",
            "A székesegyház orgonáját cseh mesterek készítették kifejezetten ebbe a térbe, és 3000 síppal rendelkezik.",
            "Polock volt az egész Kijevi Rusz régió első jelentős oktatási és könyvnyomtatási központja."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Der See Driwjaty ist der drittgrößte See des Landes und bildet das touristische Zentrum der Region.",
            "Auf einigen Inseln in den Seen befinden sich Überreste alter Klöster und Einsiedeleien aus vergangenen Jahrhunderten.",
            "Die Region Braslaw gilt als eines der saubersten ökologischen Gebiete in ganz Europa.",
            "Jedes Jahr im Sommer findet am Ufer des Sees das beliebte Musik- und Sportfestival 'Viva Braslav' statt."
        ],
        "hu": [
            "A Drivjati-tó az ország harmadik legnagyobb tava, és a régió turisztikai központját alkotja.",
            "A tavak egyes szigetein régi kolostorok és remetelakok maradványai találhatók az elmúlt évszázadokból.",
            "A braszlavi régió egész Európa egyik legtisztább ökológiai területének számít.",
            "Minden évben nyáron a tó partján rendezik meg a népszerű 'Viva Braslav' zenei és sportfesztivált."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Das Schloss wurde so konstruiert, dass es sowohl mit Kanonen verteidigt als auch als repräsentativer Palast genutzt werden konnte.",
            "In den Kellern des Schlosses befanden sich riesige Vorratslager, die eine jahrelange Belagerung ermöglicht hätten.",
            "Die Decke des 'Porträtsaals' ist eine kunstvolle Rekonstruktion einer vergoldeten Kassettendecke aus der Renaissancezeit.",
            "Schloss Mir ist seit dem Jahr 2000 Teil des UNESCO-Weltkulturerbes."
        ],
        "hu": [
            "A várat úgy tervezték, hogy ágyúkkal is védhető legyen, ugyanakkor reprezentatív palotaként is szolgáljon.",
            "A vár pincéiben hatalmas raktárak voltak, amelyek lehetővé tették az akár évekig tartó ostrom elviselését is.",
            "A 'Portréterem' mennyezete a reneszánsz korból származó aranyozott kazettás mennyezet művészi rekonstrukciója.",
            "A miri várkastély 2000 óta az UNESCO Világörökség része."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "Die Mauern der Burg erreichen an manchen Stellen eine Dicke von bis zu zwei Metern und sind über 12 Meter hoch.",
            "Innerhalb der Burgmauern befand sich ursprünglich eine ganze kleine Siedlung mit Kirche und Wohngebäuden.",
            "Die Burg von Lida war Teil eines ganzen Verteidigungsgürtels, zu dem auch die Burgen in Krewo und Medininkai gehörten.",
            "Besucher können im Museum der Burg aktiv an mittelalterlichen Spielen und Handwerksworkshops teilnehmen."
        ],
        "hu": [
            "A vár falai helyenként akár két méter vastagok is lehetnek, magasságuk pedig meghaladja a 12 métert.",
            "A várfalakon belül eredetileg egy egész kis település volt templommal és lakóépületekkel.",
            "A lidai vár egy teljes védelmi övezet része volt, amelyhez a krevói és a medininkai várak is tartoztak.",
            "A látogatók a vár múzeumában aktívan részt vehetnek középkori játékokban és kézműves műhelyfoglalkozásokon."
        ],
        "ro": [
  ...
  },
  {
    ...
    factsAdvanced: {
        "de": [
            "In der Festung Bobruisk wurden im 19. Jahrhundert geheime Treffen der Dekabristen-Verschwörer abgehalten.",
            "Das Gelände der Festung ist so weitläufig, dass sich darauf heute ein modernes Fußballstadion und ein Eissportpalast befinden.",
            "Die charakteristischen roten Backsteine für den Bau der Festung wurden in eigens dafür errichteten Ziegeleien in der Umgebung hergestellt.",
            "Die Festung diente im Laufe ihrer Geschichte auch als bedeutendes Gefängnis für politische Gefangene."
        ],
        "hu": [
            "A babrujszki erődben a 19. században a dekabrista összeesküvők titkos találkozókat tartottak.",
            "Az erőd területe olyan hatalmas, hogy ma egy modern futballstadion és egy jégcsarnok is elfér rajta.",
            "Az erőd építéséhez használt jellegzetes vörös téglákat a környéken kifejezetten erre a célra létrehozott téglagyárakban készítették.",
            "Az erőd története során jelentős börtönként is szolgált politikai foglyok számára."
        ],
        "ro": [
