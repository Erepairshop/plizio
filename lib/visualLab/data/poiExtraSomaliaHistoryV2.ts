...
,
  {
    ...
    description: {
      ...
      ro: "Această fortificație istorică a fost construită în timpul revoltei dervișilor la începutul secolului al XX-lea. A servit ca punct de apărare strategic în regiunea Jubaland.",
      en: "This historic fortification was constructed during the Dervish uprising in the early 20th century. It served as a strategic defensive point in the Jubaland region.",
    },
    facts: {
      de: ["Erbaut um 1905", "Dervisch-Architektur", "Historische Militärstätte", "Regionaler Verteidigungsknoten"],
      hu: ["1905 körül épült", "Dervis építészet", "Történelmi katonai helyszín", "Regionális védelmi csomópont"],
      ro: ["Construit în jurul anului 1905", "Arhitectură dervișă", "Sit militar istoric", "Nod defensiv regional"],
      en: ["Built around 1905", "Dervish architecture", "Historic military site", "Regional defensive hub"],
    },
    imageHint: "ancient stone fort ruins near Kismayo coast",
  },
  {
    ...
    description: {
      ...
      ro: "Un mormânt antic din piatră cioplită, datat în primul mileniu. Face parte din descoperirile arheologice din munții Golis.",
      en: "An ancient tomb made of hewn stone, dated to the first millennium. It belongs to the archaeological findings of the Golis Mountains.",
    },
    facts: {
      de: ["Antike Architektur", "Golis-Berge Region", "Erstes Jahrtausend", "Archäologische Stätte"],
      hu: ["Antik építészet", "Golis-hegység régió", "Első évezred", "Régészeti helyszín"],
      ro: ["Arhitectură antică", "Regiunea munților Golis", "Primul mileniu", "Sit arheologic"],
      en: ["Ancient architecture", "Golis Mountains region", "First millennium", "Archaeological site"],
    },
    imageHint: "ancient stone tomb structure in Somali highland landscape",
  },
  {
    ...
    description: {
      ...
      ro: "Rămășițele unei fortificații construite în timpul prezenței otomane în Golful Aden. Complexul proteja importantul port comercial.",
      en: "Remains of a fortification built during the Ottoman presence in the Gulf of Aden. The complex protected the important trading port.",
    },
    facts: {
      de: ["16. Jahrhundert", "Golf von Aden", "Osmanisches Erbe", "Handelsschutz"],
      hu: ["16. század", "Ádeni-öböl", "Oszmán örökség", "Kereskedelemvédelem"],
      ro: ["Secolul al XVI-lea", "Golful Aden", "Moștenire otomană", "Protecția comerțului"],
      en: ["16th century", "Gulf of Aden", "Ottoman heritage", "Trade protection"],
    },
    imageHint: "ruined ottoman style stone walls near Berbera port",
  },
  {
    ...
    description: {
      ...
      ro: "Un sector arheologic adiacent celebrului complex Laas Geel, cu reprezentări preistorice suplimentare de bovine. Datat în jurul anului 3000 î.Hr.",
      en: "A neighboring archaeological sector of the famous Laas Geel complex with additional prehistoric depictions of cattle. Dated to around 3000 BCE.",
    },
    facts: {
      de: ["Neolithikum", "Höhlenkunst", "Rinderdarstellungen", "3000 v. Chr."],
      hu: ["Neolitikum", "Barlangművészet", "Szarvasmarha-ábrázolások", "Kr. e. 3000"],
      ro: ["Neolitic", "Artă rupestră", "Reprezentări bovine", "3000 î.Hr."],
      en: ["Neolithic", "Cave art", "Cattle depictions", "3000 BCE"],
    },
    imageHint: "ancient rock paintings of cattle in Somali cave",
  },
  {
    ...
    description: {
      ...
      ro: "Rămășițe ale infrastructurii portuare medievale a Sultanatului Adal. Zeila a fost cândva unul dintre cele mai importante porturi de la Marea Roșie.",
      en: "Remains of the medieval port infrastructure of the Adal Sultanate. Zeila was once one of the most important ports on the Red Sea.",
    },
    facts: {
      de: ["Adal-Sultanat", "Mittelalterliche Wirtschaft", "Rotes Meer", "Handelsknoten"],
      hu: ["Adal Szultanátus", "Középkori gazdaság", "Vörös-tenger", "Kereskedelmi csomópont"],
      ro: ["Sultanatul Adal", "Economie medievală", "Marea Roșie", "Nod comercial"],
      en: ["Adal Sultanate", "Medieval economy", "Red Sea", "Trading hub"],
    },
    imageHint: "ancient stone pier remains on Zeila coastline",
  },
  {
    ...
    description: {
      ...
      ro: "O veche casă de rugăciune de la începutul secolului al XX-lea, reprezentativă pentru stilul arhitectural al regiunii Mudug. Este un loc important pentru istoria locală a orașului.",
      en: "An old house of prayer from the early 20th century, representing the architectural style of the Mudug region. It is an important site for local urban history.",
    },
    facts: {
      de: ["Mudug-Region", "Frühes 20. Jahrhundert", "Regionale Architektur", "Stadtkultur"],
      hu: ["Mudug régió", "20. század eleje", "Regionális építészet", "Városkultúra"],
      ro: ["Regiunea Mudug", "Începutul secolului al XX-lea", "Arhitectură regională", "Cultura urbană"],
      en: ["Mudug region", "Early 20th century", "Regional architecture", "Urban culture"],
    },
    imageHint: "old stone mosque architecture in Galkayo",
  },
  {
    ...
    description: {
      ...
      ro: "Rămășițe ale clădirilor administrative din perioada administrației coloniale italiene. Ruinele sunt situate chiar pe coasta Oceanului Indian.",
      en: "Remains of administrative buildings from the period of Italian colonial administration. The ruins lie directly on the Indian Ocean coast.",
    },
    facts: {
      de: ["Italienische Kolonialzeit", "Indischer Ozean", "Verwaltungsarchitektur", "20. Jahrhundert"],
      hu: ["Olasz gyarmati időszak", "Indiai-óceán", "Közigazgatási építészet", "20. század"],
      ro: ["Perioada colonială italiană", "Oceanul Indian", "Arhitectură administrativă", "Secolul al XX-lea"],
      en: ["Italian colonial period", "Indian Ocean", "Administrative architecture", "20th century"],
    },
    imageHint: "ruined colonial building near Bandar Beyla coast",
  },
  {
    ...
    description: {
      ...
      ro: "Sate istorice de extracție pentru gresia moale, folosită la construcția multor clădiri din centrul Somaliei. În funcțiune de secole.",
      en: "Historic extraction sites for the soft sandstone used to construct many buildings in central Somalia. In operation for centuries.",
    },
    facts: {
      de: ["Sandsteinabbau", "Historische Handwerkskunst", "Zentral-Somalia", "Langjährige Nutzung"],
      hu: ["Homokkőbányászat", "Történelmi kézművesség", "Közép-Szomália", "Hosszú távú használat"],
      ro: ["Extracția gresiei", "Măiestrie istorică", "Somalia centrală", "Utilizare de lungă durată"],
      en: ["Sandstone extraction", "Historic craftsmanship", "Central Somalia", "Long-term usage"],
    },
    imageHint: "historic sandstone quarry excavation site",
  },
  {
    ...
    description: {
      ...
      ro: "Ruinele unei așezări antice, cunoscută pentru descoperirile sale de ceramică. Mărturisește rețele comerciale complexe din Somalia timpurie.",
      en: "Ruins of an ancient settlement known for its pottery findings. It testifies to complex trading networks in early Somalia.",
    },
    facts: {
      de: ["Archäologische Siedlung", "Keramikfunde", "Handelsgeschichte", "Frühes Somalia"],
      hu: ["Régészeti település", "Kerámialeletek", "Kereskedelmi történelem", "Korai Szomália"],
      ro: ["Așezare arheologică", "Descoperiri de ceramică", "Istoria comerțului", "Somalia timpurie"],
      en: ["Archaeological settlement", "Pottery findings", "Trade history", "Early Somalia"],
    },
    imageHint: "archaeological site remains in desert landscape",
  },
  {
    ...
    description: {
      ...
      ro: "O parte bine conservată a centrului istoric al orașului, cu case din calcar coraligen. Prezintă influența arhitecturală a culturii swahili.",
      en: "A well-preserved part of the historic city center featuring coral limestone houses. It displays the architectural influence of Swahili culture.",
    },
    facts: {
      de: ["Swahili-Architektur", "Korallenkalkstein", "Historisches Zentrum", "Weltkulturerbe-Potential"],
      hu: ["Szuahéli építészet", "Korallos mészkő", "Történelmi központ", "Világörökségi potenciál"],
      ro: ["Arhitectură swahili", "Calcar coraligen", "Centru istoric", "Potențial de patrimoniu mondial"],
      en: ["Swahili architecture", "Coral limestone", "Historic center", "World heritage potential"],
    },
    imageHint: "historic coral limestone house in Barawe",
  },
  {
    ...
    description: {
      ...
      ro: "Un turn de veghe din perioada rezistenței dervișilor împotriva puterilor coloniale. De aici era monitorizată coasta.",
      en: "A lookout tower from the era of Dervish resistance against colonial powers. The coastline was monitored from here.",
    },
    facts: {
      de: ["Dervisch-Widerstand", "Strategische Überwachung", "Küstenschutz", "20. Jahrhundert"],
      hu: ["Dervis-ellenállás", "Stratégiai megfigyelés", "Partvédelem", "20. század"],
      ro: ["Rezistența dervișilor", "Monitorizare strategică", "Protecția coastei", "Secolul al XX-lea"],
      en: ["Dervish resistance", "Strategic monitoring", "Coastal defense", "20th century"],
    },
    imageHint: "stone lookout tower on Alula cliff",
  },
  {
    ...
    description: {
      ...
      ro: "Vechi puncte de alimentare cu apă, vitale pentru rutele caravanelor din nord. Mărturisesc așezarea timpurie în regiune.",
      en: "Old watering points that were vital for the caravan routes of the north. They testify to the early settlement of the region.",
    },
    facts: {
      de: ["Karawanenroute", "Wasserbau", "Frühe Besiedlung", "Nord-Somalia"],
      hu: ["Karavánút", "Vízépítés", "Korai betelepülés", "Észak-Szomália"],
      ro: ["Rută de caravane", "Hidrotehnică", "Așezare timpurie", "Somalia de Nord"],
      en: ["Caravan route", "Hydraulic engineering", "Early settlement", "North Somalia"],
    },
    imageHint: "ancient stone wells in Borama area",
  },
  {
    ...
    description: {
      ...
      ro: "Rămășițe ale zidurilor istorice ale portului Merca. Acestea mărturisesc istoria comercială intensă a orașului la Oceanul Indian.",
      en: "Remains of the historic quay walls of Merca port. These testify to the city's intense trade history on the Indian Ocean.",
    },
    facts: {
      de: ["Indischer Ozean", "Handelshafen", "Historische Infrastruktur", "Mittelalter"],
      hu: ["Indiai-óceán", "Kereskedelmi kikötő", "Történelmi infrastruktúra", "Középkor"],
      ro: ["Oceanul Indian", "Port comercial", "Infrastructură istorică", "Evul Mediu"],
      en: ["Indian Ocean", "Trading port", "Historic infrastructure", "Middle Ages"],
    },
    imageHint: "ancient sea wall remains at Merca port",
  },
  {
    ...
    description: {
      ...
      ro: "Peșteri relevante din punct de vedere arheologic lângă Baidoa, care prezintă urme ale așezării umane din perioada preistorică.",
      en: "Archaeologically relevant caves near Baidoa, which show traces of human settlement from prehistoric times.",
    },
    facts: {
      de: ["Prähistorisch", "Archäologie", "Höhlenbesiedlung", "Baidoa-Region"],
      hu: ["Őskori", "Régészet", "Barlangi letelepedés", "Baidoa régió"],
      ro: ["Preistoric", "Arheologie", "Așezare în peșteră", "Regiunea Baidoa"],
      en: ["Prehistoric", "Archaeology", "Cave settlement", "Baidoa region"],
    },
    imageHint: "entrance to ancient settlement caves near Baidoa",
  },
  {
    ...
    description: {
      ...
      ro: "O construcție comemorativă pentru un luptător important al rezistenței dervișilor. Este un simbol central al istoriei locale.",
      en: "A commemorative structure for an important fighter of the Dervish resistance. It is a central symbol of local history.",
    },
    facts: {
      de: ["Dervisch-Widerstand", "Gedenkstätte", "20. Jahrhundert", "Lokale Geschichte"],
      hu: ["Dervis-ellenállás", "Emlékhely", "20. század", "Helyi történelem"],
      ro: ["Rezistența dervișilor", "Loc de comemorare", "Secolul al XX-lea", "Istorie locală"],
      en: ["Dervish resistance", "Memorial", "20th century", "Local history"],
    },
    imageHint: "historic tomb structure in Las Anod",
  },
  {
    ...
    description: {
      ...
      ro: "Rămășițe ale unei instalații defensive care era strategic importantă pentru hinterland. Zidurile sunt construite din piatră locală.",
      en: "Remains of a defensive facility that was strategically important for the hinterland. The walls are made of local stone.",
    },
    facts: {
      de: ["Verteidigungsanlage", "Hinterland", "Lokales Steinmaterial", "Historische Bedeutung"],
      hu: ["Védelmi létesítmény", "Hátország", "Helyi kőanyag", "Történelmi jelentőség"],
      ro: ["Instalație defensivă", "Hinterland", "Material de piatră locală", "Semnificație istorică"],
      en: ["Defensive facility", "Hinterland", "Local stone material", "Historical significance"],
    },
    imageHint: "ruined stone walls of defensive fort in Xuddur",
  },
  {
    ...
    description: {
      ...
      ro: "O moschee istorică, cunoscută pentru stilul său simplu, dar robust. Este un exemplu de arhitectură de coastă din perioada medievală.",
      en: "A historic mosque known for its simple yet robust style. It is an example of coastal architecture from the medieval period.",
    },
    facts: {
      de: ["Mittelalterliche Architektur", "Küstengebiet", "Religiöses Erbe", "Warsheikh"],
      hu: ["Középkori építészet", "Partvidék", "Vallási örökség", "Warsheikh"],
      ro: ["Arhitectură medievală", "Zonă de coastă", "Moștenire religioasă", "Warsheikh"],
      en: ["Medieval architecture", "Coastal area", "Religious heritage", "Warsheikh"],
    },
    imageHint: "ancient stone mosque exterior in Warsheikh",
  },
  {
    ...
    description: {
      ...
      ro: "Ruinele palatului Sultanului din Hobyo. Complexul a fost centrul politic al puternicului sultanat în secolul al XIX-lea.",
      en: "Ruins of the palace of the Sultan of Hobyo. The complex was the political center of the powerful sultanate in the 19th century.",
    },
    facts: {
      de: ["Sultanat Hobyo", "19. Jahrhundert", "Politisches Zentrum", "Palastarchitektur"],
      hu: ["Hobyo Szultanátus", "19. század", "Politikai központ", "Palotaépítészet"],
      ro: ["Sultanatul Hobyo", "Secolul al XIX-lea", "Centru politic", "Arhitectură de palat"],
      en: ["Hobyo Sultanate", "19th century", "Political center", "Palace architecture"],
    },
    imageHint: "ruined coral stone palace walls in Hobyo",
  },
  {
    ...
    description: {
      ...
      ro: "O fortificație pe coastă, construită pentru protecția împotriva pirateriei și a incursiunilor coloniale în secolul al XIX-lea.",
      en: "A coastal fortification built for protection against piracy and colonial incursions in the 19th century.",
    },
    facts: {
      de: ["Küstenschutz", "19. Jahrhundert", "Historisches Erbe", "Strategischer Hafen"],
      hu: ["Partvédelem", "19. század", "Történelmi örökség", "Stratégiai kikötő"],
      ro: ["Protecția coastei", "Secolul al XIX-lea", "Moștenire istorică", "Port strategic"],
      en: ["Coastal defense", "19th century", "Historic heritage", "Strategic port"],
    },
    imageHint: "coastal stone fort remains at Qandala",
  }
];
