...
image: "/poi-images/rio-coco-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Cel mai lung râu din America Centrală care se află în întregime în regiune. Râul Coco este cunoscut pentru: curge de-a lungul graniței cu honduras, lungime: aprox. 750 km, se varsă în marea caraibelor. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Râul Coco face parte din patrimoniul cultural al statului Nicaragua.",
      en: "The longest river in Central America that lies entirely within the region. Coco River is known for: flows along the border with honduras, length: approx. 750 km, empties into the caribbean sea. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Coco River is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Râul Coco face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Râul Coco are o istorie și o tradiție bogată.", "Râul Coco este un loc important în Nicaragua."],
      en: ["Coco River is part of Nicaragua's cultural heritage.", "The region around Coco River has a rich history and tradition.", "Coco River is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/lago-de-nicaragua-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Cel mai mare lac de apă dulce din America Centrală, cunoscut pentru rechinii săi de apă dulce. Lacul Nicaragua este cunoscut pentru: găzduiește insula ometepe, singurul loc cu rechini de apă dulce, suprafață: 8.264 km². Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Lacul Nicaragua face parte din patrimoniul cultural al statului Nicaragua.",
      en: "The largest freshwater lake in Central America, known for its freshwater sharks. Lake Nicaragua is known for: contains ometepe island, the only place with freshwater sharks, area: 8,264 km². This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Lake Nicaragua is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Lacul Nicaragua face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Lacul Nicaragua are o istorie și o tradiție bogată.", "Lacul Nicaragua este un loc important în Nicaragua."],
      en: ["Lake Nicaragua is part of Nicaragua's cultural heritage.", "The region around Lake Nicaragua has a rich history and tradition.", "Lake Nicaragua is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/lago-de-managua-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un lac mare în vestul Nicaraguei, pe malul căruia se află capitala. Lacul Managua (Xolotlán) este cunoscut pentru: cunoscut și ca lacul xolotlán, legat de lacul nicaragua prin râul tipitapa, foarte poluat, dar cu eforturi de recuperare. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Lacul Managua (Xolotlán) face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A large lake in western Nicaragua on whose shores the capital city is located. Lake Managua (Xolotlán) is known for: also known as lake xolotlán, connected to lake nicaragua by the tipitapa river, highly polluted but with recovery efforts. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Lake Managua (Xolotlán) is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Lacul Managua (Xolotlán) face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Lacul Managua (Xolotlán) are o istorie și o tradiție bogată.", "Lacul Managua (Xolotlán) este un loc important în Nicaragua."],
      en: ["Lake Managua (Xolotlán) is part of Nicaragua's cultural heritage.", "The region around Lake Managua (Xolotlán) has a rich history and tradition.", "Lake Managua (Xolotlán) is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/solentiname-archipelago-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un grup de 36 de insule în Lacul Nicaragua, cunoscut pentru comunitatea sa de artiști. Arhipelagul Solentiname este cunoscut pentru: cunoscut pentru pictura primitivistă, casa poetului ernesto cardenal, faună aviară bogată. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Arhipelagul Solentiname face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A group of 36 islands in Lake Nicaragua, known for its community of artists. Solentiname Archipelago is known for: known for primitivist painting, home of poet ernesto cardenal, rich birdlife. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Solentiname Archipelago is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Arhipelagul Solentiname face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Arhipelagul Solentiname are o istorie și o tradiție bogată.", "Arhipelagul Solentiname este un loc important în Nicaragua."],
      en: ["Solentiname Archipelago is part of Nicaragua's cultural heritage.", "The region around Solentiname Archipelago has a rich history and tradition.", "Solentiname Archipelago is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/pearl-cays-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un grup de 18 insule mici, nelocuite, din Caraibe. Pearl Cays este cunoscut pentru: plaje cu nisip alb, apă turcoaz, locuri de cuibărit pentru țestoasele marine. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Pearl Cays face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A group of 18 small, uninhabited Caribbean islands. Pearl Cays is known for: white sandy beaches, turquoise waters, nesting sites for sea turtles. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Pearl Cays is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Pearl Cays face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Pearl Cays are o istorie și o tradiție bogată.", "Pearl Cays este un loc important în Nicaragua."],
      en: ["Pearl Cays is part of Nicaragua's cultural heritage.", "The region around Pearl Cays has a rich history and tradition.", "Pearl Cays is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/rio-escondido-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un râu important care leagă orașul Bluefields de interiorul țării. Râul Escondido este cunoscut pentru: cale navigabilă importantă către caraibe, acces principal spre bluefields, important pentru comerț. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Râul Escondido face parte din patrimoniul cultural al statului Nicaragua.",
      en: "An important river connecting the city of Bluefields with the country's interior. Escondido River is known for: important waterway to the caribbean, main access to bluefields, significant for trade. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Escondido River is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Râul Escondido face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Râul Escondido are o istorie și o tradiție bogată.", "Râul Escondido este un loc important în Nicaragua."],
      en: ["Escondido River is part of Nicaragua's cultural heritage.", "The region around Escondido River has a rich history and tradition.", "Escondido River is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/indio-maiz-reserve-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Una dintre cele mai bine conservate rezervații naturale din Nicaragua. Rezervația Biologică Indio Maíz este cunoscut pentru: cuprinde zone vaste de pădure tropicală, biodiversitate extrem de ridicată, habitat pentru jaguari și tapiri. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Rezervația Biologică Indio Maíz face parte din patrimoniul cultural al statului Nicaragua.",
      en: "One of the best-preserved nature reserves in Nicaragua. Indio Maíz Biological Reserve is known for: contains vast areas of rainforest, extremely high biodiversity, home to jaguars and tapirs. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Indio Maíz Biological Reserve is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Rezervația Biologică Indio Maíz face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Rezervația Biologică Indio Maíz are o istorie și o tradiție bogată.", "Rezervația Biologică Indio Maíz este un loc important în Nicaragua."],
      en: ["Indio Maíz Biological Reserve is part of Nicaragua's cultural heritage.", "The region around Indio Maíz Biological Reserve has a rich history and tradition.", "Indio Maíz Biological Reserve is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/peninsula-de-chiltepe-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O peninsulă vulcanică în Lacul Managua cu două lagune. Peninsula Chiltepe este cunoscut pentru: include lagunele apoyeque și xiloá, origine vulcanică, zonă de recreere populară pentru managua. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Peninsula Chiltepe face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A volcanic peninsula in Lake Managua with two lagoons. Chiltepe Peninsula is known for: includes the apoyeque and xiloá lagoons, of volcanic origin, popular recreational area for managua. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Chiltepe Peninsula is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Peninsula Chiltepe face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Peninsula Chiltepe are o istorie și o tradiție bogată.", "Peninsula Chiltepe este un loc important în Nicaragua."],
      en: ["Chiltepe Peninsula is part of Nicaragua's cultural heritage.", "The region around Chiltepe Peninsula has a rich history and tradition.", "Chiltepe Peninsula is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/la-flor-wildlife-refuge-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O plajă importantă de cuibărit pentru țestoasele Olive Ridley pe coasta Pacificului. Refugiul de viață sălbatică La Flor este cunoscut pentru: sosirea în masă a țestoaselor ('arribada'), plajă protejată la pacific, important pentru conservarea speciilor. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Refugiul de viață sălbatică La Flor face parte din patrimoniul cultural al statului Nicaragua.",
      en: "An important nesting beach for Olive Ridley sea turtles on the Pacific coast. La Flor Wildlife Refuge is known for: mass nesting of turtles ('arribada'), protected pacific beach, important for species conservation. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. La Flor Wildlife Refuge is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Refugiul de viață sălbatică La Flor face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Refugiul de viață sălbatică La Flor are o istorie și o tradiție bogată.", "Refugiul de viață sălbatică La Flor este un loc important în Nicaragua."],
      en: ["La Flor Wildlife Refuge is part of Nicaragua's cultural heritage.", "The region around La Flor Wildlife Refuge has a rich history and tradition.", "La Flor Wildlife Refuge is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/gulf-of-fonseca-nicaragua-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Partea nicaraguană a unui mare golf la Pacific, împărțit cu Honduras și El Salvador. Golful Fonseca (Nicaragua) este cunoscut pentru: include vulcanul cosigüina, păduri importante de mangrove, faună marină bogată. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Golful Fonseca (Nicaragua) face parte din patrimoniul cultural al statului Nicaragua.",
      en: "The Nicaraguan part of a large Pacific gulf shared with Honduras and El Salvador. Gulf of Fonseca (Nicaragua) is known for: includes the cosigüina volcano, important mangrove forests, rich marine fauna. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Gulf of Fonseca (Nicaragua) is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Golful Fonseca (Nicaragua) face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Golful Fonseca (Nicaragua) are o istorie și o tradiție bogată.", "Golful Fonseca (Nicaragua) este un loc important în Nicaragua."],
      en: ["Gulf of Fonseca (Nicaragua) is part of Nicaragua's cultural heritage.", "The region around Gulf of Fonseca (Nicaragua) has a rich history and tradition.", "Gulf of Fonseca (Nicaragua) is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/rio-tuma-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un râu important care alimentează Lacul Apanás. Râul Tuma este cunoscut pentru: barat pentru a forma lacul apanás, important pentru hidroenergie, curge prin zonele muntoase centrale. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Râul Tuma face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A significant river that feeds Lake Apanás. Tuma River is known for: dammed to form lake apanás, important for hydropower, flows through the central highlands. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Tuma River is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Râul Tuma face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Râul Tuma are o istorie și o tradiție bogată.", "Râul Tuma este un loc important în Nicaragua."],
      en: ["Tuma River is part of Nicaragua's cultural heritage.", "The region around Tuma River has a rich history and tradition.", "Tuma River is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/tisey-estanzuela-reserve-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O zonă protejată cu păduri de pini și de ceață lângă Estelí. Rezervația Naturală Tisey-Estanzuela este cunoscut pentru: cunoscut pentru cascada salto de la estanzuela, climat răcoros, trasee de drumeție și puncte de belvedere. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Rezervația Naturală Tisey-Estanzuela face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A protected area with pine and cloud forests near Estelí. Tisey-Estanzuela Nature Reserve is known for: known for the salto de la estanzuela waterfall, cool climate, hiking trails and viewpoints. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Tisey-Estanzuela Nature Reserve is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Rezervația Naturală Tisey-Estanzuela face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Rezervația Naturală Tisey-Estanzuela are o istorie și o tradiție bogată.", "Rezervația Naturală Tisey-Estanzuela este un loc important în Nicaragua."],
      en: ["Tisey-Estanzuela Nature Reserve is part of Nicaragua's cultural heritage.", "The region around Tisey-Estanzuela Nature Reserve has a rich history and tradition.", "Tisey-Estanzuela Nature Reserve is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/rio-prinza-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un râu lung care leagă regiunea minieră de coasta Caraibilor. Râul Prinzapolka este cunoscut pentru: cale de transport importantă pentru comunitățile izolate, se varsă în caraibe la prinzapolka, traversează păduri tropicale dense. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Râul Prinzapolka face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A long river connecting the mining region to the Caribbean coast. Prinzapolka River is known for: important transport route for remote communities, empties into the caribbean at prinzapolka, crosses dense rainforest. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Prinzapolka River is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Râul Prinzapolka face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Râul Prinzapolka are o istorie și o tradiție bogată.", "Râul Prinzapolka este un loc important în Nicaragua."],
      en: ["Prinzapolka River is part of Nicaragua's cultural heritage.", "The region around Prinzapolka River has a rich history and tradition.", "Prinzapolka River is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/miskito-cays-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un grup izolat de insule, mangrove și recife în largul coastei de nord-est. Miskito Cays este cunoscut pentru: rezervație marină biologică, important pentru pescarii miskito, biodiversitate marină ridicată. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Miskito Cays face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A remote group of islands, mangroves, and reefs off the northeast coast. Miskito Cays is known for: marine biological reserve, important for miskito fishermen, high marine biodiversity. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Miskito Cays is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Miskito Cays face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Miskito Cays are o istorie și o tradiție bogată.", "Miskito Cays este un loc important în Nicaragua."],
      en: ["Miskito Cays is part of Nicaragua's cultural heritage.", "The region around Miskito Cays has a rich history and tradition.", "Miskito Cays is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/rio-grande-de-matagalpa-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Unul dintre cele mai lungi și importante râuri care traversează țara de la vest la est. Râul Grande de Matagalpa este cunoscut pentru: izvorăște lângă matagalpa, se varsă în caraibe, potențial hidroenergetic. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Râul Grande de Matagalpa face parte din patrimoniul cultural al statului Nicaragua.",
      en: "One of the longest and most important rivers crossing the country from west to east. Grande de Matagalpa River is known for: originates near matagalpa, empties into the caribbean, potential for hydropower. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Grande de Matagalpa River is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Râul Grande de Matagalpa face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Râul Grande de Matagalpa are o istorie și o tradiție bogată.", "Râul Grande de Matagalpa este un loc important în Nicaragua."],
      en: ["Grande de Matagalpa River is part of Nicaragua's cultural heritage.", "The region around Grande de Matagalpa River has a rich history and tradition.", "Grande de Matagalpa River is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/zapatera-island-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O insulă vulcanică în Lacul Nicaragua, protejată ca parc național. Insula Zapatera este cunoscut pentru: situl arheologic important, numeroase petroglife și statui, vulcan scut. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Insula Zapatera face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A volcanic island in Lake Nicaragua, protected as a national park. Zapatera Island is known for: important archaeological site, numerous petroglyphs and statues, shield volcano. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Zapatera Island is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Insula Zapatera face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Insula Zapatera are o istorie și o tradiție bogată.", "Insula Zapatera este un loc important în Nicaragua."],
      en: ["Zapatera Island is part of Nicaragua's cultural heritage.", "The region around Zapatera Island has a rich history and tradition.", "Zapatera Island is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/laguna-de-perlas-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Cea mai mare lagună de coastă din Nicaragua, pe coasta Caraibilor. Laguna Perlelor (corp de apă) este cunoscut pentru: ecosistem de apă salmastră, legătură cu marea caraibilor, important pentru pescuitul local. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Laguna Perlelor (corp de apă) face parte din patrimoniul cultural al statului Nicaragua.",
      en: "The largest coastal lagoon in Nicaragua on the Caribbean coast. Pearl Lagoon (body of water) is known for: brackish water ecosystem, connection to the caribbean sea, important for local fishing. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Pearl Lagoon (body of water) is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Laguna Perlelor (corp de apă) face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Laguna Perlelor (corp de apă) are o istorie și o tradiție bogată.", "Laguna Perlelor (corp de apă) este un loc important în Nicaragua."],
      en: ["Pearl Lagoon (body of water) is part of Nicaragua's cultural heritage.", "The region around Pearl Lagoon (body of water) has a rich history and tradition.", "Pearl Lagoon (body of water) is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/telica-volcano-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Unul dintre cei mai activi vulcani din Nicaragua, popular pentru drumeții nocturne. Vulcanul Telica este cunoscut pentru: erupții minore frecvente, lavă vizibilă în crater noaptea, parte a lanțului vulcanic maribios. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Vulcanul Telica face parte din patrimoniul cultural al statului Nicaragua.",
      en: "One of Nicaragua's most active volcanoes, popular for night hikes. Telica Volcano is known for: frequent minor eruptions, visible lava in the crater at night, part of the maribios volcanic chain. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Telica Volcano is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Vulcanul Telica face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Vulcanul Telica are o istorie și o tradiție bogată.", "Vulcanul Telica este un loc important în Nicaragua."],
      en: ["Telica Volcano is part of Nicaragua's cultural heritage.", "The region around Telica Volcano has a rich history and tradition.", "Telica Volcano is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/san-lorenzo-cloud-forest-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O pădure de ceață mică, dar importantă, în departamentul Boaco. Pădurea de ceață San Lorenzo este cunoscut pentru: ecosistem izolat, bogat în epifite precum orhideele, sursă importantă de apă pentru regiune. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Pădurea de ceață San Lorenzo face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A small but important cloud forest in the department of Boaco. San Lorenzo Cloud Forest is known for: isolated ecosystem, rich in epiphytes like orchids, important water source for the region. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. San Lorenzo Cloud Forest is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Pădurea de ceață San Lorenzo face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Pădurea de ceață San Lorenzo are o istorie și o tradiție bogată.", "Pădurea de ceață San Lorenzo este un loc important în Nicaragua."],
      en: ["San Lorenzo Cloud Forest is part of Nicaragua's cultural heritage.", "The region around San Lorenzo Cloud Forest has a rich history and tradition.", "San Lorenzo Cloud Forest is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/little-corn-island-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O mică insulă caraibiană fără mașini, perfectă pentru o vacanță liniștită. Little Corn Island este cunoscut pentru: fără vehicule motorizate, înconjurat de recife de corali, popular pentru scufundări și snorkeling. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Little Corn Island face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A small, car-free Caribbean island perfect for a quiet getaway. Little Corn Island is known for: no motorized vehicles, surrounded by coral reefs, popular for diving and snorkeling. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Little Corn Island is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Little Corn Island face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Little Corn Island are o istorie și o tradiție bogată.", "Little Corn Island este un loc important în Nicaragua."],
      en: ["Little Corn Island is part of Nicaragua's cultural heritage.", "The region around Little Corn Island has a rich history and tradition.", "Little Corn Island is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/cosiguina-lagoon-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Lacul de crater din vârful vulcanului Cosigüina. Laguna Cosigüina este cunoscut pentru: format după erupția din 1835, apă de un verde profund, locație izolată. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Laguna Cosigüina face parte din patrimoniul cultural al statului Nicaragua.",
      en: "The crater lake at the summit of the Cosigüina volcano. Cosigüina Lagoon is known for: formed after the 1835 eruption, deep green water, secluded location. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Cosigüina Lagoon is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Laguna Cosigüina face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Laguna Cosigüina are o istorie și o tradiție bogată.", "Laguna Cosigüina este un loc important în Nicaragua."],
      en: ["Cosigüina Lagoon is part of Nicaragua's cultural heritage.", "The region around Cosigüina Lagoon has a rich history and tradition.", "Cosigüina Lagoon is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/estero-real-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Unul dintre cele mai mari estuare cu mangrove din America Centrală. Estero Real este cunoscut pentru: zonă importantă de reproducere pentru păsări și pești, creșterea creveților, se varsă în golful fonseca. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Estero Real face parte din patrimoniul cultural al statului Nicaragua.",
      en: "One of the largest mangrove estuaries in Central America. Estero Real is known for: important breeding ground for birds and fish, shrimp farming, empties into the gulf of fonseca. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Estero Real is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Estero Real face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Estero Real are o istorie și o tradiție bogată.", "Estero Real este un loc important în Nicaragua."],
      en: ["Estero Real is part of Nicaragua's cultural heritage.", "The region around Estero Real has a rich history and tradition.", "Estero Real is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/rio-bocay-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un afluent al râului Coco care curge prin rezervația Bosawás. Râul Bocay este cunoscut pentru: curge prin păduri tropicale virgine, coridor important pentru fauna sălbatică, habitat pentru comunități indigene. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Râul Bocay face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A tributary of the Coco River that flows through the Bosawás Reserve. Bocay River is known for: flows through pristine rainforest, important corridor for wildlife, home to indigenous communities. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Bocay River is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Râul Bocay face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Râul Bocay are o istorie și o tradiție bogată.", "Râul Bocay este un loc important în Nicaragua."],
      en: ["Bocay River is part of Nicaragua's cultural heritage.", "The region around Bocay River has a rich history and tradition.", "Bocay River is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/cerro-el-arenal-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O rezervație naturală și un munte lângă Matagalpa. Cerro El Arenal este cunoscut pentru: ecosistem de pădure de ceață, sursă importantă de apă pentru matagalpa, cultivarea cafelei pe versanți. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Cerro El Arenal face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A nature reserve and mountain near Matagalpa. El Arenal Hill is known for: cloud forest ecosystem, important water source for matagalpa, coffee cultivation on its slopes. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. El Arenal Hill is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Cerro El Arenal face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Cerro El Arenal are o istorie și o tradiție bogată.", "Cerro El Arenal este un loc important în Nicaragua."],
      en: ["El Arenal Hill is part of Nicaragua's cultural heritage.", "The region around El Arenal Hill has a rich history and tradition.", "El Arenal Hill is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/saslaya-national-park-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Primul parc național din Nicaragua, protejând un munte important și o pădure de ceață. Parcul Național Saslaya este cunoscut pentru: include cel mai înalt munte din centrul țării (cerro saslaya), zona centrală a rezervației bosawás, habitat pentru quetzal. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Parcul Național Saslaya face parte din patrimoniul cultural al statului Nicaragua.",
      en: "Nicaragua's first national park, protecting an important mountain and cloud forest. Saslaya National Park is known for: includes the highest mountain in the country's center (cerro saslaya), core zone of the bosawás reserve, home of the quetzal. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Saslaya National Park is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Parcul Național Saslaya face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Parcul Național Saslaya are o istorie și o tradiție bogată.", "Parcul Național Saslaya este un loc important în Nicaragua."],
      en: ["Saslaya National Park is part of Nicaragua's cultural heritage.", "The region around Saslaya National Park has a rich history and tradition.", "Saslaya National Park is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/caribbean-sea-nicaragua-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Granița maritimă estică a Nicaraguei, cu recife de corali și insule. Marea Caraibelor (Nicaragua) este cunoscut pentru: include insulele corn și pearl cays, zone de pescuit importante, parte a recifului mesoamerican. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Marea Caraibelor (Nicaragua) face parte din patrimoniul cultural al statului Nicaragua.",
      en: "Nicaragua's eastern maritime border, with coral reefs and islands. Caribbean Sea (Nicaragua) is known for: includes the corn islands and pearl cays, important fishing grounds, part of the mesoamerican reef system. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Caribbean Sea (Nicaragua) is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Marea Caraibelor (Nicaragua) face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Marea Caraibelor (Nicaragua) are o istorie și o tradiție bogată.", "Marea Caraibelor (Nicaragua) este un loc important în Nicaragua."],
      en: ["Caribbean Sea (Nicaragua) is part of Nicaragua's cultural heritage.", "The region around Caribbean Sea (Nicaragua) has a rich history and tradition.", "Caribbean Sea (Nicaragua) is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/pacific-ocean-nicaragua-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Granița maritimă vestică a Nicaraguei, cu plaje pentru surf și o coastă vulcanică. Oceanul Pacific (Nicaragua) este cunoscut pentru: cunoscut pentru valurile înalte pentru surf, plaje cu nisip vulcanic, pescuit important. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Oceanul Pacific (Nicaragua) face parte din patrimoniul cultural al statului Nicaragua.",
      en: "Nicaragua's western maritime border with surf beaches and a volcanic coastline. Pacific Ocean (Nicaragua) is known for: known for high waves for surfing, volcanic sand beaches, important fisheries. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Pacific Ocean (Nicaragua) is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Oceanul Pacific (Nicaragua) face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Oceanul Pacific (Nicaragua) are o istorie și o tradiție bogată.", "Oceanul Pacific (Nicaragua) este un loc important în Nicaragua."],
      en: ["Pacific Ocean (Nicaragua) is part of Nicaragua's cultural heritage.", "The region around Pacific Ocean (Nicaragua) has a rich history and tradition.", "Pacific Ocean (Nicaragua) is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/cerro-negro-forest-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Ecosistemul unic de pădure uscată care înconjoară tânărul vulcan. Pădurea uscată din jurul Cerro Negro este cunoscut pentru: adaptat la cenușa vulcanică, găzduiește floră și faună specializată, parte a unui complex mai mare de arii protejate. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Pădurea uscată din jurul Cerro Negro face parte din patrimoniul cultural al statului Nicaragua.",
      en: "The unique dry forest ecosystem surrounding the young volcano. Dry Forest around Cerro Negro is known for: adapted to volcanic ash, hosts specialized flora and fauna, part of a larger protected area complex. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Dry Forest around Cerro Negro is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Pădurea uscată din jurul Cerro Negro face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Pădurea uscată din jurul Cerro Negro are o istorie și o tradiție bogată.", "Pădurea uscată din jurul Cerro Negro este un loc important în Nicaragua."],
      en: ["Dry Forest around Cerro Negro is part of Nicaragua's cultural heritage.", "The region around Dry Forest around Cerro Negro has a rich history and tradition.", "Dry Forest around Cerro Negro is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/laguna-nejapa-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un lac de crater la periferia vestică a Managuei. Laguna Nejapa este cunoscut pentru: parte a unui lanț de lacuri de crater, ușor accesibil din managua, punct de belvedere popular. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Laguna Nejapa face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A crater lake on the western outskirts of Managua. Nejapa Lagoon is known for: part of a chain of crater lakes, easily accessible from managua, popular viewpoint. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Nejapa Lagoon is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Laguna Nejapa face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Laguna Nejapa are o istorie și o tradiție bogată.", "Laguna Nejapa este un loc important în Nicaragua."],
      en: ["Nejapa Lagoon is part of Nicaragua's cultural heritage.", "The region around Nejapa Lagoon has a rich history and tradition.", "Nejapa Lagoon is a significant location in Nicaragua."]
    }
  },
  {
...
image: "/poi-images/rio-wawa-nature-v2.webp"
},
    ...
    descriptionAdvanced: {
      ...
      ro: "Un râu pe coasta Caraibilor, important pentru comunitățile locale. Râul Wawa este cunoscut pentru: leagă interiorul țării de coastă, ruta de transport importantă, se varsă lângă puerto cabezas. Această regiune joacă un rol important în geografia și cultura statului Nicaragua și reprezintă o parte semnificativă a patrimoniului național. Râul Wawa face parte din patrimoniul cultural al statului Nicaragua.",
      en: "A river on the Caribbean coast, important for local communities. Wawa River is known for: connects the interior to the coast, important transportation route, empties near puerto cabezas. This region plays an important role in Nicaragua's geography and culture and represents a significant part of the national heritage. Wawa River is part of Nicaragua's cultural heritage."
    },
    factsAdvanced: {
      ...
      ro: ["Râul Wawa face parte din patrimoniul cultural al statului Nicaragua.", "Regiunea Râul Wawa are o istorie și o tradiție bogată.", "Râul Wawa este un loc important în Nicaragua."],
      en: ["Wawa River is part of Nicaragua's cultural heritage.", "The region around Wawa River has a rich history and tradition.", "Wawa River is a significant location in Nicaragua."]
    }
  }
];
