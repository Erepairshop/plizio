...
export const slovakiaHistory: POI[] = [
  {
    ...
    description: {
      ...
      es: "El Castillo de Spiš es uno de los complejos de castillos más grandes de Europa Central y es Patrimonio de la Humanidad por la UNESCO. Se alza sobre el paisaje y atestigua la agitada historia de la región.",
      pt: "O Castelo de Spiš é um dos maiores complexos de castelos da Europa Central e é Património da Humanidade pela UNESCO. Ergue-se sobre a paisagem e testemunha a agitada história da região.",
      fr: "Le château de Spiš est l'un des plus grands complexes castraux d'Europe centrale et est inscrit au patrimoine mondial de l'UNESCO. Il domine le paysage et témoigne de l'histoire mouvementée de la région.",
    },
    descriptionAdvanced: {
      ...
      es: "El Castillo de Spiš es una fortaleza monumental erigida en el siglo XII. Como Patrimonio de la Humanidad por la UNESCO, documenta la historia de la arquitectura medieval y las estructuras sociales feudales en Europa Central. Durante siglos sirvió como centro político y militar de la región de Spiš. Tras el incendio de 1780, se convirtió en una ruina que hoy muestra la evolución arquitectónica desde el estilo románico al gótico y renacentista. Historia K7: Arquitectura de fortificación medieval.",
      pt: "O Castelo de Spiš é uma fortaleza monumental erigida no século XII. Como Património da Humanidade pela UNESCO, documenta a história da arquitetura medieval e as estruturas sociais feudais na Europa Central. Durante séculos, serviu como centro político e militar da região de Spiš. Após o incêndio de 1780, tornou-se uma ruína que hoje mostra a evolução arquitetónica desde o estilo românico ao gótico e renascentista. História K7: Arquitetura de fortificação medieval.",
      fr: "Le château de Spiš est une forteresse monumentale érigée au XIIe siècle. En tant que site du patrimoine mondial de l'UNESCO, il documente l'histoire de l'architecture médiévale et des structures sociales féodales en Europe centrale. Pendant des siècles, il a servi de centre politique et militaire de la région de Spiš. Après l'incendie de 1780, il est tombé en ruine, montrant aujourd'hui l'évolution architecturale du style roman au gothique et à la Renaissance. Histoire K7 : Architecture de fortification médiévale.",
    },
    facts: {
      de: [
      ...
      es: ["Es Patrimonio de la Humanidad por la UNESCO desde 1993.", "El complejo del castillo abarca una superficie de 4 hectáreas.", "Fue uno de los castillos más grandes de Europa Central.", "El castillo fue destruido por un incendio en 1780."],
      pt: ["É Património da Humanidade pela UNESCO desde 1993.", "O complexo do castelo abrange uma área de 4 hectares.", "Foi um dos maiores castelos da Europa Central.", "O castelo foi destruído por um incêndio em 1780."],
      fr: ["Inscrit au patrimoine mondial de l'UNESCO depuis 1993.", "Le complexe du château s'étend sur une superficie de 4 hectares.", "C'était l'un des plus grands châteaux d'Europe centrale.", "Le château a été détruit par un incendie en 1780."],
    },
    factsAdvanced: {
      ...
      es: ["Se han encontrado hallazgos de la época celta en la colina del castillo.", "El castillo alberga hoy un extenso museo de historia regional.", "La arquitectura muestra una transición de elementos románicos a elementos góticos.", "El complejo es un escenario importante para festivales históricos."],
      pt: ["Foram encontrados achados da época celta na colina do castelo.", "O castelo alberga hoje um extenso museu de história regional.", "A arquitetura mostra uma transição de elementos românicos para elementos góticos.", "O complexo é um cenário importante para festivais históricos."],
      fr: ["Des découvertes de l'époque celte ont été faites sur la colline du château.", "Le château abrite aujourd'hui un vaste musée d'histoire régionale.", "L'architecture montre une transition des éléments romans aux éléments gothiques.", "Le complexe est un lieu important pour des festivals historiques."],
    },
