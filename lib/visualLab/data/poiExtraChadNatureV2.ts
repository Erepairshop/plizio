...
export const poiExtraChadNatureV2: POI[] = [
  {
    ...
    name: {
      ...
      en: "Lake Chad"},
    descriptionAdvanced: {
      de: "Der Tschadsee ist ein ökologisch faszinierendes Gewässer am Rande der Sahara, das für seine extremen Schwankungen des Wasserspiegels bekannt ist. Ursprünglich einer der größten Seen der Welt, ist seine Fläche in den letzten Jahrzehnten dramatisch geschrumpft, was ihn zu einem Symbol für den Klimawandel in Afrika macht. Dennoch bleibt das flache, endorheische Becken eine unverzichtbare Lebensader für Millionen von Menschen in den Anrainerstaaten Tschad, Kamerun, Niger und Nigeria. Die Vegetation besteht größtenteils aus Schilfgürteln und Papyrus, die zahlreichen Zugvögeln und einheimischen Tierarten Schutz bieten. Für Besucher bietet der See einen Einblick in die fragile Balance zwischen Mensch und Natur in der Sahelzone, wo traditionelle Fischerei und Landwirtschaft das täglich Leben bestimmen. Trotz der ökologischen Herausforderungen ist die Weite der Wasserlandschaft, unterbrochen von schwimmenden Inseln, von einer kargen, aber beeindruckenden Schönheit geprägt.",
      hu: "A Csád-tó a Szahara peremén elhelyezkedő, ökológiailag rendkívül érzékeny állóvíz, amely a vízszint drasztikus ingadozásairól ismert. Egykor a világ egyik legnagyobb tava volt, mára azonban töredékére zsugorodott, ami az afrikai klímaváltozás egyik leglátványosabb jelképévé tette. Ennek ellenére a sekély, lefolyástalan medence továbbra is létfontosságú vízforrásként szolgál Csád, Kamerun, Niger és Nigéria több millió lakója számára. A tó partvidékét sűrű nádasok és papiruszültetvények borítják, amelyek számtalan költöző madárnak és helyi vadfajnak nyújtanak menedéket. Az ide látogatók megtapasztalhatják a Száhel-övezet törékeny egyensúlyát, ahol a hagyományos halászat és az öntözéses földművelés alapvető megélhetést biztosít. A táj kietlen, mégis lenyűgöző szépségét a végtelennek tűnő vízfelület és a köztük úszó kis szigetek adják, amelyek a természet alkalmazkodóképességét hirdetik a sivatag peremén.",
      en: "Lake Chad is an ecologically fascinating body of water situated on the edge of the Sahara, renowned for its extreme fluctuations in water levels. Once one of the largest lakes in the world, its surface area has shrunk dramatically over the recent decades, making it a prominent symbol of climate change in Africa. Despite this, the shallow, endorheic basin remains a vital lifeline for millions of people across Chad, Cameroon, Niger, and Nigeria. The vegetation largely consists of reed beds and papyrus, providing a safe haven for countless migratory birds and indigenous wildlife. For travelers, the lake offers a glimpse into the fragile balance between human activity and nature in the Sahel region, where traditional fishing and farming dictate daily life. Notwithstanding the ecological challenges, the vast expanse of the water landscape, broken only by floating islands, possesses a stark yet haunting beauty that highlights the resilience of the surrounding ecosystems."
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/lake-chad-nature-v2.webp"},
  {
    ...
    name: {
      ...
      en: "Chari River"},
    descriptionAdvanced: {
      de: "Der Schari-Fluss (Chari) ist die wichtigste Lebensader des Tschad und ein entscheidendes hydrologisches Element für die gesamte Sahelzone. Mit einer Länge von rund 1.400 Kilometern entspringt er in der Zentralafrikanischen Republik und fließt in nordwestlicher Richtung, bis er schließlich in den Tschadsee mündet. In der Hauptstadt N'Djamena bildet der Schari eine natürliche Grenze und vereint sich dort mit seinem größten Nebenfluss, dem Logone. Dieser Zusammenfluss ist von strategischer und wirtschaftlicher Bedeutung, da der Fluss etwa 90 % des Wassers liefert, das den Tschadsee speist. Für die lokale Bevölkerung ist der Schari eine unverzichtbare Quelle für den Fischfang und die Bewässerung in einer ansonsten ariden Region. Während der Regenzeit schwillt der Fluss massiv an und überflutet weite Uferbereiche, was die Bodenfruchtbarkeit erhöht, aber auch die Navigation erschwert. Eine Bootsfahrt auf dem Schari bietet Einblicke in das tägliche Leben am Ufer, wo Wäscherinnen, Fischer und Händler den Rhythmus des Wassers nutzen.",
      hu: "A Chari-folyó Csád legfontosabb vízi útja és a Száhel-övezet egyik legmeghatározóbb természeti eleme. A körülbelül 1400 kilométer hosszú folyó a Közép-afrikai Köztársaság területén ered, és északnyugati irányban szeli át az országot, mielőtt a Csád-tóba ömlene. A folyó különösen fontos szerepet játszik a főváros, N’Djamena életében, ahol nemcsak átszeli a várost, hanem itt egyesül legnagyobb mellékfolyójával, a Logone-nal is. Ez a vízi rendszer biztosítja a Csád-tó vízutánpótlásának több mint 90%-át, így a folyó állapota közvetlen hatással van az egész régió ökológiai egyensúlyára. A helyi lakosság számára a Chari a fő élelemforrás a halászat révén, és elengedhetetlen az öntözéses mezőgazdasághoz. Az esős évszakban a vízszint jelentősen megemelkedik, elárasztva a környező síkságokat, ami tápanyagban gazdag iszapot hagy hátra. A folyóparti élet lüktetése, a kenuikon közlekedő kereskedők és a vízparti piacok egyedülálló bepillantást engednek az afrikai ország mindennapjaiba.",
      en: "The Chari River is the lifeblood of Chad and a critical hydrological lifeline for the entire Sahel region. Stretching approximately 1,400 kilometers from its headwaters in the Central African Republic, it flows northwest across Chad's vast plains before emptying into Lake Chad. The river plays a central role in the capital city, N'Djamena, where it meets its largest tributary, the Logone River. This confluence is of immense ecological importance, as the Chari system provides over 90% of the water that sustains Lake Chad, a vital resource for millions of people across four countries. For the people of Chad, the river is a primary source of protein through fishing and an essential resource for seasonal irrigation. During the rainy season, the river swells significantly, depositing nutrient-rich silt along its banks, which supports local agriculture. Travelers to N'Djamena can witness the river's bustling activity, from fishermen casting traditional nets to traders crossing the waters in heavily laden pirogues, reflecting the river's enduring importance to local commerce."
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/chari-river-nature-v2.webp"},
  {
    ...
    name: {
      ...
      en: "Logone River"},
    descriptionAdvanced: {
      de: "Der Logone ist einer der bedeutendsten Flüsse Zentralafrikas und bildet auf weiten Strecken die natürliche Grenze zwischen dem Tschad und Kamerun. Als wichtigster Nebenfluss des Schari spielt er eine entscheidende Rolle für das hydrologische Gleichgewicht des Tschadsees. Das Flusssystem ist bekannt für seine saisonalen Überschwemmungen, die fruchtbare Sedimente auf die umliegenden Ebenen tragen und so die Lebensgrundlage für Tausende von Menschen sichern. Die Ufer des Logone sind von dichten Feuchtgebieten gesäumt, die eine enorme Artenvielfalt an Vögeln, Fischen und Flusspferden beherbergen. Für die lokale Bevölkerung dient der Fluss nicht nur der Bewässerung, sondern auch als lebenswichtiger Transportweg für Güter und Vieh. Historisch gesehen war das Logone-Tal ein Zentrum afrikanischer Königreiche und Handelsrouten. Heute ist der Schutz dieses Ökosystems von grenzüberschreitender Bedeutung, um die Wasserressourcen und die Flora und Fauna der Region für die Zukunft zu bewahren.",
      hu: "A Logone-folyó Közép-Afrika egyik legfontosabb vízi útja, amely hosszú szakaszon természetes határvonalat képez Csád és Kamerun között. A Chari-folyó legjelentősebb mellékfolyójaként alapvető szerepet játszik a Csád-tó vízutánpótlásában és a régió törékeny ökológiai egyensúlyának fenntartásában. A folyó vízjárását erőteljes szezonalitás jellemzi; az áradások idején hatalmas területeket önt el, termékeny iszappal borítva be a környék mezőgazdasági területeit. Ezek a vizes élőhelyek nemzetközi jelentőségűek, számtalan vándormadárnak, vízilónak és ritka halfajnak nyújtanak menedéket. A helyi közösségek számára a Logone az élet forrása: vizét öntözésre használják, a folyó pedig fontos közlekedési folyosóként szolgál az áruk és az emberek szállítására. A folyóparti településeken ma is láthatók a hagyományos halászati módszerek, amelyek generációk óta változatlanok. A Logone-völgy kulturális és természeti öröksége elválaszthatatlan a vidék történelmétől.",
      en: "The Logone River is one of Central Africa's most significant waterways, acting as a natural border between Chad and Cameroon for much of its length. As the primary tributary to the Chari River, it plays a vital role in sustaining the water levels of Lake Chad and the surrounding ecosystems. The river is characterized by dramatic seasonal flooding, which deposits nutrient-rich silt across the floodplains, supporting large-scale agriculture and pastoral activities. These seasonal wetlands are internationally recognized for their biodiversity, providing habitats for hippopotamuses, diverse fish species, and vast numbers of migratory birds. For the local communities, the Logone is an essential lifeline, offering a reliable transport route for goods and a primary source of protein through fishing. Historically, the river valley has been a crossroads of cultures and trade, shaping the development of regional kingdoms. Managing the Logone's water resources remains a critical task for ensuring the environmental health of the Lake Chad Basin."
    },
    factsAdvanced: {
