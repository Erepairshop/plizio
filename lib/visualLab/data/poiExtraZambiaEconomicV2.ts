...
export const poiExtraZambiaEconomicV2: POI[] = [
  {
    ...
    facts: {
      de: [
        "Gehört zu den tiefsten Minen.",
        "Wichtiger Arbeitgeber der Region.",
      ],
      hu: [
        "A legmélyebb bányák közé tartozik.",
        "A régió fontos munkaadója.",
      ],
      ro: [
        "Printre cele mai adânci mine.",
        "Angajator important în regiune.",
      ],
      en: [
    ...
    descriptionAdvanced: {
      ...
      hu: "A Mopani Copper Mines (MCM) Zambia egyik legnagyobb integrált réz- és kobalttermelője, jelentős létesítményekkel Kitwe és Mufulira városaiban. A vállalat mélyművelésű és külszíni bányákat, valamint átfogó feldolgozóüzemeket, köztük dúsítókat, olvasztót és finomítót üzemeltet. Történelmileg a Mopani a zambiai rézöv (Copperbelt) bányászatának sarokköve volt, és évtizedek óta meghatározza Kitwe és Mufulira gazdasági fejlődését. Nemzetközi konszernek, például a Glencore tulajdonlása után a zambiai állam a ZCCM-IH-n keresztül 2021-ben vette át a teljes irányítást, mielőtt új befektetési partnereket kerestek volna. A bánya híres mély aknáiról, amelyek Afrika legmélyebbjei közé tartoznak, és a legmodernebb bányászati technológiát igénylik. A réztermelés mellett a Mopani a kobalt fontos előállítója is, amely a globális energiaátmenet szempontjából kritikus ásvány. A vállalat folyamatosan fektet be üzemei modernizálásába a hatékonyság növelése és a környezetvédelmi előírások betartása érdekében. Munkahelyek ezrei függenek közvetlenül és közvetve e bányák életerejétől. A Mopani emellett társadalmi programokat is működtet az oktatás és az egészségügy területén a környező közösségekben.",
      ro: "Mopani Copper Mines (MCM) este unul dintre cei mai mari producători integrați de cupru și cobalt din Zambia, având facilități majore în Kitwe și Mufulira. Compania operează atât mine de adâncime, cât și de suprafață, precum și unități complexe de procesare, inclusiv concentratoare, o topitorie și o rafinărie. Din punct de vedere istoric, Mopani a fost o piatră de temelie a mineritului din Centura Cuprului (Copperbelt) din Zambia, modelând dezvoltarea economică a orașelor Kitwe și Mufulira timp de decenii. După o perioadă în proprietatea unor consorții internaționale precum Glencore, statul zambian a preluat controlul total prin ZCCM-IH în 2021, înainte de a căuta noi parteneri de investiții. Mina este cunoscută pentru puțurile sale adânci, care se numără printre cele mai profunde din Africa și necesită tehnologie minieră de ultimă oră. Pe lângă producția de cupru, Mopani este un producător important de cobalt, un mineral critic pentru tranziția energetică globală. Compania investește continuu în modernizarea instalațiilor sale pentru a crește eficiența și a respecta standardele de mediu. Mii de locuri de muncă depind direct și indirect de vitalitatea acestor mine. Mopani derulează, de asemenea, programe sociale în domeniile educației și sănătății în comunitățile învecinate.",
      en: "Mopani Copper Mines (MCM) is one of Zambia's largest integrated copper and cobalt producers, with extensive operations located in the cities of Kitwe and Mufulira. The company operates both underground and open-pit mines, supported by comprehensive processing facilities including concentrators, a smelter, and a refinery. Historically, Mopani has been a cornerstone of the Zambian Copperbelt, driving the economic development of Kitwe and Mufulira for several decades. Following a period of ownership by international firms like Glencore, the Zambian government through ZCCM-IH took full control in 2021 to restructure and seek new investment partners. The mine is notable for its deep shafts, which are among the deepest on the African continent, requiring advanced mining technology and safety systems. In addition to copper, Mopani is a key supplier of cobalt, a mineral essential for the global green energy transition. The firm continually invests in asset upgrades to enhance production efficiency and meet modern environmental regulations. Thousands of jobs are sustained both directly and indirectly by these operations. Mopani also plays a proactive role in community development, supporting local schools and hospitals.",
    },
    factsAdvanced: {
      de: ["Mopani betreibt Anlagen an zwei Hauptstandorten: Kitwe und Mufulira.", "Im Jahr 2021 übernahm ZCCM-IH die Mine für einen symbolischen Preis von 1 USD plus Schulden.", "Die Mufulira-Mine wurde bereits in den 1930er Jahren in Betrieb genommen.", "Mopani produziert jährlich Zehntausende Tonnen Kupfer und bedeutende Mengen Kobalt.", "Die Schächte der Mine reichen über 1.200 Meter tief in die Erde.", "Das Unternehmen ist einer der größten Arbeitgeber im sambischen Copperbelt."],
  ...
  },
  {
    ...
    facts: {
      de: [
        "Eines der nassesten Bergwerke weltweit.",
        "Fördert auch Kobalt.",
      ],
      hu: [
        "A világ egyik legvizesebb bányája.",
        "Kobaltot is bányásznak itt.",
      ],
      ro: [
        "Una dintre cele mai umede mine.",
        "Extrage și cobalt.",
      ],
      en: [
    ...
    descriptionAdvanced: {
      ...
      hu: "A Konkola Copper Mines (KCM) Zambia egyik legnagyobb bányászati vállalata, amely Chililabombwe és Chingola városokban üzemeltet bányákat. A vállalat zászlóshajója a Konkola mélyművelésű bánya, amely a világ egyik legvízgazdagabb bányájaként ismert, és hatalmas szivattyúzási kapacitást igényel. A KCM integrált létesítményeket foglal magában, köztük egy modern olvasztót Chingolában és egy finomítót. A bánya Afrika egyik leggazdagabb rézérckészletével rendelkezik, ami stratégiailag nélkülözhetetlenné teszi a zambiai gazdaság számára. A vállalat tulajdonosi szerkezete összetett múltra tekint vissza, sok éven át a Vedanta Resources volt a fő részvényes. Mérete miatt a bánya Zambia bruttó hazai termékének meghatározó tényezője, és emberek ezreinek ad munkát. A mélyművelés technológiai kihívásai extrém vízviszonyok mellett a Konkolát a nemzetközi mérnöki tudomány referenciaprojektjévé teszik. A réz mellett jelentős mennyiségű kobaltot is bányásznak. Az utóbbi időben a KCM jogi és politikai viták középpontjában állt az üzemek irányítása és újjáélesztése kapcsán. A vállalat emellett erőteljesen elkötelezett a helyi sport és a társadalmi infrastruktúra támogatása mellett a Copperbelt régióban.",
      ro: "Konkola Copper Mines (KCM) este una dintre cele mai mari companii miniere din Zambia, operând mine în Chililabombwe și Chingola. Nava amiral a companiei este mina de adâncime Konkola, cunoscută ca fiind una dintre cele mai apoase mine din lume, necesitând capacități enorme de pompare. KCM cuprinde facilități integrate, inclusiv o topitorie modernă în Chingola și o rafinărie. Mina deține unele dintre cele mai bogate zăcăminte de cupru din Africa, ceea ce o face strategic indispensabilă pentru economia zambiană. Compania are o istorie complexă de schimbări de proprietate, Vedanta Resources fiind acționarul majoritar timp de mulți ani. Datorită dimensiunii sale, mina este un factor central pentru Produsul Intern Brut al Zambiei și oferă locuri de muncă pentru mii de oameni. Provocarea tehnologică a mineritului de adâncime în condiții de apă extremă face din Konkola un proiect de referință pentru ingineria internațională. Pe lângă cupru, se extrag și cantități semnificative de cobalt. Recent, KCM a fost în centrul unor dispute juridice și politice privind controlul și revitalizarea instalațiilor sale. Compania este, de asemenea, puternic implicată în promovarea sportului local și a infrastructurii sociale în regiunea Copperbelt.",
      en: "Konkola Copper Mines (KCM) is a premier mining entity in Zambia, maintaining significant operations in the towns of Chililabombwe and Chingola. Its flagship operation, the Konkola Deep Mine, is globally renowned for being one of the wettest mines in existence, requiring massive, continuous pumping operations to manage groundwater. KCM is a fully integrated producer, featuring advanced facilities such as the Nchanga smelter in Chingola and a dedicated refinery. The company controls some of the highest-grade copper deposits in Africa, making it a critical asset for Zambia's national economy. Over the decades, KCM has experienced various ownership structures, with Vedanta Resources serving as the majority shareholder for a substantial period. Due to its scale, the mine is a major contributor to Zambia's GDP and is a primary employer for thousands in the Copperbelt province. The engineering feats required to mine at depth under such extreme hydrological conditions make Konkola a global case study for technical innovation. Besides copper, it is also a source of cobalt. Lately, KCM has been at the center of complex legal and administrative processes aimed at securing long-term investment. The company also sponsors various community health and sports initiatives.",
    },
    factsAdvanced: {
      de: ["Die Konkola-Mine pumpt täglich rund 400.000 Kubikmeter Wasser aus der Tiefe.", "KCM verfügt über eine der modernsten Kupferschmelzhütten Afrikas in Chingola.", "Das Erz bei Konkola hat einen außergewöhnlich hohen Kupfergehalt von fast 4 %.", "Vedanta Resources hielt über ein Jahrzehnt lang die Mehrheitsbeteiligung an KCM.", "Das Konkola Deep Mining Project (KDMP) zielt auf Vorkommen in über 1.500 m Tiefe.", "Die Mine wurde ursprünglich in den 1950er Jahren als Bancroft Mine eröffnet."],
  ...
  },
  {
    ...
    facts: {
      de: [
        "Befindet sich bei Solwezi.",
        "Wird im Tagebau betrieben.",
      ],
      hu: [
        "Solwezi közelében található.",
        "Külszíni fejtéssel működik.",
      ],
      ro: [
        "Situată lângă Solwezi.",
        "Operată în carieră deschisă.",
      ],
      en: [
    ...
    descriptionAdvanced: {
      ...
      hu: "A Solwezi melletti Kansanshi réz- és aranybánya Afrika legnagyobb rézbányája termelési kapacitás tekintetében, és a zambiai bányászat egyik zászlóshajója. Az üzemet a First Quantum Minerals (FQM) működteti, amely a többségi részesedést birtokolja, míg a zambiai állam a ZCCM-IH-n keresztül vesz részt a tulajdonlásban. A Kansanshi abban különbözik a hagyományos Copperbelt bányáktól, hogy az Északnyugati tartományban található, és jelentős aranykészletekkel rendelkezik melléktermékként. A létesítmény a legmodernebb külszíni bányászati technológiákat alkalmazza, és korszerű lúgzó- és elektrolizáló üzemekkel, valamint saját olvasztóval rendelkezik. A 2005-ös üzembe helyezés óta a Kansanshi alapjaiban változtatta meg Solwezi gazdasági képét, a várost virágzó gazdasági központtá téve. A bánya híres nagy hatékonyságáról és arról a képességéről, hogy oxid- és szulfidérceket egyidejűleg tud feldolgozni. Gazdasági jelentősége mellett a bánya úttörő a környezetvédelmi és társadalmi szabványok terén Zambiában. A Kansanshiból származó adóbevételek a zambiai állami költségvetés egyik legfontosabb bevételi forrását jelentik. A vállalat masszívan fektet be oktatási programokba és a helyi beszállítók támogatásába. A tervezett S3 bővítés évtizedekkel fogja meghosszabbítani a bánya élettartamát.",
      ro: "Mina de cupru și aur Kansanshi de lângă Solwezi este cea mai mare mină de cupru din Africa după capacitatea de producție și o emblemă a mineritului din Zambia. Este operată de First Quantum Minerals (FQM), care deține pachetul majoritar de acțiuni, în timp ce statul zambian participă prin ZCCM-IH. Kansanshi se deosebește de minele tradiționale din Centura Cuprului prin locația sa în Provincia de Nord-Vest și prin rezervele semnificative de aur ca produs secundar. Instalația utilizează cele mai moderne tehnologii de minerit la suprafață și dispune de unități avansate de lixiviere și electroliză, precum și de o topitorie proprie. De la reluarea operațiunilor în 2005, Kansanshi a transformat fundamental peisajul economic al orașului Solwezi, transformându-l într-un centru economic înfloritor. Mina este cunoscută pentru eficiența sa ridicată și pentru capacitatea de a procesa simultan atât minereuri oxidice, cât și sulfurice. Pe lângă importanța economică, mina este un pionier în standardele sociale și de mediu în Zambia. Veniturile fiscale de la Kansanshi sunt una dintre cele mai importante surse de venit pentru bugetul de stat zambian. Compania investește masiv în programe educaționale și în sprijinirea furnizorilor locali. Extinderea planificată S3 va prelungi durata de viață a minei cu decenii.",
      en: "The Kansanshi Copper-Gold Mine near Solwezi stands as Africa's largest copper mine by production capacity and is a flagship asset for the Zambian mining industry. Operated by First Quantum Minerals (FQM), which holds the majority stake, the mine also features strategic state participation via ZCCM-IH. Kansanshi distinguishes itself from traditional Copperbelt mines through its location in the North-Western Province and its significant output of gold as a valuable byproduct. The site utilizes large-scale open-pit mining techniques and incorporates state-of-the-art hydrometallurgical processing and a dedicated smelter. Since its redevelopment in 2005, Kansanshi has fundamentally altered the economic landscape of Solwezi, turning the town into a primary regional commercial hub. The operation is noted for its high technical efficiency and its specialized ability to treat oxide, sulfide, and mixed ores concurrently. Beyond its financial impact, the mine is a leader in implementing ESG standards within the Zambian extractive sector. Tax contributions from Kansanshi represent a cornerstone of Zambia's national fiscal revenue. The firm is heavily invested in community literacy and local supply chain development. The 'S3' expansion project is set to extend the mine's operational life for several decades.",
    },
    factsAdvanced: {
      de: ["Kansanshi produziert jährlich rund 340.000 Tonnen Kupfer.", "Die Mine ist einer der größten Goldproduzenten in Sambia.", "First Quantum Minerals (FQM) hält 80 % der Anteile an der Mine.", "Kansanshi betreibt eine der weltweit größten Kupferschmelzhütten mit Isotasmelt-Technologie.", "Die Mine liegt etwa 10 Kilometer nördlich der Stadt Solwezi.", "Das S3-Erweiterungsprojekt umfasst Investitionen von über 1,25 Milliarden USD."],
  ...
  {
    id: "zm-lumwana-copper-mine-economic-v2",
    type: "industry",
    parent: "ZM-06",
    coords: [25.8239, -12.2415],
    name: {
    ...
    facts: {
      de: [
        ...
        "Verarbeitet große Mengen an Erz.",
      ],
      hu: [
        "2008-ban nyitották meg.",
        "Nagy mennyiségű ércet dolgoz fel.",
      ],
      ro: [
        "Deschisă în anul 2008.",
        "Procesează cantități mari de minereu.",
      ],
      en: [
        "Opened in 2008.",
    ...
    descriptionAdvanced: {
      ...
      hu: "A Lumwana rézbánya egy jelentős külszíni bányászati projekt Zambia Északnyugati tartományában, mintegy 100 kilométerre nyugatra Solwezitől. Az üzemet a Barrick Gold, a világ egyik vezető bányászati vállalata működteti. A bánya híres masszív, alacsony réztartalmú érckészleteiről, amelyek nagyléptékű, rendkívül hatékony feldolgozást igényelnek. 2008-as üzembe helyezése óta a Lumwana döntő szerepet játszott abban, hogy az Északnyugati tartományt Zambia új 'bányászati határvidékeként' pozícionálja. A létesítmény két fő külszíni fejtést, a Malundwe-t és a Chimiwungo-t foglalja magában, és a legmodernebb aprító- és flotálóberendezéseket alkalmazza. A projekt egy teljesen új város létrejöttéhez vezetett az alkalmazottak és családjaik számára. Gazdaságilag a Lumwana kulcsfontosságú tényező Zambia exportbevételeiben és jelentős foglalkoztató a régióban. A Barrick Gold az elmúlt években bejelentette egy masszív bővítés (Super Pit) tervét, hogy a bányát világszínvonalú, hosszú élettartamú réztermelővé alakítsa. Ezek a beruházások hangsúlyozzák a nemzetközi befektetők bizalmát a zambiai bányászati környezet iránt. A bánya emellett részt vesz a nők gazdasági szerepvállalását segítő programokban és a helyi oktatás támogatásában.",
      ro: "Mina de cupru Lumwana este un proiect major de minerit la suprafață în Provincia de Nord-Vest a Zambiei, situat la aproximativ 100 de kilometri vest de Solwezi. Este operată de Barrick Gold, una dintre cele mai importante companii miniere din lume. Mina este cunoscută pentru corpurile sale masive de minereu cu conținut scăzut de cupru, care necesită o procesare la scară largă și de înaltă eficiență. De la darea sa în folosință în 2008, Lumwana a contribuit decisiv la stabilirea Provinciei de Nord-Vest ca o nouă „frontieră minieră” a Zambiei. Instalația cuprinde două cariere principale, Malundwe și Chimiwungo, și utilizează cele mai moderne instalații de sfărâmare și flotație. Proiectul a dus la crearea unui oraș complet nou pentru angajați și familiile acestora. Din punct de vedere economic, Lumwana este un factor determinant pentru veniturile din export ale Zambiei și un angajator semnificativ în regiune. Barrick Gold a anunțat în ultimii ani planuri pentru o extindere masivă (Super Pit) pentru a transforma mina într-un producător de cupru de talie mondială, cu o durată lungă de viață. Aceste investiții subliniază încrederea investitorilor internaționali în sectorul minier zambian. Mina este implicată, de asemenea, în programe de promovare a participării economice a femeilor și în sprijinirea educației locale.",
      en: "The Lumwana Copper Mine is a significant large-scale open-pit mining operation in Zambia's North-Western Province, situated roughly 100 kilometers west of Solwezi. It is operated by Barrick Gold, a global leader in the mining industry. The mine is distinguished by its vast, low-grade copper ore bodies, which necessitate highly efficient, large-volume processing techniques. Since starting operations in 2008, Lumwana has been instrumental in shifting Zambia's copper production focus toward the North-Western 'New Copperbelt.' The facility exploits two primary pits, Malundwe and Chimiwungo, utilizing high-capacity crushing and flotation circuits. The establishment of the mine led to the development of a purpose-built township to house its workforce and provide essential services. Economically, Lumwana is a pillar for Zambia's foreign exchange earnings and a vital regional employer. Barrick Gold recently unveiled plans for a 'Super Pit' expansion, aiming to elevate the site into a world-class, long-life copper producer. This strategic reinvestment demonstrates strong international confidence in the Zambian mining sector's regulatory environment. Additionally, the mine champions local socio-economic initiatives, including women's empowerment programs and primary education support.",
    },
    factsAdvanced: {
      de: ["Lumwana wird zu 100 % von Barrick Gold betrieben.", "Die Mine produziert jährlich etwa 200.000 Tonnen Kupferkonzentrat.", "Das Super-Pit-Projekt soll die Produktion auf bis zu 240.000 Tonnen steigern.", "Die Mine nutzt eine der größten Flotationsanlagen der Welt.", "Lumwana war die erste große Investition in der Nordwestprovinz Sambias.", "In der Mine kommen riesige Muldenkipper mit einer Kapazität von 240 Tonnen zum Einsatz."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Lubambe rézbánya, korábbi nevén Konkola North, a zambiai rézöv (Copperbelt) északi részén, Chililabombwe városának közelében található. Ez egy mélyművelésű bányászati projekt, amely stratégiailag a Kongói Demokratikus Köztársasággal közös határ mentén helyezkedik el. A bányát az EMR Capital, egy globális, erőforrásokra összpontosító magántőke-társaság működteti. A Lubambe-t a Konkola-medencében elfoglalt földrajzi elhelyezkedése jellemzi, amely régió kiemelkedően magas réztartalommal rendelkezik. A bánya modern függőleges aknákat és gépesített föld alatti bányászati rendszert alkalmaz az érc hatékony kitermeléséhez. A 2012-es üzembe helyezés óta a bánya változatos múltra tekint vissza különböző befektetési partnerekkel. Gazdaságilag a bánya jelentősen hozzájárul Chililabombwe bányászati portfóliójához, és fontos munkahelyeket teremt egy bányászattól erősen függő régióban. Az elmúlt években kiterjedt kutatómunkát végeztek a bánya bővítési potenciáljának (Lubambe Extension) felmérésére, amelyet a világ egyik legértékesebb kiaknázatlan rézprojektjeként tartanak számon. A bánya nagy hangsúlyt fektet a munkabiztonságra és a nemzetközi környezetvédelmi szabványok betartására. A Lubambe emellett helyi közösségi projektekben is részt vesz, különösen az ivóvízellátás és a mezőgazdaság területén.",
      ro: "Mina de cupru Lubambe, cunoscută anterior sub numele de Konkola North, este situată în nordul regiunii Copperbelt din Zambia, lângă orașul Chililabombwe. Este un proiect de minerit de adâncime poziționat strategic la granița cu Republica Democrată Congo. Mina este operată de EMR Capital, o firmă globală de capital privat axată pe resurse. Lubambe se remarcă prin locația sa geologică în bazinul Konkola, o regiune cu conținut de cupru extrem de ridicat. Mina utilizează puțuri verticale moderne și un sistem de minerit subteran mecanizat pentru a extrage minereul în mod eficient. De la darea sa în folosință în 2012, a avut o istorie variată cu diferiți parteneri de investiții. Din punct de vedere economic, mina contribuie semnificativ la portofoliul minier al orașului Chililabombwe și creează locuri de muncă esențiale într-o regiune care depinde puternic de minerit. În ultimii ani, au fost efectuate lucrări de explorare extinse pentru a evalua potențialul de extindere a minei (Lubambe Extension), considerat unul dintre cele mai valoroase proiecte de cupru neexploatate din lume. Mina pune un mare accent pe siguranța muncii și pe respectarea standardelor internaționale de mediu. Lubambe este, de asemenea, implicată în proiecte comunitare locale, în special în domeniile aprovizionării cu apă potabilă și agriculturii.",
      en: "The Lubambe Copper Mine, formerly recognized as Konkola North, is situated at the northern edge of Zambia's Copperbelt near the town of Chililabombwe. This underground operation is strategically located along the border with the Democratic Republic of Congo. The mine is managed by EMR Capital, a global private equity firm specializing in natural resources. Lubambe is geographically favored by its position within the Konkola Basin, an area known for exceptionally high-grade copper mineralisation. The facility employs modern vertical shafts and a highly mechanized trackless underground mining system to optimize ore extraction. Since its official commissioning in 2012, Lubambe has undergone several ownership transitions involving major international players. Economically, it is a key component of the Chililabombwe district's industrial sector and serves as a major employer for the local community. Recent extensive exploration drilling has highlighted the massive potential of the 'Lubambe Extension' project, often cited as one of the world's most significant undeveloped high-grade copper resources. The operation adheres to stringent international safety and environmental protocols. Community engagement is a priority for Lubambe, with active investments in local sanitation, clean water access, and sustainable farming initiatives.",
    },
    factsAdvanced: {
      de: ["Lubambe war ein Joint Venture zwischen Vale und African Rainbow Minerals.", "Die Mine wurde 2012 offiziell vom sambischen Präsidenten eingeweiht.", "EMR Capital erwarb 2017 eine 80 %-Beteiligung an der Mine.", "Die Lubambe Extension verfügt über Reserven mit über 3,6 % Kupfergehalt.", "Die Mine befindet sich in unmittelbarer Nähe zum Grenzübergang Kasumbalesa.", "Lubambe nutzt ein modernes Flotationssystem zur Konzentratgewinnung."],
  ...
  },
  {
    ...
    facts: {
      de: [
        "Größte Kobaltraffinerie des Landes.",
        "Verarbeitet Erze aus der ganzen Region.",
      ],
      hu: [
        "Az ország legnagyobb kobaltfinomítója.",
        "A régió érceit dolgozza fel.",
      ],
      ro: [
        "Cea mai mare rafinărie de cobalt din țară.",
        "Procesează minereuri din întreaga regiune.",
      ],
      en: [
    ...
    descriptionAdvanced: {
      ...
      hu: "A Chambishi Metals Zambia egyik legjelentősebb finomító üzeme, amely a rézöv (Copperbelt) szívében, Kitwe és Chingola között található. A létesítmény világszerte ismert a réz- és kobaltkoncentrátumok speciális feldolgozásáról, valamint a fémek kinyeréséről a történelmi salakhalmokból. A modern ívkemencés technológia (Cosac) alkalmazásával a Chambishi Metals jelentősen növelni tudta a kobalt-extraúció hatékonyságát. Történelmileg a finomító kulcsszerepet játszott a régió különböző bányáiból származó ércek, köztük a Kongói Demokratikus Köztársaságból származó koncentrátumok feldolgozásában. A vállalat különböző nemzetközi csoportok, köztük az Eurasian Resources Group (ERG) tulajdonában volt. A Chambishi Metals jelentősen hozzájárul ahhoz, hogy Zambia a világ egyik legnagyobb kobalttermelője maradjon, ami az elektromos mobilitás korában stratégiai fontosságú. A fémtermelés mellett az üzem fontos helyi foglalkoztató, és befektet Chambishi város társadalmi infrastruktúrájába. Az ingadozó piaci árak idején a finomító üzemeltetési kihívásokkal szembesült, de továbbra is a zambiai bányászati értéklánc nélkülözhetetlen része. A károsanyag-kibocsátás ellenőrzése és a környezetvédelmi előírások szigorú betartása a modern működés központi eleme.",
      ro: "Chambishi Metals este una dintre cele mai importante rafinării din Zambia, situată în inima regiunii Copperbelt, între Kitwe și Chingola. Instalația este cunoscută la nivel mondial pentru procesarea specializată a concentratelor de cupru și cobalt, precum și pentru recuperarea metalelor din haldele istorice de zgură. Prin utilizarea tehnologiei moderne a cuptorului cu arc electric (Cosac), Chambishi Metals a reușit să crească semnificativ eficiența extracției de cobalt. Din punct de vedere istoric, rafinăria a jucat un rol cheie în procesarea minereurilor din diferite mine din regiune, inclusiv concentrate din Republica Democrată Congo. Compania s-a aflat în proprietatea mai multor grupuri internaționale, inclusiv Eurasian Resources Group (ERG). Chambishi Metals contribuie esențial la menținerea Zambiei în topul celor mai mari producători de cobalt din lume, mineral de importanță strategică în era electromobilității. Pe lângă producția de metale, instalația este un angajator local important și investește în infrastructura socială a orașului Chambishi. În perioadele cu prețuri de piață volatile, rafinăria s-a confruntat cu provocări operaționale, dar rămâne o parte indispensabilă a lanțului de valoare al mineritului zambian. Respectarea strictă a controlului emisiilor și a cerințelor de mediu este o componentă centrală a operațiunilor moderne.",
      en: "Chambishi Metals is a premier metal processing refinery in Zambia, strategically located in the Copperbelt Province between Kitwe and Chingola. The facility is internationally recognized for its specialized expertise in treating copper and cobalt concentrates, as well as its advanced techniques for recovering valuable metals from historic slag dumps. By utilizing sophisticated electric arc furnace technology, specifically the Cosac process, Chambishi Metals has achieved high levels of cobalt recovery efficiency. Historically, the refinery has served as a central hub for processing feedstock from various regional mines, including high-grade concentrates imported from the Democratic Republic of Congo. The enterprise has seen several changes in ownership, most recently associated with the Eurasian Resources Group (ERG). Its operations are vital for sustaining Zambia's position as a leading global cobalt supplier, a role increasingly important for the worldwide production of electric vehicle batteries. Beyond industrial output, Chambishi Metals is a major contributor to local employment and supports community development projects in Chambishi town. While the plant has navigated periods of market volatility and care-and-maintenance cycles, it remains a critical link in the nation's mineral value chain. The company maintains a strong focus on environmental stewardship and emission reduction standards.",
    },
    factsAdvanced: {
      de: ["Chambishi Metals betreibt eine der weltweit größten Anlagen zur Schlackenaufbereitung.", "Die Anlage nutzt das Cosac-Verfahren zur Rückgewinnung von Kobalt aus Schlacke.", "Das Unternehmen war ein wichtiger Akteur bei der Gründung der Eurasian Resources Group (ERG).", "Die Raffinerie liegt im Distrikt Kalulushi in der Copperbelt-Provinz.", "Chambishi Metals produziert Kupferkathoden und hochreines Kobaltmetall.", "Die Schlackenhalde in Chambishi enthält schätzungsweise über 20 Millionen Tonnen Material."],
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Chibuluma rézbánya Kalulushi városában, a Copperbelt tartományban található, és Zambia egyik legmagasabb minőségű ércet termelő mélyművelésű bányájaként ismert. A kitermelés 1955-ben kezdődött a Rhodesian Selection Trust irányítása alatt, és a bánya híressé vált a 3 százalékot is meghaladó réztartalmú érceiről. 1997-ben a privatizáció során a dél-afrikai Metorex vállalat vásárolta meg az egységet, ami jelentős technológiai korszerűsítést és a termelés optimalizálását vonta maga után. A komplexum jelenleg két fő részből áll: Chibuluma West és Chibuluma South, ez utóbbit 2001-ben nyitották meg a termelés fenntartása érdekében. A bánya kulcsszerepet játszik Kalulushi gazdasági életében, több száz helyi szakembernek biztosítva megélhetést. Bár a tartalékok végesek, a Chibuluma továbbra is a sambiai bányászat hatékonyságának és precizitásának egyik kiemelkedő példája marad a nemzetközi piacon.",
      ro: "Mina de cupru Chibuluma este situată în Kalulushi, în provincia Copperbelt, și este recunoscută ca fiind una dintre cele mai bogate unități miniere subterane din Zambia în ceea ce privește calitatea minereului. Operațiunile miniere au început oficial în anul 1955 sub egida Rhodesian Selection Trust, mina devenind rapid celebră pentru concentrația de cupru de peste 3%, o valoare excepțională pentru regiune. În 1997, în contextul procesului de privatizare a sectorului minier zambian, mina a fost achiziționată de compania sud-africană Metorex, fapt ce a dus la investiții masive în tehnologie. Facilitatea include două secțiuni principale, Chibuluma West și Chibuluma South, cea din urmă fiind dată în exploatare în anul 2001 pentru a extinde durata de viață a minei. Activitatea economică generată de această mină susține comunitatea locală din Kalulushi prin crearea de locuri de muncă specializate. Chibuluma rămâne un punct de referință pentru eficiența operațională în industria extractivă din Africa Australă.",
      en: "The Chibuluma Copper Mine is located in Kalulushi within the Copperbelt Province and is distinguished as one of Zambia's highest-grade underground mining operations. Mining activities officially commenced in 1955 under the Rhodesian Selection Trust, and the site became renowned for copper ore grades often exceeding 3 percent. In 1997, following the privatization of the Zambian mining sector, the mine was acquired by the South African firm Metorex, which initiated significant infrastructure upgrades. The operation currently consists of two primary sectors, Chibuluma West and Chibuluma South, with the latter commissioned in 2001 to bolster production capacity. This mining complex plays a vital role in the local economy of Kalulushi, providing stable employment for hundreds of skilled workers. Despite the gradual depletion of some mineral reserves, Chibuluma remains a symbol of technical excellence and operational efficiency within the Zambian copper industry.",
    },
    factsAdvanced: {
      de: ["Offizieller Produktionsstart der Mine im Jahr 1955.", "Kupfergehalt des Erzes erreicht oft über 3 Prozent.", "Privatisierung und Verkauf an Metorex im Jahr 1997.", "Inbetriebnahme von Chibuluma South im Jahr 2001.", "Die Mine befindet sich im Distrikt Kalulushi.", "Erreichte eine Tiefe von über 500 Metern im Untertagebau."],
  ...
  },
  {
    ...
    facts: {
      ...
      hu: [
        "A legmodernebb technológiát használja.",
        "Magas termelési kapacitás.",
      ],
      ro: [
        "Folosește tehnologie de ultimă oră.",
    ...
    descriptionAdvanced: {
      ...
      hu: "A Sentinel rézbánya a zambiai Északnyugati tartomány Kalumbila körzetében található, és a modern zambiai bányászat egyik legnagyobb léptékű beruházását képviseli. A First Quantum Minerals által fejlesztett bányát 2015-ben helyezték üzembe egy mintegy 2,1 milliárd dolláros beruházási programot követően. A Sentinel egy hatalmas külszíni fejtés, amely a világ egyik legkorszerűbb feldolgozóüzemével rendelkezik, és évi 300 000 tonna réz előállítására képes. A projekt nem csupán a bányát foglalta magában, hanem Kalumbila új városának felépítését és a kapcsolódó infrastruktúra, például utak és elektromos hálózatok kiépítését is. Mivel az érc réztartalma viszonylag alacsony, a bánya nagy volumenű, rendkívül hatékony technológiákat alkalmaz a jövedelmezőség biztosítására. A Sentinel kulcsszerepet játszik Zambia azon törekvésében, hogy a bányászati súlypontot a hagyományos Copperbelt régión kívülre helyezze. Az üzem jelentősen hozzájárul az ország GDP-jéhez és több ezer embernek biztosít közvetlen munkalehetőséget.",
      ro: "Mina de cupru Sentinel este situată în districtul Kalumbila din Provincia de Nord-Vest a Zambiei și reprezintă una dintre cele mai mari investiții din istoria mineritului modern din această țară. Dezvoltată de compania First Quantum Minerals, mina a început producția în anul 2015, după o investiție masivă estimată la 2,1 miliarde de dolari americani. Sentinel este o exploatare de suprafață de mari dimensiuni, dotată cu o uzină de procesare ultramodernă, proiectată să gestioneze o capacitate de producție de până la 300.000 de tone de cupru anual. Proiectul a inclus dezvoltarea de la zero a orașului Kalumbila și a infrastructurii aferente, inclusiv drumuri de acces și rețele electrice extinse. Deoarece concentrația de cupru din minereu este relativ scăzută, mina utilizează tehnologii de procesare de mare volum pentru a menține eficiența economică. Sentinel este pilonul central al extinderii activității miniere zambiene dincolo de regiunea tradițională Copperbelt. Operațiunea contribuie semnificativ la veniturile statului și susține mii de locuri de muncă în regiune.",
      en: "The Sentinel Copper Mine is located in the Kalumbila District of Zambia's North-Western Province and represents one of the most significant greenfield investments in the nation's modern mining history. Developed by First Quantum Minerals, the mine was commissioned in 2015 following a massive capital investment of approximately 2.1 billion USD. Sentinel is a large-scale open-pit operation featuring one of the world's most advanced processing plants, designed for an annual output capacity of 300,000 tonnes of copper. The project encompassed more than just the mine, involving the establishment of the new town of Kalumbila and extensive infrastructure development, including roads and power lines. Due to the relatively low copper grades in the ore body, the mine relies on high-efficiency, large-volume processing technologies to ensure commercial viability. Sentinel is a cornerstone of Zambia's strategy to expand mining activities beyond the traditional Copperbelt region. The operation contributes substantially to Zambia's GDP and provides direct employment for thousands of residents.",
    },
    factsAdvanced: {
      de: ["Inbetriebnahme der Mine erfolgte im Jahr 2015.", "Investitionskosten beliefen sich auf ca. 2,1 Milliarden USD.", "Geplante jährliche Kupferproduktion von 300.000 Tonnen.", "Betrieben vom Bergbauunternehmen First Quantum Minerals.", "Befindet sich im neu erschlossenen Distrikt Kalumbila.", "Verfügt über die weltweit größte Mahlanlage ihrer Art."],
  ...
  },
  {
    ...
    facts: {
      de: [
        "Beliefert die Bergbauindustrie.",
        "Gegründet in den 1930er Jahren.",
      ],
      hu: [
        "A bányászatot látja el.",
        "Az 1930-as években alapították.",
      ],
      ro: [
        "Aprovizionează industria minieră.",
        "Înființată în anii 1930.",
      ],
      en: [
    ...
    descriptionAdvanced: {
      ...
      hu: "A Ndola Lime Company (NDLC) Zambia legrégebbi és legjelentősebb mészgyártó vállalata, amely nélkülözhetetlen szerepet tölt be az ország bányászati ágazatában. A céget 1931-ben alapították a Copperbelt tartománybeli Masaiti körzetben, Ndola ipari városa mellett. A mészkő és a belőle készült mész alapvető fontosságú a rézkitermelés során, mivel folyósítószerként használják az olvasztásnál, valamint a bányászati folyamatok során keletkező savas vizek semlegesítésére. Az NDLC kiterjedt kőfejtőket és modern mészégető kemencéket üzemeltet, köztük két nagyméretű forgókemencét az égetett mész előállításához. Az évtizedek során a vállalat több tulajdonosváltáson ment keresztül, jelenleg többségi tulajdonosa az állami ZCCM-IH holding. Az új piaci szereplők megjelenése ellenére az NDLC továbbra is a Copperbelt nagy bányavállalatainak stratégiai beszállítója marad. A gyár nemcsak az ipari értéklánc fontos szeme, hanem Masaiti régiójának egyik legfontosabb munkaadója is.",
      ro: "Ndola Lime Company (NDLC) este cel mai vechi și cel mai important producător de var din Zambia, jucând un rol indispensabil în susținerea industriei miniere naționale. Compania a fost înființată în anul 1931 și este situată în districtul Masaiti, în apropierea orașului industrial Ndola din provincia Copperbelt. Calcarul extras și procesat aici este o materie primă esențială pentru extracția cuprului, fiind utilizat ca fondant în procesul de topire și pentru neutralizarea apelor acide rezultate din activitățile miniere. NDLC operează cariere vaste și instalații moderne de calcinare, inclusiv două cuptoare rotative de mari dimensiuni pentru producerea varului nestins. De-a lungul deceniilor, structura acționariatului s-a modificat, compania fiind în prezent deținută majoritar de holdingul de stat ZCCM-IH. În ciuda apariției unor noi competitori pe piață, NDLC rămâne furnizorul strategic principal pentru marile companii miniere din regiunea Copperbelt. Unitatea industrială contribuie semnificativ la economia locală din Masaiti prin crearea de locuri de muncă.",
      en: "The Ndola Lime Company (NDLC) is Zambia's oldest and most prominent lime producer, playing an indispensable role in supporting the nation's vital mining industry. Founded in 1931, the company is situated in the Masaiti District, near the industrial hub of Ndola in the Copperbelt Province. Limestone and its derivatives are essential for copper extraction, serving as a flux in smelting processes and as a neutralizing agent for acidic effluents in mining operations. NDLC operates extensive limestone quarries and sophisticated calcination plants, including two large rotary kilns for the production of quicklime. Over the decades, the company has undergone various ownership changes and is currently majority-owned by the state investment holding ZCCM-IH. Despite increasing competition from new market entrants, NDLC remains the strategic primary supplier for major mining firms across the Copperbelt. The facility not only bolsters the industrial value chain but also stands as a key employer in the Masaiti region.",
    },
    factsAdvanced: {
      de: ["Gründung der Ndola Lime Company im Jahr 1931.", "Sitz des Unternehmens ist der Distrikt Masaiti.", "Gehört mehrheitlich zur staatlichen Holding ZCCM-IH.", "Betreibt zwei große Drehrohröfen zur Kalkherstellung.", "Hauptlieferant von Flussmitteln für sambische Kupferhütten.", "Der Kalkstein wird in lokalen Steinbrüchen im Tagebau gewonnen."],
  ...
  },
  {
    ...
    facts: {
      de: [
        "Gehört zur nigerianischen Dangote-Gruppe.",
        "Tageskapazität von mehreren tausend Tonnen.",
      ],
      hu: [
        "A nigériai Dangote cégcsoport része.",
        "Napi több ezer tonnás kapacitás.",
      ],
      ro: [
        "Aparține grupului nigerian Dangote.",
        "Capacitate zilnică de câteva mii de tone.",
      ],
      en: [
    ...
    descriptionAdvanced: {
      ...
      hu: "A zambiai Dangote cementgyár Ndolában, a Copperbelt tartományban található, és Dél-Afrika egyik legmodernebb és legnagyobb cementgyártó létesítménye. A nigériai milliárdos, Aliko Dangote által vezetett Dangote Group építtette, és 2015-ben adták át hivatalosan. A mintegy 400 millió dolláros beruházással megvalósult üzem éves kapacitása 1,5 millió tonna cement. A létesítmény teljesen integrált, saját mészkőbányával és egy 30 megawattos széntüzelésű erőművel rendelkezik, amely biztosítja a gyár zavartalan energiaellátását. A Dangote megjelenése a zambiai piacon jelentős versenyt generált, ami a cementárak csökkenéséhez és stabilizálódásához vezetett, fellendítve ezzel az ország építőiparát. A belföldi igények kielégítése mellett a gyár jelentős mennyiségű cementet exportál a szomszédos országokba, például a Kongói Demokratikus Köztársaságba és Malawiba. Az üzem a pánafrikai befektetések és a technológiai fejlődés jelképe Zambia iparában.",
      ro: "Fabrica de ciment Dangote din Zambia, situată în Ndola, provincia Copperbelt, este una dintre cele mai moderne și mai mari facilități de producție a cimentului din Africa Australă. Proiectul a fost realizat de Dangote Group, deținut de antreprenorul nigerian Aliko Dangote, și a fost inaugurat oficial în anul 2015. Cu o investiție de aproximativ 400 de milioane de dolari, fabrica are o capacitate instalată de 1,5 milioane de tone de ciment pe an. Aceasta este o unitate complet integrată, dispunând de propria carieră de calcar și de o centrală electrică pe cărbune de 30 MW pentru a-și asigura independența energetică. Intrarea Dangote pe piața zambiană a generat o concurență acerbă, ducând la stabilizarea prețurilor cimentului și sprijinind astfel sectorul construcțiilor la nivel național. Pe lângă piața internă, fabrica exportă ciment în țările vecine, precum Republica Democrată Congo și Malawi. Este considerată un model de succes pentru investițiile pan-africane și pentru progresul tehnologic în industria Zambiei.",
      en: "The Dangote Cement plant in Zambia, located in Ndola within the Copperbelt Province, is one of the most advanced and largest cement production facilities in Southern Africa. Developed by the Dangote Group, owned by Nigerian businessman Aliko Dangote, the plant was officially commissioned in 2015. Following an investment of approximately 400 million USD, the facility boasts an installed annual production capacity of 1.5 million tonnes. It is a fully integrated plant, featuring its own limestone quarry and a dedicated 30-megawatt coal-fired power station to ensure self-sufficient energy supply. Dangote's entry into the Zambian market significantly increased competition, leading to stabilized cement prices and providing a substantial boost to the national construction sector. Beyond satisfying domestic demand, the plant exports cement to neighboring countries such as the Democratic Republic of Congo and Malawi. It stands as a prime example of pan-African investment and industrial modernization within Zambia.",
    },
    factsAdvanced: {
      de: ["Offizielle Inbetriebnahme des Werks im Jahr 2015.", "Gesamtinvestition von rund 400 Millionen US-Dollar.", "Jährliche Produktionskapazität von 1,5 Millionen Tonnen.", "Verfügt über ein eigenes 30-MW-Kohlekraftwerk.", "Eigentümer ist die nigerianische Dangote Group.", "Exportiert Zement in die DR Kongo und nach Malawi."],
  ...
  },
  {
    ...
    facts: {
      de: [
        "Gegründet 1949.",
        "Teil eines internationalen Baustoffkonzerns.",
      ],
      hu: [
        "1949-ben alapították.",
        "Egy nemzetközi építőanyag-konszern része.",
      ],
      ro: [
        "Fondată în 1949.",
        "Parte a unui concern internațional de materiale de construcții.",
      ],
      en: [
        "Founded in 1949.",
  ...
  },
  {
    ...
    facts: {
      de: [
        "Betreibt eigene Farmen.",
        "Integriertes Geschäftsmodell.",
      ],
      hu: [
        "Saját farmokat üzemeltet.",
        "Integrált üzleti modell.",
      ],
      ro: [
        "Operează propriile ferme.",
        "Model de afaceri integrat.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Produziert für den Inlands- und Exportmarkt.",
        "Nutzt Bewässerungssysteme.",
      ],
      hu: [
        "Belföldi és exporthírekre termel.",
        "Öntözőrendszereket használ.",
      ],
      ro: [
        "Produce pentru piața internă și export.",
        "Folosește sisteme de irigații.",
      ],
      en: [
  ...
  {
    id: "zm-kafue-gorge-power-station-economic-v2",
    type: "industry",
    parent: "ZM-09",
    coords: [28.4111, -15.8117],
    name: {
    ...
    facts: {
      de: [
        "Leistung von über 900 Megawatt.",
        "Befindet sich unter der Erde.",
      ],
      hu: [
        "Több mint 900 megawattos teljesítmény.",
        "A föld alatt helyezkedik el.",
      ],
      ro: [
        "Capacitate de peste 900 de megawați.",
        "Este situată în subteran.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Wurde mehrfach erweitert.",
        "Nutzt das Wasser des Sambesi.",
      ],
      hu: [
        "Többször is bővítették.",
        "A Zambézi folyó vizét használja.",
      ],
      ro: [
        "A fost extinsă de mai multe ori.",
        "Folosește apa râului Zambezi.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Relativ neue Anlage.",
        "Unterstützt das Kafue-Gorge-Projekt.",
      ],
      hu: [
        "Viszonylag új létesítmény.",
        "Támogatja a Kafue-szurdok projektet.",
      ],
      ro: [
        "Instalație relativ nouă.",
        "Sprijină proiectul Kafue Gorge.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        ...
        "Nutzt die natürliche Strömung.",
      ],
      hu: [
        "Az ország egyik legrégebbi erőműve.",
        "A természetes áramlást használja.",
      ],
      ro: [
        "Una dintre cele mai vechi centrale din țară.",
        "Folosește curentul natural.",
      ],
      en: [
  ...
  {
    id: "zm-maamba-collieries-power-economic-v2",
    type: "industry",
    parent: "ZM-07",
    coords: [27.1517, -17.3622],
    name: {
    ...
    facts: {
      de: [
        "Neben einer Kohlemine errichtet.",
        "Mindert die Abhängigkeit von Wasserkraft.",
      ],
      hu: [
        "Egy szénbánya mellett épült.",
        "Csökkenti a vízenergiától való függőséget.",
      ],
      ro: [
        "Construită lângă o mină de cărbune.",
  ...
  },
  {
    ...
    facts: {
      de: [
        "Verbindet Sambia mit Tansania und Burundi.",
        "Wichtig für den Export von Zement und Zucker.",
      ],
      hu: [
        "Összeköti Zambiát Tanzániával és Burundival.",
        "Fontos a cement és cukor exportjában.",
      ],
      ro: [
        "Conectează Zambia de Tanzania și Burundi.",
        "Important pentru exportul de ciment și zahăr.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Größter privater FMCG-Hersteller in Sambia.",
        "Exportiert in das südliche Afrika.",
      ],
      hu: [
        "A legnagyobb magán FMCG-gyártó Zambiában.",
        "Dél-Afrikába is exportál.",
      ],
      ro: [
        "Cel mai mare producător privat FMCG din Zambia.",
        "Exportă în Africa de Sud.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        ...
        "Produziert das beliebte Mosi Lager.",
      ],
      hu: [
        "Egy globális konszern leányvállalata.",
        "A népszerű Mosi Lagert gyártja.",
      ],
      ro: [
        "Subsidiară a unui concern global.",
        "Produce populara bere Mosi Lager.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Bezieht Milch von lokalen Bauern.",
        "Sorgt für Ernährungssicherheit.",
      ],
      hu: [
        "Helyi gazdáktól szerzi be a tejet.",
        "Biztosítja az élelmezésbiztonságot.",
      ],
      ro: [
        "Achiziționează lapte de la fermierii locali.",
        "Asigură securitatea alimentară.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Bedeutende Quelle für Kleinschürfer.",
        "Enthält Kobalt und Kupferreste.",
      ],
      hu: [
        "Jelentős forrás a kisbányászok számára.",
        "Kobalt- és rézmaradványokat tartalmaz.",
      ],
      ro: [
        "Sursă importantă pentru micii mineri.",
        "Conține resturi de cobalt și cupru.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Historisch bedeutsam für Ndola.",
        "Hat eine große Aufbereitungsanlage.",
      ],
      hu: [
        "Történelmileg jelentős Ndola számára.",
        "Nagy feldolgozóüzemmel rendelkezik.",
      ],
      ro: [
        "Istoric semnificativă pentru Ndola.",
        "Are o mare instalație de procesare.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Versorgt das benachbarte Wärmekraftwerk.",
        "Abbau im Tagebauverfahren.",
      ],
      hu: [
        "Ellátja a szomszédos hőerőművet.",
        "Külszíni bányászat.",
      ],
      ro: [
        "Aprovizionează centrala termică vecină.",
        "Extracție de suprafață.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Umfasst Baluba und andere Schächte.",
        "Wechselhafte Besitzergeschichte.",
      ],
      hu: [
        "Magában foglalja a Baluba és más aknákat.",
        "Változatos tulajdonosi történelem.",
      ],
      ro: [
        "Include Baluba și alte puțuri.",
        "Istoric schimbător de proprietari.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        "Verbunden mit der TAZAMA-Pipeline.",
        "Strategisch wichtig für das Land.",
      ],
      hu: [
        "A TAZAMA csővezetékhez csatlakozik.",
        "Stratégiailag fontos az ország számára.",
      ],
      ro: [
        "Conectată la conducta TAZAMA.",
        "Strategic importantă pentru țară.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        ...
        "Schafft hunderte Arbeitsplätze.",
      ],
      hu: [
        "Szövetkezeti modell.",
      ...
      ro: [
        "Model cooperativ.",
        "Creează sute de locuri de muncă.",
      ],
      en: [
        "Cooperative model.",
  ...
  },
  {
    ...
    facts: {
      de: [
        "Produziert hochwertiges Nickelkonzentrat.",
        "Befindet sich südlich von Lusaka.",
      ],
      hu: [
        "Kiváló minőségű nikkelkoncentrátumot állít elő.",
        "Lusakától délre található.",
      ],
      ro: [
        "Produce concentrat de nichel de înaltă calitate.",
        "Situată la sud de Lusaka.",
      ],
      en: [
  ...
  },
  {
    ...
    facts: {
      de: [
        ...
        "Wichtig für den Straßenfrachtverkehr.",
      ],
      hu: [
        "Egyablakos határátkelő.",
        "Fontos a közúti árufuvarozásban.",
      ],
      ro: [
        "Punct de frontieră cu oprire unică.",
        "Important pentru transportul rutier de marfă.",
      ],
      en: [
        "One-stop border post.",
