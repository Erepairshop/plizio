  ...
  },
  {
    ...
    factsAdvanced: {
      en: [
        ...
        "According to Greek mythology, Zeus was born in a cave on the Psiloritis mountains.",
      ...
      de: [
        ...
        "Sie war das Zentrum der minoischen Zivilisation, Europas ältester dokumentierter Kultur.",
        "Laut griechischer Mythologie wurde Zeus in einer Höhle auf dem Psiloritis-Gebirge geboren.",
        "Die Insel ist für die Samaria-Schlucht bekannt, ein Weltbiosphärenreservat."
      ],
      hu: [
        "Kréta Görögország legnagyobb szigete és az ötödik legnagyobb a Földközi-tengeren.",
        "A minószi civilizáció központja volt, Európa legrégebbi dokumentált kultúrája.",
        "A görög mitológia szerint Zeusz a Psziloritisz-hegység egyik barlangjában született.",
        "A sziget a Szamaria-szurdokról ismert, amely világ bioszféra-rezervátum."
      ],
      ro: [
        "Creta este cea mai mare insulă din Grecia și a cincea ca mărime din Marea Mediterană.",
        "A fost centrul civilizației minoice, cea mai veche cultură documentată din Europa.",
        "Conform mitologiei grecești, Zeus s-a născut într-o peșteră din munții Psiloritis.",
        "Insula este cunoscută pentru Cheile Samariei, o rezervație mondială a biosferei."
      ]
    },
    facts: {
        en: [
