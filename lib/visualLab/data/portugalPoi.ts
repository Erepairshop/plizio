...
export const portugalAllPoi: POI[] = [portugalCountry, ...portugalRegions, ...portugalCities, ...portugalCulture, ...portugalNature, ...poiExtraPortugalFinal, ...poiExtraPortugalHistorical, ...poiExtraPortugalIndustry, ...poiExtraPortugalMixed, ...poiExtraPortugalNature];
