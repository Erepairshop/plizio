...
export const portugalCountry: POI = {
  ...
  descriptionAdvanced: {    en: "Portugal is a fascinating coastal nation located on the western edge of Europe, known for its rich maritime history, melancholic Fado music, and spectacular beaches. Its diverse landscape ranges from the lush, green mountains of the north to the sun-baked, rolling plains of the Alentejo and the dramatic limestone cliffs of the Algarve. As one of the oldest nation-states in Europe, its borders have remained nearly unchanged since the 13th century. The country played a pivotal role in the Age of Discovery, establishing a vast global empire that profoundly influenced world history and spread the Portuguese language across continents."s history is one of the oldest in Europe, with its borders remaining remarkably stable since the 12th century. This longevity is reflected in its rich architectural heritage, ranging from Roman ruins in Évora to the intricate Manueline style of the Age of Discovery, and the somber beauty of its medieval castles. The landscape of Portugal is incredibly diverse for its size. In the north, the terrain is mountainous and lush, home to the terraced vineyards of the Douro Valley, a UNESCO World Heritage site where the world-famous Port wine is produced. Central Portugal features rolling hills, historic villages, and the majestic Serra da Estrela mountains, the highest on the mainland. Moving south, the Alentejo region offers vast, sun-drenched plains dotted with cork oaks and olive groves, leading finally to the Algarve, renowned for its stunning limestone cliffs, golden beaches, and turquoise waters. Portugal's culture is deeply intertwined with the sea, a connection celebrated in its soulful Fado music, which expresses the melancholic concept of 'saudade'. The country's culinary scene is equally impressive, focusing on fresh seafood, world-class wines, and iconic pastries like the Pastel de Nata. Beyond the mainland, the autonomous regions of Madeira and the Azores offer volcanic landscapes, lush forests, and unique island traditions. Today, Portugal is recognized for its high quality of life, safety, and commitment to renewable energy, making it a premier destination for travelers seeking history, nature, and authentic Mediterranean charm. Whether exploring the narrow alleys of Lisbon's Alfama district, surfing the giant waves of Nazaré, or enjoying a sunset in a remote Alentejo village, visitors are met with a warmth and hospitality that is uniquely Portuguese. The country's transition from a global empire to a modern, forward-looking European nation has preserved its soul while embracing innovation, ensuring that its ancient stones and modern designs tell a story of resilience and beauty.",
    ...
    hu: "Portugália, hivatalos nevén a Portugál Köztársaság, egy lenyűgöző tengerparti ország az Ibériai-félsziget nyugati szélén, Délnyugat-Európában. Nyugatról és délről az Atlanti-óceán, északról és keletről pedig Spanyolország határolja. Stratégiai elhelyezkedése alapjaiban határozta meg identitását mint úttörő tengeri hatalom. Portugália történelme az egyik legrégebbi Európában, határai a 12. század óta szinte változatlanok. Ez a hosszú múlt tükröződik gazdag építészeti örökségében, az évori római romoktól a felfedezések korának bonyolult mánuel stílusán át a középkori várak komor szépségéig. Portugália tájai méretéhez képest rendívül változatosak. Északon a terep hegyvidéki és buja, itt találhatók a Douro-völgy teraszos szőlőültetvényei, amely az UNESCO Világörökség része, és ahol a világhírű portói bort termelik. Közép-Portugáliát lankás dombok, történelmi falvak és a fenséges Serra da Estrela-hegység jellemzi, amely a szárazföld legmagasabb pontja. Délebbre haladva az Alentejo régió hatalmas, napsütötte síkságai következnek paratölgyekkel és olajfaligetekkel, végül pedig az Algarve, amely lenyűgöző mészkőszikláiról, aranyló strandjairól és türkizkék vizéről híres. Portugália kultúrája mélyen összefonódik a tengerrel, ezt a kapcsolatot ünnepli a lélekkel teli fado zene, amely a 'saudade' melankolikus életérzését fejezi ki. Az ország gasztronómiája hasonlóan lenyűgöző, a friss tengeri ételekre, a világszínvonalú borokra és az olyan ikonikus süteményekre összpontosít, mint a Pastel de Nata. A szárazföldön túl Madeira és az Azori-szigetek autonóm régiói vulkanikus tájakat, buja erdőket és egyedülálló szigeti hagyományokat kínálnak. Ma Portugáliát magas életminőségéről, biztonságáról és a megújuló energia iránti elkötelezettségéről ismerik, így az egyik legnépszerűbb úti cél a történelmet, természetet és autentikus mediterrán bájt kereső utazók számára. Legyen szó Lisszabon Alfama negyedének szűk utcáiról, Nazaré óriási hullámainak meglovagolásáról vagy egy naplementéről egy távoli alentejói faluban, a látogatókat egyedülálló portugál vendégszeretet fogadja. Az ország átalakulása a globális birodalomból modern, előretekintő európai nemzetté megőrizte lelkét, miközben befogadta az innovációt, biztosítva, hogy ősi kövei és modern épületei a kitartás és a szépség történetét meséljék el.",
  ...
  facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Portugal is the largest producer of cork in the world, supplying over 50% of the global market.", "The alliance between Portugal and England, signed in 1373, is the oldest active diplomatic alliance in the world.", "Portuguese is the official language of nine countries spanning four different continents.", "The University of Coimbra, established in 1290, is one of the oldest universities in continuous operation in Europe."] },
...
export const portugalRegions: POI[] = [
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The iconic yellow Tram 28 navigates some of the steepest and narrowest streets of any major European capital.", "The Vasco da Gama Bridge in Lisbon is over 12 kilometers long, making it one of the longest in Europe.", "The city's famous 'Pastéis de Nata' custard tarts were originally created by Catholic monks in the Belém district.", "Lisbon is officially recognized as one of the oldest cities in the world, predating Rome by centuries."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Port wine is exclusively produced in the Douro Valley but historically aged and shipped from Porto.", "The spectacular Dom Luís I Bridge was designed by a business partner of Gustave Eiffel.", "Porto's Livraria Lello is widely considered one of the most beautiful and inspiring bookstores on Earth.", "The city's name is the direct etymological root of the name of the country of Portugal."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Algarve is Portugal's southernmost region and its premier tourist destination, celebrated for its spectacular coastline of golden beaches, hidden coves, and towering, sea-carved limestone cliffs. The region boasts a highly desirable Mediterranean microclimate, offering over 300 days of sunshine a year. While the coastal resorts buzz with international visitors and world-class golf courses, the tranquil, hilly hinterland preserves a highly traditional, slow-paced agricultural lifestyle centered around orange, almond, and carob orchards. The heavy influence of five centuries of Moorish rule is still visible in the region's distinctive white architecture and intricate chimney designs." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Algarve este cea mai suică regiune a Portugaliei continentale, renumită pentru clima mediteraneană, stâncile de calcar uimitoare și plajele aurii. Este o destinație turistică populară, care oferă terenuri de golf de clasă mondială, sate de pescari fermecătoare și viață de noapte vibrantă. Regiunea", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The name 'Algarve' originates directly from the Arabic word 'Al-Gharb', which translates to 'The West'.","The region features the Ria Formosa Natural Park, a massive lagoon system critical for migratory birds.","It is globally recognized as one of the finest surfing and golfing destinations in all of Europe.","Cape St. Vincent, located in the western Algarve, was considered the 'end of the world' in medieval times."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Faro este capitala regiunii Algarve.", "Regiunea este cunoscută pentru migdalele și smochinii săi.", "Sagres a fost locul școlii de navigație a Prințului Henric Navigatorul.", "Algarve are unele dintre cele mai bune locuri de surfing din Europa."], "en": [] },
...
export const portugalCulture: POI[] = [
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Belém Tower is an exquisite 16th-century fortress and an absolute icon of Portugal's Age of Discovery, strategically situated on the northern bank of the Tagus River. Built entirely of gleaming white lioz limestone, the tower served as both a defensive bastion and a ceremonial gateway for early Portuguese explorers returning from the Americas and Asia. The structure is a masterpiece of Manueline architecture, intricately carved with maritime motifs, stone ropes, and the crosses of the Order of Christ. It was officially declared a UNESCO World Heritage site in 1983." },
    facts: {
      en: [
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The exterior features the first known stone carving of a rhinoceros in Europe, based on a gift from India.", "It originally sat completely surrounded by water before shifts in the riverbank brought it closer to shore.", "The tower's dark, flooded lower levels were infamously used as a dungeon for political prisoners.", "Its unique architectural style strongly incorporates both Moorish and Venetian design elements."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Sintra is an enchanting, mystical town nestled in the cool, pine-covered foothills of the Sintra Mountains, located just a short train ride from Lisbon. Historically favored by Portuguese royalty as a summer retreat to escape the capital's heat, the town became the epicenter of 19th-century European Romantic architecture. The landscape is dotted with extravagant, whimsical palaces, ancient Moorish ruins, and elaborate aristocratic estates set within dense, exotic gardens. The sheer concentration of spectacular historical estates has earned Sintra's cultural landscape a prestigious UNESCO World Heritage designation." },
    facts: {
      en: [
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The colorful Pena Palace was designed by King Ferdinand II to resemble a fantasy, fairy-tale castle.", "The Quinta da Regaleira estate features incredibly deep, mysterious 'Initiation Wells' used for esoteric rituals.", "The town is famous for two traditional, highly guarded pastries: Travesseiros and Queijadas.", "Lord Byron, the famous English poet, spent time here and described Sintra as a 'glorious Eden'."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Jerónimos Monastery is an awe-inspiring religious and cultural monument located in the Belém district of Lisbon, serving as the ultimate architectural celebration of Portugal's maritime discoveries. Commissioned by King Manuel I in 1501, it was financed by the immense wealth generated from the highly lucrative spice trade with India. The monumental complex is the absolute zenith of the Manueline architectural style, featuring an incredibly ornate cloister and soaring vaulted ceilings supported by slender, intricately carved columns. It survived the devastating 1755 Lisbon earthquake almost entirely unscathed." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The legendary explorer Vasco da Gama is permanently entombed just inside the main entrance of the church.", "The monks of this monastery originally created the world-famous 'Pastel de Nata' custard tart recipe.", "Construction of the massive monastery took over a century to complete.", "In 2007, the historic Treaty of Lisbon was signed by European Union leaders within its grand cloister."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Belém Tower (Torre de Belém) is a striking fortified tower located in the civil parish of Santa Maria de Belém in Lisbon. Constructed in the early 16th century during the peak of the Portuguese Renaissance, it was designed by military architect Francisco de Arruda. The structure is heavily adorned with Manueline symbols, highlighting Portugal's growing maritime power and global expansion. From this exact spot, countless Portuguese caravels set sail to chart unknown oceans, making the tower an enduring symbol of adventure, maritime supremacy, and the profound historical connection between Lisbon and the sea." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Turnul Belém este un turn fortificat în stil manuelin din Lisabona. A servit drept punct de plecare pentru multe călătorii de descoperire și este acum un reper al orașului.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The tower features 17 massive cannon ports that provided a devastating defensive crossfire over the river.","A statue of Our Lady of Safe Homecoming faces the river to bless departing and returning sailors.","Despite its delicate appearance, the tower is a heavily reinforced, highly functional military structure.","It is constructed from locally quarried Lioz limestone, which was also used for the nearby Jerónimos Monastery."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Turnul a fost construit în secolul al XVI-lea.", "Inițial a fost complet înconjurat de apă.", "Turnul este bogat decorat cu motive maritime.", "Face parte din Patrimoniul Mondial UNESCO.", "A servit și drept închisoare."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Batalha Monastery, formally the Monastery of Saint Mary of the Victory, is a towering masterpiece of late Gothic and Manueline architecture located in central Portugal. It was commissioned by King João I in profound gratitude for divine intervention following the decisive Portuguese victory over Castilian forces at the Battle of Aljubarrota in 1385. The sheer scale and intricate detailing of the monastery required over two centuries of continuous construction by successive monarchs. The site is particularly famous for its spectacular 'Unfinished Chapels', an ornate octagonal structure that remains open to the sky." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Mănăstirea Batalha este o capodopera a stilului gotic portughez și manuelin. A fost construit pentru a comemora victoria portugheză asupra Castiliei în bătălia de la Aljubarrota.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The monastery houses the monumental tombs of King João I and his English queen, Philippa of Lancaster.","The Founder's Chapel features some of the oldest and most exquisite medieval stained glass in Portugal.","Prince Henry the Navigator, the great patron of Portuguese exploration, is buried in this monastery.","The massive, intricately carved entrance portal features over 70 distinct biblical statues."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Numele oficial este Mănăstirea Santa Maria da Vitória.", "Construcția a durat peste 150 de ani.", "„Capelele neterminate” sunt deosebit de renumite.", "Este un sit al Patrimoniului Mondial UNESCO.", "Aici se află mormântul lui Henric Navigatorul."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Guimarães is a profoundly historic city in northern Portugal, universally celebrated as the literal 'Cradle of the Nation'. It was here in the 12th century that the first King of Portugal, Afonso Henriques, was born, and where the pivotal Battle of São Mamede secured the nation's independence. The city's incredibly well-preserved medieval core features narrow, atmospheric streets, ancient plazas, and traditional granite houses with wrought-iron balconies. Dominated by its stark, 10th-century castle and the towering Palace of the Dukes of Braganza, Guimarães is a proud, living museum of Portuguese origins." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Orașul vechi istoric Guimarães este cunoscut sub numele de", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The city's ancient, defensive wall features the famous, bold inscription: 'Aqui Nasceu Portugal' (Here Portugal was born).", "The historic city center was collectively designated a UNESCO World Heritage site in 2001.", "The Palace of the Dukes of Braganza is instantly recognizable by its 39 towering, cylindrical brick chimneys.", "Guimarães served as a highly successful European Capital of Culture in 2012."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Pena Palace is an extraordinary, brilliantly colored 19th-century romanticist castle standing at the very peak of the Sintra Mountains. Commissioned by the visionary 'Artist King', Ferdinand II, the palace was built over the ruins of a severe 16th-century monastery, transforming it into a fantastical, eclectic summer residence for the Portuguese royal family. The palace's architecture is a deliberate, wildly imaginative mishmash of Neo-Gothic, Neo-Manueline, Neo-Islamic, and Neo-Renaissance styles. It is surrounded by a sprawling, 200-hectare forested park planted with exotic tree species imported from every corner of the globe." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Palatul Pena din Sintra este unul dintre cele mai bune exemple de romantism din secolul al XIX-lea. Cu culorile sale strălucitoare și locația pe vârful muntelui, arată ca ceva dintr-un basm.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The palace's vivid red and yellow facades were meticulously restored to their original brilliance in the late 1990s.", "On a clear day, the striking palace can be easily seen from the center of Lisbon, over 25 kilometers away.", "The interior rooms remain exactly as they were left by the royal family when they fled into exile in 1910.", "The massive Pena Park contains rare tree ferns from New Zealand and towering redwoods from North America."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Palatul a fost construit pe ruinele unei mănăstiri.", "A fost comandat de regele Ferdinand al II-lea.", "Culorile marchează diferite zone ale palatului.", "Este înconjurat de un parc vast.", "Palatul este una dintre cele șapte minuni ale Portugaliei."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Monastery of Alcobaça is a colossal, starkly beautiful Cistercian monastery founded in the 12th century by Portugal's first king, Afonso Henriques. It was established to populate and cultivate the lands newly conquered from the Moors. The immense, unadorned Gothic church—the largest in Portugal—perfectly reflects the ascetic ideals of the Cistercian order, emphasizing spiritual purity over elaborate decoration. However, the monastery is most deeply famous for housing the incredibly intricate, tragically romantic tombs of King Pedro I and his murdered lover, Inês de Castro, whose story is the ultimate Portuguese legend of star-crossed lovers." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The tragic royal lovers are buried foot-to-foot, supposedly so they will immediately see each other upon the resurrection.", "The monastery features an absolutely gigantic medieval kitchen completely lined with decorative ceramic tiles.", "A small branch of the Alcoa River was diverted directly through the kitchen to provide fresh water and fish.", "The site has been officially protected as a UNESCO World Heritage site since 1989."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Convent of Christ in Tomar is a sprawling, deeply atmospheric complex that served as the grand headquarters of the enigmatic Knights Templar in Portugal. Founded in 1160, the original Templar fortress evolved over centuries into a massive monastery under the Order of Christ, a uniquely Portuguese organization that financed the early maritime discoveries. The architecture spans five centuries, blending severe Romanesque, sweeping Gothic, intricate Manueline, and elegant Renaissance styles. Its defining architectural treasure is the ornate Chapter House window, heavily laden with stone-carved nautical ropes, coral, and esoteric Templar symbolism." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Castelul Templierului Tomar este strâns legat de Cavalerii Templieri și face parte din Patrimoniul Mondial UNESCO. Complexul a început să se dezvolte în jurul anului 1160 și a fost extins ulterior de Cavalerii lui Hristos.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The central 'Charola' (rotunda) is a 16-sided Templar church designed to mimic the Holy Sepulchre in Jerusalem.","Prince Henry the Navigator governed the Order of Christ from here and significantly expanded the complex.","The convent incorporates an incredible eight separate cloisters, built successively by different monarchs.","The massive, 6-kilometer-long Pegões Aqueduct was built in the 16th century to supply the convent with water."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["A fost o importantă cetate templieră din Portugalia.", "Cavalerii lui Hristos au preluat ulterior complexul.", "Mănăstirea lui Hristos este un sit al Patrimoniului Mondial UNESCO.", "Rotonda a fost inspirată de Biserica Sfântului Mormânt."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The National Palace of Pena in Sintra represents one of the premier expressions of 19th-century Romanticism in the world. This brightly painted, fairy-tale palace sits dramatically on a high, rocky peak, emerging from the dense mist of the Sintra hills. Built by King Consort Ferdinand II, it masterfully synthesizes diverse architectural influences, from medieval Gothic and Portuguese Manueline to North African Moorish. The lavish, perfectly preserved interiors offer an intimate look into the domestic life of the 19th-century Portuguese monarchy, while the sweeping exterior terraces provide some of the most staggering panoramic views in the country." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Palatul Pena din Sintra este un exemplu emblematic al arhitecturii romantice din secolul al XIX-lea. Fațadele sale colorate și decorul de pe deal îl fac unul dintre Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The extravagant design of the palace heavily inspired the architectural style of 'Neuschwanstein Castle' in Bavaria.","A massive, terrifying stone carving of a Triton guards the main arched gateway into the inner courtyard.","The palace includes an incredibly intricate, fully functioning chapel saved from the original 16th-century monastery.","The surrounding gardens were specifically designed with winding, labyrinthine paths to evoke a sense of mystical discovery."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Palatul face parte din Patrimoniul Mondial UNESCO.", "Este un exemplu de vârf al romantismului portughez.", "Culorile sale vii sunt renumite în întreaga lume.", "Se află sus deasupra orașului Sintra."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Livraria Lello in Porto is universally acclaimed as one of the most beautiful and historically significant bookstores in the world. Opened in 1906, this architectural gem features a stunning Neo-Gothic facade and a breathtaking, heavily carved wooden interior. The absolute centerpiece of the shop is its majestic, curving red staircase, illuminated by a large, brilliantly colored stained-glass skylight bearing the Latin motto 'Decus in Labore' (Dignity in Work). The magical, almost fantastical atmosphere of the bookstore draws thousands of literature enthusiasts daily and has cemented its status as a major cultural icon of Porto." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Livraria Lello din Porto este o librărie neogotică din 1906. Interiorul său bogat decorat o face una dintre Portugalia.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The elaborate, dark 'wood carvings' covering the walls and ceiling are actually painted plaster, not wood.","It is widely rumored that the bookstore heavily inspired J.K. Rowling's descriptions of Hogwarts in Harry Potter.","Due to massive tourist crowds, the bookstore instituted a small entrance fee, which is fully deductible from book purchases.","The store contains a hidden, secure vault housing first editions and extremely rare historical manuscripts."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Librăria a fost deschisă în 1906.", "Este cunoscut pentru scara sa spectaculoasă.", "Este adesea asociat cu Harry Potter.", "Este considerată una dintre cele mai frumoase librării din lume."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Capela dos Ossos (Chapel of Bones) in Évora is a profoundly striking and macabre 16th-century monument constructed by Franciscan monks. Motivated by a desire to remind the city's wealthy population of the fleeting nature of earthly life, the monks lined the entire interior of the chapel with human remains. The walls and eight supportive pillars are meticulously covered with the skulls and long bones of an estimated 5,000 individuals, exhumed from overflowing local graveyards. This stark 'memento mori' remains one of the most intense and unforgettable psychological experiences for visitors in Portugal." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Capela Oaselor din Évora este o capelă uimitoare de os ai cărei pereți sunt decorați cu rămășițe umane. A fost creat de franciscani ca o amintire a vieții", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The ominous inscription above the entrance reads: 'Nós ossos que aqui estamos, pelos vossos esperamos' (We bones that are here, await yours).","Two desiccated corpses, including one of a young child, hang suspended from the chapel's wall.","The vaulted ceiling is painted with intricate frescoes featuring death-themed allegories and biblical quotes.","Despite its morbid appearance, the chapel was intended purely as an area for deep spiritual meditation and reflection."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Capela este situată în interiorul Bisericii São Francisco.", "Pereții săi sunt decorați cu mii de oase.", "Există un avertisment puternic deasupra intrării.", "Este una dintre cele mai cunoscute obiective turistice din Évora."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Castle of Óbidos is a spectacularly preserved medieval fortress that completely dominates the picturesque, walled town of Óbidos in central Portugal. With foundations laid by the Romans and heavily modified by the Moors, the castle received its current form in the 12th century following the Christian Reconquista. Historically, the entire town and castle were traditionally given as a wedding gift by the Kings of Portugal to their Queens, an affluent tradition that lasted for centuries. The castle's towering keep and the perfectly intact, walkable perimeter walls offer sweeping views over the surrounding vineyards and cherry orchards." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The castle was severely damaged by the catastrophic 1755 earthquake but was meticulously restored in the 20th century.", "Today, the castle houses a luxurious 'Pousada' (historic hotel), allowing guests to sleep within its medieval walls.", "Every July, the castle grounds host a massive, highly immersive medieval market featuring jousting and troubadours.", "The town is famous for 'Ginjinha de Óbidos', a traditional sour cherry liqueur often served in edible chocolate cups."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Castle of Marvão is a staggering, near-impregnable fortress perched over 800 meters high on a sheer quartzite crag in the Alentejo, overlooking the Spanish border. This incredibly strategic location meant the castle served as an essential, unyielding watchtower against Spanish invasions for centuries. Heavily reinforced by King Dinis in the 13th century, its massive, wind-battered granite walls completely enclose a tiny, immaculate whitewashed village. The absolute highlight of visiting Marvão is walking the dizzying ramparts, offering what are undeniably some of the most expansive and dramatic panoramic views on the Iberian Peninsula." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The fortress contains a massive, brilliantly engineered vaulted cistern capable of holding a six-month water supply.", "Portuguese Nobel Laureate José Saramago famously wrote that from Marvão, 'one can see the entire earth'.", "Its extreme elevation meant it was primarily used as an early warning lookout rather than engaging in direct combat.", "The incredibly narrow, winding access roads were deliberately designed to exhaust invading armies before reaching the gates."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Battlefield of Aljubarrota is the hallowed site of the most decisive military engagement in Portuguese history, fought on August 14, 1385. Here, a heavily outnumbered Portuguese army, bolstered by a small contingent of English longbowmen, decisively crushed the invading forces of the Kingdom of Castile. This monumental victory permanently secured Portugal's independence and firmly established the Avis Dynasty. The site now features the modern, highly immersive Interpretation Centre of the Battle of Aljubarrota (CIBA), which uses advanced multimedia to vividly recreate the brilliant defensive tactics employed by the Portuguese commander, Nuno Álvares Pereira." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Câmpul de luptă Aljubarrota marchează unul dintre cele mai decisive momente din istoria Portugaliei. Aici Portugalia și-a asigurat independența împotriva Castiliei în 1385. Memorialul combină memoria națională, peisajul și interpretarea istorică. Pentru Portugalia SEO, Aljubarrota este un cuvânt cheie puternic pentru bătălii, identitate și Evul Mediu.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Portuguese forces numbered roughly 6,500 men, facing a massive Castilian army of over 30,000.", "The brilliant use of hidden defensive trenches and caltrops (spikes) devastated the heavy Castilian cavalry.", "The nearby Batalha Monastery was explicitly built by King João I in gratitude for this miraculous victory.", "The battle firmly solidified the Anglo-Portuguese Alliance, which remains the oldest active diplomatic treaty in the world."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Roman Temple of Évora is a majestic and remarkably well-preserved ancient monument standing in the historic heart of Évora, Portugal. Constructed in the 1st century AD, this elegant Corinthian temple was likely dedicated to the Imperial Cult of Augustus, though it is widely, yet incorrectly, known as the Temple of Diana. The temple's incredible survival through two millennia is due to a bizarre historical twist: in the Middle Ages, its towering granite columns were incorporated into the walls of a fortress, and later, an abattoir. Uncovered and carefully restored in the 19th century, it is now an iconic UNESCO World Heritage site." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Fourteen of the temple's original exquisite granite columns remain standing, topped with elegantly carved marble capitals.", "The temple's solid platform (podium) is built entirely from massive blocks of rough-hewn, local granite.", "It survived the devastating 1755 earthquake, which leveled many other ancient monuments in southern Portugal.", "The temple was partially destroyed in the 5th century during violent invasions by Germanic tribes."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The National Palace of Mafra is a colossal, staggering monument to royal excess, ranking among the largest and most opulent Baroque buildings in Europe. Commissioned in the early 18th century by King João V, the massive complex was entirely financed by the staggering influx of gold and diamonds from the Portuguese colony of Brazil. The sprawling structure unifies a lavish royal palace, a monumental basilica, and a Franciscan monastery under one roof. Its construction required an army of 50,000 workers, deeply straining the national economy but resulting in an architectural masterpiece of unrivaled scale and symmetry." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Palatul Național Mafra este un complex monumental în stil baroc în apropiere de Lisabona. Palatul, bazilica și mănăstirea formează împreună unul dintre Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The palace contains an unbelievable 1,200 rooms, 4,700 doors and windows, and 156 grand staircases.","The basilica features a completely unique, fully integrated ensemble of six massive historical pipe organs.","Its magnificent Rococo library houses over 36,000 leather-bound volumes and is protected by a resident colony of bats.","The massive complex was famously immortalized in José Saramago's Nobel Prize-winning novel, 'Baltasar and Blimunda'."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Construcția a început în secolul al XVIII-lea.", "Complexul include un palat și o bazilică.", "Ansamblul face parte din Patrimoniul Mondial UNESCO.", "Biblioteca este deosebit de renumită.", "Mafra este unul dintre cele mai mari proiecte baroc din Portugalia."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Ruins of Conímbriga, located near Coimbra, constitute the largest, most comprehensively excavated, and best-preserved Roman settlement in Portugal. The city flourished during the reign of Emperor Augustus in the 1st century AD, transforming into a wealthy, highly developed provincial hub. Visitors can explore the intricate foundations of massive public baths, an ancient forum, and luxurious patrician villas. The absolute highlight of Conímbriga is its astonishingly well-preserved, vibrantly colored floor mosaics, which depict mythological scenes and complex geometric patterns with a level of detail rarely seen outside of Italy." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The 'House of the Fountains', a massive aristocratic villa, features an elaborate, fully functioning Roman water garden.", "A substantial defensive wall cuts directly through the city, hastily built to defend against 5th-century barbarian invasions.", "Despite extensive work, it is estimated that less than 20% of the ancient city has been fully excavated.", "The site features a highly advanced, underground Roman heating system (hypocaust) visible in the bathhouses."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Castle of Almourol is a deeply romantic, picturesque medieval fortress that rises dramatically from a tiny, rocky islet in the middle of the Tagus River. Rebuilt by the Knights Templar in 1171, it served as an utterly crucial stronghold defending the Christian reconquered territories from the Moorish forces to the south. With its soaring keep and ring of defensive towers surrounded by the flowing river, it is considered one of the finest examples of Templar military architecture in Europe. Accessible only by small boats, the castle retains an intensely magical, mythical atmosphere." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Castelul Almourol se află pe o insulă din râul Tajo și este una din Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The castle sits squarely on an ancient fault line, though it has never been significantly damaged by earthquakes.", "It features exactly nine circular defensive towers, a hallmark of Templar fortresses.", "Local folklore is rich with legends of Moorish princesses and forbidden love stories haunting the castle's towers.", "After the Reconquista, the castle lost its strategic value and was largely abandoned for centuries before being restored."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Castle of Silves is a massive, imposing fortress built from vibrant red sandstone, dominating the skyline of the historic city of Silves in the Algarve. During the period of Moorish rule from the 8th to the 13th centuries, Silves was an incredibly prosperous cultural and trading capital known as 'Xelb'. The castle is the largest and most brilliantly preserved monument of Islamic military architecture in Portugal. Visitors exploring its extensive battlements and lush interior courtyards are treated to sweeping views of the surrounding citrus groves and the Arade River, reflecting a profound era of Andalusian history." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The fortress contains a massive, 20-meter-deep vaulted cistern (Cisterna Grande) that secured the city's water supply during brutal sieges.", "The striking, blood-red color of the castle comes from the local 'grés de Silves' sandstone used in its construction.", "A towering bronze statue of King Sancho I, who briefly captured the castle in 1189, guards the main entrance.", "During the summer, the castle grounds serve as the atmospheric centerpiece for the city's massive Medieval Fair."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The MAAT (Museum of Art, Architecture and Technology) is a spectacular, ultra-modern cultural institution gracefully curving along the banks of the Tagus River in Lisbon. Designed by the acclaimed British architect Amanda Levete, the museum's sweeping, organic architecture is entirely clad in 15,000 crackle-glazed ceramic tiles that brilliantly reflect the famous Lisbon sunlight and the shimmering water. Opened in 2016, the museum hosts cutting-edge, multidisciplinary exhibitions exploring contemporary global issues. The building's sweeping, walkable roof seamlessly connects the city to the waterfront, providing locals and tourists with an unparalleled, panoramic sunset viewpoint." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "MAAT este unul din Lisabona", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The futuristic new building is physically connected to the historic, brilliantly restored Tejo Power Station.","Visitors can walk seamlessly over the swooping, arching roof without ever purchasing a ticket to the museum.","The 3D ceramic tiles were specifically designed to subtly change color depending on the angle of the sun and the tide.","The museum focuses heavily on highly immersive, large-scale contemporary art installations."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["MAAT se află pe malul râului.", "Combină muzeul și arhitectura.", "Acoperișul poate fi mers pe jos.", "Situl face parte din scena culturală modernă a Lisabonei.", "Locația este foarte prietenoasă pentru turiști."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Lisbon Oceanarium (Oceanário de Lisboa) is a world-class marine conservation center and one of the largest indoor aquariums in Europe. Serving as the spectacular centerpiece of the 1998 Lisbon World Exposition, the building was designed by American architect Peter Chermayeff to resemble an aircraft carrier seemingly floating on the Tagus estuary. The absolute core of the experience is a colossal, 5-million-liter central tank representing the Global Ocean, surrounded by four distinct, highly immersive habitats recreating the Atlantic, Pacific, Indian, and Antarctic marine environments. It is universally praised for its exceptional design and deep commitment to environmental education." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Oceanariul de la Lisabona este unul din Europa", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The massive central tank features a staggering diversity of marine life, including sharks, majestic rays, and schooling fish.", "It is one of the very few aquariums globally that successfully houses the massive, notoriously difficult-to-keep Ocean Sunfish.", "The beloved, incredibly playful sea otters are part of a critical global conservation and rescue program.", "The Oceanarium actively funds and conducts numerous vital marine conservation projects across the globe."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Monument to the Discoveries (Padrão dos Descobrimentos) is a monumental, highly evocative structure dominating the waterfront in the Belém district of Lisbon. Shaped like the stylized prow of an immense caravel pointing boldly out toward the Atlantic Ocean, the monument celebrates the Portuguese Age of Discovery. It was erected in 1960 to mark the 500th anniversary of the death of Prince Henry the Navigator, who stands prominently at the very front of the sculpture. Flanking him are 32 massive statues representing the most significant explorers, cartographers, monarchs, and missionaries who mapped the unknown world." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The monument stands an imposing 52 meters tall, and visitors can take an elevator to the roof for spectacular panoramic views.", "Prominent figures depicted include Vasco da Gama, Ferdinand Magellan, and the poet Luís de Camões.", "The expansive plaza directly in front features a massive, 50-meter-wide marble compass rose mapping global Portuguese discoveries.", "The marble compass rose was an official gift from the government of South Africa in 1960."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Casa da Música is a radical, visually arresting concert hall that has become the definitive contemporary icon of Porto. Designed by the visionary Dutch architect Rem Koolhaas, the building was conceived when Porto served as the European Capital of Culture in 2001, though it officially opened in 2005. The building's asymmetrical, faceted concrete shape deliberately challenges traditional acoustic and architectural norms, resembling a massive, fallen meteorite. Inside, the spectacular main auditorium features walls of undulating, corrugated glass, flooding the concert space with natural daylight and visually connecting the music with the bustling city outside." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Casa da Musica este una din Porto", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The VIP room is a stunning visual contrast to the concrete exterior, completely lined with traditional, hand-painted blue Azulejos.","It is the first building in Portugal specifically and exclusively designed for musical performances.","The complex, multi-faceted concrete exterior was notoriously difficult to construct, requiring highly advanced engineering techniques.","The main hall's bizarrely shaped, corrugated glass walls were scientifically designed to guarantee perfect acoustic reflection."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Clădirea a fost proiectată pentru Porto 2001.", "Este un simbol al arhitecturii moderne.", "Fațada este foarte geometrică și distinctă.", "Aici au loc concerte internaționale.", "Se află în partea de vest a orașului Porto."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Bom Jesus do Monte is an extraordinarily dramatic religious sanctuary located on a wooded hillside overlooking the historic city of Braga. Recognized as a UNESCO World Heritage site, the sanctuary is globally famous for its monumental, zigzagging Baroque stairway that climbs 116 meters up the mountain. This breathtaking architectural ascent represents the spiritual journey of the believer, featuring over 500 steps adorned with allegorical statues, intricate fountains dedicated to the five senses, and small chapels depicting the Passion of Christ. At the summit, a serene neoclassical church offers sweeping, unforgettable panoramas across the entire region." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Bom Jesus do Monte este Braga", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The sanctuary is serviced by the oldest operational water-powered funicular in the world, built in 1882.","Devout pilgrims traditionally climb the entire, grueling 577-step staircase on their knees as an act of penance.","The complex includes expansive, romantic gardens featuring artificial grottos, serene lakes, and dense woodland trails.","The grand staircase is divided into three thematic sections: the Portico, the Five Senses, and the Three Theological Virtues."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Scara este cel mai cunoscut element.", "Sanctuarul se află deasupra Braga.", "Situl este o destinație de pelerinaj.", "Ansamblul face parte din Patrimoniul Mondial UNESCO.", "Priveliștea este o atracție majoră."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Dom Luís I Bridge is an absolute masterpiece of 19th-century industrial engineering and the most universally recognized symbol of Porto. Spanning the deep gorge of the Douro River, this colossal, double-deck iron arch bridge connects the historic Ribeira district of Porto to the port wine cellars of Vila Nova de Gaia. Designed by Théophile Seyrig, a disciple of Gustave Eiffel, the bridge was completed in 1886. Today, it remains a vital, heavily utilized transit artery; the upper deck carries the modern metro and pedestrians, while the lower deck serves car traffic and local foot passengers." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Podul Dom Luis I este Porto", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Upon its completion in 1886, its massive 172-meter central arch was officially the longest of its kind in the world.","Walking the high upper deck provides arguably the most spectacular, highly photographed panoramic view of Porto's historic skyline.","The bridge is a crucial, fully integrated component of Porto's UNESCO World Heritage designation.","Local daredevil teenagers famously dive from the lower deck into the Douro River during the hot summer months."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Podul a fost deschis în secolul al XIX-lea.", "Leagă Porto de Gaia.", "Puntea superioară oferă vederi puternice.", "Este un simbol al malului Douro.", "Cadrul său metalic este iconic din punct de vedere arhitectural."], "en": [] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Biblioteca Joanina găzduiește o colonie de lilieci care protejează cărțile antice mâncând insecte noaptea.", "Pelerina tradițională pentru studenți a universității l-a inspirat pe J.K. Uniformele Hogwarts ale lui Rowling.", "Turnul cu ceas emblematic este poreclit cu afecțiune „A Cabra” (Capra) de către studenți.", "A început inițial la Lisabona, înainte de a se muta definitiv la Coimbra."], en: ["The Joanina Library houses a colony of bats that protect the ancient books by eating insects at night.","The university's traditional student capes inspired J.K. Rowling's Hogwarts uniforms.","The iconic clock tower is affectionately nicknamed 'A Cabra' (The Goat) by students.","It originally started in Lisbon before moving permanently to Coimbra."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Gara São Bento din Porto este renumită la nivel mondial pentru interiorul său uimitor, împodobit în întregime cu plăci azulejo albastre și albe complicate. Construită la începutul secolului al XX-lea pe locul unei foste mănăstiri benedictine, gara", en: "São Bento Station is widely celebrated as one of the most beautiful and culturally significant railway stations in the world, located in the historic heart of Porto. Built in the early 20th century on the exact site of a former Benedictine convent, its French Beaux-Arts exterior hides a truly jaw-dropping entrance hall. The walls are completely covered with over 20,000 traditional, hand-painted blue and white azulejo tiles. Created over a decade by artist Jorge Colaço, these magnificent murals vividly depict crucial, defining moments in Portuguese history and highly romanticized scenes of traditional rural life in the northern provinces." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The massive tile murals depict famous historic events, such as the crucial Battle of Valdevez and the Conquest of Ceuta.", "Despite its museum-like atmosphere, São Bento remains a heavily trafficked, fully operational commuter railway station.", "The station serves as the primary, highly scenic starting point for train journeys winding deep into the Douro Valley.", "The intricate tile work also subtly chronicles the history of transport in Portugal, from rural ox carts to the railway itself."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Acesta gestionează mai mult de jumătate din traficul total de mărfuri maritime al Portugaliei.", "Sines este cea mai importantă poartă europeană pentru gazele naturale lichide din America.", "Apele portului ating o adâncime naturală de până la 28 de metri.", "Orașul Sines din apropiere găzduiește un festival anual celebru de muzică mondială."], en: ["It handles more than half of Portugal's total maritime cargo traffic.","Sines is the most important European gateway for liquid natural gas from the Americas.","The port's waters reach a natural depth of up to 28 meters.","The nearby city of Sines hosts a famous annual world music festival."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Terminalul modern de croazieră seamănă cu o panglică încolăcită și a câștigat mai multe premii de arhitectură.", "Este al doilea cel mai aglomerat port maritim din Portugalia, după Sines.", "Construcția portului a necesitat diguri masive de granit care se extind până departe în Atlantic.", "Acesta sprijină în mod direct comunitatea vibrantă de pescuit și restaurantele faimoase cu fructe de mare din Matosinhos."], en: ["The modern cruise terminal resembles a coiled ribbon and has won several architectural awards.","It is the second busiest seaport in Portugal after Sines.","The port's construction required massive granite breakwaters extending far into the Atlantic.","It directly supports the vibrant fishing community and famous seafood eateries of Matosinhos."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Este unul dintre cele mai importante porturi din Portugalia pentru transportul vehiculelor „Ro-Ro” (Roll-on/Roll-off).", "Estuarul Sado găzduiește un celebru grup rezident de delfini cu bot.", "Zona portuară a fost din punct de vedere istoric central pentru industria masivă a conservelor de sardine din Portugalia.", "Portul său natural este adăpostit în mod natural de furtunile atlantice de Peninsula Tróia."], en: ["It is one of Portugal's leading ports for 'Ro-Ro' (Roll-on/Roll-off) vehicle transport.", "The Sado estuary is home to a famous resident pod of bottlenose dolphins.", "The port area was historically central to Portugal's massive sardine canning industry.", "Its natural harbor is naturally sheltered from Atlantic storms by the Tróia Peninsula."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Podgoriile Douro sunt semnul distinctiv vizual al lumii", en: "The Douro Vineyards form a monumental, awe-inspiring cultural landscape in northern Portugal, recognized globally as the oldest legally demarcated wine region on Earth. The region is visually defined by its impossibly steep, schist-covered hillsides that have been painstakingly carved into thousands of stepped terraces over two millennia. This harsh, breathtaking environment, featuring blistering summers and freezing winters, forces the vine roots deep into the rocky soil, producing the incredibly concentrated, flavorful grapes required for world-class Port wine. The dramatic, winding Douro River acts as the vital, reflective lifeline running through this spectacular UNESCO World Heritage site." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Douro Valley was officially demarcated by the powerful Marquis of Pombal in 1756 to strictly control the quality of Port wine.", "The traditional, mortarless stone walls supporting the terraces are known locally as 'socalcos'.", "Due to the extreme, unforgiving incline of the slopes, almost all grape harvesting must still be done entirely by hand.", "Historically, the dangerous, flat-bottomed 'rabelo' boats were the only way to transport the heavy wine barrels downriver to Porto."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Coruche Cork Oaks represent the sprawling, semi-wild agricultural landscape of the Ribatejo province, known globally as the 'Cork Capital of the World'. These vast forests, locally called 'montados', consist of ancient, resilient cork oak trees (Quercus suber) that provide the absolute foundation for Portugal's thriving cork industry. The trees are never cut down; instead, their thick, protective bark is painstakingly harvested by skilled artisans every nine years in a highly sustainable cycle. The montado ecosystem is a vital, biodiverse sanctuary, supporting endangered species while preventing desertification of the dry Iberian plains."montados', which are ancient, semi-wild agricultural landscapes dominated by cork oak trees. Portugal is the global leader in cork production, a deeply sustainable industry because the trees are never cut down; instead, their bark is carefully peeled off by skilled artisans every nine years. The montado ecosystem is a model of sustainable farming that provides a crucial habitat for endangered species, including the Iberian lynx and the Imperial eagle." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Portugal is the world's largest producer of cork, supplying over half of global demand.", "A single cork oak tree can easily live for over 200 years and be harvested up to 15 times.", "The white number painted on the trunk of a harvested tree indicates the exact year its bark was last removed.", "Cork is a 100% natural, fully biodegradable, and renewable industrial material."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Autoeuropa este una dintre cele mai mari investiții străine directe din istoria Portugaliei.", "Fabrica reprezintă singură peste 1% din întregul Produs Intern Brut (PIB) al Portugaliei.", "Are o linie feroviară dedicată care face legătura direct cu portul Setúbal pentru exportul de vehicule.", "Fabrica este adesea pionieri a practicilor avansate de producție durabilă în cadrul grupului VW."], en: ["Autoeuropa is one of the largest single foreign direct investments in Portuguese history.","The factory single-handedly represents over 1% of Portugal's entire Gross Domestic Product (GDP).","It has a dedicated railway line connecting directly to the Port of Setúbal for exporting vehicles.","The plant frequently pioneers advanced sustainable manufacturing practices within the VW group."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Biserica circulară „Charola” le-a permis cavalerilor templieri să participe la liturghie, rămânând călare.", "Prințul Henric Navigatorul a slujit ca Mare Maestru al Ordinului lui Hristos și a trăit în mănăstire.", "Fereastra emblematică manuelină este considerată capodopera supremă a artei gotice târzii portugheze.", "Complexul include un impresionant apeduct renascentist care are peste 6 kilometri lungime."], en: ["The circular 'Charola' church allowed Templar knights to attend mass while remaining on horseback.","Prince Henry the Navigator served as the Grand Master of the Order of Christ and lived in the convent.","The iconic Manueline window is considered the ultimate masterpiece of Portuguese late Gothic art.","The complex includes an impressive Renaissance aqueduct that is over 6 kilometers long."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Fortress of Peniche is a massive, star-shaped coastal citadel built in the 16th century to vigorously defend Portugal's western coastline against frequent, devastating pirate attacks. Situated strategically on a rugged peninsula Jutting into the Atlantic, the fort is a robust example of early modern military architecture. During the 20th century, the fortress gained a dark, notorious reputation as a high-security political prison under the authoritarian Estado Novo regime. The dramatic 1960 escape of prominent political prisoners from its formidable walls remains a legendary event in Portuguese history. Today, the fortress serves as a powerful museum dedicated to resistance and freedom." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The fortress was originally built on an island, which eventually connected to the mainland via massive sand accumulation.", "During the dictatorship, it was widely considered Portugal's most inescapable and brutal political prison.", "The daring 1960 escape involved climbing down the sheer, sea-facing outer walls using knotted ropes.", "The museum also showcases the region's long, intricate tradition of making delicate bobbin lace (renda de bilros)."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Muzeul Național al Placilor (Museu Nacional do Azulejo) din Lisabona este dedicat artei unice portugheze a plăcilor ceramice decorative sau azulejos. Găzduit în măreasa Mănăstire Madre de Deus din secolul al XVI-lea, muzeul prezintă o colecție uimitoare, de la modele geometrice maure timpurii până la piese contemporane vibrante. Expozițiile prezintă evoluția tehnicilor de fabricare a plăcilor și semnificația lor culturală profundă în arhitectura portugheză. Bijuteria coroanei colecției este o piesă murală panoramică imensă, lungă de 23 de metri, care înfățișează întregul peisaj urban al Lisabonei așa cum arăta chiar înainte de cutremurul devastator din 1755.", en: "The National Tile Museum (Museu Nacional do Azulejo) in Lisbon is dedicated to the uniquely Portuguese art of decorative ceramic tiles, or azulejos. Housed in the grand, 16th-century Convent of Madre de Deus, the museum displays an astonishing collection ranging from early Moorish geometric designs to vibrant contemporary pieces. The exhibits chronicle the evolution of tile-making techniques and their profound cultural significance in Portuguese architecture. The crown jewel of the collection is an immense, 23-meter-long panoramic tile mural depicting the entire cityscape of Lisbon as it looked just before the devastating 1755 earthquake." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Cuvântul „azulejo” provine din arabă „al-zillij”, care înseamnă „piatră lustruită”.", "Clădirea muzeului are o capelă baroc aurit spectaculos, acoperită cu plăci istorice.", "Marea panoramă a Lisabonei conține peste 1.300 de plăci individuale pictate manual.", "Azulejos portugheze sunt complet unice, deoarece sunt utilizate pe scară largă la exteriorul clădirilor, nu doar la interior."], en: ["The word 'azulejo' comes from the Arabic 'al-zillij', meaning 'polished stone'.","The museum's building features a spectacularly gilded baroque chapel covered in historic tiles.","The grand panorama of Lisbon contains over 1,300 individual hand-painted tiles.","Portuguese azulejos are completely unique as they are used extensively on the exteriors of buildings, not just interiors."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "São Jorge Castle is a majestic, heavily fortified Moorish stronghold crowning the absolute highest hill in Lisbon's historic center. With origins tracing back to ancient Roman and Visigoth times, the castle was massively reinforced by the Moors before being conquered by Portugal's first king, Afonso Henriques, in 1147 during the Second Crusade. For centuries, it served as the lavish royal palace and the ultimate seat of power in the Portuguese kingdom. Though partially ruined by the catastrophic 1755 earthquake, extensive 20th-century restorations returned it to its former imposing glory. Today, its ancient pine-shaded courtyards and walkable ramparts offer the most spectacular panoramic views over the Tagus River and the sprawling capital."s historic center. With origins tracing back to Roman and Visigoth times, the castle was heavily fortified by the Moors before being conquered by Portugal's first king, Afonso Henriques, in 1147 during the Second Crusade. For centuries, it served as the royal palace and the ultimate seat of power in Portugal. Though partially ruined by the 1755 earthquake, extensive 20th-century restorations returned it to its former glory. Today, its ancient pine-shaded courtyards and walkable ramparts offer the most spectacular panoramic views over the Tagus River and the sprawling capital." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The legendary Portuguese knight Martim Moniz is said to have sacrificed himself by wedging his body in the castle doors to let his comrades enter.", "The castle grounds are famously home to a vibrant population of free-roaming peacocks.", "Vasco da Gama was grandly celebrated within these walls by King Manuel I after his historic return from India in 1499.", "The castle's camera obscura provides a highly unique, 360-degree optical projection of Lisbon in real-time."] },
...
export const portugalNature: POI[] = [
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Regiunea a fost delimitată oficial pentru producția de vin în 1756 pentru a proteja calitatea vinului de Porto.", "Terenul abrupt înseamnă că aproape toată recoltarea strugurilor se face încă în întregime manual.", "În 2001, regiunea viticolă Alto Douro a fost desemnată în patrimoniul mondial UNESCO.", "Calea ferată pitorească Linha do Douro circulă strâns de-a lungul râului, oferind una dintre cele mai pitorești curse cu trenul din Europa."], en: ["The region was officially demarcated for wine production in 1756 to protect the quality of Port wine.","The steep terrain means that almost all grape harvesting is still done entirely by hand.","In 2001, the Alto Douro Wine Region was designated a UNESCO World Heritage site.","The scenic Linha do Douro railway runs tightly along the river, offering one of Europe's most picturesque train rides."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Regiunea Douro este o minune geografică extraordinară în nordul Portugaliei, îmbinând frumusețea naturală accidentată cu practicile agricole străvechi. Zona este dominată de maiestuosul râu Douro, care curge spre vest de la granița cu Spania până la Oceanul Atlantic la Porto. Peisajul este un mediu aspru, dar uimitor, de dealuri abrupte de șist și aflorințe stâncoase, care au fost sculptate cu migăre în podgorii terasate de-a lungul secolelor. Acest terroir unic, cu variațiile sale extreme de temperatură, oferă condițiile perfecte de creștere pentru soiurile de struguri indigene folosite pentru a produce vinuri fortificate și de masă de clasă mondială.", en: "The Douro region is an extraordinary geographical marvel in northern Portugal, blending rugged natural beauty with ancient agricultural practices. The area is dominated by the majestic Douro River, which flows westward from the Spanish border down to the Atlantic Ocean at Porto. The landscape is a harsh yet stunning environment of steep schist hillsides and rocky outcrops, which have been painstakingly sculpted into terraced vineyards over centuries. This unique terroir, with its extreme variations in temperature, provides the perfect growing conditions for the indigenous grape varieties used to produce world-class fortified and table wines." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Numele „Douro” este adesea spus că înseamnă „râu de aur” datorită culorii aurii a râului în lumina soarelui.", "Râul a fost foarte periculos de navigat până când au fost construite o serie de ecluze și baraje în secolul al XX-lea.", "Verile în Douro pot atinge 40°C (104°F), în timp ce iernile pot scădea sub îngheț.", "Regiunea găzduiește peste 100 de soiuri de struguri indigene care prosperă în solul de șist."], en: ["The name 'Douro' is often said to mean 'River of Gold' due to the golden color of the river in the sunlight.", "The river was highly dangerous to navigate until a series of locks and dams were built in the 20th century.", "Summers in the Douro can reach 40°C (104°F), while winters can drop below freezing.", "The region is home to over 100 indigenous grape varieties that thrive in the schist soil."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Serra da Estrela este cel mai înalt lanț muntos din Portugalia continentală și o rezervație naturală de o importanță ecologică imensă. Ajungând la o altitudine de 1.993 de metri la vârful Torre, este singurul loc din țară unde schiul și sporturile de iarnă sunt posibile. Peisajul accidentat, sculptat de ghețari, este definit de văi adânci, lacuri alpine cristaline și formațiuni masive de bolovani de granit. Munții sunt adânc înrădăcinați în tradițiile pastorale, în special în creșterea câinelui de munte Estrela mare și producția din regiune.", en: "Serra da Estrela is the highest mountain range in mainland Portugal and a nature reserve of immense ecological importance. Reaching an elevation of 1,993 meters at its Torre peak, it is the only place in the country where skiing and winter sports are possible. The rugged, glacier-carved landscape is defined by deep valleys, crystal-clear alpine lakes, and massive granite boulder formations. The mountains are deeply rooted in pastoral traditions, most notably the breeding of the large Estrela Mountain Dog and the production of the region's famous creamy, artisanal sheep's cheese." },
    facts: {
    ...
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Cel mai înalt punct este Torre, la 1.993 de metri.", "Regiunea este renumită pentru brânza de oaie (Queijo Serra da Estrela).", "Are propria sa rasă de câini (Cão da Serra da Estrela).", "Lanțul muntos face parte dintr-un geoparc.", "Există numeroase văi glaciare de descoperit."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Ria Formosa Natural Park is a vast and incredibly dynamic estuarine labyrinth of saltwater lagoons, shifting sandbanks, and barrier islands protecting the eastern Algarve coast. Spanning an impressive 60 kilometers, this delicate, ever-changing ecosystem is widely considered one of Portugal's seven natural wonders. It serves as a critically important wintering ground and migratory stopover for tens of thousands of aquatic birds traveling between Europe and Africa. The shallow, sun-drenched waters also heavily support highly traditional economic activities, including artisan sea salt harvesting and the highly productive cultivation of world-class clams and oysters." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The park is famously home to a massive population of flamingos that can frequently be seen wading in the shallow salt pans.", "It hosts the absolute highest global concentration of the endangered seahorse species 'Hippocampus guttulatus'.", "The park's pristine barrier islands are completely devoid of cars and can only be reached by small passenger ferries.", "The highly prized 'Portuguese Water Dog' breed originally originated from the fishermen working in this exact lagoon."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Deschiderea tavanului peșterii a fost formată prin prăbușirea unei secțiuni slabe a stâncii de calcar.", "Înotul până la peșteră este puternic descurajat din cauza curenților oceanici puternici și imprevizibili.", "Interiorul peșterii are o acustică excelentă, mărind sunetul valurilor care se prăbușesc.", "Pereții de calcar auriu ai peșterii prezintă straturi de strat vizibile care cartografiază milioane de ani de istorie geologică."], en: ["The cave's ceiling opening was formed by the collapse of a weak section of the limestone cliff.","Swimming to the cave is strongly discouraged due to strong, unpredictable ocean currents.","The interior of the cave has excellent acoustics, magnifying the sound of the crashing waves.","The golden limestone walls of the cave display visible strata layers mapping millions of years of geological history."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Parcul Natural Sintra-Cascais este o zonă protejată incredibil de diversă, care se întinde de la munții luxurianți, de poveste din Sintra, până la coasta accidentată a Atlanticului. Parcul", en: "The Sintra-Cascais Natural Park is an incredibly diverse, protected natural area that sweeps from the lush, mist-shrouded, fairy-tale mountains of Sintra directly down to the rugged Atlantic coastline. The park's dramatic, contrasting landscape includes dense, mystical forests, steep coastal cliffs, and sweeping, wind-battered sand dunes. A major geographical highlight of the park is Cabo da Roca, officially the westernmost point of continental Europe, where sheer rock cliffs plunge vertically into the churning ocean. The park's unique microclimate fosters a remarkable array of endemic flora and provides a critical haven for diverse wildlife, while its massive crashing waves attract professional surfers to beaches like the famous Praia do Guincho." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Cabo da Roca was famously described by the epic Portuguese poet Luís de Camões as the place 'where the land ends and the sea begins'.", "The park is home to an extremely rare species of wild orchid (Epipactis tremolsii) found almost nowhere else in the world.", "The predictably high winds at Praia do Guincho make it one of Europe's absolute premier destinations for windsurfing and kitesurfing.", "The park's mystical mountains are heavily filled with ancient, moss-covered granite boulders and hidden romantic hermitages."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Parcul conține Geira, un drum roman cu cea mai mare concentrație de repere antice din lume.", "Este ultimul refugiu din Portugalia pentru lupul iberic pe cale de dispariție.", "Depozitele tradiționale de cereale de granit pe piloni, numite „espigueiros”, sunt emblematice pentru regiune.", "În unele zone, caii sălbatici Garrano se plimbă complet liberi pe terenul muntos."], en: ["The park contains the Geira, a Roman road featuring the highest concentration of ancient milestones in the world.","It is the last refuge in Portugal for the endangered Iberian wolf.","The traditional granite grain stores on stilts, called 'espigueiros', are iconic to the region.","In some areas, wild Garrano horses roam completely free across the mountainous terrain."] },
  ...
  
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Serra da Estrela Natural Park vigorously protects the highest mountain range in continental Portugal, presenting a stunning landscape of raw, stark granite beauty and sweeping alpine meadows. During the cold winter months, the peaks are often heavily blanketed in snow, transforming the entire region into the country's sole, highly popular winter sports destination. The park is a profound geological wonder, deeply and permanently scarred by ancient, massive glaciers that violently carved out the magnificent Zêzere Valley. Beyond its immense natural splendor, the park fiercely preserves a rich pastoral culture; the steep, rocky hillsides are still actively grazed by massive flocks of sheep guarded by the indigenous, intensely loyal Estrela Mountain Dog."s sole winter sports destination. The park is a geological wonder, deeply scarred by ancient glaciers that carved out the magnificent Zêzere Valley. Beyond its natural splendor, the park preserves a rich pastoral culture; the steep hillsides are still grazed by flocks of sheep guarded by the indigenous, fiercely loyal Estrela Mountain Dog." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The region's unique, freezing microclimate allows for the highly traditional curing of the renowned, gooey Serra da Estrela cheese.", "It is home to the absolute highest town in Portugal, Guarda, which sits formidably at over 1,000 meters altitude.", "The massive, U-shaped glacial valley of Zêzere is one of the largest of its kind in Europe, stretching for 13 kilometers.", "The massive Estrela Mountain Dog is officially one of the oldest recorded dog breeds in the entire Iberian Peninsula."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Ultima erupție majoră a Muntelui Pico a avut loc relativ recent în 1720.", "Deoarece se ridică direct din oceanul adânc, înălțimea sa totală de la bază la vârf îl face un munte subacvatic masiv.", "Aburul poate fi încă văzut scăpând din fumarole lângă vârful absolut.", "Alpiniștii trebuie să se înregistreze înainte de a urca, iar drumeția implică navigarea pe storuri vulcanice."], en: ["The last major eruption of Mount Pico occurred relatively recently in 1720.","Because it rises straight out of the deep ocean, its total base-to-peak height makes it a massive underwater mountain.","Steam can still be seen escaping from fumaroles near the absolute summit.","Climbers must register before ascending, and the hike involves navigating loose volcanic scree."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Lagoa das Sete Cidades is an incredibly iconic, massive twin-lake crater located in the dormant caldera of the Sete Cidades massif on the Azorean island of São Miguel. It is internationally famous for its striking visual anomaly: one half of the lake reflects a vivid, vibrant emerald green, while the other appears deep sapphire blue. According to enduring local legend, the beautiful lakes were formed directly from the tears of a green-eyed princess and a blue-eyed shepherd who shared a tragic, forbidden love. The immense volcanic crater, spanning over five kilometers in diameter, is completely surrounded by incredibly steep walls covered in lush, subtropical vegetation and blooming hydrangeas." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The two distinct lakes are technically a single, massive body of water, separated only by a narrow, man-made land bridge.", "The striking color difference is an optical illusion caused by varying water depths, mineral content, and algae reflection.", "Sete Cidades directly translates to 'Seven Cities', an intriguing reference to the mythical, lost islands of the Atlantic.", "The spectacular viewpoint at Vista do Rei offers the most famous and highly photographed breathtaking panorama of the lakes."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Lagoa do Fogo, meaning 'Lake of Fire', is a breathtaking, utterly pristine crater lake situated high in the central volcanic mountains of São Miguel Island in the Azores. Occupying the massive caldera of the dormant Água de Pau massif, it is the absolute highest lake on the island. The lake's crystalline, azure waters are completely surrounded by incredibly steep, wild slopes cloaked in dense, endemic vegetation, keeping it completely free from any human development. Often heavily shrouded in a mystical, shifting fog, the landscape reveals itself in dramatic, sudden bursts of absolute clarity. The lake's raw volcanic environment makes it one of the most beautiful and aggressively protected nature reserves in Portugal."Lake of Fire', is a pristine and remote crater lake situated in the central mountains of São Miguel in the Azores. Positioned within the caldera of the Água de Pau massif, it is the highest lake on the island. The lake is entirely surrounded by steep, wild slopes cloaked in dense endemic vegetation, keeping it completely free from human development. Often shrouded in a mystical, shifting fog, the landscape reveals itself in dramatic bursts of clarity. The lake's crystalline blue waters and raw volcanic environment make it one of the most beautiful and unspoiled nature reserves in Portugal." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The colossal volcanic eruption that formed the current, massive caldera occurred relatively recently, in 1563.", "Lagoa do Fogo is a strictly protected nature reserve, meaning motorized boats and swimming are generally totally forbidden.", "The massive lake sits at a lofty altitude of almost 600 meters above sea level.", "Hundreds of wild seagulls use the isolated, pumice-covered sandy shores of the lake as a major, undisturbed nesting ground."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Râul Douro are aproximativ 897 de kilometri lungime, ceea ce îl face unul dintre cele mai lungi din Peninsula Iberică.", "Barajul Carrapatelo de pe Douro are una dintre cele mai înalte ecluze de navigație din Europa, cu o cădere de 35 de metri.", "Înainte de construirea barajelor, bărcile „rabel” cu fund plat erau singurele vase capabile să navigheze pe rapid.", "Microclimatul râului captează căldura în vale, creând condiții perfecte pentru strugurii dulci."], en: ["The Douro River is approximately 897 kilometers long, making it one of the longest in the Iberian Peninsula.","The Carrapatelo Dam on the Douro features one of the highest navigation locks in Europe, with a 35-meter drop.","Before the dams were built, flat-bottomed 'rabelo' boats were the only vessels capable of navigating the rapids.","The river's microclimate traps heat in the valley, creating perfect conditions for sweet grapes."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Uriașul estuar al Tajului este atât de larg în apropiere de Lisabona încât este denumit local „Marea de paie”.", "Râul este străbătut de Podul Vasco da Gama, care la 12 kilometri este unul dintre cele mai lungi din Europa.", "Rezervația Naturală Estuarul Tagului este o escală critică pentru peste 120.000 de păsări de apă migratoare.", "Bogăția istorică a Lisabonei a fost construită în întregime pe accesul la apă adâncă oferită de Tajo."], en: ["The massive Tagus estuary is so wide near Lisbon that it is locally referred to as the 'Straw Sea'.","The river is spanned by the Vasco da Gama Bridge, which at 12 kilometers is one of the longest in Europe.","The Tagus Estuary Nature Reserve is a critical stopover for over 120,000 migratory waterfowl.","Lisbon's historic wealth was built entirely on the deep-water access provided by the Tagus."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Arhipelagul Berlengas este un grup accidentat și curat de insule minuscule de granit situate la aproximativ 10 kilometri de coasta Peniche. Insula principală, Berlenga Grande, este un mediu aspru, dar uimitor de stânci roz, peșteri de adâncime și ape limpezi. Datorită naturii sale izolate și nealterate, arhipelagul este o Rezervație a Biosferei UNESCO extrem de protejată, plină de păsări marine și viață marină diversă. Prezența umană este strict limitată la un număr mic de vizitatori zilnici, un paznic al farului și spectaculosul Fort São João Baptista din secolul al XVII-lea, care se așează dramatic pe o insuliță stâncoasă conectată printr-un pod îngust de piatră.", en: "The Berlengas Archipelago is a rugged, pristine group of tiny granite islands located about 10 kilometers off the coast of Peniche. The main island, Berlenga Grande, is a harsh but stunning environment of sheer pinkish cliffs, deep sea caves, and crystal-clear waters. Due to its isolated and unspoiled nature, the archipelago is a highly protected UNESCO Biosphere Reserve, teeming with seabirds and diverse marine life. Human presence is strictly limited to a small number of daily visitors, a lighthouse keeper, and the spectacular 17th-century Fort of São João Baptista, which sits dramatically on a rocky islet connected by a narrow stone bridge." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Insulele sunt un loc esențial de cuibărit pentru mii de pescăruși și rarul pufin Cory.", "Fortul dramatic din São João Baptista a respins cu succes un atac al unei flote spaniole masive în 1666.", "Nu există absolut niciun vehicul pe insulă, iar energia solară se bazează în mare măsură.", "Apele incredibil de limpezi îl fac unul dintre principalele locuri din Portugalia pentru scufundări și snorkeling."], en: ["The islands are a critical nesting ground for thousands of seagulls and the rare Cory's shearwater.","The dramatic Fort of São João Baptista successfully fended off an attack by a massive Spanish fleet in 1666.","There are absolutely no vehicles on the island, and solar energy is heavily relied upon.","The incredibly clear waters make it one of Portugal's premier spots for scuba diving and snorkeling."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Laurisilva of Madeira is an ancient, highly mystical evergreen forest that is widely recognized as the largest surviving laurel forest in the entire world. Covering the steep, mist-shrouded valleys of the island's mountainous interior, this UNESCO World Heritage site is an actual living botanical relic from the Tertiary period, having miraculously survived the last major Ice Age. The profoundly atmospheric environment is characterized by giant, moss-draped trees, violently cascading waterfalls, and an incredibly dense, lush canopy that filters the sunlight. This unique botanical sanctuary plays an absolutely crucial role in capturing moisture from the passing clouds to reliably supply the island's ingenious 'levada' irrigation network."s ingenious 'levada' irrigation network." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The massive forest is estimated to be over 15 million years old, serving as a true living fossil of ancient European ecosystems.", "It covers approximately 20% of the entire island of Madeira, mostly clinging precariously to the inaccessible northern slopes.", "The highly endangered Madeira long-toed pigeon is an endemic bird species found nowhere else on Earth.", "The network of 'levadas' (water channels) winding incredibly through the forest covers over 2,000 kilometers in total length."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Serra do Caramulo is a tranquil, undulating granite and schist mountain range prominently located in the central Dão-Lafões region of Portugal. Historically renowned for its exceptionally pure mountain air and crystal-clear, fast-flowing spring waters, the mountain was famously utilized in the mid-20th century as a premier health resort for tuberculosis patients. The idyllic landscape features rolling hills completely covered in dense pine and eucalyptus forests, terraced green valleys, and spectacular, dizzying viewpoints like the Caramulinho, which offers panoramas stretching all the way to the distant Atlantic coast. Today, the pristine environment deeply attracts hikers, while the quiet village of Caramulo surprisingly houses a world-class classic car and art museum." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The mountain air quality is so exceptionally high that the entire town of Caramulo was originally built as a sprawling sanatorium.", "The unexpected Caramulo Museum houses an absolutely priceless collection of vintage Bugattis, Ferraris, and original Picassos.", "The absolute highest peak, Caramulinho, reaches 1,075 meters and offers staggering views of the Serra da Estrela on clear days.", "The entire region is highly famous for producing exceptionally high-quality honey and traditional, dark, dense mountain bread."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "Serra de Montejunto este o creastă de munte calcaroasă uimitoare, situată la doar o oră nord de Lisabona. Adesea descris ca", en: "The Serra de Montejunto is a striking, highly visible limestone mountain ridge located just an hour's drive north of Lisbon. Often accurately described as the 'Balcony of Estremadura', its absolute highest peak provides sweeping, uninterrupted 360-degree views stretching endlessly from the crashing Atlantic coast all the way to the fertile Tagus Valley. The mountain features a severely rugged, karst landscape completely riddled with hidden, subterranean caves and deep, treacherous sinkholes. Historically, its extreme high elevation was utilized by the Dominican order, who built an isolated monastery and Portugal's very first ice factory here in the 18th century, harvesting winter snow to supply highly sought-after ice to the royal court in Lisbon." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The massive ruins of the Real Fábrica do Gelo (Royal Ice Factory) remain a highly unique monument to 18th-century industrial engineering.", "The heavily forested mountain is a critical, protected sanctuary for the rare Bonelli's eagle and several endangered bat species.", "Its fertile lower slopes are completely covered in sprawling vineyards that produce some of the finest wines of the Lisbon wine region.", "A series of ancient, beautifully preserved windmills dot the lower ridges, perfectly utilizing the incredibly strong Atlantic breezes."] },
  ...
  },
  {
    ...
    factsAdvanced: { de: [], hu: [], ro: ["Tocanita „Cozido” este gătită în vase metalice îngropate în pământul vulcanic timp de peste șase ore.", "Lacul este înconjurat de păduri luxuriante care conțin copaci importați din clime globale complet diferite.", "Capela izbitoare Nossa Senhora das Vitórias a fost construită de un localnic bogat în secolul al XIX-lea din durerea pentru soția sa bolnavă.", "În ciuda frumuseții sale, lacul suferă de eutrofizare, iar eforturile masive de mediu sunt în curs de restabilire a calității apei."], en: ["The 'Cozido' stew is cooked inside metal pots buried in the volcanic soil for over six hours.","The lake is surrounded by lush forests containing trees imported from completely different global climates.","The striking Chapel of Nossa Senhora das Vitórias was built by a wealthy local in the 19th century out of grief for his sick wife.","Despite its beauty, the lake suffers from eutrophication, and massive environmental efforts are underway to restore its water quality."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Lagoa de Albufeira is a stunning, deeply tranquil coastal lagoon located just south of Lisbon on the Setúbal Peninsula, completely separated from the fierce Atlantic Ocean by a massive, sweeping sandbar. The lagoon is technically divided into two main bodies of water—the deeper, darker 'Lagoa Grande' and the shallower 'Lagoa Pequena'—which are surrounded by dense, fragrant pine forests. The exceptionally calm, sheltered waters make it an absolute paradise for windsurfing, kitesurfing, and paddleboarding, contrasting wildly with the massive, crashing ocean waves just over the dunes. During the spring, an artificial channel is heavily dredged through the sand to violently flush and renew the lagoon's waters with the ocean tide." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Lagoa de Albufeira este o lagună de coastă la sud de Lisabona, cu apă calmă și zone naturale. Este popular pentru observarea păsărilor, sporturi de apă ușoare și zile relaxate pe plajă. Situl combină terenul protejat, petrecerea timpului liber și peisajul de coastă. Pentru SEO despre Setubal, lagune și ieșiri în natură, este foarte util.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The lagoon reaches surprising depths of up to 15 meters, making it exceptionally popular for local scuba diving training.","The surrounding dense pine forests were originally planted by order of King Dinis in the 14th century to halt massive sand dune erosion.","It is a highly critical, protected resting and nesting area for thousands of migratory birds traveling the Atlantic flyway.","The shallowest areas of the lagoon are a highly traditional site for the localized gathering of wild, edible mussels and clams."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Laguna se află la sud de Lisabona.", "Observarea păsărilor este populară aici.", "Apa este de obicei calmă.", "Natura și petrecerea timpului liber se întâlnesc aici.", "Locul este bun pentru excursii scurte."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Minho River (Rio Minho) is a powerful, historically profound waterway that forms the extreme northern natural border between Portugal and Spain. Originating deep in the Spanish mountains of Galicia, it flows powerfully westward for over 300 kilometers before emptying dramatically into the Atlantic Ocean near the picturesque town of Caminha. The river valley is a region of immense, lush natural beauty, deeply characterized by steep, incredibly green hills totally blanketed in terraced vineyards that produce the region's famous Vinho Verde wine. The river itself is highly celebrated for its rich, ancient fishing traditions, most notably the seasonal, highly prized catch of wild sea lamprey." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Râul Minho formează o mare parte din Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The river acts as a totally natural, undisputed international boundary between Portugal and Spain for approximately 75 kilometers.","It is historically famous for its highly unique, traditional 'pesqueiras'—ancient stone walls built directly into the river to trap migrating fish.","The intense, seasonal lamprey (lampreia) fishing season is a major, highly anticipated culinary event in the Minho region.","The river estuary provides an absolutely critical, protected wetland habitat for huge flocks of migratory birds."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Râul marchează granița de nord.", "Leagă Portugalia și Spania.", "Gura este foarte pitorească.", "Ecosistemul contează pentru regiune.", "Numele este strâns legat de nordul Portugaliei."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Mondego River is a highly significant and deeply romanticized waterway, officially holding the title of the longest river located entirely within the borders of Portugal. It originates high up in the freezing, glacial valleys of the Serra da Estrela mountains, cascading forcefully down through the heart of the country before widening into a massive, fertile estuary at the coastal city of Figueira da Foz. The river is most famously associated with the historic, academic city of Coimbra, where it flows gently past the ancient university and the tragic, legendary 'Estate of Tears' (Quinta das Lágrimas), completely intertwining its waters with centuries of Portuguese poetry, fado music, and royal history." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The river is frequently and affectionately referred to as the 'River of Poets' due to its massive presence in classic Portuguese literature.", "The highly fertile lower Mondego Valley is one of the absolute most important agricultural regions for rice cultivation in Europe.", "Massive, 20th-century flood control projects permanently altered the river's flow to protect the historic lower city of Coimbra.", "The sprawling estuary at Figueira da Foz is home to extensive, highly productive commercial salt evaporation ponds."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Ilha da Culatra is a pristine, idyllic barrier island situated squarely within the highly protected Ria Formosa Natural Park in the eastern Algarve. Completely devoid of cars and paved roads, the island relies entirely on sandy paths, wooden boardwalks, and a small fleet of fishing boats. The island boasts some of the most spectacularly expansive, uncrowded beaches in Portugal, with incredibly fine, white sand meeting the crystal-clear waters of the Atlantic Ocean. The island's small, deeply authentic year-round fishing community fiercely guards their traditional way of life, heavily centered around artisan sea salt harvesting, clam farming, and traditional lagoon fishing." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Ilha da Culatra este una dintre insulele calme ale Ria Formosa din Algarve. Este cunoscut pentru plaja, atmosfera satului de pescuit și turismul lent pe insulă. Insula este accesibilă doar cu barca, ceea ce o face deosebit de relaxată. Pentru SEO despre insule, Algarve și zone protejate, Culatra se potrivește foarte bine.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The island is completely free of any motorized vehicles; tractors and boats are the absolute only forms of heavy transport.","It is home to the towering, immensely powerful Farol do Cabo de Santa Maria, a massive lighthouse guiding ships since 1851.","The extremely shallow, sun-warmed lagoon waters surrounding the island are considered the absolute best in Portugal for clam cultivation.","The island can only be accessed via a highly scenic, 30-minute passenger ferry ride departing from the nearby cities of Faro or Olhão."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Insula se află în Ria Formosa.", "Vizitatorii ajung acolo doar cu barca.", "Are o senzație de sat pescaresc.", "Plaja și calmul sunt principalele sale puncte forte.", "Insula aparține Algarve."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Mata Nacional de Leiria (Leiria National Forest), also deeply revered as the Pinhal do Rei (The King's Pine Forest), is an immense, incredibly historic maritime pine forest sprawling across the central Portuguese coastline. It was originally planted by King Afonso III in the 13th century and massively expanded by King Dinis to aggressively halt the catastrophic inland movement of coastal sand dunes. For centuries, this massive forest provided the absolute critical supply of highly durable timber and vital pitch needed to construct the enormous fleets of caravels during the Portuguese Age of Discovery. Tragically, in 2017, catastrophic wildfires destroyed nearly 80% of the ancient forest, sparking a massive, ongoing national reforestation and ecological recovery effort." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Pădurea Națională Leiria este una din Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The immense forest originally covered a staggering 11,000 hectares before the devastating 2017 wildfires.", "Timber from this exact forest was used exclusively to construct the legendary ships commanded by explorers like Vasco da Gama.", "King Dinis, who massively expanded the forest, is still affectionately remembered in Portugal as the 'Farmer King'.", "The forest features an incredibly strict, perfectly geometric grid pattern of firebreaks dating back to its original medieval design."] },
...
export const portugalCities: POI[] = [
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Lisbon, frequently spelled Lisboa in Portuguese, is the radiant, historic capital of Portugal, famously spread across seven steep hills overlooking the grand estuary of the Tagus River. The city is a vibrant, intoxicating tapestry of ancient Moorish neighborhoods, elegant 18th-century Pombaline squares, and cutting-edge contemporary architecture. It is internationally beloved for its rattling yellow trams, melancholic Fado music echoing through the narrow, impossibly steep streets of Alfama, and its incredible, golden natural light. Following a devastating earthquake in 1755, the entire downtown city center (Baixa) was completely rebuilt under the Marquis of Pombal, serving as an early, brilliant marvel of earthquake-resistant urban planning." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Lisabona, capitala Portugaliei, este renumită pentru cartierele sale istorice precum Alfama și Baixa. Situat la vărsarea râului Tajo, orașul oferă un amestec unic de tradiție și modernitate.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The iconic yellow Tram 28 navigates some of the absolute steepest and narrowest streets of any major European capital.","The Vasco da Gama Bridge in Lisbon is over 12 kilometers long, making it undeniably one of the longest bridges in Europe.","The city's famous 'Pastéis de Nata' custard tarts were originally created by Catholic monks in the historic Belém district.","Lisbon is officially recognized as one of the absolutely oldest cities in the world, predating Rome by centuries."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Lisabona este unul dintre cele mai vechi orașe din Europa de Vest.", "Orașul este renumit pentru tramvaiele sale galbene.", "Districtul Alfama a supraviețuit marelui cutremur din 1755.", "Orașul este construit pe șapte dealuri.", "Lisabona este casa cântatului Fado."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Coimbra is the deeply historic, intensely romantic academic heart of Portugal, majestically situated on a steep hill overlooking the Mondego River. It served as the capital of the newly formed Portuguese nation during the 12th and 13th centuries before completely surrendering its political power to Lisbon. However, Coimbra retained its immense intellectual supremacy by hosting the University of Coimbra, one of the absolute oldest universities in continuous operation in the world. The city's atmosphere is totally defined by its massive student population, who roam the steep, cobbled medieval streets wearing highly distinctive, flowing black capes while singing the deeply mournful, unique Coimbra style of Fado music." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Coimbra a fost cândva capitala Portugaliei și găzduiește una dintre cele mai vechi universități din lume. Orașul de pe râul Mondego este bogat în istorie și tradiții academice.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The spectacular Joanina Library houses a colony of bats that protect the ancient, priceless books by eating insects at night.","The university's highly traditional student capes heavily inspired J.K. Rowling's design of the Hogwarts uniforms.","The incredibly tragic, legendary 14th-century love story of Pedro and Inês de Castro took place primarily in Coimbra.","The entire historic university campus, including its towering clock tower ('The Goat'), is a protected UNESCO World Heritage site."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Universitatea din Coimbra a fost fondată în 1290.", "Biblioteca Joanina este o superbă bibliotecă baroc.", "Orașul are propriul stil de Fado.", "Coimbra a fost capitala țării în Evul Mediu.", "Portugal dos Pequenitos este un faimos parc tematic."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Braga is Portugal's third-largest city and its absolute religious capital, often affectionately referred to as the 'Rome of Portugal' due to its overwhelming concentration of massive churches and immense ecclesiastical history. Founded over two millennia ago by the Romans as 'Bracara Augusta', it is one of the oldest Christian cities in the entire world. Despite its deeply ancient roots and overwhelming religious architecture, including the oldest surviving cathedral in the country, Braga boasts a highly vibrant, intensely youthful energy driven by a massive university population and a booming modern tech sector. The city is completely dominated by the spectacular, zigzagging baroque stairway of the Bom Jesus do Monte sanctuary." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Sé de Braga (Braga Cathedral) is so incredibly ancient that the Portuguese idiom 'older than the Sé of Braga' means extremely old.", "The Romans established Bracara Augusta in 20 BC, dedicating it entirely to the Emperor Augustus.", "Every year, Braga hosts the absolute largest and most spectacular Holy Week (Semana Santa) religious processions in Portugal.", "The spectacular Bom Jesus do Monte sanctuary features the absolute oldest functioning water-powered funicular in the world."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Faro is the bustling, highly historic capital city of the Algarve region, often completely overlooked by tourists rushing directly to the nearby resort beaches. However, those who explore Faro are rewarded with a deeply authentic, meticulously preserved Portuguese city. Its incredibly charming historic center (Cidade Velha) is completely encircled by ancient Roman and Moorish walls, hiding peaceful cobbled squares, orange trees, and a massive 13th-century cathedral built over a ruined mosque. Beyond its rich history, Faro serves as the primary gateway to the spectacular Ria Formosa Natural Park, a massive coastal lagoon system teeming with diverse wildlife and pristine, completely untouched barrier islands." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Faro este capitala Algarve și servește drept poartă spre sudul Portugaliei. Orașul are un oraș vechi fermecător (Vila Adentro) și este situat chiar lângă Parcul Natural Ria Formosa.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The macabre Capela dos Ossos (Chapel of Bones) in Faro is meticulously lined with the skulls and bones of over 1,000 monks.","Before the Christian reconquest in 1249, Faro was an incredibly important Moorish trading hub known widely as Ossonoba.","The city's massive university heavily focuses on advanced marine biology and oceanographic research.","The towering Arco da Vila, the main gate into the old town, is famously home to numerous nesting white storks."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Faro are un zid maur bine conservat.", "Catedrala Faro datează din secolul al XIII-lea.", "Parcul Natural Ria Formosa este un paradis pentru observatorii de păsări.", "Orașul are o atmosferă relaxată în comparație cu alte puncte turistice.", "Faro are un aeroport internațional."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Setúbal is a massive, incredibly vibrant working port city located at the mouth of the Sado River estuary, just south of Lisbon. It is deeply and aggressively defined by its immense maritime heritage, serving historically as the absolute center of Portugal's massive sardine canning and salt harvesting industries. Today, it beautifully balances its gritty, heavy industrial port with breathtaking natural beauty, sitting directly between the incredibly lush Arrábida Natural Park and the dolphin-filled waters of the Sado estuary. The city's bustling, chaotic daily fish market, the Mercado do Livramento, is universally considered one of the finest and most colorful in the world." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Sado Estuary is famously home to one of Europe's very few resident, non-migratory pods of bottlenose dolphins.", "Setúbal is universally famous throughout Portugal for its signature dish, 'Choco Frito' (deep-fried cuttlefish).", "The city's spectacular Mercado do Livramento is entirely lined with thousands of traditional, hand-painted blue azulejo tiles.", "The massive, 16th-century Fort of São Filipe sits high above the city, offering staggering views over the entire peninsula."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Évora is the monumental, spectacularly preserved historic capital of the sun-baked Alentejo region. Enclosed completely by massive medieval walls, the city is a staggering, living museum of Portuguese history, officially recognized as a UNESCO World Heritage site. Its absolute architectural centerpiece is the stunningly intact Roman Temple of Évora, standing majestically alongside the imposing, fortress-like Sé Cathedral. The city's labyrinthine, incredibly narrow streets are lined with perfectly whitewashed houses featuring bright yellow borders and intricate wrought-iron balconies. Évora's immense historical wealth is matched only by its exceptionally vibrant, youthful energy, heavily driven by its prestigious university." },
    facts: {
      en: [
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The macabre Capela dos Ossos (Chapel of Bones) is completely covered with the carefully arranged bones of 5,000 monks.", "The massive Évora University is the second oldest in Portugal, originally founded by the powerful Jesuit order in 1559.", "The majestic Roman Temple survived primarily because it was bizarrely incorporated into a medieval butcher shop.", "Évora is completely surrounded by massive, ancient megalithic sites, including the staggering Almendres Cromlech stone circle."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Aveiro is a highly unique, deeply picturesque coastal city located in central Portugal, almost universally referred to as the 'Venice of Portugal'. The city is completely defined by its extensive network of saltwater canals, which are elegantly navigated by highly distinctive, vibrantly painted gondola-like boats called 'Moliceiros'. Historically, these striking boats were used to harvest underwater algae to fertilize the region's sandy agricultural soils. Today, Aveiro perfectly blends its deep maritime traditions with striking, pastel-colored Art Nouveau architecture. The city is also incredibly famous for its traditional, intensely sweet egg-yolk pastries known as 'Ovos Moles'." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Aveiro este Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The incredibly vibrant, often playfully painted Moliceiro boats frequently feature highly humorous or mildly suggestive local folk scenes.", "Aveiro's massive, shallow lagoon system is traditionally used for extensive, highly productive artisan sea salt harvesting.", "The nearby Costa Nova beach is incredibly famous for its brightly painted, candy-striped wooden fisherman's houses.", "The incredibly sweet 'Ovos Moles' pastries are officially protected by the European Union with a geographical indication status."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Viseu is a majestic, deeply historic city nestled high in the lush, mountainous heart of central Portugal. Consistently voted as one of the absolute best cities to live in Portugal regarding quality of life, it completely escapes the massive tourist crowds of the coast. The city's incredibly well-preserved medieval core centers around the Adro da Sé, a towering granite plaza flanked by the imposing Viseu Cathedral and the striking Misericórdia Church. Viseu is deeply steeped in incredibly ancient national mythology, widely believed to be the birthplace of Viriathus, the legendary Lusitanian warrior chief who fiercely and successfully resisted the advancing Roman Empire." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The city is universally celebrated as the absolute epicenter of the highly acclaimed Dão wine region.", "Every late summer, Viseu hosts the Feira de São Mateus, officially one of the oldest and largest agricultural fairs in Europe.", "The highly impressive Grão Vasco Museum is dedicated to the brilliant, massive altarpiece paintings of the famous Portuguese Renaissance artist.", "The city's ancient defensive walls feature massive, beautifully preserved Romanesque stone gates."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Beja is a severely ancient, intensely sun-baked city sitting prominently on a high hill in the deep south of the vast Alentejo plains. Its massive, commanding skyline is totally dominated by the Torre de Menagem, an incredibly imposing, 40-meter-tall marble castle keep that is the tallest in all of Portugal. Originally founded by Julius Caesar as 'Pax Julia', Beja later served as a highly prominent Moorish cultural center for over four centuries. The incredibly rich, multi-layered history of the city is fully evident in its incredibly quiet, whitewashed streets, Roman archaeological sites, and stunning former convents converted into brilliant regional museums." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The massive, heavily fortified castle keep is constructed almost entirely from locally quarried, solid marble.", "Beja is famously associated with the highly romantic, internationally controversial 17th-century 'Letters of a Portuguese Nun'.", "The surrounding incredibly flat, severely dry plains are heavily dedicated to massive wheat farming and olive oil production.", "The regional museum houses one of the absolute most important collections of ancient Roman and Visigothic artifacts in the Iberian Peninsula."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Bragança is an intensely rugged, completely isolated ancient city situated in the extreme mountainous northeast of Portugal, mere kilometers from the Spanish border. Serving as the historic capital of the wildly untamed Trás-os-Montes region, the city's incredibly rich history is perfectly preserved within its massive, fully intact medieval citadel (Cidadela). The citadel is crowned by a towering, 15th-century castle keep and houses one of the only completely surviving Romanesque civic buildings in Portugal, the pentagonal Domus Municipalis. The city proudly retains an incredibly distinct, fierce cultural identity, deeply tied to ancient pagan winter solstice rituals and extreme self-reliance." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The city famously gave its name to the House of Braganza, the absolute final royal dynasty to rule the Kingdom of Portugal.", "The profoundly unique Domus Municipalis is an incredibly rare, perfectly preserved pentagonal Romanesque town hall.", "The incredibly rugged, highly isolated region still preserves a completely distinct, officially recognized ancient language called Mirandese.", "Every winter, the surrounding villages violently celebrate the 'Caretos', an incredibly ancient Celtic ritual featuring men in demonic, fringed masks."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Leiria is an incredibly vibrant, rapidly growing city located centrally along the Portuguese coast, deeply shaped by the meandering Lis River. The city's absolute focal point is the spectacular, fairy-tale Castle of Leiria, which sits dramatically atop a steep volcanic plug directly overlooking the bustling modern city below. The castle was heavily fortified by Portugal's first king and later transformed into a luxurious, highly romantic Gothic palace by King Dinis. Historically, Leiria was incredibly important for its massive royal pine forest (Pinhal de Leiria), which directly supplied the essential timber for the immense fleets of the Portuguese Age of Discovery." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The majestic castle was extensively and beautifully restored in the late 19th century by the visionary Swiss architect Ernesto Korrodi.", "Leiria is absolutely famous for a highly unique, incredibly sweet traditional pastry known as the 'Brisa do Lis'.", "The city established one of the absolute first printing presses in the entire Iberian Peninsula during the 15th century.", "The massive, adjacent pine forest was almost totally devastated by catastrophic national wildfires in 2017."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Portimão is the absolutely largest and most intensely bustling commercial city in the western Algarve. Historically deeply defined by shipbuilding, fishing, and massive sardine canning industries, the city has successfully transformed into a major tourism and nautical sports hub. Its completely modernized, palm-lined riverfront promenade runs gracefully alongside the Arade River, leading directly out to the spectacularly expansive, highly iconic Praia da Rocha beach, famous for its massive limestone rock formations and powerful surfing waves. While possessing a highly modern skyline, Portimão retains a deeply gritty, authentic Portuguese atmosphere, especially around its legendary grilled sardine restaurants." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The highly engaging Portimão Museum is beautifully housed in a massive, flawlessly restored 19th-century sardine canning factory.", "The nearby Autódromo Internacional do Algarve is a massive, world-class racing circuit that frequently hosts Formula 1 and MotoGP events.", "Praia da Rocha was officially one of the absolute first beaches in the Algarve to be developed for mass international tourism in the 1960s.", "The city hosts an incredibly massive, weeks-long grilled sardine festival every single August, attracting thousands of visitors."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Ponta Delgada is the sprawling, highly vibrant economic capital of the Autonomous Region of the Azores, located on the massive volcanic island of São Miguel. It evolved brilliantly from a humble 15th-century fishing village into an absolutely crucial port of call for the massive galleons traversing between Europe and the Americas. The city's incredibly striking, highly distinctive architecture is completely characterized by stark, white-washed buildings heavily trimmed with dark, volcanic basalt rock, best exemplified by the iconic, triple-arched Portas da Cidade (City Gates). Today, its massive marina and historic center make it the absolute perfect, highly developed base for exploring the island's unbelievable natural wonders." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The highly iconic three-arched Portas da Cidade were built in the 18th century and literally moved stone by stone to their current location in 1952.", "The city's historic Forte de São Brás is a massive, perfectly preserved star-shaped Renaissance fortress fiercely protecting the harbor.", "The Carlos Machado Museum is officially the oldest museum in the entire Azores, established initially in 1876.", "Highly exotic pineapples, introduced in the 19th century, are famously and successfully cultivated in unique glass greenhouses just outside the city."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Funchal is the incredibly vibrant, deeply historic capital city of the Madeira archipelago, famously and dramatically situated in a massive, lush natural amphitheater facing the deep blue Atlantic Ocean. Founded in the 15th century, the city grew immensely wealthy during the 'white gold' era of sugar cane production and later from the global export of its world-renowned Madeira fortified wine. The city is a staggering botanical paradise, boasting absolutely spectacular tropical gardens, incredibly steep historic cobbled streets, and the highly exhilarating, completely unique traditional wicker toboggan ride rapidly descending from the mountainous suburb of Monte." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Funchal este Madeira", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Funchal hosts one of the absolute largest, most spectacular, and highly awarded New Year's Eve fireworks displays in the entire world.", "The city is highly famous globally as the exact birthplace of the legendary football superstar Cristiano Ronaldo.", "The highly traditional Monte toboggans are heavy wicker sleds guided rapidly down incredibly steep asphalt streets by two men in distinctive straw hats.", "Its incredibly colorful Mercado dos Lavradores (Farmers' Market) is universally famous for completely exotic, hybrid fruits and terrifying-looking black scabbard fish."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Mafra is a deeply historic, highly significant town located just northwest of Lisbon, almost entirely defined by the colossal, staggering presence of the National Palace of Mafra. This monumental, massively opulent baroque complex was commissioned by King João V in the 18th century and largely financed by the unbelievable influx of Brazilian gold, fundamentally and permanently changing the small town's destiny. Beyond the imposing palace, Mafra retains an incredibly charming, traditional Portuguese atmosphere with quiet squares and excellent local bakeries. The town is also closely tied to the Tapada Nacional de Mafra, a massive, walled former royal hunting ground." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The construction of the massive Mafra Palace was so completely overwhelming it essentially created the town as it exists today.", "The town is absolutely famous nationally for its 'Pão de Mafra', a highly regarded, dense, and incredibly crusty traditional rustic bread.", "Portuguese Nobel Prize-winning author José Saramago immortalized the town in his famous, highly magical novel 'Baltasar and Blimunda'.", "The massive royal hunting grounds (Tapada de Mafra) were established in 1747 to provide exclusive leisure for the Portuguese monarch."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Óbidos is a spectacularly preserved medieval walled town located in central Portugal. Captured from the Moors by the first King of Portugal, Afonso Henriques, the entire town was historically presented as a wedding gift to Portuguese queens, earning it the title 'Town of Queens'. Encircled by high, crenellated walls that visitors can walk along, the town features a maze of narrow cobblestone streets, whitewashed houses adorned with vibrant blue and yellow borders, and a majestic hilltop castle. Óbidos is a living museum, renowned for its literary festivals, medieval fairs, and the local sour cherry liqueur known as Ginjinha." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Obidos este un oraș mic cu ziduri din vestul Portugaliei și unul din țară", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Óbidos has been officially designated as a UNESCO City of Literature since 2015.","The traditional Ginjinha liqueur is typically served in small, edible cups made of dark chocolate.","The town's main gate, Porta da Vila, features a beautiful 18th-century chapel decorated with azulejo tiles.","Every winter, Óbidos transforms into a massive Christmas village (Vila Natal), attracting thousands of families."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Obidos este înconjurat de zidurile orașului.", "Orașul vechi este compact și ușor de mers pe jos.", "Orașul se află aproape de coasta Atlanticului.", "Aici au loc multe festivaluri culturale.", "Orașul este cunoscut pentru starea sa romantică."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Tomar, universally known as the 'City of the Templars', is an incredibly enchanting historic town in central Portugal that grew entirely around the magnificent Convent of Christ. Founded in the 12th century by Gualdim Pais, the absolute Grand Master of the Knights Templar in Portugal, the town's original layout was uniquely designed in the shape of a cross, oriented perfectly to the cardinal points. Tomar's incredibly rich, multi-layered heritage prominently spans the medieval crusader era, the Portuguese Age of Discovery, and the Renaissance. Visitors are highly captivated by its tranquil riverside park and the perfectly preserved, incredibly rare historic Synagogue." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Every four years, Tomar hosts the absolutely spectacular 'Festa dos Tabuleiros', an incredibly ancient and massive harvest festival.", "The historic Tomar Synagogue is officially the only fully preserved pre-Renaissance Jewish temple in all of Portugal.", "The town is beautifully bisected by the highly scenic Nabão River, complete with charming, fully functional ancient water wheels.", "Tomar's historical center features a highly unique, perfectly rigid checkerboard street plan, which was incredibly unusual for medieval Portuguese towns."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Viana do Castelo is one of the most beautiful and architecturally rich cities in northern Portugal, gracefully situated at the estuary of the Lima River. Historically a major port for Portuguese explorers and later the cod fishing fleet, its wealth is reflected in the splendid Renaissance, Manueline, and Baroque mansions of the historic center. The city is crowned by the magnificent neo-Byzantine Sanctuary of Santa Luzia, offering panoramic views over the ocean and the green Minho region. Viana do Castelo is deeply rooted in local traditions, most notably its intricate gold filigree jewelry and the vibrant Romaria de Nossa Senhora da Agonia festival." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Viana do Castelo este un oraș elegant din nordul Portugaliei, între râu, mare și munte. Este cunoscut pentru orașul său vechi, tradiția construcțiilor navale și priveliștea de la Monte de Santa Luzia. Orașul combină coasta Atlanticului și cultura nordică într-o zonă compactă. Pentru SEO despre nordul Portugaliei, orașele de coastă și tradițiile festivalurilor, Viana do Castelo este foarte puternică.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Gil Eannes, a former hospital ship for the cod fishing fleet, is now moored in the city as a fascinating museum.", "The Sanctuary of Santa Luzia is clearly inspired by the Sacré-Cœur basilica in Paris.", "During the city's main festival, women wear traditional, heavily embroidered 'trajes à vianesa' and kilos of gold filigree.", "Gustave Eiffel designed the city's impressive two-tiered iron bridge spanning the Lima River."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Tavira is widely considered the most charming and architecturally authentic town in the eastern Algarve. Straddling the slow-flowing Gilão River, it is famous for its romantic 'Roman' bridge, numerous historic churches, and distinctive 'tesouro' (treasure) roofs—a unique pyramidal roof style hinting at its affluent past. Unlike the highly developed western Algarve, Tavira has preserved its tranquil, Moorish-influenced character with labyrinthine cobbled streets and whitewashed houses. The town serves as the primary gateway to the pristine barrier islands and pristine beaches of the Ria Formosa Nature Park." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Tavira este un oraș fermecător din estul Algarve, cu un râu, poduri și un peisaj urban calm. Bisericile istorice și apropierea sa de Parcul Natural Ria Formosa îi conferă o atracție puternică. Tavira combină accesul la plajă cu o atmosferă autentică de oraș mic. Pentru călătoriile în Algarve, orașele vechi și SEO de pe coasta de sud, Tavira este un nume puternic.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The town is famously said to have exactly 37 churches, though some are no longer in religious use.", "The iconic seven-arched bridge in the center is called the 'Roman Bridge' but actually dates to the Moorish period.", "Tavira's economy was historically dominated by tuna fishing and the evaporation of sea salt.", "An ancient Moorish castle in the town center now houses a small, beautifully maintained botanical garden."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Loulé is a vibrant and culturally rich market town located inland from the Algarve coast. It is best known for its striking, Neo-Arab style municipal market hall, which serves as the beating heart of the town, bustling with vendors selling fresh local produce, fish, and regional crafts. Loulé has a deep Moorish heritage, evident in its restored 13th-century castle and the historic Islamic baths discovered underneath the city streets. Beyond its history, Loulé is famous throughout Portugal for hosting the country's most spectacular and colorful annual Carnival parade, drawing visitors from far and wide." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Neo-Arab Municipal Market was inaugurated in 1908 and features distinctive red onion domes.", "Loulé is home to a unique underground salt mine that reaches a depth of 230 meters.", "The local artisans are famous for their intricate copper work and traditional palm-leaf weaving.", "During the MED Festival in summer, the entire historic center transforms into a massive world music celebration."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Silves is a historically profound city in the Algarve, famously serving as the region's capital during the era of Moorish rule. Situated along the banks of the Arade River, it was once a major cultural and trading hub known as 'Xelb', rivaling Lisbon and Córdoba in importance. The city's skyline is utterly dominated by the massive, red sandstone walls of the Castelo de Silves, the best-preserved Moorish fortification in southern Portugal. Walking through its steep, cobbled streets reveals a blend of Islamic heritage and traditional Portuguese architecture, surrounded by fragrant orange and lemon groves." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["During the Moorish period, boats could navigate the Arade River all the way from the ocean directly to Silves.", "The Sé Cathedral of Silves was built on the exact site of the former Grand Mosque.", "Every August, the city hosts a massive Medieval Fair, completely transforming the historic center.", "Silves is recognized as the citrus capital of Portugal, producing the country's finest oranges."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Santarém is the historical capital of the Ribatejo province, situated dramatically on a high plateau overlooking the vast, fertile plains of the Tagus River. Known as the 'Capital of Portuguese Gothic', its historic center is a treasure trove of medieval churches, intricate cloisters, and ancient monuments. The city's strategic vantage point, particularly from the Portas do Sol park, has made it a crucial military stronghold since Roman and Moorish times. Santarém is also deeply rooted in the equestrian and agricultural traditions of the Ribatejo, closely associated with the breeding of the famous Lusitano horses." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Santarem se află deasupra râului Tajo și este unul dintre orașele cheie din Ribatejo. Poziția sa pe platou oferă vederi largi asupra câmpiei râului. Orașul este strâns legat de agricultură, cultura cailor și comerțul regional. Pentru SEO despre Tagus, Ribatejo și Portugalia interioară, Santarem se potrivește foarte bine.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Jardim das Portas do Sol offers an unparalleled, panoramic view over the Tagus River valley.","The Church of the Miracle of the Holy Sacrament houses a famously venerated Catholic relic from the 13th century.","Santarém hosts the National Agricultural Fair, celebrating the region's cowboy ('campino') culture.","The city was conquered from the Moors in 1147 in a daring nighttime raid led by King Afonso Henriques."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Poziția sa deasupra Tajo-ului este distinctă.", "Santarem aparține lui Ribatejo.", "Orașul este cunoscut pentru cai și agricultură.", "Platoul oferă panorame largi.", "Orașul are o piață regională puternică."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Guarda is the highest city in continental Portugal, proudly perched at an altitude of 1,056 meters in the foothills of the Serra da Estrela mountains. Its lofty position and formidable granite architecture earned it the moniker 'The City of the Five Fs': Fria, Farta, Forte, Fiel, Formosa (Cold, Plentiful, Strong, Loyal, Beautiful). Established as a border fortress to defend against Spanish invasions, its historic center is defined by narrow, winding streets and the imposing, fortress-like Cathedral of Guarda, which seamlessly blends Gothic and Manueline styles. The crisp mountain air and rugged surroundings give the city a distinctly alpine character." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Guarda este cel mai înalt oraș din Portugalia continentală și un punct important în estul țării. Aerul proaspăt de munte și un oraș vechi de piatră îi definesc caracterul. Guarda este o poartă către Serra da Estrela și regiunile de graniță interioară. Pentru SEO despre altitudine, munți și Portugalia continentală, Guarda este o alegere puternică.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The construction of the towering, granite Cathedral of Guarda took nearly 150 years to complete.","Guarda was traditionally considered one of the most impregnable strongholds in the entire kingdom.","The historic Jewish quarter (Judiaria) retains many original houses marked with ancient Hebrew symbols.","Due to its high altitude, Guarda is one of the few Portuguese cities that frequently experiences winter snow."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Guarda este cel mai înalt oraș continental.", "Orașul se află lângă Serra da Estrela.", "Orașul vechi este modelat de arhitectura din piatră.", "Iernile sunt adesea reci.", "Orașul este o poartă strategică interioară."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Chaves is an ancient and vital border city located in the extreme north of Portugal, along the banks of the Tâmega River. Originally founded by the Romans as 'Aquae Flaviae', the city has been famous for millennia for its therapeutic thermal springs, which emerge naturally at a scalding 73°C (163°F). Its strategic location near the Spanish border made it a heavily fortified bastion throughout Portuguese history, evidenced by the impressive medieval castle keep that still dominates the skyline. Visitors to Chaves enjoy the stunning Roman bridge, the relaxing thermal spas, and the rich local gastronomy, particularly the famous smoked meats." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Chaves se află în nord, lângă granița cu Spania și este cunoscut pentru băile termale și podurile sale. Orașul combină istoria romană cu o viață regională de zi cu zi. Râul Tâmega creează un cadru fluvial plăcut în zona interioară. Pentru SEO despre orașele de graniță, cultura termală și nordul Portugaliei, Chaves este foarte puternic.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Roman Bridge of Trajan in Chaves has withstood the Tâmega River's floods for nearly two thousand years.","The local thermal waters are among the hottest naturally occurring mineral springs in all of Europe.","Chaves is the northern starting point of the iconic N2 road, which runs the entire length of Portugal.","The local culinary specialty is 'Pastel de Chaves', a crescent-shaped pastry filled with minced veal."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Chaves este renumit pentru băile termale.", "Podul roman este un simbol.", "Orașul este aproape de Spania.", "Tâmega definește orașul.", "Chaves are o puternică identitate regională."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Elvas is a fiercely guarded border city in the Alentejo region, possessing the largest and most complex system of bulwarked fortifications in the world. Due to its extreme proximity to Spain, the city was heavily fortified from the 17th to the 19th centuries, culminating in a sprawling, star-shaped defensive masterpiece that is now a UNESCO World Heritage site. Beyond its formidable walls, Elvas features a pristine historic center with elegant plazas, whitewashed houses, and the monumental Amoreira Aqueduct, an engineering marvel with multi-tiered arches. The city stands as an ultimate symbol of Portuguese sovereignty and military ingenuity." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The massive Amoreira Aqueduct took over a century to build and is over 7 kilometers long.", "The Forte da Graça, located on a nearby hill, is considered a global masterpiece of 18th-century military architecture.", "The star-shaped fortifications were designed by a Dutch Jesuit priest and military engineer.", "Despite numerous sieges by Spanish forces, the modern fortifications of Elvas were never successfully breached."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Portalegre is a serene, elegant city situated in the northern Alentejo, nestled against the lush slopes of the Serra de São Mamede. In the 16th and 17th centuries, the city amassed immense wealth from the silk and textile industries, which funded the construction of its beautifully preserved Baroque and Renaissance mansions. Unlike the sun-baked plains typical of the Alentejo, Portalegre enjoys a cooler, greener microclimate that fosters beautiful public gardens and dense cork oak forests. The city remains deeply tied to its artisanal roots, particularly through the famous Guy Fino Tapestry Manufacture, which continues to produce exquisite handwoven artworks." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Portalegre este un oraș liniștit din nordul Alentejo, cu istorie textilă și de graniță. Orașul se află lângă Serra de São Mamede și este înconjurat de dealuri și pădure. Orașul său vechi păstrează un aer tradițional portughez din interior. Pentru SEO despre Alentejo, meșteșuguri și apropierea munților, Portalegre se potrivește foarte bine.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Portalegre Tapestry Manufacture is renowned globally and has collaborated with famous artists like Almada Negreiros.","The city's historic center contains an unusually high concentration of aristocratic coats of arms on its mansions.","José Régio, one of Portugal's most famous 20th-century poets, lived in Portalegre and his house is now a museum.","The nearby Serra de São Mamede Natural Park offers excellent hiking and birdwatching opportunities."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Portalegre se află în nordul Alentejo.", "Orașul este cunoscut pentru textile.", "Serra de São Mamede este în apropiere.", "Orașul păstrează un peisaj urban calm.", "Urmele comerciale istorice sunt încă vizibile."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Castelo Branco is a prominent city in the Beira Baixa region of central Portugal, characterized by its elegant avenues, historic squares, and deep cultural heritage. The city's crown jewel is the Jardim do Paço Episcopal, an extraordinary 18th-century Baroque garden renowned for its meticulously manicured hedges and a complex array of statues representing Portuguese kings, apostles, and the zodiac. Historically, the city grew around a Templar castle, though much of its modern layout reflects later centuries of prosperous bishopric rule. Castelo Branco is also the absolute center for the production of the region's famous, intricately embroidered silk bedspreads (Bordados de Castelo Branco)." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The statues of the Spanish Kings who ruled Portugal are deliberately carved smaller than the Portuguese kings in the Bishop's Garden.", "The famous 'Bordados de Castelo Branco' feature complex symbolic motifs, such as the Tree of Life and the Tree of Good and Evil.", "A museum dedicated entirely to the regional silk embroidery is located in the city center.", "The ancient Templar castle ruins provide sweeping panoramic views over the surrounding plains to the Spanish border."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Vila Real is an aristocratic city in northern Portugal, dramatically situated on a rocky promontory above the confluence of the Corgo and Cabril rivers. Often referred to as the 'Court of Trás-os-Montes', the city historically attracted numerous noble families whose stately mansions and granite coats of arms still adorn the historic center. Vila Real serves as the primary gateway to the spectacular Alto Douro Wine Region and the untamed landscapes of the Alvão Natural Park. The city is universally associated with the Mateus Palace, a breathtaking Baroque masterpiece just outside the city limits, famous for gracing the label of the globally recognized Mateus Rosé wine." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Vila Real se află în nordul Portugaliei, între Douro și munți. Orașul este o bază bună pentru Valea Douro, lanțul Marão și nordul Portugaliei. Viața urbană aici rămâne modestă și puternic regională. Pentru SEO despre nordul Portugaliei, munți și peisaje vinicole, Vila Real este foarte utilă.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Mateus Palace was designed by Nicolau Nasoni, the most influential Baroque architect in northern Portugal.","Vila Real is famous for 'Bila' pottery, distinctive black clay ceramics crafted using ancient techniques.","The historic center features the Diogo Cão house, alleged birthplace of the explorer who discovered the Congo River.","A thrilling, high-speed urban car race, the Circuito Internacional de Vila Real, takes place on its streets annually."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Vila Real se află între Douro și munți.", "Orașul este o bază bună pentru călătoriile în interior.", "Regiunea este strâns legată de vin.", "Orașul are un centru regional calm.", "Nordul Portugaliei este ușor de ajuns de aici."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Covilhã is a robust mountain city clinging to the steep eastern slopes of the Serra da Estrela, Portugal's highest mountain range. Historically known as the 'Manchester of Portugal', it was the epicenter of the nation's powerful wool and textile industry, utilizing the abundant mountain streams to power its massive mills. Today, the city successfully blends its gritty industrial heritage with a vibrant, youthful energy brought by the local university. The steep, winding streets have been revitalized by an impressive array of world-class urban street art, making Covilhã a unique open-air gallery amidst a dramatic alpine setting." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The city's urban art festival, WOOL, has transformed dozens of historic industrial walls into massive contemporary murals.", "Covilhã was the hometown of several key navigators and cosmographers during the Portuguese Age of Discovery.", "A scenic funicular and several public elevators help residents and tourists navigate the extremely steep city terrain.", "It serves as the primary base camp for skiers and winter sports enthusiasts heading up to the Torre peak."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Church of São Francisco in Porto is an awe-inspiring religious monument, hiding one of Europe's most lavishly decorated interiors behind its austere Gothic facade. Originally built by Franciscan friars in the 14th century, the church underwent a spectacular transformation in the 18th century when almost every inch of its interior was covered in complex, gilded woodwork (Talha Dourada). The dizzying array of golden cherubs, animals, and intricate floral motifs required an estimated 300 to 400 kilograms of gold leaf. The absolute masterpiece inside is the 'Tree of Jesse', a stunning wooden carving tracing the genealogy of Jesus Christ." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Biserica São Francisco din Porto este renumită pentru interiorul său baroc bogat aurit. Din exterior pare modest, dar in interior are o puternica putere decorativa. Situl combină arta sacră, istoria orașului și atractia puternică pentru vizitatori. Pentru Porto, biserici și SEO baroc, această biserică este foarte valoroasă.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The church is so overwhelmingly covered in gold that locals once refused to worship there, deeming it too ostentatious for the poor.","Beneath the church lie extensive catacombs containing thousands of human bones, including an eerie glass floor over a mass grave.","The church was briefly used as a stable for horses by French troops during the Napoleonic Invasions.","It is the most prominent Gothic monument in Porto, despite its overwhelmingly Baroque interior."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Interiorul este puternic aurit.", "Biserica se află în orașul vechi din Porto.", "Exteriorul este intenționat simplu.", "Arta barocă este puternic prezentă aici.", "Site-ul este un punct important al orașului."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Sanctuary of the Sacred Heart of Jesus, universally known as Santa Luzia, is a monumental basilica crowning the Mount of Santa Luzia above the city of Viana do Castelo. Completed in the mid-20th century, its striking neo-Byzantine and neo-Gothic architecture was directly inspired by the Sacré-Cœur in Paris. The sanctuary's massive, imposing dome and intricate rose windows are a beacon visible from miles around. The absolute highlight of a visit is ascending to the very top of the dome, which rewards visitors with what National Geographic once described as one of the most beautiful panoramas in the world, spanning the ocean, river, and mountains." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The sanctuary can be reached from the city center via the Santa Luzia Funicular, the longest funicular in Portugal.", "Construction of the basilica began in 1904 but wasn't officially completed until 1959.", "Its enormous rose windows are the largest in the Iberian Peninsula.", "The panoramic view from the top encompasses the entire Lima River estuary and the distant Spanish coastline."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Roman Ruins of Milreu, located near Faro in the Algarve, offer a fascinating glimpse into the opulent lifestyle of ancient Roman elites. Originally constructed in the 1st century AD, this sprawling complex was a luxurious rural villa (villa rustica) that featured extensive residential quarters, an agricultural processing area, and a magnificent bathhouse. The site's most remarkable feature is a large, incredibly well-preserved water sanctuary (nymphaeum) decorated with intricate, colorful mosaics of fish and marine life. In the 16th century, a rustic Portuguese farmhouse was built directly over part of the ruins, creating a unique layering of historical eras." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Ruinele romane din Milreu sunt lângă Faro și arată istoria antică a Algarve. Situl păstrează ziduri, structuri domestice și urme arheologice importante. Acesta adaugă adâncime regiunii cu mult dincolo de turismul pe plajă. Pentru Faro, arheologie și istoricul SEO din Algarve, Milreu este un loc foarte bun.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The maritime mosaics in the bathhouse are considered some of the finest Roman artwork surviving in Portugal.","The central temple of the complex was later converted into a Christian basilica during the Visigothic period.","The villa remained continuously inhabited and operational for over 500 years.","Excavations have revealed an advanced Roman underfloor heating system (hypocaust) in the bathhouse."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Site-ul se află lângă Faro.", "Milreu arată istoria Romanului Algarve.", "Arheologia este principala atracție.", "Ruinele adaugă profunzime imaginii de coastă a regiunii.", "Locul contează pentru educație și turism."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Fortifications of Elvas constitute the largest and most pristine system of bulwarked, star-shaped defenses anywhere in the world. Located practically on the Spanish border in the Alentejo, this colossal military complex was massively expanded during the Portuguese Restoration War in the 17th century to protect the nation's hard-won independence. The UNESCO World Heritage site encompasses the entire historic city walls, the monumental Amoreira Aqueduct, and the spectacular, independent hilltop forts of Santa Luzia and Nossa Senhora da Graça. This defensive masterpiece represents the absolute pinnacle of European military engineering and strategic landscape modification." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Fortificațiile Elvas sunt printre Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Forte da Graça is a perfect, multi-layered star fort that is considered impenetrable by 18th-century standards.","The defensive system proved entirely successful; Elvas never fell to a Spanish siege.","The fortifications successfully integrate the massive, 7-kilometer Amoreira Aqueduct to ensure a secure water supply.","The complex includes deep, bomb-proof underground cisterns capable of sustaining the city for months."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Elvas era un punct de apărare a frontierei.", "Ansamblul este protejat de UNESCO.", "Bastioanele definesc peisajul urban.", "Fortificațiile sunt vizibile de departe.", "Istoria militară este centrală aici."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Vinho Verde wine region in the verdant Minho province of northern Portugal is globally renowned for its completely unique, slightly effervescent, and crisp wines. The name 'Vinho Verde' (Green Wine) refers not to the color, but to the fact that the wine is meant to be consumed young and fresh. The lush, damp climate influenced by the Atlantic Ocean creates a highly fertile, intensely green landscape dotted with small, family-owned vineyards. Traditionally, vines here were grown on high trellises or trained up trees to maximize the use of land below for other crops, creating a distinctly beautiful agricultural scenery." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Regiunea Vinho Verde din nordul Portugaliei este o zonă importantă de viticultura cu vinuri proaspete și ușoare. Peisajele verzi și parcelele mici definesc zona dintre Braga și Minho. Agricultura, turismul și identitatea regională se reunesc aici. Pentru SEO despre nordul Portugaliei, vin și cultura agricolă, Vinho Verde este foarte puternic.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Vinho Verde is Portugal's largest demarcated wine region, representing around 15% of the country's total vineyard area.","The Alvarinho grape, highly prized for producing exceptional white Vinho Verde, originates in this region.","Vinho Verde can actually be white, red, or rosé, though the white is by far the most internationally famous.","The high-trellis growing system, called 'enforcado', helps protect the grapes from the damp soil's moisture."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Vinho Verde este un clasic din nordul Portugaliei.", "Vinurile sunt ușoare și proaspete.", "Braga și Minho modelează regiunea.", "Peisajul este puternic agricol.", "Regiunea este, de asemenea, importantă pentru turism."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Dão Vineyards are nestled in the mountainous heart of central Portugal, an area often celebrated as the 'Burgundy of Portugal'. Completely surrounded and sheltered by high mountain ranges, including the Serra da Estrela, the region enjoys a unique microclimate shielded from extreme Atlantic rains and harsh continental winds. The vineyards are typically planted on rocky, granite slopes surrounded by dense pine forests. This exceptional terroir produces incredibly elegant, structured, and long-living wines, heavily utilizing the noble Touriga Nacional grape, which is believed to have originated in a small village within the Dão." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The Dão was officially demarcated as a wine region in 1908, making it one of the oldest in Portugal.", "The region is almost exclusively dedicated to indigenous Portuguese grape varieties.", "Dão wines are historically known for their exceptional aging potential due to their high natural acidity.", "The vineyards are often divided into very small, irregular plots separated by rocky outcrops and forests."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Alentejo Olive Groves dominate the sun-baked, undulating plains of southern Portugal, forming an endless, silvery-green ocean of ancient trees. The Alentejo is the absolute heart of Portuguese olive oil production, yielding some of the highest-quality extra virgin olive oils in the world. The region's hot, dry climate and fertile soils provide perfect conditions for robust olive varieties like Galega and Cobrançosa. Many of the traditional, gnarled olive trees in the region are several centuries old, standing as silent witnesses to the generations of agricultural heritage that define the serene Alentejo landscape." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Plantațiile de măslini din Alentejo definesc câmpiile largi din sud. Uleiul de măsline, agricultura și peisajele mediteraneene joacă un rol major aici. Regiunea îmbină producția tradițională cu calitatea modernă. Pentru SEO despre Alentejo, agricultura și uleiul de măsline portughez, este ideal.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Portugal is the world's fourth-largest exporter of olive oil, with the vast majority coming from the Alentejo.", "Some monumental olive trees in the region have been carbon-dated to be over 2,000 years old.", "The olive harvest in the Alentejo typically begins in late October and continues into the winter months.", "Olive oil tourism (oleotourism) is rapidly growing, with many historic estates (herdades) offering tastings."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Sines Petrochemical Complex is the most important industrial and energy hub in Portugal, located on the Alentejo coast adjacent to the deep-water Port of Sines. Developed in the 1970s, it completely transformed a quiet fishing village into the powerhouse of the national economy. The massive complex includes the country's largest oil refinery, a major petrochemical plant producing vital industrial polymers, and a critical terminal for liquefied natural gas (LNG). Despite its imposing, highly technical skyline of cooling towers and pipelines, the complex operates with advanced environmental controls, sitting surprisingly close to pristine coastal nature reserves." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Complexul industrial Sines este unul din Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The refinery in Sines processes millions of tons of crude oil annually to supply the domestic market.","The complex represents a significant percentage of Portugal's entire industrial Gross Domestic Product (GDP).","A major transition is underway in Sines to shift from fossil fuels to the production of green hydrogen.","The port and industrial zone are connected by a vast network of highly secure, specialized pipelines."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Sines este un loc de energie.", "Portul contează pentru industrie.", "Logistica sa este internațională.", "Locul are o poziție strategică de coastă.", "Economia modernă definește imaginea."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Barcelos is a historic city in northern Portugal that serves as the undisputed heart of traditional Portuguese ceramics and pottery. The region's rich, workable clay and centuries of generational craftsmanship have given rise to a vibrant and highly distinctive style of folk art. The absolute symbol of this industry is the 'Galo de Barcelos' (Rooster of Barcelos), a brightly painted clay rooster that has become the ubiquitous national icon of Portugal. The city's thriving weekly market, one of the largest in Europe, is a vibrant showcase of this immense ceramic heritage, featuring thousands of handmade pots, figurines, and household items." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Ceramica Barcelos reprezintă o puternică cultură meșteșugărească și de producție în nordul Portugaliei. Orașul este cunoscut pentru ceramica colorată, atelierele locale și legătura dintre tradiție și marketing. Barcelos beneficiază și de simbolul său emblematic al cocoșului. Pentru SEO despre meșteșuguri, industrie și nordul Portugaliei, această intrare se potrivește foarte bine.", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The legend of the Barcelos Rooster involves a dead, roasted rooster miraculously coming to life to save an innocent man from the gallows.","Barcelos was recognized by UNESCO as a Creative City of Crafts and Folk Art in 2017.","Traditional Barcelos pottery is famous for its bright, almost fluorescent colors and whimsical, dotted patterns.","In addition to roosters, local artisans are famous for creating satirical clay figurines of politicians and local characters."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Ceramica face parte din identitatea orașului.", "Barcelos este cunoscut pentru cocoș.", "Atelierele locale rămân active.", "Tradiția și vânzările lucrează împreună.", "Nordul Portugaliei beneficiază de imagine."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "The Lisbon Oceanarium is widely celebrated as one of the best and largest indoor aquariums in the world, making it a premier destination for families. Located in the modern Parque das Nações, the building is architecturally stunning, seemingly floating on the Tagus River. The conceptual design brilliantly connects four separate marine habitats—representing the Atlantic, Pacific, Indian, and Antarctic oceans—around one colossal, multi-story central tank. Children and adults alike are mesmerized by the seamless, immersive experience, offering close encounters with sharks, playful sea otters, majestic rays, and an incredible diversity of marine ecosystems." },
    "descriptionAdvanced": { "de": "", "hu": "", "ro": "Oceanariul Lisabona este unul din Portugalia", "en": "" },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The central tank is so large it holds 5 million liters of saltwater and is equivalent to four Olympic swimming pools.","It is one of the few aquariums globally that successfully houses the massive, bizarrely shaped Ocean Sunfish.","The Oceanarium was the centerpiece of the 1998 Lisbon World Exposition, which focused on ocean conservation.","The sea otter habitat features rescued otters that charm visitors with their playful grooming and swimming routines."] },
    "factsAdvanced": { "de": [], "hu": [], "ro": ["Este una dintre cele mai cunoscute opriri de familie din oraș.", "Animalele marine sunt în centrul atenției.", "Situl se află în estul modern al Lisabonei.", "Acvariul este atractiv pe tot parcursul anului.", "Combină învățarea și distracția."], "en": [] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Zoomarine, located in Guia in the central Algarve, is Portugal's most popular family theme park, brilliantly combining marine life education with exhilarating entertainment. The park offers an extensive array of attractions, from a massive wave pool and water slides to thrilling amusement rides and a spectacular artificial beach. However, Zoomarine's true heart lies in its zoological presentations, featuring highly trained dolphins, sea lions, and tropical birds. The park is deeply committed to marine conservation, operating a highly respected rehabilitation center for injured and stranded marine animals found along the Portuguese coast." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["Zoomarine's Porto Pim rehabilitation center has successfully rescued and released hundreds of sea turtles and marine mammals.", "The park features a highly sought-after program allowing visitors to interact closely with bottlenose dolphins.", "It has been repeatedly voted the best theme park in Portugal by major travel review platforms.", "Beyond marine life, the park includes a large walk-through butterfly garden and a 4D cinema experience."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Zoo Santo Inácio, located just minutes from Porto, is the largest and most prominent zoological park in northern Portugal. Designed with a strong emphasis on spacious, naturalistic enclosures, the zoo focuses on the well-being and conservation of endangered species. Families can explore beautifully landscaped habitats housing everything from majestic Asian lions and Siberian tigers to playful Humboldt penguins and massive rhinoceroses. One of the absolute highlights for visitors is the spectacular, 40-meter-long glass tunnel that cuts directly through the lion enclosure, offering heart-pounding, face-to-face encounters with the majestic predators." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The zoo participates in numerous European Endangered Species Programmes (EEP) for successful breeding.", "The zoo's Asian Lion glass tunnel is the first of its kind in Portugal.", "It features a massive, immersive tropical greenhouse filled with free-flying exotic birds and reptiles.", "Daily feeding demonstrations allow visitors to learn directly from the keepers about the animals' natural behaviors."] },
  ...
  },
  {
    ...
    descriptionAdvanced: { de: "", hu: "", ro: "", en: "Badoca Safari Park is a highly unique, 90-hectare wildlife park located in the Alentejo region, expertly blending the environment of a Portuguese cork oak forest with the thrill of an African safari. Created to promote environmental education and animal conservation, the park's absolute main attraction is a 45-minute guided tractor-trailer ride through vast, open-air enclosures. Families can experience incredibly close encounters with free-roaming giraffes, zebras, antelopes, and ostriches. Beyond the immersive safari, the park features an exhilarating river rafting ride, a primate island, and dedicated areas that allow children to interact directly with farm animals and playful lemurs." },
    facts: {
    ...
    factsAdvanced: { de: [], hu: [], ro: [], en: ["The park successfully simulates the open African savanna environment using the natural, rolling terrain of the Alentejo.", "It operates highly successful, internationally recognized breeding programs for endangered species like the Rothschild's giraffe.", "The 'Badoca River Ride' is an African-themed rafting adventure featuring a thrilling 500-meter course with rapids and drops.", "A specialized 'Lemur Island' allows visitors to walk freely among extremely curious and friendly ring-tailed lemurs."] },
    image: "/geo-images/portugal/kid-badoca-safari-park.webp"
  }
];

export const portugalAllPoi: POI[] = [portugalCountry, ...portugalRegions, ...portugalCities, ...portugalCulture, ...portugalNature, ...poiExtraPortugalHistorical, ...poiExtraPortugalNature];
