...
export const finlandCultureExtended: POI[] = [
  ...
  },
  {
    ...
    description: {
      de: "Bomarsund ist die berühmte Festungsruine auf Åland und ein Schlüsselort der Krimkriegsgeschichte im Norden. Die Anlage wurde im 19. Jahrhundert als russische Militärfestung geplant und später im Krimkrieg zerstört. Heute ist sie ein markanter historischer Ort mit Wasserblick und Inselkulisse. Für Åland, Festungen und europäische Militärgeschichte ist Bomarsund sehr attraktiv.",
      hu: "Bomarsund Åland híres erődromja és az északi krími háborús történelem egyik kulcshelyszíne. A 19. században orosz katonai erődnek tervezték, majd a krími háborúban megsemmisült. Ma látványos történelmi hely vízparti panorámával és szigetvilági környezettel. Åland, erődök és európai hadtörténelem témájában Bomarsund nagyon vonzó.",
      ro: "Bomarsund este celebra ruină de fortăreață din Åland și un loc-cheie în istoria nordică a Războiului Crimeii. Complexul a fost proiectat în secolul al XIX-lea ca fortăreață militară rusă și a fost distrus ulterior în război. Astăzi este un loc istoric impresionant, cu priveliști spre apă și peisaj insular. Pentru Åland, fortărețe și istorie militară europeană, Bomarsund este foarte atractiv.",
      en: "Bomarsund is the famous fortress ruin on Åland and a key northern site in Crimean War history. The complex was planned in the 19th century as a Russian military fortress and later destroyed in the war. Today it is a striking historic place with water views and island scenery. For Åland, fortresses, and European military history, Bomarsund is very attractive."
    },
    facts: {
      de: ["Die Festung liegt auf Åland.", "Sie ist mit dem Krimkrieg verbunden.", "Der Bau begann im 19. Jahrhundert.", "Heute ist sie eine eindrucksvolle Ruine.", "Ein wichtiger Punkt für Insel- und Militärgeschichte."],
      hu: ["Az erőd Ålandon található.", "A krími háborúhoz kapcsolódik.", "Az építése a 19. században kezdődött.", "Ma látványos romként áll.", "Fontos pont a sziget- és hadtörténetben."],
      ro: ["Fortăreața se află în Åland.", "Este legată de Războiul Crimeii.", "Construcția a început în secolul al XIX-lea.", "Astăzi este o ruină impresionantă.", "Un punct important pentru istoria insulelor și istoria militară."],
      en: ["The fortress is located in Åland.", "It is linked to the Crimean War.", "Construction began in the 19th century.", "Today it stands as an impressive ruin.", "An important point for island and military history."]
    },
