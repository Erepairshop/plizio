...
,
  {
    ...
    description: {
      ...
      ro: "Această zonă umedă de coastă se întinde pe 3.068 de hectare și servește ca habitat vital pentru păsările migratoare. A fost declarată rezervație în 1996.",
      en: "This coastal wetland ecosystem covers 3,068 hectares and serves as a vital habitat for migratory birds. It was declared a sanctuary in 1996.",
    },
    facts: {
      de: ["Beherbergt 192 Pflanzenarten", "Lebensraum für 209 Tierarten", "Wichtigstes Feuchtgebiet bei Colombo", "Schutzgebiet seit 1996"],
      hu: ["192 növényfaj otthona", "209 állatfaj él itt", "Legnagyobb mocsár Colombo mellett", "1996 óta védett terület"],
      ro: ["Găzduiește 192 specii de plante", "Habitat pentru 209 specii de animale", "Cea mai mare zonă umedă lângă Colombo", "Statut de rezervație din 1996"],
      en: ["Home to 192 species of flora", "Habitat for 209 species of fauna", "Largest saline peat bog in Sri Lanka", "Declared a sanctuary in 1996"],
    },
    imageHint: "Muthurajawela marsh boat safari at sunrise",
  },
  {
    ...
    description: {
      ...
      ro: "Înființată în 2014, această grădină se concentrează pe conservarea plantelor endemice amenințate din zona umedă. Include un lac artificial în Avissawella.",
      en: "Established in 2014, this garden focuses on the conservation of threatened endemic plants from the wet zone. It features a large man-made lake in Avissawella.",
    },
    facts: {
      de: ["Eröffnet im September 2014", "Fläche von ca. 43 Hektar", "Fokus auf endemische Feuchtpflanzen", "Fünfter botanischer Garten des Landes"],
      hu: ["2014 szeptemberében nyílt meg", "Területe körülbelül 43 hektár", "Endemikus nedves erdei növények", "Az ország ötödik botanikus kertje"],
      ro: ["Deschisă în septembrie 2014", "Suprafață de aproximativ 43 hectare", "Focus pe plante endemice de zonă umedă", "A cincea grădină botanică a țării"],
      en: ["Opened in September 2014", "Covers approximately 106 acres", "Focus on endemic wet zone plants", "Sri Lanka's fifth botanical garden"],
    },
    imageHint: "Seethawaka Wet Zone Botanical Garden lake and hills",
  },
  {
    ...
    description: {
      ...
      ro: "Fondată în 1936, aceasta este una dintre cele mai vechi grădini zoologice din Asia, găzduind peste 2.500 de animale. Este cunoscută pentru grădina de fluturi.",
      en: "Founded in 1936, this is one of the oldest zoos in Asia and houses over 2,500 animals. It is widely known for its butterfly garden and elephant performances.",
    },
    facts: {
      de: ["Gegründet im Jahr 1936", "Beherbergt über 3.000 Tiere", "Eigener Schmetterlingspark", "Sitz in Dehiwala-Mount Lavinia"],
      hu: ["1936-ban alapították", "Több mint 3000 állat él itt", "Saját pillangóparkkal rendelkezik", "Dehiwala-Mount Lavinia városában van"],
      ro: ["Fondată în anul 1936", "Găzduiește peste 3.000 de animale", "Include un parc de fluturi", "Situată în Dehiwala-Mount Lavinia"],
      en: ["Established in 1936", "Home to over 3,000 animals", "Features a dedicated butterfly park", "Located in Dehiwala-Mount Lavinia"],
    },
    imageHint: "National Zoological Gardens of Sri Lanka entrance",
  },
  {
    ...
    description: {
      ...
      ro: "Desemnat parc național în 2015, acest teritoriu include o lagună mare și dune de nisip. Oferă sanctuar pentru păsări de apă și crocodili.",
      en: "Designated as a national park in 2015, this area includes a large lagoon and sand dunes in northern Sri Lanka. It is a sanctuary for water birds and crocodiles.",
    },
    facts: {
      de: ["Nationalpark seit 2015", "Fläche von 19.565 Hektar", "Wichtiger Stop für Zugvögel", "Früheres Vogelschutzgebiet"],
      hu: ["2015-ben lett nemzeti park", "Területe 19 565 hektár", "Vándormadarak fontos állomása", "Korábban madárrezervátum volt"],
      ro: ["Parc național din 2015", "Suprafață de 19.565 hectare", "Popas important pentru păsări", "Fost sanctuar de păsări"],
      en: ["Established as national park in 2015", "Covers 19,565 hectares", "Vital stop for migratory birds", "Formerly a bird sanctuary"],
    },
    imageHint: "Chundikulam National Park lagoon and birdlife",
  },
  {
    ...
    description: {
      ...
      ro: "Această zonă umedă Ramsar cuprinde șapte bazine antice artificiale. Servește ca loc de reproducere pentru multe specii de păsări locale.",
      en: "This Ramsar wetland comprises seven ancient man-made tanks. It serves as a vital breeding ground for many resident and migratory bird species.",
    },
    facts: {
      de: ["Ramsar-Gebiet seit 2001", "Besteht aus 7 antiken Teichen", "Fläche von 1.397 Hektar", "Über 150 Vogelarten gesichtet"],
      hu: ["2001 óta Ramsari-terület", "7 ősi mesterséges tóból áll", "Területe 1397 hektár", "Több mint 150 madárfaj él itt"],
      ro: ["Sit Ramsar din anul 2001", "Format din 7 bazine antice", "Suprafață de 1.397 hectare", "Peste 150 specii de păsări"],
      en: ["Ramsar site since 2001", "Comprises 7 ancient tanks", "Covers 1,397 hectares", "Over 150 bird species recorded"],
    },
    imageHint: "Anawilundawa wetland tanks with birds",
  },
  {
    ...
    description: {
      ...
      ro: "Această pădure tropicală de joasă altitudine este un punct critic de biodiversitate în sud. Conține multe specii endemice de floră și faună.",
      en: "This lowland rainforest is a significant biodiversity hotspot in southern Sri Lanka. It contains many endemic floral and faunal species of the wet zone.",
    },
    facts: {
      de: ["Teil des KDN-Waldkomplexes", "UNESCO-Biosphärenreservat", "Quelle des Gin Ganga Flusses", "Sehr hoher Anteil an Endemiten"],
      hu: ["A KDN erdőkomplexum része", "UNESCO bioszféra-rezervátum", "A Gin Ganga folyó forrásvidéke", "Magas az endemikus fajok aránya"],
      ro: ["Parte a complexului forestier KDN", "Rezervație a Biosferei UNESCO", "Sursa râului Gin Ganga", "Grad ridicat de endemism"],
      en: ["Part of the KDN forest complex", "UNESCO Biosphere Reserve", "Source of the Gin Ganga river", "High degree of floral endemism"],
    },
    imageHint: "Kanneliya rainforest waterfall and lush greenery",
  },
  {
    ...
    description: {
      ...
      ro: "Declarat în 1986, acest parc este renumit pentru elefanți și antica stupă Somawathiya. Acoperă o porțiune din lunca râului Mahaweli.",
      en: "Declared in 1986, this park is famous for its elephant population and the ancient Somawathiya Stupa. It covers portions of the Mahaweli River floodplains.",
    },
    facts: {
      de: ["Gegründet im Jahr 1986", "Fläche von 37.762 Hektar", "Heimat großer Elefantenherden", "Antike Stupa im Parkzentrum"],
      hu: ["1986-ban alapították", "Területe 37 762 hektár", "Nagy elefántcsordák otthona", "Ősi sztúpa a park közepén"],
      ro: ["Înființat în anul 1986", "Suprafață de 37.762 hectare", "Găzduiește turme de elefanți", "Stupa antică în centrul parcului"],
      en: ["Established in 1986", "Covers 37,762 hectares", "Home to large elephant herds", "Ancient stupa inside the park"],
    },
    imageHint: "Somawathiya Stupa surrounded by wild elephants",
  },
  {
    ...
    description: {
      ...
      ro: "Acest parc a fost înființat în 2006 pentru a proteja bazinul de drenaj al rezervorului Parakrama Samudra. Oferă un coridor pentru elefanți.",
      en: "Established in 2006, this park protects the drainage basin of the Parakrama Samudra reservoir. It serves as a vital corridor for elephants.",
    },
    facts: {
      de: ["Gegründet im Juni 2006", "Fläche von 7.529 Hektar", "Wichtiger Elefantenkorridor", "Schützt Wasserressourcen"],
      hu: ["2006 júniusában alapították", "Területe 7529 hektár", "Fontos elefántfolyosó", "Védi a vízkészleteket"],
      ro: ["Înființat în iunie 2006", "Suprafață de 7.529 hectare", "Coridor important de elefanți", "Protejează resursele de apă"],
      en: ["Established in June 2006", "Covers 7,529 hectares", "Key corridor for elephants", "Protects reservoir drainage basin"],
    },
    imageHint: "Angammedilla National Park forest and reservoir view",
  }
];
