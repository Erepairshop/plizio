...
export const austriaCountry: POI = {
  ...
  shortDesc: { de: "Österreich ist ein mitteleuropäischer Binnenstaat, bekannt für seine Alpenlandschaft und Geschichte.", hu: "Ausztria egy közép-európai ország, amely alpesi tájairól és történelméről híres.", ro: "Austria este un stat din Europa Centrală, renumit pentru peisajele sale alpine și istorie.", en: "Austria is a Central European country known for its Alpine scenery and history." },
  description: {
...
export const austriaRegions: POI[] = [
  {
    ...
    shortDesc: { de: "Das Burgenland ist das östlichste Bundesland Österreichs, bekannt für den Neusiedler See und Weinbau.", hu: "Burgenland Ausztria legkeletibb tartománya, amely a Fertő tóról és borászatáról ismert.", ro: "Burgenland este cel mai estic stat federal al Austriei, cunoscut pentru lacul Neusiedl și viticultură.", en: "Burgenland is Austria's easternmost federal state, known for Lake Neusiedl and viticulture." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Kärnten ist das südlichste Bundesland Österreichs, berühmt für seine warmen Badeseen.", hu: "Karintia Ausztria legdélibb tartománya, amely meleg vizű tavairól híres.", ro: "Carintia este cel mai sudic stat federal al Austriei, renumit pentru lacurile sale calde.", en: "Carinthia is Austria's southernmost federal state, famous for its warm swimming lakes." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Niederösterreich ist das größte Bundesland, geprägt von der Donau und weiten Weinvierteln.", hu: "Alsó-Ausztria a legnagyobb tartomány, amelyet a Duna és kiterjedt borvidékek határoznak meg.", ro: "Austria Inferioară este cel mai mare stat, caracterizat de Dunăre și regiuni viticole.", en: "Lower Austria is the largest state, characterized by the Danube and vast wine regions." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Ein vielseitiges Bundesland, geprägt von der industriellen Stärke von Linz und dem Salzkammergut.", hu: "Sokszínű tartomány, amelyet Linz ipari ereje és a Salzkammergut határoz meg.", ro: "Un stat versatil, caracterizat de puterea industrială a orașului Linz și regiunea Salzkammergut.", en: "A versatile state characterized by the industrial strength of Linz and the Salzkammergut." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Bundesland Salzburg, berühmt für die Mozartstadt und Bergwelten.", hu: "Salzburg tartomány, híres Mozart városáról és a hegyekről.", ro: "Statul Salzburg, renumit pentru orașul lui Mozart și munți.", en: "Salzburg state, famous for Mozart's city and mountains." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Die Steiermark, das 'Grüne Herz Österreichs', ist bekannt für dichte Wälder und Weinbau.", hu: "Stájerország, Ausztria 'zöld szíve', sűrű erdőiről és borvidékeiről ismert.", ro: "Stiria, 'inima verde a Austriei', este cunoscută pentru pădurile dese și viticultură.", en: "Styria, the 'Green Heart of Austria', is known for dense forests and viticulture." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Tirol ist das Herz der Alpen, weltbekannt für spektakuläre Hochgebirgslandschaften und Skigebiete.", hu: "Tirol az Alpok szíve, amely látványos magashegyi tájairól és síközpontjairól híres.", ro: "Tirol este inima Alpilor, renumit pentru peisaje montane spectaculoase și stațiuni de schi.", en: "Tyrol is the heart of the Alps, world-renowned for high mountain landscapes and ski resorts." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Das westlichste Bundesland, bekannt für moderne Architektur, den Bodensee und erstklassige Skigebiete.", hu: "A legnyugatibb tartomány, amely modern építészetéről, a Bodeni-tóról és síközpontjairól ismert.", ro: "Cel mai vestic stat, cunoscut pentru arhitectura modernă, lacul Constanța și stațiuni de schi.", en: "The westernmost state, known for modern architecture, Lake Constance, and ski resorts." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Wien ist ein Bundesland und die Hauptstadt Österreichs.", hu: "Bécs egy tartomány és egyben Ausztria fővárosa.", ro: "Viena este un stat federal și capitala Austriei.", en: "Vienna is a federal state and the capital of Austria." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Gartenstadt an der Donau mit bedeutender Messe- und Römergeschichte.", hu: "Kertváros a Duna partján, jelentős vásári és római kori múlttal.", ro: "Oraș al grădinilor pe Dunăre, cu o importantă istorie a târgurilor și a epocii romane.", en: "Garden city on the Danube with significant trade fair and Roman history." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Industrie- und Einkaufsstadt im südlichen Wiener Becken am Rande der Alpen.", hu: "Ipari és bevásárlóváros a Bécsi-medence déli részén, az Alpok szélén.", ro: "Oraș industrial și comercial în sudul Bazinului Vienei, la marginea Alpilor.", en: "Industrial and shopping town in the southern Vienna Basin at the edge of the Alps." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Schulstadt und regionales Zentrum im Herzen des Weinviertels.", hu: "Iskolaváros és regionális központ a Weinviertel szívében.", ro: "Oraș al școlilor și centru regional în inima regiunii Weinviertel.", en: "School town and regional center in the heart of the Weinviertel." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Braustadt im Waldviertel, bekannt für ihr bedeutendes Zisterzienserstift.", hu: "Sörváros a Waldviertelben, amely jelentős ciszterci apátságáról ismert.", ro: "Oraș al berii în Waldviertel, cunoscut pentru importanta sa mănăstire cisterciană.", en: "Brewing town in the Waldviertel, known for its significant Cistercian monastery." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Sportstadt im Salzachtal, international bekannt durch die Vierschanzentournee.", hu: "Sportváros a Salzach-völgyben, a Négysáncverseny révén nemzetközileg ismert.", ro: "Oraș al sportului în valea Salzach, cunoscut internațional datorită Turneului Celor Patru Trambuline.", en: "Sports town in the Salzach Valley, internationally known for the Four Hills Tournament." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Elegante Kurstadt am Traunsee, weltberühmt für ihre Keramiktradition.", hu: "Elegáns fürdőváros a Traunsee partján, kerámiatradíciójáról világhírű.", ro: "Oraș balnear elegant pe malul lacului Traunsee, faimos în întreaga lume pentru tradiția ceramicii.", en: "Elegant spa town on Lake Traunsee, world-famous for its ceramics tradition." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Wirtschaftlicher Knotenpunkt im Mostviertel an der Westbahnstrecke.", hu: "Gazdasági csomópont a Mostviertelben, a Westbahn vasútvonal mentén.", ro: "Nod economic în Mostviertel, situat pe linia de cale ferată Westbahn.", en: "Economic hub in the Mostviertel region on the Westbahn railway line." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Kultur- und Einkaufsstadt in Oberkärnten, nahe dem Millstätter See.", hu: "Kulturális és bevásárlóváros Felső-Karintiában, a Millstätter See közelében.", ro: "Oraș cultural și comercial în Carintia de Sus, aproape de lacul Millstätter See.", en: "Cultural and shopping town in Upper Carinthia, near Lake Millstatt." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Marktgemeinde im Inntal am Fuße der Hohen Munde mit starker Wirtschaft.", hu: "Mezőváros az Inn völgyében a Hohe Munde lábánál, erős gazdasággal.", ro: "Comună de piață în valea Inn la poalele muntelui Hohe Munde, cu o economie puternică.", en: "Market town in the Inn Valley at the foot of the Hohe Munde with a strong economy." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Moderner Verkehrsknotenpunkt und Handelsstadt im Tiroler Unterland.", hu: "Modern közlekedési csomópont és kereskedőváros a tiroli Unterlandban.", ro: "Nod de transport modern și oraș comercial în Tirolul de Jos.", en: "Modern transport hub and commercial town in Lower Tyrol." },
    description: {
...
export const austriaCities: POI[] = [
  {
    ...
    name: { de: "Wien", hu: "Bécs", ro: "Viena", en: "Vienna" },
    image: "/geo-images/austria/vienna.webp",
    shortDesc: { de: "Österreichs Hauptstadt, bekannt für imperiale Geschichte und klassische Musik.", hu: "Ausztria fővárosa, császári történelméről és klasszikus zenéjéről ismert.", ro: "Capitala Austriei, cunoscută pentru istoria imperială și muzica clasică.", en: "Austria's capital, known for its imperial history and classical music." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Zweitgrößte Stadt Österreichs mit einer historischen Altstadt.", hu: "Ausztria második legnagyobb városa történelmi óvárossal.", ro: "Al doilea oraș ca mărime din Austria cu un centru istoric vechi.", en: "Austria's second largest city with a historic old town." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Industrie- und Technologiestadt an der Donau, Zentrum der Medienkunst.", hu: "Ipari és technológiai város a Duna partján, a médiaművészet központja.", ro: "Oraș industrial și tehnologic pe Dunăre, centru al artei media.", en: "Industrial and technology city on the Danube, center of media arts." },
    description: {
  ...
  },
  {
    ...
    name: { de: "Salzburg", hu: "Salzburg", ro: "Salzburg", en: "Salzburg" },
    image: "/geo-images/austria/salzburg.webp",
    shortDesc: { de: "Mozarts Geburtsort, weltberühmt für barocke Architektur und Festspiele.", hu: "Mozart szülővárosa, világhírű barokk építészetéről és ünnepi játékairól.", ro: "Locul de naștere al lui Mozart, renumit pentru arhitectura barocă și festivaluri.", en: "Mozart's birthplace, world-famous for Baroque architecture and festivals." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Hauptstadt der Alpen, berühmt für Wintersport und das Goldene Dachl.", hu: "Az Alpok fővárosa, híres a téli sportokról és az Aranytetőről.", ro: "Capitala Alpilor, faimoasă pentru sporturile de iarnă și Acoperișul de Aur.", en: "Capital of the Alps, famous for winter sports and the Golden Roof." },
    description: {
  ...
  },
  {
    ...
    shortDesc: { de: "Kärntens Hauptstadt am Wörthersee, bekannt für den Lindwurmbrunnen.", hu: "Karintia fővárosa a Wörthersee partján, a Lindwurm-kútról ismert.", ro: "Capitala Carintiei pe Wörthersee, cunoscută pentru fântâna Lindwurm.", en: "Carinthia's capital on Lake Wörthersee, known for the Lindwurm fountain." },
  ...
  },
  {
    ...
    shortDesc: { de: "Festspielstadt am Bodensee mit beeindruckender Seebühne.", hu: "Fesztiválváros a Bodeni-tó partján, lenyűgöző tavi színpaddal.", ro: "Oraș de festival pe Lacul Constanța, cu o scenă impresionantă pe apă.", en: "Festival city on Lake Constance with an impressive floating stage." },
  ...
  },
  {
    ...
    shortDesc: { de: "Haydn-Stadt und Landeshauptstadt des Burgenlandes mit Schloss Esterházy.", hu: "Haydn városa és Burgenland fővárosa az Esterházy-kastéllyal.", ro: "Orașul lui Haydn și capitala Burgenlandului cu Palatul Esterházy.", en: "Haydn city and capital of Burgenland with Esterházy Palace." },
  ...
  },
  {
    ...
    shortDesc: { de: "Niederösterreichs Landeshauptstadt mit Barockarchitektur und modernem Regierungsviertel.", hu: "Alsó-Ausztria fővárosa barokk építészettel és modern kormányzati negyeddel.", ro: "Capitala Austriei Inferioare cu arhitectură barocă și un cartier guvernamental modern.", en: "Lower Austria's capital with Baroque architecture and a modern government district." },
  ...
  },
  {
    ...
    shortDesc: { de: "Ehemalige kaiserliche Sommerresidenz der Habsburger in Wien.", hu: "A Habsburgok egykori császári nyári rezidenciája Bécsben.", ro: "Fosta reședință imperială de vară a Habsburgilor în Viena.", en: "Former imperial summer residence of the Habsburgs in Vienna." },
  ...
  },
  {
    ...
    shortDesc: { de: "Das Machtzentrum der Habsburger und heutiger Amtssitz in Wien.", hu: "A Habsburgok hatalmi központja és a mai elnöki hivatal Bécsben.", ro: "Centrul de putere al Habsburgilor și reședința oficială de astăzi în Viena.", en: "The center of power of the Habsburgs and current official residence in Vienna." },
  ...
  },
  {
    ...
    shortDesc: { de: "Das gotische Wahrzeichen von Wien mit seinem berühmten Dach.", hu: "Bécs gótikus jelképe, híres színes cserepes tetejéről.", ro: "Simbolul gotic al Vienei cu faimosul său acoperiș.", en: "The Gothic landmark of Vienna with its famous roof." },
  ...
  },
  {
    ...
    shortDesc: { de: "Das Haus in Salzburg, in dem Wolfgang Amadeus Mozart geboren wurde.", hu: "A salzburgi ház, ahol Wolfgang Amadeus Mozart született.", ro: "Casa din Salzburg unde s-a născut Wolfgang Amadeus Mozart.", en: "The house in Salzburg where Wolfgang Amadeus Mozart was born." },
