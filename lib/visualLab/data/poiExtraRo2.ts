...
export const poiExtraRo2: POI[] = [
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "The Petrobrazi Refinery, located near Ploiești, is one of the largest and most technologically advanced industrial facilities in Romania. Founded in 1934, it has undergone massive modernization since joining OMV Petrom, with over 2 billion euros invested to meet Euro 5 standards. It plays a critical role in the national economy, supplying approximately 35% of Romania's total fuel demand. The refinery is highly efficient, processing OMV Petrom's entire domestic crude production. Recent developments focus on sustainability, including the production of sustainable aviation fuel and green hydrogen. Geography K8 — heavy industry and energy resources."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Established on June 17, 1934, with an initial capacity of 300,000 tonnes/year.", "Current annual refining capacity stands at 4.5 million tonnes (90,000 bpd).", "It features a Nelson Complexity Index of 11.4, the highest in Romania.", "Supplies roughly 35% of the fuel demand for the entire Romanian market.", "Over 2 billion euros invested in modernization since 2005.", "First Romanian refinery to install catalytic cracking technology in 1962."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "Constanța South Port is the modern, deep-water extension of Romania's primary maritime gateway, specifically designed to handle massive container ships and bulk carriers. Located at the meeting point of the Danube-Black Sea Canal, it functions as a maritime-river port, connecting the Black Sea to Central Europe. It features the largest container terminal in the Black Sea, operated by DP World, and serves as a vital logistics hub for the entire Balkan region. Its deep-water berths allow it to accommodate the world's largest Suezmax tankers and grain carriers, making Constanța the leading grain export hub in Europe. Geography K7 — transport and trade routes."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Berth depths reach 18.5 to 19 meters, allowing access for 220,000 DWT vessels.", "Hosts the largest container terminal in the Black Sea with 1.5 million TEU capacity.", "Connects to Central Europe via the 64 km long Danube-Black Sea Canal.", "The entire port complex handled a record 92.7 million tonnes of cargo in 2023.", "Functions as the number one grain export hub in the European Union.", "The specialized RO-RO terminal can handle thousands of vehicles daily."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "The Dacia plant in Mioveni is the cornerstone of the Romanian automotive industry and a flagship facility for the Renault Group. Established in 1966, the plant produced its first vehicle, the Dacia 1100, in 1968. Today, it is an integrated industrial complex that includes assembly lines, a mechanical plant, and a massive logistics center. It produces iconic models like the Duster, Logan, and Jogger, with approximately 86% of its output exported to over 40 countries worldwide. The facility is renowned for its efficiency, rolling out a new car every 55 seconds. It celebrated a historic milestone in 2025 by producing its 8 millionth vehicle. Geography K8 — industrial production."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["The plant inaugurated production on August 20, 1968, with the Dacia 1100.", "Maximum production capacity reaches 350,000 vehicles per year.", "Produces one finished vehicle every 55 seconds during peak operations.", "Over 2.6 million units of the Dacia Duster have been produced at Mioveni.", "Exports approximately 86% of its total production to international markets.", "Reached the milestone of 8 million vehicles produced in April 2025."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "Continental AG's presence in Timișoara represents one of the most significant foreign investments in the Romanian high-tech sector. The site consists of two major divisions: a massive tire manufacturing plant and a sophisticated automotive electronics 'Mega Factory'. The tire plant, established in 1998, is one of the company's largest globally, producing millions of units for passenger cars and light trucks. The automotive electronics division specializes in advanced User Experience solutions, such as digital dashboards and control units for autonomous driving. Timișoara is also home to a major R&D center, making it a hub for automotive innovation in Eastern Europe. Geography K8 — technological development."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["The Timișoara tire plant produced its 300 millionth tire in October 2023.", "Annual production capacity for tires exceeds 16.5 million units.", "Over 600 million euros invested in the tire facility since its 1998 opening.", "The electronics 'Mega Factory' produces over 17 million components annually.", "Specializes in C-Shape digital displays and airbag control units.", "The site employs over 2,700 people in manufacturing and R&D roles."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "The Craiova automotive plant is a major industrial pillar in southern Romania, currently operated by Ford Otosan. Its history began in 1976 as Oltcit, a joint venture with Citroen, before becoming a Daewoo facility in the 1990s. Ford took over in 2008, transforming it into a world-class manufacturing site. Today, it produces popular models like the Ford Puma and the Transit Courier, including their fully electric versions. The plant is highly automated and integrated, featuring its own engine production line. As a major employer and exporter, the Craiova facility drives the regional economy and serves as a key production hub for Ford's European operations. Geography K8 — automotive industry."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Founded in 1976 as the Oltcit-Citroen joint venture plant.", "Ford Motor Company officially took over the facility in March 2008.", "Currently produces the Ford Puma, the best-selling Ford model in Europe.", "Production capacity stands at approximately 250,000 vehicles per year.", "Transitioned to Ford Otosan management in 2022 to boost efficiency.", "Employs approximately 6,000 people and hosts a major engine plant."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "Liberty Galați, formerly known as Sidex, is Romania's largest steel works and its only integrated metallurgical complex. Located on the banks of the Danube, it was built in the 1960s as a symbol of industrial independence. The site is so massive that it operates its own internal railway system. It produces a wide range of flat steel products, including galvanized and organic coated steel, used in construction, shipbuilding, and the automotive industry. Under Liberty Steel Group, the complex is undergoing a major transformation toward 'GREENSTEEL' production, aiming for carbon neutrality through the installation of modern electric arc furnaces. Geography K8 — heavy industry."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Construction began in 1960, with the first production starting in 1966.", "The site covers over 15 square kilometers, making it a city within a city.", "Production peaked in 1988 with over 8.2 million tonnes of liquid steel.", "Currently produces roughly 2-3 million tonnes of flat steel per year.", "Acquired by the Liberty Steel Group from ArcelorMittal in July 2019.", "Directly employs thousands of workers and supports the local economy."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "Aerostar Bacău is the leader of the Romanian aerospace and defense industry, with a heritage dating back to 1953. Originally established for military aircraft repairs, it has evolved into a global provider of aerospace manufacturing and maintenance services. The company is a key partner for Lockheed Martin, serving as a regional maintenance hub for F-16 fighter jets and HIMARS systems. Aerostar also produces millions of components for international civil aviation programs, including Airbus and Boeing. It is famous for producing over 1,800 Yak-52 trainer aircraft and for modernizing the MiG-21 LanceR fleet. Its expertise makes it a strategic asset for NATO defense. Geography K8 — aerospace industry."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Established in 1953 as the Aircraft Repair Factory (U.R.A.) in Bacău.", "Produced over 1,800 units of the Yak-52 aircraft for global markets.", "Functions as the official MRO center for Romania's F-16 fighter fleet.", "Produces over 6 million specialized parts annually for Airbus and Boeing.", "Opened Europe's first certified HIMARS sustainment center in 2024.", "Led the MiG-21 LanceR modernization program in the 1990s."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "Autoliv Romania, headquartered in Brașov, is a vital part of the world's largest automotive safety supplier. Since entering the Romanian market in 1997, it has expanded to include multiple high-tech plants across the country, with Brașov serving as its main hub. The facility produces critical safety components such as steering wheels, seat belts, and airbag modules for the world's leading car manufacturers. Known for its rigorous quality standards and innovation, Autoliv Romania employs over 10,000 people and operates advanced engineering centers. It plays a crucial role in the global supply chain, contributing to the goal of saving more lives on the road. Geography K8 — safety technology."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Autoliv started its operations in Romania in 1997 in Brașov.", "The company employs over 10,000 people across its Romanian locations.", "Brașov is the main production hub for high-quality steering wheels.", "Supplies safety systems to brands like BMW, Volkswagen, and Volvo.", "Romania hosts one of Autoliv's most advanced crash-test and R&D centers.", "Produces millions of airbag modules and seat belts annually for export."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "The Mintia-Deva Power Station was for decades one of Romania's most important energy producers. Located on the banks of the Mureș River, it was commissioned in 1969 as a coal-fired plant with a total installed capacity of 1,285 MW. For half a century, its iconic chimneys dominated the landscape and provided electricity to millions of homes and industries. The plant was decommissioned in 2021 due to environmental regulations. In 2022, it was acquired by Mass Group Holding with plans for a massive transformation into a modern, low-emission gas-fired power plant, representing one of the largest energy investments in the region. Geography K8 — energy production."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Commissioned in 1969 with an initial capacity of 210 MW per group.", "Reached a total installed capacity of 1,285 MW with six power units.", "The plant's main chimneys stand at a height of 220 meters.", "Historically fueled by coal from the nearby Jiu Valley mining region.", "Acquired in 2022 by Mass Group Holding for 91.2 million euros.", "The site is being converted into Europe's largest gas-fired power plant."]
    }
  },
  {
  ...
  ,
    descriptionAdvanced: {
      ...
      en: "The Reșița Steel Works is one of Europe's oldest industrial sites, with a history of metallurgical production dating back to 1771. For over 250 years, the foundries and mills of Reșița have shaped the industrial identity of the Banat region and Romania. Famous for building the first steam locomotives in Southeastern Europe, the site has survived multiple political eras. Today, the facility is specialized in high-quality steel production and seamless tubes, operating as part of the Artrom Steel Tubes group. It remains a symbol of technical continuity and resilience, blending its rich industrial heritage with modern steel-making technologies. Geography K8 — history of industry."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Industrial activity began in Reșița on July 3, 1771, with two furnaces.", "The first steam locomotive in Romania was built here in 1872.", "The site produced the steel for many iconic bridges across Europe.", "Currently part of the Artrom Steel Tubes group since 2023.", "The Reșița plant has over 250 years of uninterrupted industrial history.", "Specializes in high-purity steel for specialized industrial applications."]
    }
  },
  {
