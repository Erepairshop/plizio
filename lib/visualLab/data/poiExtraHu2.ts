...
export const poiExtraHu2: POI[] = [
  // HU-BU: Budapest
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A 527 méteres János-hegy Budapest legmagasabb pontja, a Budai-hegység koronázó csúcsa. A tetőn áll az 1910-ben Erzsébet királyné emlékére emelt neoromán Erzsébet-kilátó, amely 23 méter magas és 360 fokos panorámát kínál a városra. A csúcsra felvezet a Libegő, a kétszemélyes lánckerékpályás drótkötélpálya 1970 óta, valamint a Gyermekvasút, amelyet úttörő gyerekek üzemeltetnek 1948 óta. A hegy az UNESCO világörökség részét képező Budai-hegység természetvédelmi területén belül helyezkedik el.",
      ro: "Dealul János (János-hegy) este cel mai înalt punct al Budapestei, oferind o panoramă de neegalat asupra capitalei și a Munților Buda. Situat la o altitudine de 528 de metri, vârful este încununat de Turnul de observare Erzsébet, o capodoperă neoromanică construită în onoarea reginei Elisabeta (Sisi). Vizitatorii pot ajunge aici cu telescaunul (Libegő), care oferă o călătorie pitorească deasupra pădurii, sau cu Calea Ferată a Copiilor. Zona este o destinație de relaxare extrem de populară pentru locuitorii orașului, având numeroase trasee de drumeție care traversează păduri dese de stejar și fag. Este un loc simbolic unde natura se întâlnește cu istoria imperială, oferind aer curat și liniște la doar câțiva kilometri de centrul agitat. Geografia K7 – Forme de relief și turism montan.",
      en: "János Hill is the highest point in Budapest, reaching an elevation of 527 meters above sea level. Located in the 12th district within the Buda Mountains, it offers the most spectacular 360-degree panoramic view of the Hungarian capital. At its summit stands the Erzsébet Lookout Tower, a Neo-Romanesque masterpiece built between 1908 and 1910, named after Empress Elisabeth (Sisi). Visitors can reach the peak via the Zugliget Chairlift (Libegő), which has been operating since 1970, or by hiking through the dense forests. The hill is part of a protected natural area and serves as a major recreation hub for families and nature enthusiasts, featuring the nearby Children's Railway. Geography K7 — mountain ranges and peaks."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["János-hegy este cel mai înalt punct din Budapesta, având 528 de metri.", "Turnul Erzsébet a fost finalizat în 1910 și are o înălțime de 23,5 metri.", "Telescaunul Libegő a fost inaugurat în 1970 și are o lungime de 1040 de metri.", "Se spune că în zilele senine se pot vedea vârfurile Munților Tatra din Slovacia.", "Regina Elisabeta a vizitat vârful de mai multe ori în 1882 pentru a admira priveliștea.", "Traseul Căii Ferate a Copiilor trece pe la baza dealului János."],
      en: ["Highest point in Budapest at 527 meters elevation.", "Home to the 23-meter tall Erzsébet Lookout Tower built in 1910.", "Accessible by the Zugliget Chairlift (Libegő), traveling 1,040 meters.", "Named after Empress Elisabeth, who visited the site in 1882.", "Geologically composed of 200-million-year-old Dachstein limestone.", "Visible from up to 80 kilometers away on exceptionally clear days.", "The Children's Railway has a station nearby, operated by students since 1948.", "The lookout tower features four circular observation levels for tourists."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hármashatár-hegy 495 méteres csúcsa Budapest harmadik legmagasabb pontja, és Buda északnyugati peremén emelkedik. Nevét a 19. századi közigazgatási határáról kapta, amely Buda, Óbuda és Pesthidegkút községeket választotta el. Ma a hegy elsősorban a vitorlázó- és siklóernyős sportoké – ideális termikája miatt egész Európából érkeznek pilóták. A csúcsról a Duna-kanyar és a Dunántúli-középhegység is látható tiszta időben. A vidéket a Kék körtúra és számos turistautak hálózata szeli át.",
      ro: "Muntele Hármashatár-hegy, cu o înălțime de 495 de metri, este situat în partea de nord-vest a Budapestei. Numele său tradus înseamnă 'Muntele celor trei granițe', deoarece în secolul al XIX-lea marca punctul de întâlnire al orașelor Buda, Óbuda și satului Pesthidegkút. Astăzi, zona este extrem de populară printre pasionații de sporturi aerodinamice, precum parapanta și planorismul, datorită curenților de aer favorabili. Pe vârf se află un centru modern pentru vizitatori și numeroase trasee de drumeție care fac parte din Traseul Albastru Național maghiar. Vegetația este diversă, predominând pădurile de fag și gorun.",
      en: "Hármashatár Hill, standing at 495 meters, is the third highest point in Budapest and a landmark of the northern Buda Mountains. Its name, meaning 'Three Border Hill', originates from the 19th-century administrative boundary where the independent towns of Buda, Óbuda, and Pesthidegkút met. Today, the hill is world-renowned among gliding and paragliding enthusiasts due to its exceptional thermal updrafts. The summit features the Guckler Károly Lookout Tower, a modern wooden structure offering views of the Danube Bend and the Pilis Mountains. The National Blue Trail (Országos Kéktúra) crosses the peak, making it a vital junction for hikers. The plateau is characterized by unique dolomite-loving flora and sparse woodlands. Geography K7 — mountain ecosystems and thermal air currents."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Elevation of 495 meters above sea level in the Buda Hills.", "Marked the triple border of Buda, Óbuda, and Pesthidegkút until 1873.", "The first gliding club in Hungary was established here in 1933.", "Features the 360-degree Guckler Károly wooden lookout tower built in 2016.", "Composed mainly of Triassic dolomite rock with visible karst phenomena.", "Strategic military observation post during World War II and the Cold War.", "Key section of the 1,165 km long National Blue Trail hiking route.", "Home to the rare and protected Pannonian dry grassland flora."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A budai Sas-hegy egy 266 méter magas dolomitkiemelkedés, amely Budapest egyik legértékesebb természetvédelmi területe. A hegy különlegessége a jégkorszakból fennmaradt reliktum növénytársulásokban rejlik, amelyek a déli fekvésű, kopár sziklagyepeken találtak menedéket. Olyan ritka fajok élnek itt, mint a magyar gurgolya vagy az István király-szegfű. A terület 1958 óta áll védelem alatt, és ma látogatóközpont, valamint tanösvény segít megismerni az itteni ökoszisztémát. A csúcsról lenyűgöző panoráma nyílik a Gellért-hegyre, a Budai Várra és a pesti oldalra. Geológiailag a hegyet triász kori dolomit építi fel, amelynek porladó felszíne sajátos mikroklímát biztosít a hőt kedvelő hüllőknek, például a pannon gyíknak.",
      ro: "Dealul Sas-hegy, situat în inima Budei, este o rezervație naturală unică ce conservă ecosistemul original al zonei înainte de urbanizare. Cu o înălțime de 266 de metri, acest afloriment de dolomit găzduiește numeroase specii de plante și animale relicte, supraviețuitoare ale perioadelor glaciare. Din motive de conservare, vizitarea centrului rezervației este permisă doar în cadrul tururilor ghidate pe un traseu educațional amenajat. De pe platforma panoramică de pe vârf, vizitatorii pot admira Castelul Buda și Dealul Gellért dintr-o perspectivă inedită. Este un exemplu remarcabil de conservare a biodiversității într-un mediu urban dens.",
      en: "Sas Hill (Eagle Hill) is a 266-meter high dolomite formation and one of Budapest's most valuable nature reserves. Located in the heart of Buda, this 30-hectare site preserves a unique micro-ecosystem with plants and animals that are relicts from the Ice Age. The southern slopes receive intense sunlight, creating a warm habitat for rare species like the Pannonian lizard and the Hungarian Gurgolya plant. Since 1958, the area has been strictly protected, and access to the core area is restricted to guided tours on the 850-meter educational trail. The visitor center provides interactive displays about the hill's biodiversity. From the summit, visitors can enjoy a unique perspective of the Buda Castle and Gellért Hill. Nature Studies K3 — animal habitats and urban biodiversity."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Elevation of 266 meters, formed during the Triassic period.", "Declared a strictly protected nature reserve in 1958.", "Home to the endemic Hungarian Gurgolya (Seseli leucospermum) plant.", "Features an 850-meter long barrier-free panoramic educational trail.", "Houses a sensitive seismological station operated by the Eötvös Loránd University.", "Refuge for the rare Ablepharus kitaibelii lizard, an Ice Age survivor.", "The name 'Eagle Hill' supposedly dates back to the liberation of Buda in 1686.", "Visitor center offers interactive exhibitions on karst flora and fauna."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Naplás-tó, hivatalos nevén Szilas-pataki árvízvédelmi víztározó, Budapest legnagyobb kiterjedésű állóvize a XVI. kerületben. Az 1978-ban létrehozott mesterséges tó mára fontos ökológiai folyosóvá és természetvédelmi területté vált. A tó és környezete, a Cinkotai-erdővel együtt, számos védett madárfaj és hüllő, köztük a mocsári teknős egyik utolsó fővárosi menedékhelye. 2021-ben egy modern, 22 méter magas kilátót adtak át a tó partján, amely különleges faépítészeti megoldásaival a környék jelképévé vált. A terület népszerű a kirándulók, horgászok és kerékpárosok körében, mivel a városi környezetben is képes megőrizni természetközeli jellegét.",
      ro: "Lacul Naplás, situat în sectorul XVI al Budapestei, este cel mai mare lac stătător din capitală și face parte dintr-o zonă protejată de interes local. Creat artificial în 1978 prin bararea pârâului Szilas, lacul a devenit un refugiu crucial pentru biodiversitate, în special pentru păsările migratoare și broaștele țestoase de mlaștină. Zona este înconjurată de mlaștini și păduri, oferind un mediu propice pentru recreere, pescuit și observarea naturii. Recent, a fost construit un turn de observație modern din lemn, cu o arhitectură premiată, care oferă o vedere panoramică asupra lacului și a bazinului Szilas. Este considerat plămânul verde al părții de est a orașului.",
      en: "Lake Naplás, officially the Szilas Creek flood control reservoir, is the largest body of standing water in Budapest, located in the 16th district. Created in 1978, this 16-hectare man-made lake has evolved into a crucial ecological corridor and a protected nature reserve. Surrounded by the Cinkota Forest, it provides one of the last urban refuges for the European pond turtle and numerous migratory bird species. In 2021, a 22-meter tall modern wooden lookout tower was inaugurated on the lakeshore, offering panoramic views of the surrounding marshlands and the Szilas Basin. The area is a popular destination for cycling, fishing, and nature walks, successfully balancing urban recreation with habitat preservation. Nature Studies K3 — freshwater ecosystems and turtles."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Largest lake within Budapest city limits, covering 16 hectares.", "Built in 1978 as a reservoir to regulate Szilas Creek floods.", "Declared a locally protected nature reserve in 1997.", "Home to the largest population of European pond turtles in the region.", "Features a 22-meter high sustainable timber lookout tower built in 2021.", "Over 200 bird species have been recorded in the protected area.", "Surrounded by the 150-hectare Cinkota Forest and marshland system.", "The average water depth is approximately 2 meters throughout the basin."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Soroksári-Duna, vagy más néven Ráckevei-Duna, a folyam 58 kilométer hosszú mellékága, amely a Csepel-szigetet választja el a pesti oldaltól. A folyószakasz két zsilip, a Kvassay- és a Tassi-zsilip között helyezkedik el, ami lehetővé teszi a vízszint szabályozását és a lassú áramlást. Ez a nyugodt víztükör ideális feltételeket teremtett az úszólápok kialakulásához, amelyek Európa-szerte ritka természeti képződmények. A Soroksári-Duna partja mentén horgásztanyák, csónakházak és üdülőövezetek sorakoznak, jelentős rekreációs értéket képviselve a fővárosiak számára. Ökológiai szempontból kiemelkedő a nádasok és a vízi növényzet szerepe a biodiverzitás megőrzésében.",
      ro: "Brațul Soroksár al Dunării, cunoscut și sub numele de Dunărea Mică (Ráckevei-Duna), este un braț secundar al fluviului ce se întinde la sud de Budapesta. Cu o lungime de 57 de kilometri, acesta este separat de brațul principal prin insula Csepel și este controlat prin ecluze la ambele capete (Kvassay și Tass). Datorită curentului lent și a calității apei, este o destinație de top pentru canotaj, pescuit și sporturi nautice. Malurile sale sunt bogate în stufărișuri și zone umede protejate, adăpostind numeroase specii de pești și păsări de apă. Este considerat una dintre cele mai importante zone de agrement acvatic din regiunea centrală a Ungariei.",
      en: "The Soroksár Danube, also known as the Ráckeve Danube, is a 58-kilometer long side arm of the main river, separating Csepel Island from the Pester mainland. Regulated by the Kvassay Lock in the north and the Tass Lock in the south, this branch has a very slow current, making it an ideal habitat for unique aquatic life. It is famous for its extensive reed beds and rare floating bogs, which are considered ecological wonders in Europe. The calm waters are a paradise for anglers, rowers, and canoeists seeking recreation near the capital. Historically, the arm supported a thriving milling industry and local transport, but today its primary value lies in its biodiversity and leisure opportunities. Geography K7 — river regulation and side arms."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length of 58 kilometers between Budapest and Tass.", "Water levels are strictly controlled by the historic Kvassay Lock (1927).", "Features some of the largest floating bogs (úszóláp) in Central Europe.", "Average water depth ranges between 3 and 4 meters.", "Critical nesting site for kingfishers, bitterns, and various heron species.", "Home to over 20 fishing clubs and numerous traditional boathouses.", "The Molnár Island within the arm is a popular suburban excursion spot.", "Designated as an internationally important area for water sports and fishing."]
    }
  },
  // HU-BA: Baranya
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A 682 méter magas Zengő a Mecsek-hegység és egyben Baranya vármegye legmagasabb csúsa. A hegy nevét a néphit szerint a mélyéből hallatszó zengő hangról kapta, amelyet a népmesék a kincskereső pásztorok történetével magyaráznak. A hegytetőn 2020-ban adták át a modern, hét szintes kilátót, amely egy régi geodéziai torony köré épült, és pazar kilátást nyújt a Villányi-hegységre, sőt tiszta időben Horvátországig is ellátni. A Zengő északi oldala ad otthont a világszerte ritka bánáti bazsarózsa állományának több mint 90 százalékának. A hegy történelmébe bevonult a 'zengői csata' is, amikor a helyi lakosok és természetvédők megakadályozták egy NATO-radarállomás felépítését.",
      ro: "Vârful Zengő este cel mai înalt punct al munților Mecsek din sudul Ungariei, atingând o altitudine de 682 de metri. Situat în județul Baranya, muntele este încărcat de legende locale, numele său însemnând 'Cel care răsună'. Pe vârful muntelui se află ruinele unei cetăți medievale și un turn de observație modern din oțel, construit în 2020, care oferă o panoramă până la munții din Croația. Versanții sunt acoperiți de păduri de fag și gorun, adăpostind specia rară de bujor de munte (Paeonia officinalis banatica), care înflorește în luna mai. Este o destinație iconică pentru drumeții în Transdanubia de Sud.",
      en: "Zengő is the highest peak of the Mecsek Mountains and Baranya County, reaching an elevation of 682 meters. Its name, meaning 'Resonant', comes from local folklore claiming that a booming sound can sometimes be heard from within the mountain. The summit is crowned by a 22-meter high modern lookout tower, opened in 2020, providing views as far as Croatia and Lake Balaton on clear days. The mountain is world-famous for its northern slopes, which host 90% of the global population of the rare Banat Peony. In 2004, the site was the center of the 'Battle of Zengő', a successful environmental protest that prevented the construction of a NATO radar station. Geography K7 — mountain ranges and flora preservation."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Zengő 682 méteres magasságával a Mecsek csúcspontja.", "A hegyen található a világ bánáti bazsarózsa-állományának 90%-a.", "Az új, 22 méteres kilátót 2020 júliusában adták át.", "A hegytetőn egy 13. századi vár romjai is felfedezhetők.", "A 'zengői csata' néven ismert civil ellenállás 2004-ben zajlott.", "Húsvéthétfőn rendezik meg a hagyományos Zengő-túrát.", "A hegyet főként tölgy- és bükkerdők borítják a lejtőkön.", "A csúcsról látható a horvátországi Papuk-hegység is tiszta időben."],
      ro: ["Altitudinea maximă este de 682 de metri.", "Aici crește 90% din populația mondială de Paeonia officinalis banatica.", "Noul turn de observație are o înălțime de 22 de metri.", "Ruinele cetății Zengővár datează probabil din secolul al XIII-lea.", "Muntele este compus în principal din calcar jurasic.", "În 2004, localnicii au oprit cu succes construcția unui radar NATO aici."],
      en: ["Highest point of the Mecsek Mountains at 682 meters elevation.", "Host to 90% of the world's population of the rare Banat Peony (Paeonia banatica).", "The 22-meter tall, seven-story lookout tower was completed in July 2020.", "Contains the ruins of a small 13-century medieval castle at the summit.", "Site of a major 2004 environmental protest against a NATO radar facility.", "Traditional 'Zengő Hike' takes place every year on Easter Monday.", "Composed primarily of Jurassic limestone and volcanic rocks.", "Offers visibility of the Papuk Mountains in Croatia on clear days."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tubes a Mecsek középső részének egyik legnépszerűbb csúcsa, amely 611 méterrel magasodik Pécs városa fölé. Nevét egyes feltételezések szerint a területen egykor élt népcsoportról vagy egy régi földrajzi elnevezésről kapta. A hegytetőn áll a János-kilátó, amelyet 2001-ben építettek újjá, és amelyről körpanoráma nyílik a baranyai dombságra és a Dráva völgyére. A Tubes környéke különleges szubmediterrán mikroklímával rendelkezik, ahol olyan ritka növények élnek, mint a magyar zergevirág. A hegy a pécsiek egyik kedvenc kirándulóhelye, számos turistaút és a híres Misina-tetői tévétoronyhoz vezető ösvény érinti a csúcsot.",
      ro: "Muntele Tubes, cu o înălțime de 611 metri, este al doilea vârf ca mărime din masivul Mecsek, situat deasupra orașului Pécs. Este renumit pentru Turnul de observație János-kilátó, o structură de piatră construită în 2001, care înlocuiește o construcție mai veche. De aici se deschide o priveliște impresionantă asupra orașului Pécs, a bazinului Dráva și, în condiții meteorologice bune, până la muntele Papuk din Slavonia. Flora este caracterizată prin influențe sub-mediteraneene, cu specii de plante termofile care nu se găsesc în alte părți ale Ungariei. Rețeaua densă de trasee turistice face din Tubes un centru vital pentru turismul activ regional.",
      en: "Tubes is a 611-meter high peak in the central Mecsek Mountains, standing directly above the city of Pécs. It is the second highest point of the range and a favorite destination for local hikers. The summit features the János Lookout Tower, a stone structure rebuilt in 2001, offering a 360-degree panorama of the Baranya hills and the Dráva Valley. The area is characterized by a unique sub-Mediterranean micro-climate, supporting heat-loving plants like the Hungarian Doronicum. Tubes is connected to the famous Misina TV Tower by a scenic ridge trail. Historically, its strategic position made it a key site for regional surveillance and defense since medieval times. Geography K7 — micro-climates and central mountain ranges."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Elevation of 611 meters above sea level overlooking Pécs.", "The 2001 stone lookout tower replaces a previous wooden structure.", "Located on the E7 European long-distance hiking trail.", "Features rare sub-Mediterranean flora, including Ruscus aculeatus.", "The name is likely of Slavic origin, possibly meaning 'oak mountain'.", "Strategic fire monitoring and regional radio communication hub.", "Direct ridge connection to the 197-meter tall Pécs TV Tower.", "Composed of Jurassic limestone with characteristic karst formations."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Jakab-hegy a Mecsek nyugati vonulatának legmagasabb tömbje, amely 602 méteres magasságával és vörös homokkő szikláival emelkedik ki környezetéből. A hegy platóján található Magyarország egyik legnagyobb vaskori földvára, amelynek hatalmas sáncai ma is jól kivehetőek. A Jakab-hegy spirituális és történelmi jelentőségét a 13. században alapított pálos kolostor romjai is emelik, amely az egyetlen magyar alapítású szerzetesrend központja volt. A hegy déli oldalán található látványos sziklaalakzatok, mint a Zsongorkő vagy a Babás-szerkövek, a helyi legendák szerint elátkozott násznépek kővé vált alakjai. Geológiailag a hegy a perm időszaki vörös homokkőről nevezetes, amely egyedülálló a régióban.",
      ro: "Dealul Jakab-hegy (Muntele lui Iacob) este o formațiune geografică distinctivă în partea de vest a munților Mecsek, atingând 602 metri. Este celebru pentru formațiunile sale geologice spectaculoase din gresie roșie, cum ar fi 'Babás-szerkövek' (Pietrele Păpușilor) și 'Zsongorkő' (Piatra lui Zsongor). Pe platoul său se află ruinele unei mănăstiri pauline fondate în 1225 și rămășițele unei cetăți imense din epoca fierului, atribuită culturii Hallstatt. Pădurile de castan comestibil și flora specifică solului acid conferă zonei un caracter aparte. Jakab-hegy combină în mod armonios valorile geologice, istorice și peisagistice ale regiunii Baranya.",
      en: "Jakab Hill is the most mystical block of the western Mecsek Mountains, rising 602 meters with unique red sandstone formations. Geologically distinct, it is composed of 250-million-year-old Permian sandstone, giving the rocks a characteristic reddish hue. The plateau hosts one of Hungary's largest Iron Age hillforts, with over 5 kilometers of massive earthen ramparts still visible. The hill's spiritual significance is highlighted by the ruins of a 13th-century Pauline monastery, the only monk order founded in Hungary. Spectacular rock formations like the 'Babás-szerkövek' (Dolls' Rocks) offer breathtaking views of the Dráva Plain. History K5 — Iron Age settlements and religious orders."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Elevation of 602 meters, unique for its Permian red sandstone.", "Contains an Iron Age hillfort with ramparts enclosing over 50 hectares.", "The Pauline monastery was founded in 1225 by Bishop Bartholomew of Pécs.", "Features the Zsongorkő viewpoint, the most spectacular in the Mecsek.", "Home to the 'Babás-szerkövek' erosion-carved rock formations.", "Contains the only sandstone cave in the entire Mecsek range.", "Part of the Western Mecsek Landscape Protection Area since 1978.", "Traversed by the Rockenbauer Pál South Transdanubian Blue Trail."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Fekete-víz a Baranyai-síkság legfontosabb vízfolyása, amely a Mecsek déli lábánál ered és mintegy 45 kilométer után ömlik a Drávába. Neve a víz sötét színére utal, amelyet a mocsaras, tőzeges területekről kimosott huminsavak okoznak. A folyó határozta meg évszázadokon át az Ormánság arculatát; a szabályozások előtt hatalmas áradásokkal tartotta fenn a környék mocsárvilágát. Ez az elszigeteltség segített megőrizni a régió egyedülálló népi építészetét, a talpasházakat és a festett kazettás templomokat. Ma a Fekete-víz fontos ökológiai folyosó, amely a szárazabb mezőgazdasági területek között biztosít életteret a vízi élővilág számára.",
      ro: "Râul Fekete-víz (Apa Neagră) este un curs de apă important din sudul Transdanubiei, traversând regiunea istorică Ormánság din județul Baranya. Acesta colectează apele din versanții sudici ai munților Mecsek și se varsă în fluviul Dráva. Numele său provine de la culoarea închisă a apei, cauzată de sedimentele organice din zonele mlăștinoase pe care le străbate. Istoric, râul a jucat un rol vital în viața comunităților locale, furnizând pește și apă pentru agricultură. Astăzi, cursul său este în mare parte regularizat, dar păstrează încă porțiuni naturale cu o bogată floră și faună acvatică, fiind monitorizat pentru protecția ecosistemelor de luncă.",
      en: "The Fekete-víz (Black Water) is the primary watercourse of the Baranya Plain in southern Hungary, flowing 45 kilometers from the foot of the Mecsek to the Drava River. Its name refers to the dark color of the water, caused by humic acids washed out from the marshy and peaty areas it crosses. Historically, this river defined the Ormánság region; before modern regulation, its frequent floods maintained a vast swampland that isolated the area, helping preserve unique folk architecture and painted wooden churches. Today, the river serves as a vital ecological corridor through agricultural lands and an important drainage system for the plain. Geography K7 — river basins and cultural landscapes."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length of 45 kilometers, a left-bank tributary of the Drava.", "The dark water color stems from high organic humic content in peaty soil.", "Lifeline of the historically isolated Ormánság marshland region.", "Catchment area covers over 1,300 square kilometers of southern Baranya.", "Critical habitat for the European otter (Lutra lutra).", "Malurian reed beds along the banks support rare marshland bird species.", "The river's name was first recorded in 13th-century charters.", "Key component of modern flood management in the Baranya Plain."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az orfűi tórendszer a Mecsek északi lábánál fekvő mesterséges víztározók láncolata, amely az 1960-as években jött létre. A négy tóból (Orfűi-tó, Pécsi-tó, Herman Ottó-tó, Kovácsszénájai-tó) álló rendszer minden eleme más funkciót tölt be: a fürdőzéstől és vízisportoktól kezdve a horgászaton át a szigorú természetvédelemig. A központi Pécsi-tó 72 hektáros vízfelületével a régió legnagyobb strandolóhelye. Orfű mára nemcsak turisztikai központ, hanem kulturális helyszín is, itt rendezik meg minden évben a népszerű 'Fishing on Orfű' zenei fesztivált. A tavakat tápláló karsztforrások vize kiváló minőségű, a környék pedig hegyvidéki bájával vonzza a kikapcsolódni vágyókat.",
      ro: "Sistemul de lacuri de la Orfű, situat în inima munților Mecsek la nord de Pécs, este una dintre cele mai populare zone de agrement din sudul Ungariei. Acesta cuprinde patru lacuri artificiale: Orfűi-tó, Pécsi-tó, Hermann Ottó-tó și Kovácsszénájai-tó, create în anii 1960 prin bararea pârâului Vízfő. Cel mai mare și mai cunoscut este Lacul Pécsi, centrul sporturilor nautice, al navigației și al festivalurilor de vară. Lacul Orfűi este destinat în principal scăldatului, având o plajă amenajată, în timp ce celelalte două lacuri sunt rezervații pentru pescuit și protecția naturii. Zona este înconjurată de dealuri împădurite, oferind un microclimat plăcut și numeroase facilități turistice.",
      en: "The Orfű lake system is a chain of four man-made reservoirs at the northern foot of the Mecsek Mountains, created in the 1960s. The system includes Lake Orfű, Lake Pécsi, Lake Herman Ottó, and Lake Kovácsszénájai, each serving a different purpose ranging from recreation and water sports to strict nature conservation. Lake Pécsi, with its 72-hectare surface, is the largest swimming and sailing center in the region. Orfű has become a cultural hotspot, hosting the popular 'Fishing on Orfű' music festival annually. Fed by high-quality karst springs, the lakes offer clean water and a picturesque mountain setting. Nature Studies K3 — artificial lakes and water management."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Comprises four functional lakes created by damming the Vízfő spring.", "Lake Pécsi is the largest at 72 hectares with a depth of 10-12 meters.", "Lake Herman Ottó serves as a strictly protected bird sanctuary.", "Home to Hungary's only functioning ship mill museum.", "Host of the 'Fishing on Orfű' festival, established in 2008.", "The water is supplied by the permanent Vízfő karst spring.", "Features a 5-kilometer long cycling path encircling the lakes.", "Summer water temperatures in Lake Orfű often reach 26 degrees Celsius."]
    }
  },
  // HU-BK: Bács-Kiskun
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kunfehértói-tó Bács-Kiskun vármegye egyik legkedveltebb természetes fürdőhelye, amely a Kiskunsági-homokhátság mélyedésében alakult ki. A tó vize enyhén sós és alkáli-karbonátos, amelynek gyógyhatást tulajdonítanak, különösen bőrbántalmak és reumatikus panaszok esetén. Különlegessége az úgynevezett 'erdős strand', ahol hatalmas, évszázados kocsányos tölgyek és fenyők nyújtanak természetes árnyékot közvetlenül a vízparton. A tó környezete Natura 2000-es védettség alatt áll, megőrizve a homokpusztai élővilág ritkaságait. A nyári szezonban a tópart fesztiválok és táborok helyszíne, miközben a környékbeli erdők kiváló túrázási lehetőséget biztosítanak.",
      ro: "Lacul Kunfehér-tó este o bijuterie naturală situată în județul Bács-Kiskun, în apropierea localității Kunfehértó. Acest lac salin de origine naturală este renumit pentru calitățile sale terapeutice și pentru apa sa limpede, fiind înconjurat de o pădure de pini și stejari care creează un cadru pitoresc. Zona este o destinație tradițională de vacanță, oferind plaje cu nisip, terenuri de sport și locuri de campare. Pe lângă valoarea recreativă, lacul și împrejurimile sale sunt importante din punct de vedere ecologic, adăpostind specii de plante adaptate solului nisipos și sărat. Este un exemplu perfect de oază de relaxare în marea câmpie a Ungariei (Alföld).",
      en: "Lake Kunfehértó is one of the most popular natural bathing sites in Bács-Kiskun County, formed in a natural wind-carved depression of the Kiskunság sand ridge. The lake's water is slightly salty and alkaline, traditionally credited with healing properties for skin conditions and rheumatic complaints. Its unique feature is the 'forest beach', where centennial pedunculate oaks and pines provide natural shade right at the water's edge, a rarity in the hot Puszta region. The environment is protected under the Natura 2000 network, preserving rare sand-steppe wildlife. In summer, it hosts youth festivals and camps. Nature Studies K3 — salt lakes and sand habitats."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tó vize nátrium-hidrogénkarbonátban gazdag, enyhén sós.", "A strandot egy 120 hektáros kocsányos tölgyerdő övezi.", "A Kunfehértói-tó átlagos mélysége mindössze 1,5-2 méter.", "A terület a Kiskunsági Nemzeti Park hatókörébe tartozik.", "A tómeder természetes szélvájta mélyedésben jött létre.", "Évente megrendezik itt a Kunfehértói Nyár kulturális programsorozatot.", "A part menti homokdűnéken ritka homoki árvalányhaj díszlik.", "A tó közelében modern ifjúsági tábor és kemping üzemel."],
      ro: ["Suprafața lacului este de aproximativ 4 hectare.", "Pădurea din jurul lacului este o rezervație naturală protejată.", "Aici crește specia rară de brândușă Colchicum arenarium.", "Lacul este alimentat în principal de apele subterane și precipitații.", "Nivelul de salinitate al apei variază în funcție de anotimp.", "Este un loc popular pentru observarea păsărilor de stepă."],
      en: ["Slightly saline water rich in sodium bicarbonate.", "Beach area is surrounded by a 120-hectare pedunculate oak forest.", "Average depth is shallow, ranging between 1.5 and 2 meters.", "Part of the Kiskunság National Park's ecological monitoring zone.", "The lake bed was formed naturally by wind erosion in sand dunes.", "Host to the 'Kunfehértó Summer' cultural event series.", "Home to the rare and protected sand-dwelling Colchicum arenarium.", "Features a modern youth camp and camping facility near the shore."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szelidi-tó Dunapataj közelében található, és Magyarország ötödik legnagyobb természetes tava. Ez a 5 kilométer hosszú, kanyargós állóvíz a Duna egy elhagyott medréből alakult ki évezredekkel ezelőtt. A tó vize különleges: magas nátrium-magnézium-karbonát tartalma miatt szikes jellegű, de nem sós, és selymes tapintású. Gyógyhatása miatt régóta kedvelt üdülőhely, különösen az idegrendszeri és ízületi bántalmak enyhítésére ajánlják. A déli parton kiépített strand, vendéglátóhelyek és kempingek várják a nyaralókat, míg az északi rész érintetlenebb természetvédelmi terület. A tó medre helyenként a 4 méteres mélységet is eléri, ami a magyarországi tavak között jelentősnek számít.",
      ro: "Lacul Szelidi este al cincilea lac ca mărime din Ungaria și cel mai mare lac de tip 'meandru părăsit' din bazinul Dunării. Situat în județul Bács-Kiskun, lângă Dunapataj, lacul are o formă alungită, cu o lungime de 4 kilometri, și s-a format dintr-un vechi braț al fluviului. Este renumit pentru conținutul ridicat de magneziu și carbonat de sodiu al apei, care îi conferă proprietăți curative pentru afecțiunile reumatice și dermatologice. Fundul lacului este acoperit cu nisip fin, ceea ce îl face ideal pentru scăldat. Zona este protejată ca rezervație naturală, conservând flora și fauna specifică zonelor umede de câmpie.",
      en: "Lake Szelid, located near Dunapataj, is the fifth largest natural lake in Hungary and a former dead arm of the Danube. This 5-kilometer long, winding body of water formed thousands of years ago when the river changed its course. The water is unique: its high sodium-magnesium carbonate content gives it an alkaline character and a silky feel. Renowned for its medicinal properties, it is recommended for treating nervous and joint disorders. The southern shore features developed beaches and campsites, while the northern part remains an untouched nature reserve. It reaches depths of 4 meters, which is significant for Hungarian plain lakes. Nature Studies K3 — oxbow lakes and alkaline water."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length of 5 kilometers with a surface area of 80 hectares.", "The largest 'dead arm' lake in the Danube basin of Hungary.", "Maximum depth reaches 4 meters at specific points in the old bed.", "Features the 2.4-kilometer 'Blue Castle' educational nature trail.", "High concentration of magnesium and sodium (approx. 1.5 g/liter).", "Summer water temperatures often reach 28 degrees Celsius.", "Protected as a national nature reserve since 1976.", "Adjacent to an archaeological site from the Avar period."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Izsák mellett fekvő Kolon-tó a Kiskunsági Nemzeti Park egyik legértékesebb vizes élőhelye és UNESCO bioszféra-rezervátum. Bár tónak nevezik, ma már inkább egy hatalmas, összefüggő nádas-mocsaras terület, amely a Duna egykori medrében, a homokbuckák között alakult ki. Európai jelentőségű madárrezervátum, ahol olyan ritka fajok költenek, mint a nagy kócsag, a kanalasgém és a cigányréce. A területen található Magyarország legnagyobb orchidea-állománya is, köztük a mocsári nőszőfűvel. A látogatók számára madármegfigyelő tornyok és a Bikatorok tanösvény biztosít betekintést ebbe a rejtett vízi világba anélkül, hogy zavarnák a kényes ökológiai egyensúlyt.",
      ro: "Lacul Kolon, situat lângă localitatea Izsák, este cea mai mare mlaștină cu apă dulce din Europa Centrală și face parte din Parcul Național Kiskunság. Deși este numit 'lac', acesta este în mare parte acoperit de stufărișuri întinse și zone de mlaștină, fiind un paradis pentru ornitologi. Zona este un sit de importanță internațională pentru cuibărirea păsărilor de apă și un punct cheie pe rutele de migrație. Rezervația adăposteste specii rare de orhidee și pești endemici. Vizitatorii pot explora zona prin trasee educaționale și turnuri de observație, care oferă o privire de ansamblu asupra acestui peisaj sălbatic și nealterat, reprezentativ pentru vechea câmpie maghiară.",
      en: "Lake Kolon near Izsák is one of Central Europe's most valuable freshwater wetlands and a UNESCO Biosphere Reserve. Although called a lake, it is now primarily a vast system of reed beds and marshes formed in a former bed of the Danube among sand dunes. It is a bird sanctuary of European importance, where rare species like the great egret, spoonbill, and ferruginous duck breed. The area also hosts Hungary's largest marsh orchid population, including the marsh helleborine. Visitors can explore this hidden world via the Bikatorok lookout tower and educational trails without disturbing the delicate balance. Nature Studies K3 — marshlands and biosphere reserves."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Protected area covers approximately 3,000 hectares of wetland.", "Designated as a UNESCO Biosphere Reserve and Ramsar site.", "Home to Hungary's largest contiguous marsh orchid field.", "Over 200 bird species have been recorded in the marsh system.", "Features the 10-meter high Bikatorok lookout with views of the reeds.", "Strategic stopover for thousands of cranes during autumn migration.", "Contains rare post-glacial bog birch and willow swamp forests.", "Part of the Kiskunság National Park since its founding in 1975."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Bugaci puszta a Kiskunsági Nemzeti Park leglátogatottabb területe, ahol a magyar alföldi pásztorhagyományok a mai napig elevenen élnek. A hatalmas legelőkön magyar szürkemarha-gulyák, rackanyájak és ménesek legelnek, őrizve a puszta archaikus arculatát. Bugac nemzetközi hírnevét látványos lovasbemutatóinak és a kétévente megrendezett Kurultájnak, a hun és türk tudatú népek legnagyobb törzsi gyűlésének köszönheti. A terület ökológiailag is sokszínű: az ősborókás homokbuckák és a szikes laposok egyedülálló élővilágnak adnak otthont. A Pásztormúzeum egy kör alakú épületben mutatja be a kiskunsági csikósok és gulyások életmódját, használati tárgyait.",
      ro: "Bugac este una dintre cele mai cunoscute și extinse regiuni ale Parcului Național Kiskunság, reprezentând simbolul vieții tradiționale de păstor din Ungaria. Peisajul este un amestec fascinant de dune de nisip mișcătoare, pajiști întinse și păduri de ienupăr. Aici se află Muzeul Păstorilor (Pásztormúzeum), găzduit într-o clădire cu arhitectură organică, unde sunt prezentate uneltele și modul de viață al nomazilor din secolele trecute. Vizitatorii pot asista la spectacole ecvestre impresionante cu cai Lipițani și pot vedea animale autohtone precum vitele Sure maghiare și oile Racka. Bugac este, de asemenea, locul de desfășurare a Kurultáj-ului, cea mai mare adunare a popoarelor turcice din Europa.",
      en: "Bugac Puszta is the most visited part of the Kiskunság National Park, where Hungarian Great Plain shepherd traditions remain vibrantly alive. Vast pastures are home to herds of Hungarian Grey cattle, Racka sheep, and horses, preserving an archaic landscape. Bugac gained international fame for its spectacular equestrian shows and the biennial Kurultáj, the largest tribal gathering of people with Hun and Turkic roots. The area is ecologically diverse, featuring ancient juniper sand dunes and saline flats. The Shepherd Museum, housed in a circular building, showcases the lifestyle and tools of local horsemen. Nature Studies K3 — shepherd culture and steppe wildlife."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Core area of the Kiskunság National Park covering 11,000 hectares.", "Host of the Kurultáj tribal gathering, attracting 200,000+ visitors.", "Features unique ancient juniper (Juniperus communis) sand dunes.", "The Shepherd Museum was built in 1933 in the heart of the puszta.", "Home to pure-bred Hungarian Grey cattle and Racka sheep herds.", "The 'Hungarian Post' five-horse stunt is a signature of local riders.", "Part of the UNESCO Biosphere Reserve network since 1979.", "Includes archaeological ruins of a significant medieval monastery."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Duna–Tisza-csatorna egy grandiózus, de befejezetlen vízépítési projekt, amelynek célja a két legnagyobb magyar folyó hajózható összekötése volt. A csatorna gondolata már a 18. században felmerült, de a munkálatok csak a 20. században kezdődtek el, majd több alkalommal félbeszakadtak. Jelenleg a csatorna kiépített szakaszai fontos szerepet játszanak a Kiskunság vízpótlásában, az öntözésben és a belvízvédelemben. A csatorna mentén sűrű nádasok és fűzfák alakultak ki, amelyek gazdag halállománynak (ponty, csuka, keszeg) és madárvilágnak adnak otthont. A lassan mozgó víz és a csendes partvidék népszerű a horgászok és a természetjárók körében, akik az Alföld nyugodt arcát keresik.",
      ro: "Canalul Dunăre-Tisa este o lucrare hidrotehnică majoră din centrul Ungariei, concepută inițial pentru a asigura o cale navigabilă între cele două mari fluvii ale țării. Deși proiectul de navigație nu a fost niciodată finalizat complet, canalul joacă astăzi un rol esențial în irigarea regiunii Kiskunság și în managementul resurselor de apă. Acesta traversează peisaje variate, de la terenuri agricole fertile până la zone cu soluri nisipoase, contribuind la menținerea echilibrului ecologic în zonele umede adiacente. Malurile sale sunt locuri preferate de pescari, oferind un habitat liniștit pentru diverse specii de pești de apă dulce. Este un simbol al eforturilor umane de a controla și distribui apa în regiunile aride ale câmpiei.",
      en: "The Danube–Tisza Canal is a grandiose but unfinished hydraulic engineering project aimed at creating a navigable waterway between Hungary's two largest rivers. The concept dates back to the 18th century, but construction only began in the 20th century and was interrupted multiple times. Currently, the completed sections play a vital role in providing water to the Kiskunság ridge, supporting irrigation and inland flood protection. Dense reed beds and willow trees have formed along the canal, providing habitat for carp, pike, and diversas bird species. The slow-moving water and quiet banks are popular with anglers seeking the tranquility of the Great Plain. Geography K7 — artificial waterways and irrigation."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Plan originally discussed during the reign of Empress Maria Theresa.", "The section between Dunaharaszti and Dabas is the most developed.", "Average width of the canal bed is 25-30 meters in main sections.", "Crucial for supplying water to the arid Kiskunság sand ridge.", "Average water depth varies between 1.5 and 2.5 meters.", "Home to the protected bittern (Botaurus stellaris) in the reeds.", "Features multiple lock systems to regulate regional water levels.", "Known as an excellent fishing spot for grass carp and common carp."]
    }
  },
  // HU-BE: Békés
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hármas-Körös Délkelet-Magyarország egyik legszebb és legtermészetesebb folyója, amely Gyomaendrőd közelében jön létre a Kettős- és a Sebes-Körös egyesüléséből. A folyó 91 kilométeren keresztül kanyarog, amíg Csongrádnál a Tiszába ömlik. Különlegessége a rendkívül gazdag holtágrendszer, amely a 19. századi folyószabályozások során jött létre, és mára horgászparadicsommá vált. A Hármas-Körös mentén található hullámtéri erdők az Alföld egyik utolsó érintetlen erdőfoltjai, ahol fekete nyárak és füzek dominálnak. A folyó kiválóan alkalmas vízitúrázásra, mivel lassú folyása és tiszta vize biztonságos és látványos evezést tesz lehetővé a természetbarátok számára.",
      ro: "Râul Hármas-Körös (Crișul Triplu) se formează prin confluența Crișului Dublu și a Crișului Repede în apropiere de Gyomaendrőd. Acesta este cursul inferior al sistemului hidrografic al Crișurilor, șerpuind prin județele Békés și Jász-Nagykun-Szolnok până la vărsarea în Tisa la Csongrád. Râul este celebru pentru numeroasele sale meandre și brațe moarte, care alcătuiesc un peisaj natural sălbatic și spectaculos. Zona este protejată în cadrul Parcului Național Criș-Tisa, fiind un refugiu pentru nenumărate specii de păsări și pești. Datorită curentului liniștit, este o destinație ideală pentru turismul cu barca, oferind liniște și o conexiune profundă cu natura neatinsă.",
      en: "The Hármas-Körös (Triple Koros) is one of southeastern Hungary's most beautiful and natural rivers, formed near Gyomaendrőd by the union of the Kettős and Sebes-Körös rivers. It meanders for 91 kilometers until it flows into the Tisza at Csongrád. It is famous for its extensive system of oxbow lakes, created during 19th-century regulations, which have become a paradise for anglers. The floodplain forests along the Hármas-Körös are among the last untouched woodlands of the Great Plain, dominated by black poplars and willows. The river is excellent for water tours, as its slow current and clean water offer safe and scenic rowing. Geography K7 — floodplains and oxbow lakes."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A folyó teljes hossza 91 kilométer az egyesüléstől a torkolatig.", "A Hármas-Körös a Tisza bal oldali mellékfolyója Csongrádnál.", "A folyó mentén található holtágak száma meghaladja a 20-at.", "A hullámtér a Körös-Maros Nemzeti Park védelme alatt áll.", "Gyakori halfajai a harcsa, a süllő és a paduc.", "A folyó partján fekszik a híres szarvasi Arborétum.", "A vízszintet a békésszentandrási duzzasztómű szabályozza.", "Itt található Magyarország egyik leghosszabb gátrendszere."],
      ro: ["Lungimea cursului este de 91,3 kilometri.", "Se varsă în râul Tisa în dreptul orașului Csongrád.", "Formează peste 30 de brațe moarte de-a lungul cursului său.", "Bazinul hidrografic este extrem de bogat în biodiversitate.", "Digurile de protecție au fost construite la sfârșitul secolului al XIX-lea.", "Este o rută populară pentru competițiile internaționale de canotaj."],
      en: ["Total length of 91 kilometers from confluence to the Tisza.", "A left-bank tributary of the Tisza river joining at Csongrád.", "Features over 20 major oxbow lakes along its course.", "Protected within the Körös-Maros National Park system.", "Common fish species include wels catfish, zander, and nase.", "The famous Szarvas Arboretum is located along its banks.", "Water levels are regulated by the Békésszentandrás dam.", "Part of one of the longest levee systems in Hungary."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Sebes-Körös neve hűen tükrözi a folyó karakterét: a többi alföldi vízfolyáshoz képest jelentősen gyorsabb sodrású és tisztább vizű. Erdélyből, a Király-hágó mellől érkezik, és jelentős mennyiségű hordalékot, kavicsot szállít a síkságra. Magyarországi szakasza Gyomaendrőd környékén ér véget, ahol a Kettős-Körössel egyesülve alkotják a Hármas-Köröst. A folyó oxigéndús vize olyan halfajoknak is életteret biztosít, amelyek ritkák a lassabb alföldi vizekben, mint például a sebes pisztráng a felsőbb szakaszokon vagy a domolykó. A partmenti löszfalakban fészkelnek a színpompás gyurgyalagok és a jégmadarak, a kavicsos zátonyok pedig népszerű fürdőhelyek a nyári melegben.",
      ro: "Râul Sebes-Körös (Crișul Repede) este unul dintre cele mai importante cursuri de apă din estul Ungariei, originar din Munții Apuseni din România. După ce intră pe teritoriul maghiar la Körösszakál, râul traversează județele Hajdú-Bihar și Békés. Spre deosebire de celelalte brațe ale Crișurilor, acesta are o viteză de curgere mai mare în porțiunea superioară, de unde și numele său. Râul joacă un rol vital în ecosistemul regional, alimentând numeroase canale de irigații și bălți de pește. Malurile sale sunt adesea acoperite de păduri de luncă, fiind zone ideale pentru pescuit, observarea păsărilor și recreere activă în natură.",
      en: "The Sebes-Körös (Fast Koros) lives up to its name with a significantly faster current and clearer water compared to other rivers of the Great Plain. Arriving from the Apuseni Mountains in Transylvania, it brings cool, oxygen-rich water and significant sediment to the lowlands. Its Hungarian section ends near Gyomaendrőd, where it joins the Kettős-Körös to form the Hármas-Körös. The river's high oxygen level supports fish species rare in slower lowland waters, such as trout in upper sections and chub. Colorful bee-eaters and kingfishers nest in the riverside loess walls, while gravel bars are popular for swimming in summer. Geography K7 — river speed and sediment transport."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length of 209 km, with 59 km located within Hungary.", "Characterized by a gravel bed and higher gradient than typical plain rivers.", "Regarded as having some of the cleanest river water in the Great Plain.", "Forms the Hármas-Körös upon joining the Kettős-Körös at Gyomaendrőd.", "Nesting site for the protected European bee-eater in loess cliffs.", "Major source of irrigation for the eastern Hungarian counties.", "Serves as a border river between Hungary and Romania in sections.", "Known for its populations of barbel and various rare caddisfly species."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Biharugrai-tavak Magyarország második legnagyobb mesterséges halastórendszere, amely Békés vármegye keleti szélén, a román határ mentén terül el. Az egykori hatalmas mocsárvilág, a Sárrét maradványaként kialakított tavak mára nemzetközi jelentőségű madárrezervátummá váltak. A több mint 1900 hektárnyi vízfelület a vonuló madarak, különösen a vadludak, darvak és kanalasgémek egyik legfontosabb európai állomása. A Körös-Maros Nemzeti Park részeként a területen madármegfigyelő tornyok és tanösvények várják az érdeklődőket. A tórendszer gazdaságilag is jelentős a haltermelés szempontjából, ahol hagyományos és ökológiai módszerekkel tenyésztenek pontyot és más őshonos halfajokat.",
      ro: "Sistemul de lacuri de la Biharugra reprezintă a doua cea mai mare zonă de iazuri piscicole din Ungaria, situată în județul Békés, lângă granița cu România. Create la începutul secolului al XX-lea prin transformarea unor mlaștini, aceste lacuri au devenit acum o rezervație ornitologică de importanță mondială, protejată prin Convenția de la Ramsar. Mii de păsări migratoare, inclusiv gâște sălbatice și egrete, folosesc zona ca punct de oprire și hrănire. Vizitatorii pot folosi platformele de observație pentru a urmări viața sălbatică fără a o deranja. Pe lângă valoarea naturală, zona păstrează tradițiile pescuitului tradițional de câmpie, fiind un peisaj cultural și biologic unic.",
      en: "The Biharugra Ponds form Hungary's second largest artificial fishpond system, located on the eastern edge of Békés County along the Romanian border. Developed as a remnant of the once vast Sárrét marshland, the ponds have become a bird sanctuary of international importance. The 1,900-hectare water surface is a crucial station for migratory birds, especially wild geese, cranes, and spoonbills. As part of the Körös-Maros National Park, the area features birdwatching towers and educational trails. Economically, the ponds support traditional and organic fish farming, primarily producing carp and other native species. Nature Studies K3 — fishponds and migratory birds."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total water surface area of approximately 1,900 hectares.", "Protected wetland of international importance under the Ramsar Convention.", "Over 300 bird species have been observed at the pond system.", "Established in the early 20th century on the site of the former Sárrét marsh.", "Home to one of Hungary's largest colonies of Eurasian spoonbills.", "Autumn migration can see up to 40,000 wild geese resting here.", "The Ölyvös Canal is the primary water source for the system.", "Includes a local museum on the history of plain-land fishing."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Mályvádi-erdő az Alföld egyik legnagyobb és legértékesebb összefüggő erdőtömbje, amely Gyula és Sarkad között, a román határ mentén terül el. Ez az egykori hatalmas ártéri erdőségek utolsó hírmondója, ahol évszázados kocsányos tölgyek, magyar kőrisek és mezei szilfák alkotják a fenséges lombozatot. Az erdő gazdag vadállományáról, különösen gím- és dámvad állományáról híres, de fészkel itt a ritka fekete gólya és a rétisas is. Tavasszal a mocsári nőszirom és a tavaszi tőzike virágszőnyege borítja a nedvesebb területeket. A Mályvádi-erdő hűvös mikroklímája és háborítatlan csendje a természetfotósok és a magányos túrázók kedvelt célpontja az Alföld egyébként nyitottabb tájain.",
      ro: "Pădurea Mályvád este una dintre cele mai mari și mai valoroase păduri de câmpie din Ungaria, situată în județul Békés, lângă localitatea Gyula. Această pădure de luncă este formată predominant din stejari și fagi, reprezentând un rest al vastelor păduri care acopereau odinioară valea Crișurilor. Este o rezervație naturală de importanță națională, celebră pentru populația sa de cerbi lopătari și pentru flora sa rară care înflorește în ferestrele de lumină ale pădurii. Zona oferă un habitat excelent pentru specii de păsări răpitoare și este un loc preferat pentru drumeții ecologice. Mályvád este un exemplu viu de reziliență a naturii în fața transformărilor agricole ale regiunii.",
      en: "The Mályvád Forest is one of the largest and most valuable contiguous forest blocks in the Great Plain, stretching between Gyula and Sarkad along the Romanian border. It is one of the last remnants of the once vast floodplain forests of the Körös region, where centennial pedunculate oaks, Hungarian ashes, and field elms form a majestic canopy. The forest is famous for its rich wildlife, particularly its red and fallow deer populations, but also hosts rare black storks and white-tailed eagles. In spring, a carpet of marsh irises and spring snowflakes covers the wetter areas. Its cool micro-climate and undisturbed silence make it a highlight for nature photographers. Nature Studies K3 — floodplain forests and deer habitats."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Covers over 3,000 hectares of contiguous forest area.", "Second largest contiguous forest in the Hungarian Great Plain.", "Core part of the Körös-Maros National Park since 1989.", "Hosts the most significant fallow deer population in the region.", "Contains monumental oak trees with ages exceeding 200 years.", "Nesting site for the strictly protected black stork (Ciconia nigra).", "Home to the rare and protected debreceni torma (Armoracia macrocarpa) plant.", "Features numerous forestry and hunting-themed educational trails."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kettős-Körös Doboz mellett jön létre a Fehér- és a Fekete-Körös egyesüléséből, és Békés vármegye szívén folyik keresztül. A 37 kilométer hosszú folyószakasz lassú áramlásával és buja ártéri erdőivel a vízi turizmus egyik kedvenc helyszíne. A folyó szabályozása során épült magas gátak nemcsak árvízvédelmi szerepet töltenek be, hanem ma már népszerű kerékpáros útvonalként is funkcionálnak. Békés városánál egy modern kishajókikötő és szabadstrand várja az érkezőket, ahol a folyóparti élet pezsgése és a természet nyugalma egyszerre van jelen. A Kettős-Körös holtágai kiváló horgászhelyek, ahol a kapitális amurok és pontyok mellett a ritka lápi póc is előfordulhat a csendesebb öblökben.",
      ro: "Râul Kettős-Körös (Crișul Dublu) se formează în județul Békés prin unirea Crișului Alb și a Crișului Negru în apropierea orașului Gyula. Acesta parcurge un traseu sinuos prin câmpia maghiară până la confluența cu Crișul Repede, unde devine Crișul Triplu. Râul este esențial pentru transportul sedimentelor și menținerea zonelor umede din regiune. Digurile sale de protecție oferă trasee excelente pentru ciclism și plimbări, fiind înconjurate de păduri de luncă dese. Din punct de vedere istoric, gestionarea acestui râu a fost crucială pentru protejarea orașelor împotriva inundațiilor, ducând la dezvoltarea unor tehnici avansate de inginerie hidrologică în secolul al XIX-lea.",
      en: "The Kettős-Körös (Double Koros) is formed near Doboz by the confluence of the White and Black Koros rivers, flowing through the heart of Békés County. This 37-kilometer long section is famous for its slow current and lush floodplain forests, making it a favorite for water tourism. The high levees built during river regulation now serve as popular asphalted cycling paths. Near the town of Békés, a modern small-boat harbor and a public beach await visitors, where riverside life and natural peace meet. The oxbow lakes of the Kettős-Körös are excellent fishing spots, hosting large carp and the rare European mudminnow in quiet bays. Geography K7 — river confluences and water tourism."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Length of exactly 37.3 kilometers from confluence to Gyomaendrőd.", "Formed by the union of the Fehér-Körös and Fekete-Körös.", "The Békés dam is the largest hydraulic structure on this branch.", "Asphalted levee roads are part of the regional cycling network.", "Features extensive willow-poplar gallery forests in the floodplain.", "The Békés harbor is one of the region's most modern water bases.", "Common fish species include carp, catfish, and asp.", "Serves as a vital ecological corridor in the southern Great Plain."]
    }
  },
  // HU-BZ: Borsod-Abaúj-Zemplén
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Istállós-kő 959 méteres magasságával sokáig a Bükk-hegység legmagasabb pontjaként volt ismert, bár a legfrissebb mérések szerint a szomszédos Szilvási-kő pár centiméterrel megelőzi. A hegycsúcs északnyugati oldalán található az Istállós-kői-barlang, amely világhírű régészeti lelőhely: itt találták meg a jégkorszaki barlangi medve csontjai mellett az aurignaci kultúra kőeszközeit és a világ egyik legrégebbi csontfuvoláját is. A csúcsra vezető túraútvonal a Szalajka-völgyből indul, és bár meredek, a tetőn lévő bükkerdők csendje és a hegy történelmi levegője kárpótolja a vándort. A hegy anyaga triász kori mészkő, amelyre jellemzőek a mély töbrök és a karsztjelenségek.",
      ro: "Istállós-kő este cel de-al doilea cel mai înalt vârf din munții Bükk și al treilea din Ungaria, cu o altitudine de 959 de metri. Situat lângă localitatea Szilvásvárad, muntele este faimos pentru peștera Istállós-kő, un sit arheologic de importanță mondială unde au fost descoperite rămășițe ale omului de Neanderthal și numeroase unelte din piatră. Urcarea spre vârf pornește adesea din pitoreasca Vale Szalajka, oferind peisaje montane dramatice și păduri de fag spectaculoase. Din cauza compoziției sale calcaroase, muntele prezintă numeroase fenomene carstice, fiind un laborator natural pentru studiul geologiei și al preistoriei Europei Centrale.",
      en: "Istállós-kő is the second highest peak of the Bükk Mountains, reaching 959 meters above sea level. It is famous for the Istállós-kő Cave, which is a major archaeological site where tools and artifacts from prehistoric humans (Aurignacian culture) were discovered. The mountain is part of the Bükk National Park and offers a challenging but rewarding hike through dense beech forests. The name \"Istállós-kő\" roughly translates to \"Stable Stone,\" referring to the massive cave that once provided shelter. It is a key location for understanding early human life in Central Europe. Geography K7 – mountains and caves."Istállós-kő\" roughly translates to \"Stable Stone,\" referring to the massive cave that once provided shelter. It is a key location for understanding early human life in Central Europe. Geography K7 – mountains and caves."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A csúcs tengerszint feletti magassága 959 méter.", "A hegyen található barlang 1944 óta fokozottan védett.", "Itt találták a világ egyik legidősebb csontfuvoláját (30 ezer éves).", "A hegy a Bükki Nemzeti Park központi, védett övezetében van.", "A Szalajka-völgyből induló 'Istállós-kői kaptató' a legmeredekebb utak egyike.", "A csúcson egy hatalmas fakereszt jelzi a legmagasabb pontot.", "A hegy növényzetét az ország legszebb bükkerdői alkotják.", "Geológiailag a Bükki-fennsík mészkőplatójának peremén fekszik."],
      ro: ["Altitudinea vârfului este de 959 de metri.", "Peștera Istállós-kő se află la o înălțime de 609 metri.", "Aici au fost găsite fluiere din os vechi de peste 30.000 de ani.", "Face parte din Parcul Național Bükk, înființat în 1977.", "Vârful a fost considerat cel mai înalt din Bükk până în 2014.", "Pădurile de fag de aici au o structură virgină în anumite zone."],
      en: ["Reaches an elevation of 959 meters, making it one of Hungary's highest points.", "The nearby cave was declared a protected natural monument in 1944.", "Archaeologists found bone flutes and stone tools dating back 30,000 years.", "Features a steep hiking trail leading from Szalajka Valley.", "Part of the Bükk National Park, protected since 1977.", "The cave entrance is located at an altitude of 609 meters."]
    }
  },
  {
    id: "river-sajo-extra",
    ...
    descriptionAdvanced: {
      ...
      hu: "A Sajó Észak-Magyarország egyik legjelentősebb folyója, amely a szlovákiai Alacsony-Tátrában ered és mintegy 230 kilométer után ömlik a Tiszába. A folyó határozta meg Miskolc és környéke ipari arculatát; a vashámorok és gyárak telepítésekor kulcsfontosságú volt a folyó vize. Bár az ipari múlt nyomai még láthatók, a Sajó az utóbbi évtizedekben látványosan megtisztult, így visszatértek a ritka halfajok, mint például a paduc és a márna. A folyó völgye fontos éghajlati választóvonal a Bükk és a Cserehát között, partjait vadregényes füzesek és homokpadok kísérik. Tiszaújvárosnál torkollik a Tiszába, ahol a két folyó találkozása különleges látványt nyújt a vízi túrázók számára.",
      ro: "Râul Sajó (Slaná) este unul dintre cele mai mari și mai importante cursuri de apă din nord-estul Ungariei, un afluent major al Tisei. Izvorăște din munții Tatra Mică din Slovacia și intră în Ungaria la localitatea Sajópüspöki. Râul traversează regiunea industrială Miskolc, jucând istoric un rol economic vital pentru transport și industrie. Deși cursul său a suferit transformări umane, porțiunile sale superioare păstrează o frumusețe sălbatică, cu maluri abrupte și vegetație bogată. Sajó este, de asemenea, cunoscut pentru marea bătălie din 1241 (Bătălia de la Muhi) împotriva tătarilor, care a avut loc pe malurile sale, marcând un moment tragic în istoria maghiară.",
      en: "The Sajó River is a 229-kilometer-long waterway that originates in the Stolica Mountains of Slovakia and flows into Hungary to join the Tisza River. It serves as a vital natural corridor between the northern mountains and the Great Hungarian Plain. Historically, the river valley was a strategic trade route, often referred to as a \"Salt Road\" for transporting minerals. The Sajó is famous for the Battle of Mohi in 1241, a major conflict between the Kingdom of Hungary and the Mongol Empire. Today, it is an important ecological site, though it faces challenges from industrial history in its basin. Geography K7 – rivers and historical trade routes."Salt Road\" for transporting minerals. The Sajó is famous for the Battle of Mohi in 1241, a major conflict between the Kingdom of Hungary and the Mongol Empire. Today, it is an important ecological site, though it faces challenges from industrial history in its basin. Geography K7 – rivers and historical trade routes."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length is 229 kilometers, with roughly 120 km in Hungary.", "Known as \"Slaná\" in Slovak, which translates to \"Salt River.\"", "Flows through Miskolc, the largest city in Northern Hungary.", "Confluence with the Tisza River occurs near Tiszaújváros.", "The river basin covers an area of approximately 12,700 square kilometers.", "Site of the historic Battle of Mohi during the Mongol invasion."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hernád Magyarország egyik legvadregényesebb és legkevésbé szabályozott folyója, amely az északkeleti határszélen kanyarog. Szlovákiából érkezik, és mély löszfalaival, hordalékos zátonyaival egyedülálló tájképet fest. A folyó sodrása viszonylag gyors, ami a tapasztaltabb kajakosok és kenusok kedvencévé teszi. Ökológiai szempontból felbecsülhetetlen értékű: a magas löszpartokban fészkelnek az ország egyik legnagyobb gyurgyalag- és jégmadár-kolóniái. A Hernád völgye történelmileg is jelentős, hiszen a folyó mentén sorakoznak a Zemplén lábánál fekvő ősi települések, mint például Vizsoly, ahol az első magyar nyelvű bibliát nyomtatták. A folyó Ónod közelében torkollik a Sajóba, gazdagítva a Tisza vízrendszerét.",
      ro: "Râul Hernád (Hornád) este unul dintre cele mai frumoase și mai dinamice râuri din nordul Ungariei, fiind renumit pentru cursul său natural și malurile sale loessoase spectaculoase. Izvorăște din Slovacia și traversează județul Borsod-Abaúj-Zemplén înainte de a se vărsa în râul Sajó. Hernád este o destinație preferată pentru pasionații de caiac și canoe datorită numeroaselor sale curbe și a vitezei moderate a apei. Zona luncii sale găzduiește păduri de galerii valoroase și este un loc important pentru cuibărirea păsărilor precum prigoria maghiară. Valea râului Hernád a fost istoric o rută comercială importantă, legând regiunea Zemplén de Transilvania și Polonia.",
      en: "The Hernád River, known as the Hornád in Slovakia, is a significant tributary of the Sajó that flows through breathtaking landscapes, including deep canyons and wide valleys. Its most spectacular section is the Hornád Canyon in the Slovak Paradise National Park, but its Hungarian reach is equally important for its meandering course and rich floodplain biodiversity. The river has shaped the history of the regions it passes through, supporting mills and agriculture for centuries. It enters Hungary near Tornyosnémeti and provides a habitat for numerous protected fish species. Nature lovers often visit the river for its scenic beauty and birdwatching opportunities. Geography K7 – river systems and canyons."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Has a total length of 286 kilometers, flowing through Slovakia and Hungary.", "The Hornád Canyon is one of the most famous hiking spots in Central Europe.", "Its drainage basin covers more than 5,400 square kilometers.", "Merges with the Sajó River south of Miskolc.", "Features high water quality in its upper reaches, supporting trout populations.", "Historically marked part of the border between ancient counties."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Lázbérci-víztározó az Upponyi-hegység és a Bükk határán fekszik, és Magyarország egyik legfestőibb mesterséges tava. Az 1960-as években hozták létre a Bán-patak felduzzasztásával, elsődleges célja a környékbeli ipari városok ivóvízellátásának biztosítása volt. Emiatt a tóban és közvetlen környezetében tilos a fürdés és a vízisportok, ami megőrizte a víz kristálytiszta minőségét és a környék háborítatlan nyugalmát. A tavat övező erdőkben számos túraútvonal fut, a nyugati végénél található Upponyi-szurdok pedig vadregényes sziklafalaival nyűgözi le a látogatókat. A víztározó gazdag halállománya miatt a horgászok körében is népszerű, de szigorú környezetvédelmi szabályok mellett.",
      ro: "Rezervorul Lázbérc este unul dintre cele mai pitorești lacuri artificiale din Ungaria, situat în munții Uppony din nordul țării. Creat în 1968 pentru a asigura alimentarea cu apă a regiunilor industriale din jur, lacul este acum o zonă protejată de o frumusețe rară. Este înconjurat de dealuri împădurite abrupte, amintind de peisajele montane din Alpi. Deși scăldatul este strict interzis pentru a păstra calitatea apei potabile, zona este un paradis pentru pescari și drumeți. Traseele de pe malul lacului oferă vederi spectaculoase, iar curățenia exemplară a apei și a mediului înconjurător face din Lázbérc o destinație ecoturistică de top în regiunea Borsod.",
      en: "The Lázbérc Reservoir is a picturesque man-made lake nestled in the Uppony Mountains of Northern Hungary. Created between 1967 and 1970 by damming the Bán stream, it serves as a critical drinking water source for the cities of Ózd and Kazincbarcika. The reservoir is Y-shaped and surrounded by steep, forested hills, giving it a fjord-like appearance. It is a strictly protected area, and swimming is prohibited to preserve water purity, but the surrounding trails offer stunning views and a peaceful atmosphere. The area is also famous for its diverse birdlife and unique geological formations in the Uppony Pass. Geography K8 – water management and reservoirs."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Covers a surface area of approximately 77 hectares.", "The dam is 24 meters high and holds millions of cubic meters of water.", "Part of the Lázbérc Landscape Protection Area established in 1975.", "The Uppony Mountains nearby feature some of Hungary's oldest rocks.", "Popular spot for regulated angling, known for its large carp and pike.", "Serves as a habitat for rare birds of prey like the Imperial Eagle."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Bodrog a Tokaj-Hegyaljai borvidék meghatározó folyója, amely lassú folyásáról és kanyargós medréről híres. Szlovákiából érkezik és Tokajnál torkollik a Tiszába. Különlegessége, hogy esése rendkívül csekély, így áradások idején előfordulhat, hogy a Tisza 'visszanyomja' a vizét, és a folyó folyásiránya megfordul. A Bodrog-ártér, a Bodrogzug, nemzetközileg elismert Ramsari terület, ahol hatalmas mocsárrétek és ligeterdők adnak otthont a vízimadaraknak. A folyó kiválóan alkalmas kezdő vízitúrázók számára, mivel sodrása minimális, partjai pedig buják és érintetlenek. Sárospatak mellett elhaladva a folyó közvetlenül a Rákóczi-vár falai alatt folyik el, felejthetetlen látványt nyújtva a csónakázóknak.",
      ro: "Râul Bodrog este un curs de apă unic în nord-estul Ungariei, fiind format din confluența a patru râuri pe teritoriul Slovaciei. Intră în Ungaria la Felsőberecki și străbate regiunea viticolă Tokaj, vărsându-se în Tisa la picioarele celebrului deal Tokaj. Bodrog este renumit pentru curentul său extrem de lent, ceea ce permite navigația facilă și croazierele de agrement. Zona luncii sale, Bodrogzug, este o rezervație naturală inundabilă unde natura își recapătă drepturile în fiecare primăvară, creând un peisaj acvatic fascinant. Râul este strâns legat de istoria producției vinului de Tokaj, malurile sale fiind presărate cu sate istorice și podgorii renumite.",
      en: "The Bodrog River is unique among Hungarian rivers because it has no single source; it is formed by the confluence of five smaller rivers in Slovakia before entering Hungary. It is a slow-moving, meandering river that defines the landscape of the Bodrogköz region and the famous Tokaj wine district. The river is known for its wide floodplains and \"gallery forests\" that support a rich variety of wildlife. Every spring, the Bodrog often floods its banks, creating a mystical water-world that is a paradise for canoeists and birdwatchers. It eventually joins the Tisza River at the foot of Tokaj Hill. Geography K7 – wetlands and river confluences."gallery forests\" that support a rich variety of wildlife. Every spring, the Bodrog often floods its banks, creating a mystical water-world that is a paradise for canoeists and birdwatchers. It eventually joins the Tisza River at the foot of Tokaj Hill. Geography K7 – wetlands and river confluences."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Formed by the Ondava, Latorica, Laborc, Topoly, and Ung rivers.", "Only 65 kilometers long, with 51 km flowing through Hungary.", "One of the few rivers in Hungary where you can see the \"Tisza flower\" bloom.", "The river is navigable for small ships and is a popular water tourism route.", "Its confluence with the Tisza is a symbolic landmark of the Tokaj region.", "The Bodrogköz area is a Ramsar site of international importance."]
    }
  },
  // HU-CS: Csongrád-Csanád
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szegedi Fehér-tó Magyarország legnagyobb szikes tava, amely a Kiskunsági Nemzeti Park déli részén terül el. Bár eredetileg természetes szikes tó volt, a 20. században halastórendszerré alakították át, de ökológiai jelentőségét így is megőrizte. Európai hírű madárrezervátum, amely a vonuló madarak, különösen a darvak egyik legfontosabb őszi pihenőhelye – ilyenkor több tízezer madár krúgatása hallatszik a tó felett. A tómeder sókiválása fehér színűre festi a partokat a szárazabb időszakokban, erről kapta a nevét is. A látogatókat a Sirály-tanösvény és madármegfigyelő tornyok várják, amelyek segítségével betekintést nyerhetnek e különleges vizes élőhely életébe.",
      ro: "Lacul Alb din Szeged (Szegedi Fehér-tó) este cel mai mare lac sărat din Ungaria, având o suprafață de aproximativ 14 kilometri pătrați. Situat la nord de orașul Szeged, lacul este o componentă esențială a Parcului Național Kiskunság și un loc de importanță internațională pentru protecția păsărilor. Numele său provine de la depunerile albe de sodă (carbonat de sodiu) care apar pe maluri în perioadele de secetă. Zona a fost transformată într-un sistem de heleșteie piscicole la începutul secolului XX, însă și-a păstrat rolul ecologic crucial ca punct de popas pentru sute de mii de păsări migratoare, în special macarale și gâște sălbatice, care creează un spectacol vizual fascinant în fiecare toamnă.",
      en: "The Szeged White Lake (Fehér-tó) is Hungary's largest saltwater lake and a crown jewel of the Kiskunság National Park. Originally a shallow, alkaline lake that often dried out, it was transformed into a massive fishpond system in the early 20th century. Today, it is one of the most important bird migration stops in Europe, especially for the tens of thousands of common cranes that gather here every autumn. The lake's name comes from its white, salty bed that becomes visible during dry periods. It offers a unique glimpse into the ancient wetlands of the Great Plain before the massive river regulations. Biology K8 – bird migration and ecosystems."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tórendszer kiterjedése megközelítőleg 14 négyzetkilométer.", "A terület 1939 óta élvez természetvédelmi oltalmat.", "Az őszi daruvonuláskor akár 50 000 madár is megpihenhet itt.", "A halastavakban évente több száz tonna pontyot termelnek.", "A part menti szikeseken él a ritka és védett pozsgás zsázsa.", "A Sirály-tanösvényen madármegfigyelő faházak találhatók.", "A terület a Pusztaszeri Tájvédelmi Körzet része.", "Itt található Magyarország egyik legrégebbi halászati kutatóállomása."],
      ro: ["Suprafața totală a complexului lacustru este de 1.400 de hectare.", "Face parte din rețeaua Ramsar de zone umede de importanță mondială.", "Peste 280 de specii de păsări au fost observate în perimetrul lacului.", "În fiecare an, peste 50.000 de macarale poposesc aici în timpul migrației.", "Turnul de observație 'Korsós-sziget' oferă cea mai bună panoramă asupra faunei.", "Primele heleșteie artificiale au fost construite aici în anul 1932."],
      en: ["Spans an area of about 14 square kilometers north of Szeged.", "Home to over 280 bird species, including rare herons and egrets.", "Key stopover for up to 60,000 cranes during their migration to the south.", "First mentioned in historical documents as early as 1075.", "Features a dedicated birdwatching tower and a nature trail for visitors.", "Managed by the Kiskunság National Park to protect its biodiversity."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Maros torkolata az a pont Szegednél, ahol a Maros folyó beletorkollik a Tiszába. Ez a hely nemcsak földrajzilag fontos, hanem a szegediek kedvelt kirándulóhelye is. A Maros a Kárpátokból érkezve jelentős mennyiségű homokot szállít, így a torkolatnál hatalmas homokpadok alakulnak ki, amelyek alacsony vízállásnál szinte tengerparti hangulatot árasztanak. A 'szőke' Tisza és a sötétebb, hordalékos Maros találkozásánál élesen elkülönül a két folyó színe, mielőtt végleg eggyé válnának. A torkolat környékét dús ártéri erdők borítják, amelyek fontos ökológiai folyosóként szolgálnak a vadállomány számára, a szegedi oldalon pedig népszerű szabadstrand (Lapos) üzemel a nyári hónapokban.",
      ro: "Confluența râului Mureș cu Tisa, situată la marginea orașului Szeged, este unul dintre cele mai importante puncte hidrografice și peisagistice din sudul Ungariei. Mureșul, după un parcurs lung de 749 de kilometri de la izvoarele sale din Carpații Orientali, își varsă apele în Tisa la o altitudine de doar 75 de metri deasupra mării. În perioadele de viitură, fenomenul de 'amestecare a culorilor' este vizibil clar: apele mai tulburi și bogate în aluviuni ale Mureșului se disting de cele mai limpezi ale Tisei. Zona torkolat-ului (confluenței) este protejată în cadrul Parcului Național Criș-Mureș, adăpostind păduri de luncă sălbatice unde castorii și numeroase păsări de apă găsesc un habitat ideal.",
      en: "The Maros-torkolat is the point where the Maros River meets the Tisza near the city of Szeged. This confluence is a site of great natural beauty, characterized by vast floodplains and lush riparian forests. The Maros brings sediment and unique flora from the Carpathian Mountains, enriching the local ecosystem. Historically, this area was a vital hub for the salt and timber trade, as goods were floated down from Transylvania on massive rafts. Today, the confluence is a popular spot for leisure, offering sandy beaches during low water and serving as a protected area within the Körös-Maros National Park. Geography K7 – river confluences and trade history."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Mureșul are o lungime totală de 749 km, din care 48 km în Ungaria.", "Confluența se află la nord-est de centrul orașului Szeged, lângă Tápé.", "Mureșul este principalul furnizor de nisip și pietriș pentru cursul inferior al Tisei.", "Debitul mediu al Mureșului la vărsare este de aproximativ 155 m³/s.", "În trecut, pe Mureș se transporta sarea din Transilvania pe plute până la Szeged.", "Zona este un loc popular pentru pescuit și excursii cu caiacul."],
      en: ["The Maros is 789 km long, originating in the Eastern Carpathians.", "The confluence is located at an elevation of only 75 meters above sea level.", "The river creates a natural border between different landscape types.", "Known for its sandy banks, which are rare for rivers in the Great Plain.", "Part of the Körös-Maros National Park since its establishment.", "Ancient Greeks referred to the river as the \"Maris\" in their writings."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Csaj-tó a Pusztaszeri Tájvédelmi Körzet szívében fekvő hatalmas halastórendszer, amely az egykori Tisza-menti mocsárvilág rehabilitációjának eredménye. A gátakkal elválasztott, több medencéből álló tórendszer mára a dél-alföldi régió egyik legfontosabb ornitológiai központjává vált. Különösen híres a kanalasgém, a nagy kócsag és a különféle récefajok népes kolóniáiról. A tavak gazdaságilag is jelentősek a haltenyésztés révén, de a természetvédelmi szempontok elsődlegességet élveznek. A látogatók számára vezetett túrák keretében nyílik lehetőség a terület bejárására, ahol a madármegfigyelő tornyokból zavartalanul tanulmányozható a vízi világ. Ópusztaszer közelsége miatt a kulturális és természeti értékek felfedezése remekül összekapcsolható.",
      ro: "Lacul Csaj este un complex de heleșteie și zone umede situat lângă localitatea Csanytelek, fiind una dintre cele mai valoroase rezervații ornitologice din regiunea cursului inferior al Tisei. Integrat în Parcul Național Kiskunság, acest sistem de lacuri acoperă aproximativ 1.000 de hectare și a fost creat inițial pentru piscicultură, dar a evoluat rapid într-un paradis pentru biodiversitate. Aici cuibăresc specii rare precum lopătarul și stârcul cenușiu, iar în perioadele de migrație, mii de păsări limicole folosesc apele puțin adânci pentru a se hrăni. Lacul este înconjurat de pășuni saline și stufărișuri dense, oferind un peisaj tipic pentru Câmpia Maghiară, protejat de convenția Ramsar.",
      en: "Lake Csaj (Csaj-tó) is a sprawling fishpond system located within the Pusztaszer Landscape Protection Area. It is a masterpiece of man-made wetland management that has become a vital sanctuary for aquatic life and birds. The lake consists of several large basins separated by dikes, providing a diverse range of habitats from open water to thick reed beds. It is particularly famous among nature photographers for its incredible bird density, including breeding colonies of spoonbills and various heron species. The lake plays a crucial role in maintaining the ecological balance of the Kiskunság region and is a testament to how artificial water bodies can support nature. Biology K7 – wetland habitats and conservation."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Sistemul lacustru Csaj-tó se întinde pe o suprafață de circa 1.000 de hectare.", "Este format din 10 bazine separate, folosite parțial pentru piscicultură.", "Aici se află una dintre cele mai mari colonii de lopătari din Europa Centrală.", "Accesul în zonă este restricționat pentru a proteja perioadele de cuibărit.", "Zona a fost declarată rezervație naturală de interes național în anul 1977.", "Este un sit esențial pentru monitorizarea migrației păsărilor pe ruta Tisei."],
      en: ["Part of the Kiskunság National Park's network of protected waters.", "More than 220 different bird species have been recorded at the lake.", "Serves as a breeding ground for the globally threatened Saker Falcon.", "One of the best locations in Hungary for high-quality bird photography.", "The lake system is used for sustainable fish farming alongside conservation.", "Located near the historic village of Pusztaszer and its memorial park."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A mártélyi Holt-Tisza a folyó egyik legfestőibb holtága Csongrád-Csanád vármegyében, amely a 19. századi szabályozások során szakadt el a főmedertől. Az íves alakú holtág és környezete ma tájvédelmi körzet, amely egyedülálló esztétikai és ökológiai értékkel bír. Partjait évszázados füzek és nyárak szegélyezik, amelyek látványa generációk óta vonzza a művészeket, különösen az alföldi festőiskola alkotóit. Mártély mára népszerű üdülőhellyé vált, ahol szabadstrand, tanösvény és kemping várja a látogatókat. A víz sekély és lassan melegszik, így ideális fürdőzésre és vízisportokra, miközben a nádasok között gazdag madárvilág és horgászható halállomány rejtőzik.",
      ro: "Zona de agrement Mártély, situată pe un braț mort al râului Tisa, este una dintre cele mai vechi și mai frumoase arii protejate din Ungaria, fiind înființată în 1971. Această regiune peisagistică oferă o privire fascinantă asupra modului în care arăta lunca Tisei înainte de marile lucrări de regularizare din secolul al XIX-lea. Brațul mort de la Mártély este înconjurat de păduri de sălcii și plopi uriași, oferind un refugiu liniștit pentru turiști și un habitat bogat pentru vidre și păsări de apă. Plaja naturală, posibilitățile de canotaj și traseele educative fac din Mártély o destinație culturală și naturală de prim rang, inspirând de-a lungul timpului numeroși pictori și artiști maghiari.",
      en: "The Mártély Oxbow Lake is a stunning remnant of the old Tisza River course, formed during the massive river regulations in the late 19th century. Located near Hódmezővásárhely, it is the center of the Mártély Landscape Protection Area, one of Hungary's oldest protected sites. The area is famous for its \"gallery forests\" of massive willows and poplars that dip into the still water. For decades, the scenic beauty of Mártély has inspired famous Hungarian painters, leading to the establishment of an artist colony. Today, it offers a blend of natural wonder and quiet recreation, with nature trails that educate visitors about the life of the floodplain. Geography K7 – oxbow lakes and floodplain ecology."gallery forests\" of massive willows and poplars that dip into the still water. For decades, the scenic beauty of Mártély has inspired famous Hungarian painters, leading to the establishment of an artist colony. Today, it offers a blend of natural wonder and quiet recreation, with nature trails that educate visitors about the life of the floodplain. Geography K7 – oxbow lakes and floodplain ecology."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Aria de Protecție Peisagistică Mártély a fost înființată în anul 1971.", "Suprafața protejată depășește 2.200 de hectare de-a lungul Tisei.", "Brațul mort are o lungime de peste 5 kilometri și o adâncime medie de 3 metri.", "Școala de pictură de la Mártély este celebră în istoria artei maghiare.", "Zona dispune de o potecă educativă pe piloni prin mlaștină.", "Satul Mártély este renumit pentru arhitectura sa tradițională și ospitalitate."],
      en: ["Established as a landscape protection area in 1971, the third oldest in Hungary.", "The oxbow was created between 1887 and 1892 during the Tisza's regulation.", "Recorded as a Ramsar site due to its international importance for waterbirds.", "Home to 112 breeding bird species, including the elusive Black Stork.", "Features a 2.6 km long study trail through the floodplain forest.", "Famous as a retreat for painters like János Tornyai and Jenő Barcsay."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Pusztaszeri-erdő a pusztai táj egyik meghatározó zöld szigete Szegedtől északra, amely a Pusztaszeri Tájvédelmi Körzet részeként élvez oltalmat. Az erdő vegyes összetételű: megtalálhatók benne az őshonos ártéri keményfás ligeterdők maradványai, valamint a homokhátságra telepített tölgyesek és akácosok is. Ez az erdőtömb kulcsfontosságú a régió mikroklímájának szabályozásában és a szél elleni védelemben az Alföld nyitott síkságain. Gazdag állatvilágának ékkövei a ragadozó madarak, köztük a parlagi sas és a fekete kánya, amelyek itt találnak biztonságos fészkelőhelyet. A területet átszövik a túraútvonalak, amelyek összekötik az erdőt a Tisza-parttal és a közeli történelmi emlékparkkal, lehetőséget adva a természetközeli kikapcsolódásra.",
      ro: "Pădurile și pășunile din Aria de Protecție Peisagistică Pusztaszer reprezintă un sit istoric și natural de o importanță fundamentală pentru identitatea maghiară. Conform tradiției, aici a avut loc prima adunare legislativă a triburilor maghiare după descălecat, eveniment comemorat astăzi în Parcul Memorial Istoric Național. Pe lângă semnificația simbolică, zona protejează resturile pădurilor de silvostepă care odinioară acopereau mari părți din Câmpia Maghiară. Peisajul este un mozaic de dune de nisip, mlaștini saline și pâlcuri de stejari seculari, oferind condiții de viață pentru specii rare precum dropia sau șoimul dunărean, într-un mediu ce păstrează atmosfera de acum un mileniu.",
      en: "The Pusztaszer Forest is an integral part of the landscape surrounding the historic Pusztaszer National Memorial Park. It is a mosaic of sandy grasslands, oak-ash-elm forests, and planted groves that represent the original vegetation of the Southern Great Plain. The forest provides a green backdrop to the site where, according to tradition, the first Hungarian assembly was held over a thousand years ago. Beyond its historical significance, the forest is a sanctuary for local wildlife, including roe deer and numerous songbirds. It offers peaceful walking paths for visitors who come to explore the nearby ruins and the famous Feszty Panorama. History K5 – early Hungarian history and landscape."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Aria protejată a fost constituită în anul 1976 pe o suprafață de 22.000 ha.", "Include celebrul lac Büdösszék, cunoscut pentru apele sale curative saline.", "Aici se găsește monumentul Árpád, ridicat în 1896 pentru mileniul descălecării.", "Vegetația de nisip include rarități botanice precum garofița de nisip.", "În rezervație trăiește o populație stabilă de căprioare și mistreți.", "Zona este parte a rețelei europene Natura 2000 pentru conservarea habitatelor."],
      en: ["Located within the Pusztaszer Landscape Protection Area.", "Protects remnants of the ancient \"forest-steppe\" ecosystem of the Alföld.", "Surrounds the ruins of a 12th-century Benedictine monastery.", "Features a mix of native trees and drought-resistant sandy grasslands.", "The forest is a key part of the local ecological network for migratory animals.", "Provides a quiet area for reflection near the busy National Memorial Park."]
    }
  },
  // HU-FE: Fejér
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Sárvíz-csatorna a Dunántúl egyik leghosszabb mesterségesen szabályozott vízfolyása, amely a Fejér-síkságon halad keresztül. A terület eredetileg egy hatalmas, átjárhatatlan mocsárvilág volt, amelyet a 19. századi nagyszabású vízrendezési munkálatok során csapoltak le, létrehozva a mai mezőgazdasági tájat. A csatorna ma kettős funkciót lát el: elvezeti a felesleges belvizet és vizet biztosít az öntözéshez a szárazabb időszakokban. A vízpart mentén kialakult másodlagos élőhelyek – nádasok és füzesek – fontos menedéket nyújtanak a vízimadaraknak és a halaknak. A Sárvíz völgye történelmi szempontból is jelentős, hiszen már a római korban is használták az itteni vízi utakat a Pannónia provincia belseje felé vezető kereskedelemben.",
      ro: "Râul Sárvíz este unul dintre cele mai importante cursuri de apă din regiunea Transdanubia Centrală, având o istorie strâns legată de drenarea mlaștinilor din zona Mezőföld. Acesta izvorăște din Munții Bakony și traversează județul Fejér, vărsându-se în Canalul Sió. În trecut, zona Sárvíz era o regiune vastă de smârcuri și canale naturale care au fost regularizate începând cu secolul al XVIII-lea pentru a câștiga teren agricol fertil. Astăzi, valea râului este o arie protejată importantă pentru biodiversitate, oferind refugiu multor specii de păsări de apă și floră specifică zonelor umede. Geografia K7 – Ape curgătoare și protecția mediului.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A csatorna teljes hossza megközelíti a 100 kilométert.", "A mocsarak lecsapolása a 19. század egyik legnagyobb beruházása volt.", "A csatorna medre egy geológiai törésvonalat követ a síkságon.", "Fontos szerepe van Fejér vármegye árvízvédelmi rendszerében.", "Nádasaiban költ a védett bölömbika és a vörös gém.", "A víz minőségét folyamatosun ellenőrzik a halállomány védelmében.", "A római korban a Sárvíz mentén fontos kereskedelmi út haladt.", "A csatorna partján kiépített szervizút a kerékpárosok körében kedvelt."],
      ro: ["Lungimea totală a cursului de apă este de aproximativ 100 km.", "Regularizarea sistematică a început în 1772 sub supravegherea lui József Letenyei.", "Valea Sárvíz este declarată rezervație naturală pe o suprafață de peste 3000 de hectare.", "Canalul principal a fost finalizat în forma sa modernă în secolul al XIX-lea.", "Râul colectează apele dintr-un bazin hidrografic de circa 1500 km².", "Zona este celebră pentru coloniile de stârci și lopătari."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gaja-patak a Bakony egyik legromantikusabb vízfolyása, amely Bodajk és Fehérvárcsurgó között mély és látványos szurdokvölgyet vájt a mészkősziklákba. A Gaja-völgy kristálytiszta vize, a sziklákról lezúduló kaskádok és a sűrű bükkerdők szinte alpesi hangulatot árasztanak a Dunántúli-középhegységben. A szurdok egyik legkeresettebb pontja a Római-fürdő, ahol a patak egy szűk sziklahasadékon keresztül zuhan alá egy mély sziklamedencébe. A környék a bakonyi betyárlegendákról is híres, mint például Sobri Jóska barlangjáról, amely a patak feletti sziklafalban található. A völgy népszerűsége az Országos Kéktúra útvonalának és a jól kiépített pihenőhelyeknek köszönhetően töretlen a természetjárók körében.",
      ro: "Pârâul Gaja este cel mai important și cel mai curat curs de apă din munții Bakony de Est, fiind celebru pentru pitorescul 'Gaja-szurdok' (Cheile Gaja). Pârâul a tăiat de-a lungul mileniilor o vale adâncă în rocile de calcar și dolomit, creând un peisaj spectaculos cu stânci abrupte și mici cascade. Apa sa rămâne rece chiar și în zilele fierbinți de vară, rareori depășind 16 grade Celsius, ceea ce permite existența păstrăvului indigen. Cheile, lungi de 4 kilometri între localitățile Bodajk și Fehérvárcsurgó, sunt o destinație de drumeție preferată, oferind acces la peșteri legendare, cum este cea a celebrului haiduc Sobri Jóska, și la puncte de belvedere care domină întreaga vale.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Cheile Gaja au o lungime de 4 km și sunt mărginite de pereți de dolomit.", "Pârâul Gaja se varsă în final în râul Sárvíz lângă Székesfehérvár.", "În 1242, mlaștinile formate de Gaja au protejat Székesfehérvár de tătari.", "În valea pârâului trăiesc vidre și numeroase specii de insecte acvatice rare.", "Peștera Sobri Jóska din chei a fost adăpost pentru haiduci în secolul XIX.", "Turnul de observație 'Károlyi-kilátó' oferă o vedere panoramică asupra văii."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Alcsúti Arborétum Magyarország legősibb és egyik legszebb angolparkja, amelyet József nádor alapított 1820-ban a Váli-völgy szívében. A 40 hektáros terület egykor a Habsburg-család klasszicista kastélyának kertje volt, amelynek ma már csak Pollack Mihály által tervezett, impozáns főhomlokzata látható mementóként a fák között. A park kialakítását Tost Károly schönbrunni kertépítőmester irányította, aki több mint 540 fa- és cserjefajból álló gyűjteményt hozott létre. Az arborétum világszerte híres kora tavaszi hóvirágünnepéről, amikor 2,5 hektáron hét hóvirágfaj 24 fajtája nyílik, valamint a júniusi szentjánosbogár-rajzásról, amely varázslatos látványt nyújt az esti séták alkalmával.",
      ro: "Arboretul din Alcsút este una dintre cele mai valoroase grădini botanice istorice din Ungaria, fiind fondat în anul 1820 de către arhiducele Iosif, palatinul Ungariei. Proiectat ca un parc peisagistic englezesc de către grădinarul curții de la Schönbrunn, Károly Tost, arboretul se întinde pe 40 de hectare și găzduiește peste 540 de specii de arbori și arbuști. Deși castelul clasicist al familiei Habsburg a fost distrus în timpul celui de-al Doilea Război Mondial, rămânând doar fațada principală, parcul și-a păstrat splendoarea originală. Vizitatorii pot admira platani uriași, chiparoși de baltă și specii exotice aduse din întreaga lume, zona fiind celebră pentru spectacolul natural al înfloririi ghioceilor primăvara și al licuricilor în luna iunie.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["József nádor, a „legmagyarabb Habsburg” alapította 1820-tól.", "A 40 hektáros parkban több mint 540 növényfaj található.", "Itt élnek az ország legidősebb, közel 200 éves platánfái.", "A Pollack Mihály tervezte kastély 1944-ben leégett.", "Február-márciusban 2,5 hektáron virágzik a hóvirágmező.", "Júniusban ezernyi szentjánosbogár tánca látható a parkban.", "A közeli Csaplári-erdőben él egy 170 éves libanoni cédrus.", "A parkban neoromán kápolna és egy különleges Babaház is áll."],
      ro: ["Arboretul a fost înființat oficial în anul 1820.", "Acoperă o suprafață de aproximativ 40 de hectare de parc peisagistic.", "Fațada castelului Pollack Mihály este singura parte rămasă din clădirea principală.", "Găzduiește cea mai mare colecție de ghiocei din țară, cu peste 20 de soiuri.", "Capela neoromană din incintă a fost proiectată de Ferenc Storno în 1880.", "Parcul a fost declarat rezervație naturală protejată încă din anul 1941."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A pázmándi Veres-hegy a Velencei-hegység keleti nyúlványának egyik legérdekesebb geológiai formációja. A 202 méter magas domb nem a hegységre jellemző gránitból, hanem eocén kori vulkáni tevékenység során keletkezett andezitből áll, amelyet a forró, kovasavas oldatok rendkívül kemény kvarcittá alakítottak át. A hegy tetején a szél és a víz eróziója különleges, tál alakú mélyedéseket, úgynevezett rókaitatókat hozott létre a sziklákban. A Zsidó-hegy és a Veres-hegy közötti szakaszon egy látványos sziklaszoros található, amely Magyarország egyik legősibb tájának hangulatát idézi. A csúcsról pazar panoráma nyílik a Velencei-tóra és a környező szőlőskertekre.",
      ro: "Muntele Veres-hegy (Muntele Roșu) este o formațiune geologică distinctivă situată în munții Velence, cel mai vechi masiv muntos din Ungaria. Numele său provine de la nuanța roșiatică a rocii de granit și a solului, cauzată de oxidarea mineralelor de fier prezente în compoziția acestora. Deși altitudinea sa este modestă, sub 300 de metri, muntele oferă o perspectivă geologică fascinantă, granitul de aici având o vechime de peste 300 de milioane de ani. Vegetația de pe versanții săi este de tip stepic și submediteraneean, adăpostind specii rare de flori de stâncă. De pe culmea Veres-hegy se deschide o panoramă spectaculoasă asupra întregului lac Velence și a dealurilor înconjurătoare.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A hegy csúcsa 202 méterrel magasodik a tengerszint fölé.", "Kőzetanyaga eocén kori andezitből átalakult kemény kvarcit.", "A sziklákon látható mélyedéseket rókaitatónak nevezi a népnyelv.", "A területen található a 10,3 méter hosszú Maléza-barlang.", "A hegyoldalban egy látványos, természetes sziklaszoros húzódik.", "A kvarcitsziklák Magyarország legidősebb kőzetei közé tartoznak.", "A dombtetőről tiszta időben a Velencei-tó víztükre is látszik.", "A közeli Zsidó-hegy kálváriája fontos szakrális emlékhely."],
      ro: ["Muntele este format din granit din perioada Carboniferului (cca. 300 mil. ani).", "Se află în apropierea localității Sukoró, la nord de lacul Velence.", "Numele 'Veres' (Roșu) reflectă conținutul ridicat de oxizi de fier din rocă.", "Este un sit important pentru observarea fenomenului de eroziune a granitului.", "Flora include specii rare precum 'Stipa' (colilia) și rujița de stâncă.", "Traseele de aici sunt populare pentru drumeții ușoare de weekend."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Pázmándi-tó a falu határában, a festői Szőlőhegy lábánál fekvő mesterséges völgyzárógátas horgásztó. A tavat a környező dombokról lefolyó csapadékvizek és helyi források táplálják, biztosítva a terület friss vízellátását. A rendezett parttal és dús nádasokkal övezett vízfelület nemcsak a horgászok kedvelt célpontja, hanem fontos fészkelőhelye számos vízimadárnak is. A tó környéke ideális helyszín a csendes pihenésre és családi kirándulásokra, hiszen a közelében halad el a Budapest-Balaton kerékpárút (BUBA) is. A vízpartról csodálatos kilátás nyílik a közeli kvarcitsziklákra, amelyek vöröses színe a lemenő nap fényében különleges látványt nyújt.",
      ro: "Rezervorul de apă Pázmánd este un lac de acumulare situat la poalele estice ale munților Velence, lângă pitorescul sat Pázmánd. Creat pentru gestionarea resurselor de apă și pentru prevenirea inundațiilor, lacul a devenit în timp un element central al peisajului local, fiind apreciat pentru liniștea sa și pentru posibilitățile de pescuit sportiv. Zona din jurul lacului este marcată de prezența stâncilor de cuarțit ale munților Velence, oferind un fundal dramatic pentru oglinda apei. Pázmánd este, de asemenea, o localitate cu o bogată moștenire culturală, unde vizitatorii pot combina o plimbare pe malul lacului cu vizitarea morii de apă restaurate sau a grădinilor tradiționale de pe dealul Zsidó.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tó egy mesterségesen kialakított völgyzárógátas állóvíz.", "Fő halállományát ponty, amur, kárász és süllő alkotja.", "A tavat domboldali források és a csapadékvíz táplálja.", "A közelében halad el a népszerű BUBA kerékpáros útvonal.", "Fontos pihenőhely a vonuló és fészkelő vízimadarak számára.", "A tó partjáról belátható a Veres-hegy és a szőlőskertek sora.", "A környező nádasok védelmet nyújtanak a kétéltűeknek.", "A tó víztükre visszatükrözi a közeli kvarcitsziklák vonulatait."],
      ro: ["Lacul este un rezervor artificial alimentat de pârâul Bágyom.", "Este situat în județul Fejér, la aproximativ 10 km de lacul Velence.", "Zona este renumită pentru tradiția sa viticolă și cramele istorice.", "Lângă lac se găsesc formațiuni stâncoase rare de cuarțit vechi de milioane de ani.", "Pázmánd este cunoscut și pentru 'sibálás', un obicei tradițional de Paște.", "Apa lacului este populată cu diverse specii de pești, fiind o zonă de pescuit reglementată."],
      en: []
    }
  },
  // HU-GS: Győr-Moson-Sopron
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hanság Magyarország egyik legkülönlegesebb tájegysége, amely a Kisalföld nyugati részén, Győr-Moson-Sopron vármegyében terül el. Ez a terület egykor hatalmas, összefüggő lápvidék volt, amelyet a Fertő-tóval közös vízrendszer jellemezett. A 20. század során végzett lecsapolási munkálatok jelentősen megváltoztatták a képét, de a Fertő–Hanság Nemzeti Park részeként ma is őrzi vadregényes jellegét. A vidék gazdag növény- és állatvilágnak ad otthont, ahol a mocsári teknős és a túzok mellett ritka jégkorszaki maradványfajok is megtalálhatóak. A Hanság kulturális emlékei, mint a tőzegbányászat nyomai vagy a régi gátőrházak, bepillantást engednek az itt élő ember és a természet küzdelmes, mégis harmonikus kapcsolatába. Földrajz K7 – vizes élőhelyek és ökológia.",
      ro: "Hanság este o regiune de mlaștină și pădure situată în nord-vestul Ungariei, formând împreună cu lacul Fertő o unitate ecologică transfrontalieră inclusă în patrimoniul UNESCO. După ce a fost drenată parțial în secolul al XIX-lea, zona a păstrat totuși nuclee de păduri de arini și mlaștini de turbă care adăpostesc o biodiversitate uluitoare. Hanság este locul de origine al legendei lui 'Hany Istók', un copil găsit în mlaștini în secolul al XVIII-lea care se adaptase perfect la viața acvatică. Astăzi, Parcul Național Fertő-Hanság depune eforturi uriașe pentru refacerea zonelor umede originale, oferind un habitat protejat pentru vidre, broaște țestoase de baltă și numeroase păsări rare.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Területe mintegy 55 000 hektár, amelynek egy része ma is mocsaras.", "A Fertő–Hanság Nemzeti Parkot 1991-ben hozták létre.", "A terület legmagasabb pontjai a homokszigetek, az úgynevezett „gorondok”.", "A Hanság-főcsatorna 1910 körül készült el a vízszabályozás céljából.", "A lápvidék lecsapolása előtt a terület 70%-át víz borította.", "A környéken található osztrák-magyar határ mentén haladt át az Andaui-híd."],
      ro: ["Hanság a fost odinioară cea mai mare mlaștină continuă din Europa Centrală.", "Aria protejată face parte din Parcul Național Fertő-Hanság din anul 1991.", "Găzduiește specii rare de pești precum dunărița și țiparul.", "Canalul principal Hanság colectează apele regiunii spre râul Rábca.", "Pădurile de arini sunt principalele formațiuni forestiere din zonele joase.", "În rezervația ornitologică se pot observa vulturi codalb și dropii."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Rábca folyó Északnyugat-Magyarország egyik fontos vízfolyása, amely valójában a Répce folyó folytatása. Nevét onnantól viseli, ahol a Hanság területén, Kapuvár közelében egyesül a Kis-Rába csatornával. A folyó medre a történelem során jelentős szabályozáson esett át, különösen a Hanság lecsapolási munkálatai idején. A Rábca mintegy 60 kilométert tesz meg magyar területen, mielőtt Abdánál a Mosoni-Dunába torkollik. A folyó lassú folyású, partjait sűrű nádasok és ártéri ligetek kísérik, amelyek gazdag élővilágnak adnak otthont. A Hanság és a Rábca mente ma fontos természetvédelmi terület, a Fertő–Hanság Nemzeti Park része, ahol ritka madárfajok és vidrák is megfigyelhetők.",
      ro: "Râul Rábca este un curs de apă important în nord-vestul Ungariei, având o lungime de aproximativ 50 de kilometri pe teritoriul maghiar. Acesta se formează din unirea râurilor Répce și Ikva și colectează apele din regiunea Hanság înainte de a se vărsa în brațul Dunărea de Moson, în apropierea orașului Győr. Rábca joacă un rol crucial în hidrogeologia regiunii Kisalföld, servind drept canal principal de drenaj pentru zonele joase ale Hanságului. De-a lungul istoriei, râul a fost regularizat prin construirea unor diguri și ecluze moderne, însă secțiunile sale mai sălbatice rămân zone de interes ecologic major, adăpostind comunități bogate de pești și fiind înconjurate de păduri de luncă.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A folyó a Répce és a Kis-Rába egyesüléséből jön létre.", "Magyarországi szakaszának hossza körülbelül 60 kilométer.", "Abdánál torkollik a Mosoni-Dunába, Győr szomszédságában.", "Vízjárása nagyban függ a Rába és a Duna aktuális állásától.", "A Hanság mocsárvilágának lecsapolása után nyerte el mai alakját.", "Part menti ligeterdeiben vidrák és hódok is élnek.", "A folyó mente a Fertő–Hanság Nemzeti Park védelme alatt áll.", "A Rábca-csatorna fontos szerepet játszik a térség vízkormányzásában."],
      ro: ["Râul Rábca are o lungime totală de circa 50 km în Ungaria.", "Este un afluent de dreapta al Dunării de Moson, vărsându-se la Győr.", "Bazinul său hidrografic total depășește 4.500 km².", "Sistemul de ecluze de la Győr-Révfalu reglează nivelul apelor sale la vărsare.", "Pe cursul său se găsesc zone excelente pentru pescuitul de crap și somn.", "Râul traversează regiunea Hanság, fiind esențial pentru echilibrul său hidric."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Marcal a Rába folyó legnagyobb és legjelentősebb jobb oldali mellékfolyója, amely mintegy 100 kilométer hosszan kanyarog a Dunántúli-középhegység és a Kisalföld találkozásánál. A folyó Sümegprága környékén, a Bakony és a Keszthelyi-hegység határán ered, majd észak felé tartva szeli át a Marcal-medencét. Vízgyűjtő területe több mint 3000 négyzetkilométert fed le, magába foglalva a Bakony nyugati lejtőinek patakjait, mint például a Torna- és a Gerence-patakot. A folyó alsó szakasza Koroncó és Gyirmót térségében ér véget, ahol Győr közelében egyesül a Rábával. A Marcal völgye egykor gazdag mocsárvilág volt, mára azonban a szabályozott meder és a környező mezőgazdasági területek határozzák meg a táj képét.",
      ro: "Râul Marcal este unul dintre principalii afluenți ai râului Rába, având o lungime totală de aproximativ 100 de kilometri. Acesta izvorăște de pe versanții sudici ai munților Bakony și curge spre nord, străbătând câmpiile vestice ale Ungariei. Râul este cunoscut în istoria recentă pentru tragedia ecologică din 2010, când o scurgere de noroi roșu a afectat grav ecosistemul său, însă prin eforturi masive de curățare și repopulare, natura s-a regenerat vizibil. Astăzi, Marcal este din nou un curs de apă plin de viață, cu o albie regularizată dar mărginită de vegetație bogată, fiind o zonă importantă pentru agricultura locală prin sistemele de irigații pe care le alimentează.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A folyó teljes hossza megközelítőleg 100,4 kilométer.", "A Bakony és a Keszthelyi-hegység találkozásánál ered.", "A Rába folyóba torkollik Gyirmót és Koroncó térségében.", "Vízgyűjtő területe eléri a 3084 négyzetkilométert.", "Főbb mellékvizei a Torna, a Hajagos és a Gerence-patak.", "A folyó menti rétek fontos fészkelőhelyei a bíbicnek.", "Egykor malmok sora működött a folyó sodrását kihasználva.", "A Marcal-medence termékeny öntéstalaja kedvez a növénytermesztésnek."],
      ro: ["Lungimea totală a râului Marcal este de aproximativ 100 de kilometri.", "Se varsă în râul Rába în apropierea orașului Győr.", "Bazinul său hidrografic se întinde pe o suprafață de circa 3.000 km².", "Râul traversează câmpiile de la poalele munților Bakony și Somló.", "Apele sale sunt folosite istoric pentru funcționarea morilor din regiune.", "Monitorizarea calității apei este acum una dintre cele mai stricte din țară."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Répce egy nemzetközi folyó, amely az osztrák Rozália-hegységben ered és Magyarországon, a Hanság területén ér véget, ahol a Kis-Rábával egyesülve Rábca néven folytatja útját. A folyó felső szakasza gyorsabb folyású, hegyi jellegű, de a magyar határt átlépve lassul, és kiterjedt ártéri erdőket táplál. Különösen híres a Répce-menti keményfaligetekről, ahol tavasszal több millió tő védett tőzike virágzik, felejthetetlen látványt nyújtva a természetjáróknak. A folyó menti Csáfordjánosfa környéki erdők a Fertő–Hanság Nemzeti Park féltett kincsei. A Répce völgye fontos ökológiai folyosó az Alpok és a Kisalföld között, segítve számos növény- és állatfaj vándorlását és fennmaradását.",
      ro: "Râul Répce (cunoscut sub numele de Rabnitz în Austria) este un curs de apă transfrontalier care izvorăște din Alpii austrieci și intră în Ungaria în apropierea localității Bük. Cu o lungime totală de circa 120 de kilometri, râul străbate peisaje variate, de la zone deluroase la câmpiile plane ale Hanságului, unde în final se unește cu alte pârâuri pentru a forma râul Rábca. Répce este renumit pentru puritatea apelor sale în cursul superior și pentru pădurile de luncă protejate care îl mărginesc. Valea sa oferă un coridor ecologic vital pentru migrația animalelor sălbatice între Alpi și Câmpia Panonică, fiind totodată o resursă valoroasă pentru stațiunile balneare din zonă, precum Bükfürdő.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A folyó Ausztriában, a Rozália-hegységben (Rosaliengebirge) ered.", "Magyarországon a Hanság kapujában egyesül a Kis-Rábával.", "A Répce és a Rábca folyó valójában ugyanazt a vízfolyást alkotja.", "A csáfordi erdőben több millió tő tőzike virágzik tavasszal.", "A folyó mentén kocsányos tölgyekből álló ligeterdők találhatók.", "Élővilágában ritka pataki halak és vidrák is képviseltetik magukat.", "Fontos szerepet tölt be a Sopron–Vasi-síkság vízellátásában.", "A Répce-völgy a Fertő–Hanság Nemzeti Park része."],
      ro: ["Râul are o lungime de aproximativ 120 km, din care 82 km în Ungaria.", "Secțiunea maghiară a râului începe lângă localitatea Zsira.", "Face parte din bazinul hidrografic al Dunării, via râurile Rábca și Rába.", "Pădurea Répce de lângă Répcevis este o rezervație naturală locală importantă.", "În apele sale trăiesc specii de pești sensibile la poluare, precum zglăvoaca.", "Inundațiile râului au creat depozite fertile de aluviuni în valea sa."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A szigetközi erdők Magyarország egyik legkülönlegesebb ökoszisztémáját alkotják a Duna hordalékából épült „szárazföldi deltában”. A terület erdőit a víz közelsége és a talajvízszint dinamikus változása határozza meg, létrehozva a puhafa- és keményfaligetek mozaikját. A legalacsonyabb szinteken bíborfűz-bokorfüzesek, a hullámtéren pedig hatalmas fehér fűz és nyárfákból álló erdők találhatók. A Szigetköz botanikai ritkasága a „dealpin” jelleg, ami azt jelenti, hogy az Alpokból a folyó által lehozott növényfajok, mint a tűzliliom, itt a síkságon is megtelepedtek. Az ártéri erdők mélyén fekete gólyák, rétisasok és eurázsiai hódok élnek, a mindent átszelő vadszőlő-indák miatt pedig a belső ágrendszereket gyakran nevezik a „magyar Amazonasnak”.",
      ro: "Pădurile din Szigetköz fac parte din cea mai mare insulă fluvială a Dunării, un peisaj deltaic interior unic în Europa. Această regiune este un labirint de brațe secundare, canale și insule, unde pădurile de luncă (dominante fiind sălciile și plopii) inundate periodic creează o biodiversitate incredibilă. Szigetköz este considerat 'darul Dunării', ecosistemul său depinzând direct de regimul hidrologic al fluviului. Pădurile adăpostesc specii rare de plante acvatice, colonii impresionante de stârci și cea mai mare populație de vidre din regiune. Pentru vizitatori, zona este un paradis al ecoturismului, oferind posibilități nelimitate pentru plimbări cu caiacul prin 'pădurea de apă' și pentru observarea naturii sălbatice.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Szigetközben él a hazai védett állatfajok mintegy 30%-a.", "A terület a Duna hordalékából épült, úgynevezett szárazföldi delta.", "Ritka „dealpin” növényfaja a lángvörös virágú tűzliliom.", "Az erdőkben fészkel a fokozottan védett fekete gólya és a rétisas.", "A hazai halfajok 75%-a megtalálható a szigetközi ágrendszerben.", "A hűvös mikroklíma miatt jégkorszaki maradványnövények is élnek itt.", "A hullámtéri erdőkben tavasszal tömegesen nyílik a nyári tőzike.", "Az ártéri erdőket az 1990-es évektől visszatelepült hódok lakják."],
      ro: ["Szigetköz este delimitată de Dunărea principală și Dunărea de Moson.", "Suprafața totală a pădurilor și zonelor umede protejate este de peste 9.000 ha.", "Găzduiește peste 200 de specii de păsări și 60 de specii de pești.", "Sistemul de brațe ale Dunării se întinde pe o lungime de circa 50 km.", "Aici se găsesc 'insule de pădure' care rămân uscate chiar și la viituri medii.", "Zona face parte din Parcul Natural Szigetköz, înființat în anul 1987."],
      en: []
    }
  },
  // HU-HB: Hajdú-Bihar
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Berettyó folyó a Tiszántúl egyik legfontosabb mellékvize, amely Erdélyben, a Réz-hegységben ered és Szeghalom közelében torkollik a Sebes-Körösbe. Teljes hossza közel 167 kilométer, amelynek jelentős része magyar területen, Hajdú-Bihar és Békés vármegyén halad át. A folyó szabályozása előtt hatalmas mocsárvilágot táplált a Nagy-Sárréten, amely alapjaiban határozta meg a környék néprajzát és életmódját. Napjainkban a Berettyó menti táj nemcsak mezőgazdasági szempontból jelentős, hanem fontos ökológiai folyosó is, ahol számos védett madárfaj fészkel. A part menti települések, mint Berettyóújfalu, szorosan kötődnek a folyóhoz, amely egykor fontos kereskedelmi és szállítási útvonalként is szolgált a hegyvidék és az alföldi rónák között. Földrajz K7 – folyóvizek és vízgazdálkodás.",
      ro: "Râul Berettyó (în română Barcău) este un curs de apă transfrontalier lung de 167 de kilometri, care izvorăște din Carpații Occidentali (Munții Plopiș) din România și străbate regiunea istorică a Bihorului înainte de a intra în Ungaria. În trecut, râul alimenta vastul sistem de mlaștini Nagy-Sárrét, însă lucrările de regularizare de anvergură din secolul al XIX-lea i-au schimbat radical cursul, transformându-l într-o arteră controlată prin diguri. Astăzi, Berettyó trece prin orașe precum Berettyóújfalu și se varsă în râul Sebes-Körös. Deși transformat, râul păstrează zone naturale valoroase, fiind o resursă importantă pentru agricultura din Câmpia Crișurilor și un loc tradițional pentru pescuit și recreere locală.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A folyó teljes hossza 167,4 km, vízgyűjtő területe 5840 km².", "Forrása Romániában, Szilágy megyében található, 600 méter feletti magasságban.", "A 19. századi vízszabályozás során medrét jelentősen megrövidítették.", "A Berettyó-csatorna köti össze a folyót a Tiszával Keleti-főcsatorna révén.", "Átlagos vízhozama a torkolatnál mindössze 10 köbméter másodpercenként.", "A folyó neve a régi magyar „berek” és „jó” (folyó) szavak összetételéből ered."],
      ro: ["Lungimea totală a râului este de 167 km, din care 78 km pe teritoriul Ungariei.", "Izvorăște din România, lângă localitatea Tusa, județul Sălaj.", "Se varsă în râul Sebes-Körös (Crișul Repede) în apropierea localității Szeghalom.", "Cel mai mare afluent al său este râul Ér (Ier), care i se alătură la Pocsaj.", "Numele râului este de origine maghiară, însemnând 'râu cu berek' (pădurice).", "Regularizarea râului în secolul XIX a dus la secarea mlaștinii Nagy-Sárrét."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A debreceni Vekeri-tó a város környéki Erdőspuszták legnépszerűbb pihenőhelye, amely az 1970-es években jött létre mesterségesen. A 18 hektáros tórendszert egy mocsaras terület rehabilitációja során alakították ki a Kati-ér vizének felhasználásával. Megnyitása után hamar a környék egyik fő turisztikai vonzereje lett, ahol sétahajózás, kemping és fesztiválok várták a látogatókat. A tó sekély vize miatt rendkívül érzékeny az aszályra, 2022-ben szinte teljesen kiszáradt, ám a CivAqua-program révén a Tisza vizével sikerült újraéleszteni. Partján rendezett piknikezőhelyek, kilátó és kalandpark található, a víztükör pedig ideális helyszín a horgászathoz és a madármegfigyeléshez a homokbuckák ölelésében.",
      ro: "Lacul Vekeri este un lac artificial situat la sud-est de Debrețin, fiind creat în anii 1970 ca parte a sistemului de rezervoare Erdőspuszták. Suprafața sa variază între 10 și 18 hectare, în funcție de nivelul precipitațiilor, și este înconjurat de o zonă împădurită pitorească. Lacul a fost proiectat pentru a oferi oportunități de recreere locuitorilor din regiune, devenind rapid o destinație populară pentru plimbări cu barca, pescuit și evenimente în aer liber, cum ar fi concerte și festivaluri de tineret. Deși în ultimii ani s-a confruntat cu perioade de secetă severă, rămâne un simbol al eforturilor de gestionare a apei în Câmpia Maghiară.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tavat 1974-ben kezdték építeni egy mocsaras terület helyén.", "A teljes tórendszer területe megközelítőleg 18 hektár.", "Vízellátását eredetileg a Kati-ér biztosította, ezért Kati-tónak is hívják.", "Az 1970-es években nemzetközi kemping-világtalálkozónak adott otthont.", "A CivAqua-program keretében a Tisza vizével pótolják a vízkészletét.", "Közvetlen közelében található a Zsuzsi Erdei Vasút egyik állomása.", "A tó partján álló kilátóból belátható az Erdőspuszták tája.", "Gyakori fészkelő madara a búbos vöcsök és a tőkés réce."],
      ro: ["Lacul a fost creat artificial în anul 1970.", "Suprafața medie a luciului de apă este de aproximativ 10-12 hectare.", "Este situat la doar 13 kilometri de centrul orașului Debrețin.", "Face parte din rețeaua de lacuri de agrement Erdőspuszták.", "Zona dispune de un punct de observare a păsărilor și facilități de camping.", "În 2022, lacul a secat complet din cauza secetei extreme, fiind ulterior revitalizat."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Debrecentől keletre elterülő Erdőspuszták egy különleges tájvédelmi körzet, ahol a Nyírség homokbuckái, a mocsaras nyírvízlaposok és az őshonos tölgyesek alkotnak sajátos mozaikot. A terület neve az erdő és a puszta váltakozására utal, ami a 19. századi erdőtelepítések és a legeltetés során alakult ki. A legmagasabb pontja a 151 méter magas Hármashegy, amely nevét három elkülönülő homokbuckáról kapta. Az Erdőspuszták növényvilágának ékkövei a gyöngyvirágos tölgyesek, ahol tavasszal illatos virágszőnyeg fogadja a látogatókat. A táj történelméhez hozzátartoznak a vákáncsosok, azok a nincstelen családok, akik földbe vájt kunyhókban élve gondozták a frissen telepített erdőket a múlt századokban.",
      ro: "Erdőspuszták reprezintă o zonă peisagistică protejată care se întinde la est de Debrețin, acoperind o suprafață de peste 4.800 de hectare. Această regiune este un amestec fascinant de păduri de salcâm, stejar și pin, intercalate cu mlaștini și lacuri de acumulare. Istoria zonei este strâns legată de exploatarea tradițională a resurselor forestiere și de transformarea peisajului prin plantări sistematice începând cu secolul al XVIII-lea. Biodiversitatea este remarcabilă, adăpostind specii rare de plante, cum ar fi irisul siberian, și numeroase specii de păsări protejate, fiind un loc ideal pentru educație ecologică și turism activ.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A terület legmagasabb pontja a 151 méteres Hármashegy.", "Itt található a 18 méter magas Hármashegyi-kilátó.", "A várostól 10 km-re fekvő terület a Nyírség déli peremén található.", "A gyöngyvirágos tölgyesek az erdőssztyepp növényzet maradványai.", "A vákáncsosok földbe vájt kunyhókban éltek a 19. században.", "Átszeli a területet a 4. századi szarmata védvű, az Ördögárok.", "A Bánki Bemutatóházban vákáncsos kunyhó másolata is látható.", "Itt közlekedik Magyarország legrégebbi kisvasútja, a Zsuzsi vonat."],
      ro: ["Aria protejată a fost înființată oficial în anul 1988.", "Acoperă o suprafață totală de aproximativ 4.800 de hectare.", "Cel mai înalt punct al zonei este dealul munto-nisipos numit 'Csonka-torony'.", "Pădurile de aici au fost plantate inițial pentru a opri eroziunea solului nisipos.", "Include arboretul Bánk, unde se găsesc specii forestiere din întreaga lume.", "Regiunea este traversată de numeroase trasee de drumeție și piste pentru biciclete."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hortobágy-folyó a Tiszántúl és a magyar puszta központi vízfolyása, amely mintegy 167 kilométer hosszan kanyarog az Alföld szívében. Érdekessége, hogy nincs klasszikus forrása: Tiszavasvári határában ágazik ki a Keleti-főcsatornából, majd a puszta mélyedéseit követve tart dél felé. A folyó folyása rendkívül lassú, esése minimális, ezért a széliránytól és vízállástól függően időnként mindkét irányba képes folyni. Partjai mentén kiterjedt mocsárvilág és ártéri erdők húzódnak, amelyek a Hortobágyi Nemzeti Park részeként szigorú védelmet élveznek. A folyó végül Mezőtúr közelében torkollik a Hármas-Körösbe. Történelmi jelentőségét növeli a rajta átívelő Kilenclyukú híd, amely a folyó és a pusztai élet jelképévé vált.",
      ro: "Râul Hortobágy este o cale navigabilă unică în estul Ungariei, având o lungime totală de 167,3 kilometri. Interesant este faptul că râul nu are un izvor montan clasic, ci se formează în apropierea localității Tiszavasvári, colectând apele din regiunea Hortobágy și din canalul principal Keleti. Râul traversează inima Parcului Național Hortobágy, o zonă inclusă în patrimoniul mondial UNESCO, și are o pantă extrem de mică, ceea ce face ca uneori apa să pară că stă pe loc sau chiar să curgă în sens invers. Pe malurile sale se află celebrul Pod cu Nouă Arcuri, cel mai lung pod de piatră din Ungaria.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A folyó teljes hossza magyarországi szakaszán 167,3 kilométer.", "Tiszavasvári közelében, a Keleti-főcsatornából indul ki.", "A Hármas-Körösbe torkollik Mezőtúr déli határában.", "A puszta központi vizeként a Hortobágyi Nemzeti Park magterülete.", "Igen kis esése miatt képes megfordítani a folyási irányát.", "A folyó felett ível át Magyarország leghosszabb kőhídja.", "Fontos szerepet játszik a halastórendszerek vízellátásában.", "Mocsaras partvidéke darvak és kócsagok fontos pihenőhelye."],
      ro: ["Lungimea totală a râului este de 167,3 kilometri.", "Bazinul său hidrografic acoperă o suprafață de aproximativ 5.500 km².", "Se varsă în râul Hármas-Körös la sud de orașul Mezőtúr.", "Lățimea albiei variază între 15 și 25 de metri pe cursul principal.", "Râul este o verigă vitală pentru ecosistemul de mlaștini și stepe din Puszta.", "Podul cu Nouă Arcuri de peste râu a fost construit între 1827 și 1833."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Fancsikai-tavak Debrecentől keletre, az Erdőspuszták ölelésében található mesterséges tórendszer tagjai, amelyek a 20. század második felében jöttek létre. Eredetileg rekreációs és víztározási célokkal alakították ki őket, és évtizedeken át a debreceniek kedvelt kiránduló- és horgászhelyeként szolgáltak. A tavak vízellátását a Kati-ér és a csapadékvíz biztosítja, ám az utóbbi évek aszályos időszakai komoly kihívás elé állították a tórendszert. Ennek ellenére a környék gazdag élővilággal rendelkezik; a környező nádasokban és erdőségekben számos vízimadár és apróvad talál menedéket. A tavak menti kilátók és tanösvények a természetjáróknak nyújtanak kikapcsolódást, bemutatva a Nyírség és a Hajdúság találkozásának sajátos flóráját és faunáját. Földrajz K6 – alföldi vizek és környezetvédelem.",
      ro: "Sistemul de lacuri Fancsika, format din trei rezervoare principale (Fancsika I, II și III), este situat în regiunea Erdőspuszták, lângă Debrețin. Aceste lacuri au fost create în anii 1970 prin bararea pârâului Létai, cu scopul principal de a colecta apele pluviale și de a oferi spații pentru agrement și pescuit. De-a lungul deceniilor, lacurile au devenit un habitat crucial pentru fauna locală, în special pentru păsările de apă care folosesc zona ca punct de oprire în timpul migrației. Din păcate, schimbările climatice au dus la scăderi drastice ale nivelului apei, transformând uneori lacurile în câmpii înverzite, ceea ce necesită intervenții constante de umplere artificială.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tórendszer három fő tározóból áll (Fancsika I, II és III).", "Összesen mintegy 90 hektárnyi vízfelületet foglaltak el a legteljesebb állapotukban.", "A tavakat az 1970-es évek elején alakították ki a Kati-ér völgyében.", "A Fancsika I. tó mellett található a Panoráma-út kedvelt pihenőhelye.", "A tavak átlagos mélysége mindössze 1,5–2 méter között mozog.", "A terület része az Erdőspuszták jóléti parkerdő hálózatának."],
      ro: ["Rezervoarele au fost finalizate și date în folosință în cursul anilor 1970.", "Volumul maxim de apă al sistemului depășește 1,5 milioane de metri cubi.", "Sunt renumite printre pescari pentru populațiile de crap și amur.", "Malurile sunt dotate cu turnuri de observație pentru iubitorii de ornitologie.", "Lacul Fancsika I este cel mai mare din cele trei componente ale sistemului.", "Zona face parte dintr-un coridor ecologic protejat de interes regional."],
      en: []
    }
  },
  // HU-HE: Heves
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Galyatető a Mátra és egyben Magyarország egyik legmagasabb pontja, amely 964 méteres tengerszint feletti magasságával emelkedik a táj fölé. Ez a terület nemcsak a túrázók körében népszerű, hanem történelmi üdülőhelyként is ismert; az itt található Nagyszálló az 1930-as években épült, és azóta is a hazai hegyvidéki turizmus szimbóluma. A csúcson álló Galya-kilátó, amely egy régi épület modernizálásával nyerte el mai formáját, páratlan körpanorámát nyújt: tiszta időben akár a Tátra vonulatai is láthatóak. A hegy éghajlata szubalpin jellegű, így a nyári hőség elől menekülőknek és a téli sportok kedvelőinek egyaránt ideális úti cél. A Galyatető körüli bükkerdők és hegyi rétek számos ritka növényfajnak adnak otthont a Mátrai Tájvédelmi Körzet oltalmában. Földrajz K7 – hegyvidéki formakincs és turizmus.",
      ro: "Galyatető este al doilea cel mai înalt vârf din munții Mátra și din Ungaria, atingând o altitudine de 964,4 metri deasupra nivelului mării. Situat într-un peisaj montan spectaculos, este una dintre cele mai populare destinații turistice pe tot parcursul anului, oferind condiții excelente pentru drumeții vara și sporturi de iarnă în sezonul rece. Punctul de reper principal este turnul de observație Galya-kilátó, o structură de piatră renovată în 2015 care a primit numeroase premii internaționale de arhitectură. De pe platforma sa de observație, vizitatorii se pot bucura de o panoramă de 360 de grade, care, în zilele senine, permite vizualizarea crestelor munților Tatra.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Magassága 964 méter, ezzel hazánk harmadik legmagasabb hegycsúcsa.", "A Galya-kilátó 2016-ban kapta meg a nemzetközi építészeti nívódíjat.", "A Galyatetői Nagyszálló 1937 és 1939 között épült luxusüdülőnek.", "A hegyen található Magyarország legmagasabban fekvő temploma, a Magyarok Nagyasszonya templom.", "Az éves csapadékmennyiség itt eléri a 700-800 millimétert.", "Kodály Zoltán zeneszerző gyakori vendége volt az üdülőhelynek, itt írta több művét is."],
      ro: ["Altitudinea exactă a vârfului este de 964,4 metri.", "Turnul Galya-kilátó a fost înălțat la 30 de metri în timpul renovării din 2015.", "Galyatető deține recordul pentru cel mai înalt punct de cazare din Ungaria.", "Biserica catolică din stațiune a fost construită în 1941 de arhiducele Iosif.", "Zona este traversată de 'Traseul Național Albastru' (Országos Kéktúra).", "Temperaturile de aici sunt, în medie, cu 6-8 grade mai mici decât în câmpie."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Sár-hegy a Mátra déli lábánál, Gyöngyös városa felett magasodó vulkanikus eredetű tanúhegy, amely 445 méteres magasságával messziről felismerhető. Ez a terület különleges biogeográfiai sziget, ahol a hegyvidéki és az alföldi fajok találkoznak, létrehozva egy rendkívül diverz ökoszisztémát. A hegy déli lejtői évszázadok óta híresek szőlőművelésükről, itt teremnek a Mátrai borvidék kiváló fehérboraihoz alapanyagul szolgáló fürtök. A hegytetőn található Szent Anna-tó egyedülálló krátertó, amely bár időnként kiszárad, fontos élőhelye a kétéltűeknek. A Sár-hegy természetvédelmi terület, ahol a pusztafüves lejtőkön tavasszal a tavaszi hérics és a leánykökörcsin virít, a sziklagyepeken pedig ritka rovarfajok figyelhetőek meg. Földrajz K8 – vulkanizmus és mezőgazdaság.",
      ro: "Muntele Sár-hegy, situat la marginea orașului Gyöngyös, este un deal de origine vulcanică ce reprezintă avanpostul sudic al munților Mátra. Deși are o înălțime modestă de 497 de metri, importanța sa ecologică este imensă, fiind declarată rezervație naturală încă din 1975. Microclimatul specific permite coexistența vegetației montane cu specii mediteraneene rare, creând un mozaic botanic unic. Versanții muntelui sunt acoperiți parțial de podgorii faimoase, făcând parte din regiunea viticolă Mátra, unde tradiția cultivării viței-de-vie datează de secole. De pe culme, priveliștea se deschide larg către Câmpia Maghiară și spre orașul Gyöngyös.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Legmagasabb pontja 445 méterrel magasodik a tengerszint fölé.", "A hegyen található Szent Anna-kápolna 1767-ben épült barokk stílusban.", "A terület 1975 óta élvez természetvédelmi oltalmat 365 hektáron.", "A Szent Anna-tó egy természetes úton feltöltődött vulkáni mélyedésben alakult ki.", "A hegyről tiszta időben ellátni a Tisza-tóig és a Bükk vonulataiig.", "Itt halad át a Rákóczi-turistaút, amely Gyöngyöst köti össze Mátrafüreddel."],
      ro: ["Înălțimea maximă a vârfului Sár-hegy este de 497 de metri.", "Statutul de rezervație naturală a fost obținut în anul 1975.", "Pe munte se află lacul Szent Anna, un mic lac de acumulare naturală.", "Zona găzduiește peste 1.000 de specii de fluturi documentate.", "Este renumit pentru plante rare precum Iris pumila și degețelul lânos.", "Capela Sfânta Ana de pe munte este un loc de pelerinaj local din secolul XVIII."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tarna a Zagyva legnagyobb mellékfolyója, amely a Cserhát és a Mátra közötti völgyben, a Heves–Borsodi-dombságban ered. Közel 105 kilométeres útja során átszeli Heves vármegyét, érintve olyan történelmi településeket, mint Verpelét vagy Jászárokszállás. A folyó vízjárása rendkívül szeszélyes; tavasszal a hóolvadáskor jelentősen megduzzadhat, míg a száraz nyári hónapokban szinte patakká szelídül. A Tarna völgye fontos mezőgazdasági terület, de természeti értékei is kiemelkedőek: a folyó menti ártéri erdők és rétek számos védett állatfajnak, köztük vidráknak és hódoknak nyújtanak otthont. A folyó alsó szakasza a Jászság határán torkollik a Zagyvába, ahol a két víz összefolyása jellegzetes síkvidéki tájat alkot. Földrajz K7 – folyóhálózat és vízrajz.",
      ro: "Râul Tarna este un curs de apă semnificativ în nordul Ungariei, având o lungime de 105 kilometri și un bazin hidrografic ce se întinde pe aproximativ 2.150 km². Izvorăște din munții Cserhát, la granița cu Slovacia, și curge spre sud, traversând văi pitorești și localități istorice înainte de a se vărsa în râul Zagyva. Tarna este cunoscută pentru fluctuațiile sale mari de debit; primăvara poate provoca inundații din cauza topirii zăpezii, în timp ce vara poate seca aproape complet în porțiunile sale superioare. Ecologia râului este bogată, malurile sale oferind refugiu multor specii de animale sălbatice și fiind zone preferate pentru pescuitul sportiv de mreană și clean.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A folyó teljes hossza 105 kilométer, vízgyűjtője 2116 km².", "Forrása Istenmezeje közelében, mintegy 300 méteres magasságban található.", "A Tarna medre Jászjákóhalma közelében egyesül a Zagyva folyóval.", "A folyó mentén található Tarnaszentmária temploma az egyik legrégebbi hazai épített emlék.", "Vízhozama az alsó szakaszon átlagosan 4-5 köbméter másodpercenként.", "A Tarna völgyében jelentős a zöldségtermesztés a kedvező öntözési lehetőségek miatt."],
      ro: ["Lungimea totală a cursului de apă este de 105 kilometri.", "Se varsă în râul Zagyva în apropierea localității Jászjákóhalma.", "Cea mai mare inundație documentată pe Tarna a avut loc în anul 1999.", "Râul formează o graniță naturală între munții Mátra și Cserhát.", "Valea Tarna este o zonă istorică importantă pentru cultura palocilor.", "În apele sale trăiesc specii protejate precum dunărița și boișteanul."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Eger-patak a Mátra és a Bükk-vidék találkozásánál eredő jelentős vízfolyás, amely keresztülfolyik Heves vármegye székhelyén, Eger városán. A patak nemcsak esztétikai szempontból meghatározó eleme az egri városképnek, hanem történelmileg is fontos volt a város ipari fejlődésében; egykor számos vízimalmot hajtott a medre mentén. Északi irányból dél felé haladva a hegyvidéki patakból fokozatosan lassabb folyású vizzé válik, mielőtt a Tisza-tó északi medencéjébe torkollana. A patak völgye a Bükki Nemzeti Park peremén húzódik, így gazdag növény- és állatvilággal rendelkezik, a vízi növényzettől a ritka madárfajokig. A part menti sétányok Egerben a helyiek és a turisták kedvelt pihenőhelyei. Földrajz K6 – városi vízfolyások és helytörténet.",
      ro: "Pârâul Eger, cunoscut local și ca pârâul Rima în cursul său inferior, este principala axă hidrografică a orașului Eger și a regiunii înconjurătoare. Având o lungime de 68 de kilometri, acesta colectează apele de pe versanții sudici ai munților Bükk, traversând o vale strâmtă și pitorească înainte de a ajunge în orașul baroc Eger. Pârâul are o importanță istorică deosebită, malurile sale fiind fortificate în epoca otomană și folosite pentru numeroase mori de apă în perioada modernă. Astăzi, pârâul Eger este un element peisagistic central, oferind zone de promenadă relaxante și alimentând cu apă lacurile de agrement din bazinul său înainte de a se vărsa în râul Tisa.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A patak hossza 68 kilométer, amely a Bükk-fennsík nyugati szélén ered.", "Eger belvárosában a patak medre kőfallal szabályozott csatornában halad.", "A vízfolyás a Tisza-tóba torkollik Poroszló és Négyes között.", "Az 1878-as egri árvíz során a patak rekordmagas szintet ért el, súlyos károkat okozva.", "A patak mentén korábban több mint 20 vízimalom üzemelt Szarvaskő és Eger között.", "A vízminőség védelme érdekében a patak felső szakasza szigorúan védett terület."],
      ro: ["Lungimea totală a pârâului Eger este de 68 de kilometri.", "Traversează orașul Eger pe o distanță de aproximativ 5 kilometri.", "Izvorăște la o altitudine de 360 de metri lângă localitatea Balaton (HU).", "Se varsă în lacul Tisa (rezervorul Kisköre) lângă Poroszló.", "Reglarea albiei sale în orașul Eger a început în secolul al XVIII-lea.", "În apă pot fi observați adesea păstrăvi și vidre în secțiunile superioare."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Mátrai Tájvédelmi Körzet az Északi-középhegység egyik legértékesebb védett területe, amely a Mátra-hegység központi tömbjét és annak lejtőit foglalja magában. Az 1985-ben alapított körzet feladata a vulkanikus hegyvidék egyedülálló geológiai formáinak és gazdag élővilágának megőrzése. A területet hatalmas bükkösök és tölgyesek uralják, ahol olyan ritka ragadozó madarak költenek, mint a parlagi sas vagy a békászó sas. A tájvédelmi körzet része a Kékes-tető és Galyatető környéke is, ahol a magassági övezetesség miatt szubalpin növényfajokat is találunk. A kirándulókat jól kiépített turistautak, források és kilátóhelyek várják, amelyek minden évszakban más-más arcát mutatják Magyarország legmagasabb hegységének. Természetismeret K5 – erdők életközössége és természetvédelem.",
      ro: "Aria de Protecție Peisagistică Mátra cuprinde pădurile vaste ale celui mai înalt lanț muntos din Ungaria, acoperind peste 12.000 de hectare de teren protejat. Pădurile sunt dominate de fagi la altitudini mari și de stejari pe versanții sudici mai calzi, formând un plămân verde vital pentru nordul țării. Această zonă forestieră este renumită pentru puritatea aerului și pentru diversitatea florei, incluzând specii rare de ferigi și orhidee sălbatice. Managementul forestier aici se concentrează pe conservarea peisajului natural și pe promovarea turismului durabil, Mátra fiind străbătută de sute de kilometri de trasee marcate care duc către vârfuri precum Kékes sau formațiuni stâncoase spectaculoase.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tájvédelmi körzet területe mintegy 12 141 hektár, Heves és Nógrád vármegyében.", "A Bükki Nemzeti Park Igazgatósága alá tartozik a kezelése.", "Itt található hazánk legmagasabb pontja, a 1014 méteres Kékes-tető.", "A terület 80%-át erdő borítja, amelynek jelentős része kárpáti flóraelemekből áll.", "A körzetben több mint 100 forrás és számos különleges sziklaalakzat található.", "Ritka állatfaja a kárpáti gőte és a havasi cincér, mindkettő fokozottan védett."],
      ro: ["Aria protejată a fost înființată în anul 1985 pentru a conserva pădurile.", "Peste 80% din suprafața munților Mátra este acoperită de păduri compacte.", "Găzduiește cea mai mare populație de mufloni din Ungaria.", "În aceste păduri trăiește pasărea răpitoare rară 'acvila țipătoare mică'.", "Include rezervații forestiere unde intervenția umană este total interzisă.", "Vârful Kékes (1014 m) este punctul culminant al acestei regiuni forestiere."],
      en: []
    }
  },
  // HU-JN: Jász-Nagykun-Szolnok
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Zagyva a Jászság legfontosabb folyója és a Tisza egyik legjelentősebb mellékfolyója, amely a Karancs-hegységben ered és 179 kilométer megtétele után Szolnoknál torkollik a Tiszába. Lassú folyású, kanyargós medre az Alföld tágas rónaságait szeli át, meghatározva a vidék mezőgazdasági arculatát és vízháztartását. A folyó menti ártéri erdők és rétek gazdag élővilágnak adnak otthont, a víz pedig kiváló horgászhelyeket kínál, különösen ponty és csuka horgászatára. Szolnok városában a Zagyva és a Tisza találkozása festői látványt nyújt, a part menti sétányok pedig a helyiek kedvelt kikapcsolódási helyszínei. Történelmileg a folyó fontos szerepet játszott a jászok betelepülésében és kultúrájuk kialakulásában.",
      ro: "Râul Zagyva este unul dintre cei mai importanți afluenți ai Tisei, având o lungime considerabilă și un rol vital în hidrografia Marii Câmpii. Secțiunea de la Szolnok este deosebit de importantă, deoarece aici Zagyva se varsă în Tisa, formând un peisaj fluvial spectaculos în inima orașului. Malurile râului la Szolnok sunt amenajate pitoresc, fiind un loc preferat pentru plimbări și pentru vizitarea Coloniei de Artiști situată chiar la confluență. Zagyva traversează regiuni agricole bogate, aducând un suflu de viață zonelor de câmpie prin luncile sale verzi și habitatele de păsări. Regularizarea râului în secolul trecut a fost o lucrare de inginerie majoră pentru a preveni inundațiile devastatoare. Geografia K7 – Râuri și confluențe urbane.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Zagyva teljes hossza megközelítőleg 179 kilométer.", "A folyó Szolnok belvárosában torkollik a Tisza folyóba.", "Medre az egyik legkevésbé szabályozott alföldi folyónk.", "A folyó menti vizes élőhelyek a Natura 2000 hálózat részei.", "Szolnokon a Zagyva-parti sétány modern rekreációs övezet.", "A folyó táplálja a Jászság öntözőcsatorna-rendszerét.", "Itt található az ország egyik legjelentősebb fehér gólya állománya.", "A torkolat közelében épült fel a szolnoki művésztelep 1902-ben."],
      ro: ["Râul Zagyva are o lungime totală de 179 km.", "Izvorăște din Munții Cserhát, la o altitudine de aproximativ 500 de metri.", "La Szolnok, râul formează o peninsulă unde se află celebrul parc al orașului.", "Valea Zagyva este renumită pentru pământurile negre foarte fertile.", "Confluența cu Tisa este un punct strategic monitorizat pentru debitele de apă.", "În apropierea râului se găsesc numeroase situri arheologice din perioada migrațiilor."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hortobágy-Berettyó egy különleges vízfolyás, amely a Hortobágy és a Nagykunság határán kanyarog, összekötve a pusztát a Berettyó folyóval. Tulajdonképpen egy mesterségesen szabályozott csatornázott folyó, amely az egykori mocsárvilág lecsapolása során nyerte el mai formáját a 19. században. Lassú folyása miatt medrét sűrű nádasok és mocsári növényzet szegélyezi, ami ideális fészkelőhelyet biztosít a vízi madaraknak, például a bakcsónak és a kiskócsagnak. A folyó fontos szerepet játszik a Hortobágyi Nemzeti Park vízháztartásában, biztosítva a vízpótlást a száraz nyári időszakokban. A csendes, háborítatlan partvidék a természetfotósok és a magányt kedvelő horgászok egyik utolsó menedéke az Alföldön.",
      ro: "Râul Hortobágy-Berettyó este un curs de apă vital pentru regiunea Marii Câmpii, fiind de fapt un canal care face legătura între râurile Hortobágy și Berettyó. Acesta joacă un rol crucial în sistemul de irigații al stepei Hortobágy și în reglarea nivelului apelor în zonele umede protejate. Cursul său liniștit traversează peisaje de o frumusețe austeră, fiind flancat de stufărișuri și pășuni unde pot fi observate specii rare de păsări de apă. Istoria sa este strâns legată de marile lucrări de hidroameliorație din secolul al XIX-lea, care au transformat mlaștinile periculoase în terenuri agricole controlate. Astăzi, râul este o destinație populară pentru pescuitul sportiv și pentru iubitorii de natură care caută liniștea câmpiei. Geografia K7 – Ape curgătoare și irigații.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Hortobágy-Berettyó are o lungime totală de aproximativ 167 km.", "Este un curs de apă artificial, creat prin regularizarea brațelor vechi ale Tisei.", "Râul formează granița naturală între județele Hajdú-Bihar și Jász-Nagykun-Szolnok.", "Sistemul de ecluze de la Ágota este un monument tehnic important pe cursul său.", "Este o zonă de cuibărit importantă pentru speciile de păsări protejate din parc.", "Debitul râului este controlat pentru a preveni inundațiile în perioadele ploioase."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Nagykunsági-víztározó a magyar vízmérnöki tudomány monumentális alkotása az Alföld aszályos területein. A mesterséges tározót azzal a céllal hozták létre, hogy a Tisza áradásai során visszatartott vizet a száraz nyári hónapokban a mezőgazdaság rendelkezésére bocsássák öntözés céljából. Hatalmas vízfelülete azonban messze túlmutat a technikai funkción: az évtizedek alatt jelentős vizes élőhellyé vált, ahol számos vonuló madár talál pihenőhelyet és táplálékot. A tározó környéke a horgászok körében is népszerű, hiszen a tiszai vízrendszerből érkező halak (ponty, süllő, harcsa) itt ideális életfeltételeket találnak. A víztükörben tükröződő alföldi égbolt látványa szinte tengerparti hangulatot áraszt a rónaság közepén.",
      ro: "Rezervorul Nagykunság este o componentă strategică a sistemului hidrografic din estul Ungariei, fiind situat în apropierea orașului Tiszafüred. Creat pentru a colecta apele râului Tisa în perioadele de viitură, rezervorul servește atât scopurilor agricole, furnizând apă pentru irigații, cât și protecției împotriva inundațiilor. Suprafața sa vastă de apă a devenit de-a lungul timpului un habitat artificial extrem de valoros, atrăgând numeroase specii de păsări migratoare și oferind condiții excelente pentru piscicultură. Zona este tot mai populară pentru turismul ecologic, oferind posibilități de canotaj și observarea păsărilor într-un cadru liniștit. Este un exemplu de inginerie hidraulică care lucrează în armonie cu mediul înconjurător. Geografia K8 – Gospodărirea apelor și agricultura.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Rezervorul face parte din sistemul complex de canale al Marii Câmpii.", "Capacitatea de stocare a apei este de ordinul zecilor de milioane de metri cubi.", "Nivelul apei este reglat prin barajul de la Kisköre.", "Rezervorul susține o biodiversitate bogată, incluzând specii rare de pești.", "Este o zonă importantă pentru pescarii sportivi din regiunea Tisza.", "Digurile rezervorului sunt utilizate ca trasee pentru ciclismul de cursă lungă."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tisza Szajolnál látható szakasza a folyó egyik legnyugodtabbik és legméltóságteljesebb része a közép-tiszai régióban. Itt a 'szőke' Tisza már teljes szélességében hömpölyög, partjait sűrű fűz- és nyárfaligetek kísérik, amelyek az ártéri erdők jellegzetes hangulatát adják. Szajol térsége stratégiai közlekedési pont is, hiszen itt ível át a folyón az egyik legfontosabb vasúti híd, amely Budapestet köti össze az ország keleti felével. A folyópart ezen a szakaszon kedvelt horgászhely, ahol a lassú sodrás és a mély gödrök kiváló életteret biztosítanak a harcsának és a süllőnek. Júniusban itt is megcsodálható a tiszavirágzás lenyűgöző természeti jelensége, amikor kérészek milliói táncolnak a víz felett.",
      ro: "Secțiunea râului Tisa de la Szajol este renumită pentru meandrele sale spectaculoase și pentru importanța sa în transportul feroviar, aici aflându-se unul dintre cele mai importante noduri de cale ferată din Ungaria. Râul curge liniștit prin această zonă, fiind mărginit de păduri inundabile bogate în specii de plop și salcie. Digurile înalte protejează așezările din jur, dar oferă și trasee excelente pentru plimbări și ciclism. Tisa a jucat întotdeauna un rol central în viața localnicilor, oferind resurse pentru pescuit și fiind o cale de transport esențială. Zona Szajol este de asemenea un loc preferat pentru amatorii de sporturi nautice și pentru cei care vor să admire fenomenul natural al 'înfloririi Tisei'. Geografia K7 – Râuri și infrastructură de transport.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Szajol este un punct strategic unde magistralele feroviare traversează râul Tisa.", "Podul feroviar de la Szajol este una dintre cele mai importante structuri de acest tip din țară.", "În această zonă, Tisa are o lățime medie de 150-200 de metri.", "Inundația istorică din 2000 a atins niveluri record în această secțiune.", "Pădurile de pe malul râului fac parte din sistemul de protecție Natura 2000.", "Fenomenul 'înfloririi Tisei' (eclozarea efemeridelor) poate fi observat aici în luna iunie."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tiszakürti Arborétum a Tisza partjának egyik legszebb kertépítészeti emléke, ahol a folyómenti ártéri táj és az egzotikus növényvilág harmóniája valósul meg. A 19. század végén a Bolza család által alapított kastélykert ma már országos jelentőségű természetvédelmi terület, amely több mint 500 fafajnak ad otthont. Legnagyobb látványossága a hatalmas, monumentális mocsárciprus-csoport, amelynek légzőgyökerei a vízparton különleges látványt nyújtanak. Az arborétum minden évszakban más arcát mutatja: tavasszal a rododendronok virágzása, ősszel pedig a lombhullató fák színpompája nyűgözi le a látogatókat. A park területén kilátó, tanösvény és interaktív kiállítás segít megismerni az Alföld e különleges zöld oázisának titkait.",
      ro: "Arboretumul din Tiszakürt este o grădină botanică spectaculoasă situată pe malul stâng al Tisei, fiind faimos pentru colecția sa de arbori seculari și peisajele sale armonioase. Fondat la sfârșitul secolului al XIX-lea de familia Bolza, parcul se întinde pe o suprafață de peste 60 de hectare, cuprinzând specii exotice aduse de pe toate continentele, alături de vegetația nativă a luncii Tisei. Vizitatorii pot admira platani uriași, chiparoși de baltă și o varietate impresionantă de pini. Arboretumul oferă o liniște deplină, fiind un loc ideal pentru relaxare, educație ecologică și fotografie de natură. Turnul de observare din incintă oferă o privire panoramică asupra coroanelor arborilor și a cursului râului. Științele Naturii K5 – Arbori și grădini botanice.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Arboretumul a fost înființat în anul 1880 de către contele József Bolza.", "Suprafața totală protejată a parcului este de aproximativ 60 de hectare.", "Cele mai spectaculoase exemplare sunt chiparoșii de baltă (Taxodium) cu rădăcini aeriene.", "Grădina adăpostește peste 1600 de varietăți de arbori și arbuști.", "Turnul de observare are o înălțime de 15 metri și a fost construit din lemn.", "În luna mai, înflorirea rododendronilor atrage mii de vizitatori."],
      en: []
    }
  },
  // HU-KE: Komárom-Esztergom
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Bokodi-tó, vagy ahogy sokan ismerik, a 'lebegő falu', az utóbbi években Magyarország egyik legtöbbet fotózott helyszínévé vált. A tavat az 1960-as években hozták létre a Vértesi Erőmű hűtőtavaként, és a technológiából adódóan vize még a legkeményebb téli fagyokban sem fagyott be. Ez a különleges adottság tette lehetővé, hogy a horgászok cölöpökre épült házakat emeljenek a vízen, hosszú stégekkel összekötve őket a parttal. Bár az erőmű ma már nem üzemel a korábbi kapacitással, a tó és a rajta sorakozó színes házikók látványa továbbra is misztikus és egyedülálló. A reggeli ködben úszó stégek és a víztükörben tükröződő épületek látványa miatt a tavat gyakran a 'magyar Baliként' is emlegetik a közösségi médiában.",
      ro: "Lacul Bokodi este unul dintre cele mai fotografiate și neobișnuite locuri din Ungaria, fiind celebru pentru 'satul plutitor' de case de pescari construite pe piloni. Situat lângă orașul Oroszlány, lacul este de fapt un rezervor de răcire artificial creat pentru centrala electrică din apropiere. Datorită apei calde evacuate de centrală, lacul nu îngheață niciodată complet, ceea ce îl face un loc ideal pentru pescuit pe tot parcursul anului. Pasarelele lungi de lemn care duc spre căsuțele colorate creează un peisaj suprarealist, care a devenit viral pe rețelele de socializare internaționale. Deși centrala și-a redus activitatea, lacul rămâne o destinație turistică și fotografică unică, păstrându-și atmosfera magică. Geografie K8 – Peisaje antropice și industrie.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tó vízfelülete körülbelül 160 hektár kiterjedésű.", "Az 1960-as években az oroszlányi erőmű hűtőtavaként létesült.", "Vize évtizedekig 10-15 fokkal melegebb volt a környezetnél.", "Több száz horgászház található a tó körül és a vízen.", "A tó vize híres kapitális amur- és pontyállományáról.", "A nemzetközi turisztikai magazinok 'floating village'-ként hivatkoznak rá.", "A terület a Vértes-hegység lábánál fekszik.", "Télen is fontos pihenőhelye a jégmentes vizet kereső madaraknak."],
      ro: ["Lacul Bokodi este un lac artificial de răcire creat în anii 1960.", "A devenit faimos la nivel mondial după ce a apărut în clipuri publicitare și fotografii pe social media.", "Există peste 400 de căsuțe de pescari construite pe piloni de-a lungul malurilor.", "Apa lacului rămâne cu câteva grade mai caldă decât în mod natural datorită proceselor industriale.", "Satul plutitor este adesea numit 'Maldivele Ungariei' de către turiști.", "Lacul are o suprafață de aproximativ 160 de hectare."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Által-ér a Vértes-hegységben eredő és a Dunába torkolló, Komárom-Esztergom vármegye egyik legfontosabb kisvízfolyása. Meghatározó szerepet játszik Tata, a 'vizek városa' arculatának kialakításában, hiszen ez a patak táplálja a híres tatai Öreg-tavat. A folyószabályozások előtt medre mentén számos vízi malom működött, amelyek közül több ma is ipartörténeti emlékhely. Az utóbbi évtizedekben az Által-ér völgye jelentős ökológiai rehabilitáción esett át, így ma már tiszta vizével és kiépített kerékpárútjaival a környék egyik legnépszerűbb kirándulóhelye. Fontos ökológiai folyosó, amely összeköti a középhegységi erdőket a dunai ártérrel, segítve a vadállomány és a madárvilág szabad mozgását.",
      ro: "Râul Által-ér este un curs de apă de importanță majoră pentru regiunea Transdanubiei Centrale, traversând județul Komárom-Esztergom și alimentând mai multe lacuri, inclusiv celebrul Lac Öreg din Tata. Izvorând din Munții Bakony, râul colectează apele din bazinul Vértes și se varsă în Dunăre. De-a lungul timpului, valea râului a fost un centru de activitate industrială și agricolă, dar și o zonă de o mare valoare ecologică. Recent, s-au depus eforturi considerabile pentru revitalizarea cursului de apă și pentru amenajarea unei piste de biciclete spectaculoase care urmează malurile sale, făcând legătura între Tata și Tatabánya. Este un exemplu de gestionare modernă a resurselor de apă care integrează recreerea cu protecția naturii. Geografia K7 – Rețele hidrografice și turism activ.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Lungimea totală a râului Által-ér este de aproximativ 51 km.", "Râul este principala sursă de alimentare pentru Lacul Öreg din Tata.", "Valea râului găzduiește numeroase situri arheologice din perioada romană.", "Pista de biciclete de-a lungul râului a fost votată 'Pista anului' în Ungaria în 2020.", "Debitul râului a fost afectat în trecut de activitățile miniere din bazinul Tatabánya.", "Zona gurii de vărsare în Dunăre este un habitat protejat pentru păsările de baltă."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A 756 méter magas Pilis-tető a Pilis-hegység és egyben a Dunántúli-középhegység Bakonyon kívüli legmagasabb pontja. A hegycsúcs nemcsak földrajzi, hanem szakrális jelentőséggel is bír, hiszen a pálos rend, az egyetlen magyar alapítású szerzetesrend bölcsője és történelmi központja volt. A hegytetőn 2014-ben adták át a Boldog Özséb-kilátót, amely egy régi geodéziai torony újjáépítésével jött létre, és 360 fokos körpanorámát nyújt a Dunakanyarra, a Budai-hegységre és tiszta időben a Tátrára. A hegy anyaga dachsteini mészkő, amelyre jellemzőek a meredek sziklafalak és a karsztjelenségek. A Pilis-tető a természetjárók körében kultikus hely, sokan a hegy különleges energiái miatt látogatják.",
      ro: "Vârful Pilis-tető este cel mai înalt punct al Munților Pilis, situat la o altitudine de 756 de metri, fiind un loc încărcat de istorie și spiritualitate. Vârful oferă o panoramă spectaculoasă la 360 de grade asupra Curburii Dunării, a Munților Visegrád și a Bazinului Budapestei. În trecut, zona a fost un centru important pentru Ordinul Paulin, singurul ordin călugăresc fondat în Ungaria, existând numeroase legende despre energiile locului. Astăzi, pe vârf se află turnul de observație Boldog Özséb, construit pe baza unei foste stații radar militare, oferind o perspectivă modernă asupra peisajului antic. Traseele care duc spre vârf trec prin păduri de foioase și pe lângă formațiuni stâncoase calcaroase, fiind o destinație de top pentru drumeții de weekend. Geografia K7 – Relieful carstic și peisaje montane.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Pilis-tető are o înălțime de 756 de metri, fiind cel mai înalt vârf calcaros din Ungaria.", "Turnul de observație Boldog Özséb are o înălțime de 17 metri și a fost inaugurat în 2014.", "Munții Pilis sunt formați în principal din sedimente marine de triasic (calcar și dolomit).", "Zona vârfului a fost mult timp închisă publicului din cauza instalațiilor militare sovietice.", "Există numeroase peșteri în masivul Pilis, unele având importanță arheologică.", "Pilis-tető este un punct popular de lansare pentru amatorii de parapantă."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gerecse-hegység kiterjedt erdőségei a Dunántúli-középhegység egyik legzavartalanabb természeti területét alkotják. A hegységet főként mészkő és dolomit építi fel, így erdeit mély szurdokvölgyek, barlangok és sziklás gerincek tagolják. A Gerecse híres vörös mészkövéről, amelyet 'gerecsei márványként' ismernek, és már a rómaiak óta bányásznak. Az erdőkben dominálnak a cseres-tölgyesek és a bükkösök, amelyek fontos fészkelőhelyet biztosítanak a ritka ragadozó madaraknak, például a kerecsensólyomnak és a parlagi sasnak. A csendes, eldugott völgyekben megbújó falvak (például Tardos vagy Vértestolna) és a jól jelzett turistaútvonalak miatt a Gerecse a nyugodt, tömegmentes túrázás ideális helyszíne.",
      ro: "Pădurile Munților Gerecse reprezintă unul dintre cele mai diverse ecosisteme din Transdanubia, fiind renumite pentru carierele de 'marmură roșie' și pentru bogăția de specii de păsări răpitoare. Aceste păduri, formate în principal din stejari și fagi, acoperă un relief carstic plin de peșteri și platouri calcaroase. Zona este protejată ca sit Natura 2000, fiind un refugiu crucial pentru șoimul dunărean și acvila de munte. Pe lângă valoarea naturală, pădurile Gerecse au și o importanță istorică, ascunzând urmele unor așezări medievale și posturi de observație din timpul imperiului roman. Traseele de drumeție sunt bine marcate și oferă liniște și aer curat, departe de agitația orașelor industriale din jur. Științele Naturii K6 – Ecosisteme forestiere și specii protejate.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Munții Gerecse găzduiesc una dintre cele mai importante populații de șoimi dunăreni din Europa.", "Pădurile sunt renumite pentru exploatarea calcarului roșu de la Tardos, folosit în marile palate regale.", "Există peste 300 de peșteri identificate în masivul Gerecse.", "Cea mai mare parte a zonei forestiere este declarată Parc Natural din 1977.", "Vârful Nagy-Gerecse (634 m) este dominat de un turn de televiziune impunător.", "Flora include specii rare de orhidee sălbatice care înfloresc în lunile de primăvară."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Vértes-hegység északi részén, Vérteskozma környékén található csúcsok és völgyek Magyarország egyik legfestőibb és legcsendesebb táját alkotják. Vérteskozma maga egy skanzenszerű, műemléki védettségű zsákfalu, amely mélyen az erdők közé ékelődve őrizte meg 18. századi arculatát. A környéket hullámos dolomitdombok, fehér sziklakibúvások és sűrű bükkerdők jellemzik. A Vértes-fennsík ezen szakasza különleges mikroklímával rendelkezik, ahol a szubmediterrán és a hegyvidéki növényfajok egymás mellett élnek. A túrázók számára ez a vidék a nyugalom szigete, ahol a jól kiépített tanösvények (például a környei erdőkben) bemutatják a hegység geológiai múltját és gazdag vadállományát, köztük a jelentős muflon- és szarvaspopulációt.",
      ro: "Vérteskozma este un sat-muzeu pitoresc situat în inima Munților Vértes, fiind un exemplu perfect de conservare a arhitecturii rurale germane (șvabe) din secolul al XVIII-lea. Satul, format dintr-o singură stradă străjuită de case albe cu prispă, a fost aproape abandonat la mijlocul secolului XX, dar a renăscut ca o destinație de vacanță exclusivistă. Peisajul montan din jur este caracterizat prin văi adânci și păduri de foioase care ascund ruinele unor cetăți medievale, precum castelul Vitány. Liniștea deplină, absența semnalului GSM în unele zone și stilul de viață tradițional fac din Vérteskozma un refugiu ideal pentru cei care caută deconectarea totală. Este un loc unde timpul pare să fi stat în loc, oferind o experiență culturală și naturală autentică. Istorie K5 – Minorități etnice și sate tradiționale.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Vérteskozma a fost colonizat cu populație germană în anii 1740.", "Satul este declarat monument istoric protejat, nicio construcție nouă nefiind permisă fără aviz special.", "Majoritatea caselor păstrează elementele decorative originale de acum 200 de ani.", "În apropiere se află Rezervația Naturală Vértes, faimoasă pentru geologia sa.", "Satul nu are mai mult de 20-30 de locuitori permanenți, majoritatea caselor fiind de vacanță.", "Traseul drumeției 'Vértesi Panoráma' trece prin apropierea satului."],
      en: []
    }
  },
  // HU-NO: Nógrád
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Ipoly Magyarország egyik legtermészetesebb állapotában megmaradt folyója, amely hosszú szakaszon alkot határt Szlovákia és hazánk között. Nógrád vármegyei szakasza különösen vadregényes: a folyó itt szabadon kanyarog, medrét nem szorítják gátak közé, így az áradások rendszeresen megújíthatják az ártéri réteket és mocsarakat. Ez a háborítatlan vízvilág a Duna-Ipoly Nemzeti Park része, és Európa-szerte ritka vizes élőhelynek számít. A folyó menti galériaerdőkben vidrák, hódok és jégmadarak élnek, a lassú sodrású vizek pedig kedveltek a kenutúrázók körében. Az Ipoly-völgy nemcsak természeti, hanem kulturális híd is a két ország között, ahol a régi fa hidak helyén ma már modern átkelők segítik a kapcsolatokat.",
      ro: "Râul Ipoly (Ipeľ) formează pe o lungime considerabilă granița naturală dintre Ungaria și Slovacia, fiind unul dintre cele mai sălbatice și nealterate râuri din regiune. Secțiunea sa mijlocie traversează peisaje inundabile spectaculoase, unde meandrele naturale au fost păstrate, oferind habitate ideale pentru păsări și pești. Valea Ipoly este renumită pentru biodiversitatea sa, fiind protejată prin parcuri naționale pe ambele maluri ale frontierei. Râul este popular pentru canotaj, oferind o experiență de aventură prin zone unde civilizația pare departe. Podurile reconstruite recent peste Ipoly au restabilit legăturile istorice între comunitățile de pe cele două maluri, transformând râul dintr-o barieră într-un loc de întâlnire. Geografia K7 – Râuri de frontieră și ecosisteme de luncă.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Az Ipoly teljes hossza 232 kilométer, ebből 140 km a határfolyó.", "A folyó mente Ramsari terület, nemzetközi jelentőségű vizes élőhely.", "Itt fészkel az ország egyik legjelentősebb gyurgyalag-állománya.", "A folyóban 45 halfajt mutattak ki, köztük a ritka magyar bucót.", "Szob közelében torkollik a Dunába a Börzsöny lábánál.", "A folyó völgye fontos madárvonulási útvonal Észak-Magyarországon.", "Ipolytarnóc közelében található a híres ősmaradvány-lelőhely.", "Télen a folyó ártéri rétjei hatalmas természetes korcsolyapályává fagynak."],
      ro: ["Râul Ipoly izvorăște din Munții Metaliferi Slovaci și are o lungime de 232 km.", "Pe o distanță de peste 140 km, râul servește drept graniță de stat.", "Valea Ipoly face parte din situl Ramsar, fiind o zonă umedă de importanță internațională.", "Inundațiile de primăvară sunt frecvente, creând zone temporare de cuibărit pentru păsări.", "Reconstrucția podurilor peste Ipoly a fost finanțată prin programe transfrontaliere europene.", "Este unul dintre puținele râuri maghiare unde nu s-au făcut regularizări masive pe cursul inferior."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Medves-fennsík Közép-Európa legnagyobb kiterjedésű bazaltfennsíkja, amely Salgótarján felett, az államhatáron terül el. A 8 négyzetkilométeres, 500-600 méter magasan fekvő területet millió évekkel ezelőtti vulkáni tevékenység hozta létre, amikor a felszínre törő láva hatalmas lepényként terült szét. A fennsík arculata egyedülálló: tágas hegyi kaszálók, virágos rétek és a peremeken meredek bazaltsziklák váltják egymást. A terület a Novohrad-Nógrád UNESCO Globális Geopark szíve, ahonnan lenyűgöző kilátás nyílik a közeli Salgó és Somoskő váraira, sőt tiszta időben a Magas-Tátra csúcsai is láthatók. A fennsík háborítatlan csendje és tiszta levegője miatt a túrázók és a természetfotósok egyik kedvenc célpontja.",
      ro: "Platoul Medves este cel mai mare platou bazaltic din Europa Centrală, situat la granița dintre Ungaria și Slovacia, lângă orașul Salgótarján. Format prin activitate vulcanică intensă în urmă cu milioane de ani, platoul oferă un peisaj unic, cu pajiști alpine vaste situate la peste 500 de metri altitudine, înconjurate de stânci de bazalt negru. Din punctele de observație precum stânca Szilvás-kő, se pot vedea ruinele spectaculoase ale cetăților Salgó și Somoskő, care par să vegheze zona. Platoul este o destinație fascinantă pentru geologi și iubitorii de drumeții, având trasee care trec prin foste cariere de bazalt și pe lângă 'coloane' vulcanice hexagonale. Este un monument al forțelor naturii care au modelat relieful nordului Ungariei. Geografia K7 – Relieful vulcanic și geologia.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Platoul Medves se întinde pe o suprafață de aproximativ 8-10 km².", "Altitudinea medie a platoului este de circa 520-550 de metri.", "Baza platoului este formată din gresie, peste care s-a scurs lava bazaltică.", "Carierele de bazalt de aici au furnizat piatra pentru pavarea străzilor din Viena și Budapesta.", "Pe platou se află singura fântână de munte cu apă potabilă din regiune, izvorul Petőfi.", "În timpul iernii, platoul este adesea acoperit de un strat gros de zăpadă, fiind ideal pentru schi fond."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Galga egy kicsi, de kulturálisan meghatározó folyó, amely a Cserhát-hegységben, Becske közelében ered, és a Galgamente vidékének központi vízfolyása. Bár vízhozama nem vetekszik a nagy folyókéval, a Galga évszázadokon át alakította a környék településszerkezetét és népművészetét. A folyó völgye híres színpompás népviseletéről, zenéjéről és hagyományairól, amelyek szorosan kötődnek a mezőgazdasági művelésű völgyhöz. A Galga lassan kanyarog a dombok és szántóföldek között, partjait nádasok és öreg fűzfák szegélyezik. Ökológiai szempontból fontos összekötő kapocs a hegyvidéki és az alföldi tájak között, biztosítva a vizes élőhelyek fennmaradását a szárazabb területeken is.",
      ro: "Izvorul râului Galga este situat în dealurile Cserhát, lângă localitatea Becske, fiind punctul de plecare al unui curs de apă care dă numele întregii văi Galga. Râul traversează o regiune bogată în tradiții populare maghiare, unde portul popular și obiceiurile au fost păstrate cu sfințenie până în prezent. Deși la izvor Galga este doar un fir de apă cristalină, ea devine pe parcurs un râu care alimentează terenurile agricole fertile ale zonei. Valea Galga este faimoasă pentru satele sale pitorești, precum Turura și Galgamácsa, unde cultura rurală este încă vibrantă. Izvorul în sine este amenajat ca un loc de popas pentru turiști, fiind înconjurat de păduri de foioase liniștite. Geografia K7 – Izvoare și regiuni etnografice.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Râul Galga este un afluent al râului Zagyva și are o lungime de 58 km.", "Izvorul este situat la o altitudine de aproximativ 350 de metri în Munții Cserhát.", "Valea Galga este una dintre cele mai importante micro-regiuni etnografice din Ungaria.", "Regiunea este renumită pentru pictura tradițională pe mobilă și portul popular brodat.", "Râul a fost o sursă importantă de energie pentru numeroase mori de apă în trecut.", "Flora de lângă izvor include specii protejate de ghiocei și brebenei."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Cserhát erdőségei Észak-Magyarország egyik legcsendesebb és legkevésbé felfedezett táját borítják, távol a nagy turisztikai központok zajától. A dombvidéki jellegű hegységet főként gyertyános-tölgyesek és bükkösök uralják, amelyek harmonikusan simulnak a lankás domboldalakra. A régió híres eldugott 'palóc' falvairól, mint például a világörökség részét képező Hollókő, amelyeket minden irányból sűrű erdők öveznek. A Cserháti-erdőben túrázva a látogatót a háborítatlan nyugalom és az Alföld felé nyíló tágas kilátások kísérik. Gazdag vadállománya, gombákban bővelkedő völgyei és a középkori várromok (például Szanda vagy Buják) a természetjárók és a történelemkedvelők számára egyaránt vonzó úti céllá teszik.",
      ro: "Pădurile din Munții Cserhát oferă un peisaj de o blândețe aparte, caracterizat prin dealuri domoale și văi ascunse care adăpostesc sate incluse în patrimoniul UNESCO, cum este Hollókő. Aceste păduri de stejar și carpen sunt un mozaic de natură și cultură, fiind străbătute de trasee de drumeție care fac legătura între cetăți medievale ruinate și puncte de observație moderne. Relieful variat al Cserhátului, format din roci vulcanice și sedimentare, susține o floră bogată, inclusiv numeroase specii de orhidee. Este o regiune ideală pentru drumeții lejere, oferind liniște și o perspectivă autentică asupra vieții rurale maghiare. Pădurile sunt populate de căprioare, mistreți și vulpi, fiind un loc excelent pentru observarea faunei sălbatice. Științele Naturii K6 – Dealuri și păduri de foioase.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Munții Cserhát fac parte din masivul muntos din nordul Ungariei.", "Pădurile de aici au fost sursa principală de lemn pentru construcția caselor tradiționale din Hollókő.", "Cel mai înalt punct al regiunii este vârful Karancs (729 m), situat la graniță.", "În pădurile Cserhát se pot găsi urmele unor vulcani antici stinși de milioane de ani.", "Traseul 'Cărarea Albastră' traversează regiunea Cserhát de la vest la est.", "Zona este renumită pentru culesul ciupercilor sălbatice în perioada de toamnă."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szandavár-hegy egy jellegzetes vulkanikus andezitkúp, amely merészen emelkedik ki a Cserhát dombjai közül. 527 méteres magasságával és a tetején trónoló középkori várrommal Nógrád vármegye egyik legvonzóbb tájképi eleme. A hegy geológiai tanösvényként is felfogható; lejtőin jól megfigyelhetők a kihűlt lávafolyások és az andezitre jellemző oszlopos elválású kőzetformációk. A csúcsra felkapaszkodva 360 fokos körpanoráma tárul elénk, amely tiszta időben a Dunakanyartól egészen a Kékesig terjed. A várrom maga a hegy stratégiai fontosságáról mesél a török időkben. Ma a Szandavár-hegy védett természeti érték, ahol a történelem, a geológia és a lenyűgöző kilátás együtt ad felejthetetlen élményt.",
      ro: "Dealul Szandavár este un vârf vulcanic proeminent din Munții Cserhát, încununat de ruinele unei cetăți medievale care oferea odinioară o vedere panoramică strategică asupra întregii regiuni. Stânca pe care se află cetatea este formată din andezit, o rocă vulcanică dură care a rezistat eroziunii mai bine decât straturile din jur. Legendele spun că cetatea a fost un punct important de apărare în timpul invaziilor tătare și otomane. Astăzi, urcușul spre Szandavár este o provocare plăcută pentru drumeți, vârful oferind o perspectivă spectaculoasă asupra Curburii Dunării și a Munților Mátra. Zona este de asemenea un sit geologic important, unde se pot observa coloane de bazalt și alte formațiuni vulcanice fascinante. Istorie K6 – Cetăți de pază și geologie vulcanică.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Dealul Szandavár are o înălțime de 527 de metri.", "Cetatea a fost construită în secolul al XIII-lea și a fost distrusă în timpul luptelor cu turcii.", "Roca de andezit a dealului este de o calitate excepțională, fiind folosită în construcții.", "Panorama de pe vârf este considerată una dintre cele mai frumoase din regiunea Cserhát.", "Situl arheologic al cetății a scos la iveală numeroase obiecte din viața de zi cu zi a soldaților.", "Vegetația de pe versanții dealului include specii de plante iubitoare de căldură."],
      en: []
    }
  },
  // HU-PE: Pest
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Visegrádi-hegység Magyarország egyik leglátványosabb és legváltozatosabb vulkanikus eredetű középhegysége, amely közvetlenül a Dunakanyar mentén fekszik. A hegységet a miocén kori vulkáni tevékenység formálta, aminek köszönhetően meredek sziklafalak, mély szurdokok (például a Rám-szakadák) és különleges kőzetalakzatok tagolják. Történelmileg elválaszthatatlan a magyar királyoktól, akiknek visegrádi rezidenciája a folyó felett magasodik. Az erdőkkel borított gerincekről, mint például a Prédikálószékről, nyílik a leghíresebb kilátás a Dunakanyar ívére. Gazdag növény- és állatvilága a Duna-Ipoly Nemzeti Park oltalma alatt áll, a mély völgyekben pedig olyan ritka fajok találnak menedéket, mint a fekete gólya és a rétisas.",
      ro: "Munții Visegrád reprezintă una dintre cele mai spectaculoase regiuni muntoase din Ungaria, fiind situați la Curbura Dunării. Originea lor este pur vulcanică, relieful fiind modelat de activitatea unui vulcan gigantic care a erupt în urmă cu aproximativ 15 milioane de ani. Pădurile dese de aici ascund chei adânci, precum Cheile Rám, cascade și formațiuni stâncoase bizare create prin eroziune. Regiunea este strâns legată de istoria regilor maghiari, Visegrád fiind odinioară sediul curții regale. Numeroasele trasee de drumeție duc spre puncte de observație faimoase, precum vârful Prédikálószék, de unde Dunărea se vede în toată splendoarea sa meandrată. Este un paradis pentru iubitorii de natură, istorie și aventură. Geografia K7 – Vulcani antici și Curbura Dunării.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A hegység geológiailag a Börzsöny folytatása, amit a Duna választott el.", "A Rám-szakadák az ország egyik legmélyebb és legizgalmasabb szurdoka.", "Legmagasabb pontja a 700 méteres Dobogókő.", "A hegységben számos római kori limes-maradvány (őrtorony) található.", "A hűvös szurdokokban jégkorszaki reliktum növények élnek.", "Területe a Duna-Ipoly Nemzeti Park szívéhez tartozik.", "A Prédikálószék sziklájáról látható a legszebb 180 fokos panoráma.", "Történelmileg királyi vadászterület és Buda stratégiai védvonala volt."],
      ro: ["Cel mai înalt vârf al masivului este Dobogókő, situat la 700 de metri altitudine.", "Munții Visegrád sunt separați de Munții Pilis printr-o vale tectonică adâncă.", "Cheile Rám (Rám-szakadék) sunt cel mai popular traseu de aventură din regiune.", "Vârful Prédikálószék oferă cea mai cunoscută vedere panoramică asupra Dunării.", "Există numeroase izvoare cu apă cristalină, cum este izvorul Kaán Károly.", "Masivul face parte din Parcul Național Dunăre-Ipoly."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Dobogókő a Visegrádi-hegység legmagasabb pontja és Magyarország egyik legnépszerűbb kirándulóhelye, amely 700 méteres magasságban fekszik Pest vármegyében. Nevét a népi etimológia szerint onnan kapta, hogy itt „dobog a Föld szíve”, ami miatt ezoterikus körökben is jelentős spirituális központnak számít. A csúcsról nyíló panoráma a Dunakanyarra és a Börzsöny hegyeire világhírű, a Rezső-kilátó pedig az egyik leglátványosabb kilátópont az országban. Itt épült fel 1898-ban Magyarország első turistaháza, ami a hazai szervezett természetjárás bölcsőjévé tette a területet. Dobogókő télen síközpontként is funkcionál, nyáron pedig sűrű bükkerdei és jól jelzett turistaútjai vonzzák a kikapcsolódni vágyókat. Földrajz K7 – hegyvidéki turizmus és geológia.",
      ro: "Dobogókő este cel mai înalt vârf al Munților Visegrád și una dintre cele mai populare destinații turistice din apropierea Budapestei. Situat la 700 de metri altitudine, locul este renumit nu doar pentru aerul său curat și peisajele montane, ci și pentru semnificația sa spirituală; conform tradițiilor ezoterice, aici s-ar afla 'chakra inimii' pământului. Panorama de pe terasa Rezső spre Curbura Dunării și Munții Börzsöny este considerată una dintre cele mai frumoase din țară. Dobogókő este de asemenea leagănul turismului maghiar, aici fiind construită prima cabană montană din Ungaria. Iarna, zona devine un centru pentru sporturile de iarnă, având una dintre cele mai vechi pârtii de schi din regiune. Științele Naturii K5 – Munți și recreere.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Legmagasabb pontja 700 méterrel emelkedik a tengerszint fölé.", "A báró Eötvös Loránd nevét viselő turistaház ma múzeumként működik.", "Dobogókő a Visegrádi-hegység és nem a Pilis része, bár gyakran összetévesztik.", "Itt halad át az Országos Kéktúra útvonala is.", "A területen található az ország egyik legrégebbi sípályája.", "A csúcsról tiszta időben a Magas-Tátra csúcsai is megpillanthatóak."],
      ro: ["Dobogókő se află la o altitudine de 700 de metri peste nivelul mării.", "Prima cabană turistică de piatră din Ungaria a fost construită aici în 1898.", "Locul este considerat de mulți un 'loc de putere' cu energii speciale.", "Dobogókő este punctul de plecare pentru numeroase trasee spre Cheile Rám.", "Stâncile Thirring din apropiere oferă un traseu de drumeție plin de misticism.", "Accesul se poate face ușor cu mașina sau cu autobuzul dinspre Pomáz."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gödöllői Arborétum, más néven a 'főhercegi erdő', jelentős dendrológiai gyűjtemény és a magyar erdészeti kutatás fontos állomása. Az 1902-ben alapított park eredeti célja az volt, hogy megvizsgálják, mely fafajok alkalmasak az Alföld homokos talajának befásítására. Ma az arborétum egy hatalmas, 190 hektáros parkként várja a látogatókat, ahol hazai és egzotikus fák lenyűgöző választéka látható. Különösen jelentős a tűlevelű gyűjteménye és a monumentális idős tölgyfák csoportja. A látogatók számára az arborétum csendes alternatívát kínál a gödöllői kastély nyüzsgéséhez; széles sétányai, rejtett ösvényei és tágas tisztásai ideális helyszínné teszik a családi kirándulásokhoz és a természetmegfigyeléshez.",
      ro: "Arboretumul din Gödöllő este o grădină botanică istorică, cunoscută și sub numele de Arbo-park, fiind unul dintre cele mai importante centre de cercetare forestieră din Ungaria. Fondat în 1902 pentru a testa adaptabilitatea diverselor specii de arbori la condițiile din câmpia maghiară, parcul găzduiește astăzi sute de specii de conifere și foioase din întreaga lume. Spre deosebire de alte grădini botanice, arboretumul din Gödöllő a fost creat cu un scop practic forestier, având porțiuni care arată ca niște păduri naturale aduse de pe alte continente. Este un loc liniștit, ideal pentru plimbări educaționale, unde vizitatorii pot învăța despre diversitatea silvică și despre importanța pădurilor în contextul schimbărilor climatice. Științele Naturii K5 – Cercetarea forestieră și biodiversitatea.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Arboretumul se întinde pe o suprafață de peste 350 de hectare.", "A fost înființat din ordinul Ministerului Agriculturii în anul 1902.", "Colecția de pini și molizi este una dintre cele mai bogate din Europa Centrală.", "În interiorul parcului se află o cale ferată forestieră demonstrativă.", "Arboretumul este gestionat de Institutul de Cercetări Forestiere (ERTI).", "Este o destinație populară pentru școlile care organizează ore de biologie în natură."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Garancsi-tó egy kicsiny, idilli természeti ékszerdoboz a Zsámbéki-medencében, Piliscsaba közelében. A tó egy lankás dombok közé ékelődő völgyben fekszik, nádassal és kisebb erdőfoltokkal övezve. Országos ismertségét nem utolsósorban a magyar filmgyártásnak köszönheti; itt forgatták az 'Üvegtigris' című kultuszfilmet, aminek hatására a helyszín valóságos zarándokhellyé vált. A filmes háttér mellett azonban a Garancsi-tó értékes vizes élőhely és államilag védett természetvédelmi terület, amely számos kétéltűnek és vízi madárnak nyújt biztonságos menedéket. A tó körüli nyugodt légkör, a nádas susogása és a festői naplementék a Budai-hegyek peremének egyik legkedveltebb pihenőhelyévé teszik a tavat.",
      ro: "Lacul Garancsi este o bijuterie ascunsă situată în apropierea localității Tinnye, fiind renumit în cultura populară maghiară ca locul unde s-a filmat celebra comedie 'Üvegtigris' (Tigrul de sticlă). Dincolo de faima cinematografică, lacul este o rezervație naturală protejată, fiind un habitat valoros pentru amfibieni, reptile și păsări de apă. Lacul s-a format într-o depresiune naturală și este alimentat în principal de precipitații, având un nivel al apei variabil. Malurile sale sunt amenajate pentru drumeții, oferind un peisaj pitoresc de dealuri și stufăriș. Este un loc ideal pentru o ieșire scurtă din Budapesta, combinând amuzamentul legat de locația filmului cu frumusețea liniștită a naturii transdanubiene. Științele Naturii K5 – Lacuri și habitate de amfibieni.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Lacul este declarat arie protejată din anul 1978 datorită biodiversității sale.", "În zonă trăiesc specii rare de triton și broască țestoasă de baltă.", "Numele lacului provine de la dealul Garancs situat în imediata apropiere.", "Rulota originală folosită în filmul 'Üvegtigris' este încă prezentă ca atracție turistică.", "Lacul are dimensiuni modeste, putând fi ocolit pe jos în aproximativ 30 de minute.", "Zona este un loc popular pentru picnicuri și recreere în familie."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Naszály a Dunakanyar kapujában, Vác városa felett magasodó mészkőtömb, a Cserhát hegység legnyugatibb és egyben legmagasabb tagja. 652 méteres magasságával messziről felismerhető sziluettet ad a tájnak, különösen a déli oldalán található hatalmas mészkőbánya sebhelye miatt. A hegy geológiai szempontból rendkívül változatos; felszínén számos karsztjelenség, barlang és víznyelő figyelhető meg. A Naszály északi lejtőit sűrű bükkösök és gyertyános-tölgyesek borítják, míg a déli sziklás peremeken ritka, melegkedvelő növényfajok találnak menedéket. A csúcsról és a látványos Látó-hegyi sziklaperemről lenyűgöző kilátás nyílik a Dunakanyarra, a Szentendrei-szigetre és tiszta időben a Budai-hegyek vonulataira is. Földrajz K8 – karsztjelenségek és bányászat.",
      ro: "Naszály este cel mai înalt vârf al regiunii Dunakanyar (Curbura Dunării) pe malul stâng, fiind un masiv calcaros izolat care domină peisajul orașului Vác. Cu o altitudine de 652 de metri, muntele este faimos pentru geologia sa variată și pentru peșterile sale adânci, precum peștera Násznép. Versanții săi găzduiesc o floră rară, specifică zonelor calcaroase, incluzând specii de orhidee și plante de stepă. Din punct de vedere industrial, muntele a fost exploatat pentru calcarul necesar marii fabrici de ciment din Vác, lăsând în urmă o carieră spectaculoasă care acum este parțial redată naturii. Traseele de drumeție spre vârf oferă panorame uluitoare asupra Dunării și a Munților Börzsöny. Geografia K7 – Relief calcaros și peisaje fluviale.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Magassága 652 méter, amivel a Cserhát legmagasabb pontja.", "A hegyen található a Násznép-barlang, amelyhez számos helyi legenda kötődik.", "A Naszály déli oldalán üzemel az ország egyik legnagyobb cementgyárának kőbányája.", "A területen több mint 450 barlangot regisztráltak a kutatók.", "A hegy lábánál található a Gyadai-tanösvény, az ország egyik leglátványosabb erdei útvonala.", "Növényvilágának ritkasága a pannon gyík és a lónyelvű csodabogyó."],
      ro: ["Muntele Naszály are o înălțime de 652 de metri.", "Turnul de observație de pe vârf oferă o vedere clară spre Budapesta și Munții Tatra.", "Cea mai adâncă peșteră a masivului, Peștera Násznép, are legende legate de nunți ascunse.", "Muntele este format din calcar de vârstă triasică, foarte bogat în fosile.", "Poteca educațională 'Gyadai' de la baza muntelui este una dintre cele mai moderne din țară.", "Pe versantul sudic se află o uriașă carieră de calcar activă."],
      en: []
    }
  },
  // HU-SO: Somogy
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kapos a Dél-Dunántúl legfontosabb folyója és a Somogyi-dombság vízhálózatának központi eleme. A Mecsek lábánál ered és északkeleti irányban folyik keresztül a vármegyén, érintve a róla elnevezett Kaposvár városát is. A folyó völgye évezredek óta fontos megtelepedési helyszín, tágas ártéri rétjei és termékeny területei határozták meg a környék gazdasági életét. A 19. és 20. századi szabályozások előtt a Kapos egy kanyargós, mocsaras vidék volt, mára azonban medrét gátak szegélyezik, biztosítva az árvízvédelmet. A folyó mentén kialakult galériaerdők és vizes élőhelyek fontos ökológiai folyosót alkotnak, összekötve a somogyi dombokat a Sió-csatornával és a Dunával.",
      ro: "Râul Kapos este principalul curs de apă al județului Somogy, traversând orașul Kaposvár și vărsându-se în râul Sió. Valea Kaposului a fost întotdeauna o arteră vitală pentru sudul Transdanubiei, favorizând așezările umane și dezvoltarea agriculturii pe solurile sale fertile. Râul are un curs sinuos, fiind însoțit pe mare parte din lungimea sa de zone umede și lunci inundabile care adăpostesc o faună diversă, de la vidre la stârci cenușii. De-a lungul istoriei, Kaposul a fost regularizat pentru a preveni inundațiile, dar s-au păstrat secțiuni care păstrează caracterul natural al râului. Astăzi, malurile sale sunt amenajate în orașe pentru recreere, oferind spații verzi pentru plimbări și relaxare. Geografia K7 – Rețeaua hidrografică a Transdanubiei.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Kapos teljes hossza megközelítőleg 113 kilométer.", "A folyó Pincehely közelében torkollik a Sió-csatornába.", "Kaposvár városa a folyó egyik stratégiai átkelőhelyénél alakult ki.", "Part menti sávjában ritka kétéltűfajok, például dunai gőte él.", "Kaposvárnál a folyó mentén parkosított pihenőövezet épült ki.", "Halfajai között megtalálható a domolykó, a márna és a csuka.", "Történelmileg számos vízimalmot hajtott a folyó vize a régióban.", "A Kapos-völgy fontos madárvonulási útvonal a Dráva és a Balaton között."],
      ro: ["Râul Kapos are o lungime totală de 113 km.", "Bazinul hidrografic al râului acoperă o suprafață de peste 3000 km².", "Kaposvár, reședința județului Somogy, s-a dezvoltat pe ambele maluri ale râului.", "Râul colectează apele din dealurile Zselic și Outer Somogy.", "În trecut, râul era mult mai bogat în apă, fiind navigabil pentru bărci mici.", "Valea Kapos este o rută importantă pentru transportul feroviar spre Budapesta."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Deseda-tó Magyarország leghosszabb mesterséges tava, a vízügyi tervezés és a természetvédelem kiváló összhangjának példája. Az 1970-es években jött létre a Deseda-patak felduzzasztásával Kaposvártól északra. A több mint 8 kilométer hosszú tó szinte folyószerűen kanyarog a somogyi dombok között, 245 hektárnyi vízfelületet alkotva. A terület mára komplex rekreációs övezetté vált, ahol a déli rész a strandolóké és a vízisportoké, míg az északi, mocsarasabb vidék érintetlen természetvédelmi terület. A tó félszigetén található arborétum és a modern látogatóközpont interaktív módon mutatja be a tó élővilágát. A Deseda nemcsak a horgászok paradicsoma, hanem a kerékpárosok és a természetjárók kedvelt úti célja is.",
      ro: "Lacul Deseda, situat la marginea orașului Kaposvár, este cel mai lung lac artificial din Ungaria, având o lungime de peste 8 kilometri. Creat în anii 1970 prin bararea pârâului Deseda pentru protecția împotriva inundațiilor, lacul a devenit rapid una dintre cele mai populare zone de agrement din sud-vestul țării. Malurile sale sunt înconjurate de păduri și grădini, oferind condiții ideale pentru pescuit, canotaj, ciclism și drumeții. Un punct de atracție major este Centrul de Vizitare Deseda, o clădire modernă în formă de barcă ce găzduiește expoziții despre ecosistemul lacului. Pista de biciclete care înconjoară complet lacul și podul pietonal spectaculos spre peninsulă fac din Deseda o destinație de top pentru turiștii activi. Științele Naturii K5 – Lacuri artificiale și recreere.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Lacul Deseda are o lungime de 8,2 km și o suprafață de 245 de hectare.", "Pista de biciclete care înconjoară lacul are o lungime totală de circa 17 km.", "Arboretumul de pe peninsula lacului adăpostește specii rare de arbori și o grădină de joacă.", "Lacul este renumit printre pescari pentru exemplarele mari de crap și somn.", "Centrul de vizitare a fost premiat pentru arhitectura sa sustenabilă.", "Există un turn de observație din lemn care oferă o vedere panoramică asupra întregului lac."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Boronka-melléki Tájvédelmi Körzet Belső-Somogy egyik legvadregényesebb és legérintetlenebb erdős-vizes élőhelye. Ez a hatalmas terület egy mozaikos táj, ahol sűrű égerláperdők, ősi tölgyesek és számtalan kicsi, rejtett tó és mocsár váltja egymást. Egyfajta reliktum terület ez, amely megmutatja, hogyan nézett ki a Dunántúl nagy része a folyószabályozások és lecsapolások előtt. Az erdő igazi paradicsom az élővilág számára: itt él Magyarország egyik legsűrűbb rétisas-populációja, és fészkel a ritka fekete gólya is. Az elszigeteltség és a mocsaras területek nehéz megközelíthetősége segített megőrizni olyan fajokat, amelyek máshonnan már régen eltűntek.",
      ro: "Rezervația Naturală Boronka-melléki este o vastă zonă de păduri umede, mlaștini și lacuri situate în județul Somogy, fiind una dintre cele mai sălbatice regiuni din Transdanubia. Peisajul este un labirint de cursuri de apă și zone forestiere de stejar și anin, care au rămas în mare parte nealterate de intervenția umană masivă. Această 'Amazonie maghiară' este un refugiu vital pentru vidre, vulturi codalbi și barza neagră. Rețeaua complexă de peste 20 de lacuri piscicole din interiorul rezervației atrage mii de păsări migratoare în fiecare sezon. Pentru vizitatori, zona oferă trasee de drumeție liniștite și posibilitatea de a călători cu o cale ferată forestieră cu ecartament îngust, care străbate inima pădurii. Științele Naturii K6 – Zone umede și conservarea faunei.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Rezervația Boronka-melléki se întinde pe o suprafață de peste 8000 de hectare.", "Este parte integrantă a Parcului Național Dunăre-Drava din anul 1996.", "Calea ferată forestieră de la Mesztegnyő este cea mai bună modalitate de a explora zona.", "Aici trăiește una dintre cele mai dense populații de vidre din Europa.", "Rezervația adăpostește rarisima ferigă de mlaștină și numeroase specii de orhidee.", "Satele din jur păstrează tradiții vechi legate de pescuitul în ape dulci și olărit."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Koppány egy festői kis folyó, amely Somogy és Tolna vármegye határvidékén kanyarog, meghatározva a vidék nyugodt és természetközeli arculatát. A Somogyi-dombságban ered és kelet felé haladva egy tágas, zöld völgyet vájt a dombok közé. A folyó híres tiszta vizéről és a partjait kísérő buja növényzetről, amely fontos ökológiai folyosót alkot az erdők és rétek között. A völgyben számos apró település sorakozik, ahol a hagyományos gazdálkodás és a természet nyugalma még ma is érezhető. A horgászok számára a Koppány igazi titkos tipp, hiszen sauberebb vizeiben számos őshonos halfaj (például domolykó és paduc) megtalálható. A völgy kiváló lehetőséget nyújt a gyalogos és kerékpáros túrázásra is.",
      ro: "Râul Koppány este un afluent important al râului Kapos, străbătând peisajele deluroase ale județului Tolna și Somogy. Numele său evocă figura istorică a lui Koppány, liderul rebel care s-a opus regelui Sfântul Ștefan, regiunea fiind centrul puterii sale în secolul al X-lea. Astăzi, valea râului este o zonă agricolă liniștită, dar cu o mare valoare ecologică, având lunci inundabile care servesc drept coridoare verzi pentru fauna locală. Râul alimentează mai multe lacuri de acumulare utilizate pentru pescuit și irigații, cum ar fi lacul de la Tamási. Cursul său este liniștit, fiind ideal pentru plimbări în natură și pentru cei interesați de istoria timpurie a Ungariei. Geografia K7 – Râuri și istorie regională.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Râul Koppány are o lungime de aproximativ 79 km.", "Valea sa este considerată o micro-regiune ecologică protejată.", "Râul izvorăște din dealurile Somogy și se varsă în Kapos lângă localitatea Regöly.", "În apropierea râului s-au descoperit numeroase artefacte din epoca bronzului și a fierului.", "Debitul râului este constant, fiind alimentat de numeroase izvoare mici de deal.", "Traseele de ciclism regional traversează de mai multe ori cursul râului Koppány."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Balatonszentgyörgyi-mocsár egy rendkívül értékes vizes élőhely a Balaton legnyugatibb csücskében, a Kis-Balaton és a nagy tó találkozásánál. Ez a terület természetes szűrőként funkcionál a tóba érkező vizek számára, és kulcsfontosságú eleme a Balaton ökológiai védelmi rendszerének. A tájat végtelen nádasok, nyílt víztükrök és nedves rétek alkotják, amelyek hihetetlen változatosságú vízi madárvilágot vonzanak. Itt a természet az úr, a közeli strandok nyüzsgése után a látogatót mélységes csend és a nádas susogása fogadja. A mocsárvilág rejtelmeibe madármegfigyelő tornyokból nyerhetünk betekintést, ahol zavartalanul tanulmányozható a kócsagok, gémek és a ritka rétisasok élete.",
      ro: "Zona lacustră de lângă Balatonszentgyörgy reprezintă 'poarta de vest' a lacului Balaton, fiind un punct de întâlnire între apele lacului și mlaștinile Kis-Balaton. Acest peisaj este dominat de stufărișuri vaste și canale navigabile care joacă un rol crucial în filtrarea naturală a apei care intră în Balaton. Localitatea este faimoasă pentru 'Cetatea de Stele' (Csillagvár), o fortificație unică în formă de stea, dar și pentru Rezervația de Bivoli din apropiere. Zona oferă un habitat spectaculos pentru păsările de baltă, fiind un loc ideal pentru turismul de observare a naturii. Este un loc unde istoria defensivă a regiunii se îmbină armonios cu un ecosistem acvatic vital. Științele Naturii K7 – Zone de luncă și filtrarea apei.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Balatonszentgyörgy este nodul feroviar principal pentru accesul spre malul sudic al Balatonului.", "Rezervația de bivoli de la Kápolnapuszta se află la câțiva kilometri de localitate.", "Canalul Zala, care alimentează Balatonul, trece prin această zonă.", "Csillagvár a fost construită în secolul al XIX-lea ca un pavilion de vânătoare, nu ca cetate militară.", "Zona este renumită pentru tradiția împletitului din papură și stuf.", "Podul de lemn de peste Kis-Balaton este un punct fotografic celebru în apropiere."],
      en: []
    }
  },
  // HU-SZ: Szabolcs-Szatmár-Bereg
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szamos Északkelet-Magyarország egyik leghatalmasabb és legkarakteresebb folyója, amely az erdélyi Kárpátokból érkezve Csenger közelében lépi át a határt. A folyó híres dinamikus sodrásáról és kanyargós medréről, amely tágas homokpadokat és mély gödröket alkot a Szatmári-síkságon. Partjait sűrű galériaerdők szegélyezik, amelyek szinte őserdő jellegűek, gazdag növény- és állatvilágnak adva otthont. Történelmileg a Szamos fontos szállítási útvonal volt a só- és fafuvarozásban. Ma elsősorban a horgászok körében örvend nagy népszerűségnek, hiszen vizeiben kapitális harcsák és süllők élnek. A Szamos vadregényes tája a természetbarátok számára az érintetlen, zabolátlan folyami természet élményét nyújtja.",
      ro: "Râul Someș (Szamos) intră în Ungaria dinspre România în județul Szabolcs-Szatmár-Bereg, fiind unul dintre cei mai importanți afluenți ai Tisei. În această secțiune maghiară, râul are un curs extrem de sinuos, cu meandre naturale și maluri abrupte, oferind peisaje fluviale de o frumusețe sălbatică. Pădurile inundabile care însoțesc râul sunt bogate în biodiversitate, fiind locuite de numeroase specii de păsări și vidre. Someșul este renumit pentru apele sale bogate în pește, fiind o destinație de top pentru pescuit. Un fenomen spectaculos este unirea Someșului cu Tisa la Vásárosnamény, unde se pot observa clar diferențele de culoare și temperatură ale celor două cursuri de apă. Geografia K7 – Râuri internaționale și confluențe.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Szamos teljes hossza 418 kilométer, amiből 52 km a magyar szakasz.", "Olcsvaapáti közelében torkollik a Tisza folyóba.", "A folyó a Kárpátokból szállított hordalék miatt gyakran opálos színű.", "Partjain találhatók az ország legszebb fehérfűz-ligeterdői.", "A Szamos a magyarországi harcsahorgászat egyik fellegvára.", "A Szatmári-síkságon a folyó számos festői holtágat alkotott.", "Árvizei korábban rettegettek voltak, ezért magas gátrendszer védi a vidéket.", "Csengernél modern híd köti össze a folyó két partját, különleges építészeti megoldással."],
      ro: ["Someșul se varsă în Tisa după un parcurs de aproximativ 52 km pe teritoriul Ungariei.", "Confluența Someșului cu Tisa are loc la Vásárosnamény-Gergelyiugornya.", "Râul aduce cantități mari de aluviuni, care au format plaje de nisip naturale pe malurile sale.", "În trecut, Someșul a fost o cale importantă pentru transportul sării din Transilvania.", "Zona luncii Someșului este protejată sub egida Parcului Național Szatmár-Bereg.", "Podul de la Olcsvaapáti oferă o perspectivă spectaculoasă asupra meandrelor râului."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Túr talán Magyarország legromantikusabb és legjátékosabb folyója a távoli északkeleten. Különlegességét az adja, hogy medre rendkívül kanyargós, szinte 'táncol' a tájban, innen ered a 'táncoló folyó' elnevezés is. Kiemelkedő látványossága a sonkádi bukógát, ahol a folyó vize egy mesterséges gáton zúdul le, létrehozva a 'Túr-vízesést'. A Túr menti természet szinte érintetlen; a fák mélyen a víz fölé hajolnak, helyenként zöld alagutat képezve. Mivel vize tiszta és sekély, a folyó a kezdő vízitúrázók és a családok egyik legkedveltebb célpontja. A távol eső vidék csendje és a folyó menti idill az Alföld egyik legszebb, háborítatlan szegletévé teszi a Túr-vidéket.",
      ro: "Râul Tur (Túr) este unul dintre cele mai pitorești și 'originale' râuri din estul Ungariei, renumit pentru faptul că a păstrat numeroase brațe moarte și meandre sălbatice. Secțiunea cea mai faimoasă este 'Túr-ul vechi', unde râul curge printre păduri de foioase, oferind un traseu de canotaj de neuitat prin tunele de vegetație. Râul este strâns legat de literatura maghiară, poetul Petőfi Sándor descriind aici locul unde 'Túr-ul se varsă în Tisa'. Astăzi, zona este o rezervație naturală protejată, fiind un habitat esențial pentru specii rare de plante acvatice și păsări. Turul este un simbol al naturii neîmblânzite, oferind o liniște absolută și un contact direct cu ecosistemul autentic de luncă. Științele Naturii K6 – Ecosisteme fluviale și brațe moarte.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Râul Tur se varsă în Tisa printr-un canal artificial construit pentru a preveni inundațiile.", "Lungimea cursului maghiar al Turului este de aproximativ 65 km.", "Zona 'Túr-bucó' este un baraj spectaculos unde râul se varsă în Tisa printr-o cădere de apă.", "Este considerat unul dintre cele mai bune râuri din Ungaria pentru canotajul de aventură.", "Flora râului include nufărul alb și diverse specii rare de ferigi de apă.", "În apropiere se află celebrul sat Sonkád, renumit pentru biserica sa medievală."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kraszna a Tisza egyik csendes mellékfolyója, amely Szabolcs-Szatmár-Bereg vármegye keleti részén halad át. Erdélyből érkezik és méltóságteljesen kanyarog a termékeny síkságon. A folyót rendkívül alacsony sodrási sebesség jellemzi, ami miatt helyenként szinte állóvíznek tűnik. Ez az adottság tette lehetővé a sűrű nádasok és a gazdag vízi növényzet kialakulását a medrében. A Kraszna fontos szerepet játszik a környék mezőgazdasági vízellátásában, különösen a híres szatmári almaültetvények öntözésében. Bár a múltban jelentősen szabályozták, sok helyen megmaradtak a természetközeli partok, amelyek fontos menedéket nyújtanak a vízi madaraknak és a horgászok számára is kedvelt, nyugodt terepet biztosítanak.",
      ro: "Râul Crasna (Kraszna) traversează regiunea Szatmár din nord-estul Ungariei, având un curs paralel cu Someșul până la vărsarea sa în Tisa. Râul a fost supus unor lucrări masive de regularizare în secolul al XIX-lea, cursul său fiind canalizat pe porțiuni lungi pentru a proteja terenurile agricole de inundațiile frecvente. Cu toate acestea, valea Crasnei păstrează zone de o mare frumusețe naturală, cu pajiști umede și resturi de păduri de luncă. Râul este o sursă importantă de apă pentru agricultura locală și oferă oportunități pentru pescuitul liniștit. Istoric, regiunea Crasnei a fost un teritoriu de frontieră, urmele fortificațiilor vechi fiind încă vizibile în unele localități de pe malurile sale. Geografia K7 – Râuri canalizate și agricultură.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Râul Crasna izvorăște din Munții Apuseni (România) și are o lungime totală de 193 km.", "Pe teritoriul Ungariei, râul parcurge aproximativ 46 km înainte de confluența cu Tisa.", "Vărsarea Crasnei în Tisa se află în apropierea localității Vásárosnamény.", "Canalizarea râului a fost unul dintre cele mai mari proiecte de hidroameliorație din secolul XIX.", "Valea Crasnei este renumită pentru solurile sale argiloase potrivite pentru olăritul tradițional.", "Râul traversează orașul Mátészalka, un centru regional important."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Baktalórántházi-erdő a Nyírség homokvidékének egyik legértékesebb maradványerdeje. Ez az erdőtömb főként évszázados kocsányos tölgyekből és gyertyánosokból áll, amelyek a környék homokbuckáin fejlődtek hatalmas méretűvé. Jelentős természetvédelmi terület, hiszen bemutatja, hogyan festett a régió a nagy mezőgazdasági művelésbe vonás és az akácosítás előtt. Az erdő rendkívül gazdag rovarvilágnak ad otthont, köztük olyan ritka fajoknak, mint a nagy szarvasbogár. A látogatók számára jól kiépített tanösvény segít feltárni az erdei ökoszisztéma titkait. Az öreg tölgyóriások alatti mélységes csend és a lombok között átszűrődő fény a Nyírség egyik legmeghittebb és legszebb természeti helyszínévé teszi a baktalórántházi erdőt.",
      ro: "Pădurea de la Baktalórántháza este una dintre ultimele rămășițe ale marilor păduri de câmpie care acopereau odinioară regiunea Nyírség. Această pădure de stejari și carpeni este o rezervație naturală de o importanță deosebită, adăpostind arbori seculari și o floră specifică solurilor nisipoase. Zona este renumită pentru climatul său special și pentru bogăția de ciuperci și fructe de pădure, fiind un loc preferat pentru drumeții locale și educație în natură. Pădurea înconjoară castelul Dégenfeld, creând un ansamblu peisagistic și istoric deosebit. Este un refugiu vital pentru fauna locală, inclusiv căprioare și numeroase specii de păsări de pădure, reprezentând o insulă de biodiversitate în mijlocul terenurilor agricole. Științele Naturii K6 – Păduri de câmpie și biodiversitate.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Pădurea se întinde pe o suprafață de aproximativ 1300 de hectare.", "Este declarată rezervație naturală încă din anul 1953.", "Aici pot fi găsite specimene de stejar pedunculat cu vârste de peste 200 de ani.", "Flora include specii rare precum degetăruțul și diversas specii de orhidee de pădure.", "Pădurea este un sit Natura 2000 pentru protejarea habitatelor forestiere prioritare.", "Traseele de drumeție sunt ușoare, fiind potrivite pentru excursii cu copiii."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Vajai-tó a Nyírség egyik egyedülálló természeti jelensége, amely már az 1970-es évek óta természetvédelmi oltalom alatt áll. Legnagyobb különlegessége a 'lebegő szigetek' jelenléte, amelyek sűrű növényi összefonódásokból és tőzegből állnak, és a szél hatására képesek elmozdulni a vízfelületen. Ez a folyamat a régió egykori mocsárvilágának elöregedési fázisát mutatja be. A tavat nádasok és ritka mocsári tölgyerdők övezik, amelyek számos veszélyeztetett fajnak nyújtanak életteret, köztük húsevő növényeknek és ritka vízi madaraknak. A természetbarátok számára a Vajai-tó lenyűgöző példája a vizes élőhelyek dinamikájának; a tóparti kilátóból zavartalanul figyelhető meg a szigetek mozgása és a madarak élete.",
      ro: "Lacul de la Vaja este o rezervație naturală fascinantă situată în județul Szabolcs-Szatmár-Bereg, fiind renumit pentru insulele sale plutitoare de turbă. Acest fenomen rar, unde vegetația crește pe un strat de turbă care plutește la suprafața apei, oferă un habitat pentru numeroase specii de plante și animale rare. Lacul este înconjurat de o centură densă de stuf și trestie, fiind un paradis pentru pescari și pentru cei care studiază viața acvatică. Importanța sa ecologică este dublată de valoarea peisagistică, lacul fiind situat lângă castelul Vay, un monument istoric de seamă. Este un loc unde natura 'vie' poate fi observată în forme neobișnuite, oferind lecții directe despre formarea mlaștinilor. Științele Naturii K6 – Insule plutitoare și ecosisteme lacustre.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Lacul Vaja este declarat arie protejată din anul 1971.", "Insulele plutitoare se deplasează pe suprafața lacului în funcție de direcția vântului.", "Pe insule cresc specii rarisime precum rarița și diverse tipuri de mușchi de turbă.", "Adâncimea medie a lacului este de aproximativ 1-1,5 metri.", "Este un loc de popas crucial pentru păsările migratoare în drumul lor spre est.", "Accesul pe insulele plutitoare este strict interzis pentru a proteja ecosistemul fragil."],
      en: []
    }
  },
  // HU-TO: Tolna
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szekszárdi-dombság a Dunántúli-dombság délkeleti része, amely Tolna vármegyében, Szekszárd városa felett terül el. A terület alapvetően löszös alapkőzetű, ami kiválóan alkalmas a szőlőtermesztésre, így nem véletlen, hogy itt található Magyarország egyik legnevesebb vörösbortermő vidéke, a Szekszárdi borvidék. A dombság mély völgyekkel, úgynevezett szurdikokkal tagolt, amelyek hűvös mikroklímája és különleges növényvilága vonzza a természetjárókat. A legmagasabb pontja az Óriás-hegy, ahonnan tiszta időben az Alföld rónái és a Mecsek vonulatai is jól láthatóak. A táj karakterét a rendezett szőlősorok, a présházak és a löszfalakba vájt borospincék határozzák meg, amelyek a helyi kultúra és gazdaság alapkövei. Földrajz K8 – mezőgazdasági tájak és borászat.",
      ro: "Dealurile Szekszárd (Szekszárdi-dombság) reprezintă o regiune viticolă de renume mondial din sudul Transdanubiei, fiind faimoase pentru solul lor de loess și climatul cald, ideal pentru vinurile roșii corpolente. Peisajul este un mozaic de coline terasate, văi adânci și păduri de foioase, oferind panorame superbe asupra văii Dunării. Regiunea este renumită pentru soiul 'Kadarka' și pentru 'Szekszárdi Bikavér' (Sânge de Taur), fiind una dintre cele mai vechi zone de cultură a viței-de-vie din Ungaria, cu rădăcini care coboară până în perioada romană. Traseele de drumeție prin podgorii și micile crame tradiționale (tanyas) oferă o experiență culturală și gastronomică autentică, unde ospitalitatea locală este la ea acasă. Geografia K8 – Regiuni viticole și pedologie.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A dombság területe mintegy 300 négyzetkilométer.", "Legmagasabb pontja az Óriás-hegy, 285 méterrel a tengerszint felett.", "A területen található szurdikok (pl. Szurdik-völgy) mélysége elérheti a 15-20 métert.", "A löszfalakban számos gyurgyalag-fészkelőhely található.", "Itt készül a híres Szekszárdi Bikavér, az ország egyik legfontosabb házasított vörösbora.", "A dombság keleti lábánál fekszik Szekszárd, Tolna vármegye székhelye."],
      ro: ["Regiunea beneficiază de peste 2000 de ore de soare pe an.", "Solul de loess atinge aici grosimi record de până la 30-50 de metri.", "Szekszárd este una dintre cele două regiuni oficiale care pot produce vinul 'Bikavér'.", "Traseul drumeției 'Rockenbauer Pál' traversează cele mai frumoase puncte ale dealurilor.", "Aici se organizează anual unul dintre cele mai mari festivaluri de vin din Ungaria.", "Flora locală include specii rare de plante de stepă pe versanții sudici."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Pacsmagi-tavak Tolna vármegye egyik legjelentősebb természetvédelmi területe, amely Tamási és Regöly közelében található. Ez a vizes élőhely-rendszer mesterséges halastavakból, nádasokból és mocsárrétekből áll, amelyeket a Koppány-patak vize táplál. A terület kiemelkedő jelentőségét a gazdag madárvilág adja: a tavak fontos pihenőhelyei a vonuló vízimadaraknak, és számos ritka faj, mint a cigányréce vagy a rétisas fészkelőhelyeként is szolgálnak. A Pacsmagi-tavak szerepelnek a Ramsari-listán is, ami nemzetközi elismertséget jelent a vizes élőhelyek védelmében. A látogatókat madármegfigyelő tornyok és tanösvények várják, ahol szakvezetéssel ismerkedhetnek meg a táj és a vadvilág különleges szimbiózisával. Természetismeret K5 – vizes élőhelyek védelme és ornitológia.",
      ro: "Lacurile de la Pacsmag reprezintă un sistem complex de bazine piscicole și zone umede naturale situate în județul Tolna, fiind o rezervație de importanță internațională (sit Ramsar). Aceste lacuri oferă condiții ideale de cuibărit și hrană pentru mii de păsări, fiind unul dintre cele mai importante puncte de observație ornitologică din regiune. Stufărișurile dense și zonele de apă deschisă adăpostesc specii rare precum lopătarul, egreta mare și diverse specii de rațe sălbatice. Rezervația este gestionată pentru a păstra echilibrul între piscicultură și conservarea naturii, oferind un refugiu liniștit pentru biodiversitate. Vizitatorii pot explora zona prin puncte de observație amenajate, admirând dinamica spectaculoasă a vieții aviare în funcție de anotimp. Științele Naturii K7 – Conservarea zonelor umede.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A természetvédelmi terület nagysága 485 hektár.", "A terület 1990 óta szerepel a nemzetközi jelentőségű vizes élőhelyek listáján.", "Eddig több mint 200 madárfaj jelenlétét mutatták ki a tavak környékén.", "A Koppány-patak völgyében kialakított tórendszer 7 nagyobb tóból áll.", "Gyakori látvány a tavakon a nagy kócsag és a szürke gém.", "A terület a Duna-Dráva Nemzeti Park Igazgatósága alá tartozik."],
      ro: ["Sistemul cuprinde 11 bazine piscicole cu suprafețe variate.", "Aria protejată se întinde pe o suprafață de peste 400 de hectare.", "Peste 200 de specii de păsări au fost identificate în rezervație.", "Zona este un loc de popas crucial pentru gâștele sălbatice în timpul migrației de toamnă.", "Rezervația găzduiește cea mai mare colonie de stârci roșii din regiunea Tolna.", "Accesul este reglementat pentru a nu deranja păsările în perioada de cuibărit."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gemenci-erdő Európa legnagyobb összefüggő ártéri erdeje, amely a Duna mentén, Tolna és Bács-Kiskun vármegye határán terül el. Ez a terület a Duna-Dráva Nemzeti Park része, és egyedülálló ökoszisztémát alkot, ahol a folyó vízjárása folyamatosan formálja a tájat. A Gemenci-erdő világhírű a gímszarvas-állományáról, a szarvasbőgés idején a vidék a vadászok és természetfotósok paradicsomává válik. Az erdő sűrűjében fészkelnek a fokozottan védett fekete gólyák, és itt található Magyarország egyik legfontosabb rétisas-populációja is. A területet a Gemenci Állami Erdei Vasúttal is felfedezhetjük, amely a holtágak és az ártéri erdők között kanyarogva mutatja be ezt a vadregényes, vízi világot. Földrajz K7 – ártéri erdők és vadgazdálkodás.",
      ro: "Pădurea Gemenc este cea mai mare pădure inundabilă din Europa Centrală, situată în lunca Dunării, la granița județelor Tolna și Bács-Kiskun. Acest labirint de brațe moarte, insule și păduri dese de salcie și plop este un ecosistem unic, unde nivelul apei este dictat de ritmul Dunării. Gemenc este faimos la nivel mondial pentru populația sa de cerbi carpatini de o calitate excepțională, dar și pentru coloniile de barză neagră și vulturi codalbi. Calea ferată forestieră cu ecartament îngust este modalitatea preferată a turiștilor de a explora inima acestei sălbăticii, oferind acces în zone greu accesibile pe jos. Este un monument al naturii unde forța fluviului modelează constant peisajul. Științele Naturii K6 – Ecosisteme inundabile și fauna de luncă.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Az erdő területe mintegy 20 000 hektár, hossza 30 km a Duna mentén.", "Itt él az ország legértékesebb és legnagyobb gímszarvas-populációja.", "A Gemenci Erdei Vasút vonala 30 kilométer hosszan szeli át az ártéri vidéket.", "Az erdőben fészkelő fekete gólyák száma elérheti a 40 párt évente.", "A terület nagy része csak vízi úton vagy kisvasúttal közelíthető meg.", "Gyakoriak a hatalmas fekete nyárfák, amelyek kora meghaladhatja a 100 évet."],
      ro: ["Pădurea Gemenc se întinde pe o lungime de 30 km și o lățime de 7 km.", "Face parte din Parcul Național Dunăre-Drava din anul 1996.", "Calea ferată forestieră de la Gemenc are o lungime de 32 km.", "Aici trăiește cea mai mare densitate de barză neagră din lume.", "Cerbii de la Gemenc dețin numeroase recorduri mondiale pentru mărimea coarnelor.", "Zona este inundată periodic, uneori complet, în funcție de debitele Dunării."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kapos folyó Somogy és Tolna vármegye egyik legfontosabb vízfolyása, amely Tolnanémedi közelében torkollik a Sió-csatornába. A folyó közel 112 kilométeres útja során átszeli a Dunántúli-dombságot, érintve Kaposvár városát is. A torkolatvidék környéke geomorfológiailag érdekes, hiszen itt találkozik a dombvidéki jellegű folyó az Alföld peremével és a szabályozott Sió-csatornával. A Kapos völgye történelmileg is fontos volt, hiszen mentén alakultak ki a térség jelentős települései és kereskedelmi útvonalai. Napjainkban a torkolat környezete fontos ökológiai terület, ahol a vízi és az ártéri növényzet gazdag élőhelyet biztosít a helyi faunának, különösen a kétéltűeknek és a madaraknak. Földrajz K6 – folyóhálózat és vízszabályozás.",
      ro: "Gura de vărsare a râului Kapos în râul Sió reprezintă un punct hidrografic strategic în sudul Transdanubiei, unde apele colectate din dealurile Somogy se unesc cu principalul canal de evacuare al lacului Balaton. Această zonă de confluență este caracterizată printr-un relief plat de luncă, unde albiile râurilor au fost regularizate pentru a permite navigația și controlul viiturilor. Peisajul este unul tipic de câmpie inundabilă, cu pajiști umede și canale secundare care oferă habitate pentru pești și păsări de apă. Din punct de vedere istoric, controlul acestor ape a fost esențial pentru drenarea mlaștinilor din Tolna și transformarea lor în terenuri agricole productive. Este un loc ce ilustrează puterea ingineriei hidrotehnice maghiare din secolele XIX-XX. Geografia K7 – Managementul bazinelor hidrografice.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Kapos folyó hossza 112,7 kilométer, forrása a Zselicben található.", "A folyó torkolata a Sió-csatornába Tolnanémedi és Pincehely között van.", "Vízgyűjtő területe 3170 négyzetkilométert tesz ki.", "A 19. századi szabályozások előtt a folyó völgye hatalmas mocsárvilág volt.", "A Kapos vize jelentős szerepet játszott a korai iparosodásban Kaposváron.", "A torkolat közelében található a Sió-zsilip, amely a Balaton vízszintjét is szabályozza."],
      ro: ["Confluența are loc în apropierea localității Tolnanémedi.", "Râul Kapos este cel mai mare afluent al râului Sió.", "După unirea cu Kapos, debitul râului Sió crește semnificativ.", "Zona a fost supusă unor lucrări masive de dragare în anii 1970.", "Ecosistemul local este monitorizat pentru calitatea apei deversate spre Dunăre.", "În apropiere se află vestigiile unor poduri feroviare vechi de o mare valoare tehnică."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tolnai-hegyhát a Dunántúli-dombság északi része, Tolna vármegye északnyugati felén, a Kapos és a Sió völgye között terül el. Nevével ellentétben nem hegység, hanem egy hullámos felszínű dombvidék, amelyet lösszel borított hátak és mélyre vágódott völgyek jellemeznek. A terület mezőgazdasági szempontból kiemelkedő, a domboldalakon kiterjedt gyümölcsösök és szántóföldek sorakoznak, a völgyekben pedig festői kis falvak bújnak meg. A Hegyhát központja Tamási, amely gyógyfürdőjéről és vadászterületeiről ismert. A táj érdekességei a löszmélyutak és a régi földvárak maradványai, amelyek az egykori védelmi vonalak emlékét őrzik. Földrajz K6 – dombvidéki tájak és löszformakincs.",
      ro: "Tolnai-hegyhát este o regiune deluroasă pitorească situată în nordul județului Tolna, reprezentând o trecere lină între Munții Mecsek și Marea Câmpie. Relieful este caracterizat prin platouri de loess fragmentate de văi adânci și împădurite, oferind un peisaj variat și relaxant. Regiunea este renumită pentru satele sale tradiționale, unde cultura maghiară se împletește cu moștenirea coloniștilor germani, și pentru agricultura sa diversificată, de la viticultură la cultivarea plantelor medicinale. Pădurile de aici, bogate în specii de stejar și tei, sunt destinații excelente pentru drumeții liniștite și pentru culesul fructelor de pădure. Este o regiune unde turismul rural se dezvoltă armonios, valorificând liniștea și produsele locale de calitate. Geografia K7 – Dealuri de loess și peisaje culturale.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tájegység átlagos magassága 200-250 méter között mozog.", "Legmagasabb pontja a Hegyhát északi részén található (272 m).", "A terület alapvető kőzete a pleisztocén kori lösz.", "A Tolnai-hegyhát híres a vadászati turizmusáról, különösen a dámszarvasról.", "Itt található a Tamási közelében fekvő Gyulaj, az ország egyik legnevesebb vadaskertje.", "A dombvidék völgyeiben számos kisebb horgásztó és víztározó jött létre."],
      ro: ["Cea mai înaltă altitudine a regiunii depășește cu puțin 280 de metri.", "Solul de loess este extrem de fertil, fiind baza economiei agricole locale.", "Regiunea este străbătută de traseul de drumeție 'Calea Albastră a Sudului'.", "Satele din Tolnai-hegyhát sunt faimoase pentru pivnițele săpate direct în loess.", "Zona este bogată în vânătoare, fiind renumită pentru populația de mistreți.", "Flora include specii rare de bujor sălbatic pe versanții protejați."],
      en: []
    }
  },
  // HU-VA: Vas
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Rába a Duna legjelentősebb magyarországi jobb oldali mellékfolyója, amely Ausztriában, a Fischbachi-Alpokban ered és Győrnél torkollik a Mosoni-Dunába. Magyarországi szakasza közel 188 kilométer hosszú, érintve Szentgotthárd, Körmend és Sárvár városait. A Rába az egyik legvadregényesebb hazai folyónk, mivel felső szakaszán megőrizte természetes medrét, zátonyait és kavicsos partjait, ami a vízitúrázók kedvelt úti céljává teszi. A folyó vízjárása rendkívül gyors és kiszámíthatatlan, gyakran okoz hirtelen áradásokat a környező völgyekben. A Rába-völgy fontos ökológiai folyosó az Alpok és az Alföld között, ahol számos ritka növény- és állatfaj talál otthonra a Rába-menti tájvédelmi területeken. Földrajz K7 – folyóvizek és vízenergia.",
      ro: "Râul Rába este principalul curs de apă din vestul Ungariei, izvorând din Alpii Austriaci și traversând regiunea Transdanubiei de Vest până la vărsarea în brațul Moson al Dunării, la Győr. Rába este renumită pentru cursul său sălbatic și imprevizibil, având numeroase meandre și zone cu curenți puternici care o fac o destinație preferată pentru iubitorii de rafting și canotaj de aventură. Valea râului este o arie protejată importantă, păstrând păduri de luncă autentice și pajiști inundabile unde trăiesc specii rare de pești și păsări. De-a lungul secolelor, Rába a fost o linie defensivă strategică, malurile sale fiind martorele unor bătălii istorice importante, precum cea de la Szentgotthárd din 1664. Geografia K7 – Râuri alpine și ecosisteme de frontieră.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Teljes hossza 283 kilométer, amelyből 188 kilométer esik Magyarországra.", "A folyó Győr városában egyesül a Mosoni-Dunával.", "A Rába mentén épült fel Sárvár vára, a Nádasdy család egykori központja.", "Vízgyűjtő területe összesen 10 113 négyzetkilométer.", "A folyó energiáját korábban számos vízimalom hasznosította.", "Az Őrségi Nemzeti Park egyik fontos észak-déli tengelyét alkotja."],
      ro: ["Râul Rába are o lungime totală de 283 km, dintre care 188 km în Ungaria.", "Este unul dintre puținele râuri maghiare unde navigația comercială nu este practicată pe scară largă.", "Nivelul apei poate crește extrem de rapid în urma ploilor abundente din Alpi.", "Orașul Győr, situat la confluența râului Rába cu Dunărea, este numit 'orașul celor trei râuri'.", "Valea Rába face parte din Parcul Național Örség pe secțiunea sa superioară.", "Râul alimentează numeroase centrale hidroelectrice mici pe teritoriul Austriei."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kőszegi-hegység az Alpok legkeletibb nyúlványa Magyarországon, amely Vas vármegye északnyugati szélén, az osztrák határ mentén terül el. Ez a terület hazánk egyik legcsapadékosabb és legtisztább levegőjű vidéke, ahol a hegyi kristálytiszta patakok és a hatalmas bükkösök alpesi hangulatot árasztanak. Itt található a Dunántúl legmagasabb pontja, az Írott-kő, amely 882 méteres magasságával emelkedik a táj fölé. A hegység gazdag történelmi emlékekben is: Kőszeg városa és annak vára a magyar történelem egyik hősi helyszíne. A terület az Írottkő Naturpark része, ahol jól jelzett turistautak, források (pl. Hétforrás) és kilátók várják a természetjárókat minden évszakban. Földrajz K7 – hegyvidéki éghajlat és középhegységek.",
      ro: "Munții Kőszeg reprezintă singura regiune montană de tip alpin din Ungaria, situată la granița cu Austria. Acest masiv, format din roci metamorfice (șisturi cristaline), oferă un peisaj distinct față de restul munților maghiari, cu pante abrupte și păduri dense de conifere și foioase. Cel mai înalt vârf, Írott-kő, oferă o panoramă uluitoare spre Alpi și spre Marea Câmpie. Climatul subalpin, aerul de o puritate excepțională și numeroasele izvoare fac din această zonă o stațiune climaterică renumită de peste un secol. Orașul Kőszeg, situat la poalele munților, este unul dintre cele mai frumoase orașe istorice ale țării, păstrând atmosfera medievală intactă. Geografia K7 – Relief alpin și stațiuni climaterice.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Legmagasabb pontja az Írott-kő (882 m), amelynek kilátóján a határvonal is áthalad.", "A hegység fő kőzete a kristályos pala, ami ritka Magyarországon.", "Itt található az ország egyik legrégebbi természetvédelmi területe.", "A Hétforrás vizét 1896-ban a hét magyar vezér tiszteletére foglalták írásba.", "Az évi csapadékmennyiség itt eléri a 800-900 millimétert.", "A hegység lábánál fekvő Bozsok és Velem népszerű üdülőfalvak."],
      ro: ["Masivul face parte din contraforturile estice ale Alpilor (Grupul Central).", "Altitudinea maximă este de 884 metri (vârful Írott-kő).", "Munții sunt bogați în minerale, fiind exploatați în trecut pentru fier și cupru.", "Regiunea este faimoasă pentru podgoriile sale de pe versanții sudici, unde se produce vinul 'Kékfrankos'.", "Aici se găsesc cele mai multe specii de ferigi și mușchi din Ungaria.", "Traseul 'Cărarea Albastră' pornește oficial de pe vârful Írott-kő."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Őrségi erdők az Őrségi Nemzeti Park szívében, Vas vármegye délnyugati sarkában találhatók, ahol a magyar, az osztrák és a szlovén határ találkozik. Ez a táj a „dombok országa”, ahol a sűrű fenyvesek és bükkösök között megbújó kisméretű falvak és szerek alkotják az egyedülálló településszerkezetet. Az erdők talaja savanyú és agyagos, ami kedvez a hangás fenyérek és a különleges tőzegmohás lápok kialakulásának. Az Őrség erdői gazdagok gombákban és erdei gyümölcsökben, az állatvilágot pedig olyan ritka fajok képviselik, mint a fekete gólya vagy a darázsölyv. A táj és az ember kapcsolata itt évszázadok óta harmóniában van, a hagyományos szálaló erdőművelés pedig segít megőrizni az erdők természetes jellegét. Természetismeret K5 – az erdő életközössége és hagyományos tájhasználat.",
      ro: "Pădurile din regiunea Örség reprezintă inima celui mai tânăr parc național din Ungaria, fiind un peisaj cultural și natural unic unde omul și natura trăiesc în armonie de peste un mileniu. Aceste păduri dense de pin, mesteacăn și stejar acoperă dealurile domoale de la granița cu Slovenia și Austria, oferind un habitat ideal pentru numeroase specii rare de animale și plante. Regiunea este renumită pentru 'szer-ek' – așezări mici dispersate pe dealuri, care au păstrat arhitectura tradițională din lemn și obiceiurile seculare ale grănicerilor maghiari. Plimbările prin aceste păduri oferă o liniște absolută, aer bogat în rășină și șansa de a descoperi mlaștini de turbă cu vegetație rară. Științele Naturii K6 – Păduri de amestec și conservarea tradițiilor.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A terület 2002 óta élvez nemzeti parki oltalmat.", "Az erdők uralják a táj több mint 60%-át, főleg erdeifenyő és bükk formájában.", "Itt található Magyarország egyik legjelentősebb tőzegmohás lápja, a Grajka-patak mentén.", "Az Őrség híres a gombászati hagyományairól, több száz faj él itt.", "Az erdők mélyén még ma is találhatók régi, úgynevezett „tökmagos” présházak.", "A Szalafő-Pityerszer skanzen bemutatja az erdőhöz kötődő régi életmódot."],
      ro: ["Pădurile acoperă peste 60% din suprafața Parcului Național Örség.", "Regiunea este renumită pentru uleiul de semințe de dovleac produs prin metode tradiționale.", "În pădurile Örség trăiesc specii rare de fluturi și gândaci protejați la nivel european.", "Tradiția 'arderea oalelor' în sate precum Magyarszombatfa folosește lemn din aceste păduri.", "Mlaștinile de turbă de aici adăpostesc planta carnivoră 'Roua cerului'.", "Regiunea are cea mai mare cantitate de precipitații din Ungaria, favorizând vegetația bogată."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gyöngyös-patak a Kőszegi-hegység legjelentősebb vízfolyása, amely Ausztriában ered és Kőszegnél lépi át a magyar határt. A patak keresztülfolyik Kőszeg és Szombathely városán, meghatározva a két település arculatát és vízellátását. A patak völgye fontos ökológiai folyosó, amely összeköti a hegyvidéket a Rába-völgyi síksággal. Történelmileg a Gyöngyös-patak energiája kiemelkedő volt, hiszen mentén egykor malmok hosszú sora üzemelt, segítve a helyi ipar fejlődését. Napjainkban a patak medre Szombathely belvárosában parkosított környezetben halad, partján sétányokkal és pihenőhelyekkel, miközben a városi zöldfelület alapját képezi. Földrajz K6 – kisvízfolyások szerepe a városépítészetben.",
      ro: "Pârâul Gyöngyös este un curs de apă pitoresc care izvorăște din Munții Kőszeg și traversează orașul istoric Kőszeg, fiind o arteră vitală pentru regiunea de vest a Transdanubiei. Numele său, care s-ar traduce prin 'Pârâul cu Perle', sugerează puritatea apelor sale în trecut. Cursul său este însoțit de pajiști montane și păduri de foioase, oferind un peisaj de o frumusețe relaxantă. În orașul Kőszeg, pârâul trece pe lângă zidurile cetății și prin parcuri îngrijite, fiind un element central al peisajului urban. Gyöngyös a jucat un rol economic important, alimentând în trecut numeroase mori și ateliere meșteșugărești care au adus prosperitate orașului. Astăzi este un loc preferat pentru plimbări și recreere. Geografia K7 – Ape curgătoare mici și dezvoltare urbană.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A patak teljes hossza közel 70 kilométer.", "Kőszegen a patak mentén található a várárok vízellátását biztosító rendszer.", "Szombathelyen a patak kettészeli a várost, több mint tíz híd ível át rajta.", "Vízhozama a hegyvidéki csapadéktól függően gyorsan változhat.", "A patak vize táplálja Szombathelyen a Csónakázó-tavat is.", "A folyó torkolata a Rába folyóba Sárvár közelében található."],
      ro: ["Pârâul are o lungime de aproximativ 45 km până la vărsarea în râul Rába.", "Izvorul său se află pe teritoriul Austriei, sub numele de Güns.", "În secolul al XIX-lea, pârâul alimenta peste 15 mori de apă în regiunea Kőszeg.", "Inundația istorică din 1965 a cauzat daune majore centrului orașului Kőszeg.", "Valea pârâului este un coridor ecologic important pentru migrația animalelor mici.", "Albia pârâului a fost recent revitalizată prin proiecte europene de protecție a mediului."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Írott-kő a Kőszegi-hegység és egyben az egész Dunántúl legmagasabb pontja, amely 882 méteres magasságával emelkedik az osztrák-magyar határon. Nevét egy 14. századi határkőről kapta, amelybe jeleket véstek („írtak”). A csúcson egy 1913-ban épült kőkilátó áll, amelynek érdekessége, hogy a közepén halad át az államhatár, így az egyik ajtón belépve még Magyarországon, a másikon kilépve már Ausztriában találjuk magunkat. A kilátóból pazar panoráma nyílik: tiszta időben észak felé a Fertő-tó, dél felé a Balaton víztükre, nyugat felé pedig az Alpok havas csúcsai is megpillanthatóak. Az Írott-kő az Országos Kéktúra nyugati végpontja, így a magyar természetjárók egyik legfontosabb zarándokhelye. Földrajz K7 – Magyarország hegyvidékei és határmenti turizmus.",
      ro: "Írott-kő (Piatra Scrisă) este cel mai înalt vârf al Munților Kőszeg și al întregii regiuni Transdanubia, având o altitudine de 884 metri. Vârful este situat exact pe granița dintre Ungaria și Austria, fiind marcat de un turn de observație din piatră construit în 1913. Interesant este că linia de frontieră trece chiar prin mijlocul turnului, vizitatorii putând trece dintr-o țară în alta în interiorul clădirii. Panorama de pe platforma superioară este spectaculoasă, cuprinzând în zilele senine lacul Balaton, lacul Neusiedl și vârfurile înzăpezite ale Alpilor austrieci. Numele vârfului provine de la pietrele de hotar marcate cu litere care se găseau în apropiere. Este punctul de plecare al celebrului traseu de drumeție 'Cărarea Albastră'. Geografia K7 – Vârfuri de frontieră și panorame transfrontaliere.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Magassága 882 méter, amivel a Dunántúl csúcsa.", "A mai kilátót 1913-ban emelték a korábbi faépítmény helyett.", "Az Országos Kéktúra (OKT) 1160 kilométeres útvonala innen indul kelet felé.", "A csúcs közelében található a Hármashatár-kő, ahol régen három vármegye találkozott.", "A hegy német neve Geschriebenstein, ami szintén „megírt követ” jelent.", "A csúcsra vezető legrövidebb út a Hörmann-forrástól indul."],
      ro: ["Vârful are o altitudine de 884 de metri, fiind cel mai înalt punct din vestul Ungariei.", "Turnul de observație actual a fost ridicat pe locul unui turn de lemn mai vechi.", "Până în 1989, accesul la turn a fost strict interzis din cauza Cortinei de Fier.", "Turnul a fost restaurat complet în anul 2002 prin cooperare maghiaro-austriacă.", "Lângă turn se află o piatră de hotar istorică datând din secolul al XVIII-lea.", "Drumeția până la vârf de la parcarea Hörmann-forrás durează aproximativ 45 de minute."],
      en: []
    }
  },
  // HU-VE: Veszprém
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Somló Magyarország legkisebb borvidékének névadó hegye, egy magányosan álló, 431 méter magas tanúhegy Veszprém vármegyében, a Marcal-medence szélén. A hegy bazaltból épül fel, amely a vulkáni tevékenység során jött létre, és az erózióval szembeni ellenállása miatt maradt meg tanúhegyként. A Somló déli lejtői világhírűek tüzes, ásványos fehérborairól, amelyeket a „nászéjszakák boraként” is emlegetnek. A hegytetőn található a 14. századi Somlói vár romja, amely egykor a Bakony védelmi vonalának része volt. A kilátóból és a várfalakról pazar kilátás nyílik a Bakonyra és a Balaton-felvidékre. A hegy északi oldalán sűrű erdők, a déli oldalon pedig teraszos szőlőskertek alkotják a táj jellegzetes képét. Földrajz K8 – tanúhegyek és vulkanizmus Magyarországon.",
      ro: "Muntele Somló este cel mai mic, dar poate cel mai caracteristic dintre 'munții martori' ai Ungariei, ridicându-se izolat ca o insulă vulcanică din câmpia Transdanubiei de Vest. Acest con de bazalt este faimos în întreaga lume pentru vinurile sale 'vulcanice', în special soiul Juhfark, despre care se spunea odinioară că este 'vinul nopții nunții' datorită proprietăților sale legendare. Versanții muntelui sunt acoperiți de podgorii terasate și pivnițe de vin pitorești, în timp ce platoul superior este dominat de ruinele cetății Somló și de un turn de observație modern. Peisajul este unul dramatic, cu coloane de bazalt (orgi de piatră) și o floră xerofilă rară. Este un loc unde geologia, istoria și viticultura se împletesc într-un mod fascinant. Geografia K7 – Munții martori și viticultura vulcanică.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Legmagasabb pontja 431 méterrel magasodik a környező síkság fölé.", "A hegyen található Szent István-kilátó 1938-ben épült bazaltkőből.", "A Somló Magyarország legkisebb történelmi borvidéke (mintegy 600 hektár).", "A Somlói vár a 13-14. században épült a hegy északi, meredek szikláira.", "Jellemző szőlőfajtája a Juhfark, amely csak itt adja jellegzetes ízét.", "A hegy lábánál fekszik Doba és Somlóvásárhely települése."],
      ro: ["Vârful muntelui atinge o altitudine de 431 de metri peste nivelul mării.", "Regiunea viticolă Somló este cea mai mică zonă viticolă oficială din Ungaria.", "Cetatea Somló, situată pe versantul nordic, datează din secolul al XIV-lea.", "Turnul de observație Szent István a fost construit din bazalt în anul 1938.", "Muntele este o arie protejată sub egida Parcului Național Balaton-felvidék.", "Vinurile de aici sunt renumite pentru mineralitatea lor extremă dată de solul bazaltic."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szent György-hegy a Balaton-felvidék egyik legszebb tanúhegye, amely a Tapolcai-medencében magasodik 415 méteres magasságával. A hegy legfőbb nevezetessége a bazaltorgonák sora, ahol a kihűlő láva hatalmas, 20-30 méter magas, orgonasípszerű oszlopokra vált szét. A hegy déli lejtői évszázadok óta híresek bortermelésükről, a bazaltos talaj különleges ásványos ízt ad az itt termett szürkebarátnak és olaszrizlingnek. A hegyen található a barokk stílusú Lengyel-kápolna és a Tarányi-présház, amelyek a vidéki építészet remekei. A csúcsról lenyűgöző kilátás nyílik a szomszédos Badacsonyra, a Csobáncra és a Balaton csillogó víztükrére. Földrajz K8 – vulkáni tanúhegyek és bazaltformák.",
      ro: "Muntele Szent György este unul dintre cei mai impunători munți martori de la nord de lacul Balaton, fiind faimos pentru 'orgile de bazalt' – coloane vulcanice verticale spectaculoase care ating înălțimi de până la 30 de metri. Formate prin răcirea lentă a lavei, aceste structuri geometrice oferă un peisaj natural copleșitor. Muntele este de asemenea un centru viticol de elită, podgoriile sale producând unele dintre cele mai fine vinuri albe din regiunea Badacsony. Pe versanții săi se găsesc monumente arhitecturale deosebite, precum capela barocă Lengyel, cu fațada sa galbenă strălucitoare. Traseul educațional care trece pe lângă orgile de bazalt și prin 'Peștera de gheață' este o experiență obligatorie pentru orice vizitator al zonei Balatonului. Geografia K7 – Vulcanismul și formațiunile de bazalt.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Magassága 415 méter, anyaga miocén kori bazalt.", "A bazaltorgonák helyenként a 1,5 méteres átmérőt is elérik.", "A hegy oldalában található a Jégbarlang, ahol nyáron is fagypont körüli a hőmérséklet.", "A Lengyel-kápolna 1760 körül épült a Tóti-Lengyel család megbízásából.", "Itt halad át az Országos Kéktúra útvonala Badacsony és Tapolca között.", "A hegy neve a sárkányölő Szent György legendájához kötődik."],
      ro: ["Vârful muntelui Szent György are o altitudine de 415 metri.", "Coloanele de bazalt ('orgile') s-au format acum aproximativ 3-4 milioane de ani.", "Casa Turchi, o clădire cu elemente ortodoxe rusești, este o curiozitate locală pe munte.", "Panorama de pe platou cuprinde munții Badacsony, Csobánc și bazinul Tapolca.", "Fenomenul 'peșterii de gheață' se datorează circulației aerului prin crăpăturile bazaltului.", "Aici crește rarisima ferigă de stâncă, o specie protejată."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tapolcai-tavasbarlang Magyarország egyik legkülönlegesebb természeti látványossága, amely Veszprém vármegyében, Tapolca városa alatt húzódik. A barlangot 1903-ban fedezték fel kútásás közben, és érdekessége, hogy járatait részben kristálytiszta, meleg karsztvíz tölti ki, amin csónakkal lehet közlekedni. A barlangrendszer a pliocén korban alakult ki a mészkőben, a feltörő meleg források oldó hatására. A barlang feletti látogatóközpont interaktív módon mutatja be a karsztvidék titkait és a barlangok keletkezését. A város főterén található Malom-tó közvetlen kapcsolatban áll a barlang vízrendszerével, hiszen ide folyik ki a barlang vize, hajtva a történelmi vízimalmot. Földrajz K7 – barlangtípusok és karsztvizek.",
      ro: "Peștera Lacustră din Tapolca este o minune naturală unică în Europa Centrală, fiind situată chiar sub centrul orașului Tapolca. Descoperită accidental în 1903 în timpul săpării unei fântâni, peștera face parte dintr-un sistem carstic vast inundat de ape termale și reci. Cea mai spectaculoasă activitate pentru vizitatori este plimbarea cu barca prin canalele înguste cu apă cristalină, unde pot fi admirate formațiunile calcaroase luminate subacvatic. Pe lângă valoarea turistică, peștera are și proprietăți curative; aerul din galeriile uscate este extrem de pur și are o umiditate constantă, fiind folosit pentru tratarea afecțiunilor respiratorii în secția de spital adiacentă. Este un loc unde aventura se întâlnește cu relaxarea și sănătatea. Științele Naturii K6 – Relief carstic și ape subterane.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A barlang teljes hossza 3,3 kilométer, ebből 250 méter látogatható csónakkal.", "A víz hőmérséklete állandóan 18-20 °C körül mozog.", "A barlang levegője rendkívül tiszta és páradús, kiválóan alkalmas légúti betegségek kezelésére.", "Ez volt az ország első villanyvilágítással ellátott és idegenforgalmi célra megnyitott barlangja.", "A Malom-tó partján álló vízimalom eredetileg a 13-14. században épült.", "A barlangban él a ritka fürge cselle nevű halfaj."],
      ro: ["Peștera a fost prima din Ungaria deschisă oficial pentru turiști, în anul 1912.", "Traseul vizitabil cu barca are o lungime de aproximativ 180 de metri.", "Temperatura apei în peșteră este constantă, în jur de 18-20 de grade Celsius.", "Sistemul de peșteri de sub oraș are o lungime totală explorată de peste 3 km.", "În apele peșterii trăiește un pește endemic de talie mică, 'crăiasa apelor'.", "Centrul de vizitare oferă expoziții interactive despre formarea carstului și a peșterilor."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Cuha-patak a Bakony hegység egyik legszebb és legvadregényesebb vízfolyása, amely Eplény környékén ered és a Bakony-alján egyesül a Bakony-érrel. A patak leglátványosabb szakasza a Vinye és Porva-Csesznek közötti mély szurdokvölgy, ahol a víz hatalmas sziklafalak között kanyarog. Itt halad át a műemléki védelem alatt álló Cuha-völgyi vasútvonal is, amely alagútjaival és viaduktjaival Magyarország legszebb hegyi vasútja. A patak medre mentén kanyargó turistaút több helyen gázlókkal keresztezi a vizet, ami izgalmas kalanddá teszi a túrázást. A völgy hűvös és párás klímája kedvez a ritka hegyvidéki növényfajoknak, a sziklafalakon pedig különleges mohák és páfrányok élnek. Földrajz K6 – szurdokvölgyek és hegyvidéki patakok.",
      ro: "Valea pârâului Cuha este una dintre cele mai spectaculoase chei naturale din Munții Bakony, renumită pentru peisajele sale sălbatice și pentru calea ferată montană care o traversează. Pârâul a săpat un defileu adânc în stânca calcaroasă, creând pereți abrupți, cascade mici și o vegetație luxuriantă de luncă montană. Traseul de drumeție urmează cursul apei, traversându-l de mai multe ori pe pietre sau podețe improvizate, oferind o experiență de aventură autentică. Un element de inginerie spectaculos este linia ferată Győr-Veszprém, care trece prin defileu pe viaducte și prin tuneluri săpate în stâncă, fiind declarată monument tehnic. Valea Cuha este o destinație preferată pentru familii și fotografi de natură, fiind accesibilă în orice anotimp. Geografia K7 – Eroziunea fluvială și peisaje de munte.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A patak hossza mintegy 81 kilométer a torkolatáig.", "A Bakonyi Vasút (Győr–Veszprém vonal) 1896-ban épült meg a völgyben.", "A szurdokvölgyben található a Gubányi Károly viadukt, a vasútvonal egyik legszebb hídja.", "A patak neve szláv eredetű, valószínűleg „szárazat” vagy „csendeset” jelent.", "Nagyobb esőzések után a patak vízszintje órák alatt több métert emelkedhet.", "A völgy része a Bakonyi Tájvédelmi Körzetnek és népszerű piknikezőhely."],
      ro: ["Valea Cuha este declarată arie protejată datorită geologiei și florei sale specifice.", "Viaductul feroviar de lângă Porva-Csesznek este o piesă de patrimoniu tehnic din secolul XIX.", "Numele 'Cuha' este de origine slavă și înseamnă 'pârâu sec', deși debitul este adesea bogat.", "Traseul de drumeție are o lungime de circa 4-5 km în porțiunea cea mai spectaculoasă.", "În pereții cheilor se află mai multe peșteri mici care au servit drept adăpost haiducilor.", "Primăvara, defileul este inundat de înflorirea ghioceilor sălbatici."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kab-hegy 599 méteres magasságával a Déli-Bakony legmagasabb csúcsa és a Dunántúl egyik legfontosabb tájékozódási pontja. Különleges formáját a vulkáni tevékenységnek köszönheti; egy kialudt pajzsvulkán maradványa, amelynek lapos tetején ma hatalmas televíziós és rádiós adótornyok sorakoznak. A hegyet szinte teljesen sűrű bükk- és tölgyerdők borítják, amelyek gazdag vadállománynak és ritka növényfajoknak adnak otthont. Bár a csúcsot technikai építmények uralják, a hegy oldalában lévő tisztásokról és a Kinizsi-kilátóból pazar kilátás nyílik a Balaton-felvidékre és a Bakony vonulataira. A Kab-hegy népszerű a túrázók és kerékpárosok körében, hiszen jól karbantartott erdészeti utak vezetnek a fennsíkjára.",
      ro: "Muntele Kab este cel mai înalt vârf din regiunea Bakony-ul de Sud, având o altitudine de 599 de metri și fiind un punct de reper inconfundabil datorită turnurilor sale de comunicații vizibile de la distanță. Muntele este un platou bazaltic de origine vulcanică, acoperit de păduri vaste de fag și stejar care oferă un habitat excelent pentru fauna sălbatică. Pe vârful muntelui se află turnul de observație Kinizsi, de unde se deschide o panoramă spectaculoasă spre lacul Balaton, Munții Somló și restul masivului Bakony. Zona este faimoasă printre drumeți și cicliști montani pentru traseele sale variate și bine marcate. De asemenea, muntele joacă un rol crucial în meteorologia națională, găzduind o stație radar și de monitorizare a vremii. Geografia K7 – Vulcanismul bazaltic și infrastructura montană.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Muntele Kab are o altitudine de 599 de metri, fiind cel mai înalt punct din Bakony-ul de Sud.", "Structura muntelui este formată dintr-un strat gros de bazalt așezat peste calcar.", "Turnul de televiziune de pe vârf are o înălțime de peste 100 de metri.", "Vârful este accesibil cu mașina pe un drum asfaltat, dar și prin numeroase trasee de drumeție.", "În apropiere se află localitatea Nagyvázsony, renumită pentru cetatea lui Kinizsi Pál.", "Pădurile de pe munte sunt renumite pentru populația de cerbi și mufloni."],
      en: []
    }
  },
  // HU-ZA: Zala
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Mura Magyarország egyik legvadregényesebb és ökológiailag legértékesebb határfolyója, amely hosszú szakaszon választja el hazánkat Horvátországtól. Zala vármegye délnyugati részén kanyarog, medrét pedig még ma is a természet alakítja; a folyó szabadon épít és rombol zátonyokat, szigeteket. A Mura-mente a Mura-Dráva-Duna bioszféra-rezervátum része, amelyet gyakran 'Európa Amazonasaként' is emlegetnek a sűrű ártéri erdők és a gazdag vízi élővilág miatt. Történelmileg a folyó híres volt az aranyászásról és a különleges hajómalmokról, amelyek a sebes sodrást használták ki. Ma a Mura a vízitúrázók és a természetfotósok paradicsoma, ahol az érintetlen folyami táj nyugalma fogadja a látogatót.",
      ro: "Râul Mura este cel mai mare afluent al Dravei și formează o porțiune importantă a graniței sudice a Ungariei cu Croația. Izvorând din Alpii Austriaci, râul aduce în Ungaria un caracter dinamic, cu meandre naturale și zone inundabile care fac parte din Parcul Național Dunăre-Drava. Valea Murei este una dintre cele mai puțin alterate regiuni fluviale din Europa, fiind inclusă în Rezervația Biosferei Transfrontaliere UNESCO 'Amazonia Europei'. Râul este renumit pentru biodiversitatea sa extremă, fiind un refugiu pentru vidre, castori și numeroase specii de păsări rare. Tradițiile locale legate de pescuitul pe Mura și de utilizarea morilor plutitoare sunt încă păstrate în satele de pe mal, oferind o perspectivă culturală unică. Geografia K7 – Râuri de frontieră și biodiversitate fluvială.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Mura a Dráva legnagyobb és legvízdúsabb mellékfolyója.", "A magyarországi szakasz a Balaton-felvidéki Nemzeti Park része.", "A folyóban régebben több száz hajómalom működött.", "Itt él a ritka galóca és több más védett halfaj.", "A Mura menti kavicspadokon ma is találni apró aranyszemcséket.", "Az ártéri erdőkben hatalmas, évszázados kocsányos tölgyek élnek.", "Fontos ökológiai folyosó az Alpok és a Pannon-síkság között.", "A folyó vízminősége kiváló, alkalmas a fürdésre is a kijelölt helyeken."],
      ro: ["Râul Mura are o lungime totală de 444 km, dintre care 48 km în Ungaria.", "Formează granița de stat între Ungaria și Croația pe o distanță de 45 km.", "Este unul dintre puținele râuri europene care nu are baraje pe cursul său inferior.", "Mura este celebră pentru micile sale insule de pietriș care apar și dispar la viituri.", "Zona este protejată sub egida Natura 2000 pentru habitatele sale de luncă.", "Pescuitul tradițional cu 'vârșe' este o practică străveche încă întâlnită pe Mura."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Zala folyó a Dunántúl délnyugati részének legjelentősebb vízfolyása és a Balaton éltető főere. Az Őrség dombjai között ered, majd Zala vármegye szívén keresztülfolyva torkollik a Kis-Balatonon keresztül a magyar tengerbe. Stratégiai fontossága felbecsülhetetlen, hiszen a Balaton vízutánpótlásának döntő többségét ez a folyó biztosítja. A Zala völgye változatos tájakon halad át: szűk erdős völgyektől a tágas mocsárvilágig minden megtalálható a partjai mentén. A folyó szabályozása során kialakított Kis-Balaton védelmi rendszer ma már Európa-szerte híres madárrezervátum és természetes szűrőállomás, amely garantálja a Balaton vizének tisztaságát. A horgászok számára a Zala gazdag halállománya miatt kedvelt célpont.",
      ro: "Râul Zala este cel mai important curs de apă care alimentează lacul Balaton, aducând aproape jumătate din volumul de apă proaspătă al lacului. Izvorând din dealurile Örség, râul traversează județul Zala într-un curs sinuos, trecând prin orașul Zalaegerszeg și vărsându-se în Balaton la sud de localitatea Keszthely. Înainte de gura de vărsare, râul trece prin mlaștinile Kis-Balaton, care acționează ca un filtru natural uriaș, reținând sedimentele și nutrienții pentru a proteja calitatea apei din Balaton. Valea râului Zala este o regiune agricolă bogată, cu tradiții vechi în cultivarea cerealelor și creșterea animalelor. Este un râu vital pentru echilibrul ecologic al întregii regiuni transdanubiene. Geografia K7 – Râuri și sisteme de filtrare naturală.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Râul Zala are o lungime totală de 126 km.", "Bazinul său hidrografic acoperă peste 2600 km², fiind motorul hidrologic al Balatonului.", "Regularizarea cursului inferior a dus în secolul XX la degradarea Kis-Balatonului, remediată ulterior prin proiecte ecologice.", "Râul este renumit pentru populațiile de somn și clean pe tot parcursul său.", "Canalul Zala a fost curățat și revitalizat pentru a facilita turismul cu barca.", "Nivelul debitului râului influențează direct nivelul apei în lacul Balaton."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kerka egy kicsi, de ökológiai szempontból rendkívül értékes folyó a délnyugati határszélen, amely a Hetés vidékét és Lenti környékét határozza meg. Szlovéniában ered, majd számos kanyarulattal szeli át a zalai tájat, égerligetekkel és nedves rétekkel kísérve. A Kerka híres tiszta vizéről és a medrében élő gazdag kisállatvilágról; itt található Magyarország egyik legjelentősebb folyami rák populációja. A folyó völgye a természetjárók számára a nyugalom oázisa, ahol a part menti erdőkben ritka madarak, a réteken pedig védett növények, például a mocsári kockásliliom élnek. A Kerka fontos összekötő kapocs a dél-dunántúli természetvédelmi hálózatban, megőrizve a vidék archaikus vízivilágát.",
      ro: "Râul Kerka este cel mai mare curs de apă din regiunea Hetés și Göcsej, în sud-vestul Ungariei, fiind un afluent important al Murei. Râul izvorăște din Slovenia și traversează un peisaj de o frumusețe pastorală, unde satele tradiționale cu case de lemn și biserici vechi se integrează perfect în natură. Valea Kerka este o arie protejată sub numele de Parcul Natural Kerka-mente, fiind faimoasă pentru pajiștile sale umede pline de narcise sălbatice și pentru pădurile de arini de pe maluri. Râul are un curs natural, cu multe meandre, fiind un habitat ideal pentru vidre și diverse specii de pești rari. Este o zonă unde timpul pare să curgă mai lent, oferind condiții ideale pentru ecoturism și drumeții liniștite. Geografia K7 – Râuri mici și micro-regiuni etnografice.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Râul Kerka are o lungime de aproximativ 60 km pe teritoriul Ungariei.", "Valea râului găzduiește cea mai mare colonie de narcise sălbatice din țară, care înfloresc în aprilie.", "Parcul Natural Kerka-mente a fost înființat în anul 2003 pentru protejarea peisajului local.", "Râul este cunoscut în rândul pescarilor pentru 'mreana de Kerka'.", "Numeroase mori de apă vechi, acum monumente tehnice, se găsesc de-a lungul cursului său.", "Zona este bogată în zone umede de tip mlaștină, fiind protejată prin Natura 2000."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A göcseji erdők a Nyugat-Dunántúl egyik legkarakteresebb dombvidékét, a 'szegek' világát borítják Zala vármegyében. Ez a vidék különleges mikroklímával rendelkezik: a párás, hűvös levegő kedvez a fenyvesek és bükkösök kialakulásának, ami az ország más részein ritka ilyen alacsony magasságban. Az erdők mozaikos szerkezete – ahol a mély völgyek sűrű vadonját tágas hegyi kaszálók szakítják meg – egyedülálló esztétikai élményt nyújt. Göcsej híres a gombákban és erdei gyümölcsökben való gazdagságáról, az itteni emberek kultúrája pedig évszázadok óta ezer szállal kötődik az erdőhöz, legyen szó faépítészetről vagy hagyományos gazdálkodásról. A göcseji erdőkben túrázva a látogató a háborítatlan természet és a népi hagyományok különleges elegyét tapasztalhatja meg.",
      ro: "Pădurile din regiunea Göcsej reprezintă unul dintre cele mai compacte și misterioase masive forestiere din Ungaria, acoperind dealurile înalte din județul Zala. Aceste păduri, dominate de fagi uriași și brazi argintii, creează o atmosferă de codru secular, unde lumina pătrunde cu greu prin coronamentul des. Regiunea Göcsej este faimoasă pentru satele sale 'ascunse' și pentru arhitectura tradițională din bușteni, pădurea fiind principala resursă de existență a localnicilor timp de secole. Zona este un paradis pentru căutătorii de ciuperci și pentru iubitorii de drumeții care caută trasee sălbatice și puțin frecventate. Fauna este bogată, pădurile fiind populate de populații mari de cerbi carpatini și mistreți. Științele Naturii K6 – Păduri de foioase și cultura lemnului.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Regiunea Göcsej este cunoscută sub numele de 'țara dealurilor și a pădurilor'.", "Fagul este specia dominantă, atingând dimensiuni impresionante datorită solului umed.", "Satul-muzeu Göcsej din Zalaegerszeg prezintă modul în care lemnul din aceste păduri a fost utilizat în construcții.", "Calea ferată forestieră de la Csömödér străbate peste 100 km prin aceste păduri.", "Zona este renumită pentru producția de miere de pădure de înaltă calitate.", "Göcsej este una dintre cele mai importante zone de vânătoare din Europa Centrală."],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Zalacsányi-tó egy festői, mesterségesen kialakított állóvíz Zala vármegye szívében, amely harmonikusan illeszkedik a környező dombvidékbe. Az 1990-es években elsősorban jóléti és horgászati célokra létrehozott tó mára népszerű szabadidőközponttá vált. A tavat lankás, erdővel borított dombok övezik, amelyek szélvédett, nyugodt mikroklímát biztosítanak a völgynek. Kristálytiszta vize és a gondozott part menti sétányok ideális helyszínt nyújtanak családi kirándulásokhoz, piknikezéshez és a horgászathoz. A tó közvetlen közelében modern wellness-létesítmények és golfpálya is található, így Zalacsány a minőségi turizmus egyik zalai központjává nőtte ki magát, megőrizve ugyanakkor természetközeli báját is.",
      ro: "Lacul Zalacsány este o destinație turistică de smarald situată în valea râului Zala, fiind renumit pentru apele sale limpezi și pentru cadrul natural relaxant. Lacul de acumulare artificial a fost creat prin bararea pârâului Kettős-mező, devenind rapid un centru de atracție pentru pescari și pentru cei care caută odihna în natură. Malurile sale sunt înconjurate de păduri și dealuri, oferind trasee de plimbare și locuri de picnic amenajate. Un punct de interes major în apropiere este castelul Batthyány, transformat în hotel, și terenul de golf de talie mondială, care fac din Zalacsány o destinație de vacanță elegantă. Lacul este populat cu specii valoroase de pești, fiind gazda a numeroase competiții de pescuit sportiv. Științele Naturii K5 – Lacuri și recreere rurală.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tó vízfelülete megközelítőleg 11 hektár kiterjedésű.", "Vízutánpótlását helyi források és a Kettős-patak biztosítja.", "Országosan elismert horgászvíz, híres kapitális amurjairól és csukáiról.", "A tó körüli tanösvény kényelmes sétát kínál a természetben.", "A közelben fekszik a Batthyány-kastély, amely ma szállodaként üzemel.", "A tó partja kedvelt esküvői és rendezvényhelyszín a szabadban.", "A halállományt rendszeres és fenntartható telepítéssel kezelik.", "Télen a befagyott tó és a havas dombok mesebeli látványt nyújtanak."],
      ro: ["Lacul are o suprafață de aproximativ 11 hectare.", "Este renumit pentru exemplarele mari de crap, amur și șalău.", "Pista de plimbare care înconjoară lacul este iluminată pe timpul nopții.", "În apropiere se află complexul Zala Springs, cel mai modern teren de golf din regiune.", "Lacul este alimentat de izvoare subterane care mențin apa proaspătă.", "Zona este o destinație populară pentru team-building-uri și nunți datorită peisajului romantic."],
      en: []
    }
  }
];
