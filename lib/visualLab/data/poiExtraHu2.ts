...
export const poiExtraHu2: POI[] = [
  // HU-BU: Budapest
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Vârful János-hegy reprezintă cel mai înalt punct geografic al Budapestei, atingând o altitudine de 528 de metri. Acesta este situat în sectorul XII și face parte integrantă din Munții Buda, oferind o panoramă spectaculoasă asupra întregii capitale maghiare. Principala atracție este Turnul de observație Erzsébet, construit în stil neoromanic între anii 1908 și 1910. Accesul către vârf este facilitat de telecabina Zugligeti Libegő, o modalitate populară de transport pentru turiști. Zona este înconjurată de păduri dense, fiind o destinație preferată pentru drumeții și activități în aer liber în orice anotimp.",
      en: "János-hegy is the highest point in Budapest, reaching an elevation of 527 meters above sea level. Located in the 12th district within the Buda Hills, it offers one of the most iconic panoramic views of the Hungarian capital and its surroundings. The summit is crowned by the Erzsébet Lookout Tower, a neo-Romanesque structure built in 1910 and named after Empress Elisabeth of Austria. The mountain is a popular recreational destination throughout the year, accessible via several hiking trails or the famous Zugliget Chairlift (Libegő). Its unique microclimate and forested slopes provide a refreshing escape from the urban heat, making it a cornerstone of Budapest's natural heritage and a must-visit location for nature lovers and history enthusiasts alike."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Elevation of 527 meters makes it Budapest's highest peak.", "Home to the Erzsébet Lookout Tower, completed in 1910.", "Accessible by the Zugliget Chairlift, which opened in 1970.", "Part of the Buda Hills and the Duna-Ipoly National Park.", "Features a distinctive neo-Romanesque architectural style.", "Named after St. John the Baptist in the early 19th century.", "Offers a visibility range of up to 80 kilometers on clear days.", "The lookout tower was designed by architect Frigyes Schulek."]
    }, image: "/poi-images/mountain-janos-hegy-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Hármashatár-hegy, standing at 495 meters, is a prominent peak in the Buda Mountains known for its strategic and recreational importance. Its name, meaning 'Three Border Mountain,' originates from the 19th century when the borders of Buda, Óbuda, and Pesthidegkút met at its summit. The area is a significant center for outdoor activities, particularly gliding and paragliding, due to favorable wind conditions. A modern lookout point, the Guckler Károly Lookout, provides a unique 360-degree view encompassing both the city and the winding Danube. The mountain's geological composition is primarily dolomite and limestone, and it serves as a vital green corridor for local wildlife within the metropolitan area."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Peak elevation is 495 meters in the Buda Mountains.", "Name refers to the historic 19th-century administrative borders.", "Center for Hungarian gliding since the early 20th century.", "Features the Guckler Károly Lookout, built in 2016.", "The mountain is largely composed of Triassic dolomite.", "Traversed by the National Blue Trail (Országos Kéktúra).", "Home to several rare plant species endemic to the Buda Hills.", "The forest consists mostly of oak and hornbeam trees."]
    }, image: "/poi-images/mountain-harmashatar-hegy-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Sas-hegy (Eagle Hill) is a unique nature reserve located in the heart of Budapest's 11th district, rising to 266 meters. Despite being surrounded by urban development, it preserves a remarkably intact ecosystem with rare flora and fauna dating back to the ice age. The hill is characterized by its dramatic dolomite cliffs and karst formations. It provides a sanctuary for the Pannonian lizard and several rare butterfly species. A designated visitor center and a guided nature trail offer insights into the hill's geology and biodiversity, while the summit affords a spectacular view of the Buda Castle and the Gellért Hill. It is a prime example of urban nature conservation in Central Europe."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Elevation of 266 meters above sea level.", "Declared a protected nature reserve in 1958.", "Geological foundation consists of 200-million-year-old dolomite.", "Home to the rare Pannonian lizard (Ablepharus kitaibelii).", "Preserves 'ice age relict' plant species like the Sesleria sadleriana.", "Features a 850-meter-long educational nature trail.", "The name 'Sas-hegy' dates back to the recapture of Buda in 1686.", "Located only a few kilometers from Budapest's city center."]
    }, image: "/poi-images/mountain-sas-hegy-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Lake Naplás, also known as the Szilas-patak flood control reservoir, is the largest standing water body in Budapest, located in the 16th district. Formed in 1978 by damming the Szilas stream, it has since evolved into a rich ecological habitat and was declared a nature reserve in 1997. The lake and its surrounding marshlands are crucial for migratory birds and local amphibians, including the European pond turtle. In 2021, a striking 27-meter-high wooden lookout tower was inaugurated, offering bird's-eye views of the Cinkota Forest and the lake's surface. It is a favorite spot for local anglers, cyclists, and families seeking a quiet retreat within the city limits."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Budapest's largest lake with a surface area of about 16 hectares.", "Created as a reservoir in 1978 for flood protection.", "The surrounding area became a protected nature reserve in 1997.", "A 27-meter-high modern lookout tower was added in 2021.", "Habitat for over 200 species of birds and various rare turtles.", "Average depth of the lake is approximately 2 to 6 meters.", "Surrounded by the protected Cinkota Forest (Cinkotai kiserdő).", "Popular destination for ice skating during cold winters."]
    }, image: "/poi-images/lake-naplas-to-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "The Soroksár Danube, also known as the Ráckeve-Danube branch, is a 57-kilometer-long side arm of the Danube river that bypasses the main shipping route. It stretches from the Kvassay Lock in Budapest to Tass, creating a unique wetland environment. Characterized by slow-moving water and extensive reed beds, it is famous for its 'floating bogs' (úszóláp), which are rare botanical formations. The branch is a paradise for water sports, fishing, and recreation, with numerous holiday homes and rowing clubs lining its banks. It plays a vital role in regional water management and provides a tranquil habitat for numerous protected fish and bird species away from the main river's bustle."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length of the branch is approximately 57 kilometers.", "Regulated by the Kvassay Lock (North) and Tass Lock (South).", "Home to rare 'floating bogs', a protected natural phenomenon.", "The water flow is significantly slower than the main Danube branch.", "One of Hungary's most popular destinations for recreational fishing.", "Features Csepel Island as its western boundary.", "Vital habitat for the European otter and various heron species.", "Important venue for national rowing and canoeing competitions."]
  ...
  // HU-BA: Baranya
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Zengő is the highest peak in the Mecsek Mountains, situated in southern Hungary near the town of Pécsvárad, with an elevation of 682 meters. The name 'Zengő' (Resounding) comes from a local legend about the wind whistling through the trees. The summit is home to a modern 22-meter-high lookout tower, completed in 2020, which was built around a pre-existing geodesic tower to minimize environmental impact. From the top, visitors can see as far as the Croatian mountains and Lake Balaton on clear days. The mountain is world-renowned for being the primary habitat of the rare Banat Peony (Paeonia officinalis subsp. banatica), a strictly protected plant that blooms in late spring."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Highest point of the Mecsek Mountains at 682 meters.", "Features a 22-meter-high lookout tower inaugurated in 2020.", "Primary habitat for the rare Banat Peony (Bánáti bazsarózsa).", "Nearby ruins of a small medieval watchtower can still be found.", "Located within the East Mecsek Landscape Protection Area.", "The mountain is mainly composed of Jurassic limestone and shale.", "A local legend tells of a giant whose shouting created the 'resounding' wind.", "Strategic location used for signaling during various historical wars."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Tubes is the second-highest peak in the Mecsek Mountains, reaching 611 meters and overlooking the city of Pécs. It is famous for the János Lookout Tower, a stone and wood structure that offers a breathtaking 360-degree panorama of the Drava Valley to the south and the Tolna hills to the north. The mountain serves as a major hiking hub, with numerous trails connecting it to the nearby Misina peak and its iconic TV tower. The geological history of Tubes is rich, featuring Triassic limestone that creates a rugged, karst-like landscape. Its slopes are covered in dense deciduous forests, providing a cool retreat for the residents of Pécs and a sanctuary for diverse wildlife."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Elevation of 611 meters, making it the second highest in Mecsek.", "Home to the János Lookout, named after Bishop János Scitovszky.", "Offers a clear view of the city of Pécs and the Villány Mountains.", "The current lookout tower was rebuilt and reopened in 2001.", "Part of the Mecsek Karst, featuring typical limestone formations.", "A vital junction for several regional and national hiking trails.", "The forest is dominated by sessile oak and silver lime trees.", "Historically significant as a site for early 20th-century tourism."]
    }, image: "/poi-images/mountain-tubes-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Jakab-hegy (James Hill) is one of the most culturally and geologically significant peaks in the Western Mecsek, rising to 602 meters. It is distinguished by its unique red Permian sandstone formations, most notably the 'Babás-szerkövek' (Doll-like rocks) and the 'Zsongorkő' lookout point. The mountain's flat plateau was once the site of a massive Iron Age Celtic hillfort, the largest of its kind in the region. In the 13th century, the Pauline Order—the only Hungarian-founded monastic order—established a monastery here, the ruins of which have been partially restored. Today, the hill is a premier destination for those interested in combining a natural hike with historical exploration."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Stands at 602 meters in the Western Mecsek range.", "Famous for unique red sandstone rock formations (Babás-szerkövek).", "Site of a 13th-century Pauline monastery, ruins of which are visible.", "Features the largest Iron Age Celtic ramparts in Hungary.", "The Zsongorkő rock offers the most famous natural lookout point.", "A part of the hill is an ancient burial mound field (tumuli).", "Declared a protected area due to its unique geological features.", "The sandstone was formed approximately 250 million years ago."]
    }, image: "/poi-images/mountain-jakab-hegy-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "The Fekete-víz (Black Water) is a significant stream in Baranya County, flowing through the Ormánság region before joining the Danube. It drains a large portion of the Baranya Plain and is characterized by its dark, tea-colored water, which results from the high organic matter and humic acids collected from its marshy catchment area. Historically, the river and its periodic flooding shaped the unique lifestyle of the 'Ormánság' people, leading to the development of traditional architecture such as houses built on stilts. Modern regulation has changed its course, but it remains a vital ecological corridor and a defining feature of the southern Hungarian landscape, supporting numerous wetland species and traditional meadows."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Flows through the historic Ormánság region in Baranya County.", "Named 'Black Water' due to its high organic/peat content.", "Major tributary that eventually feeds into the Danube River.", "Essential for the drainage of the southern Baranya Plain.", "Historically caused extensive flooding, shaping local culture.", "Home to the rare European mudminnow in its slower reaches.", "Average discharge is relatively low but increases during spring.", "The riverbanks are lined with ancient willow and poplar trees."]
    }, image: "/poi-images/river-fekete-viz-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Lake Orfű is the centerpiece of a magnificent four-lake system located in a valley of the Mecsek Mountains. Created in the 1960s as a recreational project, the system includes Lake Orfű (for bathing), Lake Pécs (the largest), Lake Herman Ottó (a nature reserve), and Lake Kovácsszénaia. Lake Orfű itself is a popular summer destination, known for its clean water and scenic forest backdrop. The village of Orfű has become a cultural hub, hosting the famous 'Fishing on Orfű' music festival annually. Additionally, the area features a unique Mill Museum with working water and wind mills, showcasing the region's industrial heritage. It offers a perfect blend of active relaxation, culture, and nature."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Part of a four-lake artificial system created in the 1960s.", "Lake Pécs within the system is the largest in Baranya County.", "Home to the only Mill Museum in Hungary with a working water mill.", "Host of the 'Fishing on Orfű' alternative music festival.", "The Herman Ottó Lake acts as a strictly protected nature reserve.", "Surrounded by the dense forests of the Western Mecsek.", "Popular for kayaking, sailing, and recreational swimming.", "The valley was originally a swampy area before the damming."]
  ...
  // HU-BK: Bács-Kiskun
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Lake Kunfehértó is a popular natural bathing destination in Bács-Kiskun County, formed in a natural wind-carved depression of the Kiskunság sand plateau. The lake is famous for its slightly saline, alkaline-carbonate water, which has been traditionally used for its therapeutic effects on skin conditions and rheumatic complaints. A unique feature of the site is its 'forested beach,' where century-old oak and pine trees provide natural shade directly at the water's edge, offering a cool sanctuary in the often intense heat of the Great Plain. The area is protected as part of the Natura 2000 network, preserving the rare flora and fauna of the sandy puszta landscape while serving as a vibrant center for summer festivals and youth camps."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Water is rich in sodium bicarbonate with a slight saline character.", "The beach is surrounded by a 120-hectare ancient pedunculate oak forest.", "Average depth of the lake ranges between 1.5 and 2 meters.", "Part of the Kiskunság National Park's ecological protection zone.", "Formed naturally in a depression between sand dunes.", "Host to the 'Kunfehértó Summer' cultural festival series.", "Rare plant species like the sand feather grass thrive on the nearby dunes.", "Features a modern youth camp and camping facilities near the shore."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Lake Szelid, located near Dunapataj, is the fifth largest natural lake in Hungary and the largest oxbow lake in the Danube basin. This 5-kilometer-long winding water body was formed thousands of years ago from an abandoned bed of the Danube river. The lake's water is exceptional: due to its high sodium and magnesium carbonate content, it has a saline character but remains silky to the touch rather than salty. Long favored for its healing properties, it is particularly recommended for relieving nervous system and joint ailments. While the southern shore is a developed resort area with beaches and campsites, the northern part remains an untouched nature reserve. The lakebed reaches depths of up to 4 meters, which is significant for Hungarian standing waters."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length is 5 kilometers with an average width of 150-200 meters.", "Surface area covers approximately 80 hectares of water.", "Reaches a maximum depth of 4 meters at its deepest points.", "Water has a 'soapy' feel due to its high sodium carbonate content.", "Features a 2.4-kilometer nature trail presenting local fauna.", "Formed as an oxbow lake of the Danube before river regulations.", "Summer water temperatures frequently reach 26-28 degrees Celsius.", "The area has been a nationally protected site since 1976."]
    }, image: "/poi-images/lake-szelidi-to-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Lake Kolon, situated near the town of Izsák, is one of the most valuable wetland habitats in Central Europe and a jewel of the Kiskunság National Park. Although called a 'lake,' it is now primarily an extensive, continuous marsh and reed system that formed in an ancient Danube bed between sand dunes. As a bird reserve of European significance, it is a breeding ground for rare species such as the Great White Egret, Spoonbill, and Ferruginous Duck. The area also hosts Hungary's largest population of orchids, including the marsh helleborine. For visitors, birdwatching towers and the 'Bikatorok' nature trail provide a deep look into this hidden water world without disturbing the delicate ecological balance."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["The protected area of Lake Kolon spans approximately 3,000 hectares.", "Part of the Kiskunság National Park since its establishment in 1975.", "Home to the largest marsh orchid field in Hungary.", "Recognized as a wetland of international importance under the Ramsar Convention.", "Thousands of cranes stop here during their autumn migration.", "Over 200 bird species have been recorded by researchers in the marsh.", "The Bikatorok Lookout offers a panoramic view of the entire reed landscape.", "Features rare alder and willow swamp forests in the deeper areas."]
    }, image: "/poi-images/lake-kolon-to-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Bugac Puszta is the quintessential representation of the Hungarian steppe and a living monument to Pannonian history. As the most visited part of the Kiskunság National Park, this area preserves the centuries-old tradition of extensive animal husbandry and the culture of the 'Csikós' (horse-herds). The vast plain is a mosaic of sand dunes, alkaline flats, and enormous pastures where Hungarian Grey Cattle and Racka sheep graze. Visitors can experience breathtaking equestrian shows that demonstrate the deep bond between man and horse. Furthermore, it serves as the venue for the Kurultáj—the largest tribal assembly of peoples with nomadic roots, celebrating Central Asian heritage in the heart of Europe."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["The Bugac Puszta area exceeds 11,000 hectares in size.", "Designated as a strictly protected part of the national park since 1975.", "Venue for the biennial Kurultáj tribal assembly since 2008.", "The ancient juniper forest is one of the puszta's rarest plant communities.", "The Shepherd Museum was built in 1933 in the heart of the plain.", "Equestrian shows feature the famous 'Hungarian Post' five-horse maneuver.", "Part of the UNESCO World Network of Biosphere Reserves.", "Includes over 10 kilometers of educational nature trails among the dunes."]
    }, image: "/poi-images/forest-bugaci-puszta-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "The Danube-Tisza Canal is an ambitious but unfinished hydraulic engineering project intended to create a navigable link between Hungary's two largest rivers. The concept dates back to the 18th century, but construction only began in the 20th century and was interrupted multiple times. Today, the completed sections play a vital role in the water supply of the Kiskunság region, assisting in irrigation and flood protection. Dense reed beds and willow trees have grown along its banks, providing a habitat for a rich fish population, including carp, pike, and bream. The slow-moving water and quiet surroundings make it a popular spot for anglers and nature lovers seeking the tranquil side of the Great Hungarian Plain."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["The canal project was first discussed during the reign of Maria Theresa.", "The section between Dunaharaszti and Dabas is the most developed part.", "The canal bed is 25-30 meters wide in its primary sections.", "Crucial for replenishing water in the sandy Kiskunság plateau.", "Average water depth varies between 1.5 and 2.5 meters.", "The protected Great Bittern nests in the extensive reed beds.", "A system of several locks regulates the water level along the route.", "A highly popular destination for recreational carp and grass carp fishing."]
  ...
  // HU-BE: Békés
  {
    ...
    descriptionAdvanced: {
      ...
      en: "The Hármas-Körös (Triple Koros) is one of the most picturesque and natural rivers in southeastern Hungary, formed near Gyomaendrőd by the confluence of the Kettős- and Sebes-Körös rivers. It meanders for 91 kilometers until it joins the Tisza at Csongrád. Its primary characteristic is the extremely rich system of oxbow lakes, created during the large-scale river regulations of the 19th century, which have since become a paradise for anglers. The floodplain forests along the Hármas-Körös are among the last untouched forest patches of the Great Plain, dominated by black poplars and willows. The river is excellent for water tourism, as its slow current and clean water allow for safe and scenic rowing for nature enthusiasts."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length of the river is 91 kilometers from confluence to mouth.", "A significant left-bank tributary of the Tisza River at Csongrád.", "The number of oxbow lakes along the river exceeds twenty.", "The floodplain is protected under the Körös-Maros National Park.", "Common fish species include catfish, zander, and nase.", "The famous Szarvas Arboretum is located directly on the riverbank.", "Water levels are regulated by the dam at Békésszentandrás.", "Features one of the longest continuous levee systems in Hungary."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      en: "The Sebes-Körös (Swift Koros) lives up to its name with a significantly faster current and clearer water compared to other rivers of the Great Plain. It originates in Transylvania, Romania, near the Király Pass, and brings cool, oxygen-rich water into the Hungarian lowlands. This characteristic makes it a unique ecosystem supporting fish species that are rare in slower lowland waters, such as trout in the upper reaches or chub. The river's section in Békés County is marked by gravel bars and clear water, making it popular for both bathers and canoeists. Colorful bee-eaters and kingfishers nest in the loess walls along the banks, while the river plays a central role in regional water management."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length is 209 km, with 59 km located within Hungary.", "Named for its swift flow and distinctive gravelly riverbed.", "The water is considered some of the cleanest in the Great Plain.", "Joins the Kettős-Körös at Gyomaendrőd to form the Hármas-Körös.", "The protected European bee-eater nests in the river's loess banks.", "A favorite for water tourism due to its clear water and scenic bars.", "Rare caddisfly species can be observed along the riverbed.", "Acts as a border river in some sections between Romania and Hungary."]
    }, image: "/poi-images/river-sebes-koros-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "The Biharugra Ponds constitute the second largest artificial fishpond system in Hungary, located at the eastern edge of Békés County along the Romanian border. Developed as remnants of the once-vast Sárrét marshlands, these ponds have become a bird reserve of international significance. The more than 1,900 hectares of water surface serve as one of the most important European stopovers for migratory birds, particularly wild geese, cranes, and spoonbills. As part of the Körös-Maros National Park, the area features birdwatching towers and nature trails for visitors. Economically, the system is also significant for fish production, utilizing traditional and ecological methods to raise carp and other native fish species."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["The water surface of the pond system covers approximately 1,900 hectares.", "Recognized as an internationally important wetland under the Ramsar Convention.", "More than 300 bird species have been observed at the pond system.", "The ponds were developed in the early 20th century in the former Sárrét marsh.", "Home to one of Hungary's largest breeding colonies of spoonbills.", "Part of the Biharugra unit within the Körös-Maros National Park.", "The main Ölyvös Canal is the primary water source for the system.", "Up to 40,000 wild geese may rest here during autumn migration."]
    }, image: "/poi-images/lake-biharugrai-tavak-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Mályvádi Forest is one of the largest and most valuable continuous forest blocks in the Great Hungarian Plain, stretching between Gyula and Sarkad along the Romanian border. It is a final remnant of the once-vast floodplain forests of the region, where century-old pedunculate oaks, Hungarian ashes, and field elms form a majestic canopy. The forest is famous for its rich wildlife, particularly its fallow deer and red deer populations, but it also serves as a nesting site for the rare Black Stork and White-tailed Eagle. In spring, carpets of marsh iris and spring snowflake cover the wetter areas. Its cool microclimate and undisturbed silence make it a favorite for nature photographers and hikers seeking wilderness."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["The forest spans more than 3,000 hectares of continuous area.", "The second largest continuous lowland forest in Hungary.", "Significant portions are protected within the Körös-Maros National Park.", "Home to the region's most important population of fallow deer.", "Several individual oak trees are more than 200 years old.", "Habitat for the rare and protected plant 'Debreceni torma' in spring.", "Serves as an important genetic base for native tree species.", "Features numerous forestry and hunting-themed educational trails."]
    }, image: "/poi-images/forest-malyvadi-erdo-extra.webp"},
  {
    ...
    factsAdvanced: {
      ...
      en: ["River length is 37 km from the confluence of the White and Black branches.", "Home to the largest dam of this river branch at the town of Békés.", "Asphalted levee roads are a favorite for regional cycling tourists.", "Joins the Sebes-Körös at Gyomaendrőd to form the Hármas-Körös.", "Lined by extensive willow-poplar floodplain gallery forests.", "The Békés boat harbor is one of the most modern water bases in the region.", "Common fish species include carp, catfish, and asp.", "The riverbed serves as a vital ecological corridor in the southern Great Plain."]
  ...
  // HU-BZ: Borsod-Abaúj-Zemplén
  {
    ...
    descriptionAdvanced: {
      ...
      en: "Istállós-kő, with its 959-meter elevation, was long considered the highest point of the Bükk Mountains until recent measurements showed the neighboring Szilvási-kő to be slightly taller. On the mountain's northwestern side lies the Istállós-kő Cave, a world-famous archaeological site where stone tools of the Aurignacian culture and some of the world's oldest bone flutes (30,000 years old) were discovered alongside Ice Age cave bear remains. The hiking trail to the summit typically starts from the Szalajka Valley; though steep, the silence of the beech forests and the historical atmosphere of the mountain reward the traveler. The mountain is composed of Triassic limestone, featuring characteristic karst phenomena like deep sinkholes."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Summit elevation is 959 meters above sea level.", "The cave on the mountain has been strictly protected since 1944.", "Site of one of the world's oldest bone flutes, dating back 30,000 years.", "Located in the central, strictly protected zone of the Bükk National Park.", "The 'Istállós-kő climb' from Szalajka Valley is one of Hungary's steepest.", "A large wooden cross marks the highest point at the summit.", "Vegetation consists of some of the country's most beautiful beech forests.", "Geologically situated on the edge of the Bükk Plateau's limestone shield."]
    }
  },
  {
    id: "river-sajo-extra",
    ...
    descriptionAdvanced: {
      ...
      en: "The Sajó is one of the most significant rivers in Northern Hungary, originating in the Low Tatras of Slovakia and flowing approximately 230 kilometers before joining the Tisza. The river defined the industrial character of Miskolc and its surroundings; its water was crucial for the establishment of iron works and factories in the region. Although industrial traces remain, the Sajó has cleaned up significantly in recent decades, allowing rare fish species like nase and barbe to return. The river valley acts as an important climatic divide between the Bükk and Cserehát hills, with its banks accompanied by wild willow groves and sandbars. Its confluence with the Tisza near Tiszaújváros offers a spectacular sight for water tourists."
    },
    factsAdvanced: {
      de: [
      ...
      en: ["Total length is 229 km, with 125 km located in Hungarian territory.", "The Hernád is the Sajó's largest tributary within Hungary.", "Industrial significance is historically linked to steel production in Diósgyőr.", "Sandbanks along the river serve as nesting sites for sand martins.", "The Sajó valley is a major bird migration route and ecological corridor.", "The river runs through the industrial heart of the city of Miskolc.", "European beavers have reappeared on the river as water quality improved.", "The river mouth is located in the immediate vicinity of Tiszaújváros."]
  ...
  // HU-CS: Csongrád-Csanád
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Lacul Alb de lângă Szeged (Szegedi Fehér-tó) reprezintă cel mai mare lac alcalin din Ungaria și o componentă vitală a Parcului Național Kiskunság. Această zonă umedă de o importanță internațională extraordinară servește drept punct critic de oprire pe rutele de migrație ale păsărilor europene. Deși a fost transformat întrun sistem de iazuri piscicole în secolul al XX-lea, și-a păstrat caracterul ecologic unic, fiind renumit pentru concentrația mare de săruri care, în perioadele secetoase, lasă o crustă albă strălucitoare pe maluri. Peisajul este unul de o liniște absolută, unde cerul se oglindește în apele puțin adânci, oferind un spectacol natural deosebit în orice anotimp, dar mai ales toamna, când mii de cocori poposesc aici în drumul lor spre sud.",
      en: "Szeged White Lake (Fehér-tó) is the largest saline lake system in Hungary and a significant landmark on European bird migration routes. Located north of the city of Szeged and part of the Kiskunság National Park, it was originally a natural alkali lake that frequently dried out in summer. In the 20th century, it was transformed into a complex fishpond system, but it has maintained its immense ecological value. It is an internationally famous bird reserve, serving as one of the most important autumn stopovers for migratory birds, particularly cranes—during this time, the calls of tens of thousands of birds can be heard over the lake. Salt precipitation still colors the shores white during dry periods, giving the lake its name. Visitors can explore this unique wetland habitat via the 'Sirály' (Gull) nature trail and several birdwatching towers."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Are o suprafață totală de aproximativ 14 kilometri pătrați.", "Este prima rezervație ornitologică din Ungaria, protejată din 1939.", "Găzduiește peste 280 de specii de păsări identificate de cercetători.", "În timpul migrației de toamnă, aici se pot aduna până la 50.000 de cocori.", "Face parte din rețeaua internațională a zonelor umede Ramsar.", "Traseul didactic 'Sirály' (Pescărușul) oferă puncte de observație strategice.", "Sistemul de iazuri este alimentat cu apă din râul Tisa prin canale.", "Este un sit important pentru studiul plantelor halofile (iubitoare de sare)."],
      en: ["The lake system covers an area of approximately 14 square kilometers.", "Protected as a nature reserve since 1939.", "Up to 50,000 cranes may rest here during autumn migration.", "Produces hundreds of tons of high-quality carp annually.", "Home to the rare and protected succulent 'Lepidium crassifolium'.", "Includes several birdwatching cabins along the 'Sirály' nature trail.", "Part of the Pusztaszer Landscape Protection Area.", "Features one of Hungary's oldest fishery research stations."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Gura de vărsare a Mureșului în Tisa, situată în apropierea orașului Szeged, este un punct geografic fascinant unde apele celor două râuri se întâlnesc și se contopesc. Mureșul, venind din Carpații Orientali, aduce cu sine cantități mari de sedimente și nisip fin, creând bancuri spectaculoase care se modifică constant sub acțiunea curentului. Fenomenul de confluență este vizibil prin diferența de culoare dintre apele 'blonde' ale Tisei și cele mai tulburi ale Mureșului. Zona este înconjurată de păduri de luncă dese, care funcționează ca un coridor ecologic esențial pentru fauna sălbatică a Câmpiei Panonice. Pentru locuitorii din Szeged, acest loc reprezintă o destinație populară de recreere, oferind o atmosferă aproape mediteraneeană pe timpul verii, când plajele de nisip devin accesibile.",
      en: "The Mures Confluence (Maros-torkolat) near Szeged is a location of significant geographical and ecological importance. The Mures River, originating in the Eastern Carpathians, carries vast amounts of sand and sediment from the mountains, leading to constant changes in the shoreline at the confluence. The meeting of the 'blonde' Tisza and the darker, sediment-rich Mures creates a fascinating color contrast in the water before they fully merge. The area is surrounded by dense, primeval-like floodplain forests that serve as a vital ecological corridor for wildlife. For the residents of Szeged, the confluence is a favorite excursion destination, especially in summer when the river's sandbanks create a beach-like atmosphere and a popular free public beach (Lapos) operates on the Szeged side."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Mureșul este cel mai lung afluent al Tisei, cu un curs total de 749 km.", "Confluența este situată la nord-est de centrul istoric al orașului Szeged.", "Sedimentele aduse de Mureș au fost istoric folosite ca material de construcție.", "Pădurile de luncă de aici adăpostesc specia rară de gaia brună.", "Zona este un loc important de reproducere pentru cegă și alte specii de pești.", "Plaja 'Lapos' din apropiere este cea mai populară plajă fluvială din regiune.", "Fenomenul 'înfloririi Tisei' (eclozarea rusalca) este foarte vizibil în această zonă.", "Istoric, gura de vărsare a fost un punct cheie pentru transportul sării din Transilvania."],
      en: ["The Mures is the most significant tributary of the Tisza (749 km total length).", "The confluence is situated northeast of Szeged's city center.", "Extensive sand islands form at the mouth during low water levels.", "Protected under the Körös-Maros National Park.", "The rare black kite nests in the riverside willow groves.", "A major site for the famous 'Tisza blooming' mayfly phenomenon.", "The colors of the two rivers remain visibly separate at the meeting point.", "The 'Lapos' beach is a popular summer recreation spot nearby."]
    }, image: "/poi-images/river-maros-torkolat-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Lacul Csaj este un sistem vast de iazuri piscicole situat în inima zonei de protecție a peisajului Pusztaszer, fiind rezultatul reabilitării vechilor mlaștini de-a lungul Tisei. Acest complex, format din mai multe bazine separate prin diguri, a devenit unul dintre cele mai importante centre ornitologice din sudul Ungariei. Diversitatea adâncimilor apei atrage o varietate incredibilă de specii, de la stârci și lopătari până la numeroase tipuri de rațe sălbatice. Administrarea lacului îmbină în mod armonios activitățile de piscicultură tradițională cu obiectivele stricte de conservare a naturii, oferind un model de dezvoltare durabilă. Proximitatea față de Parcul Memorial Național Ópusztaszer face ca vizitarea lacului să fie o completare ideală pentru turiștii interesați de istoria și natura regiunii.",
      en: "Lake Csaj is an extensive fishpond system in the heart of the Pusztaszer Landscape Protection Area, resulting from the rehabilitation of former marshlands along the Tisza river. This multi-basin system, separated by levees, has become one of the most important ornithological centers in the southern Great Plain. It is particularly famous for its large colonies of spoonbills, great white egrets, and various duck species. While the ponds are economically significant for fish production, nature conservation goals remain the priority. Guided tours are available for visitors to explore the area, where birdwatching towers allow for the undisturbed observation of the aquatic world. Its proximity to the Ópusztaszer National Heritage Park makes it easy to combine cultural and natural exploration."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Sistemul de iazuri acoperă o suprafață totală de aproximativ 800 de hectare.", "Este un sit de importanță comunitară în cadrul rețelei europene Natura 2000.", "Adăpostește una dintre cele mai mari colonii de stârci de noapte din regiune.", "Iazurile au fost amenajate în forma lor actuală în anii 1960.", "Există platforme speciale de observație pentru fotografii de natură.", "Apa este împrospătată prin canale care fac legătura directă cu râul Tisa.", "Flora include specii protejate precum stânjenelul galben de mlaștină.", "Toamna, mii de păsări limicole se hrănesc în bazinele parțial secate."],
      en: ["The total area of the pond system is approximately 800 hectares.", "Recognized as a site of major importance within the Natura 2000 network.", "Home to the largest breeding population of black-crowned night herons in the region.", "The ponds were developed for fishery purposes in the 1960s.", "Several high stands and specialized hides assist in bird photography.", "Replenished with fresh, oxygenated water from the Tisza Canal.", "The protected yellow iris blooms in abundance along the shores.", "Thousands of wading birds feed in the drained basins during autumn."]
    }, image: "/poi-images/lake-csaj-to-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Brațul mort Mártély al Tisei este unul dintre cele mai pitorești și încărcate de istorie culturală locuri din sud-estul Ungariei. Format în urma lucrărilor de regularizare a cursului Tisei din secolul al XIX-lea, acest meandru părăsit a devenit un sanctuar al naturii și o sursă de inspirație constantă pentru artiști. Sălciile bătrâne ale căror ramuri ating luciul apei și lumina specifică a câmpiei au fost imortalizate de numeroși pictori din celebra Școală de la Alföld. Astăzi, Mártély este o zonă de recreere recunoscută oficial, oferind un mix echilibrat între relaxarea pe plaja amenajată și explorarea traseelor educative care șerpuiesc prin pădurea de luncă. Este un loc unde liniștea este întreruptă doar de cântecul păsărilor, oferind o experiență autentică a peisajului fluvial maghiar.",
      en: "The Martély Dead-Tisza is one of the most picturesque oxbow lakes of the river in Csongrád-Csanád County, separated from the main bed during the 19th-century regulations. This crescent-shaped oxbow and its surroundings are now a landscape protection area with unique aesthetic and ecological value. Its banks are lined with century-old willows and poplars, a sight that has attracted generations of artists, particularly those of the 'Great Plain school' of painters. Today, Mártély is a popular resort destination featuring a public beach, nature trails, and camping facilities. The water is shallow and warms up slowly, making it ideal for swimming and water sports, while its reed beds hide a rich birdlife and a significant fish population for angling."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Mártély a fost prima zonă din Ungaria declarată peisaj protejat, în 1971.", "Brațul mort are o formă de potcoavă și o lungime de circa 4,5 kilometri.", "Este strâns legat de numele pictorului János Tornyai, care a activat aici.", "Un traseu didactic de 2,6 km pe pasarele de lemn traversează zona mlăștinoasă.", "Planta acvatică protejată sulițelul (Trapa natans) înflorește aici abundent vara.", "Zona reprezintă un habitat crucial pentru castori și vidre de-a lungul Tisei.", "Există un turn de observație din lemn care oferă o panoramă asupra întregului braț.", "Calitatea apei de pe plaja publică este monitorizată și catalogată frecvent ca excelentă."],
      en: ["The length of the Mártély oxbow is approximately 4.5 kilometers.", "Established as Hungary's first landscape protection area in 1971.", "The landscape was made nationally famous by the painter János Tornyai.", "Includes a 2.6-kilometer nature trail on wooden boardwalks through the marsh.", "The protected water chestnut (Trapa natans) blooms massively in the shallows.", "Key habitat for beavers and otters along the Tisza region.", "The public beach's water quality regularly receives excellent ratings.", "Home to one of the country's oldest nature conservation camps."]
    }, image: "/poi-images/river-tisza-martely-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Pădurea Pusztaszer reprezintă o oază de verdeață vitală în peisajul de stepă, adesea lipsit de arbori, la nord de Szeged. Face parte integrantă din Rezervația Naturală Pusztaszer și este compusă dintr-un amestec de resturi ale pădurilor de luncă originale și plantații de stejar și salcâm realizate pe crestele nisipoase. Această pădure joacă un rol central în reglarea microclimatului local, oferind protecție împotriva vânturilor puternice caracteristice marii câmpii. Fauna este extrem de bogată, pădurea fiind cunoscută ca loc de cuibărire pentru păsări răpitoare maiestuoase, cum ar fi acvila de câmp și gaia neagră. Rețeaua extinsă de poteci permite vizitatorilor să exploreze diversele tipuri de habitate și să se bucure de răcoarea oferită de coronamentul bogat în zilele toride de vară.",
      en: "The Pusztaszeri Forest is a defining green island in the otherwise tree-sparse steppe landscape north of Szeged, protected as part of the Pusztaszer Landscape Protection Area. The forest is of mixed composition: it contains remnants of native floodplain hardwood groves as well as oaks and acacias planted on the sandy ridges. This forest block is crucial for regulating the regional microclimate and providing protection against the wind on the open plains of the Great Plain. The crown jewels of its rich wildlife are the birds of prey, including the imperial eagle and the black kite, which find safe nesting sites here. Hiking trails weave through the area, connecting the forest with the Tisza bank and the nearby historical memorial park, offering opportunities for nature-based recreation."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Nucleul central al pădurii acoperă o suprafață compactă de circa 1.000 de hectare.", "Face parte dintr-o zonă protejată mai largă ce însumează peste 22.000 de hectare.", "Este un loc de cuibărire pentru specii strict protejate precum șoimul dunărean.", "La marginea pădurii se pot observa semne istorice ale granițelor de la descălecat.", "Constituie un domeniu de vânătoare important, cu populații mari de căprioare.", "Flora include specii rare precum stânjenelul siberian și degețelul lânos.", "O secțiune a traseului național 'Blue Trail' traversează inima acestei păduri.", "Primăvara, solul pădurii este acoperit de flori de dedițel și dedițelul de munte."],
      en: ["The core area of the forest covers approximately 1,000 hectares.", "An integral part of the 22,000-hectare Pusztaszer Landscape Protection Area.", "Nesting site for the strictly protected imperial eagle and saker falcon.", "Historical Hungarian border markers from the settlement era are visible at the edge.", "Important hunting ground with significant deer and wild boar populations.", "The rare desert checkered butterfly thrives on the sandy soil.", "A section of the Great Plain Blue Trail passes through the forest.", "Spring Adonis and pasqueflowers decorate the forest floor in spring."]
  ...
  // HU-FE: Fejér
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Canalul Sárvíz este un sistem hidrotehnic de o importanță majoră care traversează județul Fejér din centrul Ungariei. Inițial, această regiune era o mlaștină vastă și inaccesibilă, care a fost transformată în teren agricol fertil prin lucrări de drenaj ambițioase începute în secolul al XIX-lea. Astăzi, canalul servește în principal la evacuarea apelor excedentare și la reglarea nivelului freatic pentru agricultura intensivă. De-a lungul cursului său s-au dezvoltat biotopuri secundare valoroase, oferind refugiu multor specii de pești și păsări de apă. Valea Sárvíz este cunoscută și pentru vestigiile sale arheologice ce datează din epoca romană, când cursurile de apă din zonă erau deja utilizate strategic. Pentru iubitorii de natură, canalul oferă orizonturi largi și liniștea specifică câmpiei ungare, întreruptă doar de strigătul stârcilor.",
    ...
    factsAdvanced: {
      ...
      ro: ["Canalul are o lungime de aproximativ 100 de kilometri prin Câmpia Fejér.", "Drenarea mlaștinilor Sárvíz a fost unul dintre cele mai mari proiecte de ameliorare din secolul al XIX-lea.", "Cursul canalului urmează o linie de fractură tectonică a scoarței terestre.", "Joacă un rol crucial în protecția localităților adiacente împotriva inundațiilor.", "În stufărișurile de pe maluri cuibărește stârcul roșu și buhaiul de baltă.", "Calitatea apei este monitorizată constant pentru protejarea populațiilor de crap și știucă.", "În epoca romană, un drum comercial important trecea de-a lungul văii Sárvíz.", "Drumul de serviciu de pe mal este utilizat frecvent ca traseu de cicloturism."],
      en: ["The total length of the canal is nearly 100 kilometers.", "Draining the marshes was one of the largest investments of the 19th century.", "The canal bed follows a geological fault line on the plain.", "Plays a vital role in the flood protection system of Fejér County.", "The protected Great Bittern and Purple Heron nest in its reed beds.", "Water quality is continuously monitored to protect fish populations.", "An important trade route ran along the Sárvíz during the Roman era.", "The service road along the canal is popular among cyclists."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Pârâul Gaja este, fără îndoială, unul dintre cele mai romantice și spectaculoase cursuri de apă din munții Bakony. Pe parcursul drumului său prin partea estică a masivului, a săpat de-a lungul mileniilor un defileu adânc și sinuos în calcar, cunoscut astăzi sub numele de Valea Gaja. Secțiunea dintre Bodajk și Fehérvárcsurgó este deosebit de impresionantă, cu pereți stâncoși abrupți și păduri de foioase dense care creează un cadru aproape alpin. Apa limpede a pârâului formează mici cascade și ochiuri de apă liniștite, oferind o răcoare binevenită pe timpul verii. Valea nu este doar un paradis al drumeților, ci și un loc plin de legende despre haiduci celebri precum Sobri Jóska. Combinația de diversitate geologică, floră rară și atmosferă mistică face din pârâul Gaja o destinație esențială în Ungaria de Vest.",
    ...
    factsAdvanced: {
      ...
      ro: ["Izvorăște în centrul munților Bakony și se varsă ulterior în canalul Sárvíz.", "Găzduiește spectaculoasa cascadă 'Baia Romană' (Római fürdő) de lângă Bakonynána.", "Peștera legendarului haiduc Sobri Jóska se află în pereții de stâncă de deasupra apei.", "Valea este o rezervație naturală protejada, adăpostind specii rare de ferigi.", "O secțiune a Traseului Albastru Național maghiar urmărește cursul pârâului.", "În perioada medievală, apele sale alimentau numeroase mori de cereale în regiune.", "Pârâul alimentează rezervorul Fehérvárcsurgó, important pentru controlul inundațiilor.", "Flora văii este dominată de fagi și frasini monumentali, spectaculoși toamna."],
      en: ["The brook originates near Velemér in the central part of the Bakony.", "The Gaja Valley Landscape Center is one of the country's most beautiful hiking spots.", "Features the spectacular 'Roman Bath' waterfall at Bakonynána.", "Home to the legendary Sobri Jóska Cave within the cliffs.", "The brook feeds the Fehérvárcsurgó reservoir at the foot of the mountains.", "Rare fern species occur in the valley's flora.", "The National Blue Trail passes through the entire protected area.", "Water quality is excellent, supporting a population of brown trout."]
    }, image: "/poi-images/river-gaja-patak-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Alcsúti Arborétum Magyarország egyik legjelentősebb és legszebb tájképi kertje, amely Fejér vármegye szívében, a Habsburgok egykori uradalmi központjában található. József nádor alapította 1820-ban, aki a kor híres kertépítőjével, Tost Károllyal közösen alakította ki ezt a botanikai remekművet. A kert központi látványossága az egykori klasszicista kastély monumentális portikusza, amely egy 1944-es tűzvész után is büszkén hirdeti a múlt dicsőségét. Az arborétum több mint 40 hektáron terül el, és több mint 540 fa- és cserjefajnak ad otthont, köztük évszázados mocsárciprusoknak és libanoni cédrusoknak. Különleges vonzereje a kora tavaszi hóvirágünnep, amikor hatalmas fehér virágszőnyeg borítja a parkot, valamint a nyári szentjánosbogár-rajzás, amely varázslatos esti látványt nyújt. Földrajz K7 – Magyarország védett természeti értékei és a kultúrtáj védelme.",
      ro: "Arboretumul de la Alcsút este o bijuterie a artei grădinăritului maghiar și unul dintre cele mai importante monumente de peisagistică din perioada clasicistă. Fondat în anii 1820 de arhiducele Iosif, Palatinul Ungariei, acesta a fost conceput ca o grădină englezească de clasă mondială. Pe o suprafață de peste 40 de hectare, vizitatorii pot admira o colecție impresionantă de peste 540 de specii de arbori și arbuști, inclusiv platani gigantici și conifere rare. Un punct culminant este sărbătoarea ghiocelului, care are loc la începutul primăverii, când milioane de flori albe acoperă solul pădurii. Atmosfera romantică este amplificată de ruinele fostului castel al familiei Habsburg, din care a mai rămas doar fațada principală după un incendiu din Al Doilea Război Mondial. Este un loc de liniște și inspirație, îmbinând istoria cu botanica.",
      en: "The Alcsút Arboretum is one of Hungary's most significant and beautiful landscape gardens, located in the heart of Fejér County in the former estate center of the Habsburgs. It was founded in 1820 by Archduke Joseph, the Palatine of Hungary, who created this botanical masterpiece together with the famous garden designer of the era, Károly Tost. The central attraction of the garden is the monumental portico of the former Neoclassical castle, which proudly proclaims past glory even after a 1944 fire. The arboretum spans over 40 hectares and is home to more than 540 species of trees and shrubs, including century-old swamp cypresses and Lebanon cedars. Special attractions include the early spring snowdrop festival and the summer firefly swarming, providing a magical evening sight."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["A fost amenajat sub îndrumarea grădinarului curții, Károly Tost, după planurile arhiducelui.", "Adăpostește una dintre cele mai vechi alei de platani din Ungaria, plantați la fondare.", "Fațada castelului este opera celebrului arhitect Mihály Pollack.", "În parc se află o capelă mică și o casă de păpuși istorică a copiilor arhiducali.", "Câmpul de ghiocei include șapte specii diferite, fiind cel mai mare din țară.", "Este clasificat ca rezervație naturală de importanță națională.", "Un sistem de iazuri și un pârâu în interiorul parcului reglează microclimatul local.", "Arboretumul servește astăzi ca loc de cercetare pentru studii dendrologice."],
      en: ["Founded in 1820 by Archduke Joseph as one of the country's first arboretums.", "Preserves over 540 different species of trees and shrubs from around the world.", "Features Hungary's largest continuous 2.5-hectare snowdrop field.", "Designed by renowned garden artists, including Károly Tost of Schönbrunn.", "Castle remains are masterpieces of Mihály Pollack's Neoclassical architecture.", "The chapel in the garden was built in Neo-Romanesque style by Ferenc Storno.", "One of its oldest inhabitants is a Lebanon cedar over 170 years old.", "The park's microclimate is regulated by its own lake system."]
    }, image: "/poi-images/forest-alcsuti-arboretum-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Vértes-hegység déli lankáin, Csákvár közelében emelkedő Veres-hegy a hegység egyik legizgalmasabb geológiai és botanikai pontja. A hegy neve a naplementében vöröslő dolomitsziklákra és az ősszel élénk színekben pompázó cserszömörcére utal, amely a vidék egyik jellegzetes növénye. A terület a Vértes 'szubmediterrán' arcát mutatja be, ahol a kopár dolomit sziklagyepek és a karsztbokorerdők különleges élőhelyet biztosítanak ritka orchideafajoknak és hüllőknek. A csúcsról és a környező bércekről pazar kilátás nyílik a Zámolyi-medencére és a Velencei-hegység távoli vonulataira. A hegy lábánál futó Haraszt-hegyi tanösvény interaktív módon mutatja be a környék kialakulását és a kőzetrétegek titkait, így a természetjárók és a geológia iránt érdeklődők számára is tökéletes célpont. Földrajz K6 – a középhegységek felépítése és a karsztjelenségek.",
      ro: "Muntele Veres (Muntele Roșu) este o ridicătură proeminentă în masivul Vértes, remarcându-se prin constituția sa geologică și panorama vastă pe care o oferă. Situat lângă localitatea Csákvár, muntele se înalță deasupra Câmpiei Zámolyi, oferind drumeților unul dintre cele mai frumoase puncte de belvedere din regiune. Numele său provine de la culoarea roșiatică a solului și a stâncilor, cauzată pe alocuri de prezența bauxitei și a unor minerale specifice. Vegetația este tipică pentru munții Vértes, fiind un mozaic de tufișuri carstice sub-mediteraneene, păduri de stejar pufos și pajiști pe stânci de dolomit. Această diversitate face din munte un habitat valoros pentru insecte rare și păsări protejate. Urcarea este moderată, dar extrem de satisfăcătoare, vârful permițând o vedere circulară până la culmile îndepărtate ale munților Bakony.",
      en: "Rising on the southern slopes of the Vértes Mountains near Csákvár, Veres Hill is one of the most exciting geological and botanical points of the range. The mountain's name refers to the dolomite rocks reddening in the sunset and the smoketree (Cotinus coggygria) that turns vivid colors in autumn, a characteristic plant of the region. The area showcases the 'sub-Mediterranean' face of the Vértes, where barren dolomite rock grasslands and karst brush forests provide unique habitats for rare orchid species and reptiles. Breathtaking views open from the summit and surrounding peaks over the Zámolyi Basin and the distant ranges of the Velence Hills. The Haraszt Hill nature trail at the foot of the mountain interactively presents the area's formation and geological secrets."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Este compus în principal din dolomit triasic, care formează structuri carstice specifice.", "În apropiere se află foste mine de bauxită, transformate parțial în trasee didactice.", "Flora include specii rare precum orhideea Himantoglossum adriaticum.", "În zilele senine, de pe vârf se poate distinge silueta cetății Csókakő la orizont.", "Face parte din Rezervația Naturală Vértes, având reguli stricte de protecție.", "Este cunoscut pentru curenții de aer calzi ascendenți, preferați de păsările răpitoare.", "Descoperirile arheologice din zonă atestă prezența umană încă din epoca pietrei.", "Un traseu marcat pleacă din Csákvár și duce direct pe platoul înalt al muntelui."],
      en: ["Veres Hill is located in the southern Vértes, with an elevation of about 350 meters.", "Named after the color of the dolomite rocks and the red smoketree in autumn.", "Home to rare sub-Mediterranean plant communities and karst brush forests.", "The Velence Hills and Lake Balaton ranges are visible on clear days.", "One of Hungary's largest gypsum caves is located in nearby Csákvár.", "Part of the Duna-Ipoly National Park and a highly protected natural value.", "Formerly an important bauxite mining center, it is now a geological park.", "The gravelly, dolomitic soil of the hiking trails can be very slippery when wet."]
    }, image: "/poi-images/mountain-veres-hegy-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Fejér vármegyei Pázmánd határában elterülő Pázmándi-tó egy festői völgyzárógátas víztározó, amely a Velencei-hegység keleti lábánál fekszik. A tavat a Pázmándi-vízfolyás táplálja, és bár eredetileg mezőgazdasági és árvízvédelmi célokkal hozták létre, mára a régió egyik legkedveltebb horgász- és pihenőhelyévé vált. A vízfelületet nádasok és gondosan karbantartott partvonal övezi, ahol a látogatók csendes, zavartalan környezetben élvezhetik a természet közelségét. A tó gazdag halállománya, különösen a ponty és az amur, messziről vonzza a sporthorgászokat, miközben a környék lankás dombjai kiváló túrázási lehetőségeket kínálnak a híres pázmándi kvarcit-sziklákhoz. A tó vize fontos szerepet játszik a helyi ökoszisztéma fenntartásában és a talajvíz szabályozásában a szárazabb időszakokban is. Földrajz K5 – síksági és dombsági vízrendszerek, mesterséges tavak szerepe.",
      ro: "Lacul Pázmánd este o bijuterie naturală ascunsă la marginea nord-estică a munților Velence. Acest lac mic și idilic este mult mai puțin cunoscut decât vecinul său mai mare, lacul Velence, oferind în schimb o liniște și o autenticitate rar întâlnite în centrele turistice aglomerate. Situat într-un peisaj de dealuri line, lacul este înconjurat de stufărișuri dese și sălcii bătrâne. Deși servește în principal ca bazin de pescuit și zonă de agrement locală, a devenit de-a lungul anilor un biotop important pentru păsările acvatice și amfibieni. Împrejurimile localității Pázmánd sunt renumite și pentru formațiunile bizare din granit și cramele istorice, ceea ce face ca o excursie la lac să fie completată perfect de o plimbare culturală. Lumina blândă a serii și susurul apei transformă acest loc într-un spațiu ideal pentru relaxare.",
      en: "Lake Pázmánd, situated on the edge of the village of Pázmánd in Fejér County, is a picturesque reservoir located at the eastern foot of the Velence Hills. The lake is fed by the Pázmándi stream, and while originally created for agricultural and flood protection purposes, it has become one of the region's most popular fishing and recreation spots. The water surface is bordered by reed beds and a carefully maintained shoreline where visitors can enjoy nature in a quiet, undisturbed environment. The lake's rich fish population, especially carp and grass carp, attracts sport anglers from afar, while the surrounding gentle hills offer excellent hiking opportunities to the famous Pázmánd quartzite rocks. The water plays an important role in maintaining the local ecosystem and groundwater regulation even during drier periods."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Lacul este alimentat în principal de ape de suprafață și izvoare locale din dealurile de granit.", "Pázmánd este faimos pentru 'Pietrele mișcătoare' (Ingókövek) situate la mică distanță.", "Populația de pești a lacului include crapi, amuri și diverse specii de pești albi.", "Zona este un punct de popas pentru păsări migratoare precum stârcul cenușiu.", "Calitatea apei este considerată excelentă, susținând o floră acvatică diversă.", "Anual se organizează competiții locale de pescuit cu o tradiție îndelungată în sat.", "Geologia zonei este marcată de granit vechi de 300 de milioane de ani, o raritate în Ungaria.", "De pe mal se deschide o vedere superbă spre dealul Pázmándi și capela sa caracteristică."],
      en: ["Lake Pázmánd is an artificially created valley reservoir in Fejér County.", "The water surface area is about 3-4 hectares, with an average depth of 1.5-2.5 meters.", "Fed by fresh water from the Pázmándi stream flowing from the Velence Hills.", "Famous for its rich carp and grass carp stock, and also home to predatory fish.", "Equipped with fireplaces and rest benches for hikers along the shore.", "Adjacent to the unique geological formation known as the 'Ingókövek' (Wiggle Stones).", "Located at the edge of Pázmánd village, accessible in minutes from the M7 motorway.", "Provides an important habitat for local water birds and amphibians."]
  ...
  // HU-GS: Győr-Moson-Sopron
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hanság, vagy népi nevén a Hany, Magyarország északnyugati részén elterülő hatalmas lápos, mocsaras terület, amely egykor a Kisalföld legvadregényesebb tája volt. Az évszázadokig áthatolhatatlan mocsárvilágot a 18. századtól kezdődően csatornázással és lecsapolással próbálták megszelídíteni, ami radikálisan átalakította a táj képét. Ma a Fertő–Hanság Nemzeti Park részeként a terület egyedülálló biodiverzitást őriz: égerlápok, nedves rétek és ritka állatfajok, mint a parlagi sas vagy a túzok otthona. A Hanság legendákkal is átszőtt, legismertebb alakja Hany Istók, a mocsárban talált 'víziember', akinek története generációk óta foglalkoztatja az embereket. A vidék ma fontos ökológiai folyosó és a fenntartható tájgazdálkodás mintaterülete, ahol a látogatók tanösvényeken ismerhetik meg a lápi világ rejtett kincseit. Földrajz K8 – mocsarak lecsapolása, tájátalakítás és természetvédelem.",
      ro: "Hanság este unul dintre cele mai misterioase și pline de legende peisaje din Ungaria de Vest. Inițial o mlaștină imensă și aproape inaccesibilă care lega lacul Neusiedl de Dunăre, zona a fost drenată în mare parte în secolul al XX-lea. Astăzi, Hanság este un mozaic de canale, pajiști umede, mici păduri de arini și turbării reinundate, formând o parte importantă a Parcului Național Fertő-Hanság. Regiunea este celebră pentru folclorul său bogat și ca ultim refugiu pentru specii rare precum țiparul de noroi sau dropia. Jocurile de lumină peste canalele largi și liniștea absolută conferă acestui loc o frumusețe aproape melancolică. Vizitatorii pot explora zona prin observarea păsărilor sau prin trasee lungi de ciclism pe fostele diguri ale canalelor, unde se poate simți efortul naturii de a recuceri teritoriul.",
    ...
    factsAdvanced: {
      ...
      hu: ["A Hanság a Kisalföld mélyebb fekvésű, egykor összefüggő mocsárvidéke volt.", "Neve a 'hany' szóból ered, ami lápos, ingoványos területet jelent.", "A Fertő–Hanság Nemzeti Park része, 1991 óta áll nemzetközi védelem alatt.", "Itt él Magyarország egyik legjelentősebb túzokállománya a háborítatlan réteken.", "A Hanság-főcsatorna építése a 18. század végén kezdődött a terület lecsapolására.", "A monda szerint Hany Istókot, a vadóc fiút 1749-ben találták meg a halászok a lápban.", "A táj ma mozaikos szerkezetű: égererdők, sásrétek és szántóföldek váltják egymást.", "A terület madárvilága kiemelkedő, több mint 200 fészkelő és vonuló fajt figyeltek meg."],
      ro: ["Hanság este împărțit istoric în două zone principale: Kapuvári Hany și Lébényi Hany.", "În trecut, mlaștina putea fi traversată doar cu încălțări speciale sau bărci cu fund plat.", "Găzduiește una dintre cele mai importante populații de dropie, cea mai grea pasăre zburătoare din Europa.", "Legenda lui Hany Istók, un 'om al apei' găsit în mlaștină în 1749, este adânc înrădăcinată aici.", "Reinundarea fostelor zone de extracție a turbei a readus numeroase păsări acvatice rare.", "Canalele adăpostesc specii de pești protejate precum mihalțul și boișteanul.", "Centrul de informare din Öntésmajor oferă detalii despre istoria drenării mlaștinii.", "Joacă un rol vital ca și coridor ecologic transfrontalier între Ungaria și Austria."],
      en: ["The Hanság was a low-lying, once-contiguous marshland of the Little Plain.", "The name comes from the word 'hany,' meaning marshy, swampy area.", "Part of the Fertő-Hanság National Park, under international protection since 1991.", "Home to one of Hungary's most significant great bustard populations.", "Construction of the Hanság Main Canal began in the late 18th century for drainage.", "Legend says Hany Istók, a wild boy, was found by fishermen in the marsh in 1749.", "The landscape is now mosaic-like: alder forests, sedge meadows, and arable fields.", "Over 200 nesting and migratory bird species have been observed here."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Rábca folyó a Kisalföld egyik meghatározó vízfolyása, amely a Répce és a Kis-Rába egyesüléséből születik a Hanság területén. A folyó útja során keresztülvág a síkságon, és végül Győr városánál torkollik a Mosoni-Dunába, fontos szerepet játszva a régió hidrológiájában. Története szorosan kapcsolódik a Hanság mocsárvilágának lecsapolásához, hiszen a folyó medrét többször is szabályozták, hogy elvezesse a felesleges belvizeket a lápos területekről. A Rábca ma kedvelt célpontja a vízitúrázóknak és a horgászoknak, köszönhetően lassú folyásának és a part menti gazdag növényzetnek, amely menedéket nyújt a vízi élővilágnak. Győri szakasza különösen érdekes, hiszen a város építésekor a folyó eredeti medrét elterelték, helyén ma parkok és sétányok találhatók, emlékeztetve a folyó és a város évszázados kapcsolatára. Földrajz K7 – folyószabályozás, torkolatvidékek és városi vízgazdálkodás.",
      ro: "Rábca este un râu caracteristic regiunii Transdanubia, colectând apele din extremitatea nordică a Hanságului și vărsându-se în Dunărea de la Moson. Cursul său traversează peisajul plat și fertil al regiunii Rábaköz, șerpuind leneș în numeroase meandre. Din punct de vedere istoric, Rábca a fost esențial pentru drenarea mlaștinilor Hanság, motiv pentru care albia sa a fost canalizată în multe secțiuni. Cu toate acestea, râul și-a păstrat farmecul natural în multe locuri, fiind mărginit de zăvoaie dese de sălcii și stuf. Pentru pescari, Rábca este un loc secret, fiind renumit pentru liniștea și bogăția sa piscicolă. Gura de vărsare de la Győr reprezintă un punct hidrotehnic major, unde râul contribuie la peisajul urban al orașului, oferind un spațiu de relaxare la granița dintre natură și arhitectură.",
      en: "The Rábca River is a defining watercourse of the Little Plain, born from the confluence of the Répce and Kis-Rába rivers in the Hanság area. During its journey, the river cuts through the plain and finally joins the Moson Danube at the city of Győr, playing an important role in the region's hydrology. Its history is closely linked to the drainage of the Hanság marshlands, as the riverbed was regulated multiple times to carry away excess inland waters. Today, the Rábca is a popular destination for water tourists and anglers, thanks to its slow current and rich riverside vegetation that provides sanctuary for aquatic life. Its Győr section is particularly interesting; during the city's construction, the original bed was diverted, and parks and promenades now stand in its place, recalling the centuries-old connection between the river and the city."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Rábca se formează din confluența râurilor Répce și Ikva în bazinul Hanság.", "Râul are o lungime totală de aproximativ 50 de kilometri până la vărsarea în Győr.", "Servește ca emisar principal pentru un sistem vast de canale de drenaj.", "În secțiunile liniștite înfloresc vara nuferi galbeni și nuferi albi de baltă.", "Fauna piscicolă include specii precum știuca, șalăul și avatul.", "Istoric, nivelul râului depindea puternic de fluctuațiile lacului Neusiedl.", "Numeroase cuiburi de barză pot fi găsite în satele adiacente râului.", "Digurile de protecție împotriva inundațiilor sunt folosite astăzi ca piste de biciclete."],
      en: ["The Rábca is formed by the confluence of the Répce and Kis-Rába in the Hanság.", "Total length is approximately 50-60 kilometers including regulated sections.", "The river is the main drain for the Hanság marshland; its bed is almost entirely channeled.", "Several important bridges span the mouth of the Rábca in the city of Győr.", "In the early 20th century, the river mouth was relocated to protect the city from floods.", "Rich in fish, it is a favorite spot for those angling for bream and zander.", "Average discharge is 15-20 m³/s, but it can swell significantly during snowmelt.", "Significant floodplain forests and reed beds remain along its banks as Natura 2000 sites."]
    }, image: "/poi-images/river-rabca-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Marcal folyó a Bakony délnyugati lábánál eredő, a Kisalföld síkságán végigkanyargó jelentős vízfolyás, amely a Rába folyó egyik legfontosabb mellékvize. Völgye, a Marcal-medence, különleges átmeneti táj a hegyvidék és az alföld között, ahol a folyó lassú folyásával és széles árterével határozza meg a környező települések életét. A folyó történetének egyik legtragikusabb pontja a 2010-es vörösiszap-katasztrófa volt, amely során a Torna-patakon keresztül beömlő lúgos anyag szinte a teljes élővilágot elpusztította. Azóta azonban a természet és a tudatos emberi beavatkozás révén a Marcal látványos regeneráción ment keresztül, és ma ismét fontos horgászvíz és ökológiai folyosó. A folyó menti rétek és legelők hagyományosan az állattenyésztés központjai, a völgy panorámáját pedig a távoli tanúhegyek, mint a Somló és a Ság-hegy sziluettje teszi teljessé. Földrajz K8 – környezeti katasztrófák, folyó-rehabilitáció és tájegységek találkozása.",
      ro: "Marcal este un afluent de dreapta important al râului Rába, izvorând din sudul munților Bakony și traversând câmpia fertilă a Micului Alföld. Cursul său este marcat de o atmosferă liniștită, aproape contemplativă, străbătând pajiști largi și sate pitorești. Râul a devenit faimos în mod tragic după catastrofa noroiului roșu din 2010, când ecosistemul său a fost grav afectat. Totuși, măsurile intensive de renaturare care au urmat au dus la un mic miracol: astăzi, Marcal este din nou un râu viu, cu apă curată și o faună piscicolă care a revenit în forță. Malurile sale sunt un paradis pentru observatorii naturii, fiind coridoare de migrație esențiale pentru animalele sălbatice. Peisajul de pe malurile râului Marcal întruchipează reziliența naturii și oferă condiții ideale pentru canotaj și pescuit recreativ.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Izvorăște lângă Sümeg și are o lungime totală de aproximativ 100 de kilometri.", "Formează granița naturală între județele Veszprém, Vas și Győr-Moson-Sopron.", "După 2010, albia râului a fost curățată complet și repopulată cu microorganisme.", "Este cunoscut pentru populațiile de mreană și clean care preferă apele curate.", "De-a lungul râului se află pajiști umede protejate în cadrul rețelei Natura 2000.", "În perioada medievală, râul alimenta numeroase mori de apă strategice.", "Gura de vărsare în Rába, lângă Koroncó, este o destinație populară pentru drumeții.", "În luncile râului cuibăresc specii rare precum cristelul de câmp și becațina comună."],
      en: []
    }, image: "/poi-images/river-marcal-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Répce folyó az Alpokalján, Ausztria területén eredő, majd Magyarországon a Kisalföld síkságába simuló vízfolyás, amely kristálytiszta felső szakaszáról és természeti értékeiről nevezetes. Ausztriában még Rabnitz néven ismert, de a határt átlépve nevét a mentén egykor tömegesen termesztett káposztarepce után kapta. A folyó útja során áthalad a híres fürdőváros, Bük mellett, ahol vize és part menti parkjai a rekreációt szolgálják. A Répce völgye fontos ökológiai kapocs, amely az Alpok és az Alföld flóráját és faunáját köti össze, különleges élőhelyet biztosítva a ritka jégkorszaki maradványnövényeknek és védett halfajoknak. A Hanságba érve a folyó vize a Kis-Rábával egyesülve alkotja meg a Rábcát, így zárva le önálló útját. Szabályozatlanabb szakaszain ma is felfedezhető az ősi folyómenti táj vadsága és szépsége. Földrajz K7 – határmenti folyók, vízgyűjtő területek és az Alpokalja vízrajza.",
      ro: "Répce este un râu mic, dar extrem de valoros din punct de vedere ecologic din nord-vestul Ungariei, începându-și călătoria în Alpii Austrieci (unde este cunoscut sub numele de Rabnitz). După ce trece granița, șerpuiește prin dealurile județului Vas și apoi prin câmpia județului Győr-Moson-Sopron. Répce este renumit pentru secțiunile sale naturale, unde râul are libertatea de a-și modela propria albie. Deosebit de frumoasă este zona din jurul localităților Répcevis și Bük, unde râul traversează păduri de luncă dense. Répce alimentează zone umede importante care funcționează ca rezervoare naturale de apă. În ciuda dimensiunilor sale reduse, joacă un rol crucial pentru microclimatul local și ca habitat pentru numeroase specii protejate. Regiunea oferă o combinație de natură și relaxare, fiind situată aproape de băile termale celebre ale zonei.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Répce parcurge o distanță de aproximativ 55 de kilometri pe teritoriul ungar.", "În perioadele cu debit mare, alimentează sistemul de canale din Hanság.", "Este cunoscut pentru prezența chișcarului de râu, un indicator al calității ridicate a apei.", "Găzduiește unele dintre cele mai bine conservate păduri de arini din regiune.", "Lângă stațiunea Bükfürdő, râul oferă o zonă verde vitală pentru turiști.", "Istoric, râul a marcat limite administrative importante în cadrul Regatului Ungariei.", "Populațiile de pești includ țiparul de noroi și porcușorul de vad.", "Un traseu de biciclete urmărește o mare parte a cursului râului, legând sate istorice."],
      en: []
    }, image: "/poi-images/river-repce-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szigetköz, a Duna 'ajándéka', Magyarország legnagyobb szigete, amelyet a Nagy-Duna és a Mosoni-Duna ölel közre, egyedülálló ártéri erdőrendszert alkotva. Ez a vidék egy óriási hordalékkúp, amelyet a folyó épített évezredek alatt, és ahol ma Európa egyik legszövevényesebb és legváltozatosabb ágrendszere található. A Szigetköz erdői, a fűz-nyár ligeterdők és a tölgy-kőris-szil ligeterdők, különleges mikroklímával rendelkeznek, menedéket nyújtva a hódoknak, vidráknak és a ritka fekete gólyáknak. A terület hidrológiája a bőszi-nagymarosi vízlépcsőrendszer körüli viták óta központi környezetvédelmi téma, de a rehabilitációs munkák révén sikerült megőrizni a táj vadregényes jellegét. A Szigetköz nemcsak természeti kincs, hanem a vízitúrázók paradicsoma is, ahol a labirintusszerű csatornák és holtágak felejthetetlen élményt kínálnak a felfedezőknek. Földrajz K8 – folyami szigetek kialakulása, ártéri erdők és a fenntartható vízgazdálkodás.",
      ro: "Pădurea Szigetköz face parte dintr-un peisaj fluvial unic în nord-vestul Ungariei, cunoscut sub numele de 'Mica Insulă de Grâu'. Această zonă, cuprinsă între Dunărea Mare și Dunărea de la Moson, adăpostește una dintre cele mai mari zone compacte de păduri de luncă din Europa Centrală. Pădurile sunt caracterizate printr-un sistem complex de brațe secundare, insule și canale care susțin o biodiversitate extraordinară. Sălciile argintii gigantice, plopii negri și frasinii formează un coronament dens care protejează numeroase specii rare. Pădurea funcționează ca un filtru natural și regulator pentru sistemul hidrologic al Dunării. Pentru vizitatori, oferă o experiență de tip junglă, explorabilă cel mai bine cu canoea sau prin drumeții pe diguri, într-o atmosferă mistică creată de ceața de deasupra brațelor de râu.",
      en: ""
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Szigetköz este cea mai mare deltă de interior din Europa Centrală (375 km²).", "Peste 200 de specii de păsări trăiesc aici, inclusiv vulturul codalb și barza neagră.", "Găzduiește una dintre cele mai importante populații de castori din Ungaria.", "Sistemul labirintic de peste 300 de brațe secundare este ideal pentru canotaj.", "Din punct de vedere botanic, este renumită pentru orhideele sălbatice și stânjenelul siberian.", "Pădurile servesc ca loc esențial de depunere a icrelor pentru peștii din Dunăre.", "Cea mai mare parte a zonei aparține Rezervației Naturale Szigetköz.", "Tradiția împletirii coșurilor din nuiele de salcie este încă vie în satele din zonă."],
      en: []
  ...
  // HU-HB: Hajdú-Bihar
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Berettyó a Tiszántúl egyik legkarakteresebb folyója, amely a romániai Réz-hegységben ered, majd a magyar határt átlépve kanyarog az Alföld rónaságán. A folyó története elválaszthatatlan a Nagy-Sárrét mocsárvilágától, hiszen a szabályozások előtt a Berettyó vize táplálta ezt a hatalmas és titokzatos vízi birodalmat. Neve ősi magyar eredetű, jelentése 'berekkel szegélyezett folyó', ami ma is híven tükrözi a part menti ligeterdők és bokrosok hangulatát. Bár medre ma már nagyrészt gátak közé szorított, a folyó lassú folyásával, horgászhelyeivel és a mentén fekvő olyan városokkal, mint Berettyóújfalu, fontos kulturális és gazdasági tengelyt alkot. A Berettyó végül Szeghalom közelében egyesül a Sebes-Körössel, vizeivel gazdagítva a Körös-vidék hidrológiai rendszerét és biztosítva az alföldi mezőgazdaság vízellátását. Földrajz K6 – alföldi folyók jellemzői, a Sárrét története és mocsarak átalakítása.",
      ro: "Râul Barcău (Berettyó) este un curs de apă caracteristic regiunii de est a Ungariei, izvorând din Munții Apuseni (Munții Plopiș) din România. Traversând județul Hajdú-Bihar, acesta definește peisajul Câmpiei Bihorului prin cursul său liniștit, aproape lent. Istoric, Barcăul a fost un râu sălbatic și imprevizibil care alimenta mlaștini vaste până la regularizarea sa din secolul al XIX-lea, când a fost canalizat în mare parte. Astăzi, reprezintă o componentă vitală a sistemului regional de management al apelor, fiind folosit pentru irigarea terenurilor agricole fertile. În ciuda canalizării, s-au păstrat biotopuri valoroase de-a lungul malurilor, unde înfloresc plante de luncă tipice. Orașul Berettyóújfalu nu își datorează doar numele acestui râu, ci și importanța sa istorică drept nod comercial regional.",
      en: "The Berettyó is a characteristic river of eastern Hungary, originating in the Apuseni Mountains of Romania and flowing through the Bihar Plain. In Hajdú-Bihar County, it defines the landscape with its slow, almost sluggish current. Historically, the Berettyó was a wild, unpredictable river that fed vast marshlands until it was largely channelized during the major river regulations of the 19th century. Today, it is a vital part of the regional water management system, providing irrigation for fertile fields. Despite the canalization, valuable habitats have been preserved along the river, where typical floodplain plants and numerous fish species thrive. The town of Berettyóújfalu owes not only its name but also its historical significance as a trade hub to the river."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Berettyó teljes hossza 167 kilométer, ebből 79 kilométer esik Magyarországra.", "Neve a finnugor 'bere' (berek) és a 'jó' (folyó) szavak összetételéből ered.", "A folyó vízgyűjtő területe közel 6000 km², forrása 589 méter magasan található.", "A 19. századi szabályozások előtt a folyó vize a hatalmas Sárrét mocsárba veszett.", "Berettyóújfalu a folyó partján fekvő legjelentősebb magyarországi város.", "A folyó vize kedvelt horgászhely, híres a harcsa- és pontyállományáról.", "A Berettyó-csatorna köti össze a folyót a Körösökkel az árvízvédelem érdekében.", "A folyó menti ligetekben számos védett növény- és rovarfaj talál menedéket."],
      ro: ["Are o lungime totală de 167 km, dintre care 78 km pe teritoriul Ungariei.", "Se varsă în Crișul Repede în apropierea orașului Szeghalom.", "Înainte de regularizare, a fost responsabil pentru formarea mlaștinii imense 'Sárrét'.", "În apele sale liniștite se găsesc plante protejate precum sulițelul și nuferii galbeni.", "Fauna piscicolă este bogată în știucă, mreană și rarul țipar de noroi.", "Digurile de pe maluri funcționează astăzi ca rute importante de ciclism.", "Lângă mal, la Berettyóújfalu, se află ruinele mănăstirii medievale Herpály.", "Numele provine probabil din cuvinte maghiare vechi ce înseamnă 'râul mărginit de zăvoi'."],
      en: ["The Berettyó has a total length of 167 kilometers, with 78 km in Hungary.", "The river flows into the Sebes-Körös near the town of Szeghalom.", "Before regulation, it was responsible for the vast 'Sárrét' marshland.", "Protected water chestnut and yellow water-lilies are common in its quiet sections.", "Fish populations are rich in pike, barbel, and the rare European mudminnow.", "Levees along the river now serve as important cycling routes in the Bihar Plain.", "Remains of the medieval Herpály monastery are located near the river at Berettyóújfalu.", "The name likely derives from ancient Hungarian words meaning 'grove-lined river'."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Debrecen központjától mintegy 10 kilométerre, az Erdőspuszták szívében fekvő Vekeri-tó a cívisváros egyik legnépszerűbb jóléti víztározója és kirándulóhelye. Az 1970-es években mesterségesen létrehozott tó célja a debreceniek rekreációjának biztosítása volt egy olyan területen, ahol a természetes állóvizek ritkák. A tó és környezete igazi oázis az Alföld közepén: csónakázó tó, horgászstégek, kemping és tágas rétek várják a látogatókat. A Vekeri-tó neve összefonódott a híres debreceni zenei fesztiválokkal is, amelyek évtizedeken át vonzották ide a fiatalokat a tölgyerdők árnyékába. Bár a klímaváltozás és a szárazság az utóbbi években komoly kihívások elé állította a tó vízellátását, a vízpótlási projektek révén ma ismét csillog a víztükör, élőhelyet adva a vízi madaraknak és frissítő levegőt a városi embernek. Sachkunde K3 – szabadidő a természetben és mesterséges vizek fenntartása.",
      ro: "Lacul Vekeri este cea mai populară destinație de agrement pentru locuitorii din Debrecen, fiind situat în zona pitorească Erdőspuszták. Amenajat artificial în anii 1970, lacul s-a integrat armonios în peisajul forestier și de stepă înconjurător. Oferă o oază de răcoare și liniște în mediul adesea arid și fierbinte al Câmpiei Ungare. Lacul este înconjurat de păduri dese de pini și stejari, care adăpostesc numeroase trasee de drumeție și locuri pentru picnic. Fie că este vorba de plimbări cu barca pe luciul apei, pescuit pe malul cu stuf sau pur și simplu relaxare la umbra arborilor, lacul Vekeri oferă posibilități variate de petrecere a timpului liber. Atmosfera este deosebit de sugestivă toamna, când frunzișul pădurii se colorează în nuanțe vii, reflectându-se în oglinda apei.",
      en: "Lake Vekeri is the most popular recreational destination for the residents of Debrecen and a jewel of the Erdőspuszták region. Created artificially in the 1970s, the lake has blended harmoniously into the surrounding forest and steppe landscape. It offers a welcome cooling retreat and an oasis of peace in the often hot and dry environment of the Great Plain. The lake is surrounded by dense pine and oak forests that host numerous hiking trails and picnic areas. Whether rowing on the mirror-smooth water, fishing at the reed-lined shores, or simply relaxing in the shade of the trees, Lake Vekeri provides diverse leisure opportunities. The area is particularly atmospheric in autumn when the forest foliage turns vivid colors and reflects in the water's surface."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["A fost creat în 1975 prin bararea pârâului Kati pentru recreere urbană.", "Suprafața apei este de circa 12 hectare, fiind înconjurată de 200 de hectare de parc.", "Deține o mică insulă centrală accesibilă printr-un pod de lemn pitoresc.", "Este un loc de pescuit renumit, fiind populat regulat cu crap și amur.", "Un turn de observație din apropiere oferă vederi panoramice asupra regiunii Erdőspuszták.", "Zonele de camping și taberele de tineret îl fac ideal pentru excursii școlare.", "Face parte dintr-un lanț mai mare de lacuri ce include și lacul Fancsika.", "Iarna, când îngheață suficient, devine un patinoar natural foarte apreciat."],
      en: ["The lake was created in 1975 by damming the Kati stream for urban recreation.", "The area includes about 12 hectares of water surrounded by 200 hectares of parkland.", "Features a small island in the center, accessible via a wooden bridge.", "A well-known fishing spot, regularly stocked with carp and grass carp.", "A nearby lookout tower offers views over the unique Erdőspuszták landscape.", "Large camping sites and youth hostels make it ideal for school excursions.", "Part of a larger chain of lakes, which also includes Lake Fancsika.", "Historically famous for the Vekeri Lake Festival, a major regional music event."]
    }, image: "/poi-images/lake-vekeri-to-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Debrecentől keletre elterülő Erdőspuszták a Nyírség déli részének egyik legértékesebb erdős-sztyepp vidéke, amely félkörívben öleli körbe a cívisvárost. Ez a táj az egykori hatalmas nyírségi erdőségek maradványa, ahol a homokbuckák és a vizenyős völgyek váltakozása különleges mikroklímát és gazdag élővilágot hozott létre. A terület központja Hármashegyalja, ahol a 151 méter magas dombon álló kilátóból pazar panoráma nyílik a vidékre. Az Erdőspuszták nemcsak a természetjárók paradicsoma a Zsuzsi Erdei Vasúttal és a számos tanösvénnyel, hanem fontos környezetvédelmi terület is, ahol gyöngyvirágos tölgyesek és ritka homoki növények élnek. A vidék bemutatóháza és arborétuma hitelesen szemlélteti a régió természeti kincseit és a hagyományos erdőművelő vákáncsosok múltját. Földrajz K7 – a Nyírség kialakulása és az erdős-sztyepp övezet jellemzői.",
      ro: "Erdőspuszták reprezintă o centură verde fascinantă la est de orașul Debrecen, fiind o zonă de tranziție unică între terenurile nisipoase din Nyírség și Câmpia Mare. Această zonă diversă este marcată de un mozaic de păduri de pini și salcâmi plantate, alături de resturi ale pădurilor originale de stejar și carpen. Printre acestea se găsesc lacuri mici, mlaștini și dune de nisip deschise care adăpostesc o floră și o faună specializată. Regiunea servește nu doar ca un coridor ecologic, ci este și semnificativă din punct de vedere istoric, deoarece a constituit anterior zonele de pășunat ale orașului Debrecen. Astăzi, este cea mai importantă zonă de drumeție pentru iubitorii de natură din regiune, având numeroase trasee marcate care oferă informații despre geologia și biologia acestui habitat deosebit.",
      en: "The Erdőspuszták (Forest-Puszta) form a fascinating green belt east of Debrecen, representing a unique transition between the Nyírség sandy region and the Great Plain. This varied area is marked by a mosaic of planted pine and acacia forests along with remnants of original oak-hornbeam stands. Interspersed among these are small ponds, marshes, and open sand dunes that host a specialized flora and fauna. The region serves not only as an ecological corridor but is also historically significant as it formerly served as the grazing grounds for the city of Debrecen. Today, it is the most important hiking area for local nature lovers, with numerous marked trails providing information on the geology and biology of this special habitat."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Az Erdőspuszták Debrecen városától kb. 10 km-re, egy 120-150 méter magas hátságon fekszenek.", "Legmagasabb pontja a Hármashegy (151 m), ahol egy 18 méter magas kilátó áll.", "A területen halad át a Zsuzsi Erdei Vasút, Magyarország legidősebb kisvasútja.", "Jellemző erdőtípusai a gyöngyvirágos tölgyesek és a homoki fenyvesek.", "A Bánki bemutatóház az egykori erdőművelők, a vákáncsosok életét is ismerteti.", "A vidék gazdag vadállományában az őz, a vaddisznó és a gímszarvas is gyakori.", "Számos jóléti tó, köztük a Vekeri-tó és a Fancsikai-tavak láncolata található itt.", "A terület a Hortobágyi Nemzeti Park Igazgatóságának felügyelete alá tartozik."],
      ro: ["Acoperă o suprafață totală de aproximativ 5.000 de hectare de pădure și pajiști.", "Găzduiește specia rară de floarea-vântului maghiară (Pulsatilla hungarica).", "Include arboretumul de la Bánk, care prezintă flora regională specifică.", "Turnul de observație de pe Hármashegy oferă vederi până la orizontul câmpiei.", "Este traversată de 'Trenulețul Zsuzsi', cea mai veche cale ferată îngustă din Ungaria.", "Păduri de arini valoroase s-au păstrat în depresiunile umede dintre dune.", "Este un paradis pentru culegătorii de ciuperci după ploile calde de toamnă.", "Descoperirile arheologice confirmă existența multor sate medievale în această centură."],
      en: ["The Erdőspuszták cover a total area of approximately 5,000 hectares of forest and meadow.", "Home to the rare Hungarian windflower, found only in the sandy regions of the plain.", "Features a botanical garden (Bánk Arboretum) displaying regional flora.", "Several lookout towers, such as on Hármashegy, allow for wide views over the plains.", "Traversed by the 'Zsuzsi Train', the oldest narrow-gauge railway in Hungary.", "Valuable alder swamp forests have been preserved in the damp depressions.", "A paradise for mushroom foragers, especially after warm autumn rains.", "Archaeological finds confirm the existence of numerous medieval villages in this belt."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Hortobágy-folyó, amelyről a híres magyar puszta a nevét kapta, az Alföld egyik legkülönlegesebb és leglassabb vízfolyása. Érdekessége, hogy nincs klasszikus forrásvidéke; mai formájában a Keleti-főcsatornából ágazik ki Tiszavasvári közelében, majd 167 kilométeren át kanyarog a Hortobágyi Nemzeti Park szívében, mígnem a Hármas-Körösbe torkollik. A folyó esése olyannyira csekély, hogy bizonyos vízállásoknál képes 'megfordulni' és visszafelé folyni, ami vízrajzi ritkaságnak számít. A szabályozások előtt a folyó vize hatalmas mocsárvilágot táplált a pusztán, ma pedig fontos ökológiai folyosó, amelynek nádasai és árterei számtalan vízi madárnak és ritka halfajnak nyújtanak menedéket. A folyó menti legelők a hagyományos magyar pásztorkultúra bölcsője, ahol a víz és a föld egysége határozza meg a táj karakterét. Földrajz K6 – alföldi vízrendszerek, síksági folyók lassú folyása és mocsárvilág.",
      ro: "Râul Hortobágy este artera vitală a faimoasei stepe maghiare (puszta), inclusă în patrimoniul mondial UNESCO. Izvorăște din zona Nyírség și șerpuiește cu o viteză de curgere extrem de scăzută prin inima Parcului Național Hortobágy. Râul este inseparabil legat de imaginea regiunii, în special prin emblematicul Pod cu Nouă Arcuri care îl traversează în localitatea omonimă. În trecut, râul era cunoscut pentru inundațiile sale vaste care irigau stepele alcaline imense. Astăzi, cursul său este în mare parte regularizat, dar rămâne cea mai importantă sursă de apă pentru animalele crescute în regim extensiv: vitele Sure maghiare, oile Racka și caii. Stufărișurile de pe maluri sunt un sanctuar vital pentru numeroase păsări protejate, oferind un peisaj de o liniște arhaică.",
      en: "The Hortobágy River is the life-giving artery of the world-famous Hungarian Puszta. It originates in the Nyírség area and meanders with an extremely low flow velocity through the heart of the Hortobágy National Park. The river is inseparably linked with the image of the Puszta, especially through the iconic Nine-arched Bridge that spans it at the village of Hortobágy. In the past, the river was known for its extensive flooding that irrigated the vast alkaline steppes. Today, its course is largely regulated, but it remains the most important water source for livestock—Hungarian Grey Cattle, Racka sheep, and horses—grazing on the steppe. The reed beds along its banks are a vital sanctuary for numerous protected bird species."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Are o lungime totală de 167 de kilometri și se varsă în râul Barcău.", "Datorită pantei extrem de reduse, apa pare adesea să stea pe loc.", "Podul cu Nouă Arcuri a fost construit între anii 1827 și 1833 din piatră de gresie.", "Este o componentă centrală a ecosistemului Parcului Național Hortobágy.", "Păsări rare precum dumbrăveanca și șoimul de seară cuibăresc pe malurile sale.", "Istoric, ruta fluvială a fost folosită pentru transportul sării din Maramureș.", "Solurile alcaline de-a lungul râului găzduiesc plante halofile specializate.", "Celebra 'Piață de la Pod' are loc anual în august la traversarea râului."],
      en: ["The Hortobágy River has a total length of 167 kilometers and flows into the Berettyó.", "Due to the extremely low gradient, the water often appears to stand still.", "The Nine-arched Bridge, the river's landmark, was built between 1827 and 1833.", "The river is a central component of the UNESCO World Heritage Site Hortobágy National Park.", "Rare birds like the European roller and red-footed falcon nest in the riverside zones.", "Historically, the river route was used for transporting salt from the Carpathians.", "Alkaline soils along the river host specialized, salt-tolerant plant species.", "The famous 'Bridge Market' takes place annually in August at the river crossing."]
    }, image: "/poi-images/river-hortobagy-folyo-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Debrecen határában található Fancsikai-tavak egy három tagból álló mesterséges tórendszert alkotnak, amely évtizedekig a város környékének legnépszerűbb horgász- és pihenőhelye volt. Az Erdőspuszták völgyeiben kialakított víztározók (Fancsika I, II és III) célja a csapadékvíz visszatartása és a jóléti funkciók biztosítása volt. Az utóbbi években azonban a klímaváltozás és az aszályok miatt a tavak sorsa bizonytalanná vált: vízszintjük drasztikusan lecsökkent, helyenként teljesen kiszáradtak. A rehabilitációs törekvések és a vízpótlási projektek ma is zajlanak, hogy megmentsék ezt az értékes vizes élőhelyet. A tavakat övező dús növényzet és erdősávok ma is kedvelt túracélpontok, ahol a látogatók a vízi világ és a homoki erdők találkozását figyelhetik meg, miközben reménykednek a víztükör tartós visszatérésében. Sachkunde K3 – vizes élőhelyek védelme és a környezeti változások hatásai.",
      ro: "Sistemul de lacuri Fancsika (format din două bazine principale, Fancsika I și II) este o zonă semnificativă de pescuit și recreere la est de Debrecen. Situat în peisajul idilic Erdőspuszták, acest complex a fost creat inițial ca rezervor pentru managementul apelor. De-a lungul anilor, s-a transformat într-un biotop valoros, înconjurat de centuri dense de stuf care servesc ca locuri de cuibărit pentru numeroase păsări de apă, precum rațele sălbatice și stârcii. Pentru populația urbană, lacurile Fancsika sunt sinonime cu relaxarea de weekend în mijlocul naturii. În ciuda provocărilor cauzate de fluctuațiile nivelului apei în anii secetoși, zona rămâne un refugiu important. Malurile bine amenajate oferă condiții ideale pentru picnicuri de familie și plimbări liniștite sub arbori bătrâni.",
      en: "The Fancsika Lake system is a significant angling and recreation area on the eastern edge of Debrecen. Nestled in the idyllic landscape of the Erdőspuszták, these lakes were originally created as reservoirs for water management. Over the years, however, they have developed into valuable biotopes. The lakes are surrounded by dense reed belts that serve as nesting sites for numerous water birds such as ducks, herons, and grebes. For the urban population, the Fancsika lakes are synonymous with weekend relaxation. Despite challenges from fluctuating water levels in dry years, the area remains an important retreat for both humans and nature. Well-developed shore areas provide ideal conditions for family picnics and quiet walks under old trees."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Sistemul a fost creat în anii 1970 pentru a regla pârâul Kati.", "Lacurile sunt o locație de top pentru pescuitul la crap și amur.", "Peste 50 de specii diferite de păsări cuibăresc în vecinătatea lacurilor.", "Suprafața apei variază semnificativ în funcție de precipitații.", "Un traseu de drumeție leagă lacurile Fancsika de lacul învecinat Vekeri.", "Vestigii valoroase ale fortificațiilor din era Arpadiană se găsesc în pădurile din jur.", "Lacurile servesc ca adăpători vitale pentru cerbi și mistreți.", "Asociațiile locale de conservare lucrează activ pentru menținerea purității apei."],
      en: ["The Fancsika system was created in the 1970s to regulate the Kati stream.", "The lakes are a prime location for coarse fishing, especially known for large carp.", "Over 50 different bird species breed in the vicinity of the lakes.", "Water surface area varies significantly based on precipitation, a key local ecological topic.", "A hiking trail connects the Fancsika lakes with the neighboring Lake Vekeri.", "Valuable remnants of Arpadian-era fortifications are found in the surrounding woods.", "The lakes serve as vital watering holes for deer and wild boar living in the area.", "Local conservation groups actively work to maintain the water level and purity."]
  ...
  // HU-HE: Heves
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Galyatető a Mátra hegység és egyben Magyarország egyik legmagasabban fekvő üdülőhelye, a hegység második legmagasabb tömbje (964 méter). Híres tiszta, magaslati levegőjéről, amely már a 20. század eleje óta vonzza a gyógyulni és pihenni vágyókat. A csúcs legmeghatározóbb építménye a modernizált Galya-kilátó, amely innovatív építészeti megoldásaival és a benne kialakított bivakszállásokkal világszinten is egyedülálló. A kilátó tetejéről 360 fokos panoráma nyílik, tiszta időben még a Magas-Tátra havas csúcsai is feltűnnek az északi horizonton. Galyatető fontos központja az országos kéktúrának és a téli sportoknak is, sífutópályái és biatlon lőtere országos jelentőségűek. A település és környéke a csend és a nyugalom szigete, ahol a bükkerdők és a hegyi rétek harmóniája felejthetetlen élményt nyújt. Földrajz K7 – magashegységi formakincs és a klimatikus gyógyhelyek szerepe.",
      ro: "Galyatető, situat la o altitudine de 964 de metri, este al doilea cel mai înalt vârf din munții Mátra și una dintre cele mai renumite stațiuni climaterice din Ungaria. Datorită aerului său extrem de pur, lipsit de polen, locația a devenit un refugiu pentru persoanele cu afecțiuni respiratorii încă din secolul trecut. Punctul de reper al vârfului este turnul de observație Galya, renovat spectaculos și premiat pentru arhitectura sa modernă, care include și camere colorate pentru bivuac. De pe platformă se deschide o panoramă grandioasă care, în zilele senine, poate ajunge până la vârfurile munților Tatra din Slovacia. Înconjurat de păduri de fag maiestuoase, Galyatető este străbătut de numeroase trasee montane, inclusiv Traseul Albastru Național, oferind o combinație perfectă între eleganță istorică și sport montan.",
      en: "Galyatető is one of Hungary's highest elevations at 964 meters and a jewel of the Mátra Mountains. Known as one of the country's most significant climatic health resorts, this location offers ideal conditions for relaxation and those with respiratory issues due to its altitude and pure, pollen-free air. The landmark of the summit is the spectacularly renovated Galya Lookout Tower, which gained worldwide attention for its modern architecture and colorful bivouac rooms. From the platform, a grand panorama opens that can reach the peaks of the High Tatras on clear days. The surroundings are marked by dense beech forests traversed by a network of trails, including the National Blue Trail."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Galyatető 964 méteres magasságával a Mátra és az ország egyik legmagasabb pontja.", "A Galya-kilátó (korábban Péter-hegyese kilátó) 2015-ben kapott modern, díjnyertes külsőt.", "Itt található az ország legmagasabban fekvő temploma, a Kodály Zoltánról elnevezett kápolna.", "A helyszín híres sífutó- és biatlonközpont, modern lőtérrel és pályarendszerrel.", "A Galyatető Turistacentrum az ország egyik legkorszerűbb bakancsos szálláshelye.", "A bükkerdők uralják a tájat, ahol gyakori a ritka havasi cincér és a parlagi sas.", "A település levegője bizonyítottan gyógyhatású a légzőszervi betegségek esetén.", "Az Országos Kéktúra útvonala keresztülhalad a település központján."],
      ro: ["Este al treilea cel mai înalt vârf din Ungaria și al doilea din masivul Mátra.", "Turnul Galya a fost construit în 1934 și renovat în 2015 cu un design inovator.", "Grandhotel Galyatető a fost un refugiu exclusivist pentru elită în anii 1930.", "Găzduiește cel mai înalt centru de biatlon din țară, cu facilități moderne.", "Capela Kodály de pe munte îl comemorează pe compozitorul Zoltán Kodály.", "Datorită microclimatului, zăpada persistă aici mult mai mult decât în restul țării.", "Traseul național 'Országos Kéktúra' trece chiar pe lângă vârful muntelui.", "Flora include specii montane rare precum degețelul galben și diverse ferigi."],
      en: ["Galyatető is the third highest peak in Hungary and the second highest in the Mátra.", "The Galya Lookout was built in 1934 and renovated in 2015, winning several awards.", "The Grandhotel Galyatető served as an exclusive retreat for the elite in the 1930s.", "The location hosts the highest-situated biathlon center in Hungary.", "The Kodály Chapel on the mountain commemorates composer Zoltán Kodály, a frequent guest.", "Due to its microclimate, snow often remains here much longer than in the rest of the country.", "The Országos Kéktúra long-distance trail leads directly over the summit area.", "Flora includes rare mountain plants like the foxglove and various fern species."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gyöngyös felett magasodó Sár-hegy a Mátra hegység déli előhírnöke, egy különálló vulkanikus tömb, amely meredeken emelkedik ki az Alföld északi pereméből. Ez a terület egy igazi ökológiai ékszerdoboz, ahol a hegység vulkáni kőzetei és a síkság meleg klímája találkozik, különleges szubmediterrán élőhelyeket hozva létre. A hegy déli lejtőin évszázadok óta virágzik a szőlőkultúra, a Mátrai borvidék egyik legnemesebb területeit adva. A Sár-hegy tetején található a titokzatos Szent Anna-tó, egy apró, mocsaras állóvíz, amely a hegy vulkáni kráterében alakult ki. A hegyoldalakon ritka növények, mint a tavaszi hérics és a leánykökörcsin virítanak, a sziklás bércekről pedig lélegzetelállító kilátás nyílik a magyar Alföld végtelen rónáira. Földrajz K6 – vulkáni tanúhegyek és a sztyepprétek élővilága.",
      ro: "Dealul Sár-hegy este un munte vulcanic izolat situat la marginea sudică a munților Mátra, direct deasupra orașului Gyöngyös. În ciuda numelui său (care s-ar traduce prin Dealul Noroiului), muntele este un loc de o diversitate botanică și o frumusețe extraordinară. Din punct de vedere geologic, este o rămășiță a activității vulcanice care a format masivul Mátra, dar expunerea sa sudică îi conferă un microclimat aproape mediteraneean. Dealul este faimos pentru vegetația sa de stepă și podgoriile terasate de pe versanți, care produc unele dintre cele mai apreciate vinuri din regiune. Un punct de atracție geologic deosebit este micul lac de crater Szent Anna, situat pe platoul înalt. Traseele de drumeție șerpuiesc prin pajiști aride parfumate și păduri de stejar pufos, oferind vederi spectaculoase.",
      en: "Sár Hill is a prominent, isolated volcanic mountain on the southern edge of the Mátra, directly above the town of Gyöngyös. Despite its name (Mud Hill), the mountain is a place of extraordinary botanical diversity and beauty. Geologically, it is a remnant of the volcanic activity that formed the Mátra range, but its southern exposure gives it a nearly Mediterranean microclimate. The hill is famous for its steppe vegetation and the terraced vineyards on its slopes, which produce some of the best wines of the Mátra region. A special geological highlight is the small, often temporary crater lake 'St. Anne's Lake' on the high plateau. Hiking trails lead through fragrant dry grasslands and downy oak forests."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Se înalță la o altitudine de 468 de metri deasupra nivelului mării.", "Găzduiește peste 1.000 de specii de plante diferite pe o suprafață restrânsă.", "Capela Sfânta Ana de pe vârf este un loc de pelerinaj local popular.", "Lacul de crater Szent Anna este o rezervație naturală strict protejată.", "Este cunoscut pentru populația de șopârlă de smarald panonică.", "Viticultura se practică pe versanți încă din perioada medievală.", "Este un sit de cercetare cheie pentru botaniștii și ecologii maghiari.", "Primăvara înfloresc aici mii de stânjenei pitici și flori de ruscuță."],
      en: ["Sár Hill rises to an elevation of 468 meters above sea level.", "The mountain hosts over 1,000 different plant species, a record for such a small area.", "The small St. Anne's Chapel on the summit is a popular pilgrimage site.", "The St. Anne's crater lake is a protected nature reserve within the mountain area.", "Known for its populations of the rare Pannonian emerald lizard.", "Viticulture has been practiced on the slopes since the Middle Ages.", "A key research site for Hungarian botanists and ecologists.", "In spring, thousands of dwarf iris and spring Adonis bloom across the hillsides."]
    }, image: "/poi-images/mountain-sar-hegy-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tarna folyó az Északi-középhegység egyik legfontosabb vízfolyása, amely a Heves–Borsodi-dombságban ered, majd a Mátrát és a Bükköt elválasztva halad dél felé az Alföld irányába. A folyó völgye évszázadok óta fontos közlekedési folyosó és mezőgazdasági terület, ahol a folyó vize élteti a környék gazdag növénytermesztését és állattenyésztését. A Tarna felső szakasza gyorsabb folyású és tiszta vizű, míg az alsóbb részeken lelassul, és kanyargós mederben éri el a Zagyva folyót. A Tarna mente gazdag néprajzi és történelmi emlékekben, hiszen számos várat és ősi települést találunk a partján. A folyó vízszintje rendkívül ingadozó, a tavaszi áradások után a nyári aszályok idején gyakran kritikusan lecsökken a vízhozama, ami komoly kihívást jelent a helyi élővilág és a vízgazdálkodás számára. Földrajz K7 – a vízgyűjtő területek szerkezete és a folyók évszakos ingadozása.",
      ro: "Râul Tarna este un curs de apă semnificativ în nord-estul Ungariei, separând munții Mátra de Câmpia Heves. Izvorăște în dealurile Cserhát și curge într-un arc larg spre sud-est. Râul joacă un rol central în ecosistemul regional, acționând ca un coridor natural între munții împăduriți și stepa deschisă. În cursul său superior, Tarna este un pârâu montan vioi care curge prin văi pitorești, în timp ce în cursul inferior șerpuiește leneș prin terenuri agricole fertile. Tarna este cunoscută pentru fauna sa piscicolă bogată și pădurile de luncă bine conservate de-a lungul malurilor sale. În ciuda intervențiilor umane pentru regularizare, râul și-a menținut caracterul natural în multe secțiuni, fiind o destinație apreciată pentru observatorii naturii și pescarii care caută locuri izolate.",
      en: "The Tarna is a significant river in northeastern Hungary, separating the Mátra Mountains from the Heves Plain. It originates in the Cserhát hills and flows in a wide arc to the southeast. The river plays a central role in the regional ecosystem, acting as a natural corridor between the forested mountains and the open steppe. In its upper reaches, the Tarna is a lively mountain stream flowing through picturesque valleys, while in its lower reaches, it meanders leisurely through fertile farmland. The Tarna is known for its rich fish fauna and well-preserved floodplain forests along its banks. Despite human interventions for regulation, the river has maintained its natural character in many sections."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Are o lungime totală de circa 105 kilometri și se varsă în Zagyva la Jászberény.", "Traversează peisaje istorice precum Valea Tarna cu satele sale tradiționale.", "Păsări rare precum cristelul de câmp cuibăresc în pajiștile umede adiacente.", "Este un habitat important pentru specii de pești precum mreanul și cleanul.", "Alimentează mai multe iazuri artificiale folosite pentru piscicultură și conservare.", "Istoric, apele râului alimentau numeroase mori, ale căror ruine mai există și azi.", "La Sirok, râul trece pe sub faimoasa cetate medievală construită pe stâncă.", "Calitatea apei este protejată prin măsuri stricte în bazinul munților Mátra."],
      en: ["The Tarna has a total length of about 105 kilometers and flows into the Zagyva.", "The river passes through historically significant landscapes like the Tarna Valley.", "Rare birds like the corncrake breed in the wet meadows along the Tarna.", "An important habitat for barbel, chub, and gudgeon fish species.", "The Tarna feeds several artificial ponds used for fish farming and conservation.", "Historically, the river's waters powered numerous mills, ruins of which still exist.", "At Sirok, the Tarna flows beneath the famous historic rocky castle.", "Water quality is ensured by strict environmental protection in the Mátra catchment area."]
    }, image: "/poi-images/river-tarna-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Eger-patak a Bükk-vidék és a Mátra határán folyó jelentős vízfolyás, amely keresztülhalad Heves vármegye székhelyén, Eger városán. A patak a Bükk-fennsík déli peremén ered, és útja során mély völgyeket váj a mészkőbe, mielőtt elérné az alföldi síkságot. Eger városában a patak a település szövetének szerves része: partjait sétányok, hidak és parkok díszítik, meghatározva a barokk belváros hangulatát. A történelem során a patak vize malmokat hajtott és a vár védműveit is táplálta a híres 1552-es ostrom idején. Ma az Eger-patak fontos ökológiai folyosó, amely összeköti a hegyvidéki erdőket az alföldi vizes élőhelyekkel. Bár hossza nem nagy, vízgyűjtő területe és kulturális jelentősége kiemelt helyet biztosít számára a magyar folyók sorában. Földrajz K6 – városi vízfolyások szerepe és a patakok völgyképző munkája.",
      ro: "Pârâul Eger este artera vitală a orașului baroc omonim, Eger, modelându-i istoria și peisajul urban de secole. Izvorăște din munții Bükk și curge spre sud prin Valea Eger înainte de a se vărsa în lacul Tisa. În orașul Eger, pârâul este integrat artistic în arhitectură; promenadele sale de pe maluri și micile poduri invită la plimbări romantice. Istoric, pârâul a avut o importanță strategică, alimentând șanțurile de apărare ale celebrei cetăți din Eger. Dincolo de rolul său urban, pârâul reprezintă o legătură ecologică importantă, transportând apa răcoroasă de munte spre câmpie. Numeroase locuri unde au existat mori și parcuri mici pot fi găsite de-a lungul cursului său, făcând din acest pârâu o parte indispensabilă a calitatii vieții regionale.",
      en: "The Eger Brook is the lifeblood of the eponymous Baroque city of Eger and has shaped its history and cityscape for centuries. It originates in the Bükk Mountains and flows south through the Eger Valley before finally emptying into Lake Tisza. In the city of Eger, the brook is artistically integrated into the architecture; its riverside promenades and small bridges invite romantic walks. Historically, the brook was of strategic importance as it fed the moats of the famous Castle of Eger. Beyond its urban role, the Eger Brook is an important ecological link, transporting cool mountain water to the plains. Numerous former mill sites and small parks can be found along its course."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Are o lungime de aproximativ 68 de kilometri de la izvor până la vărsare.", "În orașul Eger, alimentează faimoasa baie termală și Grădina Arhiepiscopală.", "Istoric, a acționat până la 15 mori în limitele orașului în secolul al XVIII-lea.", "Traversează pitoreasca 'Vale a Femeii Frumoase', o zonă viticolă celebră.", "Calitatea apei în secțiunile superioare permite supraviețuirea păstrăvului indigen.", "Controlul asupra pârâului a jucat un rol decisiv în timpul asediului Egerului din 1552.", "Este cunoscut pentru populațiile sale de rațe sălbatice și mierle de apă.", "Acțiunile periodice de curățare ale cetățenilor arată legătura profundă cu pârâul."],
      en: ["The Eger Brook has a length of approximately 68 kilometers from source to mouth.", "In Eger, the brook feeds the famous thermal bath and the Archbishop's Garden.", "Historically, the brook powered up to 15 mills within the city limits in the 18th century.", "The brook flows through the picturesque 'Valley of the Beautiful Woman', a famous wine area.", "Water quality in the upper sections is high enough to support brown trout.", "Control over the brook played a decisive role during the Siege of Eger in 1552.", "Known for its populations of mallards and white-throated dippers.", "Regular community cleanup events show the deep connection between citizens and their brook."]
    }, image: "/poi-images/river-eger-patak-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Mátrai Tájvédelmi Körzet Magyarország legmagasabb hegységének legértékesebb részeit foglalja magában, mintegy 12 000 hektáron. A terület célja a Mátra vulkanikus formakincsének, bükk- és tölgyerdőinek, valamint ritka hegyi rétjeinek megőrzése. Itt találhatók hazánk legmagasabb csúcsai, a Kékes és a Galyatető, melyek környezete különleges magashegységi mikroklímával rendelkezik. A tájvédelmi körzetben olyan természeti ritkaságokat csodálhatunk meg, mint az Ilona-völgyi vízesés vagy a sástói lápvidék. Az erdők mélyén ritka állatfajok, mint a parlagi sas, a vándorsólyom és a muflon találnak otthonra. A terület nemcsak természetvédelmi szempontból kiemelkedő, hanem az ország egyik legfontosabb turisztikai célpontja is, ahol az ember és a természet évszázados együttélése (erdőgazdálkodás, legeltetés, turizmus) ma is megfigyelhető. Földrajz K7 – a Mátra vulkanizmusa és a magashegységi flóra-fauna védettsége.",
      ro: "Pădurile Mátra acoperă cel mai înalt masiv montan din Ungaria și reprezintă un refugiu ecologic de importanță națională. Caracterizate prin păduri de fag maiestuoase la altitudini mari și stejărișuri dense pe versanți, aceste păduri oferă un habitat pentru o varietate impresionantă de animale sălbatice, inclusiv cerbi comuni, mistreți și mufloni introduși cu succes acum câteva decenii. Masivul Mátra este renumit și pentru numeroasele sale izvoare curative și climatul forestier sănătos, care a dus la înființarea unor sanatorii importante la începutul secolului al XX-lea. Drumeții găsesc aici o rețea perfect dezvoltată de trasee care duc spre formațiuni stâncoase ascunse, cascade și puncte de belvedere spectaculoase, pădurea fiind plămânul verde al Ungariei de Nord.",
      en: "The Matra Forest covers the highest mountain massif in Hungary and represents an ecological refuge of national importance. Characterized by majestic beech forests in the higher elevations and dense oak-hornbeam stands on the slopes, these forests provide a habitat for an impressive variety of wildlife, including red deer, wild boar, and the successfully introduced mouflon. The Mátra is also known for its numerous healing springs and healthy forest climate, which led to the founding of major sanatoriums in the early 20th century. Hikers find a perfectly developed network of trails leading to hidden rock formations, waterfalls, and spectacular vantage points."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Peste 80% din suprafața munților Mátra este acoperită de pădure.", "Include vârful Kékes (1.014 m), cel mai înalt punct din țară.", "Găzduiește păsări răpitoare rare, cum ar fi acvila de câmp și șoimul călător.", "Este renumită pentru prezența brândușei de toamnă panonice.", "Populația de mufloni din Mátra este una dintre cele mai stabile din Europa Centrală.", "Numeroase trasee tematice oferă informații despre silvicultură și conservare.", "Pădurile sunt bogate în formațiuni vulcanice numite 'mări de piatră'.", "Este o destinație majoră pentru sporturile de iarnă, cu pârtii de schi și săniuș."],
      en: ["Over 80 percent of the Mátra Mountains are forested, making it one of Hungary's woodiest areas.", "The Matra Forest contains Kékes (1,014 m), the highest point in the country.", "The area hosts rare birds of prey such as the imperial eagle and peregrine falcon.", "Botanically famous for the occurrence of the rare Pannonian crocus.", "The mouflon population of the Mátra is one of the most stable in Central Europe.", "Numerous marked nature trails inform about forestry traditions and conservation.", "The forests are rich in volcanic rock formations often called 'stone seas'.", "A major destination for winter sports, featuring ski slopes and toboggan runs."]
  ...
  // HU-JN: Jász-Nagykun-Szolnok
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Zagyva este cel mai important râu din regiunea Jászság și un afluent major al Tisei. Izvorăște din munții Karancs, în nordul Ungariei, și șerpuiește pe o lungime de aproximativ 179 de kilometri prin Marea Câmpie Ungară până la vărsarea sa la Szolnok. Râul este cunoscut pentru curentul său calm și peisajele deschise și vaste pe care le traversează. Pentru pescari, Zagyva este un teritoriu valoros, fiind bogat în specii de pești nativi, cum ar fi crapul și știuca. Din punct de vedere istoric, râul a jucat un rol crucial în așezarea poporului Jász (iazigi), a cărui cultură și tradiții rămân strâns legate de cursul apei și de luncile sale fertile. Malurile oferă un refugiu liniștit și un coridor ecologic vital într-o câmpie utilizată altfel intens pentru agricultură.",
      en: "The Zagyva is the most significant river of the Jászság region and a major tributary of the Tisza. It originates in the Karancs Mountains of northern Hungary and meanders for about 179 kilometers through the Great Plain until its mouth at Szolnok. The river is known for its calm current and the wide, open landscapes it traverses. For anglers, the Zagyva is a valued territory, as it is rich in native fish species like carp and pike. Historically, the river played a crucial role in the settlement of the Jász (Jazygen) people, whose culture and traditions remain closely linked to the watercourse and its fertile floodplains. The banks offer a peaceful retreat and vital ecological corridor."
    },
    factsAdvanced: {
      de: [
      ...
      ro: ["Este cel mai lung râu care izvorăște și se varsă integral pe teritoriul Ungariei.", "Lungimea totală este de 179 km, cu un bazin hidrografic de peste 5.000 km².", "Confluența cu Tisa la Szolnok este un punct peisagistic și turistic central.", "Numele râului are probabil origini slave, însemnând 'râu mlaștinos'.", "În orașul Szolnok, gura de vărsare este flancată de promenade și parcuri.", "Bazinul Zagyva este o zonă agricolă cheie pentru cultivarea cerealelor.", "Adăpostește populații semnificative de vidră europeană.", "Inundațiile istorice ale râului au dus la construcția unor diguri masive de apărare."],
      en: ["The Zagyva is one of the longest rivers flowing entirely within Hungary (179 km).", "The river flows directly into the Tisza River within the city of Szolnok.", "Historically known for unpredictable flooding, leading to extensive levee systems.", "Rare plants of the Pannonian flora are found in the river's floodplains.", "Feeds several important irrigation canals for agriculture in the region.", "Numerous white stork nests are found along its banks due to abundant food.", "Water quality has improved significantly with modern treatment plants.", "Increasingly discovered for gentle tourism, particularly for canoe trips."]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "",
      en: "The Hortobágy-Berettyó is a fascinating water body that acts as a link between the Puszta and the rivers of the lowlands. Technically, it is a channelized watercourse created by regulating the Hortobágy River and connecting it with the Berettyó. It crosses vast areas of the Hortobágy National Park and is characterized by extensive reed zones and marshlands. This landscape provides one of the most important breeding grounds for rare water birds in Central Europe. The water flows extremely slowly here, which has led to the development of rich aquatic vegetation, including rare water ferns and water lilies. For visitors, it is a place of absolute silence where the original swamp landscape can be experienced."
    },
    factsAdvanced: {
      de: [
      ...
      ro: [],
      en: ["The Hortobágy-Berettyó extends over a length of approximately 167 kilometers.", "The watercourse is an artificially regulated system created in the 19th century.", "Hosts the largest heron colony in the region, including the little egret.", "Unique salt flora and rare alkaline moors are found along its banks.", "Serves as an important water reservoir for protection against drought in the Puszta.", "A favorite destination for nature photographers, especially at dawn.", "Several historic locks along the course demonstrate Hungarian hydraulic engineering.", "Part of the UNESCO World Heritage Site of the Hortobágy Puszta."]
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Dobogókő nemcsak a Visegrádi-hegység legmagasabb pontja, hanem sokak számára Magyarország 'szakrális szíve' is. A 700 méteres magasságban fekvő település és kilátópont a magyar természetjárás bölcsője; itt épült fel az ország első turistaháza a 19. század végén. Dobogókő hírnevét elsősorban a Dunakanyarra és a szemközti Börzsöny hegyeire nyíló lélegzetelállító panorámának köszönheti. Sok látogató a hegyhez kötődő ezoterikus legendák miatt is felkeresi, miszerint itt dobog a 'Föld szívcsakrája'. Akár a Pilis- és Visegrádi-hegységbe induló túrák kiindulópontjaként, akár a csendes elmélyülés helyszíneként tekintünk rá, Dobogókő Budapest környékének egyik leglátogatottabb és legtiszteltebb természeti helyszíne.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/lake-garancsi-to-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Naszály a Dunakanyar legmeghatározóbb csúcsa, amely Vác városa felett magasodik fenségesen. A Cserhát-hegység legdélebbi nyúlványaként főként mészkő építi fel, ami jellegzetes formát és gazdag karsztvilágot kölcsönöz neki. A hegy gyomra számos barlangot rejt, köztük a híres Násznép-barlangot, amelyhez több legenda is fűződik. A csúcsra vezető túra változatos tájakon – sűrű lombhullató erdőkön és nyílt sziklagyepeken – keresztül vezet. A felfelé tartó fáradtságot az ország egyik legszebb kilátása kárpótolja: a csúcsról rálátni a Dunakanyarra, a Visegrádi-hegységre, a Pilisre, sőt tiszta időben Budapest sziluettje is kirajzolódik. A Naszály igazi geológiai és botanikai kincsestár.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
  ...
  // HU-TO: Tolna
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szekszárdi-dombság a Dunántúli-dombság délkeleti peremén helyezkedik el, és világszerte híres a löszös talaján termő tüzes vörösborairól. Ez a tájegység egy mélyen szabdalt, völgyekkel és meredek horhosokkal átszőtt vidék, amelyet vastag, néhol a 30 métert is elérő löszréteg borít. A dombság klímája mediterrán hatások alatt áll, ami hosszú, meleg nyarakat és kedvező őszöket biztosít a szőlőművelésnek. Szekszárd városa a dombság lábánál fekszik, és történelme összefonódott a borászattal: már a rómaiak is ültettek itt szőlőt. A vidék legnemesebb bora a Szekszárdi Bikavér, amelynek készítése szigorú szabályokhoz kötött. A dombság nemcsak gazdasági, hanem természeti érték is: a löszfalakban gyurgyalagok fészkelnek, a völgyekben pedig gazdag tölgyerdők és vadvirágos rétek találhatók. Földrajz K8 – a lösz kialakulása, dombsági formakincs és a történelmi borvidékek földrajza.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      ...
      hu: ["A dombságot vastag, 20-30 méteres löszréteg borítja, amely az utolsó jégkorszak idején rakódott le.", "Legmagasabb pontja a Sötét-völgy felett található, magassága nem éri el a 300 métert.", "A vidék az egyik legnaposabb tájegységünk, erős dél-európai éghajlati hatással.", "Itt találhatók a híres 'szekszárdi horhosok', a löszbe vájt mély utat és völgyek.", "A Szekszárdi borvidék az ország egyik legrégebbi és legnevesebb vörösboros területe.", "A dombság löszfalai a színpompás gyurgyalagok egyik legfontosabb hazai költőhelyei.", "A területen számos borospincét vájtak közvetlenül a löszfalakba a 18-19. században.", "A Gemenci-erdő közelsége miatt a dombság vadállománya, különösen a gímszarvas-állomány kiemelkedő."],
      ro: [],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tolna vármegyei Tamási közelében fekvő Pacsmagi-tavak Magyarország egyik legjelentősebb vízimadár-rezervátuma és nemzetközileg elismert Ramsari területe. A hét tóból álló tórendszert a Kapos-folyó völgyében alakították ki, és mára Európa-szerte híres a gazdag madárvilágáról: eddig több mint 214 madárfajt figyeltek meg itt, ami a hazai fajok több mint fele. A tavak különösen fontosak a gémfélék és récefélék számára; itt él hazánk egyik legnagyobb cigányréce-állománya és rendszeresen költ a ritka üstökösréce is. A terület a Duna-Dráva Nemzeti Park Igazgatóságához tartozik, és szigorú védelem alatt áll, biztosítva a zavartalan fészkelést és táplálkozást a vonuló madarak számára. A tavakat övező nádasok, mocsárrétek és erdők komplex ökoszisztémát alkotnak, amely a természetfotósok és az ornitológusok igazi paradicsoma. Biológia K8 – vizes élőhelyek ökológiája, madárvonulás és a nemzetközi természetvédelmi egyezmények.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/lake-pacsmagi-tavak-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gemenci-erdő Közép-Európa legnagyobb összefüggő ártéri erdeje, amely a Duna és a Sió találkozásánál, Tolna és Bács-Kiskun vármegyék határán terül el. Ez a vadregényes táj a folyó állandó alakító munkájának köszönheti létét: a rendszeres áradások, a kanyargós holtágak és a sűrű galériaerdők egyedülálló ökoszisztémát alkotnak. Gemenc világhírű a gímszarvas-állományáról, amelynek bikái rekordméretű agancsokat növesztenek az ártéri réteken. A fekete gólyák sűrűsége itt a legnagyobb a világon, de a terület a rétisasok és vidrák számára is fontos menedék. A látogatók a híres Gemenci Állami Erdei Vasúton utazva vagy magas vízállásnál kenuba szállva ismerhetik meg ezt a misztikus vízi világot, ahol a természet az úr. Földrajz K7 – folyami ártéri erdők, biodiverzitás és a Duna vízrajzi jelentősége.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/forest-gemenci-erdo-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kapos folyó torkolatvidéke Tolna vármegyében, Tolna és Szekszárd közelében található, ahol a somogyi és tolnai dombság vizeit összegyűjtő folyó a Sió-csatornába ömlik. Ez a terület stratégiai fontosságú a régió vízgazdálkodása szempontjából, hiszen itt találkozik a dél-dunántúli dombvidék vízrendszere a Duna menti síksággal. A torkolat környéke alacsonyan fekvő, vizenyős terület, amely gazdag ártéri növényzettel és nádasokkal rendelkezik, fontos élőhelyet biztosítva a vízi madaraknak és kétéltűeknek. A Kapos völgye történelmileg is jelentős, hiszen fontos közlekedési útvonal volt a Balaton és a Duna között. Ma a torkolatvidék a horgászok és a természetjárók kedvelt célpontja, ahol a folyók lassú hömpölygése és a környező löszhátak kontrasztja különleges tájképi élményt nyújt. Földrajz K5 – folyótorkolatok típusai és a dombsági vízgyűjtők.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/river-kapos-torkolat-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tolnai-hegyhát a Dunántúli-dombság északkeleti részén, a Kapos és a Sió völgyei között elterülő, völgyekkel sűrűn szabdalt dombvidék. Ez a táj nemcsak mezőgazdasági jelentőségéről, hanem gazdag történelmi és néprajzi örökségéről is nevezetes. A hegyhátat vastag löszréteg borítja, amelynek köszönhetően mély horhosok és szakadékok alakultak ki, egyedi domborzati formákat hozva létre. A terület központja Gyönk és környéke, ahol a német (székely) és magyar telepesek kultúrája ötvöződik. A Tolnai-hegyhát erdői, főként tölgyesek és gyertyánosok, gazdag vadállománynak adnak otthont, míg a domboldalakon kiváló minőségű borok teremnek. A vidék nyugalma és érintetlensége ideális a falusi turizmus és a csendes túrázás kedvelőinek, akik a múlt emlékeit és a természeti szépségeket egyszerre keresik. Földrajz K8 – dombsági formakincs, löszpuszták és a népesség eloszlása.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
  ...
  // HU-VA: Vas
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Rába a Dunántúl legjelentősebb folyója, amely az osztrák Alpokban, a Fischbachi-Alpokban ered, majd Magyarországon a Kisalföldön keresztül tart Győr felé, ahol a Mosoni-Dunába torkollik. Ez a folyó az ország egyik legvadabb és legtermészetesebb vízfolyása, amelynek kanyargós medre és hirtelen áradásai évszázadok óta meghatározzák a vidék életét. A Rába-völgy nemcsak természeti, hanem történelmi szempontból is kiemelkedő: a folyó mentén sorakoznak az egykori határőrvidék települései, és partján zajlott a híres 1664-es szentgotthárdi csata is. A folyó ma a vízitúrázók egyik legnépszerűbb célpontja, ahol a gyorsabb és lassabb szakaszok váltakozása izgalmas kalandot kínál. A Rába menti ártéri erdők és rétek a Fertő–Hanság Nemzeti Park részeként szigorú védelem alatt állnak, őrizve a nyugat-magyarországi táj eredeti szépségét. Földrajz K7 – hegyvidéki és síksági folyószakaszok, árvízvédelem és határmenti vízrajz.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      ...
      hu: ["A Rába teljes hossza 283 kilométer, ebből 188 kilométer található Magyarország területén.", "Ez a Duna legjelentősebb magyarországi jobb oldali mellékfolyója.", "Vízjárása rendkívül szeszélyes, az Alpokban leeső csapadék miatt órák alatt megáradhat.", "Szentgotthárdnál lép be az országba, és Győrnél, a 'folyók városánál' ér véget.", "A Rába-menti nemzeti parki területeken ritka vízi növények és vidrák élnek.", "A folyó energiáját már a középkortól malmok, ma pedig kiserőművek hasznosítják.", "Medre sok helyen még ma is szabadon kanyarog, zátonyokat és holtágakat építve.", "A Rába vize fontos szerepet játszik a Kisalföld mezőgazdasági öntözőrendszereiben."],
      ro: [],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Kőszegi-hegység Magyarország legnyugatibb hegyvidéke, az Alpok utolsó nyúlványa, amely kristálytiszta levegőjével és alpesi jellegű növényvilágával emelkedik ki környezetéből. Itt található a Dunántúl legmagasabb pontja, az Írott-kő, amelynek csúcsán a határvonal pontosan a kilátón keresztül halad. A hegység híres szubalpin klímájáról, amely már a 19. század óta kedvelt gyógyhelyszínné tette a vidéket, különösen a légzőszervi betegségek kezelésében. A sűrű bükk- és fenyőerdők mélyén sebes vizű patakok, mint a Gyöngyös-patak, és olyan látványosságok bújnak meg, mint a Hétforrás vagy a Stájer-házak. Kőszeg városa a hegység lábánál fekszik, és történelme elválaszthatatlan a hegyek védelmétől. A Kőszegi Tájvédelmi Körzet részeként a terület gazdag ritka orchideákban, havasi növényekben és az erdők csendjét kedvelő nagyvadakban. Földrajz K7 – az Alpok és a Kárpát-medence találkozása, magashegységi hatások.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/mountain-koszegi-hegyseg-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Őrség erdői Magyarország legnyugatibb csücskében, a Vas vármegyei dombvidéken terülnek el, és hazánk egyik legérintetlenebb természeti tájának szívét alkotják. Ez a vidék az Őrségi Nemzeti Park része, ahol a dús fenyvesek, a gyertyános-tölgyesek és a vizenyős rétek mozaikja különleges, nyugodt atmoszférát teremt. Az Őrség elnevezés a középkori határőrizeti funkcióra utal, amikor az itt élők 'őrállók' voltak, és a tájat is eszerint alakították ki a jellegzetes szeres településszerkezettel. Az erdők mélyén olyan ritka fajok élnek, mint a fekete gólya, a darázsölyv és a különböző orchideafajok, míg a gombákban való gazdagsága országosan egyedülálló. Az Őrségi-erdő nemcsak természeti kincs, hanem kulturális menedék is, ahol a hagyományos gazdálkodás és a természet tisztelete a mai napig kéz a kézben jár. Biológia K6 – erdőségek típusai, biodiverzitás és a fenntartható erdőgazdálkodás.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/forest-orsegi-erdo-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Gyöngyös-patak a Kőszegi-hegység legjelentősebb vízfolyása, amely az Alpok osztrák oldalán ered, majd Kőszeg városán keresztülhaladva érkezik meg a magyar síkságra. A patak vize kristálytiszta és gyors folyású, ami az alpesi eredetének köszönhető, és meghatározza Kőszeg és környékének mikroklímáját. A patak mentén épült ki a város történelmi magja, ahol a víz egykor a várárkokat táplálta és malmokat hajtott. A Gyöngyös-patak völgye fontos ökológiai folyosó, amely összeköti a hegyvidéki erdőket a Rába-síksággal, gazdag élőhelyet biztosítva a pisztrángoknak és a jégmadaraknak. A patak partján kialakított sétányok és parkok a város legszebb részei, ahol a látogatók a természet közelségét élvezhetik a történelmi falak tövében. Földrajz K6 – hegyi patakok jellemzői, eróziós munka és a víz szerepe a városszerkezetben.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/river-gyongyos-patak-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Írott-kő (németül Geschriebenstein) a Kőszegi-hegység és egyben a Dunántúl legmagasabb pontja, 882 méteres magasságával. Ez a csúcs nemcsak földrajzi, hanem szimbolikus jelentőséggel is bír: a tetején álló kőkilátó pontosan a magyar-osztrák államhatáron fekszik, így a látogatók egyetlen lépéssel országhatárt válthatnak. Nevét a hagyomány szerint egy egykori feliratos határkőről kapta, amely a Batthyány és az Esterházy birtokok határát jelölte. Az Írott-kő az Országos Kéktúra nyugati végpontja, így a magyar természetjárás ikonikus helyszíne. A csúcsot övező hatalmas bükk- és fenyőerdők, a tiszta hegyi levegő és a kilátóból elénk táruló panoráma – amely tiszta időben egészen a Fertő-tóig és az osztrák Alpokig ellát – felejthetetlen élményt nyújt minden túrázónak. Földrajz K7 – határmenti hegyvidékek, a Dunántúl domborzata és a gyalogos turizmus jelentősége.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
  ...
  // HU-VE: Veszprém
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Somló, a 'nászéjszakák bora' hazája, a Bakony és a Kisalföld határán magányosan emelkedő vulkanikus tanúhegy. Jellegzetes, koporsó alakú sziluettje már messziről felismerhető a síkságból. A hegy oldalai teraszosan beültetett szőlőkkel vannak teli, ahol az ország egyik legkisebb, de legnevesebb borvidéke található. A Somlói bor különlegességét a vulkáni bazalt talaj adja, amely ásványos, tüzes és hosszú ideig eltartható fehérborokat (pl. Juhfark) eredményez. A hegy tetején a Somlói vár romjai magasodnak, ahonnan pazar kilátás nyílik a Kisalföldre és a Balaton-felvidékre. A terület nemcsak gazdasági, hanem természeti érték is: a bazaltsziklák és a karsztbokorerdők számos ritka fajnak nyújtanak menedéket. A Somló egy igazi spirituális és gasztronómiai központ, ahol a táj és az emberi munka harmonikus egysége érezhető. Földrajz K8 – tanúhegyek kialakulása, vulkanizmus és a történelmi borvidékek földrajza.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      ...
      hu: ["A Somló magassága 431 méter, és egy körülbelül 3-5 millió évvel ezelőtti vulkánkitörés eredménye.", "Ez Magyarország legkisebb borvidéke, mindössze 600 hektárnyi szőlőterülettel.", "A hegy tetején álló vár a 14. században épült, és fontos stratégiai pont volt a török korban.", "A bazaltorgonák és sziklaalakzatok a hegy északi oldalán a leglátványosabbak.", "Itt található a Szent István-kilátó, amelyet a magyar államalapítás 950. évfordulójára építettek.", "A terület a Balaton-felvidéki Nemzeti Park része, fokozottan védett növényekkel (pl. fekete kökörcsin).", "Híres mondás szerint a somlói Juhfark elfogyasztása fiúgyermek születését segíti elő.", "A hegy lábánál található a híres somlóvásárhelyi borászati központ."],
      ro: [],
      en: []
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Szent György-hegy a Balaton-felvidék egyik legszebb és leglátványosabb tanúhegye, amely a Tapolcai-medence közepén emelkedik. Világhírét a hegy északi oldalán található monumentális bazaltorgonáinak köszönheti, amelyek akár 30-40 méter magas, szabályos sokszögletű oszlopokként sorakoznak a meredek lejtőn. A hegy déli lejtői a napsütés és a bazalt talaj jótékony hatása miatt kiváló szőlőtermő vidékek, ahol a Badacsonyhoz hasonlóan tüzes fehérborok teremnek. A Szent György-hegy nemcsak geológiai látványosság, hanem spirituális és történelmi helyszín is: számos barokk kápolna (pl. Lengyel-kápolna) és népi építészeti emlék díszíti az oldalát. A csúcsról nyíló panoráma – rálátással a Balaton víztükrére és a környező tanúhegyekre – Magyarország egyik legszebb kilátása. Földrajz K6 – tanúhegyek, oszlopos bazalt kialakulása és a pannon-tenger emlékei.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/mountain-szent-gyorgy-hegy-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Tapolcai-tavasbarlang egyedülálló természeti képződmény, amely a Balaton-felvidéken, Tapolca városa alatt húzódik. Ez az ország egyik legkülönlegesebb barlangja, ahol a látogatók csónakba szállva fedezhetik fel a mészkőbe vájt járatokat a kristálytiszta, azúr kék víz felett. A barlangot 1903-ban, kútásás közben fedezték fel véletlenül, és hamar világhírűvé vált turisztikai attrakcióként. A víz hőmérséklete állandóan 18-20 fok körüli, amit a mélyből feltörő meleg vizek és a felszíni hidegebb vizek keveredése okoz. A barlang levegője rendkívül tiszta és magas páratartalmú, ami bizonyítottan gyógyhatású a légzőszervi betegségekre – ezért a barlangrendszer egyik ága gyógybarlangként is funkcionál. A barlang felett interaktív látogatóközpont mutatja be a karsztvidékek titkait és a víz alatti világ élővilágát. Földrajz K7 – karsztjelenségek, barlangképződés és a gyógyvíz szerepe.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/lake-tapolca-tavasbarlang-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Cuha-patak a Bakony hegység legvadregényesebb vízfolyása, amely mély, sziklás szurdokvölgyet vájt a mészkőbe Veszprém és Győr-Moson-Sopron vármegyék határán. A Cuha-völgy nemcsak a természetjárók kedvence a meredek sziklafalaival és a patakon átvezető gázlóival, hanem az ipari műemlékvédelem egyik ékköve is: itt halad keresztül a Győr-Veszprém vasútvonal (a Bakonyvasút) legszebb szakasza. A vasút monumentális viaduktokon és alagutakon keresztül kanyarog a szurdok oldalában, miközben a patak vize alattunk zúg a mélyben. A völgy különleges mikroklímája kedvez a ritka hegyi növényeknek és a bükkerdőknek. A túrázók számára felejthetetlen élményt nyújt a patak mentén haladó ösvény, amely többször is keresztezi a vizet, próbára téve az ügyességet. Földrajz K6 – völgyképződés, szurdokvölgyek és a közlekedési útvonalak műszaki megoldásai a hegységben.",
      ro: "",
      en: ""
    },
    factsAdvanced: {
