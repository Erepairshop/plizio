...
export const poiExtraBulgariaCities: POI[] = [
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Szófia, Bulgária fővárosa és legnagyobb városa, lendületes metropolisz a fenséges Vitosa-hegység lábánál, ahol a többezer éves történelem és a modern életstílus találkozik. A város gyökerei a thrákok szerd törzséig nyúlnak vissza, ezzel Szófia Európa egyik legrégebbi települése. A belvárosban található a híres „vallási tolerancia tere”, ahol egy ortodox templom, egy mecset, egy zsinagóga és egy katolikus székesegyház áll egymás közvetlen szomszédságában. A város ásványvízforrásairól is ismert, amelyeket részben szabadon lehet használni, és amelyeket már a rómaiak is értékeltek. Szófia az ország politikai, kulturális és gazdasági szíve, gazdag múzeumi és galériakínálattal. Földrajzi adottságai miatt egyszerre tökéletes kiindulópont a városnézéshez és a környező hegyek felfedezéséhez.",
      ro: "Sofia, capitala și cel mai mare oraș al Bulgariei, este o metropolă dinamică situată la poalele maiestuosului munte Vitosha, unde mii de ani de istorie se împletesc cu un stil de viață modern. Originile orașului datează din vremea tracilor serdi, ceea ce face din Sofia unul dintre cele mai vechi orașe ale Europei. Vizitatorii pot descoperi celebra „Piață a Toleranței Religioase”, unde o biserică ortodoxă, o moschee, o sinagogă și o catedrală catolică se află la doar câțiva pași una de cealaltă. Orașul este cunoscut pentru izvoarele sale minerale, multe dintre ele accesibile publicului în mod gratuit și folosite încă din epoca romană. Sofia este inima administrativă, culturală și economică a țării, oferind o rețea bogată de muzee, galerii și parcuri. Poziția sa o transformă în baza ideală atât pentru explorări urbane, cât și pentru aventuri în munții din apropiere.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "Szófia egyike azon kevés európai fővárosoknak, amelyek határain belül magashegység található (Vitosa, 2290 m).",
        "A város mottója „Növekszik, de nem öregszik”, melyet 1911-ben fogadtak el hivatalosan.",
        "Szófia több mint 7000 éve folyamatosan lakott település, Európa egyik legősibb városa.",
        "A városban és környékén több mint 30 ásványvízforrás tör fel, köztük olyanok is, melyeket már a rómaiak használtak.",
        "Az Alekszandr Nyevszkij-székesegyház a világ egyik legnagyobb ortodox temploma, 5000 hívőt képes befogadni.",
        "550 méteres tengerszint feletti magasságával Szófia Madrid után az Európai Unió második legmagasabban fekvő fővárosa.",
        "A mai utcák alatt található Serdica római város maradványai, amelyek részben a metróállomásoknál is megtekinthetők.",
      ...
      ro: [
        ...
        "Motto-ul orașului este „Crește, dar nu îmbătrânește”, adoptat oficial în anul 1911.",
        "Sofia este locuită neîntrerupt de peste 7.000 de ani, fiind unul dintre cele mai vechi orașe din Europa.",
        "În oraș și în împrejurimi există peste 30 de izvoare minerale, unele utilizate încă din vremea romanilor.",
        "Catedrala Alexandru Nevski este una dintre cele mai mari catedrale ortodoxe din lume, putând găzdui 5.000 de credincioși.",
        "Situată la 550 de metri altitudine, Sofia este a doua cea mai înaltă capitală din Uniunea Europeană, după Madrid.",
        "Sub străzile moderne se află rămășițele orașului roman Serdica, vizibile parțial în zona stațiilor de metrou.",
        "Numele Sofia provine de la biserica Sfânta Sofia, ridicată în secolul al IV-lea, una dintre cele mai vechi biserici din oraș."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Plovdiv hihetetlenül régi város, amelyet gyakran Európa legrégebb óta folyamatosan lakott településének tartanak, több mint 8000 éves múlttal. A Marica folyó mellett, hét dombra épült város jelentős kereskedelmi kereszteződés volt a thrákok, rómaiak, bizánciak és oszmánok számára. Az óváros építészeti gyöngyszem: 19. századi újjászületés-kori házak, macskaköves utcák és a lenyűgöző római színház teszi különlegessé. 2019-ben Plovdiv volt Európa Kulturális Fővárosa, ami felkerült a Kapana kreatív negyed és a sokszínű művészeti élet a térképre. Az ősi romok – köztük a stadion és a fórum – mára élénk, fiatalos hangulattal keverednek. Plovdiv egyúttal a Rodope-hegység kapuja, így a történelemkedvelők és a városi utazók egyaránt megtalálják benne a számításukat.",
      ro: "Plovdiv este un oraș cu o longevitate impresionantă, considerat adesea cel mai vechi oraș locuit neîntrerupt din Europa, cu o istorie ce se întinde pe peste 8.000 de ani. Construit pe șapte coline de-a lungul râului Marița, a fost o răscruce importantă pentru traci, romani, bizantini și otomani. Centrul vechi este o bijuterie arhitecturală, cu case colorate din perioada Renașterii bulgare, străzi pavate cu piatră cubică și magnificul Teatru Roman Antic. În 2019, Plovdiv a fost Capitală Europeană a Culturii, ocazie cu care cartierul creativ Kapana și scena artistică diversă au atras atenția internațională. Ruinele antice — inclusiv stadionul și forul — se îmbină acum cu o atmosferă tânără și plină de viață. Plovdiv este, în plus, poarta către Munții Rodopi, fiind o destinație îndrăgită atât de pasionații de istorie, cât și de călătorii moderni.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "Plovdiv idősebb Rómánál és Athénnél, az első települések nyomai mintegy 6000 évre nyúlnak vissza Krisztus előtt.",
        ...
        "A belvárosi római stadion egykor 30 000 nézőnek adott helyet az atlétikai versenyeken.",
        "A Kapana negyed Bulgária első hivatalos kreatív negyede, számos galériával és kézműves bolttal.",
        ...
        "A város fősétálóutcája csaknem 1,8 km hosszú, ezzel Európa egyik leghosszabb sétálóutcája."
      ],
      ro: [
        "Plovdiv este mai vechi decât Roma și Atena, primele așezări datând din jurul anului 6.000 î.Hr.",
        "Orașul a fost construit inițial pe șapte coline de sienit, dintre care astăzi se mai disting clar șase.",
        "Teatrul Roman din Philippopolis, construit în secolul al II-lea d.Hr., este unul dintre cele mai bine conservate din lume.",
        "Stadionul Roman din centru găzduia odinioară 30.000 de spectatori la jocurile sportive.",
        "Kapana este primul cartier creativ oficial din Bulgaria, plin de galerii de artă și ateliere de meșteșuguri.",
        "Orașul a fost cunoscut ca Philippopolis după ce regele Filip al II-lea al Macedoniei l-a cucerit în 342 î.Hr.",
        "Colina Nebet Tepe păstrează ruinele celei mai vechi așezări trace de pe acest sit.",
        "Strada principală pietonală a orașului are aproape 1,8 km, fiind una dintre cele mai lungi din Europa."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Várnát gyakran „Bulgária tengeri fővárosaként” emlegetik; a bolgár Fekete-tenger partjának legnagyobb városa, valamint fontos gazdasági és kulturális központ. A Várnai nekropolisz révén világhírű lett: itt találták meg a történelem legrégebbi feldolgozott aranykincsét, amely több mint 6000 éves. Az ókori kincsek mellett Várna egyszerre nyüzsgő kikötőváros és népszerű tengerparti üdülőhely. A kiterjedt Tengeri-kert a Balkán egyik legnagyobb városi parkja, akváriummal, planetáriummal és tengerre nyíló panorámával. Az impozáns Istenanya elszenderedése-székesegyház, valamint Európa egyik legnagyobb fennmaradt római fürdője, az ókori thermae szintén kiemelt látnivalók. Élénk fesztiváljaival, homokos strandjaival és gazdag tengeri történelmével Várna a kikapcsolódást és a történelmi felfedezést kedvelőket egyaránt vonzza.",
      ro: "Varna, numită adesea „capitala maritimă a Bulgariei”, este cel mai mare oraș de pe litoralul bulgar al Mării Negre și un important centru economic și cultural. Orașul este celebru în întreaga lume datorită Necropolei de la Varna, unde a fost descoperit cel mai vechi aur prelucrat din istorie, cu o vechime de peste 6.000 de ani. Pe lângă comorile sale antice, Varna combină energia unui oraș-port aglomerat cu farmecul unei stațiuni de litoral foarte populare. Întinsa Grădină a Mării este unul dintre cele mai mari parcuri amenajate din Balcani, cu acvariu, planetariu și priveliști spectaculoase la mare. Impresionanta Catedrală a Adormirii Maicii Domnului și Termele Romane antice, printre cele mai mari din Europa, completează patrimoniul vizibil al orașului. Cu festivaluri animate, plaje întinse de nisip și o istorie maritimă bogată, Varna atrage atât turiști în căutare de relaxare, cât și pasionați de istorie.",
    ...
    factsAdvanced: {
      ...
      hu: [
        ...
        "A várnai római fürdő Európa negyedik legnagyobb fennmaradt római termája.",
      ...
      ro: [
        "Tezaurul de aur de la Varna, descoperit în 1972, cuprinde 3.000 de obiecte și este cel mai vechi aur prelucrat din lume (4.600–4.200 î.Hr.).",
        "Termele Romane din Varna sunt al patrulea cel mai mare complex termal roman conservat din Europa.",
        "Parcul Grădina Mării a fost proiectat la sfârșitul secolului al XIX-lea de grădinarul ceh Anton Novák.",
        "Varna găzduiește comandamentul Marinei Bulgare și al flotei comerciale.",
        "Orașul a fost fondat ca o colonie grecească numită Odessos în jurul anului 570 î.Hr.",
        "Lacul Varna este cel mai adânc și mai mare liman de pe coasta bulgară a Mării Negre.",
        "Festivalul Internațional „Vara la Varna” este cel mai vechi festival muzical din Bulgaria, înființat în 1926.",
        "Catedrala Adormirii Maicii Domnului, ridicată în 1886, este a doua ca mărime din Bulgaria."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Burgasz a déli bolgár Fekete-tenger partvidékének lüktető kapuja, amely jelentős ipari központi szerepét gazdag kulturális és természeti kínálattal egyensúlyozza ki. A várost három tó – Atanaszovo, Burgaszi-tó és Mandra – öleli körül, amelyek a Via Pontica vonulásrendszer fontos ökológiai folyosói. A városi élet központja a Tengeri-kert, gondosan ápolt parti park, ahonnan páratlan kilátás nyílik a Burgaszi-öbölre. Az év során számos nemzetközi eseménynek ad otthont, köztük a látványos homokszobor-fesztiválnak és a Spirit of Burgas zenei fesztiválnak. Délkelet-Európa legnagyobb olajfinomítójával és stratégiai mélyvízi kikötőjével a város a nemzetgazdaság egyik tartópillére. Modern sétálóutcái és Neszebár UNESCO-örökség közelsége sokoldalú úti céllá teszik üzleti és turisztikai célokra egyaránt.",
      ro: "Burgas este poarta vibrantă către coasta sudică a Mării Negre din Bulgaria, îmbinând rolul de important centru industrial cu un bogat profil cultural și natural. Orașul este înconjurat în mod unic de trei lacuri — Atanasovsko, Burgas și Mandra — coridoare ecologice esențiale pentru păsările migratoare aflate pe ruta Via Pontica. Inima vieții urbane este Grădina Mării, un parc costier amenajat cu grijă, oferind priviri panoramice asupra Golfului Burgas. De-a lungul anului, orașul găzduiește numeroase evenimente internaționale, inclusiv spectaculosul Festival al Sculpturilor în Nisip și festivalul Spirit of Burgas. Cu cea mai mare rafinărie de petrol din sud-estul Europei și un port strategic de adâncime, orașul este un pilon al economiei naționale. Zonele pietonale moderne și apropierea de Nesebărul aflat în patrimoniul UNESCO fac din Burgas o destinație versatilă pentru afaceri și turism deopotrivă.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "A Burgaszi-tórendszer Bulgária legnagyobb vizes élőhelye, mintegy 95 négyzetkilométeren terül el.",
        "Az Atanaszovo-tónál több mint 317 madárfaj figyelhető meg, ami a Bulgáriában előforduló fajok több mint 70%-a.",
        "A Burgaszi kikötő a teljes árumozgás alapján Bulgária legnagyobb tengeri kikötője.",
        "A burgaszi homokszobor-fesztiválon évente több mint 2500 tonna speciális homokot használnak fel.",
        "Burgasz volt az első bolgár város, amely integrált közbringa-rendszert vezetett be.",
        "A Tengeri-kert mintegy 72 hektáron húzódik a tengerpart mentén.",
        "A Burgaszi repülőtér főszezonban több mint 3 millió utast szolgál ki, fontos charterközpont.",
        "Szent Anasztázia szigete, a parttól 6 km-re, az egyetlen lakott sziget a bolgár Fekete-tenger felségvizein."
      ],
      ro: [
        "Lacurile din Burgas formează cel mai mare complex de zone umede din Bulgaria, acoperind aproximativ 95 de kilometri pătrați.",
        "La Lacul Atanasovsko pot fi observate peste 317 specii de păsări, adică mai mult de 70 % din toate speciile din Bulgaria.",
        "Portul Burgas este cel mai mare port maritim din Bulgaria după volumul total de marfă.",
        "Festivalul Sculpturilor în Nisip de la Burgas folosește în fiecare vară peste 2.500 de tone de nisip special.",
        "Burgas a fost primul oraș bulgar care a introdus un sistem integrat public de bike-sharing.",
        "Grădina Mării se întinde pe aproximativ 72 de hectare de-a lungul coastei.",
        "Aeroportul Burgas gestionează peste 3 milioane de pasageri în vârf de sezon și este un important hub charter.",
        "Insula Sfânta Anastasia, situată la 6 km de coasta orașului Burgas, este singura insulă locuită din Marea Neagră bulgară."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Veliko Tarnovo, a „cárok városa”, Bulgária egyik leglátványosabb települése: három dombra épült, magasan a kanyargó Jantra folyó fölött. A Második Bolgár Birodalom (1185–1396) egykori fővárosaként a Balkán fontos politikai és kulturális központja volt. A városképet a hatalmas Carevec erőd uralja, amely valaha a királyi palotának és a patriarkátusnak adott otthont. A történelmi negyed szűk, macskaköves utcáit hagyományos újjászületés-kori házak és kézműves műhelyek szegélyezik a híres Szamovodszka Csarsijában. Minden este a Carevec-domb látványos hang- és fényjáték keretében elevenedik meg, mely a bolgár állam viharos történelmét meséli el. Veliko Tarnovo a bolgár nemzeti büszkeség jelképe maradt, középkori pompájával és egyedülálló teraszos építészetével vonzza a látogatókat.",
      ro: "Veliko Târnovo, „Orașul Țarilor”, este unul dintre cele mai spectaculoase orașe ale Bulgariei, situat dramatic pe trei coline deasupra meandrelor râului Yantra. Fostă capitală a celui de-al Doilea Țarat Bulgar (1185–1396), a fost un important centru politic și cultural al Balcanilor. Orașul este dominat de impunătoarea Cetate Tsarevets, care odinioară găzduia palatul regal și patriarhia. Districtul istoric este străbătut de străduțe înguste pavate cu piatră, mărginite de case tradiționale din perioada Renașterii bulgare și ateliere meșteșugărești pe celebra Samovodska Charshiya. În fiecare seară, dealul Tsarevets prinde viață printr-un spectaculos show de sunet și lumini care narează istoria zbuciumată a statului bulgar. Veliko Târnovo rămâne un simbol al identității și mândriei naționale bulgare, atrăgând vizitatorii prin grandoarea sa medievală și arhitectura sa unică în terase.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "Veliko Tarnovóban dolgozták ki 1879-ben az első bolgár alkotmányt (Tarnovói alkotmány).",
        "A Carevec-erőd fala eredetileg több mint 1100 méter hosszú és helyenként 3 méter vastag volt.",
        ...
        "A Szamovodszka Csarsija piac a 19. század óta a hagyományos kézművesség, a fazekasság és a rézművesség központja.",
        "A városban működő Szent Cirill és Metód Egyetem Bulgária második legnagyobb egyeteme."
      ],
      ro: [
        "La Veliko Târnovo a fost redactată în 1879 prima Constituție a Bulgariei (Constituția de la Târnovo).",
        "Zidul Cetății Tsarevets avea inițial peste 1.100 de metri lungime și până la 3 metri grosime.",
        "Râul Yantra formează trei peninsule distincte în jurul colinelor Tsarevets, Trapezitsa și Sveta Gora.",
        "În secolul al XIV-lea, orașul era descris drept „al doilea oraș după Constantinopol” ca frumusețe și putere.",
        "Catedrala Patriarhală de pe colina Tsarevets are fresce moderne unicate, pictate în 1985.",
        "În oraș se păstrează peste 40 de biserici din perioada medievală și a Renașterii bulgare.",
        "Piața Samovodska Charshiya este, încă din secolul al XIX-lea, un centru pentru meșteșuguri tradiționale precum olăritul și aramăria.",
        "Universitatea „Sfinții Chiril și Metodiu” din oraș este a doua ca mărime din Bulgaria."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Vidin Bulgária északnyugati határvidékének történelmi kapuja, a Duna déli partján fekvő város. Ékszere a Baba Vida erőd – az ország egyetlen teljesen épen maradt középkori vára –, melyet vizesárok és kettős falgyűrű védelmezett évszázadokon át. Történelmileg Vidin a Bononia néven ismert jelentős római központ, később a Vidini Cárság fővárosa volt. Ma nyugodt folyóparti hangulatot kínál tágas dunai parkjával és a lenyűgöző Duna-híd 2-vel, amely Bulgáriát a romániai Calafattal köti össze. A város építészeti öröksége tükrözi multikulturális múltját: a méltóságteljes Szent Demeter-székesegyház – Bulgária második legnagyobb temploma – és egy 19. századi pompás zsinagóga romjai egyaránt láthatók. A Duna mentén utazók számára Vidin nélkülözhetetlen állomás, ahol a katonai történelem és a folyóparti szépség egyedi módon találkozik.",
      ro: "Vidin este o poartă istorică situată în extremitatea de nord-vest a Bulgariei, pe malul sudic al Dunării. Bijuteria orașului este Cetatea Baba Vida — singurul castel medieval păstrat integral din țară, cu șanțuri impunătoare și ziduri duble care au apărat regiunea timp de secole. Din punct de vedere istoric, Vidin a fost un important centru roman numit Bononia, iar mai târziu capitala Țaratului de Vidin. Astăzi, orașul oferă o experiență liniștită pe faleza Dunării, cu un parc întins și impresionantul Pod 2 al Dunării, care conectează Bulgaria cu Calafat, în România. Patrimoniul arhitectural reflectă trecutul multicultural: maiestuoasa Catedrală Sfântul Dumitru — a doua ca mărime din Bulgaria — și ruinele unei sinagogi grandioase din secolul al XIX-lea. Pentru turiștii care explorează ruta Dunării, Vidin este o oprire esențială, prin combinația unică de istorie militară și frumusețe fluvială.",
    ...
    factsAdvanced: {
      de: [
        ...
        "Im historischen Stadtkern befinden sich eine gut erhaltene Kreuzmoschee und eine Bibliothek aus der Zeit von Osman Pazvantoğlu.",
      ...
      hu: [
        "A Baba Vida erőd a Bononia nevű ókori római erőd romjaira épült.",
        ...
        "Vidin a 14. század végén Ivan Sztracimir alatt a független Vidini Cárság fővárosa volt.",
        ...
        "A Castra Martis római romok mindössze 30 km-re találhatók Vidintől, Kula településen."
      ],
      ro: [
        "Cetatea Baba Vida a fost ridicată pe ruinele vechii fortărețe romane Bononia.",
        "Podul 2 al Dunării, deschis în 2013, are o lungime de 1.971 de metri și suportă atât trafic rutier, cât și feroviar.",
        "Catedrala Sfântul Dumitru din Vidin este al doilea cel mai mare lăcaș de cult creștin din Bulgaria, după Sfântul Alexandru Nevski din Sofia.",
        "Vidin a fost capitala Țaratului independent de Vidin sub Ivan Stratsimir, la sfârșitul secolului al XIV-lea.",
        "Sinagoga din Vidin, construită în 1894 în stil neogotic, era cândva a doua ca mărime din Bulgaria.",
        "Centrul istoric păstrează o moșchee în formă de cruce și o bibliotecă ridicate de Osman Pazvantoğlu.",
        "Parcul Dunavski este unul dintre cele mai vechi parcuri din țară, amenajat la sfârșitul secolului al XIX-lea.",
        "Ruinele romane Castra Martis se află la doar 30 km de Vidin, în orașul Kula."
      ],
      en: [
        ...
        "The city's historic core contains a well-preserved cross-shaped mosque and library built by Osman Pazvantoğlu.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Vraca a Vracsanszki Balkán Natúrpark kapuja, és Bulgária északnyugati részének kiemelkedő úti célja sziklamászók és természetkedvelők számára. A várost a Vracata-szurdok függőleges sziklafalai uralják, melyek mészkőfalai akár 400 méter magasra emelkednek. A térség történelmileg trák törzsek erőssége volt, a helyi Régiótörténeti Múzeum büszkesége pedig a Rogozeni kincs, a valaha feltárt legnagyobb trák aranylelet. A látogatókat vonzza a közeli Ledenika-barlang is, amely jégformációiról és lenyűgöző karszti akusztikájáról ismert. A város a hegymászás központja, számos ösvénnyel a Balkán magas csúcsai felé. Vraca egyedülálló módon ötvözi a zord alpesi környezetet a gazdag történelmi örökséggel, sajátos élményt kínálva a tengerparti üdülőhelyektől távol.",
      ro: "Vratsa este recunoscut ca poartă către Parcul Natural Vrachanski Balkan, fiind o destinație de top pentru alpiniști și iubitori de natură din nord-vestul Bulgariei. Orașul este dominat dramatic de pereții verticali ai Defileului Vratsata, ai cărui pereți de calcar urcă până la 400 de metri înălțime. Din punct de vedere istoric, zona a fost o bază a triburilor trace, iar Muzeul Regional de Istorie expune cu mândrie Tezaurul de la Rogozen, cea mai mare descoperire de aur trac de până acum. Vizitatorii sunt atrași și de Peștera Ledenika din apropiere, vestită pentru formațiunile sale de gheață și pentru acustica karstică impresionantă. Orașul este un punct central pentru alpinism, cu numeroase trasee ce urcă spre crestele înalte ale Balcanilor. Vratsa îmbină în mod unic peisajul alpin abrupt cu o moștenire istorică bogată, oferind o experiență distinctivă, departe de stațiunile de pe litoral.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "A Vracata-szurdokban a Balkán-félsziget legmagasabb függőleges mészkőfalai találhatók.",
        "Az 1986-ban előkerült Rogozeni kincs 165 ezüst és aranyozott edényből áll, össztömege 20 kg.",
        "A Ledenika-barlang 320 méter hosszú, és egész évben -7 és 15 °C közötti hőmérsékletet tart.",
        "A város neve a „vrata” (ajtó, kapu) szóból ered, mely a szűk hegyi szorosra utal.",
        "Vraca a 19. században a bolgár nemzeti újjászületés egyik jelentős központja volt.",
        "A közeli Szkaklja-vízesés 141 méteres esésével Bulgária legmagasabb időszakos vízesése.",
        "A Vracsanszki Balkán Natúrpark körülbelül 30 000 hektáron terül el.",
        "A városban évente megrendezik a Botev-napokat Hriszto Botev nemzeti hős emlékére, aki a környező hegyekben esett el."
      ],
      ro: [
        "Defileul Vratsata găzduiește cei mai înalți pereți verticali de calcar din Peninsula Balcanică.",
        "Tezaurul de la Rogozen, descoperit în 1986, conține 165 de vase din argint și placate cu aur, cântărind 20 kg.",
        "Peștera Ledenika are 320 de metri lungime și păstrează tot anul temperaturi între -7 și 15 °C.",
        "Numele orașului provine din cuvântul „vrata”, care înseamnă „ușă” sau „poartă”, în referire la pasul îngust dintre munți.",
        "Vratsa a fost un important centru al Renașterii naționale bulgare în secolul al XIX-lea.",
        "Cascada Skaklya, situată în apropiere, este cea mai înaltă cascadă intermitentă din Bulgaria, cu o cădere de 141 de metri.",
        "Parcul Natural Vrachanski Balkan se întinde pe aproximativ 30.000 de hectare.",
        "În oraș se desfășoară anual Zilele Botev, festival dedicat eroului național Hristo Botev, căzut în munții din apropiere."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Sumen mély történelmi büszkeséggel teli város Bulgária északkeleti részén, stratégiai helyen, a bolgár állam születésének közelében. Leghíresebb látnivalója a „Bolgár Állam Alapítói” emlékmű, egy hatalmas brutalista alkotás a Sumeni-fennsíkon, amely szinte a régió bármely pontjáról látszik. Sumen Pliszka és Preszlav, az első és második bolgár főváros mellett egy erős védelmi háromszög része volt; mindkettő romjai könnyen elérhetők a városból. A közeli sziklán álló Sumeni erőd a vaskortól a középkorig kínál régészeti betekintést. A városban található a Tombul-mecset is, Bulgária legnagyobb mecsete és az oszmán barokk építészet kiemelkedő példája. Ókori romok, középkori erődítmények és monumentális modern építészet ötvözeteként Sumen kulcspont a bolgár nemzet születésének és fejlődésének megértéséhez.",
      ro: "Shumen este un oraș cu o profundă mândrie istorică, situat strategic în nord-estul Bulgariei, aproape de locurile de origine ale statului bulgar. Este cunoscut mai ales pentru monumentul „Fondatorii Statului Bulgar”, o structură masivă în stil brutalist de pe Platoul Shumen, vizibilă aproape din orice punct al regiunii. Din punct de vedere istoric, Shumen forma împreună cu Pliska și Preslav, primele două capitale bulgare, un puternic triunghi defensiv, ale cărui ruine sunt ușor accesibile din oraș. Cetatea Shumen, situată pe o stâncă din apropiere, oferă o panoramă arheologică ce se întinde din epoca fierului până în Evul Mediu. Orașul găzduiește și Moscheea Tombul, cea mai mare moschee din Bulgaria și un exemplu remarcabil de arhitectură barocă otomană. Cu acest amestec de ruine antice, fortărețe medievale și arhitectură monumentală modernă, Shumen este un punct central pentru înțelegerea nașterii și evoluției națiunii bulgare.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "A „Bolgár Állam Alapítói” emlékművet 1981-ben állították, az ország 1300. évfordulójára.",
        "A Tombul-mecset (Serif Halil pasa mecsete) Bulgária legnagyobb mecsete, és a Balkánon a második legnagyobb.",
        "A Sumeni erőd több mint 3000 éve lakott, kezdve a korai trákoktól.",
        "A Madarai lovas, az UNESCO-világörökség része, mindössze 15 km-re fekszik Sumentől.",
        "A 19. század közepén Sumenben tartották az első bolgár színielőadást, és itt alakult meg az első bolgár zenekar is.",
        "Az 1882-ben alapított Sumeni sörfőzde Bulgária egyik legrégebbi sörfőzdéje.",
        "A Sumeni-fennsík védett természetvédelmi park, több mint 60 mészkőbarlanggal.",
        "Pliszka, az Első Bolgár Birodalom első fővárosa, mindössze 25 km-re fekszik északkeletre a várostól."
      ],
      ro: [
        "Monumentul „Fondatorii Statului Bulgar” a fost construit în 1981, pentru a marca 1.300 de ani de la întemeierea țării.",
        "Moscheea Tombul (Moscheea Sherif Halil Pașa) este cea mai mare din Bulgaria și a doua ca mărime din Balcani.",
        "Cetatea Shumen este locuită de peste 3.000 de ani, începând cu tracii timpurii.",
        "Călărețul de la Madara, sit al Patrimoniului Mondial UNESCO, se află la doar 15 km de Shumen.",
        "La Shumen a avut loc, la mijlocul secolului al XIX-lea, prima reprezentație teatrală bulgară și a luat ființă prima orchestră bulgară.",
        "Berăria Shumen, înființată în 1882, este una dintre cele mai vechi din Bulgaria.",
        "Platoul Shumen este o rezervație naturală cu peste 60 de peșteri în calcar.",
        "Pliska, prima capitală a Primului Țarat Bulgar, se află la numai 25 km nord-est de oraș."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Dobrics a Dobrudzsa régió vitathatatlan közigazgatási és gazdasági fővárosa, kiterjedt, termékeny síkságai miatt gyakran Bulgária magtárának nevezik. Történelmileg a város fontos kereszteződés volt a Duna és a Fekete-tenger közötti kereskedelmi utak mentén. Egyik legmegragadóbb látnivalója a „Régi Dobrics” néprajzi szabadtéri múzeum, ahol a látogatók a 19. századi városi környezetbe helyezve élvonalbeli kézműves szakmákat – szövést, rézművességet és más hagyományos mesterségeket – figyelhetnek meg élőben. A városban található a Szent György városi park is, Bulgária egyik legrégebbi és legnagyobb zöldterülete, melyet 1867-ben alapítottak. Dobrics identitása erősen kötődik az agrárhagyományokhoz, amit múzeumai és sajátos regionális konyhája is tükröz. Akik a bolgár alföld autentikus életét keresik, Dobricsban csendes, mégis kulturálisan gazdag alternatívát találnak a tengerparti üdülőhelyek helyett.",
      ro: "Dobrich este capitala administrativă și economică incontestabilă a regiunii Dobrogea, denumită adesea grânarul Bulgariei datorită câmpiilor sale fertile. Din punct de vedere istoric, orașul a fost o răscruce esențială pentru comerțul dintre Dunăre și Marea Neagră. Una dintre cele mai captivante atracții este Muzeul Etnografic în aer liber „Vechiul Dobrich”, unde vizitatorii pot urmări meșteșuguri tradiționale, de la țesut la prelucrarea aramei, într-un cadru urban restaurat din secolul al XIX-lea. Orașul găzduiește și Parcul Sfântul Gheorghe, unul dintre cele mai vechi și mai mari spații verzi din Bulgaria, înființat în 1867. Identitatea orașului Dobrich este profund legată de tradițiile agricole, lucru reflectat în muzeele sale și în bucătăria regională distinctă. Pentru călătorii care caută o experiență autentică a câmpiei bulgare, Dobrich oferă o alternativă liniștită, dar bogată cultural, la stațiunile de pe litoral.",
    ...
    factsAdvanced: {
      ...
      hu: [
        ...
        "A Szent György városi park 25 hektáron terül el, és Bulgária egyik első tervezett parkja volt.",
        "Dobricsban található Jordan Jovkov emlékháza, aki Bulgária egyik legjelentősebb írója volt.",
        "A „Régi Dobrics” néprajzi múzeumban 18 különféle kézműves műhely őrzi a hagyományos szakmákat.",
        "A városi képtár egy reprezentatív épületben kapott helyet, amely egykor katonai iskola volt.",
        "Dobrics mindössze 35 km-re fekszik a népszerű tengerparti várostól, Balcsiktól.",
        "A Dobricset körülvevő régió a Balkán-félsziget legtermékenyebb búzatermesztő területe."
      ],
      ro: [
        "Orașul poartă numele lui Dobrotici, conducătorul Despotatului de Dobrogea din secolul al XIV-lea.",
        "În perioada comunistă (1949–1990), orașul a purtat numele Tolbuhin.",
        "Parcul Orășenesc Sfântul Gheorghe se întinde pe 25 de hectare și a fost unul dintre primele parcuri amenajate din Bulgaria.",
        "La Dobrich se află Casa Memorială Yordan Yovkov, dedicată unuia dintre cei mai mari scriitori bulgari.",
        "Muzeul Etnografic „Vechiul Dobrich” găzduiește 18 ateliere diferite de meșteșuguri tradiționale.",
        "Galeria de Artă a orașului funcționează într-o clădire impunătoare care a fost odinioară școală militară.",
        "Dobrich se află la numai 35 km de stațiunea de pe litoral Balcic.",
        "Regiunea din jurul orașului Dobrich este cea mai productivă zonă de cultivare a grâului din Peninsula Balcanică."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Szliven a „száz vajda városaként” ismert – ez a cím a város szerepét emeli ki a bolgár ellenállás központjaként az oszmán uralom idején. A Szinite Kamani (Kék-sziklák) Natúrpark lábánál fekvő város identitását egyaránt formálja hősies katonai múltja és ipari öröksége. 1834-ben itt alapította Dobri Zseljazkov a Balkán első modern textilgyárát, ezzel Szliven a bolgár ipar bölcsője lett. A látogatók megtekinthetik Hadzsi Dimitar emlékházát, aki az ország egyik legtiszteltebb forradalmi hőse. A környező Kék-sziklák zord, drámai tájképet alkotnak, és népszerű túra- és hegyisport-célpontok. Szliven továbbra is fontos kulturális és gazdasági csomópont Bulgária délkeleti részén, mely büszkén ápolja kézműves és lázadó hagyományait.",
      ro: "Sliven este cunoscut drept „Orașul celor o sută de voievozi”, un titlu care îi onorează rolul de important centru al rezistenței bulgare în perioada otomană. Așezat la poalele Parcului Natural Sinite Kamani (Stâncile Albastre), identitatea orașului este forjată atât de trecutul său militar eroic, cât și de moștenirea industrială. Aici, în 1834, Dobri Jelyazkov a înființat prima fabrică modernă de textile din Balcani, iar Sliven a câștigat reputația de leagăn al industriei bulgare. Vizitatorii pot explora Casa-Muzeu Hadzhi Dimitar, dedicată unuia dintre cei mai venerați eroi revoluționari ai țării. Stâncile Albastre din împrejurimi formează un peisaj sumbru și dramatic, fiind un punct popular pentru drumeții și sporturi montane. Sliven rămâne o răscruce culturală și economică vitală în sud-estul Bulgariei, păstrându-și cu mândrie tradițiile de meșteșug și răzvrătire.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "A Szinite Kamani Natúrpark a mészkőszikláknak a fény bizonyos szögében mutatott jellegzetes kékesszürke csillogásáról kapta a nevét.",
        "Az 1834-ben megnyitott első bolgár textilgyár ma a Textilipari Múzeumnak ad otthont.",
        "Szliven számos legendás bolgár forradalmár szülővárosa, közülük is kiemelkedik Hadzsi Dimitar.",
        "A „Vén szilfa” (Stariyat Brast) több mint 1100 éven át Szliven élő jelképe volt, mielőtt elpusztult.",
        "A városban álló Tuida-erőd a római korból, a 4. századból származik.",
        "Szliven azon kevés bolgár városok egyike, amely közel 200 éve folyamatos ipari tevékenységet folytat.",
        "A közeli Szlivenszki Mineralni Bani fürdőit gyógyhatásukért már a rómaiak is használták.",
        "A város minden májusban otthont ad a Nemzetközi Gyermek Folklórfesztiválnak."
      ],
      ro: [
        "Parcul Natural Sinite Kamani își datorează numele nuanței albastre-cenușii pe care stâncile de calcar o capătă în anumite condiții de lumină.",
        "Prima fabrică de textile din Bulgaria, deschisă în 1834, găzduiește astăzi Muzeul Industriei Textile.",
        "Sliven este locul de naștere al multor revoluționari bulgari legendari, în special al lui Hadzhi Dimitar.",
        "„Ulmul Bătrân” (Stariyat Brast) a fost un simbol viu al orașului Sliven timp de peste 1.100 de ani, înainte de a se usca.",
        "Cetatea Tuida, situată pe o colină a orașului, datează din perioada romană (secolul al IV-lea d.Hr.).",
        "Sliven este unul dintre puținele orașe bulgare care au păstrat o orientare industrială constantă timp de aproape 200 de ani.",
        "Băile Sliven (Slivenski Mineralni Bani) din apropiere au fost folosite pentru proprietățile lor curative încă din vremea romanilor.",
        "În fiecare lună mai, orașul găzduiește Festivalul Internațional de Folclor pentru Copii."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Sztara Zagora, a „hársfák városa”, a Trák-síkság szívében elhelyezkedő, figyelemreméltóan modern és jól tervezett város. Miután az 1877-es orosz–török háborúban teljesen lerombolták, a várost széles, egyenes sugárutakból álló rácsos rendszerrel építették újjá, ami sajátos európai hangulatot adott neki. A modern homlokzatok mögött azonban hihetetlenül mély múlt rejlik: az Újkőkori Lakóhelyek Múzeuma két, mintegy 8000 éves házat őriz, amelyek Európa legrégebbi ilyen lakóhelyei. A város a római korban Augusta Traiana néven volt jelentős központ, és az ókori fórum ma is meghatározó látnivaló. Sztara Zagora kiemelt kulturális főváros: itt található Bulgária első operaháza, és élénk irodalmi élet jellemzi. Tágas parkjaival, erős gazdaságával és gazdag régészeti örökségével a város a kitartás és a folyamatos városi fejlődés szimbóluma.",
      ro: "Stara Zagora, cunoscut drept „Orașul Teilor”, este un centru urban remarcabil de modern și bine planificat, situat în inima Văii Tracice. După ce a fost rasă complet în timpul Războiului Ruso-Turc din 1877, orașul a fost reconstruit pe un plan unic de tip grilă, cu bulevarde largi și drepte, ceea ce îi conferă o atmosferă vădit europeană. În spatele fațadei moderne se ascunde însă o istorie incredibil de profundă: Muzeul Locuințelor Neolitice păstrează două case vechi de 8.000 de ani, considerate cele mai vechi din Europa. Orașul a fost și un important centru roman, cunoscut sub numele de Augusta Traiana, iar forul antic rămâne un reper vizibil și astăzi. Stara Zagora este o capitală culturală vitală, găzduind prima operă construită din Bulgaria și o scenă literară vibrantă. Cu parcurile sale generoase, economia puternică și moștenirea arheologică bogată, orașul stă ca o mărturie a rezilienței și a evoluției urbane continue.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "Az Újkőkori Lakóhelyek Múzeuma két, a Krisztus előtti 6. évezredből származó házat őriz az eredeti helyén.",
        ...
        "A városhoz közeli Sztara Zagora védőinek emlékműve egy 50 méter magas betonszerkezet, amely az orosz–bolgár hadi zászlót formázza.",
        ...
        "Az 1902 óta a városban működő Zagorka sörfőzde Bulgária egyik legnépszerűbb sörmárkája."
      ],
      ro: [
        "Muzeul Locuințelor Neolitice conservă in situ două case ce datează din mileniul al VI-lea î.Hr.",
        "După distrugerea din 1877, Stara Zagora a fost reconstruit complet după un plan în formă de grilă.",
        "Forumul Roman Augusta Traiana, descoperit în centrul orașului, a găzduit cândva un teatru pentru jocurile de gladiatori.",
        "Opera de Stat din oraș este cea mai veche și una dintre cele mai prestigioase companii de operă din Bulgaria.",
        "Memorialul Apărătorilor de la Stara Zagora din apropiere include o construcție masivă din beton, înaltă de 50 de metri, ce reprezintă steagul militar ruso-bulgar.",
        "Parcul Ayazmo, înființat în 1895, se întinde pe 350 de hectare și conține peste 150 de specii exotice de arbori.",
        "Orașul se află în centrul geografic al Peninsulei Balcanice.",
        "Berăria Zagorka, prezentă în oraș din 1902, este una dintre cele mai populare mărci de bere din țară."
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      ...
      hu: "Blagoevgrad Bulgária délnyugati részén, a Sztruma-folyó völgyében fekvő város, élénk egyetemi központ és a régió jelentős kulturális helyszíne. A város két nagy egyetemnek ad otthont, köztük a bulgáriai Amerikai Egyetemnek, ami fiatalos és nemzetközi hangulatot kölcsönöz neki. Különleges látnivaló a „Varosa” történelmi negyed, jól megőrzött újjászületés kori házaival és az Istenanya elszenderedése templommal. Blagoevgrad ideális kiindulópont a közeli Rila-hegységinto és a híres Rilai kolostorhoz tett kirándulásokhoz. A város emellett számos parkot, kávézót és dinamikus kulturális életet kínál. Blagoevgrad ötvözi a történelmi hagyományokat a modern oktatással, és fontos csomópont a Görögország felé vezető úton.",
    ...
    descriptionAdvanced: {
      ...
      hu: "Blagoevgrad lendületes egyetemi város a festői Sztruma folyó völgyében, Bulgária délnyugati részének legfontosabb közigazgatási és kulturális központja. Fiatalos hangulatáért elsősorban két nagy intézmény felelős: a Neofit Rilski Délnyugati Egyetem és a Bulgáriai Amerikai Egyetem, amely Kelet-Európa első, amerikai mintára létrehozott liberal-arts főiskolája. A történelmi varázs szívét a Varosa-negyed adja, gondosan helyreállított, újjászületés-kori épületekkel, macskaköves utcákkal és a Boldogságos Szűz Bemutatása-templommal. A Rila- és a Pirin-hegység lábánál fekvő város stratégiai kapu a kiváló sípályák és a történelmi Rilai kolostor felé. A belvárosi sétálóövezet kávézókkal, szökőkutakkal és élénk közterekkel az akadémiai szellem és a hagyományos bolgár hangulat tökéletes elegyét kínálja.",
      ro: "Blagoevgrad este un oraș universitar dinamic, situat în pitoreasca vale a râului Struma, fiind principalul centru administrativ și cultural din sud-vestul Bulgariei. Este renumit pentru energia sa tinerească, în mare parte grație celor două instituții majore: Universitatea de Sud-Vest „Neofit Rilski” și Universitatea Americană din Bulgaria — prima instituție de tip liberal arts în stil american din Europa de Est. Inima farmecului istoric o constituie cartierul Varosha, o zonă frumos restaurată, cu arhitectură din perioada Renașterii bulgare, străduțe pavate și impunătoarea Biserică Intrarea în Biserică a Maicii Domnului. Poziționat la poalele munților Rila și Pirin, Blagoevgrad este o poartă strategică pentru iubitorii de aer liber care pornesc către stațiunile de schi de top sau către istorica Mănăstire Rila. Centrul orașului este o zonă pietonală plină de cafenele, fântâni și spații publice vibrante, oglindind un echilibru perfect între spiritul academic și atmosfera tradițională bulgărească.",
    ...
    factsAdvanced: {
      ...
      hu: [
        ...
        "A Varosa védett építészeti rezervátum, sok háza a 19. század elejéről származik.",
        ...
        "A regionális történeti múzeum Délnyugat-Bulgária egyik legátfogóbb régészeti gyűjteményével rendelkezik.",
        "A közeli Sztob-i földpiramisok látványos sziklaképződmények, mindössze 20 km-re a várostól.",
        "Blagoevgrad fontos csomópont a Szófiát a görög határ Kulata-i átkelőjével összekötő autópályán.",
        "A „Makedónia” városi park a régió egyik legnagyobb és legszebben kialakított zöldterülete."
      ],
      ro: [
        "Universitatea Americană din Bulgaria, fondată în 1991, atrage studenți din peste 40 de țări.",
        "Varosha este o rezervație arhitecturală protejată, multe case datând de la începutul secolului al XIX-lea.",
        "Orașul s-a numit inițial Gorna Dzhumaya, fiind redenumit în 1950 după liderul socialist Dimitar Blagoev.",
        "Blagoevgrad este renumit pentru izvoarele sale termale naturale, folosite în scopuri terapeutice încă din Antichitate.",
        "Muzeul de istorie regională al orașului adăpostește una dintre cele mai cuprinzătoare colecții arheologice din sud-vest.",
        "Piramidele de pământ de la Stob, formațiuni stâncoase naturale, se află la doar 20 km de oraș.",
        "Blagoevgrad este un nod important pe autostrada internațională ce leagă Sofia de granița cu Grecia la Kulata.",
        "Parcul „Macedonia” din oraș este unul dintre cele mai mari și mai frumos amenajate parcuri urbane din regiune."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Haszkovo a rekordok és ókori titkok városa: Bulgária délkeleti részén, a hullámzó dombok között, a török és görög határ közelében fekszik. Nemzetközi hírnévre a Szűz Mária-emlékmű révén tett szert, amelyet a Guinness Rekordok Könyve hivatalosan a világ legmagasabb, a Gyermek Jézust tartó Szűz Mária-szobraként ismer el. A Jamacsa-dombon álló emlékmű részét képezi egy 30 méter magas harangtorony is, ahonnan szemkápráztató kilátás nyílik a városra. A régió valóságos trák kultúrkincs: különösen az alekszandrovói trák sírkamra emelkedik ki, amelyben a Balkán egyik legjobban megőrzött Krisztus előtti 4. századi freskója látható. Haszkovo belvárosa hívogató sétálóutcákkal, díszes szökőkutakkal és a hangulatos Kenana parkkal várja a látogatókat. A város fontos nemzetközi kereskedelmi csomópont, és mélyen kötődik a dohány- és textiliparhoz, így egyedülállóan ötvözi a vallási áhítatot, az ősi történelmet és a modern gazdaságot.",
      ro: "Haskovo este un oraș al recordurilor și al misterelor antice, situat printre dealurile blânde din sud-estul Bulgariei, aproape de granițele cu Turcia și Grecia. A devenit cunoscut la nivel internațional pentru Monumentul Sfintei Fecioare Maria, certificat oficial de Guinness World Records drept cea mai înaltă statuie a Maicii Domnului cu Pruncul Iisus. Amplasat pe Dealul Yamacha, monumentul include un clopotniță de 30 de metri, de unde se deschide o panoramă largă asupra orașului. Din punct de vedere istoric, regiunea este o adevărată comoară de cultură tracică, în special prin Mormântul de la Alexandrovo, care păstrează unele dintre cele mai bine conservate fresce din secolul al IV-lea î.Hr. din Balcani. Centrul orașului este o zonă primitoare, cu artere pietonale, fântâni elegante și pitorescul Parc Kenana. Haskovo este un nod important pentru comerțul internațional și este strâns legat de tradițiile producției de tutun și textile, oferind un amestec captivant de devotament religios, istorie antică și economie modernă.",
    ...
    factsAdvanced: {
      ...
      hu: [
        "A Szűz Mária-emlékmű talapzatával együtt 32,8 méter magas.",
        "A mellette álló harangtorony 8 különböző méretű harangot rejt; a legnagyobb 500 kilogrammos.",
        ...
        "A Kenana park több mint 40 hektáros erdős területével a város legnagyobb parkja.",
        "Haszkovo jelentős kiváló minőségű pamut- és selyemtextil-előállító központ.",
        "A közeli Uzundzsovói templom egyedülálló építészeti emlék, amely az oszmán korszakban időszakosan mecsetként is működött."
      ],
      ro: [
        "Monumentul Sfintei Fecioare Maria are 32,8 metri înălțime, incluzând și piedestalul.",
        "Clopotnița aflată lângă monument adăpostește 8 clopote de diferite dimensiuni; cel mai mare cântărește 500 kg.",
        "Mormântul tracic de la Alexandrovo, descoperit în 2000, conține scene unice de vânătoare și de ospăț ritualic.",
        "Haskovo este una dintre cele mai vechi așezări din Bulgaria, cu urme de viață umană de peste 7.000 de ani.",
        "„Vechiul Turn cu Ceas” al orașului a fost ridicat în secolul al XIX-lea și restaurat complet în 2013.",
        "Parcul Kenana este cel mai mare parc al orașului, întinzându-se pe peste 40 de hectare de pădure.",
        "Haskovo este un producător important de textile de calitate superioară din bumbac și mătase.",
        "Biserica Uzundzhovo, aflată în apropiere, este un monument arhitectural unic, folosit pentru o vreme drept moschee în perioada otomană."
      ],
      en: [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Pazardzsik fő jellegzetessége a Marica folyó partján elfoglalt stratégiai fekvése és a kereskedelem, valamint a hagyományos kézművesség mély gyökerei. A 15. század végén piacvárosként alapított település mára a termékeny Felső-trák síkság fontos mezőgazdasági és ipari központja. A város különösen híres a „Szabadság-szigete” (Osztrovat) nevű parkról, amely a Marica egyik természetes szigetén kapott helyet, és állatkertet, számos szobrot és szabadidős létesítményt foglal magában. Másik kulturális gyöngyszem a Szűz Mária-templom, amely a Debar-iskola mesterei által faragott, világszínvonalú ikonosztáznak ad otthont – ez a Balkán legszebb fafaragásai közé tartozik. A történelmi Plovdiv és a nyugodt Rodope-hegység közelsége miatt Pazardzsik kényelmes és érdekes megálló Közép-Bulgária felfedezőinek. A folyóparti szépség és a vallási művészet ötvözete csendes, mégis mély betekintést kínál a bolgár kulturális örökségbe.",
      ro: "Pazardzhik este definit de poziția sa strategică pe malurile râului Marița și de tradițiile sale profunde în comerț și meșteșuguri. Fondat la sfârșitul secolului al XV-lea ca piață, orașul s-a dezvoltat într-un centru agricol și industrial important al fertilei Câmpii a Traciei Superioare. Este renumit în special pentru parcul „Insula Libertății” (Ostrovat), un parc urban deosebit, situat pe o insulă naturală a râului Marița, care găzduiește o grădină zoologică, numeroase statui și spații de recreere. O altă bijuterie culturală este Biserica Maicii Domnului, care adăpostește un iconostas sculptat în lemn de maeștrii școlii din Debar — considerat unul dintre cele mai frumoase exemple de sculptură în lemn din Balcani. Apropierea de istoricul oraș Plovdiv și de liniștiții Munți Rodopi face din Pazardzhik o oprire convenabilă și interesantă pentru cei care explorează centrul Bulgariei. Combinația dintre frumusețea fluvială și arta religioasă oferă o privire discretă, dar profundă asupra patrimoniului cultural bulgar.",
    ...
    factsAdvanced: {
      ...
      hu: [
        ...
        "A Szűz Mária-templom faragott ikonosztázát mesterek több mint tíz év alatt készítették el.",
        ...
        "Pazardzsik pontosan félúton fekszik a Szófia–Plovdiv közötti főúton és vasútvonalon.",
        "Az Oszmán Birodalom idején a város fontos rizs- és selyemtermelő központ volt.",
        "Pazardzsik 1741-ben épült órás tornya egyike a kevés fennmaradt oszmán kori toronynak Bulgáriában.",
        "A közeli Bessaparszki-dombok jelentős régészeti lelőhelyek, számos trák halomsírral."
      ],
      ro: [
        "Pazardzhik s-a numit inițial Tatar Pazardzhik, deoarece a fost fondat de tătarii din Crimeea ca oraș de târg.",
        "Iconostasul sculptat din lemn al Bisericii Maicii Domnului a fost realizat de meșteri pe parcursul a peste 10 ani.",
        "Parcul „Insula Libertății” găzduiește una dintre cele mai mari galerii de sculptură în aer liber din Bulgaria.",
        "Muzeul de istorie regională al orașului este unul dintre cele mai vechi din țară, fondat în 1911.",
        "Pazardzhik este situat exact la jumătatea drumului și a căii ferate principale dintre Sofia și Plovdiv.",
        "În perioada otomană, orașul a fost un important centru de producție a orezului și a mătăsii.",
        "Turnul cu Ceas din Pazardzhik, construit în 1741, este unul dintre puținele turnuri otomane păstrate în Bulgaria.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Pernik büszkén viseli ipari örökségét, és egyedülálló módon ötvözi a kemény bányászati múltat Európa egyik leglendületesebb folklórhagyományával. Szófiától nyugatra fekvő város volt a bolgár iparosodás motorja, melyet a hatalmas szén-, vagyis a „fekete arany” lelőhelyek tápláltak. Kiemelkedő látnivalója a Bányászati Múzeum, amely egy valódi, 50 méter mélyen futó volt szénbányavágatban kapott helyet, és magával ragadó betekintést kínál a bányászok életébe. Minden januárban a város a „Szurva” nemzetközi maszkos fesztivál színhelye lesz: ezrek öltik magukra a kukerik bonyolult, ijesztő maszkjait és csengőit, hogy elűzzék a gonosz szellemeket – ez a hagyomány ma már UNESCO szellemi örökség. A város fölött a középkori Krakra erőd romjai magasodnak, mely több bizánci ostromnak is ellenállt. Pernik lebilincselő utazást kínál az ókori erődöktől az ipari forradalomig, majd a bolgárok élő, lélegző népi hagyományaiig.",
      ro: "Pernik își poartă cu mândrie moștenirea industrială, îmbinând în mod unic un trecut minier dur cu una dintre cele mai vibrante tradiții folclorice din Europa. Situat la vest de Sofia, Pernik a fost motorul industrializării Bulgariei, alimentat de vastele zăcăminte de cărbune cunoscute sub numele de „aurul negru”. Muzeul Mineritului este o atracție remarcabilă, amenajată într-o galerie de cărbune autentică, situată la 50 de metri sub pământ, oferind o privire imersivă asupra vieții minerilor. În fiecare ianuarie, orașul se transformă pentru Festivalul Internațional al Jocurilor cu Măști „Surva”, în care mii de kukeri îmbracă măști elaborate și terifiante și clopote pentru a alunga spiritele rele — o tradiție recunoscută astăzi de UNESCO. Deasupra orașului se înalță ruinele Cetății medievale Krakra, care a rezistat mai multor asedii bizantine. Pernik oferă o călătorie captivantă, de la fortărețe antice la revoluția industrială și până la tradițiile populare vii ale bulgarilor.",
    ...
    factsAdvanced: {
      ...
      hu: [
        ...
        "A Krakra-erőd Perniki Krakra, a 11. századi legendás bolgár hadvezér székhelye volt, aki visszaverte II. Baszileiosz bizánci császárt.",
        "A perniki szénbányászat 1891-ben indult meg, alapjaiban változtatva meg a kis agrárváros életét.",
        "A város Művelődési Háza a szocialista neoklasszicizmus egyik kiemelkedő példája, 1957-ben épült.",
        ...
        "A perniki Regionális Múzeum egyedülálló középkori kerámiagyűjteményt őriz, amely a Krakra-erődben került elő."
      ],
      ro: [
        "Muzeul Mineritului din Pernik este singurul de acest fel din întreaga regiune balcanică.",
        "Festivalul Surva este cel mai vechi festival al măștilor din Bulgaria, organizat încă din 1966.",
        "Cetatea Krakra a fost sediul lui Krakra din Pernik, legendarul războinic bulgar din secolul al XI-lea care l-a respins pe împăratul bizantin Vasile al II-lea.",
        "Industria minieră a cărbunelui din Pernik a început în 1891, schimbând fundamental identitatea micului oraș agrar.",
        "Palatul Culturii al orașului este un exemplu impresionant de arhitectură socialistă neoclasică, ridicat în 1957.",
        "Pernik este cunoscut drept „orașul minerilor”, mineritul cărbunelui fiind motorul principal al economiei timp de peste un secol.",
        "Muntele Lyulin din apropiere oferă numeroase trasee de drumeție și ciclism montan, chiar la marginea orașului.",
        "Muzeul Regional din Pernik găzduiește o colecție unică de ceramică medievală descoperită în Cetatea Krakra."
      ],
      en: [
