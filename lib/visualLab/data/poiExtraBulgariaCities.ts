...
export const poiExtraBulgariaCities: POI[] = [
  {
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Sub strazile moderne se afla ramați?ele orașului roman Serdica, vizibile par?ial în zona stațiilor de metrou.",
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Orașul a fost construit ini?ial pe ?apte coline de sienit, dintre care astazi se mai disting clar ?ase.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Vidin este o poarta istorica situata în extremitatea de nord-vest a Bulgariei, pe malul sudic al Dunarii. Bijuteria orașului este Cetatea Baba Vida — singurul castel medieval pastrat integral din ?ara, cu ?an?uri impunatoare ?i ziduri duble care au aparat regiunea timp de secole. Din punct de vedere istoric, Vidin a fost un important centru roman numit Bononia, iar mai târziu capitala ?aratului de Vidin. Astazi, orașul ofera o experien?a lini?tita pe faleza Dunarii, cu un parc întins ?i impresionantul Pod 2 al Dunarii, care conecteaza Bulgaria cu Calafat, în România. Patrimoniul arhitectural reflecta trecutul multicultural: maiestuoasa Catedrala Sfântul Dumitru — a doua ca marime din Bulgaria — ?i ruinele unei sinagogi grandioase din secolul al XIX-lea. Pentru turi?tii care exploreaza ruta Dunarii, Vidin este o oprire esen?iala, prin combinația unica de istorie militara ?i frumuse?e fluviala.",
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Vratsa, situat la poalele Mun?ilor Balcani, este un paradis pentru iubitorii de natura ?i aventurieri. Orașul este cunoscut pentru locația sa dramatica sub pere?ii de stânca abrup?i ai pasului Vratsata, considerat unul dintre cele mai înalte stânci verticale din Balcani. Vratsa servește ca punct de plecare ideal pentru drume?ii, alpinism ?i speologie în Parcul Natural Vrachanski Balkan. Un punct culminant special este Pe?tera Ledenika, una dintre cele mai vizitate pe?teri din Bulgaria, cunoscuta pentru forma?iunile sale impresionante de stalactite ?i stalagmite. Orașul în sine ofera o ambian?a lini?tita, cu un muzeu istoric care gazduiește comori trace valoroase. Vratsa îmbina experien?ele naturale alpine cu istoria regionala ?i este o vizita obligatorie pentru calatorii care doresc sa descopere frumuse?ea salbatica a Bulgariei de nord-vest.",
    ...
    facts: {
      ...
      ro: ["Locație: La poalele Mun?ilor Balcani", "Natura: Defileul Vratsata", "Atracție: Pe?tera Ledenika", "Sport: Centru pentru alpinism ?i drume?ii", "Istorie: Tezaurul tracic de la Rogozen", "Parc: Parcul Natural Vrachanski Balkan"],
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "În ora? se desfa?oara anual Zilele Botev, festival dedicat eroului național Hristo Botev, cazut în mun?ii din apropiere."
      ],
      en: [
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Platoul Shumen este o rezervație naturala cu peste 60 de pe?teri în calcar.",
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Galeria de Arta a orașului func?ioneaza într-o cladire impunatoare care a fost odinioara ?coala militara.",
  ...
  },
  {
    ...
    facts: {
      ...
      ro: ["Statut: Ora? universitar al sud-vestului", "Educație: Sediul Universita?ii Americane din Bulgaria", "Cultura: Cartierul istoric 'Varosha'", "Locație: În valea râului Struma", "Natura: Poarta catre Mun?ii Rila", "Economie: Centru comercial regional"],
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Orașul s-a numit ini?ial Gorna Dzhumaya, fiind redenumit în 1950 dupa liderul socialist Dimitar Blagoev.",
  ...
  },
  {
    ...
    facts: {
      ...
      ro: ["Locație: În Câmpia Traciei Superioare", "Natura: Parcul 'Insula Liberta?ii' pe Maritsa", "Cultura: Biserica Sf. Fecioare Maria", "Istorie: Fondat ca centru comercial", "Economie: Centru agricol", "Transport: Nod important Sofia-Plovdiv"],
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Parcul \\\\\\\"Insula Liberta?ii\\\\\\\" gazduiește una dintre cele mai mari galerii de sculptura în aer liber din Bulgaria.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Pernik î?i poarta cu mândrie mo?tenirea industriala, îmbinând în mod unic un trecut minier dur cu una dintre cele mai vibrante tradi?ii folclorice din Europa. Situat la vest de Sofia, Pernik a fost motorul industrializarii Bulgariei, alimentat de vastele zacaminte de carbune cunoscute sub numele de \\\\\\\"aurul negru\\\\\\\". Muzeul Mineritului este o atracție remarcabila, amenajata într-o galerie de carbune autentica, situata la 50 de metri sub pamânt, oferind o privire imersiva asupra vie?ii minerilor. În fiecare ianuarie, orașul se transforma pentru Festivalul Internațional al Jocurilor cu Maști \\\\\\\"Surva\\\\\\\", în care mii de kukeri îmbraca maști elaborate ?i terifiante ?i clopote pentru a alunga spiritele rele — o tradiție recunoscuta astazi de UNESCO. Deasupra orașului se înal?a ruinele Ceta?ii medievale Krakra, care a rezistat mai multor asedii bizantine. Pernik ofera o calatorie captivanta, de la fortare?e antice la revoluția industriala ?i pâna la tradițiile populare vii ale bulgarilor.",
