...
export const bulgariaAllPoi = [
  ...
  },
  {
    ...
    facts: {
      de: ["Status: Meereshauptstadt Bulgariens", "Geschichte: Ältester Goldschatz der Welt", "Wahrzeichen: Kathedrale Mariä Himmelfahrt", "Natur: Meeresgarten (Morska Gradina)", "Wirtschaft: Größter Hafen Bulgariens", "Kultur: Internationales Ballettfestival", "Archäologie: Römische Thermen", "Lage: Am Golf von Warna"],
  ...
  },
  {
    ...
    facts: {
      de: ["Status: UNESCO-Weltkulturerbe seit 1983", "Gründer: Hl. Iwan von Rila (10. Jh.)", "Höhe: 1147 m über dem Meeresspiegel", "Architektur: Bulgarische Wiedergeburt", "Highlight: Raffail-Kreuz (140 Miniszenen)", "Ältestes Gebäude: Hreljo-Turm (1335)", "Fresken: Über 1200 biblische Szenen", "Bedeutung: Geistiges Zentrum Bulgariens", "Lage: Rila-Nationalpark", "Besucher: Über 1 Million jährlich"],
