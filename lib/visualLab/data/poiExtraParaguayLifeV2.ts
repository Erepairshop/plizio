...
export const poiExtraParaguayLifeV2: POI[] = [
  {
    ...
    name: { de: "Zoológico de Itaipú", hu: "Itaipú Állatkert", ro: "Grădina Zoologică Itaipú", en: "Itaipú Zoo" },
    description: {
    ...
    descriptionAdvanced: {
      de: "Paraguay bietet eine vielfältige Palette an natürlichen Lebensräumen und agrarischen Landschaften, die sowohl die reiche biologische Vielfalt als auch das wirtschaftliche Rückgrat im ländlichen Sektor widerspiegeln. Von den einzigartigen Ökosystemen im Chaco bis zu den blühenden Wäldern nahe des Paraná-Flusses besitzt die Nation einen bemerkenswerten natürlichen Reichtum. Der Agrarsektor, einschließlich Sojaanbau, Rinderzucht und Yerba-Mate-Ernte, ist tief in das tägliche Leben und die Traditionen der paraguayischen Bevölkerung integriert. Diese Aspekte sind entscheidend, um die natürliche Identität der Nation, die Bemühungen um nachhaltige Entwicklung und die bedeutende Rolle auf dem globalen Lebensmittelmarkt zu verstehen.",
      hu: "Paraguay változatos természeti környezetet és mezőgazdasági tájakat kínál, amelyek tükrözik a gazdag biológiai sokféleséget és a vidéki szektor gazdasági gerincét. A Chaco régió egyedülálló ökoszisztémáitól a Paraná folyó melletti virágzó erdőkig, a nemzet figyelemre méltó természeti gazdagsággal rendelkezik. A mezőgazdasági ágazat, beleértve a szójatermesztést, a szarvasmarha-tenyésztést és a yerba mate betakarítását, mélyen beépült a paraguayi emberek mindennapi életébe és hagyományaiba. Ezek a szempontok alapvetőek a nemzet természeti identitásának, a fenntartható fejlődési törekvéseknek és a globális élelmiszerpiacon betöltött jelentős szerepének megértéséhez.",
      ro: "Paraguay oferă o gamă diversă de habitate naturale și peisaje agricole, reflectând atât bogata biodiversitate, cât și coloana vertebrală economică a sectorului rural. De la ecosistemele unice din regiunea Chaco până la pădurile înfloritoare din apropierea râului Paraná, națiunea deține o bogăție naturală remarcabilă. Sectorul agricol, incluzând cultivarea soiei, creșterea vitelor și recoltarea de yerba mate, este profund integrat în viața de zi cu zi și în tradițiile poporului paraguayan. Aceste aspecte sunt esențiale pentru înțelegerea identității naturale a națiunii, eforturile de dezvoltare durabilă și rolul său semnificativ pe piața alimentară globală.",
      en: "Paraguay offers a diverse range of natural environments and agricultural landscapes, reflecting both its rich biodiversity and its economic backbone in the rural sector. From the unique ecosystems of the Chaco region to the flourishing forests near the Paraná river, the nation holds remarkable natural wealth. The agricultural sector, including soybean cultivation, cattle ranching, and yerba mate harvesting, is deeply integrated into the daily life and traditions of the Paraguayan people. These aspects are vital for understanding the nation’s natural identity, sustainable development efforts, and its significant role in the global food market." },
    factsAdvanced: {
      de: ["Heimat vielfältiger Ökosysteme, darunter Chaco und Atlantischer Wald.", "Entscheidende Rolle bei globalen Agrarexporten.", "Spiegelt die tiefe Integration von Natur und täglichem Leben wider.", "Bedeutende Bemühungen in Naturschutz und nachhaltiger Entwicklung."],
      hu: ["A változatos ökoszisztémák, köztük a Chaco és az Atlanti-erdő otthona.", "Kulcsszerep a globális mezőgazdasági exportban.", "Tükrözi a természet és a mindennapi élet mély integrációját.", "Jelentős erőfeszítések a természetvédelem és a fenntartható fejlődés terén."],
      ro: ["Găzduiește ecosisteme diverse, inclusiv Chaco și Pădurea Atlantică.", "Rol crucial în exporturile agricole globale.", "Reflectă integrarea profundă a naturii și a vieții de zi cu zi.", "Eforturi semnificative în conservare și dezvoltare durabilă."],
      en: ['Home to diverse ecosystems including Chaco and Atlantic Forest.', 'Crucial role in global agricultural exports.', 'Reflects the deep integration of nature and daily life.', 'Significant efforts in conservation and sustainable development.']
    },
    facts: {
    ...
    }, image: "/poi-images/py-itaipu-zoo-life-v2.webp"},
  {
    ...
    name: { de: "Biologisches Schutzgebiet Mbaracayú", hu: "Mbaracayú Biológiai Rezervátum", ro: "Refugiul Biologic Mbaracayú", en: "Mbaracayú Biological Refuge" },
    description: {
    ...
    }, image: "/poi-images/py-refugio-mbaracayu-binacional-life-v2.webp"},
  {
    ...
    name: { de: "Nationalpark Río Negro", hu: "Río Negro Nemzeti Park", ro: "Parcul Național Río Negro", en: "Río Negro National Park" },
    description: {
    ...
    }, image: "/poi-images/py-rio-negro-life-v2.webp"},
  {
    ...
    parent: "PY-17",
    coords: [-61.8, -21.2],
    name: { de: "Nationalpark Teniente Agripino Enciso", hu: "Teniente Agripino Enciso Nemzeti Park", ro: "Parcul Național Teniente Agripino Enciso", en: "Teniente Agripino Enciso National Park" },
    description: {
    ...
    }, image: "/poi-images/py-teniente-agripino-life-v2.webp"},
  {
    ...
    parent: "PY-10",
    coords: [-54.58, -25.36],
    name: { de: "Biologisches Schutzgebiet Tatí Yupí", hu: "Tatí Yupí Biológiai Rezervátum", ro: "Refugiul Biologic Tatí Yupí", en: "Tatí Yupí Biological Refuge" },
    description: {
    ...
    }, image: "/poi-images/py-tati-yupi-life-v2.webp"},
  {
    ...
    parent: "PY-08",
    coords: [-56.84, -27.32],
    name: { de: "Wildtierschutzgebiet Atinguy", hu: "Atinguy Vadvédelmi Terület", ro: "Refugiul pentru Viață Sălbatică Atinguy", en: "Atinguy Wildlife Refuge" },
    description: {
    ...
    }, image: "/poi-images/py-atinguy-life-v2.webp"},
  {
    ...
    parent: "PY-16",
    coords: [-59.85, -21.4],
    name: { de: "Chaco Rinderfarmen", hu: "Chaco Szarvasmarha Farmok", ro: "Ferme de Vite din Chaco", en: "Chaco Cattle Ranches" },
    description: {
    ...
    }, image: "/poi-images/py-estancia-cattle-life-v2.webp"},
  {
    ...
    name: { de: "Mate-Strauch-Plantagen (Bella Vista)", hu: "Yerba Mate Ültetvények (Bella Vista)", ro: "Plantații de Yerba Mate (Bella Vista)", en: "Yerba Mate Plantations (Bella Vista)" },
    description: {
  ...
  },
  {
    ...
    parent: "PY-02",
    coords: [-56.5, -24.0],
    name: { de: "Stevia-Plantagen San Pedro", hu: "San Pedro Stevia Ültetvények", ro: "Plantațiile de Stevia San Pedro", en: "San Pedro Stevia Plantations" },
    description: {
  ...
  },
  {
    ...
    parent: "PY-10",
    coords: [-54.9, -25.5],
    name: { de: "Sojafelder in Alto Paraná", hu: "Szójaföldek Alto Paraná-ban", ro: "Câmpuri de Soia în Alto Paraná", en: "Soya Fields in Alto Paraná" },
    description: {
    ...
    }, image: "/poi-images/py-soya-alto-parana-life-v2.webp"},
  {
    ...
    parent: "PY-04",
    coords: [-56.4, -25.8],
    name: { de: "Zuckerrohrfelder in Guairá", hu: "Cukornádültetvények Guairában", ro: "Câmpuri de Trestie de Zahăr din Guairá", en: "Sugarcane Fields in Guairá" },
    description: {
  ...
  },
  {
    ...
    name: { de: "Nationalpark Cerro Corá (Tierwelt)", hu: "Cerro Corá Nemzeti Park (Vadvilág)", ro: "Parcul Național Cerro Corá (Faună)", en: "Cerro Corá National Park (Wildlife)" },
    description: {
  ...
  },
  {
    ...
    name: { de: "Mennonitische Milchwirtschaft (Filadelfia)", hu: "Mennonita Tejgazdaság (Filadelfia)", ro: "Lăptărie Menonită (Filadelfia)", en: "Mennonite Dairy Farming (Filadelfia)" },
    description: {
  ...
  },
  {
    ...
    parent: "PY-15",
    coords: [-59.5, -23.5],
    name: { de: "Baumwollfelder im Chaco", hu: "Gyapotmezők a Chaco-ban", ro: "Câmpuri de Bumbac în Chaco", en: "Cotton Fields in the Chaco" },
    description: {
    ...
    }, image: "/poi-images/py-cotton-chaco-life-v2.webp"},
  {
    ...
    name: { de: "Botanischer Garten und Zoo Asunción", hu: "Asuncióni Botanikus Kert és Állatkert", ro: "Grădina Botanică și Zoologică Asunción", en: "Asunción Botanical Garden and Zoo" },
    description: {
  ...
  },
  {
    ...
    name: { de: "Naturkundemuseum San Lorenzo", hu: "San Lorenzo Természettudományi Múzeum", ro: "Muzeul de Istorie Naturală San Lorenzo", en: "San Lorenzo Natural History Museum" },
    description: {
    ...
    }, image: "/poi-images/py-museo-historia-natural-life-v2.webp"},
  {
    ...
    parent: "PY-03",
    coords: [-57.1, -25.3],
    name: { de: "Straußenfarm Mbocayaty", hu: "Mbocayaty Struccfarm", ro: "Ferma de Struți Mbocayaty", en: "Mbocayaty Ostrich Farm" },
    description: {
    ...
    }, image: "/poi-images/py-granja-avestruz-life-v2.webp"},
  {
    ...
    type: "kid-landmark",
    parent: "PY-11",
    coords: [-57.4167, -25.35],
    name: { de: "Ökologischer Park Capiatá", hu: "Capiatá Ökológiai Park", ro: "Parcul Ecologic Capiatá", en: "Capiatá Ecological Park" },
    description: {
    ...
    }, image: "/poi-images/py-parque-ecologico-capiata-life-v2.webp"},
  {
    ...
    name: { de: "Naturreservat Bosque Mbaracayú", hu: "Bosque Mbaracayú Természetvédelmi Terület", ro: "Rezervația Naturală Bosque Mbaracayú", en: "Bosque Mbaracayú Nature Reserve" },
    description: {
    ...
    }, image: "/poi-images/py-reserva-mbaracayu-life-v2.webp"},
  {
    ...
    name: { de: "Laguna Capitán (Flamingo-Habitat)", hu: "Laguna Capitán (Flamingó Élőhely)", ro: "Laguna Capitán (Habitat pentru Flamingi)", en: "Laguna Capitán (Flamingo Habitat)" },
    description: {
  ...
  },
  {
    ...
    parent: "PY-15",
    coords: [-58.85, -23.1],
    name: { de: "Estancia Loma Porã", hu: "Loma Porã Estancia", ro: "Estancia Loma Porã", en: "Estancia Loma Porã" },
    description: {
    ...
    }, image: "/poi-images/py-estancia-loma-pora-life-v2.webp"},
  {
    ...
    parent: "PY-02",
    coords: [-56.4, -24.2],
    name: { de: "Sesamfelder in San Pedro", hu: "Szezámmagföldek San Pedróban", ro: "Câmpuri de Susan în San Pedro", en: "Sesame Fields in San Pedro" },
    description: {
    ...
    }, image: "/poi-images/py-sesame-san-pedro-life-v2.webp"},
  {
    ...
    parent: "PY-05",
    coords: [-56.0, -25.4],
    name: { de: "Maisfelder in Caaguazú", hu: "Kukoricaföldek Caaguazúban", ro: "Câmpuri de Porumb în Caaguazú", en: "Corn Fields in Caaguazú" },
    description: {
  ...
  },
  {
    ...
    parent: "PY-07",
    coords: [-55.7, -26.8],
    name: { de: "Weizenfelder in Itapúa", hu: "Búzaföldek Itapúában", ro: "Câmpuri de Grâu în Itapúa", en: "Wheat Fields in Itapúa" },
    description: {
    ...
    }, image: "/poi-images/py-wheat-itapua-life-v2.webp"},
  {
    ...
    parent: "PY-05",
    coords: [-55.8, -25.2],
    name: { de: "Bananenplantagen von Tembiaporá", hu: "Tembiaporá Banánültetvények", ro: "Plantațiile de Banane din Tembiaporá", en: "Tembiaporá Banana Plantations" },
    description: {
    ...
    }, image: "/poi-images/py-banana-tembiapora-life-v2.webp"},
  {
    ...
    type: "animal-habitat",
    parent: "PY-10",
    coords: [-54.45, -24.8167],
    name: { de: "Biologisches Schutzgebiet Limoy", hu: "Limoy Biológiai Rezervátum", ro: "Refugiul Biologic Limoy", en: "Limoy Biological Refuge" },
    description: {
    ...
    }, image: "/poi-images/py-refugio-limoy-life-v2.webp"},
  {
    ...
    name: { de: "Biologisches Schutzgebiet Carapã", hu: "Carapã Biológiai Rezervátum", ro: "Refugiul Biologic Carapã", en: "Carapã Biological Refuge" },
    description: {
    ...
    }, image: "/poi-images/py-refugio-carapa-life-v2.webp"},
  {
    ...
    parent: "PY-02",
    coords: [-56.1333, -23.8],
    name: { de: "Laguna Blanca Öko-Reservat", hu: "Laguna Blanca Öko-Rezervátum", ro: "Rezervația Eco Laguna Blanca", en: "Laguna Blanca Eco-Reserve" },
    description: {
    ...
    }, image: "/poi-images/py-laguna-blanca-nature-life-v2.webp"},
  {
    ...
    parent: "PY-11",
    coords: [-57.48, -25.4],
    name: { de: "Granja Educativa Kuruzu", hu: "Kuruzu Oktatófarm", ro: "Ferma Educațională Kuruzu", en: "Kuruzu Educational Farm" },
    description: {
    ...
    }, image: "/poi-images/py-granja-kuruzu-life-v2.webp"},
  {
    ...
    parent: "PY-16",
    coords: [-59.7, -21.0],
    name: { de: "Agrar-Versuchsfeld Chaco", hu: "Chaco Agrár Kísérleti Terület", ro: "Câmpul Experimental Agricol Chaco", en: "Chaco Agricultural Experimental Field" },
    description: {
