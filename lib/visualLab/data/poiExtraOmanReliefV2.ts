...
,
  {
    ...
    description: {
      ...
      ro: "Pasul Semail este o vale naturală largă care separă Munții Hajar în secțiunile estică și vestică, fiind o rută istorică vitală.",
      en: "The Semail Gap is a wide natural pass that divides the Hajar Mountains into eastern and western sections, serving as a vital route.",
    },
    facts: {
      de: ["Länge von etwa 60 Kilometern", "Trennt den West-Hadschar vom Ost-Hadschar", "Historisch wichtigster Karawanenweg Omans", "Verbindet die Küstenregion mit dem Binnenland"],
      hu: ["Körülbelül 60 kilométer hosszú", "Elválasztja a Nyugati- és Keleti-Hadsart", "Omán legfontosabb történelmi karavánútja", "Összeköti Maszkatot a belső régiókkal"],
      ro: ["Lungime de aproximativ 60 de kilometri", "Separă Hajarul de Vest de Hajarul de Est", "Cea mai importantă rută istorică de caravane", "Conectează regiunea de coastă cu interiorul"],
      en: ["Approximate length of 60 kilometers", "Divides Western and Eastern Hajar ranges", "Oman's most vital historical caravan route", "Connects the coastal area with the interior"],
    },
    imageHint: "Aerial view of Semail Gap valley in Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Jebel Ja'alan este masivul muntos situat în extremitatea estică a sistemului Hajar, marcând sfârșitul lanțului lângă Marea Arabiei.",
      en: "Jebel Ja'alan is the easternmost mountain massif of the Hajar system, marking the end of the range near the Arabian Sea.",
    },
    facts: {
      de: ["Maximale Höhe von etwa 1200 Metern", "Besteht überwiegend aus Sedimentgestein", "Markanter Orientierungspunkt für Seefahrer", "Beherbergt seltene arabische Gazellen"],
      hu: ["Maximális magassága kb. 1200 méter", "Főként üledékes kőzetekből épül fel", "Fontos tájékozódási pont a hajósoknak", "Ritka arab gazellák élőhelye"],
      ro: ["Înălțime maximă de aproximativ 1200 metri", "Compus în principal din roci sedimentare", "Punct de reper important pentru navigatori", "Adăpostește gazele arabe rare"],
      en: ["Maximum elevation of about 1200 meters", "Composed mainly of sedimentary rocks", "Prominent landmark for coastal sailors", "Home to rare Arabian gazelles"],
    },
    imageHint: "Jebel Jaalan mountain peak Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Sahtan este un bazin spectaculos în formă de bol în Munții Hajar, înconjurat de pereți abrupți de peste 1000 de metri înălțime.",
      en: "Wadi Sahtan is a striking bowl-shaped basin in the Hajar Mountains, surrounded by steep walls exceeding 1000 meters in height.",
    },
    facts: {
      de: ["Wird oft als 'Schüssel von Sahtan' bezeichnet", "Nur über steile Bergpässe erreichbar", "Umfasst mehrere isolierte Bergdörfer", "Besitzt ein einzigartiges Mikroklima"],
      hu: ["Gyakran 'Szahtan táljaként' emlegetik", "Csak meredek hágókon át közelíthető meg", "Több elszigetelt hegyi falu található benne", "Egyedi mikroklímával rendelkezik"],
      ro: ["Cunoscut sub numele de 'Bolul Sahtan'", "Accesibil doar prin pasuri montane abrupte", "Conține mai multe sate montane izolate", "Are un microclimat montan unic"],
      en: ["Often called the 'Bowl of Sahtan'", "Accessible only via steep mountain passes", "Contains several isolated mountain villages", "Possesses a unique mountain microclimate"],
    },
    imageHint: "Wadi Sahtan bowl basin mountains Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Escarpamentul Huqf este o treaptă geologică importantă în centrul Omanului, care expune straturi de rocă foarte vechi la suprafață.",
      en: "The Huqf Escarpment is a geologically significant ridge in central Oman that brings ancient rock layers to the surface.",
    },
    facts: {
      de: ["Zeigt Gesteine aus dem Präkambrium", "Erstreckt sich über 100 Kilometer", "Wichtig für die Erdölgeologie Omans", "Durchschnittshöhe von 200 bis 300 Metern"],
      hu: ["Prekambriumi kőzeteket tár fel", "Több mint 100 kilométer hosszan nyúlik el", "Kiemelt jelentőségű az olajgeológia számára", "Átlagos magassága 200-300 méter"],
      ro: ["Expune roci din era Precambriană", "Se întinde pe o lungime de peste 100 km", "Crucial pentru geologia petrolieră a Omanului", "Înălțime medie între 200 și 300 de metri"],
      en: ["Exposes rocks from the Precambrian era", "Extends for over 100 kilometers", "Crucial for Oman's petroleum geology", "Average elevation of 200 to 300 meters"],
    },
    imageHint: "Huqf Escarpment geological ridge Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Jebel Al-Lathib este un vârf proeminent din Munții Dhofar, cunoscut pentru vegetația bogată în timpul sezonului musonic.",
      en: "Jebel Al-Lathib is a prominent peak in the Dhofar mountain range, known for its lush vegetation during the monsoon season.",
    },
    facts: {
      de: ["Höhe von etwa 1300 Metern", "Wird stark vom Khareef-Monsun beeinflusst", "Wichtiger Standort für Weihrauchbäume", "Bietet Ausblicke auf die Salalah-Ebene"],
      hu: ["Magassága körülbelül 1300 méter", "Erősen érinti a Khareef-monszun", "A tömjénfák fontos termőhelye", "Kilátást nyújt a Szalála-síkságra"],
      ro: ["Înălțime de aproximativ 1300 metri", "Puternic influențat de musonul Khareef", "Locație importantă pentru arborii de tămâie", "Oferă panorame asupra câmpiei Salalah"],
      en: ["Elevation of approximately 1300 meters", "Heavily affected by the Khareef monsoon", "Important site for frankincense trees", "Offers views over the Salalah coastal plain"],
    },
    imageHint: "Jebel Al-Lathib green mountain Dhofar Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Tanuf este un defileu impresionant la poalele Jebel Akhdar, faimos pentru pereții verticali de calcar și izvoarele sale.",
      en: "Wadi Tanuf is an impressive gorge at the foot of Jebel Akhdar, famous for its vertical limestone walls and water springs.",
    },
    facts: {
      de: ["Quelle des bekannten Tanuf-Mineralwassers", "Beherbergt Ruinen eines alten Dorfes", "Verfügt über einen saisonalen Wasserfall", "Beliebtes Ziel für Wanderer und Kletterer"],
      hu: ["A híres Tanuf ásványvíz forrása", "Egy régi elhagyatott falu romjai találhatók itt", "Szezonális vízeséssel rendelkezik", "Népszerű túrázó és sziklamászó hely"],
      ro: ["Sursa faimoasei ape minerale Tanuf", "Găzduiește ruinele unui sat vechi", "Prezintă o cascadă sezonieră", "Destinație populară pentru drumeții și alpinism"],
      en: ["Source of the famous Tanuf mineral water", "Contains the ruins of an ancient village", "Features a seasonal waterfall", "Popular destination for hikers and climbers"],
    },
    imageHint: "Wadi Tanuf gorge limestone cliffs Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Jebel Al-Rawdah este un platou înalt în exclava Musandam, remarcabil prin aerul răcoros și peisajul montan arid.",
      en: "Jebel Al-Rawdah is a high plateau in the Musandam exclave, distinguished by its cool air and barren mountain landscapes.",
    },
    facts: {
      de: ["Liegt auf etwa 1500 Metern über dem Meer", "Bekannt für traditionelle Steinhäuser (Bait Al Qufl)", "Bietet kühles Klima im heißen Sommer", "Teil des zerklüfteten Musandam-Massivs"],
      hu: ["Kb. 1500 méterrel a tengerszint felett fekszik", "Hagyományos kőházairól (Bait Al Qufl) nevezetes", "Hűvös klímát kínál a forró nyárban", "A csipkézett Muszandam-masszívum része"],
      ro: ["Situat la circa 1500 metri deasupra mării", "Cunoscut pentru casele de piatră (Bait Al Qufl)", "Oferă un climat răcoros în timpul verii", "Parte a masivului accidentat Musandam"],
      en: ["Located at about 1500 meters above sea level", "Known for traditional stone houses (Bait Al Qufl)", "Offers a cool climate during the hot summer", "Part of the rugged Musandam massif"],
    },
    imageHint: "Jebel Al-Rawdah plateau Musandam Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Al-Khoudh este un bazin aluvionar vast lângă Muscat, cunoscut pentru formațiunile sale stâncoase diverse.",
      en: "Wadi Al-Khoudh is a sprawling alluvial basin near Muscat, known for its diverse rock formations and wide channel.",
    },
    facts: {
      de: ["Eines der größten Wassereinzugsgebiete Maskats", "Wichtige Zone für die Grundwasserneubildung", "Beliebtes Ziel für Geländewagenfahrten", "Zeigt interessante geologische Faltungen"],
      hu: ["Maszkat egyik legnagyobb vízgyűjtő területe", "Fontos talajvíz-utánpótlási zóna", "Népszerű terepjárós túrahelyszín", "Érdekes geológiai gyűrődéseket mutat"],
      ro: ["Unul dintre cele mai mari bazine din Muscat", "Zonă importantă pentru reîncărcarea pânzei freatice", "Destinație populară pentru off-road", "Prezintă falii și cutări geologice interesante"],
      en: ["One of Muscat's largest drainage catchments", "Important zone for groundwater recharge", "Popular destination for off-road driving", "Displays interesting geological folding"],
    },
    imageHint: "Wadi Al-Khoudh rocky basin Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Jebel Khadar este un munte proeminent în Hajarul de Est, ridicându-se deasupra văilor din regiunea Sharqiyah.",
      en: "Jebel Khadar is a prominent mountain in the Eastern Hajar range, rising above the surrounding wadis of the Sharqiyah region.",
    },
    facts: {
      de: ["Gipfelhöhe von etwa 1800 Metern", "Gehört zur Kette des Ost-Hadschar", "Besteht aus dunklem, vulkanischem Gestein", "Wenig Vegetation aufgrund extremer Trockenheit"],
      hu: ["Csúcsmagassága kb. 1800 méter", "A Keleti-Hadsar láncolatának része", "Sötét, vulkáni kőzetekből épül fel", "Szegényes növényzet a szárazság miatt"],
      ro: ["Înălțimea vârfului este de circa 1800 metri", "Parte a lanțului muntos Hajar de Est", "Compus din roci vulcanice de culoare închisă", "Vegetație rară din cauza aridității extreme"],
      en: ["Peak elevation of about 1800 meters", "Part of the Eastern Hajar mountain chain", "Composed of dark volcanic rocks", "Sparse vegetation due to extreme aridity"],
    },
    imageHint: "Jebel Khadar mountain range Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Wadi Halfayn este unul dintre cele mai lungi cursuri de apă sezoniere din Oman, curgând din Munții Hajar spre câmpia centrală.",
      en: "Wadi Halfayn is one of Oman's longest seasonal watercourses, flowing from the Hajar Mountains toward the central desert plains.",
    },
    facts: {
      de: ["Entwässert ein Gebiet von 8000 km²", "Fließt in Richtung der südlichen Wüste", "Besitzt antike Bewässerungssysteme (Falaj)", "Wichtige ökologische Korridor für Wildtiere"],
      hu: ["Vízgyűjtő területe kb. 8000 négyzetkilométer", "A déli sivatagok irányába folyik", "Ősi öntözőrendszerek (Falaj) találhatók mentén", "Fontos ökológiai folyosó a vadon élő állatoknak"],
      ro: ["Drenează o suprafață de circa 8000 km²", "Curge spre deșerturile din sudul țării", "Găzduiește sisteme antice de irigații (Falaj)", "Coridor ecologic important pentru fauna locală"],
      en: ["Drains an area of approximately 8000 sq km", "Flows towards the southern desert regions", "Features ancient irrigation systems (Falaj)", "Important ecological corridor for wildlife"],
    },
    imageHint: "Wadi Halfayn desert riverbed Oman",
  },
  {
    ...
    description: {
      ...
      ro: "Dealurile Al-Hamra formează zona de tranziție între câmpie și masivul impunător Jebel Shams.",
      en: "The Al-Hamra Foothills form the transition zone between the plain and the massive Jebel Shams mountain range.",
    },
    facts: {
      de: ["Höhe zwischen 600 und 1000 Metern", "Besteht aus Sediment- und Vulkangestein", "Standort antiker Terrassenlandwirtschaft", "Bietet dramatische Ausblicke auf Al-Hamra"],
      hu: ["Tengerszint feletti magassága 600-1000 méter", "Üledékes és vulkáni kőzetekből áll", "Ősi teraszos mezőgazdaság helyszíne", "Drámai kilátást nyújt Al-Hamra városára"],
      ro: ["Înălțime între 600 și 1000 de metri", "Compuse din roci sedimentare și vulcanice", "Locul unor terase agricole antice", "Oferă vederi spectaculoase asupra Al-Hamra"],
      en: ["Elevation between 600 and 1000 meters", "Composed of sedimentary and volcanic rocks", "Site of ancient terraced agriculture", "Offers dramatic views over Al-Hamra town"],
    },
    imageHint: "Al-Hamra foothills mountains Oman",
  }
];
