...
export const poiExtraGhanaReliefV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      en: "The Akwapim-Togo range is the most prominent and continuous mountain chain in Ghana, representing a massive fold belt of ancient Precambrian rocks. Beginning just north of Accra as the relatively low Akuapem Ridge, the range stretches diagonally across the eastern corridor of the country, steadily gaining elevation as it crosses the Volta River and extends into the Oti Region before crossing into Togo. This dramatic topographical spine forms the absolute eastern boundary of the massive Volta River basin. The rugged, heavily forested slopes fundamentally dictate the hydrology, microclimates, and agricultural practices of the entire eastern half of Ghana. Geography K7 — structural fold mountains."
    },
    factsAdvanced: {
      en: ["The most massive, continuous mountain chain in the entire geographical territory of Ghana.", "Formed by the intense tectonic folding of highly ancient Precambrian rock formations.", "Stretches diagonally from near the capital city, Accra, northeast directly into Togo.", "Forms the absolute, towering eastern boundary of the immense Volta River basin.", "The high elevation drastically increases local rainfall compared to the surrounding plains.", "Creates deep, highly fertile valleys supporting intense commercial agriculture."]
    },
    descriptionAdvanced: {
    ...
    }, image: "/poi-images/akwapim-togo-relief-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      en: "Mount Afadja, commonly referred to as Afadjato, is the highest officially recognized mountain peak in Ghana, standing at an elevation of exactly 885 meters (2,904 feet) above sea level. Located in the Agumatsa Range near the village of Liati Wote in the Volta Region, the mountain sits directly on the international border with Togo. The mountain's steep, sharply rising slopes are covered in incredibly dense, humid tropical forest, making the ascent highly challenging. The peak offers spectacular, sweeping panoramic views of the adjacent deep valleys and the Tagbo Falls. It is a premier destination for rugged eco-tourism and high-altitude ecological research. Geography K7 — highest national elevations."
    },
    factsAdvanced: {
      en: ["The highest officially recognized mountain peak within the borders of Ghana.", "Stands at a measured elevation of exactly 885 meters (2,904 feet) above sea level.", "Located within the rugged Agumatsa Range in the Hohoe municipality of the Volta Region.", "The steep slopes are entirely blanketed by dense, humid tropical forest.", "Geographically sits directly on the international borderline separating Ghana and Togo.", "A highly popular, physically demanding destination for hiking and rigorous eco-tourism."]
    },
    descriptionAdvanced: {
