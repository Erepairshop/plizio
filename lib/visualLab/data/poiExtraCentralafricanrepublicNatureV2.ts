...
export const poiExtraCentralafricanrepublicNatureV2: POI[] = [
  {
    ...
    }, image: "/poi-images/chari-river-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      de: "Der Mbomou-Fluss bildet über eine weite Strecke die natürliche Grenze zwischen der Demokratischen Republik Kongo und der Zentralafrikanischen Republik. Mit einer Länge von rund 800 Kilometern entspringt er im Hochland nahe der Wasserscheide zwischen Kongo und Nil und fließt nach Westen, wo er sich mit dem Uele zum Ubangi vereint. Geografisch ist der Flusslauf von zahlreichen Stromschnellen und kleinen Inseln geprägt, was die durchgehende Schifffahrt erschwert, aber eine wilde, unberührte Flusslandschaft bewahrt hat. Historisch war der Mbomou eine bedeutende Route für den kulturellen Austausch zwischen den Völkern der Region, aber auch ein Schauplatz kolonialer Grenzziehungen. Die Uferregionen sind von dichten Regenwäldern und Savannen bedeckt, die wichtige Korridore für Wildtiere wie Elefanten und Flusspferde darstellen. Der Fluss spielt eine zentrale Rolle für die lokale Bevölkerung, die ihn für den Fischfang und als einzige verlässliche Wasserquelle nutzt. In der Neuzeit ist die Region aufgrund ihrer Abgeschiedenheit ökologisch wertvoll, steht jedoch vor Herausforderungen durch grenzüberschreitende Konflikte und illegale Ressourcenausbeutung.",
  ...
  {
    id: "mount-ngaya-nature-v2",
    type: "mountain",
    parent: "CF-HK",
    coords: [22.4000, 7.8000],
    name: {
      de: "Mont Ngaya",
      hu: "Ngaya-hegy",
      ro: "Muntele Ngaya",
