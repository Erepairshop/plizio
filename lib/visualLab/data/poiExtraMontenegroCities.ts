...
export const montenegroCitiesExtra = ([
  {
    id: "me-podgorica",
    descriptionAdvanced: { 
      ...
      en: "Podgorica serves as the administrative, economic, and cultural heartbeat of Montenegro. Situated strategically at the confluence of five rivers—Morača, Ribnica, Zeta, Cijevna, and Sitnica—the city has transformed significantly from its complex historical past into a modern capital filled with lush green parks and vibrant recreational spaces. It acts as the primary gateway for travelers exploring the country's diverse landscapes and the rich cultural heritage of the Balkan region. Geography K7 – city development." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      en: "Kotor is an exceptional medieval coastal town nestled deep within the dramatic Kotor Bay, surrounded by towering, rugged mountains. Its UNESCO-listed Old Town is a meticulously preserved living museum, defined by a labyrinth of narrow, winding cobblestone streets and historic architecture. The city's unique maritime heritage is deeply rooted in its time as a strategic commercial port under Venetian influence, making it a masterpiece of Balkan historic preservation. History K6 – Mediterranean maritime trade." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      en: "Budva is widely considered the tourism capital of the Montenegrin coast, seamlessly blending a historic fortified Old Town with a vibrant modern lifestyle. Known for its energetic nightlife and rich Mediterranean charm, the city provides access to a diverse array of over 35 distinct sandy and pebble beaches along its coastline. The walled Stari Grad (Old Town) stands as a spectacular example of medieval urban planning, attracting visitors from all over the world. Geography K5 – Mediterranean tourism and coastal management." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      en: "Cetinje stands as the historic and cultural heart of Montenegro, perched on a high karst plateau surrounded by imposing mountains. As the former capital, it retains a distinct regal atmosphere, showcasing preserved royal palaces, national museums, and historic diplomatic legations that played pivotal roles in European history. Today, it serves as the ultimate repository of Montenegrin national identity and heritage. History K8 – 19th-century European monarchies and independence." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      en: "Bar functions as the primary maritime gateway for Montenegro, balancing a bustling modern port city with profound historical depth. Just a few kilometers from the modern center lies Stari Bar (Old Bar), a massive ruin site that offers travelers a fascinating look into millennia of history encompassing Illyrian, Roman, Venetian, and Ottoman eras. It remains a strategic node on Adriatic maritime trade routes. History K7 – maritime logistics and history." 
    },
    factsAdvanced: { 
  ...
  },
  {
    id: "me-herceg-novi",
    descriptionAdvanced: { 
      de: "Herceg Novi ist als die 'Stadt der Sonne' bekannt und fungiert als botanischer Garten der Bucht von Kotor. Die Küstenstadt wurde stark von venezianischen, osmanischen und spanischen Einflüssen geprägt, was sich in ihren zahlreichen Festungen widerspiegelt. Die mediterrane Vegetation, das milde Klima und die charmante Altstadt mit endlosen Treppen machen sie zu einem der faszinierendsten Küstenorte. Geographie K6 – Mediterrane Hafenstädte.", 
      ...
      en: "Herceg Novi is a captivating coastal town located at the entrance to the Kotor Bay, distinguished by its exceptionally pleasant Mediterranean climate and lush, subtropical flora. Often referred to as the 'City of Stairs,' the urban layout is defined by steep inclines and thousands of stone steps that connect its various levels. Rich in historic fortresses, it offers both natural beauty and a deep historical context. Geography K4 – Mediterranean microclimates and urban topography." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      en: "Tivat has undergone a dynamic transformation from a historic naval base into a high-end luxury resort and yachting hub. At the core of this rebirth is Porto Montenegro, a premier destination that has become one of the most exclusive maritime centers in the Adriatic region. This shift has redefined Tivat's role, turning it into a cornerstone of Montenegro's modern economic and luxury tourism development. Geography K8 – sustainable tourism and economic growth." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      en: "Žabljak is widely recognized as the highest town in the Balkans, situated deep within the heart of Durmitor National Park. A true four-season paradise, the town attracts skiers during the winter months and becomes a premier hub for hikers and climbers in the summer. It is most famous for its 18 spectacular glacial lakes, known locally as 'mountain eyes,' which provide stunning vistas amidst the rugged alpine terrain. Geography K6 – mountain geography and eco-tourism." 
    },
    factsAdvanced: { 
  ...
  },
  {
    ...
    descriptionAdvanced: { 
      ...
      hu: "Ulcinj Montenegró legdélibb városa, amely hosszú homokos strandjairól és keleti hangulatáról ismert. A város történelme a kalózoktól az illír törzsekig sokszínű, ma pedig az ország egyik legfontosabb turisztikai célpontja. A városfalakon belül található óváros csodálatos kilátást nyújt az Adriai-tengerre. Történelem K5 – kalózok és kereskedelem.", 
      ...
      en: "Ulcinj is the southernmost coastal city of Montenegro, celebrated for its expansive sandy beaches and distinct oriental cultural atmosphere. The city's history is incredibly diverse, stretching back to ancient Illyrian tribes and through a notorious era as a pirate stronghold. Today, Ulcinj stands as one of the country's most significant tourist destinations, offering a unique blend of deep historical roots and modern seaside relaxation. History K5 – history of Mediterranean piracy and regional commerce." 
    },
    factsAdvanced: { 
      de: ["Der 'Velika Plaža' (Große Strand) ist mit 13 Kilometern einer der längsten Sandstrände an der Adria.", "Ulcinj war im 16. und 17. Jahrhundert ein gefürchtetes Zentrum für Seeräuber.", "Die Stadt hat eine mehrheitlich albanischsprachige Bevölkerung.", "Der berühmte spanische Schriftsteller Miguel de Cervantes soll hier als Sklave gefangen gehalten worden sein.", "Die Salinen von Ulcinj sind ein wichtiges Brut- és Rastgebiet für Tausende von Zugvögeln, darunter Flamingos."], 
...
export const montenegroOtherExtra = ([
  ] as unknown as POI[]);
