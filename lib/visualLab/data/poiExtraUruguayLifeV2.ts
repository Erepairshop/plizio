...
export const poiExtraUruguayLifeV2: POI[] = [
  {
    ...
    factsAdvanced: {
      de: [
        "Das Projekt wurde 1999 ins Leben gerufen und wird privat finanziert.",
        "Der Park beherbergt eines der modernsten Zentren für die Aufzucht bedrohter Arten in Südamerika.",
    ...
    }, image: "/poi-images/bioparque-mbopicua-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Der Park erstreckt sich über eine beeindruckende Fläche von mehr als 120 Hektar.",
        "Er beherbergt eine der weltweit größten Gruppen der vom Aussterben bedrohten Mendesantilope in Gefangenschaft.",
  ...
  {
    id: "reserva-cerro-pan-de-azucar-life-v2",
    type: "animal-habitat",
    parent: "UY-MA",
    coords: [-55.25, -34.8],
    name: {
    ...
    factsAdvanced: {
      de: [
        "Das Reservat wurde 1980 gegründet und ist nach dem markanten 'Zuckerhut'-Berg benannt.",
        "Es beherbergt die 'Estación de Cría de Fauna Autóctona', eine renommierte Zuchtstation für lokale Tiere.",
    ...
    }, image: "/poi-images/reserva-cerro-pan-de-azucar-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Der Park beherbergt über 120 verschiedene Arten, darunter viele seltene südamerikanische Vögel.",
        "Eine Besonderheit ist der große See, auf dem man mit Tretbooten die Wasserwelt erkunden kann.",
    ...
    }, image: "/poi-images/ecoparque-talice-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Das Weingut nutzt historische Tunnel, die früher Teil einer Jesuitenmission waren.",
        "Juanicó war das erste Weingut in Uruguay, das die Tannat-Traube für den internationalen Export veredelte.",
    ...
    }, image: "/poi-images/establecimiento-juanico-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Narbona blickt auf eine Geschichte zurück, die bis ins Jahr 1709 als Farm und Hafenstation reicht.",
        "Der Bauernhof produziert eine der besten Dulce de Leche Uruguays nach einem geheimen Hausrezept.",
  ...
  },
  {
    ...
    factsAdvanced: {
      de: [
        "Die Bodega war das weltweit erste Weingut außerhalb der USA, das die vollständige LEED-Zertifizierung erhielt.",
        "Garzón produziert preisgekröntes Olivenöl, das international zur Spitzenklasse zählt.",
  ...
  {
    id: "reserva-natural-salus-life-v2",
    type: "animal-habitat",
    parent: "UY-LA",
    coords: [-55.3333, -34.4],
    name: {
    ...
    factsAdvanced: {
      de: [
        "Das Reservat umfasst eine Fläche von über 1.300 Hektar in den Sierras de Minas.",
        "Der Wald beherbergt über 100 verschiedene Baumarten und eine Vielzahl von Orchideen.",
  ...
  {
    id: "parque-nacional-cabo-polonio-life-v2",
    type: "animal-habitat",
    parent: "UY-RO",
    coords: [-53.7833, -34.4],
    name: {
    ...
    factsAdvanced: {
      de: [
        "Die Kolonie umfasst sowohl Südamerikanische Seelöwen als auch Seebären.",
        "Die Tiere können hier das ganze Jahr über in ihrem natürlichen Habitat beobachtet werden.",
    ...
    }, image: "/poi-images/parque-nacional-cabo-polonio-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Auf der Insel leben Schätzungen zufolge über 200.000 Robben und Seelöwen.",
        "Der Leuchtturm von Isla de Lobos wurde 1906 erbaut und ist 59 Meter hoch.",
  ...
  {
    id: "esteros-de-farrapos-life-v2",
    type: "animal-habitat",
    parent: "UY-RN",
    ...
    factsAdvanced: {
      de: [
        "Das Schutzgebiet umfasst 24 Inseln und eine Gesamtfläche von über 17.000 Hektar.",
        "Über 200 verschiedene Vogelarten wurden in diesem Gebiet bereits registriert.",
    ...
    }, image: "/poi-images/esteros-de-farrapos-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Die Lagune ist Teil eines UNESCO-Biosphärenreservats und ein Ramsar-Feuchtgebiet.",
        "Sie ist durch einen schmalen Sandstreifen vom Ozean getrennt, der sich periodisch öffnet.",
  ...
  },
  {
    ...
    factsAdvanced: {
      de: [
        "Die Farm ist landesweit für ihr handwerklich hergestelltes Dulce de Leche ohne Konservierungsstoffe bekannt.",
        "Besucher können an kostenlosen Verkostungen der verschiedenen Milchprodukte teilnehmen.",
    ...
    }, image: "/poi-images/tambo-lapataia-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Die Bleistiftsammlung umfasst über 24.000 verschiedene Exemplare aus aller Welt.",
        "Der Betrieb verarbeitet Früchte wie Feigen, Pfirsiche und Quitten direkt vom eigenen Land.",
    ...
    }, image: "/poi-images/granja-arenas-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Karumbé bedeutet in der indigenen Sprache Guaraní 'Schildkröte'.",
        "Das Projekt betreibt mehrere Stationen entlang der uruguayischen Küste.",
    ...
    }, image: "/poi-images/karumbe-tortugas-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Der Ombu-Wald von Castillos gilt als botanisches Weltwunder, da diese Bäume sonst Solitäre sind.",
        "Die Lagune ist mit dem Ozean durch den Bach Arroyo Valizas verbunden.",
    ...
    }, image: "/poi-images/laguna-de-castillos-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Das Gebiet wurde 1976 zum UNESCO-Biosphärenreservat erklärt.",
        "Es beherbergt die weltweit größte Konzentration von Butiá-Palmen.",
    ...
    }, image: "/poi-images/banados-del-este-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Die Bodega wurde in einer wunderschön restaurierten Scheune aus dem Jahr 1942 eingerichtet.",
        "Bouza war ein Pionier bei der Einführung der galicischen Albarino-Traube in Uruguay.",
  ...
  {
    id: "quebrada-de-los-cuervos-life-v2",
    type: "animal-habitat",
    parent: "UY-TT",
    ...
    factsAdvanced: {
      de: [
        "Die Schlucht ist an einigen Stellen über 100 Meter tief.",
        "Hier wachsen Farne und Bäume, die sonst nur in weitaus nördlicheren Regionen Südamerikas vorkommen.",
    ...
    }, image: "/poi-images/quebrada-de-los-cuervos-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Das Valle del Lunarejo umfasst eine geschützte Fläche von rund 30.000 Hektar.",
        "Der Park beherbergt über 150 Vogelarten, von denen viele nirgendwo sonst in Uruguay vorkommen.",
    ...
    }, image: "/poi-images/valle-del-lunarejo-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Das geschützte Waldgebiet erstreckt sich über eine Fläche von mehr als 20.000 Hektar.",
        "Es beherbergt die höchste Dichte an einheimischen Baumarten im ganzen Land.",
    ...
    }, image: "/poi-images/montes-del-queguay-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Der Park verfügt über ein eigenes Hotel und Hunderte von kleinen Bungalows für Besucher.",
        "Es gibt ein großes Wegenetz für Wanderungen zu Aussichtspunkten über die Berge von Minas.",
    ...
    }, image: "/poi-images/parque-ute-antel-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Die Sammlung umfasst über 10.000 verschiedene Muschelarten aus allen Weltmeeren.",
        "Das Museum ist in vier große Themenbereiche unterteilt: Muscheln, Meereskunde, Geschichte und Bademode.",
    ...
    }, image: "/poi-images/museo-del-mar-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Salto ist das Hauptanbaugebiet für Blaubeeren in Uruguay aufgrund der milden Winter.",
        "Uruguay exportiert jährlich mehrere tausend Tonnen frische Blaubeeren in alle Welt.",
    ...
    }, image: "/poi-images/arandanos-salto-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "In Rincón de Franquía wurden bereits über 220 verschiedene Vogelarten dokumentiert.",
        "Das Gebiet dient als wichtiger biologischer Korridor zwischen Uruguay, Argentinien und Brasilien.",
    ...
    }, image: "/poi-images/rincon-de-franquia-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Die Estancia wurde 1854 von Pedro Jackson gegründet und war ein Vorzeigebetrieb seiner Zeit.",
        "San Pedro de Timote war eines der ersten Anwesen Uruguays mit eigenem Telefonanschluss und Elektrizität.",
    ...
    }, image: "/poi-images/san-pedro-de-timote-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Die Farm nutzt traditionelle Kaltpressverfahren, um die volle Qualität des Öls zu erhalten.",
        "Besucher können während der Erntezeit aktiv mitwirken und den Weg der Olive verfolgen.",
    ...
    }, image: "/poi-images/chacra-la-anyta-life-v2.webp"},
  {
    ...
    factsAdvanced: {
      de: [
        "Agroland bewirtschaftet eine Fläche von über 4.000 Hektar Land.",
        "Das Unternehmen ist der größte Produzent von Pekannüssen in Uruguay.",
  ...
  {
    id: "museo-oceanografico-life-v2",
    type: "kid-landmark",
    parent: "UY-MO",
    ...
    factsAdvanced: {
      de: [
        "Das Gebäude wurde ursprünglich als Leichenhalle konzipiert, aber nie als solche genutzt.",
        "Der markante Baustil ist als 'Neo-Mudéjar' bekannt und in Uruguay sehr selten.",
  ...
  {
    id: "parque-salto-del-penitente-life-v2",
    type: "kid-landmark",
    parent: "UY-LA",
    ...
    factsAdvanced: {
      de: [
        "Der Name 'Penitente' (der Büßer) stammt von einer Felsformation, die an einen betenden Mönch erinnert.",
        "Der Park bietet eine der längsten Ziplines Uruguays mit über 300 Metern Länge.",
