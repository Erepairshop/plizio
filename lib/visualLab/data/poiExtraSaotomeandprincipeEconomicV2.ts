...
,
  {
    ...
    description: {
      ...
      ro: "Depozitul central pentru produse petroliere gestionează rezervele de energie ale țării și este situat strategic pe coasta de nord.",
      en: "The central storage facility for petroleum products manages the nation's energy reserves and is strategically located on the north coast.",
    },
    facts: {
      de: ["Verwaltet von der Empresa Nacional de Combustíveis e Óleos", "Wichtigster Knotenpunkt für den Import von Diesel und Benzin", "Verfügt über großvolumige oberirdische Lagertanks", "Versorgt das nahegelegene Wärmekraftwerk mit Brennstoff"],
      hu: ["Az Empresa Nacional de Combustíveis e Óleos üzemelteti", "A gázolaj- és benzimport legfontosabb csomópontja", "Nagy kapacitású, föld feletti tárolótartályokkal rendelkezik", "Ellátja üzemanyaggal a közeli hőerőművet"],
      ro: ["Administrat de Empresa Nacional de Combustíveis e Óleos", "Principalul nod pentru importul de motorină și benzină", "Dispune de rezervoare de stocare supraterane de mare capacitate", "Furnizează combustibil centralei termoelectrice din apropiere"],
      en: ["Managed by the Empresa Nacional de Combustíveis e Óleos", "Primary hub for diesel and gasoline imports", "Features large-capacity above-ground storage tanks", "Supplies fuel to the nearby thermal power station"],
    },
    imageHint: "Industrial fuel storage tanks near a tropical coast",
  },
  {
    ...
    description: {
      ...
      ro: "Acesta este principalul nod pentru infrastructura digitală a țării, găzduind conexiunea la cablurile submarine.",
      en: "This is the primary hub for the nation's digital infrastructure, housing the connection to undersea fiber-optic cables.",
    },
    facts: {
      de: ["Hauptsitz der Companhia Santomense de Telecomunicações", "Verwaltet den internationalen Internetverkehr des Landes", "Beinhaltet die Landestation für das ACE-Unterseekabel", "Zentraler Punkt für das nationale Mobilfunknetz"],
      hu: ["A Companhia Santomense de Telecomunicações székhelye", "Kezeli az ország nemzetközi internetforgalmát", "Itt található az ACE tenger alatti kábel végpontja", "A nemzeti mobilhálózat központi egysége"],
      ro: ["Sediul Companhia Santomense de Telecomunicações", "Gestionează traficul internațional de internet al țării", "Include stația de aterizare pentru cablul submarin ACE", "Punct central pentru rețeaua națională de telefonie mobilă"],
      en: ["Headquarters of Companhia Santomense de Telecomunicações", "Manages the country's international internet traffic", "Houses the landing station for the ACE undersea cable", "Central point for the national mobile network"],
    },
    imageHint: "Modern telecommunications building with satellite dishes",
  },
  {
    ...
    description: {
      ...
      ro: "Centrul administrativ și tehnic al furnizorului național de energie controlează distribuția de energie pentru insula São Tomé.",
      en: "The administrative and technical center of the national power utility controls electricity distribution for the entire São Tomé island.",
    },
    facts: {
      de: ["Betrieben von der Empresa de Água e Electricidade", "Überwacht den Betrieb von Dieselgeneratoren und Wasserkraft", "Zentrale Leitstelle für das nationale Stromnetz", "Wichtigster Arbeitgeber im Versorgungssektor der Hauptstadt"],
      hu: ["Az Empresa de Água e Electricidade üzemelteti", "Felügyeli a dízelgenerátorok és vízerőművek működését", "A nemzeti villamosenergia-hálózat központi vezérlője", "A főváros közműszektorának legfontosabb foglalkoztatója"],
      ro: ["Operat de Empresa de Água e Electricidade", "Monitorizează funcționarea generatoarelor diesel și hidro", "Dispeceratul central pentru rețeaua electrică națională", "Principalul angajator din sectorul utilităților din capitală"],
      en: ["Operated by Empresa de Água e Electricidade", "Monitors operation of diesel generators and hydro power", "Central control room for the national electrical grid", "Key employer in the capital's utility sector"],
    },
    imageHint: "Electrical substation and administrative office building",
  },
  {
    ...
    description: {
      ...
      ro: "Această zonă din portul Ana Chaves servește ca principal terminal de containere și centru de procesare a comerțului maritim.",
      en: "This zone at the Port of Ana Chaves serves as the primary container terminal and processing center for maritime trade.",
    },
    facts: {
      de: ["Verwaltet von der Nationalen Hafenbehörde ENAPORT", "Zentraler Punkt für den Warenumschlag von Konsumgütern", "Beinhaltet Zollämter und Frachtlagerhallen", "Wichtigstes Tor für Importe aus Europa und Angola"],
      hu: ["Az ENAPORT nemzeti kikötői hatóság kezeli", "A fogyasztási cikkek áruforgalmának központi helyszíne", "Vámhivatalokat és raktárakat foglal magában", "Az Európából és Angolából érkező import fő kapuja"],
      ro: ["Administrat de autoritatea portuară națională ENAPORT", "Punct central pentru manipularea mărfurilor de larg consum", "Include birouri vamale și depozite de marfă", "Poarta principală pentru importurile din Europa și Angola"],
      en: ["Managed by the national port authority ENAPORT", "Central point for consumer goods cargo handling", "Includes customs offices and freight warehouses", "Main gateway for imports from Europe and Angola"],
    },
    imageHint: "Container shipping terminal with cranes and warehouses",
  },
  {
    ...
    description: {
      ...
      ro: "Centrul economic al insulei Príncipe cuprinde administrația și unitățile comerciale locale din regiunea Pagué.",
      en: "The economic hub of Príncipe island encompasses the administration and local commercial units in the Pagué region.",
    },
    facts: {
      de: ["Verwaltungssitz der autonomen Region Príncipe", "Zentrum für die Verteilung von Gütern auf der Insel", "Beinhaltet kleine Verarbeitungsbetriebe für Fisch", "Wichtiger Standort für die lokale Tourismusverwaltung"],
      hu: ["Príncipe autonóm régiójának adminisztratív székhelye", "A sziget áruelosztási forgalmának központja", "Kisebb halfeldolgozó üzemeknek ad otthont", "A helyi turisztikai igazgatás fontos helyszíne"],
      ro: ["Sediul administrativ al regiunii autonome Príncipe", "Centru pentru distribuția mărfurilor pe insulă", "Include mici unități de procesare a peștelui", "Locație importantă pentru administrația locală a turismului"],
      en: ["Administrative seat of the autonomous region of Príncipe", "Center for the distribution of goods across the island", "Houses small-scale fish processing facilities", "Key location for local tourism management"],
    },
    imageHint: "Regional government and commercial buildings in a tropical setting",
  },
  {
    ...
    description: {
      ...
      ro: "În acest centru agricol, cacaoa și cafeaua destinate exportului sunt pregătite și verificate din punct de vedere calitativ.",
      en: "In this agricultural center, cocoa and coffee destined for export are prepared and quality-checked.",
    },
    facts: {
      de: ["Spezialisiert auf die Trocknung von Kakaobohnen", "Dient als Sammelstelle für Kleinbauern der Region", "Verfügt über moderne Sortieranlagen für Kaffeebohnen", "Wichtiger Bestandteil der landwirtschaftlichen Wertschöpfungskette"],
      hu: ["Kakaóbab szárítására specializálódott üzem", "A régió kistermelőinek gyűjtőpontjaként szolgál", "Modern kávébab-válogató berendezésekkel rendelkezik", "A mezőgazdasági értéklánc fontos eleme"],
      ro: ["Specializat în uscarea boabelor de cacao", "Servește ca punct de colectare pentru micii fermieri", "Dispune de echipamente moderne de sortare a boabelor de cafea", "Element important al lanțului valoric agricol"],
      en: ["Specializes in the drying of cocoa beans", "Serves as a collection point for regional smallholders", "Features modern coffee bean sorting equipment", "Key component of the agricultural value chain"],
    },
    imageHint: "Agricultural warehouse with cocoa beans drying on trays",
  },
  {
    ...
    description: {
      ...
      ro: "Această locație din districtul Lobata este un centru semnificativ pentru cultivarea și prima procesare a culturilor agricole.",
      en: "This location in the Lobata district is a significant center for the cultivation and primary processing of crops.",
    },
    facts: {
      de: ["Schwerpunkt auf der Produktion von Nahrungsmitteln für den Inlandsmarkt", "Standort für landwirtschaftliche Schulungsprojekte", "Verfügt über Bewässerungsanlagen für den Gemüseanbau", "Zentraler Umschlagplatz für Erzeugnisse aus dem Norden"],
      hu: ["A hazai piacra szánt élelmiszertermelésre összpontosít", "Mezőgazdasági képzési projektek helyszíne", "Öntözőrendszerekkel rendelkezik a zöldségtermesztéshez", "Az északi területek terményeinek központi elosztóhelye"],
      ro: ["Se concentrează pe producția de alimente pentru piața internă", "Locație pentru proiecte de instruire agricolă", "Dispune de sisteme de irigații pentru cultivarea legumelor", "Punct central de distribuție pentru produsele din nord"],
      en: ["Focuses on food production for the domestic market", "Site for agricultural training projects", "Features irrigation systems for vegetable cultivation", "Central distribution point for produce from the north"],
    },
    imageHint: "Tropical fields and agricultural storage buildings",
  },
  {
    ...
    description: {
      ...
      ro: "Acest domeniu de pe insula Príncipe este cunoscut pentru producția sa de cacao de înaltă calitate și dispune de plantații vaste.",
      en: "This estate on Príncipe island is known for its high-quality cocoa production and features extensive plantation areas.",
    },
    facts: {
      de: ["Produziert zertifizierten Bio-Kakao für den Weltmarkt", "Verwendet traditionelle Fermentationsmethoden", "Wichtiger Arbeitgeber für die südliche Region von Príncipe", "Teil eines nachhaltigen Forstwirtschaftsprojekts"],
      hu: ["Minősített bio kakaót termel a világpiacra", "Hagyományos fermentációs módszereket alkalmaz", "Príncipe déli régiójának fontos foglalkoztatója", "Egy fenntartható erdőgazdálkodási projekt része"],
      ro: ["Produce cacao organică certificată pentru piața mondială", "Utilizează metode tradiționale de fermentare", "Angajator important pentru regiunea de sud a insulei Príncipe", "Parte a unui proiect de gestionare durabilă a pădurilor"],
      en: ["Produces certified organic cocoa for the world market", "Utilizes traditional fermentation methods", "Significant employer for the southern region of Príncipe", "Part of a sustainable forest management project"],
    },
    imageHint: "Lush cocoa plantation with fermentation sheds",
  },
  {
    ...
    description: {
      ...
      ro: "Terminalul din vârful sudic este punctul critic de legătură logistică pentru traficul către insula Ilhéu das Rolas.",
      en: "The terminal at the southern tip is the critical logistical link for traffic to the island of Ilhéu das Rolas.",
    },
    facts: {
      de: ["Hauptabfahrtspunkt für Personenfähren und Versorgungsboote", "Zentrum für den lokalen Fischhandel im Süden", "Beinhaltet Anlegestellen für private Tourismusunternehmen", "Strategischer Punkt für die Überwachung der Küstengewässer"],
      hu: ["A személyszállító kompok és ellátóhajók fő indulási pontja", "A déli területek helyi halkereskedelmi központja", "Magán turisztikai vállalkozások kikötőhelyeit foglalja magában", "Stratégiai pont a parti vizek ellenőrzésére"],
      ro: ["Principalul punct de plecare pentru feriboturi și bărci de aprovizionare", "Centru pentru comerțul local cu pește în sud", "Include dane pentru companii private de turism", "Punct strategic pentru monitorizarea apelor de coastă"],
      en: ["Main departure point for passenger ferries and supply boats", "Hub for local fish trade in the south", "Includes docking facilities for private tourism enterprises", "Strategic point for monitoring coastal waters"],
    },
    imageHint: "Small concrete pier with boats in a tropical cove",
  },
  {
    ...
    description: {
      ...
      ro: "Această zonă servește la extracția materialelor de construcție și este o locație importantă pentru dezvoltarea infrastructurii locale.",
      en: "This area serves the extraction of construction materials and is an important site for local infrastructure development.",
    },
    facts: {
      de: ["Wichtigste Quelle für Basalt und Gesteinskörnung im Norden", "Versorgt Straßenbauprojekte auf der Insel São Tomé", "Standort für Zerkleinerungs- und Sortieranlagen", "Wesentlicher Beitrag zur Unabhängigkeit von Materialimporten"],
      hu: ["A bazalt és kőzúzalék legfontosabb forrása északon", "São Tomé szigetének útépítési projektjeit látja el", "Kőzúzó és válogató berendezések telephelye", "Jelentősen hozzájárul az importfüggőség csökkentéséhez"],
      ro: ["Cea mai importantă sursă de bazalt și agregate din nord", "Alimentează proiectele de construcție a drumurilor de pe insulă", "Locație pentru instalații de concasare și sortare", "Contribuție esențială la independența față de importurile de materiale"],
      en: ["Primary source of basalt and aggregates in the north", "Supplies road construction projects across São Tomé island", "Site for crushing and sorting machinery", "Significant contribution to reducing dependency on material imports"],
    },
    imageHint: "Open-pit quarry with construction machinery",
  }
];
