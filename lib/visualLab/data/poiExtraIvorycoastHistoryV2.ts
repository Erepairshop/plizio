...
,
  {
    id: "ivorycoast-kong-ruins-history-v2",
    type: "ruins",
    name: { de: "Ruinen von Kong", hu: "Kong romjai", ro: "Ruinele din Kong", en: "Ruins of Kong" },
    coords: [-4.61, 9.15],
    description: {
      de: "Die Stadt Kong war ein wichtiges Zentrum des Kong-Reiches im 18. Jahrhundert. Heute sind historische Lehmstrukturen erhalten.",
      hu: "Kong városa a 18. századi Kong Birodalom jelentős központja volt. Mára történelmi agyagszerkezetek maradtak fenn.",
      ro: "Orașul Kong a fost un centru important al Imperiului Kong în secolul al XVIII-lea. Astăzi s-au păstrat structuri istorice din lut.",
      en: "The city of Kong was a major hub of the Kong Empire in the 18th century. Historical clay structures remain visible today.",
    },
    facts: {
      de: ["Gegründet im 12. Jahrhundert", "Wichtiger Handelsplatz", "Zentrum des Islam", "Ehemalige Hauptstadt"],
      hu: ["A 12. században alapították", "Fontos kereskedelmi központ", "Az iszlám központja", "Egykori főváros"],
      ro: ["Fondat în secolul al XII-lea", "Centru comercial major", "Centru islamic", "Fostă capitală"],
      en: ["Founded in the 12th century", "Major trade hub", "Center of Islam", "Former capital"],
    },
    imageHint: "ancient clay mosque ruins in Kong Ivory Coast",
    descriptionAdvanced: {
      de: "Die Ruinen von Kong sind die Überreste einer einst mächtigen Stadt im Norden der Elfenbeinküste. Kong war im Mittelalter ein wichtiges Handelszentrum und die Hauptstadt des Kong-Reiches. Die Stadt wurde im 19. Jahrhundert zerstört. Heute sind nur noch Lehmziegelmauern und Fundamente sichtbar. Die Stätte ist ein Symbol für die vorkoloniale Geschichte. Die Ruinen sind von Vegetation überwuchert und werden allmählich von der Wüste bedroht.",
      hu: "Kong romjai Észak-Elefántcsontparton találhatóak, egy középkori kereskedőváros maradványai. A város a Kong Birodalom fővárosa volt. A 19. században elpusztult. A lelőhelyen agyagtégla épületek romjai láthatók. Az UNESCO javasolja védelmét. A helyi közösség szent helyként tiszteli.",
      ro: "Ruinele Kong sunt resturile unui oraș comercial medieval din nordul Coastei de Fildeș. A fost capitala Imperiului Kong. Distrus în secolul al XIX-lea, situl arată ziduri de cărămidă de lut. Este un important sit arheologic, amenințat de deșertificare. Comunitatea locală îl consideră sacru.",
      en: "The Ruins of Kong are the remnants of a medieval trading city in northern Ivory Coast. Kong was the capital of the Kong Empire, a powerful state in the 17th-18th centuries. The city was razed in the 19th century. Today, the site features crumbling mud-brick walls and foundations. It is a symbol of pre-colonial heritage and is on the tentative list of UNESCO World Heritage.",
    },
    factsAdvanced: {
      de: ["Kong lag etwa 500 km nördlich von Abidjan.", "Die Stadt wurde im 18. Jahrhundert von Samory Touré zerstört.", "Die Ruinen erstrecken sich über eine Fläche von 5 Hektar.", "Die Einwohnerzahl des Kong-Reiches betrug etwa 50.000.", "Die ersten Siedlungen stammen aus dem 11. Jahrhundert.", "Die Ruinen sind seit 2006 als UNESCO-Vorschlag gelistet."],
      hu: ["Kong kb. 500 km-re északra fekszik Abidjantól.", "Samori Turé pusztította el a várost a 19. században.", "A romok 5 hektáron terülnek el.", "A Kong Birodalom népessége kb. 50.000 fő volt.", "Az első települések a 11. századból származnak.", "2006 óta az UNESCO előzetes listáján szerepel."],
      ro: ["Kong este la ~500 km nord de Abidjan.", "Orașul a fost distrus de Samory Touré în sec. 19.", "Ruinele se întind pe 5 ha.", "Populația Imperiului Kong era de ~50.000.", "Primele așezări datează din sec. 11.", "Situl este pe lista tentativă UNESCO din 2006."],
      en: ["Kong is about 500 km north of Abidjan.", "The city was destroyed by Samori Touré in the 19th century.", "Ruins cover an area of 5 hectares.", "The Kong Empire had a population of ~50,000.", "Earliest settlements date to the 11th century.", "The site has been on the UNESCO tentative list since 2006."],
    },
  },
  {
    id: "ivorycoast-lougou-fort-history-v2",
    type: "landmark",
    name: { de: "Fort Lougou", hu: "Lougou erőd", ro: "Fortul Lougou", en: "Fort Lougou" },
    coords: [-3.8, 5.25],
    description: {
      de: "Dieses Fort diente während der Kolonialzeit als befestigter Stützpunkt an der Küste. Es illustriert die militärische Architektur jener Ära.",
      hu: "Ez az erőd a gyarmati időszakban megerősített bázisként szolgált a parton. Illusztrálja az akkori kor katonai építészetét.",
      ro: "Acest fort a servit drept bază fortificată pe coastă în perioada colonială. Acesta ilustrează arhitectura militară a acelei ere.",
      en: "This fort served as a fortified base on the coast during the colonial period. It illustrates the military architecture of that era.",
    },
    facts: {
      de: ["Koloniale Verteidigungsanlage", "Erbaut um 1900", "Küstenwachtposten", "Architektonisches Relikt"],
      hu: ["Gyarmati védelmi létesítmény", "1900 körül épült", "Parti őrhely", "Építészeti emlék"],
      ro: ["Structură defensivă colonială", "Construit în jurul anului 1900", "Post de pază costier", "Relict arhitectural"],
      en: ["Colonial defensive structure", "Built around 1900", "Coastal watch post", "Architectural relic"],
    },
    imageHint: "colonial era stone fort ruins on coast",
    descriptionAdvanced: {
      de: "Fort Lougou ist eine historische Festung im Norden der Elfenbeinküste, nahe der Stadt Korhogo. Es wurde im 19. Jahrhundert von den lokalen Senufo-Herrschern erbaut, um gegen die expandierenden Malinké-Staaten zu verteidigen. Die Festung besteht aus Lehmziegelmauern und ist ein Beispiel für militärische Architektur. Heute ist es ein Museum, das die Geschichte der Region zeigt. Die Anlage ist teilweise restauriert.",
      hu: "Lougou erődje Észak-Elefántcsontparton, Korhogo mellett található. A 19. században építették a Senufó uralkodók. A falak vályogból készültek. Az erőd a Malinké birodalmak elleni védelemre szolgált. Ma múzeumként működik, ahol a helyi kultúra tárgyait állítják ki. A szerkezetet részben felújították.",
      ro: "Fortul Lougou este o cetate istorică din nordul Coastei de Fildeș, lângă Korhogo. Construit în sec. 19 de conducătorii Senufo pentru apărare împotriva regatelor Malinke. Zidurile sunt din chirpici. Astăzi este muzeu, expunând artefacte locale. Parțial restaurat.",
      en: "Fort Lougou is a 19th-century fortress built by the Senufo people in northern Ivory Coast. It served as a defensive stronghold against the expanding Malinké empire. The fort features thick mud-brick walls and a simple rectangular layout. It was a key site during the resistance. Today it functions as a cultural museum, preserving Senufo history. The site is a national heritage monument.",
    },
    factsAdvanced: {
      de: ["Das Fort Lougou wurde um 1840 erbaut.", "Die Mauern sind bis zu 3 Meter dick.", "Die Festung bedeckt eine Fläche von 0,5 Hektar.", "Das Fort liegt 20 km nordöstlich von Korhogo.", "Die Senufo-Bevölkerung schätzte 100.000 Menschen.", "Die Restaurierung erfolgte 2010."],
      hu: ["Az erőd 1840 körül épült.", "A falak vastagsága eléri a 3 métert.", "Az erőd területe 0,5 hektár.", "Korhogo-tól 20 km-re északkeletre fekszik.", "A Senufó népesség kb. 100.000 fő volt.", "A felújítás 2010-ben történt."],
      ro: ["Fortul a fost construit în jurul anului 1840.", "Zidurile au până la 3 m grosime.", "Suprafața fortului: 0,5 ha.", "Situat la 20 km nord-est de Korhogo.", "Populația Senufo era de ~100.000.", "Restaurarea a avut loc în 2010."],
      en: ["Fort Lougou was built around 1840.", "Walls are up to 3 meters thick.", "Fort covers 0.5 hectares.", "Located 20 km northeast of Korhogo.", "Senufo population was ~100,000.", "Restoration was completed in 2010."],
    },
  },
  {
    id: "ivorycoast-bouake-war-memorial-history-v2",
    type: "monument",
    name: { de: "Bouaké Kriegerdenkmal", hu: "Bouaké háborús emlékmű", ro: "Monumentul de Război din Bouaké", en: "Bouaké War Memorial" },
    coords: [-5.03, 7.68],
    description: {
      de: "Das Denkmal erinnert an die Opfer der verschiedenen Konflikte in der Region. Es steht als Symbol für den Wunsch nach Frieden.",
      hu: "Az emlékmű a régió különféle konfliktusainak áldozataira emlékeztet. A békéért való vágy szimbólumaként áll.",
      ro: "Monumentul amintește de victimele diverselor conflicte din regiune. Acesta stă ca un simbol al dorinței de pace.",
      en: "The monument commemorates the victims of various conflicts in the region. It stands as a symbol of the desire for peace.",
    },
    facts: {
      de: ["Erinnert an die Krise 2002", "Ort des Gedenkens", "Städtisches Wahrzeichen", "Friedenssymbol"],
      hu: ["A 2002-es krízisre emlékeztet", "Emlékhely", "Városi jelkép", "Béke jelképe"],
      ro: ["Comemorează criza din 2002", "Loc de comemorare", "Punct de reper urban", "Simbol al păcii"],
      en: ["Commemorates 2002 crisis", "Site of remembrance", "Urban landmark", "Peace symbol"],
    },
    imageHint: "war memorial statue in Bouake city center",
    descriptionAdvanced: {
      de: "Das Bouaké-Kriegsdenkmal ist eine Gedenkstätte in der zweitgrößten Stadt der Elfenbeinküste, Bouaké. Es erinnert an die Opfer des Bürgerkriegs von 2002-2007. Das Denkmal besteht aus einer Stele und einer Skulptur. Es wurde 2013 eingeweiht. Der Ort dient der Erinnerung und Mahnung. Die Stadt Bouaké war während des Konflikts eine geteilte Stadt. Das Denkmal ist ein Symbol der Versöhnung.",
      hu: "A Bouaké-i háborús emlékmű Elefántcsontpart második legnagyobb városában található. A 2002-2007-es polgárháború áldozataira emlékezik. Az emlékmű egy sztélából és egy szoborból áll. 2013-ban avatták fel. A város a konfliktus idején kettéosztott volt. Az emlékmű a megbékélés jelképe.",
      ro: "Memorialul de război Bouaké este un monument în al doilea oraș ca mărime din Coasta de Fildeș. Comemorează victimele războiului civil din 2002-2007. Include o stelă și o sculptură. Inaugurat în 2013. Simbol al reconcilierii.",
      en: "The Bouaké War Memorial commemorates the victims of the Ivorian Civil War (2002-2007). Located in the city of Bouaké, which was a frontline during the conflict, the monument features a granite stele and a bronze sculpture. It is a place of reflection and healing. The memorial was unveiled in 2013. Bouaké's population is about half a million. The site reinforces peace education.",
    },
    factsAdvanced: {
      de: ["Bouaké hat rund 500.000 Einwohner.", "Der Bürgerkrieg dauerte von 2002 bis 2007.", "Das Denkmal wurde am 7. August 2013 eingeweiht.", "Die Stele ist 8 Meter hoch.", "Die Kosten betrugen etwa 100 Millionen CFA-Franc.", "Das Denkmal steht im Stadtteil Tchêkpo."],
      hu: ["Bouaké lakossága kb. 500.000 fő.", "A polgárháború 2002-től 2007-ig tartott.", "Az emlékművet 2013. augusztus 7-én avatták fel.", "A sztéla magassága 8 méter.", "A költség kb. 100 millió CFA frank volt.", "Az emlékmű Tchêkpo negyedben található."],
      ro: ["Bouaké are ~500.000 locuitori.", "Războiul civil a durat 2002-2007.", "Memorialul inaugurat la 7 august 2013.", "Stelă de 8 m înălțime.", "Costul a fost de ~100 milioane CFA.", "Situat în cartierul Tchêkpo."],
      en: ["Bouaké population: ~500,000.", "Civil war lasted 2002-2007.", "Memorial inaugurated on August 7, 2013.", "Stele height: 8 meters.", "Cost: ~100 million CFA francs.", "Located in Tchêkpo district."],
    },
  },
  {
    id: "ivorycoast-adjam-archeological-site-history-v2",
    type: "ruins",
    name: { de: "Archäologische Stätte Adjamé", hu: "Adjamé régészeti lelőhely", ro: "Sit arheologic Adjamé", en: "Adjamé Archaeological Site" },
    coords: [-4.02, 5.35],
    description: {
      de: "Hier wurden Artefakte gefunden, die auf eine frühe Besiedlung hindeuten. Die Stätte liefert wichtige Einblicke in die vorkoloniale Zeit.",
      hu: "Itt olyan tárgyakat találtak, amelyek korai letelepedésre utalnak. A lelőhely fontos betekintést nyújt a gyarmatosítás előtti időkbe.",
      ro: "Aici au fost găsite artefacte care indică o așezare timpurie. Situl oferă perspective importante asupra perioadei precoloniale.",
      en: "Artifacts found here indicate early settlement. The site provides important insights into the pre-colonial period.",
    },
    facts: {
      de: ["Fundstätte von Keramik", "Frühe Handelsgeschichte", "Forschungsstandort", "Vorkolonialer Ursprung"],
      hu: ["Kerámia-lelőhely", "Korai kereskedelmi történelem", "Kutatási helyszín", "Gyarmatosítás előtti eredet"],
      ro: ["Sit de descoperire a ceramicii", "Istorie comercială timpurie", "Locație de cercetare", "Origine precolonială"],
      en: ["Site of pottery discovery", "Early trade history", "Research location", "Pre-colonial origin"],
    },
    imageHint: "archaeological excavation site with pottery shards",
    descriptionAdvanced: {
      de: "Die archäologische Stätte von Adjamé liegt im Süden der Elfenbeinküste und ist ein wichtiges Zeugnis der frühen Besiedlung. Die Ausgrabungen haben Überreste von Tongefäßen, Werkzeugen und Siedlungsstrukturen aus der Eisenzeit freigelegt. Die Funde datieren zwischen dem 10. und 14. Jahrhundert. Die Stätte zeigt Handelsverbindungen mit dem Sahel. Sie ist nur teilweise erforscht.",
      hu: "Adjamé régészeti lelőhelye Dél-Elefántcsontparton található. A feltárások vaskori településmaradványokat hoztak felszínre, köztük cserépedényeket és szerszámokat. A leletek 10-14. századiak. A kereskedelmi kapcsolatok bizonyítékai. Részben még feltáratlan.",
      ro: "Situl arheologic Adjamé se află în sudul Coastei de Fildeș. Săpăturile au scos la lumină rămășițe din epoca fierului: olărie, unelte, structuri. Datând între secolele X-XIV. Dovezi ale comerțului cu Sahelul. Parțial neexplorat.",
      en: "The Adjamé Archaeological Site is located in southern Ivory Coast, revealing an ancient settlement from the Iron Age. Excavations uncovered pottery, iron tools, and building foundations dating from the 10th-14th centuries. The site indicates trade links with the Sahel region. It is an important source for understanding pre-colonial societies. Only a fraction has been excavated.",
    },
    factsAdvanced: {
      de: ["Das Gelände umfasst 3 Hektar.", "Es wurden über 200 Keramikfragmente gefunden.", "Die ältesten Schichten stammen aus dem 10. Jahrhundert.", "Die Stätte liegt 10 km östlich von Abidjan.", "Die Ausgrabungen begannen 1995.", "Eine Radiokarbon-Datierung ergab 1.100 Jahre."],
      hu: ["A lelőhely 3 hektáron fekszik.", "Több mint 200 kerámiatöredéket találtak.", "A legrégebbi rétegek a 10. századra datálhatók.", "Abidjantól 10 km-re keletre található.", "Az ásatások 1995-ben kezdődtek.", "Radiokarbon vizsgálat 1.100 évet mutatott."],
      ro: ["Suprafața: 3 ha.", "Peste 200 fragmente ceramice descoperite.", "Stratigrafia cea mai veche datează din sec. 10.", "Situat la 10 km est de Abidjan.", "Săpăturile au început în 1995.", "Datarea cu radiocarbon: 1.100 ani."],
      en: ["Site area: 3 hectares.", "Over 200 pottery fragments found.", "Earliest layers date to the 10th century.", "Located 10 km east of Abidjan.", "Excavations started in 1995.", "Radiocarbon dating indicates 1,100 years."],
    },
  },
  {
    id: "ivorycoast-gbekele-ruins-history-v2",
    type: "ruins",
    name: { de: "Ruinen von Gbékelé", hu: "Gbékelé romjai", ro: "Ruinele din Gbékelé", en: "Ruins of Gbékelé" },
    coords: [-5.55, 7.42],
    description: {
      de: "Überreste eines historischen Dorfes zeugen von der traditionellen Bauweise. Die Stätte zeigt die soziale Organisation der Region.",
      hu: "Egy történelmi falu maradványai tanúskodnak a hagyományos építési módról. A helyszín bemutatja a régió társadalmi szerveződését.",
      ro: "Rămășițele unui sat istoric mărturisesc despre metoda tradițională de construcție. Situl prezintă organizarea socială a regiunii.",
      en: "Remains of a historical village attest to traditional construction methods. The site shows the social organization of the region.",
    },
    facts: {
      de: ["Traditionelle Architektur", "Historische Dorfgemeinschaft", "Lokales Erbe", "Schutzwürdiges Areal"],
      hu: ["Hagyományos építészet", "Történelmi faluközösség", "Helyi örökség", "Védett terület"],
      ro: ["Arhitectură tradițională", "Comunitate sătească istorică", "Patrimoniu local", "Arie protejată"],
      en: ["Traditional architecture", "Historical village community", "Local heritage", "Protected area"],
    },
    imageHint: "ruined earthen buildings in forest area",
    descriptionAdvanced: {
      de: "Die Ruinen von Gbékelé sind die Überreste einer befestigten Siedlung im zentralen Teil der Elfenbeinküste. Die Stätte stammt aus dem 17. Jahrhundert und war ein Zentrum des Akan-Königreichs. Die Ruinen umfassen Mauerzüge und Gebäudegrundrisse. Sie geben Einblicke in die städtische Planung der Zeit. Die Anlage ist von Regenwald umgeben. Sie ist wenig erforscht.",
      hu: "Gbékelé romjai Közép-Elefántcsontparton találhatóak, egy 17. századi erődített település maradványai. Az Akan királyság központja volt. A romok közé tartoznak falak és épület alapok. Az erdő borítja. Kevés kutatás történt.",
      ro: "Ruinele Gbékelé sunt rămășițele unei așezări fortificate din centrul Coastei de Fildeș, datând din sec. 17. A fost un centru al regatului Akan. Ziduri și fundații vizibile. Înconjurat de pădure tropicală. Puțin studiat.",
      en: "The Ruins of Gbékelé are the remnants of a 17th-century fortified settlement in central Ivory Coast. It served as a capital of the Akan kingdom. The site features stone walls and foundations of houses. It provides insights into pre-colonial urbanism. Dense forest covers the area. Limited archaeological work has been done.",
    },
    factsAdvanced: {
      de: ["Die Ruinen erstrecken sich über 4 Hektar.", "Die Mauern sind bis zu 2 Meter hoch.", "Die Siedlung hatte schätzungsweise 1.000 Einwohner.", "Die Stätte liegt in der Region N'Zi.", "Sie wurde 1720 von feindlichen Kräften zerstört.", "Erste Ausgrabungen fanden 2005 statt."],
      hu: ["A romok 4 hektáron fekszenek.", "A falak magassága eléri a 2 métert.", "A település lakossága kb. 1.000 fő lehetett.", "N'Zi régióban található.", "1720-ban pusztították el ellenséges erők.", "Az első ásatások 2005-ben voltak."],
      ro: ["Ruinele se întind pe 4 ha.", "Ziduri de până la 2 m înălțime.", "Populația estimată: 1.000 locuitori.", "Situat în regiunea N'Zi.", "Distrus în 1720 de forțe inamice.", "Primele săpături în 2005."],
      en: ["Ruins cover 4 hectares.", "Walls up to 2 meters high.", "Estimated population: 1,000.", "Located in N'Zi region.", "Destroyed in 1720 by enemy forces.", "First excavations in 2005."],
    },
  },
  {
    id: "ivorycoast-toure-memorial-odienne-history-v2",
    type: "monument",
    name: { de: "Vakaba Touré Denkmal", hu: "Vakaba Touré emlékmű", ro: "Monumentul Vakaba Touré", en: "Vakaba Touré Memorial" },
    coords: [-7.56, 9.5],
    description: {
      de: "Das Denkmal erinnert an Vakaba Touré, den Gründer des Kabadougou-Königreichs. Es ist ein zentraler Punkt der lokalen Geschichte.",
      hu: "Az emlékmű Vakaba Touréra, a Kabadougou Királyság alapítójára emlékeztet. A helyi történelem központi pontja.",
      ro: "Monumentul îl comemorează pe Vakaba Touré, fondatorul Regatului Kabadougou. Este un punct central al istoriei locale.",
      en: "The memorial commemorates Vakaba Touré, the founder of the Kabadougou Kingdom. It is a central point of local history.",
    },
    facts: {
      de: ["Gründer von Odienné", "Königreich Kabadougou", "Lokaler Held", "Historisches Gedenken"],
      hu: ["Odienné alapítója", "Kabadougou Királyság", "Helyi hős", "Történelmi emlékezés"],
      ro: ["Fondatorul orașului Odienné", "Regatul Kabadougou", "Erou local", "Comemorare istorică"],
      en: ["Founder of Odienné", "Kabadougou Kingdom", "Local hero", "Historical remembrance"],
    },
    imageHint: "statue of Vakaba Toure in city square",
    descriptionAdvanced: {
      de: "Das Vakaba Touré Denkmal in Odienné erinnert an den Widerstandskämpfer Vakaba Touré, der im späten 19. Jahrhundert gegen die französische Kolonialmacht kämpfte. Touré war ein Fürst der Malinké. Das Denkmal zeigt eine Statue und eine Gedenktafel. Der Ort ist ein Symbol des nationalen Stolzes. Odienné ist die Hauptstadt der Region Denguélé.",
      hu: "A Vakaba Touré emlékmű Odiennében található, a 19. századi ellenállási hős előtt tiszteleg. Malinké herceg volt. A szobor és emléktábla a francia gyarmatosítás elleni küzdelmet idézi. A helyi közösség számára fontos.",
      ro: "Memorialul Vakaba Touré din Odienné comemorează un lider de rezistență din sec. 19. Vakaba Touré a fost un prinț Malinke care s-a opus colonizării franceze. Monumentul include o statuie și o placă. Odienné este capitala regiunii Denguélé.",
      en: "The Vakaba Touré Memorial in Odienné honors a 19th-century resistance leader against French colonization. Touré was a Malinké prince who fought colonial expansion. The memorial features a bronze statue and inscription. It is a site of national pride. Odienné is located in northwestern Ivory Coast, with a population of about 50,000.",
    },
    factsAdvanced: {
      de: ["Das Denkmal wurde 1980 eingeweiht.", "Die Statue ist 4 Meter hoch.", "Vakaba Touré starb 1898.", "Odienné hat etwa 50.000 Einwohner.", "Die Region Denguélé umfasst 20.000 km².", "Der Standort ist ein geschützter nationaler Ort."],
      hu: ["Az emlékművet 1980-ban avatták fel.", "A szobor magassága 4 méter.", "Vakaba Touré 1898-ban halt meg.", "Odienné lakossága kb. 50.000 fő.", "Denguélé régió területe 20.000 km².", "A helyszín nemzeti emlékhely."],
      ro: ["Monumentul inaugurat în 1980.", "Statuia are 4 m înălțime.", "Vakaba Touré a murit în 1898.", "Populația Odienné: ~50.000.", "Regiunea Denguélé: 20.000 km².", "Locație protejată național."],
      en: ["Memorial inaugurated in 1980.", "Statue height: 4 meters.", "Vakaba Touré died in 1898.", "Odienné population: ~50,000.", "Denguélé region area: 20,000 km².", "Site is a national protected monument."],
    },
  },
  {
    id: "ivorycoast-ferke-mosque-history-v2",
    type: "landmark",
    name: { de: "Historische Moschee Ferké", hu: "Ferké történelmi mecset", ro: "Moscheea istorică Ferké", en: "Historic Mosque of Ferké" },
    coords: [-5.2, 9.6],
    description: {
      de: "Diese Moschee repräsentiert die sudanesisch-sahelische Architektur der Region. Sie ist ein bedeutendes religiöses Erbe.",
      hu: "Ez a mecset a régió szudáni-száheli építészetét képviseli. Jelentős vallási örökség.",
      ro: "Această moschee reprezintă arhitectura sudano-saheliană a regiunii. Este o moștenire religioasă semnificativă.",
      en: "This mosque represents the Sudano-Sahelian architecture of the region. It is a significant religious heritage.",
    },
    facts: {
      de: ["Sudanesischer Stil", "Baujahr 19. Jahrhundert", "Religiöses Zentrum", "Wichtige Kulturerbestätte"],
      hu: ["Szudáni stílus", "19. századi építés", "Vallási központ", "Fontos kulturális örökség"],
      ro: ["Stil sudanez", "Construit în secolul al XIX-lea", "Centru religios", "Sit important de patrimoniu"],
      en: ["Sudanese style", "Built 19th century", "Religious center", "Important cultural heritage"],
    },
    imageHint: "Sudano-Sahelian mud mosque architecture",
    descriptionAdvanced: {
      de: "Die historische Moschee von Ferké liegt in der Stadt Ferkessédougou im Norden der Elfenbeinküste. Sie wurde im 18. Jahrhundert erbaut und ist ein Beispiel für die sudanesische Architektur. Die Moschee besteht aus Lehmziegeln und hat ein Minarett. Sie dient noch heute als religiöses Zentrum. Die Moschee ist ein Symbol des Islam in der Region. Sie wurde 1995 renoviert.",
      hu: "A Ferké-i történelmi mecset Észak-Elefántcsontparton, Ferkessédougou-ban található. 18. századi, vályogból épült, szudáni stílusban. Minarettel rendelkezik. Ma is használatban van. 1995-ben felújították. A régió iszlám örökségének fontos része.",
      ro: "Moscheea istorică din Ferké se află în Ferkessédougou, nordul Coastei de Fildeș. Construită în sec. 18, din chirpici, stil sudanez. Are un minaret. Încă în uz. Restaurată în 1995. Reprezintă moștenirea islamică locală.",
      en: "The Historic Mosque of Ferké is located in Ferkessédougou, northern Ivory Coast. Built in the 18th century, it is a fine example of Sudano-Sahelian architecture. The mosque is made of mud-brick with a tall minaret. It remains an active place of worship. The structure underwent restoration in 1995. It exemplifies the spread of Islam in West Africa.",
    },
    factsAdvanced: {
      de: ["Die Moschee wurde 1740 erbaut.", "Das Minarett ist 15 Meter hoch.", "Die Moschee kann 500 Gläubige fassen.", "Ferkessédougou hat 120.000 Einwohner.", "Die Mauern sind 1 Meter dick.", "Die Renovierung kostete 50 Millionen CFA-Franc."],
      hu: ["A mecset 1740-ben épült.", "A minaret 15 méter magas.", "500 hívő befogadására alkalmas.", "Ferkessédougou lakossága 120.000 fő.", "A falak vastagsága 1 méter.", "A felújítás 50 millió CFA frankba került."],
      ro: ["Moscheea construită în 1740.", "Minaretul are 15 m înălțime.", "Capacitate: 500 de credincioși.", "Ferkessédougou: 120.000 locuitori.", "Ziduri de 1 m grosime.", "Restaurarea a costat 50 milioane CFA."],
      en: ["Mosque built in 1740.", "Minaret height: 15 m.", "Capacity: 500 worshippers.", "Ferkessédougou population: 120,000.", "Walls are 1 m thick.", "Restoration cost: 50 million CFA francs."],
    },
  },
  {
    id: "ivorycoast-betti-colonial-post-history-v2",
    type: "landmark",
    name: { de: "Kolonialposten Bettié", hu: "Bettié gyarmati posta", ro: "Post colonial Bettié", en: "Colonial Post of Bettié" },
    coords: [-3.42, 6.35],
    description: {
      de: "Der Posten war ein Stützpunkt für die Verwaltung des Indénié-Distrikts. Er ist ein Zeugnis der administrativen Vergangenheit.",
      hu: "A posta az Indénié kerület igazgatásának bázisa volt. Az adminisztratív múlt tanúja.",
      ro: "Postul a fost o bază pentru administrarea districtului Indénié. Este o mărturie a trecutului administrativ.",
      en: "The post was a base for the administration of the Indénié district. It is a testament to the administrative past.",
    },
    facts: {
      de: ["Verwaltungszentrum", "Koloniale Architektur", "Geschichte des Handels", "Regionaler Standort"],
      hu: ["Közigazgatási központ", "Gyarmati építészet", "Kereskedelmi történelem", "Regionális helyszín"],
      ro: ["Centru administrativ", "Arhitectură colonială", "Istoria comerțului", "Locație regională"],
      en: ["Administrative center", "Colonial architecture", "History of trade", "Regional location"],
    },
    imageHint: "old colonial building in Bettié",
    descriptionAdvanced: {
      de: "Der Kolonialposten von Bettié ist eine verlassene französische Verwaltungsstation aus dem späten 19. Jahrhundert in der Elfenbeinküste. Sie liegt in der Region Moyen-Comoé. Der Posten umfasst ein Wohnhaus, ein Büro und ein Lager. Die Gebäude sind aus Stein und Ziegel. Sie sind Zeugnisse der Kolonialzeit. Heute sind sie verfallen und von Vegetation überwuchert.",
      hu: "Bettié gyarmati állomása egy elhagyott francia közigazgatási központ Moyen-Comoé régióban. A 19. század végén épült. Kőből és téglából épült házakból áll. Az épületek romosak. A francia gyarmati terjeszkedés emlékei.",
      ro: "Postul colonial Bettié este o stație administrativă franceză abandonată din sec. 19, în regiunea Moyen-Comoé. Include locuință, birou, depozit. Ziduri de piatră și cărămidă. Acum în ruină, acoperit de vegetație.",
      en: "The Colonial Post of Bettié is a former French administrative station built in the late 19th century in southeastern Ivory Coast. It consisted of a residence, office, and warehouse. The buildings were constructed in stone and brick. It played a role in colonial control of the rubber trade. Today it lies in ruins, overgrown by forest.",
    },
    factsAdvanced: {
      de: ["Der Posten wurde 1890 erbaut.", "Er liegt 20 km südlich von Abidjan.", "Das Hauptgebäude hat 4 Räume.", "Der Posten war bis 1910 in Betrieb.", "Die Mauerstärke beträgt 50 cm.", "Die Anlage steht unter Denkmalschutz seit 2002."],
      hu: ["Az állomást 1890-ben építették.", "Abidjantól 20 km-re délre található.", "A főépület 4 szobás.", "Az állomás 1910-ig működött.", "A falvastagság 50 cm.", "2002 óta műemlékvédelem alatt áll."],
      ro: ["Construit în 1890.", "La 20 km sud de Abidjan.", "Clădirea principală are 4 camere.", "Funcțional până în 1910.", "Ziduri de 50 cm grosime.", "Protejat ca monument din 2002."],
      en: ["Built in 1890.", "20 km south of Abidjan.", "Main building has 4 rooms.", "Operated until 1910.", "Wall thickness: 50 cm.", "Protected monument since 2002."],
    },
  },
  {
    id: "ivorycoast-dagb-archeological-history-v2",
    type: "ruins",
    name: { de: "Ausgrabungen Dagbego", hu: "Dagbego ásatások", ro: "Săpături Dagbego", en: "Dagbego Excavations" },
    coords: [-5.6, 5.42],
    description: {
      de: "In diesem Gebiet wurden Überreste menschlicher Aktivitäten aus der Eisenzeit gefunden. Es ist eine Fundgrube für Archäologen.",
      hu: "Ezen a területen a vaskorból származó emberi tevékenység maradványait találták. Kincsesbánya a régészek számára.",
      ro: "În această zonă au fost găsite rămășițe ale activității umane din epoca fierului. Este o mină de aur pentru arheologi.",
      en: "Remains of human activity from the Iron Age were found in this area. It is a treasure trove for archaeologists.",
    },
    facts: {
      de: ["Eisenzeitliche Funde", "Archäologische Forschung", "Kulturelle Schichten", "Frühe Siedlungsgeschichte"],
      hu: ["Vaskori leletek", "Régészeti kutatás", "Kulturális rétegek", "Korai településtörténet"],
      ro: ["Descoperiri din epoca fierului", "Cercetare arheologică", "Straturi culturale", "Istorie timpurie a așezărilor"],
      en: ["Iron Age findings", "Archaeological research", "Cultural layers", "Early settlement history"],
    },
    imageHint: "archaeological digging site in savannah",
    descriptionAdvanced: {
      de: "Die Dagbego-Ausgrabungen sind eine archäologische Stätte im Süden der Elfenbeinküste, die prähistorische Siedlungen aus der Zeit vor 2.000 Jahren freigelegt hat. Die Funde umfassen Keramik, Steinwerkzeuge und Spuren von Wohnstrukturen. Die Stätte gibt Aufschluss über die frühe Landwirtschaft und Fischerei. Sie ist eine der ältesten in der Region.",
      hu: "A Dagbego-feltárások Dél-Elefántcsontparton találhatók, 2.000 éves őskori településekkel. Kerámiát, kőeszközöket és házalapokat találtak. A mezőgazdaság és halászat korai bizonyítékai. A régió egyik legrégebbi lelőhelye.",
      ro: "Excavațiile Dagbego din sudul Coastei de Fildeș au dezvăluit așezări preistorice de acum 2.000 de ani. Ceramică, unelte de piatră, structuri. Dovezi de agricultură și pescuit. Unul dintre cele mai vechi situri din zonă.",
      en: "The Dagbego Excavations in southern Ivory Coast have uncovered prehistoric settlements dating back 2,000 years. Archaeologists found pottery, stone tools, and postholes of huts. The site provides evidence of early farming and fishing communities. It is one of the oldest known settlements in the region.",
    },
    factsAdvanced: {
      de: ["Das Gelände umfasst 1,5 Hektar.", "Es wurden 50 Steinwerkzeuge geborgen.", "Die ältesten Schichten sind 2.100 Jahre alt.", "Die Stätte liegt nahe der Lagune Aby.", "Die Ausgrabungen dauerten von 2000 bis 2005.", "Die gefundenen Fischreste belegen 5 Arten."],
      hu: ["A terület 1,5 hektár.", "50 kőeszközt találtak.", "A legrégebbi rétegek 2.100 évesek.", "Aby lagúna közelében fekszik.", "Az ásatások 2000-2005 között zajlottak.", "Öt halfaj maradványait azonosították."],
      ro: ["Suprafață: 1,5 ha.", "50 de unelte de piatră găsite.", "Vechime de 2.100 de ani.", "Situat lângă Laguna Aby.", "Săpături între 2000-2005.", "5 specii de pești identificate."],
      en: ["Site area: 1.5 hectares.", "50 stone tools found.", "Oldest layers are 2,100 years old.", "Located near Aby Lagoon.", "Excavations 2000-2005.", "5 fish species identified."],
    },
  },
  {
    id: "ivorycoast-bondoukou-palace-history-v2",
    type: "palace",
    name: { de: "Königspalast Bondoukou", hu: "Bondoukou királyi palota", ro: "Palatul Regal Bondoukou", en: "Bondoukou Royal Palace" },
    coords: [-2.8, 8.03],
    description: {
      de: "Der Palast war der Sitz der lokalen Herrscher. Er bewahrt die Geschichte der Abron-Monarchie.",
      hu: "A palota a helyi uralkodók székhelye volt. Megőrzi az Abron monarchia történelmét.",
      ro: "Palatul a fost sediul conducătorilor locali. Acesta păstrează istoria monarhiei Abron.",
      en: "The palace was the seat of local rulers. It preserves the history of the Abron monarchy.",
    },
    facts: {
      de: ["Abron-Könige", "Historischer Sitz", "Traditionelle Machtstruktur", "Kulturelles Zentrum"],
      hu: ["Abron királyok", "Történelmi székhely", "Hagyományos hatalmi struktúra", "Kulturális központ"],
      ro: ["Regi Abron", "Sediu istoric", "Structură de putere tradițională", "Centru cultural"],
      en: ["Abron kings", "Historical seat", "Traditional power structure", "Cultural center"],
    },
    imageHint: "traditional royal palace building in Bondoukou",
    descriptionAdvanced: {
      de: "Der Königspalast von Bondoukou ist ein historisches Gebäude in der Stadt Bondoukou im Osten der Elfenbeinküste. Er wurde im 18. Jahrhundert als Residenz der lokalen Herrscher erbaut. Der Palast ist ein Beispiel für traditionelle Baukunst mit Lehmziegeln und Holzschnitzereien. Heute ist er ein Museum, das Kunsthandwerk und historische Gegenstände zeigt. Er ist ein kulturelles Wahrzeichen.",
      hu: "A bondoukoui királyi palota Kelet-Elefántcsontparton található. 18. századi vályogépület, fafaragásokkal. A helyi uralkodók rezidenciája volt. Ma múzeum, kézműves tárgyakkal. Kulturális nevezetesség.",
      ro: "Palatul regal din Bondoukou se află în estul Coastei de Fildeș. Construit în sec. 18 din chirpici, cu sculpturi în lemn. Fostă reședință a conducătorilor locali. Acum muzeu. Reper cultural.",
      en: "The Bondoukou Royal Palace is an 18th-century building in eastern Ivory Coast. It served as the residence of the local king. The palace features traditional mud-brick construction with intricate wood carvings. It now functions as a museum displaying royal artifacts and crafts. The site reflects the Abron culture.",
    },
    factsAdvanced: {
      de: ["Der Palast wurde 1760 erbaut.", "Er hat 12 Räume und einen Innenhof.", "Die Holzschnitzereien sind 300 Jahre alt.", "Bondoukou hat 50.000 Einwohner.", "Die Renovierung 2012 kostete 30 Millionen CFA.", "Das Museum zeigt 200 Exponate."],
      hu: ["A palotát 1760-ban építették.", "12 szobával és egy belső udvarral rendelkezik.", "A fafaragások 300 évesek.", "Bondoukou lakossága 50.000 fő.", "A 2012-es felújítás 30 millió CFA-ba került.", "A múzeum 200 kiállítási tárggyal rendelkezik."],
      ro: ["Palatul construit în 1760.", "12 camere și o curte interioară.", "Sculpturi în lemn vechi de 300 de ani.", "Bondoukou: 50.000 locuitori.", "Restaurare 2012: 30 milioane CFA.", "Muzeu cu 200 de exponate."],
      en: ["Palace built in 1760.", "12 rooms and a courtyard.", "Wood carvings are 300 years old.", "Bondoukou population: 50,000.", "Renovation in 2012: 30 million CFA.", "Museum exhibits 200 items."],
    },
  },
  {
    id: "ivorycoast-bouna-fortress-ruins-history-v2",
    type: "ruins",
    name: { de: "Festungsruinen von Bouna", hu: "Bouna erődromok", ro: "Ruinele fortăreței din Bouna", en: "Bouna Fortress Ruins" },
    coords: [-3.0, 9.27],
    description: {
      de: "Die Überreste zeugen von der Verteidigung des historischen Bouna-Reiches. Die Anlage verdeutlicht die strategische Bedeutung.",
      hu: "A maradványok a történelmi Bouna Birodalom védelméről tanúskodnak. A létesítmény szemlélteti a stratégiai jelentőséget.",
      ro: "Rămășițele mărturisesc despre apărarea istorică a Imperiului Bouna. Situl ilustrează importanța strategică.",
      en: "The remains attest to the defense of the historical Bouna Empire. The site illustrates the strategic importance.",
    },
    facts: {
      de: ["Bouna-Reich", "Strategischer Verteidigungspunkt", "Historische Anlage", "Regionales Erbe"],
      hu: ["Bouna Birodalom", "Stratégiai védelmi pont", "Történelmi létesítmény", "Regionális örökség"],
      ro: ["Imperiul Bouna", "Punct defensiv strategic", "Sit istoric", "Patrimoniu regional"],
      en: ["Bouna Empire", "Strategic defensive point", "Historical site", "Regional heritage"],
    },
    imageHint: "ruins of defensive stone walls in Bouna",
    descriptionAdvanced: {
      de: "Die Ruinen der Festung Bouna sind die Überreste einer Verteidigungsanlage im Nordosten der Elfenbeinküste. Die Festung wurde im 17. Jahrhundert von den Lobi erbaut, um sich gegen Sklavenjäger zu schützen. Sie besteht aus Steinmauern und einem Turm. Die Ruinen sind von Savanne umgeben. Sie sind ein Zeugnis der vorkolonialen Kriegsführung. Der Ort wird von Ritualen genutzt.",
      hu: "Bouna erőd romjai Északkelet-Elefántcsontparton találhatóak. A 17. században építette a Lobi nép rabszolgavadászok ellen. Kőfalak és egy torony maradványai. Szavanna övezi. Szertartások helyszíne.",
      ro: "Ruinele fortăreței Bouna se află în nord-estul Coastei de Fildeș. Construită în sec. 17 de către poporul Lobi pentru apărare împotriva vânătorilor de sclavi. Ziduri de piatră și un turn. Înconjurat de savană. Loc de ritualuri.",
      en: "The Bouna Fortress Ruins are the remains of a 17th-century defensive structure built by the Lobi people in northeastern Ivory Coast. The fortress was used to defend against slave raiders. It features stone walls and a watchtower. The site is a symbol of resistance. It is still used for traditional ceremonies.",
    },
    factsAdvanced: {
      de: ["Die Festung stammt aus dem Jahr 1650.", "Die Mauern sind bis zu 4 Meter hoch.", "Die Anlage umfasst 2 Hektar.", "Bouna hat 30.000 Einwohner.", "Der Turm ist 8 Meter hoch.", "Die Festung wurde 2001 zur nationalen Stätte erklärt."],
      hu: ["Az erőd 1650-ből származik.", "A falak magassága eléri a 4 métert.", "A terület 2 hektár.", "Bouna lakossága 30.000 fő.", "A torony 8 méter magas.", "Az erőd 2001 óta nemzeti emlékhely."],
      ro: ["Fortăreață datând din 1650.", "Ziduri de până la 4 m înălțime.", "Suprafață: 2 ha.", "Bouna: 30.000 locuitori.", "Turnul: 8 m.", "Sit național din 2001."],
      en: ["Fortress dating to 1650.", "Walls up to 4 m high.", "Area: 2 hectares.", "Bouna population: 30,000.", "Tower height: 8 m.", "Declared national site in 2001."],
    },
  },
  {
    id: "ivorycoast-tiassale-bridge-history-v2",
    type: "bridge",
    name: { de: "Historische Brücke Tiassalé", hu: "Tiassalé történelmi híd", ro: "Podul istoric Tiassalé", en: "Tiassalé Historic Bridge" },
    coords: [-4.83, 5.89],
    description: {
      de: "Die Brücke ist ein Meisterwerk der kolonialen Ingenieurskunst. Sie war ein entscheidender Verbindungspunkt für die Region.",
      hu: "A híd a gyarmati mérnöki munka remekműve. Döntő fontosságú összekötő pont volt a régió számára.",
      ro: "Podul este o capodoperă a ingineriei coloniale. A fost un punct crucial de legătură pentru regiune.",
      en: "The bridge is a masterpiece of colonial engineering. It was a crucial connecting point for the region.",
    },
    facts: {
      de: ["Baujahr ca. 1930", "Koloniale Ingenieurskunst", "Verkehrsgeschichte", "Wichtiges Infrastrukturdenkmal"],
      hu: ["Épült kb. 1930", "Gyarmati mérnöki művészet", "Közlekedéstörténet", "Fontos infrastruktúrális emlék"],
      ro: ["Construit în jurul anului 1930", "Inginerie colonială", "Istoria transporturilor", "Monument de infrastructură"],
      en: ["Built c. 1930", "Colonial engineering", "Transport history", "Important infrastructure landmark"],
    },
    imageHint: "old metal colonial bridge structure",
    descriptionAdvanced: {
      de: "Die historische Brücke von Tiassalé ist eine Stahlkonstruktion aus der frühen Kolonialzeit, die den Fluss Bandama überspannt. Sie wurde 1905 erbaut und ist eine der ältesten Brücken des Landes. Die Brücke hat eine Fachwerkstruktur. Sie war Teil der Eisenbahnstrecke Abidjan-Niger. Heute ist sie für den Verkehr gesperrt, aber ein Industriedenkmal.",
      hu: "A tiassaléi történelmi híd egy acél híd a Bandama folyón, 1905-ben épült. Az ország egyik legrégebbi hídja. Rácsos szerkezetű. Az Abidjan-Niger vasútvonal része volt. Ma lezárták, ipari műemlék.",
      ro: "Podul istoric Tiassalé este o construcție de oțel peste râul Bandama, construită în 1905. Una dintre cele mai vechi poduri din țară. Structură cu zăbrele. A făcut parte din calea ferată Abidjan-Niger. Închis traficului, monument industrial.",
      en: "The Tiassalé Historic Bridge is a steel truss bridge across the Bandama River, built in 1905 during the French colonial period. It was part of the Abidjan-Niger railway, measuring 300 meters long. The bridge is an engineering landmark, closed to vehicles but preserved as a historic monument. It reflects early 20th-century infrastructure.",
    },
    factsAdvanced: {
      de: ["Die Brücke ist 300 Meter lang.", "Sie wurde 1905 erbaut.", "Die Baukosten betrugen 1 Million Francs.", "Die Brücke hatte eine Tragfähigkeit von 20 Tonnen.", "Sie war bis 1975 in Betrieb.", "Die Brücke wurde 2010 restauriert."],
      hu: ["A híd hossza 300 méter.", "1905-ben épült.", "Az építési költség 1 millió frank volt.", "Teherbírása 20 tonna volt.", "1975-ig üzemelt.", "2010-ben felújították."],
      ro: ["Podul are 300 m lungime.", "Construit în 1905.", "Cost de construcție: 1 milion franci.", "Capacitate: 20 de tone.", "Operațional până în 1975.", "Restaurat în 2010."],
      en: ["Bridge length: 300 m.", "Built in 1905.", "Construction cost: 1 million francs.", "Load capacity: 20 tons.", "Operated until 1975.", "Restored in 2010."],
    },
  },
  {
    id: "ivorycoast-sassandra-governor-palace-history-v2",
    type: "palace",
    name: { de: "Gouverneurspalast Sassandra", hu: "Sassandra kormányzói palota", ro: "Palatul Guvernatorului Sassandra", en: "Governor's Palace Sassandra" },
    coords: [-6.08, 4.95],
    description: {
      de: "Dieses Gebäude war der Sitz der französischen Kolonialverwaltung in Sassandra. Es spiegelt den kolonialen architektonischen Stil wider.",
      hu: "Ez az épület a francia gyarmati közigazgatás székhelye volt Sassandrában. Tükrözi a gyarmati építészeti stílust.",
      ro: "Această clădire a fost sediul administrației coloniale franceze din Sassandra. Reflectă stilul arhitectural colonial.",
      en: "This building was the seat of the French colonial administration in Sassandra. It reflects the colonial architectural style.",
    },
    facts: {
      de: ["Koloniale Verwaltung", "Erbaut Anfang 20. Jhd", "Historische Architektur", "Küstenstandort"],
      hu: ["Gyarmati közigazgatás", "Épült a 20. sz. elején", "Történelmi építészet", "Parti helyszín"],
      ro: ["Administrație colonială", "Construit la începutul sec. XX", "Arhitectură istorică", "Locație costieră"],
      en: ["Colonial administration", "Built early 20th C", "Historical architecture", "Coastal location"],
    },
    imageHint: "colonial style palace architecture",
    descriptionAdvanced: {
      de: "Der Gouverneurspalast in Sassandra ist ein koloniales Gebäude aus dem frühen 20. Jahrhundert. Es diente als Residenz des französischen Gouverneurs der Region. Der Palast ist im neoklassizistischen Stil mit Veranden und Säulen erbaut. Er liegt auf einer Klippe mit Blick auf den Atlantik. Heute ist er teilweise verfallen, aber ein beliebtes Fotomotiv.",
      hu: "A sassandrai kormányzói palota egy gyarmati épület a 20. század elejéről. A francia kormányzó rezidenciája volt. Neoklasszicista stílusú, oszlopokkal. Sziklán áll, az Atlanti-óceánra néz. Részben romos, fotós helyszín.",
      ro: "Palatul guvernatorului din Sassandra este o clădire colonială din începutul sec. 20. Reședința guvernatorului francez. Stil neoclasic, cu coloane. Pe o stâncă deasupra Atlanticului. Parțial deteriorat, popular pentru fotografii.",
      en: "The Governor's Palace in Sassandra is a colonial-era building constructed in 1910. It served as the residence of the French governor of the Sassandra region. The palace features neoclassical architecture with large verandas. Perched on a cliff overlooking the Atlantic Ocean, it offers scenic views. The building is abandoned but remains a tourist attraction.",
    },
    factsAdvanced: {
      de: ["Der Palast wurde 1910 erbaut.", "Er hat 10 Zimmer und eine große Terrasse.", "Das Grundstück umfasst 1 Hektar.", "Sassandra hat 25.000 Einwohner.", "Der Palast wurde 1960 nach der Unabhängigkeit aufgegeben.", "Die Höhe der Klippe beträgt 30 Meter."],
      hu: ["A palota 1910-ben épült.", "10 szobával és egy nagy terasszal rendelkezik.", "A telek 1 hektáros.", "Sassandra lakossága 25.000 fő.", "A palotát 1960-ban hagyták el a függetlenség után.", "A szikla magassága 30 méter."],
      ro: ["Construit în 1910.", "10 camere și o terasă mare.", "Teren de 1 ha.", "Sassandra: 25.000 locuitori.", "Abandonat după 1960.", "Stâncă de 30 m înălțime."],
      en: ["Built in 1910.", "10 rooms and large terrace.", "Property: 1 ha.", "Sassandra population: 25,000.", "Abandoned after independence in 1960.", "Cliff height: 30 m."],
    },
  },
  {
    id: "ivorycoast-gagnoa-resistance-site-history-v2",
    type: "landmark",
    name: { de: "Historischer Ort Gagnoa", hu: "Gagnoa történelmi helyszín", ro: "Sit istoric Gagnoa", en: "Historic Site of Gagnoa" },
    coords: [-5.95, 6.13],
    description: {
      de: "Der Ort war ein bedeutendes Zentrum der bäuerlichen Widerstandsbewegungen gegen koloniale Praktiken. Er symbolisiert den lokalen Stolz.",
      hu: "A hely a gyarmati gyakorlatok elleni paraszti ellenállási mozgalmak fontos központja volt. A helyi büszkeséget jelképezi.",
      ro: "Locul a fost un centru important al mișcărilor de rezistență țărănească împotriva practicilor coloniale. Simbolizează mândria locală.",
      en: "The site was a significant center of peasant resistance movements against colonial practices. It symbolizes local pride.",
    },
    facts: {
      de: ["Widerstandsgeschichte", "Bäuerliche Autonomie", "Kulturelles Zentrum", "Lokale Geschichte"],
      hu: ["Ellenállási történelem", "Paraszti autonómia", "Kulturális központ", "Helyi történelem"],
      ro: ["Istoria rezistenței", "Autonomie țărănească", "Centru cultural", "Istorie locală"],
      en: ["Resistance history", "Peasant autonomy", "Cultural center", "Local history"],
    },
    imageHint: "memorial plaque in Gagnoa",
    descriptionAdvanced: {
      de: "Die historische Stätte von Gagnoa erinnert an den Widerstand der Bété gegen die französische Kolonialverwaltung im frühen 20. Jahrhundert. Der Ort markiert das Gefecht von Gagnoa im Jahr 1910, bei dem lokale Kämpfer gegen französische Truppen kämpften. Ein Gedenkstein und ein kleiner Park markieren die Stätte. Sie ist ein nationales Symbol des Widerstands.",
      hu: "A gagnoa-i ellenállás helyszíne a Bété nép 1910-es franciák elleni harcát idézi. Egy emlékkő és park található itt. A nemzeti ellenállás szimbóluma.",
      ro: "Situl istoric Gagnoa comemorează rezistența poporului Bété împotriva francezilor în 1910. O piatră comemorativă și un parc. Simbol al rezistenței naționale.",
      en: "The Historic Site of Gagnoa marks a 1910 battle where the Bété people resisted French colonial rule. The site features a memorial stone and a small park. It commemorates the lives lost in the uprising. Gagnoa is a town in central Ivory Coast. The site is a place of patriotic reflection.",
    },
    factsAdvanced: {
      de: ["Das Gefecht fand am 12. August 1910 statt.", "Etwa 200 Bété-Kämpfer starben.", "Die Franzosen verloren 30 Soldaten.", "Der Gedenkstein wurde 1970 aufgestellt.", "Gagnoa hat 150.000 Einwohner.", "Der Park umfasst 0,3 Hektar."],
      hu: ["A csata 1910. augusztus 12-én zajlott.", "Kb. 200 Bété harcos halt meg.", "A franciák 30 katonát veszítettek.", "Az emlékkövet 1970-ben helyezték el.", "Gagnoa lakossága 150.000 fő.", "A park 0,3 hektáros."],
      ro: ["Bătălia din 12 august 1910.", "~200 luptători Bété uciși.", "Pierderi franceze: 30 de soldați.", "Piatra comemorativă instalată în 1970.", "Gagnoa: 150.000 locuitori.", "Parcul are 0,3 ha."],
      en: ["Battle on August 12, 1910.", "~200 Bété fighters killed.", "French losses: 30 soldiers.", "Memorial stone erected in 1970.", "Gagnoa population: 150,000.", "Park area: 0.3 ha."],
    },
  },
  {
    id: "ivorycoast-jacqueville-warehouses-history-v2",
    type: "landmark",
    name: { de: "Koloniale Lagerhäuser Jacqueville", hu: "Jacqueville gyarmati raktárak", ro: "Depozitele coloniale Jacqueville", en: "Colonial Warehouses Jacqueville" },
    coords: [-4.41, 5.2],
    description: {
      de: "Diese Speicher dienten dem Handelsverkehr von Agrarprodukten im 20. Jahrhundert. Sie prägen das historische Stadtbild.",
      hu: "Ezek a tárolók a 20. századi mezőgazdasági termékek kereskedelmi forgalmát szolgálták. Meghatározzák a történelmi városképet.",
      ro: "Aceste depozite au deservit comerțul cu produse agricole în secolul al XX-lea. Ele definesc peisajul urban istoric.",
      en: "These warehouses served the trade of agricultural products in the 20th century. They define the historical cityscape.",
    },
    facts: {
      de: ["Handelsgeschichte", "20. Jahrhundert", "Architektonisches Erbe", "Agrarwirtschaft"],
      hu: ["Kereskedelmi történelem", "20. század", "Építészeti örökség", "Mezőgazdasági gazdaság"],
      ro: ["Istoria comerțului", "Secolul al XX-lea", "Patrimoniu arhitectural", "Economie agricolă"],
      en: ["Trade history", "20th Century", "Architectural heritage", "Agricultural economy"],
    },
    imageHint: "colonial warehouse buildings",
    descriptionAdvanced: {
      de: "Die Koloniallagerhäuser von Jacqueville sind eine Reihe von Lagergebäuden aus dem späten 19. Jahrhundert in der Küstenstadt Jacqueville. Sie wurden für den Umschlag von Gütern wie Kakao und Kaffee genutzt. Die Gebäude sind aus Stein und haben Wellblechdächer. Sie stehen am Ufer der Lagune Ébrié. Heute sind sie verlassen, aber ein Zeugnis der Handelsgeschichte.",
      hu: "A jacqueville-i gyarmati raktárak a 19. század végén épültek a tengerparti városban. Kakaó és kávé tárolására szolgáltak. Kőből és hullámlemezből készültek. A Lagun partján állnak. Elhagyottak, kereskedelmi örökség.",
      ro: "Depozitele coloniale Jacqueville sunt construcții din sfârșitul sec. 19 în orașul de coastă Jacqueville. Folosite pentru cacao și cafea. Piatră și acoperiș de tablă. Pe malul lagunei Ébrié. Abandonate, moștenire comercială.",
      en: "The Colonial Warehouses of Jacqueville are a complex of storage buildings built in the 1890s in the coastal town of Jacqueville. They were used for exporting cocoa and coffee during the colonial era. The warehouses are made of stone with corrugated iron roofs. Located on the Ébrié Lagoon, they are abandoned but historically significant.",
    },
    factsAdvanced: {
      de: ["Die Lagerhäuser wurden 1895 erbaut.", "Es gibt 5 Hauptgebäude.", "Jedes Gebäude ist 20 Meter lang.", "Jacqueville hat 30.000 Einwohner.", "Die Lagune Ébrié ist 100 km lang.", "Die Lagerhäuser sind seit 1995 geschlossen."],
      hu: ["A raktárak 1895-ben épültek.", "5 főépületből állnak.", "Minden épület 20 méter hosszú.", "Jacqueville lakossága 30.000 fő.", "Az Ébrié lagúna 100 km hosszú.", "A raktárak 1995 óta zárva vannak."],
      ro: ["Construite în 1895.", "5 clădiri principale.", "Fiecare clădire: 20 m lungime.", "Jacqueville: 30.000 locuitori.", "Laguna Ébrié: 100 km lungime.", "Depozite închise din 1995."],
      en: ["Built in 1895.", "5 main buildings.", "Each building 20 m long.", "Jacqueville population: 30,000.", "Ébrié Lagoon length: 100 km.", "Warehouses closed since 1995."],
    },
  },
  {
    id: "ivorycoast-mankono-historic-center-history-v2",
    type: "landmark",
    name: { de: "Historisches Zentrum Mankono", hu: "Mankono történelmi központ", ro: "Centrul istoric Mankono", en: "Historic Center of Mankono" },
    coords: [-6.18, 8.06],
    description: {
      de: "Der Stadtkern zeigt die Entwicklung der Region als Handelskreuzungspunkt. Viele Gebäude stammen aus der kolonialen Übergangszeit.",
      hu: "A városmag a régió kereskedelmi csomópontként való fejlődését mutatja. Számos épület a gyarmati átmeneti időszakból származik.",
      ro: "Centrul orașului arată dezvoltarea regiunii ca punct de intersecție comercială. Multe clădiri datează din perioada de tranziție colonială.",
      en: "The town center shows the development of the region as a trade crossroads. Many buildings date from the colonial transition period.",
    },
    facts: {
      de: ["Handelsknotenpunkt", "Koloniale Übergangszeit", "Städtisches Erbe", "Traditionelle Strukturen"],
      hu: ["Kereskedelmi csomópont", "Gyarmati átmeneti időszak", "Városi örökség", "Hagyományos szerkezetek"],
      ro: ["Nod comercial", "Perioada de tranziție colonială", "Patrimoniu urban", "Structuri tradiționale"],
      en: ["Trade crossroads", "Colonial transition period", "Urban heritage", "Traditional structures"],
    },
    imageHint: "street view of Mankono historical buildings",
    descriptionAdvanced: {
      de: "Das historische Zentrum von Mankono wurde 1905 als Sitz der französischen Kolonialverwaltung gegründet. Die rechteckige Anordnung der Straßen und der zentrale Marktplatz spiegeln europäische Stadtplanung wider. Die Bauten verbinden französische Neoklassik mit lokalen Baule-Traditionen: Arkadengänge, verzierte Holztüren und bunte Fassaden. Das Zentrum war ein wichtiger Umschlagplatz für Baumwolle, Kola und Elfenbein. Nach der Unabhängigkeit verfielen viele Gebäude; ein 2020 gestartetes Restaurierungsprogramm mit einem Budget von 2,5 Millionen Euro soll 12 Bauwerke sichern. Heute ist der Ort ein Zeugnis kolonialer Geschichte und kultureller Synthese.",
      hu: "Mankono történelmi központja a gyarmati korszakban, 1905-ben jött létre. A település szerkezete a francia várostervezést tükrözi: szabályos utcahálózat, központi piactér. Az épületek a francia neoklasszicizmus és a Baule nép kézműves hagyományainak ötvözetét mutatják. A város fontos kereskedelmi központ volt, ahonnan gyapotot és kóladiót szállítottak a tengerpartra. A függetlenség után a negyed hanyatlásnak indult; 2020-ban indult el a felújítás, melynek célja 12 épület helyreállítása. A központ ma a gyarmati múlt és a helyi kultúra egyedülálló emlékhelye.",
      ro: "Centrul istoric al orașului Mankono a fost fondat în 1905, în perioada colonizării franceze. Planul urbanistic rectangular și piața centrală sunt caracteristici ale urbanismului colonial. Arhitectura îmbină stilul neoclasic francez cu elemente decorative locale Baule, cum ar fi ușile sculptate și verandele. Orașul a fost un nod comercial important pentru bumbac și nuci de kola. După independență, multe clădiri s-au deteriorat; un proiect de restaurare început în 2020, cu un buget de 2,5 milioane de euro, vizează conservarea a 15 clădiri. Centrul este inclus pe lista monumentelor naționale din 1985.",
      en: "The Historic Center of Mankono was established in 1905 during French colonial rule, designed as a model administrative town. Its grid layout centers on a market square surrounded by government buildings, shops, and residences. Architecture combines French neoclassicism with Baule artisanry, featuring carved wooden doors and wide verandas. The town flourished as a trading hub for cotton and kola nuts, linking the Savanes region to coastal ports. Post-independence, the district suffered neglect until a 2020 restoration project funded by international donors began rehabilitating 15 key structures. The center now serves as a living museum of colonial urbanism and a testament to cultural fusion.",
    },
    factsAdvanced: {
      de: ["Gründung des Zentrums 1905.", "Fläche des historischen Viertels: 4,8 Hektar.", "Durchschnittliche Gebäudehöhe: 10 Meter.", "Anzahl denkmalgeschützter Gebäude: 12.", "Restaurierungsbudget 2020: 2,5 Millionen Euro.", "Einwohnerzahl Mankono (2021): ca. 22.000."],
      hu: ["1905-ben alapították gyarmati központként.", "A történelmi negyed területe: 4,8 hektár.", "Az épületek átlagos magassága: 10 méter.", "Védett épületek száma: 12.", "A felújítás 2020-ban kezdődött, költségvetése 2,5 millió euró.", "Mankono lakossága (2021): kb. 22.000 fő."],
      ro: ["Fondat în 1905 ca centru administrativ colonial.", "Suprafața districtului istoric: 4,8 hectare.", "Înălțimea medie a clădirilor: 10 metri.", "Numărul de clădiri protejate: 15.", "Bugetul de restaurare în 2020: 2,5 milioane de euro.", "Populația orașului Mankono (2021): aproximativ 22.000 de locuitori."],
      en: ["Founded in 1905 as a colonial administrative center.", "Area of historic district: 4.8 hectares.", "Average building height: 10 meters.", "Number of protected structures: 15.", "Restoration project initiated in 2020 with a budget of 2.5 million euros.", "Mankono city population (2021): approximately 22,000."],
    },
  },
  {
    id: "ivorycoast-anyama-railway-station-history-v2",
    type: "landmark",
    name: { de: "Historischer Bahnhof Anyama", hu: "Anyama történelmi vasútállomás", ro: "Gara istorică Anyama", en: "Historic Railway Station Anyama" },
    coords: [-4.05, 5.49],
    description: {
      de: "Der Bahnhof war entscheidend für die wirtschaftliche Anbindung des Hinterlandes an Abidjan. Er ist ein Zeugnis der Eisenbahngeschichte.",
      hu: "Az állomás döntő fontosságú volt a hátország Abidjanhoz való gazdasági kötődésében. A vasúttörténet tanúja.",
      ro: "Gara a fost crucială pentru legătura economică a hinterlandului cu Abidjan. Este o mărturie a istoriei feroviare.",
      en: "The station was crucial for the economic connection of the hinterland to Abidjan. It is a testament to railway history.",
    },
    facts: {
      de: ["Eisenbahngeschichte", "Wirtschaftliche Anbindung", "Koloniale Architektur", "Verkehrsknoten"],
      hu: ["Vasúttörténet", "Gazdasági kötődés", "Gyarmati építészet", "Közlekedési csomópont"],
      ro: ["Istoria feroviară", "Conectare economică", "Arhitectură colonială", "Nod de transport"],
      en: ["Railway history", "Economic connection", "Colonial architecture", "Transport hub"],
    },
    imageHint: "old colonial railway station",
    descriptionAdvanced: {
      de: "Der historische Bahnhof von Anyama wurde 1912 an der Strecke der Eisenbahnlinie Elfenbeinküste–Niger errichtet. Das Gebäude ist ein Beispiel kolonialer Zweckarchitektur mit einem langgestreckten Grundriss, einem weit ausladenden Vordach und großen Wartesälen. Der Bahnhof war für den Transport von Kakao, Kaffee und anderen Agrarprodukten aus dem Hinterland nach Abidjan zentral. Seit 1998 steht er unter Denkmalschutz. Obwohl der Personenverkehr eingestellt wurde, dient das Gebäude gelegentlich als Veranstaltungsort. Die Gleisanlagen sind teilweise noch erhalten; die Brücke über den Fluss Anyama wurde 1930 erneuert.",
      hu: "Az anyamai vasútállomást 1912-ben adták át az Elefántcsontpart–Niger vasútvonal részeként. Az épület a gyarmati vasúti építészet jellegzetes példája: hosszú, egyemeletes csarnok, széles előtetővel. Az állomás fontos szerepet játszott a kakaó és kávé szállításában a belső területekről Abidjan kikötőjébe. 1998-ban nemzeti műemlékké nyilvánították. Bár a személyszállítás megszűnt, az épületet ma is használják rendezvényekre. A tervek szerint 2025-ben múzeumot alakítanak ki benne.",
      ro: "Gara istorică din Anyama, construită în 1912, face parte din linia de cale ferată Coasta de Fildeș–Niger. Clădirea are un design colonial tipic: o structură lungă, cu un singur nivel, acoperiș în consolă și săli de așteptare mari. A fost esențială pentru transportul de cacao și cafea din interiorul țării către portul Abidjan. În 1998 a fost declarată monument național. Deși nu mai este utilizată pentru călători, gara este păstrată ca simbol al erei feroviare.",
      en: "The Historic Railway Station of Anyama, built in 1912, is a key remnant of the Ivory Coast–Niger railway line. The station served as a vital transportation link for agricultural exports, particularly cocoa and coffee, from the interior to the port of Abidjan. Its design reflects typical early 20th-century colonial railway architecture: a long, single-story building with a prominent canopy and large waiting halls. The station played a role in the economic development of the Anyama region, now a suburb of Abidjan. In 1998, the building was listed as a national heritage site. Although no longer used for passenger services, it remains a symbol of the railway era.",
    },
    factsAdvanced: {
      de: ["Erbaut 1912 als Teil der Eisenbahnlinie Elfenbeinküste–Niger.", "Länge des Stationsgebäudes: 80 Meter.", "Bahnsteigbreite: 6 Meter.", "Denkmalschutz seit 1998.", "Jährliches Frachtaufkommen (Spitze 1960er): 500.000 Tonnen.", "Entfernung vom Zentrum Abidjans: 20 km."],
      hu: ["1912-ben épült az Elefántcsontpart–Niger vasútvonal részeként.", "Az állomásépület hossza: 80 méter.", "A peron szélessége: 6 méter.", "1998 óta nemzeti műemlék.", "Csúcs évi teherforgalom (1960-as évek): 500 000 tonna.", "Távolság Abidjan központjától: 20 km."],
      ro: ["Construită în 1912 ca parte a căii ferate Coasta de Fildeș–Niger.", "Lungimea clădirii gării: 80 de metri.", "Lățimea peronului: 6 metri.", "Monument național din 1998.", "Tonaj anual de marfă (vârf în anii 1960): 500.000 de tone.", "Distanța față de centrul Abidjanului: 20 km."],
      en: ["Built in 1912 as part of the Ivory Coast–Niger railway.", "Length of the station building: 80 meters.", "Platform width: 6 meters.", "Listed as national heritage in 1998.", "Annual freight tonnage (peak in 1960s): 500,000 tons.", "Distance from Abidjan city center: 20 km."],
    },
  },
  {
    id: "ivorycoast-touba-fadika-history-v2",
    type: "landmark",
    name: { de: "Fadika-Zentrum Touba", hu: "Touba Fadika központ", ro: "Centrul Fadika Touba", en: "Fadika Center of Touba" },
    coords: [-7.68, 8.28],
    description: {
      de: "Dieses Zentrum ist eng mit der Geschichte der Fadika-Familie und deren Einfluss in der Region verknüpft. Es bewahrt lokale Überlieferungen.",
      hu: "Ez a központ szorosan összefonódik a Fadika család történetével és a régióra gyakorolt befolyásukkal. Megőrzi a helyi hagyományokat.",
      ro: "Acest centru este strâns legat de istoria familiei Fadika și de influența lor în regiune. Acesta păstrează tradițiile locale.",
      en: "This center is closely linked to the history of the Fadika family and their influence in the region. It preserves local traditions.",
    },
    facts: {
      de: ["Lokaler Einfluss", "Fadika-Dynastie", "Historisches Erbe", "Traditionelle Verwaltung"],
      hu: ["Helyi befolyás", "Fadika-dinasztia", "Történelmi örökség", "Hagyományos közigazgatás"],
      ro: ["Influență locală", "Dinastia Fadika", "Patrimoniu istoric", "Administrație tradițională"],
      en: ["Local influence", "Fadika dynasty", "Historical heritage", "Traditional administration"],
    },
    imageHint: "historical site in Touba city",
    descriptionAdvanced: {
      de: "Das Fadika-Zentrum von Touba entstand im 18. Jahrhundert als spirituelles und Handelszentrum. Benannt nach dem Marabout Fadika, entwickelte es sich zu einem Knotenpunkt für islamische Gelehrsamkeit und Karawanenhandel. Die Lehmziegelmoscheen imSudan-Stil prägen das Ortsbild. Der Wochenmarkt auf dem zentralen Platz zieht Händler aus Guinea und Mali an. Seit 1970 steht das Viertel unter Denkmalschutz. Die Bauweise mit flachen Dächern und dicken Lehmwänden ist an das trockene Klima angepasst. Gefährdet ist das Zentrum durch Regen- und Winderosion; ein Schutzprogramm läuft seit 2015.",
      hu: "A toubai Fadika Központ a 18. században jött létre szellemi és kereskedelmi központként. Nevét Fadika maraburól kapta, aki iszlám tudósként és kereskedőként tevékenykedett. Az építészetre a szudáni stílusú vályog mecsetek és lapostetős házak jellemzők. A főtéren heti piacot tartanak, ahová Guinea és Mali területéről is érkeznek árusok. 1970-ben műemléki védettséget kapott. A település lakossága főleg mandinka, erős szájhagyománnyal. A vályogépületeket az eső és szél eróziója fenyegeti; 2015 óta védelmi program működik.",
      ro: "Centrul Fadika din Touba, fondat în secolul al XVIII-lea, este un vechi centru spiritual și comercial. Numit după un marabout local, Fadika, a devenit un loc de învățare islamică și comerț. Arhitectura este dominată de moschei din chirpici în stil sudanez și case cu acoperiș plat. Piața centrală găzduiește o piață săptămânală ce atrage comercianți din Guineea și Mali. În 1970, centrul a fost declarat district istoric. Populația este predominant mandinka. Eforturile recente se concentrează pe conservarea structurilor fragile împotriva eroziunii climatice.",
      en: "The Fadika Center of Touba, established in the 18th century as a spiritual and commercial crossroads, is one of the oldest settlements in north-western Ivory Coast. Named after a local marabout, Fadika, it became a center for Islamic learning and trade. The architecture is characterized by Sudanic-style mudbrick mosques and flat-roofed houses. The main square hosts a weekly market attracting traders from Guinea and Mali. In 1970, the center was designated a historic district. The population is predominantly Mandinka, with a strong tradition of oral history. Recent efforts focus on preserving the fragile earthen structures against climate erosion.",
    },
    factsAdvanced: {
      de: ["Im 18. Jahrhundert gegründet.", "Höhe der Hauptmoschee: 15 Meter.", "Fläche des historischen Viertels: 3,2 Hektar.", "Einwohnerzahl Touba (2021): 15.000.", "Anzahl geschützter Lehmbauten: 40.", "Erhaltungsprogramm seit 2015, Budget 1,2 Millionen Euro."],
      hu: ["A 18. században alapították.", "A fő mecset magassága: 15 méter.", "A történelmi negyed területe: 3,2 hektár.", "Touba lakossága (2021): 15.000 fő.", "Védett vályogépületek száma: 40.", "Védelmi program 2015 óta, költségvetése 1,2 millió euró."],
      ro: ["Fondat în secolul al XVIII-lea.", "Înălțimea moscheii principale: 15 metri.", "Suprafața districtului istoric: 3,2 hectare.", "Populația orașului Touba (2021): 15.000 de locuitori.", "Numărul de clădiri protejate din chirpici: 40.", "Program de conservare început în 2015, finanțat cu 1,2 milioane de euro."],
      en: ["Established in the 18th century.", "Main mosque height: 15 meters.", "Area of historic district: 3.2 hectares.", "Population of Touba (2021): 15,000.", "Number of protected mudbrick buildings: 40.", "Conservation program started in 2015, funded by €1.2 million."],
    },
  }
];
