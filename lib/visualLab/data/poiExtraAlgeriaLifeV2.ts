...
image: "/poi-images/tassili-n-ajjer-life-v2.webp"
    ...
    descriptionAdvanced: {
      de: "Tassili n'Ajjer ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein Bergplateau, das seltene Tierarten wie den Saharageparden beherbergt. UNESCO-Welterbe. Heimat des Saharageparden. Felsmalereien vorhanden. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
      hu: "A Tassili n'Ajjer egy homokkő-fennsík a Szaharában, amely holdbéli tájra emlékeztet. Neve 'a folyók fennsíkját' jelenti, utalva a nedvesebb múltra. A 'kőerdők' a világ egyik legjelentősebb őskori sziklaművészeti gyűjteményét rejtik. Több mint 15 000 festmény és véset található itt. UNESCO Világörökségi és Bioszféra Rezervátum. Őstörténet K6 – Ember és környezete.",
      ro: "Tassili n'Ajjer este un element remarcabil al geografiei și culturii algeriene. Un platou montan care găzduiește specii rare precum ghepardul saharian. Patrimoniul Mondial UNESCO. Habitat al ghepardului saharian. Picturi rupestre prezente. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
...
image: "/poi-images/hoggar-mountains-life-v2.webp"
    ...
    descriptionAdvanced: {
      de: "Hoggar-Gebirge ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Eine beeindruckende Gebirgsregion mit einzigartiger Wüstenfauna. Höchster Gipfel: Tahat. Vulkanisches Gestein. Seltene Antilopenarten. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
      hu: "A Hoggar-hegység egy drámai vulkanikus masszívum a Szahara déli részén. Zord környezete ellenére gazdag élővilágnak ad otthont. A guelták (víztározók) lehetővé teszik a növényzet, például az olajfa és a mirtusz túlélését. Itt él a rendkívül ritka szaharai gepárd is. A tuareg nomádok otthona. Biológia K7 – Adaptáció.",
      ro: "Munții Hoggar este un element remarcabil al geografiei și culturii algeriene. O regiune muntoasă impresionantă cu o faună deșertică unică. Cel mai înalt vârf: Tahat. Roci vulcanice. Specii rare de antilope. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
...
image: "/poi-images/el-kala-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
      de: "Nationalpark El Kala ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein Küstenpark, der wichtige Feuchtgebiete und Zugvogelrouten schützt. Biosphärenreservat. Wichtige Vogelbrutgebiete. Küstenökosystem. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
      hu: "Az algéria északkeleti csücskében található El Kala Nemzeti Park az ország egyik legfontosabb biológiai sokféleséggel rendelkező területe. A park különlegessége a tavakból, mocsarakból, erdőkből és tengerparti dűnékből álló változatos ökoszisztéma. Ez a terület kulcsfontosságú állomása a vándormadaraknak, amelyek Európa és Afrika között vonulnak. A parkban található édesvizű tavak, mint a Tonga-tó, ritka madárfajoknak és vízi növényeknek adnak otthont. A dús parafa tölgyesek és fenyvesek között vaddisznók, sakálok és ritka szarvasfajok élnek. El Kala nemcsak a tudósok paradise-a, hanem a természetkedvelők számára is menedék, ahol a vizek tükre és a zöld erdők harmóniája fogadja a látogatót. Földrajz K9 – Természetvédelem és ökológiai egyensúly.",
      ro: "Parcul Național El Kala este un element remarcabil al geografiei și culturii algeriene. Un parc de coastă care protejează zone umede importante și rute de migrație ale păsărilor. Rezervație a biosferei. Zone importante de cuibărit pentru păsări. Ecosistem costier. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
...
image: "/poi-images/chrea-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Nationalpark Chréa ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Bekannt für seine Berberaffenpopulation im Atlasgebirge. Berberaffen beheimatet. Beliebtes Wandergebiet. Zedernwälder. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Az Atlasz-hegység szívében, Blida városa felett található Chréa Nemzeti Park Algéria egyik legnépszerűbb hegyvidéki üdülőhelye. A park sűrű atlaszcédrus erdőiről híres, amelyek télen hófödte tájjá változnak, lehetővé téve a síelést is, ami ritka jelenség Afrikában. A terület fontos menedéke a veszélyeztetett berber makákóknak, amelyek gyakran merészkednek az utazók közelébe. A tiszta hegyi levegő és a kanyargós szerpentinek vonzzák a túrázókat és a természetfotósokat. A park legmagasabb pontjairól tiszta időben ellátni egészen a Földközi-tengerig. Chréa a biodiverzitás megőrzésének mintapéldája, ahol az emberi kikapcsolódás és a vadon védelme kéz a kézben jár. Földrajz K8 – Hegyvidéki övezetek és magashegységi éghajlat.",
    ro: "Parcul Național Chréa este un element remarcabil al geografiei și culturii algeriene. Cunoscut pentru populația sa de macaci de Berberia din Munții Atlas. Acasă pentru macacii de Berberia. Zonă populară de drumeții. Păduri de cedru. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
...
image: "/poi-images/gouraya-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Nationalpark Gouraya ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein Park an der Mittelmeerküste mit vielfältiger Flora und Fauna. Meeresküste. Berberaffen. Wanderwege. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Gouraya Nemzeti Park Bejaia városa mellett, a Földközi-tenger partján fekszik, ahol a meredek mészkősziklák találkoznak a türkizkék vízzel. A park névadója a Gouraya-hegy, amelynek csúcsán egy régi erődítmény vigyázza az öblöt. A terület gazdag növényvilággal rendelkezik, mediterrán bozótosok és ritka orchideák díszítik a sziklás lejtőket. A park lakói között megtalálhatók a berber makákók és számos ragadozó madár. A látogatókat festői öblök, mint a Les Aiguades, és kristálytiszta források várják. Gouraya nemcsak természeti kincs, hanem kulturális szempontból is jelentős, hiszen számos legenda kötődik a hegy szelleméhez, Yemma Gourayához. Földrajz K8 – Mediterrán tájak és tengerparti ökoszisztémák.",
    ro: "Parcul Național Gouraya este un element remarcabil al geografiei și culturii algeriene. Un parc de pe coasta Mediteranei cu o floră și faună diversă. Coasta mării. Macaci de Berberia. Trasee de drumeție. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Gouraya National Park is a remarkable feature of the geography and culture of Algeria. A park on the Mediterranean coast with diverse flora and fauna. Seacoast. Barbary macaques. Hiking trails. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/mitidja-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Mitidja-Ebene ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Das fruchtbarste landwirtschaftliche Gebiet Algeriens, bekannt für Zitrusfrüchte. Zitrusfrüchteanbau. Hauptanbaugebiet. Reichhaltiger Boden. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Mitidja-síkság Algéria 'éléskamrája', egy hatalmas és termékeny mezőgazdasági terület az Atlasz-hegység lábánál, Algír szomszédságában. Az egykor mocsaras területet az évszázadok során virágzó kertekké és ültetvényekké alakították. Itt található az ország legjelentősebb narancs- és citromligeteinek nagy része, de jelentős a szőlő-, gabona- és zöldségtermesztés is. A síkság bőséges vízkészletei és a mediterrán éghajlat ideális feltételeket biztosítanak az intenzív gazdálkodáshoz. A Mitidja nemcsak gazdasági motor, hanem a tájképet meghatározó zöld szőnyeg is, amely friss élelmiszerrel látja el a fővárost és környékét. A modern öntözőrendszerek bevezetése tovább növelte a terület hatékonyságát. Földrajz K8 – Mezőgazdasági termelési körzetek és élelmiszerbiztonság.",
    ro: "Câmpia Mitidja este un element remarcabil al geografiei și culturii algeriene. Cea mai fertilă zonă agricolă din Algeria, cunoscută pentru citrice. Cultivarea citricelor. Principală zonă de producție. Sol bogat. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
...
image: "/poi-images/oued-souf-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Oued Souf ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Bekannt für den Anbau von Dattelpalmen in der Sahara. Dattelproduktion. Oasenwirtschaft. Traditionelle Methoden. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Oued Souf az algériai Szahara egyik legkülönlegesebb mezőgazdasági csodája, ahol az emberi leleményesség győzedelmeskedett a sivatag felett. A térség híres a 'ghout' technológiáról: a gazdák mély tölcséreket ásnak a homokdűnék közé, hogy a datolyapálmák gyökerei elérjék a felszín alatti vízréteget. Felülről nézve a táj olyan, mintha ezer apró zöld oázis pettyezné a homoktengert. A pálmák mellett a homokban burgonyát és egyéb zöldségeket is termesztenek modern öntözéssel. A régió központja, El Oued, az 'ezer kupola városa' nevet viseli, különleges építészete miatt. Oued Souf példája annak, hogyan lehet fenntartható életet kialakítani a legszélsőségesebb környezetben is. Földrajz K9 – Oázisgazdálkodás és elsivatagosodás elleni küzdelem.",
    ro: "Oued Souf este un element remarcabil al geografiei și culturii algeriene. Cunoscută pentru cultivarea curmalilor în Sahara. Producția de curmale. Agricultură de oază. Metode tradiționale. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
...
image: "/poi-images/annaba-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Annaba Umland ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Region mit intensivem Weinbau und Gemüseanbau. Weinbaugebiet. Gemüseanbau. Küstenklima. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Annaba és környéke Algéria északkeleti részének meghatározó mezőgazdasági központja, ahol a bőséges csapadék és a vasban gazdag, vörös talaj kiváló feltételeket teremt. A Seybouse-folyó völgye különösen termékeny, itt hatalmas paradicsom-, búza- és dohányültetvények sorakoznak. Annaba környéke híres a gyümölcsöskertjeiről is, különösen a lédús szilva és a barack népszerű. Az élelmiszeripar szorosan kapcsolódik a termeléshez, számos feldolgozóüzem működik a város közelében. A tájat a zöldellő dombok és a rendezett szántóföldek határozzák meg, amelyek a tenger közelsége miatt sajátos mikroklímával rendelkeznek. A régió hozzájárulása az ország élelmiszer-exportjához kiemelkedő. Földrajz K8 – Talajfajták és növénytermesztési övezetek.",
    ro: "Împrejurimile Annaba este un element remarcabil al geografiei și culturii algeriene. Regiune cunoscută pentru viticultură și cultivarea legumelor. Zonă viticolă. Cultivarea legumelor. Climat costier. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Annaba Surroundings is a remarkable feature of the geography and culture of Algeria. Region known for intensive viticulture and vegetable farming. Viticulture area. Vegetable farming. Coastal climate. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/biskra-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Biskra Oase ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Zentrum für den Anbau von hochwertigen Datteln. Deglet-Nour-Datteln. Wüstenklima. Bewässerung. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Biskra, a 'Szahara kapuja', a világ egyik legfontosabb datolyatermelő vidéke. Az oázisvárost körülvevő hatalmas pálmaligetekben terem a híres 'Deglet Nour' (a fény ujja) datolya, amely mézédes ízéről és áttetsző húsáról ismert. A mezőgazdaság itt a hagyományos csatornarendszerek (foggarák) és a modern fúrt kutak kombinációjára épül. Az utóbbi évtizedekben Biskra a primőr zöldségek (paprika, paradicsom) központjává is vált, köszönhetően a fóliasátras termesztés elterjedésének a téli napsütésben. A tájképet a végtelen pálmaerdők és a távolban magasodó Aurès-hegység kontrasztja teszi felejthetetlenné. Biskra az élettel teli sivatagi gazdálkodás mintaképe. Földrajz K9 – Trópusi sivatagi éghajlat és öntözéses gazdálkodás.",
    ro: "Oaza Biskra este un element remarcabil al geografiei și culturii algeriene. Centrul pentru cultivarea curmalelor de înaltă calitate. Curmale Deglet-Nour. Climat deșertic. Irigare. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Biskra Oasis is a remarkable feature of the geography and culture of Algeria. Center for the cultivation of high-quality dates. Deglet Nour dates. Desert climate. Irrigation. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/setif-highlands-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Sétif Hochland ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Wichtige Region für Getreideanbau im Norden Algeriens. Getreideanbau. Hochlandklima. Landwirtschaftliche Zentrale. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Sétif-fennsík Algéria legfontosabb gabonatermesztő vidéke, amelyet gyakran az ország 'búzaövéként' emlegetnek. A magas fekvésű területeken a hideg telek és a forró nyarak ideálisak az őszi búza és az árpa számára. A tájat végtelen, aranyló gabonatáblák és modern silók határozzák meg, amelyek a betakarítás idején pezsdülnek fel igazán. Sétif környékén az állattenyésztés, különösen a szarvasmarha- és juhtartás is jelentős, ami megalapozza a helyi tej- és húsipart. A fennsík mezőgazdasága nagyban függ az időszakos csapadéktól, ezért a vízgazdálkodás kulcsfontosságú a fenntartható termeléshez. A régió évezredek óta fontos élelmiszerforrás, már a rómaiak is innen látták el birodalmukat gabonával. Földrajz K8 – Kontinentális éghajlat hatása a növénytermesztésre.",
    ro: "Podișul Sétif este un element remarcabil al geografiei și culturii algeriene. Regiune importantă pentru cultivarea cerealelor în nordul Algeriei. Cultivarea cerealelor. Climat de podiș. Centru agricol. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Sétif Highlands is a remarkable feature of the geography and culture of Algeria. Important region for grain farming in northern Algeria. Grain farming. Highland climate. Agricultural hub. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/algiers-botanical-garden-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Botanischer Garten Hamma ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein grüner Park in Algier, ideal für Familien und Kinder. Seltene Pflanzen. Spielbereiche. Erholungsort. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Az algíri Jardin d'Essai du Hamma a világ egyik legszebb és legjelentősebb botanikus kertje, egy valóságos zöld oázis a nagyvárosi nyüzsgésben. Az 1832-ben alapított kert egy hatalmas élő laboratórium, ahol a világ minden tájáról származó egzotikus növényeket honosítottak meg. A kert két fő részből áll: egy szimmetrikus francia kertből és egy buja, dzsungelszerű angolparkból. Hatalmas fikuszok, ritka pálmák és bambuszerdők között sétálhatunk, miközben a tenger felől érkező szellő hűsíti a levegőt. A kert híres filmes helyszín is, itt forgatták az 1932-es Tarzan-filmet. A Hamma nemcsak a pihenés helye, hanem a botanikai kutatás és az oktatás nemzetközileg elismert központja is. Földrajz K7 – Globális növényföldrajz és mesterséges ökoszisztémák.",
    ro: "Grădina Botanică Hamma este un element remarcabil al geografiei și culturii algeriene. O grădină verde în Alger, ideală pentru familii și copii. Plante rare. Zone de joacă. Loc de relaxare. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Hamma Botanical Garden is a remarkable feature of the geography and culture of Algeria. A green park in Algiers, ideal for families and children. Rare plants. Play areas. Recreation spot. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/aquafortland-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Aquafortland ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein beliebter Wasserpark für Kinder in Algier. Wasserrutschen. Schwimmbecken. Familienattraktion. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Aquafortland egy modern vízi élménypark Algír keleti részén, Bordj El Kiffan tengerpartján, amely a helyi családok és fiatalok kedvelt kikapcsolódási helyszíne. A park számos csúszdával, hullámmedencével és kalandpályával várja a látogatókat a forró nyári napokon. A létesítmény kialakítása megfelel a nemzetközi szabványoknak, tiszta és biztonságos környezetet nyújtva a szórakozáshoz. Aquafortland nemcsak a vízről szól: fitneszterem, wellness-részleg és kiváló éttermek is találhatók a területén. A park népszerűsége mutatja a modern szabadidős szolgáltatások iránti növekvő igényt Algériában. A tenger közelsége és a vidám hangulat miatt a park a fővárosi nyár elengedhetetlen részévé vált. Földrajz K8 – Szolgáltatások és turizmus a nagyvárosokban.",
    ro: "Aquafortland este un element remarcabil al geografiei și culturii algeriene. Un parc acvatic popular pentru copii în Alger. Tobogane cu apă. Piscine. Atracție de familie. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Aquafortland is a remarkable feature of the geography and culture of Algeria. A popular water park for kids in Algiers. Water slides. Swimming pools. Family attraction. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/dinosaur-park-setif-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Dinosaurierpark Sétif ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein Themenpark mit Dinosauriernachbildungen für Kinder. Lebensgroße Modelle. Bildungsangebot. Unterhaltung. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Sétifben található Dinoszaurusz Park egy különleges tematikus élménypark, amely az őslények világába repíti vissza a látogatókat. Az élethű, gyakran mozgó és hangot adó dinoszaurusz-modellek között sétálva a gyerekek és felnőttek egyaránt játékos formában tanulhatnak a Föld történetéről. A park célja az oktatás és a szórakoztatás ötvözése, segítve a természettudományok népszerűsítését. A területen játszóterek, pihenőhelyek és zöld felületek is találhatók, így ideális célpont családi kirándulásokhoz. A park létrejötte a város kulturális kínálatának modernizálását tükrözi, és Sétif egyik új turisztikai vonzerejévé vált. A kiállított fajok között a legismertebb ragadozók és növényevők is megtalálhatók. Földrajz K7 – A Föld története és az élővilág fejlődése.",
    ro: "Parcul Dinozaurilor Sétif este un element remarcabil al geografiei și culturii algeriene. Un parc tematic cu replici de dinozauri pentru copii. Modele în mărime naturală. Valoare educativă. Divertisment. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Dinosaur Park Sétif is a remarkable feature of the geography and culture of Algeria. A theme park with dinosaur replicas for children. Life-sized models. Educational value. Entertainment. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/mostaganem-wildlife-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Tierpark Mostaganem ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein kleiner Zoo mit Fokus auf lokale Tierarten. Familienbesuche. Lokale Fauna. Bildung. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Mostaganem Wildlife Park (Mosta Land) egy hatalmas állatkert és vidámpark együttes, amely Nyugat-Algéria egyik legfontosabb szabadidős központja. A parkban a világ minden tájáról származó állatfajok, köztük oroszlánok, tigrisek, zsiráfok és egzotikus madarak láthatók tágas és modern kifutókban. Az állatkert mellett egy izgalmas vidámpark is működik, óriáskerékkel és különböző játékokkal, amelyek felejthetetlen élményt nyújtanak minden korosztálynak. A park nagy hangsúlyt fektet az állatvédelemre és a környezeti nevelésre. A domboldalon elhelyezkedő komplexumból csodás kilátás nyílik a tengerre, a sétányok pedig ideálisak a délutáni pihenéshez. Földrajz K8 – Állatföldrajzi övezetek bemutatása.",
    ro: "Grădina Zoologică Mostaganem este un element remarcabil al geografiei și culturii algeriene. O grădină zoologică mică axată pe specii locale de animale. Vizite în familie. Faună locală. Educație. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Mostaganem Zoo is a remarkable feature of the geography and culture of Algeria. A small zoo focusing on local animal species. Family visits. Local fauna. Education. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/oran-aquarium-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Aquarium von Oran ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein Aquarium, das das Meeresleben des Mittelmeers zeigt. Unterwasserwelt. Bildung. Kinderattraktion. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Az orani akvárium a Földközi-tenger és a világ óceánjainak rejtélyes világába enged betekintést. A létesítmény célja a tengeri élővilág bemutatása és a környezetvédelmi tudatosság növelése az algériai fiatalok körében. A medencékben színes halak, cápák, korallok és különleges tengeri gerinctelenek csodálhatók meg, amelyek a régió tengeri biodiverzitását reprezentálják. Az akvárium oktatási programjai segítenek megérteni a tengerek törékeny egyensúlyát és a szennyezés elleni küzdelem fontosságát. A látogatók számára a vízi világ látványa egyszerre megnyugtató és lenyűgöző élmény. Az orani kikötő közelében található épület fontos tudományos és turisztikai bástyája a városnak. Földrajz K9 – Világtengerek élővilága és védelme.",
    ro: "Acvariul din Oran este un element remarcabil al geografiei și culturii algeriene. Un acvariu care prezintă viața marină a Mediteranei. Lume subacvatică. Educație. Atracție pentru copii. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Oran Aquarium is a remarkable feature of the geography and culture of Algeria. An aquarium showcasing the marine life of the Mediterranean. Underwater world. Education. Kids attraction. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/taza-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Nationalpark Taza ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein Park, der eine große Vielfalt an Vögeln und Säugetieren schützt. Biosphärenreservat. Küstenlandschaft. Flora. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Jijel tartományban található Taza Nemzeti Park Algéria egyik legvadregényesebb és legzöldebb tája, ahol az erdővel borított hegyek meredeken szakadnak bele a tengerbe. A park híres buja növényzetéről, különösen a paratölgy- és afrikai tölgyerdőiről, amelyek hűvös menedéket nyújtanak a nyári melegben. Itt él a rendkívül ritka kabyl csuszka, egy apró madárfaj, amely csak ezen a vidéken honos. A park part menti szakaszán titokzatos barlangok, mint a 'Grottes Merveilleuses' (Csodálatos barlangok), várják a felfedezőket lenyűgöző cseppkőalakzataikkal. Taza a természet érintetlenségének jelképe, ahol a hegyi túrázás és a tengerparti pihenés egyedülálló módon ötvöződik. Földrajz K8 – A Maghreb természetes növényzete és endemikus fajai.",
    ro: "Parcul Național Taza este un element remarcabil al geografiei și culturii algeriene. Un parc care protejează o mare varietate de păsări și mamifere. Rezervație a biosferei. Peisaj costier. Floră. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
...
image: "/poi-images/belezma-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Nationalpark Belezma ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein bergiger Park, bekannt für seine Atlas-Zedern. Atlas-Zedern. Wildtiere. Wandern. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Belezma Nemzeti Park Algéria északi részén, Batna tartományban található, és az Aurès-hegység egyik legfontosabb természetvédelmi területe. A park hírnevét elsősorban az őshonos atlaszi cédrusoknak (Cedrus atlantica) köszönheti, amelyek hatalmas erdőségeket alkotnak a 2000 méter feletti csúcsok lankáin. A terület klímája a mediterrán és a szaharai hatások találkozása, ami különleges biodiverzitást eredményez: több mint 440 növényfaj és számos ritka állatfaj, köztük a berber szarvas és a kőris mormota otthona. A látogatókat látványos kanyonok, barlangok és sűrű erdők várják, amelyek a vándorló madarak számára is létfontosságú pihenőhelyet jelentenek. Földrajz K7 – Algéria élővilága és védett területei.",
    ro: "Parcul Național Belezma este un element remarcabil al geografiei și culturii algeriene. Un parc muntos cunoscut pentru cedrii săi din Atlas. Cedri de Atlas. Animale sălbatice. Drumeții. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Belezma National Park is a remarkable feature of the geography and culture of Algeria. A mountainous park known for its Atlas cedars. Atlas cedars. Wildlife. Hiking. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/djurdjura-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Nationalpark Djurdjura ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Hohe Gipfel und Heimat der Berberaffen. Berberaffen. Hohe Gipfel. Naturlandschaft. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Djurdjura Nemzeti Park a Tell-Atlasz szívében, a Kabília régióban fekszik, és Algéria egyik legdrámaibb hegyvidéki tája. A parkot meredek sziklafalak, mély szakadékok és hófödte csúcsok jellemzik, köztük a 2308 méter magas Lalla Khedidja. A terület híres kiterjedt barlangrendszereiről, mint például az Anou Ifflis, amely Afrika egyik legmélyebb barlangja. Az élővilág kiemelkedő képviselője a veszélyeztetett berber majom (magott), amely a sűrű cédrus- és tölgyerdőkben él. A park a túrázók és a barlangászok paradicsoma, ahol a zord terep és a buja völgyek váltakozása lenyűgöző látványt nyújt minden évszakban. Földrajz K7 – Magashegységi életközösségek.",
    ro: "Parcul Național Djurdjura este un element remarcabil al geografiei și culturii algeriene. Vârfuri înalte și casa macacilor de Berberia. Macaci de Berberia. Vârfuri înalte. Peisaj natural. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Djurdjura National Park is a remarkable feature of the geography and culture of Algeria. High peaks and home to Barbary macaques. Barbary macaques. High peaks. Natural landscape. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/theniet-el-had-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Nationalpark Theniet El Had ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Berühmt für seine dichten Zedernwälder. Zedernwald. Wanderwege. Ruhe. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Théniet El Had Nemzeti Park, amelyet gyakran 'S'hel' néven is emlegetnek, Algéria első nemzeti parkja, amelyet még 1923-ban alapítottak. Tissemsilt tartományban található, és az Atlasz-hegység egyik legszebb cédruserdőjének, az El Meddad erdőnek ad otthont. A park különleges mikroklímája lehetővé tette, hogy az atlaszi cédrusok itt hatalmasra nőjenek, némelyikük több száz éves. A terület nemcsak botanikai szempontból értékes, hanem fontos menedékhely a helyi fauna számára is, beleértve a különféle ragadozó madarakat és vadmacskákat. A park kirándulóútvonalai a természet szerelmeseinek kínálnak felejthetetlen élményt a sűrű, óriási fákkal teli erdőben. Földrajz K7 – Erdők és természetvédelem.",
    ro: "Parcul Național Theniet El Had este un element remarcabil al geografiei și culturii algeriene. Faimos pentru pădurile sale dese de cedru. Pădure de cedru. Trasee de drumeție. Liniște. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Theniet El Had National Park is a remarkable feature of the geography and culture of Algeria. Famous for its dense cedar forests. Cedar forest. Hiking trails. Tranquility. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/tlemcen-national-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Nationalpark Tlemcen ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein Park, der eine reiche Flora und historische Stätten umfasst. Flora. Tlemcen-Wasserfälle. Natur. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Tlemcen Nemzeti Park Algéria északnyugati részén található, és a természetvédelmi területek közül az egyik leggazdagabb történelmi és kulturális örökséggel rendelkezik. A park területén található a lenyűgöző Ourit-vízesés, valamint a Beni Add-barlang, amelynek cseppkőformációi több ezer évesek. A park ötvözi a mediterrán erdők szépségét a középkori iszlám építészet romjaival, mint például Mansourah városa. Az élővilág itt is változatos, a tölgyesekben és fenyvesekben számos kisemlős és hüllő talál otthonra. A park fontos szerepet játszik a környezeti nevelésben, bemutatva a természet és az emberi történelem szoros kapcsolatát. Földrajz K7 – Tájegységek és ökoszisztémák.",
    ro: "Parcul Național Tlemcen este un element remarcabil al geografiei și culturii algeriene. Un parc care cuprinde o floră bogată și situri istorice. Floră. Cascadele Tlemcen. Natură. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Tlemcen National Park is a remarkable feature of the geography and culture of Algeria. A park that includes rich flora and historical sites. Flora. Tlemcen waterfalls. Nature. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/guelma-thermal-baths-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Hammam Debagh ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Thermalquellen, die bei Familien sehr beliebt sind. Heißes Wasser. Erholung. Familien. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Guelma tartomány egyik legkülönlegesebb látványossága a Hammam Debagh termálfürdő, amely híres extrém forró vizű forrásairól és látványos mésztufa-formációiról. A források vize eléri a 95°C-ot, ami a világon az egyik legmagasabb hőmérsékletű természetes víz. Az évezredek során a kicsapódó ásványi anyagokból hatalmas, színes 'kőzuhatagok' és travertin kúpok jöttek létre, amelyek a föld mélyéből feltörő vulkáni energiák tanúi. A helyiek és a turisták nemcsak gyógyító hatása miatt látogatják, hanem a természeti jelenség esztétikai értéke miatt is. A forró gőzölgő táj és a fehér mészkőfalak drámai kontrasztot alkotnak a környező zöld völgyekkel. Földrajz K7 – Hévizek és utóvulkáni jelenségek.",
    ro: "Hammam Debagh este un element remarcabil al geografiei și culturii algeriene. Izvoare termale foarte populare printre familii. Apă caldă. Relaxare. Familii. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Hammam Debagh is a remarkable feature of the geography and culture of Algeria. Thermal springs that are very popular among families. Hot water. Relaxation. Families. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/el-oued-palm-groves-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Palmenhaine von El Oued ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Traditionelle Oasen-Landwirtschaft in der Wüste. Oasenbau. Datteln. Tradition. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "El Oued, az 'ezer kupola városa', a Szahara szívében fekszik, és híres egyedülálló mezőgazdasági módszeréről, a 'Ghout' rendszerről. A helyi gazdák hatalmas tölcsérszerű mélyedéseket ásnak a homokdűnék közé, hogy a datolyapálmák gyökerei közvetlenül elérjék a talajvizet. Ez a zseniális technika lehetővé teszi az öntözés nélküli pálmatermesztést a sivatagban. A pálmaligetek a levegőből nézve hatalmas zöld körökként tűnnek fel a sárga homoktengerben. Itt teremnek a világ legjobb minőségű Deglet Nour datolyái, amelyek a helyi gazdaság alappillérét jelentik. A táj az emberi kitartás és a természeti erőforrások okos kihasználásának szimbóluma. Földrajz K8 – Sivatagi gazdálkodás és öntözés.",
    ro: "Lunzile de palmieri El Oued este un element remarcabil al geografiei și culturii algeriene. Agricultură tradițională de oază în deșert. Amenajarea oazelor. Curmale. Tradiție. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "El Oued Palm Groves is a remarkable feature of the geography and culture of Algeria. Traditional oasis farming in the desert. Oasis farming. Dates. Tradition. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/mascara-vineyards-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Weinberge von Mascara ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Region mit langer Tradition im Weinanbau. Weinbau. Klima. Tradition. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Mascara tartomány Algéria egyik történelmi bortermelő vidéke, ahol a szőlőtermesztés hagyományai az ókorig nyúlnak vissza. A régió mediterrán éghajlata, a forró nyarak és a dombos domborzat ideális feltételeket biztosítanak a minőségi szőlőműveléshez. A francia gyarmati időszakban a terület a világ egyik legjelentősebb borvidékévé vált, és bár azóta a termelés szerkezete átalakult, a szőlőkertek ma is meghatározzák a tájképet. A helyi borok híresek testességükről és karakteres ízvilágukról. A szőlőművelés mellett az olajbogyó-termesztés is jelentős, ami tovább színesíti a vidék mezőgazdasági palettáját. Földrajz K8 – Algéria mezőgazdasági régiói.",
    ro: "Podgoriile Mascara este un element remarcabil al geografiei și culturii algeriene. Regiune cu o lungă tradiție în viticultură. Viticultură. Climat. Tradiție. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Mascara Vineyards is a remarkable feature of the geography and culture of Algeria. Region with a long tradition in viticulture. Viticulture. Climate. Tradition. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/tipaza-coastal-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Küstenlandwirtschaft Tipaza ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Fruchtbares Land direkt am Meer. Obstbau. Gemüse. Küstenklima. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Tipaza partvidéke Algéria egyik legtermékenyebb mezőgazdasági övezete, ahol a Földközi-tenger közelsége és a Mitidja-alföld gazdag talaja találkozik. A régió híres citrusféléiről, korai zöldségeiről és gyümölcsöskertjeiről. A domboldalakon gondosan kialakított teraszok és öntözőrendszerek biztosítják a folyamatos termelést a forró nyári hónapokban is. A mezőgazdasági területek közvetlenül a kék tengerpart mellett fekszenek, ahol a sós tengeri szél és a napsütés különleges zamatot ad az itt termő gyümölcsöknek. A táj itt nemcsak gazdaságilag értékes, hanem esztétikailag is lenyűgöző, ahogy a zöld ültetvények a tengerparti sziklákig nyúlnak. Földrajz K8 – Mediterrán típusú mezőgazdaság.",
    ro: "Agricultura costieră Tipaza este un element remarcabil al geografiei și culturii algeriene. Pământ fertil chiar pe malul mării. Cultivarea fructelor. Legume. Climat costier. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Tipaza Coastal Agriculture is a remarkable feature of the geography and culture of Algeria. Fertile land right by the sea. Fruit growing. Vegetables. Coastal climate. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/ghardaia-oasis-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Oase Ghardaia ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Einzigartige Oasen-Kultur mit traditioneller Bewässerung. Datteln. Bewässerung. Kultur. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A M'zab-völgy in található Ghardaia oázisa az emberi találékonyság mesterműve a sivatagi környezetben. A helyi mezőgazdaság alapja a több száz éves, bonyolult öntözőrendszer, amely minden egyes csepp vizet szétoszt a pálmaligetek között. A gátak, csatornák és földalatti víztározók (foggara) rendszere biztosítja a datolyapálmák túlélését a perzselő hőségben. Az oázisban háromszintű gazdálkodás folyik: felül a pálmák árnyékolnak, alattuk gyümölcsfák (füge, gránátalma) nőnek, a talajszinten pedig takarmányt és zöldségeket termesztenek. Ez a fenntartható rendszer évszázadok óta élelmet ad a sivatagi közösségeknek, és az UNESCO Világörökség része. Földrajz K8 – Hagyományos oázisgazdálkodás.",
    ro: "Oaza Ghardaia este un element remarcabil al geografiei și culturii algeriene. Cultură de oază unică cu irigare tradițională. Curmale. Irigare. Cultură. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Ghardaia Oasis is a remarkable feature of the geography and culture of Algeria. Unique oasis culture with traditional irrigation. Dates. Irrigation. Culture. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/souk-ahras-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Souk Ahras Landwirtschaft ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Region mit Fokus auf Getreide und Hülsenfrüchte. Getreide. Hülsenfrüchte. Klima. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Souk Ahras tartomány Algéria északkeleti részén, a tunéziai határ közelében fekszik, és az ország egyik legfontosabb gabonatermelő vidéke. A dombos, fennsíki domborzat és a viszonylav bőséges csapadék ideális a búza és az árpa termesztéséhez. A régió története szorosan összefonódik a mezőgazdasággal: már a római korban az 'Empire éléstáraként' ismerték ezt a területet. A gabonatáblák mellett kiterjedt olajfaligetek és állattenyésztő gazdaságok is találhatók itt. A táját a végtelen aranyszínű gabonamezők jellemzik, amelyek a nyári aratás idején a leglátványosabbak. Földrajz K8 – Szántóföldi növénytermesztés az Atlaszban.",
    ro: "Agricultura Souk Ahras este un element remarcabil al geografiei și culturii algeriene. Regiune axată pe cereale și leguminoase. Cereale. Leguminoase. Climat. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Souk Ahras Agriculture is a remarkable feature of the geography and culture of Algeria. Region focusing on grains and legumes. Grains. Legumes. Climate. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/skikda-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Skikda Obstbau ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Bekannt für Erdbeeren und Zitrusfrüchte. Erdbeeren. Zitrusfrüchte. Klima. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Skikda, a 'szamócák városa', Algéria északkeleti partvidékén található, és híres különlegesen édes eperterméséről. A párás tengerparti klíma és a tápanyagban gazdag völgyek tökéletes környezetet biztosítanak a kertészeti kultúráknak. Az oroszországi eredetű eperfajta, amelyet a 20. század elején honosítottak meg itt, mára a város jelképévé vált. Az eper mellett a régió citrusféléiről és paradicsomtermesztéséről is ismert, amelyeket modern üvegházakban és szabadföldi ültetvényeken egyaránt művelnek. A minden évben megrendezett eper-fesztivál a helyi mezőgazdasági büszkeség és a gazdag termés ünnepe. Földrajz K8 – Kertgazdálkodás és tengerparti mezőgazdaság.",
    ro: "Cultivarea fructelor Skikda este un element remarcabil al geografiei și culturii algeriene. Cunoscută pentru căpșuni și citrice. Căpșuni. Citrice. Climat. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Skikda Fruit Growing is a remarkable feature of the geography and culture of Algeria. Known for strawberries and citrus fruits. Strawberries. Citrus fruits. Climate. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/tindouf-agriculture-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Landwirtschaft in Tindouf ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Kleine landwirtschaftliche Projekte in der Wüste. Wüstenanbau. Resilienz. Datteln. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "Tindouf Algéria távoli délnyugati sarkában, a Szaharában fekszik, ahol a mezőgazdaság a túlélés és az alkalmazkodás művészete. A szélsőséges szárazság ellenére az utóbbi évtizedekben jelentős fejlesztések történtek a sivatagi kertészkedés terén. Modern üvegházakban és gondosan öntözött parcellákon zöldségeket, gyümölcsöket és természetesen datolyát termesztenek. Ezek a projektek nemcsak a helyi lakosság élelmezését szolgálják, hanem a menekülttáborok önellátási törekvéseit is támogatják. A gazdák napenergiával működtetett szivattyúkat használnak a mélyen fekvő víztartó rétegek eléréséhez, bizonyítva, hogy a technológia segítségével még a legzordabb környezet is termőre fordítható. Földrajz K8 – Alkalmazkodás a sivatagi körülményekhez.",
    ro: "Agricultura în Tindouf este un element remarcabil al geografiei și culturii algeriene. Mici proiecte agricole în deșert. Agricultură în deșert. Reziliență. Curmale. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Agriculture in Tindouf is a remarkable feature of the geography and culture of Algeria. Small agricultural projects in the desert. Desert farming. Resilience. Dates. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/bejaia-botanical-garden-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Botanischer Garten Béjaïa ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Ein entspannender Garten für Familien in Béjaïa. Pflanzenwelt. Ruhe. Spaziergänge. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Béjaïa városában található botanikus kert (Jardin de la Liberté) a tengerparti város egyik zöld ékköve, amely a mediterrán és egzotikus növényvilág gazdag gyűjteményét mutatja be. A kertet eredetileg a 19. század végén alapították, és azóta is fontos szerepet tölt be a tudományos kutatásban és a pihenésben. A sétányok mentén hatalmas pálmák, ritka kaktuszok és színes mediterrán virágok láthatók, amelyek a tenger sós levegőjével együtt különleges atmoszférát teremtenek. A kert nemcsak a botanikusok számára érdekes, hanem a családok kedvelt helyszíne is, ahol a gyerekek megismerhetik a különböző éghajlati övezetek növényeit. Biológia K7 – A növényvilág sokfélesége és rendszertana.",
    ro: "Grădina Botanică Béjaïa este un element remarcabil al geografiei și culturii algeriene. O grădină relaxantă pentru familii în Béjaïa. Floră. Liniște. Plimbări. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Béjaïa Botanical Garden is a remarkable feature of the geography and culture of Algeria. A relaxing garden for families in Béjaïa. Flora. Tranquility. Walks. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
...
image: "/poi-images/batna-amusement-park-life-v2.webp"
    ...
    descriptionAdvanced: {
    de: "Freizeitpark Batna ist ein bemerkenswertes Element der algerischen Geografie und Kultur. Unterhaltungspark für Kinder in Batna. Fahrgeschäfte. Spiele. Spaß. Dieses Schutzgebiet ist Teil der vielfältigen Tier- und Pflanzenwelt Algeriens, von der Sahara bis zum Tell-Atlas. Wie viele bedeutende Orte in Algerien vereint dieser Ort berberisches Erbe, mediterrane und saharische Einflüsse. Damit trägt dieser Ort zum vielseitigen Profil Algeriens bei.",
    hu: "A Batna városában található családi vidámpark, a Lompi Family Park, a régió legnagyobb és legmodernebb szórakoztató központja. A park széles választékát kínálja a játékoknak, a klasszikus körhintáktól a modernebb hullámvasutakig, minden korosztály számára. A tervezők nagy hangsúlyt fektetnek a zöldterületek kialakítására is, így a park egyfajta oázisként működik a városi környezetben. A látogatókat különféle tematikus zónák, éttermek és pihenőhelyek várják, ahol a családok kikapcsolódhatnak. A park különösen népszerű az esti órákban és ünnepnapokon, amikor a kivilágított játékok varázslatos hangulatot árasztanak. Technika K6 – Szabadidő, pihenés és technikai eszközök.",
    ro: "Parc de Distracții Batna este un element remarcabil al geografiei și culturii algeriene. Parc de divertisment pentru copii în Batna. Atracții. Jocuri. Distracție. Această arie protejată face parte din fauna și flora variată a Algeriei, de la Sahara până la Atlasul Tellian. Asemenea multor locuri importante din Algeria, acesta îmbină moștenirea berberă cu influențele mediteraneene și sahariene. Astfel, acest loc contribuie la profilul variat al Algeriei.",
    en: "Batna Amusement Park is a remarkable feature of the geography and culture of Algeria. Amusement park for kids in Batna. Rides. Games. Fun. This protected area is part of Algeria's diverse wildlife and flora, from the Sahara to the Tell Atlas. Like many notable places in Algeria, it combines Berber heritage with Mediterranean and Saharan influences. Thus, this place contributes to the diverse profile of Algeria."
    },
    factsAdvanced: {
