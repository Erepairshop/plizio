...
export const poiExtraBrazilNatureV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Amazonul este fluviul cu cel mai mare debit de apă de pe Pământ și joacă un rol crucial pentru climatul global și biodiversitate. Izvorăște din Anzii peruvieni și curge pe o distanță de peste 6.400 de kilometri prin bazinul Amazonului înainte de a se vărsa în Oceanul Atlantic. Cu un bazin hidrografic de aproximativ 7 milioane de kilometri pătrați, acesta drenează circa 40% din America de Sud. Volumul de apă descărcat este atât de imens încât depășește debitul următoarelor șapte cele mai mari fluvii la un loc. Amazonul găzduiește o varietate incredibilă de viață, inclusiv peste 3.000 de specii de pești cunoscute și celebrul delfin roz de râu. Din punct de vedere geografic, formează coloana vertebrală a celei mai mari păduri tropicale din lume, numită adesea 'plămânul planetei'. Fluviul este, de asemenea, o arteră vitală de transport pentru milioanele de oameni care trăiesc pe malurile sale, în special în regiunile izolate fără conexiuni rutiere. Istoric, fluviul a fost parcurs pentru prima dată de europeanul Francisco de Orellana în 1541.",
      en: "The Amazon is the world's largest river by discharge volume and plays a critical role in global climate and biodiversity. Originating in the Peruvian Andes, it flows over 6,400 kilometers through the Amazon Basin before emptying into the Atlantic Ocean. With a drainage basin of approximately 7 million square kilometers, it drains about 40 percent of South America. The volume of water discharged is so immense that it carries more water than the next seven largest rivers combined. The Amazon hosts an incredible variety of life, including over 3,000 known fish species and the famous pink river dolphin. Geographically, it forms the backbone of the world's largest tropical rainforest, often referred to as the 'lungs of the Earth.' The river is also a vital transportation artery for millions of people living along its banks, especially in remote regions lacking road connections. Historically, the river was first traversed by the European explorer Francisco de Orellana in 1541.",
      es: "El Amazonas es el río con mayor volumen de agua del planeta y constituye el corazón de la región selvática más extensa de nuestro mundo. Su complejo sistema de afluentes recorre todo el norte de Brasil y alberga una biodiversidad inigualable. El río es una arteria vital para millones de personas y desempeña un papel crucial en el clima global. Ecosistemas tropicales.",
      pt: "O Amazonas é o rio com o maior volume de água do planeta e forma o coração da maior área de floresta tropical do nosso mundo. O seu complexo sistema de afluentes percorre todo o norte do Brasil e abriga uma biodiversidade inigualável. O rio é uma via vital para milhões de pessoas e desempenha um papel crucial para o clima mundial. Ecossistemas tropicais.",
      fr: "L'Amazone est le fleuve ayant le plus gros débit de la planète et forme le cœur de la plus vaste région de forêt tropicale de notre monde. Son système complexe d'affluents parcourt tout le nord du Brésil et abrite une biodiversité inégalée. Le fleuve est une artère vitale pour des millions de personnes et joue un rôle crucial pour le climat mondial. Écosystèmes tropicaux.",
    },
    factsAdvanced: {
      de: ["Der Amazonas entlädt durchschnittlich 209.000 Kubikmeter Wasser pro Sekunde.", "Er ist je nach Messmethode zwischen 6.400 und 6.992 Kilometer lang.", "Das Flussbecken umfasst Gebiete in neun verschiedenen südamerikanischen Ländern.", "Der Amazonas hat über 1.100 Nebenflüsse, von denen 17 über 1.500 km lang sind.", "An seiner Mündung ist der Fluss zwischen 180 und 250 Kilometer breit.", "Es gibt keine einzige Brücke, die den Hauptstrom des Amazonas überquert."],
      hu: ["Az Amazonas átlagosan 209 000 köbméter vizet bocsát ki másodpercenként.", "A mérési módszertől függően hossza 6400 és 6992 kilométer között mozog.", "A folyómedence kilenc különböző dél-amerikai ország területét érinti.", "Az Amazonasnak több mint 1100 mellékfolyója van, ebből 17 hossza meghaladja az 1500 km-t.", "A torkolatánál a folyó szélessége 180 és 250 kilométer között van.", "Egyetlen híd sem ível át az Amazonas főágán a teljes hossza mentén."],
      ro: ["Amazonul descarcă în medie 209.000 de metri cubi de apă pe secundă.", "Lungimea sa este estimată între 6.400 și 6.992 km, depinzând de metodă.", "Bazinul fluviului cuprinde teritorii din nouă țări sud-americane diferite.", "Amazonul are peste 1.100 de afluenți, dintre care 17 au peste 1.500 km.", "La gura de vărsare, fluviul are o lățime cuprinsă între 180 și 250 de kilometri.", "Nu există nicio punte sau pod care să traverseze cursul principal al Amazonului."],
      en: ["The Amazon discharges an average of 209,000 cubic meters of water per second.", "Its length is estimated between 6,400 and 6,992 km depending on the source.", "The river basin covers territories in nine different South American countries.", "The Amazon has over 1,100 tributaries, 17 of which are longer than 1,500 km.", "At its mouth, the river width varies between 180 and 250 kilometers.", "There is not a single bridge crossing the main stem of the Amazon River."],
      es: [],
      pt: [],
      fr: [],
    },
    description: {
      ...
      es: "El Amazonas es el río más caudaloso de la Tierra y la columna vertebral de la selva más grande del mundo. Marca el transporte, el clima y la vida cotidiana en gran parte del norte de Brasil.",
      pt: "O Amazonas é o rio com o maior caudal da Terra e a espinha dorsal da maior floresta tropical do mundo. Molda o transporte, o clima e o quotidiano em grandes partes do Norte do Brasil.",
      fr: "L'Amazone est le fleuve le plus puissant de la Terre et la colonne vertébrale de la plus grande forêt tropicale du monde. Il façonne les transports, le climat et la vie quotidienne dans une grande partie du nord du Brésil.",
    },
    facts: {
      ...
      es: ["Mayor caudal del mundo", "Central para la selva amazónica", "Importante arteria de transporte"],
      pt: ["Maior caudal do mundo", "Central para a floresta amazónica", "Importante artéria de transporte"],
      fr: ["Plus grand débit du monde", "Central pour la forêt amazonienne", "Artère de transport majeure"],
    }, image: "/poi-images/br-amazon-river-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Rio São Francisco, adesea numit cu afecțiune 'Velho Chico', este unul dintre cele mai importante fluvii din Brazilia și o sursă vitală de apă pentru regiunea aridă a Nord-Estului. Izvorăște din munții Serra da Canastra din statul Minas Gerais și curge pe o distanță de peste 2.800 de kilometri prin cinci state înainte de a se vărsa în Atlantic. Fiind supranumit 'Fluviul Integrării Naționale', acesta conectează istoric și cultural sud-estul cu nord-estul țării. Fluviul este cunoscut pentru canioanele sale impresionante din zona Xingó și pentru numeroasele centrale hidroelectrice care produc o mare parte din energia regiunii. Din punct de vedere geografic, traversează diverse biomuri, de la vegetația luxuriantă din Cerrado până la Caatinga semi-aridă. În ultimele decenii, fluviul a fost subiectul masivului proiect de deviere 'Transposição', menit să direcționeze apa către zonele predispuse la secetă, declanșând însă și controverse ecologice. Rămâne un element central în folclorul, literatura și muzica identității braziliene.",
      en: "The São Francisco River, often affectionately called 'Velho Chico,' is one of Brazil's most significant rivers and a vital water source for the arid Northeast region. Originating in the Serra da Canastra mountains in Minas Gerais state, it flows over 2,800 kilometers through five states before reaching the Atlantic Ocean. Known as the 'River of National Integration,' it historically and culturally connects the country's Southeast and Northeast regions. The river is famous for its stunning canyons in the Xingó area and numerous hydroelectric plants that generate a large portion of the region's power. Geographically, it traverses various biomes, from the lush vegetation of the Cerrado to the semi-arid Caatinga. In recent decades, the river has been the subject of the massive 'Transposição' diversion project aimed at channeling water to drought-prone areas, which has also sparked ecological controversies. It remains a central element in the folklore, literature, and music of Brazilian identity.",
    },
    factsAdvanced: {
      de: ["Die Gesamtlänge des Rio São Francisco beträgt etwa 2.830 Kilometer.", "Er ist der längste Fluss, der vollständig auf brasilianischem Territorium fließt.", "Das Wasserkraftwerk Sobradinho staut einen der größten künstlichen Seen der Welt an.", "Die Canyons von Xingó gehören zu den fünf größten schiffbaren Canyons der Welt.", "Über 500 Gemeinden hängen direkt von der Wasserversorgung des Flusses ab.", "Der Fluss mündet zwischen den Bundesstaaten Alagoas und Sergipe in den Ozean."],
      hu: ["A Rio São Francisco teljes hossza körülbelül 2830 kilométer.", "Ez a leghosszabb folyó, amely teljes egészében brazil területen folyik.", "A Sobradinho vízerőmű a világ egyik legnagyobb mesterséges tavát hozta létre.", "A Xingó-kanyonok a világ öt legnagyobb hajózható kanyonja közé tartoznak.", "Több mint 500 település függ közvetlenül a folyó vízellátásától.", "A folyó Alagoas és Sergipe államok határán torkollik az óceánba."],
      ro: ["Lungimea totală a fluviului Rio São Francisco este de aproximativ 2.830 km.", "Este cel mai lung fluviu care curge integral pe teritoriul brazilian.", "Hidrocentrala Sobradinho formează unul dintre cele mai mari lacuri artificiale din lume.", "Canioanele din Xingó sunt printre cele mai mari cinci canioane navigabile din lume.", "Peste 500 de municipalități depind direct de alimentarea cu apă a fluviului.", "Fluviul se varsă în ocean între statele Alagoas și Sergipe."],
      en: ["The total length of the São Francisco River is approximately 2,830 kilometers.", "It is the longest river that flows entirely within Brazilian territory.", "The Sobradinho hydroelectric plant creates one of the world's largest artificial lakes.", "The Xingó Canyons are among the five largest navigable canyons in the world.", "Over 500 municipalities depend directly on the river's water supply.", "The river flows into the ocean between the states of Alagoas and Sergipe."],
      es: [],
      pt: [],
      fr: [],
    }, image: "/poi-images/br-sao-francisco-river-nature-v2.webp",
    description: {
      ...
      es: "El río São Francisco es el río más largo que fluye íntegramente por territorio brasileño. Conecta el interior con el océano Atlántico y es vital para el riego y la producción de energía.",
      pt: "O Rio São Francisco é o rio mais longo que corre inteiramente pelo território brasileiro. Conecta o interior com o oceano Atlântico e é fundamental para a irrigação e produção de energia.",
      fr: "Le fleuve São Francisco est le plus long cours d'eau coulant entièrement au Brésil. Il relie l'intérieur des terres à l'océan Atlantique et est crucial pour l'irrigation et l'énergie.",
    },
    facts: {
      ...
      es: ["Río más largo exclusivamente en Brasil", "Une el interior con la costa", "Importante para la energía hidroeléctrica"],
      pt: ["Rio mais longo exclusivamente no Brasil", "Une o interior com a costa", "Importante para a energia hidrelétrica"],
      fr: ["Plus long fleuve exclusivement au Brésil", "Relie l'arrière-pays et la côte", "Important pour l'hydroélectricité"],
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Fluviul Paraná este al doilea ca lungime din America de Sud după Amazon, având o lungime totală de aproximativ 4.880 de kilometri. Acesta ia naștere în sudul Braziliei, la confluența râurilor Rio Grande și Paranaíba, traversând Paraguay și Argentina înainte de a se vărsa în estuarul Río de la Plata. Bazinul său hidrografic acoperă circa 2,6 milioane de kilometri pătrați și reprezintă o resursă economică vitală pentru regiunile traversate. Pe cursul superior al Paranáului se află barajul Itaipu, una dintre cele mai mari hidrocentrale din lume, esențială pentru rețeaua electrică a Braziliei și Paraguayului. Fluviul servește drept arteră principală de navigație, facilitând exportul cerealelor și al bunurilor industriale către Oceanul Atlantic. Biodiversitatea sa este remarcabilă, adăpostind numeroase specii de pești, printre care celebrul dorado, fiind totodată un ecosistem fragil în fața schimbărilor climatice. Debitul său variază sezonier, fiind influențat direct de precipitațiile abundente din zonele muntoase braziliene.",
      en: "The Paraná River is the second longest river in South America after the Amazon, stretching approximately 4,880 kilometers. It originates in southern Brazil at the confluence of the Rio Grande and Paranaíba rivers, flowing through Paraguay and Argentina before emptying into the Río de la Plata estuary. Its drainage basin covers about 2.6 million square kilometers and is of immense economic importance to the region. The upper course of the Paraná hosts the Itaipu Dam, one of the world's largest hydroelectric power plants, providing a significant portion of the electricity for Brazil and Paraguay. The river serves as a crucial waterway for transporting grain and industrial goods from the interior to the Atlantic Ocean. Ecologically, the system is highly diverse, home to numerous fish species including the prized dorado. The river's flow is subject to seasonal fluctuations, largely dictated by subtropical rainfall patterns in the Brazilian highlands.",
    },
    factsAdvanced: {
      de: ["Länge von 4.880 km macht ihn zum zweitlängsten Fluss des Kontinents.", "Das Einzugsgebiet erstreckt sich über 2.582.672 Quadratkilometer.", "Das Itaipu-Kraftwerk am Fluss wurde 1984 in Betrieb genommen.", "Der Fluss bildet über weite Strecken die Grenze zwischen Brasilien und Paraguay.", "Mündet zusammen mit dem Uruguay-Fluss in den Río de la Plata.", "Transportiert jährlich Millionen Tonnen Sedimente in das Delta."],
      hu: ["Hossza 4880 km, amivel a kontinens második leghosszabb folyója.", "Vízgyűjtő területe 2 582 672 négyzetkilométerre terjed ki.", "Az Itaipu-vízerőmű 1984-ben kezdte meg működését a folyón.", "Hosszú szakaszon természetes határt képez Brazília és Paraguay között.", "Az Uruguay-folyóval együtt alkotja a Río de la Plata tölcsértorkolatát.", "Évente több millió tonna hordalékot szállít a deltavidékre."],
      ro: ["Are o lungime de 4.880 km, fiind al doilea fluviu din America de Sud.", "Bazinul său hidrografic măsoară 2.582.672 de kilometri pătrați.", "Hidrocentrala Itaipu de pe Paraná a fost inaugurată în anul 1984.", "Formează o frontieră naturală extinsă între Brazilia și Paraguay.", "Se unește cu râul Uruguay pentru a forma estuarul Río de la Plata.", "Transportă anual cantități masive de sedimente spre zona deltei."],
      en: ["Its length of 4,880 km makes it the second longest river in South America.", "The drainage basin covers an area of 2,582,672 square kilometers.", "The Itaipu hydroelectric dam on the river began operation in 1984.", "It forms a long natural border between Brazil and Paraguay.", "It joins the Uruguay River to form the massive Río de la Plata estuary.", "The river carries millions of tons of sediment to its delta each year."],
      es: [],
      pt: [],
      fr: [],
    }, image: "/poi-images/br-parana-river-nature-v2.webp",
    description: {
      ...
      es: "El Paraná es uno de los ríos más importantes de Sudamérica y forma parte de las fronteras entre países de la región. Sus aguas están estrechamente vinculadas a la energía hidroeléctrica, el comercio y el transporte.",
      pt: "O Paraná é um dos rios mais importantes da América do Sul e forma partes das fronteiras entre países da região. Suas águas estão estreitamente ligadas à energia hidrelétrica, ao comércio e ao transporte.",
      fr: "Le Paraná est l'un des fleuves les plus importants d'Amérique du Sud et constitue une partie des frontières entre les pays de la région. Ses eaux sont étroitement liées à l'hydroélectricité, au commerce et aux transports.",
    },
    facts: {
      ...
      es: ["Río importante en Sudamérica", "Río fronterizo en la región", "Significativo para la energía hidroeléctrica"],
      pt: ["Rio importante na América do Sul", "Rio fronteiriço na região", "Significativo para a energia hidrelétrica"],
      fr: ["Fleuve important en Amérique du Sud", "Fleuve frontalier dans la région", "Important pour l'hydroélectricité"],
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Râul Tocantins este o arteră fluvială majoră din centrul Braziliei, având o lungime de aproximativ 2.450 de kilometri. Izvorăște din statul Goiás și curge spre nord până la vărsarea în Oceanul Atlantic, în apropierea insulei Marajó. Deși cursul său este adesea asociat cu Amazonul, Tocantins formează un sistem hidrografic distinct, nefiind un afluent al acestuia. Fluviul găzduiește barajul Tucuruí, unul dintre cele mai mari proiecte hidroelectrice de pe glob, care alimentează centrele industriale din nordul țării. Peisajul riveran variază de la savana Cerrado în cursul superior până la pădurea tropicală densă în apropierea gurii de vărsare. Navigația este limitată pe anumite porțiuni din cauza numeroaselor praguri și cataracte naturale. Fluviul rămâne însă esențial pentru comunitățile locale, care depind de pescuit și de agricultura practicată pe terenurile aluvionare. Variațiile de nivel ale apei pot atinge 10 metri, influențând dramatic ecosistemele inundabile din jur.",
      en: "The Tocantins River is a major waterway in central Brazil, spanning approximately 2,450 kilometers in length. It rises in the state of Goiás and flows northward until it empties into the Atlantic Ocean near Marajó Island. Although often associated with the Amazon, it technically belongs to a separate drainage system, though its mouth is adjacent to the Amazon delta. The river is home to the Tucuruí Dam, one of the largest hydroelectric plants in the world, supplying power to regional industries and cities. The surrounding vegetation transitions from the Cerrado savanna in the south to the tropical rainforest in the north. Navigation is hindered on several stretches by rapids and sedimentation. Despite this, it remains a vital resource for local populations who rely on fishing and agriculture in the fertile floodplains. Seasonal water level changes can reach up to ten meters, periodically reshaping the riverbank landscapes.",
    },
    factsAdvanced: {
      de: ["Gesamtlänge des Flusses beträgt rund 2.450 km.", "Die Tucuruí-Talsperre wurde 1984 eingeweiht.", "Das Einzugsgebiet umfasst etwa 764.183 Quadratkilometer.", "Der Fluss durchquert die Bundesstaaten Goiás, Tocantins, Maranhão und Pará.", "Der größte Nebenfluss ist der Rio Araguaia.", "Der Hafen von Belém liegt in der Nähe der Mündungsregion."],
      hu: ["A folyó teljes hossza körülbelül 2450 km.", "A Tucuruí-gátat 1984-ben adták át a forgalomnak.", "Vízgyűjtő területe mintegy 764 183 négyzetkilométer.", "Goiás, Tocantins, Maranhão és Pará államokon folyik keresztül.", "Legnagyobb mellékfolyója az Araguaia-folyó.", "Belém kikötője a torkolatvidék közvetlen közelében található."],
      ro: ["Lungimea totală a râului este de circa 2.450 km.", "Barajul Tucuruí a fost inaugurat în anul 1984.", "Bazinul hidrografic ocupă o suprafață de 764.183 km pătrați.", "Traversează statele Goiás, Tocantins, Maranhão și Pará.", "Cel mai important afluent al său este râul Araguaia.", "Portul Belém este situat strategic lângă gura de vărsare."],
      en: ["The total length of the river is approximately 2,450 km.", "The Tucuruí Dam was officially inaugurated in 1984.", "Its drainage basin covers an area of about 764,183 square km.", "The river flows through Goiás, Tocantins, Maranhão, and Pará states.", "The Araguaia River is its largest and most important tributary.", "The port of Belém is located near the river's mouth region."],
      es: [],
      pt: [],
      fr: [],
    },
    description: {
      ...
      es: "El Tocantins es un gran río del interior de Brasil y forma parte de un sistema fluvial esencial en el norte. Juega un papel clave en la energía, el transporte y el desarrollo regional.",
      pt: "O Tocantins é um grande rio no interior do Brasil e parte de um importante sistema fluvial no norte. Desempenha um papel na energia, transporte e desenvolvimento regional.",
      fr: "Le Tocantins est un grand fleuve de l'intérieur du Brésil, membre d'un système fluvial majeur au nord. Il joue un rôle dans l'énergie, le transport et le développement régional.",
    },
    facts: {
      ...
      es: ["Gran río del centro de Brasil", "Importante para el transporte", "Parte de una gran cuenca hidrográfica"],
      pt: ["Grande rio no centro do Brasil", "Importante para o transporte", "Parte de uma grande bacia hidrográfica"],
      fr: ["Grand fleuve du centre du Brésil", "Important pour le transport", "Fait partie d'un vaste bassin versant"],
    }, image: "/poi-images/br-tocantins-river-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Râul Araguaia este unul dintre cursurile de apă emblematice ale Braziliei și principalul afluent al râului Tocantins, întinzându-se pe 2.627 de kilometri. Izvorând din Podișul Mato Grosso, acesta curge spre nord, marcând granița naturală între mai multe state braziliene. Este renumit la nivel mondial pentru Ilha do Bananal, cea mai mare insulă fluvială de pe planetă, formată prin bifurcarea cursului râului. În timpul sezonului secetos, se formează plaje vaste de nisip care atrag mii de turiști pentru camping și pescuit sportiv. Din punct de vedere ecologic, regiunea reprezintă o zonă de tranziție între savana Cerrado și pădurea amazoniană, adăpostind o diversitate biologică uluitoare. Specii precum delfinul de râu, vidra gigantică și diverse tipuri de caimani populează apele sale. Totuși, ecosistemul este amenințat de defrișările masive și de agricultura intensivă care accelerează eroziunea malurilor. Navigația pe Araguaia este îngreunată de prezența numeroaselor bancuri de nisip și a pragurilor stâncoase.",
      en: "The Araguaia River is one of Brazil's most iconic rivers and the primary tributary of the Tocantins, flowing for approximately 2,627 kilometers. Rising in the Mato Grosso Plateau, it moves northwards, serving as a natural boundary between several Brazilian states. It is globally famous for hosting Bananal Island, the world's largest river island, formed by a split in the river's main channel. During the dry season, extensive white sand beaches emerge along its banks, attracting tourists for camping and fishing. Ecologically, the area is a transition zone between the Cerrado savanna and the Amazon rainforest, resulting in extraordinary biodiversity. The river is home to the Amazon river dolphin, giant otters, and various caiman species. However, the river faces threats from deforestation and intensive agriculture within its basin, leading to increased erosion. Despite its size, the Araguaia is only partially navigable due to numerous sandbars and rapids.",
    },
    factsAdvanced: {
      de: ["Länge von 2.627 km macht ihn zu einem der längsten Flüsse Brasiliens.", "Die Ilha do Bananal umfasst eine Fläche von ca. 19.162 km².", "Der Fluss mündet in den Rio Tocantins bei der Stadt Marabá.", "Etwa 32.000 Jahre alte archäologische Funde wurden in der Region gemacht.", "Der Araguaia-Nationalpark schützt große Teile des Flussökosystems.", "In der Trockenzeit (Juni-September) sinkt der Wasserstand erheblich."],
      hu: ["Hossza 2627 km, amivel Brazília egyik leghosszabb folyója.", "A Bananal-sziget területe körülbelül 19 162 négyzetkilométer.", "A folyó Marabá városánál torkollik a Tocantins-folyóba.", "A régióban mintegy 32 000 éves régészeti leleteket is találtak.", "Az Araguaia Nemzeti Park védi a folyó ökoszisztémájának nagy részét.", "A száraz évszakban (június-szeptember) a vízszint jelentősen leapad."],
      ro: ["Lungimea de 2.627 km îl plasează printre cele mai lungi râuri braziliene.", "Insula Bananal are o suprafață de aproximativ 19.162 km².", "Râul se varsă în Tocantins în apropierea orașului Marabá.", "În regiune au fost descoperite vestigii arheologice vechi de 32.000 de ani.", "Parcul Național Araguaia protejează o mare parte din biodiversitate.", "Nivelul apei scade drastic în sezonul secetos (iunie-septembrie)."],
      en: ["Its length of 2,627 km makes it one of the longest rivers in Brazil.", "Bananal Island covers an area of approximately 19,162 square km.", "The river joins the Tocantins near the city of Marabá.", "Archaeological finds in the region date back roughly 32,000 years.", "The Araguaia National Park protects vast stretches of the river ecosystem.", "The water level drops significantly during the dry season (June-September)."],
      es: [],
      pt: [],
      fr: [],
    }, image: "/poi-images/br-araguaia-river-nature-v2.webp",
    description: {
      ...
      es: "El Araguaia es un río destacado del centro de Brasil con amplios bancos de arena en la estación seca. Atraviesa la zona del Cerrado y es importante para la fauna.",
      pt: "O Araguaia é um rio marcante no centro do Brasil, com amplos bancos de areia na época seca. Percorre a zona do Cerrado e é importante para a fauna.",
      fr: "L'Araguaia est une rivière marquante du centre du Brésil, dotée de larges bancs de sable pendant la saison sèche. Elle traverse la région du Cerrado et est importante pour la faune.",
    },
    facts: {
      ...
      es: ["Amplias playas de arena en la estación seca", "Atraviesa el Cerrado", "Importante para el ecoturismo"],
      pt: ["Praias de areia largas na época seca", "Atravessa o Cerrado", "Importante para o ecoturismo"],
      fr: ["Larges plages de sable à la saison sèche", "Traverse le Cerrado", "Important pour l'écotourisme"],
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Rio Negro este cel mai mare afluent de stânga al Amazonului și cel mai mare râu cu apă neagră din lume. Izvorăște din munții Columbiei sub numele de Guainía și parcurge peste 2.250 de kilometri până la confluența sa de lângă Manaus. Culoarea sa închisă caracteristică se datorează acizilor humici proveniți din vegetația în descompunere, care scad pH-ul apei. Acest mediu acid împiedică dezvoltarea larvelor de țânțari, făcând zonele riverane mult mai ospitaliere decât restul junglei. Un fenomen celebru este „Encontro das Águas”, unde apele negre ale Rio Negro curg alături de apele lăptoase ale râului Solimões pe parcursul a câțiva kilometri fără a se amesteca. Râul adăpostește arhipelagul Anavilhanas, unul dintre cele mai mari sisteme de insule fluviale de pe glob, cu peste 400 de insule. Din punct de vedere economic, este esențial pentru orașul Manaus ca rută de transport și centru pentru ecoturism. Regiunea este, de asemenea, căminul a numeroase comunități indigene care depind de resursele râului.",
      en: "The Rio Negro is the largest left tributary of the Amazon and the largest blackwater river in the world. It originates in the Colombian highlands as the Guainía River and flows for over 2,250 kilometers to its confluence near Manaus. Its characteristic dark color is caused by humic acids dissolved from decaying vegetation, which significantly lower the water's pH level. This acidic environment makes the river a difficult breeding ground for mosquitoes, resulting in relatively insect-free banks. A world-famous phenomenon is the 'Encontro das Águas' (Meeting of Waters), where the dark Rio Negro and the sandy Rio Solimões flow side-by-side for several kilometers without mixing. The river contains the Anavilhanas Archipelago, one of the world's largest river island systems with over 400 islands. Economically, it is vital for the city of Manaus as a transport route and a hub for ecotourism. The region is also home to numerous indigenous communities that have lived in harmony with the river for millennia.",
    },
    factsAdvanced: {
      de: ["Länge beträgt etwa 2.250 km von der Quelle bis zur Mündung.", "Der pH-Wert des Wassers liegt oft zwischen 3,8 und 4,9.", "Das Einzugsgebiet umfasst ca. 691.000 Quadratkilometer.", "Die Wassertemperatur liegt konstant zwischen 28 °C und 30 °C.", "Über 400 Inseln bilden den Anavilhanas-Nationalpark im Fluss.", "In Manaus wurde 2011 eine 3,6 km lange Brücke über den Fluss eingeweiht."],
      hu: ["Hossza körülbelül 2250 km a forrástól a torkolatig.", "A víz pH-értéke gyakran 3,8 és 4,9 közé esik.", "Vízgyűjtő területe nagyjából 691 000 négyzetkilométer.", "A víz hőmérséklete állandóan 28 °C és 30 °C között mozog.", "Az Anavilhanas Nemzeti Park több mint 400 szigetet foglal magában.", "2011-ben adták át a Manaus melletti 3,6 km hosszú hidat a folyó felett."],
      ro: ["Are o lungime de aproximativ 2.250 km până la confluență.", "Nivelul pH-ului apei variază de obicei între 3,8 și 4,9.", "Bazinul său hidrografic ocupă circa 691.000 km pătrați.", "Temperatura apei rămâne constantă între 28 °C și 30 °C.", "Peste 400 de insule formează Parcul Național Anavilhanas.", "Podul Rio Negro, inaugurat în 2011, are o lungime de 3,6 km."],
      en: ["The total length is about 2,250 km from source to mouth.", "The water's pH level often ranges between 3.8 and 4.9.", "Its drainage basin covers approximately 691,000 square km.", "The water temperature remains constant between 28 °C and 30 °C.", "Over 400 islands make up the Anavilhanas National Park within the river.", "A 3.6 km long bridge over the river near Manaus was opened in 2011."],
      es: [],
      pt: [],
      fr: [],
    }, image: "/poi-images/br-negro-river-nature-v2.webp",
    description: {
      ...
      ro: "Rio Negro este cel mai mare afluent cu apă neagră al fluviului Amazon și unul dintre cele mai mari râuri din lume.",
      en: "The Negro River is the largest blackwater river in the world and a major tributary of the Amazon, known for its dark, humic acid-rich waters.",
      es: "El río Negro es un afluente del Amazonas rico en aguas oscuras. En su desembocadura cerca de Manaos, se produce el famoso espectáculo natural del Encuentro de las Aguas.",
      pt: "O Rio Negro é um afluente do Amazonas rico em águas negras. Em sua foz, perto de Manaus, ocorre o famoso espetáculo natural do encontro das águas.",
      fr: "Le Rio Negro est un affluent de l'Amazone aux eaux noires caractéristiques. À son embouchure près de Manaus, se produit le célèbre spectacle naturel de la Rencontre des Eaux.",
    },
    facts: {
      ...
      ro: ["Culoare datorată acidului humic", "Fenomenul Întâlnirea Apelor", "Izvorăște din Columbia"],
      en: ["Largest blackwater river", "Main Amazon tributary", "Joins the Solimões near Manaus", "Rich in humic acid and tannins"],
      es: ["Río de aguas negras", "Afluente del Amazonas", "Conocido por la mezcla de aguas en Manaos"],
      pt: ["Rio de águas negras", "Afluente do Amazonas", "Conhecido pelo encontro das águas em Manaus"],
      fr: ["Rivière d'eau noire", "Affluent de l'Amazone", "Connu pour le mélange des eaux à Manaus"],
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Rio Madeira este cel mai important și mai bogat în apă afluent al Amazonului, având o lungime de aproximativ 3.250 de kilometri. Se formează la confluența râurilor Mamoré și Beni, la granița dintre Brazilia și Bolivia. Numele său, care înseamnă „lemn” în portugheză, provine de la cantitățile uriașe de trunchiuri de copaci pe care le transportă în timpul sezonului ploios. Fiind un râu cu „apă albă”, este extrem de bogat în sedimente și nutrienți, ceea ce îl transformă în unul dintre cele mai populate ecosisteme piscicole de pe planetă. Navigația pe Madeira este crucială pentru logistica din vestul Amazoniei, în special pentru exportul masiv de soia. Recent, pe cursul său au fost construite hidrocentrale gigantice, precum Santo Antônio și Jirau, proiecte care au stârnit controverse din cauza impactului asupra mediului. Fluviul traversează zone de junglă densă, oferind refugiu unor specii periclitate precum delfinul roz. Inundațiile anuale fertilizează pădurile inundabile din jur, susținând productivitatea biologică a întregii regiuni.",
      en: "The Madeira River is the most significant and voluminous tributary of the Amazon, stretching about 3,250 kilometers in length. It is formed by the confluence of the Mamoré and Beni rivers on the border between Brazil and Bolivia. Its name, 'Madeira' (meaning wood in Portuguese), was given due to the vast amounts of driftwood it carries during the rainy season. It is a classic whitewater river, rich in sediments and nutrients, making it one of the most biodiverse aquatic environments in the world for fish. Navigation on the Madeira is vital for logistics in the western Amazon, particularly for soybean exports. In recent years, massive hydroelectric plants like Santo Antônio and Jirau were built on the river, though they remain controversial due to their ecological impact. The river winds through dense rainforest, providing habitat for endangered species like the pink river dolphin. Annual flood cycles fertilize the surrounding floodplain forests, ensuring the biological productivity of the entire ecosystem.",
    },
    factsAdvanced: {
      de: ["Gesamtlänge des Flusssystems beträgt ca. 3.250 km.", "Der Fluss liefert etwa 15 % des Gesamtwassers des Amazonas.", "Die Jirau-Talsperre hat eine installierte Leistung von 3.750 MW.", "Im Fluss leben mehr als 1.000 verschiedene Fischarten.", "Die Stadt Porto Velho ist das wichtigste wirtschaftliche Zentrum am Fluss.", "Der Fluss hat ein Einzugsgebiet von etwa 1,3 Millionen km²."],
      hu: ["A folyórendszer teljes hossza körülbelül 3250 km.", "Az Amazonas teljes vízhozamának mintegy 15%-át adja.", "A Jirau-vízerőmű beépített teljesítménye 3750 MW.", "A folyóban több mint 1000 különböző halfaj él.", "Porto Velho városa a legfontosabb gazdasági központ a folyó mentén.", "Vízgyűjtő területe nagyjából 1,3 millió négyzetkilométer."],
      ro: ["Lungimea totală a sistemului fluvial este de circa 3.250 km.", "Râul furnizează aproximativ 15% din debitul total al Amazonului.", "Barajul Jirau are o capacitate instalată de 3.750 MW.", "În apele sale trăiesc peste 1.000 de specii diferite de pești.", "Orașul Porto Velho este principalul nod economic de pe malurile sale.", "Bazinul său hidrografic acoperă aproximativ 1,3 milioane km²."],
      en: ["The total length of the river system is about 3,250 km.", "The river contributes about 15% of the Amazon's total water volume.", "The Jirau Dam has an installed capacity of 3,750 MW.", "More than 1,000 different species of fish inhabit the river.", "The city of Porto Velho is the main economic hub along the river.", "The river's drainage basin covers approximately 1.3 million square km."],
      es: [],
      pt: [],
      fr: [],
    },
    description: {
      ...
      es: "El río Madeira es uno de los principales afluentes del Amazonas y es económicamente importante para el norte de Brasil. Se utiliza para la navegación, la energía y el transporte de mercancías.",
      pt: "O Rio Madeira é um dos grandes afluentes do Amazonas e é economicamente importante para o norte do Brasil. É utilizado para navegação, energia e transporte de mercadorias.",
      fr: "Le Rio Madeira est l'un des grands affluents de l'Amazone et revêt une grande importance économique pour le nord du Brésil. Il est utilisé pour la navigation, l'énergie et le transport de marchandises.",
    },
    facts: {
      ...
      es: ["Gran afluente del Amazonas", "Importante para la navegación", "Relevante para la energía hidroeléctrica"],
      pt: ["Grande afluente do Amazonas", "Importante para a navegação", "Relevante para a energia hidrelétrica"],
      fr: ["Grand affluent de l'Amazone", "Important pour la navigation", "Pertinent pour l'hydroélectricité"],
    }, image: "/poi-images/br-madeira-river-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Rio Tapajós este unul dintre cei mai importanți afluenți ai Amazonului, fiind celebru pentru apele sale limpezi, de un albastru-verzui spectaculos. Se formează la confluența râurilor Teles Pires și Juruena, parcurgând peste 800 de kilometri (1.900 km incluzând izvoarele) prin statul Pará. Spre deosebire de alți afluenți amazonieni, Tapajós transportă foarte puține sedimente, ceea ce îi conferă o transparență unică. La Santarém, acesta se întâlnește cu fluviul Amazon, oferind un contrast vizual izbitor între apele clare și cele mâloase. Râul este renumit pentru plajele sale de nisip fin, Alter do Chão fiind adesea numit „Caraibele Amazoniei”. În lungul cursului său se află arii protejate majore, precum Parcul Național Amazônia, care adăpostește o biodiversitate incredibilă. Din punct de vedere istoric, regiunea este marcată de experimentul „Fordlândia”, așezarea fondată de Henry Ford pentru producția de cauciuc. În prezent, conservarea râului în fața proiectelor hidroelectrice și a mineritului ilegal de aur reprezintă o prioritate ecologică internațională.",
      en: "The Tapajós River is one of the Amazon's largest tributaries, distinguished by its clear, blue-green waters. Formed by the confluence of the Teles Pires and Juruena rivers, it flows for over 800 kilometers (1,900 km including source rivers) through Pará state. Unlike many other Amazonian tributaries, the Tapajós carries very little sediment, giving it a unique transparency. At the city of Santarém, it meets the Amazon, where the boundary between the clear and muddy waters remains sharply defined. The river is famous for its stunning sandy beaches, such as Alter do Chão, often called the 'Caribbean of the Amazon.' The region hosts significant conservation areas like the Amazônia National Park, protecting an enormous variety of flora and fauna. Historically, the river is known for 'Fordlândia,' a rubber plantation established by Henry Ford that is now a ghost town. Currently, protecting the river from planned dam projects and illegal gold mining is a major focus for international environmentalists.",
    },
    factsAdvanced: {
      de: ["Hauptrinne ist 800 km lang, Gesamtsystem ca. 1.900 km.", "Die Mündung bei Santarém ist an manchen Stellen über 12 km breit.", "Das Einzugsgebiet umfasst etwa 492.000 Quadratkilometer.", "Alter do Chão wurde von der Presse zu einem der schönsten Strände gewählt.", "Henry Ford investierte in den 1920ern Millionen in die Stadt Fordlândia.", "Der Fluss ist die Heimat des seltenen Tapajós-Flussdelfins."],
      hu: ["A főmeder hossza 800 km, a teljes rendszeré kb. 1900 km.", "A torkolat Santarémnél néhol több mint 12 km széles.", "Vízgyűjtő területe körülbelül 492 000 négyzetkilométer.", "Alter do Chão strandját a sajtó a világ egyik legszebbjének választotta.", "Henry Ford az 1920-as években milliókat fektetett Fordlândia városába.", "A folyó a ritka Tapajós-folyamidelfin természetes élőhelye."],
      ro: ["Cursul principal are 800 km, iar sistemul total circa 1.900 km.", "Gura de vărsare de la Santarém depășește uneori 12 km în lățime.", "Bazinul hidrografic acoperă aproximativ 492.000 km pătrați.", "Plaja Alter do Chão a fost declarată una dintre cele mai frumoase din lume.", "Henry Ford a investit milioane de dolari în Fordlândia în anii 1920.", "Râul este habitatul specific pentru delfinul de râu Tapajós."],
      en: ["The main channel is 800 km long, the total system about 1,900 km.", "The mouth at Santarém is over 12 km wide in some places.", "Its drainage basin covers approximately 492,000 square km.", "Alter do Chão has been voted one of the most beautiful beaches in the world.", "Henry Ford invested millions in the town of Fordlândia in the 1920s.", "The river is home to the rare Tapajós river dolphin."],
      es: [],
      pt: [],
      fr: [],
    },
    description: {
      ...
      ro: "Râul Tapajós este cunoscut pentru apele sale cristaline și plajele cu nisip alb, fiind numit Caraibele Amazonului.",
      ...
      es: "El río Tapajós es conocido por sus aguas cristalinas y sus playas de arena. Es una parte esencial de la cuenca amazónica y un destino popular para el ecoturismo.",
      pt: "O Rio Tapajós é conhecido por suas águas claras e praias de areia. O rio é uma parte importante da região amazônica e um destino para o turismo de natureza.",
      fr: "Le Tapajós est réputé pour ses eaux claires et ses plages de sable. Le fleuve est un élément majeur du bassin amazonien et une destination pour le tourisme vert.",
    },
    facts: {
      ...
      es: ["Agua de río cristalina", "Playas de arena famosas", "Parte de la región amazónica"],
      pt: ["Águas claras do rio", "Praias de areia conhecidas", "Parte da região amazônica"],
      fr: ["Eau de rivière limpide", "Plages de sable réputées", "Fait partie de l'Amazonie"],
    }, image: "/poi-images/br-tapajos-river-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Rio Xingu este un afluent major al Amazonului în nordul Braziliei, având o lungime de aproximativ 1.980 de kilometri. Izvorăște din Podișul Mato Grosso și traversează bazinul amazonian înainte de a se vărsa în cursul principal la vest de insula Marajó. Râul este celebru pe plan internațional pentru Parcul Național Xingu, prima mare rezervație indigenă din Brazilia, creată în anii 1960 prin eforturile fraților Villas-Bôas. Această zonă protejează numeroase etnii indigene care și-au păstrat stilul de viață ancestral în inima junglei. Recent, râul a atras atenția globală din cauza construcției barajului Belo Monte, una dintre cele mai mari hidrocentrale din lume, proiect care a afectat drastic regimul hidrologic și biodiversitatea locală. Xingu este un ecosistem fragil, adăpostind specii endemice de pești și o avifaună extrem de bogată. Cursul inferior este marcat de meandre uriașe și o vegetație luxuriantă pe maluri. În ciuda presiunilor economice, lupta pentru conservarea Xingu-ului rămâne un simbol al rezistenței pentru drepturile indigenilor și protecția mediului.",
      en: "The Xingu River is a roughly 1,980-kilometer-long tributary of the Amazon in northern Brazil. Originating in the Mato Grosso Plateau, it flows through the Amazon Basin before joining the main stream west of Marajó Island. The river is globally recognized for the Xingu National Park, Brazil's first large-scale indigenous territory, established in the 1960s through the efforts of the Villas-Bôas brothers. This area is home to numerous indigenous tribes that have preserved their traditional ways of life. In recent years, the river gained international notoriety due to the construction of the Belo Monte Dam, one of the world's largest hydroelectric plants, which has significantly altered the water flow and local ecosystems. The Xingu is an ecologically sensitive area with many endemic fish species and rich birdlife. The lower reaches of the river are characterized by massive bends and lush riparian vegetation. Despite technological advances, the struggle to protect the Xingu remains a symbol of Amazon conservation and indigenous rights.",
    },
    factsAdvanced: {
      de: ["Gesamtlänge des Flusses beträgt ca. 1.980 km.", "Der Xingu-Nationalpark wurde offiziell 1961 gegründet.", "Belo Monte ist das viertgrößte Wasserkraftwerk der Welt.", "Im Flussgebiet leben mehr als 14 verschiedene indigene Gruppen.", "Der Fluss weist zahlreiche Stromschnellen auf seinem Weg auf.", "Das Einzugsgebiet umfasst etwa 511.000 Quadratkilometer."],
      hu: ["A folyó teljes hossza körülbelül 1980 km.", "A Xingu Nemzeti Parkot hivatalosan 1961-ben alapították.", "A Belo Monte a világ negyedik legnagyobb vízerőműve.", "A vízgyűjtő területén több mint 14 különböző indián törzs él.", "A folyó folyása során számos zúgó és vízesés található.", "Vízgyűjtő területe mintegy 511 000 négyzetkilométer."],
      ro: ["Lungimea totală a râului este de aproximativ 1.980 km.", "Parcul Național Xingu a fost înființat oficial în anul 1961.", "Belo Monte este a patra cea mai mare hidrocentrală din lume.", "În bazinul râului trăiesc peste 14 grupuri etnice indigene.", "Cursul râului prezintă numeroase praguri și cataracte naturale.", "Bazinul hidrografic acoperă circa 511.000 km pătrați."],
      en: ["The total length of the river is approximately 1,980 km.", "The Xingu National Park was officially established in 1961.", "Belo Monte is the fourth-largest hydroelectric dam in the world.", "More than 14 different indigenous groups live in the river basin.", "The river's course is marked by numerous rapids and waterfalls.", "The drainage basin covers approximately 511,000 square km."],
      es: [],
      pt: [],
      fr: [],
    },
    description: {
      ...
      ro: "Râul Xingu este faimos pentru prima rezervație indigenă majoră din Brazilia și complexul hidroelectric Belo Monte.",
      ...
      es: "El Xingu es un río destacado de la cuenca amazónica, estrechamente vinculado a áreas protegidas y territorios indígenas. Representa la diversidad ecológica del norte de Brasil.",
      pt: "O Xingu é um rio importante na bacia amazônica e está estreitamente ligado a áreas protegidas e terras indígenas. Representa a diversidade ecológica do norte do Brasil.",
      fr: "Le Xingu est une rivière majeure du bassin amazonien, étroitement liée aux zones protégées et aux territoires indigènes. Il incarne la diversité écologique du nord du Brésil.",
    },
    facts: {
      ...
      es: ["En la cuenca amazónica", "Vital para la biodiversidad", "Vinculado a territorios indígenas"],
      pt: ["Na bacia amazônica", "Importante para a biodiversidade", "Ligado a terras indígenas"],
      fr: ["Dans le bassin amazonien", "Crucial pour la biodiversité", "Lié aux territoires autochtones"],
    }, image: "/poi-images/br-xingu-river-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Râul Iguaçu, situat în sudul Braziliei, are o lungime de aproximativ 1.320 de kilometri și este faimos în întreaga lume pentru Cascadele de pe Iguaçu. Izvorăște din lanțul muntos Serra do Mar, lângă Curitiba, și curge spre vest traversând statul Paraná. Chiar înainte de a se vărsa în râul Paraná, cursul său se prăbușește peste o margine de bazalt lată de peste doi kilometri, formând un sistem de până la 275 de cascade individuale. Acest spectacol natural face parte din Patrimoniul Mondial UNESCO și atrage milioane de turiști anual. Debitul râului este reglat de mai multe baraje hidroelectrice construite în amonte, ceea ce poate afecta volumul de apă al cascadelor în perioadele secetoase. Parcurile naționale adiacente din Brazilia și Argentina protejează ultimele vestigii ale pădurii atlantice, un hotspot de biodiversitate. Jaguarul, coati și numeroase specii de orhidee trăiesc în acest mediu umed și luxuriant. Numele „Iguaçu” provine din limba guarani și înseamnă „apă mare”, o descriere perfectă pentru forța impresionantă a naturii de aici.",
      en: "The Iguazu River is a roughly 1,320-kilometer-long river in southern Brazil, world-renowned primarily for the Iguazu Falls. It rises in the Serra do Mar coastal range near Curitiba and flows westward through the state of Paraná. Just before its confluence with the Paraná River, it plunges over a basalt edge more than two miles wide, forming up to 275 individual waterfalls. These falls are a UNESCO World Heritage site and attract millions of visitors annually. The river's flow is regulated by several hydroelectric dams upstream, which can impact the natural water levels at the falls. The surrounding national parks in both Brazil and Argentina protect some of the last remains of the Atlantic Forest, hosting an enormous variety of species. Jaguars, coatis, and rare orchid species thrive in this humid, mist-shrouded environment. The name 'Iguazu' comes from the Guaraní language, meaning 'big water,' a fitting tribute to the immense power displayed at the falls.",
      es: "El río Iguazú es mundialmente conocido por las espectaculares cataratas en la frontera entre Brasil y Argentina, que se encuentran entre las más grandes del mundo. El sistema fluvial serpentea a través del bosque subtropical y forma una de las bellezas naturales más impresionantes de América del Sur. Las cataratas forman parte del Patrimonio Mundial de la UNESCO desde 1984. Geografía K7 – Sistemas fluviales y monumentos naturales.",
      pt: "O rio Iguaçu é mundialmente conhecido pelas espetaculares cataratas na fronteira entre o Brasil e a Argentina, que estão entre as maiores do mundo. O sistema fluvial serpenteia através da floresta subtropical e forma uma das belezas naturais mais impressionantes da América do Sul. As cataratas fazem parte do Patrimônio Mundial da UNESCO desde 1984. Geografia K7 – Sistemas fluviais e monumentos naturais.",
      fr: "Le fleuve Iguaçu est mondialement connu pour ses chutes spectaculaires à la frontière entre le Brésil et l'Argentine, qui comptent parmi les plus grandes au monde. Le système fluvial serpente à travers la forêt subtropicale et constitue l'une des beautés naturelles les plus impressionnantes d'Amérique du Sud. Les chutes sont inscrites au patrimoine mondial de l'UNESCO depuis 1984. Géographie K7 – Systèmes fluviaux et monuments naturels.",
    },
    factsAdvanced: {
      de: ["Länge des Flusses beträgt ca. 1.320 km.", "Die Fälle haben eine maximale Fallhöhe von etwa 82 Metern.", "Die durchschnittliche Abflussmenge beträgt 1.746 m³/s.", "Der brasilianische Iguaçu-Nationalpark wurde 1939 gegründet.", "Der Teufelsschlund (Garganta del Diablo) ist der höchste Wasserfall.", "Der Fluss bildet die Grenze zwischen Brasilien und Argentinien."],
      hu: ["A folyó hossza körülbelül 1320 km.", "A vízesések maximális magassága eléri a 82 métert.", "Átlagos vízhozama 1746 m³/s körüli.", "A brazil Iguaçu Nemzeti Parkot 1939-ben alapították.", "Az Ördögtorok (Garganta del Diablo) a legmagasabb szakasz.", "A folyó természetes határt képez Brazília és Argentína között."],
      ro: ["Lungimea râului este de aproximativ 1.320 km.", "Cascadele au o înălțime maximă de cădere de circa 82 de metri.", "Debitul mediu al râului este de 1.746 m³/s.", "Parcul Național Iguaçu din Brazilia a fost creat în 1939.", "Garganta del Diablo (Gâtlejul Diavolului) este cea mai înaltă cădere.", "Râul marchează granița naturală dintre Brazilia și Argentina."],
      en: ["The river's total length is approximately 1,320 km.", "The falls have a maximum drop of about 82 meters.", "The average water discharge is 1,746 cubic meters per second.", "The Brazilian Iguazu National Park was established in 1939.", "The Devil's Throat (Garganta del Diablo) is the tallest waterfall section.", "The river forms the border between Brazil and Argentina."],
      es: [],
      pt: [],
      fr: [],
    },
    description: {
      ...
      es: "El Iguazú es el río detrás de las famosas cataratas del Iguazú en la frontera con Argentina. Es uno de los paisajes naturales más conocidos del sur de Brasil.",
      pt: "O Iguaçu é o rio por trás das famosas Cataratas do Iguaçu, na fronteira com a Argentina. É uma das paisagens naturais mais conhecidas do sul do Brasil.",
      fr: "L'Iguaçu est le fleuve qui alimente les célèbres chutes d'Iguaçu à la frontière avec l'Argentine. C'est l'un des paysages naturels les plus connus du sud du Brésil.",
    },
    facts: {
      ...
      es: ["Forma las cataratas del Iguazú", "En la frontera con Argentina", "Famoso monumento natural"],
      pt: ["Forma as Cataratas do Iguaçu", "Na fronteira com a Argentina", "Famoso monumento natural"],
    ...
    }, image: "/poi-images/br-iguazu-river-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Cel mai înalt munte din Brazilia, adesea învăluit în ceață densă, lângă granița cu Venezuela.",
      en: "The highest mountain in Brazil, often shrouded in dense fog, near the Venezuelan border.",
      es: "La montaña más alta de Brasil, a menudo envuelta en una densa niebla, cerca de la frontera con Venezuela.",
      pt: "A montanha mais alta do Brasil, muitas vezes envolta em névoa densa, perto da fronteira com a Venezuela.",
      fr: "Le plus haut sommet du Brésil, souvent enveloppé de brume épaisse, près de la frontière avec le Venezuela.",
    },
    facts: {
      de: ["Er ist 2995 Meter hoch.", "Liegt tief im Amazonas-Regenwald."],
      ...
      es: ["Tiene 2995 metros de altura.", "Se encuentra en lo profundo de la selva amazónica."],
      pt: ["Tem 2995 metros de altitude.", "Localiza-se nas profundezas da floresta amazônica."],
      fr: ["Il culmine à 2995 mètres.", "Il est situé au cœur de la forêt amazonienne."],
    },
    descriptionAdvanced: {
      de: "Der Pico da Neblina ist mit einer Höhe von 2.995,30 Metern der höchste Berg Brasiliens. Er befindet sich im Norden des Landes, im Bundesstaat Amazonas, direkt an der Grenze zu Venezuela in der Serra do Imeri. Seinen Namen, der übersetzt „Nebelgipfel“ bedeutet, verdankt er der Tatsache, dass er fast das gesamte Jahr über in dichte Wolken gehüllt ist. Der Berg wurde erst 1953 entdeckt und 1965 zum ersten Mal bestiegen, da er tief im unwegsamen tropischen Regenwald versteckt liegt. Das Gebiet ist Teil des Pico da Neblina Nationalparks und gleichzeitig ein Territorium der Yanomami-Indigenen. Aufgrund der extremen Abgeschiedenheit und der schwierigen klimatischen Bedingungen ist der Aufstieg eine logistische Herausforderung, die Genehmigungen und erfahrene Führer erfordert. Die Flora am Berg weist viele endemische Arten auf, die an die hohen Niederschlagsmengen und die kühleren Temperaturen in der Gipfelregion angepasst sind. Wissenschaftlich ist der Berg von großer Bedeutung für die Erforschung der Evolution isolierter Ökosysteme auf den Tepuis Südamerikas.",
      hu: "A Pico da Neblina 2995,30 méteres magasságával Brazília legmagasabb hegycsúcsa. Az ország északi részén, Amazonas államban található, közvetlenül a venezuelai határ mellett, a Serra do Imeri hegységben. Neve, amely magyarul „Ködcsúcsot” jelent, arra utal, hogy az év nagy részében sűrű felhőzet borítja. A hegyet csak 1953-ban fedezték fel, és 1965-ben mászták meg először, mivel mélyen az áthatolhatatlan trópusi esőerdőben rejtőzik. A terület a Pico da Neblina Nemzeti Park része, és egyben a janomami őslakosok területe is. A rendkívüli elszigeteltség és a nehéz éghajlati viszonyok miatt a megmászása komoly logisztikai kihívást jelent, amelyhez külön engedélyek és tapasztalt vezetők szükségesek. A hegy növényvilága számos endemikus fajt tartalmaz, amelyek alkalmazkodtak a bőséges csapadékhoz és a csúcsközeli hűvösebb hőmérséklethez. Tudományos szempontból a hegy kiemelt jelentőségű a dél-amerikai táblahegyek (tepuik) izolált ökoszisztémáinak kutatása miatt.",
      ro: "Pico da Neblina este cel mai înalt punct din Brazilia, atingând o altitudine de 2.995,30 metri. Situat în nordul țării, în statul Amazonas, acesta se află chiar pe granița cu Venezuela, în lanțul muntos Serra do Imeri. Numele său, care se traduce prin „Vârful de Ceață”, provine de la faptul că este acoperit de nori denși în majoritatea timpului. Muntele a fost descoperit târziu, în 1953, și escaladat prima dată abia în 1965, fiind ascuns adânc în jungla tropicală inaccesibilă. Zona face parte din Parcul Național Pico da Neblina și se suprapune cu teritoriul indigen al tribului Yanomami. Din cauza izolării extreme și a condițiilor climatice dificile, expedițiile pe acest vârf sunt provocări logistice majore, necesitând permise speciale și ghizi experimentați. Flora de pe munte include numeroase specii endemice, adaptate la precipitațiile constante și temperaturile scăzute de la înălțime. Din punct de vedere științific, vârful oferă date prețioase despre evoluția ecosistemelor izolate pe platourile muntoase numite „tepui”.",
      en: "Pico da Neblina is the highest peak in Brazil, reaching an elevation of 2,995.30 meters. Located in the northern part of the country in Amazonas state, it sits right on the border with Venezuela within the Serra do Imeri range. Its name, which translates to 'Mist Peak,' refers to the fact that it is shrouded in dense clouds for most of the year. The mountain was discovered as late as 1953 and first climbed in 1965, as it is hidden deep within the inaccessible tropical rainforest. The area is part of the Pico da Neblina National Park and overlaps with the Yanomami indigenous territory. Due to extreme isolation and harsh climatic conditions, climbing the peak is a major logistical challenge requiring special permits and experienced guides. The flora on the mountain features many endemic species adapted to the high rainfall and cooler temperatures near the summit. Scientifically, the peak is significant for studying the evolution of isolated ecosystems on South American tepuis.",
      es: "Pico da Neblina es un elemento notable de la geografía y cultura brasileña. Es la montaña más alta de Brasil, a menudo envuelta en una densa niebla, cerca de la frontera con Venezuela. Tiene 2995 metros de altura. Se encuentra en lo profundo de la selva amazónica. Este paraje natural muestra la diversidad paisajística de Brasil, desde la región amazónica hasta el Pantanal y el Cerrado. Como muchos lugares significativos en Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil polifacético de Brasil, donde se entrelazan la naturaleza tropical, la herencia portuguesa, el samba, el fútbol y el carnaval.",
      pt: "O Pico da Neblina é um elemento notável da geografia e cultura brasileiras. A montanha mais alta do Brasil, muitas vezes envolta em névoa densa, perto da fronteira com a Venezuela. Tem 2995 metros de altitude. Localiza-se no coração da floresta amazônica. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Le Pico da Neblina est un élément remarquable de la géographie et de la culture brésiliennes. C'est le plus haut sommet du Brésil, souvent enveloppé de brumes denses, près de la frontière vénézuélienne. Il culmine à 2995 mètres. Il est situé au cœur de la forêt amazonienne. Cet espace naturel illustre la diversité des paysages du Brésil, de la région amazonienne au Pantanal en passant par le Cerrado. Comme de nombreux sites importants au Brésil, ce lieu conjugue des particularités régionales avec l'importance globale du cinquième plus grand pays du monde. Ce site contribue ainsi au profil aux multiples facettes du Brésil, où se mêlent nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Offizielle Höhe beträgt 2.995,30 Meter über dem Meeresspiegel.", "Der Berg liegt im größten Nationalpark Brasiliens (2,2 Mio. Hektar).", "Die Erstbesteigung erfolgte am 30. März 1965.", "Der Gipfel ist an ca. 300 Tagen im Jahr wolkenverhangen.", "Es herrscht ein tropisches Gebirgsklima mit viel Regen.", "Der Berg gehört geologisch zum Guayana-Schild."],
      hu: ["Hivatalos magassága 2995,30 méter a tengerszint felett.", "Brazília legnagyobb nemzeti parkjában található (2,2 millió hektár).", "Az első dokumentált megmászás 1965. március 30-án történt.", "A csúcsot az év kb. 300 napján felhő takarja.", "Trópusi hegyvidéki éghajlat jellemzi, rengeteg esővel.", "Földtanilag a Guyanai-pajzshoz tartozik a hegy."],
      ro: ["Înălțimea oficială este de 2.995,30 metri deasupra mării.", "Se află în cel mai mare parc național din Brazilia (2,2 mil. hectare).", "Prima escaladare a avut loc pe data de 30 martie 1965.", "Vârful este acoperit de nori aproximativ 300 de zile pe an.", "Clima este montană tropicală, cu precipitații foarte ridicate.", "Geologic, muntele face parte din Scutul Guianez."],
      en: ["The official height is 2,995.30 meters above sea level.", "It is located in Brazil's largest national park (2.2 million hectares).", "The first recorded ascent took place on March 30, 1965.", "The summit is shrouded in clouds about 300 days a year.", "The climate is tropical highland with very high rainfall.", "Geologically, the mountain is part of the Guiana Shield."],
      es: ["La montaña más alta de Brasil, a menudo envuelta en densa niebla, cerca de la frontera con Venezuela.", "Situado en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado a la vida cotidiana y a la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["A montanha mais alta do Brasil, muitas vezes envolta em névoa densa, perto da fronteira com a Venezuela.", "Localizado no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligado ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-pico-da-neblina-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Cel mai înalt vârf din statul Rio de Janeiro, cu ace stâncoase negre distinctive.",
      en: "The highest peak in the state of Rio de Janeiro, featuring distinctive black rock needles.",
      es: "El pico más alto del estado de Río de Janeiro, con llamativas agujas de roca negra.",
      pt: "O pico mais alto do estado do Rio de Janeiro, com agulhas de rocha negra marcantes.",
      fr: "Le plus haut sommet de l'État de Rio de Janeiro, caractérisé par ses impressionnantes aiguilles de roche noire.",
    },
    facts: {
      de: ["Teil des Itatiaia-Nationalparks.", "Im Winter kann es hier Frost geben."],
      hu: ["Az Itatiaia Nemzeti Park része.", "Télen itt fagy is előfordulhat."],
      ro: ["Face parte din Parcul Național Itatiaia.", "Aici poate apărea înghețul în timpul iernii."],
      en: ["Part of the Itatiaia National Park.", "Frost can occur here during the winter."],
      es: ["Parte del Parque Nacional de Itatiaia.", "En invierno puede haber heladas aquí."],
      pt: ["Parte do Parque Nacional do Itatiaia.", "No inverno, pode haver geada aqui."],
      fr: ["Fait partie du parc national d'Itatiaia.", "Il peut y avoir du gel en hiver."],
    },
    descriptionAdvanced: {
      de: "Der Pico das Agulhas Negras ist mit 2.791 Metern der fünfthöchste Gipfel Brasiliens und das markanteste Wahrzeichen des Itatiaia-Nationalparks, des ältesten Nationalparks des Landes. Er liegt in der Serra da Mantiqueira an der Grenze zwischen den Bundesstaaten Rio de Janeiro und Minas Gerais. Sein Name bedeutet „Gipfel der schwarzen Nadeln“ und bezieht sich auf die markanten, vertikalen Felsformationen aus dunklem Alkaligestein, die den Gipfel krönen. Diese ungewöhnliche Geologie macht ihn zu einem beliebten Ziel für Bergsteiger und Kletterer aus ganz Südostbrasilien. Das Klima in dieser Höhe ist für brasilianische Verhältnisse außergewöhnlich kühl; im Winter fallen die Temperaturen häufig unter den Gefrierpunkt, und gelegentlich kommt es sogar zu Schneefall. Die Vegetation wird von alpinen Gräsern und Sträuchern dominiert, die in den Spalten der massiven Granitblöcke überleben. Der Aufstieg zum Gipfel bietet spektakuläre Ausblicke über das Paraíba-Tal und ist ein wichtiger Bestandteil der regionalen Biodiversitätsforschung.",
      hu: "A Pico das Agulhas Negras 2791 méteres magasságával Brazília ötödik legmagasabb hegycsúcsa, és az ország legrégebbi nemzeti parkjának, az Itatiaia Nemzeti Parknak a legfőbb látványossága. A Serra da Mantiqueira hegységben található, Rio de Janeiro és Minas Gerais államok határán. Neve „Fekete Tűk csúcsát” jelenti, ami a csúcsot koronázó jellegzetes, függőleges, sötét alkáli kőzetekből álló sziklaformációkra utal. Ez a szokatlan geológiai felépítés Délkelet-Brazília egyik legnépszerűbb hegymászó- és sziklamászó célpontjává teszi. Az éghajlat ebben a magasságban brazil viszonylatban rendkívül hűvös; télen a hőmérséklet gyakran fagypont alá süllyed, és alkalmanként havazás is előfordulhat. A növényzetet alpesi füvek és cserjék dominálják, amelyek a hatalmas gránittömbök repedéseiben kapaszkodnak meg. A csúcsra vezető út lenyűgöző kilátást nyújt a Paraíba-völgyre, és fontos helyszíne a régió biodiverzitási kutatásainak.",
      ro: "Pico das Agulhas Negras, cu o înălțime de 2.791 de metri, este al cincilea cel mai înalt vârf din Brazilia și punctul central al Parcului Național Itatiaia, cea mai veche arie protejată din țară. Situat în lanțul muntos Serra da Mantiqueira, acesta marchează granița dintre statele Rio de Janeiro și Minas Gerais. Numele său înseamnă „Vârful Acatelor Negre” și face referire la formațiunile stâncoase verticale din rocă alcalină închisă la culoare care domină creasta. Această geologie neobișnuită îl transformă într-o destinație favorită pentru alpiniști și pasionații de trekking din sud-estul Braziliei. Clima la această altitudine este neobișnuit de rece pentru Brazilia; în timpul iernii, temperaturile coboară frecvent sub zero grade Celsius, fiind înregistrate ocazional și căderi de zăpadă. Vegetația este compusă din pajiști alpine și arbuști rezistenți care cresc în crăpăturile blocurilor masive de granit. Ascensiunea spre vârf oferă panorame spectaculoase asupra Văii Paraíba și este esențială pentru studiul biodiversității montane.",
      en: "Pico das Agulhas Negras, at 2,791 meters, is Brazil's fifth-highest peak and the center-piece of Itatiaia National Park, the country's oldest national park. Located in the Serra da Mantiqueira range, it straddles the border between the states of Rio de Janeiro and Minas Gerais. Its name means 'Peak of the Black Needles,' referring to the distinctive vertical formations of dark alkaline rock that crown the summit. This unusual geology makes it a premier destination for mountaineers and rock climbers from across southeastern Brazil. The climate at this altitude is exceptionally cool by Brazilian standards; in winter, temperatures frequently drop below freezing, and occasional snowfall has been recorded. The vegetation is dominated by alpine grasses and shrubs that survive in the crevices of massive granite boulders. The ascent to the summit provides spectacular views over the Paraíba Valley and is a key site for regional biodiversity research.",
      es: "Pico das Agulhas Negras es un elemento notable de la geografía y cultura brasileña. Es el pico más alto del estado de Río de Janeiro, con llamativas agujas de roca negra. Forma parte del Parque Nacional de Itatiaia. En invierno puede haber heladas aquí. Este paraje natural muestra la diversidad paisajística de Brasil, desde la región amazónica hasta el Pantanal y el Cerrado. Como muchos lugares significativos en Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil polifacético de Brasil, donde se entrelazan la naturaleza tropical, la herencia portuguesa, el samba, el fútbol y el carnaval.",
      pt: "O Pico das Agulhas Negras é um elemento notável da geografia e cultura brasileiras. O pico mais alto do estado do Rio de Janeiro, com agulhas de rocha negra marcantes. Parte do Parque Nacional do Itatiaia. No inverno, pode haver geada aqui. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Le Pico das Agulhas Negras est un élément remarquable de la géographie et de la culture brésiliennes. C'est le plus haut sommet de l'État de Rio de Janeiro, avec ses remarquables aiguilles de roche noire. Il fait partie du parc national d'Itatiaia. En hiver, le gel peut y faire son apparition. Cet espace naturel illustre la diversité des paysages du Brésil, de la région amazonienne au Pantanal en passant par le Cerrado. Comme de nombreux sites importants au Brésil, ce lieu conjugue des particularités régionales avec l'importance globale du cinquième plus grand pays du monde. Ce site contribue ainsi au profil aux multiples facettes du Brésil, où se mêlent nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Gipfelhöhe beträgt 2.791 Meter.", "Der Itatiaia-Nationalpark wurde 1937 gegründet.", "Der Berg besteht primär aus Syenit, einem Tiefengestein.", "Im Jahr 1985 wurde einer der stärksten Schneefälle dokumentiert.", "Der Aufstieg dauert je nach Route 6 bis 8 Stunden.", "Die Basisstation liegt auf ca. 2.450 Metern Höhe."],
      hu: ["A csúcs magassága 2791 méter.", "Az Itatiaia Nemzeti Parkot 1937-ben alapították.", "A hegy főleg szienitből, egy mélységi magmás kőzetből áll.", "1985-ben dokumentálták az egyik legnagyobb havazást a csúcson.", "A feljutás útvonaltól függően 6-8 órát vesz igénybe.", "A túrák bázisállomása kb. 2450 méteres magasságban található."],
      ro: ["Vârful are o altitudine de 2.791 de metri.", "Parcul Național Itatiaia a fost înființat în anul 1937.", "Muntele este format preponderent din sienit, o rocă plutonică.", "În 1985 s-a înregistrat una dintre cele mai mari ninsori din istorie.", "Ascensiunea durează între 6 și 8 ore, în funcție de traseu.", "Punctul de plecare pentru turiști se află la circa 2.450 m altitudine."],
      en: ["The peak reaches a height of 2,791 meters.", "Itatiaia National Park was established in 1937.", "The mountain is primarily composed of syenite, a plutonic rock.", "One of the most significant snowfalls was recorded here in 1985.", "The climb to the summit takes between 6 to 8 hours depending on route.", "The high-altitude base station is located at about 2,450 meters."],
      es: ["El pico más alto del estado de Río de Janeiro con llamativas agujas de roca negra.", "Situado en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado a la vida cotidiana y a la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["O pico mais alto do estado do Rio de Janeiro com agulhas de rocha negra marcantes.", "Localizado no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligado ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-pico-das-agulhas-negras-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Muntele Roraima este cel mai faimos dintre tepuis, munții tabulari din Podișul Guayanei, situat la granița triplă dintre Brazilia, Venezuela și Guyana. Cu o altitudine de 2810 metri, acesta reprezintă o relicvă geologică din Precambrian, fiind format din gresie veche de aproximativ două miliarde de ani. Pereții săi aproape verticali se ridică deasupra pădurii tropicale, protejând un platou vast unde evoluția izolată a creat o floră și faună unice, cu numeroase specii endemice. Muntele a fost urcat pentru prima dată în 1884 de exploratorul britanic Everard im Thurn și a servit drept inspirație pentru celebrul roman 'O lume pierdută' al lui Sir Arthur Conan Doyle. În mitologia indigenilor Pemon, muntele este considerat trunchiul unui arbore gigantic care odinioară susținea toate fructele și legumele lumii. Condițiile meteorologice extreme de pe vârf generează ploi frecvente și cascade spectaculoase care se revarsă peste marginile abrupte.",
      en: "Mount Roraima is the most prominent of the tepuis, or table-top mountains, located in the Guiana Highlands at the triple border of Brazil, Venezuela, and Guyana. Reaching an elevation of 2,810 meters, it is a geological relic from the Precambrian era, composed of sandstone approximately two billion years old. Its nearly vertical cliffs rise 400 meters above the surrounding terrain, enclosing a vast plateau that hosts a unique ecosystem with numerous endemic species, including carnivorous plants and the Roraima bush toad. The mountain was first climbed in 1884 by Sir Everard im Thurn, an expedition that famously inspired Arthur Conan Doyle's novel 'The Lost World.' To the local Pemon indigenous people, Roraima is seen as the stump of a mighty tree that once held all the world's fruits and tubers. The summit experiences extreme weather with heavy rainfall, leading to the formation of spectacular ephemeral waterfalls cascading down its sheer stone faces.",
      es: "El Monte Roraima es un tepuy en la frontera de Brasil, Venezuela y Guyana, y pertenece a las formaciones geológicas más antiguas de la Tierra. Su característica cima plana y sus paredes de roca verticales albergan una gran variedad de especies de plantas endémicas que no existen en ningún otro lugar. Es una maravilla geológica y un importante centro de investigación.",
      pt: "O Monte Roraima é um monte de topo plano na fronteira de Brasil, Venezuela e Guiana e pertence às formações geológicas mais antigas da Terra. Sua forma de cume plano e paredes rochosas íngremes abrigam uma variedade de espécies de plantas endêmicas que não existem em nenhum outro lugar. É uma maravilha geológica e um importante local de pesquisa.",
      fr: "Le Mont Roraima est un tepuy situé à la frontière du Brésil, du Venezuela et de la Guyane, et compte parmi les plus anciennes formations géologiques de la Terre. Son sommet plat caractéristique et ses parois rocheuses abruptes abritent une multitude d'espèces végétales endémiques que l'on ne trouve nulle part ailleurs. C'est une merveille géologique et un site de recherche important.",
    },
    factsAdvanced: {
      de: ["Höhe des Gipfels beträgt 2810 Meter über dem Meeresspiegel", "Besteht aus etwa 2 Milliarden Jahre altem präkambrischem Gestein", "Erste dokumentierte Besteigung erfolgte im Jahr 1884", "Das Gipfelplateau umfasst eine Fläche von etwa 31 Quadratkilometern", "Etwa 35 Prozent der dortigen Pflanzenarten sind endemisch", "Diente als Vorlage für den Roman 'Die vergessene Welt'"],
      hu: ["A hegy legmagasabb pontja 2810 méterrel van a tengerszint felett", "Kőzetei a prekambriumból származnak, koruk 2 milliárd év", "Everard im Thurn brit kutató mászta meg először 1884-ben", "A fennsík területe körülbelül 31 négyzetkilométert tesz ki", "A hegyen található növények 35%-a sehol máshol nem él", "Inspirációként szolgált Sir Arthur Conan Doyle híres regényéhez"],
      ro: ["Altitudinea maximă a muntelui este de 2810 metri", "Formațiunile de gresie au o vechime de circa 2 miliarde de ani", "Prima ascensiune documentată a avut loc în anul 1884", "Platoul sommital are o suprafață de aproximativ 31 km pătrați", "Circa 35% din speciile de plante de pe vârf sunt endemice", "A inspirat locația pentru romanul 'O lume pierdută' de Conan Doyle"],
      en: ["The mountain's highest point reaches 2,810 meters", "Formed from Precambrian sandstone dating back 2 billion years", "Sir Everard im Thurn completed the first recorded ascent in 1884", "The summit plateau covers an area of approximately 31 square km", "About 35% of the plant species found on top are endemic", "It inspired the setting for the 1912 novel 'The Lost World'"],
      es: ["Tepuy (cima plana)", "Punto fronterizo (Brasil, Ven, Guy)", "Geológicamente muy antiguo", "Gran número de especies endémicas", "Paredes de roca verticales", "Forma de cima plana distintiva"],
      pt: ["Tepui (monte de topo plano)", "Ponto de fronteira (Brasil, Ven, Guy)", "Geologicamente muito antigo", "Alto número de espécies endêmicas", "Paredes rochosas íngremes", "Forma de cume plano marcante"],
      fr: ["Tepuy (sommet plat)", "Point frontalier (Brésil, Ven, Guy)", "Géologiquement très ancien", "Nombre élevé d'espèces endémiques", "Parois rocheuses abruptes", "Forme de sommet plat remarquable"],
    }, image: "/poi-images/br-mount-roraima-nature-v2.webp",
    description: {
      ...
      ro: "Muntele Roraima este un munte masiv de tip tepui, situat la granița dintre Brazilia, Venezuela și Guyana.",
      ...
      es: "El Monte Roraima es un imponente tepuy en la frontera de Brasil, Venezuela y Guyana. Sus paredes verticales y su ubicación remota lo convierten en un espacio natural único.",
      pt: "O Monte Roraima é um monte de topo plano marcante na fronteira de Brasil, Venezuela e Guiana. Suas paredes íngremes e localização remota o tornam uma área natural especial.",
      fr: "Le Mont Roraima est un tepuy remarquable à la frontière du Brésil, du Venezuela et de la Guyane. Ses parois abruptes et son emplacement reculé en font un espace naturel exceptionnel.",
    },
    facts: {
      ...
      ro: ["Vârstă geologică de 2 miliarde de ani", "Vârf plat înconjurat de stânci abrupte", "A inspirat romanul Lumea Pierdută"],
      en: ["On the Brazil border region", "Flat-topped tepui mountain", "Known for unique ecosystems", "Part of the Guiana Highlands"],
      es: ["Tepuy en la frontera", "Entre tres países", "Conocido por especies endémicas"],
      pt: ["Monte de topo plano na fronteira", "Entre três países", "Conhecido por espécies endêmicas"],
      fr: ["Tepuy à la frontière", "Entre trois pays", "Connu pour ses espèces endémiques"],
    }
  },
  {
    ...
    description: {
      ...
      ro: "Al treilea cel mai înalt munte din Brazilia, o destinație populară pentru alpiniști la răsărit.",
      en: "The third highest mountain in Brazil, a popular destination for climbers at sunrise.",
      es: "La tercera montaña más alta de Brasil, un destino popular para que los montañistas vean el amanecer.",
      pt: "A terceira montanha mais alta do Brasil, um destino popular para montanhistas ao nascer do sol.",
      fr: "La troisième plus haute montagne du Brésil, une destination prisée des alpinistes pour le lever du soleil.",
    },
    facts: {
      de: ["Liegt im Caparaó-Nationalpark.", "Der Name bedeutet Gipfel der Flagge."],
      ...
      es: ["Situado en el Parque Nacional del Caparaó.", "El nombre significa Pico de la Bandera."],
      pt: ["Localizado no Parque Nacional do Caparaó.", "O nome significa Pico da Bandeira."],
      fr: ["Situé dans le parc national du Caparaó.", "Le nom signifie Pic du Drapeau."],
    },
    descriptionAdvanced: {
      de: "Der Pico da Bandeira ist mit 2891 Metern der dritthöchste Berg Brasiliens und liegt an der Grenze zwischen den Bundesstaaten Espírito Santo und Minas Gerais. Er befindet sich im Caparaó-Nationalpark, der 1961 zum Schutz der atlantischen Regenwald-Ökosysteme in der Hochgebirgsregion gegründet wurde. Seinen Namen erhielt der Gipfel im 19. Jahrhundert von Kaiser Dom Pedro II., der anordnete, an der höchsten Stelle des Landes eine Flagge zu hissen. Lange Zeit galt er fälschlicherweise als der höchste Punkt Brasiliens, bis in den 1960er Jahren die Gipfel im Norden an der Grenze zu Venezuela vermessen wurden. Der Aufstieg ist aufgrund gut markierter Wege technisch unkompliziert und bietet Wanderern einen weiten Blick über die Gebirgskette Serra do Caparaó. Die Region ist bekannt für ihr kühles Klima, wobei im Winter Temperaturen unter dem Gefrierpunkt und gelegentlich sogar Frost auftreten können.",
      hu: "A Pico da Bandeira Brazília harmadik legmagasabb hegycsúcsa, amely 2891 méteres magasságával Espírito Santo és Minas Gerais államok határán helyezkedik el. A hegy a Caparaó Nemzeti Park területén található, amelyet 1961-ben hoztak létre a régió magashegyi ökoszisztémáinak és atlanti esőerdőinek védelmében. Nevét a 19. században kapta II. Péter brazil császártól, aki elrendelte, hogy az ország akkori legmagasabbnak hitt pontján tűzzék ki a nemzeti lobogót. Évtizedekig tartotta magát az a tévhit, hogy ez Brazília legmagasabb pontja, amíg az 1960-as években pontos mérésekkel fel nem fedezték az északi határ menti csúcsokat. A hegy viszonylag könnyen megmászható, a kijelölt túraútvonalak népszerűek a látogatók körében, akik a Serra do Caparaó vonulataira nyíló kilátás miatt érkeznek ide. A csúcson télen gyakori a fagy, ami szokatlan jelenség a trópusi éghajlatú országban.",
      ro: "Pico da Bandeira este al treilea cel mai înalt vârf din Brazilia, atingând o altitudine de 2891 de metri la granița dintre statele Espírito Santo și Minas Gerais. Muntele face parte din Parcul Național Caparaó, înființat în 1961 pentru a proteja ecosistemele montane și porțiunile de pădure atlantică din această regiune. Numele său a fost dat în secolul al XIX-lea de împăratul Dom Pedro al II-lea, care a ordonat arborarea drapelului național pe ceea ce se considera atunci cel mai înalt punct al țării. Până în anii 1960, Pico da Bandeira a fost considerat oficial cel mai înalt vârf brazilian, titlu pierdut în favoarea vârfurilor din nordul extrem, lângă Venezuela. Traseele de ascensiune sunt bine marcate și accesibile turiștilor, oferind panorame spectaculoase asupra lanțului muntos Serra do Caparaó. Climatul este neobișnuit de rece pentru Brazilia, în timpul iernii înregistrându-se frecvent temperaturi sub zero grade și îngheț.",
      en: "Pico da Bandeira is Brazil's third highest mountain, standing at 2,891 meters on the border between the states of Espírito Santo and Minas Gerais. It is located within the Caparaó National Park, established in 1961 to preserve the high-altitude Atlantic Forest ecosystems of the region. The peak received its name in the mid-19th century from Emperor Dom Pedro II, who ordered the national flag to be raised at what was then believed to be the highest point in Brazil. It held the title of the nation's tallest summit until the 1960s, when modern surveys identified higher peaks along the northern border with Venezuela. The mountain is a popular hiking destination with well-defined trails that offer expansive views of the Serra do Caparaó range. Due to its significant elevation, the summit area experiences a microclimate with freezing temperatures and frost common during the winter months.",
      es: "Pico da Bandeira es un elemento notable de la geografía y cultura brasileña. Es la tercera montaña más alta de Brasil y un destino popular para los montañistas al amanecer. Se encuentra en el Parque Nacional del Caparaó. El nombre significa Pico de la Bandera. Este paraje natural muestra la diversidad paisajística de Brasil, desde la región amazónica hasta el Pantanal y el Cerrado. Como muchos lugares significativos en Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil polifacético de Brasil, donde se entrelazan la naturaleza tropical, la herencia portuguesa, el samba, el fútbol y el carnaval.",
      pt: "O Pico da Bandeira é um elemento notável da geografia e cultura brasileiras. A terceira montanha mais alta do Brasil, um destino popular para montanhistas ao nascer do sol. Localiza-se no Parque Nacional do Caparaó. O nome significa Pico da Bandeira. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Le Pico da Bandeira est un élément remarquable de la géographie et de la culture brésiliennes. C'est la troisième plus haute montagne du Brésil, une destination populaire pour les alpinistes au lever du soleil. Il est situé dans le parc national du Caparaó. Son nom signifie Pic du Drapeau. Cet espace naturel illustre la diversité des paysages du Brésil, de la région amazonienne au Pantanal en passant par le Cerrado. Comme de nombreux sites importants au Brésil, ce lieu conjugue des particularités régionales avec l'importance globale du cinquième plus grand pays du monde. Ce site contribue ainsi au profil aux multiples facettes du Brésil, où se mêlent nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Die offizielle Höhe des Berges beträgt 2891 Meter", "Liegt auf der Grenze von Espírito Santo und Minas Gerais", "Der Caparaó-Nationalpark wurde im Jahr 1961 gegründet", "Benannt nach einer Anweisung von Kaiser Dom Pedro II.", "Galt bis in die 1960er Jahre als höchster Punkt Brasiliens", "Im Winter können die Temperaturen auf bis zu -10°C sinken"],
      hu: ["A hegy hivatalos magassága 2891 méter a tengerszint felett", "Espírito Santo és Minas Gerais államok határán fekszik", "A környező nemzeti parkot 1961-ben alapították meg", "II. Péter császár adományozta a hegy nevét a 19. században", "Az 1960-as évekig Brazília legmagasabb hegyének tartották", "A téli időszakban rendszeresen fagypont alá süllyed a hőmérséklet"],
      ro: ["Altitudinea oficială a vârfului este de 2891 de metri", "Se află la granița statelor Espírito Santo și Minas Gerais", "Parcul Național Caparaó a fost stabilit în anul 1961", "Numele provine de la ordinul împăratului Dom Pedro al II-lea", "A fost considerat cel mai înalt punct al Braziliei până în 1960", "Temperaturile pot scădea sub pragul de îngheț în timpul iernii"],
      en: ["The official height of the peak is 2,891 meters", "It marks the border between Espírito Santo and Minas Gerais", "The Caparaó National Park was established in 1961", "Named following a decree by Emperor Dom Pedro II", "Held the record for Brazil's highest point until the 1960s", "Winter temperatures at the summit can drop below 0°C"],
      es: ["La tercera montaña más alta de Brasil, un destino popular para montañistas al amanecer.", "Situado en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado a la vida cotidiana y a la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["A terceira montanha mais alta do Brasil, um destino popular para montanhistas ao nascer do sol.", "Localizado no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligado ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-pico-da-bandeira-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "O stâncă de granit proeminentă la gura golfului Guanabara, unul dintre reperele din Rio.",
      en: "A prominent granite peak at the mouth of Guanabara Bay, one of Rio's landmarks.",
      es: "Una prominente roca de granito situada en la desembocadura de la bahía de Guanabara, uno de los hitos más famosos de Río de Janeiro.",
      pt: "Um imponente rochedo de granito situado na foz da Baía de Guanabara, um dos marcos mais famosos do Rio de Janeiro.",
      fr: "Un rocher de granit imposant situé à l'embouchure de la baie de Guanabara, l'un des emblèmes de Rio de Janeiro.",
    },
    facts: {
      de: ["Eine Seilbahn bringt Besucher auf den Gipfel.", "Bietet einen Panoramablick auf die Stadt."],
      ...
      es: ["Un teleférico lleva a los visitantes a la cima.", "Ofrece una vista panorámica de la ciudad."],
      pt: ["Um bondinho leva os visitantes ao topo.", "Oferece uma vista panorâmica da cidade."],
      fr: ["Un téléphérique emmène les visiteurs au sommet.", "Offre une vue panoramique sur la ville."],
    },
    descriptionAdvanced: {
      de: "Der Zuckerhut (Pão de Açúcar) ist ein ikonischer Granitfelsen, der sich 396 Meter über die Guanabara-Bucht in Rio de Janeiro erhebt. Der Berg besteht aus Gneis und Granit und entstand vor etwa 600 Millionen Jahren durch geologische Prozesse im Rahmen der Kontinentalverschiebung. Sein Name leitet sich von der traditionellen Form eines Zuckerhutes ab, in der raffinierter Zucker im 16. und 17. Jahrhundert gelagert wurde. Seit 1912 ist der Gipfel durch eine Seilbahn, den 'Bondinho', erschlossen, die eine der ersten ihrer Art weltweit war und heute jährlich Millionen von Besuchern anzieht. Der Berg ist Teil eines Ensembles, das 2012 von der UNESCO zum Weltkulturerbe unter dem Titel 'Rio de Janeiro: Carioca-Landschaften zwischen Bergen und Meer' erklärt wurde. Neben seiner touristischen Bedeutung ist der Zuckerhut ein weltbekanntes Ziel für Kletterer mit zahlreichen Routen an seinen steilen Wänden.",
      hu: "A Cukorsüveg-hegy (Pão de Açúcar) Rio de Janeiro egyik legismertebb jelképe, amely 396 méter magasan magasodik a Guanabara-öböl fölé. A hegy anyaga pre-kambriumi gneisz és gránit, amely körülbelül 600 millió évvel ezelőtt alakult ki a tektonikus lemezek mozgása során. Nevét a 16-17. században használt cukorsüvegek formájáról kapta, amelyekben a finomított cukrot tömbösítették és szállították. 1912-ben adták át az első drótkötélpályát (Bondinho), amely a világ egyik legrégebbi ilyen jellegű turisztikai eszköze, és azóta is folyamatosan üzemel modernizált formában. A hegy 2012 óta az UNESCO Világörökség részét képezi a Rio de Janeiro-i kultúrtáj elemeként. A turisták mellett a hegy a sziklamászók körében is rendkívül népszerű, falain több mint 270 különböző nehézségi fokú útvonalat tartanak számon.",
      ro: "Muntele Sugarloaf (Pão de Açúcar) este un monolitic de granit situat în Rio de Janeiro, la gura de vărsare a golfului Guanabara în Oceanul Atlantic. Ridicându-se la o înălțime de 396 de metri, formațiunea este compusă din gneis și granit, având o vechime de peste 600 de milioane de ani. Denumirea sa provine de la asemănarea cu forma tradițională de 'pâine de zahăr' utilizată pentru transportul zahărului rafinat în secolele al XVI-lea și al XVII-lea. Un sistem de telecabină, cunoscut sub numele de 'Bondinho', a fost inaugurat în 1912, fiind unul dintre primele de acest gen din lume și rămânând până astăzi o atracție turistică majoră. În 2012, muntele a fost inclus pe lista Patrimoniului Mondial UNESCO ca parte a peisajelor culturale din Rio de Janeiro. Sugarloaf este, de asemenea, un punct de reper global pentru alpinism, oferind sute de trasee pe fețele sale abrupte.",
      en: "Sugarloaf Mountain (Pão de Açúcar) is an iconic peak situated at the mouth of Guanabara Bay in Rio de Janeiro, rising 396 meters above the Atlantic Ocean. This granite and gneiss monolith was formed roughly 600 million years ago through tectonic activity during the Precambrian period. Its name dates back to the 16th century, referring to the conical shape of 'sugarloaves' used to transport refined sugar by sea. The summit was made accessible to the public in 1912 with the opening of a cable car system, the 'Bondinho,' which was one of the first of its kind globally and has since carried millions of passengers. In 2012, the mountain was designated a UNESCO World Heritage site as part of Rio's cultural landscape. Beyond tourism, Sugarloaf is a world-class destination for rock climbing, featuring over 270 established routes across its steep, smooth stone faces.",
      es: "El Pan de Azúcar es un elemento notable de la geografía y la cultura brasileñas. Esta prominente roca de granito en la desembocadura de la bahía de Guanabara es uno de los símbolos de Río. Un teleférico lleva a los visitantes a la cima, ofreciendo una vista panorámica de la ciudad. Este paraje natural muestra la diversidad paisajística de Brasil, desde la región amazónica hasta el Pantanal y el Cerrado. Como muchos lugares significativos de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Contribuye así al perfil polifacético de Brasil, donde se entrelazan la naturaleza tropical, la herencia portuguesa, el samba, el fútbol y el carnaval.",
      pt: "O Pão de Açúcar é um elemento notável da geografia e cultura brasileiras. Um rochedo de granito marcante na foz da Baía de Guanabara, é um dos símbolos do Rio. Um bondinho leva os visitantes ao topo, oferecendo uma vista panorâmica da cidade. Esta área natural demonstra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares significativos no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil multifacetado do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Le Pain de Sucre est un élément remarquable de la géographie et de la culture brésiliennes. Ce rocher de granit distinctif à l'embouchure de la baie de Guanabara est l'un des symboles de Rio. Un téléphérique emmène les visiteurs au sommet, offrant une vue panoramique sur la ville. Cet espace naturel témoigne de la diversité paysagère du Brésil, de la région amazonienne au Pantanal en passant par le Cerrado. Comme de nombreux lieux importants au Brésil, ce site allie des particularités régionales à l'importance globale du cinquième plus grand pays du monde. Il contribue ainsi au profil varié du Brésil, où s'entremêlent nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Der Gipfel erreicht eine Höhe von 396 Metern", "Besteht hauptsächlich aus 600 Millionen Jahre altem Gneis", "Die erste Seilbahn wurde im Jahr 1912 eröffnet", "Teil des UNESCO-Weltkulturerbes seit dem Jahr 2012", "Der Name stammt von der Form der Zuckerverpackung des 16. Jhs.", "Es gibt über 270 registrierte Kletterrouten am Berg"],
      hu: ["A hegy legmagasabb pontja 396 méter magas", "Kőzete kb. 600 millió éves gránit és gneisz", "Az első drótkötélpályát 1912 októberében nyitották meg", "2012-ben lett az UNESCO Világörökség része", "A név a 16. századi cukorszállítási formára utal", "Több mint 270 különböző sziklamászó útvonal található rajta"],
      ro: ["Înălțimea maximă a muntelui este de 396 de metri", "Formațiunea geologică are o vechime de 600 milioane de ani", "Telecabina a fost inaugurată pe 27 octombrie 1912", "Inclus în lista Patrimoniului Mondial UNESCO în 2012", "Numele face referire la comerțul cu zahăr din secolul XVI", "Găzduiește unul dintre cele mai mari centre de alpinism urban"],
      en: ["The mountain rises to a height of 396 meters", "Formed from 600-million-year-old granite and gneiss", "The first cable car line was inaugurated in 1912", "Designated as a UNESCO World Heritage site in 2012", "Named after the conical sugar molds used in the 16th century", "Features more than 270 distinct rock climbing routes"],
      es: ["Una prominente roca de granito en la bahía de Guanabara, símbolo de Río.", "Situado en el territorio de la República Federativa de Brasil.", "Desempeña un papel en la identidad local de la región.", "Vinculado a la vida cotidiana y la historia del país.", "Influenciado por el clima predominantemente tropical de Brasil."],
      pt: ["Um rochedo de granito marcante na Baía de Guanabara, símbolo do Rio.", "Localizado no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligado ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-sugarloaf-mountain-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Un munte din Rio de Janeiro, faimos în întreaga lume pentru statuia masivă a lui Hristos de pe vârf.",
      en: "A mountain in Rio de Janeiro, world-famous for the massive Christ statue on its peak.",
      es: "Una montaña en Río de Janeiro, mundialmente famosa por la enorme estatua de Cristo en su cima.",
      pt: "Uma montanha no Rio de Janeiro, mundialmente famosa pela estátua massiva de Cristo em seu topo.",
      fr: "Une montagne de Rio de Janeiro, mondialement célèbre pour l'imposante statue du Christ à son sommet.",
    },
    facts: {
      de: ["Erhebt sich 710 Meter über dem Meeresspiegel.", "Liegt inmitten des Tijuca-Nationalparks."],
      ...
      es: ["Se eleva a 710 metros sobre el nivel del mar.", "Se encuentra en medio del Parque Nacional de Tijuca."],
      pt: ["Eleva-se a 710 metros acima do nível do mar.", "Localiza-se no meio do Parque Nacional da Tijuca."],
      fr: ["S'élève à 710 mètres au-dessus du niveau de la mer.", "Se trouve au milieu du parc national de Tijuca."],
    },
    descriptionAdvanced: {
      de: "Der Corcovado ist ein 710 Meter hoher Granitberg im Herzen von Rio de Janeiro, der vor allem als Standort der monumentalen Christusstatue 'Cristo Redentor' weltberühmt ist. Er befindet sich im Tijuca-Nationalpark, dem größten Stadtwald der Welt, und bietet einen unvergleichlichen Panoramablick auf das Stadtzentrum, den Zuckerhut und die Strände von Copacabana und Ipanema. Geologisch gehört der Berg zum Gebirgszug der Serra do Mar und besteht aus präkambrischem Granit. Der Name 'Corcovado' bedeutet im Portugiesischen 'der Bucklige' und bezieht sich auf die charakteristische Form des Berges. Bereits 1884 wurde eine Zahnradbahn, die Trem do Corcovado, eingeweiht, um den Gipfel für Touristen zugänglich zu machen – lange bevor die Statue in den Jahren 1922 bis 1931 errichtet wurde. Der Gipfel ist jährlich Ziel von über einer Million Besuchern und gilt als das wichtigste Wahrzeichen Brasiliens.",
      hu: "A Corcovado egy 710 méter magas gránithegy Rio de Janeiróban, amely világszerte a csúcsán álló monumentális Krisztus-szoborról (Cristo Redentor) ismert. A hegy a Tijuca Nemzeti Park területén fekszik, amely a világ egyik legnagyobb városi erdősége, és lenyűgöző panorámát nyújt a városra, az öbölre és a híres tengerpartokra. Geológiailag a Serra do Mar hegylánchoz tartozik, és több száz millió éves gránitból áll. A 'Corcovado' név portugálul 'púpost' jelent, ami a hegy jellegzetes, hajlott formájára utal. A csúcsra vezető fogaskerekű vasutat (Trem do Corcovado) már 1884-ben átadták II. Péter császár jelenlétében, jóval azelőtt, hogy a szobrot 1922 és 1931 között felépítették volna. A helyszín nemcsak turisztikai látványosság, hanem vallási szimbólum és 2012 óta az UNESCO Világörökség része is.",
      ro: "Muntele Corcovado este un vârf de granit situat în Rio de Janeiro, atingând o altitudine de 710 metri în interiorul Parcului Național Tijuca. Este cunoscut la nivel global pentru găzduirea statuii Cristos Mântuitorul (Cristo Redentor), una dintre cele șapte minuni ale lumii moderne. Din punct de vedere geologic, muntele face parte din masivul Serra do Mar și este compus din granit precambrian. Numele său înseamnă 'cocoșatul' în limba portugheză, referindu-se la silueta sa distinctivă vizibilă din întreaga metropolă. Calea ferată cu cremalieră, Trem do Corcovado, a fost inaugurată în 1884 de împăratul Dom Pedro al II-lea, facilitând accesul pe vârf cu decenii înainte de construcția statuii între 1922 și 1931. Astăzi, Corcovado primește anual peste 1,8 milioane de vizitatori, fiind cel mai recunoscut simbol cultural al Braziliei și parte a patrimoniului UNESCO.",
      en: "Corcovado is a 710-meter-tall granite mountain located in the heart of Rio de Janeiro, world-renowned as the pedestal for the Christ the Redeemer statue. Situated within the Tijuca National Park, it offers a commanding view of the city, including Sugarloaf Mountain, Rodrigo de Freitas Lagoon, and the Atlantic beaches. Geologically, it is part of the Serra do Mar range and consists of Precambrian granite and gneiss. The name 'Corcovado' translates from Portuguese as 'the hunchback,' describing its distinctive shape. The Corcovado Rack Railway, Brazil's oldest tourist excursion, was inaugurated in 1884, predating the construction of the iconic statue which took place between 1922 and 1931. Designated as a UNESCO World Heritage site in 2012, the summit attracts over 1.8 million visitors each year and remains the definitive symbol of Brazilian tourism and cultural identity.",
      es: "El Corcovado es un elemento notable de la geografía y la cultura brasileñas. Una montaña en Río de Janeiro, famosa mundialmente por la enorme estatua de Cristo en su cima. Se eleva a 710 metros sobre el nivel del mar. Se encuentra en medio del Parque Nacional de Tijuca. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "O Corcovado é um elemento notável da geografia e cultura brasileiras. Uma montanha no Rio de Janeiro, mundialmente famosa pela estátua massiva de Cristo em seu topo. Eleva-se a 710 metros acima do nível do mar. Localiza-se no meio do Parque Nacional da Tijuca. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Le Corcovado est un élément remarquable de la géographie et de la culture brésiliennes. Une montagne de Rio de Janeiro, mondialement célèbre pour l'imposante statue du Christ à son sommet. Il s'élève à 710 mètres au-dessus du niveau de la mer. Il se trouve au cœur du parc national de Tijuca. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Der Gipfel befindet sich auf einer Höhe von 710 Metern", "Liegt vollständig innerhalb des Tijuca-Nationalparks", "Die Zahnradbahn wurde bereits im Jahr 1884 eingeweiht", "Der Name bedeutet übersetzt 'Der Bucklige'", "Die Christusstatue auf dem Gipfel ist 30 Meter hoch", "Teil der UNESCO-Kulturerbeliste seit dem Jahr 2012"],
      hu: ["A hegycsúcs magassága 710 méter a tengerszint felett", "A világ legnagyobb városi erdőjében, a Tijucában található", "A fogaskerekű vasút 1884 óta szállítja az utasokat", "A hegy neve portugálul púpost vagy hajlottat jelent", "A csúcsán álló Krisztus-szobor súlya 635 tonna", "Évente több mint 1,8 millió turista látogatja meg"],
      ro: ["Altitudinea vârfului este de 710 metri peste nivelul mării", "Se află în Parcul Național Tijuca, o pădure urbană vastă", "Calea ferată a fost deschisă publicului în anul 1884", "Numele provine din limba portugheză și înseamnă 'cocoșat'", "Statuia de pe vârf a fost finalizată în anul 1931", "A fost inclus în patrimoniul mondial UNESCO în 2012"],
      en: ["The mountain's height is exactly 710 meters", "It is located within the world's largest urban forest", "The cog train started operations in the year 1884", "The name 'Corcovado' means 'hunchback' in Portuguese", "The Christ the Redeemer statue was completed in 1931", "The site is part of a UNESCO World Heritage landscape"],
      es: ["Una montaña en Río de Janeiro, mundialmente famosa por la enorme estatua de Cristo en su cima.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Uma montanha no Rio de Janeiro, mundialmente famosa pela estátua massiva de Cristo em seu topo.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-corcovado-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Un monolit uriaș care se ridică direct din ocean în Rio de Janeiro.",
      en: "A massive monolith rising directly from the ocean in Rio de Janeiro.",
      es: "Un enorme monolito que se eleva directamente desde el océano en Río de Janeiro.",
      pt: "Um enorme monólito que se eleva diretamente do oceano no Rio de Janeiro.",
      fr: "Un immense monolithe qui s'élève directement de l'océan à Rio de Janeiro.",
    },
    facts: {
      de: ["Es ist der größte küstennahe Monolith der Welt.", "Die Klippe sieht aus manchen Winkeln wie ein Gesicht aus."],
      ...
      es: ["Es el monolito costero más grande del mundo.", "El acantilado parece una cara desde ciertos ángulos."],
      pt: ["É o maior monólito costeiro do mundo.", "A falésia parece um rosto de certos ângulos."],
      fr: ["C'est le plus grand monolithe côtier du monde.", "La falaise ressemble à un visage sous certains angles."],
    },
    descriptionAdvanced: {
      de: "Die Pedra da Gávea ist ein massiver Gneisfelsen in Rio de Janeiro, der sich 842 Meter direkt aus dem Atlantik erhebt. Er ist einer der höchsten Monolithen der Welt, die unmittelbar an einer Küste liegen, und gehört zum Tijuca-Nationalpark. Seinen Namen erhielt der Fels im 16. Jahrhundert von portugiesischen Seefahrern, die in seiner Form das Marssegel (Gávea) eines Schiffes erkannten. Eine markante Felsformation an einer der Seiten ähnelt einem menschlichen Gesicht, was zu zahlreichen Mythen über phönizische Inschriften und Grabanlagen führte, die jedoch wissenschaftlich als natürliche Erosion klassifiziert wurden. Der Berg ist ein beliebtes Ziel für erfahrene Wanderer und Kletterer, da der Aufstieg steile Passagen und Kletterstellen wie die berühmte 'Carrasqueira' umfasst. Von der Spitze aus bietet sich ein spektakulärer Blick über die Stadtteile Barra da Tijuca, São Conrado und die gesamte Südküste von Rio.",
      hu: "A Pedra da Gávea egy hatalmas gneisz- és gránitmonolit Rio de Janeiróban, amely 842 méter magasan emelkedik közvetlenül az Atlanti-óceán partján. Ez a világ egyik legmagasabb partmenti monolitja, amely a Tijuca Nemzeti Park határain belül található. Nevét a 16. századi portugál tengerészektől kapta, akik egy vitorlás hajó keresztvitorlájához (gávea) hasonlították az alakját. A hegy egyik oldala egy óriási emberi arcra emlékeztet, ami számos legendát szült, többek között föníciai feliratokról és királysírokról, bár a geológusok ezeket természetes erózió eredményének tartják. A hegycsúcsra vezető túra az egyik legnehezebb a városban, mivel meredek sziklamászást is igényel, különösen a Carrasqueira nevű szakaszon. A fennsíkról belátható Barra da Tijuca, São Conrado és Rio de Janeiro szinte teljes déli része.",
      ro: "Pedra da Gávea este un monolit masiv de granit și gneis situat în Rio de Janeiro, ridicându-se la 842 de metri deasupra Oceanului Atlantic. Este unul dintre cei mai înalți munți din lume care se termină direct în mare și face parte din Parcul Național Tijuca. Numele său a fost dat de exploratorii portughezi în secolul al XVI-lea, deoarece forma vârfului seamănă cu coșul de veghe (gávea) al unei nave cu pânze. O formațiune stâncoasă specifică de pe una dintre fețe seamănă cu un chip uman uriaș, generând numeroase teorii pseudoștiințifice despre inscripții feniciene, deși cercetările geologice confirmă că este rezultatul eroziunii naturale. Traseul către vârf este considerat cel mai dificil din Rio, incluzând secțiuni de escaladă liberă, cum ar fi celebra 'Carrasqueira'. Panorama de pe vârf oferă o vedere spectaculoasă asupra cartierelor Barra da Tijuca și São Conrado.",
      en: "Pedra da Gávea is a massive monolith of gneiss and granite in Rio de Janeiro, rising 842 meters directly from the Atlantic coast. It ranks as one of the highest mountains in the world that ends directly in the ocean and is a prominent part of the Tijuca National Park. Its name was bestowed by Portuguese sailors in the 16th century, who noted that its flat top resembled the topsail (gávea) of a carrack. One side of the mountain features a rock formation that looks like a giant human face, giving rise to local legends about Phoenician inscriptions and tombs, though geologists attribute these features to natural erosion. Hiking to the summit is considered the most challenging trek in the city, requiring rock climbing skills to navigate sections like the 'Carrasqueira.' The peak provides an unparalleled panoramic view of Barra da Tijuca, São Conrado, and Rio's southwestern coastline.",
      es: "Pedra da Gávea es un elemento notable de la geografía y cultura brasileña. Un enorme monolito que se eleva directamente desde el océano en Río de Janeiro. Es el monolito costero más grande del mundo. El acantilado parece una cara desde ciertos ángulos. Este paraje natural muestra la diversidad paisajística de Brasil, desde la región amazónica hasta el Pantanal y el Cerrado. Como muchos lugares significativos en Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil polifacético de Brasil, donde se entrelazan la naturaleza tropical, la herencia portuguesa, el samba, el fútbol y el carnaval.",
      pt: "A Pedra da Gávea é um elemento notável da geografia e cultura brasileiras. Um enorme monólito que se eleva diretamente do oceano no Rio de Janeiro. É o maior monólito costeiro do mundo. A falésia parece um rosto de certos ângulos. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "La Pedra da Gávea est un élément remarquable de la géographie et de la culture brésiliennes. Un immense monolithe qui s'élève directement de l'océan à Rio de Janeiro. C'est le plus grand monolithe côtier du monde. Sous certains angles, la falaise ressemble à un visage. Cet espace naturel illustre la diversité des paysages du Brésil, de la région amazonienne au Pantanal en passant par le Cerrado. Comme de nombreux sites importants au Brésil, ce lieu conjugue des particularités régionales avec l'importance globale du cinquième plus grand pays du monde. Ce site contribue ainsi au profil aux multiples facettes du Brésil, où se mêlent nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Die Höhe des Berges beträgt 842 Meter", "Einer der höchsten küstennahen Monolithen der Welt", "Der Name bedeutet Marssegel auf Portugiesisch", "Gehört geologisch zum präkambrischen Gneis-Komplex", "Die berühmte Kletterstelle heißt Carrasqueira", "Es gibt keine wissenschaftlichen Belege für phönizische Inschriften"],
      hu: ["A hegy magassága 842 méter a tengerszint felett", "A világ egyik legmagasabb part menti monolitja", "A neve portugálul keresztvitorlát jelent", "A túraútvonal legnehezebb szakasza a Carrasqueira", "A hegyoldal 'arca' természetes erózió eredménye", "A Tijuca Nemzeti Park területén helyezkedik el"],
      ro: ["Altitudinea maximă este de 842 de metri", "Este unul dintre cei mai înalți monoliți litorali de pe glob", "Numele înseamnă 'gávea' (coșul de veghe al unei corăbii)", "Traseul include o secțiune de escaladă numită Carrasqueira", "Formațiunile de tip 'inscripții' sunt cauzate de eroziune", "Face parte din lanțul muntos Serra do Mar"],
      en: ["The summit stands at an elevation of 842 meters", "It is among the world's highest coastal monoliths", "The name refers to a ship's topsail in Portuguese", "Geologically composed of granite and Precambrian gneiss", "Includes a famous climbing passage known as Carrasqueira", "First officially explored by scientists in the 19th century"],
      es: ["Un enorme monolito que se eleva directamente desde el océano en Río de Janeiro.", "Situado en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado a la vida cotidiana y a la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Um enorme monólito que se eleva diretamente do oceano no Rio de Janeiro.", "Localizado no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligado ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-pedra-da-gavea-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Munte cu semnificație istorică, primul pământ văzut de exploratorii portughezi în 1500.",
      en: "Historically significant mountain, the first land seen by Portuguese explorers in 1500.",
      es: "Montaña de importancia histórica, la primera tierra que los exploradores portugueses divisaron en el año 1500.",
      pt: "Montanha historicamente significativa, a primeira terra que os exploradores portugueses viram em 1500.",
      fr: "Montagne d'importance historique, la première terre que les explorateurs portugais ont aperçue en 1500.",
    },
    facts: {
      de: ["Der Name bedeutet Osterberg.", "Er ist Teil eines Nationalparks, der die Mata Atlântica schützt."],
      ...
      es: ["El nombre significa Monte de Pascua.", "Forma parte de un parque nacional que protege la Mata Atlántica."],
      pt: ["O nome significa Monte de Páscoa.", "Faz parte de um parque nacional que protege a Mata Atlântica."],
      fr: ["Le nom signifie Mont de Pâques.", "Il fait partie d'un parc national qui protège la forêt atlantique (Mata Atlântica)."],
    },
    descriptionAdvanced: {
      de: "Der Monte Pascoal ist ein 536 Meter hoher Berg im Süden des Bundesstaates Bahia und besitzt eine herausragende Bedeutung für die Geschichte Brasiliens. Am 22. April 1500 war er das erste Land, das die portugiesische Flotte unter Pedro Álvares Cabral sichtete, was die offizielle Entdeckung des Landes markierte. Der Name wurde gewählt, da die Sichtung während der Osterwoche (portugiesisch 'Páscoa') stattfand. Heute ist der Berg das Herzstück des 1961 gegründeten Monte Pascoal Nationalparks, der eines der letzten bedeutenden Gebiete des ursprünglichen atlantischen Regenwaldes (Mata Atlântica) im Nordosten schützt. Das Gebiet wird zudem von den indigenen Pataxó bewohnt, die das Land als heiliges Territorium betrachten und in den Schutz der Region eingebunden sind. Die charakteristische kegelförmige Gestalt des Berges diente Seefahrern jahrhundertelang als wichtiger Navigationspunkt an der brasilianischen Küste.",
      hu: "A Monte Pascoal egy 536 méter magas hegy Bahia állam déli részén, amely Brazília történelmének egyik legfontosabb szimbóluma. 1500. április 22-én ez volt az első szárazföld, amelyet a Pedro Álvares Cabral vezette portugál flotta megpillantott, ezzel kijelölve az ország hivatalos felfedezésének helyszínét. Nevét a húsvéti időszakról (portugálul Páscoa) kapta, mivel a felfedezés a húsvéti héten történt. Ma a hegy az 1961-ben létrehozott Monte Pascoal Nemzeti Park központja, amely az atlanti esőerdő (Mata Atlântica) egyik utolsó érintetlen maradványát őrzi az északkeleti régióban. A terület a pataxó indiánok ősi lakóhelye, akik szent helyként tisztelik a hegyet és aktívan részt vesznek a környezetvédelmi feladatokban. A hegy jellegzetes kúp alakja évszázadokon át fontos tájékozódási pontként szolgált az Atlanti-óceánon hajózók számára.",
      ro: "Monte Pascoal este un munte cu o înălțime de 536 de metri situat în sudul statului Bahia, având o valoare simbolică imensă pentru istoria Braziliei. Acesta a fost primul punct de uscat zărit de flota portugheză condusă de Pedro Álvares Cabral pe 22 aprilie 1500, marcând descoperirea oficială a țării de către europeni. Numele a fost ales deoarece evenimentul a avut loc în săptămâna Paștelui (Páscoa în portugheză). În prezent, muntele face parte din Parcul Național Monte Pascoal, înființat în 1961 pentru a proteja una dintre ultimele suprafețe semnificative de pădure atlantică (Mata Atlântica) din regiune. Teritoriul este locuit și administrat parțial de tribul indigen Pataxó, care consideră muntele un loc sacru și ancestral. Silueta sa conică distinctivă a servit timp de secole ca reper natural de navigație pentru corăbiile care navigau de-a lungul coastei braziliene.",
      en: "Monte Pascoal is a 536-meter-high peak located in the south of Bahia state, holding immense significance in Brazilian history. On April 22, 1500, it was the first piece of land sighted by the Portuguese fleet commanded by Pedro Álvares Cabral, marking the official European discovery of Brazil. The mountain was named after the Easter week (Páscoa in Portuguese) during which the sighting occurred. Today, it serves as the center of the Monte Pascoal National Park, established in 1961 to protect one of the last remaining fragments of the original Atlantic Forest (Mata Atlântica) in the northeast. The surrounding area is also an indigenous territory belonging to the Pataxó people, who regard the mountain as a sacred ancestral site. Its conical shape made it a reliable natural lighthouse for mariners navigating the Brazilian coast for centuries.",
      es: "Monte Pascoal es un elemento notable de la geografía y cultura brasileña. Es una montaña de importancia histórica, al ser la primera tierra que los exploradores portugueses divisaron en 1500. El nombre significa Monte de Pascua. Forma parte de un parque nacional que protege la Mata Atlántica. Este paraje natural muestra la diversidad paisajística de Brasil, desde la región amazónica hasta el Pantanal y el Cerrado. Como muchos lugares significativos en Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil polifacético de Brasil, donde se entrelazan la naturaleza tropical, la herencia portuguesa, el samba, el fútbol y el carnaval.",
      pt: "O Monte Pascoal é um elemento notável da geografia e cultura brasileiras. Montanha historicamente significativa, foi a primeira terra que os exploradores portugueses viram em 1500. O nome significa Monte de Páscoa. Faz parte de um parque nacional que protege a Mata Atlântica. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Le Monte Pascoal est un élément remarquable de la géographie et de la culture brésiliennes. Montagne d'importance historique, elle fut la première terre vue par les explorateurs portugais en 1500. Son nom signifie Mont de Pâques. Il fait partie d'un parc national qui protège la forêt atlantique (Mata Atlântica). Cet espace naturel illustre la diversité des paysages du Brésil, de la région amazonienne au Pantanal en passant par le Cerrado. Comme de nombreux sites importants au Brésil, ce lieu conjugue des particularités régionales avec l'importance globale du cinquième plus grand pays du monde. Ce site contribue ainsi au profil aux multiples facettes du Brésil, où se mêlent nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Der Berg erreicht eine Höhe von 536 Metern", "Erste Sichtung durch Pedro Álvares Cabral im Jahr 1500", "Der Nationalpark wurde am 29. November 1961 gegründet", "Der Name bezieht sich auf das Osterfest (Páscoa)", "Wird von den indigenen Pataxó als heiliges Land betrachtet", "Gehört zum UNESCO-Weltnaturerbe 'Discovery Coast'"],
      hu: ["A hegy magassága 536 méter a tengerszint felett", "1500. április 22-én fedezték fel a portugál hajósok", "A nemzeti parkot 1961-ben alapították meg", "A húsvéti hétről nevezték el a felfedezők", "A pataxó indián törzs szent területének számít", "Az UNESCO Discovery Coast világörökségi helyszín része"],
      ro: ["Muntele are o altitudine de 536 de metri", "Data descoperirii oficiale este 22 aprilie 1500", "Parcul Național a fost creat în anul 1961", "Numele provine de la sărbătoarea de Paște", "Teritoriul este recunoscut oficial ca pământ indigen Pataxó", "Face parte din situl UNESCO 'Discovery Coast'"],
      en: ["The peak stands at an elevation of 536 meters", "Sighted by Portuguese explorers on April 22, 1500", "The national park was officially created in 1961", "Named after the Easter holiday period of the discovery", "The area is recognized as Pataxó indigenous territory", "Part of the UNESCO Discovery Coast Atlantic Forest Reserves"],
      es: ["Montaña de importancia histórica, la primera tierra que los exploradores portugueses vieron en 1500.", "Situado en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado a la vida cotidiana y a la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Montanha historicamente significativa, a primeira terra que os exploradores portugueses viram em 1500.", "Localizado no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligado ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
      fr: ["Montagne d'importance historique, la première terre aperçue par les explorateurs portugais en 1500.", "Situé sur le territoire de la République fédérative du Brésil.", "Joue un rôle dans l'identité locale de la région.", "Lié à la vie quotidienne et à l'histoire du pays.", "Soumis à l'influence du climat majoritairement tropical du Brésil."],
    }, image: "/poi-images/br-monte-pascoal-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Cea mai mare lagună din Brazilia și America de Sud, situată paralel cu Oceanul Atlantic.",
      en: "The largest lagoon in Brazil and South America, located parallel to the Atlantic Ocean.",
      es: "La laguna más grande de Brasil y Sudamérica, situada paralela al Océano Atlántico.",
      pt: "A maior lagoa do Brasil e da América do Sul, situada paralelamente ao Oceano Atlântico.",
      fr: "La plus grande lagune du Brésil et d'Amérique du Sud, située parallèlement à l'océan Atlantique.",
    },
    facts: {
      de: ["Erstreckt sich über 265 Kilometer Länge.", "Eine schmale Sandbank trennt sie vom Meer."],
      ...
      es: ["Se extiende a lo largo de 265 kilómetros.", "Un estrecho banco de arena la separa del mar."],
      pt: ["Estende-se por 265 quilômetros de comprimento.", "Um estreito banco de areia a separa do mar."],
      fr: ["S'étend sur 265 kilomètres de long.", "Un étroit banc de sable la sépare de la mer."],
    },
    descriptionAdvanced: {
      de: "Die Lagoa dos Patos im Bundesstaat Rio Grande do Sul ist mit einer Fläche von rund 10.140 Quadratkilometern die größte Lagune Brasiliens und die zweitgrößte Südamerikas. Sie erstreckt sich über eine Länge von etwa 280 Kilometern parallel zur Atlantikküste und ist durch eine schmale, durchschnittlich 8 Kilometer breite Halbinsel vom Meer getrennt. Trotz ihrer enormen Größe ist die Lagune sehr flach, mit einer durchschnittlichen Tiefe von nur 7 Metern, was die Schifffahrt auf markierte Kanäle beschränkt. Wirtschaftlich ist sie von großer Bedeutung, da sie die Verbindung zwischen dem wichtigen Hafen von Rio Grande im Süden und der Landeshauptstadt Porto Alegre im Norden darstellt. Ihr Name, der 'See der Enten' bedeutet, geht auf die indigenen Bewohner zurück oder bezieht sich auf die dort lebenden Entenarten, die bereits von frühen Kolonisten gesichtet wurden. Die Lagune beherbergt eine reiche Artenvielfalt, darunter zahlreiche Zugvögel und eine bedeutende Population von rosa Delfinen (Toninhas).",
      hu: "A Lagoa dos Patos Brazília legnagyobb, Dél-Amerika második legnagyobb lagúnája, amely Rio Grande do Sul állam partvidékén terül el. Körülbelül 10 140 négyzetkilométeres területével és 280 kilométeres hosszával párhuzamosan fut az Atlanti-óceánnal, amelytől egy keskeny homokos félsziget választja el. Annak ellenére, hogy kiterjedése hatalmas, vize meglehetősen sekély, átlagos mélysége mindössze 7 méter, ami miatt a nagyobb hajók csak kijelölt csatornákon közlekedhetnek. A lagúna kulcsfontosságú vízi út, amely összeköti Porto Alegre városát Rio Grande kikötőjével és az óceánnal. Nevét (Kacsák tava) valószínűleg a korai telepesek által itt talált vadkacsákról vagy a helyi indián törzsekről kapta. Ökoszisztémája rendkívül gazdag, fontos élőhelye a vándormadaraknak és a ritka toninha delfineknek, miközben partjain jelentős mezőgazdasági termelés, főleg rizstermesztés folyik.",
      ro: "Lagoa dos Patos, situată în statul Rio Grande do Sul, este cea mai mare lagună din Brazilia și a doua ca mărime din America de Sud. Acoperind o suprafață de aproximativ 10.140 km pătrați, se întinde pe 280 km lungime paralel cu Oceanul Atlantic, fiind separată de acesta printr-o peninsulă îngustă de nisip. Laguna are o adâncime medie redusă, de circa 7 metri, ceea ce necesită dragarea constantă a canalelor pentru a permite navigația comercială între Porto Alegre și portul Rio Grande. Numele său, care s-ar traduce prin 'Laguna Rațelor', provine de la triburile indigene locale sau de la numeroasele păsări acvatice observate de primii coloniști. Din punct de vedere ecologic, este un habitat vital pentru specii de pești euryhaline și pentru delfinii 'toninha'. Laguna joacă un rol esențial în controlul inundațiilor și susține economia regională prin pescuit și transport naval.",
      en: "Lagoa dos Patos, located in the state of Rio Grande do Sul, is the largest lagoon in Brazil and the second largest in South America. Spanning approximately 10,140 square kilometers, it stretches 280 kilometers in length parallel to the Atlantic coast, separated by a narrow sandy peninsula. Despite its vast surface area, the lagoon is relatively shallow, with an average depth of only 7 meters, necessitating dredged channels for commercial shipping. It serves as a vital maritime link between the state capital, Porto Alegre, and the international port of Rio Grande at its southern outlet. The name, meaning 'Lagoon of the Ducks,' is attributed to the indigenous inhabitants or the abundance of waterfowl noted by early European explorers. Ecologically, it is a highly productive brackish environment, supporting diverse fisheries, migratory birds, and a resident population of Franciscana dolphins.",
      es: "La Lagoa dos Patos es un elemento notable de la geografía y la cultura brasileñas. La laguna más grande de Brasil y Sudamérica, situada paralela al Océano Atlántico. Se extiende a lo largo de 265 kilómetros. Un estrecho banco de arena la separa del mar. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "A Lagoa dos Patos é um elemento notável da geografia e cultura brasileiras. A maior lagoa do Brasil e da América do Sul, situada paralelamente ao Oceano Atlântico. Estende-se por 265 quilômetros de comprimento. Um estreito banco de areia a separa do mar. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "La Lagoa dos Patos est un élément remarquable de la géographie et de la culture brésiliennes. La plus grande lagune du Brésil et d'Amérique du Sud, située parallèlement à l'océan Atlantique. Elle s'étend sur 265 kilomètres de long. Un étroit banc de sable la sépare de la mer. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Fläche der Lagune beträgt etwa 10.140 Quadratkilometer", "Mit 280 Kilometern Länge die größte Lagune Brasiliens", "Die durchschnittliche Wassertiefe liegt bei nur 7 Metern", "Wichtigster Schifffahrtsweg nach Porto Alegre", "Beherbergt seltene Tierarten wie den rosa Delfin (Toninha)", "Durch eine 8 km breite Landzunge vom Atlantik getrennt"],
      hu: ["A lagúna teljes felszíne kb. 10 140 négyzetkilométer", "Hosszúsága eléri a 280 kilométert", "Átlagos mélysége csupán 7 méter körül van", "Összeköti Porto Alegre-t az Atlanti-óceánnal", "Fontos élőhelye a Toninha néven ismert delfineknek", "Brazília legnagyobb sós-édesvízi lagúnarendszere"],
      ro: ["Suprafața totală este de aproximativ 10.140 km pătrați", "Este cea mai mare lagună din Brazilia (280 km lungime)", "Adâncimea medie a apei este de aproximativ 7 metri", "Asigură accesul naval către capitala Porto Alegre", "Este un habitat protejat pentru delfinii 'toninha'", "S-a format prin acumularea de sedimente în ultimele milenii"],
      en: ["The lagoon covers an area of roughly 10,140 square km", "It measures 280 km long and up to 70 km wide", "The average depth is approximately 7 meters", "Primary waterway connecting Porto Alegre to the ocean", "Home to the rare and endangered Franciscana dolphin", "Separated from the sea by a peninsula 8 km wide on average"],
      es: ["La laguna más grande de Brasil y Sudamérica, situada paralela al Océano Atlántico.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["A maior lagoa do Brasil e da América do Sul, situada paralelamente ao Oceano Atlântico.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
      fr: ["La plus grande lagune du Brésil et d'Amérique du Sud, située parallèlement à l'océan Atlantique.", "Situé sur le territoire de la République fédérative du Brésil.", "Joue un rôle dans l'identité locale de la région.", "Lié à la vie quotidienne et à l'histoire du pays.", "Sous l'influence du climat principalement tropical du Brésil."],
    }, image: "/poi-images/br-lagoa-dos-patos-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "O mare lagună de coastă împărțită de Brazilia și Uruguay, cunoscută pentru biodiversitatea sa.",
      en: "A large coastal lagoon shared by Brazil and Uruguay, known for its biodiversity.",
      es: "Una gran laguna costera que Brasil comparte con Uruguay y que es conocida por su biodiversidad.",
      pt: "Uma grande lagoa costeira que o Brasil compartilha com o Uruguai, conhecida por sua biodiversidade.",
      fr: "Une grande lagune côtière partagée entre le Brésil et l'Uruguay, connue pour sa biodiversité.",
    },
    facts: {
      de: ["Wichtiger Lebensraum für Zugvögel.", "Durch den São-Gonçalo-Kanal mit der Lagoa dos Patos verbunden."],
      ...
      es: ["Hábitat importante para aves migratorias.", "Conectada a la Lagoa dos Patos a través del canal de São Gonçalo."],
      pt: ["Habitat importante para aves migratórias.", "Conectada à Lagoa dos Patos através do canal de São Gonçalo."],
      fr: ["Habitat important pour les oiseaux migrateurs.", "Reliée à la Lagoa dos Patos par le canal de São Gonçalo."],
    },
    descriptionAdvanced: {
      de: "Die Lagoa Mirim ist eine große Lagune im Süden Brasiliens und im Osten Uruguays, die eine Fläche von etwa 3.750 Quadratkilometern umfasst. Sie ist durch den schiffbaren Canal de São Gonçalo mit der größeren Lagoa dos Patos verbunden und bildet einen Teil des umfangreichen hydrographischen Systems von Rio Grande do Sul. Geologisch gesehen ist sie eine Küstenlagune, die durch die Ablagerung von Sedimenten und die Bildung von Sandbänken in den letzten 400.000 Jahren entstand. Das Gebiet ist ökologisch wertvoll und als Schutzgebiet ausgewiesen, da es zahlreichen Wasservögeln und Fischarten als Lebensraum dient. Die Grenze zwischen Brasilien und Uruguay verläuft mitten durch die Lagune, wobei beide Nationen die Nutzung der Gewässer durch den Mirim-Lagunen-Vertrag von 1909 regeln. Die umliegende Region wird intensiv für den Reisanbau genutzt, wobei das Wasser der Lagune eine zentrale Rolle für die Bewässerung spielt.",
      hu: "A Lagoa Mirim egy jelentős lagúna Brazília legdélebbi részén és Uruguay keleti határán, amelynek területe körülbelül 3750 négyzetkilométer. A lagúnát a São Gonçalo-csatorna köti össze a szomszédos Lagoa dos Patos-szal, egy komplex vízrendszert alkotva Rio Grande do Sul államban. Kialakulását tekintve egy partmenti lagúna, amely az elmúlt százezer év során üledékfelhalmozódás és homokpadok kialakulása révén jött létre. A tó közepén húzódik a nemzetközi határ, amelynek használatát az 1909-es Mirim-lagúna szerződés szabályozza a két ország között. Ökológiai szempontból kiemelkedő jelentőségű, mivel számos vándormadár és édesvízi halfaj élőhelye. A környező síkságokon folyó intenzív rizstermesztés nagymértékben támaszkodik a lagúna vizére az öntözés során, ami állandó figyelmet igényel a vízminőség megőrzése érdekében.",
      ro: "Lagoa Mirim este o lagună vastă situată la granița dintre sudul Braziliei și estul Uruguayului, acoperind o suprafață de aproximativ 3.750 km pătrați. Aceasta comunică cu laguna mai mare, Lagoa dos Patos, prin canalul navigabil São Gonçalo, formând împreună un sistem hidrografic complex în statul Rio Grande do Sul. Laguna s-a format prin procese sedimentare costiere pe parcursul ultimelor sute de mii de ani, fiind separată de ocean printr-o fâșie de pământ nisipoasă. Granița politică dintre cele două state trece chiar prin apele lagunei, exploatarea acesteia fiind reglementată de Tratatul Lagoa Mirim semnat în 1909. Regiunea este una dintre cele mai productive zone pentru cultivarea orezului din America de Sud, bazându-se masiv pe resursele de apă ale lagunei pentru irigații. Ecologic, zona este protejată pentru biodiversitatea sa, oferind refugiu multor specii de păsări migratoare și faunei acvatice locale.",
      en: "Mirim Lagoon (Lagoa Mirim) is a large coastal lagoon located on the border between southern Brazil and eastern Uruguay, covering an area of about 3,750 square kilometers. It is connected to the larger Lagoa dos Patos to the north via the São Gonçalo Channel, creating a vast interconnected wetland system in the state of Rio Grande do Sul. Formed by sedimentary deposits over the last few hundred thousand years, it is separated from the Atlantic Ocean by a sandy littoral strip. The international border between Brazil and Uruguay runs through the center of the lagoon, governed by the Mirim Lagoon Treaty of 1909 which established shared navigation and usage rights. The surrounding lowlands are major rice-producing regions, heavily relying on the lagoon's fresh water for irrigation. The area is also an important ecological corridor for migratory birds and home to diverse freshwater fish species.",
      es: "La Lagoa Mirim es un elemento notable de la geografía y la cultura brasileñas. Una gran laguna costera que Brasil comparte con Uruguay y que es conocida por su biodiversidad. Hábitat importante para aves migratorias. Conectada a la Lagoa dos Patos a través del canal de São Gonçalo. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "A Lagoa Mirim é um elemento notável da geografia e cultura brasileiras. Uma grande lagoa costeira que o Brasil compartilha com o Uruguai, conhecida por sua biodiversidade. Habitat importante para aves migratórias. Conectada à Lagoa dos Patos através do canal de São Gonçalo. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "La Lagoa Mirim est un élément remarquable de la géographie et de la culture brésiliennes. Une grande lagune côtière partagée entre le Brésil et l'Uruguay, connue pour sa biodiversité. Habitat important pour les oiseaux migrateurs. Reliée à la Lagoa dos Patos par le canal de São Gonçalo. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Die Gesamtfläche der Lagune beträgt 3750 Quadratkilometer", "Bildet die natürliche Grenze zwischen Brasilien und Uruguay", "Verbunden mit der Lagoa dos Patos über den São Gonçalo Kanal", "Der Mirim-Lagunen-Vertrag wurde im Jahr 1909 unterzeichnet", "Wichtigste Wasserquelle für den regionalen Reisanbau", "Entstand durch Sedimentation in den letzten 400.000 Jahren"],
      hu: ["A lagúna területe körülbelül 3750 négyzetkilométer", "Brazília és Uruguay természetes határát alkotja", "A São Gonçalo-csatornán keresztül érintkezik a Lagoa dos Patos-szal", "Az 1909-es nemzetközi szerződés szabályozza a használatát", "Kritikus fontosságú a dél-brazil rizstermesztés számára", "Fontos vizes élőhely a dél-amerikai vándormadarak számára"],
      ro: ["Suprafața lagunei este de aproximativ 3.750 km pătrați", "Este traversată de granița dintre Brazilia și Uruguay", "Comunică cu Lagoa dos Patos prin canalul São Gonçalo", "Tratatul de exploatare comună a fost semnat în anul 1909", "Resursele sale de apă susțin marea producție de orez a zonei", "Adâncimea maximă a lagunei nu depășește 4 metri"],
      en: ["The lagoon covers a total area of 3,750 square km", "It marks the international border between Brazil and Uruguay", "Linked to Lagoa dos Patos by the São Gonçalo Channel", "Shared usage was formally agreed in the 1909 Treaty", "Serves as a primary irrigation source for regional rice farms", "The average depth is between 1 and 2 meters"],
      es: ["Una gran laguna costera que Brasil comparte con Uruguay y que es conocida por su biodiversidad.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Uma grande lagoa costeira que o Brasil compartilha com o Uruguai, conhecida por sua biodiversidade.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-lagoa-mirim-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "O lagună pitorească cu apă sărată pe Insula Santa Catarina, înconjurată de dealuri verzi.",
      en: "A picturesque saltwater lagoon on Santa Catarina Island, surrounded by green hills.",
      es: "Una pintoresca laguna de agua salada en la isla de Santa Catarina, rodeada de colinas verdes.",
      pt: "Uma lagoa pitoresca de água salgada na ilha de Santa Catarina, cercada por colinas verdes.",
      fr: "Une lagune d'eau salée pittoresque sur l'île de Santa Catarina, entourée de collines verdoyantes.",
    },
    facts: {
      de: ["Beliebt zum Windsurfen und Kitesurfen.", "Das Herzstück der Tourismusindustrie in Florianópolis."],
      ...
      es: ["Popular para el windsurf y el kitesurf.", "El corazón de la industria turística en Florianópolis."],
      pt: ["Popular para windsurf e kitesurf.", "O coração da indústria turística em Florianópolis."],
      fr: ["Prisée pour la planche à voile et le kitesurf.", "Le cœur de l'industrie touristique de Florianópolis."],
    },
    descriptionAdvanced: {
      de: "Die Lagoa da Conceição ist eine der bekanntesten Lagunen auf der Insel Santa Catarina in Florianópolis und ein zentrales Zentrum für Kultur und Tourismus. Sie umfasst eine Fläche von etwa 19 Quadratkilometern und ist durch einen Kanal mit dem Meer verbunden, was zu einer Mischung aus Süß- und Salzwasser führt. Die Lagune ist von Bergen und Dünen umgeben, darunter die berühmten Dünen von Joaquina, die ein beliebtes Ziel für Sandboarding sind. Historisch wurde die Region im 18. Jahrhundert von Einwanderern von den Azoren besiedelt, deren Einfluss noch heute in der Architektur, dem traditionellen Handwerk der Klöppelspitze und der lokalen Gastronomie sichtbar ist. Die Lagune ist in drei Abschnitte unterteilt: Canto dos Araçás, Costa da Lagoa und das Zentrum, wobei die Costa da Lagoa nur per Boot oder über Wanderwege erreichbar ist. Heute ist sie ein Hotspot für Wassersportarten wie Windsurfen, Kitesurfen und Segeln.",
      hu: "A Lagoa da Conceição Florianópolis városának és Santa Catarina szigetének egyik legkedveltebb turisztikai és kulturális központja. A mintegy 19 négyzetkilométer területű lagúnát egy csatorna köti össze az óceánnal, így vize édes- és sós víz keveréke, ami különleges élővilágot eredményez. A tavat festői hegyek és homokdűnék veszik körül, mint például a híres Joaquina-dűnék, ahol a homokdeszkázás (sandboarding) hódít. A területet a 18. században az Azori-szigetekről érkező bevándorlók népesítették be, akiknek öröksége ma is él a hagyományos csipkeverésben, a halászatban és az építészetben. A lagúna partján fekvő Costa da Lagoa falucska csak hajóval vagy erdei gyalogúton közelíthető meg, megőrizve ezzel régi világias hangulatát. Modern időkben a lagúna a vízi sportok, különösen a windsurf és a vitorlázás egyik legfontosabb brazil helyszínévé vált.",
      ro: "Lagoa da Conceição este cea mai celebră lagună de pe Insula Santa Catarina, situată în orașul Florianópolis, fiind un pol cultural și turistic major. Cu o suprafață de aproximativ 19 km pătrați, laguna este conectată la ocean printr-un canal, rezultând un amestec de apă dulce și sărată. Peisajul este definit de dealuri verzi și dune de nisip impunătoare, precum Joaquina, faimoase pentru practicarea sandboarding-ului. Istoria zonei este strâns legată de coloniștii din Insulele Azore care s-au stabilit aici în secolul al XVIII-lea, lăsând moștenire tradiția dantelei și a arhitecturii coloniale. Laguna este împărțită în mai multe zone, dintre care Costa da Lagoa este accesibilă doar cu barca sau pe poteci pietonale, păstrând un stil de viață tradițional. Astăzi, apele sale liniștite sunt ideale pentru sporturi nautice precum windsurfing, kitesurfing și stand-up paddle.",
      en: "Lagoa da Conceição is the most famous lagoon on Santa Catarina Island in Florianópolis, serving as a vibrant hub for culture, nature, and tourism. Covering approximately 19 square kilometers, the lagoon is connected to the sea via a channel, creating a brackish water environment that supports unique local biodiversity. It is surrounded by lush green hills and massive sand dunes, such as the Joaquina dunes, which are a premier destination for sandboarding. The area was settled in the 18th century by Azorean immigrants, and their cultural legacy remains evident in the traditional lace-making, fishing practices, and colonial-style architecture. The lagoon is divided into sections, with the Costa da Lagoa remaining accessible only by boat or hiking trails, preserving a secluded and historic atmosphere. Today, its calm waters make it a top Brazilian destination for windsurfing, sailing, and kitesurfing.",
      es: "La Lagoa da Conceição es un elemento notable de la geografía y la cultura brasileñas. Una pintoresca laguna de agua salada en la isla de Santa Catarina, rodeada de colinas verdes. Popular para el windsurf y el kitesurf. El corazón de la industria turística en Florianópolis. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "A Lagoa da Conceição é um elemento notável da geografia e cultura brasileiras. Uma lagoa pitoresca de água salgada na ilha de Santa Catarina, cercada por colinas verdes. Popular para windsurf e kitesurf. O coração da indústria turística em Florianópolis. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "La Lagoa da Conceição est un élément remarquable de la géographie et de la culture brésiliennes. Une lagune d'eau salée pittoresque sur l'île de Santa Catarina, entourée de collines verdoyantes. Prisée pour la planche à voile et le kitesurf. Le cœur de l'industrie touristique de Florianópolis. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Die Lagune hat eine Wasserfläche von etwa 19 Quadratkilometern", "Besiedlung durch Azoren-Einwanderer im 18. Jahrhundert", "Costa da Lagoa ist nur per Boot oder Wanderweg erreichbar", "Die berühmten Joaquina-Dünen grenzen an die Lagune an", "Ein 2 km langer Kanal verbindet die Lagune mit dem Ozean", "Wichtiges Zentrum für Klöppelspitzen-Handwerk in Brasilien"],
      hu: ["A lagúna vízfelülete körülbelül 19 négyzetkilométer", "A 18. században azori telepesek alapították a környező falvakat", "Costa da Lagoa városrésze nem érhető el közúton", "A közeli Joaquina-dűnék a homokdeszkázás őshazája", "Vize brakkvíz, azaz édes- és sós víz keveréke", "Florianópolis egyik legfontosabb gasztronómiai negyede"],
      ro: ["Suprafața totală a lagunei este de circa 19 km pătrați", "Regiunea a fost colonizată de azoreni începând cu anul 1748", "Costa da Lagoa este accesibilă exclusiv pe apă sau pe poteci", "Dunele Joaquina sunt renumite pentru sporturi pe nisip", "Canalul da Barra face legătura permanentă cu oceanul", "Este un centru tradițional pentru meșteșugul dantelei"],
      en: ["The lagoon covers a surface area of 19 square km", "Azorean immigrants settled the area in the 18th century", "Costa da Lagoa is accessible only by boat or trail", "Nearby Joaquina dunes are famous for sandboarding", "A 2 km long channel connects the lagoon to the Atlantic", "Known for the traditional 'Renda de Bilro' lace-making"],
      es: ["Una pintoresca laguna de agua salada en la isla de Santa Catarina, rodeada de colinas verdes.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Uma lagoa pitoresca de água salgada na ilha de Santa Catarina, cercada por colinas verdes.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
      fr: ["Une lagune d'eau salée pittoresque sur l'île de Santa Catarina, entourée de collines verdoyantes.", "Situé sur le territoire de la République fédérative du Brésil.", "Joue un rôle dans l'identité locale de la région.", "Lié à la vie quotidienne et à l'histoire du pays.", "Sous l'influence du climat principalement tropical du Brésil."],
    }, image: "/poi-images/br-lagoa-da-conceicao-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Un arhipelag vulcanic protejat în Atlantic, faimos pentru plajele sale imaculate și viața marină.",
      en: "A protected volcanic archipelago in the Atlantic, famous for its pristine beaches and marine life.",
      es: "Un archipiélago volcánico protegido en el Atlántico, famoso por sus playas vírgenes y su vida marina.",
      pt: "Um arquipélago vulcânico protegido no Atlântico, famoso por suas praias intocadas e vida marinha.",
      fr: "Un archipel volcanique protégé dans l'Atlantique, célèbre pour ses plages immaculées et sa faune marine.",
    },
    facts: {
      de: ["Es ist ein UNESCO-Weltnaturerbe.", "Die Besucherzahlen sind streng limitiert, um die Natur zu schützen."],
      ...
      es: ["Es Patrimonio de la Humanidad por la UNESCO.", "El número de visitantes está estrictamente limitado para proteger la naturaleza."],
      pt: ["É um Patrimônio Mundial da UNESCO.", "O número de visitantes é estritamente limitado para proteger a natureza."],
      fr: ["Il est inscrit au patrimoine mondial de l'UNESCO.", "Le nombre de visiteurs est strictement limité pour protéger la nature."],
    },
    descriptionAdvanced: {
      de: "Fernando de Noronha ist ein vulkanischer Archipel im Atlantischen Ozean, etwa 350 Kilometer vor der Küste Brasiliens gelegen. Die Hauptinsel, die dem Archipel den Namen gibt, ist die einzige bewohnte Insel der 21 Eilande umfassenden Gruppe. Die Region ist weltweit bekannt für ihre unberührten Strände, wie die Baía do Sancho, die regelmäßig zu den schönsten Stränden der Welt gewählt wird. Seit 2001 gehört der Archipel zum UNESCO-Weltnaturerbe, da er ein wichtiges Brutgebiet für Seevögel und ein Refugium für Delfine und Meeresschildkröten ist. Die Gewässer um Fernando de Noronha zeichnen sich durch extreme Sichtweiten von bis zu 50 Metern aus, was sie zu einem der besten Tauchreviere Brasiliens macht. Um die ökologische Integrität zu bewahren, ist die Anzahl der Touristen streng limitiert und jeder Besucher muss eine Umweltsteuer entrichten. Historisch diente die Insel zeitweise als Gefängnis für politische Gefangene und gefährliche Verbrecher.",
      hu: "Fernando de Noronha egy 21 szigetből álló vulkanikus szigetcsoport az Atlanti-óceánban, körülbelül 350 kilométerre a brazil partoktól. A névadó fősziget az egyetlen lakott terület az egész csoportban, amely kristálytiszta vizéről és gazdag tengeri élővilágáról híres. Itt található a Baía do Sancho, amelyet többször is a világ legszebb strandjának választottak meg nemzetközi szavazásokon. 2001 óta az UNESCO Világörökség része, mint az atlanti szigetek egyik legfontosabb madárfészkelő helye és tengeri védett területe. A szigetcsoport körüli vizekben a látótávolság akár az 50 métert is elérheti, így ez Brazília első számú búvárparadicsoma. A környezet védelme érdekében a látogatók száma korlátozott, és minden turistának környezetvédelmi adót kell fizetnie a tartózkodása alatt. A sziget történetéhez hozzátartozik, hogy korábban börtönszigetként is funkcionált.",
      ro: "Fernando de Noronha este un arhipelag vulcanic situat în Oceanul Atlantic, la aproximativ 354 km distanță de coasta de nord-est a Braziliei. Grupul cuprinde 21 de insule și insulițe, dintre care doar insula principală este locuită. Arhipelagul este renumit pentru plajele sale virgine, Baía do Sancho fiind adesea votată drept cea mai frumoasă plajă din lume. În 2001, situl a fost inclus în Patrimoniul Mondial UNESCO datorită ecosistemului său marin divers, fiind un loc crucial pentru hrănirea și reproducerea delfinilor rotatori și a țestoaselor marine. Apele din jurul insulelor oferă o vizibilitate excepțională de până la 50 de metri, atrăgând scafandri din întreaga lume. Pentru a proteja mediul fragil, autoritățile impun o limită strictă privind numărul de turiști și percep o taxă de conservare de la fiecare vizitator. Istoric, insula a servit ca închisoare federală timp de peste 200 de ani.",
      en: "Fernando de Noronha is a volcanic archipelago in the Atlantic Ocean, situated approximately 354 kilometers offshore from the Brazilian mainland. Consisting of 21 islands and islets, only the main island is inhabited, serving as a sanctuary for diverse wildlife and a premier eco-tourism destination. The archipelago is home to Baía do Sancho, frequently ranked as the world's most beautiful beach by international travel publications. In 2001, it was designated a UNESCO World Heritage site due to its importance as a breeding ground for spinner dolphins, sea turtles, and various seabirds. The surrounding waters boast exceptional visibility of up to 50 meters, making it the top destination for scuba diving in Brazil. To maintain its ecological balance, the government limits the number of daily visitors and requires payment of an environmental preservation tax. Historically, the island functioned as a penal colony for several centuries before becoming a protected area.",
      es: "Fernando de Noronha es un elemento notable de la geografía y la cultura brasileñas. Un archipiélago volcánico protegido en el Atlántico, famoso por sus playas vírgenes y su vida marina. Es Patrimonio de la Humanidad por la UNESCO. El número de visitantes está estrictamente limitado para proteger la naturaleza. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "Fernando de Noronha é um elemento notável da geografia e cultura brasileiras. Um arquipélago vulcânico protegido no Atlântico, famoso por suas praias intocadas e vida marinha. É um Patrimônio Mundial da UNESCO. O número de visitantes é estritamente limitado para proteger a natureza. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Fernando de Noronha est un élément remarquable de la géographie et de la culture brésiliennes. Un archipel volcanique protégé dans l'Atlantique, célèbre pour ses plages immaculées et sa faune marine. Il est inscrit au patrimoine mondial de l'UNESCO. Le nombre de visiteurs est strictement limité pour protéger la nature. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Der Archipel besteht aus insgesamt 21 Inseln", "Liegt etwa 354 km von der brasilianischen Küste entfernt", "UNESCO-Weltnaturerbe seit dem Jahr 2001", "Die Baía do Sancho gilt als einer der besten Strände weltweit", "Sichtweiten unter Wasser erreichen oft 50 Meter", "Besucher müssen eine tägliche Umweltsteuer zahlen"],
      hu: ["A szigetcsoport összesen 21 szigetből és sziklából áll", "A szárazföldtől való távolsága 354 kilométer", "2001 óta szerepel az UNESCO Világörökségi listáján", "A Baía do Sancho többször elnyerte a világ legjobb strandja címet", "A víz alatti látótávolság eléri az 50 métert", "A turisták napi környezetvédelmi adót kötelesek fizetni"],
      ro: ["Arhipelagul cuprinde 21 de insule de origine vulcanică", "Se află la 354 km de orașul Natal din Brazilia", "Inclus în lista Patrimoniului Mondial UNESCO în 2001", "Plaja Baía do Sancho este celebră la nivel mondial", "Vizibilitatea subacvatică poate atinge recordul de 50 de metri", "Accesul turiștilor este strict limitat prin cote zilnice"],
      en: ["The archipelago consists of 21 islands and islets", "Located 354 km from the nearest point of the mainland", "Designated as a UNESCO World Heritage site in 2001", "Home to Baía do Sancho, often voted the world's best beach", "Underwater visibility regularly reaches up to 50 meters", "Visitors pay a daily Environmental Preservation Tax"],
      es: ["Un archipiélago volcánico protegido en el Atlántico, famoso por sus playas vírgenes y su vida marina.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Um arquipélago vulcânico protegido no Atlântico, famoso por suas praias intocadas e vida marinha.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-fernando-de-noronha-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "O insulă tropicală fără mașini în largul coastei Rio de Janeiro, cunoscută pentru traseele sale prin junglă.",
      en: "A car-free tropical island off the coast of Rio de Janeiro, known for its jungle trails.",
      es: "Una isla tropical sin coches frente a la costa de Río de Janeiro, conocida por sus senderos selváticos.",
      pt: "Uma ilha tropical livre de carros na costa do Rio de Janeiro, conhecida por suas trilhas na selva.",
      fr: "Une île tropicale sans voiture au large de Rio de Janeiro, connue pour ses sentiers dans la jungle.",
    },
    facts: {
      de: ["Auf der Insel gibt es keine motorisierten Fahrzeuge.", "Sie war einst eine Piratenhochburg und ein Gefängnis."],
      ...
      es: ["No hay vehículos motorizados en la isla.", "Antiguamente fue un refugio de piratas y una prisión."],
      pt: ["Não há veículos motorizados na ilha.", "Antigamente foi um reduto de piratas e uma prisão."],
      fr: ["Il n'y a pas de véhicules motorisés sur l'île.", "C'était autrefois un repaire de pirates et une prison."],
    },
    descriptionAdvanced: {
      de: "Die Ilha Grande liegt vor der Küste des Bundesstaates Rio de Janeiro und umfasst eine Fläche von etwa 193 Quadratkilometern. Die Topographie der Insel ist durch schroffe Gebirgszüge geprägt, wobei der Pico do Papagaio mit 982 Metern die höchste Erhebung darstellt. Historisch gesehen diente die Insel verschiedenen Isolationszwecken, darunter als Leprakolonie und später als Standort des Hochsicherheitsgefängnisses Cândido Mendes, das bis 1994 in Betrieb war. Nach der Schließung der Haftanstalt wandelte sich die Insel zu einem bedeutenden ökologischen Schutzgebiet, das größtenteils durch den Ilha Grande State Park geschützt wird. Die Erhaltung der ursprünglichen Vegetation wird durch ein striktes Verbot von motorisierten Fahrzeugen unterstützt, was die Ausbreitung des Atlantischen Regenwaldes begünstigt hat. Im Jahr 2019 wurde die Insel zusammen mit Paraty zum UNESCO-Welterbe erklärt, da sie eine außergewöhnliche biologische Vielfalt und kulturelle Relikte aus der Kolonialzeit vereint. Die Gewässer um die Insel sind für ihre Artenvielfalt bekannt und dienen als wichtiger Lebensraum für Meeresschildkröten und Delfine.",
      hu: "Az Ilha Grande a brazíliai Rio de Janeiro állam partjainál fekvő sziget, amelynek teljes területe megközelítőleg 193 négyzetkilométer. A sziget domborzatát meredek hegyvonulatok jellemzik, legmagasabb pontja a 982 méter magas Pico do Papagaio. Történelmileg a sziget több elkülönített funkciót is betöltött, működött itt lepratelep, majd 1994-ig itt állt a hírhedt Cândido Mendes börtön is. A börtön lebontása után a terület az ökoturizmus és a természetvédelem központjává vált, nagy részét az Ilha Grande Állami Park védi. A szigeten tilos a gépjárműforgalom, ami hozzájárult az Atlanti-parti Esőerdő maradványainak és a gazdag vadvilágának megőrzéséhez. 2019-ben az UNESCO a Világörökség részévé nyilvánította a területet Paraty városával együtt, elismerve annak biológiai és kulturális jelentőségét. A környező vizek fontos tengeri élőhelyek, ahol gyakran láthatók zöld teknősök és tengeri emlősök is.",
      ro: "Ilha Grande este o insulă situată în largul coastei statului Rio de Janeiro, Brazilia, având o suprafață totală de aproximativ 193 de kilometri pătrați. Relieful insulei este predominant muntos, atingând altitudinea maximă de 982 de metri în vârful Pico do Papagaio. Din punct de vedere istoric, insula a fost utilizată pentru izolare, găzduind o colonie de leproși și ulterior închisoarea de maximă siguranță Cândido Mendes, închisă definitiv în anul 1994. După demolarea penitenciarului, insula a devenit o destinație ecologică majoră, fiind protejată în mare parte de Parcul Statal Ilha Grande. Conservarea ecosistemului este facilitată de interzicerea vehiculelor motorizate, fapt ce a permis regenerarea pădurii atlantice și protejarea faunei diverse. În anul 2019, Ilha Grande a fost inclusă în patrimoniul mondial UNESCO, împreună cu orașul Paraty, pentru valoarea sa biologică și peisajele culturale. Astăzi, insula reprezintă un model de turism sustenabil și un laborator natural pentru cercetări marine.",
      en: "Ilha Grande is an island located off the coast of the state of Rio de Janeiro, Brazil, covering an area of approximately 193 square kilometers. The island's topography is characterized by rugged mountains, with the highest peak, Pico do Papagaio, reaching an altitude of 982 meters above sea level. Historically, the island served several isolated functions, including a leper colony and later the high-security Cândido Mendes prison, which operated until its closure in 1994. Since the prison's decommissioning, the island has transitioned into a major ecological destination, protected largely by the Ilha Grande State Park. The environment remains remarkably preserved due to a strict ban on motorized vehicles, which has helped maintain its extensive Atlantic Forest cover and diverse wildlife. In 2019, Ilha Grande, along with the nearby town of Paraty, was inscribed as a UNESCO World Heritage site for its unique combination of cultural and biological significance. Today, it is a center for sustainable tourism and scientific research regarding coastal ecosystems.",
      es: "Ilha Grande es un elemento notable de la geografía y la cultura brasileñas. Una isla tropical sin coches frente a la costa de Río de Janeiro, conocida por sus senderos selváticos. No hay vehículos motorizados en la isla. Antiguamente fue un refugio de piratas y una prisión. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "A Ilha Grande é um elemento notável da geografia e cultura brasileiras. Uma ilha tropical livre de carros na costa do Rio de Janeiro, conhecida por suas trilhas na selva. Não há veículos motorizados na ilha. Antigamente foi um reduto de piratas e uma prisão. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Ilha Grande est un élément remarquable de la géographie et de la culture brésiliennes. Une île tropicale sans voiture au large de Rio de Janeiro, connue pour ses sentiers dans la jungle. Il n'y a pas de véhicules motorisés sur l'île. C'était autrefois un repaire de pirates et une prison. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Die Insel umfasst eine Gesamtfläche von 193 Quadratkilometern.", "Der Pico do Papagaio ist mit 982 Metern der höchste Punkt.", "Das Cândido Mendes Gefängnis wurde im Jahr 1994 geschlossen.", "Auf der gesamten Insel sind motorisierte Fahrzeuge streng verboten.", "Die UNESCO nahm die Insel im Jahr 2019 in die Welterbeliste auf.", "Es gibt über 100 verschiedene Strände entlang der Küstenlinie."],
      hu: ["A sziget teljes területe 193 négyzetkilométer.", "A Pico do Papagaio csúcs magassága 982 méter.", "A hírhedt Cândido Mendes börtönt 1994-ben zárták be.", "A szigeten a gépjárművek használata szigorúan tilos.", "Az UNESCO 2019-ben vette fel a Világörökségi listára.", "A sziget partvonalán több mint 100 strand található."],
      ro: ["Insula are o suprafață totală de 193 de kilometri pătrați.", "Vârful Pico do Papagaio atinge o înălțime de 982 de metri.", "Închisoarea Cândido Mendes a fost închisă oficial în 1994.", "Vehiculele motorizate sunt complet interzise pe întreaga insulă.", "UNESCO a declarat insula sit al patrimoniului mondial în 2019.", "Există peste 100 de plaje distribuite pe circumferința insulei."],
      en: ["The island covers a total area of 193 square kilometers.", "Pico do Papagaio is the highest point at 982 meters.", "The Cândido Mendes prison was officially closed in 1994.", "Motorized vehicles are strictly prohibited on the entire island.", "UNESCO added the island to the World Heritage list in 2019.", "There are over 100 distinct beaches located along the coastline."],
      es: ["Una isla tropical sin coches frente a la costa de Río de Janeiro, conocida por sus senderos selváticos.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Uma ilha tropical livre de carros na costa do Rio de Janeiro, conhecida por suas trilhas na selva.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-ilha-grande-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Cea mai mare insulă fluvială din lume, cuibărită între două brațe ale râului Araguaia.",
      en: "The largest river island in the world, nestled between two branches of the Araguaia River.",
      es: "La isla fluvial más grande del mundo, situada entre dos brazos del río Araguaia.",
      pt: "A maior ilha fluvial do mundo, situada entre dois braços do Rio Araguaia.",
      fr: "La plus grande île fluviale au monde, nichée entre deux bras de la rivière Araguaia.",
    },
    facts: {
      de: ["Schützt den Araguaia-Nationalpark.", "Ist ein wichtiges Reservat für indigene Gemeinschaften."],
      ...
      es: ["Protege el Parque Nacional del Araguaia.", "Es una reserva importante para comunidades indígenas."],
      pt: ["Protege o Parque Nacional do Araguaia.", "É uma reserva importante para comunidades indígenas."],
      fr: ["Protège le parc national de l'Araguaia.", "Est une réserve importante pour les communautés autochtones."],
    },
    descriptionAdvanced: {
      de: "Die Ilha do Bananal befindet sich im brasilianischen Bundesstaat Tocantins und gilt mit einer Fläche von etwa 19.162 Quadratkilometern als die größte Binneninsel der Welt. Sie wird durch die Gabelung des Rio Araguaia gebildet, der sich in den Hauptarm und den Rio Javaés teilt, bevor die Flüsse sich weiter nördlich wieder vereinigen. Geographisch liegt die Insel in einer Übergangszone zwischen dem Amazonas-Regenwald und der Cerrado-Savanne, was zu einer außergewöhnlichen biologischen Vielfalt führt. Ein bedeutender Teil der Insel wird durch den Araguaia-Nationalpark geschützt, der 1959 gegründet wurde, um die lokale Flora und Fauna zu bewahren. Neben ihrer ökologischen Bedeutung beherbergt die Insel mehrere indigene Territorien, in denen die Völker der Karajá und Javaé in rechtlich geschützten Gebieten leben. Während der Regenzeit werden große Teile der Insel überflutet, was das Ökosystem maßgeblich beeinflusst und als natürlicher Filter fungiert. Der Zugang zur Insel ist streng reglementiert, um sowohl die empfindlichen Ökosysteme als auch die kulturelle Integrität der indigenen Gemeinschaften zu schützen.",
      hu: "Az Ilha do Bananal Brazília Tocantins államában található, és mintegy 19 162 négyzetkilométeres területével a világ legnagyobb folyami szigeteként tartják számon. A szigetet az Araguaia-folyó kettéágazása hozta létre, amely a Javaés-folyóra és az Araguaia főágára válik szét, majd északabbra újra egyesül. Földrajzilag az Amazonas-medence és a Cerrado szavanna találkozásánál fekszik, ami rendkívül gazdag és változatos élővilágot eredményez. A sziget északi részét az 1959-ben alapított Araguaia Nemzeti Park foglalja el, amely az őshonos növény- és állatvilág védelmét szolgálja. Ökológiai jelentősége mellett a sziget fontos kulturális központ is, mivel itt találhatók a Karajá és Javaé őslakos népek védett területei. Az esős évszakban a sziget jelentős része víz alá kerül, ami meghatározza a helyi ökoszisztémát és a mezőgazdasági ciklusokat. A területre való belépés korlátozott, hogy megőrizzék a biodiverzitást és az őslakos közösségek hagyományos életmódját.",
      ro: "Ilha do Bananal este situată în statul brazilian Tocantins și este recunoscută ca fiind cea mai mare insulă fluvială din lume, cu o suprafață de aproximativ 19.162 de kilometri pătrați. Insula este formată de bifurcația fluviului Araguaia în două brațe, brațul principal și râul Javaés, care se reunesc în partea de nord. Din punct de vedere geografic, se află într-o zonă de tranziție între pădurea amazoniană și savana Cerrado, găzduind o biodiversitate remarcabilă. Partea de nord a insulei este protejată prin Parcul Național Araguaia, înființat în anul 1959 pentru conservarea speciilor endemice. Pe lângă importanța ecologică, insula cuprinde teritorii indigene vaste unde trăiesc comunitățile Karajá și Javaé în zone protejate prin lege. În timpul sezonului ploios, suprafețe extinse ale insulei sunt inundate, proces esențial pentru menținerea echilibrului ecologic local. Accesul pe insulă este restricționat pentru a asigura protecția ecosistemelor fragile și a patrimoniului cultural indigen.",
      en: "Bananal Island is located in the Brazilian state of Tocantins and is recognized as the world's largest fluvial island, covering an area of approximately 19,162 square kilometers. The island is formed by the bifurcation of the Araguaia River into two branches, the main Araguaia and the Javaés River, which rejoin further north. Geographically, it sits in a transition zone between the Amazon rainforest and the Cerrado savanna, resulting in exceptional biological diversity. A significant portion of the island is protected by the Araguaia National Park, established in 1959 to preserve the local flora and fauna. Beyond its ecological importance, the island hosts several indigenous territories where the Karajá and Javaé peoples live in legally protected areas. During the rainy season, large parts of the island are flooded, a process that is vital for the local ecosystem and acts as a natural water filter. Access to the island is strictly regulated to protect both the fragile environments and the cultural integrity of the indigenous communities.",
      es: "La Isla del Bananal es un elemento notable de la geografía y la cultura brasileñas. La isla fluvial más grande del mundo, situada entre dos brazos del río Araguaia. Protege el Parque Nacional del Araguaia. Es una reserva importante para comunidades indígenas. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "A Ilha do Bananal é um elemento notável da geografia e cultura brasileiras. A maior ilha fluvial do mundo, situada entre dois braços do Rio Araguaia. Protege o Parque Nacional do Araguaia. É uma reserva importante para comunidades indígenas. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "L'île de Bananal est un élément remarquable de la géographie et de la culture brésiliennes. La plus grande île fluviale au monde, nichée entre deux bras de la rivière Araguaia. Elle protège le parc national de l'Araguaia. C'est une réserve importante pour les communautés autochtones. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Die Insel hat eine Fläche von etwa 19.162 Quadratkilometern.", "Sie gilt als die größte reine Binneninsel der Erde.", "Der Araguaia-Nationalpark wurde am 31. Dezember 1959 gegründet.", "Die Flüsse Araguaia und Javaés umschließen die Insel vollständig.", "Über 360 Vogelarten wurden auf der Insel offiziell dokumentiert.", "Die indigenen Völker der Karajá und Javaé bewohnen die Insel."],
      hu: ["A sziget területe körülbelül 19 162 négyzetkilométer.", "Ez a Föld legnagyobb édesvízi folyami szigete.", "Az Araguaia Nemzeti Parkot 1959. december 31-én hozták létre.", "Az Araguaia és a Javaés folyók határolják a szigetet.", "Több mint 360 madárfajt regisztráltak a területen.", "A Karajá és Javaé indián törzsek élnek a szigeten."],
      ro: ["Insula ocupă o suprafață de circa 19.162 de kilometri pătrați.", "Este considerată cea mai mare insulă fluvială de pe planetă.", "Parcul Național Araguaia a fost înființat la 31 decembrie 1959.", "Fluviile Araguaia și Javaés delimitează întregul perimetru al insulei.", "Peste 360 de specii de păsări au fost identificate pe insulă.", "Comunitățile indigene Karajá și Javaé dețin teritorii pe insulă."],
      en: ["The island covers an area of about 19,162 square kilometers.", "It is recognized as the largest fluvial island in the world.", "Araguaia National Park was established on December 31, 1959.", "The Araguaia and Javaés rivers completely encircle the island.", "Over 360 species of birds have been documented on the island.", "The Karajá and Javaé indigenous peoples inhabit the island."],
      es: ["La isla fluvial más grande del mundo, situada entre dos brazos del río Araguaia.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["A maior ilha fluvial do mundo, situada entre dois braços do Rio Araguaia.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
      fr: ["La plus grande île fluviale au monde, nichée entre deux bras de la rivière Araguaia.", "Situé sur le territoire de la République fédérative du Brésil.", "Joue un rôle dans l'identité locale de la région.", "Lié à la vie quotidienne et à l'histoire du pays.", "Sous l'influence du climat principalement tropical du Brésil."],
    }, image: "/poi-images/br-ilha-do-bananal-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "O insulă masivă de coastă la gura Amazonului, remarcată pentru bivolii săi de apă.",
      en: "A massive coastal island at the mouth of the Amazon, noted for its water buffaloes.",
      es: "Una enorme isla costera en la desembocadura del Amazonas, conocida por sus búfalos de agua.",
      pt: "Uma ilha costeira maciça na foz do Amazonas, conhecida por seus búfalos de água.",
      fr: "Une île côtière massive à l'embouchure de l'Amazone, connue pour ses buffles d'eau.",
    },
    facts: {
      de: ["Die größte Insel der Welt, die komplett von Süßwasser umgeben ist.", "Hier werden Wasserbüffel von der Polizei geritten."],
      ...
      es: ["La isla más grande del mundo rodeada completamente por agua dulce.", "Aquí, los búfalos de agua son montados por la policía."],
      pt: ["A maior ilha do mundo completamente cercada por água doce.", "Aqui, búfalos de água são montados pela polícia."],
      fr: ["La plus grande île au monde entièrement entourée d'eau douce.", "Ici, les buffles d'eau sont montés par la police."],
    },
    descriptionAdvanced: {
      de: "Die Ilha de Marajó liegt an der Mündung des Amazonas im brasilianischen Bundesstaat Pará und ist mit etwa 40.100 Quadratkilometern die größte Küsteninsel Brasiliens. Sie ist eine fluviomarine Insel, da sie sowohl vom Süßwasser des Amazonas als auch vom Salzwasser des Atlantiks umgeben ist. Die Geographie der Insel ist zweigeteilt: Der östliche Teil besteht aus offenen Savannen, während der westliche Teil von dichten tropischen Wäldern und Sumpfgebieten geprägt ist. Historisch ist Marajó für die präkolumbianische Marajoara-Kultur bekannt, die zwischen 400 und 1400 n. Chr. für ihre hochentwickelte Keramik berühmt war. Eine Besonderheit der heutigen Inselkultur ist die massive Präsenz von Wasserbüffeln, die ursprünglich aus Asien eingeführt wurden und heute als wichtigstes Transportmittel und Wirtschaftsfaktor dienen. Die Hauptstadt der Insel ist Soure, die für ihre koloniale Architektur und den Zugang zu weitläufigen Stränden bekannt ist. Aufgrund ihrer Lage am Äquator herrscht ein tropisches Klima mit einer ausgeprägten Regenzeit von Januar bis Juni, die weite Teile der Savannen in Seen verwandelt.",
      hu: "Az Ilha de Marajó az Amazonas torkolatánál, Brazília Pará államában található, és mintegy 40 100 négyzetkilométeres területével az ország legnagyobb partmenti szigete. Ez egy különleges, folyami-tengeri sziget, mivel egyszerre érintkezik az Amazonas édesvizével és az Atlanti-óceán sós vizével. A sziget tájképe kettéoszlik: a keleti részt nyitott szavannák jellemzik, míg a nyugati oldalt sűrű trópusi erdők és mocsarak borítják. Történelmileg Marajó a kolumbusz előtti Marajoara-kultúráról nevezetes, amely i.sz. 400 és 1400 között virágzott, és híres volt kifinomult díszítésű kerámiáiról. A sziget egyik legismertebb jellegzetessége a hatalmas bivalycsorda, amelyeket eredetileg Ázsiából hoztak be, és ma már a közlekedésben és a gazdaságban is kulcsszerepet játszanak. A sziget központja Soure városa, amely gyarmati építészetéről és a környező kiterjedt homokos strandjairól ismert. Az egyenlítői fekvés miatt a klíma trópusi, a januártól júniusig tartó esős évszakban pedig a szavannák nagy része ideiglenes tavakká alakul.",
      ro: "Insula Marajó este situată la gura de vărsare a Amazonului, în statul brazilian Pará, și are o suprafață de aproximativ 40.100 de kilometri pătrați, fiind cea mai mare insulă de coastă din Brazilia. Este o insulă fluvio-marină, fiind scăldată atât de apele dulci ale Amazonului, cât și de apele sărate ale Oceanului Atlantic. Geografia insulei este divizată: partea estică este compusă din savane deschise, în timp ce partea vestică este dominată de păduri tropicale dense și zone mlăștinoase. Din punct de vedere istoric, Marajó este faimoasă pentru cultura precolumbiană Marajoara, care a înflorit între anii 400 și 1400 d.Hr., fiind recunoscută pentru ceramica sa elaborată. O caracteristică unică a insulei moderne este populația masivă de bivoli de apă, introduși inițial din Asia, care servesc astăzi ca principal mijloc de transport și pilon economic. Soure este principalul oraș al insulei, renumit pentru arhitectura sa colonială și accesul la plaje vaste. Datorită locației sale pe Ecuator, insula are un climat tropical cu un sezon ploios intens între ianuarie și iunie.",
      en: "Marajó Island is located at the mouth of the Amazon River in the Brazilian state of Pará and is the largest coastal island in Brazil, covering about 40,100 square kilometers. It is a fluviomarine island, as it is surrounded by both the freshwater of the Amazon and the saltwater of the Atlantic Ocean. The island's geography is split into two distinct zones: the eastern part consists of open savannas, while the western part is dominated by dense tropical forests and wetlands. Historically, Marajó is famous for the pre-Columbian Marajoara culture, which thrived between 400 and 1400 AD and was renowned for its sophisticated ceramics. A unique feature of the island's modern culture is the massive presence of water buffaloes, originally introduced from Asia, which now serve as the main mode of transport and a key economic resource. The island's main hub is the town of Soure, known for its colonial architecture and proximity to extensive beaches. Due to its equatorial position, the climate is tropical, with a heavy rainy season from January to June that turns large parts of the savanna into lakes.",
      pt: "A Ilha de Marajó é um elemento notável da geografia e cultura brasileiras. Uma ilha costeira maciça na foz do Amazonas, conhecida por seus búfalos de água. A maior ilha do mundo completamente cercada por água doce. Aqui, búfalos de água são montados pela polícia. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "L'île de Marajó est un élément remarquable de la géographie et de la culture brésiliennes. Une île côtière massive à l'embouchure de l'Amazone, connue pour ses buffles d'eau. C'est la plus grande île au monde entièrement entourée d'eau douce. Ici, les buffles d'eau sont montés par la police. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
      es: "La Isla de Marajó es un elemento notable de la geografía y la cultura brasileñas. Una enorme isla costera en la desembocadura del Amazonas, conocida por sus búfalos de agua. Es la isla más grande del mundo rodeada completamente por agua dulce. Aquí, los búfalos de agua son montados por la policía. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
    },
    factsAdvanced: {
      de: ["Die Insel erstreckt sich über eine Fläche von 40.100 Quadratkilometern.", "Sie ist etwa so groß wie die Schweiz oder die Niederlande.", "Die Marajoara-Kultur existierte zwischen 400 und 1400 n. Chr.", "Es gibt schätzungsweise 500.000 Wasserbüffel auf der Insel.", "Die Insel wird im Norden vom Atlantischen Ozean begrenzt.", "Die Stadt Soure gilt als das wirtschaftliche Zentrum der Insel."],
      hu: ["A sziget területe meghaladja a 40 100 négyzetkilométert.", "Mérete körülbelül akkora, mint Svájc vagy Hollandia területe.", "A Marajoara-kultúra i.sz. 400 és 1400 között virágzott.", "Becslések szerint 500 000 bivaly él a sziget területén.", "Északon az Atlanti-óceán határolja a szigetet.", "Soure városa a sziget legfontosabb gazdasági központja."],
      ro: ["Insula se întinde pe o suprafață de 40.100 de kilometri pătrați.", "Dimensiunea sa este comparabilă cu cea a Elveției sau a Olandei.", "Cultura Marajoara s-a dezvoltat între anii 400 și 1400 d.Hr.", "Există aproximativ 500.000 de bivoli de apă pe insulă.", "Insula este limitată la nord de apele Oceanului Atlantic.", "Orașul Soure este considerat capitala economică a insulei."],
      en: ["The island covers an area of approximately 40,100 square kilometers.", "Its size is roughly comparable to Switzerland or the Netherlands.", "The Marajoara culture flourished between 400 and 1400 AD.", "There are estimated to be 500,000 water buffaloes on the island.", "The island is bordered to the north by the Atlantic Ocean.", "The town of Soure serves as the island's main economic center."],
      es: ["Una enorme isla costera en la desembocadura del Amazonas, conocida por sus búfalos de agua.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Uma ilha costeira maciça na foz do Amazonas, conhecida por seus búfalos de água.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-ilha-de-marajo-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Insula Frumoasă este o destinație populară de vacanță cu păduri luxuriante și numeroase cascade.",
      en: "The Beautiful Island is a popular vacation destination with lush forests and numerous waterfalls.",
      es: "Esta hermosa isla es un popular destino de vacaciones con bosques exuberantes y numerosas cascadas.",
      pt: "Esta bela ilha é um destino de férias popular com florestas exuberantes e inúmeras cachoeiras.",
      fr: "Cette belle île est une destination de vacances prisée, dotée de forêts luxuriantes et de nombreuses cascades.",
    },
    facts: {
      de: ["Rund 85 Prozent der Insel sind als Staatspark geschützt.", "Berühmt als Brasiliens Hauptstadt des Segelns."],
      ...
      es: ["Alrededor del 85 por ciento de la isla está protegida como parque estatal.", "Famosa como la capital de la vela de Brasil."],
      pt: ["Cerca de 85 por cento da ilha é protegida como parque estadual.", "Famosa como a capital da vela do Brasil."],
      fr: ["Environ 85 % de l'île est protégée en tant que parc d'État.", "Célèbre comme la capitale brésilienne de la voile."],
    },
    descriptionAdvanced: {
      de: "Ilhabela ist ein Archipel und eine Stadtgemeinde im Bundesstaat São Paulo, etwa 200 Kilometer östlich der Landeshauptstadt gelegen. Die Hauptinsel, São Sebastião, erstreckt sich über 347 Quadratkilometer und zeichnet sich durch ein extrem gebirgiges Relief aus, das vom Pico do Japi mit 1.307 Metern dominiert wird. Rund 85 % der Inselfläche sind durch den Staatspark Ilhabela geschützt, der eines der besterhaltenen Gebiete des Atlantischen Regenwaldes (Mata Atlântica) in Brasilien umfasst. Die Insel ist bekannt für ihre hohe Dichte an Wasserfällen, von denen über 300 kartiert sind, sowie für ihre zahlreichen Strände an der geschützten Westküste und der wilderen Ostküste. Historisch war die Region ein wichtiger Stützpunkt für den Kaffee- und Zuckerrohranbau im 19. Jahrhundert, wovon heute noch Ruinen alter Plantagen (Fazendas) zeugen. Heute ist Ilhabela als die 'Segelhauptstadt Brasiliens' bekannt und ist jährlich Austragungsort bedeutender internationaler Regatten. Die lokale Fauna umfasst seltene Arten wie den Ozelot und zahlreiche endemische Vogelarten, die in den dichten Wäldern des Nationalparks Zuflucht finden.",
      hu: "Ilhabela egy szigetcsoport és település São Paulo államban, mintegy 200 kilométerre keletre az állam székhelyétől. A fősziget, São Sebastião, 347 négyzetkilométeren terül el, és rendkívül hegyvidéki domborzat jellemzi, amelynek legmagasabb pontja az 1307 méteres Pico do Japi. A sziget területének körülbelül 85%-át az Ilhabela Állami Park védi, amely az Atlanti-parti Esőerdő egyik legjobb állapotban fennmaradt maradványa Brazíliában. A sziget híres a vízeséseiről, amelyekből több mint 300-at tartanak nyilván, valamint változatos partvonaláról, amely a nyugati oldalon védett, a keletin pedig vadregényes. Történelmileg a régió fontos kávé- és cukornádtermesztő központ volt a 19. században, aminek emlékét régi ültetvények (fazendák) romjai őrzik. Napjainkban Ilhabela 'Brazília vitorlás fővárosaként' ismert, és minden évben rangos nemzetközi vitorlásversenyeknek ad otthont. A helyi élővilág olyan ritka fajokat foglal magában, mint az ocelot, valamint számos endemikus madárfaj, amelyek a sűrű erdőkben találnak menedéket.",
      ro: "Ilhabela este un arhipelag și o municipalitate din statul São Paulo, situată la aproximativ 200 de kilometri est de capitala statului. Insula principală, São Sebastião, se întinde pe 347 de kilometri pătrați și prezintă un relief muntos accentuat, dominat de vârful Pico do Japi, care atinge 1.307 metri. Circa 85% din suprafața insulei este protejată prin Parcul Statal Ilhabela, care conservă una dintre cele mai bine păstrate porțiuni de pădure atlantică (Mata Atlântica) din Brazilia. Insula este renumită pentru densitatea sa mare de cascade, peste 300 fiind cartografiate, și pentru plajele sale diverse, de la cele adăpostite din vest la cele sălbatice din est. Din punct de vedere istoric, regiunea a fost un centru important pentru producția de cafea și trestie de zahăr în secolul al XIX-lea, vestigiile vechilor ferme (fazendas) fiind încă vizibile. Astăzi, Ilhabela este cunoscută drept 'Capitala Velierelor din Brazilia', găzduind anual competiții nautice internaționale de prestigiu. Fauna locală include specii rare, precum ocelotul, și numeroase păsări endemice care trăiesc în pădurile dense ale parcului.",
      en: "Ilhabela is an archipelago and municipality in the state of São Paulo, located about 200 kilometers east of the state capital. The main island, São Sebastião, covers 347 square kilometers and is characterized by an extremely mountainous relief, dominated by Pico do Japi at 1,307 meters. Approximately 85% of the island's area is protected by the Ilhabela State Park, which encompasses one of the best-preserved remnants of the Atlantic Forest (Mata Atlântica) in Brazil. The island is famous for its high density of waterfalls, with over 300 documented, and its diverse coastline featuring sheltered western beaches and rugged eastern shores. Historically, the region was an important hub for coffee and sugarcane production during the 19th century, with ruins of old plantations (fazendas) still present today. Nowadays, Ilhabela is known as the 'Sailing Capital of Brazil' and hosts prestigious international regattas annually. The local fauna includes rare species like the ocelot and numerous endemic birds that find refuge in the dense forests of the state park.",
      es: "Ilhabela es un elemento notable de la geografía y la cultura brasileñas. Esta hermosa isla es un popular destino de vacaciones con bosques exuberantes y numerosas cascadas. Alrededor del 85 por ciento de la isla está protegida como parque estatal. Famosa como la capital de la vela de Brasil. Esta área natural muestra la diversidad paisajística de Brasil, desde la región amazónica pasando por el Pantanal hasta el Cerrado. Como muchos lugares importantes de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil versátil de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "Ilhabela é um elemento notável da geografia e cultura brasileiras. Esta bela ilha é um destino de férias popular com florestas exuberantes e inúmeras cachoeiras. Cerca de 85 por cento da ilha é protegida como parque estadual. Famosa como a capital da vela do Brasil. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Ilhabela est un élément remarquable de la géographie et de la culture brésiliennes. Cette belle île est une destination de vacances prisée, dotée de forêts luxuriantes et de nombreuses cascades. Environ 85 % de l'île est protégée en tant que parc d'État. Célèbre comme la capitale brésilienne de la voile. Cette zone naturelle illustre la diversité paysagère du Brésil, de la région amazonienne au Cerrado en passant par le Pantanal. Comme de nombreux lieux importants du Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Ainsi, ce lieu contribue au profil polyvalent du Brésil, où la nature tropicale, l'héritage portugais, la samba, le football et le carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Die Hauptinsel São Sebastião umfasst 347 Quadratkilometer Fläche.", "Der Pico do Japi ist mit 1.307 Metern die höchste Erhebung.", "Rund 85 % der Insel stehen unter staatlichem Naturschutz.", "Es gibt über 300 kartierte Wasserfälle auf dem Archipel.", "Ilhabela gilt offiziell als die Segelhauptstadt Brasiliens.", "Die Insel liegt im Durchschnitt 4 Kilometer vom Festland entfernt."],
      hu: ["A São Sebastião fősziget területe 347 négyzetkilométer.", "A Pico do Japi csúcs magassága 1307 méter.", "A sziget területének 85%-a természetvédelmi terület.", "Több mint 300 regisztrált vízesés található a szigeten.", "Ilhabelát Brazília vitorlás fővárosának nevezik.", "A sziget átlagosan 4 kilométerre fekszik a szárazföldtől."],
      ro: ["Insula principală, São Sebastião, are o suprafață de 347 km2.", "Vârful Pico do Japi atinge altitudinea de 1.307 metri.", "Aproximativ 85% din teritoriu este arie naturală protejată.", "Peste 300 de cascade au fost identificate pe arhipelag.", "Ilhabela este recunoscută ca fiind capitala velierelor din Brazilia.", "Insula se află la o distanță de circa 4 km de continent."],
      en: ["The main island, São Sebastião, covers 347 square kilometers.", "Pico do Japi is the highest peak at 1,307 meters.", "About 85% of the island's territory is legally protected.", "There are over 300 documented waterfalls on the archipelago.", "Ilhabela is officially known as the Sailing Capital of Brazil.", "The island is located on average 4 kilometers from the mainland."],
      es: ["Esta hermosa isla es un popular destino de vacaciones con bosques exuberantes y numerosas cascadas.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado con la vida cotidiana y la historia del país.", "Está bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Esta bela ilha é um destino de férias popular com florestas exuberantes e inúmeras cachoeiras.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Conectado ao cotidiano e à história do país.", "Está sob a influência do clima predominantemente tropical do Brasil."],
      fr: ["Cette belle île est une destination de vacances prisée, dotée de forêts luxuriantes et de nombreuses cascades.", "Situé sur le territoire de la République fédérative du Brésil.", "Joue un rôle dans l'identité locale de la région.", "Lié à la vie quotidienne et à l'histoire du pays.", "Sous l'influence du climat principalement tropical du Brésil."],
    }, image: "/poi-images/br-ilhabela-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Cea mai mare pădure tropicală de pe Pământ, crucială pentru reglarea climatului global.",
      en: "The largest tropical rainforest on Earth, crucial for regulating the global climate.",
      es: "La selva tropical más grande de la Tierra, crucial para la regulación del clima mundial.",
      pt: "A maior floresta tropical da Terra, crucial para a regulação do clima mundial.",
      fr: "La plus grande forêt tropicale de la Terre, cruciale pour la régulation du climat mondial.",
    },
    facts: {
      de: ["Beherbergt schätzungsweise 10 Prozent der weltweit bekannten Arten.", "Wird oft als Lunge der Erde bezeichnet."],
      ...
      es: ["Alberga aproximadamente el 10 por ciento de las especies conocidas en el mundo.", "A menudo se le denomina el pulmón de la Tierra."],
      pt: ["Abriga cerca de 10 por cento das espécies conhecidas mundialmente.", "Frequentemente chamada de pulmão do mundo."],
      fr: ["Abrite environ 10 % des espèces connues dans le monde.", "Souvent qualifiée de poumon de la Terre."],
    },
    descriptionAdvanced: {
      de: "Der Amazonas-Regenwald ist das größte tropische Waldgebiet der Erde und erstreckt sich über eine Fläche von etwa 5,5 Millionen Quadratkilometern, wovon etwa 60 % auf brasilianischem Staatsgebiet liegen. Das Ökosystem spielt eine entscheidende Rolle im globalen Klimasystem, indem es riesige Mengen an Kohlendioxid speichert und als 'Lunge des Planeten' fungiert. Der Wald beherbergt etwa 10 % der weltweit bekannten Artenvielfalt, darunter geschätzte 390 Milliarden einzelne Bäume aus 16.000 verschiedenen Arten. Das hydrologische System wird vom Amazonas-Fluss dominiert, der nach Volumen der größte Fluss der Welt ist und jährlich Billionen Tonnen Wasser in den Atlantik transportiert. Historisch gesehen war die Region Schauplatz des Kautschukbooms im späten 19. Jahrhundert, der Städte wie Manaus und Belém zu großem Wohlstand verhalf. Heute steht der Regenwald vor massiven Herausforderungen durch Entwaldung, Bergbau und landwirtschaftliche Expansion, was weitreichende Folgen für die indigenen Völker und die globale Biodiversität hat. Mehr als 400 indigene Gruppen bewohnen das Becken und bewahren traditionelles Wissen über die medizinische Nutzung von Pflanzen und nachhaltige Ressourcennutzung.",
      hu: "Az Amazonas-esőerdő a Föld legnagyobb trópusi erdősége, amely mintegy 5,5 millió négyzetkilométeren terül el, és területének 60%-a Brazíliában található. Ez az ökoszisztéma döntő szerepet játszik a globális éghajlati rendszerben, mivel hatalmas mennyiségű szén-dioxidot köt le, ezért gyakran a 'bolygó tüdejének' nevezik. Az erdő ad otthont a világ ismert biodiverzitásának körülbelül 10%-ának, beleértve becslések szerint 390 milliárd fát és 16 000 különböző fafajt. A terület vízi rendszerét az Amazonas-folyó határozza meg, amely vízhozamát tekintve a világ legnagyobb folyója, és évente több billió tonna édesvizet juttat az Atlanti-óceánba. Történelmileg a régió a 19. század végén zajló gumiláz helyszíne volt, amely olyan városokat tett gazdaggá, mint Manaus és Belém. Napjainkban az esőerdő súlyos veszélyekkel néz szembe az erdőirtás, a bányászat és a mezőgazdasági terjeszkedés miatt, ami súlyos következményekkel jár az őslakos népekre és a globális élővilágra. A medencében több mint 400 őslakos csoport él, akik megőrizték hagyományos ismereteiket a növények gyógyászati felhasználásáról.",
      ro: "Pădurea amazoniană este cea mai mare pădure tropicală din lume, întinzându-se pe o suprafață de aproximativ 5,5 milioane de kilometri pătrați, din care circa 60% se află pe teritoriul Braziliei. Acest ecosistem joacă un rol crucial în sistemul climatic global prin stocarea unor cantități uriașe de dioxid de carbon, fiind supranumit 'plămânul planetei'. Pădurea găzduiește aproximativ 10% din biodiversitatea cunoscută la nivel mondial, incluzând aproximativ 390 de miliarde de arbori individuali din 16.000 de specii diferite. Sistemul hidrologic este dominat de fluviul Amazon, cel mai mare fluviu din lume după debit, care transportă anual trilioane de tone de apă spre Oceanul Atlantic. Din punct de vedere istoric, regiunea a fost centrul 'boom-ului cauciucului' la sfârșitul secolului al XIX-lea, perioadă care a adus o prosperitate imensă orașelor Manaus și Belém. În prezent, pădurea se confruntă cu provocări majore din cauza defrișărilor, mineritului și expansiunii agricole, având consecințe grave pentru populațiile indigene și echilibrul ecologic. Peste 400 de grupuri indigene locuiesc în bazinul Amazonului, păstrând cunoștințe tradiționale despre medicina plantelor.",
      en: "The Amazon Rainforest is the largest tropical forest on Earth, covering approximately 5.5 million square kilometers, with about 60% of its area within Brazilian territory. This ecosystem plays a critical role in the global climate system by sequestering vast amounts of carbon dioxide, earning it the nickname 'the lungs of the planet.' The forest is home to about 10% of the world's known biodiversity, including an estimated 390 billion individual trees belonging to 16,000 different species. The hydrological system is dominated by the Amazon River, the world's largest river by discharge, which transports trillions of tons of water to the Atlantic Ocean annually. Historically, the region was the site of the rubber boom in the late 19th century, which brought immense wealth to cities like Manaus and Belém. Today, the rainforest faces significant threats from deforestation, mining, and agricultural expansion, with far-reaching consequences for indigenous peoples and global biodiversity. More than 400 indigenous groups inhabit the basin, maintaining traditional knowledge of medicinal plants and sustainable resource management.",
      es: "La Selva Amazónica es un elemento notable de la geografía y cultura brasileñas. Es el bosque tropical más extenso del planeta y alberga aproximadamente el 10 por ciento de las especies conocidas en el mundo. A menudo se le denomina el pulmón de la Tierra. Este ecosistema muestra la inmensa diversidad natural de Brasil. Como muchos lugares significativos de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. De este modo, contribuye al perfil polifacético de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "A Floresta Amazônica é um elemento notável da geografia e cultura brasileiras. É a maior floresta tropical do mundo, abrigando cerca de 10 por cento das espécies conhecidas globalmente. Frequentemente chamada de pulmão do mundo, esta área natural demonstra a diversidade paisagística do Brasil. Como muitos lugares significativos no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, contribui para o perfil multifacetado do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "La forêt amazonienne est un élément remarquable de la géographie et de la culture brésiliennes. Plus grande forêt tropicale de la planète, elle abrite environ 10 % des espèces connues dans le monde. Souvent qualifiée de poumon de la Terre, elle témoigne de l'immense diversité naturelle du Brésil. Comme beaucoup de lieux importants au Brésil, ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Il contribue ainsi au profil multiforme du Brésil, où nature tropicale, héritage portugais, samba, football et carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Das gesamte Amazonasbecken umfasst etwa 7 Millionen Quadratkilometer.", "Etwa 60 % des Regenwaldes befinden sich innerhalb Brasiliens.", "Man schätzt die Anzahl der Bäume im Amazonas auf 390 Milliarden.", "Der Amazonas-Fluss liefert 20 % des Süßwassers in die Ozeane.", "Über 16.000 verschiedene Baumarten wurden bisher identifiziert.", "Mehr als 400 verschiedene indigene Stämme leben im Regenwald."],
      hu: ["Az Amazonas-medence teljes területe 7 millió négyzetkilométer.", "Az esőerdő területének körülbelül 60%-a Brazíliához tartozik.", "Becslések szerint 390 milliárd fa található az esőerdőben.", "Az Amazonas szállítja az óceánokba jutó édesvíz 20%-át.", "Eddig több mint 16 000 különböző fafajt azonosítottak a kutatók.", "Több mint 400 különböző őslakos törzs él a területen."],
      ro: ["Bazinul Amazonului ocupă o suprafață totală de 7 milioane km2.", "Aproximativ 60% din pădurea tropicală se află în interiorul Braziliei.", "Se estimează că există 390 de miliarde de arbori în Amazonia.", "Fluviul Amazon furnizează 20% din apa dulce care ajunge în oceane.", "Peste 16.000 de specii de arbori au fost identificate până în prezent.", "Mai mult de 400 de triburi indigene diferite trăiesc în pădure."],
      en: ["The entire Amazon basin covers about 7 million square kilometers.", "Approximately 60% of the rainforest is located within Brazil.", "There are an estimated 390 billion trees in the Amazon.", "The Amazon River provides 20% of the freshwater entering oceans.", "Over 16,000 different tree species have been identified so far.", "More than 400 distinct indigenous tribes live within the rainforest."],
      es: ["La selva tropical más grande de la Tierra, crucial para la regulación del clima mundial.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculada a la vida cotidiana y la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["A maior floresta tropical da Terra, crucial para a regulação do clima mundial.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligada à vida quotidiana e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-amazon-rainforest-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Un biom extrem de amenințat, dar divers biologic de-a lungul coastei de est a Braziliei.",
      en: "A highly threatened but extremely biodiverse biome along the eastern coast of Brazil.",
      es: "Un bioma altamente amenazado pero extremadamente biodiverso a lo largo de la costa este de Brasil.",
      pt: "Um bioma altamente ameaçado, mas extremamente biodiverso ao longo da costa leste do Brasil.",
      fr: "Un biome gravement menacé mais extrêmement riche en biodiversité le long de la côte est du Brésil.",
    },
    facts: {
      de: ["Heute existieren nur noch etwa 12 Prozent des ursprünglichen Waldes.", "Heimat des goldenen Löwenäffchens."],
      ...
      es: ["Hoy solo existe cerca del 12 por ciento del bosque original.", "Hogar del tití leoncito."],
      pt: ["Hoje, restam apenas cerca de 12 por cento da floresta original.", "Lar do mico-leão-dourado."],
      fr: ["Aujourd'hui, il ne reste qu'environ 12 % de la forêt originelle.", "Habitat du tamarin-lion doré."],
    },
    descriptionAdvanced: {
      de: "Der Atlantische Regenwald (Mata Atlântica) erstreckt sich entlang der brasilianischen Ostküste und gehört zu den artenreichsten und gleichzeitig am stärksten bedrohten Ökosystemen der Welt. Ursprünglich bedeckte der Wald eine Fläche von etwa 1,3 Millionen Quadratkilometern, doch heute sind nur noch etwa 12 % bis 15 % der ursprünglichen Fläche in fragmentierter Form erhalten. Trotz dieser massiven Zerstörung beherbergt er eine außergewöhnliche Anzahl endemischer Arten; etwa 40 % der Wirbeltiere und über 50 % der Pflanzenarten kommen nirgendwo sonst auf der Erde vor. Die Vegetation reicht von Küstenmangroven und Restinga bis hin zu montanen Nebelwäldern in den höheren Lagen der Serra do Mar. Historisch gesehen war die Mata Atlântica das erste Gebiet Brasiliens, das durch die Kolonialisierung und die Errichtung von Zuckerrohr- und Kaffeeplantagen sowie die spätere Urbanisierung massiv verändert wurde. Heute leben mehr als 70 % der brasilianischen Bevölkerung im ehemaligen Verbreitungsgebiet des Waldes, was den Druck auf die verbleibenden Schutzgebiete erhöht. Internationale und nationale Naturschutzorganisationen arbeiten intensiv an der Wiederaufforstung und der Schaffung ökologischer Korridore, um den genetischen Austausch zwischen den isolierten Waldfragmenten zu ermöglichen.",
      hu: "Az Atlanti-parti Esőerdő (Mata Atlântica) Brazília keleti partvonala mentén húzódik, és a világ egyik legváltozatosabb, ugyanakkor legveszélyeztetettebb ökoszisztémája. Eredetileg mintegy 1,3 millió négyzetkilométert borított, de mára az eredeti területnek csupán 12-15%-a maradt fenn, töredezett formában. A pusztulás ellenére rendkívüli az endemikus fajok száma; a gerincesek 40%-a és a növényfajok több mint 50%-a sehol máshol nem található meg a Földön. A növényzet a partmenti mangrovéktól és restingáktól a Serra do Mar magasabb régióiban található köderdőkig terjed. Történelmileg ez volt Brazília első olyan területe, amelyet a gyarmatosítás, a cukornád- és kávéültetvények, valamint a későbbi városiasodás drasztikusan átalakított. Ma Brazília lakosságának több mint 70%-a az erdő egykori területén él, ami folyamatos nyomást gyakorol a megmaradt védett területekre. Nemzetközi és hazai természetvédelmi szervezetek intenzíven dolgoznak az erdőfelújításon és az ökológiai folyosók létrehozásán, hogy biztosítsák a genetikai cserét az izolált erdőfoltok között.",
      ro: "Pădurea Atlantică (Mata Atlântica) se întinde de-a lungul coastei de est a Braziliei și reprezintă unul dintre cele mai bogate și totodată cele mai amenințate ecosisteme de pe planetă. Inițial, pădurea acoperea o suprafață de aproximativ 1,3 milioane de kilometri pătrați, însă astăzi mai subzistă doar circa 12%-15% din suprafața originală sub formă fragmentată. În ciuda degradării masive, aceasta găzduiește un număr extraordinar de specii endemice; aproximativ 40% din vertebrate și peste 50% din speciile de plante nu se mai găsesc nicăieri altundeva pe Pământ. Vegetația variază de la mangrove de coastă și restinga până la păduri montane de ceață în zonele înalte din Serra do Mar. Din punct de vedere istoric, Mata Atlântica a fost prima regiune din Brazilia afectată major de colonizare, prin înființarea plantațiilor de trestie de zahăr și cafea, urmată de urbanizarea intensă. Astăzi, peste 70% din populația Braziliei trăiește în zonele care au fost odinioară acoperite de această pădure, crescând presiunea asupra ariilor protejate. Organizațiile internaționale depun eforturi pentru reîmpădurire și crearea de coridoare ecologice între fragmentele izolate.",
      en: "The Atlantic Forest (Mata Atlântica) extends along the eastern coast of Brazil and is one of the most biodiverse yet most threatened ecosystems in the world. Originally covering approximately 1.3 million square kilometers, only about 12% to 15% of its original area remains today in a fragmented state. Despite this massive destruction, it hosts an extraordinary number of endemic species; about 40% of its vertebrates and over 50% of its plant species are found nowhere else on Earth. The vegetation ranges from coastal mangroves and restingas to montane cloud forests in the higher elevations of the Serra do Mar. Historically, the Mata Atlântica was the first area of Brazil to be heavily impacted by colonization, with the establishment of sugarcane and coffee plantations and later urbanization. Today, more than 70% of the Brazilian population lives within the forest's former range, increasing pressure on the remaining protected areas. International and national conservation organizations are working intensively on reforestation and the creation of ecological corridors to enable genetic exchange between isolated forest fragments.",
      es: "La Mata Atlántica es un elemento notable de la geografía y cultura brasileñas. Es un bioma en peligro crítico pero con una biodiversidad extrema a lo largo de la costa oriental. Hoy solo existe cerca del 12 por ciento del bosque original. Es el hogar del tití leoncito. Este ecosistema refleja la diversidad paisajística de Brasil. Como muchos lugares significativos de Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. De este modo, contribuye al perfil polifacético de Brasil, donde la naturaleza tropical, la herencia portuguesa, la samba, el fútbol y el carnaval se entrelazan.",
      pt: "A Mata Atlântica é um elemento notável da geografia e cultura brasileiras. É um bioma altamente ameaçado, mas extremamente biodiverso ao longo da costa leste do Brasil. Hoje, restam apenas cerca de 12 por cento da floresta original. É o lar do mico-leão-dourado. Esta área natural demonstra a diversidade paisagística do Brasil. Como muitos lugares significativos no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, contribui para o perfil multifacetado do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "La Forêt atlantique (Mata Atlântica) est un élément remarquable de la géographie et de la culture brésiliennes. C'est un biome gravement menacé mais extrêmement riche en biodiversité le long de la côte est du Brésil. Aujourd'hui, il ne reste qu'environ 12 % de la forêt originelle. C'est l'habitat du tamarin-lion doré. Ce site allie les particularités régionales à l'importance globale du cinquième plus grand pays du monde. Il contribue ainsi au profil multiforme du Brésil, où nature tropicale, héritage portugais, samba, football et carnaval s'entremêlent.",
    },
    factsAdvanced: {
      de: ["Ursprünglich bedeckte der Wald etwa 1,3 Millionen Quadratkilometer.", "Heute sind weniger als 15 % der ursprünglichen Fläche erhalten.", "Über 50 % der dortigen Pflanzenarten sind weltweit endemisch.", "Mehr als 70 % der Brasilianer leben in diesem Ökosystem.", "UNESCO ernannte Teile des Waldes zum Biosphärenreservat.", "Über 20.000 verschiedene Pflanzenarten wurden dort registriert."],
      hu: ["Az erdő eredeti kiterjedése 1,3 millió négyzetkilométer volt.", "Mára az eredeti terület kevesebb mint 15%-a maradt meg.", "A területen található növényfajok több mint 50%-a endemikus.", "A brazíliai lakosság több mint 70%-a ezen a területen él.", "Az UNESCO bioszféra-rezervátumnak nyilvánította az erdő részeit.", "Több mint 20 000 növényfajt regisztráltak a kutatók a régióban."],
      ro: ["Suprafața originală a pădurii era de 1,3 milioane de km2.", "În prezent, mai puțin de 15% din suprafața inițială este păstrată.", "Peste 50% din speciile de plante de aici sunt endemice.", "Mai mult de 70% din populația Braziliei locuiește în această zonă.", "UNESCO a inclus porțiuni din pădure în Rețeaua Rezervațiilor Biosferei.", "Peste 20.000 de specii de plante diferite au fost identificate aici."],
      en: ["The forest originally covered about 1.3 million square kilometers.", "Less than 15% of the original forest area remains today.", "Over 50% of the plant species found here are endemic.", "More than 70% of Brazilians live within the forest's former range.", "UNESCO designated parts of the forest as a Biosphere Reserve.", "Over 20,000 different plant species have been recorded here."],
      es: ["Un bioma altamente amenazado pero extremadamente biodiverso a lo largo de la costa este de Brasil.", "Se encuentra en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculada a la vida cotidiana y la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["Um bioma altamente ameaçado, mas extremamente biodiverso ao longo da costa leste do Brasil.", "Localiza-se no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligada à vida quotidiana e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
    ...
    }, image: "/poi-images/br-atlantic-forest-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Cea mai mare pădure tropicală urbană din lume, reîmpădurită manual în inima Rio de Janeiro.",
      en: "The largest urban rainforest in the world, reforested by hand in the heart of Rio de Janeiro.",
      es: "El bosque urbano más grande del mundo, replantado a mano en el corazón de Río de Janeiro.",
      pt: "A maior floresta urbana do mundo, reflorestada à mão no coração do Rio de Janeiro.",
      fr: "La plus grande forêt urbaine du monde, replantée à la main au cœur de Rio de Janeiro.",
    },
    facts: {
      de: ["Schützt die Wasserquellen von Rio de Janeiro.", "Beherbergt die berühmte Christusstatue."],
      ...
      es: ["Protege las fuentes de agua de Río de Janeiro.", "Alberga la famosa estatua del Cristo Redentor."],
      pt: ["Protege as fontes de água do Rio de Janeiro.", "Abriga a famosa estátua do Cristo Redentor."],
      fr: ["Protège les sources d'eau de Rio de Janeiro.", "Abrite la célèbre statue du Christ Rédempteur."],
    },
    descriptionAdvanced: {
      de: "Der Tijuca-Wald in Rio de Janeiro gilt als einer der größten Stadtwälder der Welt und ist ein bemerkenswertes Beispiel für eine erfolgreiche ökologische Wiederherstellung. Im 18. und frühen 19. Jahrhundert wurde das ursprüngliche Waldgebiet fast vollständig gerodet, um Platz für Kaffeeplantagen und Holzkohleproduktion zu machen. Dies führte zu einer schweren Wasserknappheit in der Stadt, woraufhin Kaiser Pedro II. im Jahr 1861 den Befehl zur Wiederaufforstung gab. Unter der Leitung von Major Manuel Archer wurden in den folgenden 13 Jahren über 100.000 Setzlinge gepflanzt, überwiegend einheimische Arten der Mata Atlântica. Heute ist das Gebiet als Tijuca-Nationalpark geschützt und umfasst eine Fläche von etwa 39,5 Quadratkilometern. Der Park beherbergt markante geologische Formationen wie den Pico da Tijuca (1.021 m) und den berühmten Corcovado mit der Christusstatue. Neben seiner Funktion als Naherholungsgebiet für Millionen von Menschen dient der Wald als entscheidender Wasserspeicher und reguliert das Mikroklima von Rio de Janeiro, indem er die Temperaturen in den umliegenden Stadtteilen senkt.",
      hu: "A Rio de Janeiróban található Tijuca-erdő a világ egyik legnagyobb városi erdője, és az ökológiai helyreállítás egyik legjelentősebb példája. A 18. és a 19. század elején az eredeti erdőterületet szinte teljesen kiirtották, hogy kávéültetvényeket hozzanak létre és faszenet termeljenek. Ez súlyos vízhiányhoz vezetett a városban, ami miatt II. Péter császár 1861-ben elrendelte a terület újraerdősítését. Manuel Archer őrnagy vezetésével a következő 13 évben több mint 100 000 csemetét ültettek el, főként az Atlanti-parti Esőerdő őshonos fajaiból. Ma a terület a Tijuca Nemzeti Park része, és mintegy 39,5 négyzetkilométeren terül el. A park olyan ikonikus földrajzi képződményeknek ad otthont, mint az 1021 méter magas Pico da Tijuca és a híres Corcovado-hegy a Megváltó Krisztus szobrával. Amellett, hogy több millió ember számára biztosít kikapcsolódási lehetőséget, az erdő kulcsfontosságú víztározóként szolgál, és szabályozza Rio de Janeiro mikroklímáját, csökkentve a környező városrészek hőmérsékletét.",
      ro: "Pădurea Tijuca din Rio de Janeiro este considerată una dintre cele mai mari păduri urbane din lume și reprezintă un exemplu remarcabil de restaurare ecologică. În secolul al XVIII-lea și începutul secolului al XIX-lea, suprafața forestieră originală a fost aproape complet defrișată pentru a face loc plantațiilor de cafea și producției de cărbune. Această degradare a cauzat o criză severă de apă în oraș, determinându-l pe împăratul Pedro al II-lea să ordone reîmpădurirea în anul 1861. Sub conducerea maiorului Manuel Archer, peste 100.000 de puieți au fost plantați în următorii 13 ani, majoritatea fiind specii native din pădurea atlantică. Astăzi, zona este protejată sub numele de Parcul Național Tijuca și ocupă o suprafață de aproximativ 39,5 kilometri pătrați. Parcul include formațiuni geologice celebre, precum Pico da Tijuca (1.021 m) și muntele Corcovado cu statuia lui Isus Mântuitorul. Pe lângă funcția recreativă pentru milioane de locuitori, pădurea servește ca rezervor crucial de apă și reglează microclimatul orașului Rio de Janeiro, reducând temperaturile locale.",
      ...
      es: "El Bosque de Tijuca es un elemento notable de la geografía y la cultura brasileñas. Es el bosque urbano más grande del mundo, recuperado manualmente en el centro de Río de Janeiro. Protege las fuentes de agua de la ciudad y alberga la famosa estatua del Cristo Redentor. Este espacio natural refleja la variedad de paisajes de Brasil, desde el Amazonas hasta el Pantanal y el Cerrado. Al igual que otros sitios clave de Brasil, combina rasgos regionales con la relevancia nacional del quinto país más grande del mundo. De este modo, contribuye a la imagen diversa de Brasil, donde conviven la naturaleza tropical, el legado portugués, el samba, el fútbol y el carnaval.",
      pt: "A Floresta da Tijuca é um elemento notável da geografia e cultura brasileiras. A maior floresta urbana do mundo, que foi reflorestada à mão no coração do Rio de Janeiro. Protege as fontes de água do Rio de Janeiro e abriga a famosa estátua do Cristo Redentor. Esta área natural mostra a diversidade de paisagens do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares significativos no Brasil, este local une características regionais com a importância global do quinto maior país do mundo. Com isso, este lugar contribui para o perfil variado do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se integram.",
      fr: "La forêt de Tijuca est un élément remarquable de la géographie et de la culture brésiliennes. C'est la plus grande forêt urbaine du monde, reboisée à la main au cœur de Rio de Janeiro. Elle protège les sources d'eau de la ville et abrite la célèbre statue du Christ Rédempteur. Cet espace naturel illustre la diversité des paysages du Brésil, de l'Amazonie au Pantanal en passant par le Cerrado. Comme beaucoup de sites majeurs au Brésil, ce lieu allie des spécificités régionales à l'importance du cinquième plus grand pays du monde. Il participe ainsi au profil riche du Brésil, où se côtoient nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Die offizielle Wiederaufforstung begann im Jahr 1861.", "Major Manuel Archer pflanzte über 100.000 Bäume in 13 Jahren.", "Der Tijuca-Nationalpark umfasst etwa 39,5 Quadratkilometer.", "Der Pico da Tijuca ist mit 1.021 Metern der höchste Punkt.", "Der Corcovado-Hügel mit der Christusstatue liegt im Parkgebiet.", "Über 30 Wasserfälle befinden sich innerhalb der Parkgrenzen."],
      hu: ["A hivatalos újraerdősítés 1861-ben vette kezdetét.", "Manuel Archer őrnagy 100 000 fát ültetett el 13 év alatt.", "A Tijuca Nemzeti Park területe körülbelül 39,5 négyzetkilométer.", "A Pico da Tijuca csúcs magassága 1021 méter.", "A Megváltó Krisztus szobra a nemzeti park területén található.", "Több mint 30 vízesés található a park határain belül."],
      ro: ["Reîmpădurirea oficială a început în anul 1861.", "Maiorul Manuel Archer a plantat peste 100.000 de arbori în 13 ani.", "Parcul Național Tijuca acoperă circa 39,5 kilometri pătrați.", "Vârful Pico da Tijuca are o înălțime de 1.021 de metri.", "Statuia lui Isus Mântuitorul de pe Corcovado se află în parc.", "Peste 30 de cascade sunt localizate în interiorul parcului."],
      en: ["The official reforestation project began in 1861.", "Major Manuel Archer planted over 100,000 trees in 13 years.", "The Tijuca National Park covers about 39.5 square kilometers.", "Pico da Tijuca is the highest point at 1,021 meters.", "The Christ the Redeemer statue on Corcovado is inside the park.", "There are more than 30 waterfalls within the park's boundaries."],
      es: ["El bosque urbano más grande del mundo, replantado a mano en Río de Janeiro.", "Situado en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado a la vida diaria y la historia del país.", "Bajo la influencia del clima mayoritariamente tropical de Brasil."],
      pt: ["A maior floresta urbana do mundo, reflorestada à mão no coração do Rio de Janeiro.", "Localizada no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligada ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
      fr: ["La plus grande forêt urbaine du monde, replantée à la main à Rio de Janeiro.", "Située sur le territoire de la République fédérative du Brésil.", "Joue un rôle dans l'identité locale de la région.", "Liée au quotidien et à l'histoire du pays.", "Sous l'influence du climat majoritairement tropical du Brésil."],
    }, image: "/poi-images/br-tijuca-forest-nature-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Cea mai mare zonă umedă tropicală din lume, oferind un acces de neegalat la vizualizarea faunei sălbatice.",
      en: "The world's largest tropical wetland area, offering unparalleled wildlife viewing access.",
      es: "El humedal tropical más grande del mundo, que ofrece un acceso inigualable a la vida silvestre.",
      pt: "A maior área úmida tropical do mundo, que oferece acesso incomparável à vida selvagem.",
      fr: "La plus grande zone humide tropicale du monde, offrant un accès inégalé à la faune sauvage.",
    },
    facts: {
      de: ["Es ist der beste Ort in Südamerika, um Jaguare zu sehen.", "Wird jedes Jahr während der Regenzeit überflutet."],
      hu: ["Ez a legjobb hely Dél-Amerikában a jaguárok megfigyelésére.", "Az esős évszakban minden évben elárasztja a víz."],
      ro: ["Este cel mai bun loc din America de Sud pentru a vedea jaguari.", "Se inundă în fiecare an în timpul sezonului ploios."],
      en: ["It is the best place in South America to spot jaguars.", "Floods every year during the rainy season."],
      es: ["Es el mejor lugar de Sudamérica para ver jaguares.", "Se inunda cada año durante la temporada de lluvias."],
      pt: ["É o melhor lugar na América do Sul para ver onças-pintadas.", "É inundado todos os anos durante a estação chuvosa."],
      fr: ["C'est le meilleur endroit d'Amérique du Sud pour voir des jaguars.", "Il est inondé chaque année pendant la saison des pluies."],
    },
    descriptionAdvanced: {
      de: "Das Pantanal ist das größte tropische Feuchtgebiet der Welt und erstreckt sich über eine Fläche von etwa 140.000 bis 195.000 Quadratkilometern, hauptsächlich in den brasilianischen Bundesstaaten Mato Grosso und Mato Grosso do Sul. Es handelt sich um eine riesige Sedimentebene, die während der Regenzeit von November bis März zu etwa 80 % überflutet wird. Diese saisonalen Überschwemmungen schaffen ein dynamisches Mosaik aus Seen, Sümpfen und Grasland, das eine der höchsten Konzentrationen an Wildtieren in Amerika beherbergt. Das Pantanal ist weltberühmt für seine Populationen von Jaguaren, Kaimanen, Riesenottern und dem Hyazinth-Ara, dem größten Papagei der Welt. Im Gegensatz zum dichten Amazonas-Regenwald bietet das offene Gelände des Pantanals exzellente Möglichkeiten zur Tierbeobachtung. Ein kleiner Teil des Gebiets ist als Pantanal-Nationalpark geschützt, und das gesamte Ökosystem wurde von der UNESCO zum Welterbe und Biosphärenreservat erklärt. Die Region ist auch für die traditionelle Rinderzucht auf großen Farmen (Pantaneiro-Kultur) bekannt, die sich seit Jahrhunderten an die extremen hydrologischen Zyklen angepasst hat.",
      hu: "A Pantanal a világ legnagyobb trópusi vizes élőhelye, amely 140 000 és 195 000 négyzetkilométer közötti területet foglal el, főként Brazília Mato Grosso és Mato Grosso do Sul államaiban. Ez egy hatalmas hordalékos síkság, amelynek körülbelül 80%-a víz alá kerül a novembertől márciusig tartó esős évszakban. Ezek a szezonális áradások dinamikus mozaikot hoznak létre tavakból, mocsarakból és füves pusztákból, amely Amerika egyik legnagyobb vadállat-koncentrációjának ad otthont. A Pantanal világszerte ismert jaguár-, kajmán- és óriásvidra-populációjáról, valamint a jácintkék aráról, amely a világ legnagyobb papagájfaja. Az Amazonas sűrű esőerdőjével ellentétben a Pantanal nyitott terepe kiváló lehetőségeket kínál a vadvilág megfigyelésére. A terület egy kis része a Pantanal Matogrossense Nemzeti Park néven védett, az egész ökoszisztémát pedig az UNESCO a Világörökség részévé és bioszféra-rezervátummá nyilvánította. A régió híres a hagyományos marhatenyésztésről is, ahol a helyi kultúra évszázadok óta alkalmazkodott a szélsőséges hidrológiai ciklusokhoz.",
      ro: "Pantanal este cea mai mare zonă umedă tropicală din lume, întinzându-se pe o suprafață estimată între 140.000 și 195.000 de kilometri pătrați, în principal în statele braziliene Mato Grosso și Mato Grosso do Sul. Aceasta reprezintă o câmpie sedimentară vastă, care este inundată în proporție de aproximativ 80% în timpul sezonului ploios, din noiembrie până în martie. Inundațiile sezoniere creează un mozaic dinamic de lacuri, mlaștini și pășuni, găzduind una dintre cele mai mari concentrații de viață sălbatică din America. Pantanal este renumit la nivel mondial pentru populațiile sale de jaguari, caimani, vidre uriașe și ara hiacint, cel mai mare papagal din lume. Spre deosebire de pădurea amazoniană densă, terenul deschis din Pantanal oferă condiții excelente pentru observarea animalelor în habitatul lor natural. O mică parte din teritoriu este protejată prin Parcul Național Pantanal Matogrossense, iar întregul ecosistem a fost declarat sit al Patrimoniului Mondial UNESCO și Rezervație a Biosferei. Regiunea este cunoscută și pentru cultura tradițională a crescătorilor de vite (pantaneiros), adaptați ciclurilor hidrologice extreme.",
      en: "The Pantanal is the world's largest tropical wetland, covering an area estimated between 140,000 and 195,000 square kilometers, primarily located in the Brazilian states of Mato Grosso and Mato Grosso do Sul. It is a vast alluvial plain that is roughly 80% flooded during the rainy season from November to March. These seasonal floods create a dynamic mosaic of lakes, marshes, and grasslands that support one of the highest concentrations of wildlife in the Americas. The Pantanal is world-renowned for its populations of jaguars, caimans, giant otters, and the hyacinth macaw, the world's largest parrot. Unlike the dense Amazon rainforest, the Pantanal's open landscape provides excellent visibility for wildlife spotting. A small portion of the area is protected as the Pantanal Matogrossense National Park, and the entire ecosystem has been designated a UNESCO World Heritage site and Biosphere Reserve. The region is also famous for traditional cattle ranching on large estates (fazendas), where the local culture has adapted over centuries to the extreme hydrological cycles.",
      es: "El Pantanal es un elemento notable de la geografía y cultura brasileña. Es el humedal tropical más grande del mundo y ofrece un acceso inigualable a la fauna. Es el mejor lugar de Sudamérica para ver jaguares. Se inunda cada año durante la temporada de lluvias. Este paraje natural muestra la diversidad paisajística de Brasil, desde la región amazónica hasta el Pantanal y el Cerrado. Como muchos lugares significativos en Brasil, este sitio combina peculiaridades regionales con la importancia global del quinto país más grande del mundo. Así, este lugar contribuye al perfil polifacético de Brasil, donde se entrelazan la naturaleza tropical, la herencia portuguesa, el samba, el fútbol y el carnaval.",
      pt: "O Pantanal é um elemento notável da geografia e cultura brasileiras. É a maior área úmida tropical do mundo, oferecendo acesso incomparável à vida selvagem. É o melhor lugar na América do Sul para ver onças-pintadas. É inundado todos os anos durante a estação chuvosa. Esta área natural mostra a diversidade paisagística do Brasil, da região amazônica ao Pantanal e ao Cerrado. Como muitos lugares importantes no Brasil, este local combina peculiaridades regionais com a importância abrangente do quinto maior país do mundo. Assim, este lugar contribui para o perfil versátil do Brasil, onde a natureza tropical, a herança portuguesa, o samba, o futebol e o carnaval se entrelaçam.",
      fr: "Le Pantanal est un élément remarquable de la géographie et de la culture brésiliennes. C'est la plus grande zone humide tropicale du monde, offrant un accès unique à la faune sauvage. C'est le meilleur endroit d'Amérique du Sud pour observer les jaguars. Il est inondé chaque année pendant la saison des pluies. Cet espace naturel illustre la diversité des paysages du Brésil, de la région amazonienne au Pantanal en passant par le Cerrado. Comme de nombreux sites importants au Brésil, ce lieu conjugue des particularités régionales avec l'importance globale du cinquième plus grand pays du monde. Ce site contribue ainsi au profil aux multiples facettes du Brésil, où se mêlent nature tropicale, héritage portugais, samba, football et carnaval.",
    },
    factsAdvanced: {
      de: ["Die Fläche des Pantanal beträgt bis zu 195.000 Quadratkilometer.", "Rund 80 % des Gebiets werden während der Regenzeit überflutet.", "Die Region beherbergt die höchste Jaguar-Dichte weltweit.", "Über 10 Millionen Kaimane leben schätzungsweise im Pantanal.", "UNESCO erklärte das Gebiet im Jahr 2000 zum Weltnaturerbe.", "Es wurden über 650 verschiedene Vogelarten dort dokumentiert."],
      hu: ["A Pantanal területe elérheti a 195 000 négyzetkilométert.", "Az esős évszakban a terület körülbelül 80%-át víz borítja.", "Itt található a világ legsűrűbb jaguárpopulációja.", "Becslések szerint több mint 10 millió kajmán él a térségben.", "Az UNESCO 2000-ben nyilvánította a Világörökség részévé.", "Több mint 650 különböző madárfajt azonosítottak a területen."],
      ro: ["Suprafața Pantanalului ajunge până la 195.000 de kilometri pătrați.", "Circa 80% din teritoriu este acoperit de ape în sezonul ploios.", "Regiunea găzduiește cea mai mare densitate de jaguari de pe glob.", "Se estimează că peste 10 milioane de caimani trăiesc în Pantanal.", "UNESCO a inclus zona în Patrimoniul Mondial în anul 2000.", "Peste 650 de specii de păsări au fost identificate în acest ecosistem."],
      en: ["The Pantanal covers an area of up to 195,000 square kilometers.", "Roughly 80% of the area is flooded during the rainy season.", "The region has the highest density of jaguars in the world.", "An estimated 10 million caimans live within the Pantanal.", "UNESCO designated the area a World Heritage site in 2000.", "Over 650 different bird species have been documented there."],
      es: ["El humedal tropical más grande del mundo, que ofrece un acceso inigualable a la vida silvestre.", "Situado en el territorio de la República Federativa de Brasil.", "Juega un papel en la identidad local de la región.", "Vinculado a la vida cotidiana y a la historia del país.", "Bajo la influencia del clima predominantemente tropical de Brasil."],
      pt: ["A maior área úmida tropical do mundo, oferecendo acesso incomparável à vida selvagem.", "Localizado no território da República Federativa do Brasil.", "Desempenha um papel na identidade local da região.", "Ligado ao cotidiano e à história do país.", "Sob a influência do clima predominantemente tropical do Brasil."],
      fr: ["La plus grande zone humide tropicale du monde, offrant un accès inégalé à la faune sauvage.", "Situé sur le territoire de la République fédérative du Brésil.", "Joue un rôle dans l'identité locale de la région.", "Lié à la vie quotidienne et à l'histoire du pays.", "Soumis à l'influence du climat majoritairement tropical du Brésil."],
    },
  }
];
