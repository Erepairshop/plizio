...
export const poiExtraBrazilNatureV2: POI[] = [
    ...
    }, image: "/poi-images/br-xingu-river-nature-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      fr: "Le fleuve Iguaçu est mondialement connu pour ses chutes spectaculaires à la frontière entre le Brésil et l'Argentine, qui comptent parmi les plus grandes au monde. Le système fluvial serpente à travers la forêt subtropicale et constitue l'une des beautés naturelles les plus impressionnantes d'Amérique du Sud. Les chutes sont inscrites au patrimoine mondial de l'UNESCO depuis 1984.",
    },
    factsAdvanced: {
