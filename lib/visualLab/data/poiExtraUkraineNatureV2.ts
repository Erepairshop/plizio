...
,
  {
    ...
    coordinates: { lat: 49.3333, lng: 33.15 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Der Fluss Sula ist ein rechter Nebenfluss des Dnepr in der Ukraine. Er entspringt in den Waldsteppen des Dneprhochlandes und fließt nach Süden. Die Länge beträgt 363 km, das Einzugsgebiet umfasst 18.000 km². Der Fluss ist bekannt für seine Auenwälder und Altarme. Er wird für Bewässerung und Fischerei genutzt.",
      hu: "A Szula folyó a Dnyeper jobb oldali mellékfolyója Ukrajnában. A Dnyeper-hátság erdős sztyeppéjén ered, és dél felé folyik. Hossza 363 km, vízgyűjtő területe 18 000 km². Ártéri erdeiről és holtágairól ismert. Öntözésre és halászatra használják.",
      ro: "Râul Sula este un afluent drept al Niprului în Ucraina. Izvorăște din silvostepa Podișului Niprului și curge spre sud. Lungimea sa este de 363 km, iar bazinul hidrografic de 18.000 km². Este cunoscut pentru pădurile de luncă și brațele moarte. Folosit pentru irigații și pescuit.",
      en: "The Sula River is a right tributary of the Dnieper in Ukraine. It rises in the forest-steppe of the Dnieper Upland and flows south. Its length is 363 km, with a drainage basin of 18,000 km². The river is known for its floodplain forests and oxbow lakes. It is used for irrigation and fishing.",
    },
    factsAdvanced: {
      de: ["Länge 363 km.", "Einzugsgebiet 18.000 km².", "Durchschnittliche Abflussmenge 29 m³/s.", "Gefälle 0,3 m/km.", "Mündung in den Krementschuker Stausee.", "Wichtiges Fischfanggebiet mit 30 Arten."],
      hu: ["Hossza 363 km.", "Vízgyűjtő területe 18 000 km².", "Átlagos vízhozam 29 m³/s.", "Esesése 0,3 m/km.", "A Kremencsuki-víztározóba torkollik.", "30 halfajjal fontos halászati terület."],
  ...
  },
  {
    ...
    coordinates: { lat: 49.215, lng: 32.483 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Der Fluss U ist ein linker Nebenfluss des Dnepr in der Ukraine. Er entspringt in den Kiewer Waldsteppen und fließt durch malerische Landschaften. Die Länge beträgt 98 km, das Einzugsgebiet 1.240 km². Der U ist ein beliebtes Ziel für Kanutourismus und Angler. Seine Ufer sind dicht bewaldet und beherbergen zahlreiche Vogelarten.",
      hu: "Az U folyó a Dnyeper bal oldali mellékfolyója Ukrajnában. A kijevi erdős sztyeppén ered, festői tájakon folyik keresztül. Hossza 98 km, vízgyűjtő területe 1 240 km². Népszerű kajakozási és horgászati célpont. Partjait sűrű erdők borítják, sok madárfaj él itt.",
      ro: "Râul U este un afluent stâng al Niprului în Ucraina. Izvorăște din silvostepa Kievului și curge prin peisaje pitorești. Lungime: 98 km, bazin: 1.240 km². Este o destinație populară pentru canotaj și pescuit. Malurile sunt împădurite, adăpostind multe specii de păsări.",
      en: "The U River is a left tributary of the Dnieper in Ukraine. It rises in the Kyiv forest-steppe and flows through scenic landscapes. Its length is 98 km, with a basin area of 1,240 km². The river is popular for kayaking and fishing. Its banks are forested and host many bird species.",
    },
    factsAdvanced: {
      de: ["Länge 98 km.", "Einzugsgebiet 1.240 km².", "Durchschnittliche Breite 10 Meter.", "Maximale Tiefe 3 Meter.", "Gefälle 1,2 m/km.", "Mündung in den Kiewer Stausee."],
      hu: ["Hossza 98 km.", "Vízgyűjtő területe 1 240 km².", "Átlagos szélesség 10 m.", "Maximális mélység 3 m.", "Esesése 1,2 m/km.", "A kijevi víztározóba torkollik."],
