...
export const poiExtraFranceCities: POI[] = [
  // All batches combined - Final
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Grenoble-t gyakran a francia Alpok fővárosának nevezik, festői hegyvidéki környezete és virágzó technológiai ipara miatt. A város az Isère folyó partján fekszik, és történelmi központja a Bastille-erőddel ikonikus látványt nyújt. Európa egyik legjelentősebb tudományos és kutatási központja, amely mágnesként vonzza az innovációt. Az 1968-as téli olimpia helyszíneként a téli sportok szerelmeseinek paradicsoma is egyben. Földrajz K8 - hegyvidékek és ipari övezetek.",
    ...
    factsAdvanced: {
      ...
      hu: ["A város fölé magasodó Bastille-erődbe a híres 'buborék' felvonókkal lehet feljutni.", "Grenoble az egyik leglaposabb város Franciaországban, ami kiválóvá teszi a kerékpározáshoz.", "Itt rendezték az 1968-as téli olimpiai játékokat, ami hatalmas infrastrukturális fejlődést hozott.", "A város ad otthont az ESRF-nek (European Synchrotron Radiation Facility), Európa legfontosabb szinkrotron kutatóintézetének."],
      ro: [
      ...
      en: [
        ...
        "The region is renowned for its 'Noix de Grenoble' (walnuts), which have been protected by an Appellation d'Origine Contrölée (AOC) since 1938.",
...

  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Toulouse-ban található az Airbus repülőgépgyártó vállalat globális központja és legnagyobb összeszerelő üzeme. A hatalmas ipari komplexum, ahol többek között az ikonikus A380-as és A350-es modellek is készültek, a modern európai repülőgépgyártás szíve. Látogatók tízezrei érkeznek évente, hogy részt vegyenek a gyárlátogatásokon, és megcsodálják a repülés történelmét bemutató Aeroscopia múzeumot. A komplexum nemcsak munkahelyek tízezreit biztosítja, hanem a francia technológiai fölény szimbóluma is. Sachkunde K7 - modern iparágak és közlekedés.",
      ...
      en: "Toulouse is the global heart of the aeronautical industry, hosting Airbus headquarters and assembly lines. The city's industrial complex is a marvel of modern engineering, where some of the world's most advanced aircraft are assembled. The Aeroscopia museum and factory tours offer visitors a glimpse into the past and future of flight. Beyond Airbus, Toulouse is a hub for space research and innovation, solidifying its place as a cornerstone of European aerospace technology."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Az összeszerelő csarnokok annyira hatalmasak, hogy a dolgozók kerékpárral közlekednek rajtuk belül.", "A Jean-Luc Lagardère üzem Európa egyik legnagyobb egybefüggő épülete.", "A repülőgépek alkatrészeit egész Európából speciális hajókkal és 'Beluga' szállítógépekkel hozzák ide.", "A gyárterület mérete megegyezik egy kisebb francia városéval."],
      ro: [
      ...
      en: [
        "The assembly hangars are so vast that employees use bicycles to navigate inside.",
        "The Jean-Luc Lagardère plant is one of the largest continuous industrial buildings in Europe.",
        "Aircraft parts from across Europe are transported here by ships and special 'Beluga' transport planes.",
        "The Airbus site area is equivalent to that of a small French city.",
        "Toulouse's aerospace cluster, known as 'Aerospace Valley,' is a leader in European innovation.",
        "The city's aerospace sector drives massive investment in local R&D and engineering talent.",
        "Toulouse is a key node in the development of future sustainable aviation technologies."
      ]
    }, image: "/poi-images/industry-airbus-toulouse-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Le Havre kikötője Franciaország legnagyobb konténerkikötője, és a Párizsba tartó áruk legfontosabb tengeri kapuja. A Szajna torkolatánál elhelyezkedő komplexum a világ minden tájáról érkező hatalmas teherhajókat fogad, biztosítva az ország nemzetközi kereskedelmét. A második világháború során a város és a kikötő szinte teljesen elpusztult, de Auguste Perret zseniális tervei alapján betonból újjáépítették. Ma az UNESCO Világörökség része, amely ötvözi az ipari brutalitást a modern városépítészettel. Földrajz K6 - nemzetközi kereskedelem és logisztika.",
      ...
      en: "Le Havre, strategically located at the mouth of the Seine, serves as France's primary gateway for international trade. As the country's leading container port, it handles millions of tons of cargo annually, with the 'Port 2000' complex accommodating the world's largest ships. Beyond trade, the city is an architectural marvel; rebuilt after WWII by Auguste Perret, it was named a UNESCO World Heritage site in 2005 for its cohesive modern urban planning."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Le Havre az ország második legnagyobb tengeri kikötője a teljes áruforgalmat tekintve Marseille után.", "A várost 1517-ben I. Ferenc király alapította, kifejezetten kikötői célokra.", "Az újjáépített belváros a 20. századi betonépítészet egyik legkiválóbb példája.", "A kikötő képes fogadni a világ legnagyobb, több mint 20 ezer TEU kapacitású konténerszállító hajóit is."],
      ro: [
      ...
      en: [
        "The port spans approximately 10,000 hectares, serving as a vital industrial backbone.",
        "Le Havre is a major stop for cruise lines, acting as the primary sea link to Paris.",
        "Nearby, the Normandy Bridge is a masterpiece of modern bridge engineering.",
        "The city's modern architecture is a significant tourist draw, recognized by UNESCO.",
        "It was historically the departure point for many grand transatlantic liners.",
        "MuMa (Musée d'art moderne André Malraux) is world-renowned for its impressionist collection.",
        "The port operates 24/7, linking directly with inland river and rail networks for efficient logistics."
      ]
    }, image: "/poi-images/port-le-havre-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Bordeaux-i borvidék a világ leghíresebb és egyik legdrágább borokat adó régiója, amely a Garonne és a Dordogne folyók mentén terül el. Több mint százezer hektáron termesztenek szőlőt, ahol a Cabernet Sauvignon és a Merlot fajták dominálnak. A régió egyedülálló 'terroir'-ja, amely a kavicsos talajnak és az óceáni éghajlatnak köszönhető, páratlan minőségű borokat eredményez. A történelmi châteaux-k és a végtelen szőlőültetvények látványa több millió borturistát vonz évente. Sachkunde K8 - mezőgazdaság és élelmiszeripar.",
      ...
      en: "As the world's most iconic wine region, Bordeaux produces some of the most sought-after vintages, underpinned by centuries of history and a perfect 'terroir.' From the Médoc's Cabernet blends to the merlot-heavy wines of Pomerol and Saint-Émilion, the region's diversity is legendary. The 1855 Classification remains a global benchmark. Today, visitors explore not just historic châteaux, but modern marvels like the Cité du Vin, ensuring Bordeaux remains the global epicenter of wine culture and oenotourism."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A régióban évente körülbelül 700 millió üveg bort állítanak elő.", "Az 1855-ös bordeaux-i borbesorolás a mai napig meghatározza a legjobb borászatok rangsorát.", "A bordeaux-i borok több mint 85 százaléka vörösbor.", "A szőlőművelés hagyományát még az ókori rómaiak honosították meg ezen a vidéken."],
      ro: [
      ...
      en: [
        "The region produces around 700 million bottles of wine annually.",
        "Bordeaux's viticultural roots reach deep into Roman times.",
        "The 'terroir'—a specific mix of soil, climate, and topography—defines the character of every wine here.",
        "While famed for red blends, Bordeaux produces world-class dry whites in Graves and sweet wines in Sauternes.",
        "The Place de la Bourse and its 'Water Mirror' showcase the city's 18th-century grandeur.",
        "Saint-Émilion is a UNESCO-listed wine landscape, combining architectural beauty with viticulture.",
        "The 'En Primeur' futures market allows international connoisseurs to purchase wines before they are bottled."
      ]
    }, image: "/poi-images/agriculture-bordeaux-vineyards-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Millau-i völgyhíd egy lenyűgöző mérnöki csoda, amely a Tarn folyó völgyét íveli át Dél-Franciaországban. Ez a világ egyik legmagasabb hídja; az egyik pilonja a 343 méteres magasságot is eléri, ami meghaladja az Eiffel-torony magasságát is. A Norman Foster brit építész és Michel Virlogeux francia mérnök által tervezett szerkezet nemcsak funkcionális, hanem karcsú, vitorlás hajókra emlékeztető dizájnjával esztétikai remekmű is. A híd jelentősen lerövidítette a Párizs és a Földközi-tenger közötti utazási időt. Földrajz K7 - modern infrastruktúra és mérnöki tudományok.",
      ...
      en: "As the world's tallest bridge, the Millau Viaduct is a feat of modern civil engineering. Rising 343 meters above the valley floor, it elegantly traverses the Tarn river valley. Designed by Norman Foster and Michel Virlogeux, its slender pylons and cable-stayed architecture blend into the landscape with remarkable grace. It serves as a vital artery on the A75 motorway, reducing travel times while standing as an iconic landmark of 21st-century architectural ambition and aesthetic harmony."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A híd acélszerkezete közel 36 ezer tonnát nyom, ami ötször nehezebb az Eiffel-toronynál.", "Építése mindössze három évet vett igénybe, és 2004-ben adták át a forgalomnak.", "A pálya hossza 2460 méter, amely 270 méterrel a völgyfenék felett húzódik.", "Gyakran előfordul, hogy a híd a reggeli ködréteg felett lebeg, misztikus látványt nyújtva."],
      ro: [
      ...
      en: [
        "The bridge spans an impressive 2,460 meters.",
        "Construction utilized advanced self-climbing formwork technology.",
        "GPS-controlled hydraulic systems were used to push the deck onto the pylons.",
        "It is engineered to endure high wind speeds and thermal expansion cycles.",
        "The project cost roughly €400 million, completed on a tight three-year schedule.",
        "With a deck 270 meters high, it is the highest road bridge in Europe.",
        "A dedicated visitor center provides insights into the technological complexity of the build."
      ]
    }, image: "/poi-images/landmark-viaduc-de-millau-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Parc Astérix egy vidámpark Párizstól északra, amely a híres francia képregény, az Asterix és Obelix világát kelti életre. A park több tucat izgalmas hullámvasúttal és attrakcióval rendelkezik, amelyek a rómaiak, gallok és ókori görögök komikus összecsapásaira épülnek. A komplexum a francia popkultúra fontos része, és erős konkurenciája a közeli Disneylandnek, főleg a helyi családok körében. Különleges show-műsorai és jelmezes karakterei garantálják, hogy a látogatók a képregények lapjain érezzék magukat. Történelem K5 - a római kor humoros megközelítése.",
      ...
      en: "Located just north of Paris, Parc Astérix is a celebration of French comic culture. Immersively themed zones like the Gaulish village and the Roman Empire bring the tales of Asterix and Obelix to life. The park is renowned for world-class thrill rides like 'Toutatis' and 'OzIris,' complemented by family-friendly attractions and water rides. Daily stunt shows featuring beloved comic characters make for an unforgettable, humor-filled adventure, providing a distinctly 'Gaulish' alternative to the standard theme park experience."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A parkot 1989-ben nyitották meg, és évente több mint 2 millió látogatót fogad.", "Leghíresebb hullámvasútja, az OzIris, egy egyiptomi témájú felfüggesztett hullámvasút.", "A park területe tematikus zónákra van osztva, például a Római Birodalom és a Vikingek.", "René Goscinny és Albert Uderzo, a képregény alkotói, aktívan részt vettek a park arculatának kialakításában."],
      ro: [
      ...
      en: [
        "Opened in 1989, the park attracts millions of visitors annually.",
        "It features the massive 'Tonnerre 2 Zeus' wooden roller coaster.",
        "The aquatic theater is famous for its dolphin and sea lion performances.",
        "On-site themed hotels offer a fully immersive experience inspired by the comics.",
        "Diverse zones explore themes ranging from Vikings to ancient Egyptian culture.",
        "The park is highly acclaimed for its blend of extreme roller coasters and family-friendly street shows.",
        "Halloween brings a unique and intense atmosphere with the 'Peur sur le Parc' events."
      ]
    }, image: "/poi-images/kid-landmark-parc-asterix-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Aiguille du Midi egy lenyűgöző, 3842 méter magas hegycsúcs a Mont Blanc masszívumban, amely a világ egyik legmagasabb felvonójával közelíthető meg. A Chamonix-ból induló drótkötélpálya mindössze 20 perc alatt juttatja fel a látogatókat a szédítő magasságba, ahol a 'Lépés az űrbe' nevű üvegpadlós kilátóból páratlan panoráma nyílik a francia, svájci és olasz Alpokra. A csúcs nemcsak a turisták, hanem az extrém alpinisták és a Mont Blanc-ra induló hegymászók egyik legfontosabb kiindulópontja. Földrajz K8 - alpesi hegyképződés és turizmus.",
      ...
      en: "Rising to a staggering 3,842 meters, the Aiguille du Midi offers one of the most breathtaking panoramas in the entire Alpine range. Reached by one of the world's most spectacular cable car rides from Chamonix, visitors are treated to 360-degree views encompassing the French, Swiss, and Italian Alps. The 'Step into the Void' glass skywalk provides an adrenaline-fueled experience over a sheer drop, while the mountain itself remains a legendary starting point for high-altitude climbers and glacier explorers venturing toward the Mont Blanc massif."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A csúcsra vezető első drótkötélpályát még 1955-ben adták át.", "A felvonó alsó és felső állomása közötti szintkülönbség 2742 méter, ami világrekord.", "Az üvegkilátó (Le Pas dans le Vide) alatt több mint 1000 méteres mélység tátong.", "A hegy belsejében egy egész alagútrendszert vájt ki a turisták számára."],
      ro: [
      ...
      en: [
        "Opened in 1955, this engineering marvel held the record for the world's highest cable car for decades.",
        "The name 'Midi' refers to the sun's position directly over the peak at noon when viewed from Chamonix.",
        "High-altitude air here contains only 60% of the oxygen found at sea level.",
        "A cliff-embedded elevator transports visitors from the landing station to the top terrace.",
        "It serves as the starting point for the world-famous Vallée Blanche off-piste ski route.",
        "The summit features a fascinating museum detailing the history of mountaineering in the region.",
        "In summer, the 'Panoramic Mont-Blanc' gondola connects the summit across the glaciers to Italy."
      ]
    }, image: "/poi-images/mountain-aiguille-du-midi-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Genfi-tó (franciául Lac Léman) Közép-Európa egyik legnagyobb édesvízű tava, amely Franciaország és Svájc határán terül el. A félhold alakú víztömeg gleccserekből ered, vizét a Rhône folyó táplálja, amely átfolyik rajta. A francia oldalon olyan elegáns fürdővárosok találhatók, mint Évian-les-Bains és Thonon-les-Bains, amelyek híresek ásványvizeikről. A tó vizének lenyűgöző kék színe, háttérben a hófödte Alpokkal, a történelem során számtalan írót és művészt inspirált. Földrajz K6 - európai tavak és vízrajz.",
      ...
      en: "Lake Geneva, or 'Lac Léman,' is a crescent-shaped expanse of water shared between France and Switzerland. Fed by the Rhône River and framed by the Alps and Jura Mountains, it boasts a mild climate and elegant shorelines. French towns like Évian-les-Bains are world-famous for their mineral springs, while the medieval village of Yvoire remains a historic gem. The lake's clear blue waters and dramatic Alpine backdrop have made it a magnet for artists, writers, and travelers for centuries, often toured via historic paddle-steamer cruises."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A tó teljes területe 580 négyzetkilométer, melyből 234 négyzetkilométer tartozik Franciaországhoz.", "Legnagyobb mélysége eléri a 310 métert.", "Évian-les-Bains városa adja a világ egyik leghíresebb ásványvizét, az Eviant.", "A tavon közlekedő történelmi lapátkerekes gőzhajók több mint 100 éve szállítják az utasokat."],
      ro: [
      ...
      en: [
        "Covering 580 km², it is the largest lake in Western Europe.",
        "Its deepest point plunges down 310 meters.",
        "It serves as a critical drinking water reservoir for both France and Switzerland.",
        "The lake is world-famous for its historic paddle-steamer cruises, some over a century old.",
        "Chillon Castle is one of Switzerland's most significant historical landmarks, situated on the eastern bank.",
        "The Jet d'Eau, a massive fountain in Geneva, has become a global icon of the lake.",
        "It hosts prestigious sailing events, such as the famous 'Bol d'Or' regatta."
      ]
    }, image: "/poi-images/lake-lake-geneva-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Fontainebleau-i erdő egy hatalmas, lenyűgöző természetvédelmi terület Párizstól délkeletre, amely egykor a francia királyok kedvelt vadászterülete volt. Az erdő különlegességét a különleges homokkő sziklaalakzatok adják, amelyek a világ minden tájáról vonzzák a boulderezés (sziklamászás) szerelmeseit. A végtelen tölgy- és bükkfák között kanyargó ösvényeket festők sora örökítette meg, különösen a 19. századi barbizonti iskola művészei. Ma a párizsiak egyik legkedveltebb hétvégi kirándulóhelye. Biológia K5 - európai lomblevelű erdők és biodiverzitás.",
      ...
      en: "Located just an hour from Paris, Fontainebleau Forest is a unique 25,000-hectare landscape renowned worldwide for its sandstone boulders—a premier destination for climbing and bouldering enthusiasts. Beyond its rocks, the forest offers an incredible diversity of oak and pine woodland and sandy heaths. Its history is deeply intertwined with the French monarchy, with the magnificent Château de Fontainebleau at its center, and it famously served as a muse for the 19th-century Barbizon School of painters who pioneered plein-air painting."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Az erdő területe több mint 250 négyzetkilométer.", "Több mint 30 ezer kilométernyi jelzett turistaút található a fák között.", "A boulderezés (kötél nélküli sziklamászás) modern formája részben ezen az erdőn alakult ki.", "Az erdőben több mint 5000 különböző rovarfaj és ritka növény él."],
      ro: [
      ...
      en: [
        "The forest features over 1,600 kilometers of marked hiking trails.",
        "It was designated one of the world's first nature reserves in 1861.",
        "Its iconic sandstone formations are the result of 30 million years of erosion.",
        "It served as the primary source of inspiration for the Barbizon School painters.",
        "The Château de Fontainebleau is one of the largest royal residences in all of France.",
        "It was preserved for centuries primarily as a royal hunting domain.",
        "Some ancient oak trees within the forest canopy are over 500 years old."
      ]
    }, image: "/poi-images/forest-fontainebleau-forest-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Champagne borvidék Északkelet-Franciaországban a világ egyetlen olyan régiója, ahol a hivatalos pezsgőt (champagne) előállíthatják. A hűvös klíma és a jellegzetes krétás talaj ideális feltételeket biztosít a Pinot Noir, a Pinot Meunier és a Chardonnay szőlőfajtáknak. A mészkőbe vájt, több száz kilométer hosszú pincerendszerekben évmilliók óta palackok milliói érlelődnek állandó hőmérsékleten. A régió története során rengeteg háborút vészelt át, mégis megőrizte a luxus és az ünneplés italának hagyományát. Sachkunde K8 - exkluzív mezőgazdasági termékek.",
      ...
      en: "Champagne is synonymous with the world's most prestigious sparkling wine. Protected by strict appellation laws, only wine crafted here using the 'méthode traditionnelle' can carry the name. Its unique chalky soils provide the perfect environment for Pinot Noir, Pinot Meunier, and Chardonnay grapes to thrive. Reims and Épernay stand as the historic hubs of production, with over 100 kilometers of cellars running beneath Épernay's 'Avenue de Champagne.' Crowned by the Gothic masterpiece of Reims Cathedral, this region’s vineyards and historic cellars are a UNESCO World Heritage site of unparalleled importance."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Egy hagyományos pezsgősüvegben akár 49 millió buborék is képződhet.", "A régió alatti pincerendszerek hossza összesen meghaladja a 200 kilométert.", "Az italt Dom Pérignon bencés szerzetes tökéletesítette a 17. században.", "Csak a hagyományos, másodlagos palackos erjesztéssel (méthode champenoise) készült ital viselheti a champagne nevet."],
      ro: [
        ...
        "În Primul Răz mondial, linia frontului trecea prin Champagne, iar pivnițele au servit ca adăposturi."
      ],
      en: [
        "The region encompasses approximately 34,000 hectares of vineyards.",
        "Bottle pressure reaches about 6 bar—three times the pressure of a car tire.",
        "Dom Pérignon was instrumental in refining 17th-century production techniques.",
        "Ancient 'crayères' (chalk pits) provide the world's most stable aging cellars.",
        "The industry is a mix of ~300 historic houses and 15,000 independent growers.",
        "Reims Cathedral served as the royal coronation site for nearly every French monarch.",
        "During WWI, deep cellars in the region doubled as essential civilian shelters."
      ]
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Haut-Koenigsbourg kastély egy hatalmas hegyi erődítmény Elzászban, amely a Vosges-hegység egyik csúcsáról uralja a Rajna völgyét. A 12. században épült várat a harmincéves háború során lerombolták, majd évszázadokig elhagyatottan állt, mígnem II. Vilmos német császár a 20. század elején teljesen újjáépíttette, hogy demonstrálja a német birodalom hatalmát a frissen bekebelezett területen. Vörös homokkőből épült falai, díszes belső terei és fegyvergyűjteménye hűen adják vissza a középkori lovagvárak hangulatát. Történelem K6 - középkori várépítészet és birodalmi konfliktusok.",
      ...
      en: "Perched on a 757-meter ridge in the Vosges mountains, Haut-Koenigsbourg offers unparalleled views of the Alsace Wine Route and the Rhine Valley. While its foundations date back to the 12th century, the castle seen today is a meticulously idealized restoration commissioned by Kaiser Wilhelm II in the early 1900s. With its drawbridges, massive keep, and period-accurate weaponry, the castle provides a vivid window into 15th-century life, standing today as one of France's most cherished and popular historical landmarks."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A kastély 757 méteres tengerszint feletti magasságban épült, ahonnan tiszta időben a Fekete-erdőig ellátni.", "Az újjáépítést Bodo Ebhardt építész vezette, aki aprólékos történelmi kutatásokat végzett a pontosság érdekében.", "Ez Franciaország egyik leglátogatottabb műemléke, évente több mint félmillióan keresik fel.", "Az első világháború után, 1919-ben a vár Elzásszal együtt visszakerült Franciaországhoz."],
      ro: [
      ...
      en: [
        "The Kaiser's restoration project lasted from 1900 to 1908.",
        "On exceptionally clear days, views extend all the way to the distant Alps.",
        "The reconstruction was intended to mirror 15th-century fortification designs.",
        "It provided a cinematic backdrop for Jean Renoir’s masterpiece 'Grand Illusion.'",
        "The grounds include a recreation of a medieval medicinal garden.",
        "Its name translates directly to 'King's Castle.'",
        "A large cistern in the inner courtyard was vital for the castle's survival."
      ]
    }, image: "/poi-images/castle-chateau-haut-koenigsbourg-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Clermont-Ferrand az Auvergne régió történelmi fővárosa, amely egy egyedülálló, kialudt vulkánokból álló láncolat (Chaîne des Puys) lábánál fekszik. A város különlegessége a jellegzetes sötétszürke, vulkáni kőzetből épült gótikus katedrálisa, amely komor, mégis fenséges látványt nyújt. Itt található a Michelin gumiabroncs-gyártó vállalat globális központja is, amely több mint egy évszázada határozza meg a város gazdaságát. Az ipari múlt és a vulkanikus táj lenyűgöző kontrasztja teszi a várost igazán egyedivé. Földrajz K8 - vulkáni kőzetek és iparvárosok.",
      ...
      en: "Built upon volcanic foundations, Clermont-Ferrand is nestled at the base of the 'Chaîne des Puys'—a UNESCO World Heritage chain of 80 extinct volcanoes. This geological heritage defines the city, most notably its Gothic cathedral, built entirely from dark Volvic lava stone. Beyond its volcanoes, the city is globally recognized as the headquarters of the Michelin tire giant; their 'L'Aventure Michelin' museum offers a deep dive into the history of the company and its iconic mascot, Bibendum. The remarkably preserved medieval center of Montferrand provides a striking contrast to the lively bustle of Clermont."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Notre-Dame-de-l'Assomption katedrálist kizárólag Volvic vulkáni kőzetből építették.", "A Michelin testvérek 1889-ben alapították meg itt híres gumigyárukat.", "A közeli Puy de Dôme vulkán tetején egy ókori római templom (Merkúr-templom) romjai találhatók.", "A város egy 1630-as királyi rendelet révén jött létre, amely egyesítette Clermont és Montferrand városait."],
      ro: [
      ...
      en: [
        "The city formed by the 17th-century merger of rival towns Clermont and Montferrand.",
        "Place de Jaude serves as the central hub, famously featuring a statue of Vercingetorix.",
        "The Puy de Dôme—the chain’s highest peak—is a major hiking and tourism destination.",
        "It hosts one of the most prestigious short film festivals globally.",
        "Polymath Blaise Pascal, a pioneer of mathematics and philosophy, was born here.",
        "The Romanesque Basilica of Notre-Dame-du-Port is a UNESCO-listed masterpiece.",
        "Rugby is a cultural pillar, with the ASM Clermont Auvergne club consistently competing at the top level."
      ]
    }, image: "/poi-images/city-clermont-ferrand-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Futuroscope egy innovatív, jövő- és technológia-központú élménypark Poitiers mellett, amely a multimédiára, az audiovizuális technikákra és a robotikára épül. Az 1987-ben megnyílt park épületei futurisztikus, geometrikus formákkal (például fémgömbökkel és üvegpiramisokkal) büszkélkedhetnek. A hagyományos hullámvasutak helyett itt 4D-s mozik, hatalmas robotkaros szimulátorok és interaktív kiállítások várják a látogatókat. A park folyamatosan megújul, hogy bemutassa a tudomány és a szórakoztatás legújabb vívmányait. Tudomány K5 - technológiai innovációk és audiovizuális trükkök.",
      ...
      en: "Located near Poitiers, Futuroscope offers a theme park experience unlike any other, focusing on immersive multimedia rather than traditional roller coasters. Using state-of-the-art 3D and 4D cinema, giant screens, and robotics, it transports visitors into futuristic worlds. The park's architecture—comprised of giant geometric forms, crystals, and spheres—is as striking as its attractions. Highlights like the award-winning 'Tornado Hunters' and 'The Extraordinary Flight' exemplify the park's fusion of entertainment and education, while the spectacular nightly water and light shows provide a stunning finale to the experience."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A park jelképe a hatalmas, fehér fémgömb, a Pavillon du Futuroscope.", "Nyitása óta több mint 50 millió látogatót fogadott.", "Sok attrakció a virtuális valóság (VR) és a kiterjesztett valóság (AR) legfejlettebb technológiáit alkalmazza.", "A komplexum nemcsak szórakoztató központ, hanem egy kiterjedt technológiai park (technopole) része is."],
      ro: [
      ...
      en: [
        "Founded through an initiative by the department of Vienne.",
        "The 'Kinémax' pavilion, shaped like a giant crystal, features a massive 600m² screen.",
        "Acclaimed director Luc Besson helped create the 'Arthur, l'Aventure 4D' attraction.",
        "The 'Aerobar' allows visitors to enjoy drinks while suspended 35 meters in the air.",
        "It ranks as France's second-most visited theme park.",
        "The park undergoes continuous renewal, launching new experiences annually.",
        "It is integrated into a larger technopole that fosters active research and technological innovation."
      ]
    }, image: "/poi-images/kid-landmark-futuroscope-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A ZooParc de Beauval Franciaország legnagyobb és a világ egyik legszebb állatkertje, amely a Loire-völgy déli részén található. A park több mint 35 ezer állatnak ad otthont, köztük olyan ritkaságoknak, mint az óriáspandák, koalák és fehér tigrisek. A hatalmas, tematikus zónákba rendezett állatkert óriási hangsúlyt fektet a veszélyeztetett fajok megőrzésére és a nemzetközi tenyészprogramokra. Hatalmas egyenlítői üvegháza és a madárröpték a természetvédelmi oktatás legmagasabb szintjét képviselik. Biológia K6 - állatkerti fajmegőrzés és globális ökoszisztémák.",
      ...
      en: "Situated in the Loire Valley, ZooParc de Beauval is much more than a zoo; it is a premier global hub for biodiversity and wildlife conservation. From humble beginnings as a bird park, it now hosts an exceptional variety of species, most notably the giant pandas on loan from China—a partnership marked by the celebrated birth of panda twins in 2021. The park features immense thematic zones like the African savanna and the state-of-the-art Equatorial Dome. A cable car, 'Le Nuage de Beauval,' offers visitors an aerial view of the sanctuary, which reinvests significant revenue into over 50 global conservation programs."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Beauval állatkert volt az első Franciaországban, ahová Kína óriáspandákat kölcsönzött.", "A 2020-ban megnyitott Egyenlítői Dóm egy hatalmas üvegház, amely három kontinens trópusi állatait mutatja be.", "Az állatkertet 1980-ban alapította Françoise Delord, eredetileg madárparkként.", "A park saját alapítványa világszerte több tucat vadvédelmi projektet támogat anyagilag."],
      ro: [
      ...
      en: [
        "The park is home to around 800 different species.",
        "The Equatorial Dome is a sprawling 1-hectare greenhouse mimicking tropical habitats.",
        "Founded by Françoise Delord in 1980.",
        "Beauval holds the distinction of being the first French zoo to successfully breed white tigers and rhinoceroses.",
        "Daily shows range from breathtaking bird-of-prey displays to sea lion performances.",
        "The on-site veterinary clinic is widely regarded as one of the most advanced in Europe.",
        "Rare species such as manatees, koalas, and okapis are central to the zoo's biodiversity mission."
      ]
    }, image: "/poi-images/animal-habitat-zoo-de-beauval-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Aerospace Valley a Bordeaux és Toulouse között elterülő régióban található, Európa egyik legfontosabb légügyi és űrtechnológiai klasztere. Itt összpontosul a francia repülőgép-alkatrészgyártás, a védelmi ipar és az űrkutatás elitje, köztük a Dassault Aviation és a Thales Group kutatóközpontjai. A több százezer embert foglalkoztató zónában fejlesztik a legújabb dróntechnológiákat, katonai repülőgépeket és műholdas rendszereket. Ez a régió garantálja, hogy Franciaország megőrizze vezető szerepét a globális csúcstechnológiai versenyben. Technológia K8 - űrkutatás és védelmi ipar.",
      ...
      en: "While Toulouse focuses on civil aviation, Bordeaux has become a powerhouse for military aviation, business jets, and space technology as a key part of the 'Aerospace Valley' cluster. Dassault Aviation assembles its Falcon jets in Mérignac, while ArianeGroup develops Ariane rockets and strategic defense missiles. Thales adds critical expertise in avionics and drone systems. This sector is a fundamental economic driver for the region, fostering thousands of high-tech jobs and anchoring an extensive network of specialized suppliers and research institutions."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A klaszter több mint 120 ezer ipari munkahelyet biztosít a régióban.", "A Dassault híres Rafale vadászrepülőgépeinek végső összeszerelését is ezen a területen végzik.", "A völgyben több mint 1000 különböző repülés- és űrtechnológiai vállalat működik.", "Európa űripari kutatásainak jelentős része, beleértve a klímamegfigyelő műholdakat is, itt zajlik."],
      ro: [
      ...
      en: [
        "Half of all business jets delivered globally use Thales avionics developed in Bordeaux.",
        "The 'Laser Mégajoule' is among the world's most powerful laser research facilities.",
        "Bordeaux-Mérignac serves as a strategic hub for heavy aircraft maintenance.",
        "The region is at the forefront of aerospace composite materials research.",
        "Local university partnerships ensure a steady flow of elite engineering talent.",
        "The drone industry is rapidly emerging as a specialized growth sector.",
        "Bordeaux Technowest provides a launchpad for startups in aerospace and UAV technology."
      ]
    }, image: "/poi-images/industry-aero-valley-bordeaux-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Loire Franciaország leghosszabb folyója, amely több mint 1000 kilométeren keresztül kanyarog a Közép-Masszívumtól egészen az Atlanti-óceánig. A folyó völgye az ország egyik legfontosabb történelmi és kulturális tengelye, amelyet gyakran 'Franciaország kertjének' is neveznek. Partjai mentén sorakoznak a híres reneszánsz kastélyok, hatalmas szőlőbirtokok és történelmi városok, amelyek a francia királyság aranykorát idézik. A folyó medre nagyrészt megőrizte természetes, vadon kanyargó jellegét, így gazdag madárvilágnak is otthont ad. Földrajz K6 - európai folyórendszerek és történelmi völgyek.",
      ...
      en: "Often called the last wild river in Europe, the Loire flows for over 1,000 kilometers from the Massif Central to the Atlantic. Its central valley is a UNESCO World Heritage site, world-famous for its majestic Renaissance châteaux like Chambord and Chenonceau. Known as the 'Garden of France,' it is an agricultural and wine-producing hub (Sancerre, Chinon). The river remains ecologically vital, with its natural sandbanks providing a sanctuary for avian species. The 'Loire à Vélo' cycling route spans 900 kilometers, making it a premier destination for sustainable tourism."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Loire hossza pontosan 1006 kilométer.", "A folyó középső szakasza (Sully-sur-Loire és Chalonnes között) az UNESCO Világörökség része.", "A folyó vízhozama rendkívül ingadozó; nyáron homokpadok bukkannak elő, míg télen hatalmas áradásokat okozhat.", "A Loire mentén termesztett szőlőkből készül a híres Sancerre és Pouilly-Fumé fehérbor."],
      ro: [
      ...
      en: [
        "It is the longest river in France and one of Europe’s last unchanneled wild rivers.",
        "Water levels vary dramatically, shaping the river's dynamic ecosystem.",
        "Traditional 'toue' flat-bottomed boats remain a symbol of the river’s heritage.",
        "Villandry’s Renaissance gardens are globally regarded as masterpieces of design.",
        "Nantes, near the estuary, historically served as the largest port in the nation.",
        "Orléans, on the river, was the site of a pivotal victory for Joan of Arc.",
        "The river journey traverses everything from rugged volcanic canyons to expansive lowlands."
      ]
    }, image: "/poi-images/river-loire-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Rennes Bretagne régió nyüzsgő fővárosa, amely egyaránt büszke kelta gyökereire és modern, diákbarát atmoszférájára. A történelmi óvárost lenyűgöző, színes favázas házak díszítik, amelyek csodával határos módon túléltek egy hatalmas, 18. századi tűzvészt. A város ma fontos technológiai és kutatási csomópont, különösen a telekommunikáció területén. Bretagne közigazgatási központjaként Rennes a régió kulturális motorja, ahol a hagyományos breton fesztiválok jól megférnek a kortárs művészeti eseményekkel. Történelem K7 - regionális identitás és kelta örökség.",
      ...
      en: "As the vibrant capital of Brittany, Rennes balances a deep historical legacy with a high-energy, modern atmosphere. The medieval core, featuring colorful half-timbered houses, survived the fire of 1720, standing alongside majestic classical reconstructions. Its rich culture is amplified by a student body of over 60,000, fueling a world-class arts and music scene. Beyond history, Rennes has earned the nickname 'France's Silicon Valley' for its dominance in digital innovation, while the Saturday Marché des Lices market remains a beloved showcase for traditional Breton products."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["1720-ban egy hatalmas tűzvész a város közel felét elpusztította, ami után kőből építették újjá a központ egy részét.", "Rennes rendelkezik a világ egyik legkisebb, teljesen automatizált metróhálózatával.", "A város egyetemének több mint 60 ezer hallgatója van, ami hihetetlenül fiatalossá teszi a várost.", "A Lices piaca szombat reggelente az egyik legnagyobb és leghangulatosabb termelői piac Franciaországban."],
      ro: [
      ...
      en: [
        "Thabor Park is widely considered one of the finest public gardens in all of France.",
        "The 'Portes Mordelaises' once served as the fortress city's primary grand entrance.",
        "The December 'Les Trans Musicales' festival is a globally recognized showcase for emerging musical talent.",
        "Rennes boasts one of the most efficient, fully automated metro systems (VAL) in the nation.",
        "Breton cultural identity is preserved through traditional 'Fest-Noz' dance festivals.",
        "The Museum of Fine Arts houses an incredibly diverse collection ranging from antiquity to contemporary works.",
        "The city is strategically positioned at the historic confluence of the Ille and Vilaine rivers."
      ]
    }, image: "/poi-images/city-rennes-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "Az Étretat-i sziklák Normandia partvidékének legikonikusabb természeti képződményei, ahol a hatalmas, fehér krétasziklák drámai módon szakadnak bele a La Manche-csatorna hullámaiba. A természet ereje, a szél és a víz egyedülálló, íves kőkapukat és magányos sziklatűket vájt ki a partfalból. Ez a vad, romantikus táj olyan világhírű impresszionista festőket ihletett meg, mint Claude Monet, valamint Maurice Leblanc írót, aki Arsène Lupin kalandjait is ide helyezte. A sziklák tetején kanyargó ösvényekről lélegzetelállító kilátás nyílik az óceánra. Földrajz K7 - tengeri erózió és partvidéki geomorfológia.",
      ...
      en: "The Alabaster Coast reaches its most dramatic climax at Étretat, where majestic white chalk cliffs have been sculpted into spectacular arches and spires by the sea. The Porte d'Aval, often resembling an elephant’s trunk, and the 70-meter 'Needle' (Aiguille) stand as iconic natural formations. This breathtaking landscape captivated 19th-century Impressionists like Claude Monet, who painted them in changing lights, and literary figures like Maurice Leblanc, whose 'Arsène Lupin' tales were deeply inspired by the cliffs' mystical aura."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A legismertebb sziklaalakzatok a Porte d'Aval, a Porte d'Amont és a 70 méter magas L'Aiguille (Tű-szikla).", "A fehér kréta valójában évmilliók alatt felhalmozódott, mikroszkopikus tengeri élőlények vázából áll.", "Claude Monet több mint 50 festményt készített Étretat szikláiról különböző napszakokban.", "A helyszín gyakran szerepel a Netflix népszerű 'Lupin' című sorozatában is."],
      ro: [
      ...
      en: [
        "The Manneporte is an even grander arch west of the main Porte d'Aval.",
        "Notre-Dame de la Garde chapel stands guard atop the Amont cliff.",
        "The 'Étretat Gardens' uniquely merge modern landscaping with avant-garde sculpture.",
        "Maurice Leblanc immortalized the cliffs in his 'Arsène Lupin' thriller, 'The Hollow Needle.'",
        "The area is protected under the Natura 2000 network for its distinct biodiversity.",
        "At low tide, the Porte d'Aval provides passage to secluded adjacent beaches.",
        "The cliffs are composed of white chalk layered with bands of dark flint."
      ]
    }, image: "/poi-images/sea-etretat-cliffs-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Côte d'Azur dombjain fekvő Grasse városa a világ vitathatatlan parfümfővárosa, ahol a virágtermesztés és az illatanyagok kivonása évszázados művészet. A város mikroklímája tökéletes a jázmin, a májusi rózsa és a tubarózsa termesztésére, amelyeket a leghíresebb párizsi divatházak (például a Chanel) is felhasználnak ikonikus parfümjeikhez. A városban működő történelmi parfümgyárak – mint a Fragonard, Molinard és Galimard – látogatók millióit avatják be az illatalkotás titkaiba. A parfümkészítés hagyománya Grasse-ban az UNESCO szellemi kulturális örökségének része. Kémia K7 - illóolajok és kozmetikai ipar.",
      ...
      en: "Nestled in the hills above the Côte d'Azur, Grasse has evolved since the 16th century from a leather-tanning town into the undisputed world capital of perfume. The mild microclimate creates perfect conditions for cultivating jasmine, May roses, and tuberose. Grasse’s master perfumers—the famed 'Noses'—are artists at creating complex scents that define luxury global brands. Iconic houses like Fragonard, Molinard, and Galimard welcome visitors to discover ancient extraction techniques, including 'enfleurage.' In 2018, this unique perfumery savoir-faire was officially designated as intangible cultural heritage by UNESCO."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["Grasse eredetileg a bőrcserzésről volt híres; a parfümöket először a büdös bőrkesztyűk illatosítására használták a 16. században.", "A világ leghíresebb parfümőreinek (az 'Orroknak') nagy része Grasse-ban tanulta ki a szakmát.", "A Chanel No. 5 parfümhöz szükséges jázmint kizárólag a Grasse környéki mezőkön termesztik.", "Egy kilogramm tiszta rózsaolaj előállításához körülbelül 3000 kilogramm friss szirmot kell feldolgozni."],
      ro: [
      ...
      en: [
        "Producing one liter of pure jasmine absolute requires roughly one ton of flowers.",
        "The International Perfume Museum (MIP) chronicles a 3,000-year history of the art form.",
        "The legendary Chanel No. 5 was formulated in 1921 using locally sourced Grasse jasmine.",
        "Grasse serves as the primary setting for Patrick Süskind’s literary classic 'Perfume'.",
        "Harvesting happens at dawn, when floral scents are at their peak intensity.",
        "The annual 'Fête du Jasmin' festival in August is a colorful celebration of the industry.",
        "Major luxury fashion houses maintain exclusive private fields in the area to guarantee ingredient quality."
      ]
    }, image: "/poi-images/industry-perfume-grasse-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Lascaux IV egy lenyűgöző, csúcstechnológiás múzeum és látogatóközpont, amely az eredeti, paleolitikumi Lascaux-barlang teljes, milliméteres pontosságú másolatát rejti. Mivel az eredeti barlangot a mikroklíma felborulása miatt a 60-as években le kellett zárni a közönség elől, ez a gigantikus projekt lehetővé teszi, hogy az emberek újra átélhessék a 20 ezer éves állatfestmények varázsát. A legmodernebb 3D-s szkennerekkel és kézi festéssel rekonstruálták a bikák termét és a többi ikonikus galériát. A komplexum interaktív módon mutatja be a jégkorszaki művészek életét és technikáit. Történelem K5 - őskori művészet és digitális rekonstrukció.",
      ...
      en: "Discovered in 1940, the original Lascaux cave revealed humanity’s most impressive prehistoric art gallery. Due to the fragility of these 17,000-year-old paintings, the cave was closed in 1963. Lascaux IV, opened in 2016, serves as the most comprehensive and technologically precise replica ever created. Housed in a semi-subterranean structure, the entire cave—including the famous 'Hall of the Bulls'—was recreated using high-end 3D scanning and casting techniques. The experience recreates the exact temperature, humidity, and darkness of the original, complemented by interactive exhibits exploring the techniques and environment of Cro-Magnon people."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A Lascaux IV projekt 66 millió euróba került, és 2016-ban nyitotta meg kapuit.", "A barlangmásolat falait pontosan ugyanolyan ásványi pigmentekkel festették ki, mint amilyeneket az ősemberek használtak.", "A komplexum épülete félig a földbe van süllyesztve, hogy beleolvadjon a Dordogne régió zöld dombjaiba.", "A kiállítás egy okos-tabletes (compagnon de visite) rendszerrel működik, amely minden látogatónak testreszabott információt ad."],
      ro: [
      ...
      en: [
        "The cave was found by chance by four local teenagers.",
        "Paintings focus almost exclusively on large animals: aurochs, horses, and deer.",
        "There is only one human figure depicted in the entire cave.",
        "Pigments used were derived from natural minerals like ochre and manganese oxide.",
        "Lascaux IV follows the successful, smaller-scale predecessors Lascaux II and III.",
        "Recognized globally, it is often called the 'Sistine Chapel of Prehistory.'",
        "The replica sits precisely at the base of the hill housing the original cave."
      ]
    }, image: "/poi-images/historical-lascaux-iv-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      hu: "A Puy du Fou Franciaország egyik legnépszerűbb és legkülönlegesebb tematikus parkja, amely nem a hagyományos hullámvasutakra, hanem grandiózus történelmi show-műsorokra épül. A nyugat-franciaországi Vendée régióban található parkban római gladiátorharcok, viking támadások és középkori lovagi tornák elevenednek meg több száz színész és állat bevonásával. A park koronája a 'Cinéscénie', a világ legnagyobb éjszakai szabadtéri előadása, amely több ezer önkéntes szereplővel mutatja be a régió történelmét. A park több ízben is elnyerte a 'Világ Legjobb Vidámparkja' díjat. Történelem K6 - történelmi rekonstrukciók és látványtervezés.",
      ...
      en: "Located in the Vendée region, Puy du Fou breaks the mold of theme parks by eschewing mechanical rides in favor of grand, immersive historical shows. Epic productions feature hundreds of actors, dozens of horses, and high-tech special effects to recreate scenarios ranging from Roman chariot races to Viking raids and medieval jousts. Guests roam through accurately reconstructed historical villages between performances. The park’s crown jewel, the 'Cinéscénie,' is a massive night show on a 23-hectare stage involving over 2,500 volunteers. It has been repeatedly named the world's best theme park."
    },
    factsAdvanced: {
      de: [
      ...
      hu: ["A parkban egyetlen mechanikus hullámvasút sincs, a vonzerőt kizárólag a történelmi előadások jelentik.", "A Cinéscénie esti műsorban több mint 4000 helyi önkéntes színész és táncos lép fel.", "A park saját madarász központtal rendelkezik, ahol a ragadozó madarak hatalmas szerepet kapnak a bemutatókon.", "A római Colosseum másolatában valós méretű szekérversenyeket is rendeznek a látogatók előtt."],
      ro: [
      ...
      en: [
        "The park was founded by Philippe de Villiers in 1978.",
        "The flagship 'Cinéscénie' night show draws nearly 400,000 spectators annually.",
        "Its falconry features over 200 birds of prey in the 'Bal des Oiseaux Fantômes' show.",
        "Puy du Fou has expanded internationally, with new parks opening in Spain.",
        "'Le Dernier Panache' is performed in a rotating 360-degree theater.",
        "Performers and technical staff are trained at the park’s dedicated 'Puy du Fou Académie'.",
        "Unwavering commitment to historical precision defines every production and reconstructed village."
      ]
