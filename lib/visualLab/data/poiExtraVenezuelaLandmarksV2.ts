...
export const poiExtraVenezuelaLandmarksV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Panteonul Național din Venezuela nu este doar un loc de înmormântare, ci o capodoperă arhitecturală în inima orașului Caracas. Fațada sa neobarocă și interiorul impunător, cu fresce artistice pe tavan, îl fac una dintre cele mai fotografiate clădiri din țară. Servește ca loc central al identității naționale, unde istoria Venezuelei este sculptată în piatră și artă. Vizitatorii experimentează aici atmosfera solemnă a unui loc care onorează marii eroi ai națiunii. Arhitectură K8 — monumente.",
      en: "The National Pantheon stands as a monumental landmark in Caracas, embodying Venezuela's historical legacy and national pride. Originally constructed as a church in the 18th century, it was later repurposed to serve as a mausoleum for the nation's most revered heroes. Its striking neoclassical architecture and the presence of Simón Bolívar's tomb make it one of the most significant sites for understanding the country's republican narrative. Geography K8 — History and Landmarks.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Clădirea impresionează prin fațada albă distinctivă și cupola centrală.", "Frescele de pe tavan reprezintă scene importante din viața lui Simón Bolívar.", "Este considerat unul dintre cele mai bine conservate exemple de arhitectură monumentală din secolul al XIX-lea în Venezuela.", "Panteonul este o parte integrantă a centrului istoric din Caracas."],
      en: ["Major historical monument in Caracas.", "Final resting place of Simón Bolívar.", "Repurposed from an 18th-century church.", "Represents national republican identity.", "Neoclassical architectural style.", "Designated as a national heritage site."],
    }, image: "/poi-images/venezuela-panteon-nacional-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Muzeul de Arte Frumoase (Museo de Bellas Artes) din Caracas este o instituție de clasă mondială. A fost găzduit într-o clădire neoclasică elegantă, care a fost ulterior completată cu o aripă modernă, reflectând evoluția arhitecturală a orașului. Colecțiile cuprind lucrări din antichitate până în modernitate, cu un accent deosebit pe arta latino-americană. Muzeul este un centru pentru educația culturală și oferă o perspectivă profundă asupra bogăției estetice a istoriei umane. Artă K7 — muzeologie.",
      en: "The Museum of Fine Arts (MBA) in Caracas is an iconic cultural institution, celebrated for its extensive collection of Venezuelan and international art. Located near the National Gallery and the Science Museum, it forms part of the city's primary cultural complex. The museum plays a pivotal role in preserving and showcasing the country's artistic heritage, ranging from colonial paintings to contemporary avant-garde works. Its architectural design and surrounding parkland reflect the museum's status as a central pillar of Venezuelan artistic expression. Geography K7 — Culture and Arts.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Clădirea originală a fost proiectată de Carlos Raúl Villanueva în stil neoclasic.", "Găzduiește una dintre cele mai semnificative colecții de artă egipteană din America Latină.", "Muzeul servește drept cel mai important loc pentru conservarea moștenirii artistice clasice a Venezuelei.", "Grădina de sculpturi oferă un loc liniștit pentru a te bucura de artă în aer liber."],
      en: ["Major art museum located in Caracas.", "Extensive collection of national and international art.", "Situated in the central cultural complex of the city.", "Preserves colonial to contemporary artistic works.", "Iconic cultural institution of Venezuela.", "Architecturally integrated into the city park system."],
    }, image: "/poi-images/venezuela-museo-bellas-artes-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Galeria de Artă Națională (GAN) este gardianul moștenirii vizuale venezuelene. În sălile sale spațioase sunt expuse capodopere ale artiștilor naționali, din perioada colonială până în prezent. Galeria permite vizitatorilor să urmărească dezvoltarea identității venezuelene prin ochii pictorilor și sculptorilor săi. Cu accent pe producția națională, GAN este un loc indispensabil pentru oricine dorește să înțeleagă sufletul Venezuelei. Artă K6 — identitate.",
      en: "National Art Gallery is a remarkable feature of the geography and culture of Venezuela. This museum is dedicated exclusively to the preservation and exhibition of Venezuelan art. Largest museum of Venezuelan art. Houses over 4,000 works of art. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Galeria deține cea mai mare colecție de lucrări ale celebrului pictor Arturo Michelena.", "A fost fondată pentru a crea un spațiu central pentru producția artistică venezueleană.", "Arhitectura noii clădiri este un punct culminant modern în cartierul muzeelor din Caracas.", "În fiecare an, aici au loc retrospectivă importante despre istoria artei naționale."],
      en: ["This museum is dedicated exclusively to the preservation and exhibition of Venezuelan art.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-galeria-arte-nacional-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Muzeul de Științe (Museo de Ciencias) este un loc al descoperirii și învățării. Situat în Plaza de los Museos, oferă perspective asupra bogatei biodiversități a Venezuelei și a secretelor istoriei pământului. De la schelete de dinozauri până la colecții etnografice ale popoarelor indigene, muzeul acoperă un spectru larg. Este deosebit de popular printre familii și școli, deoarece transmite știința într-un mod viu. Științe Naturale K5 — biodiversitate.",
      en: "Science Museum is a remarkable feature of the geography and culture of Venezuela. A fascinating museum offering exhibitions on natural history, biodiversity, and archaeology. Founded in 1875. Houses significant paleontological finds. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Muzeul este una dintre cele mai vechi instituții științifice ale țării.", "Designul arhitectural realizat de Carlos Raúl Villanueva îmbină elemente clasice și moderne.", "Servește ca centru de cercetare important pentru flora și fauna Venezuelei.", "Secția etnografică prezintă artefacte valoroase ale culturilor indigene din bazinul Orinoco."],
    ...
    }, image: "/poi-images/venezuela-museo-ciencias-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Muzeul de Artă Contemporană (MAC) din Caracas este considerat unul dintre cele mai importante muzee de acest gen din America Latină. Cu o colecție impresionantă de maeștri internaționali precum Picasso, Miró și Chagall, precum și artiști venezueleni de top, este un far al modernității. Arhitectura avangardistă a clădirii din complexul Parque Central subliniază spiritul inovator al expozițiilor. Este un obiectiv obligatoriu pentru orice iubitor de estetică modernă și inovație creativă. Artă K8 — modernitate.",
      en: "Museum of Contemporary Art is a remarkable feature of the geography and culture of Venezuela. The museum is known for its outstanding collection of modern art, including works by Picasso. Owns a significant suite of Picasso prints. Located in the Parque Central complex. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Muzeul a fost fondat în 1973 prin viziunea Sofiei Imber.", "Găzduiește Suita Picasso, una dintre cele mai complete colecții de stampe ale artistului la nivel mondial.", "Arhitectura folosește spații deschise generoase pentru a prezenta optim lucrările contemporane."],
      en: ["The museum is known for its outstanding collection of modern art, including works by Picasso.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-museo-arte-contemporaneo-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Muzeul Copiilor din Caracas (Museo de los Niños) a fost primul de acest gen din America Latină și continuă să stabilească standarde pentru învățarea interactivă. Cu motto-ul învățării prin joc, oferă copiilor posibilitatea de a experimenta teme complexe din fizică, biologie și tehnologie. Diferitele pavilioane stimulează curiozitatea și spiritul de cercetare al tinerilor vizitatori. Este o instituție de învățământ care combină distracția și cunoașterea într-un mod unic. Pedagogie K5 — învățare interactivă.",
      en: "Children's Museum of Caracas is a remarkable feature of the geography and culture of Venezuela. An interactive museum that introduces children to science, technology, and culture in a playful way. First children's museum in Latin America. Focus on interactive exhibits. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Muzeul s-a deschis în 1982 și a modelat de atunci generații de copii venezueleni.", "Expozițiile acoperă domenii precum spațiul, ecologia și comunicațiile.", "Conceptul interactiv a fost premiat internațional pentru calitatea sa pedagogică."],
      en: ["An interactive museum that introduces children to science, technology, and culture in a playful way.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-museo-de-los-ninos-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Muzeul de Artă Sacră (Museo Sacro) din Caracas este situat într-o clădire de fost cimitir frumos restaurată, chiar lângă Catedrală. Acesta păstrează bogata tradiție religioasă a Venezuelei prin statui impresionante, picturi și lucrări de orfevrărie din epoca colonială. Atmosfera liniștită a curții interioare și expozițiile curatoriate cu grijă oferă un moment de reflecție în mijlocul orașului mare. Este un loc care face tangibilă istoria spirituală a țării. Religie K6 — artă sacră.",
      en: "Museum of Sacred Art is a remarkable feature of the geography and culture of Venezuela. The museum houses a significant collection of religious art from the colonial period. Located right next to the Caracas Cathedral. Collection of colonial religious art. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Clădirea a servit inițial drept Cimitirul Canonicilor.", "Colecția include piese valoroase din secolele al XVII-lea și al XVIII-lea.", "Muzeul documentează influența puternică a Bisericii Catolice asupra societății coloniale.", "Curtea interioară este un exemplu de estetică arhitecturală colonială."],
      en: ["The museum houses a significant collection of religious art from the colonial period.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-museo-sacro-caracas-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Centrul de Artă Lira este un punct de întâlnire vibrant pentru scena culturală din Caracas. Servește drept platformă pentru artiștii emergenți și oferă spațiu pentru proiecte experimentale, muzică și teatru. Datorită locației sale și a programului variat, promovează schimbul cultural și creativitatea în oraș. Centrul este un exemplu al peisajului artistic dinamic și în continuă evoluție al Venezuelei. Cultură K7 — promovarea artei.",
      en: "Lira Art Center is a remarkable feature of the geography and culture of Venezuela. A contemporary cultural center providing space for various art forms and local exhibitions. Platform for local artists. Versatile cultural program. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Centrul promovează activ networking-ul între diverse discipline artistice.", "Oferă în mod regulat workshop-uri și cursuri pentru comunitate.", "Lira este cunoscut pentru susținerea proiectelor artistice inovatoare și neconvenționale."],
      en: ["A contemporary cultural center providing space for various art forms and local exhibitions.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-centro-de-arte-lira-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Teatrul Teresa Carreño este un monument arhitectural al modernismului venezuelean. Cu arhitectura sa distinctivă din beton aparent și structurile uriașe, plutitoare, este un punct de reper al orașului Caracas. Teatrul găzduiește săli de clasă mondială pentru opere, concerte și balet și este sediul unor orchestre importante. Simbolizează aspirațiile culturale și excelența artistică a Venezuelei la nivel internațional. Muzică K8 — management cultural.",
      en: "Teresa Carreño Theater is a remarkable feature of the geography and culture of Venezuela. The most important theater in Caracas and one of the most modern cultural centers in South America. Largest theater in Venezuela. Named after the famous pianist Teresa Carreño. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Teatrul a fost inaugurat oficial în 1983.", "Sala Ríos Reyna este celebră în întreaga lume pentru acustica sa excelentă.", "Clădirea integrează opere de artă monumentale ale artiștilor venezueleni precum Jesús Soto."],
      en: ["The most important theater in Caracas and one of the most modern cultural centers in South America.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teatro-teresa-carreno-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Teatrul Municipal din Caracas este o bijuterie a arhitecturii neoclasice din secolul al XIX-lea. În momentul deschiderii sale, a fost una dintre cele mai magnifice case de operă de pe continent, reflectând ascensiunea economică a Venezuelei. Cu decorul său interior somptuos și aranjamentul în formă de potcoavă al nivelurilor, oferă un cadru clasic pentru artele spectacolului. Este un monument viu al istoriei teatrului venezuelean. Teatru K7 — istoria operei.",
      en: "Municipal Theater of Caracas is a remarkable feature of the geography and culture of Venezuela. A magnificent historic opera house, counted among the oldest theaters in South America. Opened in 1881. Sumptuous interior decoration. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Teatrul a fost construit sub președinția lui Antonio Guzmán Blanco.", "A fost locul premierelor multor opere naționale.", "În ciuda modernizărilor, teatrul și-a păstrat farmecul istoric."],
      en: ["A magnificent historic opera house, counted among the oldest theaters in South America.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Teatrul Național din Caracas este un exemplu major al arhitecturii Belle Époque în Venezuela. A fost conceput pentru a oferi un cadru demn entuziasmului tot mai mare pentru genuri lirice mai ușoare, precum zarzuela și opereta. Fațada elegantă și detaliile fin lucrate la interior îl fac un punct de atracție culturală în centrul orașului. Teatrul a modelat viața culturală a capitalei timp de peste un secol și rămâne un simbol al cultivării culturii burgheze. Teatru K6 — genuri.",
      en: "National Theater of Caracas is a remarkable feature of the geography and culture of Venezuela. A beautiful historic theater known for its performances of zarzuela and operettas. Inaugurated in 1905. Known for its baroque interior. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Teatrul a fost ridicat sub domnia lui Cipriano Castro.", "Designul interior prezintă fresce artistice și ornamente aurite.", "Amplasarea în Plaza Páez îl face o parte proeminentă a ansamblului urban."],
      en: ["A beautiful historic theater known for its performances of zarzuela and operettas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teatro-nacional-caracas-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Teatrul Baralt din Maracaibo este mai mult decât un loc pentru spectacole; este un spațiu plin de istorie unde cinematografia venezueleană a făcut primii pași. În 1897, aici au avut loc primele proiecții de film ale țării. Clădirea însăși fascinează printr-un amestec eclectic de elemente neoclasice și Art Deco. Ca inimă culturală a orașului Maracaibo, păstrează moștenirea regiunii Zulia și este un monument semnificativ al istoriei culturale naționale. Media K7 — istoria filmului.",
      en: "Baralt Theater is a remarkable feature of the geography and culture of Venezuela. A historic theater in Maracaibo, considered the cradle of Venezuelan cinema. Site of the first film screening in Venezuela in 1897. Landmark of Maracaibo. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Teatrul a fost numit după poetul și istoricul Rafael María Baralt.", "Picturile de pe tavan au fost realizate de celebrul artist Antonio Angulo.", "După o lungă fază de restaurare, a fost transformat într-un centru cultural modern."],
      en: ["A historic theater in Maracaibo, considered the cradle of Venezuelan cinema.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teatro-baralt-maracaibo-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Casa Capitulării este un loc monumental al independenței venezuelene. Aici a fost semnat în 1823 documentul care a pus capăt definitiv dominației spaniole în Venezuela. Clădirea colonială păstrează atmosfera acelor zile de cotitură și servește astăzi ca muzeu și sediu al Academiei de Istorie din Zulia. Este un simbol central al victoriei voinței de libertate asupra puterii coloniale. Istorie K8 — independență.",
      en: "House of the Capitulation is a remarkable feature of the geography and culture of Venezuela. This historic house in Maracaibo is where the Spanish capitulation was signed after the Battle of Lake Maracaibo. Historic site of independence. The only preserved colonial house of its kind in Maracaibo. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["În această casă a fost pecetluită capitularea trupelor spaniole pe 3 august 1823.", "Arhitectura prezintă trăsăturile tipice ale unei case nobiliare din perioada colonială târzie.", "Clădirea este considerată unul dintre cele mai importante monumente din statul Zulia."],
      en: ["This historic house in Maracaibo is where the Spanish capitulation was signed after the Battle of Lake Maracaibo.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-casa-de-la-capitulacion-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Palatul Academiilor din Caracas este un exemplu impresionant de arhitectură neogotică din țară. Construită inițial ca mănăstire, a devenit ulterior sediul Universității Centrale și găzduiește astăzi cele mai importante academii științifice din Venezuela. Fațada sa distinctivă și curțile interioare istorice radiază o atmosferă de erudiție și tradiție. Palatul este un centru al vieții intelectuale și un monument semnificativ în inima capitalei. Arhitectură K8 — clădiri științifice.",
      en: "Palace of the Academies is a remarkable feature of the geography and culture of Venezuela. A magnificent neo-Gothic building that houses the national academies of Venezuela. Neo-Gothic facade. Houses the national academies. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Clădirea a îndeplinit diverse funcții de-a lungul secolelor, de la mănăstire la universitate.", "Găzduiește Academiile de Istorie, Limbă, Medicină și Științe Naturale.", "Palatul este o parte importantă a moștenirii istorice și arhitecturale a orașului Caracas."],
      en: ["A magnificent neo-Gothic building that houses the national academies of Venezuela.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-palacio-de-las-academias-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Palatul Municipal din Caracas este un element central în structura politică și socială a orașului. Situat în istorica Plaza Bolívar, a însoțit dezvoltarea capitalei venezuelene timp de generații. Arhitectura neoclasică a clădirii conferă pieței o aură demnă. În interior, găzduiește Muzeul Orașului, care expune artefacte valoroase ale istoriei orașului Caracas. Politică K8 — istoria orașului.",
      en: "Municipal Palace of Caracas is a remarkable feature of the geography and culture of Venezuela. A historic government building in Plaza Bolívar, housing the city administration of Caracas. Houses the City Museum of Caracas. Located on the north side of Plaza Bolívar. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Clădirea a fost renovată extensiv la sfârșitul secolului al XIX-lea pentru a-și păstra caracterul actual.", "În Capela Santa Rosa de Lima din interiorul palatului a fost semnată Declarația de Independență.", "Palatul este sediul Consiliului Municipal, fiind astfel inima administrativă a comunei Libertador."],
      en: ["A historic government building in Plaza Bolívar, housing the city administration of Caracas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-palacio-municipal-caracas-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Poșta Carmelitas este un punct de reper arhitectural în centrul orașului Caracas. Inițial o casă de locuit nobiliară, a fost transformată la începutul secolului al XX-lea într-o clădire poștală somptuoasă. Fațada sa neoclasică elegantă și detaliile arhitecturale fine sunt mărturii ale prosperității burgheze de la acea vreme. Reprezintă epoca în care Caracas era modernizat, iar serviciile publice erau găzduite în clădiri monumentale. Arhitectură K7 — peisaj urban.",
      en: "Carmelitas Post Office is a remarkable feature of the geography and culture of Venezuela. A striking building in downtown Caracas, known for its elegant neoclassical facade. Built in the early 20th century. Example of neoclassical architecture. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Clădirea este situată pe colțul istoric de stradă Carmelitas.", "Timp îndelungat a fost cel mai important nod poștal al capitalei.", "Astăzi este un monument istoric protejat și definește identitatea urbană a centrului."],
      en: ["A striking building in downtown Caracas, known for its elegant neoclassical facade.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-correo-de-carmelitas-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Arcul Federației este un monument impunător în istoricul parc El Calvario din Caracas. A fost ridicat pentru a comemora victimele și rezultatul Războiului Federal din secolul al XIX-lea. Cu designul său neoclasic, domină intrarea în parc și este un simbol al drumului Venezuelei către republica federală. Arcul oferă un cadru impresionant pentru plimbările într-unul dintre cele mai vechi spații verzi ale orașului. Istorie K8 — monumente.",
      en: "Arch of the Federation is a remarkable feature of the geography and culture of Venezuela. A monumental arch in El Calvario Park, commemorating the Venezuelan Federal War. Located in El Calvario Park. Commemorates the Federal War (1859-1863). This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Arcul a fost inaugurat în 1895 sub președintele Joaquín Crespo.", "Designul său este inspirat de Arcul de Triumf din Paris.", "Inscripțiile de pe arc celebrează principiile federale ale republicii."],
      en: ["A monumental arch in El Calvario Park, commemorating the Venezuelan Federal War.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Turnurile El Silencio sunt un reper al planificării urbane și arhitecturii venezuelene. Au făcut parte dintr-un proiect ambițios de reînnoire urbană din anii 1950, care dorea să transforme Caracas într-o metropolă modernă. Fiind una dintre cele mai înalte clădiri din acea vreme, ele definesc până astăzi silueta centrului orașului. Forma lor simetrică și legătura cu Avenida Bolívar le fac o parte indispensabilă a identității urbane a capitalei. Arhitectură K8 — urbanism.",
      en: "El Silencio Towers is a remarkable feature of the geography and culture of Venezuela. Two iconic twin towers in the center of Caracas, symbolizing the city's 20th-century modernization. Built in the 1950s. Symbol of modern progress in Caracas. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Timp de decenii au fost cele mai înalte structuri din Venezuela.", "Proiectul a marcat sfârșitul stocului de clădiri coloniale din cartierul El Silencio de astăzi.", "Turnurile gemene sunt un exemplu remarcabil al stilului internațional în America de Sud."],
      en: ["Two iconic twin towers in the center of Caracas, symbolizing the city's 20th-century modernization.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-torres-el-silencio-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Complexul Parque Central din Caracas este un exemplu monumental al brutalismului și urbanismului vertical. Cele două turnuri principale au fost, la finalizarea lor, cei mai înalți zgârie-nori din America Latină și rămân o dovadă impresionantă a ingineriei venezuelene. Complexul funcționează ca un oraș în oraș, unde locuința, munca și cultura sunt strâns legate într-un spațiu restrâns. În ciuda provocărilor vremii, Parque Central rămâne un centru de greutate arhitectural care definește identitatea orașului Caracas. Arhitectură K8 — oraș vertical.",
      en: "Parque Central Complex is a remarkable feature of the geography and culture of Venezuela. A massive residential and commercial complex with the second tallest skyscrapers in South America. Includes the iconic twin towers. Important cultural and commercial center. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Complexul găzduiește muzee importante precum Muzeul de Artă Contemporană.", "Turnurile ating o înălțime de peste 220 de metri.", "Parque Central a fost un proiect de pionierat pentru megastructuri multifuncționale în America de Sud."],
      en: ["A massive residential and commercial complex with the second tallest skyscrapers in South America.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  },
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Turnul lui David (Torre de David) este una dintre cele mai controversate clădiri din lume. Planificat inițial ca centru financiar strălucitor, a rămas neterminat după o criză economică și a devenit mai târziu scena uneia dintre cele mai mari ocupări de case din istorie. Această clădire spune o poveste despre ambiție, eșec și adaptare urbană informală. A atras atenția internațională a arhitecților și sociologilor care examinează puterea transformatoare a spațiului urban. Arhitectură K8 — transformare.",
      en: "Tower of David (Torre de David) is a remarkable feature of the geography and culture of Venezuela. An unfinished skyscraper in Caracas that gained worldwide fame as a symbol of urban transformation. Third tallest building in Venezuela. Globally known through documentaries. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Construcția a fost oprită în 1994 din cauza crizei bancare venezuelene.", "Timp de ani de zile, mii de oameni au trăit în structura neterminată.", "Clădirea a devenit un simbol global al provocărilor socio-economice ale orașului Caracas."],
      en: ["An unfinished skyscraper in Caracas that gained worldwide fame as a symbol of urban transformation.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-centro-financiero-confinanzas-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Telecabina Mukumbarí este o performanță inginerească de top și cartea de vizită turistică a Anzilor venezueleni. Pe cinci secțiuni, duce vizitatorii de la Mérida, din înălțimi subtropicale, în regiunile înghețate ale Pico Espejo, la peste 4.700 de metri altitudine. În timpul călătoriei, pasagerii experimentează schimbarea dramatică a vegetației și priveliștea uluitoare asupra Sierra Nevada de Mérida. Este nu doar un mijloc de transport, ci o fereastră către peisajele montane maiestuoase ale Venezuelei. Turism K6 — munți înalți.",
      en: "Mukumbarí Cable Car is a remarkable feature of the geography and culture of Venezuela. The highest and longest cable car in the world, leading from Mérida to the summit of Pico Espejo. Highest station at 4,765 meters. Connects Mérida with Pico Espejo. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Sistemul are o lungime totală de aproximativ 12,5 kilometri.", "După o modernizare cuprinzătoare, a fost redeschisă în 2016 sub numele Mukumbarí.", "Stația montană oferă adesea o vedere asupra lui Pico Bolívar, cel mai înalt munte din Venezuela."],
      en: ["The highest and longest cable car in the world, leading from Mérida to the summit of Pico Espejo.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teleferico-mukumbari-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Telecabina Warairarepano este cea mai populară cale de evadare a locuitorilor capitalei de agitația din Caracas. Conectează metropola cu vârful Parcului Național El Ávila și oferă în câteva minute o lume complet nouă, cu aer montan răcoros și natură neatinsă. De la stația montană, există o vedere panoramică spectaculoasă asupra întregii văi a Caracasului și, în zilele senine, până la Marea Caraibelor. Telecabina este o experiență obligatorie pentru orice vizitator al capitalei. Turism K5 — oraș și natură.",
      en: "Warairarepano Cable Car is a remarkable feature of the geography and culture of Venezuela. A cable car in Caracas that takes visitors to the summit of El Ávila mountain. Leads to the El Ávila National Park. Offers a view of the Caribbean Sea. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Telecabina a fost inaugurată în anii 1950 și este de atunci un simbol al orașului.", "La stația montană se află celebrul Hotel Humboldt.", "Călătoria este una dintre cele mai rapide modalități de a experimenta diferențele climatice dintre vale și munte."],
      en: ["A cable car in Caracas that takes visitors to the summit of El Ávila mountain.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teleferico-warairarepano-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Podul General Rafael Urdaneta este simbolul mândru al statului Zulia. Traversează Lacul Maracaibo în cel mai îngust punct al său, legând orașul Maracaibo de restul țării. Structura este un exemplu major de inginerie modernă din beton precomprimat și a fost o senzație mondială la deschiderea sa. Pentru locuitorii din Zulia, podul este mult mai mult decât o rută de transport; este un simbol cultural, cântat în nenumărate cântece și poezii. Tehnică K8 — construcția podurilor.",
      en: "General Rafael Urdaneta Bridge is a remarkable feature of the geography and culture of Venezuela. An iconic cable-stayed bridge crossing Lake Maracaibo and one of the longest structures of its kind worldwide. Crosses Lake Maracaibo. One of the longest bridge structures in the world. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Podul a fost inaugurat în 1962 și are o lungime totală de aproximativ 8,7 kilometri.", "Construcția folosește stâlpi masivi de beton pentru a lăsa liber canalul de navigație.", "Noaptea, podul primește o iluminare spectaculoasă, vizibilă de la kilometri distanță."],
      en: ["An iconic cable-stayed bridge crossing Lake Maracaibo and one of the longest structures of its kind worldwide.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-puente-rafael-urdaneta-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Podul Angostura a fost o bornă tehnologică pentru Venezuela la finalizarea sa. Ca primă legătură permanentă peste vastul râu Orinoco, a permis transportul rutier ușor între nordul țării și zonele sudice bogate în resurse. Construcția sa suspendată elegantă definește silueta orașului Ciudad Bolívar și simbolizează depășirea barierelor geografice. Podul rămâne un element crucial al infrastructurii naționale și un monument mândru al dezvoltării moderne. Tehnică K7 — infrastructură.",
      en: "Angostura Bridge is a remarkable feature of the geography and culture of Venezuela. The first suspension bridge over the Orinoco River, connecting Ciudad Bolívar with the rest of the country. First bridge over the Orinoco River. Elegant suspension construction. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Podul a fost inaugurat în 1967 și are o deschidere principală de peste 700 de metri.", "Construcția sa a fost decisivă pentru integrarea economică a regiunii industriale Guayana.", "Arhitectura amintește de celebrele poduri suspendate din SUA."],
      en: ["The first suspension bridge over the Orinoco River, connecting Ciudad Bolívar with the rest of the country.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-puente-angostura-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Podul Orinokia este o dovadă a dezvoltării industriale în curs de desfășurare în sudul Venezuelei. Ca a doua mare structură de pod peste Orinoco, degrevează Podul Angostura și permite transportul eficient pentru industria de oțel și aluminiu din Ciudad Guayana. Cu construcția sa modernă hobanată, este un simbol al capacității tehnologice a țării în secolul al XXI-lea. Leagă statele Bolívar și Anzoátegui, întărind astfel integrarea economică. Economie K8 — logistică.",
      en: "Orinokia Bridge is a remarkable feature of the geography and culture of Venezuela. The second major bridge over the Orinoco, representing a strategic link for heavy industry. Second bridge over the Orinoco. Important for heavy transport. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Podul a fost pus oficial în funcțiune în 2006.", "Structura este una dintre cele mai moderne de acest tip din America Latină.", "Podul Orinokia a redus masiv timpul de călătorie între centrul industrial și nordul țării."],
      en: ["The second major bridge over the Orinoco, representing a strategic link for heavy industry.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-puente-orinokia-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Stadionul Monumental Simón Bolívar este noul templu pentru baseball, sportul național al Venezuelei. Cu capacitatea sa gigantică și facilitățile de ultimă generație, stabilește noi standarde pentru stadioanele din regiune. A fost proiectat pentru a găzdui turnee internaționale și pentru a surprinde entuziasmul fanilor într-un mediu de clasă mondială. Stadionul nu este doar un loc pentru sport, ci și un simbol al mândriei și semnificației culturale a baseball-ului în societatea venezueleană. Sport K6 — baseball.",
      en: "Simón Bolívar Monumental Stadium is a remarkable feature of the geography and culture of Venezuela. One of the most modern and largest baseball stadiums in Latin America, located in southern Caracas. Capacity for approx. 40,000 spectators. Most modern baseball stadium in the region. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Stadionul a fost inaugurat pentru Serie del Caribe 2023.", "Arhitectura oferă linii vizuale moderne și confort pentru fani.", "Amplasarea în La Rinconada integrează stadionul într-un mare complex sportiv și de agrement."],
      en: ["One of the most modern and largest baseball stadiums in Latin America, located in southern Caracas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-estadio-monumental-simon-bolivar-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Poliedrul din Caracas este o iconă a arhitecturii secolului al XX-lea în Venezuela. Cupola sa geodezică, inspirată de principiile lui Buckminster Fuller, o face una dintre cele mai recognoscibile clădiri din oraș. A găzduit nenumărate concerte istorice, competiții sportive și evenimente politice, fiind adânc ancorată în memoria culturală a venezuelenilor. Poliedrul reprezintă o epocă a optimismului tehnologic și rămâne locația centrală pentru evenimente de masă în capitală. Arhitectură K7 — construcții geodezice.",
      en: "Poliedro de Caracas is a remarkable feature of the geography and culture of Venezuela. A striking geodesic dome that serves as the most important multipurpose venue for concerts and sporting events. Iconic geodesic dome. Most significant event venue in the capital. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Poliedrul a fost deschis în 1974 și a fost scena multor evenimente muzicale internaționale.", "Arhitectura permite un spațiu interior gigantic fără coloane.", "Este situat în imediata apropiere a Stadionului Monumental Simón Bolívar."],
      en: ["A striking geodesic dome that serves as the most important multipurpose venue for concerts and sporting events.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-poliedro-de-caracas-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Orașul Universitar din Caracas (Ciudad Universitaria) este un exemplu unic în lume de sinteză între arhitectură și artă plastică. Proiectat de arhitectul Carlos Raúl Villanueva, campusul integrează opere de artă monumentale direct în planificarea arhitecturală. UNESCO a desemnat campusul drept Patrimoniu Mondial, deoarece întruchipează idealurile modernismului într-o formă perfectă. Nu este doar un loc de învățământ, ci un muzeu viu în aer liber care reunește cele mai importante curente ale artei moderne din secolul al XX-lea. Arhitectură K8 — patrimoniu mondial.",
      en: "University City of Caracas is a remarkable feature of the geography and culture of Venezuela. The main campus of the University of Venezuela, a UNESCO World Heritage site and masterpiece of modern architecture. UNESCO World Heritage site since 2000. Designed by Carlos Raúl Villanueva. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Campusul găzduiește peste 100 de opere de artă semnificative, integrate ferm în clădiri.", "Este considerată opera principală a lui Carlos Raúl Villanueva.", "Ciudad Universitaria este o bornă a urbanismului modern în America Latină."],
      en: ["The main campus of the University of Venezuela, a UNESCO World Heritage site and masterpiece of modern architecture.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-ciudad-universitaria-caracas-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Aula Magna a UCV este unul dintre cele mai spectaculoase auditorii din lume din punct de vedere acustic și vizual. Cunoscută pentru norii sau farfuriile zburătoare ale lui Alexander Calder care plutesc pe tavan, oferă o legătură inegalabilă între artă și funcție. Aceste structuri nu oferă doar o experiență vizuală, ci sunt esențiale pentru acustica perfectă a sălii. Aula Magna este inima orașului universitar și un simbol al integrării armonioase a artei în spațiul public. Artă K8 — acustică și design.",
      en: "Aula Magna - UCV is a remarkable feature of the geography and culture of Venezuela. The impressive auditorium of the University of Venezuela, world-famous for its acoustic 'clouds' by Alexander Calder. World-famous acoustic clouds by Alexander Calder. Heart of the UNESCO World Heritage university. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Alexander Calder a colaborat strâns cu acusticianul pentru a optimiza formele norilor.", "Aula Magna este folosită pentru ceremonii academice și culturale importante.", "Impactul vizual al elementelor colorate plutitoare este unic în lume."],
      en: ["The impressive auditorium of the University of Venezuela, world-famous for its acoustic 'clouds' by Alexander Calder.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-aula-magna-ucv-landmark-v2.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Monumentul Păcii din Trujillo este o statuie colosală a Fecioarei Maria, vizibilă de departe dincolo de regiunea Anzilor. Cu înălțimea sa impresionantă, este unul dintre cele mai înalte monumente religioase din emisfera vestică. Vizitatorii pot urca în interiorul statuii și se pot bucura de o vedere uluitoare asupra munților Trujillo de pe diferite terase panoramice. Monumentul este un simbol al credinței profunde și al dorinței de pace în Venezuela. Religie K6 — sculptură monumentală.",
      en: "Peace Monument is a remarkable feature of the geography and culture of Venezuela. A huge statue of the Virgin Mary in Trujillo, being one of the tallest religious monuments in the Americas. Taller than the Christ the Redeemer statue in Rio. Offers panoramic views of the Andes. This landmark is part of Venezuela's cultural and natural heritage, set between the Andes, the Llanos, the Orinoco Delta, and the Caribbean coast. Like many notable places in Venezuela, it combines regional character between the Caribbean, the Andes, and the Orinoco basin with wider significance. Thus, this place contributes to Venezuela's diverse profile, from the Llanos plains and Angel Falls all the way to Caracas and Maracaibo.",
    },
    facts: {
    ...
    factsAdvanced: {
      ...
      ro: ["Monumentul atinge o înălțime de aproximativ 46,7 metri.", "A fost inaugurat în 1983 și este un important loc de pelerinaj.", "Interiorul statuii poate fi vizitat și dispune de cinci puncte de belvedere."],
      en: ["A huge statue of the Virgin Mary in Trujillo, being one of the tallest religious monuments in the Americas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  }
,
  {
    ...
    description: {
      ...
      ro: "Obeliscul este situat în Plaza Francia din cartierul Altamira din Caracas. Acesta este un reper cunoscut al districtului financiar.",
      en: "The obelisk is located at Plaza Francia in the Altamira district of Caracas. It is a well-known landmark of the financial district.",
    },
    facts: {
      de: ["Höhe circa 45 Meter", "Einweihung im Jahr 1945", "Architekt Luis Malaussena", "Zentrum von Plaza Francia"],
      hu: ["Magassága kb. 45 méter", "1945-ben avatták fel", "Tervezte Luis Malaussena", "A Francia tér központja"],
      ro: ["Înălțime de aproximativ 45 de metri", "Inaugurat în 1945", "Arhitect Luis Malaussena", "Centrul Plaza Francia"],
      en: ["Height approx 45 meters", "Inaugurated in 1945", "Architect Luis Malaussena", "Center of Plaza Francia"],
    },
    imageHint: "Altamira Obelisk Caracas plaza",
  },
  {
    ...
    description: {
      ...
      ro: "Muzeul este găzduit în clădirea fostului Castillo de San Carlos. Acesta prezintă exponate legate de istoria militară a regiunii.",
      en: "The museum is housed in the building of the former Castillo de San Carlos. It displays exhibits related to the military history of the region.",
    },
    facts: {
      de: ["Gebäude aus dem 17. Jahrhundert", "Ehemalige Verteidigungsanlage", "Fokus auf regionale Konflikte", "Liegt am Maracaibo-See"],
      hu: ["17. századi épület", "Egykori védelmi létesítmény", "Regionális konfliktusokra fókuszál", "A Maracaibo-tónál fekszik"],
      ro: ["Clădire din secolul al XVII-lea", "Fostă instalație defensivă", "Se concentrează pe conflicte regionale", "Situat la lacul Maracaibo"],
      en: ["17th-century building", "Former defensive facility", "Focus on regional conflicts", "Located at Lake Maracaibo"],
    },
    imageHint: "Maracaibo colonial building museum",
  },
  {
    ...
    description: {
      ...
      ro: "Catedrala din Valencia este o biserică romano-catolică situată în centrul orașului. A fost construită inițial în secolul al XVI-lea.",
      en: "The Cathedral of Valencia is a Roman Catholic church in the city center. It was originally constructed in the 16th century.",
    },
    facts: {
      de: ["Hauptkirche von Valencia", "Barocker Baustil", "Regelmäßige Restaurierungen", "Wichtiger Ort der Verehrung"],
      hu: ["Valencia főtemploma", "Barokk építészeti stílus", "Rendszeres felújítások", "Fontos vallási helyszín"],
      ro: ["Biserica principală din Valencia", "Stil arhitectural baroc", "Restaurări periodice", "Important loc de venerație"],
      en: ["Main church of Valencia", "Baroque architectural style", "Regular restorations", "Important place of worship"],
    },
    imageHint: "Cathedral of Valencia Venezuela exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Capela este situată în munții de lângă Caracas. Este dedicată naturalistului Alexander von Humboldt.",
      en: "The chapel is located in the mountains near Caracas. It is dedicated to the naturalist Alexander von Humboldt.",
    },
    facts: {
      de: ["In bergiger Lage", "Gewidmet Alexander von Humboldt", "Einfache Architektur", "Wanderziel"],
      hu: ["Hegyvidéki helyszín", "Alexander von Humboldt emlékére", "Egyszerű építészet", "Túracélpont"],
      ro: ["Locație montană", "Dedicată lui Alexander von Humboldt", "Arhitectură simplă", "Destinație pentru drumeții"],
      en: ["Mountain location", "Dedicated to Alexander von Humboldt", "Simple architecture", "Hiking destination"],
    },
    imageHint: "Humboldt chapel mountains Caracas",
  },
  {
    ...
    description: {
      ...
      ro: "Clădirea găzduiește Adunarea Națională a Venezuelei. Este situată în centrul istoric al orașului Caracas.",
      en: "The building houses the National Assembly of Venezuela. It is located in the historic center of Caracas.",
    },
    facts: {
      de: ["Sitz der Legislative", "Neoklassizistisches Design", "Eröffnet im Jahr 1872", "Umfasst den Salon Elíptico"],
      hu: ["A törvényhozás székhelye", "Neoklasszikus stílus", "1872-ben nyílt meg", "Tartalmazza az Elíptico szalont"],
      ro: ["Sediul legislativului", "Design neoclasic", "Deschis în 1872", "Include Salonul Elíptico"],
      en: ["Seat of the legislature", "Neoclassical design", "Opened in 1872", "Includes the Elíptico Salon"],
    },
    imageHint: "Federal Legislative Palace Caracas",
  },
  {
    ...
    description: {
      ...
      ro: "Un pod istoric de fier din Caracas. A fost construit la sfârșitul secolul al XIX-lea.",
      en: "A historic iron bridge in Caracas. It was constructed in the late 19th century.",
    },
    facts: {
      de: ["Konstruktion aus Stahl", "Überquert den Río Guaire", "Industriedenkmal", "Ursprünglicher Standort bewahrt"],
      hu: ["Acélszerkezet", "Átível a Guaire folyón", "Ipari műemlék", "Megőrzött eredeti helyszín"],
      ro: ["Construcție din oțel", "Traversează râul Guaire", "Monument industrial", "Locație originală păstrată"],
      en: ["Steel construction", "Crosses the Guaire River", "Industrial monument", "Original location preserved"],
    },
    imageHint: "Puente de Hierro bridge Caracas",
  },
  {
    ...
    description: {
      ...
      ro: "Muzeul este situat într-un conac din secolul al XVIII-lea. Acesta prezintă opere de artă din perioada colonială.",
      en: "The museum is housed in an 18th-century mansion. It presents works of art from the colonial period.",
    },
    facts: {
      de: ["Herrenhaus aus dem Jahr 1797", "Zeigt Möbel und Gemälde", "Kolonialarchitektur", "Gartenanlage vorhanden"],
      hu: ["1797-es udvarház", "Bútorokat és festményeket mutat be", "Gyarmati építészet", "Kerttel rendelkezik"],
      ro: ["Conac din 1797", "Expune mobilier și picturi", "Arhitectură colonială", "Grădină inclusă"],
      en: ["Mansion from 1797", "Displays furniture and paintings", "Colonial architecture", "Garden included"],
    },
    imageHint: "Quinta de Anauco museum Caracas",
  },
  {
    ...
    description: {
      ...
      ro: "Un turn modern în orașul Mérida. Oferă priveliști asupra peisajului montan din jur.",
      en: "A modern tower in the city of Mérida. It offers views of the surrounding mountain landscape.",
    },
    facts: {
      de: ["Standort in Mérida", "Moderne Betonbauweise", "Aussichtsplattform", "In der Nähe der Anden"],
      hu: ["Méridai helyszín", "Modern betonszerkezet", "Kilátó", "Közel az Andokhoz"],
      ro: ["Locație în Mérida", "Structură modernă din beton", "Platformă de observație", "Aproape de Anzi"],
      en: ["Location in Mérida", "Modern concrete structure", "Observation deck", "Near the Andes"],
    },
    imageHint: "Torre Pedregosa Merida",
  },
  {
    ...
    description: {
      ...
      ro: "Teatrul este situat în Barquisimeto. Este unul dintre cele mai importante locuri culturale din oraș.",
      en: "The theater is located in Barquisimeto. It is one of the most important cultural venues in the city.",
    },
    facts: {
      de: ["Erbaut im frühen 20. Jahrhundert", "Kulturelles Zentrum", "Veranstaltungsort für Konzerte", "Architektonisches Erbe"],
      hu: ["A 20. század elején épült", "Kulturális központ", "Koncertek helyszíne", "Építészeti örökség"],
      ro: ["Construit la începutul secolului al XX-lea", "Centru cultural", "Locație pentru concerte", "Moștenire arhitecturală"],
      en: ["Built in the early 20th century", "Cultural center", "Venue for concerts", "Architectural heritage"],
    },
    imageHint: "Teatro Juarez Barquisimeto",
  },
  {
    ...
    description: {
      ...
      ro: "Stadionul face parte din Ciudad Universitaria de Caracas. Este un exemplu semnificativ de arhitectură modernă.",
      en: "The stadium is part of the Ciudad Universitaria de Caracas. It is a significant example of modern architecture.",
    },
    facts: {
      de: ["Architekt Carlos Raúl Villanueva", "UNESCO-Welterbe-Gelände", "Multifunktionale Sportstätte", "Eröffnet im Jahr 1951"],
      hu: ["Építész Carlos Raúl Villanueva", "UNESCO világörökségi terület", "Multifunkcionális sportlétesítmény", "1951-ben nyílt meg"],
      ro: ["Arhitect Carlos Raúl Villanueva", "Situl patrimoniului mondial UNESCO", "Arenă sportivă multifuncțională", "Deschis în 1951"],
      en: ["Architect Carlos Raúl Villanueva", "UNESCO World Heritage site", "Multipurpose sports venue", "Opened in 1951"],
    },
    imageHint: "Olympic Stadium UCV Caracas",
  },
  {
    ...
    description: {
      ...
      ro: "Această fortăreață este situată pe insula Margarita. A servit la apărarea împotriva piraților.",
      en: "This fortress is located on Margarita Island. It was used for defense against pirates.",
    },
    facts: {
      de: ["Auf der Insel Margarita", "Koloniale Verteidigungsanlage", "Steinmauerbauweise", "Touristische Attraktion"],
      hu: ["Margarita szigetén", "Gyarmati védelmi létesítmény", "Kőfalas építés", "Turisztikai látványosság"],
      ro: ["Pe insula Margarita", "Instalație defensivă colonială", "Construcție din zidărie de piatră", "Atracție turistică"],
      en: ["On Margarita Island", "Colonial defensive facility", "Stone wall construction", "Tourist attraction"],
    },
    imageHint: "Castillo de la Asuncion Margarita Island",
  },
  {
    ...
    description: {
      ...
      ro: "Muzeul din Maracaibo este dedicat temelor științifice naturale. Oferă expoziții pentru diferite grupe de vârstă.",
      en: "The museum in Maracaibo is dedicated to natural science topics. It offers exhibits for various age groups.",
    },
    facts: {
      de: ["Interaktive Exponate", "Bildungsfokus", "Regionale Geologie", "Moderne Einrichtung"],
      hu: ["Interaktív kiállítások", "Oktatási fókusz", "Regionális geológia", "Modern felszerelés"],
      ro: ["Exponate interactive", "Focus educațional", "Geologie regională", "Facilități moderne"],
      en: ["Interactive exhibits", "Educational focus", "Regional geology", "Modern facilities"],
    },
    imageHint: "Science Museum Maracaibo exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Catedrala din Barquisimeto este cunoscută pentru arhitectura sa modernă. A fost sfințită în anul 1968.",
      en: "The Cathedral of Barquisimeto is known for its modern architecture. It was consecrated in 1968.",
    },
    facts: {
      de: ["Ungewöhnliches Design", "Stahlbetonstruktur", "Entworfen von Jahn Bergkamp", "Wahrzeichen der Stadt"],
      hu: ["Szokatlan design", "Vasbeton szerkezet", "Tervezte Jahn Bergkamp", "A város jelképe"],
      ro: ["Design neobișnuit", "Structură din beton armat", "Proiectată de Jahn Bergkamp", "Simbol al orașului"],
      en: ["Unusual design", "Reinforced concrete structure", "Designed by Jahn Bergkamp", "Landmark of the city"],
    },
    imageHint: "Barquisimeto Cathedral modern",
  },
  {
    ...
    description: {
      ...
      ro: "Această clădire istorică servește drept sediu al administrației orașului. Este situată în centrul orașului Valencia.",
      en: "This historic building serves as the seat of the city administration. It is located in the center of Valencia.",
    },
    facts: {
      de: ["Sitz der Stadtregierung", "Architektur im kolonialen Stil", "Zentraler Standort", "Wichtige Verwaltungseinheit"],
      hu: ["A városi kormányzat székhelye", "Gyarmati stílusú építészet", "Központi helyszín", "Fontos adminisztratív egység"],
      ro: ["Sediul administrației locale", "Arhitectură în stil colonial", "Locație centrală", "Unitate administrativă importantă"],
      en: ["Seat of the city government", "Colonial-style architecture", "Central location", "Important administrative unit"],
    },
    imageHint: "Municipal Palace Valencia",
  },
  {
    ...
    description: {
      ...
      ro: "Muzeul este situat în Maracaibo și colectează opere contemporane. Promovează artiști locali și internaționali.",
      en: "The museum is located in Maracaibo and collects contemporary works. It promotes local and international artists.",
    },
    facts: {
      de: ["Sitz in Maracaibo", "Fokus auf moderne Kunst", "Wechselnde Ausstellungen", "Kulturelles Zentrum"],
      hu: ["Maracaiboi székhely", "Fókuszban a modern művészet", "Váltakozó kiállítások", "Kulturális központ"],
      ro: ["Sediul în Maracaibo", "Focus pe artă modernă", "Expoziții temporare", "Centru cultural"],
      en: ["Location in Maracaibo", "Focus on modern art", "Rotating exhibitions", "Cultural center"],
    },
    imageHint: "Contemporary Art Museum Zulia",
  },
  {
    ...
    description: {
      ...
      ro: "Un pod în regiunea montană a Anzilor. Este o structură tehnică pentru traversarea canioanelor.",
      en: "A bridge in the mountainous region of the Andes. It is a technical structure for crossing canyons.",
    },
    facts: {
      de: ["In den Anden gelegen", "Verkehrsknotenpunkt", "Überquert tiefe Schluchten", "Stahl- und Betonbau"],
      hu: ["Az Andokban található", "Közlekedési csomópont", "Mély szakadékokat ível át", "Acél- és betonépítés"],
      ro: ["Situat în Anzi", "Nod rutier", "Traversează canioane adânci", "Construcție din oțel și beton"],
      en: ["Located in the Andes", "Traffic junction", "Crosses deep canyons", "Steel and concrete construction"],
    },
    imageHint: "Puente de la Sierra Andes",
  },
  {
    ...
    description: {
      ...
      ro: "Teatrul din Valencia servește drept centru pentru artele spectacolului. Este valoros din punct de vedere arhitectural.",
      en: "The theater in Valencia serves as a center for performing arts. It is architecturally valuable.",
    },
    facts: {
      de: ["Kultureller Treffpunkt", "Zentrum für Künste", "Städtisches Denkmal", "Regelmäßige Vorstellungen"],
      hu: ["Kulturális találkozóhely", "Művészeti központ", "Városi műemlék", "Rendszeres előadások"],
      ro: ["Loc de întâlnire cultural", "Centru de arte", "Monument urban", "Spectacole regulate"],
      en: ["Cultural meeting place", "Center for arts", "Urban monument", "Regular performances"],
    },
    imageHint: "Teatro Ateneo Valencia",
  },
  {
    ...
    description: {
      ...
      ro: "Acest turn este un element iconic al Ciudad Universitaria de Caracas. Este considerat simbolul campusului.",
      en: "This tower is an iconic feature of the Ciudad Universitaria de Caracas. It is considered the symbol of the campus.",
    },
    facts: {
      de: ["Teil der Universität", "Modernes Design", "Uhrturm", "Wahrzeichen der Stadt"],
      hu: ["Az egyetem része", "Modern design", "Óratorony", "A város jelképe"],
      ro: ["Parte a universității", "Design modern", "Turn cu ceas", "Simbol al orașului"],
      en: ["Part of the university", "Modern design", "Clock tower", "Landmark of the city"],
    },
    imageHint: "Clock tower University Caracas",
  },
  {
    ...
    description: {
      ...
      ro: "Muzeul din Caracas este dedicat istoriei muzicii din Venezuela. Expune instrumente tradiționale.",
      en: "The museum in Caracas is dedicated to the history of music in Venezuela. It exhibits traditional instruments.",
    },
    facts: {
      de: ["Fokus auf Musikgeschichte", "Sammlung von Instrumenten", "Kulturelles Erbe", "Regelmäßige Konzerte"],
      hu: ["Zenetörténeti fókusz", "Hangszergyűjtemény", "Kulturális örökség", "Rendszeres koncertek"],
      ro: ["Focus pe istoria muzicii", "Colecție de instrumente", "Moștenire culturală", "Concerte regulate"],
      en: ["Focus on music history", "Collection of instruments", "Cultural heritage", "Regular concerts"],
    },
    imageHint: "Music museum Caracas",
  }
];
