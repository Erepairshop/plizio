...
export const poiExtraVenezuelaLandmarksV2: POI[] = [
    ...
    }, image: "/poi-images/venezuela-museo-bellas-artes-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      en: ["Largest museum of Venezuelan art.", "Houses over 4,000 works of art.", "This museum is dedicated exclusively to the preservation and exhibition of Venezuelan art.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    ...
    }, image: "/poi-images/venezuela-museo-ciencias-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Deține o suită semnificativă de stampe Picasso.", "Muzeul a fost fondat în 1973 prin viziunea Sofiei Imber.", "Găzduiește Suita Picasso, una dintre cele mai complete colecții de stampe ale artistului la nivel mondial.", "Arhitectura folosește spații deschise generoase pentru a prezenta optim lucrările contemporane."],
      en: ["Owns a significant suite of Picasso prints.", "Located in the Parque Central complex.", "The museum is known for its outstanding collection of modern art, including works by Picasso.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-museo-arte-contemporaneo-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Primul muzeu al copiilor din America Latină.", "Muzeul s-a deschis în 1982 și a modelat de atunci generații de copii venezueleni.", "Expozițiile acoperă domenii precum spațiul, ecologia și comunicațiile.", "Conceptul interactiv a fost premiat internațional pentru calitatea sa pedagogică."],
      en: ["First children's museum in Latin America.", "Focus on interactive exhibits.", "An interactive museum that introduces children to science, technology, and culture in a playful way.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-museo-de-los-ninos-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      en: ["Located right next to the Caracas Cathedral.", "Collection of colonial religious art.", "The museum houses a significant collection of religious art from the colonial period.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-museo-sacro-caracas-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Platformă pentru artiștii locali.", "Centrul promovează activ networking-ul între diverse discipline artistice.", "Oferă în mod regulat workshop-uri și cursuri pentru comunitate.", "Lira este cunoscut pentru susținerea proiectelor artistice inovatoare și neconvenționale."],
      en: ["Platform for local artists.", "Versatile cultural program.", "A contemporary cultural center providing space for various art forms and local exhibitions.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-centro-de-arte-lira-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Cel mai mare teatru din Venezuela.", "Teatrul a fost inaugurat oficial în 1983.", "Sala Ríos Reyna este celebră în întreaga lume pentru acustica sa excelentă.", "Clădirea integrează opere de artă monumentale ale artiștilor venezueleni precum Jesús Soto."],
      en: ["Largest theater in Venezuela.", "Named after the famous pianist Teresa Carreño.", "The most important theater in Caracas and one of the most modern cultural centers in South America.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teatro-teresa-carreno-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Inaugurat în 1881.", "Teatrul a fost construit sub președinția lui Antonio Guzmán Blanco.", "A fost locul premierelor multor opere naționale.", "În ciuda modernizărilor, teatrul și-a păstrat farmecul istoric."],
      en: ["Opened in 1881.", "Sumptuous interior decoration.", "A magnificent historic opera house, counted among the oldest theaters in South America.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Inaugurat în 1905.", "Teatrul a fost ridicat sub domnia lui Cipriano Castro.", "Designul interior prezintă fresce artistice și ornamente aurite.", "Amplasarea în Plaza Páez îl face o parte proeminentă a ansamblului urban."],
      en: ["Inaugurated in 1905.", "Known for its baroque interior.", "A beautiful historic theater known for its performances of zarzuela and operettas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teatro-nacional-caracas-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Locul primei proiecții de film în Venezuela în 1897.", "Teatrul a fost numit după poetul și istoricul Rafael María Baralt.", "Picturile de pe tavan au fost realizate de celebrul artist Antonio Angulo.", "După o lungă fază de restaurare, a fost transformat într-un centru cultural modern."],
      en: ["Site of the first film screening in Venezuela in 1897.", "Landmark of Maracaibo.", "A historic theater in Maracaibo, considered the cradle of Venezuelan cinema.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teatro-baralt-maracaibo-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Sit istoric al independenței.", "În această casă a fost pecetluită capitularea trupelor spaniole pe 3 august 1823.", "Arhitectura prezintă trăsăturile tipice ale unei case nobiliare din perioada colonială târzie.", "Clădirea este considerată unul dintre cele mai importante monumente din statul Zulia."],
      en: ["Historic site of independence.", "The only preserved colonial house of its kind in Maracaibo.", "This historic house in Maracaibo is where the Spanish capitulation was signed after the Battle of Lake Maracaibo.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-casa-de-la-capitulacion-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Fațadă neogotică.", "Clădirea a îndeplinit diverse funcții de-a lungul secolelor, de la mănăstire la universitate.", "Găzduiește Academiile de Istorie, Limbă, Medicină și Științe Naturale.", "Palatul este o parte importantă a moștenirii istorice și arhitecturale a orașului Caracas."],
      en: ["Neo-Gothic facade.", "Houses the national academies.", "A magnificent neo-Gothic building that houses the national academies of Venezuela.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-palacio-de-las-academias-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Găzduiește Muzeul Orașului Caracas.", "Clădirea a fost renovată extensiv la sfârșitul secolului al XIX-lea pentru a-și păstra caracterul actual.", "În Capela Santa Rosa de Lima din interiorul palatului a fost semnată Declarația de Independență.", "Palatul este sediul Consiliului Municipal, fiind astfel inima administrativă a comunei Libertador."],
      en: ["Houses the City Museum of Caracas.", "Located on the north side of Plaza Bolívar.", "A historic government building in Plaza Bolívar, housing the city administration of Caracas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-palacio-municipal-caracas-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construită la începutul secolului al XX-lea.", "Clădirea este situată pe colțul istoric de stradă Carmelitas.", "Timp îndelungat a fost cel mai important nod poștal al capitalei.", "Astăzi este un monument istoric protejat și definește identitatea urbană a centrului."],
      en: ["Built in the early 20th century.", "Example of neoclassical architecture.", "A striking building in downtown Caracas, known for its elegant neoclassical facade.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-correo-de-carmelitas-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Situat în parcul El Calvario.", "Arcul a fost inaugurat în 1895 sub președintele Joaquín Crespo.", "Designul său este inspirat de Arcul de Triumf din Paris.", "Inscripțiile de pe arc celebrează principiile federale ale republicii."],
      en: ["Located in El Calvario Park.", "Commemorates the Federal War (1859-1863).", "A monumental arch in El Calvario Park, commemorating the Venezuelan Federal War.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Construite în anii 1950.", "Timp de decenii au fost cele mai înalte structuri din Venezuela.", "Proiectul a marcat sfârșitul stocului de clădiri coloniale din cartierul El Silencio de astăzi.", "Turnurile gemene sunt un exemplu remarcabil al stilului internațional în America de Sud."],
      en: ["Built in the 1950s.", "Symbol of modern progress in Caracas.", "Two iconic twin towers in the center of Caracas, symbolizing the city's 20th-century modernization.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-torres-el-silencio-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Include iconicele turnuri gemene.", "Complexul găzduiește muzee importante precum Muzeul de Artă Contemporană.", "Turnurile ating o înălțime de peste 220 de metri.", "Parque Central a fost un proiect de pionierat pentru megastructuri multifuncționale în America de Sud."],
      en: ["Includes the iconic twin towers.", "Important cultural and commercial center.", "A massive residential and commercial complex with the second tallest skyscrapers in South America.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: ["A treia cea mai înaltă clădire din Venezuela.", "Construcția a fost oprită în 1994 din cauza crizei bancare venezuelene.", "Timp de ani de zile, mii de oameni au trăit în structura neterminată.", "Clădirea a devenit un simbol global al provocărilor socio-economice ale orașului Caracas."],
      en: ["Third tallest building in Venezuela.", "Globally known through documentaries.", "An unfinished skyscraper in Caracas that gained worldwide fame as a symbol of urban transformation.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-centro-financiero-confinanzas-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Cea mai înaltă stație la 4.765 metri.", "Sistemul are o lungime totală de aproximativ 12,5 kilometri.", "După o modernizare cuprinzătoare, a fost redeschisă în 2016 sub numele Mukumbarí.", "Stația montană oferă adesea o vedere asupra lui Pico Bolívar, cel mai înalt munte din Venezuela."],
      en: ["Highest station at 4,765 meters.", "Connects Mérida with Pico Espejo.", "The highest and longest cable car in the world, leading from Mérida to the summit of Pico Espejo.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teleferico-mukumbari-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Duce la Parcul Național El Ávila.", "Telecabina a fost inaugurată în anii 1950 și este de atunci un simbol al orașului.", "La stația montană se află celebrul Hotel Humboldt.", "Călătoria este una dintre cele mai rapide modalități de a experimenta diferențele climatice dintre vale și munte."],
      en: ["Leads to the El Ávila National Park.", "Offers a view of the Caribbean Sea.", "A cable car in Caracas that takes visitors to the summit of El Ávila mountain.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-teleferico-warairarepano-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Traversează Lacul Maracaibo.", "Podul a fost inaugurat în 1962 și are o lungime totală de aproximativ 8,7 kilometri.", "Construcția folosește stâlpi masivi de beton pentru a lăsa liber canalul de navigație.", "Noaptea, podul primește o iluminare spectaculoasă, vizibilă de la kilometri distanță."],
      en: ["Crosses Lake Maracaibo.", "One of the longest bridge structures in the world.", "An iconic cable-stayed bridge crossing Lake Maracaibo and one of the longest structures of its kind worldwide.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-puente-rafael-urdaneta-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Primul pod peste râul Orinoco.", "Podul a fost inaugurat în 1967 și are o deschidere principală de peste 700 de metri.", "Construcția sa a fost decisivă pentru integrarea economică a regiunii industriale Guayana.", "Arhitectura amintește de celebrele poduri suspendate din SUA."],
      en: ["First bridge over the Orinoco River.", "Elegant suspension construction.", "The first suspension bridge over the Orinoco River, connecting Ciudad Bolívar with the rest of the country.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-puente-angostura-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Al doilea pod peste Orinoco.", "Podul a fost pus oficial în funcțiune în 2006.", "Structura este una dintre cele mai moderne de acest tip din America Latină.", "Podul Orinokia a redus masiv timpul de călătorie între centrul industrial și nordul țării."],
      en: ["Second bridge over the Orinoco.", "Important for heavy transport.", "The second major bridge over the Orinoco, representing a strategic link for heavy industry.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-puente-orinokia-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Capacitate de aproximativ 40.000 de spectatori.", "Stadionul a fost inaugurat pentru Serie del Caribe 2023.", "Arhitectura oferă linii vizuale moderne și confort pentru fani.", "Amplasarea în La Rinconada integrează stadionul într-un mare complex sportiv și de agrement."],
      en: ["Capacity for approx. 40,000 spectators.", "Most modern baseball stadium in the region.", "One of the most modern and largest baseball stadiums in Latin America, located in southern Caracas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-estadio-monumental-simon-bolivar-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Cupolă geodezică iconică.", "Poliedrul a fost deschis în 1974 și a fost scena multor evenimente muzicale internaționale.", "Arhitectura permite un spațiu interior gigantic fără coloane.", "Este situat în imediata apropiere a Stadionului Monumental Simón Bolívar."],
      en: ["Iconic geodesic dome.", "Most significant event venue in the capital.", "A striking geodesic dome that serves as the most important multipurpose venue for concerts and sporting events.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-poliedro-de-caracas-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Patrimoniu Mondial UNESCO din 2000.", "Campusul găzduiește peste 100 de opere de artă semnificative, integrate ferm în clădiri.", "Este considerată opera principală a lui Carlos Raúl Villanueva.", "Ciudad Universitaria este o bornă a urbanismului modern în America Latină."],
      en: ["UNESCO World Heritage site since 2000.", "Designed by Carlos Raúl Villanueva.", "The main campus of the University of Venezuela, a UNESCO World Heritage site and masterpiece of modern architecture.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-ciudad-universitaria-caracas-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Nori acustici de renume mondial de Alexander Calder.", "Alexander Calder a colaborat strâns cu acusticianul pentru a optimiza formele norilor.", "Aula Magna este folosită pentru ceremonii academice și culturale importante.", "Impactul vizual al elementelor colorate plutitoare este unic în lume."],
      en: ["World-famous acoustic clouds by Alexander Calder.", "Heart of the UNESCO World Heritage university.", "The impressive auditorium of the University of Venezuela, world-famous for its acoustic 'clouds' by Alexander Calder.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }, image: "/poi-images/venezuela-aula-magna-ucv-landmark-v2.webp"},
  {
    ...
    factsAdvanced: {
      ...
      ro: ["Mai înalt decât statuia lui Cristos din Rio.", "Monumentul atinge o înălțime de aproximativ 46,7 metri.", "A fost inaugurat în 1983 și este un important loc de pelerinaj.", "Interiorul statuii poate fi vizitat și dispune de cinci puncte de belvedere."],
      en: ["Taller than the Christ the Redeemer statue in Rio.", "Offers panoramic views of the Andes.", "A huge statue of the Virgin Mary in Trujillo, being one of the tallest religious monuments in the Americas.", "Located within the Bolivarian Republic of Venezuela.", "Set between the northern Andes, the Llanos plains, and the Caribbean coast.", "Plays a role in the local identity of the region.", "Known for its scenic or cultural significance."],
    }
  }
];
