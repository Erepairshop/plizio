...
image: "/poi-images/gabalba-national-park-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Ein bedeutendes Schutzgebiet mit einzigartiger Flora und Fauna.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Jelentős védett terület egyedülálló növény- és állatvilággal.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["O arie protejată semnificativă cu o floră și faună unică.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["A significant protected area with unique flora and fauna.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/gabalba-national-park-life-v2.webp"},
  {
...
image: "/poi-images/wadial-rayan-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Lebensraum für die gefährdete Dünengazelle.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Élőhely a veszélyeztetett dorkás gazella számára.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Habitat pentru gazela dorcas pe cale de dispariție.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Habitat for the endangered dorcas gazelle.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/wadial-rayan-life-v2.webp"},
  {
...
image: "/poi-images/aswan-botanical-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Ein üppiger Garten auf einer Nilinsel in Assuan.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Dús kert egy nílusi szigeten, Asszuanban.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["O grădină luxuriantă pe o insulă de pe Nil în Assuan.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["A lush garden on a Nile island in Aswan.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/aswan-botanical-life-v2.webp"},
  {
...
image: "/poi-images/nile-delta-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Das Herz der ägyptischen Landwirtschaft.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Az egyiptomi mezőgazdaság szíve.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Inima agriculturii egiptene.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["The heart of Egyptian agriculture.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/nile-delta-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/siwa-palm-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Berühmte Oasen-Gärten für Datteln und Oliven.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Híres oáziskertek datolyához és olajbogyóhoz.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Celebre grădini de oază pentru curmale și măsline.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Famous oasis gardens for dates and olives.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/siwa-palm-agriculture-life-v2.webp"},
  {
    id: "giza-zoo-life-v2",
    type: "kid-landmark",
...
image: "/poi-images/giza-zoo-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Einer der ältesten und größten Zoos in Afrika.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Afrika egyik legrégebbi és legnagyobb állatkertje.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Una dintre cele mai vechi și mari grădini zoologice din Africa.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["One of the oldest and largest zoos in Africa.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/giza-zoo-life-v2.webp"},
  {
...
image: "/poi-images/faiyum-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Fruchtbare Region mit umfangreichem Gemüseanbau.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Termékeny régió kiterjedt zöldségtermesztéssel.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Regiune fertilă cu cultivare extinsă de legume.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Fertile region with extensive vegetable cultivation.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/faiyum-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/alqanater-kid-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Ein weitläufiges Parkgebiet am Nil, ideal für Familien.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Kiterjedt parkterület a Nílus mentén, ideális családoknak.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["O zonă extinsă de parcuri pe malul Nilului, ideală pentru familii.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["A sprawling park area on the Nile, ideal for families.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/alqanater-kid-life-v2.webp"},
  {
...
image: "/poi-images/luxor-botanical-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Grüne Oase im Zentrum von Luxor.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Zöld oázis Luxor központjában.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Oază verde în centrul orașului Luxor.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Green oasis in the center of Luxor.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/luxor-botanical-life-v2.webp"},
  {
...
image: "/poi-images/marsa-alam-habitat-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Ein geschütztes Gebiet für Seekühe im Roten Meer.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Védett terület a tengeri tehenek számára a Vörös-tengerben.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["O zonă protejată pentru dugongi în Marea Roșie.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["A protected area for dugongs in the Red Sea.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/marsa-alam-habitat-life-v2.webp"},
  {
...
image: "/poi-images/alexandria-zoo-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Beliebter Zoo an der Mittelmeerküste.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Népszerű állatkert a Földközi-tenger partján.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Grădină zoologică populară pe coasta Mediteranei.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Popular zoo on the Mediterranean coast.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/alexandria-zoo-life-v2.webp"},
  {
...
image: "/poi-images/delta-bird-habitat-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Ein wichtiges Ziel für Zugvögel.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["A vándormadarak fontos célpontja.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["O destinație importantă pentru păsările migratoare.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["An important destination for migratory birds.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/delta-bird-habitat-life-v2.webp"},
  {
...
image: "/poi-images/giza-farm-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Moderne Landwirtschaft am Rande der Wüste.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Modern mezőgazdaság a sivatag peremén.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Agricultură modernă la marginea deșertului.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Modern farming at the edge of the desert.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/giza-farm-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/aswan-island-kid-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Ein ruhiger Park auf einer historischen Nilinsel.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Csendes park egy történelmi nílusi szigeten.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Un parc liniștit pe o insulă istorică pe Nil.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["A peaceful park on a historic Nile island.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/aswan-island-kid-life-v2.webp"},
  {
...
image: "/poi-images/sina-camel-habitat-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Traditionelle Weidegebiete der Beduinen.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["A beduinok hagyományos legelőterületei.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Zone de pășunat tradiționale ale beduinilor.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Traditional grazing areas of the Bedouin.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/sina-camel-habitat-life-v2.webp"},
  {
...
image: "/poi-images/nabq-protected-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Schutzgebiet mit Mangrovenwäldern am Roten Meer.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Védett terület mangroveerdőkkel a Vörös-tengeren.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Zonă protejată cu păduri de mangrove la Marea Roșie.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Protected area with mangrove forests on the Red Sea.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/nabq-protected-life-v2.webp"},
  {
...
image: "/poi-images/azhar-park-kid-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Eine grüne Lunge in der Kairoer Altstadt.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Zöld oázis a kairói óvárosban.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Oază verde în orașul vechi din Cairo.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["A green oasis in Cairo's old city.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/azhar-park-kid-life-v2.webp"},
  {
...
image: "/poi-images/rosseta-fruit-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Bekannt für den Anbau von Zitrusfrüchten.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Ismert a citrusfélék termesztéséről.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Cunoscută pentru cultivarea citricelor.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Known for growing citrus fruits.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/rosseta-fruit-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/taba-habitat-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Bergschutzgebiet mit seltener Wüstenflora.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Hegyi védett terület ritka sivatagi növényzettel.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Zonă montană protejată cu vegetație deșertică rară.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Mountainous protected area with rare desert flora.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/taba-habitat-life-v2.webp"},
  {
...
image: "/poi-images/minya-crops-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Wichtige Anbauregion im mittleren Ägypten.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Fontos termesztési régió Közép-Egyiptomban.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Regiune agricolă importantă în Egiptul Central.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Important agricultural region in central Egypt.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/minya-crops-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/sohag-fields-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Traditionelle Landwirtschaft entlang des Nils.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Hagyományos mezőgazdaság a Nílus mentén.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Agricultură tradițională de-a lungul Nilului.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Traditional farming along the Nile.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/sohag-fields-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/qena-farming-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Produktionsstätte für regionale Agrarerzeugnisse.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Termelőhely regionális mezőgazdasági termékek számára.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Loc de producție pentru produse agricole regionale.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Production site for regional agricultural products.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/qena-farming-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/hurghada-marine-habitat-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Geschützte Korallenriffe vor der Küste.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Védett korallzátonyok a part mentén.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Recife de corali protejate lângă coastă.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Protected coral reefs off the coast.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/hurghada-marine-habitat-life-v2.webp"},
  {
...
image: "/poi-images/heliopolis-park-kid-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Großer Stadtpark mit Freizeitmöglichkeiten.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Nagy városi park szabadidős lehetőségekkel.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Parc urban mare cu facilități de recreere.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Large city park with recreational opportunities.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/heliopolis-park-kid-life-v2.webp"},
  {
...
image: "/poi-images/cairo-delta-animal-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Reservat für einheimische Tierarten im Nildelta.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Rezervátum őshonos állatfajok számára a Nílus-deltában.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Rezervație pentru specii native în Delta Nilului.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Reserve for native species in the Nile Delta.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/cairo-delta-animal-life-v2.webp"},
  {
...
image: "/poi-images/benisuef-farms-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Landwirtschaftliche Zone am Nil.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Mezőgazdasági övezet a Nílus mentén.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Zonă agricolă pe malul Nilului.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Agricultural zone along the Nile.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/benisuef-farms-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/giza-green-kid-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Großer Erholungspark für Familien.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Nagy pihenőpark családoknak.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Parc de recreere mare pentru familii.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Large recreation park for families.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/giza-green-kid-life-v2.webp"},
  {
...
image: "/poi-images/suez-canal-agri-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Anbaubereiche in der Nähe des Kanals.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Termesztési területek a csatorna közelében.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Zone de cultivare lângă canal.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Farming areas near the canal.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/suez-canal-agri-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/damanhur-fields-agriculture-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Fruchtbares Agrarland im Delta.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Termékeny mezőgazdasági földek a Deltában.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Teren agricol fertil în Deltă.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Fertile agricultural land in the Delta.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }, image: "/poi-images/damanhur-fields-agriculture-life-v2.webp"},
  {
...
image: "/poi-images/elminya-habitat-life-v2.webp"
    ...
    factsAdvanced: {
      de: ["Schutzgebiet für bedrohte Wüstentiere.", "Liegt im Gebiet der Arabischen Republik Ägypten.", "Steht in Verbindung mit dem Nil oder dem benachbarten Wüstenraum.", "Wird vom heißen Wüstenklima Nordostafrikas geprägt.", "Bekannt für seine landschaftliche oder kulturhistorische Bedeutung."],
      hu: ["Védett terület veszélyeztetett sivatagi állatok számára.", "Az Egyiptomi Arab Köztársaság területén található.", "Kapcsolódik a Nílushoz vagy a környező sivatagi térséghez.", "Az északkelet-afrikai forró sivatagi éghajlat alakítja.", "Tájképi vagy kultúrtörténeti jelentőségéről ismert."],
      ro: ["Zonă protejată pentru animalele deșertice amenințate.", "Se află pe teritoriul Republicii Arabe Egipt.", "Este legat de Nil sau de spațiul deșertic învecinat.", "Este modelat de clima caldă deșertică din nord-estul Africii.", "Este cunoscut pentru semnificația sa peisagistică sau cultural-istorică."],
      en: ["Protected area for threatened desert animals.", "Located within the Arab Republic of Egypt.", "Connected with the Nile or the surrounding desert area.", "Shaped by the hot desert climate of northeastern Africa.", "Known for its scenic or cultural-historical significance."],
    }
  }
];
