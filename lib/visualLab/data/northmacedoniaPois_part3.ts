...
export const mkPoisPart4: POI[] = [
  // MK-031: Staro Nagoričane
  {
    ...
    descriptionAdvanced: {
      de: "Die St.-Georg-Kirche in Staro Nagoričane zählt zu den architektonisch anspruchsvollsten Bauten des Balkans. Die prächtigen Fresken, die im 14. Jahrhundert unter der Schirmherrschaft von König Milutin entstanden, bieten einen tiefen Einblick in die byzantinische Ikonografie und den künstlerischen Ausdruck jener Zeit. Geschichte K8 — Mittelalterliche Sakralarchitektur.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Fresken gehören zu den besterhaltenen ihrer Epoche.",
        "Der Bau ist durch seine fünf Kuppeln einzigartig.",
        "Sie liegt auf historisch bedeutsamem Boden.",
        "Die Kirche wird von Kunsthistorikern weltweit geschätzt.",
        "Der Wiederaufbau wichtiger Teile wurde sorgfältig durchgeführt.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Zebrnjak-Denkmal ist ein eindrucksvolles Gedenkzeichen, das an die bedeutende Schlacht von Kumanovo erinnert. Obwohl es durch historische Ereignisse, insbesondere im Zweiten Weltkrieg, beschädigt wurde, bewahrt es seinen monumentalen Charakter. Es bietet einen weiten Blick über die Ebene, die damals Schauplatz militärischer Auseinandersetzungen war. Geschichte K8 — Balkankriege.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die architektonische Vision war damals sehr mutig.",
        "Die Lage auf dem Hügel ist symbolträchtig.",
        "Das Denkmal ist ein Ort des Gedenkens für viele Nationen.",
        "Die Ruinen wirken heute fast mahnend.",
        "Der Standort wurde nach strategischen Gesichtspunkten gewählt.",
        "Es ist ein Ort, der zur Besinnung einlädt."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-032: Kumanovo
  {
    ...
    descriptionAdvanced: {
      de: "Kokino ist ein faszinierendes Beispiel für die Beobachtungsgabe antiker Zivilisationen. Die Steinmarkierungen dienten dazu, die Bewegungen von Sonne und Mond präzise zu verfolgen, was für die landwirtschaftliche Planung fundamental war. Es ist ein weltweit einzigartiger Ort, der Wissenschaft und Geschichte verbindet. Geschichte K8 — Astronomie in der Antike.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Genauigkeit der astronomischen Messungen ist erstaunlich.",
        "Der Ort war vermutlich ein religiöses Zentrum.",
        "Die vulkanische Felslandschaft unterstreicht die Einzigartigkeit.",
        "Führungen bieten tiefe Einblicke in die antike Astronomie.",
        "Die UNESCO-Anerkennung unterstreicht den globalen Wert.",
        "Das Observatorium wurde in die Felsen hineingearbeitet."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Stadtplatz von Kumanovo ist das lebendige Zentrum der Stadt. Er ist der Ort für Versammlungen, Feste und tägliche Begegnungen. Die umliegende Architektur und die Denkmäler reflektieren die jüngere Geschichte der Stadt. Sachkunde K5 — Urbane Räume.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Umgebung bietet eine große kulinarische Vielfalt.",
        "Der Platz ist ein beliebter Treffpunkt für junge Leute.",
        "Das Stadtzentrum ist ein wichtiger Wirtschaftsmotor.",
        "Kulturelle Veranstaltungen finden hier regelmäßig statt.",
        "Die Plätze der Stadt laden zum Verweilen ein.",
        "Kumanovo ist bekannt für seine lebhafte Atmosphäre."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-033: Delčevo
  {
    ...
    descriptionAdvanced: {
      de: "Der Golak-Berg bietet eine wunderbare Abwechslung zum Alltag. Die dichten Wälder sorgen für ein gesundes Klima, das bei Wanderern und Radfahrern sehr geschätzt wird. Die Aussichten vom Gipfel sind in der Region besonders bekannt. Erdkunde K7 — Erholung.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Wälder sind ein wichtiger Lebensraum für viele Tiere.",
        "Der Berg bietet ausgezeichnete Möglichkeiten für Sport.",
        "Es finden sich hier ideale Bedingungen für frische Bergluft.",
        "Die Wanderrouten sind sehr gut gepflegt.",
        "Ein Ausflug zum Golak lohnt sich zu jeder Jahreszeit.",
        "Der Berg ist das Wahrzeichen von Delčevo."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Stadtpark Delčevo ist ein Ort der Begegnung und Erholung inmitten der städtischen Umgebung. Das Rauschen der Bregalnica sorgt für eine beruhigende Atmosphäre, besonders an warmen Sommertagen. Er ist ein beliebter Ort für Familien und Sportler. Sachkunde K5 — Natur in der Stadt.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Der Park wird sehr aktiv gepflegt.",
        "Spielplätze bieten Spaß für Kinder.",
        "Sportanlagen fördern einen gesunden Lebensstil.",
        "Die Vegetation ist sehr vielfältig.",
        "Der Park ist für Bewohner jeden Alters ein Treffpunkt.",
        "Das Flussufer bietet viele Sitzgelegenheiten."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-034: Makedonska Kamenica
  {
    ...
    descriptionAdvanced: {
      de: "Der Kalimanci-See ist ein bedeutender Stausee, der die Wasserversorgung im Osten des Landes sicherstellt. Er dient zudem der Stromerzeugung und ist ein wichtiges Element der regionalen Infrastruktur. Die landschaftliche Lage macht ihn zudem zu einem Anziehungspunkt für Touristen. Erdkunde K7 — Energie.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Fischbestände sind für Angler sehr attraktiv.",
        "Der See beeinflusst das Mikroklima der Umgebung positiv.",
        "Die Uferbereiche bieten viele Ausblicke.",
        "Wasserentnahmen für die Landwirtschaft sind essenziell.",
        "Das Gebiet ist ein Ort der Erholung.",
        "Die Staumauer ist ein technisches Meisterwerk der Region."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Sasa-Mine ist ein zentrales Element der industriellen Basis in Nordmazedonien. Sie spielt eine entscheidende Rolle im Export und bietet vielen Menschen Arbeit. Die Geschichte der Mine ist untrennbar mit der industriellen Entwicklung der Region Makedonska Kamenica verbunden. Sachkunde K6 — Industrie.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Mine arbeitet mit modernen Abbautechnologien.",
        "Sie stellt eine wichtige Einnahmequelle für den Staat dar.",
        "Viele lokale Familien hängen direkt oder indirekt davon ab.",
        "Umweltauflagen werden heute stärker beachtet.",
        "Der Bergbau hat hier eine tiefe Tradition.",
        "Sasa ist überregional bekannt."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-035: Berovo
  {
    ...
    descriptionAdvanced: {
      de: "Der Berovo-See, oft als 'Klein-Schweiz' bezeichnet, bietet eine unvergleichliche Kombination aus alpiner Natur und Erholung. Die Luft in dieser Höhe ist exzellent und macht das Gebiet zu einer Oase für Gesundheitsbewusste. Die Wander- und Radwege sind in einer der schönsten Landschaften Mazedoniens gelegen. Erdkunde K7 — Gesundheitstourismus.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Das Mikroklima ist besonders gesund.",
        "Der See bietet viele Möglichkeiten für aktive Erholung.",
        "Die Wälder rundherum sind sehr unberührt.",
        "Die Umgebung ist ein Eldorado für Naturfotografen.",
        "Berovo ist bekannt für seine gute Infrastruktur.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Kloster ist ein spirituelles Zentrum von Berovo. Es bewahrt nicht nur religiöse Werte, sondern auch traditionelle Handwerkskunst wie die Teppichweberei. Dies macht es zu einem lebendigen Zeugnis der Kulturgeschichte in den östlichen Bergen. Sachkunde K6 — Handwerk.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Teppiche sind weit über die Region bekannt.",
        "Die Atmosphäre ist sehr kontemplativ.",
        "Das Kloster bewahrt bedeutende Artefakte.",
        "Es ist ein wichtiges religiöses Zentrum.",
        "Besucher werden herzlich empfangen.",
        "Der Ort ist ein Symbol für die Stärke des Glaubens."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-036: Pehčevo
  {
    ...
    descriptionAdvanced: {
      de: "Die Pehčevo-Wasserfälle sind ein wahres Naturerlebnis. Die Gegend ist für ihre extrem sauerstoffreiche Luft bekannt, was sie zu einem perfekten Ort für Menschen mit Atemwegsbeschwerden oder Naturliebhaber macht. Die Wasserfälle sind eine Oase der Frische. Erdkunde K5 — Naturphänomene.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Luftqualität ist beispielhaft.",
        "Die Wanderwege sind sehr natürlich angelegt.",
        "Wasserfälle sind in verschiedenen Stufen angeordnet.",
        "Der Ort ist ideal zur Regeneration.",
        "Kleine Brücken erleichtern das Wandern.",
        "Die Vegetation ist sehr üppig."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Ravna Reka bietet als Bergregion eine willkommene Abkühlung. Besonders im Sommer ist es hier angenehm frisch. Es ist der perfekte Ort für Familienausflüge, bei denen man die Natur und die Stille der Berge genießen kann. Sachkunde K5 — Freizeit.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Quellen liefern erfrischendes Wasser.",
        "Die Umgebung bietet eine schöne Kulisse.",
        "Es finden sich hier viele Plätze für Picknicks.",
        "Die Wanderungen sind für alle Altersgruppen geeignet.",
        "Die Bergwelt um Ravna Reka ist sehr ruhig.",
        "Der Ort ist ideal, um Energie zu tanken."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-037: Želino
  {
    ...
    descriptionAdvanced: {
      de: "Die Brücke von Želino ist ein Bindeglied der Region. Sie ermöglicht den wichtigen Austausch über den Vardar hinweg. Architektonisch ist sie ein Symbol für die Verbindung der verschiedenen Siedlungen. Sachkunde K6 — Verkehr.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Brücke ist ein wichtiger Knotenpunkt.",
        "Sie erleichtert die Erreichbarkeit der umliegenden Dörfer.",
        "Die Aussicht vom Bauwerk ist sehr gut.",
        "Die Konstruktion ist von lokaler Bedeutung.",
        "Sie prägt das Landschaftsbild maßgeblich.",
        "Die Bedeutung für den Alltag ist sehr hoch."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Suva Gora zeichnet sich durch ihre karge Schönheit aus. Der Mangel an Wasser macht sie zu einem herausfordernden Terrain für Wanderer. Die Landschaft bietet tiefe Einblicke in geologische Prozesse. Erdkunde K7 — Hochland.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Felsformationen sind sehr eindrucksvoll.",
        "Wanderer müssen ihre Routen gut planen.",
        "Der Blick über das Polog-Tal ist einmalig.",
        "Die Flora ist an trockene Bedingungen angepasst.",
        "Das Bergmassiv ist eine natürliche Grenze.",
        "Die Stille dort oben ist sehr intensiv."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-038: Brvenica
  {
    ...
    descriptionAdvanced: {
      de: "Diese Kirche ist ein wichtiger spiritueller Anker für die Dorfbewohner von Radiovce. Sie steht für die Kontinuität des Glaubens in der ländlichen Umgebung des Vardar-Tals. Sachkunde K5 — Religion.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        ...
        "Sie wird bei religiösen Festen besucht.",
        "Die Ikonen sind von den Einheimischen sehr geschätzt.",
        "Das Gebäude fügt sich harmonisch in das Dorf ein.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Vardar ist die Lebensader der gesamten Region. Die Ebene von Brvenica nutzt sein Wasser intensiv für die Landwirtschaft, was den Reichtum an Agrarprodukten erklärt. Die Flussufer sind ein wichtiger Teil des lokalen Ökosystems. Erdkunde K6 — Flusstäler.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Bewässerung ist hochgradig organisiert.",
        "Der Vardar bietet viel Raum für Naturbeobachtungen.",
        "Die Ebene ist landschaftlich sehr harmonisch.",
        "Das Wasser ist von essenzieller Bedeutung.",
        "Die Qualität ist für die Bewässerung ausreichend.",
        "Entlang des Ufers finden sich viele Spazierwege."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-039: Brod (Makedonski Brod)
  {
    ...
    descriptionAdvanced: {
      de: "Die Pesna-Höhle beeindruckt durch ihre gewaltige Eingangshalle. Die Legende von König Marko, die mit ihr verknüpft ist, macht sie zu einem mystischen Ort. Die Kombination aus Naturdenkmal und archäologischem Erbe ist einzigartig in der Region Makedonski Brod. Geschichte K8 — Höhlen.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Dimensionen des Eingangs sind beeindruckend.",
        "Es ist ein Ort der Mythen.",
        "Die Ruinen in der Höhle sind geschichtsträchtig.",
        "Das Tageslicht dringt tief ein.",
        "Der Höhlenraum bietet ein einzigartiges Klima.",
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Kirche der Heiligen Gottesmutter ist ein spirituelles Zentrum in der Stadt Makedonski Brod. Sie spiegelt die religiöse Tradition und den architektonischen Wandel in der Region wider. Sie ist ein Ort der Ruhe und des Glaubens für viele Gläubige. Sachkunde K5 — Religion.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Kirche ist der religiöse Anker der Stadt.",
        "Der Innenraum ist sehr feierlich gestaltet.",
        "Die Ikonen sind kunstvoll gearbeitet.",
        "Die Kirche hat eine bedeutende lokale Stellung.",
        "Die Architektur zeigt den Stolz der Gemeinde.",
        "Feste werden hier groß gefeiert."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  // MK-040: Oslomej
  {
    ...
    descriptionAdvanced: {
      de: "Der Oslomej-See ist ein künstliches Gewässer, das eng mit dem Betrieb des Kraftwerks verknüpft ist. Er dient primär industriellen Zwecken, bietet aber auch Lebensraum für lokale Arten. Erdkunde K6 — Industrie.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Das Wasser ist wichtig für die Kühlung.",
        "Der See liegt in einer industriellen Zone.",
        "Lokale Angler nutzen das Gewässer regelmäßig.",
        "Die Umgebung ist durch den Bergbau geprägt.",
        "Der See erfüllt eine wichtige betriebliche Rolle.",
        "Die Anlage ist gut erreichbar."
      ],
      hu: [],
      ro: [],
      en: []
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Kirche in Popovjane bewahrt das religiöse Erbe des Dorfes. Sie ist ein kleiner, aber wichtiger Ort des Glaubens für die Einwohner. Ihre historische Bedeutung ist für die lokale Identität essenziell. Sachkunde K5 — Religion.",
      hu: "",
      ro: "",
      en: ""
    },
    factsAdvanced: {
      de: [
        "Die Kirche ist ein Symbol für die Beständigkeit der Tradition.",
        "Sie ist in die dörfliche Umgebung gut eingepasst.",
        "Viele Bewohner fühlen sich mit dem Ort verbunden.",
        "Das Gebäude ist einfach, aber bedeutsam.",
        "Religiöse Feiertage sind das Herz des Gemeindelebens.",
        "Die Kirche hat eine lange lokale Tradition."
      ],
      hu: [],
      ro: [],
      en: []
