...
image: "/poi-images/soyapango-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Soyapango is one of the most densely populated municipalities in El Salvador, functioning as a major industrial and commercial hub within the San Salvador Metropolitan Area. The city has a rich urban history, rapidly transforming during the 20th century to accommodate extensive manufacturing facilities and residential neighborhoods. It serves as a vital economic engine, connecting the capital to eastern regions via key transport routes. Despite its intense urbanization, Soyapango maintains a vibrant local culture, with bustling markets and community centers that reflect the resilience of its residents. It is a critical node in understanding the rapid metropolitan expansion and economic dynamics of modern El Salvador, making it relevant for urban studies and social sciences."
    },
    factsAdvanced: {
      de: ["Chalatenango liegt in einer hügeligen bis bergigen Region mit gemäßigtem Klima.", "Die Region um Chalatenango ist bekannt für ihr großes ökologisches Potenzial.", "Die Stadt dient als Zentrum für soziale und wirtschaftliche Dienste in der nördlichen Grenzregion."],
      hu: ["El Salvador legnagyobb területű megyéjének székhelye.", "Hűvösebb hegyi klímájáról és fenyőerdőiről nevezetes.", "A közelben található a Cerro El Pital."],
      ro: ["Este capitala celui mai mare departament ca suprafață din El Salvador.", "Orașul este faimos pentru produsele sale artizanale.", "În apropiere se află lacul Cerrón Grande."],
      en: ["Located in the San Salvador Department.", "Part of the San Salvador Metropolitan Area.", "Elevation is approximately 648 meters above sea level.", "A major center for manufacturing and textiles.", "Connected to the capital by the Boulevard del Ejército."]
    }
  },
  {
...
image: "/poi-images/usulutan-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Fontos a gyapottermesztés szempontjából.", "A Jiquilisco-öböl közelében.", "Kelet kereskedelmi központja.", "Az Usulután-vulkán otthona."],
      ro: ["Important pentru cultivarea bumbacului.", "Aproape de Golful Jiquilisco.", "Centru comercial pentru est.", "Casa vulcanului Usulután."],
      en: ["Important for cotton cultivation.", "Near the Jiquilisco Bay.", "Commercial center for the east.", "Home to the Usulután Volcano."]
    },
     image: "/poi-images/usulutan-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Usulután is the capital of El Salvador's largest department by area, playing a central role in the country's agricultural sector. Known historically as the \"Granary of the Republic,\" the surrounding region is famous for its fertile volcanic soils, ideal for cultivating coffee, sugarcane, and staple crops. The city itself is a bustling commercial center that serves farmers and coastal communities alike. The nearby Jiquilisco Bay, a UNESCO Biosphere Reserve, adds immense ecological value to the region. Usulután's history is deeply intertwined with indigenous Lenca heritage and later Spanish colonial expansion. This area offers valuable lessons in agricultural geography and environmental conservation."
    },
    factsAdvanced: {
      de: ["Früher war Usulután das Zentrum der Baumwollproduktion in Mittelamerika, was der Stadt großen Wohlstand einbrachte.", "Der Name Usulután bedeutet in der Sprache der Ureinwohner 'Ort der Ozelots'.", "Die Stadt beherbergt eines der wichtigsten Krankenhäuser und Bildungszentren in der östlichen Region des Landes."],
      hu: ["Egykor Közép-Amerika \"gyapotfővárosaként\" ismerték.", "Nevének jelentése nahuatl nyelven: \"az ocelotok helye\".", "Fontos kapu a Jiquilisco-öböl bioszféra-rezervátumához.", "Kelet-Salvador egyik legjelentősebb kereskedelmi központja."],
      ro: ["Numele Usulután provine din limba nahuatl și înseamnă locul oceloților.", "În trecut, a fost considerat capitala bumbacului din America Centrală datorită producției masive.", "Orașul este poarta principală de acces către rezervația biosferei din Golful Jiquilisco.", "Găzduiește unul dintre cele mai importante centre medicale și educaționale din estul țării."],
      en: ["Capital of the Usulután Department.", "Founded by Lenca tribes before Spanish arrival.", "Located at an elevation of 90 meters.", "Historically known as the 'Granary of the Republic'.", "Situated near the Usulután volcano.", "Gateway to the Jiquilisco Bay Biosphere Reserve."]
    }
  },
  {
...
image: "/poi-images/cojutepeque-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Cojutepeque is the vibrant capital of the Cuscatlán Department, renowned nationally for its traditional gastronomy, particularly its distinctive artisanal sausages. The city's geography is defined by the imposing Cerro de las Pavas, a prominent hill offering panoramic views of the surrounding valleys and Lake Ilopango. This hill is also a significant religious site, drawing pilgrims to the shrine of Our Lady of Fatima. Historically, Cojutepeque briefly served as the capital of El Salvador during the mid-19th century due to political instability in San Salvador. The local economy is driven by agriculture, trade, and traditional food production, making it a culturally and historically rich destination."
    },
    factsAdvanced: {
      de: ["In der Geschichte El Salvadors diente Cojutepeque mehrmals als provisorische Hauptstadt des Landes.", "Das Fest der Unbefleckten Empfängnis im Dezember zieht Tausende Gläubige auf den Cerro de las Pavas.", "Die Stadt ist ein wichtiger Knotenpunkt an der Panamericana und verbindet die Hauptstadt mit dem Osten des Landes."],
      hu: ["Híres a tradicionális chorizo és longaniza kolbászairól.", "Itt található a Cerro de las Pavas szent hegy és zarándokhely.", "Többször volt El Salvador ideiglenes fővárosa a történelem során.", "A Panamericana főútvonal mentén fekvő fontos kereskedelmi város."],
      ro: ["Este recunoscut la nivel național pentru producția artizanală de chorizo și longaniza.", "Dealul Cerro de las Pavas este un sit religios major, vizitat de mii de pelerini în decembrie.", "Orașul a servit de mai multe ori ca capitală provizorie a statului El Salvador în perioade de criză.", "Poziția sa pe autostrada Panamericană îl face un nod comercial vital între capitală și est."],
      en: ["Capital of the Cuscatlán Department.", "Elevation is approximately 850 meters.", "Famous for its traditional artisanal sausages.", "Cerro de las Pavas is a major local landmark.", "Served briefly as El Salvador's capital in the 1850s.", "Located along the Pan-American Highway."]
    }
  },
  {
...
image: "/poi-images/la-union-cities-v2.webp"
    ...
    description: { de: "Hauptstadt des Departements La Unión und wichtiger Hafen am Golf von Fonseca.", hu: "La Unión megye fővárosa és fontos kikötő a Fonseca-öbölben.", ro: "Capitala departamentului La Unión și un port important în Golful Fonseca.", en: "Capital of the La Unión department and an important port on the Gulf of Fonseca." },
    
    facts: {
      de: ["Wichtiger Hafen am Golf von Fonseca.", "Endpunkt der Panamericana in El Salvador.", "Fischerei und Handel.", "Nahe der Grenze zu Honduras."],
      hu: ["Fontos kikötő a Fonseca-öbölben.", "A Panamericana végpontja El Salvadorban.", "Halászat és kereskedelem.", "Közel a hondurasi határhoz."],
      ro: ["Port important în Golful Fonseca.", "Punct final al autostrăzii Panamericane în El Salvador.", "Pescuit și comerț.", "Aproape de granița cu Honduras."],
      en: ["Important port on the Gulf of Fonseca.", "Terminus of the Pan-American Highway in El Salvador.", "Fishing and trade.", "Near the border with Honduras."]
    },
     image: "/poi-images/la-union-cities-v2.webp",
    descriptionAdvanced: {
      de: "La Unión ist das Tor El Salvadors zum Golf von Fonseca und ein bedeutender strategischer Standort für den Seehandel mit den Nachbarstaaten Honduras und Nicaragua. Die Stadt beherbergt den modernen Hafen von Cutuco, der ein Symbol für den wirtschaftlichen Fortschritt der östlichen Region ist. Die salzige Meeresbrise und der Blick auf die Vulkaninseln im Golf verleihen La Unión eine einzigartige maritime Atmosphäre.",
      hu: "La Unión El Salvador kapuja a Fonseca-öböl felé, és stratégiai fontosságú kikötőváros a Honduras-szal és Nicaragua-val folytatott tengeri kereskedelemben. Itt található a modern Cutuco kikötő, amely a keleti régió gazdasági fejlődésének egyik legfontosabb szimbóluma. A város tengerparti levegője és az öböl vulkáni szigeteire nyíló kilátás egyedülálló tengeri hangulatot kölcsönöz a településnek. Ez a város jelenti a Panamericana főútvonal hivatalos végpontját az ország területén belül. Az idelátogatók csónaktúrákra indulhatnak a közeli szigetekre, ahol háborítatlan természet és idilli strandok várják őket.",
      ro: "La Unión este poarta de ieșire a statului El Salvador către Golful Fonseca și un punct strategic esențial pentru comerțul maritim cu Honduras și Nicaragua. Orașul găzduiește portul modern Cutuco, un simbol al progresului economic pentru regiunea de est a țării. Briza sărată a mării și vederea asupra insulelor vulcanice din golf conferă localității o atmosferă maritimă unică și plină de viață. Vizitatorii se pot bucura de excursii cu barca spre insule idilice precum Meanguera, unde natura neatinsă și plajele liniștite oferă o experiență de neuitat.",
      en: "La Unión is a crucial port city situated on the shores of the Gulf of Fonseca in eastern El Salvador. As the capital of the La Unión Department, it serves as the primary maritime gateway for the country, facilitating international trade and commerce. The city's strategic location provides access to shared waters with Honduras and Nicaragua, making it a focal point for regional maritime activities. The surrounding landscape features the striking Conchagua volcano, offering dramatic views over the gulf. Historically, La Unión has been shaped by its maritime economy, transitioning from a colonial-era settlement to a modern shipping hub, and it remains a key area for studying maritime trade and geography."
    },
    factsAdvanced: {
      de: ["Der Hafen von La Unión ist einer der tiefsten und modernsten Häfen in ganz Mittelamerika.", "Von La Unión aus starten Boote zu den idyllischen Inseln im Golf, wie Meanguera und Conchagüita.", "Die Stadt markiert den offiziellen Endpunkt der Panamericana innerhalb des salvadorianischen Staatsgebiets."],
      hu: ["Fontos stratégiai kikötő a Fonseca-öböl partján.", "A Panamericana autópálya salvadori szakaszának végpontja.", "Közeli hozzáférés az öböl festői szigeteihez (pl. Meanguera).", "Jelentős halászati és tengeri kereskedelmi központ."],
      ro: ["Portul La Unión este unul dintre cele mai adânci și moderne din întreaga regiune a Americii Centrale.", "Orașul marchează punctul terminus oficial al autostrăzii Panamericane pe teritoriul salvadorian.", "Este un centru major pentru industria pescuitului și prelucrarea produselor marine.", "Din port pornesc ambarcațiuni către insulele pitorești din Golful Fonseca, cum ar fi Conchagüita."],
      en: ["Capital of the La Unión Department.", "Located on the Gulf of Fonseca.", "Elevation is roughly 5 meters above sea level.", "Major port city facilitating maritime trade.", "Shares gulf waters with Honduras and Nicaragua.", "Situated near the base of the Conchagua volcano."]
    }
  },
  {
...
image: "/poi-images/sensuntepeque-cities-v2.webp"
    ...
    description: { de: "Hauptstadt des Departements Cabañas, bekannt für Töpferei.", hu: "Cabañas megye fővárosa, a fazekasságáról ismert.", ro: "Capitala departamentului Cabañas, cunoscută pentru olărit.", en: "Capital of the Cabañas department, known for pottery." },
    ...
    facts: {
     ...
     image: "/poi-images/sensuntepeque-cities-v2.webp",
    descriptionAdvanced: {
      de: "Sensuntepeque, gelegen im zerklüfteten Hochland von Cabañas, ist eine Stadt mit einer starken bäuerlichen Tradition und einem lebendigen Kunsthandwerk. Sie ist landesweit bekannt für ihre wunderschönen Tonarbeiten und Töpfereien, die oft Szenen aus dem ländlichen Leben darstellen. Die Stadt liegt in einem Tal, das von unzähligen grünen Hügeln umgeben ist, was ihr einen malerischen und ruhigen Charakter verleiht.",
      hu: "Sensuntepeque a Cabañas megye hegyvidéki területén fekszik, és erős paraszti hagyományokkal, valamint élő kézművességgel rendelkezik. Országszerte ismert gyönyörű agyagmunkáiról és fazekas termékeiről, amelyek gyakran a vidéki élet jeleneteit ábrázolják. A város egy völgyben terül el, amelyet számtalan zöld domb vesz körül, ami festői és nyugodt karaktert kölcsönöz neki. A gyarmati időkben fontos bányászati központ volt, ahol aranyat és ezüstöt is kitermeltek. A település neve az őslakos nyelven a környék domborzati viszonyaira, a sok kis halomra utal.",
      ro: "Sensuntepeque, situat în zonele înalte și accidentate din Cabañas, este un oraș cu o puternică tradiție agricolă și o scenă meșteșugărească vibrantă. Este cunoscut la nivel național pentru lucrările sale superbe din lut și ceramică, care înfățișează adesea scene detaliate din viața rurală. Orașul se află într-o vale înconjurată de nenumărate dealuri verzi, ceea ce îi conferă un caracter pitoresc și liniștit. În perioada colonială, a fost un centru minier important, unde se extrăgeau aur și argint, bogăție care a lăsat urme în arhitectura locală.",
      en: "Sensuntepeque is the elevated capital of the Cabañas Department, characterized by its mountainous terrain and cooler climate. The city's name originates from the Pipil language, meaning 'four hundred hills,' which accurately describes the undulating landscape that surrounds it. It serves as an administrative and commercial center for the predominantly rural, agricultural communities in the region. Historically, Sensuntepeque was a site of indigenous resistance and later became a center for indigo production during the colonial era. Today, the local economy relies heavily on agriculture, including coffee and cattle ranching. The city's rich heritage and rugged geography make it an interesting focal point for studying cultural resilience."
    },
    factsAdvanced: {
...
image: "/poi-images/san-vicente-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/san-vicente-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Vicente ist eine Stadt von großer historischer Bedeutung und ein Symbol für Beständigkeit. Gelegen im Schatten des imposanten Vulkans Chichontepec, beherbergt sie architektonische Schätze wie die wunderschöne weiße Kirche 'El Pilar', die als eines der besten Beispiele kolonialer Barockarchitektur in El Salvador gilt. Die Stadt dient als zentraler Handelsknotenpunkt für die umliegenden Zuckerrohrplantagen und Getreidefelder.",
      hu: "San Vicente nagy történelmi jelentőségű város és a kitartás szimbóluma El Salvadorban. Az impozáns Chichontepec-vulkán árnyékában fekszik, és olyan építészeti kincseket rejt, mint a gyönyörű fehér El Pilar templom, amely a koloniális barokk egyik legszebb példája az országban. A város központi kereskedelmi csomópontként szolgál a környező cukornádültetvények és gabonaföldek számára. Az ikonikus óratorony a város főterén még a súlyos földrengéseket is túlélte, és a helyiek büszkesége. A régió híres tradicionális édességeiről és péksüteményeiről is, amelyeket országszerte nagyra értékelnek.",
      ro: "San Vicente este un oraș de o mare importanță istorică și un simbol al rezilienței în fața provocărilor naturale. Situat la umbra impunătorului vulcan Chichontepec, acesta adăpostește comori arhitecturale precum frumoasa biserică albă El Pilar, considerată un exemplu remarcabil de baroc colonial. Orașul servește drept nod comercial central pentru plantațiile de trestie de zahăr și culturile de cereale din împrejurimi. Turnul cu ceas emblematic din parcul central a supraviețuit cutremurelor majore, devenind o mândrie a localnicilor și un simbol al statorniciei lor.",
      en: "San Vicente is a historically significant city and the capital of the San Vicente Department. Founded in 1635, it lies nestled in the shadow of the twin-peaked Chinchontepec volcano. The city is famous for its central clock tower (Torre Vicentina) and the grand El Pilar church, which reflect its rich architectural heritage. San Vicente has historically been a major center for sugarcane production, supported by the fertile volcanic soils of the surrounding valley. The region has experienced devastating earthquakes, notably in 2001, but has continually rebuilt, demonstrating remarkable resilience. The city provides a compelling case study of colonial history intersecting with intense volcanic geology."
    },
    factsAdvanced: {
...
image: "/poi-images/gotera-cities-v2.webp"
    ...
    facts: {
      de: ["Hauptstadt von Morazán.", "Museum der Revolution in der Nähe (Perquín).", "Wichtige Rolle im Bürgerkrieg.", "Ländliches Zentrum im Osten."],
      hu: ["Morazán fővárosa.", "A Forradalom Múzeuma a közelben (Perquín).", "Fontos szerepet játszott a polgárháborúban.", "Vidéki központ keleten."],
      ro: ["Capitala Morazán.", "Muzeul Revoluției în apropiere (Perquín).", "Rol important în războiul civil.", "Centru rural în est."],
      en: ["Capital of Morazán.", "Museum of the Revolution nearby (Perquín).", "Important role in the Civil War.", "Rural center in the east."]
    },
     image: "/poi-images/gotera-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "San Francisco Gotera is the administrative center of the Morazán Department in northeastern El Salvador. Historically, the city and its surrounding regions were heavily impacted by the Salvadoran Civil War, and today it serves as a gateway to historical routes and memorials commemorating that period. The local geography is rugged and mountainous, influencing both its historical isolation and its current appeal for historical tourism. The economy is primarily based on agriculture, trade, and remittances. San Francisco Gotera stands as a testament to post-conflict recovery and the preservation of historical memory in modern El Salvador, making it highly relevant for modern history studies."
    },
    factsAdvanced: {
...
image: "/poi-images/colon-city-cities-v2.webp"
    ...
    description: { de: "Eine wachsende Stadt im Departement La Libertad, westlich von Santa Tecla.", hu: "Növekvő város La Libertad megyében, Santa Teclától nyugatra.", ro: "Un oraș în creștere în departamentul La Libertad, la vest de Santa Tecla.", en: "A growing city in the La Libertad department, west of Santa Tecla." },
    
    facts: {
      de: ["Teil des expandierenden Ballungsraums.", "Industrielle und Wohnentwicklung.", "Lage an wichtiger Autobahn.", "Strategische Lage zwischen Santa Tecla und dem Westen."],
      hu: ["A bővülő agglomeráció része.", "Ipari és lakóövezeti fejlődés.", "Fontos autópálya mentén fekszik.", "Stratégiai fekvés Santa Tecla és a nyugati rész között."],
      ro: ["Parte a aglomerației în expansiune.", "Dezvoltare industrială și rezidențială.", "Situat pe o autostradă importantă.", "Poziție strategică între Santa Tecla și vest."],
      en: ["Part of the expanding metropolitan area.", "Industrial and residential development.", "Located on a major highway.", "Strategic location between Santa Tecla and the west."]
    },
     image: "/poi-images/colon-city-cities-v2.webp",
    descriptionAdvanced: {
      de: "Colón ist eine rasant wachsende Stadt, die sich zu einem bedeutenden Wohn- und Industrievorort westlich der Metropolregion San Salvador entwickelt hat. Strategisch günstig an der Hauptautobahn in den Westen gelegen, beherbergt die Stadt große neue Wohnprojekte wie Lourdes, die Tausende von Familien anziehen. Die Stadt vereint eine dynamische wirtschaftliche Entwicklung mit ländlichen Zonen, die für den Anbau von Getreide und Obst wichtig sind.",
      hu: "Colón egy rohamosan növekvő város, amely San Salvador metropoliszától nyugatra fekszik, és fontos lakó- és ipari elővárossá fejlődött. Stratégiai elhelyezkedése a nyugat felé tartó főút mentén vonzóvá tette az olyan nagy lakópark-beruházások számára, mint például Lourdes, amely családok ezreit vonzotta ide. A városban a dinamikus gazdasági fejlődés keveredik a vidéki övezetekkel, ahol továbbra is jelentős a gabona- és gyümölcstermesztés. Számos szabadkereskerelmi övezet és logisztikai központ található itt, amelyek erősítik a régió gazdaságát. Az utazók számára fontos pihenőhely a főváros és a nyugati országrész között.",
      ro: "Colón este un oraș cu o creștere rapidă, transformându-se dintr-o zonă agricolă într-o suburbie industrială și rezidențială importantă la vest de capitală. Situat strategic pe autostrada principală către vest, acesta găzduiește mari proiecte rezidențiale noi, precum Lourdes, care atrag mii de familii. Orașul îmbină dezvoltarea economică dinamică cu zone rurale care rămân vitale pentru cultivarea cerealelor și fructelor. Numeroase zone libere și centre logistice sunt stabilite aici, consolidând rolul orașului ca motor economic regional între Santa Tecla și Santa Ana.",
      en: "Colón is a rapidly growing municipality located in the La Libertad Department, functioning as a significant suburban and industrial extension of the San Salvador Metropolitan Area. The city has seen substantial demographic expansion due to its strategic location along major highways connecting the capital to the western departments. Originally a rural agricultural area, Colón has transformed to host numerous manufacturing plants, logistics centers, and large residential developments. This rapid urbanization highlights the challenges and opportunities of metropolitan expansion in El Salvador, offering insights into modern economic development and land-use changes."
    },
    factsAdvanced: {
      de: ["Das Gebiet von Lourdes innerhalb der Gemeinde Colón ist eines der am schnellsten wachsenden Wohngebiete des Landes.", "In Colón befinden sich mehrere Freihandelszonen und Logistikzentren, die die regionale Wirtschaft stärken.", "Die Stadt dient als wichtiger Rastpunkt für Reisende, die von der Hauptstadt in den Westen El Salvadors fahren."],
      hu: ["A Lourdes nevű városrész az ország egyik leggyorsabban növő lakóövezete.", "Számos szabadkereskedelmi övezet és logisztikai park székhelye.", "Stratégiai fekvés a San Salvador és Santa Ana közötti főúton.", "Fontos gazdasági motor La Libertad megye nyugati részén."],
      ro: ["Zona Lourdes din cadrul municipalității Colón este una dintre ariile urbane cu cea mai rapidă expansiune.", "Găzduiește numeroase zone libere și parcuri logistice de importanță națională.", "Este situat strategic pe ruta principală ce leagă San Salvador de orașul Santa Ana.", "Reprezintă un punct de legătură crucial între zonele industriale din vest și piața capitalei."],
      en: ["Located in the La Libertad Department.", "Part of the Greater San Salvador metropolitan expansion.", "Major hub for manufacturing and logistics.", "Traversed by the Pan-American Highway.", "Experienced rapid population growth since the 1990s."]
    }
  },
  {
...
image: "/poi-images/acajutla-cities-v2.webp"
    ...
    description: { de: "El Salvadors wichtigste Hafenstadt für den internationalen Seehandel.", hu: "El Salvador legfontosabb kikötővárosa a nemzetközi tengeri kereskedelemben.", ro: "Cel mai important oraș portuar din El Salvador pentru comerțul maritim internațional.", en: "El Salvador's main port city for international maritime trade." },
    
    facts: {
      de: ["Wichtigster Seehafen des Landes.", "Export von Kaffee und Zucker.", "Ölraffinerie in der Nähe.", "Historischer Ort von Seeschlachten."],
      hu: ["Az ország legfontosabb tengeri kikötője.", "Kávé és cukor exportja.", "Olajfinomító a közelben.", "Tengeri csaták történelmi helyszíne."],
      ro: ["Principalul port maritim al țării.", "Export de cafea și zahăr.", "Rafinărie de petrol în apropiere.", "Loc istoric al bătăliilor navale."],
      en: ["The country's main seaport.", "Exports coffee and sugar.", "Oil refinery nearby.", "Historic site of naval battles."]
    },
     image: "/poi-images/acajutla-cities-v2.webp",
    descriptionAdvanced: {
      de: "Acajutla ist der Lebensnerv des salvadorianischen Außenhandels und der modernste Seehafen des Landes. Seit der Kolonialzeit ist dieser Ort von entscheidender strategischer Bedeutung für den Export von Waren wie Kaffee, Zucker und heute auch industriellen Produkten. Die Stadt ist geprägt von den gewaltigen Hafenanlagen, der Ölraffinerie und einer lebhaften Gemeinschaft von Hafenarbeitern und Fischern.",
      hu: "Acajutla El Salvador külkereskedelmének éltető eleme és az ország legmodernebb tengeri kikötője. A gyarmati idők óta stratégiai jelentőségű helyszín az olyan termékek exportjában, mint a kávé és a cukor, ma pedig már az ipari áruk forgalmának nagy részét is itt bonyolítják. A város látképét a hatalmas kikötői berendezések, az olajfinomító és a halászok mindennapi élete határozza meg. Történelmileg is jelentős hely, hiszen itt zajlott le 1524-ben az a csata, amelyben Pedro de Alvarado megküzdött a pipil harcosokkal. A látogatókat emellett számos tengerparti étterem várja friss halételekkel.",
      ro: "Acajutla reprezintă inima comerțului exterior salvadorian, fiind cel mai modern și activ port maritim al țării. Încă din perioada colonială, această locație a avut o importanță strategică crucială pentru exportul de produse precum cafeaua și zahărul. Peisajul orașului este dominat de infrastructura portuară masivă, de rafinăria de petrol și de o comunitate vibrantă de muncitori și pescari. Dincolo de aspectul industrial, Acajutla este o destinație populară pentru gastronomia marină, restaurantele de pe coastă oferind preparate proaspete și delicioase în sunetul valurilor Pacificului.",
      en: "Acajutla is El Salvador's principal seaport, situated on the Pacific coast in the Sonsonate Department. The city handles a vast majority of the country's maritime imports and exports, making it a critical asset for the national economy. Historically, Acajutla was a key indigenous trading site before Spanish colonization and played a major role during the colonial era for the export of balsam and cacao. Today, its modern deep-water port infrastructure supports shipping, petroleum refining, and fishing industries. The city is a prime example of industrial coastal geography and international trade logistics in Central America."
    },
    factsAdvanced: {
      de: ["Der Hafen von Acajutla schlägt über 90 % der Seefracht El Salvadors um.", "Hier fand 1524 die historische Schlacht von Acajutla statt, in der Pedro de Alvarado gegen die Pipil-Krieger kämpfte.", "Acajutla ist auch ein beliebtes Ziel für lokales Seafood, serviert in den zahlreichen Restaurants entlang der Küste."],
      hu: ["El Salvador legfontosabb és legmodernebb tengeri kikötője.", "Itt bonyolódik le az ország tengeri áruforgalmának több mint 90%-a.", "1524-ben itt zajlott a hódítás egyik legfontosabb csatája.", "Jelentős olajfinomító és ipari központ található a városban."],
      ro: ["Prin portul Acajutla trece peste 90% din volumul total de mărfuri maritime ale țării.", "Aici a avut loc în 1524 o bătălie istorică între Pedro de Alvarado și războinicii indigeni Pipil.", "Orașul găzduiește singura rafinărie de petrol activă din El Salvador.", "Este faimos pentru varietatea și prospețimea fructelor de mare servite în restaurantele locale."],
      en: ["Located in the Sonsonate Department.", "El Salvador's primary deep-water seaport.", "Elevation is effectively at sea level.", "Handles a majority of the nation's ocean freight.", "Historically important for exporting balsam and cacao.", "Site of major petroleum processing facilities."]
    }
  },
  {
...
image: "/poi-images/iztapán-cities-v2.webp"
    ...
    description: { de: "Eine Stadt im Departement Santa Ana, nahe der Grenze zu Guatemala.", hu: "Város Santa Ana megyében, közel a guatemalai határhoz.", ro: "Un oraș în departamentul Santa Ana, aproape de granița cu Guatemala.", en: "A city in the Santa Ana department, near the border with Guatemala." },
    
    facts: {
      de: ["Grenznahe Lage zu Guatemala.", "Landwirtschaftliches Zentrum.", "Anbau von Getreide und Kaffee.", "Teil der Metropolregion Santa Ana."],
      hu: ["Guatemalai határ menti fekvés.", "Mezőgazdasági központ.", "Gabona- és kávétermesztés.", "Santa Ana nagyvárosi területének része."],
      ro: ["Situat aproape de granița cu Guatemala.", "Centru agricol.", "Cultivarea cerealelor și a cafelei.", "Parte a zonei metropolitane Santa Ana."],
      en: ["Located near the Guatemalan border.", "Agricultural center.", "Cultivation of grains and coffee.", "Part of the Santa Ana metropolitan area."]
    },
     image: "/poi-images/iztapán-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Sebastián Salitrillo ist eine charmante Stadt im Westen des Landes, die für ihre landwirtschaftliche Tradition und ihre ruhige Atmosphäre geschätzt wird. Die Stadt liegt verkehrsgünstig an der Straße nach Guatemala und dient als wichtiger lokaler Markt für Getreide und hochwertigen Kaffee. Trotz des Wachstums hat San Sebastián seinen dörflichen Charakter bewahrt, was man besonders am zentralen Platz und der traditionellen Architektur erkennt.",
      hu: "San Sebastián Salitrillo egy bájos város az ország nyugati részén, amelyet mezőgazdasági hagyományai és nyugodt légköre miatt kedvelnek. A település kényelmesen, a Guatemala felé vezető út mentén fekszik, és fontos helyi piaca a gabonaféléknek és a kiváló minőségű kávénak. A növekedés ellenére San Sebastián megőrizte falusias jellegét, ami különösen a központi téren és a hagyományos építészeten érhető tetten. Az utóbbi években egyre népszerűbb lakóhely lett a közeli Santa Anában dolgozók számára. A város névadó szentjének tiszteletére rendezett januári ünnepségek a közösségi élet csúcspontját jelentik.",
      ro: "San Sebastián Salitrillo este un oraș fermecător din vestul țării, apreciat pentru tradiția sa agricolă și atmosfera sa liniștită. Situat strategic pe drumul către Guatemala, orașul servește ca o piață locală importantă pentru cereale și cafea de înaltă calitate. În ciuda dezvoltării recente, localitatea și-a păstrat caracterul autentic, vizibil în arhitectura tradițională și în piața centrală primitoare. În ultimii ani, a devenit o opțiune rezidențială populară pentru cei care lucrează în orașul învecinat Santa Ana, oferind un echilibru perfect între mediul rural și cel urban.",
      en: "Iztapán is a historic municipality located in the San Salvador Department, deeply rooted in pre-Columbian indigenous traditions. The name reflects its ancient Nahuat origins, indicating a place with abundant salt or white sands. While it has become integrated into the expanding urban footprint of the metropolitan area, it retains aspects of its historical identity. The local economy blends modern commercial activities with traditional trades. Studying Iztapán provides a micro-level view of how ancient indigenous settlements adapt to and survive within rapid modern urbanization in Central America."
    },
    factsAdvanced: {
      de: ["Die Stadt ist bekannt für ihre jährlichen Feste zu Ehren des Heiligen Sebastian im Januar.", "San Sebastián Salitrillo profitiert von seiner Lage in einem der besten Kaffeeanbaugebiete El Salvadors.", "In den letzten Jahren hat die Stadt an Bedeutung als Wohngebiet für Pendler aus dem nahegelegenen Santa Ana gewonnen."],
      hu: ["A guatemalai határ közelében fekvő mezőgazdasági város.", "Kiváló minőségű kávé- és gabonatermesztő vidék központja.", "Népszerű elővárosi lakóhely Santa Ana közelsége miatt.", "Januárban tartják a város védőszentjének, Szent Sebestyénnek az ünnepét."],
      ro: ["Orașul este situat într-una dintre cele mai bune regiuni producătoare de cafea din El Salvador.", "În fiecare an, în luna ianuarie, se sărbătoresc festivitățile în onoarea Sfântului Sebastian.", "Beneficiază de o poziție geografică favorabilă, fiind situat pe ruta comercială către Guatemala.", "A cunoscut o dezvoltare rezidențială semnificativă datorită proximității față de Santa Ana."],
      en: ["Located in the San Salvador Department.", "Name has ancient Nahuat indigenous origins.", "Part of the expanding metropolitan region.", "Elevation is approximately 600 meters.", "Economy mixes local commerce with urban trades."]
    }
  },
  {
...
image: "/poi-images/chalchuapa-cities-v2.webp"
    ...
    facts: {
      de: ["Heimat der Tazumal-Ruinen.", "Archäologische Zone von großer Bedeutung.", "Kontinuierliche Besiedlung über Jahrtausende.", "Koloniales Stadtzentrum."],
      hu: ["A Tazumal romok otthona.", "Nagy jelentőségű régészeti zóna.", "Évezredek óta folyamatosan lakott.", "Gyarmati városközpont."],
      ro: ["Gazda ruinelor Tazumal.", "Zonă arheologică de mare importanță.", "Așezare continuă de milenii.", "Centru urban colonial."],
      en: ["Home to the Tazumal ruins.", "Archaeological zone of great importance.", "Continuously inhabited for millennia.", "Colonial city center."]
    },
     image: "/poi-images/chalchuapa-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Chalchuapa is a city in the Santa Ana Department, renowned as the archaeological heart of El Salvador. It is home to the Tazumal archaeological park, one of the most important and well-preserved pre-Columbian Mayan ruins in the country, with structures dating back to 100 AD. The city's history is a rich tapestry of Mayan, Pipil, and Spanish colonial influences. Beyond its profound historical significance, Chalchuapa is located in a fertile volcanic region that supports extensive coffee cultivation. It is a premier destination for studying Mesoamerican history, archaeology, and the intersection of ancient cultures with modern agriculture."
    },
    factsAdvanced: {
      de: ["In Chalchuapa befindet sich das größte präkolumbianische Bauwerk El Salvadors.", "Die Stadt ist berühmt für ihr traditionelles Gebäck, die 'Semitas', und andere kulinarische Schätze.", "Chalchuapa war historisch gesehen ein bedeutendes Zentrum für den Obsidianhandel in Mittelamerika."],
      hu: ["Itt található Tazumal, El Salvador legjelentősebb maja romvárosa.", "Amerika egyik legrégebb óta folyamatosan lakott települése.", "Híres a tradicionális \"Semitas\" és egyéb helyi süteményeiről.", "Fontos vallási központ a Santiago Apóstol templommal."],
      ro: ["Adăpostește situl arheologic Tazumal, care conține cea mai mare piramidă precolumbiană din țară.", "Este una dintre puținele localități din lume locuite neîntrerupt de peste 3000 de ani.", "A fost istoric un centru major de prelucrare și comerț cu obsidian în perioada prehispanică.", "Biserica Santiago Apóstol din centru este un monument colonial de o valoare arhitecturală deosebită."],
      en: ["Located in the Santa Ana Department.", "Home to the famous Tazumal archaeological ruins.", "Elevation is roughly 700 meters.", "Site of continuous human settlement for over 3000 years.", "Surrounding region is known for high-quality coffee.", "Features colonial-era architectural structures."]
    }
  },
  {
...
image: "/poi-images/quezaltepeque-city-cities-v2.webp"
    ...
    description: { de: "Eine Stadt im Departement La Libertad, bekannt für ihre Landwirtschaft und Viehzucht.", hu: "Város La Libertad megyében, mezőgazdaságáról és állattenyésztéséről ismert.", ro: "Un oraș în departamentul La Libertad, cunoscut pentru agricultură și creșterea animalelor.", en: "A city in the La Libertad department, known for its agriculture and livestock." },
    ...
    facts: {
     ...
     image: "/poi-images/quezaltepeque-city-cities-v2.webp",
    descriptionAdvanced: {
      de: "Quezaltepeque liegt strategisch am Fuße des Vulkans San Salvador und ist ein wichtiges landwirtschaftliches und industrielles Zentrum. Die Stadt ist bekannt für ihre fruchtbaren Böden, die durch vulkanische Asche bereichert wurden und hervorragende Bedingungen für die Viehzucht und den Getreideanbau bieten. Die Nähe zur Hauptstadt und die wachsende industrielle Entwicklung machen Quezaltepeque zu einer der dynamischsten Städte im Departement La Libertad.",
      hu: "Quezaltepeque stratégiai helyen, a San Salvador-vulkán lábánál fekszik, és fontos mezőgazdasági és ipari központ La Libertad megyében. A város híres termékeny talajáról, amelyet a vulkáni hamu tett gazdaggá, kiváló feltételeket biztosítva az állattenyésztéshez és a gabonatermesztéshez. A főváros közelsége és a növekvő ipari fejlődés az ország egyik legdinamikusabb településévé teszi. Nevének jelentése nahuatl nyelven a gyönyörű kvézál madárra utal, ami a környék egykori gazdag élővilágát idézi. A városi élet lüktetése és a vidéki hagyományok itt különleges elegyet alkotnak.",
      ro: "Quezaltepeque este situat strategic la poalele vulcanului San Salvador și reprezintă un centru agricol și industrial vital. Orașul este renumit pentru solurile sale fertile, îmbogățite de cenușa vulcanică, care oferă condiții excelente pentru creșterea animalelor și cultivarea cerealelor. Proximitatea față de capitală și dezvoltarea industrială susținută fac din Quezaltepeque unul dintre cele mai dinamice orașe din departamentul La Libertad. Numele său provine din limba nahuatl și face referire la pasărea quetzal, amintind de bogăția naturală de odinioară a acestei regiuni spectaculoase.",
      en: "Quezaltepeque is a dynamic city in the La Libertad Department, situated just northwest of San Salvador. It is strategically located near the San Salvador volcano, which influences its topography and soil composition. The city has transitioned from a traditional agricultural center, known for coffee and sugarcane, into a thriving industrial and commercial hub due to its proximity to the capital. The local La Toma water park is a popular recreational area fed by volcanic springs. Quezaltepeque illustrates the dynamic shift from rural agriculture to urban industrialization within the metropolitan periphery."
    },
    factsAdvanced: {
...
image: "/poi-images/antiguo-cuscatlan-cities-v2.webp"
    ...
    description: { de: "Eine wohlhabende Stadt, die Teil der Metropolregion San Salvador ist und viele Botschaften beherbergt.", hu: "Jómódú város, amely San Salvador nagyvárosi területének része, és számos nagykövetségnek ad otthont.", ro: "Un oraș prosper, parte a zonei metropolitane San Salvador, care găzduiește multe ambasade.", en: "An affluent city, part of the San Salvador metropolitan area, housing many embassies." },
    
    facts: {
      de: ["Moderne und wohlhabende Stadt.", "Sitz vieler Botschaften und internationaler Organisationen.", "Große Einkaufszentren und Bürokomplexe.", "Hoher Lebensstandard."],
      hu: ["Modern és jómódú város.", "Számos nagykövetség és nemzetközi szervezet székhelye.", "Nagy bevásárlóközpontok és irodakomplexumok.", "Magas életszínvonal."],
      ro: ["Oraș modern și prosper.", "Sediul multor ambasade și organizații internaționale.", "Mari centre comerciale și complexuri de birouri.", "Standard de viață ridicat."],
      en: ["Modern and affluent city.", "Seat of many embassies and international organizations.", "Large shopping malls and office complexes.", "High standard of living."]
    },
     image: "/poi-images/antiguo-cuscatlan-cities-v2.webp",
    descriptionAdvanced: {
      de: "Antiguo Cuscatlán gilt als eine der modernsten und wohlhabendsten Städte El Salvadors. Gelegen am Rande der Hauptstadt, ist sie ein Zentrum für internationale Organisationen, Botschaften und exklusive Wohngebiete. Die Stadt beherbergt die größten Einkaufszentren des Landes sowie bedeutende Universitäten und Bürokomplexe, was sie zu einem der wichtigsten Motoren für Wirtschaft und Bildung in der Metropolregion macht.",
      hu: "Antiguo Cuscatlán El Salvador egyik legmodernebb és legmódosabb városa, amely közvetlenül a főváros mellett helyezkedik el. Nemzetközi szervezetek, nagykövetségek és exkluzív lakónegyedek központja, ahol az életszínvonal kiemelkedően magas. Itt találhatók az ország legnagyobb bevásárlóközpontjai, fontos egyetemek és irodakomplexumok, amelyek a gazdaság és az oktatás motorjává teszik. Történelmileg ez a hely volt a pipil indiánok Cuscatlán fejedelemségének ősi fővárosa. A városban található Plan de la Laguna park egy egykori vulkáni kalderában kialakított botanikus kert, amely különleges természeti látnivaló.",
      ro: "Antiguo Cuscatlán este considerat unul dintre cele mai moderne și prospere orașe din El Salvador, fiind situat la marginea capitalei. Este un centru important pentru organizațiile internaționale, ambasade și zone rezidențiale exclusiviste. Orașul adăpostește cele mai mari centre comerciale din țară, universități de prestigiu și complexe de birouri de ultimă generație, fiind un motor esențial pentru economie și educație. Istoric, acest loc a fost capitala străveche a regatului Cuscatlán al indienilor Pipil, păstrând o moștenire culturală prețioasă sub fațada sa modernă.",
      en: "Antiguo Cuscatlán is a highly developed municipality in the La Libertad Department, directly adjacent to San Salvador. Historically, it was the capital of the Pipil nation before the Spanish conquest in the 16th century. Today, it is recognized as one of the most affluent and economically prosperous cities in El Salvador, boasting high standards of living, extensive commercial centers, and numerous universities. The city seamlessly blends its ancient indigenous heritage with modern urban infrastructure, serving as a vital financial and residential center. It is an excellent subject for studying modern urban economics and historical preservation."
    },
    factsAdvanced: {
...
image: "/poi-images/armenien-city-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Kávétermesztő terület.", "Örmény bevándorlók alapították.", "Vidéki kereskedelmi központ.", "Nyugodt légkör."],
      ro: ["Zonă de cultivare a cafelei.", "Fondat de imigranți armeni.", "Centru comercial rural.", "Atmosferă liniștită."],
      en: ["Coffee growing area.", "Founded by Armenian immigrants.", "Rural commercial center.", "Quiet atmosphere."]
    },
     image: "/poi-images/armenien-city-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Armenia is a historic city located in the Sonsonate Department, characterized by its pleasant climate and fertile surroundings. Originally an indigenous settlement, it grew in prominence during the colonial period due to its agricultural productivity. Today, Armenia remains deeply connected to agriculture, with coffee, basic grains, and livestock driving its local economy. The city is also known for its well-preserved colonial traditions and religious festivals, which draw visitors from surrounding regions. It serves as an interesting example of rural cultural preservation and agricultural community dynamics in western El Salvador."
    },
    factsAdvanced: {
      de: ["Die Stadt wurde ursprünglich von europäischen Einwanderern mitgeprägt, was man noch heute an einigen Namen und Traditionen erkennt.", "Armenia ist bekannt für seine hochwertigen Kaffeebohnen, die oft direkt für den Export verarbeitet werden.", "Die jährlichen Stadtfeste zu Ehren des Heiligen Schutzpatrons sind ein Höhepunkt im sozialen Leben der Gemeinde."],
      ...
      ro: ["Localitatea este renumită pentru producția de cafea de înaltă calitate destinată exportului.", "În centrul orașului se pot admira clădiri cu arhitectură colonială bine conservată.", "Este un punct de tranzit important între regiunea muntoasă din vest și zonele de coastă.", "Sărbătorile patronale sunt cunoscute pentru paradele pline de culoare și evenimentele culturale."],
      en: ["Located in the Sonsonate Department.", "Elevation is approximately 600 meters.", "Economy is largely driven by coffee and grain farming.", "Originally an indigenous Pipil settlement.", "Known for its traditional religious festivals."]
    }
  },
  {
...
image: "/poi-images/san-martin-cities-v2.webp"
    ...
    description: { de: "Eine Stadt östlich von San Salvador, bekannt für ihre Möbelherstellung.", hu: "San Salvadortól keletre fekvő város, bútorgyártásáról ismert.", ro: "Un oraș la est de San Salvador, cunoscut pentru producția de mobilă.", en: "A city east of San Salvador, known for its furniture manufacturing." },
    
    facts: {
      de: ["Zentrum der Möbelherstellung.", "Wachsender Vorort.", "Lage an der Panamericana.", "Handwerkliche Tradition."],
      hu: ["A bútorgyártás központja.", "Növekvő előváros.", "A Panamericana mentén található.", "Kézműves hagyományok."],
      ro: ["Centru de producție a mobilei.", "Suburbie în creștere.", "Situat pe autostrada Panamericană.", "Tradiție artizanală."],
      en: ["Center for furniture manufacturing.", "Growing suburb.", "Located on the Pan-American Highway.", "Artisanal tradition."]
    },
     image: "/poi-images/san-martin-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Martín ist eine dynamische Stadt östlich der Hauptstadt, die landesweit für ihre exzellente Möbelherstellung bekannt ist. Entlang der Hauptverkehrsstraßen finden sich zahlreiche Werkstätten und Geschäfte, in denen hochwertige handgefertigte Holzmöbel verkauft werden. Die Stadt hat sich in den letzten Jahrzehnten von einer landwirtschaftlichen Gemeinde zu einem lebhaften Handelszentrum und einem wichtigen Wohnort für Menschen aus der Metropolregion entwickelt.",
      hu: "San Martín egy dinamikus város a fővárostól keletre, amely országszerte kiváló bútorgyártásáról ismert. A főút mentén számos műhely és üzlet sorakozik, ahol kiváló minőségű, kézzel készített fa bútorokat kínálnak az idelátogatóknak. Az elmúlt évtizedekben a település mezőgazdasági közösségből nyüzsgő kereskedelmi központtá és fontos lakóövezetté vált a metropolisz környékén. Stratégiai elhelyezkedése a Panamericana mentén kulcsfontosságúvá teszi az ország keleti része felé irányuló forgalomban. A novemberi városi fesztivál híres színes felvonulásairól és a helyi kézműves mestermunkák bemutatójáról.",
      ro: "San Martín este un oraș dinamic situat la est de capitală, renumit la nivel național pentru producția sa excelentă de mobilă. De-a lungul drumului principal, se găsesc numeroase ateliere și magazine unde se vând piese de mobilier din lemn lucrate manual, de o calitate excepțională. În ultimele decenii, orașul s-a transformat dintr-o comunitate agricolă într-un centru comercial vibrant și o zonă rezidențială esențială pentru zona metropolitană. Poziția sa strategică pe autostrada Panamericană îl face un punct de oprire obligatoriu pentru cei care călătoresc spre estul țării.",
      en: "San Martín is a populous municipality situated in the eastern edge of the San Salvador Department. It functions as an important transit corridor linking the capital city with the central and eastern regions of the country via the Pan-American Highway. The city's landscape has transformed rapidly from agricultural lands to a dense mix of residential neighborhoods, commercial strips, and light industry. This strategic location has spurred significant demographic growth over recent decades. San Martín highlights the realities of suburban expansion and transit-oriented development in a developing nation."
    },
    factsAdvanced: {
      de: ["Die Möbelindustrie von San Martín liefert ihre Produkte in das ganze Land und sogar über die Grenzen hinaus.", "Strategisch an der Panamericana gelegen, ist die Stadt ein wichtiger Knotenpunkt für Reisende in den Osten El Salvadors.", "Das Stadtfest im November ist berühmt für seine farbenfrohen Paraden und die Präsentation lokaler Handwerkskunst."],
      hu: ["El Salvador leghíresebb bútorgyártó központja.", "Stratégiai fekvés a Panamericana főútvonal mentén.", "Dinamikusan növekvő előváros és kereskedelmi csomópont.", "Híres a hagyományos famegmunkálásról és kézművességről."],
      ro: ["Este considerat centrul principal de fabricare a mobilei artizanale din lemn în El Salvador.", "Situat strategic pe autostrada Panamericană, facilitează comerțul cu regiunile estice.", "Orașul a cunoscut o creștere demografică rapidă, devenind un pol urban major la est de capitală.", "Festivalul local din noiembrie este celebru pentru expozițiile sale de artizanat și paradele festive."],
      en: ["Located in the San Salvador Department.", "Positioned along the vital Pan-American Highway.", "Elevation is approximately 630 meters.", "Has experienced rapid residential and commercial growth.", "Acts as a transit gateway to eastern El Salvador."]
    }
  },
  {
...
image: "/poi-images/izalko-city-cities-v2.webp"
    ...
    facts: {
      de: ["Historisches Zentrum des Pipil-Volkes.", "Lage am Fuße des Izalco-Vulkans.", "Zwei getrennte Kolonialkirchen.", "Ort eines Bauernaufstands 1932."],
      hu: ["A pipil nép történelmi központja.", "Az Izalco-vulkán lábánál található.", "Két különálló gyarmati templom.", "Az 1932-es parasztfelkelés helyszíne."],
      ro: ["Centrul istoric al poporului Pipil.", "Situat la poalele vulcanului Izalco.", "Două biserici coloniale separate.", "Locul unei răscoale țărănești din 1932."],
      en: ["Historic center of the Pipil people.", "Located at the foot of the Izalco Volcano.", "Two separate colonial churches.", "Site of a 1932 peasant uprising."]
    },
     image: "/poi-images/izalko-city-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Izalco is a culturally and historically profound city in the Sonsonate Department, positioned at the foothills of the famous Izalco volcano. The city is deeply associated with indigenous Pipil history and was a primary center for cacao production during the Spanish colonial era. It is also tragically remembered as the epicenter of the 1932 Salvadoran peasant massacre (La Matanza). Today, Izalco maintains a strong indigenous identity, visible in its distinct neighborhoods and preserved traditions. It is a critical location for understanding indigenous history, colonial economics, and the sociopolitical struggles of 20th-century El Salvador."
    },
    factsAdvanced: {
      de: ["Die Stadt war einer der Hauptschauplätze des tragischen Bauernaufstands von 1932.", "Izalco ist berühmt für seine 'Cofradías', religiöse Bruderschaften, die antike Riten und Feste pflegen.", "Der Vulkan Izalco, früher als 'Leuchtturm des Pazifiks' bekannt, dominiert das Panorama der Stadt."],
      hu: ["A pipil indián kultúra egyik legfontosabb őrzője.", "Az Izalco-vulkán, a \"Csendes-óceán világítótornya\" lábánál fekszik.", "Két különálló történelmi gyarmati templommal rendelkezik.", "Az 1932-es történelmi események egyik központi helyszíne."],
      ro: ["Numele orașului înseamnă locul nisipurilor de obsidian în limba indigenă.", "Păstrează structura unică cu două biserici coloniale în același centru urban.", "Este un centru major al tradițiilor Cofradías, frății religioase care păstrează rituri antice.", "Vulcanul Izalco din apropiere a fost numit Farul Pacificului datorită erupțiilor sale vizibile de pe mare."],
      en: ["Located in the Sonsonate Department.", "Situated near the famous Izalco volcano.", "Elevation is approximately 400 meters.", "Historically a major center for cacao cultivation.", "Epicenter of the tragic 1932 peasant uprising.", "Maintains a strong indigenous Pipil cultural identity."]
    }
  },
  {
...
image: "/poi-images/la-paz-center-cities-v2.webp"
    ...
    description: { de: "Eine Stadt im Departement La Paz, nahe der Pazifikküste.", hu: "Város La Paz megyében, a Csendes-óceán partjának közelében.", ro: "Un oraș în departamentul La Paz, aproape de coasta Pacificului.", en: "A city in the department of La Paz, near the Pacific coast." },
    
    facts: {
      de: ["Landwirtschaftliches Zentrum.", "Nähe zu Stränden und Mangroven.", "Produktion von Salz und Obst.", "Ruhiges, ländliches Leben."],
      hu: ["Mezőgazdasági központ.", "Közel a strandokhoz és a mangroveerdőkhöz.", "Só- és gyümölcstermelés.", "Nyugodt, vidéki élet."],
      ro: ["Centru agricol.", "Apropierea de plaje și mangrove.", "Producția de sare și fructe.", "Viață rurală liniștită."],
      en: ["Agricultural center.", "Proximity to beaches and mangroves.", "Production of salt and fruits.", "Quiet, rural life."]
    },
     image: "/poi-images/la-paz-center-cities-v2.webp",
    descriptionAdvanced: {
      de: "El Rosario ist eine ruhige und fruchtbare Stadt im Departement La Paz, die für ihre starke landwirtschaftliche Ausrichtung bekannt ist. Gelegen in der Küstenebene El Salvadors, profitiert die Stadt von den reichen Böden, auf denen Getreide, Obst und Zuckerrohr angebaut werden. Die entspannte ländliche Atmosphäre und die Nähe zu den Mangrovenwäldern der Küste machen El Rosario zu einem authentischen Beispiel für das Leben in den Küstenregionen des Landes.",
      hu: "El Rosario egy nyugodt és termékeny mezőgazdasági város La Paz megyében, amely leginkább agrártevékenységéről ismert. El Salvador tengerparti síkságán fekszik, kihasználva a gazdag talajt, ahol gabonát, gyümölcsöt és cukornádat termesztenek. A békés vidéki hangulat és a közeli mangroveerdők közelsége az autentikus partmenti életmód mintájává teszi a települést. A város híres a közeli sólepárlókban előállított tengeri sóról is, ami fontos bevételi forrás a helyieknek. Az októberi városi fesztiválok alkalmával a közösség tradicionális zenével és gasztronómiai különlegességekkel ünnepli gyökereit.",
      ro: "El Rosario este un oraș agricol liniștit și fertil din departamentul La Paz, situat în câmpiile de coastă ale statului El Salvador. Localitatea beneficiază de soluri bogate, unde se cultivă intensiv cereale, fructe tropicale și trestie de zahăr pentru consumul intern și export. Atmosfera rurală pașnică și apropierea de zonele de mangrove de pe coastă fac din El Rosario un model de viață autentică în regiunea litorală. Orașul este recunoscut și pentru micile industrii locale care procesează resursele naturale din zonă, păstrând un echilibru între dezvoltare și tradiție.",
      en: "Zacatecoluca, often referred to as the administrative center of La Paz, is a prominent city located in the fertile coastal plain region. The city lies near the imposing Chinchontepec volcano, which dominates the local skyline and provides rich volcanic soil for agriculture. It is a major agricultural hub, known historically for sugarcane and cotton production. The city also features significant colonial architecture, including its central cathedral. Its proximity to the international airport and major coastal highways makes it a vital economic node. Zacatecoluca is essential for studying the agricultural economy and colonial heritage of central El Salvador."
    },
    factsAdvanced: {
      de: ["Die Stadt ist bekannt für die Produktion von Meersalz in den nahegelegenen Salinen.", "Die jährlichen Stadtfeste im Oktober locken Besucher mit traditioneller Musik und lokaler Gastronomie an.", "El Rosario dient als wichtiges Versorgungszentrum für die umliegenden ländlichen Weiler und Plantagen."],
      hu: ["Fontos mezőgazdasági központ a tengerparti síkságon.", "Híres a közeli sólepárlókból származó tengeri só termeléséről.", "Központi szerepet játszik a régió gyümölcskereskedelmében.", "Közel fekszik a Csendes-óceánhoz és a mangrove mocsarakhoz."],
      ro: ["Este un centru agricol vital situat în inima zonei de producție a trestiei de zahăr din La Paz.", "Orașul beneficiază de proximitatea rezervațiilor naturale de mangrove de pe coasta Pacificului.", "Este cunoscut pentru producția locală de sare marină și fructe tropicale proaspete.", "Comunitatea păstrează tradiții populare vii, celebrate cu entuziasm în timpul festivalurilor locale."],
      en: ["Capital of the La Paz Department (Zacatecoluca).", "Elevation is approximately 210 meters.", "Located near the Chinchontepec (San Vicente) volcano.", "Major center for sugarcane and agricultural processing.", "Features significant colonial-era architecture.", "Birthplace of notable historical figure José Simeón Cañas."]
    }
  },
  {
...
image: "/poi-images/jiquilisco-cities-v2.webp"
    ...
    description: { de: "Eine Stadt nahe der Jiquilisco-Bucht, einem wichtigen Biosphärenreservat.", hu: "Város a Jiquilisco-öböl közelében, amely fontos bioszféra-rezervátum.", ro: "Un oraș aproape de Golful Jiquilisco, o importantă rezervație a biosferei.", en: "A city near Jiquilisco Bay, an important biosphere reserve." },
    
    facts: {
      de: ["Tor zur Jiquilisco-Bucht.", "Größtes Mangrovengebiet des Landes.", "Fischerei und Garnelenzucht.", "Reiche Tierwelt."],
      hu: ["Kapu a Jiquilisco-öbölhöz.", "Az ország legnagyobb mangrove területe.", "Halászat és garnélarák-tenyésztés.", "Gazdag állatvilág."],
      ro: ["Poarta către Golful Jiquilisco.", "Cea mai mare zonă de mangrove din țară.", "Pescuit și creșterea creveților.", "Faună bogată."],
      en: ["Gateway to Jiquilisco Bay.", "Largest mangrove area in the country.", "Fishing and shrimp farming.", "Rich wildlife."]
    },
     image: "/poi-images/jiquilisco-cities-v2.webp",
    descriptionAdvanced: {
      de: "Jiquilisco ist das Tor zu einem der kostbarsten Naturschätze El Salvadors: der Bucht von Jiquilisco. Die Stadt selbst ist ein geschäftiges Handelszentrum im Departement Usulután, geprägt von der Nähe zum Meer und der fruchtbaren Küstenebene. Für Naturliebhaber und Wissenschaftler ist Jiquilisco der Ausgangspunkt, um die riesigen Mangrovenwälder und das UNESCO-Biosphärenreservat zu erkunden, das als wichtiger Lebensraum für bedrohte Meeresschildkröten dient.",
      hu: "Jiquilisco a kapu El Salvador egyik legértékesebb természeti kincséhez, a Jiquilisco-öbölhöz. Maga a város egy forgalmas kereskedelmi központ Usulután megyében, amelyet a tenger közelsége és a termékeny partmenti síkság határoz meg. A természetbarátok és kutatók számára Jiquilisco a kiindulópont a hatalmas mangroveerdők és az UNESCO bioszféra-rezervátum felfedezéséhez. Ez a terület kritikus fontosságú élőhely a veszélyeztetett tengeri teknősök, különösen a cserepesteknősök számára. A város gazdaságában a halászat mellett a modern garnélarák-tenyésztés is kiemelkedő szerepet játszik.",
      ro: "Jiquilisco este poarta de intrare către una dintre cele mai prețioase comori naturale ale statului El Salvador: Golful Jiquilisco. Orașul în sine este un centru comercial agitat în departamentul Usulután, marcat de proximitatea mării și de câmpia de coastă fertilă. Pentru iubitorii de natură și cercetători, Jiquilisco este punctul de plecare pentru explorarea vastelor păduri de mangrove și a rezervației biosferei UNESCO. Această zonă este un habitat critic pentru speciile de broaște țestoase marine aflate în pericol, fiind totodată un pilon al economiei bazate pe pescuit și acvacultură.",
      en: "Jiquilisco is a vital coastal municipality in the Usulután Department, heavily defined by its proximity to the Bay of Jiquilisco. This bay is the largest mangrove estuary in El Salvador and a designated UNESCO Biosphere Reserve, rich in biodiversity including endangered sea turtles and rare bird species. The local economy is deeply tied to the bay, relying on artisanal fishing, aquaculture, and increasingly, ecotourism. The city balances the need for economic development with critical environmental conservation efforts. Jiquilisco serves as a prime study area for coastal ecology, sustainable fishing practices, and biosphere management."
    },
    factsAdvanced: {
      de: ["Die Stadt ist ein bedeutendes Zentrum für die Garnelenzucht, die ein wichtiges Exportgut der Region darstellt.", "Jiquilisco beherbergt Organisationen, die sich intensiv für den Schutz der Karrettschildkröte einsetzen.", "Die Bucht von Jiquilisco ist die größte Mündung in El Salvador und bietet eine unvergleichliche Artenvielfalt an Wasservögeln."],
      hu: ["Kapu az ország legnagyobb mangrove-ökoszisztémájához.", "Az UNESCO Bioszféra-rezervátum része.", "Kritikus fészkelőhely a veszélyeztetett tengeri teknősök számára.", "A régió garnélarák-tenyésztésének központja."],
      ro: ["Rezervația din Golful Jiquilisco este cel mai mare ecosistem de mangrove din El Salvador.", "Este un sit Ramsar de importanță internațională pentru protecția zonelor umede și a păsărilor.", "Regiunea este centrul național al producției de creveți în ferme specializate de acvacultură.", "Reprezintă unul dintre puținele locuri din lume unde cuibărește țestoasa Eretmochelys imbricata."],
      en: ["Located in the Usulután Department.", "Elevation is close to sea level.", "Gateway to the Jiquilisco Bay Biosphere Reserve.", "Economy is dependent on fishing and aquaculture.", "Critical habitat for endangered hawksbill sea turtles.", "Emerging center for ecological tourism."]
    }
  },
  {
...
image: "/poi-images/berlin-sv-cities-v2.webp"
    ...
    description: { de: "Eine Stadt im Departement Usulután, bekannt für ihre Kaffeeplantagen und deutsche Einwanderer.", hu: "Város Usulután megyében, kávéültetvényeiről és német bevándorlóiról ismert.", ro: "Un oraș în departamentul Usulután, cunoscut pentru plantațiile de cafea și imigranții germani.", en: "A city in the Usulután department, known for its coffee plantations and German immigrants." },
    
    facts: {
      de: ["Gegründet von deutschen Einwanderern.", "Hochlandkaffee-Anbau.", "Kühles Bergklima.", "Geothermische Aktivität in der Nähe."],
      hu: ["Német bevándorlók alapították.", "Magaslati kávétermesztés.", "Hűvös hegyi éghajlat.", "Geotermikus tevékenység a közelben."],
      ro: ["Fondat de imigranți germani.", "Cultivarea cafelei la altitudine.", "Climă montană răcoroasă.", "Activitate geotermală în apropiere."],
      en: ["Founded by German immigrants.", "High-altitude coffee cultivation.", "Cool mountain climate.", "Geothermal activity nearby."]
    },
     image: "/poi-images/berlin-sv-cities-v2.webp",
    descriptionAdvanced: {
      de: "Berlín ist ein faszinierendes Bergdorf im Herzen der Sierra Tecapa-Chinameca. Gegründet von deutschen Einwanderern im späten 19. Jahrhundert, hat die Stadt ein einzigartiges Flair und ein kühleres Klima als die umliegenden Täler. Heute ist Berlín vor allem für seinen hochwertigen Hochlandkaffee und seine geothermische Aktivität bekannt, da es in unmittelbarer Nähe zu einem der größten Kraftwerke des Landes liegt, das die Energie der Vulkane nutzt.",
      hu: "Berlín egy lenyűgöző hegyi város a Sierra Tecapa-Chinameca szívében, amely különleges hangulatával tűnik ki. A 19. század végén német bevándorlók alapították, aminek köszönhetően klímája hűvösebb, építészete pedig egyedi a környező völgyekhez képest. Ma Berlín leginkább kiváló minőségű magaslati kávéjáról és geotermikus tevékenységéről ismert, mivel itt található az ország egyik legnagyobb erőműve. A város nevével alapítói szülőhazájuk fővárosa előtt tisztelegtek, megőrizve egy darabot az európai örökségből. A közelben található Alegría-lagúna smaragdzöld vize népszerű kirándulóhely az idelátogatók számára.",
      ...
      en: "Berlín is a picturesque city nestled in the mountains of the Usulután Department, known for its cool climate and historic coffee plantations. Founded in the late 19th century by a German settler, the city has a unique architectural and cultural history. Beyond coffee, Berlín has become a focal point for renewable energy due to the massive geothermal power plant located nearby, which harnesses the volcanic activity of the region to provide a significant portion of the country's electricity. The city is a fascinating blend of historical agricultural practices and cutting-edge renewable energy production."
    },
    factsAdvanced: {
...
image: "/poi-images/concepcion-batres-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/concepcion-batres-cities-v2.webp",
    descriptionAdvanced: {
      de: "Concepción Batres ist eine friedliche Landgemeinde im Herzen des Departements Usulután. Die Stadt lebt primär von der Landwirtschaft, wobei der Anbau von Grundnahrungsmitteln wie Mais und Bohnen das tägliche Leben bestimmt. Dank ihrer Lage in der fruchtbaren Küstenebene ist die Stadt ein wichtiger Produzent für lokale Märkte und bewahrt einen authentischen, entschleunigten Lebensstil abseits der großen urbanen Zentren.",
      hu: "Concepción Batres egy békés vidéki közösség Usulután megye szívében, ahol az élet ritmusát a földművelés határozza meg. A város lakói elsősorban mezőgazdaságból élnek, az alapvető élelmiszerek, mint a kukorica és a bab termesztése jelenti a mindennapok alapját. A termékeny tengerparti síkságon fekvő település fontos beszállítója a helyi piacoknak, megőrizve az autentikus, lassú életmódot a nagyvárosoktól távol. A környék látképét végtelen szántóföldek és kisebb erdőfoltok tarkítják, amelyek jellemzőek El Salvador keleti részére. A helyiek vendégszeretete és a hagyományos falusi ünnepek teszik igazán vonzóvá a közösséget.",
      ro: "Un mic oraș în departamentul Usulután. Comunitate rurală. Caracter agricol. Mod de viață tradițional. Aproape de orașul Usulután. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "Concepción Batres is a tranquil municipality located in the Usulután Department, characterized by its lush agricultural landscapes. Positioned along major transit routes in eastern El Salvador, the town relies heavily on farming, producing basic grains, sugarcane, and livestock. The area experiences a warm, tropical climate typical of the Salvadoran lowlands. The community is tight-knit, with traditional festivals playing a central role in social life. Concepción Batres offers a clear look into the everyday rural economy and the enduring traditional lifestyles of eastern El Salvador's agricultural communities."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    name: { de: "Jucuapa", hu: "Jucuapa", ro: "Jucuapa", en: "Jucuapa",
image: "/poi-images/jucuapa-cities-v2.webp"
},
    description: { de: "Eine Stadt im Departement Usulután, bekannt für ihren wöchentlichen Lebensmittelmarkt.", hu: "Város Usulután megyében, heti élelmiszerpiacáról ismert.", ro: "Un oraș în departamentul Usulután, cunoscut pentru piața sa alimentară săptămânală.", en: "A city in the Usulután department, known for its weekly food fair." },
    ...
    descriptionAdvanced: {
      ...
      en: "Jucuapa is a resilient municipality located in the Usulután Department, surrounded by the lush volcanic landscapes of eastern El Salvador. The city holds a poignant place in national history, having been almost entirely destroyed by a devastating earthquake in May 1951, which dramatically reshaped its urban layout and community structure. Historically, Jucuapa thrived on coffee cultivation due to the fertile soils of the neighboring Chinameca volcanic range. Today, the town balances its agricultural heritage with small-scale commerce. It serves as an essential case study in post-disaster recovery, seismic geography, and the enduring connection between agricultural communities and their volatile environments."
    },
    factsAdvanced: {
      de: ["Jucuapa wurde nach dem schweren Erdbeben von 1951 fast vollständig neu aufgebaut, was den starken Willen der Bevölkerung zeigt.", "Die Stadt ist ein wichtiger Produzent von Handwerkswaren in der östlichen Region El Salvadors.", "Das Klima hier ist dank der Nähe zur Sierra Tecapa-Chinameca angenehmer als in den tiefen Küstenebenen."],
      hu: ["Híres a \"Feria Gastronómica\" nevű ételfesztiváljáról.", "Fontos központ a kézműves iparban és a kereskedelemben.", "Többször épült újjá nagy erejű földrengések után.", "Kellemes mikroklímával rendelkezik a Sierra Tecapa lábánál."],
      ...
      en: ["Located in the Usulután Department.", "Elevation is roughly 520 meters.", "Severely impacted by the massive 1951 earthquake.", "Historically a major center for coffee cultivation.", "Situated near the Chinameca volcanic range."]
    }
  },
  {
...
image: "/poi-images/suchitoto-cities-v2.webp"
    ...
    description: { de: "Eine gut erhaltene Kolonialstadt am Ufer des Cerrón Grande Stausees.", hu: "Jól megőrzött gyarmati város a Cerrón Grande víztározó partján.", ro: "Un oraș colonial bine conservat pe malul lacului Cerrón Grande.", en: "A well-preserved colonial town on the shores of the Cerrón Grande Reservoir." },
    ...
    facts: {
      ...
      hu: ["Fontos kulturális központ.", "Macskaköves utcák és gyarmati építészet.", "Kilátás a Suchitlán-tóra.", "Hétvégi művészeti fesztiválok."],
      ro: ["Important centru cultural.", "Străzi pietruite și arhitectură colonială.", "Vedere la Lacul Suchitlán.", "Festivaluri de artă de weekend."],
      en: ["Major cultural center.", "Cobblestone streets and colonial architecture.", "Overlooks Lake Suchitlán.", "Weekend art festivals."]
    },
     image: "/poi-images/suchitoto-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Suchitoto is considered the cultural capital of the Cuscatlán Department, renowned for its impeccably preserved Spanish colonial architecture and cobblestone streets. Situated overlooking the expansive Lake Suchitlán, an artificial reservoir created by the Cerrón Grande dam, the city is a major hub for arts, culture, and tourism in El Salvador. Suchitoto's history dates back to pre-Columbian times, and it briefly served as the capital of the region in the early 16th century. It survived the civil war largely intact structurally and has since flourished as a center for feminist movements, artisanal crafts, and historical preservation, making it vital for cultural studies."
    },
    factsAdvanced: {
      de: ["Suchitoto war die erste offizielle Hauptstadt von San Salvador, bevor diese an ihren heutigen Standort verlegt wurde.", "Die Stadt ist weltweit bekannt für ihre Wiederbelebung der traditionellen Indigo-Färbetechnik ('Añil').", "Das 'Teatro de las Ruinas' ist ein kulturelles Wahrzeichen, das regelmäßig Konzerte und Kunstausstellungen beherbergt."],
      hu: ["El Salvador kulturális és koloniális ékköve.", "Itt volt az ország első hivatalos fővárosa.", "Világhírű a tradicionális indigo (indigofera) festési technikájáról.", "A gyönyörű Suchitlán-tóra (víztározóra) néző magaslaton fekszik."],
      ...
      en: ["Located in the Cuscatlán Department.", "Known for its preserved Spanish colonial architecture.", "Elevation is approximately 390 meters.", "Overlooks Lake Suchitlán, El Salvador's largest lake.", "Historically served as an early capital in 1528.", "Major center for local arts and cultural tourism."]
    }
  },
  {
...
image: "/poi-images/apaneca-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["El Salvador legmagasabban fekvő városa.", "A Ruta de las Flores része.", "Magaslati kávétermesztés.", "Népszerű a kalandturizmus (ziplining) körében."],
      ro: ["Cel mai înalt oraș din El Salvador.", "Parte a Rutei Florilor.", "Cultivarea cafelei la altitudine.", "Popular pentru turismul de aventură (tiroliană)."],
      en: ["Highest town in El Salvador by elevation.", "Part of the Ruta de las Flores.", "High-altitude coffee cultivation.", "Popular for adventure tourism (ziplining)."]
    },
     image: "/poi-images/apaneca-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Apaneca is a picturesque city in the Ahuachapán Department and holds the distinction of being the highest urban settlement in El Salvador. This extreme elevation provides a cool, mist-shrouded climate that is perfectly suited for cultivating some of the highest-quality coffee beans in the world. As a key destination on the famous 'Ruta de las Flores' (Route of Flowers), Apaneca attracts visitors with its colorful street art, adventure tourism, and deep-rooted indigenous heritage. The city's unique microclimate and volcanic topography make it an outstanding subject for studying high-altitude agriculture, ecotourism, and the preservation of highland cultural identity."
    },
    factsAdvanced: {
      de: ["Die Region um Apaneca produziert preisgekrönten Kaffee, der regelmäßig bei internationalen Wettbewerben glänzt.", "Der Name Apaneca bedeutet in Nahuatl 'Fluss des Windes', was auf die oft stürmischen Böen in den Bergen hinweist.", "In der Stadt befindet sich die Kirche San Andrés Apóstol, eine der ältesten und charmantesten in der Region."],
      hu: ["El Salvador legmagasabban fekvő települése.", "A népszerű \"Ruta de las Flores\" turisztikai útvonal állomása.", "Világhírű, díjnyertes magaslati kávék termőhelye.", "Itt található a misztikus Laguna de las Ninfas és a Laguna Verde."],
      ...
      en: ["Located in the Ahuachapán Department.", "Highest city in El Salvador at 1,455 meters.", "A key stop on the 'Ruta de las Flores'.", "Renowned for producing premium high-altitude coffee.", "Known for its cool climate and frequent mists.", "Surrounded by the Apaneca-Ilamatepec mountain range."]
    }
  },
  {
    id: "ataco-cities-v2",
...
image: "/poi-images/ataco-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Híres élénk falfestményeiről.", "Macskaköves utcák.", "Kávétúrák és kézművesség.", "A Ruta de las Flores része."],
      ro: ["Renumit pentru picturile murale vibrante.", "Străzi pietruite.", "Tururi de cafea și artizanat.", "Parte a Rutei Florilor."],
      en: ["Famous for vibrant murals.", "Cobblestone streets.", "Coffee tours and handicrafts.", "Part of the Ruta de las Flores."]
    },
     image: "/poi-images/ataco-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Concepción de Ataco is a vibrant, culturally rich municipality in the Ahuachapán Department, widely celebrated for its brightly painted murals that adorn almost every street corner. As a prominent highlight of the 'Ruta de las Flores', the town has successfully transitioned from a quiet coffee-producing village to a thriving center for cultural tourism and artisanal crafts. The local economy is driven by the sale of traditional textiles, gourmet coffee, and local gastronomy. Ataco's strong indigenous roots are still celebrated through annual festivals, notably the Day of the Cross. It offers excellent insights into how art and culture can revitalize a rural economy."
    },
    factsAdvanced: {
      de: ["Die Tradition der Wandmalereien begann als lokales Verschönerungsprojekt und hat sich zu einer weltweit bekannten Attraktion entwickelt.", "In Ataco kann man in alten Werkstätten den Webvorgang auf traditionellen Holzwebstühlen beobachten.", "Jedes Jahr im September feiert Ataco das 'Festival de los Farolitos' mit Tausenden von bunten Laternen."],
      hu: ["Híres az egész várost díszítő lenyűgöző falfestményeiről.", "A tradicionális kézi szövés és textilgyártás központja.", "Macskaköves utcái és színes házai miatt az ország egyik legszebb faluja.", "Kiemelkedő kávékultúrával és kézműves boltokkal rendelkezik."],
      ...
      en: ["Located in the Ahuachapán Department.", "Elevation is approximately 1,270 meters.", "Famous for its vibrant, street-covering murals.", "Major destination on the 'Ruta de las Flores'.", "Known for its traditional textile and craft industries.", "Hosts the famous 'Día de los Farolitos' festival."]
    }
  },
  {
    id: "juayua-cities-v2",
...
image: "/poi-images/juayua-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Híres a hétvégi gasztronómiai fesztiválról.", "Vízesések a közelben (Chorros de la Calera).", "A Ruta de las Flores része.", "Kávétermesztés."],
      ro: ["Cunoscut pentru festivalul său gastronomic de weekend.", "Cascade în apropiere (Chorros de la Calera).", "Parte a Rutei Florilor.", "Cultivarea cafelei."],
      en: ["Known for its weekend food festival.", "Waterfalls nearby (Chorros de la Calera).", "Part of the Ruta de las Flores.", "Coffee cultivation."]
    },
     image: "/poi-images/juayua-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Juayúa is a dynamic city in the Sonsonate Department, celebrated nationally for its bustling weekend food festival that showcases traditional Salvadoran cuisine. Nestled along the 'Ruta de las Flores', the city is surrounded by lush coffee plantations and spectacular natural features, most notably the Los Chorros de la Calera waterfalls. Juayúa's history is marked by indigenous rebellions and its eventual integration into the colonial coffee economy. The city beautifully marries natural ecotourism with rich culinary traditions. Studying Juayúa provides valuable lessons on the economic impact of gastronomic tourism and the sustainable management of local natural resources."
    },
    factsAdvanced: {
      de: ["Die markante schwarze Kirche 'Cristo Negro de Juayúa' ist ein wichtiges religiöses Wahrzeichen im Stadtzentrum.", "Das Gastronomiefestival wurde in den 1990er Jahren gegründet, um den Tourismus in der Region nach dem Bürgerkrieg anzukurbeln.", "Die Stadt ist von einigen der besten Kaffeeplantagen des Landes umgeben, die hochwertige Arabica-Bohnen produzieren."],
      hu: ["Híres a minden hétvégén megrendezett nagyszabású gasztronómiai fesztiválról.", "Itt található a látványos \"Chorros de la Calera\" hét vízesés.", "Otthont ad a híres Fekete Krisztus (Cristo Negro) szobornak.", "A Virágok Útja egyik legnépszerűbb és legélénkebb települése."],
      ...
      en: ["Located in the Sonsonate Department.", "Elevation is roughly 1,040 meters.", "Famous for its weekly weekend gastronomic festival.", "Home to the Los Chorros de la Calera waterfalls.", "Key destination on the 'Ruta de las Flores'.", "Economy centers on coffee production and tourism."]
    }
  },
  {
...
image: "/poi-images/najuizalco-cities-v2.webp"
    ...
    description: { de: "Eine Stadt mit starkem indigenem Erbe, bekannt für ihre Korbflechterei und den Nachtmarkt.", hu: "Erős őslakos örökséggel rendelkező város, kosárfonásáról és éjszakai piacáról ismert.", ro: "Un oraș cu o puternică moștenire indigenă, cunoscut pentru împletiturile sale și piața de noapte.", en: "A town with a strong indigenous heritage, known for its basket weaving and night market." },
    ...
    facts: {
      ...
      hu: ["A pipil nép erős öröksége.", "Híres a kosárfonásról és a bútorokról.", "El Salvador egyetlen éjszakai piaca.", "Hagyományos kultúra."],
      ro: ["Moștenire puternică a poporului Pipil.", "Renumit pentru împletituri și mobilier.", "Singura piață de noapte din El Salvador.", "Cultură tradițională."],
      en: ["Strong heritage of the Pipil people.", "Famous for wicker weaving and furniture.", "Only night market in El Salvador.", "Traditional culture."]
    },
     image: "/poi-images/najuizalco-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Nahuizalco is a deeply historic municipality in the Sonsonate Department, recognized as one of the most important centers of indigenous culture in El Salvador. It is one of the few places where remnants of the Nahuat-Pipil language and traditions are still actively preserved and taught. As part of the 'Ruta de las Flores', Nahuizalco is famous for its artisanal wicker and wood furniture, which drives the local economy. The town features a unique night market illuminated entirely by candles and traditional lamps. It is an indispensable location for studying indigenous resilience, linguistic preservation, and artisanal economies in modern Central America."
    },
    factsAdvanced: {
      de: ["Nahuizalco ist Teil der 'Ruta de las Flores' und markiert den Beginn dieser berühmten Kulturroute.", "Das Wort Nahuizalco bedeutet in der indigenen Sprache 'Ort der vier Izalcos', was auf die Größe der ursprünglichen Siedlung hinweist.", "Viele lokale Handwerker nutzen nachhaltige Naturfasern wie Tule und Weide, um kunstvolle Gebrauchsgegenstände herzustellen."],
      hu: ["Az egyik utolsó bástyája az élő pipil indián kultúrának.", "El Salvador egyetlen tradicionális éjszakai piacának helyszíne.", "Világhírű a kosárfonásáról és nádbútorairól.", "A \"Ruta de las Flores\" turisztikai útvonal kapuja."],
      ...
      en: ["Located in the Sonsonate Department.", "Elevation is approximately 540 meters.", "Strong center for indigenous Nahuat-Pipil heritage.", "Famous for its wicker and wooden furniture crafts.", "Features a unique traditional night market.", "Historically impacted by the 1932 indigenous uprising."]
    }
  },
  {
    ...
    name: { de: "Salcoatitán", hu: "Salcoatitán", ro: "Salcoatitán", en: "Salcoatitán",
image: "/poi-images/salcoatitan-cities-v2.webp"
},
    ...
    facts: {
      ...
      hu: ["Az első falu a Ruta de las Flores mentén.", "Kis gyarmati templom.", "Kávé- és jukka-termesztés.", "Csendes és festői környezet."],
      ro: ["Primul sat de pe Ruta Florilor.", "Biserică colonială mică.", "Cultivarea cafelei și a yucca.", "Mediu liniștit și pitoresc."],
      en: ["First village on the Ruta de las Flores.", "Small colonial church.", "Cultivation of coffee and yucca.", "Quiet and picturesque setting."]
    },
    descriptionAdvanced: {
      ...
      en: "Salcoatitán is a small but culturally significant town in the Sonsonate Department, often considered the starting point of the scenic 'Ruta de las Flores'. The town's name translates to 'the city of Quetzalcoatl' (the feathered serpent), indicating deep pre-Columbian roots. Today, Salcoatitán is renowned for its historic colonial church, its expansive coffee plantations, and its local culinary specialties, particularly dishes made from yucca. The town features a beautiful central plaza dominated by a massive, ancient ceiba tree. It provides a peaceful, authentic glimpse into rural Salvadoran life and the historical continuity of indigenous place-making."
    },
    factsAdvanced: {
      de: ["In Salcoatitán befindet sich das 'Mosaik-Projekt', bei dem Künstler die Wände der Stadt mit farbenfrohen Kachelmosaiken geschmückt haben.", "Der Name der Stadt bedeutet in Nahuatl 'Ort der gefiederten Schlange', was auf die Verehrung des Gottes Quetzalcoatl hinweist.", "Salcoatitán ist berühmt für seine Kunstgalerien, die Werke lokaler Talente aus dem Hochland präsentieren."],
      hu: ["A Virágok Útja első állomása Sonsonate felől érkezve.", "Híres a színes csempemozaikokkal díszített falairól.", "Gasztronómiai specialitása a tradicionális sült jukka (yuca frita).", "Nevének jelentése nahuatl nyelven: \"a tollas kígyó helye\"."],
      ...
      en: ["Located in the Sonsonate Department.", "Elevation is approximately 1,040 meters.", "Name translates to 'city of Quetzalcoatl'.", "Part of the 'Ruta de las Flores' tourist circuit.", "Known for its ancient ceiba tree in the central plaza.", "Economy is driven by coffee and yucca gastronomy."]
    }
  },
  {
...
image: "/poi-images/conchagua-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["A Conchagua vulkánnál található.", "Panorámás kilátás a Fonseca-öbölre.", "Az ország legrégebbi gyarmati temploma.", "Lenca őslakos gyökerek."],
      ro: ["Situat la vulcanul Conchagua.", "Vedere panoramică a Golfului Fonseca.", "Cea mai veche biserică colonială din țară.", "Rădăcini indigene Lenca."],
      en: ["Located at the Conchagua Volcano.", "Panoramic views of the Gulf of Fonseca.", "Oldest colonial church in the country.", "Indigenous Lenca roots."]
    },
     image: "/poi-images/conchagua-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Conchagua is a historic municipality situated at the base of the Conchagua volcano in the La Unión Department. The town is famous for possessing what is considered the oldest surviving colonial church in El Salvador, the Iglesia de Santiago Apóstol, built in 1693. Overlooking the Gulf of Fonseca, Conchagua has a strategic maritime history and was frequently targeted by pirates during the colonial era. Today, the town is a quiet, culturally rich community that draws tourists to both its historical architecture and the scenic viewpoints of the nearby volcano. It is a premier site for studying 17th-century colonial architecture and coastal history."
    },
    factsAdvanced: {
      de: ["Die Kirche Santiago Apóstol in Conchagua ist das einzige Gebäude aus dem 17. Jahrhundert, das fast unverändert im ganzen Land steht.", "Vom Aussichtspunkt 'Espíritu de la Montaña' am Vulkan Conchagua hat man einen Blick auf El Salvador, Honduras und Nicaragua gleichzeitig.", "In der lokalen Gastronomie sind Meeresfrüchte aus dem Golf und traditionelle ländliche Gerichte gleichermaßen präsent."],
      hu: ["Itt található az ország legrégebbi (1693) koloniális temploma.", "A Conchagua-vulkán lábánál fekvő történelmi lenca település.", "Kilátópontjáról három ország területe is belátható egyszerre.", "Gazdag gasztronómiai kínálat az öböl friss tengeri ételeiből."],
      ...
      en: ["Located in the La Unión Department.", "Elevation is approximately 190 meters.", "Home to El Salvador's oldest surviving church (built 1693).", "Situated at the base of the Conchagua volcano.", "Overlooks the strategic Gulf of Fonseca.", "Historically fortified against pirate attacks."]
    }
  },
  {
...
image: "/poi-images/perquin-cities-v2.webp"
    ...
    description: { de: "Ein Bergdorf im Departement Morazán, das als Guerilla-Hauptstadt während des Bürgerkriegs bekannt ist.", hu: "Hegyi falu Morazán megyében, amely a polgárháború alatti gerilla fővárosként ismert.", ro: "Un sat montan în departamentul Morazán, cunoscut ca fiind capitala gherilei în timpul războiului civil.", en: "A mountain town in Morazán department, known as the guerrilla capital during the civil war." },
    ...
    descriptionAdvanced: {
      ...
      en: "Perquín is a mountainous town in the Morazán Department, widely known for its profound historical significance related to the Salvadoran Civil War. Located in a rugged, pine-forested region near the Honduran border, it served as the strategic headquarters for guerrilla forces during the 1980s conflict. Today, Perquín is a center for historical tourism, home to the Museum of the Revolution, which documents the war and the subsequent peace process. The surrounding area offers beautiful natural landscapes, promoting a burgeoning ecotourism industry. Perquín is an essential study area for modern conflict resolution, historical memory, and post-war economic transition."
    },
    factsAdvanced: {
      de: ["Das Museum der Revolution in Perquín zeigt Artefakte, Fotos und Geschichten aus den Jahren des Konflikts und wird von ehemaligen Kombattanten geführt.", "Die Umgebung von Perquín bietet wunderschöne Wanderwege zu natürlichen Pools und Aussichtspunkten über die Grenze nach Honduras.", "Das kühle Klima und die Höhenlage machen Perquín zu einem beliebten Ziel für Ökotourismus und Camping in El Salvador."],
      hu: ["A polgárháború idején a gerillaerők (FMLN) bázisa és központja volt.", "Itt található a rendkívül fontos Forradalom Múzeuma.", "Hűvös hegyi levegőjéről és fenyveseiről híres ökoturisztikai célpont.", "Közel fekszik a híres El Mozote emlékhelyhez."],
      ...
      en: ["Located in the Morazán Department.", "Elevation is approximately 1,200 meters.", "Served as a major guerrilla stronghold during the civil war.", "Home to the famous Museum of the Revolution.", "Situated near the border with Honduras.", "Surrounded by pine forests and rugged terrain."]
    }
  },
  {
...
image: "/poi-images/santa-rosa-lima-cities-v2.webp"
    ...
    description: { de: "Eine Handelsstadt im Departement La Unión, nahe der Grenze zu Honduras.", hu: "Kereskedelmi város La Unión megyében, közel a hondurasi határhoz.", ro: "Un oraș comercial în departamentul La Unión, aproape de granița cu Honduras.", en: "A commercial city in the La Unión department, near the border with Honduras." },
    
    facts: {
      de: ["Wichtiges Handelszentrum für den Osten.", "Grenzüberschreitender Handel mit Honduras.", "Bekannt für Käseproduktion.", "Heißes Klima."],
      hu: ["Kelet fontos kereskedelmi központja.", "Határokon átnyúló kereskedelem Hondurasszal.", "Sajtgyártásáról ismert.", "Forró éghajlat."],
      ro: ["Important centru comercial pentru est.", "Comerț transfrontalier cu Honduras.", "Cunoscut pentru producția de brânză.", "Climă caldă."],
      en: ["Important commercial center for the east.", "Cross-border trade with Honduras.", "Known for cheese production.", "Hot climate."]
    },
     image: "/poi-images/santa-rosa-lima-cities-v2.webp",
    descriptionAdvanced: {
      de: "Santa Rosa de Lima ist das pulsierende Handelszentrum im Nordosten El Salvadors und gilt als die Stadt, die niemals schläft. Aufgrund ihrer strategischen Lage nahe der Grenze zu Honduras ist sie ein Umschlagplatz für Waren aller Art und bekannt für ihren lebhaften Viehmarkt. Die Stadt ist ein Schmelztiegel der Kulturen und ein Motor für den grenzüberschreitenden Handel, der das wirtschaftliche Leben in diesem Teil des Landes dominiert.",
      hu: "Santa Rosa de Lima El Salvador északkeleti részének lüktető kereskedelmi szíve, amelyet gyakran a városként emlegetnek, amely sosem alszik. Strategiai elhelyezkedése a hondurasi határ közelében az áruk és az állatkereskedelem fontos csomópontjává tette. A város a kultúrák olvasztótégelye és a határokon átnyúló gazdaság motorja, amely meghatározza az ország ezen szegletének életét. Híres a tradicionális salvadori sajtok gyártásáról, amelyeket országszerte nagyra értékelnek minőségük miatt. Bár klímája forró, a lakók vállalkozó szelleme és a piacok állandó nyüzsgése élettel tölti meg az utcákat. Az itteni állatvásár az egyik legnagyobb az egész keleti régióban.",
      ro: "Un oraș comercial în departamentul La Unión, aproape de granița cu Honduras. Important centru comercial pentru est. Comerț transfrontalier cu Honduras. Cunoscut pentru producția de brânză. Climă caldă. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "Santa Rosa de Lima is a bustling commercial hub located in the La Unión Department, often referred to as the 'Capital of Commerce' in eastern El Salvador. Situated near the Honduran border, the city facilitates a massive volume of cross-border trade, particularly in textiles, livestock, and agricultural goods. Historically, the area was known for extensive gold mining operations, which spurred its initial economic development in the 19th century. Today, the city is characterized by its intense daily markets and warm climate. It serves as a prime example of a border economy and the historical transitions from mining to cross-border commerce."
    },
    factsAdvanced: {
...
image: "/poi-images/metapan-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Metapán is a major city in the Santa Ana Department, recognized for its dual identity as an industrial powerhouse and a gateway to pristine natural reserves. Historically, Metapán was a wealthy colonial mining town, focusing on iron and silver, which funded its magnificent colonial church, Iglesia de San Pedro. Today, the local economy is dominated by the extraction of limestone and the production of cement, making it a critical industrial center. Despite its industry, the city is adjacent to the Montecristo Cloud Forest National Park, a tri-national biosphere reserve. Metapán highlights the complex relationship between heavy industry and critical environmental conservation."
    },
    factsAdvanced: {
      de: ["Die Kirche La Parroquia de Metapán gilt als eines der reinsten Beispiele des lateinamerikanischen Barocks in El Salvador.", "Metapán dient als Tor zum Nationalpark Montecristo, wo sich das Dreiländereck mit Guatemala und Honduras befindet.", "Die Stadt hat eine lange Geschichte in der Bergbauindustrie, die bis in die spanische Kolonialzeit zurückreicht."],
      hu: ["A gyönyörű barokk \"La Parroquia\" templom otthona.", "Közép-Amerika cementgyártásának és mészkőbányászatának központja.", "A festői Güija-tó partján fekvő kereskedelmi csomópont.", "Kiindulópont a Montecristo felhőerdő-rezervátum felfedezéséhez."],
      ...
      en: ["Located in the Santa Ana Department.", "Elevation is roughly 470 meters.", "Major national center for limestone and cement production.", "Gateway to the Montecristo Cloud Forest National Park.", "Home to the colonial Iglesia de San Pedro.", "Historically important for colonial-era iron mining."]
    }
  },
  {
    id: "jocoro-cities-v2",
...
image: "/poi-images/jocoro-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Jocoro is a historic municipality situated in the Morazán Department, characterized by its traditional rural lifestyle and deep community roots. The town's origins stretch back to pre-Columbian times, with its name deriving from indigenous languages referencing local flora. Throughout its history, Jocoro has remained an agricultural community, focusing on the cultivation of maize, beans, and sorghum. Like much of Morazán, it experienced significant hardship during the civil war but has since stabilized, retaining a quiet, traditional charm. It provides a valuable perspective on the enduring nature of subsistence agriculture and rural traditions in eastern El Salvador."
    },
    factsAdvanced: {
      de: ["Jocoro ist bekannt für seine lebhaften Viehmärkte, auf denen Bauern aus der gesamten östlichen Region zusammenkommen.", "Die Stadt feiert jedes Jahr farbenfrohe Feste zu Ehren ihrer Schutzpatrone mit traditioneller Musik und Tanz.", "Die Lage an der Hauptstraße in den Nordosten macht Jocoro zu einem wichtigen Zwischenstopp für Reisende in Morazán."],
      hu: ["Vidéki mezőgazdasági közösség Morazán megyében.", "Híres az élénk állatvásárairól és helyi piacairól.", "Az élvonalbeli Jocoro F.C. labdarúgóklub otthona.", "Fontos megállóhely a San Francisco Goterába vezető úton."],
      ...
      en: ["Located in the Morazán Department.", "Elevation is roughly 230 meters.", "Economy is primarily based on subsistence agriculture.", "Name has indigenous roots related to local trees.", "Experienced significant impact during the civil war."]
    }
  },
  {
...
image: "/poi-images/corinto-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["A Gruta del Espíritu Santo közelében.", "Őslakos barlangfestmények.", "Vidéki, hegyvidéki terület.", "Közel a hondurasi határhoz."],
      ro: ["Aproape de Gruta del Espíritu Santo.", "Picturi rupestre indigene.", "Zonă rurală, muntoasă.", "Aproape de granița cu Honduras."],
      en: ["Near the Gruta del Espíritu Santo.", "Indigenous cave paintings.", "Rural, mountainous area.", "Near the border with Honduras."]
    },
     image: "/poi-images/corinto-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Corinto is a unique municipality in the Morazán Department, celebrated nationally for its unparalleled archaeological heritage. The town is most famous for the Gruta del Espíritu Santo (Holy Spirit Grotto), an expansive rock shelter adorned with hundreds of ancient pictographs and petoglyphs dating back thousands of years. This site provides critical insight into the pre-historic populations of Central America. Beyond its archaeological fame, Corinto is an agricultural community nestled in a mountainous, pine-covered region near the Honduran border. The town is essential for studying Mesoamerican archaeology and the protection of prehistoric cultural heritage in rural settings."
    },
    factsAdvanced: {
      de: ["Die Felsmalereien in Corinto gelten als die wichtigsten archäologischen Funde dieser Art in ganz El Salvador.", "Corinto liegt in einer der abgelegensten und authentischsten Bergregionen des Landes, nahe der honduranischen Grenze.", "Lokale Führer bieten Touren an, die sowohl die historische Bedeutung der Höhlen als auch die lokale Flora und Fauna erklären."],
      hu: ["Itt található a Gruta del Espíritu Santo, Közép-Amerika egyik legfontosabb sziklarajz-lelőhelye.", "Több ezer éves őskori barlangfestményeiről híres világszerte.", "Hegyvidéki terület a hondurasi határ közvetlen közelében.", "Kiemelkedő jelentőségű régészeti és kulturális központ."],
      ...
      en: ["Located in the Morazán Department.", "Elevation is approximately 820 meters.", "Home to the Gruta del Espíritu Santo rock art site.", "Features ancient pictographs dating back millennia.", "Economy relies on agriculture and forestry.", "Situated in a pine-forested mountainous region."]
    }
  },
  {
...
image: "/poi-images/el-carmen-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "El Carmen is a tranquil municipality located within the Cuscatlán Department, distinguished by its agricultural landscape and close-knit community. Positioned along key regional routes, the town serves as a local agricultural hub, primarily producing sugarcane, corn, and traditional artisan goods. The area reflects the classic rural Salvadoran experience, characterized by a slow pace of life and a strong adherence to Catholic religious festivals, particularly honoring the Virgen del Carmen. The town is an excellent example of the small-scale agricultural economies that form the backbone of the central Salvadoran departments."
    },
    factsAdvanced: {
      de: ["Die Stadt ist bekannt für die handwerkliche Herstellung von Produkten aus Zuckerrohr, wie zum Beispiel 'Panela'.", "El Carmen feiert jährlich farbenfrohe Stadtfeste, die den Zusammenhalt der ländlichen Gemeinschaft stärken.", "Die umliegende Landschaft bietet idyllische Ansichten der zentralen salvadorianischen Bergwelt."],
      hu: ["Hagyományos mezőgazdasági közösség Cuscatlán megyében.", "A kézműves panela (nádcukor-tömb) készítésének egyik központja.", "Kellemes dombvidéki környezet, gazdag cukornádültetvényekkel.", "Híres a barátságos és összetartó helyi közösségéről."],
      ...
      en: ["Located in the Cuscatlán Department.", "Elevation is roughly 700 meters.", "Economy centers on sugarcane and basic grains.", "Known for its strong traditional religious festivals.", "Functions as a rural agricultural hub."]
    }
  },
  {
...
image: "/poi-images/jujutla-cities-v2.webp"
    ...
    description: { de: "Eine Stadt im Departement Ahuachapán, nahe der Pazifikküste.", hu: "Város Ahuachapán megyében, a Csendes-óceán partjának közelében.", ro: "Un oraș în departamentul Ahuachapán, aproape de coasta Pacificului.", en: "A city in the Ahuachapán department, near the Pacific coast." },
    
    
    facts: {
      de: ["Landwirtschaftliche Produktion.", "Anbau von Getreide und Obst.", "Nähe zum Nationalpark El Imposible.", "Ländliche Umgebung."],
      hu: ["Mezőgazdasági termelés.", "Gabona- és gyümölcstermesztés.", "Közel az El Imposible Nemzeti Parkhoz.", "Vidéki környezet."],
      ro: ["Producție agricolă.", "Cultivarea cerealelor și a fructelor.", "Aproape de Parcul Național El Imposible.", "Mediu rural."],
      en: ["Agricultural production.", "Cultivation of grains and fruits.", "Near El Imposible National Park.", "Rural surroundings."]
    },
     image: "/poi-images/jujutla-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Jujutla is a sprawling, biodiverse municipality located in the Ahuachapán Department, stretching from the coastal plains up into the volcanic mountain ranges. It is most notable for encompassing large portions of El Imposible National Park, El Salvador's largest and most important protected natural area. This critical ecosystem supports endangered species such as the ocelot and the crested eagle. The local economy is split between lowland agriculture, including sugarcane, and upland coffee farming, alongside a growing ecotourism sector. Jujutla is a vital area for studying biodiversity conservation, ecological management, and sustainable tropical agriculture."
    },
    factsAdvanced: {
      de: ["Die Gemeinde Jujutla erstreckt sich von den kühlen Hochlandregionen bis hinunter zu den tropischen Stränden des Pazifiks.", "Jujutla ist bekannt für seine Agrarmessen, auf denen die Vielfalt der lokalen Produkte präsentiert wird.", "Die Region beherbergt eine außergewöhnliche Artenvielfalt, bedingt durch die verschiedenen Höhenlagen innerhalb der Gemeindegrenzen."],
      hu: ["Kapu az El Imposible Nemzeti Parkhoz és Barra de Santiago-hoz.", "Rendkívül változatos terület a hegyektől egészen az óceánpartig.", "Jelentős kávé-, gabona- és trópusi gyümölcstermesztő vidék.", "Gazdag ökoturisztikai lehetőségek és természeti kincsek."],
      ...
      en: ["Located in the Ahuachapán Department.", "Elevation ranges from sea level to over 1000 meters.", "Contains significant portions of El Imposible National Park.", "A critical refuge for endangered tropical wildlife.", "Economy includes sugarcane, coffee, and ecotourism.", "Name means 'place of the blue birds' in Nahuat."]
    }
  },
  {
...
image: "/poi-images/guaymango-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Guaymango is a predominantly rural municipality in the Ahuachapán Department, characterized by its rolling hills and extensive agricultural lands. The region is historically rooted in indigenous traditions, and its economy relies almost entirely on the cultivation of basic grains, coffee, and livestock farming. Guaymango provides a snapshot of the traditional agrarian lifestyle that has dominated western El Salvador for centuries. The town maintains strong community ties, often centered around local markets and religious patron saint festivals. It offers valuable insights into the dynamics of rural agrarian societies and their adaptations to changing economic realities."
    },
    factsAdvanced: {
      de: ["Der Name Guaymango bedeutet in der indigenen Sprache 'Ort des Wassers und der Frösche'.", "Die Stadt bewahrt legendenumwobene Traditionen, die seit Generationen mündlich überliefert werden.", "Guaymango ist bekannt für seine lebhaften Gemeinschaftsfeste, bei denen indigene und koloniale Bräuche verschmelzen."],
      hu: ["Mélyen gyökerező őslakos identitással rendelkező település.", "Nevének jelentése nahuatl nyelven: \"a víz és a békák helye\".", "A nahuatl nyelv és hagyományok egyik fontos történelmi bástyája.", "Híres a színes vallási és kulturális felvonulásairól."],
      ...
      en: ["Located in the Ahuachapán Department.", "Elevation is roughly 420 meters.", "Economy is heavily dependent on agriculture and livestock.", "Maintains a deeply traditional agrarian lifestyle.", "Features local markets and traditional religious festivals."]
    }
  },
  {
...
image: "/poi-images/san-julian-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "San Julián is an historically significant municipality in the Sonsonate Department, centrally located along El Salvador's famous 'Balsam Coast' route. For centuries, this region was the global center for the extraction of Balsam of Peru, a highly valued resin used in medicine and perfumes. The town's economy and culture were entirely shaped by this unique indigenous extraction process, which continues on a smaller scale today. Surrounded by lush, forested hills, San Julián also produces coffee and dairy. The town is a critical study site for historical ethnobotany, colonial trade goods, and specialized agricultural heritage."
    },
    factsAdvanced: {
      de: ["Der Balsam wird durch eine aufwendige Technik aus dem Baum Myroxylon balsamum gewonnen, die bereits von den indigenen Pipil angewendet wurde.", "San Julián feiert jedes Jahr das 'Balsam-Festival', um die Bedeutung dieses Naturprodukts für die Gemeinde zu würdigen.", "Die Stadt ist von wunderschönen Wäldern umgeben, die diese einzigartigen Balsambäume beherbergen."],
      hu: ["A világ legfontosabb perubalzsam-termelő központja.", "A Myroxylon balsamum fa nedvéből készülő balzsam hazája.", "Őrzi az ősi, pipil eredetű balzsamkinyerési technikákat.", "Itt rendezik meg az egyedülálló Balzsam-fesztivált."],
      ...
      en: ["Located in the Sonsonate Department.", "Elevation is roughly 520 meters.", "Historically the global center for Balsam of Peru extraction.", "Located along the historic 'Balsam Coast' route.", "Economy includes resin extraction, coffee, and dairy.", "Surrounded by dense, forested hillsides."]
    }
  },
  {
...
image: "/poi-images/san-pedro-masahuat-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "San Pedro Masahuat is a municipality located in the La Paz Department, situated near the banks of the mighty Jiboa River. This river heavily influences the local geography, providing vital water for agriculture but also posing historical flooding risks. The area is known for its fertile soils, supporting the cultivation of sugarcane, corn, and diverse fruit orchards. The town is deeply rooted in indigenous Pipil history, which is still reflected in local customs and language fragments. San Pedro Masahuat provides an interesting study of riverine agriculture, flood management, and the preservation of indigenous cultural fragments in the coastal plains."
    },
    factsAdvanced: {
      de: ["San Pedro Masahuat ist bekannt für seine traditionellen Tänze und Masken, die während der Stadtfeste präsentiert werden.", "Die fruchtbaren Böden der Umgebung ermöglichen den Anbau von hochwertigem Zuckerrohr und tropischen Früchten.", "Die Stadt dient als wichtiger administrativer und kommerzieller Knotenpunkt für die umliegenden ländlichen Weiler."],
      hu: ["Fontos mezőgazdasági és halászati központ La Paz megyében.", "Híres a tradicionális maszkos táncairól és népszokásairól.", "Stratégiai fekvés a hegyek és a tengerparti síkság között.", "Jelentős cukornád- és trópusi gyümölcstermesztő vidék."],
      ...
      en: ["Located in the La Paz Department.", "Elevation is approximately 200 meters.", "Situated near the historically significant Jiboa River.", "Economy is based on sugarcane and fruit cultivation.", "Maintains cultural ties to its indigenous Pipil roots."]
    }
  },
  {
...
image: "/poi-images/san-rafael-oriente-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Vidéki környezet.", "Mezőgazdasági jellegű.", "San Miguel város közelében.", "Nyugodt légkör."],
      ro: ["Mediu rural.", "Caracter agricol.", "Aproape de orașul San Miguel.", "Atmosferă liniștită."],
      en: ["Rural surroundings.", "Agricultural character.", "Near the city of San Miguel.", "Quiet atmosphere."]
    },
     image: "/poi-images/san-rafael-oriente-cities-v2.webp",
    descriptionAdvanced: {
      ...
      ro: "Un mic oraș în departamentul San Miguel. Mediu rural. Caracter agricol. Aproape de orașul San Miguel. Atmosferă liniștită. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "San Rafael Oriente is a municipality located in the San Miguel Department, characterized by its warm climate and agricultural plains. Positioned in the eastern part of the country, it relies heavily on the cultivation of sorghum, maize, and cattle ranching. The town experiences the intense heat typical of the San Miguel region, which dictates its agricultural rhythms. It is a traditional, tight-knit community where local commerce and remittances play a significant role in the economy. San Rafael Oriente is highly representative of the environmental and economic realities of the eastern Salvadoran dry corridor."
    },
    factsAdvanced: {
...
image: "/poi-images/concepcion-de-oriente-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Concepción de Oriente is an isolated but culturally distinct municipality in the La Unión Department, situated directly on the border with Honduras. Its remote location has fostered a unique border culture, where trade, family ties, and daily life freely cross the international boundary. The local terrain is mountainous and rugged, limiting large-scale agriculture but supporting cattle ranching and small-scale farming. Historically, the town was involved in border disputes that were eventually settled by international courts. It serves as a fascinating case study in borderland geography, cross-national social integration, and remote economic strategies."
    },
    factsAdvanced: {
      de: ["Die Stadt ist bekannt für ihre wunderschöne natürliche Umgebung mit sanften Hügeln und klaren Bächen.", "Concepción de Oriente feiert seine traditionellen Feste mit religiösen Prozessionen und ländlichen Jahrmärkten.", "Die Abgeschiedenheit der Stadt macht sie zu einem Ort, an dem alte salvadorianische Bräuche noch unverfälscht gelebt werden."],
      hu: ["El Salvador legészakkeletibb települése a hondurasi határon.", "Megőrizte érintetlen, tradicionális vidéki karakterét.", "Gazdasága a hagyományos állattartásra és földművelésre épül.", "Híres a festői dombjairól és háborítatlan nyugalmáról."],
      ...
      en: ["Located in the La Unión Department.", "Situated directly on the international border with Honduras.", "Elevation is approximately 400 meters.", "Economy is defined by cattle ranching and border trade.", "Historically involved in the 'Bolsones' border dispute.", "Features a rugged, mountainous landscape."]
    }
  },
  {
...
image: "/poi-images/santo-domingo-guzman-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Santo Domingo de Guzmán is a deeply historic municipality in the Sonsonate Department, revered as one of the last true strongholds of the indigenous Nahuat-Pipil language. The community has made significant, internationally recognized efforts to preserve and teach this endangered language to younger generations. The town is also famous for its distinct red clay pottery (alfarería), crafted without the use of a potter's wheel—a tradition passed down for centuries. Set within rolling hills, the local economy relies heavily on this artisanal production and subsistence farming. It is a critical location for linguistic anthropologists and scholars of indigenous cultural preservation."
    },
    factsAdvanced: {
      de: ["In der Stadt gibt es Initiativen, um die Nahuat-Sprache an die jüngeren Generationen weiterzugeben.", "Die handgefertigte Keramik von Santo Domingo de Guzmán wird landesweit für ihre Qualität und Schönheit geschätzt.", "Die nahegelegenen Wasserfälle 'El Escuco' sind ein beeindruckendes Naturziel für Besucher der Region."],
      hu: ["A nahuatl nyelv utolsó élő bástyáinak egyike az országban.", "Világhírű a tradicionális kézműves vörös kerámiáiról.", "Itt található a látványos \"El Escuco\" vízesés.", "Fontos kulturális központ az őslakos örökség megőrzésében."],
      ...
      en: ["Located in the Sonsonate Department.", "One of the last strongholds of the Nahuat language.", "Elevation is approximately 250 meters.", "Famous for traditional, hand-molded red clay pottery.", "Economy is driven by artisanal crafts and agriculture.", "A focal point for indigenous linguistic revitalization."]
    }
  },
  {
...
image: "/poi-images/panchimalco-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["A pipil nép erős öröksége.", "A legrégebbi fennmaradt gyarmati templom.", "Híres a virágok és pálmák ünnepéről.", "Kézművesség és textíliák."],
      ro: ["Moștenire puternică a poporului Pipil.", "Cea mai veche biserică colonială conservată.", "Renumit pentru Festivalul Florilor și Palmierilor.", "Artizanat și textile."],
      en: ["Strong heritage of the Pipil people.", "Oldest surviving colonial church.", "Famous for the Festival of Flowers and Palms.", "Handicrafts and textiles."]
    },
     image: "/poi-images/panchimalco-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Panchimalco is a culturally vibrant municipality situated just south of the capital in the San Salvador Department. Surrounded by the rugged 'Puerta del Diablo' (Devil's Door) rock formations, the town has maintained a surprisingly distinct indigenous identity despite its proximity to the metropolis. It is most famous for its stunning, centuries-old colonial church, Santa Cruz de Roma, and its spectacular 'Festival of the Palms' held every May. The town has long been a refuge for Salvadoran artists and writers inspired by its traditional aesthetics. Panchimalco offers a fascinating study of cultural persistence within the immediate orbit of a modern capital."
    },
    factsAdvanced: {
      de: ["Die Kirche Santa Cruz de Roma in Panchimalco hat über 200 Jahre lang zahlreiche Erdbeben überstanden.", "Panchimalco beherbergt eine aktive Gemeinschaft von Künstlern und Bildhauern, die die Traditionen des Ortes pflegen.", "Die 'Panas', die indigenen Frauen von Panchimalco, tragen noch heute stolz ihre traditionelle Tracht."],
      hu: ["Itt található az ország egyik legrégebbi (18. századi) temploma.", "Híres a látványos májusi \"Virágok és Pálmák Ünnepéről\".", "Az őslakos pipil (pana) kultúra egyik legfontosabb központja.", "Híres képzőművészeti galériáiról és kőfaragóiról."],
      ...
      en: ["Located in the San Salvador Department.", "Elevation is roughly 600 meters.", "Home to the colonial Santa Cruz de Roma church.", "Famous for the vibrant annual 'Festival of the Palms'.", "Situated near the 'Puerta del Diablo' rock formation.", "Maintains strong indigenous traditions near the capital."]
    }
  },
  {
...
image: "/poi-images/san-pedro-perulapan-cities-v2.webp"
    ...
    description: { de: "Eine historisch bedeutsame Stadt im Departement Cuscatlán.", hu: "Történelmileg jelentős város Cuscatlán megyében.", ro: "Un oraș important din punct de vedere istoric în departamentul Cuscatlán.", en: "A historically significant city in the Cuscatlán department." },
    ...
    facts: {
      ...
      hu: ["Egy 1885-ös fontos csata helyszíne.", "Mezőgazdasági központ.", "Panorámás kilátás az Ilopango-tóra.", "Hagyományos ünnepek."],
      ro: ["Locul unei bătălii importante din 1885.", "Centru agricol.", "Vedere panoramică a lacului Ilopango.", "Festivaluri tradiționale."],
      en: ["Site of an important battle in 1885.", "Agricultural center.", "Panoramic views of Lake Ilopango.", "Traditional festivals."]
    },
     image: "/poi-images/san-pedro-perulapan-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "San Pedro Perulapán is a municipality in the Cuscatlán Department with a profound historical legacy. It is best known as the site of the pivotal 1839 Battle of San Pedro Perulapán, where General Francisco Morazán decisively defeated an invading army from Honduras and Nicaragua, an event celebrated in Central American military history. Today, the town is characterized by its agricultural economy, focusing on basic grains, sugarcane, and livestock. It also features notable colonial-era architecture, including its central parish church. The town provides a compelling intersection of 19th-century military history and traditional Salvadoran agrarian life."
    },
    factsAdvanced: {
      de: ["In der Schlacht von San Pedro Perulapán im Jahr 1839 siegte Francisco Morazán über die Truppen von Honduras und Nicaragua.", "Die Stadt ist bekannt für ihre traditionellen Webereien und die Herstellung von handwerklichen Produkten.", "Das kühle Klima und die Aussichtspunkte machen San Pedro Perulapán zu einem beliebten Ausflugsziel für Wochenendtouristen."],
      hu: ["Az 1839-es történelmi perulapáni csata helyszíne.", "Panorámás kilátást nyújt az Ilopango-tóra és a vulkánokra.", "Hagyományos szövőművészetéről és kézműveseiről híres.", "Fontos mezőgazdasági központ Cuscatlán megyében."],
      ...
      en: ["Located in the Cuscatlán Department.", "Elevation is approximately 640 meters.", "Site of the famous 1839 Battle of San Pedro Perulapán.", "Economy centers on grain farming and sugarcane.", "Features historic colonial architectural remnants.", "Historically significant to Central American independence."]
    }
  },
  {
...
image: "/poi-images/chinameca-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      en: "Chinameca is an important agricultural and commercial center situated in the San Miguel Department, nestled at the base of the Chinameca volcano. The rich volcanic soil of the surrounding slopes has historically made this area highly productive for coffee cultivation, which remains a cornerstone of the local economy. The town features a warm climate typical of eastern El Salvador but benefits from the cooler breezes off the volcanic heights. Chinameca's history is intertwined with the boom-and-bust cycles of the global coffee market. It serves as an excellent example of volcanic agricultural dependency in Central America."
    },
    factsAdvanced: {
      de: ["Chinameca wurde mehrfach durch Erdbeben beschädigt, aber jedes Mal mit großem Eifer von seinen Bewohnern wieder aufgebaut.", "Der Vulkan Chinameca, auch Pacayal genannt, bietet hervorragende Möglichkeiten für Bergwanderungen und Naturbeobachtungen.", "Die Stadt ist bekannt für ihre traditionellen Süßigkeiten und Backwaren, die ein fester Bestandteil lokaler Märkte sind."],
      hu: ["A Chinameca-vulkán (Pacayal) lábánál fekvő kávétermesztő város.", "Híres a tradicionális édességeiről és péksüteményeiről.", "Fontos vallási központ, különösen a San Juan-ünnep idején.", "Többször épült újjá nagy erejű földrengések után."],
      ...
      en: ["Located in the San Miguel Department.", "Situated at the base of the Chinameca volcano.", "Elevation is roughly 580 meters.", "Economy is historically tied to coffee production.", "Known for its fertile, volcanic agricultural soils.", "Features a mix of hot lowland and cooler highland climates."]
    }
  },
  {
...
image: "/poi-images/ciudad-barrios-cities-v2.webp"
    ...
    description: { de: "Geburtsort des Heiligen Óscar Romero, im Departement San Miguel.", hu: "Szent Óscar Romero szülőhelye, San Miguel megyében.", ro: "Locul de naștere al Sfântului Óscar Romero, în departamentul San Miguel.", en: "Birthplace of Saint Óscar Romero, in the department of San Miguel." },
    
    
    facts: {
      de: ["Geburtsort von Óscar Romero.", "Wichtiger Wallfahrtsort.", "Anbau von Hochlandkaffee.", "Bergige Landschaft."],
      hu: ["Óscar Romero szülőhelye.", "Fontos zarándokhely.", "Magaslati kávétermesztés.", "Hegyvidéki táj."],
      ro: ["Locul de naștere al lui Óscar Romero.", "Important loc de pelerinaj.", "Cultivarea cafelei la altitudine.", "Peisaj montan."],
      en: ["Birthplace of Óscar Romero.", "Important pilgrimage site.", "High-altitude coffee cultivation.", "Mountainous landscape."]
    },
     image: "/poi-images/ciudad-barrios-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Ciudad Barrios is a mountainous municipality in the San Miguel Department, renowned internationally as the birthplace of Saint Óscar Romero, the martyred Archbishop of San Salvador. His childhood home and the local parish where he was baptized draw pilgrims from around the world, creating a localized religious tourism economy. Beyond its spiritual significance, Ciudad Barrios is an extremely productive coffee-growing region, benefiting from its high altitude and cool climate. The town's steep, winding streets reflect its rugged topography. It is a critical study area for 20th-century church history and the socio-economics of highland coffee."
    },
    factsAdvanced: {
      de: ["Das Geburtshaus von Oscar Romero ist heute ein Museum und ein Ort des stillen Gebets für Besucher.", "Die Stadt liegt auf einer beträchtlichen Höhe, was ihr eines der angenehmsten Klimata in der östlichen Region El Salvadors beschert.", "Die Kaffeeernte in Ciudad Barrios ist das wichtigste ökonomische Ereignis des Jahres und prägt den Lebensrhythmus der Gemeinde."],
      hu: ["Szent Oscar Romero, El Salvador védőszentjének szülőhelye.", "Világszerte ismert katolikus zarándokhely és múzeum.", "A keleti régió egyik legfontosabb magaslati kávétermelő vidéke.", "Hűvös hegyi klímájával tűnik ki San Miguel megyében."],
      ...
      en: ["Located in the mountainous San Miguel Department.", "Birthplace of Saint Óscar Romero (born 1917).", "Elevation is approximately 860 meters.", "A major center for high-altitude coffee cultivation.", "Draws international religious tourism.", "Features rugged, steep topographical city planning."]
    }
  },
  {
    ...
    parent: "SV-SM",
    coords: [-88.38, 13.6],
    name: { de: "Lolotique", hu: "Lolotique", ro: "Lolotique", en: "Lolotique",
image: "/poi-images/lolotique-cities-v2.webp"
},
    ...
    descriptionAdvanced: {
      ...
      en: "Lolotique is a traditional municipality located in the San Miguel Department, characterized by its deep historical roots and agricultural lifestyle. The town's name has indigenous origins, and it has served as a rural settlement since the colonial era. The local economy is largely based on subsistence agriculture, including the cultivation of corn, beans, and sorghum, alongside small-scale cattle ranching. The community is known for its strong adherence to Catholic traditions, heavily celebrating its patron saint festivals. Lolotique provides an unvarnished look at the enduring, quiet agrarian life that characterizes much of the eastern Salvadoran interior."
    },
    factsAdvanced: {
      de: ["Der Name Lolotique bedeutet in der Lenca-Sprache 'Hügel der Wachteln'.", "Die Stadt ist berühmt für die Figur der 'Gigantona', einer riesigen tanzenden Puppe, die bei Volksfesten auftritt.", "Die Bewohner von Lolotique sind bekannt für ihre Geschicklichkeit in der Herstellung traditioneller Textilien und Stickereien."],
      hu: ["Gazdag lenca indián kulturális örökséggel rendelkezik.", "Híres a \"La Gigantona\" nevű tradicionális óriásbábos ünnepéről.", "Nevének jelentése lenca nyelven: \"fürjek dombja\".", "Hagyományos textilművészetéről és hímzéseiről ismert falu."],
      ...
      en: ["Located in the San Miguel Department.", "Elevation is approximately 350 meters.", "Economy is focused on grain cultivation and cattle.", "Maintains a strong traditional, rural lifestyle.", "Features deep indigenous and colonial historical roots."]
    }
  },
  {
...
image: "/poi-images/el-sauce-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/el-sauce-cities-v2.webp",
    descriptionAdvanced: {
      de: "El Sauce ist eine friedliche und fleißige Gemeinde im Norden des Departements La Unión. Die Stadt liegt in einer Gegend mit sanften Hügeln und ist primär von der Viehzucht und dem Getreideanbau geprägt. Aufgrund ihrer Nähe zum Handelszentrum Santa Rosa de Lima herrscht in El Sauce eine dynamische wirtschaftliche Aktivität, während die Stadt gleichzeitig ihren Charakter als ruhige ländliche Gemeinde bewahrt hat.",
      hu: "El Sauce egy békés és szorgalmas közösség La Unión megye északi részén, egy szelíd dombokkal tarkított vidéken. A város élete elsősorban az állattenyésztés és a gabonatermesztés körül forog, megőrizve a hagyományos vidéki életmódot. Santa Rosa de Lima kereskedelmi központjának közelsége miatt El Sauce-ban is élénk gazdasági tevékenység zajlik, különösen a tejtermékek piacán. A város híres kiváló sajtjairól és egyéb kézműves tejtermékeiről, amelyek a környék legelőiről származnak. A helyiek vendégszeretete és a lovas versenyekkel tarkított falusi ünnepek az autentikus El Salvador élményét nyújtják az utazóknak.",
      ro: "O municipalitate în departamentul La Unión. Comunitate rurală. Creșterea animalelor și agricultură. Aproape de Santa Rosa de Lima. Mod de viață tradițional. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "El Sauce is a remote, borderland municipality located in the La Unión Department, situated adjacent to the Honduran frontier. The town's geography is rugged and mountainous, making large-scale agriculture difficult, so the local economy relies on cattle ranching, basic grain farming, and cross-border commerce. El Sauce has a history of border disputes, deeply affecting its development until international treaties finalized the boundaries. Today, it remains a quiet, tightly-knit community heavily reliant on remittances from family members abroad. It is an interesting study in the challenges of developing remote border communities in Central America."
    },
    factsAdvanced: {
...
image: "/poi-images/pasaquina-cities-v2.webp"
},
    ...
    descriptionAdvanced: {
      ...
      en: "Pasaquina is a vital border municipality in the La Unión Department, strategically positioned near the Amatillo border crossing into Honduras. Because of its location, the town is a major conduit for international freight, transport logistics, and cross-border commerce. The constant flow of trade heavily influences the local economy, creating a bustling, dynamic environment distinct from the surrounding rural agricultural zones. The town experiences a very hot, tropical climate typical of the Gulf of Fonseca region. Pasaquina is highly relevant for studying international trade logistics, border town economics, and Central American transport infrastructure."
    },
    factsAdvanced: {
      de: ["Der Grenzübergang El Amatillo in Pasaquina ist einer der wichtigsten und am stärksten frequentierten in der gesamten Region.", "Die Stadt ist ein bedeutendes Zentrum für den Viehhandel zwischen den Nachbarländern.", "Pasaquina beherbergt eine Vielzahl von Dienstleistungsbetrieben, die den internationalen Fernverkehr unterstützen."],
      hu: ["Itt található El Amatillo, az ország egyik legfontosabb határátkelője.", "Közép-Amerika nemzetközi áruforgalmának kulcsfontosságú pontja.", "Jelentős regionális állatvásárok és kereskedelmi események helyszíne.", "A keleti országrész multikulturális és forgalmas kereskedelmi városa."],
      ...
      en: ["Located in the La Unión Department.", "Key border town near the Amatillo crossing with Honduras.", "Elevation is roughly 50 meters.", "Economy is heavily driven by international freight and trade.", "Experiences a very hot, tropical savanna climate.", "Acts as a major logistics hub in eastern El Salvador."]
    }
  },
  {
...
image: "/poi-images/la-palma-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["A naiv művészet központja.", "Fernando Llort alapította.", "Színes, stilizált minták.", "Hűvös éghajlat és fenyőerdők."],
      ro: ["Centrul artei naive.", "Fondat de Fernando Llort.", "Designuri colorate, stilizate.", "Climă răcoroasă și păduri de pini."],
      en: ["Center of Naïf art.", "Founded by Fernando Llort.", "Colorful, stylized designs.", "Cool climate and pine forests."]
    },
     image: "/poi-images/la-palma-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "La Palma is a renowned artistic hub located high in the mountains of the Chalatenango Department, near the Honduran border. In the 1970s, Salvadoran artist Fernando Llort taught the local population a unique, colorful style of naive art painted on wood and copinol seeds, which transformed the town's economy. Today, cooperatives produce these iconic crafts, which are exported globally. Historically, La Palma also played a critical role in the peace process, hosting the first peace talks between the government and guerrilla forces in 1984. It is a premier example of art-driven economic revitalization and historical peace-building."
    },
    factsAdvanced: {
      de: ["Fernando Llort gründete hier die Handwerksschule 'La Semilla de Dios', die das wirtschaftliche Schicksal der Region veränderte.", "Die Stadt diente 1984 als Schauplatz für die ersten Friedensgespräche während des salvadorianischen Bürgerkriegs.", "La Palma ist ein beliebtes Ziel für Wanderer, die den nahegelegenen höchsten Berg des Landes, den Cerro El Pital, besteigen wollen."],
      hu: ["A Fernando Llort által alapított naiv művészeti stílus bölcsője.", "Világhírű a színes, stilizált falfestményeiről és kézműves termékeiről.", "Az 1984-es történelmi béketárgyalások fontos helyszíne.", "Kellemes hegyi klíma és fenyvesek környezetében fekszik."],
      ...
      en: ["Located in the Chalatenango Department.", "Elevation is roughly 1,050 meters.", "Famous for colorful naive art created by Fernando Llort.", "Economy is heavily driven by cooperative artisan crafts.", "Site of the first civil war peace talks in 1984.", "Features a cool, highland mountain climate."]
    }
  },
  {
    ...
    parent: "SV-CH",
    coords: [-89.3, 14.13],
    name: { de: "Nueva Concepción", hu: "Nueva Concepción", ro: "Nueva Concepción", en: "Nueva Concepción",
image: "/poi-images/nueva-concepcion-cities-v2.webp"
},
    description: { de: "Eine wichtige Handelsstadt im Departement Chalatenango.", hu: "Fontos kereskedelmi város Chalatenango megyében.", ro: "Un important oraș comercial în departamentul Chalatenango.", en: "An important commercial city in the Chalatenango department." },
    
    
    facts: {
      de: ["Handelszentrum für den Norden.", "Landwirtschaft und Viehzucht.", "Lage in einem Tal.", "Verbindung zu anderen nördlichen Städten."],
      hu: ["Észak kereskedelmi központja.", "Mezőgazdaság és állattenyésztés.", "Egy völgyben található.", "Kapcsolat más északi városokkal."],
      ro: ["Centru comercial pentru nord.", "Agricultură și creșterea animalelor.", "Situat într-o vale.", "Legătură cu alte orașe din nord."],
      en: ["Commercial center for the north.", "Agriculture and livestock.", "Located in a valley.", "Connection to other northern towns."]
    },
    descriptionAdvanced: {
      ...
      en: "Nueva Concepción is a major commercial and agricultural powerhouse in the Chalatenango Department. Unlike the department's mountainous northern towns, it is situated in a broad, fertile valley, making it highly productive for large-scale cattle ranching, dairy production, and sugarcane cultivation. The city's economic vitality makes it the de facto commercial capital of the region, drawing trade from surrounding rural areas. It also features significant modern infrastructure compared to its neighbors. Nueva Concepción offers a clear example of how favorable lowland topography can create a thriving agricultural and commercial center within a largely mountainous department."
    },
    factsAdvanced: {
      de: ["Die Stadt beherbergt einen der wichtigsten Wochenmärkte in der Region Chalatenango.", "Nueva Concepción ist bekannt für seine fortschrittlichen landwirtschaftlichen Techniken und seine Produktivität.", "Der Fluss Lempa fließt in der Nähe vorbei und bietet Ressourcen für die Bewässerung und die lokale Fischerei."],
      hu: ["Chalatenango megye egyik legfontosabb kereskedelmi és piaci városa.", "Az ország északi részének kiemelkedő állattenyésztési központja.", "A Lempa-folyó mentén fekvő termékeny mezőgazdasági völgyben található.", "Híres a technológiailag fejlett agráripari tevékenységéről."],
      ...
      en: ["Located in the Chalatenango Department.", "Elevation is approximately 330 meters.", "Major regional hub for cattle ranching and dairy.", "Situated in a broad, fertile agricultural valley.", "Acts as the primary commercial center for the department.", "Economy includes large-scale sugarcane cultivation."]
    }
  },
  {
...
image: "/poi-images/osicala-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Lenca kultúra és történelem.", "Vidéki, hegyvidéki terület.", "A Torola folyó közelében.", "Hagyományos életmód."],
      ro: ["Cultură și istorie lenca.", "Zonă rurală, muntoasă.", "Aproape de râul Torola.", "Mod de viață tradițional."],
      en: ["Lenca culture and history.", "Rural, mountainous area.", "Near the Torola River.", "Traditional way of life."]
    },
     image: "/poi-images/osicala-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Osicala is a historically significant municipality in the Morazán Department, characterized by its mountainous terrain and pine forests. During the Salvadoran Civil War, the region saw intense conflict, and Osicala served at various times as a strategic point. Today, the town has transitioned into a peaceful agricultural community, focusing on the cultivation of coffee, basic grains, and small-scale livestock. The local culture remains deeply traditional, with a strong sense of community resilience forged through historical hardship. It is a valuable location for studying post-conflict agrarian recovery and life in the rugged eastern highlands."
    },
    factsAdvanced: {
      de: ["Der Name Osicala bedeutet in der Lenca-Sprache 'Fluss der schimmernden Steine'.", "Die Stadt ist bekannt für ihre jährlichen Feste, bei denen traditionelle Lenca-Tänze aufgeführt werden.", "Die Umgebung von Osicala bietet beeindruckende Ausblicke auf die Berge des Nordens und den Fluss Torola."],
      hu: ["Ősi lenca indián gyökerekkel és gazdag történelemmel rendelkezik.", "Nevének jelentése lenca nyelven: \"a csillogó kövek folyója\".", "Hagyományos lenca táncairól és vallási ünnepeiről nevezetes.", "Festői kilátást nyújt az északi hegyvonulatokra és a Torola-folyóra."],
      ...
      en: ["Located in the Morazán Department.", "Elevation is approximately 630 meters.", "Surrounded by rugged terrain and pine forests.", "Heavily impacted during the 1980s civil conflict.", "Economy relies on coffee, grains, and livestock.", "Features strong, resilient rural community traditions."]
    }
  },
  {
    ...
    parent: "SV-MO",
    coords: [-88.23, 13.63],
    name: { de: "Guatajiagua", hu: "Guatajiagua", ro: "Guatajiagua", en: "Guatajiagua",
image: "/poi-images/guatajiagua-cities-v2.webp"
},
    ...
    facts: {
      ...
      hu: ["Híres a fekete kerámiáról.", "Lenca őslakos kézművesség.", "Egyedülálló égetési technika.", "Kulturális örökség."],
      ro: ["Renumit pentru ceramica neagră.", "Meșteșug indigen lenca.", "Tehnică unică de ardere.", "Patrimoniu cultural."],
      en: ["Famous for black pottery.", "Indigenous Lenca craft.", "Unique firing technique.", "Cultural heritage."]
    },
    descriptionAdvanced: {
      ...
      en: "Guatajiagua is a culturally rich municipality in the Morazán Department, famous nationwide for its unique 'barro negro' (black clay) pottery. The local artisans, predominantly women of Lenca indigenous descent, use traditional pre-Columbian techniques and a special local dye to achieve the distinct black finish. This craft is the lifeblood of the town's identity and a crucial part of its economy. Nestled in a valley surrounded by hills, the town also engages in subsistence agriculture. Guatajiagua is an indispensable study site for indigenous Lenca heritage, traditional artisanal economies, and cultural survival in modern El Salvador."
    },
    factsAdvanced: {
      de: ["Die schwarze Farbe der Keramik wird ohne chemische Glasuren erzielt, rein durch traditionelle Räucher- und Färbetechniken.", "In Guatajiagua gibt es zahlreiche Familienwerkstätten, in denen Besucher den Entstehungsprozess der Keramik miterleben können.", "Die Handwerkskunst von Guatajiagua wird regelmäßig in nationalen und internationalen Kunstausstellungen präsentiert."],
      hu: ["A tradicionális fekete kerámia (Cerámica Negra) világhírű hazája.", "Ősi lenca technikákat alkalmazó kézműves közösség.", "Egyedi, természetes alapanyagokon nyugvó égetési és festési eljárás.", "Morazán megye egyik legfontosabb kulturális és turisztikai kincse."],
      ...
      en: ["Located in the Morazán Department.", "Famous for unique 'barro negro' (black clay) pottery.", "Elevation is approximately 230 meters.", "Pottery techniques trace back to Lenca indigenous roots.", "Economy is heavily reliant on traditional artisan crafts.", "Maintains a strong matriarchal artisanal tradition."]
    }
  },
  {
...
image: "/poi-images/san-ignacio-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Népszerű hegyi turisztikai célpont.", "Hűvös éghajlat és természet.", "Közel a Cerro El Pital hegyhez.", "Hondurasi határ menti fekvés."],
      ro: ["Destinație populară pentru turism montan.", "Climă răcoroasă și natură.", "Aproape de Cerro El Pital.", "Apropierea de granița cu Honduras."],
      en: ["Popular destination for mountain tourism.", "Cool climate and nature.", "Near Cerro El Pital.", "Close to the Honduran border."]
    },
     image: "/poi-images/san-ignacio-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "San Ignacio is a breathtaking highland municipality in the Chalatenango Department, serving as the gateway to El Pital, the highest peak in El Salvador (2,730m). Because of its extreme elevation, the town experiences a uniquely cold climate, allowing for the cultivation of non-tropical crops like peaches, strawberries, and extensive vegetable farms. The local economy has recently seen a massive boom in ecotourism, with visitors flocking to the mountain lodges and pine forests. San Ignacio represents a stark climatic and agricultural contrast to the rest of the country, making it a fascinating geographic and ecological study area."
    },
    factsAdvanced: {
      de: ["San Ignacio ist ein führender Produzent von organischem Gemüse und Hochlandkaffee in El Salvador.", "Die Stadt beherbergt zahlreiche Kunstgalerien, die vom berühmten Stil des Künstlers Fernando Llort beeinflusst sind.", "Die Wanderungen in der Umgebung bieten Begegnungen mit einer einzigartigen Flora und Fauna, einschließlich seltener Orchideenarten."],
      hu: ["El Salvador hegyi turizmusának és ökoturizmusának központja.", "Kiindulópont az ország legmagasabb hegycsúcsához, a Cerro El Pitalhoz.", "Híres a hűvös klímájáról, a fenyőerdőkről és az organikus gazdálkodásról.", "Számos képzőművészeti galéria otthona, Fernando Llort stílusában."],
      ...
      en: ["Located in the Chalatenango Department.", "Gateway to El Pital, El Salvador's highest peak.", "Elevation is roughly 1,010 meters.", "Unique cold climate supports temperate crop agriculture.", "Major and rapidly growing center for highland ecotourism.", "Surrounded by dense cloud forests and pine woods."]
    }
  },
  {
...
image: "/poi-images/santiago-de-maria-cities-v2.webp"
    ...
    facts: {
      de: ["Wichtiges Zentrum für Kaffeeanbau.", "Hochlandkaffee.", "Lage in den Tecapa-Vulkanen.", "Schöne Landschaften."],
      hu: ["A kávétermesztés fontos központja.", "Magaslati kávé.", "A Tecapa-vulkánok területén található.", "Gyönyörű tájak."],
      ro: ["Important centru pentru cultivarea cafelei.", "Cafea de altitudine.", "Situat în vulcanii Tecapa.", "Peisaje frumoase."],
      en: ["Important center for coffee cultivation.", "High-altitude coffee.", "Located in the Tecapa volcanoes.", "Beautiful landscapes."]
    },
     image: "/poi-images/santiago-de-maria-cities-v2.webp",
    descriptionAdvanced: {
      ...
      ro: "Un oraș într-o regiune de cultivare a cafelei în departamentul Usulután. Important centru pentru cultivarea cafelei. Cafea de altitudine. Situat în vulcanii Tecapa. Peisaje frumoase. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "Santiago de María is an economically pivotal city in the Usulután Department, historically serving as the 'coffee capital' of eastern El Salvador. Nestled in a cool, mountainous region, it acts as the processing and commercial hub for the vast coffee plantations covering the surrounding volcanic slopes. The city's wealth during the late 19th and early 20th centuries is reflected in its grid layout and historic administrative buildings. Today, while diversifying its economy, coffee remains central to its identity. The city offers deep insights into the historical mechanics of the coffee oligarchy and highland agro-economics."
    },
    factsAdvanced: {
...
image: "/poi-images/alegria-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["A Laguna de Alegría otthona.", "Smaragdzöld krátertó.", "Dísznövénytermesztés.", "Hűvös és kellemes éghajlat."],
      ro: ["Gazda Lagunei de Alegría.", "Lac de crater verde-smarald.", "Cultivarea plantelor ornamentale.", "Climă răcoroasă și plăcută."],
      en: ["Home to the Laguna de Alegría.", "Emerald-green crater lake.", "Cultivation of ornamental plants.", "Cool and pleasant climate."]
    },
     image: "/poi-images/alegria-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Alegría is a highly celebrated tourist destination in the Usulután Department, famous for its picturesque town center and its spectacular emerald-green volcanic crater lake, the Laguna de Alegría. The town was the birthplace of Alberto Masferrer, one of El Salvador's most influential philosophers and writers, whose legacy is celebrated locally. The economy is heavily focused on ecotourism, ornamental plant nurseries, and coffee cultivation. The town is widely regarded as one of the safest and most beautiful in the country, offering a perfect case study in sustainable rural tourism, literary history, and volcanic geography."
    },
    factsAdvanced: {
      de: ["Die Laguna de Alegría verdankt ihre leuchtende Farbe dem hohen Schwefelgehalt in ihrem vulkanischen Wasser.", "Alegría ist landesweit für seine spezialisierten Baumschulen bekannt, die eine unglaubliche Vielfalt an exotischen Pflanzen produzieren.", "Vom Aussichtspunkt 'Mirador der hundert Stufen' hat man einen spektakulären Blick über das Tal des Flusses Lempa."],
      hu: ["Itt található a smaragdzöld Laguna de Alegría krátertó.", "Híres a hűvös klímájáról és az egzotikus növényeket nevelő kertészeteiről.", "A népszerű \"Mirador de las Cien Gradas\" (Száz lépcső kilátó) helyszíne.", "A Sierra Tecapa egyik legszebb és leglátogatottabb hegyi faluja."],
      ...
      en: ["Located in the Usulután Department.", "Famous for the emerald-colored Laguna de Alegría.", "Elevation is approximately 1,220 meters.", "Birthplace of prominent philosopher Alberto Masferrer.", "Major national destination for ecotourism and culture.", "Economy is supported by ornamental plant cultivation."]
    }
  },
  {
...
image: "/poi-images/san-juan-nonualco-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["A nonualco őslakosok történelmi régiója.", "Mezőgazdasági központ.", "Közel a Chichontepec vulkánhoz.", "Hagyományos kultúra."],
      ro: ["Regiunea istorică a indigenilor Nonualco.", "Centru agricol.", "Aproape de vulcanul Chichontepec.", "Cultură tradițională."],
      en: ["Historic region of the Nonualco indigenous people.", "Agricultural center.", "Near the Chichontepec volcano.", "Traditional culture."]
    },
     image: "/poi-images/san-juan-nonualco-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "San Juan Nonualco is a historically rich municipality in the La Paz Department, deeply associated with the indigenous Nonualco culture. The region is famous for the 1833 indigenous rebellion led by Anastasio Aquino, a seminal event in Salvadoran history representing resistance against post-colonial elite rule. Today, the town preserves its strong indigenous identity through unique religious syncretism, most notably the 'Día de la Cruz' and the dance of the 'Tigre y el Venado'. The local economy is based on agriculture, particularly sugarcane and fruit. The town is essential for studying indigenous resistance and syncretic cultural traditions."
    },
    factsAdvanced: {
      de: ["San Juan Nonualco feiert jedes Jahr das Fest des 'Señor de la Caridad' mit farbenfrohen Tänzen wie dem 'Tanz des Tigers und des Hirsches'.", "Die Stadt ist bekannt für ihre handgefertigte Keramik und die Textilherstellung, die uralte Motive nutzt.", "In der Umgebung wird hochwertiges Zuckerrohr angebaut, das eine wichtige Säule der lokalen Wirtschaft darstellt."],
      hu: ["A nonualco-i őslakos ellenállás egyik történelmi bástyája.", "Híres a tradicionális \"tigris és szarvas tánca\" népszokásáról.", "Fontos mezőgazdasági központ a Chichontepec-vulkán közelében.", "Gazdag kézműves hagyományokkal rendelkezik, különösen a kerámiaiparban."],
      ...
      en: ["Located in the La Paz Department.", "Elevation is approximately 200 meters.", "Deeply tied to the historic indigenous Nonualco culture.", "Site of Anastasio Aquino's 1833 indigenous rebellion.", "Famous for the traditional 'Tigre y el Venado' dance.", "Economy centers on agriculture, including sugarcane."]
    }
  },
  {
...
image: "/poi-images/tecoluca-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["A Lempa folyó mentén található.", "Mezőgazdasági termelés.", "Nagy, vidéki község.", "A polgárháború története."],
      ro: ["Situat pe râul Lempa.", "Producție agricolă.", "Municipalitate mare, rurală.", "Istoria războiului civil."],
      en: ["Located on the Lempa River.", "Agricultural production.", "Large, rural municipality.", "History related to the civil war."]
    },
     image: "/poi-images/tecoluca-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Tecoluca is a geographically diverse municipality in the San Vicente Department, stretching from the slopes of the Chinchontepec volcano down to the coastal plains. This vast area allows for diverse agriculture, ranging from high-altitude coffee to lowland sugarcane and cattle. The town is notable for the Tehuacán archaeological park, which features pre-Columbian ruins and ancient agricultural terraces. During the civil war, Tecoluca was heavily contested, leading to the creation of repopulated communities post-conflict. It provides a broad perspective on Salvadoran geography, pre-Columbian archaeology, and modern post-war community rebuilding."
    },
    factsAdvanced: {
      de: ["Tecoluca ist El Salvadors führender Produzent von Cashewnüssen (Marañón), die in die ganze Welt exportiert werden.", "In der Gemeinde befindet sich der Park 'El Playón', ein Gebiet mit interessanten Lavaformationen des Vulkans San Vicente.", "Die Bewohner von Tecoluca sind bekannt für ihr Engagement beim Schutz des lokalen Ökosystems entlang des Flusses Lempa."],
      hu: ["El Salvador első számú kesudió (marañón) termelő vidéke.", "A monumentális Lempa-folyó és a San Vicente-vulkán között fekszik.", "Híres az El Playón vulkáni kőzetparkról és természeti kincseiről.", "A fenntartható mezőgazdaság és a közösségi fejlődés mintaképe."],
      ...
      en: ["Located in the San Vicente Department.", "Elevation ranges drastically from coast to volcano.", "Home to the Tehuacán pre-Columbian archaeological park.", "Economy spans coffee, sugarcane, and cattle ranching.", "Features post-war repopulated communities (e.g., Santa Marta).", "Lies at the base of the Chinchontepec volcano."]
    }
  },
  {
...
image: "/poi-images/santiago-texacuangos-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Panorámás kilátás az Ilopango-tóra.", "Őslakos eredetű.", "Fazekas hagyományok.", "San Salvador közelében."],
      ro: ["Vedere panoramică a lacului Ilopango.", "Origine indigenă.", "Tradiția olăritului.", "Aproape de San Salvador."],
      en: ["Panoramic views of Lake Ilopango.", "Indigenous origin.", "Pottery tradition.", "Near San Salvador."]
    },
     image: "/poi-images/santiago-texacuangos-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Santiago Texacuangos is a scenic municipality in the San Salvador Department, situated on the high ridges overlooking Lake Ilopango. Its strategic elevation provides a cool climate and spectacular panoramic views, making it a popular residential area away from the heat of the central capital. The local economy is a mix of agriculture, particularly fruit orchards and coffee, alongside a growing service sector supporting the metropolitan area. The town has deep indigenous roots, reflected in its name. It offers an excellent example of peri-urban development, where traditional agricultural communities adapt to an expanding metropolitan footprint."
    },
    factsAdvanced: {
      de: ["Der Name Texacuangos stammt aus der indigenen Sprache und bedeutet 'Ort der hohen steinernen Wälle'.", "Die Stadt ist ein beliebtes Ziel für Wanderer und Fotografen, die den perfekten Blick auf den Ilopango-See suchen.", "In der lokalen Gastronomie sind Gerichte aus frischem Fisch aus dem nahegelegenen See besonders beliebt."],
      hu: ["Lélegzetelállító panorámát nyújt az Ilopango-tóra.", "Nevének jelentése nahuatl nyelven: \"a magas kőfalak helye\".", "Fontos őslakos gyökerekkel és fazekas hagyományokkal rendelkezik.", "Népszerű hétvégi kirándulóhely a főváros közelsége miatt."],
      ...
      en: ["Located in the San Salvador Department.", "Elevation is approximately 700 meters.", "Overlooks the expansive volcanic Lake Ilopango.", "Functions as a peri-urban extension of the capital.", "Economy blends fruit orchards with urban services.", "Name has indigenous Nahuat roots."]
    }
  },
  {
    id: "tacuba-cities-v2",
...
image: "/poi-images/tacuba-cities-v2.webp"
    ...
    facts: {
      ...
      hu: ["Kapu az El Imposible Nemzeti Parkhoz.", "Gyarmati templom.", "Kávétermesztés a környéken.", "Hegyvidéki táj."],
      ro: ["Poarta de acces la Parcul Național El Imposible.", "Biserică colonială.", "Cultivarea cafelei în jur.", "Peisaj montan."],
      en: ["Gateway to El Imposible National Park.", "Colonial church.", "Coffee cultivation in the surroundings.", "Mountainous landscape."]
    },
     image: "/poi-images/tacuba-cities-v2.webp",
    descriptionAdvanced: {
      ...
      en: "Tacuba is a historic and geographically isolated municipality in the Ahuachapán Department, nestled near the border with Guatemala. The town is characterized by the dramatic ruins of its massive colonial-era church, which was destroyed by an earthquake in 1773 and left as a striking architectural monument. Tacuba also serves as a critical access point to El Imposible National Park, making it a hub for serious ecotourism and hiking. The region has strong indigenous roots and a painful history tied to the 1932 uprising. It is a vital location for studying colonial ruin preservation and ecological borderlands."
    },
    factsAdvanced: {
...
image: "/poi-images/el-paisnal-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/el-paisnal-cities-v2.webp",
    descriptionAdvanced: {
      de: "El Paisnal ist ein Ort von großer spiritueller und historischer Bedeutung im Norden des Departements San Salvador. Die Stadt erlangte internationale Bekanntheit als Geburts- und Wirkungsstätte von Pater Rutilio Grande, einem Pionier der sozialen Gerechtigkeit, dessen Leben und Tod Oscar Romero tief beeinflussten. Heute ist die friedliche ländliche Gemeinde ein Ziel für Pilger und Menschen, die sich für Menschenrechte und die Geschichte des Landes interessieren.",
      hu: "El Paisnal nagy spirituális és történelmi jelentőségű hely San Salvador megye északi részén. A város Rutilio Grande atya, a jezsuita vértanú szülő- és tevékenységi helyeként vált nemzetközileg ismertté, akinek élete és halála mélyen befolyásolta Oscar Romerót. Ma ez a békés vidéki közösség a zarándokok és az emberi jogok, valamint az ország történelme iránt érdeklődők fontos célpontja. A városi templomban található síremlék a látogatók központi emlékhelye. El Paisnal gazdasága főként a cukornádtermesztésre és a mezőgazdasági szolgáltatásokra épül, megőrizve a tradicionális salvadori falusi kultúrát a közösségre és a hitre fókuszálva.",
      ro: "Locul de naștere al părintelui Rutilio Grande, un martir iezuit. Locul de naștere al lui Rutilio Grande. Loc de pelerinaj. Comunitate rurală. Cultivarea trestiei de zahăr. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "El Paisnal is a municipality in the northern part of the San Salvador Department, widely recognized as the birthplace of Father Rutilio Grande, a Jesuit priest and close friend of Archbishop Óscar Romero. Grande's assassination in 1977 was a major catalyst for the Salvadoran Civil War, and his resting place in the town's church is a site of national historical importance. The surrounding landscape is primarily agricultural, focusing on sugarcane and livestock, supported by the Lempa River. El Paisnal is a critical site for studying liberation theology, the origins of the civil war, and agricultural river valley economics."
    },
    factsAdvanced: {
...
image: "/poi-images/san-luis-talpa-cities-v2.webp"
    ...
    description: { de: "Eine Gemeinde im Departement La Paz, nahe dem internationalen Flughafen.", hu: "Község La Paz megyében, a nemzetközi repülőtér közelében.", ro: "O municipalitate în departamentul La Paz, aproape de aeroportul internațional.", en: "A municipality in the department of La Paz, near the international airport." },
    
    facts: {
      de: ["Nähe zum internationalen Flughafen.", "Landwirtschaft und Fischerei.", "Flaches Küstengebiet.", "Wachsende Urbanisierung."],
      hu: ["A nemzetközi repülőtér közelében.", "Mezőgazdaság és halászat.", "Sík parti terület.", "Növekvő urbanizáció."],
      ro: ["Aproape de aeroportul internațional.", "Agricultură și pescuit.", "Zonă de coastă plată.", "Urbanizare în creștere."],
      en: ["Near the international airport.", "Agriculture and fishing.", "Flat coastal area.", "Growing urbanization."]
    },
     image: "/poi-images/san-luis-talpa-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Luis Talpa ist eine strategisch wichtige Gemeinde an der Küstenebene von La Paz, unmittelbar neben dem internationalen Flughafen El Salvadors gelegen. Diese Lage hat die Stadt zu einem dynamischen Zentrum für Logistik und Dienstleistungen gemacht, während sie gleichzeitig ihre landwirtschaftlichen Wurzeln bewahrt hat. Mit ihrer Nähe zu wunderschönen Stränden und Mangroven ist San Luis Talpa ein Ort, an dem modernes Reisen und traditionelle Küstenkultur aufeinandertreffen.",
      hu: "San Luis Talpa stratégiailag fontos közösség La Paz tengerparti síkságán, közvetlenül az ország nemzetközi repülőtere mellett. Ez az elhelyezkedés a várost a logisztika és a szolgáltatások dinamikus központjává tette, miközben sikerült megőriznie mezőgazdasági gyökereit is. A gyönyörű strandok és mangrove mocsarak közelsége miatt San Luis Talpa az a hely, ahol a modern utazás és a tradicionális partmenti kultúra találkozik. Számos logisztikai park és raktárbázis segíti itt az ország nemzetközi áruforgalmát. A város híres gasztronómiájáról is, amely friss tengeri gyümölcsöket kínál a közeli Csendes-óceánból az átutazók és a helyiek számára.",
      ro: "O municipalitate în departamentul La Paz, aproape de aeroportul internațional. Aproape de aeroportul internațional. Agricultură și pescuit. Zonă de coastă plată. Urbanizare în creștere. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "San Luis Talpa is a rapidly developing municipality in the La Paz Department, situated on the coastal plain. Its geography and economy are defined by its immediate proximity to El Salvador International Airport, the country's primary aviation hub. This location has spurred significant industrial and logistics development, transforming the town from a purely agricultural community into a critical component of the national transit infrastructure. Despite this modernization, the surrounding areas still support sugarcane cultivation and cattle ranching. The town represents the intersection of globalized transit networks with traditional coastal agriculture."
    },
    factsAdvanced: {
...
image: "/poi-images/chilanga-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un oraș în departamentul Morazán, cu moștenire lenca. Origine lenca. Comunitate rurală. Agricultură. Aproape de San Francisco Gotera. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "Chilanga is a quiet, historically indigenous municipality situated in the Morazán Department. Characterized by its rolling, pine-covered hills, the town offers a cool climate typical of the eastern highlands. Historically, Chilanga has strong roots in the Lenca culture, which is still reflected in local customs and fragmented traditions. The local economy relies predominantly on subsistence agriculture, including corn, beans, and small-scale coffee cultivation. The town was significantly affected during the civil war but has since returned to its peaceful agrarian roots. It provides a glimpse into the enduring rural indigenous legacy of the Morazán highlands."
    },
    factsAdvanced: {
...
image: "/poi-images/san-rafael-cedros-cities-v2.webp"
    ...
    description: { de: "Eine Stadt im Departement Cuscatlán, an der Panamericana gelegen.", hu: "Város Cuscatlán megyében, a Panamericana mentén.", ro: "Un oraș în departamentul Cuscatlán, situat pe autostrada Panamericană.", en: "A city in the Cuscatlán department, located on the Pan-American Highway." },
    
    facts: {
      de: ["Lage an der Panamericana.", "Handelsstopp für Reisende.", "Landwirtschaftliche Produkte.", "Ländliches Zentrum."],
      hu: ["A Panamericana mentén található.", "Kereskedelmi megálló az utazók számára.", "Mezőgazdasági termékek.", "Vidéki központ."],
      ro: ["Situat pe autostrada Panamericană.", "Popas comercial pentru călători.", "Produse agricole.", "Centru rural."],
      en: ["Located on the Pan-American Highway.", "Commercial stop for travelers.", "Agricultural products.", "Rural center."]
    },
     image: "/poi-images/san-rafael-cedros-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Rafael Cedros ist ein strategischer Knotenpunkt an der Panamericana, im Herzen des Departements Cuscatlán. Die Stadt hat sich als wichtiger Rastplatz für Reisende und Fernfahrer etabliert, die zwischen San Salvador und dem Osten des Landes verkehren. Neben dem Handel ist die Stadt von einer fruchtbaren Agrarzone umgeben, die für den Anbau von Getreide und die Produktion von handwerklichen Gütern bekannt ist.",
      hu: "San Rafael Cedros egy stratégiai csomópont a Panamericana autópálya mentén, Cuscatlán megye szívében. A város fontos pihenőhelyként vált ismertté az utazók és a távolsági sofőrök körében, akik San Salvador és az ország keleti része között közlekednek. A kereskedelem mellett a várost termékeny agrárzóna veszi körül, amely gabonatermesztéséről és kézműves termékeiről híres. Országszerte ismertek az autópálya melletti árusítóhelyei, ahol tradicionális salvadori harapnivalókat és friss gyümölcsöket kínálnak. San Rafael Cedros egyben fontos elágazási pont is az észak felé, Chalatenango irányába vezető utak számára.",
      ro: "Un oraș în departamentul Cuscatlán, situat pe autostrada Panamericană. Situat pe autostrada Panamericană. Popas comercial pentru călători. Produse agricole. Centru rural. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "San Rafael Cedros is a strategic municipality located in the Cuscatlán Department. Positioned directly along the Pan-American Highway, the town serves as a vital transit and commercial node connecting the capital, San Salvador, with the eastern regions of the country. This geographic advantage has fueled its growth as a hub for regional trade and services. The surrounding landscape consists of fertile valleys supporting sugarcane, coffee, and basic grains. San Rafael Cedros is an excellent example of how major transport infrastructure dictates urban growth and economic diversification in central El Salvador."
    },
    factsAdvanced: {
...
image: "/poi-images/san-sebastian-sv-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/san-sebastian-sv-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Sebastián ist das unbestrittene Zentrum der Textilkunst in El Salvador und bewahrt eine jahrhundertealte Webtradition. In der Stadt rattern fast überall die traditionellen Holzwebstühle, auf denen die berühmten bunten Hängematten, Tagesdecken und Stoffe handgefertigt werden. Ein Besuch in San Sebastián bietet die seltene Gelegenheit, dieses faszinierende Handwerk hautnah zu erleben, das von Generation zu Generation weitergegeben wurde und die Identität der Stadt prägt.",
      hu: "San Sebastián El Salvador textilvörösművészetének vitathatatlan központja, amely évszázados szövési hagyományokat őriz. A városban szinte mindenütt hallani a tradicionális fa szövőszékek kattogását, amelyeken a híres színes függőágyakat, ágytakarókat és egyéb textileket készítik kézzel. Egy látogatás San Sebastiánba ritka lehetőséget kínál e lenyűgöző mesterség közvetlen megismerésére, amely generációról generációra öröklődik és meghatározza a város identitását. A helyi függőágyak minőségükről és élénk színkombinációikról ismertek az egész országban és külföldön is. Évente megrendezik a Textil-fesztivált a helyi művészet és kultúra tiszteletére.",
      ro: "Un oraș cunoscut pentru producția sa de textile, în special hamace. Renumit pentru hamace și textile. Războaie de țesut tradiționale. Centru artizanal. Comunitate rurală. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "San Sebastián is a culturally significant municipality in the San Vicente Department, renowned nationally and internationally for its vibrant textile industry. The town is most famous for producing high-quality, brightly colored hammocks, blankets, and fabrics using traditional wooden handlooms. This artisanal craft is the primary economic engine of the community, involving hundreds of local families whose skills have been passed down for generations. Set within a warm, agricultural landscape, the town seamlessly blends its textile economy with small-scale farming. It is a premier location for studying traditional artisanal economies and Salvadoran cultural exports."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    parent: "SV-LI",
    coords: [-89.38, 13.56],
    name: { de: "Jicalapa", hu: "Jicalapa", ro: "Jicalapa", en: "Jicalapa",
image: "/poi-images/jicalapa-cities-v2.webp"
},
    ...
    facts: {
      de: ["Lage an der Balsam-Küste.", "Produktion von Balsam.", "Strände in der Nähe.", "Ländliche, ruhige Atmosphäre."],
      hu: ["A Balzsam-parton található.", "Balzsamtermelés.", "Strandok a közelben.", "Vidéki, nyugodt légkör."],
      ro: ["Situat pe Coasta Balsamului.", "Producția de balsam.", "Plaje în apropiere.", "Atmosferă rurală, liniștită."],
      en: ["Located on the Balsam Coast.", "Production of balsam.", "Beaches nearby.", "Rural, quiet atmosphere."]
    },
    descriptionAdvanced: {
      ...
      ro: "O municipalitate de coastă în departamentul La Libertad. Situat pe Coasta Balsamului. Producția de balsam. Plaje în apropiere. Atmosferă rurală, liniștită. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "Jicalapa is an isolated, rugged municipality in the La Libertad Department, perched high in the Balsam Coast mountain range overlooking the Pacific Ocean. Because of its steep topography and historical lack of infrastructure, the town has remained relatively undeveloped, preserving a deeply traditional way of life. The local economy is largely based on subsistence agriculture and the historic extraction of Balsam of Peru from the surrounding forests. The area is known for its spectacular coastal views and strong religious traditions, particularly the veneration of the Black Christ. Jicalapa is a fascinating study in geographic isolation and cultural preservation."
    },
    factsAdvanced: {
...
image: "/poi-images/tejutla-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un oraș în departamentul Chalatenango. Comunitate rurală. Agricultură și creșterea animalelor. Mediu montan. Festivaluri tradiționale. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "Tejutla is a historic municipality in the Chalatenango Department, boasting origins that predate the Spanish conquest. During the colonial era, it was an important administrative and commercial center for the northern region, serving as a hub for indigo production and cattle ranching. The town's colonial legacy is still visible in its central architecture and layout. Today, the economy remains largely agricultural, focusing on livestock and basic grains. Surrounded by a mountainous landscape, Tejutla is representative of the historical development and subsequent stabilization of the northern highland communities in El Salvador."
    },
    factsAdvanced: {
...
image: "/poi-images/cinquera-cities-v2.webp"
    ...
    description: { de: "Ein Dorf, das während des Bürgerkriegs zerstört und wieder aufgebaut wurde, heute ein Zentrum für Ökotourismus.", hu: "Falu, amelyet a polgárháború alatt elpusztítottak és újjáépítettek, ma az ökoturizmus központja.", ro: "Un sat distrus și reconstruit în timpul războiului civil, acum un centru de ecoturism.", en: "A village destroyed and rebuilt during the civil war, now a center for ecotourism." },
    
    facts: {
      de: ["Symbol des Wiederaufbaus nach dem Krieg.", "Ökotourismus und Gedenkstätten.", "Cinquera-Waldreservat.", "Starke Gemeinschaftsorganisation."],
      hu: ["A háború utáni újjáépítés szimbóluma.", "Ökoturizmus és emlékhelyek.", "Cinquera erdőrezervátum.", "Erős közösségi szervezet."],
      ro: ["Simbol al reconstrucției postbelice.", "Ecoturism și situri memoriale.", "Rezervația forestieră Cinquera.", "Organizație comunitară puternică."],
      en: ["Symbol of post-war reconstruction.", "Ecotourism and memorial sites.", "Cinquera Forest Reserve.", "Strong community organization."]
    },
     image: "/poi-images/cinquera-cities-v2.webp",
    descriptionAdvanced: {
      de: "Cinquera ist ein inspirierendes Symbol für ökologische Erholung und Versöhnung in El Salvador. Während des Bürgerkriegs fast vollständig entvölkert und zerstört, wurde das Dorf von seinen Bewohnern mit einer klaren Vision für Umweltschutz wieder aufgebaut. Heute ist Cinquera ein Modell für gemeindebasierten Ökotourismus und beherbergt einen beeindruckenden Waldpark, in dem Besucher über die Geschichte des Konflikts und den Schutz der Biodiversität lernen können.",
      hu: "Cinquera az ökológiai újjászületés és a megbékélés inspiráló szimbóluma El Salvadorban. A polgárháború alatt szinte teljesen elnéptelenedett és elpusztult falut lakói csodálatra méltó bátorsággal és a környezetvédelem iránti elkötelezettséggel építették újjá. Ma Cinquera a közösségi alapú ökoturizmus mintaképe, egy lenyűgöző erdőrezervátummal, ahol a látogatók a konfliktus történetéről és a biodiverzitás védelméről tanulhatnak. Az erdőparkot egykori harcosok vezetik, akik ma természetvédelmi őrként dolgoznak. A városban számos emlékhely található, amelyek az emigráció és a visszatérés éveinek történeteit mesélik el a következő generációknak.",
      ro: "Un sat distrus și reconstruit în timpul războiului civil, acum un centru de ecoturism. Simbol al reconstrucției postbelice. Ecoturism și situri memoriale. Rezervația forestieră Cinquera. Organizație comunitară puternică. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "Cinquera is a remarkable municipality in the Cabañas Department, celebrated as an international model for post-conflict ecological restoration. The town was entirely destroyed and abandoned during the Salvadoran Civil War due to heavy bombing. Upon returning in the 1990s, the community decided to protect the surrounding forest—which had naturally regenerated during their absence—creating the Cinquera Ecological Park. Today, the town's economy is increasingly supported by ecotourism and historical tours that combine war history with environmental education. Cinquera is a critical case study in resilience, historical memory, and community-led conservation."
    },
    factsAdvanced: {
...
image: "/poi-images/caluco-cities-v2.webp"
    ...
    description: { de: "Eine historische Stadt im Departement Sonsonate mit indigener Vergangenheit.", hu: "Történelmi város Sonsonate megyében, őslakos múlttal.", ro: "Un oraș istoric în departamentul Sonsonate, cu un trecut indigen.", en: "A historic city in the Sonsonate department with an indigenous past." },
    
    facts: {
      de: ["Historisches Pipil-Zentrum.", "Kirche aus dem 16. Jahrhundert.", "Bekannt für Suppen und traditionelle Gerichte.", "Ruhige, ländliche Atmosphäre."],
      hu: ["Történelmi pipil központ.", "16. századi templom.", "Híres a leveseiről és hagyományos ételeiről.", "Csendes, vidéki légkör."],
      ro: ["Centru istoric Pipil.", "Biserică din secolul al XVI-lea.", "Cunoscut pentru supe și mâncăruri tradiționale.", "Atmosferă rurală, liniștită."],
      en: ["Historic Pipil center.", "16th-century church.", "Known for soups and traditional dishes.", "Quiet, rural atmosphere."]
    },
     image: "/poi-images/caluco-cities-v2.webp",
    descriptionAdvanced: {
      de: "Caluco ist ein Ort, an dem die Geschichte der Pipil und die koloniale Ära in den Ruinen seiner prächtigen Architektur weiterleben. Einst ein Zentrum des Kakao-Booms im 16. Jahrhundert, beherbergt die Stadt die beeindruckenden Ruinen der Kirche San Esteban, die an den einstigen Reichtum der Region erinnern. Heute ist Caluco eine friedliche Gemeinde, die vor allem für ihre Thermalquellen und ihre authentische lokale Gastronomie, wie die berühmte Hühnersuppe, bekannt ist.",
      hu: "Caluco egy olyan hely, ahol a pipil indiánok történelme és a gyarmati korszak emlékei tovább élnek az impozáns romok és a helyi kultúra formájában. A 16. századi kakaó-boom egykori központjaként a város ma is büszkélkedhet a San Esteban templom romjaival, amelyek a régió egykori gazdagságára emlékeztetnek. Ma Caluco békés közösség, amely leginkább hévízforrásairól és autentikus helyi gasztronómiájáról, különösen a híres tyúkhúsleveséről ismert. A közeli vizesárok és termálfürdők népszerű célponttá teszik a családi kirándulások számára. Itt a látogatók egyszerre élvezhetik a történelmi felfedezéseket és a természet adta gyógyító kikapcsolódást.",
      ro: "Un oraș istoric în departamentul Sonsonate, cu un trecut indigen. Centru istoric Pipil. Biserică din secolul al XVI-lea. Cunoscut pentru supe și mâncăruri tradiționale. Atmosferă rurală, liniștită. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "Caluco is a historically profound municipality located in the Sonsonate Department. Before the Spanish arrival, it was a major center for the indigenous Pipil people and highly prized for its immense cacao production. During the colonial era, this wealth funded the construction of one of the region's most magnificent churches. Today, the dramatic brick ruins of this 16th-century church, destroyed by an earthquake in 1773, stand as a major local landmark. The town is also famous for its natural hot springs, which drive a local tourism economy. It is a vital site for studying colonial economics and architectural history."
    },
    factsAdvanced: {
...
image: "/poi-images/san-julian-nonualco-cities-v2.webp"
    ...
    description: { de: "Eine Stadt in der Region der Nonualcos.", hu: "Város a nonualco-i régióban.", ro: "Un oraș în regiunea Nonualcos.", en: "A city in the region of the Nonualcos." },
    
    facts: {
      de: ["Teil der Nonualco-Region.", "Landwirtschaftliche Produktion.", "Reiche indigene Geschichte.", "Traditionelle Feste."],
      hu: ["A nonualco-i régió része.", "Mezőgazdasági termelés.", "Gazdag őslakos történelem.", "Hagyományos ünnepek."],
      ro: ["Parte a regiunii Nonualco.", "Producție agricolă.", "Istorie indigenă bogată.", "Festivaluri tradiționale."],
      en: ["Part of the Nonualco region.", "Agricultural production.", "Rich indigenous history.", "Traditional festivals."]
    },
     image: "/poi-images/san-julian-nonualco-cities-v2.webp",
    descriptionAdvanced: {
      de: "Santiago Nonualco ist das Herzland der Nonualcos und untrennbar mit dem Namen Anastasio Aquino verbunden, der hier im 19. Jahrhundert den bedeutendsten indigenen Aufstand El Salvadors anführte. Die Stadt ist stolz auf ihr kämpferisches Erbe und ihre kulturelle Eigenständigkeit. Heute ist sie ein pulsierendes Zentrum für Landwirtschaft und Handwerk, in dem die Geschichte des Widerstands und die Traditionen der Vorfahren in den täglichen Bräuchen und Festen weiterleben.",
      hu: "Santiago Nonualco a nonualco indiánok szülőföldje, és neve elválaszthatatlan Anastasio Aquino alakjától, aki a 19. században itt vezette El Salvador legjelentősebb őslakos felkelését. A város büszke harcias örökségére és kulturális önállóságára, amire számos emlékmű és emlékhely emlékezteti az idelátogatókat. Ma a település a mezőgazdaság és a kézművesség lüktető központja, ahol az ellenállás története és az ősök hagyományai tovább élnek a mindennapi szokásokban. Különösen híres a textíliáiról és hímzéseiről, amelyek gyakran a régió szimbolikus motívumait hordozzák. A várost körülvevő termékeny földek kiváló minőségű kukoricát és egyéb alapvető élelmiszereket teremnek.",
      ro: "Un oraș în regiunea Nonualcos. Parte a regiunii Nonualco. Producție agricolă. Istorie indigenă bogată. Festivaluri tradiționale. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "San Pedro Nonualco, part of the broader Nonualco indigenous region in the La Paz Department, is deeply rooted in the historical culture of the Nonualco people. This region is famous for its fierce resistance against colonial and post-colonial rule, most notably the 1833 uprising of Anastasio Aquino. The area is characterized by its rolling hills and fertile soil, primarily used for cultivating fruit, particularly citrus, and basic grains. The community actively preserves its unique cultural heritage, visible in its distinct religious festivals and traditional dances. The region is indispensable for understanding the enduring legacy of El Salvador's indigenous populations."
    },
    factsAdvanced: {
...
image: "/poi-images/sacacoyo-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "Un mic oraș în departamentul La Libertad. Comunitate rurală. Cultivarea cerealelor și a cafelei. Atmosferă liniștită. Aproape de orașul Colón. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "Sacacoyo is a rapidly expanding municipality in the La Libertad Department, positioned within the fertile Zapotitán valley. Historically an agricultural town focused on coffee and basic grains, its proximity to the expanding San Salvador metropolitan area and major western highways has spurred recent residential and commercial development. Despite this growth, Sacacoyo retains much of its rural charm, with surrounding hills still dedicated to farming. The town's name has Nahuat origins relating to the local flora. It serves as an excellent example of the transition from traditional agriculture to peri-urban development in modern El Salvador."
    },
    factsAdvanced: {
...
image: "/poi-images/teotepeque-cities-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      ro: "O municipalitate în departamentul La Libertad, situată pe Coasta Balsamului. Parte a Coastei Balsamului. Comunitate rurală. Cultivarea balsamului și a cafelei. Aproape de Pacific. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "Teotepeque is a picturesque municipality in the La Libertad Department, dramatically situated in the coastal Balsam mountain range. The town overlooks the Pacific Ocean, though the terrain is highly mountainous and rugged. Its economy has historically been tied to the extraction of Balsam of Peru, alongside coffee and subsistence agriculture. Due to its challenging topography, Teotepeque has remained somewhat isolated, allowing it to preserve a quiet, traditional lifestyle. Its coastal proximity combined with high elevation gives it a unique microclimate, making it a fascinating area for geographic and agricultural study."
    },
    factsAdvanced: {
...
image: "/poi-images/san-antonio-pajonal-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/san-antonio-pajonal-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Antonio Pajonal ist eine ruhige Grenzgemeinde im Nordwesten El Salvadors, die direkt an Guatemala grenzt. Die Stadt dient als wichtiger, wenn auch kleinerer Übergangspunkt für den lokalen Handel und den Austausch zwischen den Gemeinden beider Länder. Das Leben hier ist geprägt von der Landwirtschaft, wobei die Bewohner stolz auf ihre fruchtbaren Felder sind und eine Lebensweise pflegen, die von der grenzüberschreitenden Zusammenarbeit geprägt ist.",
      hu: "San Antonio Pajonal egy nyugodt határmenti közösség El Salvador északnyugati részén, közvetlenül Guatemala szomszédságában. A város fontos, bár kisebb átkelőhelyként szolgál a helyi kereskedelem és a két ország közösségei közötti csereforgalom számára. Az életet itt a mezőgazdaság határozza meg, a lakók büszkék termékeny földjeikre és a határokon átnyúló együttműködésre alapozott életmódjukra. A város egy érdekes domborzati formákkal tarkított területen fekszik, ami különleges vonzerőt kölcsönöz a tájnak. San Antonio Pajonal vallási ünnepeit gyakran a határ túloldaláról érkező vendégekkel közösen ünneplik, erősítve a testvéri kapcsolatokat.",
      ro: "Un oraș de frontieră în departamentul Santa Ana, la granița cu Guatemala. Punct de trecere a frontierei \"La Hachadura\". Punct comercial important. Produse agricole. Comunitate rurală. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "San Antonio Pajonal is a small, remote border municipality in the Santa Ana Department. Tucked into the northwestern corner of the country, it shares a direct border with Guatemala. The local geography is relatively flat, and the economy is almost entirely dependent on agriculture, particularly the cultivation of corn, beans, and livestock farming, supplemented by cross-border trade. The town is known for its peaceful, slow-paced rural lifestyle, largely disconnected from the major urban centers. It provides a clear snapshot of life in El Salvador's remote, agrarian borderlands."
    },
    factsAdvanced: {
...
image: "/poi-images/el-coyolito-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/el-coyolito-cities-v2.webp",
    descriptionAdvanced: {
      de: "El Coyolito ist ein malerischer Kanton in der historischen Gemeinde Suchitoto, der für seine enge Verbindung zum Suchitlán-See bekannt ist. Diese ländliche Siedlung bietet einen authentischen Einblick in das Leben der salvadorianischen Bauern und Fischer. Die idyllische Lage in der Nähe des Wassers und der Blick auf die umliegenden Berge machen El Coyolito zu einem Ort der Ruhe und der natürlichen Schönheit, der oft von Besuchern Suchitotos für kurze Ausflüge genutzt wird.",
      hu: "El Coyolito egy festői kanton a történelmi Suchitoto községben, amely a Suchitlán-tóval való szoros kapcsolatáról ismert. Ez a vidéki település hiteles betekintést nyújt a salvadori parasztok és halászok életébe. Az idilli fekvés a víz közelében és a környező hegyekre nyíló kilátás az örök béke és a természetes szépség helyszínévé teszi El Coyolitót. A lakók kézműves halászatot folytatnak a tóban, ami fontos élelem- és bevételi forrás a közösség számára. A környéken található túraútvonalak, amelyek másodlagos erdőkön vezetnek keresztül, kiváló lehetőséget nyújtanak a madármegfigyelésre és a Cuscatlán régió ökoturizmusának felfedezésére.",
      ro: "Un canton în municipalitatea Suchitoto. Canton rural. Vedere la Lacul Suchitlán. Agricultură. Parte a municipalității Suchitoto. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "El Coyolito is a critical transit and commercial junction located in the Chalatenango Department. It is not an independent municipality but a highly significant urban center within Tejutla, functioning as the primary gateway to the northern half of the country. Situated near the Cerrón Grande hydroelectric dam and Lake Suchitlán, its geography is defined by its transit importance. The local economy is driven by logistics, transport services, and informal commerce serving travelers heading to Chalatenango. It is an excellent example of how highway infrastructure and regional geography create vital economic chokepoints."
    },
    factsAdvanced: {
...
image: "/poi-images/san-pablo-tacachico-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/san-pablo-tacachico-cities-v2.webp",
    descriptionAdvanced: {
      de: "San Pablo Tacachico ist eine bedeutende Agrargemeinde im Norden des Departements La Libertad, nahe dem Fluss Lempa gelegen. Die Stadt ist bekannt für ihre weiten Ebenen, die intensiv für die Viehzucht und den großflächigen Anbau von Zuckerrohr genutzt werden. Tacachico bewahrt einen authentischen Charakter als ländliches Versorgungszentrum und ist stolz auf seine traditionellen Feste, die die tiefe Verbundenheit der Bewohner mit ihrem Land widerspiegeln.",
      hu: "San Pablo Tacachico egy jelentős agrárközösség La Libertad megye északi részén, a Lempa-folyó közelében. A város tágas síkságairól ismert, amelyeket intenzíven használnak állattenyésztésre és nagyüzemi cukornádtermesztésre. Tacachico megőrizte hiteles karakterét mint vidéki ellátó központ, és büszke hagyományos fesztiváljaira, amelyek a lakók földhöz való mély kötődését tükrözik. A község területén több nagy hacienda is található, amelyek kulcsfontosságúak az ország hús- és tejtermelésében. A közeli Lempa-folyó horgászati lehetőségeket kínál, és fontos élőhelye számos vízimadárnak, gazdagítva a környék természeti értékét.",
      ro: "O municipalitate în departamentul La Libertad. Comunitate rurală. Cultivarea trestiei de zahăr și a cerealelor. Creșterea animalelor. Aproape de râul Lempa. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "San Pablo Tacachico is a dynamic agricultural municipality in the La Libertad Department, located in a broad, fertile valley. The region is highly productive, focusing heavily on large-scale cattle ranching, dairy production, and sugarcane cultivation. The Lempa River, El Salvador's largest river, borders the municipality, providing vital irrigation but also posing seasonal flood risks. The town is characterized by a hot, lowland climate. San Pablo Tacachico's robust agricultural output makes it a significant contributor to the national dairy and grain supply, representing the core of Salvadoran commercial farming."
    },
    factsAdvanced: {
...
image: "/poi-images/tenancingo-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/tenancingo-cities-v2.webp",
    descriptionAdvanced: {
      de: "Tenancingo ist ein Ort der Hoffnung und des Neuanfangs, der tief vom salvadorianischen Bürgerkrieg gezeichnet wurde. Nach fast vollständiger Entvölkerung kehrten die Bewohner nach dem Krieg zurück und bauten ihre Stadt mit bewundernswertem Mut wieder auf. Heute ist das friedliche Bergdorf im Departement Cuscatlán berühmt für seine handgefertigten Hüte und die traditionelle Weberei, was es zu einem Symbol für den kulturellen und sozialen Wiederaufbau El Salvadors macht.",
      hu: "Tenancingo a remény és az újrakezdés helyszíne, amelyet mélyen megjelölt a salvadori polgárháború emléke. Szinte teljes elnéptelenedés után a lakók a háború után bámulatos bátorsággal tértek vissza és építették újjá városukat. Ma ez a békés hegyi falu Cuscatlán megyében híres kézzel készített kalapjairól és tradicionális szövőművészetéről, ami El Salvador kulturális és társadalmi újjáépítésének szimbólumává tette. Tenancingót az 1980-as években demilitarizált övezetnek nyilvánították, hogy lehetővé tegyék a civil lakosság visszatérését. A lakók közösségi projekteket indítottak, hogy megőrizzék kézműves hagyományaikat és közös történelmüket.",
      ro: "Un oraș abandonat în timpul războiului civil și repopulat ulterior. Simbol al țării afectate de război. Repopulare de către foștii locuitori. Comunitate agricolă. Comunitate puternică. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate.",
      en: "Tenancingo is a historically rich municipality in the Cuscatlán Department, renowned nationwide for its artisanal production of high-quality palm hats. This traditional craft forms the backbone of the local economy and cultural identity. The town is nestled in a rugged, mountainous area, which historically made it a strategic and heavily contested location during the Salvadoran Civil War. It suffered severe damage and depopulation in 1983 but has since been rebuilt. Tenancingo is a profound case study in the resilience of artisanal traditions in the face of modern conflict and displacement."
    },
    factsAdvanced: {
...
image: "/poi-images/santa-clara-cities-v2.webp"
    ...
    facts: {
     ...
     image: "/poi-images/santa-clara-cities-v2.webp",
    descriptionAdvanced: {
      de: "Santa Clara ist eine charmante und ruhige Gemeinde im Departement San Vicente, die für ihren landwirtschaftlichen Fokus bekannt ist. Die Stadt liegt in einer malerischen Hügellandschaft, in der vor allem Getreide und Zuckerrohr angebaut werden. Santa Clara bewahrt eine friedliche ländliche Atmosphäre, in der traditionelle Feste und ein enger Gemeinschaftssinn den Takt des Lebens angeben, weit weg von der Hektik der großen urbanen Zentren.",
      hu: "Santa Clara egy bájos és nyugodt közösség San Vicente megyében, amely mezőgazdasági fókuszáról ismert. A város egy festői dombvidéken fekszik, ahol elsősorban gabonaféléket és cukornádat termesztenek a helyi piacokra. Santa Clara megőrizte békés vidéki atmoszféráját, ahol a hagyományos ünnepek és az erős közösségi szellem határozza meg az élet ütemét, távol a nagyvárosi központok nyüzsgésétől. A település büszke tradicionális építészetére, a kis házakra és a gondozott kertekre, amelyek barátságos képet festenek a városról. A környező természet kiválóan alkalmas pihentető sétákra és a közép-salvadori hegyvidék felfedezésére.",
      ro: "Un mic oraș în departamentul San Vicente. Comunitate rurală. Agricultură. Aproape de orașul San Vicente. Atmosferă liniștită. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "Santa Clara is a small, traditional municipality located in the San Vicente Department. Situated in the rolling hills of central El Salvador, the town is primarily agricultural, dedicated to the cultivation of basic grains, sugarcane, and small-scale livestock. The community is known for its strong Catholic traditions, centering social life around its historic church and annual patron saint festivals. The town has remained relatively untouched by large-scale industrialization, providing a peaceful representation of the enduring agrarian lifestyle that characterizes the central Salvadoran interior."
    },
    factsAdvanced: {
...
image: "/poi-images/san-alejo-cities-v2.webp"
},
    ...
    descriptionAdvanced: {
      ...
      ro: "Un oraș în departamentul La Unión. Comunitate rurală. Creșterea animalelor și agricultură. Aproape de vulcanul Conchagua. Mod de viață tradițional. Astfel, locul se numără printre punctele caracteristice ale republicii central-americane El Salvador, reflectând împletirea dintre coasta Pacificului, peisajele vulcanice, cultivarea cafelei și a trestiei de zahăr și reconstrucția de după războiul civil. Este situat în El Salvador, cel mai mic stat din America Centrală, la coasta Pacificului. Climat tropical, cu sezon ploios și sezon secetos bine conturate. Capitala San Salvador este centrul politic, economic și cultural al țării.",
      en: "San Alejo is a historic municipality in the La Unión Department, characterized by its warm climate and deep roots in the eastern Salvadoran culture. Historically, the area was significant for cattle ranching and indigo production during the colonial era. Today, the economy relies on livestock, basic agriculture, and significantly, remittances from a large diaspora community living abroad. The town is spread out over varied terrain, from plains to small hills, and features a distinctive colonial-style central plaza. San Alejo provides valuable insight into the modern economic reliance on migration in rural Central America."
    },
    factsAdvanced: {
