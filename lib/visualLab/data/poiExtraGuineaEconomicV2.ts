...
export const poiExtraGuineaEconomicV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      de: "Der Hafen von Kamsar ist der zentrale Knotenpunkt für die guineische Bauxitindustrie. Er liegt strategisch günstig am Rio Nuñez und dient primär als Endpunkt für die 136 km lange Sangarédi-Bahn, die das Erz direkt aus den Minen zum Exportterminal befördert. Diese logistische Verbindung ermöglicht es Guinea, seine Position als einer der weltweit führenden Exporteure von Bauxit, dem Rohstoff für Aluminium, zu festigen. Geographie K5  —  Küstenregionen und Wirtschaft.",
      hu: "Kamsar kikötője a guineai bauxitipar központi csomópontja. Stratégiailag kedvező helyen, a Rio Nuñez folyónál fekszik, és elsősorban a 136 km hosszú Sangarédi-vasút végállomásaként szolgál, amely közvetlenül a bányákból szállítja az ércet az exportterminálba. Ez a logisztikai összeköttetés lehetővé teszi Guinea számára, hogy megszilárdítsa pozícióját a világ egyik vezető bauxitexportőreként, amely az alumínium alapanyaga. Földrajz K5  —  Partvidékek és gazdaság.",
      ro: "Portul Kamsar este nodul central pentru industria bauxitei din Guineea. Situat strategic pe râul Rio Nuñez, servește în principal ca stație terminus pentru calea ferată Sangarédi de 136 km, care transportă minereul direct de la mine la terminalul de export. Această conexiune logistică permite Guineei să-și consolideze poziția ca unul dintre cei mai importanți exportatori mondiali de bauxită, materia primă pentru aluminiu. Geografie K5  —  Regiuni de coastă și economie.",
      en: "The Port of Kamsar is the central hub for the Guinean bauxite industry. Strategically located on the Rio Nuñez, it primarily serves as the terminus for the 136 km long Sangarédi railway, which transports ore directly from the mines to the export terminal. This logistical link enables Guinea to solidify its position as one of the world's leading exporters of bauxite, the raw material for aluminum. Geography K5  —  Coastal regions and economy."
    },
    factsAdvanced: {
