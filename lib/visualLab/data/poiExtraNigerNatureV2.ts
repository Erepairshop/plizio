...
export const poiExtraNigerNatureV2: POI[] = [
  {
    ...
    facts: {
      ...
      hu: ["A Guineai-felföldön ered.", "Keresztezi Niger délnyugati részét.", "Kialakítja a híres Niger-belsődeltát.", "Termékeny talajt biztosít a partjain."],
      ro: ["Izvorăște din munții Guineei.", "Traversează sud-vestul Nigerului.", "Formează faimoasa deltă interioară a Nigerului.", "Asigură soluri fertile pe malurile sale."],
      en: ["Originates in the Guinea Highlands.", "Flows through southwestern Niger.", "Forms the famous Niger Inland Delta.", "Provides fertile soil along its banks."]
    }
  },
  {
    id: "tschadsee-nature-v2",
    type: "lake",
    parent: "NE-05",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["Nagyon száraz terep.", "Csak gyér növényzet.", "Fontos legelőterületek a nomádok számára.", "Geológiailag egy régi üledékes medence."],
      ro: ["Teren foarte uscat.", "Vegetație rară.", "Zone importante de pășunat pentru nomazi.", "Din punct de vedere geologic, un bazin sedimentar vechi."],
      en: ["Very dry terrain.", "Only sparse vegetation.", "Important grazing areas for nomads.", "Geologically an old sedimentary basin."]
    }
  }
];
