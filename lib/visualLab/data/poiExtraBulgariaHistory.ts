...
export const poiExtraBulgariaHistory: POI[] = [
  {
    ...
    description: {
      ...
      es: "Monasterio ortodoxo búlgaro del siglo X protegido por la UNESCO.",
      pt: "Mosteiro ortodoxo búlgaro do século X protegido pela UNESCO.",
      fr: "Monastère orthodoxe bulgare du Xe siècle protégé par l'UNESCO.",
    },
    facts: {
      ...
      es: ["Patrimonio de la Humanidad UNESCO", "Fundado en el siglo X", "Importante centro ortodoxo"],
      pt: ["Património Mundial da UNESCO", "Fundado no século X", "Importante centro ortodoxo"],
      fr: ["Patrimoine mondial de l'UNESCO", "Fondé au Xe siècle", "Centre orthodoxe majeur"],
    },
    descriptionAdvanced: {
      ...
      ro: "Manastirea Rila, ascunsa adânc în Munții Rila, este cea mai mare ?i cea mai cunoscuta manastire ortodoxa din Bulgaria. Întemeiata în secolul al X-lea de pustnicul Sfântul Ioan de Rila, este de peste un mileniu un far spiritual ?i cultural al poporului bulgar. Complexul manastiresc este o capodopera a arhitecturii din perioada Rena?terii bulgare, cu arcade impresionante în dungi alb-negru, sculpturi delicate în lemn ?i fresce vii care acopera atât pere?ii exteriori, cât ?i pe cei interiori. Inclusa în Patrimoniul Mondial UNESCO, manastirea ramâne un simbol al identitații bulgare ?i al rezisten?ei spirituale în perioadele de stapânire straina. Sunt deosebit de impresionante Biserica Principala a Na?terii Maicii Domnului, cu unul dintre cele mai frumoase iconostase din Balcani, ?i Turnul lui Hreljo, cea mai veche cladire a complexului. Liniștea muntelui ?i atmosfera profund spirituala fac din Manastirea Rila un loc esențial de pelerinaj ?i o destinație culturala de top.",
      ...
      es: "El monasterio de Rila, situado en las profundidades de las montañas de Rila, es el monasterio ortodoxo oriental más grande y famoso de Bulgaria. Fundado en el siglo X por el ermitaño Iván de Rila, ha sido un faro espiritual y cultural para el pueblo búlgaro durante más de mil años. El complejo monástico es una obra maestra de la arquitectura del Renacimiento búlgaro, con impresionantes arcadas a rayas blancas y negras, tallas de madera intrincadas y frescos coloridos que cubren las paredes exteriores e interiores. Como Patrimonio de la Humanidad de la UNESCO, el monasterio encarna hasta hoy la identidad búlgara y la resistencia espiritual en tiempos de dominación extranjera. Especialmente impresionantes son la iglesia principal de la Natividad con uno de los iconostasios más bellos de los Balcanes y la torre Hreljo, el edificio más antiguo conservado del complejo. Su tranquila ubicación en la montaña y su profunda atmósfera espiritual hacen del monasterio de Rila un destino cultural y de peregrinación indispensable.",
      pt: "O mosteiro de Rila, situado nas profundezas das montanhas de Rila, é o mosteiro ortodoxo oriental maior e mais famoso da Bulgária. Fundado no século X pelo eremita João de Rila, tem sido um farol espiritual e cultural para o povo búlgaro durante mais de mil anos. O complexo monástico é uma obra-prima da arquitetura do Renascimento búlgaro, com impressionantes arcadas às riscas pretas e brancas, entalhes em madeira intrincados e frescos coloridos que cobrem as paredes exteriores e interiores. Como Património Mundial da UNESCO, o mosteiro encarna até hoje a identidade búlgara e a resistência espiritual em tempos de dominação estrangeira. Especialmente impressionantes são a igreja principal da Natividade, com uma das iconostases mais belas dos Balcãs, e a torre Hreljo, o edifício mais antigo preservado do complexo. A sua tranquila localização na montanha e a profunda atmosfera espiritual tornam o mosteiro de Rila um destino cultural e de peregrinação indispensável.",
      fr: "Le monastère de Rila, niché au cœur des montagnes de Rila, est le plus grand et le plus célèbre monastère orthodoxe de Bulgarie. Fondé au Xe siècle par l'ermite Jean de Rila, il est depuis plus de mille ans un phare spirituel et culturel pour le peuple bulgare. Le complexe monastique est un chef-d'œuvre de l'architecture de la Renaissance bulgare, avec ses impressionnantes arcades rayées noir et blanc, ses sculptures sur bois complexes et ses fresques colorées qui recouvrent les murs extérieurs et intérieurs. Classé au patrimoine mondial de l'UNESCO, le monastère incarne encore aujourd'hui l'identité bulgare et la résistance spirituelle face aux dominations étrangères. L'église principale de la Nativité, dotée de l'une des plus belles iconostases des Balkans, et la tour de Hrelyu, le plus ancien bâtiment du site, sont particulièrement remarquables. Le cadre montagneux paisible et l'atmosphère spirituelle profonde font du monastère de Rila un lieu de pèlerinage et de culture incontournable.",
    },
    factsAdvanced: {
      de: [
      ...
      ro: [
        ...
        "Biserica principala actuala a fost construita între 1834 ?i 1837 ?i conține 1.200 de fresce individuale.",
      ...
      es: ["El monasterio de Rila se extiende sobre 8.800 metros cuadrados y cuenta con unas 300 celdas para monjes.", "La iglesia principal actual fue construida entre 1834 y 1837 y contiene 1.200 frescos individuales.", "La torre Hreljo, erigida en 1335, fue el único edificio que se salvó del gran incendio de 1833.", "En el museo del monasterio se exhibe la famosa Cruz de Raffail, una cruz de madera con 104 escenas religiosas y 650 figuras en miniatura.", "El monje Raffail trabajó más de 12 años (1790–1802) en la cruz y perdió la vista debido al fino tallado.", "La biblioteca del monasterio contiene más de 250 manuscritos y 9.000 impresos antiguos.", "El monasterio está situado a 1.147 metros de altitud en el Parque Natural de Rila.", "El monasterio de Rila fue incluido en la lista del Patrimonio Mundial de la UNESCO en 1983."],
      pt: ["O mosteiro de Rila estende-se por 8.800 metros quadrados e possui cerca de 300 celas monásticas.", "A atual igreja principal foi construída entre 1834 e 1837 e contém 1.200 frescos individuais.", "A torre Hreljo, erguida em 1335, foi a única estrutura que sobreviveu ao grande incêndio de 1833.", "No museu do mosteiro é exibida a famosa Cruz de Raffail – uma cruz de madeira com 104 cenas religiosas e 650 figuras em miniatura.", "O monge Raffail trabalhou durante mais de 12 anos (1790–1802) na cruz e perdeu a visão devido à finura da escultura.", "A biblioteca do mosteiro compreende mais de 250 manuscritos e 9.000 impressos antigos.", "O mosteiro situa-se a 1.147 metros de altitude no Parque Natural de Rila.", "O mosteiro de Rila foi incluído na lista do Património Mundial da UNESCO em 1983."],
      fr: ["Le monastère de Rila s'étend sur 8 800 mètres carrés et compte environ 300 cellules de moines.", "L'église principale actuelle a été construite entre 1834 et 1837 et abrite 1 200 fresques individuelles.", "La tour de Hrelyu, érigée en 1335, fut le seul bâtiment épargné par le grand incendie de 1833.", "Le musée du monastère expose la célèbre croix de Raffail, une croix en bois sculptée de 104 scènes religieuses et 650 figurines miniatures.", "Le moine Raffail a travaillé plus de 12 ans (1790-1802) sur cette croix et a perdu la vue à cause de la finesse du travail.", "La bibliothèque du monastère conserve plus de 250 manuscrits et 9 000 imprimés anciens.", "Le monastère est situé à 1 147 mètres d'altitude au sein du parc naturel de Rila.", "Le monastère de Rila a été inscrit sur la liste du patrimoine mondial de l'UNESCO en 1983."],
    },
  ...
  },
  {
    ...
    description: {
      ...
      es: "La iglesia de Boyana, situada en las afueras de Sofía, al pie del monte Vitosha, es un templo medieval búlgaro ortodoxo declarado Patrimonio de la Humanidad por la UNESCO en 1979. Es famosa por sus frescos de 1259, considerados uno de los ejemplos más importantes del arte medieval de Europa del Este. Las pinturas destacan por un realismo inusual para la época y una profunda caracterización psicológica de las figuras, lo que las convierte en precursoras del Renacimiento. Impresionan los retratos de los donantes, Kaloyan y Desislava, así como del zar Constantino Tich y la zarina Irina.",
      pt: "A igreja de Boyana, situada nos arredores de Sófia, no sopé do maciço de Vitosha, é um templo medieval búlgaro ortodoxo e pertence ao Património Mundial da UNESCO desde 1979. A igreja é mundialmente famosa pelos seus frescos excecionalmente bem preservados de 1259, considerados um dos exemplos mais importantes da arte medieval da Europa de Leste. As pinturas murais caracterizam-se por um realismo invulgar para a época e uma representação psicológica profunda das figuras, tornando-as precursoras do Renascimento. Impressionam especialmente os retratos dos fundadores, Kaloyan e Desislava, bem como do czar Constantino Tich e da czarina Irina.",
      fr: "L'église de Boyana, située à la périphérie de Sofia au pied du massif de Vitocha, est un sanctuaire médiéval orthodoxe bulgare inscrit au patrimoine mondial de l'UNESCO depuis 1979. Elle est mondialement célèbre pour ses fresques de 1259, considérées comme l'un des exemples les plus importants de l'art médiéval d'Europe de l'Est. Ces peintures se distinguent par un réalisme inhabituel pour l'époque et une profondeur psychologique, ce qui en fait des précurseurs de la Renaissance. Les portraits des donateurs, le sébastocrator Kaloyan et sa femme Desislava, ainsi que du tsar Constantin Tikhi et de la tsarine Irina, sont particulièrement impressionnants.",
    },
    facts: {
      ...
      es: ["Patrimonio UNESCO desde 1979", "Frescos del año 1259", "Precursor del arte renacentista", "Situada al pie de Vitosha", "Retratos de Kaloyan y Desislava", "Tres fases de construcción"],
      pt: ["Património UNESCO desde 1979", "Frescos do ano 1259", "Precursor da arte renascentista", "Localizada no sopé de Vitosha", "Retratos de Kaloyan e Desislava", "Três fases de construção"],
      fr: ["Patrimoine mondial de l'UNESCO (1979)", "Fresques datant de 1259", "Précurseur de l'art de la Renaissance", "Au pied du massif de Vitocha", "Portraits de Kaloyan et Desislava", "Trois phases de construction"],
    },
    factsAdvanced: {
      ...
      es: ["Los frescos más famosos de la iglesia se terminaron en el año 1259.", "Desde 1979, el edificio figura en la lista del Patrimonio Mundial de la UNESCO.", "El 'Maestro de Boyana' creó un total de 89 escenas con 240 figuras.", "La sección más antigua de la iglesia data de finales del siglo X.", "Kaloyan y Desislava están representados como donantes en retratos a tamaño natural.", "La iglesia fue construida con ladrillo y piedra siguiendo el estilo de planta de cruz inscrita."],
      pt: ["Os frescos mais famosos da igreja foram concluídos no ano de 1259.", "Desde 1979, o edifício consta da lista do Património Mundial da UNESCO.", "O 'Mestre de Boyana' criou um total de 89 cenas com 240 figuras.", "A secção mais antiga da igreja remonta ao final do século X.", "Kaloyan e Desislava estão representados como fundadores em retratos de tamanho real.", "A igreja foi construída em tijolo e pedra no estilo de planta em cruz inscrita."],
      fr: ["Les fresques les plus célèbres de l'église ont été achevées en 1259.", "L'édifice est inscrit sur la liste du patrimoine mondial de l'UNESCO depuis 1979.", "Le 'Maître de Boyana' a réalisé 89 scènes comprenant 240 personnages.", "La section la plus ancienne de l'église remonte à la fin du Xe siècle.", "Kaloyan et Desislava sont représentés en donateurs dans des portraits grandeur nature.", "L'église a été construite en briques et pierres selon un plan en croix inscrite."],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "La iglesia de Boyana es uno de los monumentos más significativos del arte medieval en Europa del Este. El edificio consta de tres partes construidas en los siglos XI, XIII y XIX. Sin embargo, su fama mundial reside en los frescos de 1259, creados bajo el mandato de Kaloyan. Estas pinturas murales destacan por un notable realismo y profundidad psicológica, adelantándose a su tiempo y siendo consideradas precursoras del Renacimiento. Los retratos de Kaloyan y su esposa Desislava, así como del zar Constantino Tich y la zarina Irene, se cuentan entre los tesoros más valiosos de la pintura ortodoxa. El artista desconocido, a menudo llamado el \"Maestro de Boyana\", creó más de 240 figuras en una composición armoniosa. Hoy en día, la iglesia es un museo y está sujeta a estrictos controles climáticos para proteger los frágiles pigmentos. Una visita ofrece una visión profunda del florecimiento espiritual y artístico del Segundo Imperio Búlgaro.",
      pt: "A igreja de Boyana, nos arredores de Sófia, é um dos monumentos mais importantes da arte medieval na Europa de Leste e Património Mundial da UNESCO desde 1979. A estrutura consiste em três partes construídas nos séculos XI, XIII e XIX. No entanto, a igreja é mundialmente famosa pelos seus frescos de 1259, criados sob o domínio de Kaloyan. Estas pinturas murais distinguem-se por um realismo notável e uma profundidade psicológica que estavam muito à frente do seu tempo, sendo consideradas precursoras do Renascimento. Os retratos de Kaloyan e da sua esposa Desislava, bem como do czar Constantino Tich e da czarina Irene, estão entre os tesouros mais preciosos da pintura ortodoxa. O artista desconhecido, frequentemente chamado de \"Mestre de Boyana\", criou mais de 240 figuras numa composição harmoniosa. A igreja é hoje um museu e está sujeita a controlos climáticos rigorosos para proteger os pigmentos frágeis. Uma visita oferece uma visão profunda do florescimento espiritual e artístico do Segundo Império Búlgaro.",
      fr: "L'église de Boyana est l'un des monuments les plus importants de l'art médiéval en Europe de l'Est. L'édifice se compose de trois parties érigées aux XIe, XIIIe et XIXe siècles. Sa renommée mondiale repose sur ses fresques de 1259, réalisées sous le règne de Kaloyan. Ces peintures murales se distinguent par un réalisme et une profondeur psychologique remarquables, bien en avance sur leur temps, ce qui leur vaut d'être considérées comme précurseurs de la Renaissance. Les portraits de Kaloyan et de son épouse Desislava, ainsi que du tsar Constantin Tikhi et de la tsarine Irène, figurent parmi les trésors les plus précieux de la peinture orthodoxe. L'artiste inconnu, souvent appelé le \"Maître de Boyana\", a créé plus de 240 personnages dans une composition harmonieuse. L'église est aujourd'hui un musée soumis à des contrôles climatiques stricts pour protéger les pigments fragiles. Une visite offre un aperçu fascinant de l'apogée spirituelle et artistique du Second Empire bulgare.",
    },
  },
  {
    ...
    description: {
      ...
      es: "Península de la UNESCO con más de 3000 años de historia en la costa del Mar Negro.",
      pt: "Península da UNESCO com mais de 3000 anos de história na costa do Mar Negro.",
      fr: "Péninsule classée à l'UNESCO avec plus de 3000 ans d'histoire sur la côte de la mer Noire.",
    },
    facts: {
      ...
      es: ["Patrimonio de la Humanidad UNESCO", "Capas antiguas y bizantinas", "Destino costero popular"],
      pt: ["Património Mundial da UNESCO", "Camadas antigas e bizantinas", "Destino costeiro popular"],
      fr: ["Patrimoine mondial de l'UNESCO", "Couches antiques et byzantines", "Destination balnéaire populaire"],
    },
    descriptionAdvanced: {
      ...
      es: "Antigua Nesebar está situada en una península rocosa conectada al continente solo por un estrecho dique artificial y es uno de los lugares más pintorescos e históricos de la costa búlgara del Mar Negro. Con más de 3.000 años de asentamiento ininterrumpido, comenzó como el asentamiento tracio de Mesambria antes de convertirse en colonia griega y más tarde en un importante centro comercial bizantino. Debido a su densa concentración de iglesias medievales, a menudo se la llama \"ciudad de las 40 iglesias\", incluyendo la iglesia de Santa Sofía del siglo V y la ornamentada iglesia del Pantocrátor del siglo XIV. Como Patrimonio de la Humanidad de la UNESCO, la ciudad parece un museo vivo donde las antiguas murallas conviven con las casas de madera tradicionales del siglo XIX. Los visitantes recorren calles empedradas, descubren ruinas arqueológicas y experimentan la atmósfera marítima única de un balneario moderno con un pasado milenario.",
      pt: "A antiga Nessebar está situada numa península rochosa ligada ao continente apenas por um estreito dique artificial e é um dos locais mais pitorescos e históricos da costa búlgara do Mar Negro. Com mais de 3.000 anos de povoamento ininterrupto, começou como o povoado trácio de Mesambria antes de se tornar uma colónia grega e mais tarde um importante centro comercial bizantino. Devido à sua densa concentração de igrejas medievais, é frequentemente chamada de \"cidade das 40 igrejas\" – incluindo a igreja de Santa Sofia do século V e a ornamentada igreja do Pantocrator do século XIV. Como Património Mundial da UNESCO, a cidade parece um museu vivo onde as antigas muralhas convivem com as casas de madeira tradicionais do século XIX. Os visitantes percorrem ruas de paralelepípedos, descobrem ruínas arqueológicas e experimentam a atmosfera marítima única de uma estância balnear moderna com um passado milenar.",
      fr: "Le vieux Nessebar est situé sur une péninsule rocheuse reliée au continent uniquement par une étroite digue artificielle, et compte parmi les lieux les plus pittoresques et chargés d'histoire de la côte bulgare de la mer Noire. Avec plus de 3 000 ans d'occupation continue, la ville fut d'abord l'établissement thrace de Mesambria avant de devenir une colonie grecque, puis un centre commercial byzantin majeur. En raison de sa forte concentration d'églises médiévales, Nessebar est souvent surnommée la \"ville aux 40 églises\", parmi lesquelles l'église Sainte-Sophie du Ve siècle et l'église du Pantocrator du XIVe siècle, richement décorée. Classée au patrimoine mondial de l'UNESCO, la ville est un véritable musée vivant où les remparts antiques côtoient les maisons traditionnelles en bois du XIXe siècle. Les visiteurs flânent dans les ruelles pavées, découvrent des ruines archéologiques et profitent de l'atmosphère maritime unique d'une station balnéaire moderne au passé millénaire.",
    },
    factsAdvanced: {
      de: [
      ...
      ro: [
        ...
        "O mare parte din orașul antic, inclusiv unele ziduri de aparare, se afla astazi sub apa din cauza creșterii nivelului marii.",
      ...
      es: ["Nesebar es una de las ciudades más antiguas de Europa, fundada hacia el año 1000 a.C. como asentamiento tracio.", "La península del casco antiguo tiene solo 850 metros de largo y 300 metros de ancho.", "En su apogeo, en los siglos XIII y XIV, había casi 40 iglesias en un espacio muy reducido.", "La iglesia de San Juan Aliturgetos nunca fue consagrada porque un trabajador murió durante su construcción.", "Gran parte de la ciudad antigua, incluidas algunas murallas defensivas, se encuentra hoy bajo el agua debido al aumento del nivel del mar.", "El icónico molino de viento de madera al principio del dique es uno de los monumentos más fotografiados.", "En el siglo V a.C., Nesebar fue una de las primeras ciudades del mundo en acuñar sus propias monedas de oro.", "La ciudad fue declarada reserva arquitectónica y arqueológica en 1956 e incluida en la lista de la UNESCO en 1983."],
      pt: ["Nessebar é uma das cidades mais antigas da Europa, fundada por volta de 1.000 a.C. como um povoado trácio.", "A península da cidade velha tem apenas 850 metros de comprimento e 300 metros de largura.", "No seu auge, nos séculos XIII e XIV, existiam quase 40 igrejas num espaço muito reduzido.", "A igreja de São João Aliturgetos nunca foi consagrada porque um trabalhador morreu durante a construção.", "Grande parte da cidade antiga, incluindo algumas muralhas defensivas, encontra-se hoje debaixo de água devido à subida do nível do mar.", "O icónico moinho de vento de madeira no início do dique é um dos marcos mais fotografados da cidade.", "No século V a.C., Nessebar foi uma das primeiras cidades do mundo a cunhar as suas próprias moedas de ouro.", "A cidade foi declarada reserva arquitetónica e arqueológica em 1956 e incluída na lista da UNESCO em 1983."],
      fr: ["Nessebar est l'une des plus anciennes villes d'Europe, fondée vers 1 000 av. J.-C. en tant qu'établissement thrace.", "La péninsule de la vieille ville ne mesure que 850 mètres de long sur 300 mètres de large.", "À son apogée, aux XIIIe et XIVe siècles, Nessebar comptait près de 40 églises sur un espace très restreint.", "L'église Saint-Jean-Aliturgetos n'a jamais été consacrée car un ouvrier s'est tué pendant sa construction.", "Une grande partie de la ville antique, y compris certains murs de défense, est aujourd'hui sous l'eau en raison de la montée du niveau de la mer.", "L'emblématique moulin à vent en bois au début de la digue est l'un des monuments les plus photographiés de la ville.", "Au Ve siècle av. J.-C., Nessebar fut l'une des premières villes au monde à frapper ses propres pièces d'or.", "La ville a été déclarée réserve architecturale et archéologique en 1956 et inscrite à l'UNESCO en 1983."],
    },
  ...
  },
  {
    id: "cult-kazanlak", "sights": {
      ...
      "en": [
            {
                  "name": "Rose Museum",
                  "text": "A unique museum in Kazanlak dedicated to the history and cultivation of the famous Bulgarian roses.",
                  "category": "museum",
                  "coords": [
                        25.388312,
                        42.623197
    ...
    description: {
      ...
      es: "La tumba tracia de Kazanlak, situada en el Valle de las Rosas, es una obra maestra del arte antiguo y Patrimonio de la Humanidad por la UNESCO desde 1979. Data de finales del siglo IV a. C. y es famosa por sus frescos excepcionalmente conservados en la cámara funeraria y el corredor. Las pinturas muestran escenas de un banquete fúnebre ritual, guerreros tracios y carreras de caballos, ofreciendo una visión fascinante de la cultura y las creencias de los tracios.",
      pt: "O túmulo trácio de Kazanlak, situado no coração do Vale das Rosas, é uma obra-prima da arte antiga e pertence ao Património Mundial da UNESCO desde 1979. O túmulo data do final do século IV a.C. e é famoso pelos seus frescos excecionalmente bem preservados na câmara funerária e no corredor. As pinturas murais mostram cenas de um banquete fúnebre ritual, guerreiros trácios e corridas de cavalos, oferecendo uma visão fascinante da cultura e das crenças dos trácios.",
      fr: "Le tombeau thrace de Kazanlak, situé au cœur de la vallée des Roses, est un chef-d'œuvre de l'art antique inscrit au patrimoine mondial de l'UNESCO depuis 1979. Datant de la fin du IVe siècle av. J.-C., il est célèbre pour ses fresques exceptionnellement bien conservées dans la chambre funéraire et le dromos. Les peintures représentent des scènes de banquet funéraire rituel, des guerriers thraces et des courses de chars, offrant un aperçu fascinant de la culture et des croyances des Thraces.",
    },
    facts: {
      ...
      es: ["Patrimonio UNESCO desde 1979", "Siglo IV a. C.", "Obra maestra del arte tracio", "Valle de las Rosas, Kazanlak", "Frescos del banquete fúnebre", "Visión de los rituales tracios"],
      pt: ["Património UNESCO desde 1979", "Final do séc. IV a.C.", "Obra-prima da arte trácia", "Vale das Rosas, Kazanlak", "Frescos do banquete fúnebre", "Visão dos rituais trácios"],
      fr: ["Patrimoine mondial de l'UNESCO (1979)", "Fin du IVe siècle av. J.-C.", "Chef-d'œuvre de l'art thrace", "Vallée des Roses près de Kazanlak", "Fresques du banquet funéraire", "Aperçu des rituels thraces"],
    },
    factsAdvanced: {
      ...
      es: ["La tumba fue descubierta accidentalmente en 1944 durante unos trabajos de excavación.", "Data de finales del siglo IV o principios del III antes de Cristo.", "Las pinturas de la cúpula muestran a una pareja tracia en un festín ritual.", "Kazanlak fue el primer sitio búlgaro en la lista de la UNESCO (1979).", "Los colores originales están compuestos por pigmentos minerales y aglutinantes.", "La tumba forma parte de un grupo mayor de túmulos tracios."],
      pt: ["O túmulo foi descoberto acidentalmente em 1944 durante trabalhos de escavação.", "Data do final do século IV ou início do século III antes de Cristo.", "As pinturas da cúpula mostram um casal trácio num banquete ritual.", "Kazanlak foi o primeiro sítio búlgaro na lista da UNESCO (1979).", "As cores originais consistem em pigmentos minerais e aglutinantes.", "O túmulo faz parte de um grupo maior de túmulos trácios."],
      fr: ["Le tombeau a été découvert par hasard en 1944 lors de travaux de terrassement.", "Il date de la fin du IVe ou du début du IIIe siècle avant J.-C.", "Les peintures de la coupole représentent un couple thrace lors d'un banquet rituel.", "Kazanlak fut le premier site bulgare inscrit à l'UNESCO (1979).", "Les couleurs originales sont à base de pigments minéraux et de liants.", "Le tombeau fait partie d'un vaste ensemble de tumulus thraces."],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "La tumba tracia de Kazanlak es un testimonio excepcional de la cultura antigua y el primer monumento búlgaro incluido en la lista de la UNESCO en 1979. El lugar de enterramiento data de finales del siglo IV a. C. y formaba parte de una gran necrópolis cerca de la capital tracia de Seutópolis. Consta de un corredor estrecho y una cámara funeraria redonda con una magnífica cúpula. Sus pinturas murales interiores son únicas en el mundo, representando una ceremonia de entierro tracia y carreras de carros con un colorido inusual para la época helenística. En el centro aparece una pareja de príncipes tracios dándose la mano en un gesto solemne, rodeados de sirvientes y músicos. Las pinturas proporcionan información valiosa sobre la vestimenta, el armamento y los ritos funerarios de la aristocracia tracia. Para proteger el original, solo se permite el acceso a una copia exacta situada junto a la estructura antigua. Es el símbolo más conocido del llamado Valle de los Reyes Tracios.",
      pt: "O túmulo trácio de Kazanlak é um testemunho excecional da cultura antiga e o primeiro monumento búlgaro a ser incluído na lista do Património Mundial da UNESCO em 1979. O local de sepultamento data do final do século IV a.C. e fazia parte de uma grande necrópole perto da capital trácia, Seuthopolis. O túmulo consiste num corredor estreito e numa câmara funerária redonda com uma cúpula magnífica. As pinturas murais no interior são únicas no mundo, representando uma cerimónia fúnebre trácia e corridas de carros com um colorido invulgar para o período helenístico. No centro está um casal de príncipes trácios que dão as mãos num gesto solene, rodeados por servos e músicos. As pinturas fornecem informações valiosas sobre o vestuário, o armamento e os ritos fúnebres da aristocracia trácia. Para proteger o original, os visitantes apenas podem aceder a uma cópia exata situada ao lado da estrutura antiga. O túmulo é o símbolo mais conhecido do chamado Vale dos Reis Trácios.",
      fr: "Le tombeau thrace de Kazanlak est un témoignage exceptionnel de la culture antique et le premier monument bulgare inscrit à l'UNESCO en 1979. La sépulture date de la fin du IVe siècle av. J.-C. et faisait partie d'une vaste nécropole proche de la capitale thrace, Seuthopolis. Le tombeau se compose d'un dromos étroit et d'une chambre funéraire circulaire surmontée d'une coupole. Ses fresques sont uniques au monde, dépeignant une cérémonie funéraire et des courses de chars avec une palette de couleurs inhabituelle pour l'époque hellénistique. Au centre, un couple princier se tient la main dans un geste solennel, entouré de serviteurs et de musiciens. Ces peintures offrent des détails précieux sur les costumes, l'armement et les rites de l'élite thrace. Afin de protéger l'original de la dégradation, seule une copie exacte située à proximité est accessible au public. Le tombeau est le symbole le plus célèbre de la 'Vallée des rois thraces'.",
    },
  },
  {
    id: "cult-madara",
    ...
    description: {
      ...
      es: "Relieve rupestre del siglo VIII declarado Patrimonio de la Humanidad por la UNESCO, un símbolo del temprano Estado búlgaro.",
      pt: "Relevo rupestre da UNESCO do século VIII, um símbolo do estado búlgaro primitivo.",
      fr: "Relief rupestre classé à l'UNESCO datant du VIIIe siècle, symbole du premier État bulgare.",
    },
    facts: {
      ...
      es: ["Patrimonio Mundial UNESCO", "Siglo VIII", "Símbolo búlgaro temprano"],
      pt: ["Património Mundial da UNESCO", "Século VIII", "Símbolo búlgaro primitivo"],
      fr: ["Patrimoine mondial de l'UNESCO", "VIIIe siècle", "Symbole de l'État bulgare primitif"],
    },
    descriptionAdvanced: {
      ...
      es: "El Caballero de Madara es un impresionante relieve rupestre tallado en un acantilado vertical de 100 metros de altura cerca de la aldea de Madara, en el noreste de Bulgaria. Creado a principios del siglo VIII durante el Primer Imperio Búlgaro, representa a un jinete a tamaño natural que atraviesa a un león con una lanza, acompañado de un perro de caza. Esta obra monumental es única en Europa y se considera un símbolo profundamente arraigado de la soberanía búlgara y el triunfo militar. Alrededor del relieve se encuentran varias inscripciones en griego medio que proporcionan detalles importantes sobre los reinados de los kanes Tervel, Kormisosh y Omurtag. Como Patrimonio de la Humanidad de la UNESCO, el Caballero de Madara es uno de los monumentos más significativos del arte medieval temprano y fue elegido en 2008 como el \"Símbolo global de Bulgaria\" en una votación pública.",
      pt: "O Cavaleiro de Madara é um impressionante relevo rupestre esculpido numa falésia vertical de 100 metros de altura, perto da aldeia de Madara, no nordeste da Bulgária. Criado no início do século VIII, durante o Primeiro Império Búlgaro, retrata um cavaleiro em tamanho real que trespassa um leão com uma lança, acompanhado por um cão de caça. Esta obra de arte monumental é única na Europa e é considerada um símbolo profundamente enraizado da soberania búlgara e do triunfo militar. Em redor do relevo encontram-se várias inscrições em grego medieval que fornecem detalhes importantes sobre os reinados dos cãs Tervel, Kormisosh e Omurtag. Como Património Mundial da UNESCO, o Cavaleiro de Madara é um dos monumentos mais significativos da arte medieval precoce e foi eleito em 2008 como o \"Símbolo global da Bulgária\" numa votação pública.",
      fr: "Le Cavalier de Madara est un impressionnant relief rupestre sculpté dans une falaise verticale de 100 mètres de haut près du village de Madara, au nord-est de la Bulgarie. Réalisé au début du VIIIe siècle sous le Premier Empire bulgare, il représente un cavalier grandeur nature perçant un lion de sa lance, accompagné d'un chien de chasse. Cette œuvre monumentale est unique en Europe et constitue un symbole fort de la souveraineté bulgare et du triomphe militaire. Plusieurs inscriptions en grec médiéval entourant le relief fournissent des détails précieux sur les règnes des khans Tervel, Kormisosh et Omurtag. Inscrit au patrimoine mondial de l'UNESCO, le Cavalier de Madara figure parmi les monuments les plus importants de l'art du haut Moyen Âge et a été élu 'symbole mondial de la Bulgarie' en 2008.",
    },
    factsAdvanced: {
      de: [
      ...
      ro: [
        ...
        "Rezervația arheologica din jur include peșteri, sanctuare trace ?i o vila romana de mari dimensiuni."
      ],
      en: [
      ...
      es: ["El Caballero de Madara fue esculpido a una altura de 23 metros sobre la base de la pared rocosa.", "El relieve mide aproximadamente 2,6 m de alto y 3,1 m de ancho.", "Las inscripciones registran más de 100 años de historia búlgara (705–831 d. C.).", "La pared rocosa forma parte de la meseta de Madara, lugar sagrado desde el Neolítico.", "Una inscripción relata cómo el kan Tervel ayudó al emperador bizantino Justiniano II a recuperar el trono.", "Fue incluido en la lista del Patrimonio Mundial de la UNESCO en 1979.", "El jinete aparece en el reverso de todas las monedas búlgaras pequeñas (stotinki).", "La reserva arqueológica circundante incluye cuevas, santuarios tracios y una villa romana."],
      pt: ["O Cavaleiro de Madara foi esculpido a 23 metros de altura acima da base da parede rochosa.", "O relevo tem aproximadamente 2,6 m de altura e 3,1 m de largura.", "As inscrições em redor do cavaleiro cobrem mais de 100 anos da história búlgara (705–831 d.C.).", "A face do penhasco pertence ao planalto de Madara, um local sagrado desde o Neolítico.", "Uma inscrição relata como o Cã Tervel ajudou o imperador bizantino Justiniano II a recuperar o trono.", "O Cavaleiro de Madara foi incluído na lista do Património Mundial da UNESCO em 1979.", "O verso de todas as moedas búlgaras pequenas (stotinki) ostenta a imagem do Cavaleiro de Madara.", "A reserva arqueológica circundante inclui grutas, santuários trácios e uma grande villa romana."],
      fr: ["Le Cavalier de Madara a été sculpté à 23 mètres de hauteur sur la paroi rocheuse.", "Le relief mesure environ 2,6 m de haut sur 3,1 m de large.", "Les inscriptions relatent plus de 100 ans d'histoire bulgare (705-831 ap. J.-C.).", "La falaise fait partie du plateau de Madara, lieu sacré depuis le Néolithique.", "Une inscription raconte l'aide du khan Tervel à l'empereur byzantin Justinien II pour reprendre son trône.", "Le site a été inscrit au patrimoine mondial de l'UNESCO en 1979.", "Le Cavalier de Madara figure au revers de toutes les petites pièces de monnaie bulgares (stotinki).", "La réserve archéologique comprend des grottes, des sanctuaires thraces et une villa romaine."],
    },
  ...
  },
  {
    id: "hist-belogradchik-fortress", "sights": {
      ...
      "en": [
            {
                  "name": "History Museum",
                  "text": "A museum detailing the local history and ethnographic heritage of the Belogradchik region.",
                  "category": "museum",
                  "coords": [
                        22.681527,
                        43.624882
    ...
    description: {
      ...
      ro: "Una dintre cele mai spectaculoase cetați ale Bulgariei, construita chiar printre stâncile roșii. Este un nume de top pentru turismul istoric din nord-vest. Straturi romane, otomane ?i bulgare definesc locul. Pentru SEO despre fortare?ele Bulgariei, Belogradchik este foarte puternic.",
      ...
      es: "Una de las fortalezas más espectaculares de Bulgaria, construida entre formaciones rocosas rojas.",
      pt: "Uma das fortalezas mais espetaculares da Bulgária, construída entre formações rochosas vermelhas.",
      fr: "L'une des forteresses les plus spectaculaires de Bulgarie, bâtie au cœur de formations rocheuses rouges.",
    },
    facts: {
      ...
      ro: ["Stânci roșii", "Nord-vestul Bulgariei", "Cetate pe relief înalt", "Istorie militara", "Loc fotogenic"],
      en: ["Red rocks", "Northwestern Bulgaria", "Hilltop fortress", "Military history", "Photogenic landmark"],
      es: ["Rocas rojas", "Noroeste de Bulgaria", "Fortaleza en altura", "Historia militar", "Imán fotográfico"],
      pt: ["Rochas vermelhas", "Noroeste da Bulgária", "Fortaleza em cumeada", "História militar", "Íman de fotos"],
      fr: ["Rochers rouges", "Nord-ouest de la Bulgarie", "Forteresse d'altitude", "Histoire militaire", "Spot photo"],
    },
    descriptionAdvanced: {
      ...
      ro: "Cetatea Belogradchik, cunoscuta ?i sub numele de Kaleto, este o capodopera a ingineriei militare, care folosește forma?iunile stâncoase roșii ?i impunatoare ale Munților Balcani drept ziduri naturale de aparare. Situata în nord-vestul Bulgariei, fortarea?a originala a fost ridicata de romani în secolul al III-lea d.Hr. ?i extinsa ulterior de ?ari bulgari ?i de ocupan?i otomani. Cetatea acopera peste 10.000 de metri patrați ?i are trei cur?i distincte, conectate prin por?i masive. Cel mai impresionant aspect al sitului este modul în care pere?ii se sprijina pe coloanele naturale de calcar ?i gresie, unele înalte de pâna la 200 de metri, formând o bariera aproape inexpugnabila care a respins numeroase asedii. Urcând pâna la cel mai înalt punct, se deschide o panorama spectaculoasa asupra peisajului montan ?i a stâncilor zim?ate de la Belogradchik. Este un loc unde minunea naturala ?i istoria antica se întâlnesc, formând una dintre cele mai memorabile destinații din Bulgaria.",
      ...
      es: "La fortaleza de Belogradchik, también llamada Kaleto, es una obra maestra de la ingeniería militar que utiliza las irreales y elevadas formaciones rocosas rojas de los Montes Balcanes como murallas defensivas naturales. Situada en el noroeste de Bulgaria, la estructura original fue erigida por los romanos en el siglo III d.C. y ampliada posteriormente por zares búlgaros y gobernantes otomanos. Con más de 10.000 metros cuadrados de superficie y tres patios conectados por puertas macizas, la fortaleza impresiona sobre todo por la forma en que se integra perfectamente con las columnas de caliza y arenisca de hasta 200 metros de altura, formando un baluarte casi inexpugnable que repelió numerosos asedios a lo largo de los siglos. Desde el punto más alto se abre un panorama impresionante sobre las escarpadas rocas de Belogradchik y el vasto paisaje montañoso. Aquí se funden maravillas naturales e historia antigua en uno de los destinos más inolvidables de Bulgaria.",
      pt: "A fortaleza de Belogradchik, também chamada Kaleto, é uma obra-prima da arquitetura militar que utiliza as surreais e imponentes formações rochosas vermelhas da cordilheira dos Balcãs como muralhas de defesa naturais. Situada no noroeste da Bulgária, a instalação original foi erguida pelos romanos no século III d.C. e mais tarde expandida por tzares búlgaros e governantes otomanos. Com mais de 10.000 metros quadrados de área e três pátios ligados por portões maciços, a fortaleza impressiona sobretudo pela forma como se integra perfeitamente nas colunas de calcário e arenito com até 200 metros de altura – um baluarte quase invencível que repeliu inúmeros cercos ao longo dos séculos. Do ponto mais alto, abre-se um panorama deslumbrante sobre as rochas escarpadas de Belogradchik e a vasta paisagem montanhosa. Aqui fundem-se maravilhas naturais e história antiga num dos destinos turísticos mais inesquecíveis da Bulgária.",
      fr: "La forteresse de Belogradchik, également appelée Kaleto, est un chef-d'œuvre d'architecture militaire qui utilise les formations rocheuses rouges surréalistes du Grand Balkan comme remparts naturels. Située dans le nord-ouest de la Bulgarie, la structure initiale fut érigée par les Romains au IIIe siècle après J.-C., puis agrandie par les tsars bulgares et les souverains ottomans. Avec plus de 10 000 mètres carrés de surface et trois cours reliées par des portes massives, la forteresse impressionne par son intégration parfaite aux colonnes de calcaire et de grès s'élevant jusqu'à 200 mètres, formant un bastion quasi imprenable ayant repoussé de nombreux sièges au fil des siècles. Depuis le point le plus haut, un panorama époustouflant s'ouvre sur les rochers de Belogradchik et le vaste paysage montagneux. Ici, les merveilles de la nature et l'histoire antique se rejoignent pour former l'une des destinations les plus mémorables de Bulgarie.",
    },
    factsAdvanced: {
      de: [
      ...
      ro: [
        "Zidurile cetații au peste 2 metri grosime ?i ajung pe alocuri la 12 metri înal?ime.",
      ...
      es: ["Los muros de la fortaleza tienen en algunas partes más de 2 metros de espesor y hasta 12 metros de altura.", "Las rocas naturales que forman parte de los muros se crearon hace más de 200 millones de años.", "En el siglo XIV, la fortaleza fue una base militar importante en las guerras búlgaro-bizantinas.", "A principios del siglo XIX, los otomanos mandaron reconstruir totalmente la fortaleza con ayuda de ingenieros europeos.", "Las rocas de Belogradchik fueron nominadas en 2009 para las \"Nuevas Siete Maravillas de la Naturaleza\".", "En la región hay más de 200 formaciones rocosas individuales, cada una con su propia leyenda y nombre como \"La Madonna\" o \"El Jinete\".", "La fortaleza se utilizó en combate por última vez en la guerra serbo-búlgara de 1885.", "El área de las rocas de Belogradchik abarca unos 90 kilómetros cuadrados."],
      pt: ["As muralhas da fortaleza têm parcialmente mais de 2 metros de espessura e até 12 metros de altura.", "As rochas naturais que formam parte das muralhas surgiram há mais de 200 milhões de anos.", "No século XIV, a fortaleza era um importante posto militar nas guerras búlgaro-bizantinas.", "No início do século XIX, os otomanos mandaram reconstruir totalmente a fortaleza com a ajuda de engenheiros europeus.", "As rochas de Belogradchik foram nomeadas em 2009 para as \"Novas Sete Maravilhas Naturais\".", "Na região existem mais de 200 formações rochosas individuais, cada uma com a sua própria lenda e nome, como \"A Madona\" ou \"O Cavaleiro\".", "Na guerra servo-búlgara de 1885, a fortaleza foi utilizada em combate pela última vez.", "A área das rochas de Belogradchik abrange cerca de 90 quilómetros quadrados."],
      fr: ["Les murs de la forteresse font par endroits plus de 2 mètres d'épaisseur et jusqu'à 12 mètres de haut.", "Les rochers naturels constituant une partie des murs se sont formés il y a plus de 200 millions d'années.", "Au XIVe siècle, la forteresse était un point stratégique militaire majeur lors des guerres bulgaro-byzantines.", "Au début du XIXe siècle, les Ottomans firent reconstruire entièrement la forteresse avec l'aide d'ingénieurs européens.", "Les rochers de Belogradchik ont été nominés en 2009 pour les \"Sept nouvelles merveilles de la nature\".", "La région compte plus de 200 formations rocheuses individuelles, chacune ayant sa propre légende et son nom, comme \"La Madone\" ou \"Le Cavalier\".", "La forteresse a servi pour la dernière fois au combat lors de la guerre serbo-bulgare de 1885.", "Le site des rochers de Belogradchik s'étend sur environ 90 kilomètres carrés."],
    },
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Cetate medievala a ?arilor deasupra orașului Veliko Târnovo, cu o silueta puternica. A fost inima politica a celui de-al Doilea ?arat Bulgar. Vizitatorii vin pentru ziduri, turnuri ?i panorame. Ca simbol istoric, Tsarevets este esențial pentru Bulgaria.",
      ...
      es: "Fortaleza medieval de los zares sobre Veliko Tarnovo con una silueta imponente.",
      pt: "Fortaleza medieval dos tzares sobre Veliko Tarnovo com uma silhueta imponente.",
      fr: "Forteresse médiévale des tsars surplombant Veliko Tarnovo avec une silhouette imposante.",
    },
    facts: {
      ...
      es: ["Veliko Tarnovo", "Época de los zares", "Castillo en colina", "Vista panorámica", "Símbolo nacional"],
      pt: ["Veliko Tarnovo", "Época dos tzares", "Castelo em colina", "Vista panorâmica", "Símbolo nacional"],
      fr: ["Veliko Tarnovo", "Époque des tsars", "Château sur colline", "Vue panoramique", "Symbole national"],
    },
    descriptionAdvanced: {
      ...
      es: "La fortaleza de Tsarevets es el imponente centro de Veliko Tarnovo y fue, durante el Segundo Imperio Búlgaro (1185–1396), la principal sede del poder de los zares búlgaros. Rodeada por los meandros del río Yantra, la colina de la fortaleza alberga el palacio real, la catedral patriarcal, así como más de 400 viviendas y 22 iglesias de la Edad Media. El edificio más famoso dentro de las murallas es la Torre de Balduino, llamada así por el emperador latino Balduino I de Flandes, quien según la leyenda estuvo prisionero aquí tras la batalla de Adrianópolis. Hoy en día, la fortaleza es conocida sobre todo por su espectáculo de \"Sonido y Luz\", un evento audiovisual con láseres y música que narra el dramático ascenso y caída de la ciudad bajo el Imperio Otomano. Quien atraviesa sus puertas macizas y recorre sus adarves restaurados siente la grandeza y dimensión de la Edad de Oro medieval de Bulgaria.",
      pt: "A fortaleza de Tsarevets é o imponente centro de Veliko Tarnovo e foi, no Segundo Império Búlgaro (1185–1396), o principal centro de poder dos tzares búlgaros. Rodeada pelas curvas do rio Yantra, a colina da fortaleza alberga o palácio real, a catedral patriarcal, bem como mais de 400 edifícios residenciais e 22 igrejas da Idade Média. A construção mais famosa dentro das muralhas é a Torre de Balduíno, nomeada em honra do imperador latino Balduíno I da Flandres, que, segundo a lenda, foi mantido prisioneiro aqui após a batalha de Adrianópolis. Hoje, a fortaleza é conhecida sobretudo pelo seu espetáculo de \"Som e Luz\" – um espetáculo audiovisual com lasers e música que conta a dramática ascensão e queda da cidade no Império Otomano. Quem atravessa os portões maciços e caminha ao longo das passagens de guarda restauradas sente o esplendor e a dimensão da Idade de Ouro medieval da Bulgária.",
      fr: "La forteresse de Tsarevets est le centre imposant de Veliko Tarnovo et fut le principal centre de pouvoir des tsars bulgares sous le Second Empire bulgare (1185-1396). Enlacée par les méandres de la Yantra, la colline de la forteresse abrite le palais royal, la cathédrale patriarcale, ainsi que plus de 400 habitations et 22 églises médiévales. L'édifice le plus célèbre de l'enceinte est la tour de Baudouin, nommée d'après l'empereur latin Baudouin Ier de Flandre, qui y aurait été emprisonné après la bataille d'Andrinople selon la légende. Aujourd'hui, la forteresse est surtout réputée pour son spectacle \"Son et Lumière\", un show audiovisuel avec lasers et musique racontant l'ascension et la chute dramatique de la ville face à l'Empire ottoman. En franchissant les portes massives et en arpentant les chemins de ronde restaurés, on ressent toute la splendeur de l'âge d'or médiéval de la Bulgarie.",
    },
    factsAdvanced: {
      de: [
      ...
      ro: [
        "Dealul cetații este locuit din mileniul al II-lea î.Hr., inițial de catre traci, apoi de romani.",
        "Dealul Tsarevets se înal?a la o altitudine de 206 metri deasupra nivelului marii.",
        "Zidul exterior de aparare avea inițial 1,1 km lungime, pâna la 3,6 m grosime ?i 10 m înal?ime.",
        "Catedrala Patriarhala \\\\\\\"Înal?area Domnului\\\\\\\" a fost complet reconstruita în anii 1980.",
        "Arheologii au descoperit, în interiorul zidurilor cetații, ramați?ele a 470 de cladiri individuale.",
        "\\\\\\\"Stânca Execuțiilor\\\\\\\" de la marginea cetații era folosita în Evul Mediu pentru a-i arunca pe tradatori în râul Yantra.",
      ...
      es: ["La colina de la fortaleza ha estado habitada desde el segundo milenio a.C., primero por tracios y luego por romanos.", "La colina de Tsarevets se eleva a una altura de 206 metros sobre el nivel del mar.", "La muralla defensiva exterior tenía originalmente 1,1 km de largo, hasta 3,6 m de espesor y 10 m de alto.", "La catedral patriarcal de la 'Ascensión del Señor' fue completamente reconstruida en los años 80.", "Los arqueólogos descubrieron restos de 470 edificios individuales dentro de las murallas.", "Desde la 'roca de las ejecuciones' en el borde de la fortaleza, los traidores eran arrojados al Yantra en la Edad Media.", "Durante más de 200 años, Tsarevets fue la capital de Bulgaria hasta que la fortaleza cayó ante los otomanos en 1393.", "La fortaleza se extiende sobre la colina con una superficie total de unas 12 hectáreas."],
      pt: ["A colina da fortaleza é habitada desde o 2º milénio a.C., inicialmente por trácios e mais tarde por romanos.", "A colina de Tsarevets eleva-se a uma altitude de 206 metros acima do nível do mar.", "A muralha defensiva exterior tinha originalmente 1,1 km de comprimento, até 3,6 m de espessura e 10 m de altura.", "A catedral patriarcal da 'Ascensão do Senhor' foi completamente reconstruída na década de 1980.", "Os arqueólogos descobriram vestígios de 470 edifícios individuais dentro das muralhas.", "Do 'rochedo da execução', na borda da fortaleza, os traidores eram empurrados para o rio Yantra na Idade Média.", "Durante mais de 200 anos, Tsarevets foi a capital da Bulgária, até a fortaleza cair perante os otomanos em 1393.", "A fortaleza estende-se sobre a colina por uma área total de cerca de 12 hectares."],
      fr: ["La colline de la forteresse est habitée depuis le IIe millénaire av. J.-C., d'abord par les Thraces, puis par les Romains.", "La colline de Tsarevets s'élève à 206 mètres au-dessus du niveau de la mer.", "Le rempart extérieur mesurait à l'origine 1,1 km de long, pour 3,6 m d'épaisseur et 10 m de haut.", "La cathédrale patriarcale de l'Ascension du Seigneur a été entièrement reconstruite dans les années 1980.", "Les archéologues ont découvert les vestiges de 470 bâtiments distincts à l'intérieur des murs.", "Depuis le \"rocher de l'exécution\" au bord de la forteresse, les traîtres étaient jetés dans la Yantra au Moyen Âge.", "Tsarevets fut la capitale de la Bulgarie pendant plus de 200 ans, jusqu'à sa chute devant les Ottomans en 1393.", "La forteresse s'étend sur la colline sur une superficie totale d'environ 12 hectares."],
    },
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Complex tracic mare în Munții Rodopi de Est, cu sanctuar ?i urme de a?ezare. Perperikon este unul dintre cele mai cautate situri arheologice din Bulgaria. Poziția deasupra peisajului îl face memorabil. Pentru istorie, arheologie ?i sudul Bulgariei, Perperikon este un termen SEO foarte bun.",
      ...
      es: "Gran complejo de roca tracio en los Ródopes orientales con santuario y huellas de asentamientos.",
      pt: "Grande complexo de rocha trácio nos Ródope orientais com santuário e vestígios de povoamento.",
      fr: "Vaste complexe rupestre thrace dans les Rhodopes orientaux, avec sanctuaire et vestiges d'occupation.",
    },
    facts: {
      ...
      es: ["Sitio tracio", "Ródopes orientales", "Arqueología", "Santuario", "Complejo rocoso"],
      pt: ["Sítio trácio", "Ródope orientais", "Arqueologia", "Santuário", "Complexo rochoso"],
      fr: ["Site thrace", "Rhodopes orientaux", "Archéologie", "Sanctuaire", "Complexe rupestre"],
    },
    descriptionAdvanced: {
      ...
      ro: "Perperikon este un ora? monumental antic sapat în stânca, situat în Munții Rodopi de Est, în sudul Bulgariei, supranumit adesea \\\\\\\"Machu Picchu-ul bulgar\\\\\\\". A?ezat pe un vârf înalt de stânca, aceasta minune arheologica a fost un loc sacru de peste 8.000 de ani, începându-?i existen?a ca sanctuar neolitic. Este celebru ca loc legendar al Oracolului lui Dionysos, unde, potrivit tradiției, Alexandru cel Mare ar fi primit o profeție despre cucerirea lumii. Situl cuprinde un palat-sanctuar imens, o acropola ?i doua ora?e exterioare, toate sapate direct în stânca. Vizitatorii pot descoperi altare antice, sisteme sofisticate de drenaj al apei ?i o sala mare unde se desfa?urau ospe?e regale. Perperikon sta marturie inginerie avansate ?i vieții spirituale profunde a tracilor, fiind ulterior folosit de romani, bizantini ?i bulgari — astazi este una dintre cele mai importante destinații arheologice din Peninsula Balcanica.",
      ...
      es: "Perperikon es una monumental ciudad rocosa antigua en los Ródopes orientales del sur de Bulgaria y a menudo se la denomina el \"Machu Picchu búlgaro\". Situada en una alta cumbre rocosa, este tesoro arqueológico ha sido un lugar sagrado durante más de 8.000 años, comenzando como un santuario neolítico. Perperikon es más conocida como el legendario escenario del oráculo de Dioniso, donde según la tradición Alejandro Magno recibió una profecía sobre su conquista del mundo. El complejo consta de un enorme palacio-santuario, una acrópolis y dos ciudades exteriores, todas talladas directamente en la roca. Los visitantes descubren altares antiguos, canales de agua sofisticados y una gran sala donde antaño se celebraban banquetes reales. Perperikon atestigua la avanzada ingeniería y la profunda espiritualidad de los tracios, y fue utilizada posteriormente por romanos, bizantinos y búlgaros; hoy es uno de los destinos arqueológicos más importantes de la península balcánica.",
      pt: "Perperikon é uma monumental cidade rochosa antiga nos Ródope orientais do sul da Bulgária e é frequentemente referida como o \"Machu Picchu búlgaro\". Situado num alto cume rochoso, este tesouro arqueológico tem sido um local sagrado há mais de 8.000 anos, tendo começado como um santuário neolítico. Perperikon é mais conhecida como o cenário lendário do Oráculo de Dionísio, onde, segundo a tradição, Alexandre o Grande recebeu uma profecia sobre a sua conquista do mundo. O complexo consiste num enorme palácio-santuário, uma acrópole e duas cidades exteriores, todas escavadas diretamente na rocha. Os visitantes descobrem altares antigos, canais de água sofisticados e um grande salão onde outrora se realizavam banquetes reais. Perperikon testemunha a engenharia altamente desenvolvida e a profunda espiritualidade dos trácios e foi mais tarde utilizada por romanos, bizantinos e búlgaros – hoje é um dos destinos arqueológicos mais importantes da península balcânica.",
      fr: "Perperikon est une cité antique monumentale taillée dans le roc, située dans les Rhodopes orientaux au sud de la Bulgarie, et souvent surnommée le \"Machu Picchu bulgare\". Juché sur un haut sommet rocheux, ce trésor archéologique est un lieu sacré depuis plus de 8 000 ans, ayant débuté comme sanctuaire néolithique. Perperikon est surtout célèbre pour être le site légendaire de l'oracle de Dionysos, où Alexandre le Grand aurait reçu une prophétie sur sa conquête du monde. L'ensemble comprend un immense palais-sanctuaire, une acropole et deux villes extérieures, le tout sculpté directement dans la roche. Les visiteurs y découvrent des autels antiques, des canaux d'irrigation sophistiqués et une grande salle qui accueillait autrefois des banquets royaux. Témoignage de l'ingénierie avancée et de la spiritualité profonde des Thraces, Perperikon fut ensuite utilisé par les Romains, les Byzantins et les Bulgares ; c'est aujourd'hui l'un des sites archéologiques majeurs des Balkans.",
    },
    factsAdvanced: {
      de: [
      ...
      ro: [
        ...
        "Palatul cel mare de la Perperikon este sapat pe ?apte niveluri ?i conține peste 50 de încaperi individuale.",
      ...
      es: ["Perperikon se encuentra a 470 metros de altitud sobre una poderosa cumbre rocosa.", "El área arqueológica se extiende por aproximadamente 5 kilómetros cuadrados.", "Los primeros rastros humanos en Perperikon datan del sexto milenio antes de Cristo.", "Un altar circular de 3 metros de ancho en el lugar servía probablemente para rituales de vino y fuego en honor a Dioniso.", "El gran palacio en Perperikon está tallado en la roca en siete niveles e incluye más de 50 habitaciones individuales.", "En el siglo V d.C., Perperikon se convirtió en un importante centro cristiano temprano con su propio obispado.", "En el sitio se encuentra una cisterna excavada en la roca con capacidad para más de 270 metros cúbicos de agua.", "Perperikon se encuentra a solo 15 kilómetros al noreste de la ciudad actual de Kardzhali."],
      pt: ["Perperikon situa-se a 470 metros de altitude num imponente cume rochoso.", "A área arqueológica estende-se por cerca de 5 quilómetros quadrados.", "Os primeiros vestígios humanos em Perperikon datam do 6º milénio a.C.", "Um altar circular de 3 metros de largura no local servia provavelmente para rituais de vinho e fogo em honra de Dionísio.", "O grande palácio em Perperikon está escavado na rocha em sete níveis e compreende mais de 50 divisões individuais.", "No século V d.C., Perperikon tornou-se um importante centro cristão primitivo com o seu próprio bispado.", "No local encontra-se uma cisterna escavada na rocha, que continha mais de 270 metros cúbicos de água.", "Perperikon fica a apenas 15 quilómetros a nordeste da atual cidade de Kardzhali."],
      fr: ["Perperikon est perché à 470 mètres d'altitude sur un imposant sommet rocheux.", "La zone archéologique s'étend sur environ 5 kilomètres carrés.", "Les premières traces humaines à Perperikon remontent au VIe millénaire av. J.-C.", "Un autel circulaire de 3 mètres de large servait probablement à des rituels de vin et de feu en l'honneur de Dionysos.", "Le grand palais de Perperikon est taillé dans la roche sur sept niveaux et compte plus de 50 pièces individuelles.", "Au Ve siècle après J.-C., Perperikon devint un centre paléochrétien majeur avec son propre évêché.", "Le site abrite une citerne creusée dans le roc pouvant contenir plus de 270 mètres cubes d'eau.", "Perperikon se trouve à seulement 15 kilomètres au nord-est de la ville actuelle de Kardjali."],
    },
  ...
  },
  {
    ...
    description: {
      ...
      es: "La fortaleza más famosa de Vidin y el castillo medieval mejor conservado de Bulgaria a orillas del Danubio.",
      pt: "A fortaleza mais famosa de Vidin e o castelo medieval melhor preservado da Bulgária nas margens do Danúbio.",
      fr: "La forteresse la plus célèbre de Vidin et le château médiéval le mieux conservé de Bulgarie au bord du Danube.",
    },
    facts: {
      ...
      es: ["Orillas del Danubio", "Vidin", "Castillo medieval", "Historia fronteriza", "Icono de la ciudad"],
      pt: ["Margens do Danúbio", "Vidin", "Castelo medieval", "História fronteiriça", "Ícone da cidade"],
      fr: ["Rives du Danube", "Vidin", "Château médiéval", "Histoire frontalière", "Icône de la ville"],
    },
    descriptionAdvanced: {
      ...
      es: "Baba Vida es una majestuosa fortaleza medieval situada en la orilla sur del Danubio, en Vidin, al noroeste de Bulgaria. Es el único castillo medieval del país que se conserva íntegramente y destaca por su doble muralla y su profundo foso. Construida sobre los cimientos de la fortaleza romana de Bononia, la fortaleza vivió su apogeo en el siglo XIV como residencia de los zares de Vidin. La arquitectura cuenta con nueve torres defensivas, cuatro de las cuales se conservan completas, y potentes almenas de piedra que ofrecen una amplia vista del río hasta Rumanía. En su interior, los visitantes encontrarán salas abovedadas, antiguas mazmorras y almacenes militares que han sobrevivido a siglos de conflictos. Baba Vida no es solo una obra maestra de la arquitectura militar medieval, sino también un poderoso símbolo de la resistencia búlgara y de la importancia estratégica de la ciudad como baluarte en el Danubio.",
      pt: "Baba Vida é uma majestosa fortaleza medieval situada na margem sul do Danúbio, em Vidin, no noroeste da Bulgária. É o único castelo medieval totalmente preservado do país e impressiona com um anel duplo de muralhas e um fosso profundo. Erguida sobre as fundações da fortaleza romana de Bononia, o castelo viveu o seu apogeu no século XIV como residência dos tzares de Vidin. A arquitetura é marcada por nove torres de defesa – quatro das quais estão totalmente preservadas – e poderosas ameias de pedra que oferecem uma vista ampla sobre o rio até à Roménia. No interior, os visitantes encontram salas abobadadas, antigas masmorras e armazéns militares que sobreviveram a séculos de guerras. Baba Vida não é apenas uma obra-prima da arquitetura militar medieval, mas também um símbolo poderoso da resiliência búlgara e da importância estratégica da cidade como baluarte do Danúbio.",
      fr: "Baba Vida est une majestueuse forteresse médiévale située sur la rive sud du Danube à Vidin, dans le nord-ouest de la Bulgarie. C'est le seul château médiéval entièrement préservé du pays, impressionnant par sa double enceinte et ses douves profondes. Érigé sur les fondations de la forteresse romaine de Bononia, le château a connu son apogée au XIVe siècle en tant que résidence des tsars de Vidin. Son architecture se caractérise par neuf tours de défense — dont quatre sont intactes — et de puissants créneaux en pierre offrant une vue imprenable sur le fleuve jusqu'en Roumanie. À l'intérieur, les visiteurs découvrent des salles voûtées, d'anciens cachots et des entrepôts militaires ayant survécu à des siècles de tourmentes guerrières. Baba Vida n'est pas seulement un chef-d'œuvre de l'architecture militaire médiévale, mais aussi un symbole puissant de la résilience bulgare et de l'importance stratégique de la ville comme bastion sur le Danube.",
    },
    factsAdvanced: {
      de: [
      ...
      ro: [
        ...
        "?an?ul cetații era umplut inițial cu apa adusa direct din Dunare.",
      ...
      es: ["Baba Vida consta de dos áreas principales: una muralla defensiva interior con 9 torres y una muralla exterior con sus propios fosos.", "El foso del castillo se llenaba originalmente de forma directa con agua del Danubio.", "El nombre \"Baba Vida\" proviene de una leyenda local sobre una princesa búlgara que mandó construir el castillo para su protección.", "La construcción actual data principalmente de los siglos XIII y XIV, de la época del zar Ivan Stratsimir.", "Durante casi 200 años, la fortaleza fue una importante base militar para la flota otomana del Danubio.", "Baba Vida ha servido de escenario para más de 50 películas históricas búlgaras e internacionales.", "En el patio interior del castillo hay un teatro medieval reconstruido donde todavía se realizan representaciones en verano.", "Los muros están hechos principalmente de piedra caliza y ladrillo, unidos con un mortero excepcionalmente duradero."],
      pt: ["Baba Vida consiste em duas áreas principais: uma muralha de defesa interior com 9 torres e uma muralha exterior com os seus próprios fossos.", "O fosso do castelo era originalmente enchido diretamente com água do Danúbio.", "O nome \"Baba Vida\" baseia-se numa lenda local sobre uma princesa búlgara que mandou construir o castelo para sua proteção.", "A construção atual data predominantemente dos séculos XIII e XIV, da época do tzar Ivan Stratsimir.", "Durante quase 200 anos, a fortaleza foi uma importante base militar da frota otomana do Danúbio.", "Baba Vida serviu de cenário para mais de 50 filmes históricos búlgaros e internacionais.", "No pátio interior do castelo encontra-se um teatro medieval reconstruído, onde ainda hoje se realizam espetáculos no verão.", "As muralhas são feitas maioritariamente de calcário e tijolos, unidos por uma argamassa excecionalmente duradoura."],
      fr: ["Baba Vida se compose de deux zones principales : une enceinte intérieure avec 9 tours et une enceinte extérieure avec ses propres douves.", "Les douves du château étaient à l'origine directement alimentées par l'eau du Danube.", "Le nom \"Baba Vida\" provient d'une légende locale concernant une princesse bulgare qui aurait fait construire le château pour se protéger.", "L'édifice actuel date principalement des XIIIe et XIVe siècles, sous le règne du tsar Ivan Stratsimir.", "Pendant près de 200 ans, la forteresse fut une base militaire importante pour la flotte ottomane du Danube.", "Baba Vida a servi de décor à plus de 50 films historiques bulgares et internationaux.", "La cour intérieure du château abrite un théâtre médiéval reconstitué où des représentations ont encore lieu en été.", "Les murs sont principalement constitués de calcaire et de briques, liés par un mortier exceptionnellement résistant."],
    },
