...
export const poiExtraBulgariaHistory: POI[] = [
  {
    ...
    factsAdvanced: {
      ...
      ro: [
        "Manastirea Rila se întinde pe 8.800 de metri patra?i ?i are aproximativ 300 de chilii.",
        "Biserica principala actuala a fost construita între 1834 ?i 1837 ?i con?ine 1.200 de fresce individuale.",
        "Turnul lui Hreljo, ridicat în 1335, este singura construc?ie care a supravie?uit marelui incendiu din 1833.",
        "Muzeul manastirii adaposte?te celebra Cruce a lui Rafail, sculptata în lemn cu 104 scene religioase ?i 650 de figuri miniaturale.",
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Biserica Boiana, situata la marginea Sofiei, la poalele muntelui Vitosha, este un laca? de cult ortodox bulgar medieval ?i face parte din Patrimoniul Mondial UNESCO din 1979. Biserica este faimoasa în întreaga lume pentru frescele sale excep?ional de bine conservate din anul 1259, considerate unul dintre cele mai importante exemple de arta medievala est-europeana. Picturile murale se caracterizeaza printr-un realism neobi?nuit pentru acea perioada ?i o reprezentare psihologica profunda a figurilor, ceea ce le face precursoare ale Rena?terii. Deosebit de impresionante sunt portretele ctitorilor, sebastocratorul Kaloyan ?i so?ia sa Desislava, precum ?i ale ?arului bulgar Constantin Tih ?i ale ?arinei Irina. Biserica Boiana este un loc de o valoare culturala inestimabila ?i o vizita obligatorie pentru orice vizitator al Sofiei interesat de istoria artei ?i spiritualitate.",
    ...
    facts: {
      ...
      ro: ["Statut: Patrimoniu Mondial UNESCO din 1979", "Vârsta: Fresce din 1259", "Importan?a: Precursor al artei Rena?terii", "Loca?ie: La poalele muntelui Vitosha", "Atrac?ie: Portretele lui Kaloyan ?i Desislava", "Arhitectura: Trei faze de construc?ie (sec. XI, XIII ?i XIX)"],
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Portretul ?arinei Irina este laudat pentru frumuse?ea sa excep?ionala ?i pentru detaliile ve?mintelor medievale.",
  ...
  },
  {
    ...
    name: { de: "Alt-Nessebar", hu: "Neszebár óváros", ro: "Ora?ul vechi Nessebar", en: "Old Nessebar" },
    description: {
    ...
    facts: {
      ...
      ro: ["Patrimoniu mondial UNESCO", "Straturi antice ?i bizantine", "Destina?ie de coasta populara"],
    ...
    descriptionAdvanced: {
      ...
      ro: "Vechiul Nesebar, situat pe o peninsula stâncoasa legata de continent printr-un istm îngust, construit de mâna omului, este unul dintre cele mai pitore?ti ?i mai bogate ora?e istorice de pe litoralul bulgar al Marii Negre. Cu peste 3.000 de ani de locuire neîntrerupta, ora?ul a început ca o a?ezare tracica numita Mesambria, devenind apoi colonie greceasca ?i un important centru comercial bizantin. Cunoscut ca \\\\\\\"Ora?ul celor 40 de biserici\\\\\\\", pastreaza o concentrare extraordinara de arhitectura religioasa medievala, printre care Biserica Sfânta Sofia din secolul al V-lea ?i ornata Biserica Hristos Pantocrator din secolul al XIV-lea. Recunoscut de UNESCO ca patrimoniu mondial, Nesebar este un muzeu viu, unde ziduri antice de fortifica?ie coexista cu casele tradi?ionale din lemn ale secolului al XIX-lea. Vizitatorii pot rataci pe stradu?e pavate cu piatra, pot descoperi ruine arheologice ?i se pot bucura de atmosfera maritima unica, ce îmbina milenii de istorie cu via?a unei sta?iuni moderne.",
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Peninsula pe care se afla ora?ul vechi are doar 850 de metri lungime ?i 300 de metri la?ime.",
        "În perioada de apogeu din secolele XIII–XIV, Nesebarul avea aproape 40 de biserici pe aceasta suprafa?a mica.",
        "Biserica Sfântul Ioan Aliturgetos nu a fost niciodata sfin?ita, deoarece un muncitor ?i-a pierdut via?a în timpul construc?iei.",
        "O mare parte din ora?ul antic, inclusiv unele ziduri de aparare, se afla astazi sub apa din cauza cre?terii nivelului marii.",
        "Iconica moara de vânt din lemn de la intrarea pe istm este unul dintre cele mai fotografiate simboluri ale ora?ului.",
        "Nesebar a fost unul dintre primele ora?e din lume care a batut propriile monede de aur, în secolul al V-lea î.Hr.",
        "Ora?ul a fost declarat rezerva?ie arhitecturala ?i arheologica în 1956 ?i inclus în Patrimoniul UNESCO în 1983."
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Mormântul tracic de la Kazanlak, situat în inima Vaii Trandafirilor, este o capodopera a artei antice ?i face parte din Patrimoniul Mondial UNESCO din 1979. Mormântul dateaza de la sfâr?itul secolului al IV-lea î.Hr. ?i este faimos pentru frescele sale excep?ional de bine conservate din camera funerara ?i coridor. Picturile murale înfa?i?eaza scene ale unui ospa? funerar ritual, razboinici traci ?i curse de cai, oferind o perspectiva fascinanta asupra culturii ?i credin?elor tracilor. Deosebit de impresionanta este reprezentarea conducatorului trac ?i a so?iei sale, ?inându-se de mâna. Mormântul de la Kazanlak este cel mai important monument al culturii trace din Bulgaria ?i o vizita obligatorie pentru orice pasionat de istorie.",
    ...
    facts: {
      ...
      ro: ["Statut: Patrimoniu Mondial UNESCO din 1979", "Vârsta: Sfâr?itul sec. IV î.Hr.", "Importan?a: Capodopera a artei trace", "Loca?ie: În Valea Trandafirilor, lânga Kazanlak", "Atrac?ie: Frescele ospa?ului funerar", "Cultura: Perspectiva asupra ritualurilor trace"],
    ...
    factsAdvanced: {
      ...
      ro: [
        "Mormântul a fost descoperit întâmplator în 1944 de solda?i care sapau o tran?ee.",
        ...
        "Pictura din cupola înfa?i?eaza 12 care de lupta ?i numero?i cai într-o scena dinamica de cursa.",
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Inscrip?iile din jurul calare?ului acopera o perioada de peste 100 de ani din istoria Bulgariei (705–831 d.Hr.).",
        "Stânca însa?i face parte din Platoul Madara, considerat un loc sacru înca din neolitic.",
        "O inscrip?ie de sub calare? men?ioneaza cum hanul Tervel l-a ajutat pe împaratul bizantin Iustinian al II-lea sa î?i recâ?tige tronul.",
        ...
        "Rezerva?ia arheologica din jur include pe?teri, sanctuare trace ?i o vila romana de mari dimensiuni."
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Una dintre cele mai spectaculoase ceta?i ale Bulgariei, construita chiar printre stâncile ro?ii. Este un nume de top pentru turismul istoric din nord-vest. Straturi romane, otomane ?i bulgare definesc locul. Pentru SEO despre fortare?ele Bulgariei, Belogradchik este foarte puternic.",
    ...
    descriptionAdvanced: {
      ...
      ro: "Cetatea Belogradchik, cunoscuta ?i sub numele de Kaleto, este o capodopera a ingineriei militare, care folose?te forma?iunile stâncoase ro?ii ?i impunatoare ale Mun?ilor Balcani drept ziduri naturale de aparare. Situata în nord-vestul Bulgariei, fortarea?a originala a fost ridicata de romani în secolul al III-lea d.Hr. ?i extinsa ulterior de ?ari bulgari ?i de ocupan?i otomani. Cetatea acopera peste 10.000 de metri patra?i ?i are trei cur?i distincte, conectate prin por?i masive. Cel mai impresionant aspect al sitului este modul în care pere?ii se sprijina pe coloanele naturale de calcar ?i gresie, unele înalte de pâna la 200 de metri, formând o bariera aproape inexpugnabila care a respins numeroase asedii. Urcând pâna la cel mai înalt punct, se deschide o panorama spectaculoasa asupra peisajului montan ?i a stâncilor zim?ate de la Belogradchik. Este un loc unde minunea naturala ?i istoria antica se întâlnesc, formând una dintre cele mai memorabile destina?ii din Bulgaria.",
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "În zona exista peste 200 de forma?iuni stâncoase individuale, fiecare cu propria legenda ?i nume, precum \\\\\\\"Madona\\\\\\\" sau \\\\\\\"Calare?ul\\\\\\\".",
        "Cetatea a fost folosita ultima data în lupte în timpul Razboiului Sârbo-Bulgar din 1885.",
        "Suprafa?a totala a Stâncilor Belogradchik acopera aproximativ 90 de kilometri patra?i."
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Cetate medievala a ?arilor deasupra ora?ului Veliko Târnovo, cu o silueta puternica. A fost inima politica a celui de-al Doilea ?arat Bulgar. Vizitatorii vin pentru ziduri, turnuri ?i panorame. Ca simbol istoric, Tsarevets este esen?ial pentru Bulgaria.",
    ...
    facts: {
      ...
      ro: ["Veliko Târnovo", "Epoca ?arilor", "Cetate pe colina", "Panorama", "Simbol na?ional"],
    ...
    descriptionAdvanced: {
      ...
      ro: "Cetatea Tsarevets este centrul impunator al ora?ului Veliko Târnovo, fiind principala re?edin?a a ?arilor bulgari în timpul celui de-al Doilea ?arat Bulgar (1185–1396). Înconjurata de meandrele râului Yantra, dealul ceta?ii gazduie?te palatul regal, Catedrala Patriarhala ?i peste 400 de cladiri reziden?iale ?i 22 de biserici din perioada medievala. Cea mai cunoscuta construc?ie din interiorul zidurilor este Turnul lui Balduin, numit dupa împaratul latin Baldovin I al Flandrei, despre care legenda spune ca a fost închis aici dupa batalia de la Adrianopol. Astazi, cetatea este renumita pentru spectacolul \\\\\\\"Sunet ?i Lumina\\\\\\\", o reprezenta?ie audiovizuala cu lasere ?i muzica ce poveste?te ascensiunea dramatica ?i caderea ora?ului în mâinile Imperiului Otoman. Trecând prin por?ile masive ?i plimbându-se de-a lungul zidurilor reconstruite, vizitatorii pot sim?i cu adevarat mare?ia ?i dimensiunea epocii de aur medievale a Bulgariei.",
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Arheologii au descoperit, în interiorul zidurilor ceta?ii, rama?i?ele a 470 de cladiri individuale.",
        "\\\\\\\"Stânca Execu?iilor\\\\\\\" de la marginea ceta?ii era folosita în Evul Mediu pentru a-i arunca pe tradatori în râul Yantra.",
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Complex tracic mare în Mun?ii Rodopi de Est, cu sanctuar ?i urme de a?ezare. Perperikon este unul dintre cele mai cautate situri arheologice din Bulgaria. Pozi?ia deasupra peisajului îl face memorabil. Pentru istorie, arheologie ?i sudul Bulgariei, Perperikon este un termen SEO foarte bun.",
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Situl arheologic se întinde pe o suprafa?a de aproximativ 5 kilometri patra?i.",
        ...
        "Perperikon se afla la doar 15 kilometri nord-est de ora?ul modern Kardzhali."
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Cea mai cunoscuta fortarea?a din Vidin ?i una dintre cele mai bine pastrate ceta?i medievale ale Bulgariei. Baba Vida sta chiar pe malul Dunarii ?i define?te profilul ora?ului. Locul combina istoria de frontiera, apararea ?i comer?ul fluvial. Pentru paginile despre castele ?i traseele dunarene, Baba Vida este foarte puternic.",
    ...
    descriptionAdvanced: {
      ...
      ro: "Baba Vida este o impunatoare fortarea?a medievala situata pe malul sudic al Dunarii, în Vidin, nord-vestul Bulgariei. Este singurul castel medieval pastrat integral din ?ara, cu un sistem defensiv formidabil compus din doua ziduri concentrice ?i un ?an? adânc. Construit pe funda?iile vechii fortare?e romane Bononia, castelul a atins apogeul în secolul al XIV-lea, ca re?edin?a principala a ?arilor de Vidin. Arhitectura este definita de cele noua turnuri de aparare, dintre care patru sunt complet pastrate, ?i de zidurile masive cu metereze, oferind o panorama larga asupra fluviului pâna în România. În interior, vizitatorii pot explora sali boltite, vechi închisori ?i depozite militare care au rezistat secolelor de razboaie. Baba Vida este nu doar o capodopera a arhitecturii militare medievale, ci ?i un puternic simbol al rezilien?ei bulgare ?i al importan?ei strategice a ora?ului ca bastion fluvial.",
    ...
    factsAdvanced: {
      ...
      ro: [
        ...
        "Baba Vida a fost folosita ca decor în peste 50 de filme istorice bulgare ?i interna?ionale.",
        "Curtea interioara a castelului adaposte?te un teatru medieval reconstruit, unde se ?in spectacole vara.",
