...
export const poiExtraPeruEconomicV2: POI[] = [
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein strategisch wichtiger Hafen für die Region La Libertad, der landwirtschaftliche Produkte und Mineralien exportiert.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Stratégiailag fontos kikötő a La Libertad régió számára, amely mezőgazdasági termékeket és ásványkincseket exportál.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein entscheidender Flusshafen am Amazonas, der von hochseetauglichen Schiffen vom Atlantik aus erreicht werden kann.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Döntő fontosságú folyami kikötő az Amazonason, amely tengerjáró hajókkal is elérhető az Atlanti-óceán felől.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein wichtiger Flusshafen am Río Ucayali, der für den Transport und Handel in der Amazonasregion unerlässlich ist.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Fontos folyami kikötő az Ucayali folyón, amely elengedhetetlen az amazonasi régió közlekedéséhez és kereskedelméhez.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Un port fluvial important pe râul Ucayali, esențial pentru transportul și comerțul din regiunea Amazonului.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    }
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein wichtiger Flusshafen am Río Huallaga, der als Knotenpunkt zwischen dem Amazonasgebiet und den Anden dient.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Fontos folyami kikötő a Huallaga folyón, amely csomópontként szolgál az Amazonas és az Andok között.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine der größten Kupfer- und Zinkminen der Welt, die hoch in den Anden liegt.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["A világ egyik legnagyobb réz- és cinkbányája, amely magasan az Andok hegységben található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine riesige Kupfermine im Tagebau, die sich in der Nähe der Stadt Arequipa befindet.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Hatalmas külszíni rézbánya, amely Arequipa városának közelében található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["O mină masivă de cupru în carieră deschisă, situată lângă orașul Arequipa.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-cerroverde-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein bedeutendes Kupferbergbauprojekt in der Region Apurímac, das zu den größten des Landes zählt.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Jelentős rézbányászati projekt az Apurímac régióban, amely az ország egyik legnagyobbja.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Un proiect major de exploatare a cuprului în regiunea Apurímac, printre cele mai mari din țară.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-lasbambas-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine bedeutende Kupfermine im Süden Perus, die Teil eines großen Bergbaukomplexes ist.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Jelentős rézbánya Dél-Peruban, amely egy nagy bányászati komplexum része.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["O mină de cupru semnificativă în sudul Peru, parte a unui mare complex minier.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-cuajone-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Bekannt für ihren großen Kupferabbau im Tagebau und verfügt über eine eigene Eisenbahnlinie zur Küste.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Nagy külszíni rézkitermeléséről ismert, és saját vasútvonallal rendelkezik a part felé.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Cunoscută pentru marea sa extracție de cupru în carieră deschisă, cu o cale ferată dedicată spre coastă.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-toquepala-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["War einst die größte Goldmine in Südamerika und befindet sich in der Region Cajamarca.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Egykor Dél-Amerika legnagyobb aranybányája volt, amely a Cajamarca régióban található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["A fost odată cea mai mare mină de aur din America de Sud, situată în regiunea Cajamarca.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-yanacocha-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine große Kupfer- und Molybdänmine im Tagebau, die auf großer Höhe in der Region Junín liegt.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Nagy külszíni réz- és molibdénbánya, amely nagy magasságban található a Junín régióban.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["O mare mină de cupru și molibden în carieră deschisă, situată la o altitudine mare în Junín.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-toromocho-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein wichtiges und modernes Kupferbergbauprojekt in der Region Moquegua, das hochgradig automatisiert ist.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Fontos és modern rézbányászati projekt a Moquegua régióban, amely nagymértékben automatizált.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Un proiect minier modern și important de cupru în regiunea Moquegua, puternic automatizat.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-quellaveco-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine Kupfer- und Molybdänmine im Tagebau in der Provinz Chumbivilcas in Cusco.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Külszíni réz- és molibdénbánya Cusco Chumbivilcas tartományában.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["O mină de cupru și molibden în carieră deschisă în provincia Chumbivilcas din Cusco.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-constancia-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine wichtige Goldmine in den Anden, die sich in der Region La Libertad befindet.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Fontos aranybánya az Andokban, amely a La Libertad régióban található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["O mină de aur importantă în Anzi, situată în regiunea La Libertad.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-lagunasnorte-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein Gold- und Kupferbergbaubetrieb, der zu den regionalen Mineralexporten beiträgt.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Arany- és rézbányászati művelet, amely hozzájárul a regionális ásványkincs-exportokhoz.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Die einzige große Eisenerzmine in Peru, die sich nahe der Küste in der Region Ica befindet.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Az egyetlen nagy vasércbánya Peruban, amely a tengerpart közelében, az Ica régióban található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Singura mare mină de minereu de fier din Peru, situată lângă coastă, în regiunea Ica.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-marcona-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      hu: ["Dél-Amerika egyik legnagyobb foszfátlelőhelye, amely elengedhetetlen a műtrágyagyártáshoz.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Ein bedeutendes Erdgasförderprojekt im Amazonas-Regenwald der Region Cusco.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Jelentős földgázkitermelési projekt a Cusco régió amazóniai esőerdejében.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Un proiect major de extracție a gazelor naturale în pădurea amazoniană din regiunea Cusco.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    }
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine der wichtigsten Ölraffinerien in Peru, die kürzlich umfassend modernisiert wurde.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Peru egyik legfontosabb olajfinomítója, amelyet nemrégiben jelentősen korszerűsítettek.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Una dintre principalele rafinării de petrol din Peru, care a suferit recent o modernizare masivă.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-talara-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Die größte Ölraffinerie in Peru, die sich in der Küstenregion von Callao befindet.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["A legnagyobb olajfinomító Peruban, amely a tengerparti Callao régióban található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Cea mai mare rafinărie de petrol din Peru, situată în regiunea de coastă Callao.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-lapampilla-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Das erste Stahlwerk, das in Peru gegründet wurde, gelegen in der Küstenstadt Chimbote.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Az első acélgyár, amelyet Peruban alapítottak, a tengerparti Chimbote városában található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["Prima fabrică de oțel înfiinințată în Peru, situată în orașul de coastă Chimbote.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-siderperu-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Verarbeitet Kupfererze aus nahegelegenen Minen und umfasst eine Raffinerie sowie eine Schwefelsäureanlage.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Feldolgozza a közeli bányákból származó rézércet, és tartalmaz egy finomítót, valamint egy kénsavgyárat.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      hu: ["A világ egyik legnagyobb cinkfinomítója, amely a főváros, Lima közelében található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
  ...
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine unterirdische Gold- und Silbermine, die in großer Höhe in der Region Arequipa liegt.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Föld alatti arany- és ezüstbánya, amely nagy magasságban, az Arequipa régióban található.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["O mină subterană de aur și argint, situată la mare altitudine în regiunea Arequipa.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    },
    image: "/poi-images/ind-orcopampa-economic-v2.webp"
  },
  {
    ...
    factsAdvanced: {
      ...
      de: ["Eine historisch bedeutende Kupfermine in der südlichen Andenregion von Cusco.", "Liegt auf dem Gebiet der Republik Peru.", "Eingebettet zwischen Andenkordillere, Küstenwüste und Amazonasbecken.", "Spielt eine Rolle in der lokalen Identität der Region.", "Bekannt für seine landschaftliche oder kulturelle Bedeutung."],
      hu: ["Történelmileg jelentős rézbánya a dél-andoki Cusco régióban.", "A Perui Köztársaság területén található.", "Az Andok-kordillera, a parti sivatag és az Amazonas-medence között fekszik.", "Szerepet játszik a régió helyi identitásában.", "Tájképi vagy kulturális jelentőségéről ismert."],
      ro: ["O mină de cupru cu importanță istorică în regiunea andină sudică Cusco.", "Se află pe teritoriul Republicii Peru.", "Este situat între Cordiliera Anzilor, deșertul costier și bazinul Amazonului.", "Are un rol în identitatea locală a regiunii.", "Este cunoscut pentru semnificația sa peisagistică sau culturală."]
    }
  }
];
