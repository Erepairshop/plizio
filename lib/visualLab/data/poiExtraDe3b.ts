...
export const poiExtraDe3b: POI[] = [
  ...
  },
  {
    ...
    descriptionAdvanced: {
      ...
      en: "The Town Church of St. Mary in Wittenberg (Stadtkirche Wittenberg) is the 'Mother Church of the Reformation' and a UNESCO World Heritage site. It was here that Martin Luther preached most of his sermons and where the Lord's Supper was first distributed in both kinds (bread and wine) to the congregation. The church is famous for its magnificent Reformation Altar, painted by Lucas Cranach the Elder, which depicts Luther and his contemporaries in biblical scenes. Its twin towers dominate the skyline of the 'Lutherstadt,' standing as a powerful symbol of the spiritual revolution that changed the world. Today, the church remains a living center of Protestantism and a place of pilgrimage for those seeking to understand the roots of modern Europe. Geschichte K8 – Martin Luther and the Reformation."
    },
    factsAdvanced: {
