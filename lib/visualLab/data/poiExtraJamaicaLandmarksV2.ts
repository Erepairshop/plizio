...
export const poiExtraJamaicaLandmarksV2: POI[] = [
  {
    id: "jm-independence-park-landmarks-v2",
    type: "landmark",
    parent: "JM-02",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["Bob Marley itt élt az 1960-as években.", "Nemzeti kulturális örökségként tartják nyilván.", "Megőrzi az állami bérházak építészetét."],
      ro: ["Bob Marley a locuit aici în anii 1960.", "Recunoscut ca sit de patrimoniu național.", "Păstrează arhitectura locuințelor guvernamentale."],
      en: ["Bob Marley lived here in the 1960s.", "Designated as a National Heritage Site.", "Preserves the architecture of government housing."]
    }
  },
  {
    id: "jm-half-way-tree-clock-tower-landmarks-v2",
    type: "landmark",
    parent: "JM-02",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["1879-ben alapították.", "Több múzeumot és galériát is működtet.", "Székhelye Kingstonban van."],
      ro: ["A fost fondat în 1879.", "Operează mai multe muzee și galerii.", "Sediul este situat în Kingston."],
      en: ["Founded in 1879.", "Operates several museums and galleries.", "Headquartered in Kingston."]
    }
  },
  {
    id: "jm-plumb-point-lighthouse-landmarks-v2",
    type: "landmark",
    parent: "JM-02",
  ...
  },
  {
    ...
    facts: {
      ...
      hu: ["1801-ben Angliában öntötték, majd itt szerelték össze.", "Kőalapokon áll.", "Mára nemzeti emlékművé vált."],
      ro: ["A fost turnat în Anglia în 1801 și asamblat aici.", "Stă pe fundații de piatră.", "Este acum un monument național."],
      en: ["Was cast in England in 1801 and assembled here.", "Rests on stone foundations.", "Is now a national monument."]
    }
  }
];
