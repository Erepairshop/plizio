...
,
  {
    ...
    description: {
      ...
      ro: "Cel mai important centru de expoziții istorice și etnografice din Ulaanbaatar. Găzduiește peste 50.000 de artefacte.",
      en: "The most important center for historical and ethnographic exhibitions in Ulaanbaatar. It houses over 50,000 artifacts.",
    },
    facts: {
      de: ["Gegründet im Jahr 1924", "7 thematische Hallen", "Sammlung traditioneller Trachten", "Relikte aus dem Mongolischen Reich"],
      hu: ["1924-ben alapították", "7 tematikus kiállítóterem", "Hagyományos népviseleti gyűjtemény", "A Mongol Birodalom emlékei"],
      ro: ["Fondat în anul 1924", "7 săli tematice", "Colecție de costume tradiționale", "Relicve din Imperiul Mongol"],
      en: ["Founded in 1924", "7 thematic halls", "Traditional costume collection", "Relics of the Mongol Empire"],
    },
    imageHint: "National Museum of Mongolia building Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Acest muzeu este dedicat operelor celebrului maestru budist Zanabazar. Expune capodopere ale artei budiste mongole.",
      en: "This museum is dedicated to the works of the famous Buddhist master Zanabazar. It displays masterpieces of Buddhist art.",
    },
    facts: {
      de: ["Baujahr 1905", "Berühmte Tara-Skulpturen", "Thangka-Malereien", "Einzigartige Bronzeguss-Arbeiten"],
      hu: ["Az épület 1905-ben épült", "Híres Tara-szobrok", "Thangka festmények gyűjteménye", "Egyedi bronzöntvények"],
      ro: ["Clădire construită în 1905", "Celebrele sculpturi Tara", "Colecție de picturi Thangka", "Piese unice din bronz turnat"],
      en: ["Building constructed in 1905", "Famous Tara sculptures", "Collection of Thangka paintings", "Unique bronze castings"],
    },
    imageHint: "Zanabazar Museum of Fine Arts Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "O clădire neoclasică de culoarea somonului în inima orașului Ulaanbaatar. Este centrul muzicii clasice și al baletului.",
      en: "A salmon-colored neoclassical building in the heart of Ulaanbaatar. It is the center for classical music and ballet.",
    },
    facts: {
      de: ["Gegründet 1963", "Neoklassizistischer Stil", "Zentrum für mongolische Opern", "Befindet sich am Sükhbaatar-Platz"],
      hu: ["1963-ban alapították", "Neoklasszicista stílusú épület", "A mongol opera központja", "A Szühebátor téren található"],
      ro: ["Fondat în 1963", "Stil neoclasic", "Centrul operei mongole", "Situat în Piața Sükhbaatar"],
      en: ["Founded in 1963", "Neoclassical style", "Center for Mongolian opera", "Located at Sükhbaatar Square"],
    },
    imageHint: "State Opera and Ballet Theatre Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Cel mai modern zgârie-nori din Ulaanbaatar, cu o fațadă de sticlă în formă de velă. Găzduiește birouri și un hotel de lux.",
      en: "The most modern skyscraper in Ulaanbaatar with a distinctive sail-shaped glass facade. It houses offices and a luxury hotel.",
    },
    facts: {
      de: ["Höhe: 105 Meter", "Fertigstellung 2009", "Segelförmige Architektur", "Markantes Wahrzeichen der Stadt"],
      hu: ["Magassága 105 méter", "2009-ben fejezték be", "Vitorla alakú építészet", "A város egyik jelképe"],
      ro: ["Înălțime: 105 metri", "Finalizat în 2009", "Arhitectură în formă de velă", "Simbol modern al orașului"],
      en: ["Height: 105 meters", "Completed in 2009", "Sail-shaped architecture", "Modern landmark of the city"],
    },
    imageHint: "Blue Sky Tower Ulaanbaatar skyscraper",
  },
  {
    ...
    description: {
      ...
      ro: "Un pod important care leagă părțile de nord și de sud ale orașului Ulaanbaatar. A fost construit cu ajutor chinez.",
      en: "A major bridge connecting the northern and southern parts of Ulaanbaatar. It was built with Chinese assistance.",
    },
    facts: {
      de: ["Baujahr 1958", "Überquert die Eisenbahnstrecke", "Geschenk der Volksrepublik China", "Wichtige Verkehrsader der Stadt"],
      hu: ["1958-ban épült", "A vasútvonal felett ível át", "Kína ajándéka volt", "Fontos városi közlekedési folyosó"],
      ro: ["Construit în 1958", "Traversează calea ferată", "Cadou din partea Chinei", "Arteră rutieră vitală"],
      en: ["Built in 1958", "Spans the railway line", "Gift from PR China", "Vital traffic artery of the city"],
    },
    imageHint: "Peace Bridge Ulaanbaatar traffic",
  },
  {
    ...
    description: {
      ...
      ro: "Un muzeu militar în fosta reședință a mareșalului sovietic Jukov. Comemorează bătălia de la Halhin Gol.",
      en: "A military museum in the former residence of Soviet Marshal Zhukov. It commemorates the Battle of Khalkhin Gol.",
    },
    facts: {
      de: ["Gegründet 1979", "Persönliche Gegenstände Schukows", "Militärhistorische Exponate", "Sowjetisch-mongolisches Denkmal"],
      hu: ["1979-ben alapították", "Zsukov személyes tárgyai", "Hadtörténeti kiállítás", "Szovjet-mongol katonai emlékhely"],
      ro: ["Fondat în 1979", "Obiecte personale ale lui Jukov", "Expoziție de istorie militară", "Monument sovieto-mongol"],
      en: ["Founded in 1979", "Zhukov's personal belongings", "Military history exhibits", "Soviet-Mongolian memorial"],
    },
    imageHint: "Zhukov Museum Ulaanbaatar building",
  },
  {
    ...
    description: {
      ...
      ro: "O colecție unică de mii de jocuri logice și puzzle-uri. Vizitatorii pot descoperi șahul și puzzle-urile mongole.",
      en: "A unique collection showing thousands of logical games and puzzles. Visitors can discover interactive Mongolian puzzles.",
    },
    facts: {
      de: ["Über 11.000 Exponate", "Interaktive Puzzles", "Spezielle mongolische Schachspiele", "Wissenschaftliche Lernzentrale"],
      hu: ["Több mint 11 000 kiállítási tárgy", "Interaktív fejtörők", "Különleges mongol sakk-készletek", "Tudományos oktatóközpont"],
      ro: ["Peste 11.000 de piese", "Puzzle-uri interactive", "Seturi de șah mongol speciale", "Centru de educație științifică"],
      en: ["Over 11,000 exhibits", "Interactive puzzles", "Special Mongolian chess sets", "Scientific education center"],
    },
    imageHint: "International Intellectual Museum Ulaanbaatar puzzles",
  },
  {
    ...
    description: {
      ...
      ro: "O clădire roșie distinctivă în centrul orașului Ulaanbaatar, centrul artei dramatice. Prezintă piese mongole clasice.",
      en: "A distinctive red building in central Ulaanbaatar serving as the center for dramatic arts. It stages classical Mongolian plays.",
    },
    facts: {
      de: ["Baujahr 1931", "Auffällige rote Fassade", "Klassische mongolische Dramen", "Wichtiger Kulturstandort"],
      hu: ["1931-ben épült", "Feltűnő vörös homlokzat", "Klasszikus mongol drámák", "Fontos kulturális helyszín"],
      ro: ["Construit în 1931", "Fațadă roșie vizibilă", "Drame mongole clasice", "Locație culturală importantă"],
      en: ["Built in 1931", "Striking red facade", "Classical Mongolian dramas", "Major cultural venue"],
    },
    imageHint: "National Academic Drama Theatre Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Cea mai mare bibliotecă din țară, care adăpostește numeroase manuscrise tibetane și mongole rare. Un loc al moștenirii spirituale.",
      en: "The country's largest library, housing numerous rare Tibetan and Mongolian manuscripts. A site of intellectual heritage.",
    },
    facts: {
      de: ["Gegründet 1921", "Über 3 Millionen Bücher", "Wertvolle Manuskriptsammlung", "Monumentale Architektur"],
      hu: ["1921-ben alapították", "Több mint 3 millió kötet", "Értékes kéziratgyűjtemény", "Monumentális épület"],
      ro: ["Fondată în 1921", "Peste 3 milioane de volume", "Colecție de manuscrise valoroase", "Arhitectură monumentală"],
      en: ["Founded in 1921", "Over 3 million volumes", "Valuable manuscript collection", "Monumental architecture"],
    },
    imageHint: "National Library of Mongolia building",
  },
  {
    ...
    description: {
      ...
      ro: "Una dintre puținele mănăstiri budiste care a supraviețuit erei comuniste. Clădirile rotunde amintesc de iurtele tradiționale.",
      en: "One of the few Buddhist monasteries that survived the communist era. Its round buildings resemble traditional gers (yurts).",
    },
    facts: {
      de: ["Jurtenförmige Tempel", "Zentrum der Gelug-Schule", "Beherbergt etwa 100 Mönche", "Ehemaliges Zirkusgelände"],
      hu: ["Jurta alakú templomok", "A gelugpa iskola központja", "Körülbelül 100 szerzetes otthona", "Egykori cirkuszi területen áll"],
      ro: ["Temple în formă de iurtă", "Centrul școlii Gelug", "Găzduiește circa 100 de călugări", "Situată pe un fost teren de circ"],
      en: ["Ger-shaped temples", "Center of the Gelug school", "Home to about 100 monks", "Located on former circus grounds"],
    },
    imageHint: "Dashchoilin Monastery Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Un complex de temple din secolul al XVIII-lea dedicat eroului Geser Han. Stilul îmbină elemente taoiste și budiste.",
      en: "An 18th-century temple complex dedicated to the hero Geser Khan. The style combines Taoist and Buddhist elements.",
    },
    facts: {
      de: ["Baujahr 1919", "Epos-Helden gewidmet", "Traditionelle Holzarchitektur", "Mischstil der Architektur"],
      hu: ["1919-ben épült", "Az eposzhősnek szentelve", "Hagyományos faépítészet", "Vegyes építészeti stílus"],
      ro: ["Construit în 1919", "Dedicat eroului epic", "Arhitectură tradițională din lemn", "Stil arhitectural mixt"],
      en: ["Built in 1919", "Dedicated to the epic hero", "Traditional wooden architecture", "Mixed architectural style"],
    },
    imageHint: "Geser Temple Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Ruinele monumentale ale Ordu-Baliq, fosta capitală a Caganatului Uigur. Zidurile fortificate sunt încă vizibile.",
      en: "The monumental ruins of Ordu-Baliq, the former capital of the Uyghur Khaganate. The fortress walls are still visible today.",
    },
    facts: {
      de: ["Gegründet im 8. Jahrhundert", "Uigurische Hauptstadt", "Zentrum an der Orkhon", "Beeindruckende Lehmziegelmauern"],
      hu: ["A 8. században alapították", "Ujgur főváros volt", "Orkhon-völgyi központ", "Lenyűgöző vályogtégla falak"],
      ro: ["Fondată în secolul al VIII-lea", "Capitală uigură", "Centru pe valea Orkhon", "Ziduri masive din cărămidă nearsă"],
      en: ["Founded in the 8th century", "Uyghur capital", "Center on the Orkhon valley", "Impressive mud-brick walls"],
    },
    imageHint: "Khar Balgas ruins Mongolia",
  },
  {
    ...
    description: {
      ...
      ro: "Ruinele primei capitale a lui Ginghis Han, lângă râul Kherlen. Descoperirile arheologice atestă începuturile imperiului.",
      en: "Ruins of Genghis Khan's first capital near the Kherlen River. Archaeological finds document the early stages of the Mongol Empire.",
    },
    facts: {
      de: ["Frühe Hauptstadt des Reiches", "Nahe dem Kherlen-Fluss", "Archäologische Grabungsstätte", "Zentrum der Reichsgründung"],
      hu: ["A birodalom korai fővárosa", "A Kherlen-folyó közelében", "Régészeti feltárási terület", "A birodalomépítés központja"],
      ro: ["Prima capitală a imperiului", "Lângă râul Kherlen", "Sit arheologic important", "Centrul fondării imperiului"],
      en: ["Early capital of the empire", "Near the Kherlen River", "Archaeological excavation site", "Center of empire building"],
    },
    imageHint: "Avarga Toson archaeological site",
  },
  {
    ...
    description: {
      ...
      ro: "Un deal în nord-estul Mongoliei, venerat ca loc de naștere al lui Ginghis Han. Un monument de piatră marchează locul istoric.",
      en: "A hill in northeastern Mongolia revered as the birthplace of Genghis Khan. A stone monument marks this historic site.",
    },
    facts: {
      de: ["Geburtsort von Temüdschin", "Geboren im Jahr 1162", "Heiliger Ort in Khentii", "Steinsäule zur Markierung"],
      hu: ["Temüdzsin születési helye", "1162-ben született itt", "Szent hely Khentii tartományban", "Kőoszlop jelzi a helyszínt"],
      ro: ["Locul de naștere al lui Temujin", "Născut în anul 1162", "Loc sfânt în provincia Khentii", "Coloană de piatră comemorativă"],
      en: ["Birthplace of Temujin", "Born in the year 1162", "Sacred site in Khentii", "Stone pillar marker"],
    },
    imageHint: "Deluun Boldog monument Genghis Khan birthplace",
  },
  {
    ...
    description: {
      ...
      ro: "Un monument neobișnuit în cinstea celebrei trupe din Ulaanbaatar. Simbolizează dorința de libertate și democrație a tinerilor.",
      en: "An unusual monument honoring the famous band in Ulaanbaatar. It became a symbol of freedom and democracy for the youth.",
    },
    facts: {
      de: ["Errichtet im Jahr 2008", "Bronze-Relief der Musiker", "Symbol der Demokratiebewegung", "Beliebter Treffpunkt für Fans"],
      hu: ["2008-ban emelték", "A zenészek bronz domborműve", "A demokratikus mozgalom jelképe", "Népszerű rajongói találkozóhely"],
      ro: ["Ridicată în 2008", "Basorelief în bronz al trupei", "Simbol al mișcării democratice", "Loc de întâlnire pentru fani"],
      en: ["Erected in 2008", "Bronze relief of the band", "Symbol of democracy movement", "Popular meeting spot for fans"],
    },
    imageHint: "Beatles Monument Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Un muzeu în memoria victimelor epurărilor din anii 1930. Este situat într-o casă istorică de lemn din Ulaanbaatar.",
      en: "A museum commemorating the victims of the political purges of the 1930s. It is housed in an old wooden house in Ulaanbaatar.",
    },
    facts: {
      de: ["Historisches Holzhaus", "Erinnert an die Säuberungen", "Umfangreiche Dokumentation", "Ehemaliges Haus hoher Offiziere"],
      hu: ["Történelmi faház", "A tisztogatásoknak állít emléket", "Részletes dokumentáció", "Magas rangú tisztek egykori háza"],
      ro: ["Casă istorică din lemn", "Comemorează epurările", "Documentație extinsă", "Fostă casă a ofițerilor superiori"],
      en: ["Historic wooden house", "Commemorates the purges", "Extensive documentation", "Former home of high-ranking officers"],
    },
    imageHint: "Memorial Museum for Victims of Political Persecution Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Clădirea principală a primei universități din Mongolia, construită în stil sovietic. Este inima academică a țării.",
      en: "The main building of Mongolia's first university, built in Soviet style. It is the academic heart of the country.",
    },
    facts: {
      de: ["Gegründet 1942", "Sowjetische Architektur", "Älteste Universität des Landes", "Wissenschaftliches Zentrum"],
      hu: ["1942-ben alapították", "Szovjet építészeti stílus", "Az ország legrégebbi egyeteme", "Tudományos központ"],
      ro: ["Fondată în 1942", "Arhitectură sovietică", "Cea mai veche universitate", "Centru științific național"],
      en: ["Founded in 1942", "Soviet architectural style", "Oldest university in the country", "National scientific center"],
    },
    imageHint: "National University of Mongolia main building",
  },
  {
    ...
    description: {
      ...
      ro: "Un centru de afaceri modern și complex comercial de lux lângă Piața Sükhbaatar. Găzduiește branduri internaționale și ambasade.",
      en: "A modern business center and luxury shopping mall directly at Sükhbaatar Square. It houses international brands and embassies.",
    },
    facts: {
      de: ["Luxus-Einkaufszentrum", "Zentrale Lage am Platz", "Beherbergt Botschaften", "Modernes Glasdesign"],
      hu: ["Luxus bevásárlóközpont", "Központi fekvés a téren", "Nagykövetségek székhelye", "Modern üveg építészet"],
      ro: ["Centru comercial de lux", "Locație centrală în piață", "Găzduiește ambasade", "Design modern din sticlă"],
      en: ["Luxury shopping center", "Central location by the square", "Houses embassies", "Modern glass design"],
    },
    imageHint: "Central Tower Ulaanbaatar building",
  },
  {
    ...
    description: {
      ...
      ro: "O statuie a călătorului venețian Marco Polo în Ulaanbaatar. Comemorează călătoria sa la curtea lui Kublai Han în secolul al XIII-lea.",
      en: "A statue of the Venetian traveler Marco Polo in Ulaanbaatar. It commemorates his journey to the court of Kublai Khan in the 13th century.",
    },
    facts: {
      de: ["Errichtet 2011", "Nahe dem Central Tower", "Bronze-Skulptur", "Erinnert an Seidenstraßen-Handel"],
      hu: ["2011-ben emelték", "A Central Tower közelében", "Bronz szobor", "A Selyemút emlékezetét őrzi"],
      ro: ["Ridicată în 2011", "Lângă Central Tower", "Sculptură în bronz", "Amintește de Drumul Mătăsii"],
      en: ["Erected in 2011", "Near Central Tower", "Bronze sculpture", "Commemorates Silk Road history"],
    },
    imageHint: "Marco Polo Statue Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "O mănăstire budistă modernă fondată de Bakula Rinpoche. Este un centru educațional important pentru budismul tibetan.",
      en: "A modern Buddhist monastery founded by Bakula Rinpoche. It is an important educational center for Tibetan Buddhism.",
    },
    facts: {
      de: ["Gegründet 1999", "Lehrstätte für Buddhismus", "Besonderer indischer Einfluss", "Moderne Tempelanlage"],
      hu: ["1999-ben alapították", "Buddhista oktatási központ", "Különleges indiai hatás", "Modern templomegyüttes"],
      ro: ["Fondată în 1999", "Centru de învățământ budist", "Influență indiană specială", "Complex de temple modern"],
      en: ["Founded in 1999", "Buddhist teaching center", "Special Indian influence", "Modern temple complex"],
    },
    imageHint: "Bakula Rinpoche Monastery Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "Un centru al renașterii budismului mongol lângă mănăstirea Gandan. Complexul găzduiește învățături budiste tradiționale.",
      en: "A center of the revival of Mongolian Buddhism near the Gandan Monastery. The complex houses traditional Buddhist teachings.",
    },
    facts: {
      de: ["Nahe dem Gandan-Kloster", "Zentrum für buddhistische Studien", "Hübsche Tempelarchitektur", "Ort für religiöse Rituale"],
      hu: ["A Gandan kolostor közelében", "Buddhista tanulmányi központ", "Szép templomi építészet", "Vallási rituálék helyszíne"],
      ro: ["Lângă mănăstirea Gandan", "Centru de studii budiste", "Arhitectură frumoasă a templelor", "Loc pentru ritualuri religioase"],
      en: ["Near Gandan Monastery", "Center for Buddhist studies", "Beautiful temple architecture", "Site for religious rituals"],
    },
    imageHint: "Pethub Monastery Ulaanbaatar exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Un muzeu în aer liber care prezintă istoria căilor ferate mongole. Găzduiește vechi locomotive cu abur și vagoane istorice.",
      en: "An open-air museum showing the history of Mongolian railways. It houses old steam locomotives and historic carriages.",
    },
    facts: {
      de: ["Alte Dampflokomotiven", "Nahe dem Hauptbahnhof", "Geschichte der Transmongolischen Bahn", "Freiluft-Ausstellung"],
      hu: ["Régi gőzmozdonyok", "A főpályaudvar közelében", "A transzmongol vasút története", "Szabadtéri kiállítás"],
      ro: ["Locomotive vechi cu abur", "Lângă gara centrală", "Istoria căii ferate trans-mongole", "Expoziție în aer liber"],
      en: ["Old steam locomotives", "Near the central station", "History of Trans-Mongolian railway", "Outdoor exhibition"],
    },
    imageHint: "Mongolian Railway Museum locomotives",
  },
  {
    ...
    description: {
      ...
      ro: "Cea mai importantă colecție de artă contemporană mongolă. Picturi și sculpturi prezintă modernitatea culturii nomade.",
      en: "The most important collection of Mongolian contemporary art in Ulaanbaatar. Paintings and sculptures show nomad traditions meeting modernity.",
    },
    facts: {
      de: ["Über 10.000 Kunstwerke", "Zeitgenössische mongolische Kunst", "Gegenüber dem Opernhaus", "Zentrum für Bildende Kunst"],
      hu: ["Több mint 10 000 műalkotás", "Kortárs mongol művészet", "Az Operaházzal szemben", "Képzőművészeti központ"],
      ro: ["Peste 10.000 de opere", "Artă mongolă contemporană", "Peste drum de Operă", "Centru de arte vizuale"],
      en: ["Over 10,000 artworks", "Contemporary Mongolian art", "Opposite the Opera House", "Visual arts center"],
    },
    imageHint: "Mongolian National Modern Art Gallery exterior",
  },
  {
    ...
    description: {
      ...
      ro: "O statuie a fostului lider mongol Horloogiin Choibalsan în fața universității. Simbolizează construcția statului mongol în secolul XX.",
      en: "A statue of former Mongolian leader Khorloogiin Choibalsan in front of the university. It symbolizes the 20th-century Mongolian state building.",
    },
    facts: {
      de: ["Vor der Nationaluniversität", "Historische Persönlichkeit", "Symbol der Ära der Republik", "Bronzestatue"],
      hu: ["A Nemzeti Egyetem előtt áll", "Fontos történelmi személyiség", "A népköztársasági korszak jelképe", "Bronzszobor"],
      ro: ["În fața Universității Naționale", "Personalitate istorică marcantă", "Simbol al erei republicane", "Statuie din bronz"],
      en: ["In front of National University", "Major historical figure", "Symbol of the republican era", "Bronze statue"],
    },
    imageHint: "Choibalsan Statue Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "O clădire rotundă spectaculoasă, centrul acrobației mongole timp de decenii. Artiștii mongoli sunt renumiți mondial pentru performanțe.",
      en: "A striking round building that was the center of acrobatics for decades. Mongolian circus performers are world-renowned for their skills.",
    },
    facts: {
      de: ["Baujahr 1971", "Markante runde Form", "Zentrum für Akrobatik", "Sowjetisches Architekturdesign"],
      hu: ["1971-ben épült", "Jellegzetes kerek forma", "Az akrobatika központja", "Szovjet építészeti dizájn"],
      ro: ["Construit în 1971", "Formă rotundă distinctivă", "Centru de acrobație", "Design arhitectural sovietic"],
      en: ["Built in 1971", "Distinctive round shape", "Center for acrobatics", "Soviet architectural design"],
    },
    imageHint: "Mongolian State Circus building Ulaanbaatar",
  },
  {
    ...
    description: {
      ...
      ro: "O clădire decorată din era sovietică, unde se țin și astăzi cele mai multe căsătorii oficiale. O moștenire arhitecturală elegantă.",
      en: "An ornate Soviet-era building where most official weddings are still held today. It is an elegant architectural heritage site.",
    },
    facts: {
      de: ["Sowjetische Architektur", "Ort offizieller Trauungen", "Zentrale Lage in UB", "Beliebter Fotostandort"],
      hu: ["Szovjet építészet", "Hivatalos házasságkötések helye", "UB központi részén található", "Népszerű fotózási helyszín"],
      ro: ["Arhitectură sovietică", "Locul căsătoriilor oficiale", "Situat în centrul UB", "Loc popular pentru fotografii"],
      en: ["Soviet architecture", "Site of official weddings", "Central location in UB", "Popular photography spot"],
    },
    imageHint: "Ulaanbaatar Wedding Palace exterior",
  },
  {
    ...
    description: {
      ...
      ro: "Un muzeu din Mörön care prezintă cultura și natura regiunii Khuvsgul. Ilustrează viața crescătorilor de reni.",
      en: "A museum in Mörön showcasing the culture and nature of the Khuvsgul region. It highlights the life of reindeer herders.",
    },
    facts: {
      de: ["Standort: Mörön", "Exponate der Tsaatan-Kultur", "Naturhistorische Sammlung", "Regionale Schätze"],
      hu: ["Helyszín: Mörön", "A tsaatan kultúra tárgyai", "Természettudományi gyűjtemény", "Regionális kincsek"],
      ro: ["Locație: Mörön", "Exponate ale culturii Tsaatan", "Colecție de istorie naturală", "Comori regionale"],
      en: ["Location: Mörön", "Tsaatan culture exhibits", "Natural history collection", "Regional treasures"],
    },
    imageHint: "Khuvsgul Province Museum Mörön",
  }
];
