...
export const spainOtherExtra: POI[] = [
  {
    ...
    description: {
      de: "Der höchste Berg Spaniens und ein beeindruckender Vulkan auf Teneriffa.",
      hu: "Spanyolország legmagasabb hegye és lenyűgöző vulkánja Tenerifén.",
      ...
      es: "La montaña más alta de España y un impresionante volcán en Tenerife.",
      pt: "A montanha mais alta de Espanha e um impressionante vulcão em Tenerife.",
      fr: "La plus haute montagne d'Espagne et un volcan impressionnant à Tenerife.",
    },
    descriptionAdvanced: {
      de: "Der Teide ist ein gewaltiger Schichtvulkan auf der Kanareninsel Teneriffa und mit 3.715 Metern die höchste Erhebung auf spanischem Staatsgebiet. Von seinem Fuß am Meeresboden aus gemessen erhebt er sich etwa 7.500 Meter und gilt damit als der dritthöchste Inselvulkan der Welt. Der Vulkan bildet das Zentrum des 1954 gegründeten Nationalparks Teide, der eine Fläche von rund 190 Quadratkilometern umfasst und durch seine bizarren Lavaformationen und Kraterlandschaften besticht. Geologisch gesehen ist der Teide Teil eines komplexen Kalderasystems, das Einblicke in die Entstehungsgeschichte der Insel bietet. Im Jahr 2007 wurde der Nationalpark aufgrund seiner außergewöhnlichen natürlichen Schönheit und seiner wissenschaftlichen Bedeutung zum UNESCO-Weltnaturerbe erklärt. Der Teide gilt als schlafender Vulkan; sein letzter Ausbruch erfolgte im Jahr 1909 an der Chinyero-Flanke. Heute ist er ein wichtiges Ziel für den Tourismus und die astronomische Forschung, unterstützt durch die klare Sicht in den Hochlagen.",
      hu: "A Teide egy hatalmas rétegvulkán Tenerife szigetén, amely 3715 méteres magasságával Spanyolország legmagasabb pontja. Az óceán fenekétől mérve magassága eléri a 7500 métert, amivel a világ harmadik legmagasabb szigetvulkáni szerkezetének számít. A vulkán az 1954-ben alapított Teide Nemzeti Park központja, amely mintegy 190 négyzetkilométeren terül el, és különleges lávaformációival, krátereivel egyedülálló holdbéli tájat alkot. Geológiai szempontból a Teide egy összetett kalderarendszer része, amely fontos információkkal szolgál a sziget kialakulásáról. 2007-ben az UNESCO a Világörökség részévé nyilvánította rendkívüli természeti szépsége és tudományos jelentősége miatt. A Teide jelenleg szunnyadó vulkán, utolsó kitörése 1909-ben történt a Chinyero-hasadékon keresztül. Ma a turizmus mellett a csillagászati kutatások fontos helyszíne a tiszta égbolt és a nagy magasság miatt.",
      ro: "Muntele Teide este un stratovulcan masiv situat pe insula Tenerife din Arhipelagul Canare și reprezintă cel mai înalt punct din Spania, atingând o altitudine de 3.715 metri. Măsurat de la baza sa de pe fundul oceanului, vulcanul se ridică la aproximativ 7.500 de metri, fiind a treia cea mai înaltă structură vulcanică insulară din lume. Vulcanul este piesa centrală a Parcului Național Teide, înființat în 1954, care acoperă aproximativ 190 de kilometri pătrați de peisaje vulcanice unice. Importanța sa geologică rezidă în sistemul complex de caldere și diversele formațiuni de lavă care oferă detalii despre formarea insulei. În 2007, parcul a fost declarat Patrimoniu Mondial UNESCO datorită frumuseții naturale excepționale și importanței sale științifice. Teide este considerat un vulcan adormit, ultima sa erupție având loc în 1909. În prezent, este o destinație majoră pentru turism și observații astronomice datorită cerului senin la altitudini mari.",
      en: "Mount Teide is a massive stratovolcano located on the island of Tenerife in the Canary Islands and is the highest point in Spain, reaching an elevation of 3,715 meters. From its base on the ocean floor, it rises approximately 7,500 meters, making it the third tallest volcanic structure in the world. The volcano is the centerpiece of the Teide National Park, which was established in 1954 and covers about 190 square kilometers of unique volcanic landscape. Its geological significance lies in its complex caldera system and diverse volcanic formations, including lava flows and craters that provide insight into the islands formation. In 2007, the park was declared a UNESCO World Heritage Site due to its exceptional natural beauty and its scientific importance for understanding geological processes. The summit remains dormant, with its last eruption occurring in 1909 from the Chinyero vent, and it continues to be a major site for astronomical observation due to its high altitude and clear skies.",
      es: "El Teide, en el centro de Tenerife (Canarias), es un volcán activo y la montaña más alta de España. Se alza monumentalmente desde una enorme caldera volcánica antigua, Las Cañadas, creando un paisaje surrealista, árido y similar a Marte. Todo el Parque Nacional del Teide es la reserva natural más visitada de España y ha sido declarado Patrimonio de la Humanidad por la UNESCO. Su gran altura proyecta al amanecer la sombra volcánica más larga del mundo sobre el océano. El entorno alpino extremo alberga una flora y fauna únicas adaptadas a las condiciones duras.",
      pt: "O Teide, no centro de Tenerife (Canárias), é um vulcão ativo e a montanha mais alta de Espanha. Ergue-se monumentalmente a partir de uma enorme caldeira vulcânica antiga, Las Cañadas, criando uma paisagem surrealista, árida e semelhante a Marte. Todo o Parque Nacional do Teide é a reserva natural mais visitada de Espanha e foi declarado Património Mundial da UNESCO. A sua grande altura projeta ao amanhecer a sombra vulcânica mais longa do mundo sobre o oceano. O ambiente alpino extremo alberga uma flora e fauna únicas adaptadas às condições duras.",
      fr: "Le Teide, au centre de Tenerife (Canaries), est un volcan actif et la plus haute montagne d'Espagne. Il se dresse monumentalement depuis une énorme caldeira volcanique ancienne, Las Cañadas, créant un paysage surréaliste, aride et semblable à Mars. Tout le parc national du Teide est la réserve naturelle la plus visitée d'Espagne et a été déclaré patrimoine mondial par l'UNESCO. Sa grande hauteur projette à l'aube l'ombre volcanique la plus longue du monde sur l'océan. L'environnement alpin extrême abrite une flore et une faune uniques adaptées aux conditions difficiles.",
    },
    factsAdvanced: {
      de: ["Höchster Berg Spaniens (3.715 m)", "Dritthöchster Inselvulkan der Erde", "UNESCO-Weltnaturerbe seit 2007", "Letzter Ausbruch im Jahr 1909", "Nationalpark umfasst 18.990 Hektar", "Wichtiger Ort für Astronomie"],
      hu: ["Spanyolország legmagasabb hegye (3715 m)", "A Föld harmadik legmagasabb szigetvulkánja", "2007 óta az UNESCO Világörökség része", "Utolsó vulkáni kitörése 1909-ben volt", "A nemzeti park területe 18 990 hektár", "Világhírű csillagászati megfigyelőhely"],
      ro: ["Cel mai înalt munte din Spania (3.715 m)", "Al treilea cel mai înalt vulcan insular", "Patrimoniu Mondial UNESCO din 2007", "Ultima erupție a avut loc în 1909", "Parcul are o suprafață de 18.990 hectare", "Centru important pentru astronomie"],
      en: ["Highest peak in Spain (3,715 m)", "Third tallest island volcano on Earth", "UNESCO World Heritage site since 2007", "Last volcanic eruption occurred in 1909", "National Park covers 18,990 hectares", "Major site for global astronomy"],
      es: ["Con 3718 metros sobre el nivel del mar, el Teide es la cumbre más alta de España.", "Desde el fondo del mar, con más de 7500 metros, es el tercer volcán insular más alto del mundo.", "La árida y extraterrestre atmósfera del Parque Nacional del Teide ha servido de escenario para muchas películas de ciencia ficción.", "El observatorio del Teide es uno de los mejores lugares del mundo para la observación astronómica profesional."],
      pt: ["Com 3718 metros acima do nível do mar, o Teide é o cume mais alto de Espanha.", "Desde o fundo do mar, com mais de 7500 metros, é o terceiro vulcão insular mais alto do mundo.", "A atmosfera árida e extraterrestre do Parque Nacional do Teide serviu de cenário para muitos filmes de ficção científica.", "O observatório do Teide é um dos melhores locais do mundo para a observação astronómica profissional."],
      fr: ["Avec 3718 mètres au-dessus du niveau de la mer, le Teide est le plus haut sommet d'Espagne.", "Depuis le fond de la mer, avec plus de 7500 mètres, c'est le troisième volcan insulaire le plus haut du monde.", "L'atmosphère aride et extraterrestre du parc national du Teide a servi de décor à de nombreux films de science-fiction.", "L'observatoire du Teide est l'un des meilleurs endroits au monde pour l'observation astronomique professionnelle."],
    },
    image: "/poi-images/ES-TEI.webp",
    facts: {
      de: ["Der Gipfel erreicht eine Höhe von 3.715 Metern.", "Vom Meeresgrund gemessen ist er 7.500 Meter hoch.", "Der Teide Nationalpark gehört zum UNESCO-Welterbe.", "Die letzte Eruption fand im Jahr 1909 statt."],
      hu: ["A hegycsúcs magassága 3715 méter.", "A tengerfenéktől mérve magassága eléri a 7500 métert.", "A Teide Nemzeti Park az UNESCO Világörökség része.", "Az utolsó vulkáni kitörés 1909-ben történt."],
      ro: ["Vârful atinge o altitudine de 3.715 metri.", "Măsurat de la fundul mării, are o înălțime de 7.500 m.", "Parcul Național Teide este sit al Patrimoniului UNESCO.", "Cea mai recentă erupție a avut loc în anul 1909."],
      en: ["The peak reaches an altitude of 3,715 meters.", "Measured from the ocean floor, it is 7,500 meters high.", "Teide National Park is a UNESCO World Heritage site.", "The most recent volcanic eruption occurred in 1909."],
      es: [],
      pt: [],
      fr: [],
    },
