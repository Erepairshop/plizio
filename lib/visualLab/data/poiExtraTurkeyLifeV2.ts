...
,
  {
    id: "turkey-kure-mountains-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Parcul protejează păduri virgine și peșteri carstice adânci în nord. Adăpostește urși bruni, râmși și specii rare de păsări de pradă.",
      en: "This park protects dense old-growth forests and deep karst caves in the north. It is home to brown bears, lynxes, and rare raptors.",
    },
    facts: {
      de: ["Gegründet im Jahr 2000", "Fläche von 37.753 Hektar", "PAN Parks zertifiziertes Gebiet", "Beherbergt die Valla-Schlucht"],
      hu: ["2000-ben alapították", "37 753 hektáros terület", "PAN Parks minősítéssel rendelkezik", "Itt található a Valla-kanyon"],
      ro: ["Fondat în anul 2000", "Suprafață de 37.753 hectare", "Certificat de rețeaua PAN Parks", "Găzduiește canionul Valla"],
      en: ["Established in the year 2000", "Area of 37,753 hectares", "PAN Parks certified area", "Home to the Valla Canyon"],
    },
    imageHint: "Kure Mountains forest landscape in Kastamonu",
  },
  {
    id: "turkey-altindere-valley-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Valea oferă o floră și faună bogată în mijlocul Munților Pontici. Este cunoscută pentru cursurile de apă cu păstrăv și pădurile de conifere.",
      en: "The valley offers rich flora and fauna in the heart of the Pontic Mountains. It is known for trout streams and dense coniferous forests.",
    },
    facts: {
      de: ["Gegründet im Jahr 1987", "Lage nahe dem Sumela-Kloster", "Häufige Sichtung von Rehen", "Höhenlage bis zu 1.600 Metern"],
      hu: ["1987-ben alapították", "A Sümela-kolostor közelében fekszik", "Gyakoriak az őzmegfigyelések", "Tengerszint feletti magasság 1600 m"],
      ro: ["Înființat în anul 1987", "Situat lângă Mănăstirea Sumela", "Observări frecvente de căprioare", "Altitudine de până la 1.600 metri"],
      en: ["Established in 1987", "Located near Sumela Monastery", "Frequent roe deer sightings", "Elevation up to 1,600 meters"],
    },
    imageHint: "Altindere Valley pine forests in Trabzon",
  },
  {
    id: "turkey-beydaglari-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Parcul combină păduri de pini mediteraneeni cu ruine antice la mare. Este un loc important de cuibărit pentru țestoasele Caretta caretta.",
      en: "This park combines Mediterranean pine forests with ancient seaside ruins. It is a vital nesting site for Loggerhead sea turtles.",
    },
    facts: {
      de: ["Gegründet im Jahr 1972", "Schützt die antike Stadt Phaselis", "Beherbergt das Ewige Feuer von Chimaera", "Enthält den Berg Tahtalı (2366 m)"],
      hu: ["1972-ben alapították", "Phaselis ókori városát védi", "Itt található a Chimaera örök tüze", "Magában foglalja a Tahtalı-hegyet"],
      ro: ["Înființat în anul 1972", "Protejează orașul antic Phaselis", "Găzduiește focurile eterne Chimaera", "Include muntele Tahtalı (2366 m)"],
      en: ["Established in 1972", "Protects the ancient city of Phaselis", "Home to the Eternal Flames of Chimaera", "Includes Mount Tahtalı (2366 m)"],
    },
    imageHint: "Phaselis ruins within Beydaglari National Park",
  },
  {
    id: "turkey-ilgaz-mountain-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Munții sunt cunoscuți pentru biodiversitatea ridicată și pajiștile alpine. Servește ca refugiu pentru lupi, urși și porci mistreți.",
      en: "The mountain is known for its high biodiversity and alpine meadows. It serves as a sanctuary for wolves, bears, and wild boars.",
    },
    facts: {
      de: ["Gegründet im Jahr 1976", "Teil des nordanatolischen Gebirgszugs", "Reich an endemischen Pflanzenarten", "Wichtiges Skigebiet im Winter"],
      hu: ["1976-ban alapították", "Az Észak-Anatóliai-hegység része", "Gazdag endemikus növényfajokban", "Fontos síközpont télen"],
      ro: ["Înființat în anul 1976", "Parte a lanțului muntos Nord-Anatolian", "Bogat în specii de plante endemice", "Importante stațiuni de schi iarna"],
      en: ["Established in 1976", "Part of the North Anatolian range", "Rich in endemic plant species", "Major skiing destination in winter"],
    },
    imageHint: "Ilgaz Mountain snowy forest landscape",
  },
  {
    id: "turkey-kovada-lake-life-v2",
    type: "lake",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Parcul cuprinde un lac puțin adânc, înconjurat de păduri dense de foioase. Este un habitat important pentru păsări de apă și vidre.",
      en: "The park features a shallow lake surrounded by thick deciduous forests. It is a significant habitat for waterfowl and Eurasian otters.",
    },
    facts: {
      de: ["Gegründet im Jahr 1970", "Maximaltiefe des Sees nur 6 Meter", "Über 150 Vogelarten gesichtet", "Verbindung zum Eğirdir-See"],
      hu: ["1970-ben alapították", "A tó maximális mélysége csak 6 méter", "Több mint 150 madárfajt figyeltek meg", "Összeköttetésben áll az Eğirdir-tóval"],
      ro: ["Fondat în anul 1970", "Adâncimea maximă a lacului este de 6 metri", "Peste 150 de specii de păsări observate", "Conectat cu lacul Eğirdir"],
      en: ["Established in 1970", "Maximum lake depth only 6 meters", "Over 150 bird species recorded", "Connected to Lake Eğirdir"],
    },
    imageHint: "Kovada Lake with autumn foliage reflections",
  },
  {
    id: "turkey-spil-mountain-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Cunoscut pentru caii săi sălbatici și lalelele rare de Manisa. Parcul oferă formațiuni geologice impresionante și canioane adânci.",
      en: "Famous for its wild horses and rare Manisa tulips. The park features impressive geological formations and deep limestone canyons.",
    },
    facts: {
      de: ["Gegründet im Jahr 1968", "Heimat der Manisa-Tulpe", "Höchster Punkt auf 1.517 Metern", "Beherbergt die 'Weinende Fels'-Statue"],
      hu: ["1968-ban alapították", "A manisai tulipán hazája", "Legmagasabb pontja 1517 méter", "Itt található a 'Sírós szikla' szobor"],
      ro: ["Înființat în anul 1968", "Patria lalelei de Manisa", "Punctul culminant la 1.517 metri", "Găzduiește statuia 'Stânca Plângătoare'"],
      en: ["Established in 1968", "Home to the Manisa Tulip", "Highest peak at 1,517 meters", "Contains the 'Weeping Rock' formation"],
    },
    imageHint: "Wild horses on Spil Mountain near Manisa",
  },
  {
    id: "turkey-honaz-mountain-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Cel mai înalt vârf din regiunea Egeeană găzduiește o varietate excepțională de plante endemice. Este acoperit de pini și cedri.",
      en: "The highest peak in the Aegean region hosts an extraordinary diversity of endemic plants. It is covered in pine and cedar forests.",
    },
    facts: {
      de: ["Gegründet im Jahr 1995", "Gipfelhöhe beträgt 2.571 Meter", "964 Pflanzenarten dokumentiert", "Wichtiger Brutplatz für Steinadler"],
      hu: ["1995-ben alapították", "Csúcsmagassága 2571 méter", "964 növényfajt dokumentáltak", "Fontos fészkelőhely szirti sasoknak"],
      ro: ["Fondat în anul 1995", "Altitudinea maximă este de 2.571 metri", "964 de specii de plante documentate", "Loc important de cuibărit pentru acvile"],
      en: ["Established in 1995", "Summit elevation is 2,571 meters", "964 plant species documented", "Important nesting site for golden eagles"],
    },
    imageHint: "Snowy peak of Mount Honaz in Denizli",
  },
  {
    id: "turkey-sultan-reeds-life-v2",
    type: "wildlife",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Una dintre cele mai importante zone umede din Turcia pentru păsările migratoare. Oferă locuri de cuibărit pentru flamingo și pelicani.",
      en: "One of Turkey's most important wetlands for migratory birds. It provides breeding grounds for flamingos, pelicans, and herons.",
    },
    facts: {
      de: ["Gegründet im Jahr 2006", "Ramsar-Schutzgebiet seit 1994", "Über 300 Vogelarten beobachtet", "Blick auf den Vulkan Erciyes"],
      hu: ["2006-ban alapították", "1994 óta Ramsari terület", "Több mint 300 madárfajt láttak", "Kilátás az Erciyes-vulkánra"],
      ro: ["Fondat în anul 2006", "Sit Ramsar din anul 1994", "Peste 300 de specii de păsări observate", "Vedere spre vulcanul Erciyes"],
      en: ["Established in 2006", "Ramsar site since 1994", "Over 300 bird species observed", "View of Mount Erciyes volcano"],
    },
    imageHint: "Flamingos in Sultan Reeds wetland Kayseri",
  },
  {
    id: "turkey-abant-lake-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Un lac pitoresc de apă dulce înconjurat de păduri de brazi și fagi. Este casa păstrăvului de Abant, o specie endemică.",
      en: "A picturesque freshwater lake surrounded by fir and beech forests. It is the sole habitat of the endemic Abant trout.",
    },
    facts: {
      de: ["Gegründet im Jahr 1988", "Liegt auf 1.328 Metern Höhe", "Umfang des Sees etwa 7 km", "Bekannt für seine Seerosen"],
      hu: ["1988-ban alapították", "1328 méter magasan fekszik", "A tó kerülete kb. 7 km", "Tavirózsáiról is nevezetes"],
      ro: ["Înființat în anul 1988", "Situat la 1.328 metri altitudine", "Circumferința lacului este de 7 km", "Cunoscut pentru nuferii săi"],
      en: ["Established in 1988", "Located at 1,328 meters altitude", "Lake perimeter is about 7 km", "Known for its water lilies"],
    },
    imageHint: "Abant Lake surrounded by pine forest in Bolu",
  },
  {
    id: "turkey-ataturk-arboretum-life-v2",
    type: "park",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Un muzeu viu de plante situat în Pădurea Belgrad din Istanbul. Găzduiește mii de specii de arbori exotici și nativi.",
      en: "A living plant museum located within Istanbul's Belgrad Forest. It hosts thousands of exotic and native tree species.",
    },
    facts: {
      de: ["Eröffnet im Jahr 1949", "Fläche von 296 Hektar", "Über 2.000 verschiedene Taxa", "Verfügt über drei künstliche Seen"],
      hu: ["1949-ben nyitották meg", "296 hektáros terület", "Több mint 2000 különböző taxon", "Három mesterséges tóval rendelkezik"],
      ro: ["Deschis în anul 1949", "Suprafață de 296 hectare", "Peste 2.000 de taxoni diferiți", "Dispune de trei lacuri artificiale"],
      en: ["Opened in 1949", "Area of 296 hectares", "Over 2,000 different plant taxa", "Features three artificial lakes"],
    },
    imageHint: "Colorful autumn trees at Atatürk Arboretum Istanbul",
  },
  {
    id: "turkey-duzlercami-wildlife-life-v2",
    type: "wildlife",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Această zonă este crucială pentru supraviețuirea cerbului lopătar anatolian. Se află la poalele Munților Taurus.",
      en: "This area is critical for the survival of the Anatolian fallow deer. It is located in the foothills of the Taurus Mountains.",
    },
    facts: {
      de: ["Einziger Ort für wilde Damhirsche", "Beherbergt die Güver-Schlucht", "Schützt seltene Wildziegenarten", "Reich an monumentalen Eichen"],
      hu: ["A dámvadak egyetlen vadon élő helye", "Itt található a Güver-kanyon", "Ritka vadkecskefajokat véd", "Monumentális tölgyfákban gazdag"],
      ro: ["Singurul loc cu cerbi lopătari sălbatici", "Găzduiește canionul Güver", "Protejează specii rare de capre negre", "Bogat în stejari monumentali"],
      en: ["Only site for wild fallow deer", "Home to the Güver Canyon", "Protects rare wild goat species", "Rich in monumental oak trees"],
    },
    imageHint: "Fallow deer in Düzlerçamı forest Antalya",
  },
  {
    id: "turkey-gala-lake-life-v2",
    type: "wildlife",
    parent: "TR",
    ...
    description: {
      ...
      ro: "O zonă umedă majoră la gura de vărsare a râului Meriț, lângă graniță. Servește ca oprire importantă pentru păsările migratoare.",
      en: "A major wetland at the mouth of the Meriç River near the border. It serves as a vital stopover for European migratory birds.",
    },
    facts: {
      de: ["Gegründet im Jahr 2005", "Besteht aus See- und Sumpfflächen", "Schutz für den Krauskopfpelikan", "Wichtiges Fischereigebiet"],
      hu: ["2005-ben alapították", "Tavi és mocsári területekből áll", "A borzas pelikán védett helye", "Fontos halászati terület"],
      ro: ["Înființat în anul 2005", "Compus din lacuri și mlaștini", "Protejează pelicanul creț", "Zonă importantă pentru pescuit"],
      en: ["Established in 2005", "Consists of lake and marsh areas", "Protects the Dalmatian pelican", "Significant fishery region"],
    },
    imageHint: "Bird watching tower at Gala Lake Edirne",
  },
  {
    id: "turkey-birecik-ibis-life-v2",
    type: "wildlife",
    parent: "TR",
    ...
    description: {
      ...
      ro: "Centrul este dedicat salvării păsării Ibis pleșov, aflată în pericol de dispariție. Se află pe malul râului Eufrat.",
      en: "The center is dedicated to saving the critically endangered Northern Bald Ibis. It is located on the banks of the Euphrates River.",
    },
    facts: {
      de: ["Gegründet im Jahr 1977", "Letzte Wildpopulation der Region", "Pflanzungsstation am Felsrand", "Vögel gelten als Glücksbringer"],
      hu: ["1977-ben alapították", "A régió utolsó vadon élő populációja", "Sziklafal menti fészkelőhelyek", "A madarakat szerencsehozónak tartják"],
      ro: ["Înființat în anul 1977", "Ultima populație sălbatică din regiune", "Stație de reproducere pe stânci", "Păsările sunt considerate aducătoare de noroc"],
      en: ["Established in 1977", "Last wild population in the region", "Breeding station on limestone cliffs", "Birds are seen as symbols of luck"],
    },
    imageHint: "Northern Bald Ibis at Birecik breeding center",
  },
  {
    id: "turkey-nallihan-bird-sanctuary-life-v2",
    type: "wildlife",
    parent: "TR",
    ...
    description: {
      ...
      ro: "O zonă umedă artificială cu munți colorați impresionanți în fundal. Găzduiește berze negre și numeroase specii de rațe.",
      en: "An artificial wetland with striking colorful mountains in the background. It hosts black storks and numerous duck species.",
    },
    facts: {
      de: ["Liegt am Sarıyar-Staudamm", "Berühmt für regenbogenfarbene Hügel", "Über 190 Vogelarten dokumentiert", "Keine menschliche Siedlung erlaubt"],
      hu: ["A Sarıyar-gátnál található", "Szivárványos dombjairól híres", "Több mint 190 madárfajt jegyeztek fel", "Emberi település nem engedélyezett"],
      ro: ["Situat la barajul Sarıyar", "Faimos pentru dealurile curcubeu", "Peste 190 de specii de păsări documentate", "Nicio așezare umană permisă"],
      en: ["Located at the Sarıyar Dam", "Famous for rainbow-colored hills", "Over 190 bird species recorded", "No human settlement allowed nearby"],
    },
    imageHint: "Colorful mountains at Nallıhan Bird Sanctuary Ankara",
  }
];
