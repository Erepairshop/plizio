...
export const poiExtraHu1: POI[] = [
  // HU-BU: Budapest
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Óbuda este cel mai vechi cartier al Budapestei, având o istorie care începe cu orașul roman Aquincum. Situat în partea de nord a Budei, cartierul păstrează un amestec fascinant de ruine antice, clădiri baroce și complexe de locuințe moderne. Piața Principală (Fő tér) din Óbuda este renumită pentru atmosfera sa istorică conservată perfect, fiind inima culturală a zonei. Aici se găsesc numeroase muzee, precum Muzeul Vasarely și Muzeul Kiscelli, dar și restaurante tradiționale unde se poate gusta atmosfera vechiului oraș. Óbuda este de asemenea faimoasă pentru Insula Hajógyári, care găzduiește anual festivalul internațional Sziget, transformând cartierul într-un centru mondial al muzicii și culturii tinere. Istorie K8 – Straturile istorice ale Budapestei.",
    ...
    factsAdvanced: {
      ...
      ro: ["Óbuda a fost un oraș independent până în 1873, când s-a unit cu Buda și Pesta.", "Numele său înseamnă 'Buda Veche', referindu-se la așezarea originală.", "Amfiteatrul militar roman din Óbuda este unul dintre cele mai mari din afara Italiei.", "Cartierul a fost centrul industriei textile și navale a capitalei în secolul XIX.", "Aici se află 'Sinagoga din Óbuda', una dintre cele mai frumoase clădiri clasiciste.", "Sziget Festival, organizat aici pe insulă, atrage anual peste 500.000 de vizitatori."],
      en: []
    },
    facts: {
    ...
    }, image: "/poi-images/city-obuda-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Újpest, situat în partea de nord a Pestei, este un cartier cu o identitate industrială și sportivă puternică, fiind fondat în secolul al XIX-lea ca o așezare muncitorească modernă. Orașul s-a dezvoltat rapid datorită proximității Dunării și a căii ferate, devenind un centru al industriei pielăriei, mobilei și farmaceutice. Újpest este faimos în întreaga Ungarie pentru clubul său de fotbal legendar, Újpest FC, și pentru spiritul comunitar unit al locuitorilor săi. Turnul de apă din Újpest este simbolul arhitectural al cartierului, fiind vizibil de la mare distanță. Astăzi, cartierul trece printr-un proces de regenerare urbană, transformând vechile zone industriale în spații de locuit moderne și parcuri primitoare pentru familii. Geografie K8 – Dezvoltarea urbană și zonele industriale.",
    ...
    factsAdvanced: {
      ...
      ro: ["Újpest a primit statutul de oraș abia în anul 1907.", "Districtul este casa clubului Újpest FC, unul dintre cele mai vechi și de succes cluburi de fotbal din țară.", "Turnul de apă (Víztorony) are o înălțime de 27 de metri și a fost construit în 1911.", "Fabrica de medicamente Chinoin (acum Sanofi) este unul dintre cei mai mari angajatori istorici.", "Újpest a fost unit cu Budapesta în anul 1950, devenind Sectorul IV.", "Piața din Újpest este una dintre cele mai mari și mai moderne piețe agro-alimentare din capitală."],
      en: []
    },
    facts: {
    ...
    }, image: "/poi-images/city-ujpest-extra.webp"},
  {
    ...
    descriptionAdvanced: {
      ...
      ro: "Citadela de pe Dealul Gellért este o fortificație strategică construită de Imperiul Austriac după înfrângerea revoluției maghiare din 1848-1849. Scopul său inițial a fost de a intimida populația rebelă a Pestei, tunurile sale fiind îndreptate direct spre oraș. Situată în cel mai înalt punct al centrului capitalei, Citadela oferă o panoramă uluitoare asupra Dunării și a podurilor sale, fiind inclusă în Patrimoniul Mondial UNESCO. Statuia Libertății, ridicată în 1947 pe platforma sud-estică, a devenit simbolul Budapestei, fiind vizibilă din aproape orice punct al orașului. În prezent, Citadela trece printr-un proces major de reconstrucție pentru a fi transformată dintr-un simbol al opresiunii într-un parc public modern și un centru cultural. Istorie K8 – Lupta pentru libertate și simbolurile puterii.",
    ...
    factsAdvanced: {
      ...
      ro: ["Citadela a fost construită în 1851 de generalul austriac Julius Jacob von Haynau.", "Zidurile fortificației au o lungime de 220 de metri și o lățime de 60 de metri.", "Statuia Libertății are o înălțime de 14 metri, fiind așezată pe un piedestal de 26 de metri.", "În timpul celui de-al Doilea Război Mondial, Citadela a fost un punct de apărare antiaeriană german.", "Buncărul de sub Citadelă găzduiește o expoziție despre asediul Budapestei din 1944-1945.", "Panorama de aici este considerată una dintre cele mai frumoase vederi urbane din lume."],
      en: []
    },
    facts: {
