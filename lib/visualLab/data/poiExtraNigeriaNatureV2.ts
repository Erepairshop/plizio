...
export const poiExtraNigeriaNatureV2: POI[] = [
  {
    ...
    type: "river",
    parent: "NG-KO",
    coords: [6.7333, 5.3333],
    name: { de: "Niger", hu: "Niger", ro: "Niger", en: "Niger",
image: "/poi-images/niger-river-nature-v2.webp"
},
    description: { de: "Der drittlängste Fluss Afrikas, der durch Nigeria fließt.", hu: "Afrika harmadik leghosszabb folyója, amely átfolyik Nigérián.", ro: "Al treilea cel mai lung fluviu din Africa, care traversează Nigeria.", en: "The third-longest river in Africa, flowing through Nigeria." },
    facts: {
      de: ["Entspringt im Hochland von Guinea.", "Mündet in den Golf von Guinea."],
    ...
    descriptionAdvanced: {
      de: "Der Niger ist die bedeutendste Wasserstraße Guineas und einer der mächtigsten Ströme Afrikas. Geografisch entspringt er im guineischen Hochland, in der Nähe der Stadt Faranah, auf einer Höhe von etwa 800 Metern über dem Meeresspiegel. In Guinea wird der Fluss oft als 'Djoliba' bezeichnet, was in der Malinké-Sprache 'Großer Strom' bedeutet. Auf seinem Weg durch Oberguinea bildet der Niger das Rückgrat des Ökosystems und der lokalen Wirtschaft, indem er fruchtbare Schwemmlandebenen für den Reisanbau bewässert und als wichtige Verkehrsader dient. Der Fluss fließt zunächst nach Norden in Richtung Mali, bevor er seinen charakteristischen Bogen durch die Sahara beschreibt. Historisch gesehen war der Niger die Wiege großer westafrikanischer Reiche wie des Mali- und des Songhai-Reiches, die ihren Reichtum dem Handel auf diesem Strom verdankten. Das Leben an den Ufern des Nigers ist geprägt durch den Rhythmus der saisonalen Fluten, die lebenswichtige Sedimente auf die Felder bringen. Wirtschaftlich ist der Niger heute für Guinea unverzichtbar für die Fischerei, den Transport und zunehmend für die Erzeugung von Wasserkraft. Für das guineische Volk ist der Niger ein heiliges Erbe und ein Symbol der regionalen Verbundenheit, da er Westafrika über tausende Kilometer miteinander verknüpft.",
      hu: "A Niger Guinea legfontosabb vízi útja és Afrika egyik leghatalmasabb folyama. Földrajzilag a guineai fennsíkon, Faranah városa közelében ered, mintegy 800 méteres tengerszint feletti magasságban. Guineában a folyót gyakran „Djoliba” néven emlegetik, ami malinké nyelven „Hatalmas Folyamot” jelent. Felső-Guineán áthaladva a Niger alkotja a régió ökoszisztémájának és gazdaságának gerincét: öntözi a termékeny ártéri rizsföldeket és fontos közlekedési útvonalként szolgál. A folyó először észak felé, Mali irányába tart, mielőtt leírná jellegzetes kanyarulatát a Szahara felé. Történelmileg a Niger volt a bölcsője a nagy nyugat-afrikai államoknak, mint a Mali és a Szonghai Birodalom, amelyek gazdagságukat a folyó menti kereskedelemnek köszönhették. A Niger partján zajló életet az éves áradások ritmusa határozza meg, amelyek éltető hordalékot hoznak a termőföldekre. Gazdaságilag a folyam ma is nélkülözhetetlen Guinea számára a halászat, a szállítmányozás és egyre inkább a vízi energia termelése szempontjából. A guineai nép számára a Niger szent örökség és a regionális összetartozás jelképe, amely több ezer kilométeren át köti össze Nyugat-Afrika népeit.",
      ro: "Nigerul este cea mai importantă arteră hidrografică a Guineei și unul dintre cele mai mari fluvii ale Africii. Geografic, acesta izvorăște din munții Guineei, în apropierea orașului Faranah, la o altitudine de aproximativ 800 de metri peste nivelul mării. În Guineea, fluviul este adesea numit „Djoliba”, ceea ce în limba Malinké înseamnă „Marele Curs de Apă”. Traversând regiunea Guineei Superioare, Nigerul reprezintă coloana vertebrală a ecosistemului și a economiei locale, irigând câmpiile fertile pentru cultura orezului și servind ca o cale vitală de transport. Fluviul curge inițial spre nord, către Mali, înainte de a descrie arcul său caracteristic prin regiunea Sahelului. Din punct de vedere istoric, Nigerul a fost leagănul marilor imperii vest-africane, precum Imperiul Mali și Imperiul Songhai, care și-au clădit prosperitatea pe comerțul fluvial. Viața pe malurile Nigerului este dictată de ritmul inundațiilor sezoniere, care depun sedimente prețioase pe terenurile agricole. Astăzi, Nigerul este indispensabil pentru pescuit, transport și, tot mai mult, pentru producția de energie hidroelectrică. Pentru poporul guineean, Nigerul este o moștenire sacră și un simbol al unității regionale, legând diverse națiuni de-a lungul a mii de kilometri.",
      en: "The Niger is Guinea's most vital waterway and one of Africa's mightiest rivers. Geographically, it originates in the Guinean highlands near the town of Faranah, at an elevation of approximately 800 meters above sea level. In Guinea, the river is often called the 'Djoliba,' which in the Malinké language translates to 'Great River.' As it flows through Upper Guinea, the Niger forms the backbone of the region's ecosystem and economy, irrigating fertile floodplains for rice cultivation and serving as a major transport artery. The river initially flows north toward Mali before describing its characteristic great bend toward the Sahara. Historically, the Niger was the cradle of great West African civilizations, such as the Mali and Songhai Empires, which derived their wealth from riverine trade. Daily life along the Niger is governed by the rhythm of seasonal floods that bring essential nutrients to the fields. Economically, the river is indispensable for fishing, transport, and increasingly for hydroelectric power generation. For the Guinean people, the Niger is a sacred heritage and a symbol of regional connectivity, linking West African nations across thousands of kilometers."
    },
    factsAdvanced: {
      de: ["Der Niger ist mit 4.180 km der drittlängste Fluss Afrikas.", "Seine Quelle liegt in den Bergen von Tembakounda in Guinea.", "In Guinea ist der Fluss auf weiten Strecken für Pirogen schiffbar.", "Der Niger liefert das Wasser für die riesigen Reisfelder von Kouroussa und Kankan.", "Der Fluss beheimatet seltene Arten wie das Afrikanische Manati.", "Der Niger gilt als die spirituelle Lebensader des Mandinka-Volkes."],
      hu: ["A Niger 4180 kilométeres hosszával Afrika harmadik leghosszabb folyója.", "A folyó forrása a guineai Tembakounda-hegyekben található.", "A guineai szakaszon a folyó fontos közlekedési útvonal a pirogok számára.", "A folyam biztosítja az ivóvizet és az öntözővizet Felső-Guinea nagyvárosai számára.", "A Niger folyó mentén alakultak ki Nyugat-Afrika legősibb városi civilizációi.", "A folyó vízhozama alapvetően határozza meg a térség energiabiztonságát."],
      ro: ["Izvorul Nigerului se află la doar 240 km de Oceanul Atlantic, dar fluviul curge spre interior.", "Bazinul Nigerului în Guineea este o zonă protejată de importanță internațională.", "Fluviul este vital pentru pescuitul de apă dulce, sursa principală de proteine locale.", "Nigerul este reprezentat în simbolistica națională ca sursă a fertilității.", "Debitul său variază dramatic între sezonul uscat și cel ploios.", "Djoliba este numele sub care fluviul este celebrat în epopeile Mandinka."],
      en: ["The Niger is the third-longest river in Africa, stretching 4,180 km.", "Its source is located in the Tembakounda Mountains near the Sierra Leone border.", "The river is navigable by traditional pirogues for several hundred kilometers in Guinea.", "It provides the essential silt and water for the vast Upper Guinea rice basins.", "The Niger basin in Guinea is home to over 250 species of freshwater fish.", "It serves as a primary logistical link for trade between Guinea and Mali."]
    }
  },
  {
...
image: "/poi-images/benue-river-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      hu: "Benue A Niger legfontosabb mellékfolyója. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: kamerunon és Nigérián keresztül folyik, valamint hossza körülbelül 1400 km. A térkép szempontjából Benue jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Benue arculatán. Mindezek alapján Benue fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Benue Cel mai important afluent al fluviului Niger. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: curge prin Camerun și Nigeria și are o lungime de aproximativ 1400 km. Din perspectivă cartografică, Benue arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Benue. Pe ansamblu, Benue reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
    ...
    factsAdvanced: {
      ...
      hu: ["Benue a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Benue földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Benue apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Benue influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/chad-lake-nature-v2.webp"
    ...
    description: { de: "Ein bedeutender See im Tschadbecken, der Nigeria berührt.", hu: "Fontos tó a Csád-medencében, amely érinti Nigériát.", ro: "Un lac important din Bazinul Ciadului, care atinge Nigeria.", en: "A significant lake in the Chad Basin that touches Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Csád-tó Fontos tó a Csád-medencében, amely érinti Nigériát. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: lefolyástalan tó, valamint területe erősen változó. A térkép szempontjából Csád-tó jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Csád-tó arculatán. Az iskolai földrajzórán Csád-tó jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Csád-tó fontos földrajzi és kulturális hivatkozási pont Nigériában. Társadalomismeret K7 — Nigéria kultúrája és mindennapjai.",
      ro: "Lacul Ciad Un lac important din Bazinul Ciadului, care atinge Nigeria. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: este un lac endoreic și suprafața sa variază considerabil. Din perspectivă cartografică, Lacul Ciad arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Lacul Ciad. Pe ansamblu, Lacul Ciad reprezintă un punct geografic și cultural de referință în Nigeria. Cunoștințe sociale K7 — cultura și viața cotidiană a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Csád-tó a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Csád-tó földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Lacul Ciad apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Lacul Ciad influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/jos-plateau-mountain-nature-v2.webp"
    ...
    description: { de: "Ein Hochland im Zentrum Nigerias.", hu: "Fennsík Nigéria középső részén.", ro: "Un platou înalt în centrul Nigeriei.", en: "A highland area in central Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Jos-fennsík Fennsík Nigéria középső részén. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: vulkáni kőzetből áll, valamint hűvösebb klíma, mint a környezetében. A térkép szempontjából Jos-fennsík jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Jos-fennsík arculatán. Mindezek alapján Jos-fennsík fontos földrajzi és kulturális hivatkozási pont Nigériában. Történelem K8 — Nigéria történelmi és gazdasági öröksége.",
      ro: "Platoul Jos Un platou înalt în centrul Nigeriei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: este format din rocă vulcanică și are un climat mai răcoros decât zona înconjurătoare. Din perspectivă cartografică, Platoul Jos arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Platoul Jos. Pe ansamblu, Platoul Jos reprezintă un punct geografic și cultural de referință în Nigeria. Istorie K8 — moștenirea istorică și economică a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Jos-fennsík a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Jos-fennsík földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Platoul Jos apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Platoul Jos influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/chappal-waddi-mountain-nature-v2.webp"
    ...
    description: { de: "Der höchste Berg Nigerias.", hu: "Nigéria legmagasabb hegye.", ro: "Cel mai înalt munte din Nigeria.", en: "The highest mountain in Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Chappal Waddi Nigéria legmagasabb hegye. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: kamerun határán található, valamint magassága kb. 2419 méter. A térkép szempontjából Chappal Waddi jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Chappal Waddi arculatán. Mindezek alapján Chappal Waddi fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nigéria régiói és természeti adottságai.",
      ro: "Chappal Waddi Cel mai înalt munte din Nigeria. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: situat la granița cu Camerunul și altitudinea de aproximativ 2419 metri. Din perspectivă cartografică, Chappal Waddi arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Chappal Waddi. Pe ansamblu, Chappal Waddi reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — regiunile și particularitățile naturale ale Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Chappal Waddi a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Chappal Waddi földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Chappal Waddi apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Chappal Waddi influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/cross-river-nature-v2.webp"
    ...
    description: { de: "Ein bedeutender Fluss im Südosten Nigerias.", hu: "Jelentős folyó Nigéria délkeleti részén.", ro: "Un râu important în sud-estul Nigeriei.", en: "A significant river in southeastern Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Cross folyó Jelentős folyó Nigéria délkeleti részén. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: trópusi esőerdőn keresztül folyik, valamint az Atlanti-óceánba torkollik. A térkép szempontjából Cross folyó jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Cross folyó arculatán. Mindezek alapján Cross folyó fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Râul Cross Un râu important în sud-estul Nigeriei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: curge prin păduri tropicale și se varsă în Oceanul Atlantic. Din perspectivă cartografică, Râul Cross arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Râul Cross. Pe ansamblu, Râul Cross reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
    ...
    factsAdvanced: {
      ...
      hu: ["Cross folyó a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Cross folyó földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Râul Cross apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Râul Cross influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/ogun-river-nature-v2.webp"
    ...
    description: { de: "Ein Fluss im Südwesten Nigerias, der in die Lagune von Lagos mündet.", hu: "Folyó Nigéria délnyugati részén, amely a Lagos-lagúnába torkollik.", ro: "Un râu în sud-vestul Nigeriei, care se varsă în Laguna Lagos.", en: "A river in southwestern Nigeria that empties into the Lagos Lagoon." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Ogun Folyó Nigéria délnyugati részén, amely a Lagos-lagúnába torkollik. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: az Oyan-gátat táplálja, valamint fontos vízforrás Lagos számára. A térkép szempontjából Ogun jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Ogun arculatán. Mindezek alapján Ogun fontos földrajzi és kulturális hivatkozási pont Nigériában. Társadalomismeret K7 — Nigéria kultúrája és mindennapjai.",
      ro: "Ogun Un râu în sud-vestul Nigeriei, care se varsă în Laguna Lagos. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: alimentează barajul Oyan și sursă importantă de apă pentru Lagos. Din perspectivă cartografică, Ogun arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Ogun. Pe ansamblu, Ogun reprezintă un punct geografic și cultural de referință în Nigeria. Cunoștințe sociale K7 — cultura și viața cotidiană a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Ogun a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Ogun földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Ogun apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Ogun influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/kainji-lake-nature-v2.webp"
    ...
    description: { de: "Ein großer Stausee im Nordwesten Nigerias.", hu: "Nagy víztározó Nigéria északnyugati részén.", ro: "Un mare lac de acumulare în nord-vestul Nigeriei.", en: "A large reservoir in northwestern Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Kainji-víztározó Nagy víztározó Nigéria északnyugati részén. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: a Kainji-gát építése hozta létre, valamint villamosenergia-termelésre használják. A térkép szempontjából Kainji-víztározó jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Kainji-víztározó arculatán. Mindezek alapján Kainji-víztározó fontos földrajzi és kulturális hivatkozási pont Nigériában. Történelem K8 — Nigéria történelmi és gazdasági öröksége.",
      ro: "Lacul de acumulare Kainji Un mare lac de acumulare în nord-vestul Nigeriei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: creat prin construirea barajului Kainji și utilizat pentru energie electrică. Din perspectivă cartografică, Lacul de acumulare Kainji arată clar cum se leagă factorii naturali și umani în această zonă. Pe ansamblu, Lacul de acumulare Kainji reprezintă un punct geografic și cultural de referință în Nigeria. Istorie K8 — moștenirea istorică și economică a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Kainji-víztározó a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Kainji-víztározó földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Lacul de acumulare Kainji apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Lacul de acumulare Kainji influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/lekki-lagoon-nature-v2.webp"
    ...
    description: { de: "Eine Lagune nahe der Küste bei Lagos.", hu: "Lagúna a part közelében, Lagosnál.", ro: "O lagună aproape de coastă, lângă Lagos.", en: "A lagoon near the coast near Lagos." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Lekki-lagúna Lagúna a part közelében, Lagosnál. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: félsós vizű terület, valamint gazdag halállományban. A térkép szempontjából Lekki-lagúna jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Lekki-lagúna arculatán. Az iskolai földrajzórán Lekki-lagúna jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Lekki-lagúna fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nigéria régiói és természeti adottságai.",
      ro: "Laguna Lekki O lagună aproape de coastă, lângă Lagos. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: este o zonă cu apă salmastră și bogată în resurse piscicole. Din perspectivă cartografică, Laguna Lekki arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Laguna Lekki. Pe ansamblu, Laguna Lekki reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — regiunile și particularitățile naturale ale Nigeriei.",
      en: "Lekki Lagoon A lagoon near the coast near Lagos. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: is a brackish water area and rich in fish resources. From a map perspective, Lekki Lagoon clearly shows how natural and human factors connect in this area. The surrounding landscape and the everyday life of local communities have left many marks on Lekki Lagoon. Overall, Lekki Lagoon stands as an important geographic and cultural reference point in Nigeria. Geography K7 — regions and natural features of Nigeria.",
    ...
    factsAdvanced: {
      ...
      hu: ["Lekki-lagúna a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Lekki-lagúna földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Laguna Lekki apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Laguna Lekki influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/niger-delta-nature-v2.webp"
    ...
    description: { de: "Ein weitläufiges Flussdelta am Golf von Guinea.", hu: "Kiterjedt folyódelta a Guineai-öbölben.", ro: "O deltă vastă a fluviului la Golful Guineei.", en: "An extensive river delta on the Gulf of Guinea." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Niger-delta Kiterjedt folyódelta a Guineai-öbölben. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: nagyon gazdag biológiai sokféleségben, valamint fontos ökoszisztéma. A térkép szempontjából Niger-delta jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Niger-delta arculatán. Az iskolai földrajzórán Niger-delta jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Niger-delta fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Delta Nigerului O deltă vastă a fluviului la Golful Guineei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: foarte bogată în biodiversitate și un ecosistem important. Din perspectivă cartografică, Delta Nigerului arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Delta Nigerului. Pe ansamblu, Delta Nigerului reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
    ...
    factsAdvanced: {
      ...
      hu: ["Niger-delta a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Niger-delta földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Delta Nigerului apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Delta Nigerului influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/shere-hills-mountain-nature-v2.webp"
    ...
    description: { de: "Eine Bergkette auf dem Jos-Plateau.", hu: "Hegyvonulat a Jos-fennsíkon.", ro: "Un lanț muntos pe platoul Jos.", en: "A mountain range on the Jos Plateau." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Shere-hegyek Hegyvonulat a Jos-fennsíkon. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: túrázási lehetőségeiről ismert, valamint magas sziklaképződmények. A térkép szempontjából Shere-hegyek jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Shere-hegyek arculatán. Az iskolai földrajzórán Shere-hegyek jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Shere-hegyek fontos földrajzi és kulturális hivatkozási pont Nigériában. Társadalomismeret K7 — Nigéria kultúrája és mindennapjai.",
      ro: "Munții Shere Un lanț muntos pe platoul Jos. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: cunoscut pentru posibilitățile de drumeție și formațiuni stâncoase înalte. Din perspectivă cartografică, Munții Shere arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Munții Shere. Pe ansamblu, Munții Shere reprezintă un punct geografic și cultural de referință în Nigeria. Cunoștințe sociale K7 — cultura și viața cotidiană a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Shere-hegyek a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Shere-hegyek földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Munții Shere apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Munții Shere influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/obudu-plateau-mountain-nature-v2.webp"
    ...
    description: { de: "Ein Hochplateau mit angenehmem Klima.", hu: "Fennsík kellemes éghajlattal.", ro: "Un platou înalt cu o climă plăcută.", en: "A high plateau with a pleasant climate." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Obudu-fennsík Fennsík kellemes éghajlattal. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: népszerű turistacélpont, valamint dús növényzet. A térkép szempontjából Obudu-fennsík jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Obudu-fennsík arculatán. Az iskolai földrajzórán Obudu-fennsík jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Obudu-fennsík fontos földrajzi és kulturális hivatkozási pont Nigériában. Történelem K8 — Nigéria történelmi és gazdasági öröksége.",
      ro: "Platoul Obudu Un platou înalt cu o climă plăcută. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: o destinație turistică populară și vegetație luxuriantă. Din perspectivă cartografică, Platoul Obudu arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Platoul Obudu. Pe ansamblu, Platoul Obudu reprezintă un punct geografic și cultural de referință în Nigeria. Istorie K8 — moștenirea istorică și economică a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Obudu-fennsík a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Obudu-fennsík földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Platoul Obudu apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Platoul Obudu influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/osun-river-nature-v2.webp"
    ...
    description: { de: "Ein spirituell bedeutsamer Fluss im Südwesten Nigerias.", hu: "Spirituálisan jelentős folyó Nigéria délnyugati részén.", ro: "Un râu semnificativ spiritual în sud-vestul Nigeriei.", en: "A spiritually significant river in southwestern Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Osun Spirituálisan jelentős folyó Nigéria délnyugati részén. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: átfolyik az Osun-Osogbo-ligeten, valamint fontos kulturális örökség. A térkép szempontjából Osun jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Osun arculatán. Mindezek alapján Osun fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nigéria régiói és természeti adottságai.",
      ro: "Osun Un râu semnificativ spiritual în sud-vestul Nigeriei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: curge prin Crângul Osun-Osogbo și un patrimoniu cultural important. Din perspectivă cartografică, Osun arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Osun. Pe ansamblu, Osun reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — regiunile și particularitățile naturale ale Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Osun a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Osun földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Osun apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Osun influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/chad-basin-nature-v2.webp"
    ...
    description: { de: "Ein weites Gebiet, das im Nordosten Nigerias liegt.", hu: "Tágas terület, amely Nigéria északkeleti részén fekszik.", ro: "O zonă vastă situată în nord-estul Nigeriei.", en: "A vast area located in the northeast of Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Csád-medence Tágas terület, amely Nigéria északkeleti részén fekszik. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: száraz, félszáraz éghajlat, valamint jelentős a mezőgazdaság számára. A térkép szempontjából Csád-medence jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Csád-medence arculatán. Mindezek alapján Csád-medence fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Bazinul Ciadului O zonă vastă situată în nord-estul Nigeriei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: climat arid până la semiarid și semnificativ pentru agricultură. Din perspectivă cartografică, Bazinul Ciadului arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Bazinul Ciadului. Pe ansamblu, Bazinul Ciadului reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
    ...
    factsAdvanced: {
      ...
      hu: ["Csád-medence a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Csád-medence földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Bazinul Ciadului apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Bazinul Ciadului influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/gashaka-gumti-forest-nature-v2.webp"
    ...
    description: { de: "Nigerias größter Nationalpark mit weiten Waldgebieten.", hu: "Nigéria legnagyobb nemzeti parkja kiterjedt erdőterületekkel.", ro: "Cel mai mare parc național din Nigeria cu zone forestiere vaste.", en: "Nigeria's largest national park with vast forest areas." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Gashaka-Gumti Nemzeti Park Nigéria legnagyobb nemzeti parkja kiterjedt erdőterületekkel. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: számos fajnak ad otthont, valamint hegyvidéki táj. A térkép szempontjából Gashaka-Gumti Nemzeti Park jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Gashaka-Gumti Nemzeti Park arculatán. Mindezek alapján Gashaka-Gumti Nemzeti Park fontos földrajzi és kulturális hivatkozási pont Nigériában. Társadalomismeret K7 — Nigéria kultúrája és mindennapjai.",
      ro: "Parcul Național Gashaka-Gumti Cel mai mare parc național din Nigeria cu zone forestiere vaste. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: găzduiește numeroase specii și peisaj montan. Din perspectivă cartografică, Parcul Național Gashaka-Gumti arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Parcul Național Gashaka-Gumti. Pe ansamblu, Parcul Național Gashaka-Gumti reprezintă un punct geografic și cultural de referință în Nigeria. Cunoștințe sociale K7 — cultura și viața cotidiană a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Gashaka-Gumti Nemzeti Park a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Gashaka-Gumti Nemzeti Park földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Parcul Național Gashaka-Gumti apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Parcul Național Gashaka-Gumti influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/kano-river-nature-v2.webp"
    ...
    description: { de: "Ein Fluss, der die Region um Kano bewässert.", hu: "Folyó, amely öntözi a Kano környéki régiót.", ro: "Un râu care irigă regiunea din jurul orașului Kano.", en: "A river that irrigates the region around Kano." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Kano Folyó, amely öntözi a Kano környéki régiót. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: fontos a mezőgazdaság számára, valamint öntözőrendszereket táplál. A térkép szempontjából Kano jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Kano arculatán. Mindezek alapján Kano fontos földrajzi és kulturális hivatkozási pont Nigériában. Történelem K8 — Nigéria történelmi és gazdasági öröksége.",
      ro: "Kano Un râu care irigă regiunea din jurul orașului Kano. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: important pentru agricultură și alimentează sisteme de irigații. Din perspectivă cartografică, Kano arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Kano. Pe ansamblu, Kano reprezintă un punct geografic și cultural de referință în Nigeria. Istorie K8 — moștenirea istorică și economică a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Kano a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Kano földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Kano apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Kano influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/kaduna-river-nature-v2.webp"
    ...
    description: { de: "Ein wichtiger Zufluss des Nigers.", hu: "A Niger fontos mellékfolyója.", ro: "Un afluent important al Nigerului.", en: "An important tributary of the Niger River." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Kaduna A Niger fontos mellékfolyója. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: átfolyik Nigéria központján, valamint fontos ártéri területeket hoz létre. A térkép szempontjából Kaduna jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Kaduna arculatán. Mindezek alapján Kaduna fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nigéria régiói és természeti adottságai.",
      ro: "Kaduna Un afluent important al Nigerului. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: curge prin centrul Nigeriei și creează lunci importante. Din perspectivă cartografică, Kaduna arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Kaduna. Pe ansamblu, Kaduna reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — regiunile și particularitățile naturale ale Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Kaduna a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Kaduna földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Kaduna apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Kaduna influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/sokoto-river-nature-v2.webp"
    ...
    description: { de: "Ein Zufluss des Nigers im Nordwesten.", hu: "A Niger mellékfolyója északnyugaton.", ro: "Un afluent al Nigerului în nord-vest.", en: "A tributary of the Niger in the northwest." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Sokoto A Niger mellékfolyója északnyugaton. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: fontos vízforrás a szárazabb északon, valamint támogatja a helyi mezőgazdaságot. A térkép szempontjából Sokoto jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Sokoto arculatán. Mindezek alapján Sokoto fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Sokoto Un afluent al Nigerului în nord-vest. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: sursă importantă de apă în nordul mai uscat și susține agricultura locală. Din perspectivă cartografică, Sokoto arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Sokoto. Pe ansamblu, Sokoto reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
    ...
    factsAdvanced: {
      ...
      hu: ["Sokoto a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Sokoto földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Sokoto apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Sokoto influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/hadejia-river-nature-v2.webp"
    ...
    description: { de: "Ein Fluss, der die Hadejia-Nguru-Feuchtgebiete speist.", hu: "Folyó, amely táplálja a Hadejia-Nguru vizes élőhelyeket.", ro: "Un râu care alimentează zonele umede Hadejia-Nguru.", en: "A river that feeds the Hadejia-Nguru wetlands." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Hadejia Folyó, amely táplálja a Hadejia-Nguru vizes élőhelyeket. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: fontos vizes élőhely vándormadaraknak, valamint nagyon fajgazdag. A térkép szempontjából Hadejia jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Hadejia arculatán. Mindezek alapján Hadejia fontos földrajzi és kulturális hivatkozási pont Nigériában. Társadalomismeret K7 — Nigéria kultúrája és mindennapjai.",
      ro: "Hadejia Un râu care alimentează zonele umede Hadejia-Nguru. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: zonă umedă importantă pentru păsările migratoare și foarte bogată în specii. Din perspectivă cartografică, Hadejia arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Hadejia. Pe ansamblu, Hadejia reprezintă un punct geografic și cultural de referință în Nigeria. Cunoștințe sociale K7 — cultura și viața cotidiană a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Hadejia a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Hadejia földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Hadejia apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Hadejia influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/gongola-river-nature-v2.webp"
    ...
    description: { de: "Ein bedeutender Nebenfluss des Benue.", hu: "A Benue jelentős mellékfolyója.", ro: "Un afluent semnificativ al râului Benue.", en: "A significant tributary of the Benue." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Gongola A Benue jelentős mellékfolyója. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: átfolyik Nigéria északkeleti részén, valamint széles folyótájakat hoz létre. A térkép szempontjából Gongola jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Gongola arculatán. Mindezek alapján Gongola fontos földrajzi és kulturális hivatkozási pont Nigériában. Történelem K8 — Nigéria történelmi és gazdasági öröksége.",
      ro: "Gongola Un afluent semnificativ al râului Benue. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: curge prin nord-estul Nigeriei și creează peisaje fluviale vaste. Din perspectivă cartografică, Gongola arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Gongola. Pe ansamblu, Gongola reprezintă un punct geografic și cultural de referință în Nigeria. Istorie K8 — moștenirea istorică și economică a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Gongola a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Gongola földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Gongola apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Gongola influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/yobe-river-nature-v2.webp"
    ...
    description: { de: "Ein Fluss an der Grenze zwischen Nigeria und Niger.", hu: "Folyó Nigéria és Niger határán.", ro: "Un râu la granița dintre Nigeria și Niger.", en: "A river on the border between Nigeria and Niger." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Yobe Folyó Nigéria és Niger határán. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: a Csád-tóba torkollik, valamint fontos a határmenti régió számára. A térkép szempontjából Yobe jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Yobe arculatán. Mindezek alapján Yobe fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nigéria régiói és természeti adottságai.",
      ro: "Yobe Un râu la granița dintre Nigeria și Niger. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: se varsă în Lacul Ciad și important pentru regiunea de frontieră. Din perspectivă cartografică, Yobe arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Yobe. Pe ansamblu, Yobe reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — regiunile și particularitățile naturale ale Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Yobe a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Yobe földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Yobe apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Yobe influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/ogun-forest-nature-v2.webp"
    ...
    description: { de: "Ein Waldgebiet im Südwesten Nigerias.", hu: "Erdős terület Nigéria délnyugati részén.", ro: "O zonă forestieră în sud-vestul Nigeriei.", en: "A forest area in southwestern Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Ogun erdővidék Erdős terület Nigéria délnyugati részén. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: trópusi fáknak ad otthont, valamint fontos a fakitermelés számára. A térkép szempontjából Ogun erdővidék jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Ogun erdővidék arculatán. Mindezek alapján Ogun erdővidék fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Regiunea forestieră Ogun O zonă forestieră în sud-vestul Nigeriei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: găzduiește arbori tropicali și important pentru exploatarea forestieră. Din perspectivă cartografică, Regiunea forestieră Ogun arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Regiunea forestieră Ogun. Pe ansamblu, Regiunea forestieră Ogun reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
    ...
    factsAdvanced: {
      ...
      hu: ["Ogun erdővidék a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Ogun erdővidék földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Regiunea forestieră Ogun apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Regiunea forestieră Ogun influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/osun-forest-nature-v2.webp"
    ...
    description: { de: "Ein Waldgebiet um den heiligen Osun-Fluss.", hu: "Erdő a szent Osun-folyó körül.", ro: "O zonă forestieră în jurul sfântului râu Osun.", en: "A forest area around the sacred Osun river." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Osun-erdő Erdő a szent Osun-folyó körül. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: védett terület, valamint magas ökológiai jelentőség. A térkép szempontjából Osun-erdő jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Osun-erdő arculatán. Az iskolai földrajzórán Osun-erdő jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Osun-erdő fontos földrajzi és kulturális hivatkozási pont Nigériában. Társadalomismeret K7 — Nigéria kultúrája és mindennapjai.",
      ro: "Pădurea Osun O zonă forestieră în jurul sfântului râu Osun. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: zonă protejată și semnificație ecologică ridicată. Din perspectivă cartografică, Pădurea Osun arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Pădurea Osun. Pe ansamblu, Pădurea Osun reprezintă un punct geografic și cultural de referință în Nigeria. Cunoștințe sociale K7 — cultura și viața cotidiană a Nigeriei.",
    ...
    factsAdvanced: {
      ...
      hu: ["Osun-erdő a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Osun-erdő földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Pădurea Osun apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Pădurea Osun influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
...
image: "/poi-images/kainji-forest-nature-v2.webp"
    ...
    description: { de: "Ein bedeutendes Waldgebiet innerhalb des Nationalparks.", hu: "Jelentős erdőterület a nemzeti parkon belül.", ro: "O zonă forestieră semnificativă în cadrul parcului național.", en: "A significant forest area within the national park." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Kainji Nemzeti Park erdője Jelentős erdőterület a nemzeti parkon belül. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: sok vadállat élőhelye, valamint fontos pufferzóna. A térkép szempontjából Kainji Nemzeti Park erdője jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Kainji Nemzeti Park erdője arculatán. Mindezek alapján Kainji Nemzeti Park erdője fontos földrajzi és kulturális hivatkozási pont Nigériában. Történelem K8 — Nigéria történelmi és gazdasági öröksége.",
      ro: "Pădurea Parcului Național Kainji O zonă forestieră semnificativă în cadrul parcului național. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: habitat pentru multe animale sălbatice și zonă tampon importantă. Din perspectivă cartografică, Pădurea Parcului Național Kainji arată clar cum se leagă factorii naturali și umani în această zonă. Pe ansamblu, Pădurea Parcului Național Kainji reprezintă un punct geografic și cultural de referință în Nigeria. Istorie K8 — moștenirea istorică și economică a Nigeriei.",
      en: "Kainji National Park Forest A significant forest area within the national park. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: habitat for many wild animals and important buffer zone. From a map perspective, Kainji National Park Forest clearly shows how natural and human factors connect in this area. Overall, Kainji National Park Forest stands as an important geographic and cultural reference point in Nigeria. History K8 — historical and economic heritage of Nigeria."
    },
    factsAdvanced: {
      ...
      hu: ["Kainji Nemzeti Park erdője a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Kainji Nemzeti Park erdője földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Pădurea Parcului Național Kainji apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Pădurea Parcului Național Kainji influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
      en: ["Kainji National Park Forest appears regularly on Nigerian educational maps.", "It plays an important role in the economic and cultural life of the surrounding region.", "The geographic location of Kainji National Park Forest has long shaped the daily life of local communities.", "The climatic and landscape features of the area have long shaped how it is used."]
    }
  },
  {
...
image: "/poi-images/cross-river-forest-nature-v2.webp"
    ...
    description: { de: "Ein ausgedehnter Regenwald im Südosten.", hu: "Kiterjedt esőerdő délkeleten.", ro: "O pădure tropicală extinsă în sud-est.", en: "An extensive rainforest in the southeast." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Cross-folyó esőerdő Kiterjedt esőerdő délkeleten. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: rendkívül fajgazdag, valamint a biológiai sokféleség egyik központja. A térkép szempontjából Cross-folyó esőerdő jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Cross-folyó esőerdő arculatán. Mindezek alapján Cross-folyó esőerdő fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nigéria régiói és természeti adottságai.",
      ro: "Pădurea tropicală Cross River O pădure tropicală extinsă în sud-est. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: extrem de bogată în specii și un punct fierbinte al biodiversității. Din perspectivă cartografică, Pădurea tropicală Cross River arată clar cum se leagă factorii naturali și umani în această zonă. Pe ansamblu, Pădurea tropicală Cross River reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — regiunile și particularitățile naturale ale Nigeriei.",
      en: "Cross River Rainforest An extensive rainforest in the southeast. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: extremely biodiverse and a biodiversity hotspot. From a map perspective, Cross River Rainforest clearly shows how natural and human factors connect in this area. The surrounding landscape and the everyday life of local communities have left many marks on Cross River Rainforest. Overall, Cross River Rainforest stands as an important geographic and cultural reference point in Nigeria. Geography K7 — regions and natural features of Nigeria."
    },
    factsAdvanced: {
      ...
      hu: ["Cross-folyó esőerdő a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Cross-folyó esőerdő földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Pădurea tropicală Cross River apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Pădurea tropicală Cross River influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
      en: ["Cross River Rainforest appears regularly on Nigerian educational maps.", "It plays an important role in the economic and cultural life of the surrounding region.", "The geographic location of Cross River Rainforest has long shaped the daily life of local communities.", "The climatic and landscape features of the area have long shaped how it is used."]
    }
  },
  {
...
image: "/poi-images/buea-mountain-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      hu: "Obudu-hegyek Hegyvonulat a Kamerunnal határos területen. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: látványos hegyi tájak, valamint nagyon zöld és nedves. A térkép szempontjából Obudu-hegyek jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Obudu-hegyek arculatán. Mindezek alapján Obudu-hegyek fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Munții Obudu Un lanț muntos aproape de granița cu Camerunul. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: peisaje montane spectaculoase și foarte verde și umed. Din perspectivă cartografică, Munții Obudu arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Munții Obudu. Pe ansamblu, Munții Obudu reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
      en: "Obudu Mountains A mountain range near the border with Cameroon. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: spectacular mountain landscapes and very green and humid. From a map perspective, Obudu Mountains clearly shows how natural and human factors connect in this area. The surrounding landscape and the everyday life of local communities have left many marks on Obudu Mountains. Overall, Obudu Mountains stands as an important geographic and cultural reference point in Nigeria. Geography K7 — cities, economy and landscapes of West Africa."
    },
    factsAdvanced: {
      ...
      hu: ["Obudu-hegyek a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Obudu-hegyek földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Munții Obudu apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Munții Obudu influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
      en: ["Obudu Mountains appears regularly on Nigerian educational maps.", "It plays an important role in the economic and cultural life of the surrounding region.", "The geographic location of Obudu Mountains has long shaped the daily life of local communities.", "The climatic and landscape features of the area have long shaped how it is used."]
    }
  },
  {
...
image: "/poi-images/mandara-mountains-nature-v2.webp"
    ...
    descriptionAdvanced: {
      ...
      hu: "Mandara-hegység Vulkáni hegység Nigéria és Kamerun között. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: erősen erodált csúcsok, valamint történelmileg lakott terület. A térkép szempontjából Mandara-hegység jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Mandara-hegység arculatán. Az iskolai földrajzórán Mandara-hegység jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Mandara-hegység fontos földrajzi és kulturális hivatkozási pont Nigériában. Társadalomismeret K7 — Nigéria kultúrája és mindennapjai.",
      ro: "Munții Mandara Un lanț muntos vulcanic între Nigeria și Camerun. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: vârfuri puternic erodate și zonă locuită istoric. Din perspectivă cartografică, Munții Mandara arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Munții Mandara. Pe ansamblu, Munții Mandara reprezintă un punct geografic și cultural de referință în Nigeria. Cunoștințe sociale K7 — cultura și viața cotidiană a Nigeriei.",
      en: "Mandara Mountains A volcanic mountain range between Nigeria and Cameroon. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: strongly eroded peaks and historically inhabited area. From a map perspective, Mandara Mountains clearly shows how natural and human factors connect in this area. The surrounding landscape and the everyday life of local communities have left many marks on Mandara Mountains. Overall, Mandara Mountains stands as an important geographic and cultural reference point in Nigeria. Social studies K7 — culture and daily life in Nigeria."
    },
    factsAdvanced: {
      ...
      hu: ["Mandara-hegység a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Mandara-hegység földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Munții Mandara apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Munții Mandara influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
      en: ["Mandara Mountains appears regularly on Nigerian educational maps.", "It plays an important role in the economic and cultural life of the surrounding region.", "The geographic location of Mandara Mountains has long shaped the daily life of local communities.", "The climatic and landscape features of the area have long shaped how it is used."]
    }
  },
  {
...
image: "/poi-images/guinea-gulf-sea-nature-v2.webp"
    ...
    description: { de: "Das Küstenmeer im Süden Nigerias.", hu: "Partmenti tenger Nigéria déli részén.", ro: "Marea de coastă în sudul Nigeriei.", en: "The coastal sea in the south of Nigeria." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Guineai-öböl Partmenti tenger Nigéria déli részén. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: fontos a hajózás számára, valamint gazdag kőolajlelőhelyekben. A térkép szempontjából Guineai-öböl jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Guineai-öböl arculatán. Az iskolai földrajzórán Guineai-öböl jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Guineai-öböl fontos földrajzi és kulturális hivatkozási pont Nigériában. Történelem K8 — Nigéria történelmi és gazdasági öröksége.",
      ro: "Golful Guineei Marea de coastă în sudul Nigeriei. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: important pentru navigație și bogată în zăcăminte de petrol. Din perspectivă cartografică, Golful Guineei arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Golful Guineei. Pe ansamblu, Golful Guineei reprezintă un punct geografic și cultural de referință în Nigeria. Istorie K8 — moștenirea istorică și economică a Nigeriei.",
      en: "Gulf of Guinea The coastal sea in the south of Nigeria. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: important for shipping and rich in oil reserves. From a map perspective, Gulf of Guinea clearly shows how natural and human factors connect in this area. The surrounding landscape and the everyday life of local communities have left many marks on Gulf of Guinea. Overall, Gulf of Guinea stands as an important geographic and cultural reference point in Nigeria. History K8 — historical and economic heritage of Nigeria."
    },
    factsAdvanced: {
      ...
      hu: ["Guineai-öböl a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Guineai-öböl földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Golful Guineei apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Golful Guineei influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
      en: ["Gulf of Guinea appears regularly on Nigerian educational maps.", "It plays an important role in the economic and cultural life of the surrounding region.", "The geographic location of Gulf of Guinea has long shaped the daily life of local communities.", "The climatic and landscape features of the area have long shaped how it is used."]
    }
  },
  {
...
image: "/poi-images/kainji-dam-nature-v2.webp"
    ...
    description: { de: "Die Uferzone des großen Stausees.", hu: "A nagy víztározó partvidéke.", ro: "Zona de mal a marelui lac de acumulare.", en: "The shore zone of the large reservoir." },
    facts: {
    ...
    descriptionAdvanced: {
      ...
      hu: "Kainji-víztározó partja A nagy víztározó partvidéke. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: fontos a madarak számára, valamint népszerű megfigyelőhely. A térkép szempontjából Kainji-víztározó partja jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Kainji-víztározó partja arculatán. Mindezek alapján Kainji-víztározó partja fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nigéria régiói és természeti adottságai.",
      ro: "Malul lacului Kainji Zona de mal a marelui lac de acumulare. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: important pentru păsări și popular pentru observații. Din perspectivă cartografică, Malul lacului Kainji arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Malul lacului Kainji. Pe ansamblu, Malul lacului Kainji reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — regiunile și particularitățile naturale ale Nigeriei.",
      en: "Kainji Reservoir Shore The shore zone of the large reservoir. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: important for birds and popular for observations. From a map perspective, Kainji Reservoir Shore clearly shows how natural and human factors connect in this area. The surrounding landscape and the everyday life of local communities have left many marks on Kainji Reservoir Shore. Overall, Kainji Reservoir Shore stands as an important geographic and cultural reference point in Nigeria. Geography K7 — regions and natural features of Nigeria."
    },
    factsAdvanced: {
      ...
      hu: ["Kainji-víztározó partja a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Kainji-víztározó partja földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Malul lacului Kainji apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Malul lacului Kainji influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
      en: ["Kainji Reservoir Shore appears regularly on Nigerian educational maps.", "It plays an important role in the economic and cultural life of the surrounding region.", "The geographic location of Kainji Reservoir Shore has long shaped the daily life of local communities.", "The climatic and landscape features of the area have long shaped how it is used."]
    }
  },
  {
    ...
    parent: "NG-RI",
    coords: [6.5, 4.8],
    name: { de: "Nigerdelta-Mangroven", hu: "Niger-delta mangrovék", ro: "Mangrovele din Delta Nigerului", en: "Niger Delta Mangroves",
image: "/poi-images/niger-river-delta-nature-v2.webp"
},
    description: { de: "Ein bedeutendes Mangroven-Ökosystem.", hu: "Jelentős mangrove-ökoszisztéma.", ro: "Un ecosistem important de mangrove.", en: "A significant mangrove ecosystem." },
    facts: {
      de: ["Schützt die Küste.", "Hohe Biodiversität."],
    ...
    descriptionAdvanced: {
      ...
      hu: "Niger-delta mangrovék Jelentős mangrove-ökoszisztéma. Az itteni adottságok és emberi tevékenység együtt formálják ezt a helyet. Több részlet is rávilágít a hely jelentőségére: védi a partvonalat, valamint magas biodiverzitás. A térkép szempontjából Niger-delta mangrovék jól mutatja, hogyan kapcsolódnak a természeti és emberi tényezők ezen a vidéken. A környező táj és a helyi közösségek mindennapi élete sok nyomot hagytak Niger-delta mangrovék arculatán. Az iskolai földrajzórán Niger-delta mangrovék jó példa arra, hogyan formálják az éghajlat, a domborzat és a települések egymást. Mindezek alapján Niger-delta mangrovék fontos földrajzi és kulturális hivatkozási pont Nigériában. Földrajz K7 — Nyugat-Afrika városai, gazdasága és tájai.",
      ro: "Mangrovele din Delta Nigerului Un ecosistem important de mangrove. Condițiile naturale și activitatea umană modelează împreună acest loc. Mai multe detalii subliniază importanța locului: protejează coasta și biodiversitate ridicată. Din perspectivă cartografică, Mangrovele din Delta Nigerului arată clar cum se leagă factorii naturali și umani în această zonă. Peisajul înconjurător și viața de zi cu zi a comunităților locale au lăsat multe urme asupra Mangrovele din Delta Nigerului. Pe ansamblu, Mangrovele din Delta Nigerului reprezintă un punct geografic și cultural de referință în Nigeria. Geografie K7 — orașele, economia și peisajele Africii de Vest.",
      en: "Niger Delta Mangroves A significant mangrove ecosystem. Natural conditions and human activity together shape this place. Several details highlight the significance of the site: protects the coast and high biodiversity. From a map perspective, Niger Delta Mangroves clearly shows how natural and human factors connect in this area. The surrounding landscape and the everyday life of local communities have left many marks on Niger Delta Mangroves. Overall, Niger Delta Mangroves stands as an important geographic and cultural reference point in Nigeria. Geography K7 — cities, economy and landscapes of West Africa."
    },
    factsAdvanced: {
      ...
      hu: ["Niger-delta mangrovék a nigériai oktatási térképek visszatérő helyszíne.", "A környező régió gazdasági és kulturális életében meghatározó szerepet játszik.", "Niger-delta mangrovék földrajzi helyzete régóta befolyásolja a helyi közösségek mindennapjait.", "A környék éghajlati és tájképi jellemzői hosszú ideje formálják a használatát."],
      ro: ["Mangrovele din Delta Nigerului apare frecvent pe hărțile didactice ale Nigeriei.", "Joacă un rol important în viața economică și culturală a regiunii înconjurătoare.", "Poziția geografică a Mangrovele din Delta Nigerului influențează de mult timp viața comunităților locale.", "Caracteristicile climatice și de peisaj ale zonei modelează de mult utilizarea sa."],
      en: ["Niger Delta Mangroves appears regularly on Nigerian educational maps.", "It plays an important role in the economic and cultural life of the surrounding region.", "The geographic location of Niger Delta Mangroves has long shaped the daily life of local communities.", "The climatic and landscape features of the area have long shaped how it is used."]
    }
  }
];
