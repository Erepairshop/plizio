...
export const croatiaNatureV2: POI[] = [

  {
    ...
    description: {
      de: "Der westliche Teil der Insel ist seit 1960 als Nationalpark geschÃ¼tzt. Er umfasst zwei Salzwasserseen und ein ehemaliges Benediktinerkloster.",
      hu: "A sziget nyugati rÃ©sze 1960 Ã³ta nemzeti parkkÃ©nt vÃ©dett. KÃ©t sÃ³s tavat Ã©s egy egykori bencÃ©s kolostort foglal magÃ¡ban.",
      ro: "Partea de vest a insulei este protejatÄƒ ca parc național din 1960. Acesta cuprinde douÄƒ lacuri sÄƒrate și o fostÄƒ mÄƒnÄƒstire benedictinÄƒ.",
      ...
      es: "La parte occidental de la isla está protegida como parque nacional desde 1960. Incluye dos lagos de agua salada y un antiguo monasterio benedictino.",
      pt: "A parte ocidental da ilha está protegida como parque nacional desde 1960. Inclui dois lagos de água salgada e um antigo mosteiro beneditino.",
      fr: "La partie occidentale de l'île est protégée en tant que parc national depuis 1960. Elle comprend deux lacs d'eau salée et un ancien monastère bénédictin.",
    },
    facts: {
      de: ["GegrÃ¼ndet 1960", "Zwei Salzwasserseen", "Benediktinerkloster aus 12. Jhd", "90% Waldanteil"],
      hu: ["1960-ban alapÃ­tottÃ¡k", "KÃ©t sÃ³s tÃ³", "12. szÃ¡zadi kolostor", "90% erdÅ‘borÃ­tottsÃ¡g"],
      ro: ["Fondat Ã®n 1960", "DouÄƒ lacuri sÄƒrate", "MÄƒnÄƒstire din secolul XII", "90% pÄƒdure"],
      en: ["Established in 1960", "Two saltwater lakes", "12th century monastery", "90% forest cover"],
      es: ["Fundado en 1960", "Dos lagos de agua salada", "Monasterio benedictino del siglo XII", "90% de superficie forestal"],
      pt: ["Fundado em 1960", "Dois lagos de água salgada", "Mosteiro beneditino do séc. XII", "90% de área florestal"],
      fr: ["Fondé en 1960", "Deux lacs d'eau salée", "Monastère bénédictin du XIIe siècle", "90 % de forêt"],
    },
imageHint: "Mljet island monastery on lake",
    descriptionAdvanced: {
      ...
      es: "La isla de Mljet alberga en el oeste un parque nacional con dos lagos de agua salada, conectados al mar abierto por un estrecho canal.",
      pt: "A ilha de Mljet abriga no oeste um parque nacional com dois lagos de água salgada, ligados ao mar aberto por um canal estreito.",
      fr: "L'île de Mljet abrite dans sa partie ouest un parc national avec deux lacs salés, reliés à la mer ouverte par un étroit canal.",
    },
    factsAdvanced: {
      ...
      es: ["Fundación del parque nacional en el año 1960", "La superficie del parque es de 54 km²", "Lagos salados Veliko y Malo Jezero", "Monasterio en la isla de Sveta Marija"],
      pt: ["Fundação do parque nacional no ano 1960", "A área do parque é de 54 km²", "Lagos salgados Veliko e Malo Jezero", "Mosteiro na ilha de Sveta Marija"],
      fr: ["Création du parc national en 1960", "La superficie du parc est de 54 km²", "Lacs salés Veliko Jezero et Malo Jezero", "Monastère sur l'île de Sveta Marija"],
    },
    ...
    description: {
      de: "Dieser Archipel umfasst 89 Inseln, Riffe und Felsen mit einer GesamtkÃ¼ste von 238 km. Die Region ist bekannt fÃ¼r ihre hohen Steilklippen, die Kronen.",
      hu: "Ez a szigetcsoport 89 szigetet, zÃ¡tonyt Ã©s sziklÃ¡t foglal magÃ¡ban, 238 km hosszÃº partvonallal. A rÃ©giÃ³ magas sziklÃ¡irÃ³l, a koronÃ¡krÃ³l ismert.",
      ro: "Acest arhipelag cuprinde 89 de insule, recife și stÃ¢nci, cu o coastÄƒ totalÄƒ de 238 km. Regiunea este cunoscutÄƒ pentru stÃ¢ncile sale Ã®nalte, coroanele.",
      ...
      es: "Este archipiélago incluye 89 islas, arrecifes y rocas con una costa total de 238 km. La región es conocida por sus altos acantilados, las 'coronas'.",
      pt: "Este arquipélago inclui 89 ilhas, recifes e rochedos com uma costa total de 238 km. A região é conhecida pelas suas altas falésias, as 'coroas'.",
      fr: "Cet archipel comprend 89 îles, récifs et rochers avec un littoral total de 238 km. La région est connue pour ses hautes falaises abruptes, les 'couronnes'.",
    },
    facts: {
      de: ["GegrÃ¼ndet 1980", "89 Inseln und Felsen", "HÃ¶chste Klippe 82 Meter", "217 kmÂ² GesamtflÃ¤che"],
      hu: ["1980-ban alapÃ­tottÃ¡k", "89 sziget Ã©s szikla", "Legmagasabb szikla 82 m", "217 kmÂ² Ã¶sszterÃ¼let"],
      ro: ["Fondat Ã®n 1980", "89 de insule și stÃ¢nci", "Cea mai Ã®naltÄƒ stÃ¢ncÄƒ 82 m", "SuprafațÄƒ de 217 kmÂ²"],
      en: ["Established in 1980", "89 islands and rocks", "Highest cliff 82 meters", "Total area 217 kmÂ²"],
      es: ["Fundado en 1980", "89 islas y rocas", "Acantilado más alto de 82 metros", "Superficie total de 217 km²"],
      pt: ["Fundado em 1980", "89 ilhas e rochedos", "Falésia mais alta de 82 metros", "Área total de 217 km²"],
      fr: ["Fondé en 1980", "89 îles et rochers", "Plus haute falaise de 82 mètres", "Surface totale de 217 km²"],
    },
imageHint: "Kornati islands aerial view",
    descriptionAdvanced: {
      ...
      es: "El archipiélago de las Kornati consta de más de 80 islas y arrecifes áridos, conocidos por sus espectaculares acantilados verticales, las llamadas coronas.",
      pt: "O arquipélago de Kornati consiste em mais de 80 ilhas e recifes áridos, conhecidos pelas suas espetaculares falésias verticais, as chamadas coroas.",
      fr: "L'archipel des Kornati se compose de plus de 80 îles et récifs arides, connus pour leurs spectaculaires falaises verticales, appelées couronnes.",
    },
    factsAdvanced: {
      ...
      es: ["El parque nacional incluye 89 islas", "Superficie total de unos 220 km²", "El acantilado más alto alcanza los 82 metros", "Sin asentamientos permanentes en las islas"],
      pt: ["O parque nacional inclui 89 ilhas", "Área total de cerca de 220 km²", "A falésia mais alta atinge os 82 metros", "Sem colonização permanente nas ilhas"],
      fr: ["Le parc national comprend 89 îles", "Surface totale d'environ 220 km²", "La plus haute falaise atteint 82 mètres", "Aucun peuplement permanent sur les îles"],
    },
    ...
    description: {
      de: "Eine Gruppe von 14 Inseln vor der KÃ¼ste Istriens, bekannt fÃ¼r ihre exotische Flora und rÃ¶mische Ruinen. Veli Brijun beherbergt einen Safari-Park.",
      hu: "14 szigetbÅ‘l Ã¡llÃ³ csoport Isztria partjainÃ¡l, egzotikus flÃ³rÃ¡jÃ¡rÃ³l Ã©s rÃ³mai romjairÃ³l ismert. Veli Brijun egy szafariparknak ad otthont.",
      ro: "Un grup de 14 insule Ã®n largul coastei Istriei, cunoscut pentru flora exoticÄƒ și ruinele romane. Veli Brijun gÄƒzduiește un parc safari.",
      ...
      es: "Un grupo de 14 islas frente a la costa de Istria, conocido por su flora exótica y ruinas romanas. Veli Brijun alberga un parque safari.",
      pt: "Um grupo de 14 ilhas ao largo da costa da Ístria, conhecido pela sua flora exótica e ruínas romanas. Veli Brijun abriga um parque de safári.",
      fr: "Un groupe de 14 îles au large des côtes de l'Istrie, connu pour sa flore exotique et ses ruines romaines. Veli Brijun abrite un parc safari.",
    },
    facts: {
      de: ["GegrÃ¼ndet 1983", "14 Inseln", "Safari-Park vorhanden", "Antike rÃ¶mische Villen"],
      hu: ["1983-ban alapÃ­tottÃ¡k", "14 sziget", "Szafari park talÃ¡lhatÃ³", "Ã“kori rÃ³mai villÃ¡k"],
      ro: ["Fondat Ã®n 1983", "14 insule", "Parc safari existent", "Vile romane antice"],
      en: ["Established in 1983", "14 islands", "Safari park present", "Ancient Roman villas"],
      es: ["Fundado en 1983", "14 islas", "Parque safari disponible", "Antiguas villas romanas"],
      pt: ["Fundado em 1983", "14 ilhas", "Parque de safári existente", "Antigas vilas romanas"],
      fr: ["Fondé en 1983", "14 îles", "Parc safari présent", "Anciennes villas romaines"],
    },
imageHint: "Brijuni islands landscape and sea",
    descriptionAdvanced: {
      ...
      es: "Las islas Brijuni, frente a la costa de Istria, combinan una naturaleza virgen con el patrimonio histórico y antaño sirvieron como prestigiosa residencia de verano.",
      pt: "As ilhas Brijuni, ao largo da costa da Ístria, combinam uma natureza intocada com o património histórico e serviram outrora como uma prestigiada residência de verão.",
      fr: "Les îles Brijuni, au large de la côte d'Istrie, allient nature préservée et patrimoine historique, et servaient autrefois de résidence d'été prestigieuse.",
    },
    factsAdvanced: {
      ...
      es: ["El archipiélago consta de 14 islas", "Parque Nacional desde el año 1983", "Parque safari con animales exóticos", "Más de 200 huellas de dinosaurios"],
      pt: ["O arquipélago é composto por 14 ilhas", "Parque Nacional desde o ano de 1983", "Parque de safári com animais exóticos", "Mais de 200 pegadas de dinossauros"],
      fr: ["L'archipel se compose de 14 îles", "Parc national depuis 1983", "Parc safari avec des animaux exotiques", "Plus de 200 empreintes de dinosaures"],
    },
    ...
    coords: [14.99, 44.75],
    description: {
      de: "Dieser Park umfasst die Karstformationen HajduÄki und RoÅ¾anski kukovi. Er beherbergt die Lukina jama, eine der tiefsten HÃ¶hlen der Welt.",
      hu: "A park a HajduÄki Ã©s RoÅ¾anski kukovi karsztformÃ¡ciÃ³it foglalja magÃ¡ban. Itt talÃ¡lhatÃ³ a Lukina jama, a vilÃ¡g egyik legmÃ©lyebb barlangja.",
      ro: "Acest parc cuprinde formațiunile carstice HajduÄki și RoÅ¾anski kukovi. GÄƒzduiește Lukina jama, una dintre cele mai adÃ¢nci peșteri din lume.",
      en: "This park features the HajduÄki and RoÅ¾anski kukovi karst formations. it is home to Lukina jama, one of the world's deepest caves.",
      es: "Este parque incluye las formaciones kársticas de Hajdučki y Rožanski kukovi. Alberga la Lukina jama, una de las cuevas más profundas del mundo.",
      pt: "Este parque inclui as formações cársticas de Hajdučki e Rožanski kukovi. Abriga a Lukina jama, uma das grutas mais profundas do mundo.",
      fr: "Ce parc comprend les formations karstiques de Hajdučki et Rožanski kukovi. Il abrite la Lukina jama, l'un des gouffres les plus profonds du monde.",
    },
    facts: {
      de: ["GegrÃ¼ndet 1999", "109 kmÂ² FlÃ¤che", "Tiefe HÃ¶hle Lukina jama", "Botanischer Garten"],
      hu: ["1999-ben alapÃ­tottÃ¡k", "109 kmÂ² terÃ¼let", "Lukina jama mÃ©lybarlang", "Botanikus kert"],
      ro: ["Fondat Ã®n 1999", "SuprafațÄƒ de 109 kmÂ²", "Peștera Lukina jama", "GrÄƒdinÄƒ botanicÄƒ"],
      en: ["Established in 1999", "109 kmÂ² area", "Lukina jama deep cave", "Botanical garden"],
      es: ["Fundado en 1999", "109 km² de superficie", "Cueva profunda Lukina jama", "Jardín botánico"],
      pt: ["Fundado em 1999", "109 km² de área", "Gruta profunda Lukina jama", "Jardim botânico"],
      fr: ["Fondé en 1999", "Superficie de 109 km²", "Gouffre profond Lukina jama", "Jardin botanique"],
    },
imageHint: "North Velebit rocky peaks",
    descriptionAdvanced: {
      ...
      es: "El Parque Nacional del Velebit del Norte protege un paisaje kárstico impresionante con cuevas profundas, rocas escarpadas y una diversidad botánica extraordinaria.",
      pt: "O Parque Nacional do Velebit do Norte protege uma paisagem cárstica marcante com grutas profundas, rochas escarpadas e uma diversidade botânica extraordinária.",
      fr: "Le parc national du Velebit du Nord protège un paysage karstique remarquable avec des grottes profondes, des rochers escarpés et une diversité botanique exceptionnelle.",
    },
    factsAdvanced: {
      ...
      es: ["Fundación del parque nacional en 1999", "La superficie abarca 109 kilómetros cuadrados", "La cueva de Luka tiene 1431 metros de profundidad", "El refugio Zavižan es la estación meteorológica más alta"],
      pt: ["Fundação do parque nacional em 1999", "A área abrange 109 quilómetros quadrados", "A gruta de Luka tem 1431 metros de profundidade", "O refúgio Zavižan é a estação meteorológica mais alta"],
      fr: ["Création du parc national en 1999", "La superficie est de 109 kilomètres carrés", "Le gouffre Lukina jama fait 1431 mètres de profondeur", "Le refuge Zavižan est la station météo la plus haute"],
    },
    ...
    parent: "HR",
    type: "park",
    name: { de: "KopaÄki Rit", hu: "Kopácsi-rét", ro: "KopaÄki Rit", en: "KopaÄki Rit"},
    coords: [18.8167, 45.6167],
    description: {
      de: "Eines der grÃ¶ÃŸten Feuchtgebiete Europas liegt am Zusammenfluss von Drau und Donau. Es beherbergt Ã¼ber 300 Vogelarten und riesige WildtierbestÃ¤nde.",
      hu: "EurÃ³pa egyik legnagyobb vizes Ã©lÅ‘helye a DrÃ¡va Ã©s a Duna Ã¶sszefolyÃ¡sÃ¡nÃ¡l talÃ¡lhatÃ³. TÃ¶bb mint 300 madÃ¡rfajnak ad otthont.",
      ro: "Una dintre cele mai mari zone umede din Europa este situatÄƒ la confluența rÃ¢urilor Drava și DunÄƒre. GÄƒzduiește peste 300 de specii de pÄƒsÄƒri.",
      ...
      es: "Uno de los humedales más grandes de Europa se encuentra en la confluencia de los ríos Drava y Danubio. Alberga más de 300 especies de aves y enormes poblaciones de vida silvestre.",
      pt: "Uma das maiores zonas húmidas da Europa situa-se na confluência dos rios Drava e Danúbio. Abriga mais de 300 espécies de aves e enormes populações de vida selvagem.",
      fr: "L'une des plus grandes zones humides d'Europe se situe au confluent de la Drave et du Danube. Elle abrite plus de 300 espèces d'oiseaux et d'immenses populations d'animaux sauvages.",
    },
    facts: {
      de: ["GegrÃ¼ndet 1976", "177 kmÂ² FlÃ¤che", "Ãœber 300 Vogelarten", "Zusammenfluss von Donau/Drau"],
      hu: ["1976-ban alapÃ­tottÃ¡k", "177 kmÂ² terÃ¼let", "TÃ¶bb mint 300 madÃ¡rfaj", "Duna-DrÃ¡va Ã¶sszefolyÃ¡s"],
      ro: ["Fondat Ã®n 1976", "SuprafațÄƒ de 177 kmÂ²", "Peste 300 specii pÄƒsÄƒri", "Confluența DunÄƒre-Drava"],
      en: ["Established in 1976", "177 kmÂ² area", "Over 300 bird species", "Danube and Drava confluence"],
      es: ["Fundado en 1976", "177 km² de superficie", "Más de 300 especies de aves", "Confluencia de Danubio/Drava"],
      pt: ["Fundado em 1976", "177 km² de área", "Mais de 300 espécies de aves", "Confluência de Danúbio/Drava"],
      fr: ["Fondé en 1976", "Surface de 177 km²", "Plus de 300 espèces d'oiseaux", "Confluent du Danube et de la Drave"],
    },
imageHint: "Kopacki Rit wetland birds",
    descriptionAdvanced: {
      ...
      es: "Kopački Rit es una de las zonas pantanosas más importantes de Europa y sirve como hábitat vital para numerosas especies de aves raras a orillas del Danubio.",
      pt: "Kopački Rit é uma das zonas pantanosas mais importantes da Europa e serve como habitat vital para numerosas espécies de aves raras nas margens do Danúbio.",
      fr: "Kopački Rit est l'une des zones marécageuses les plus importantes d'Europe et sert d'habitat essentiel à de nombreuses espèces d'oiseaux rares sur le Danube.",
    },
    factsAdvanced: {
      ...
      es: ["El delta interior más grande del Danubio", "Más de 290 especies diferentes de aves", "La superficie es de unos 177 km²", "Sitio Ramsar desde el año 1993"],
      pt: ["O maior delta interior do Danúbio", "Mais de 290 espécies diferentes de aves", "A área é de cerca de 177 km²", "Sítio Ramsar desde o ano de 1993"],
      fr: ["Le plus grand delta intérieur du Danube", "Plus de 290 espèces d'oiseaux différentes", "La surface est d'environ 177 km²", "Site Ramsar depuis l'année 1993"],
    },
    ...
    coords: [16.75, 45.4],
    description: {
      de: "Das grÃ¶ÃŸte geschÃ¼tzte Feuchtgebiet Kroatiens liegt im Tal der Save. Es ist bekannt fÃ¼r seine traditionellen HolzhÃ¤user und WeiÃŸstorchpopulationen.",
      hu: "HorvÃ¡torszÃ¡g legnagyobb vÃ©dett vizes Ã©lÅ‘helye a SzÃ¡va vÃ¶lgyÃ©ben talÃ¡lhatÃ³. HagyomÃ¡nyos fahÃ¡zairÃ³l Ã©s fehÃ©r gÃ³lya populÃ¡ciÃ³irÃ³l ismert.",
      ro: "Cea mai mare zonÄƒ umedÄƒ protejatÄƒ din Croația este situatÄƒ Ã®n valea rÃ¢ului Sava. Este renumitÄƒ pentru casele tradiționale din lemn.",
      ...
      es: "El humedal protegido más grande de Croacia se encuentra en el valle del Sava. Es conocido por sus casas de madera tradicionales y sus poblaciones de cigüeñas blancas.",
      pt: "A maior zona húmida protegida da Croácia situa-se no vale do rio Sava. É conhecida pelas suas casas de madeira tradicionais e populações de cegonhas-brancas.",
      fr: "La plus grande zone humide protégée de Croatie se trouve dans la vallée de la Save. Elle est connue pour ses maisons en bois traditionnelles et ses populations de cigognes blanches.",
    },
    facts: {
      de: ["GegrÃ¼ndet 1990", "506 kmÂ² FlÃ¤che", "EuropÃ¤isches Storchendorf ÄŒigoÄ", "Traditionelle HolzhÃ¤user"],
      hu: ["1990-ben alapÃ­tottÃ¡k", "506 kmÂ² terÃ¼let", "ÄŒigoÄ gÃ³lyafalu", "HagyomÃ¡nyos fahÃ¡zak"],
      ro: ["Fondat Ã®n 1990", "SuprafațÄƒ de 506 kmÂ²", "Satul berzelor ÄŒigoÄ", "Case tradiționale din lemn"],
      en: ["Established in 1990", "506 kmÂ² area", "ÄŒigoÄ stork village", "Traditional wooden houses"],
      es: ["Fundado en 1990", "506 km² de superficie", "Čigoč, pueblo europeo de las cigüeñas", "Casas de madera tradicionales"],
      pt: ["Fundado em 1990", "506 km² de área", "Aldeia Europeia das Cegonhas de Čigoč", "Casas de madeira tradicionais"],
      fr: ["Fondé en 1990", "Superficie de 506 km²", "Village européen des cigognes de Čigoč", "Maisons en bois traditionnelles"],
    },
imageHint: "Lonjsko Polje wooden houses and storks",
    descriptionAdvanced: {
      ...
      es: "El Parque Natural Lonjsko Polje es una de las áreas de inundación mejor conservadas de Europa, famosa por su arquitectura tradicional de madera.",
      pt: "O Parque Natural Lonjsko Polje é uma das maiores áreas de inundação preservadas da Europa e é famoso pelas suas casas de madeira tradicionais.",
      fr: "Le parc naturel de Lonjsko Polje est l'une des plus grandes zones inondables préservées d'Europe, réputée pour ses maisons en bois traditionnelles.",
    },
    factsAdvanced: {
      ...
      es: ["Superficie de unos 506 kilómetros cuadrados", "Conocido por el pueblo de cigüeñas Čigoč", "Numerosas especies animales protegidas", "Lista indicativa de la UNESCO desde 2005"],
      pt: ["Área de cerca de 506 quilómetros quadrados", "Conhecido pela aldeia das cegonhas Čigoč", "Inúmeras espécies animais protegidas", "Lista indicativa da UNESCO desde 2005"],
      fr: ["Superficie d'environ 506 kilomètres carrés", "Connu pour le village des cigognes de Čigoč", "Nombreuses espèces animales protégées", "Liste indicative de l'UNESCO depuis 2005"],
    },
    ...
    description: {
      de: "Dieser Gebirgszug liegt nÃ¶rdlich von Zagreb. Der Sljeme ist der hÃ¶chste Gipfel und ein beliebtes Wintersportzentrum sowie Ausflugsziel.",
      hu: "Ez a hegylÃ¡nc ZÃ¡grÃ¡btÃ³l Ã©szakra talÃ¡lhatÃ³. A Sljeme a legmagasabb csÃºcsa, nÃ©pszerű tÃ©li sportkÃ¶zpont Ã©s kirÃ¡ndulÃ³hely.",
      ro: "Acest lanț muntos este situat la nord de Zagreb. Sljeme este cel mai Ã®nalt vÃ¢rf, fiind un centru popular de sporturi de iarnÄƒ.",
      ...
      es: "Esta cadena montañosa se encuentra al norte de Zagreb. El Sljeme es el pico más alto y un popular centro de deportes de invierno y destino de excursiones.",
      pt: "Esta cordilheira situa-se a norte de Zagreb. O Sljeme é o pico mais alto e um popular centro de desportos de inverno e destino de excursões.",
      fr: "Cette chaîne de montagnes se trouve au nord de Zagreb. Le Sljeme est le point culminant et un centre de sports d'hiver ainsi qu'un lieu d'excursion prisé.",
    },
    facts: {
      de: ["HÃ¶chster Gipfel 1033 m", "Grotte Veternica", "Burg Medvedgrad", "Ski-Weltcup Slalom"],
      hu: ["Legmagasabb csÃºcs 1033 m", "Veternica-barlang", "Medvedgrad vÃ¡ra", "SÃ­-vilÃ¡gkupa szlalom"],
      ro: ["VÃ¢rful maxim 1033 m", "Peștera Veternica", "Cetatea Medvedgrad", "CupÄƒ MondialÄƒ de Schi"],
      en: ["Highest peak 1033 m", "Veternica cave", "Medvedgrad fortress", "Ski World Cup slalom"],
      es: ["Pico más alto 1033 m", "Gruta Veternica", "Castillo Medvedgrad", "Copa del Mundo de Esquí Slalom"],
      pt: ["Pico mais alto 1033 m", "Gruta Veternica", "Castelo Medvedgrad", "Taça do Mundo de Esqui Slalom"],
      fr: ["Sommet le plus haut 1033 m", "Grotte Veternica", "Château de Medvedgrad", "Coupe du monde de ski slalom"],
    },
imageHint: "Medvednica mountain forest",
    descriptionAdvanced: {
      ...
      es: "Medvednica es la montaña local de Zagreb y ofrece densos bosques, fortalezas históricas y populares opciones de deportes de invierno justo a las puertas de la ciudad.",
      pt: "Medvednica é a montanha de Zagreb, oferecendo florestas densas, fortalezas históricas e opções populares de desportos de inverno nos arredores da cidade.",
      fr: "Le massif de Medvednica est la montagne locale de Zagreb, offrant des forêts denses, des forteresses historiques et des pistes de ski renommées aux portes de la ville.",
    },
    factsAdvanced: {
      ...
      es: ["Pico más alto Sljeme (1033 m)", "Parque natural desde el año 1981", "La cueva Veternica tiene más de 7 km de largo", "Castillo Medvedgrad del siglo XIII"],
      pt: ["Pico mais alto Sljeme (1033 m)", "Parque natural desde o ano 1981", "A gruta Veternica tem mais de 7 km de comprimento", "Castelo Medvedgrad do século XIII"],
      fr: ["Point culminant Sljeme (1033 m)", "Parc naturel depuis 1981", "La grotte Veternica mesure plus de 7 km de long", "Château de Medvedgrad datant du XIIIe siècle"],
    },
    ...
    coords: [16.89, 42.75],
    description: {
      de: "Der Naturpark umfasst 44 Inseln und Riffe im Ã¤uÃŸeren SÃ¼den Kroatiens. Das Gebiet ist fÃ¼r seine reiche MeeresbiodiversitÃ¤t und Sternenhimmel bekannt.",
      hu: "A termÃ©szetvÃ©delmi park 44 szigetet Ã©s zÃ¡tonyt foglal magÃ¡ban HorvÃ¡torszÃ¡g dÃ©li rÃ©szÃ©n. Gazdag tengeri Ã©lÅ‘vilÃ¡gÃ¡rÃ³l ismert.",
      ro: "Parcul natural cuprinde 44 de insule și recife Ã®n extremitatea sudicÄƒ a Croației. Zona este cunoscutÄƒ pentru biodiversitatea marinÄƒ.",
      ...
      es: "El parque natural incluye 44 islas y arrecifes en el extremo sur de Croacia. La zona es conocida por su rica biodiversidad marina y su cielo estrellado.",
      pt: "O parque natural inclui 44 ilhas e recifes no extremo sul da Croácia. A área é conhecida pela sua rica biodiversidade marinha e pelo céu estrelado.",
      fr: "Le parc naturel comprend 44 îles et récifs à l'extrême sud de la Croatie. La région est connue pour sa riche biodiversité marine et son ciel étoilé.",
    },
    facts: {
      de: ["44 Inseln", "GegrÃ¼ndet 2006", "Tiefblaues Meer", "Kaum Lichtverschmutzung"],
      hu: ["44 sziget", "2006-ban alapÃ­tottÃ¡k", "MÃ©lykÃ©k tenger", "MinimÃ¡lis fÃ©nyszennyezÃ©s"],
      ro: ["44 de insule", "Fondat Ã®n 2006", "Mare albastru intens", "Poluare luminoasÄƒ minimÄƒ"],
      en: ["44 islands", "Established in 2006", "Deep blue sea", "Minimal light pollution"],
      es: ["44 islas", "Fundado en 2006", "Mar azul profundo", "Casi sin contaminación lumínica"],
      pt: ["44 ilhas", "Fundado em 2006", "Mar azul profundo", "Quase sem poluição luminosa"],
      fr: ["44 îles", "Fondé en 2006", "Mer d'un bleu profond", "Presque aucune pollution lumineuse"],
    },
imageHint: "Lastovo islands aerial view",
    descriptionAdvanced: {
      ...
      es: "El archipiélago de Lastovo es un paraíso natural remoto en el sur del Adriático, caracterizado por un mundo marino virgen y densos bosques de pinos.",
      pt: "O arquipélago de Lastovo é um paraíso natural remoto no sul do Adriático, caracterizado por um mundo marinho virgem e densas florestas de pinheiros.",
      fr: "L'archipel de Lastovo est un paradis naturel reculé dans le sud de l'Adriatique, caractérisé par un monde marin intact et de denses forêts de pins.",
    },
    factsAdvanced: {
      ...
      es: ["Consta de 44 islas y rocas", "Parque natural desde el año 2006", "Faro de Struga del año 1839", "Uno de los lugares más oscuros de Europa"],
      pt: ["Consiste em 44 ilhas e rochedos", "Parque natural desde o ano de 2006", "Farol de Struga do ano de 1839", "Um dos lugares mais escuros da Europa"],
      fr: ["Se compose de 44 îles et rochers", "Parc naturel depuis l'année 2006", "Phare de Struga datant de 1839", "L'un des endroits les plus sombres d'Europe"],
    },
    ...
    description: {
      de: "Der grÃ¶ÃŸte See Kroatiens ist ein Karstfeld, das mit Wasser gefÃ¼llt ist. Er dient als ornithologisches Reservat fÃ¼r seltene SumpfvÃ¶gel.",
      hu: "HorvÃ¡torszÃ¡g legnagyobb tava egy vÃ­zzel telt karsztmezÅ‘. Ritka mocsÃ¡ri madarak ornitolÃ³giai rezervÃ¡tumakÃ©nt szolgÃ¡l.",
      ro: "Cel mai mare lac din Croația este un cÃ¢mp carstic umplut cu apÄƒ. Servește ca rezervație ornitologicÄƒ pentru pÄƒsÄƒri de mlaștinÄƒ rare.",
      en: "Croatia's largest lake is a karst field filled with water. it serves as an ornithological reserve for rare marsh birds.",
      es: "El lago más grande de Croacia es un campo kárstico lleno de agua. Sirve como reserva ornitológica para aves raras de pantano.",
      pt: "O maior lago da Croácia é um campo cárstico cheio de água. Serve como reserva ornitológica para aves raras de pântano.",
      fr: "Le plus grand lac de Croatie est un poljé karstique rempli d'eau. Il sert de réserve ornithologique pour des oiseaux de marais rares.",
    },
    facts: {
      de: ["GrÃ¶ÃŸter See Kroatiens", "Ornithologisches Reservat", "Nahe der AdriakÃ¼ste", "FlÃ¤che von 30 kmÂ²"],
      hu: ["HorvÃ¡torszÃ¡g legnagyobb tava", "OrnitolÃ³giai rezervÃ¡tum", "Adriai-part kÃ¶zelÃ©ben", "30 kmÂ² terÃ¼let"],
      ro: ["Cel mai mare lac", "Rezervație ornitologicÄƒ", "LÃ¢ngÄƒ coasta Adriaticii", "SuprafațÄƒ de 30 kmÂ²"],
      en: ["Largest lake in Croatia", "Ornithological reserve", "Near Adriatic coast", "Area of 30 kmÂ²"],
      es: ["Lago más grande de Croacia", "Reserva ornitológica", "Cerca de la costa adriática", "Superficie de 30 km²"],
      pt: ["Maior lago da Croácia", "Reserva ornitológica", "Perto da costa adriática", "Área de 30 km²"],
      fr: ["Plus grand lac de Croatie", "Réserve ornithologique", "Proche de la côte adriatique", "Superficie de 30 km²"],
    },
imageHint: "Vrana lake bird sanctuary",
    descriptionAdvanced: {
      ...
      es: "El lago Vrana es el lago natural más grande de Croacia y una importante reserva ornitológica situada directamente en la costa dálmata.",
      pt: "O lago Vrana é o maior lago natural da Croácia e uma importante reserva ornitológica situada diretamente na costa da Dalmácia.",
      fr: "Le lac de Vrana est le plus grand lac naturel de Croatie et une importante réserve ornithologique située directement sur la côte dalmate.",
    },
    factsAdvanced: {
      ...
      es: ["Superficie de agua máxima de 30 km²", "El parque natural abarca todos los alrededores", "Más de 250 especies diferentes de aves", "Criptodepresión bajo el nivel del mar"],
      pt: ["Área máxima de água de 30 km²", "O parque natural abrange todos os arredores", "Mais de 250 espécies diferentes de aves", "Criptodepressão abaixo do nível do mar"],
      fr: ["Plus grande surface d'eau de 30 km²", "Le parc naturel englobe tous les environs", "Plus de 250 espèces d'oiseaux différentes", "Cryptodépression sous le niveau de la mer"],
    },
    ...
    description: {
      ...
      hu: "A 'FÃ¶ld szeme' egy rendkÃ­vÃ¼li mÃ©lysÃ©gű Ã©s intenzÃ­v kÃ©k szÃ­nű karsztforrÃ¡s. Ez a Cetina folyÃ³ forrÃ¡svidÃ©ke.",
      ro: "â€žOchiul PÄƒmÃ¢ntuluiâ€ este un izvor carstic de o adÃ¢ncime extremÄƒ și o culoare albastrÄƒ intensÄƒ. FormeazÄƒ obÃ¢rșia rÃ¢ului Cetina.",
      ...
      es: "El 'Ojo de la Tierra' es un manantial kárstico de extrema profundidad e intenso color azul. Forma el origen del río Cetina.",
      pt: "O 'Olho da Terra' é uma nascente cárstica de extrema profundidade e cor azul intensa. Forma a nascente do rio Cetina.",
      fr: "L'« Œil de la Terre » est une source karstique d'une profondeur extrême et d'une couleur bleue intense. Elle constitue l'origine de la rivière Cetina.",
    },
    facts: {
      de: ["Tiefe Ã¼ber 150 m", "Name 'Auge der Erde'", "Kristallklares Wasser", "Quelle der Cetina"],
      hu: ["TÃ¶bb mint 150 m mÃ©ly", "'FÃ¶ld szeme' nÃ©ven ismert", "KristÃ¡lytiszta vÃ­z", "Cetina forrÃ¡sa"],
      ro: ["AdÃ¢ncime peste 150 m", "Numit â€žOchiul PÄƒmÃ¢ntuluiâ€", "ApÄƒ cristalinÄƒ", "Originea Cetinei"],
      en: ["Depth over 150 m", "Nicknamed 'Eye of the Earth'", "Crystal clear water", "Source of Cetina"],
      es: ["Profundidad superior a 150 m", "Nombre 'Ojo de la Tierra'", "Agua cristalina", "Manantial del Cetina"],
      pt: ["Profundidade superior a 150 m", "Nome 'Olho da Terra'", "Água cristalina", "Nascente do Cetina"],
      fr: ["Profondeur de plus de 150 m", "Nommée « Œil de la Terre »", "Eau cristalline", "Source de la Cetina"],
    },
imageHint: "Cetina river spring Eye of the Earth",
    descriptionAdvanced: {
      ...
      es: "El manantial del Cetina, también llamado el Ojo de la Tierra, es un impresionante lago de manantial kárstico con aguas de color azul profundo al pie de la cordillera de Dinara.",
      pt: "A nascente do Cetina, também chamada Olho da Terra, é um impressionante lago de nascente cárstica com águas azuis profundas no sopé da cordilheira Dinara.",
      fr: "La source de la Cetina, également appelée l'Œil de la Terre, est un impressionnant lac de source karstique aux eaux d'un bleu profond, situé au pied des montagnes de Dinara.",
    },
    factsAdvanced: {
      ...
      es: ["Profundidad del manantial principal superior a 115 m", "Temperatura del agua constante a 7 grados", "Situado cerca de Vrlika", "Monumento natural desde el año 1972"],
      pt: ["Profundidade da nascente principal superior a 115 m", "Temperatura da água constante nos 7 graus", "Situado perto de Vrlika", "Monumento natural desde o ano de 1972"],
      fr: ["Profondeur de la source principale de plus de 115 m", "Température de l'eau constante à 7 degrés", "Située près de Vrlika", "Monument naturel depuis 1972"],
    },
    ...
    coords: [15.7, 44.2],
    description: {
      de: "Die Zrmanja flieÃŸt durch eine spektakulÃ¤re, bis zu 200 Meter tiefe Schlucht. Der Fluss ist berÃ¼hmt als Drehort fÃ¼r Winnetou-Filme.",
      hu: "A Zrmanja egy lÃ¡tvÃ¡nyos, akÃ¡r 200 mÃ©ter mÃ©ly szurdokon folyik keresztÃ¼l. A folyÃ³ a Winnetou-filmek forgatÃ¡si helyszÃ­nekÃ©nt hÃ­res.",
      ro: "RÃ¢ul Zrmanja curge printr-un canion spectaculos, adÃ¢nc de pÃ¢nÄƒ la 200 de metri. Este faimos ca loc de filmare pentru filmele Winnetou.",
      ...
      es: "El Zrmanja fluye a través de un espectacular cañón de hasta 200 metros de profundidad. El río es famoso por ser lugar de rodaje de las películas de Winnetou.",
      pt: "O Zrmanja corre através de um desfiladeiro espetacular com até 200 metros de profundidade. O rio é famoso por ter sido local de filmagem dos filmes de Winnetou.",
      fr: "La Zrmanja coule à travers un canyon spectaculaire atteignant 200 mètres de profondeur. La rivière est célèbre pour avoir servi de lieu de tournage aux films de Winnetou.",
    },
    facts: {
      de: ["Winnetou-Drehort", "200 m tiefe Schlucht", "Bekannt fÃ¼r Rafting", "MÃ¼ndet in die Adria"],
      hu: ["Winnetou forgatÃ¡si helyszÃ­n", "200 m mÃ©ly szurdok", "RaftingrÃ³l ismert", "AdriÃ¡ba torkollik"],
      ro: ["Loc de filmare Winnetou", "Canion de 200 m adÃ¢ncime", "Popular pentru rafting", "Se varsÄƒ Ã®n AdriaticÄƒ"],
      en: ["Winnetou filming site", "200 m deep canyon", "Famous for rafting", "Flows into Adriatic"],
      es: ["Lugar de rodaje de Winnetou", "Cañón de 200 m de profundidad", "Conocido por el rafting", "Desemboca en el Adriático"],
      pt: ["Local de filmagem de Winnetou", "Canyon com 200 m de profundidade", "Conhecido pelo rafting", "Desagua no Adriático"],
      fr: ["Lieu de tournage de Winnetou", "Canyon de 200 m de profondeur", "Réputé pour le rafting", "Se jette dans l'Adriatique"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "El río Zrmanja ha excavado un cañón espectacular en el paisaje kárstico y es conocido por sus aguas verde esmeralda y sus estruendosas cascadas.",
      pt: "O rio Zrmanja escavou um canyon espetacular na paisagem cárstica e é conhecido pelas suas águas verde-esmeralda e cascatas impetuosas.",
      fr: "La rivière Zrmanja a creusé un canyon spectaculaire dans le paysage karstique. Elle est réputée pour ses eaux vert émeraude et ses cascades bouillonnantes.",
    },
    factsAdvanced: {
      ...
      es: ["Longitud total del río 69 km", "El cañón tiene hasta 200 m de profundidad", "Lugar de rodaje de películas de Winnetou", "Desemboca en el mar de Novigrad"],
      pt: ["Comprimento total do rio 69 km", "O canyon tem até 200 m de profundidade", "Local de filmagem dos filmes de Winnetou", "Desagua no mar de Novigrad"],
      fr: ["Longueur totale de la rivière 69 km", "Le canyon atteint 200 m de profondeur", "Lieu de tournage des films de Winnetou", "Se jette dans la mer de Novigrad"],
    },
  },
  {
    ...
    description: {
      de: "Die kleine Insel im Pasman-Kanal ist weltweit als 'Herzinsel' bekannt. Ihre fast perfekte Herzform macht sie zu einem berÃ¼hmten NaturphÃ¤nomen.",
      hu: "A Pasman-csatornÃ¡ban talÃ¡lhatÃ³ kis sziget vilÃ¡gszerte 'szÃ­v-szigetkÃ©nt' ismert. Szinte tÃ¶kÃ©letes szÃ­v alakja hÃ­res termÃ©szeti jelensÃ©ggÃ© teszi.",
      ro: "Mica insulÄƒ din canalul Pașman este cunoscutÄƒ Ã®n Ã®ntreaga lume sub numele de â€žinsula inimiiâ€. Forma sa de inimÄƒ este un fenomen natural.",
      ...
      es: "La pequeña isla en el canal de Pasman es conocida mundialmente como la 'isla del corazón'. Su forma de corazón casi perfecta la convierte en un famoso fenómeno natural.",
      pt: "A pequena ilha no canal de Pasman é conhecida mundialmente como a 'ilha do coração'. A sua forma de coração quase perfeita torna-a um famoso fenómeno natural.",
      fr: "La petite île du canal de Pasman est connue dans le monde entier comme l'île du cœur. Sa forme de cœur presque parfaite en fait un phénomène naturel célèbre.",
    },
    facts: {
      de: ["HerzfÃ¶rmige Insel", "Privatbesitz", "Unbewohnt", "Bekannt durch Google Earth"],
      hu: ["SzÃ­v alakÃº sziget", "MagÃ¡ntulajdon", "Lakatlan", "Google Earth tette hÃ­ressÃ©"],
      ro: ["InsulÄƒ Ã®n formÄƒ de inimÄƒ", "Proprietate privatÄƒ", "NelocuitÄƒ", "FaimoasÄƒ pe Google Earth"],
      en: ["Heart-shaped island", "Private property", "Uninhabited", "Famous via Google Earth"],
      es: ["Isla con forma de corazón", "Propiedad privada", "Deshabitada", "Conocida por Google Earth"],
      pt: ["Ilha em forma de coração", "Propriedade privada", "Desabitada", "Conhecida pelo Google Earth"],
      fr: ["Île en forme de cœur", "Propriété privée", "Inhabitée", "Connue grâce à Google Earth"],
    },
imageHint: "Galesnjak heart shaped island aerial",
    descriptionAdvanced: {
      ...
      es: "Galešnjak es conocida como la isla del amor, ya que posee una forma de corazón casi perfecta y es un símbolo del romanticismo en el Adriático croata.",
      pt: "Galešnjak é conhecida como a ilha do amor, pois possui uma forma de coração quase perfeita e é um símbolo de romantismo no Adriático croata.",
      fr: "Galešnjak est connue comme l'île de l'amour, car elle possède une forme de cœur presque parfaite et est un symbole de romantisme dans l'Adriatique croate.",
    },
    factsAdvanced: {
      ...
      es: ["Isla privada en el Adriático", "El perímetro de la isla es de unos 1,55 km", "Superficie de solo 0,132 km²", "Descubierta en Google Earth (2009)"],
      pt: ["Ilha privada no Adriático", "O perímetro da ilha é de cerca de 1,55 km", "Área de apenas 0,132 km²", "Descoberta no Google Earth (2009)"],
      fr: ["Île privée dans l'Adriatique", "Le périmètre de l'île est d'environ 1,55 km", "Superficie de seulement 0,132 km²", "Découverte sur Google Earth (2009)"],
    },
    ...
    description: {
      de: "Dieser 12 km lange Meeresarm in Istrien Ã¤hnelt einem Fjord, ist aber eine Ria. Er ist bekannt fÃ¼r seine Muschel- und Austernzucht.",
      hu: "Ez a 12 km hosszÃº isztriai tengerÃ¶bÃ¶l egy fjordhoz hasonlÃ­t, de valÃ³jÃ¡ban egy ria. KagylÃ³- Ã©s osztrigatenyÃ©sztÃ©sÃ©rÅ‘l ismert.",
      ro: "Acest braț de mare lung de 12 km din Istria seamÄƒnÄƒ cu un fjord, dar este o ria. Este renumit pentru culturile de scoici și stridii.",
      ...
      es: "Este brazo de mar de 12 km de largo en Istria se asemeja a un fiordo, pero es una ría. Es conocido por su cultivo de mejillones y ostras.",
      pt: "Este braço de mar com 12 km de comprimento na Ístria assemelha-se a um fiorde, mas é uma ria. É conhecido pelo seu cultivo de mexilhões e ostras.",
      fr: "Ce bras de mer de 12 km de long en Istrie ressemble à un fjord, mais c'est une ria. Il est connu pour son élevage de moules et d'huîtres.",
    },
    facts: {
      de: ["12 km LÃ¤nge", "Austernzucht", "Eigentlich eine Ria", "Naturschutzgebiet"],
      hu: ["12 km hosszÃº", "OsztrigatenyÃ©sztÃ©s", "ValÃ³jÃ¡ban egy ria", "TermÃ©szetvÃ©delmi terÃ¼let"],
      ro: ["Lungime 12 km", "CulturÄƒ de stridii", "Tehnic este o ria", "Rezervație naturalÄƒ"],
      en: ["12 km long", "Oyster farming", "Actually a ria", "Protected area"],
      es: ["12 km de longitud", "Cultivo de ostras", "En realidad es una ría", "Reserva natural"],
      pt: ["12 km de comprimento", "Cultivo de ostras", "Na verdade é uma ria", "Reserva natural"],
      fr: ["12 km de long", "Élevage d'huîtres", "En fait une ria", "Réserve naturelle"],
    },
imageHint: "Lim Fjord Istria aerial",
    descriptionAdvanced: {
      ...
      es: "El canal de Lim, en la costa oeste de Istria, se asemeja a un fiordo y es conocido por sus empinadas laderas boscosas y su excelente cultivo de mejillones.",
      pt: "O canal de Lim, na costa oeste da Ístria, assemelha-se a um fiorde e é conhecido pelas suas encostas íngremes e arborizadas e pelo excelente cultivo de mexilhões.",
      fr: "Le canal de Lim, sur la côte ouest de l'Istrie, ressemble à un fjord et est réputé pour ses versants boisés escarpés ainsi que pour son excellente conchyliculture.",
    },
    factsAdvanced: {
      ...
      es: ["Longitud del canal unos 12 km", "Profundidad del agua hasta 30 m", "Reserva marítima especial", "Conocido por las ostras y los mejillones"],
      pt: ["Comprimento do canal cerca de 12 km", "Profundidade da água até 30 m", "Reserva marítima especial", "Conhecido pelas ostras e mexilhões"],
      fr: ["Longueur du canal d'environ 12 km", "Profondeur de l'eau jusqu'à 30 m", "Réserve maritime spéciale", "Connu pour ses huîtres et ses moules"],
    },
    ...
    description: {
      de: "Der hÃ¶chste Berg Kroatiens liegt an der Grenze zu Bosnien und Herzegowina. Er gab dem Dinarischen Gebirge seinen Namen.",
      hu: "HorvÃ¡torszÃ¡g legmagasabb hegye a bosznia-hercegovinai hatÃ¡ron talÃ¡lhatÃ³. RÃ³la kapta nevÃ©t a DinÃ¡ri-hegysÃ©g.",
      ro: "Cel mai Ã®nalt munte din Croația este situat la granița cu Bosnia și Herțegovina. A dat numele Munților Dinarici.",
      ...
      es: "La montaña más alta de Croacia se encuentra en la frontera con Bosnia y Herzegovina. Dio nombre a los Alpes Dináricos.",
      pt: "A montanha mais alta da Croácia situa-se na fronteira com a Bósnia e Herzegovina. Deu o nome aos Alpes Dináricos.",
      fr: "La plus haute montagne de Croatie se trouve à la frontière avec la Bosnie-Herzégovine. Elle a donné son nom aux Alpes dinariques.",
    },
    facts: {
      de: ["HÃ¶chster Gipfel 1831 m", "Dinarisches Gebirge", "Grenzberg", "Karstlandschaft"],
      hu: ["Legmagasabb csÃºcs 1831 m", "DinÃ¡ri-hegysÃ©g", "HatÃ¡rhegy", "KarsztvidÃ©k"],
      ro: ["Altitudine maximÄƒ 1831 m", "Munții Dinarici", "Munte de frontierÄƒ", "Peisaj carstic"],
      en: ["Highest peak 1831 m", "Dinaric Alps", "Border mountain", "Karst landscape"],
      es: ["Pico más alto 1831 m", "Alpes Dináricos", "Montaña fronteriza", "Paisaje kárstico"],
      pt: ["Pico mais alto 1831 m", "Alpes Dináricos", "Montanha de fronteira", "Paisagem cárstica"],
      fr: ["Sommet le plus élevé 1831 m", "Alpes dinariques", "Montagne frontalière", "Paysage karstique"],
    },
imageHint: "Dinara mountain rocky summit",
    descriptionAdvanced: {
      ...
      es: "El Dinara es el pico más alto de Croacia y da nombre a toda la cordillera de los Alpes Dináricos, que se extiende a lo largo del oeste de la península balcánica.",
      pt: "O Dinara é o pico mais alto da Croácia e dá o nome a toda a cordilheira dos Alpes Dináricos, que se estende ao longo do oeste da península balcânica.",
      fr: "Le Dinara est le point culminant de Croatie et donne son nom à l'ensemble des Alpes dinariques, qui s'étendent le long de l'ouest de la péninsule balkanique.",
    },
    factsAdvanced: {
      ...
      es: ["La altura del pico es de 1831 metros", "Parque Natural desde el año 2021", "Compuesto predominantemente de piedra caliza", "Montaña fronteriza entre Croacia y Bosnia"],
      pt: ["A altitude do pico é de 1831 metros", "Parque Natural desde o ano de 2021", "Composto predominantemente por calcário", "Montanha de fronteira entre a Croácia e a Bósnia"],
      fr: ["L'altitude du sommet est de 1831 mètres", "Parc naturel depuis 2021", "Principalement composé de calcaire", "Montagne frontalière entre la Croatie et la Bosnie"],
    },
    ...
    coords: [17.47, 43.02],
    description: {
      de: "Das MÃ¼ndungsgebiet der Neretva ist ein riesiges Feuchtgebiet und ein wichtiges Landwirtschaftsareal. Es ist fÃ¼r den Anbau von Mandarinen bekannt.",
      hu: "A Neretva torkolatvidÃ©ke hatalmas vizes Ã©lÅ‘hely Ã©s fontos mezÅ‘gazdasÃ¡gi terÃ¼let. Mandarin termesztÃ©sÃ©rÅ‘l hÃ­res.",
      ro: "Zona de vÄƒrsare a Neretvei este o zonÄƒ umedÄƒ vastÄƒ și o regiune agricolÄƒ importantÄƒ. Este renumitÄƒ pentru cultivarea mandarinelor.",
      ...
      es: "La zona de la desembocadura del Neretva es un enorme humedal y un área agrícola importante. Es conocida por el cultivo de mandarinas.",
      pt: "A zona da foz do Neretva é uma enorme zona húmida e uma importante área agrícola. É conhecida pelo cultivo de tangerinas.",
      fr: "L'estuaire de la Neretva est une vaste zone humide et une zone agricole majeure. Il est réputé pour la culture des mandarines.",
    },
    facts: {
      de: ["Mandarinenanbau", "Vogelzuggebiet", "FlussmÃ¼ndung", "Traditionelle Boote (LaÄ‘a)"],
      hu: ["Mandarin termesztÃ©s", "MadÃ¡rvonulÃ¡si Ãºtvonal", "FolyÃ³torkolat", "HagyomÃ¡nyos LaÄ‘a hajÃ³k"],
      ro: ["Cultivarea mandarinelor", "Ruta migrației pÄƒsÄƒrilor", "Gura de vÄƒrsare a rÃ¢ului", "BÄƒrci tradiționale LaÄ‘a"],
      en: ["Mandarin cultivation", "Bird migration route", "River estuary", "Traditional LaÄ‘a boats"],
      es: ["Cultivo de mandarinas", "Zona de migración de aves", "Desembocadura de río", "Barcos tradicionales (Lađa)"],
      pt: ["Cultivo de tangerinas", "Zona de migração de aves", "Foz de rio", "Barcos tradicionais (Lađa)"],
      fr: ["Culture de mandarines", "Zone de migration des oiseaux", "Embouchure de fleuve", "Bateaux traditionnels (Lađa)"],
    },
imageHint: "Neretva delta mandarin fields",
    descriptionAdvanced: {
      ...
      es: "El delta del Neretva es un paisaje pantanoso fértil en el sur de Croacia, conocido por su intenso cultivo de mandarinas y su rica vida aviar.",
      pt: "O delta do Neretva é uma paisagem pantanosa fértil no sul da Croácia, conhecida pelo seu intenso cultivo de tangerinas e pela rica avifauna.",
      fr: "Le delta de la Neretva est une zone marécageuse fertile du sud de la Croatie, célèbre pour sa culture intensive de mandarines et sa riche avifaune.",
    },
    factsAdvanced: {
      ...
      es: ["Más de 1,4 millones de mandarinos", "Importante reserva ornitológica", "Maratones de barcos tradicionales (Ladja)", "Abarca unas 12.000 hectáreas de superficie"],
      pt: ["Mais de 1,4 milhões de tangerineiras", "Importante reserva ornitológica", "Maratonas de barcos tradicionais (Ladja)", "Abrange cerca de 12.000 hectares de área"],
      fr: ["Plus de 1,4 million de mandariniers", "Réserve ornithologique importante", "Marathons de bateaux traditionnels (Ladja)", "Couvre environ 12 000 hectares"],
    },
    ...
    coords: [15.58, 45.12],
    description: {
      de: "Rastoke ist das historische Zentrum der Stadt Slunj, wo der Fluss SlunjÄica Ã¼ber Kaskaden in die Korana mÃ¼ndet. Es wird oft 'kleines Plitvice' genannt.",
      hu: "Rastoke Slunj vÃ¡rosÃ¡nak tÃ¶rtÃ©nelmi kÃ¶zpontja, ahol a SlunjÄica folyÃ³ kaskÃ¡dokon keresztÃ¼l Ã¶mlik a KoranÃ¡ba. 'Kis PlitvicÃ©nek' is nevezik.",
      ro: "Rastoke este centrul istoric al orașului Slunj, unde rÃ¢ul SlunjÄica se varsÄƒ Ã®n Korana prin cascade. Este supranumit â€žmicul Plitviceâ€.",
      en: "Rastoke is the historic center of Slunj, where the SlunjÄica River flows into the Korana over cascades. it is often called 'little Plitvice'.",
      es: "Rastoke es el centro histórico de la ciudad de Slunj, donde el río Slunjčica desemboca en el Korana a través de cascadas. A menudo se le llama 'pequeño Plitvice'.",
      pt: "Rastoke é o centro histórico da cidade de Slunj, onde o rio Slunjčica desagua no Korana através de cascatas. É frequentemente chamado de 'pequeno Plitvice'.",
      fr: "Rastoke est le centre historique de la ville de Slunj, où la rivière Slunjčica se jette dans la Korana en cascades. On l'appelle souvent le 'petit Plitvice'.",
    },
    facts: {
      de: ["Kleines Plitvice", "WassermÃ¼hlen", "Zusammenfluss zweier FlÃ¼sse", "Historisches Dorf"],
      hu: ["Kis Plitvice", "VÃ­zimalmok", "KÃ©t folyÃ³ talÃ¡lkozÃ¡sa", "TÃ¶rtÃ©nelmi falu"],
      ro: ["Micul Plitvice", "Mori de apÄƒ", "Confluența a douÄƒ rÃ¢uri", "Sat istoric"],
      en: ["Little Plitvice", "Watermills", "Confluence of two rivers", "Historic village"],
      es: ["Pequeño Plitvice", "Molinos de agua", "Confluencia de dos ríos", "Pueblo histórico"],
      pt: ["Pequeno Plitvice", "Moinhos de água", "Confluência de dois rios", "Aldeia histórica"],
      fr: ["Petit Plitvice", "Moulins à eau", "Confluent de deux rivières", "Village historique"],
    },
imageHint: "Rastoke waterfalls and houses",
    descriptionAdvanced: {
      ...
      es: "Rastoke es a menudo descrito como los pequeños lagos de Plitvice, donde el río Slunjčica se precipita al Korana a través de numerosas cascadas y saltos de agua.",
      pt: "Rastoke é frequentemente descrito como os pequenos lagos de Plitvice, onde o rio Slunjčica se precipita no Korana através de inúmeras cascatas e quedas de água.",
      fr: "Rastoke est souvent décrit comme un petit Plitvice, où la rivière Slunjčica se jette dans la Korana par de nombreuses cascades et chutes d'eau.",
    },
    factsAdvanced: {
      ...
      es: ["Situado en la ciudad de Slunj", "Molinos de agua históricos en el río", "El río Slunjčica solo tiene 6,5 km de largo", "Centro de la artesanía de molienda"],
      pt: ["Situado na cidade de Slunj", "Moinhos de água históricos no rio", "O rio Slunjčica tem apenas 6,5 km de comprimento", "Centro do ofício de moagem"],
      fr: ["Situé dans la ville de Slunj", "Moulins à eau historiques sur la rivière", "La rivière Slunjčica ne mesure que 6,5 km", "Ancien centre de meunerie"],
    },
    ...
    description: {
      de: "Ein ovaler Salzwassersee in Rogoznica, der von hohen Felsen umgeben ist. Er ist bekannt fÃ¼r seine thermochemische Schichtung und lokale Legenden.",
      hu: "RogoznicÃ¡ban talÃ¡lhatÃ³ ovÃ¡lis sÃ³s tÃ³, amelyet magas sziklÃ¡k vesznek kÃ¶rÃ¼l. TermokÃ©miai rÃ©tegzÅ‘dÃ©sÃ©rÅ‘l Ã©s legendÃ¡irÃ³l ismert.",
      ro: "Un lac sÄƒrat oval Ã®n Rogoznica, Ã®nconjurat de stÃ¢nci Ã®nalte. Este cunoscut pentru stratificarea termochimicÄƒ și legendele locale.",
      ...
      es: "Un lago ovalado de agua salada en Rogoznica rodeado de altas rocas. Es conocido por su estratificación termoquímica y sus leyendas locales.",
      pt: "Um lago oval de água salgada em Rogoznica, rodeado por rochas altas. É conhecido pela sua estratificação termoquímica e lendas locais.",
      fr: "Un lac d'eau salée ovale à Rogoznica, entouré de hautes falaises. Il est connu pour sa stratification thermochimique et ses légendes locales.",
    },
    facts: {
      de: ["Salzwassersee", "Tiefe 15 m", "Rogoznica", "NaturphÃ¤nomen"],
      hu: ["SÃ³s tÃ³", "15 m mÃ©ly", "Rogoznica", "TermÃ©szeti jelensÃ©g"],
      ro: ["Lac sÄƒrat", "AdÃ¢ncime 15 m", "Rogoznica", "Fenomen natural"],
      en: ["Saltwater lake", "Depth 15 m", "Rogoznica", "Natural phenomenon"],
      es: ["Lago de agua salada", "Profundidad 15 m", "Rogoznica", "Fenómeno natural"],
      pt: ["Lago de água salgada", "Profundidade 15 m", "Rogoznica", "Fenómeno natural"],
      fr: ["Lac d'eau salée", "Profondeur 15 m", "Rogoznica", "Phénomène naturel"],
    },
imageHint: "Dragons Eye lake Rogoznica",
    descriptionAdvanced: {
      ...
      es: "El Ojo del Dragón en Rogoznica es un lago salado circular rodeado de altas rocas que representa un fenómeno ecológico único.",
      pt: "O Olho do Dragão em Rogoznica é um lago salgado circular rodeado por rochas altas e representa um fenómeno ecológico único.",
      fr: "L'Œil du Dragon à Rogoznica est un lac salé circulaire entouré de hautes falaises, représentant un phénomène écologique unique.",
    },
    factsAdvanced: {
      ...
      es: ["La profundidad del lago es de unos 15 metros", "Superficie de unos 10.000 metros cuadrados", "Conexión con el mar a través de cuevas", "Conocido por el efecto de ebullición"],
      pt: ["A profundidade do lago é de cerca de 15 metros", "Área de cerca de 10.000 metros quadrados", "Ligação ao mar através de grutas", "Conhecido pelo efeito de ebulição"],
      fr: ["La profondeur du lac est d'environ 15 mètres", "Superficie d'environ 10 000 mètres carrés", "Connexion à la mer par des grottes", "Connu pour son effet d'ébullition"],
    },
    ...
    description: {
      de: "Das Goldene Horn ist eine markante Landzunge aus weiÃŸem Kies auf der Insel BraÄ. Seine Spitze verÃ¤ndert je nach Wind und StrÃ¶mung ihre Form.",
      hu: "Az Arany-szarv egy fehÃ©r kavicsos fÃ¶ldnyelv BraÄ szigetÃ©n. CsÃºcsa a szÃ©l Ã©s az Ã¡ramlatok fÃ¼ggvÃ©nyÃ©ben vÃ¡ltoztatja alakjÃ¡t.",
      ro: "Cornul de Aur este o limbÄƒ de pÄƒmÃ¢nt formatÄƒ din pietriș alb pe insula BraÄ. VÃ¢rful sÄƒu Ã®și schimbÄƒ forma Ã®n funcție de vÃ¢nt.",
      en: "The Golden Horn is a distinct white pebble spit on BraÄ island. Its tip changes shape depending on the wind and sea currents.",
      es: "El Cuerno de Oro es una prominente lengua de tierra de guijarros blancos en la isla de Brač. Su punta cambia de forma según el viento y las corrientes.",
      pt: "O Corno de Ouro é uma língua de terra proeminente feita de seixos brancos na ilha de Brač. A sua ponta muda de forma dependendo do vento e das correntes.",
      fr: "La Corne d'Or est une avancée de terre remarquable composée de galets blancs sur l'île de Brač. Sa pointe change de forme selon le vent et les courants.",
    },
    facts: {
      de: ["Insel BraÄ", "VerÃ¤nderliche Form", "WeiÃŸer Kieselstrand", "Geomorphologisches Denkmal"],
      hu: ["BraÄ-sziget", "VÃ¡ltozÃ³ alak", "FehÃ©r kavicsos strand", "GeomorfolÃ³giai műemlÃ©k"],
      ro: ["Insula BraÄ", "FormÄƒ variabilÄƒ", "PlajÄƒ cu pietriș alb", "Monument geomorfologic"],
      en: ["BraÄ island", "Shifting shape", "White pebble beach", "Geomorphological monument"],
      es: ["Isla de Brač", "Forma cambiante", "Playa de guijarros blancos", "Monumento geomorfológico"],
      pt: ["Ilha de Brač", "Forma mutável", "Praia de seixos brancos", "Monumento geomorfológico"],
      fr: ["Île de Brač", "Forme changeante", "Plage de galets blancs", "Monument géomorphologique"],
    },
imageHint: "Zlatni Rat beach aerial view",
    descriptionAdvanced: {
      ...
      es: "Zlatni Rat en la isla de Brač es una de las playas más distintivas del mundo, cuya punta se mueve según el viento y las corrientes en el Adriático.",
      pt: "Zlatni Rat, na ilha de Brač, é uma das praias mais marcantes do mundo, cuja ponta se move dependendo do vento e das correntes no Adriático.",
      fr: "Zlatni Rat sur l'île de Brač est l'une des plages les plus emblématiques au monde, dont la pointe se déplace au gré du vent et des courants de l'Adriatique.",
    },
    factsAdvanced: {
      ...
      es: ["Longitud de la lengua de tierra unos 630 m", "Compuesta de finos guijarros", "Considerada un símbolo de Croacia", "Situada cerca de Bol"],
      pt: ["Comprimento da língua de terra cerca de 630 m", "Composta por seixos finos", "Considerada um símbolo da Croácia", "Localizada perto de Bol"],
      fr: ["Longueur de la pointe environ 630 m", "Composée de fins galets", "Considérée comme l'emblème de la Croatie", "Située à proximité de Bol"],
    },
    ...
    description: {
      ...
      hu: "MÃ©lyen fekvÅ‘ karszttÃ³ egy tÃ¶lcsÃ©r alakÃº mÃ©lyedÃ©sben Imotski szÃ©lÃ©n. SzÃ¡raz nyarakon a tÃ³ teljesen kiszÃ¡radhat.",
      ro: "Un lac carstic situat Ã®ntr-o dolinÄƒ adÃ¢ncÄƒ la marginea orașului Imotski. ÃŽn verile secetoase, lacul poate seca complet.",
      en: "A karst lake located in a deep sinkhole on the edge of Imotski. In dry summers, the lake can completely dry out.",
      es: "Un lago kárstico profundo en una profunda dolina a las afueras de Imotski. En veranos secos, el lago puede secarse por completo.",
      pt: "Um lago cárstico profundo numa dolina profunda nos arredores de Imotski. Em verões secos, o lago pode secar completamente.",
      fr: "Un lac karstique profond dans une doline profonde en bordure d'Imotski. Lors des étés secs, le lac peut s'assécher complètement.",
    },
    facts: {
      de: ["Karst-Doline", "Kann austrocknen", "Nahe Imotski", "Wanderwege zum Wasser"],
      hu: ["Karszt-dolina", "KiszÃ¡radhat", "Imotski kÃ¶zelÃ©ben", "GyalogÃºt a vÃ­zhez"],
      ro: ["DolinÄƒ carsticÄƒ", "Poate seca", "LÃ¢ngÄƒ Imotski", "Traseu pÃ¢nÄƒ la apÄƒ"],
      en: ["Karst sinkhole", "Can dry out", "Near Imotski", "Walking path to water"],
      es: ["Dolina kárstica", "Puede secarse", "Cerca de Imotski", "Senderos hacia el agua"],
      pt: ["Dolina cárstica", "Pode secar", "Perto de Imotski", "Trilhos de caminhada até à água"],
      fr: ["Doline karstique", "Peut s'assécher", "Près d'Imotski", "Sentiers de randonnée vers l'eau"],
    },
imageHint: "Blue lake Imotski sinkhole",
    descriptionAdvanced: {
      ...
      es: "El Lago Azul cerca de Imotski se encuentra en el fondo de una enorme dolina de colapso y es conocido por su color azul intenso y las fuertes fluctuaciones del nivel del agua.",
      pt: "O Lago Azul perto de Imotski situa-se no fundo de uma enorme dolina de colapso e é conhecido pela sua cor azul intensa e pelas fortes flutuações do nível da água.",
      fr: "Le Lac Bleu près d'Imotski se trouve au fond d'une immense doline d'effondrement et est connu pour sa couleur bleue intense ainsi que pour les fortes variations de son niveau d'eau.",
    },
    factsAdvanced: {
      ...
      es: ["Puede secarse completamente en verano", "La profundidad varía hasta los 100 metros", "La dolina tiene más de 200 m de profundidad", "Monumento natural desde el año 1964"],
      pt: ["Pode secar completamente no verão", "A profundidade varia até 100 metros", "A dolina tem mais de 200 m de profundidade", "Monumento natural desde o ano de 1964"],
      fr: ["Peut s'assécher complètement en été", "La profondeur varie jusqu'à 100 mètres", "La doline fait plus de 200 m de profondeur", "Monument naturel depuis 1964"],
    },
    ...
    coords: [17.2, 43.455],
    description: {
      de: "Einer der tiefsten wassergefÃ¼llten Dolinen der Welt, bekannt fÃ¼r seine roten FelswÃ¤nde. Die Gesamttiefe betrÃ¤gt Ã¼ber 500 Meter.",
      hu: "A vilÃ¡g egyik legmÃ©lyebb vÃ­zzel telt dolinÃ¡ja, vÃ¶rÃ¶ses sziklafalairÃ³l ismert. Az Ã¶sszhosszÃºsÃ¡g meghaladja az 500 mÃ©tert.",
      ro: "Una dintre cele mai adÃ¢nci doline pline cu apÄƒ din lume, renumitÄƒ pentru pereții sÄƒi stÃ¢ncoși roșiatici. AdÃ¢ncimea totalÄƒ depÄƒșește 500 m.",
      ...
      es: "Una de las dolinas llenas de agua más profundas del mundo, conocida por sus paredes de roca roja. La profundidad total supera los 500 metros.",
      pt: "Uma das dolinas cheias de água mais profundas do mundo, conhecida pelas suas paredes de rocha vermelha. A profundidade total ultrapassa os 500 metros.",
      fr: "L'une des dolines inondées les plus profondes au monde, connue pour ses parois rocheuses rouges. Sa profondeur totale dépasse les 500 mètres.",
    },
    facts: {
      de: ["Ãœber 500 m tief", "Rote FelswÃ¤nde", "Dritttiefste Doline weltweit", "KarstphÃ¤nomen"],
      hu: ["TÃ¶bb mint 500 m mÃ©ly", "VÃ¶rÃ¶s sziklafalak", "A vilÃ¡g 3. legmÃ©lyebb dolinÃ¡ja", "KarsztjelensÃ©g"],
      ro: ["AdÃ¢ncime peste 500 m", "Pereți roșiatici", "A treia dolinÄƒ ca adÃ¢ncime", "Fenomen carstic"],
      en: ["Depth over 500 m", "Reddish cliffs", "3rd deepest sinkhole globally", "Karst phenomenon"],
      es: ["Más de 500 m de profundidad", "Paredes de roca roja", "Tercera dolina más profunda del mundo", "Fenómeno kárstico"],
      pt: ["Mais de 500 m de profundidade", "Paredes de rocha vermelha", "Terceira dolina mais profunda do mundo", "Fenómeno cárstico"],
      fr: ["Plus de 500 m de profondeur", "Parois rocheuses rouges", "Troisième doline la plus profonde au monde", "Phénomène karstique"],
    },
imageHint: "Red lake Imotski deep hole",
    descriptionAdvanced: {
      ...
      es: "El Lago Rojo es una de las dolinas más profundas del mundo, llamada así por las rocas rojizas que caen verticalmente hacia el lago kárstico y que casi nunca se secan.",
      pt: "O Lago Vermelho é uma das dolinas mais profundas do mundo, nomeada devido às rochas avermelhadas que descem verticalmente para o lago cárstico e que quase nunca secam.",
      fr: "Le Lac Rouge est l'une des dolines les plus profondes au monde, nommée d'après ses falaises rougeâtres qui plongent à pic dans ce lac karstique ne s'asséchant jamais.",
    },
    factsAdvanced: {
      ...
      es: ["Profundidad total de la dolina aprox. 528 m", "El nivel del agua está muy por debajo del suelo", "La profundidad del agua alcanza hasta 287 m", "Situado cerca del Lago Azul"],
      pt: ["Profundidade total da dolina aprox. 528 m", "O nível da água está muito abaixo do solo", "A profundidade da água atinge até 287 m", "Situado perto do Lago Azul"],
      fr: ["Profondeur totale de la doline environ 528 m", "Le niveau d'eau est bien en dessous du sol", "La profondeur de l'eau atteint jusqu'à 287 m", "Situé à proximité du Lac Bleu"],
    },
    ...
    coords: [16.0145, 42.9804],
    description: {
      de: "Diese MeereshÃ¶hle auf der Insel BiÅ¡evo ist fÃ¼r ihr leuchtend blaues Licht bekannt. Das PhÃ¤nomen entsteht durch Sonnenstrahlen, die durch eine UnterwasserÃ¶ffnung eindringen.",
      hu: "A BiÅ¡evo-szigeten talÃ¡lhatÃ³ tengeri barlang a kÃ¼lÃ¶nleges kÃ©k fÃ©nyÃ©rÅ‘l nevezetes. A jelensÃ©get a vÃ­z alatti nyÃ­lÃ¡son Ã¡t behatolÃ³ Ã©s a fehÃ©r homokrÃ³l visszaverÅ‘dÅ‘ napfÃ©ny okozza.",
      ro: "AceastÄƒ peșterÄƒ marinÄƒ de pe insula BiÅ¡evo este faimoasÄƒ pentru lumina sa albastrÄƒ strÄƒlucitoare. Fenomenul este creat de razele soarelui care pÄƒtrund printr-o deschidere subacvaticÄƒ.",
      en: "This sea cave on BiÅ¡evo island is famous for its glowing blue light. The phenomenon is created by sunlight entering through an underwater opening and reflecting off the white floor.",
      es: "Esta cueva marina en la isla de Biševo es conocida por su brillante luz azul. El fenómeno se produce por los rayos de sol que penetran a través de una abertura submarina.",
      pt: "Esta gruta marinha na ilha de Biševo é conhecida pela sua luz azul brilhante. O fenómeno é criado pelos raios solares que penetram através de uma abertura subaquática.",
      fr: "Cette grotte marine sur l'île de Biševo est connue pour sa lumière bleue éclatante. Le phénomène est créé par les rayons du soleil pénétrant par une ouverture sous-marine.",
    },
    facts: {
      de: ["Entdeckt im Jahr 1884", "Eingang durch Baron Eugen von Ransonnet gesprengt", "Beste LichtverhÃ¤ltnisse zwischen 11:00 und 12:00 Uhr", "Befindet sich in der Bucht Balun"],
      hu: ["1884-ben fedeztÃ©k fel a nagykÃ¶zÃ¶nsÃ©g szÃ¡mÃ¡ra", "Az entrance-t Eugen von Ransonnet bÃ¡rÃ³ vÃ¡jatta ki", "A fÃ©nyhatÃ¡s 11 Ã©s 12 Ã³ra kÃ¶zÃ¶tt a legerÅ‘sebb", "A Balun-Ã¶bÃ¶l meredek sziklÃ¡i kÃ¶zÃ¶tt talÃ¡lhatÃ³"],
      ro: ["DescoperitÄƒ Ã®n anul 1884", "Intrarea a fost lÄƒrgitÄƒ de baronul Eugen von Ransonnet", "Efectul maxim de luminÄƒ apare Ã®ntre orele 11:00 și 12:00", "SituatÄƒ Ã®n golful Balun de pe coasta esticÄƒ"],
      en: ["Discovered for the public in 1884", "Entrance was expanded by Baron Eugen von Ransonnet", "Best light effects occur between 11:00 and 12:00", "Located in the Balun Bay on BiÅ¡evo island"],
      es: ["Descubierta en el año 1884", "Entrada abierta con explosivos por el barón Eugen von Ransonnet", "Mejores condiciones de luz entre las 11:00 y las 12:00 horas", "Se encuentra en la bahía de Balun"],
      pt: ["Descoberta no ano de 1884", "Entrada aberta com explosivos pelo barão Eugen von Ransonnet", "Melhores condições de luz entre as 11:00 e as 12:00 horas", "Localizada na baía de Balun"],
      fr: ["Découverte en 1884", "Entrée dynamitée par le baron Eugen von Ransonnet", "Meilleures conditions de lumière entre 11h00 et 12h00", "Située dans la baie de Balun"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "La Cueva Azul en la isla de Biševo es una maravilla natural de fama mundial, donde la luz del sol crea una mágica luz azul a través de una abertura submarina.",
      pt: "A Gruta Azul na ilha de Biševo é uma maravilha natural de renome mundial, onde a luz solar cria uma luz azul mágica através de uma abertura subaquática.",
      fr: "La Grotte Bleue sur l'île de Biševo est une merveille naturelle mondialement connue, où la lumière du soleil crée une lumière bleue magique à travers une ouverture sous-marine.",
    },
    factsAdvanced: {
      ...
      es: ["La gruta tiene unos 24 metros de largo", "Mejor hora de visita entre las 11 y las 12", "La entrada fue ampliada artificialmente en 1884", "Situada en la bahía de Balun"],
      pt: ["A gruta tem cerca de 24 metros de comprimento", "Melhor horário de visita entre as 11h e as 12h", "A entrada foi ampliada artificialmente em 1884", "Situada na baía de Balun"],
      fr: ["La grotte mesure environ 24 mètres de long", "Meilleur moment pour la visite entre 11h et 12h", "L'entrée a été élargie artificiellement en 1884", "Située dans la baie de Balun"],
    },
  },
  {
    ...
    description: {
      ...
      hu: "A Klek egy jellegzetes hegycsÃºcs a Nagy-Kapela hegysÃ©g szÃ©lÃ©n. FormÃ¡ja egy alvÃ³ Ã³riÃ¡sra emlÃ©keztet, Ã©s a horvÃ¡t hegymÃ¡szÃ¡s szÃ¼lÅ‘helyekÃ©nt tartjÃ¡k szÃ¡mon.",
      ro: "Klek este un munte proeminent la marginea masivului Velika Kapela. Forma sa caracteristicÄƒ seamÄƒnÄƒ cu un uriaș adormit și este considerat leagÄƒnul alpinismului croat.",
      ...
      es: "El Klek es una montaña prominente en el borde del macizo de Velika Kapela. Su forma característica recuerda a un gigante dormido y es considerada la cuna del montañismo croata.",
      pt: "O Klek é uma montanha proeminente na borda do maciço de Velika Kapela. A sua forma característica lembra um gigante adormecido e é considerada o berço do montanhismo croata.",
      fr: "Le Klek est une montagne remarquable en bordure du massif de Velika Kapela. Sa forme caractéristique rappelle un géant endormi et est considérée comme le berceau de l'alpinisme croate.",
    },
    facts: {
      de: ["Maximale HÃ¶he von 1181 Metern", "Erstes Bergsteigerabzeichen Kroatiens hier entstanden", "Legende besagt, Hexen versammeln sich auf dem Gipfel", "Befindet sich in der NÃ¤he der Stadt Ogulin"],
      hu: ["Legmagasabb pontja 1181 mÃ©ter", "A horvÃ¡t hegymÃ¡szÃ¡s bÃ¶lcsÅ‘jekÃ©nt ismert", "A legenda szerint boszorkÃ¡nyok gyÃ¼lekezÅ‘helye", "Ogulin vÃ¡rosa felett magasodik"],
      ro: ["ÃŽnÄƒlțime maximÄƒ de 1181 metri", "Locul de naștere al alpinismului croat", "Legenda spune cÄƒ vrÄƒjitoarele se adunÄƒ pe vÃ¢rf", "Situat Ã®n apropierea orașului Ogulin"],
      ...
      es: ["Altura máxima de 1181 metros", "La primera insignia de montañismo de Croacia se creó aquí", "La leyenda dice que las brujas se reúnen en la cima", "Se encuentra cerca de la ciudad de Ogulin"],
      pt: ["Altura máxima de 1181 metros", "A primeira insígnia de montanhismo da Croácia surgiu aqui", "A lenda diz que as bruxas se reúnem no topo", "Situa-se perto da cidade de Ogulin"],
      fr: ["Altitude maximale de 1181 mètres", "Le premier insigne d'alpinisme de Croatie a été créé ici", "La légende raconte que des sorcières se réunissent au sommet", "Situé près de la ville d'Ogulin"],
    },
imageHint: "Klek mountain peak sleeping giant shape",
    descriptionAdvanced: {
      ...
      es: "La montaña Klek cerca de Ogulin es conocida por su forma distintiva, que se asemeja a un gigante dormido, y es considerada el lugar de nacimiento del montañismo croata.",
      pt: "A montanha Klek perto de Ogulin é conhecida pela sua forma distinta, que se assemelha a um gigante adormecido, e é considerada o local de nascimento do montanhismo croata.",
      fr: "Le mont Klek, près d'Ogulin, est connu pour sa forme remarquable rappelant un géant endormi, et est considéré comme le lieu de naissance de l'alpinisme croate.",
    },
    factsAdvanced: {
      ...
      es: ["Altura de la cima 1182 metros", "Prominente pared de roca de 200 m de altura", "Centro de numerosas leyendas de brujas", "Área protegida desde el año 1971"],
      pt: ["Altitude do cume 1182 metros", "Parede de rocha proeminente com 200 m de altura", "Centro de numerosas lendas de bruxas", "Área protegida desde o ano de 1971"],
      fr: ["Altitude du sommet 1182 mètres", "Paroi rocheuse remarquable de 200 m de haut", "Centre de nombreuses légendes de sorcières", "Zone protégée depuis l'année 1971"],
    },
    ...
    coords: [15.8451, 44.1932],
    description: {
      de: "Die Krupa ist ein kurzer, aber wasserreicher Nebenfluss der Zrmanja im Velebit-Massiv. Sie ist bekannt fÃ¼r ihre zahlreichen Kaskaden und die historische BrÃ¼cke Kudin most.",
      hu: "A Krupa a Zrmanja rÃ¶vid, de bÅ‘vizű mellÃ©kfolyÃ³ja a Velebit-hegysÃ©gben. SzÃ¡mos vÃ­zesÃ©sÃ©rÅ‘l Ã©s a tÃ¶rtÃ©nelmi Kuda-hÃ­drÃ³l (Kudin most) nevezetes.",
      ro: "Krupa este un afluent scurt, dar bogat Ã®n apÄƒ, al rÃ¢ului Zrmanja din masivul Velebit. Este cunoscut pentru numeroasele sale cascade și podul istoric Kudin most.",
      ...
      es: "El Krupa es un afluente corto pero caudaloso del Zrmanja en el macizo de Velebit. Es conocido por sus numerosas cascadas y el histórico puente Kudin most.",
      pt: "O Krupa é um afluente curto mas caudaloso do Zrmanja no maciço de Velebit. É conhecido pelas suas numerosas cascatas e pela histórica ponte Kudin most.",
      fr: "La Krupa est un affluent court mais abondant de la Zrmanja dans le massif du Velebit. Elle est connue pour ses nombreuses cascades et son pont historique Kudin most.",
    },
    facts: {
      de: ["Besitzt 19 WasserfÃ¤lle auf kurzer Strecke", "Kudin most BrÃ¼cke wurde im 19. Jahrhundert erbaut", "FlieÃŸt durch eine tiefe Karstschlucht", "GesamtlÃ¤nge betrÃ¤gt nur etwa 7 Kilometer"],
      hu: ["RÃ¶vid szakaszÃ¡n 19 vÃ­zesÃ©s talÃ¡lhatÃ³", "A Kudin most hÃ­d a 19. szÃ¡zad elejÃ©n Ã©pÃ¼lt", "MÃ©ly karsztkanyonban halad keresztÃ¼l", "Teljes hossza mindÃ¶ssze 7 kilomÃ©ter"],
      ro: ["Are 19 cascade pe o distanțÄƒ scurtÄƒ", "Podul Kudin most a fost construit Ã®n secolul XIX", "Curge printr-un canion carstic adÃ¢nc", "Lungimea totalÄƒ este de aproximativ 7 kilometri"],
      ...
      es: ["Tiene 19 cascadas en un tramo corto", "El puente Kudin most fue construido en el siglo XIX", "Fluye a través de un profundo cañón kárstico", "La longitud total es de solo unos 7 kilómetros"],
      pt: ["Possui 19 cascatas num percurso curto", "A ponte Kudin most foi construída no século XIX", "Flui através de um desfiladeiro cárstico profundo", "O comprimento total é de apenas cerca de 7 quilômetros"],
      fr: ["Possède 19 cascades sur une courte distance", "Le pont Kudin most a été construit au XIXe siècle", "Coule à travers un profond canyon karstique", "La longueur totale n'est que d'environ 7 kilomètres"],
    },
imageHint: "Krupa river canyon Kudin most bridge",
    descriptionAdvanced: {
      ...
      es: "El Krupa es un pequeño pero excepcionalmente bello afluente del Zrmanja, famoso por sus cascadas y el histórico puente de piedra Kudin Most.",
      pt: "O Krupa é um pequeno mas excecionalmente belo afluente do Zrmanja, famoso pelas suas cascatas e pela histórica ponte de pedra Kudin Most.",
      fr: "La Krupa est un petit affluent exceptionnellement beau de la Zrmanja, célèbre pour ses cascades et son pont historique en pierre Kudin Most.",
    },
    factsAdvanced: {
      ...
      es: ["Longitud del río solo 7 km", "Posee 19 impresionantes cascadas", "El puente Kudin Most tiene 12 arcos", "Construido a finales del siglo XVIII"],
      pt: ["Comprimento do rio apenas 7 km", "Possui 19 cascatas impressionantes", "A ponte Kudin Most tem 12 arcos", "Construída no final do século XVIII"],
      fr: ["Longueur de la rivière de seulement 7 km", "Possède 19 cascades impressionnantes", "Le pont Kudin Most possède 12 arches", "Construit à la fin du XVIIIe siècle"],
    },
    ...
    coords: [16.2341, 43.0198],
    description: {
      de: "Diese kleine Bucht auf der SÃ¼dseite der Insel Vis ist von hohen, engen Klippen umgeben. Sie entstand vermutlich durch den Einsturz einer ehemaligen HÃ¶hlendecke.",
      hu: "A Vis-sziget dÃ©li oldalÃ¡n talÃ¡lhatÃ³ kis Ã¶blÃ¶t magas, szűk sziklafalak veszik kÃ¶rÃ¼l. ValÃ³szÃ­nűleg egy korÃ¡bbi barlang mennyezetÃ©nek beomlÃ¡sÃ¡val jÃ¶tt lÃ©tre.",
      ro: "Acest mic golf de pe partea de sud a insulei Vis este Ã®nconjurat de stÃ¢nci Ã®nalte și Ã®nguste. S-a format probabil prin prÄƒbușirea tavanului unei foste peșteri.",
      ...
      es: "Esta pequeña caleta en el lado sur de la isla de Vis está rodeada de altos y estrechos acantilados. Probablemente se formó por el colapso del techo de una antigua cueva.",
      pt: "Esta pequena enseada no lado sul da ilha de Vis é cercada por falésias altas e estreitas. Provavelmente formou-se devido ao colapso do teto de uma antiga gruta.",
      fr: "Cette petite crique sur la côte sud de l'île de Vis est entourée de hautes falaises étroites. Elle s'est probablement formée par l'effondrement du plafond d'une ancienne grotte.",
    },
    facts: {
      de: ["Zugang vom Meer nur durch einen 4 Meter breiten Spalt", "Seit 1967 als geomorphologisches Naturdenkmal geschÃ¼tzt", "Befindet sich in der NÃ¤he des Dorfes Marinje Zemlje", "Kiesstrand ist nur durch steile Pfade erreichbar"],
      hu: ["A tenger felÅ‘li bejÃ¡rata mindÃ¶ssze 4 mÃ©ter szÃ©les", "1967 Ã³ta vÃ©dett geomorfolÃ³giai emlÃ©k", "Marinje Zemlje falu kÃ¶zelÃ©ben fekszik", "Csak meredek gyalogÃ¶svÃ©nyen vagy hajÃ³val Ã©rhetÅ‘ el"],
      ro: ["Accesul maritim se face printr-o fantÄƒ de 4 metri", "Protejat ca monument geomorfologic din 1967", "Situat Ã®n apropierea satului Marinje Zemlje", "Plaja cu pietriș este accesibilÄƒ prin poteci abrupte"],
      ...
      es: ["Acceso desde el mar solo por una brecha de 4 metros", "Protegida desde 1967 como monumento geomorfológico natural", "Se encuentra cerca del pueblo de Marinje Zemlje", "Playa de guijarros accesible solo por senderos empinados"],
      pt: ["Acesso pelo mar apenas por uma fenda de 4 metros", "Protegida desde 1967 como monumento natural geomorfológico", "Situa-se perto da aldeia de Marinje Zemlje", "Praia de seixos acessível apenas por trilhos íngremes"],
      fr: ["Accès par la mer via un passage de 4 mètres", "Classée monument naturel géomorphologique depuis 1967", "Située près du village de Marinje Zemlje", "Plage de galets accessible uniquement par des sentiers escarpés"],
    },
imageHint: "Stiniva cove Vis island cliffs beach",
    descriptionAdvanced: {
      ...
      es: "La caleta Stiniva en la isla de Vis es una perla escondida, separada del mar abierto por un acceso de roca extremadamente estrecho.",
      pt: "A enseada de Stiniva na ilha de Vis é uma pérola escondida, separada do mar aberto por um acesso rochoso extremamente estreito.",
      fr: "La crique de Stiniva, sur l'île de Vis, est une perle cachée séparée de la mer ouverte par un passage rocheux extrêmement étroit.",
    },
    factsAdvanced: {
      ...
      es: ["Acceso desde el mar solo de 4 m de ancho", "Monumento natural desde el año 1967", "Solo accesible en barco o por un sendero empinado", "Antiguamente una cueva colapsada"],
      pt: ["Acesso pelo mar apenas com 4 m de largura", "Monumento natural desde o ano 1967", "Apenas acessível por barco ou trilho íngreme", "Antigamente uma gruta colapsada"],
      fr: ["Accès marin de seulement 4 m de large", "Monument naturel depuis 1967", "Accessible uniquement par bateau ou sentier escarpé", "Ancienne grotte effondrée"],
    },
    ...
    coords: [14.9695, 45.2218],
    description: {
      de: "Dieses strenge Naturreservat in Gorski Kotar ist berÃ¼hmt fÃ¼r seine spektakulÃ¤ren weiÃŸen Karstfelsen. Die bizarren Formationen ragen aus dichten NadelwÃ¤ldern empor.",
      hu: "Ez a szigorÃºan vÃ©dett termÃ©szetvÃ©delmi terÃ¼let Gorski Kotarban talÃ¡lhatÃ³, Ã©s lÃ¡tvÃ¡nyos fehÃ©r karsztsziklÃ¡irÃ³l hÃ­res. A bizarr formÃ¡ciÃ³k sűrű fenyÅ‘erdÅ‘kbÅ‘l emelkednek ki.",
      ro: "AceastÄƒ rezervație naturalÄƒ strictÄƒ din Gorski Kotar este faimoasÄƒ pentru stÃ¢ncile sale spectaculoase de carst alb. Formațiunile bizare se ridicÄƒ din pÄƒduri dese de conifere.",
      ...
      es: "Esta reserva natural estricta en Gorski Kotar es famosa por sus espectaculares rocas kársticas blancas. Las extrañas formaciones emergen de densos bosques de coníferas.",
      pt: "Esta reserva natural estrita em Gorski Kotar é famosa pelas suas espetaculares rochas cársticas brancas. As formações bizarras emergem de densas florestas de coníferas.",
      fr: "Cette réserve naturelle intégrale dans le Gorski Kotar est célèbre pour ses spectaculaires rochers karstiques blancs. Les formations bizarres s'élèvent au-dessus de denses forêts de conifères.",
    },
    facts: {
      de: ["Teil des Velika-Kapela-Gebirgszugs", "HÃ¶chster Punkt erreicht 1335 Meter", "Bekannt fÃ¼r die Formation Finger des Kaisers", "Strenge Schutzstufe untersagt jegliche Forstwirtschaft"],
      hu: ["A Nagy-Kapela hegysÃ©g rÃ©szÃ©t kÃ©pezi", "Legmagasabb pontja 1335 mÃ©ter", "HÃ­res formÃ¡ciÃ³ja a CsÃ¡szÃ¡r ujja (Prst)", "A legszigorÃºbb vÃ©dettsÃ©gi kategÃ³riÃ¡ba tartozik"],
      ro: ["Parte a lanțului muntos Velika Kapela", "Cel mai Ã®nalt punct atinge 1335 metri", "Cunoscut pentru formațiunea Degetul ÃŽmpÄƒratului", "Statutul de rezervație strictÄƒ interzice orice activitate"],
      ...
      es: ["Parte de la cordillera de Velika Kapela", "El punto más alto alcanza los 1335 metros", "Conocido por la formación Dedos del Emperador", "El nivel de protección estricto prohíbe cualquier actividad forestal"],
      pt: ["Parte da cordilheira Velika Kapela", "O ponto mais alto atinge os 1335 metros", "Conhecido pela formação Dedos do Imperador", "O nível de proteção estrito proíbe qualquer exploração florestal"],
      fr: ["Partie de la chaîne de montagnes Velika Kapela", "Le point culminant atteint 1335 mètres", "Connu pour la formation des Doigts de l'Empereur", "Le niveau de protection strict interdit toute exploitation forestière"],
    },
imageHint: "Bijele stijene karst rocks Gorski Kotar",
    descriptionAdvanced: {
      ...
      es: "Las Bijele y Samarske stijene son una reserva natural estricta en el Gorski Kotar, conocida por sus extrañas formaciones rocosas de piedra caliza blanca en medio de densos bosques.",
      pt: "As Bijele e Samarske stijene são uma reserva natural estrita no Gorski Kotar, conhecida pelas suas bizarras formações rochosas de calcário branco no meio de florestas densas.",
      fr: "Les Bijele et Samarske stijene sont une réserve naturelle intégrale du Gorski Kotar, connue pour leurs formations rocheuses calcaires blanches bizarres au milieu de forêts denses.",
    },
    factsAdvanced: {
      ...
      es: ["El punto más alto alcanza los 1335 metros", "Nivel de protección más estricto en Croacia", "Superficie de aprox. 11,75 kilómetros cuadrados", "Paisaje kárstico laberíntico"],
      pt: ["O ponto mais alto atinge os 1335 metros", "Nível de proteção mais rigoroso na Croácia", "Área de cerca de 11,75 quilómetros quadrados", "Paisagem cárstica labiríntica"],
      fr: ["Le point culminant atteint 1335 mètres", "Niveau de protection le plus strict en Croatie", "Superficie d'environ 11,75 kilomètres carrés", "Paysage karstique labyrinthique"],
    },
    ...
    coords: [17.4172, 43.0728],
    description: {
      de: "Die BaÄ‡ina-Seen bestehen aus sieben miteinander verbundenen Karstseen in der NÃ¤he von PloÄe. Sie sind Kryptodepressionen, deren Boden unter dem Meeresspiegel liegt.",
      hu: "A BaÄ‡ina-tavak hÃ©t egymÃ¡ssal Ã¶sszefÃ¼ggÅ‘ karszttÃ³bÃ³l Ã¡llnak PloÄe kÃ¶zelÃ©ben. Ezek kriptodepressziÃ³k, amelyek medrÃ©nek alja a tengerszint alatt talÃ¡lhatÃ³.",
      ro: "Lacurile BaÄ‡ina constau din șapte lacuri carstice interconectate Ã®n apropiere de PloÄe. Sunt criptodepresiuni, fundul lor fiind sub nivelul mÄƒrii.",
      en: "The BaÄ‡ina Lakes consist of seven interconnected karst lakes near PloÄe. They are cryptodepressions, with their bottoms reaching below sea level.",
      es: "Los lagos de Baćina constan de siete lagos kársticos interconectados cerca de Ploče. Son criptodepresiones cuyo fondo se encuentra por debajo del nivel del mar.",
      pt: "Os lagos de Baćina consistem em sete lagos cársticos interconectados perto de Ploče. São criptodepressões cujo fundo se encontra abaixo do nível do mar.",
      fr: "Les lacs de Baćina se composent de sept lacs karstiques reliés entre eux près de Ploče. Ce sont des cryptodépressions dont le fond se situe sous le niveau de la mer.",
    },
    facts: {
      de: ["Sechs der sieben Seen sind verbunden", "Maximaltiefe betrÃ¤gt 34 Meter", "Mischung aus SÃ¼ÃŸ- und Brackwasser", "Wichtiges Brutgebiet fÃ¼r SumpfvÃ¶gel"],
      hu: ["A hÃ©t tÃ³bÃ³l hat kÃ¶zvetlen Ã¶sszekÃ¶ttetÃ©sben Ã¡ll", "Legnagyobb mÃ©lysÃ©gÃ¼k 34 mÃ©ter", "Ã‰desvÃ­z Ã©s tengervÃ­z keveredik bennÃ¼k", "Fontos fÃ©szkelÅ‘hely a mocsÃ¡ri madarak szÃ¡mÃ¡ra"],
      ro: ["È˜ase din cele șapte lacuri sunt conectate", "AdÃ¢ncimea maximÄƒ este de 34 metri", "Conțin un amestec de apÄƒ dulce și salubrÄƒ", "ZonÄƒ importantÄƒ de cuibÄƒrit pentru pÄƒsÄƒrile de mlaștinÄƒ"],
      ...
      es: ["Seis de los siete lagos están conectados", "La profundidad máxima es de 34 metros", "Mezcla de agua dulce y salobre", "Importante zona de cría para aves de pantano"],
      pt: ["Seis dos sete lagos estão ligados", "A profundidade máxima é de 34 metros", "Mistura de água doce e salobra", "Área de reprodução importante para aves do pântano"],
      fr: ["Six des sept lacs sont reliés", "La profondeur maximale est de 34 mètres", "Mélange d'eau douce et saumâtre", "Zone de nidification importante pour les oiseaux de marais"],
    },
imageHint: "Bacina lakes aerial view Croatia",
    descriptionAdvanced: {
      ...
      es: "Los lagos de Baćina consisten en siete lagos kársticos interconectados cerca de Ploče, que destacan por su color verde esmeralda y su tranquilidad.",
      pt: "Os lagos de Baćina consistem em sete lagos cársticos interconectados perto de Ploče, que se destacam pela sua cor verde esmeralda e tranquilidade.",
      fr: "Les lacs de Baćina se composent de sept lacs karstiques reliés entre eux près de Ploče, qui séduisent par leur couleur vert émeraude et leur calme.",
    },
    factsAdvanced: {
      ...
      es: ["Seis de los siete lagos están conectados", "La profundidad media es de 28 m", "La superficie está por encima del nivel del mar", "El fondo está por debajo del nivel del mar"],
      pt: ["Seis dos sete lagos estão ligados", "A profundidade média é de 28 m", "A superfície está acima do nível do mar", "O fundo está abaixo do nível do mar"],
      fr: ["Six des sept lacs sont reliés", "La profondeur moyenne est de 28 m", "La surface se situe au-dessus du niveau de la mer", "Le fond se situe sous le niveau de la mer"],
    },
    ...
    coords: [15.4998, 45.4168],
    description: {
      de: "Die MreÅ¾nica ist einer der saubersten FlÃ¼sse Kroatiens und bekannt fÃ¼r ihre 93 Travertin-Barrieren. Sie flieÃŸt durch tiefe Schluchten und weite TÃ¤ler in Mittelkroatien.",
      hu: "A MreÅ¾nica HorvÃ¡torszÃ¡g egyik legtisztÃ¡bb folyÃ³ja, amely 93 mÃ©sztufa-gÃ¡tjÃ¡rÃ³l Ã©s vÃ­zesÃ©sÃ©rÅ‘l ismert. KÃ¶zÃ©p-HorvÃ¡torszÃ¡g mÃ©ly kanyonjain Ã©s vÃ¶lgyein halad Ã¡t.",
      ro: "MreÅ¾nica este unul dintre cele mai curate rÃ¢uri din Croația, cunoscut pentru cele 93 de bariere de travertin. Curge prin canioane adÃ¢nci și vÄƒi largi din Croația centralÄƒ.",
      en: "The MreÅ¾nica is one of Croatia's cleanest rivers, known for its 93 travertine barriers and waterfalls. It flows through deep canyons and wide valleys in central Croatia.",
      es: "El Mrežnica es uno de los ríos más limpios de Croacia, conocido por sus 93 barreras de travertino. Fluye a través de profundos cañones y amplios valles en el centro de Croacia.",
      pt: "O Mrežnica é um dos rios mais limpos da Croácia, conhecido pelas suas 93 barreiras de travertino. Flui através de desfiladeiros profundos e vales largos na Croácia central.",
      fr: "La Mrežnica est l'une des rivières les plus propres de Croatie, réputée pour ses 93 barrières de travertin. Elle traverse des canyons profonds et de larges vallées en Croatie centrale.",
    },
    facts: {
      de: ["Besitzt 93 markante WasserfÃ¤lle", "MÃ¼ndet bei Karlovac in die Korana", "Beliebtes Ziel fÃ¼r Kajak und Rafting", "Wassertemperatur erreicht im Sommer 24 Grad"],
      hu: ["Ã–sszesen 93 jelentÅ‘sebb vÃ­zesÃ©ssel rendelkezik", "Karlovac kÃ¶zelÃ©ben torkollik a Korana folyÃ³ba", "NÃ©pszerű kajak- Ã©s rafting Ãºtvonal", "NyÃ¡ron a vÃ­z hÅ‘mÃ©rsÃ©klete elÃ©ri a 24 fokot"],
      ro: ["Are 93 de cascade distinctive", "Se varsÄƒ Ã®n rÃ¢ul Korana lÃ¢ngÄƒ Karlovac", "Destinație popularÄƒ pentru caiac și rafting", "Temperatura apei atinge 24 de grade vara"],
      ...
      es: ["Posee 93 cascadas marcantes", "Desemboca en el Korana cerca de Karlovac", "Destino popular para kayak y rafting", "La temperatura del agua alcanza los 24 grados en verano"],
      pt: ["Possui 93 cascatas marcantes", "Desagua no Korana perto de Karlovac", "Destino popular para caiaque e rafting", "A temperatura da água atinge 24 graus no verão"],
      fr: ["Possède 93 cascades remarquables", "Se jette dans la Korana près de Karlovac", "Lieu prisé pour le kayak et le rafting", "L'eau atteint 24 degrés en été"],
    },
imageHint: "Mreznica river waterfalls kayaking",
    descriptionAdvanced: {
      ...
      es: "El Mrežnica es uno de los ríos más bellos del centro de Croacia, famoso por sus 93 barreras de travertino que forman numerosas pequeñas cascadas y lagos.",
      pt: "O Mrežnica é um dos rios mais bonitos do centro da Croácia, famoso pelas suas 93 barreiras de travertino que formam inúmeras pequenas cascatas e lagos.",
      fr: "La Mrežnica est l'une des plus belles rivières de Croatie centrale, célèbre pour ses 93 barrières de tuf qui forment de nombreuses petites cascades et des lacs.",
    },
    factsAdvanced: {
      ...
      es: ["La longitud total es de 63 kilómetros", "Cuenta con 93 cascadas naturales", "Temperatura del agua ideal para el baño", "Desemboca en el río Korana"],
      pt: ["O comprimento total é de 63 quilómetros", "Possui 93 cascatas naturais", "Temperatura da água ideal para banhos", "Desagua no rio Korana"],
      fr: ["Longueur totale de 63 kilomètres", "Dispose de 93 cascades naturelles", "Température de l'eau idéale pour la baignade", "Se jette dans la rivière Korana"],
    },
    ...
    coords: [14.3051, 44.5122],
    description: {
      de: "Susak ist eine geologische Besonderheit in der Adria, da sie fast vollstÃ¤ndig aus gelbem LÃ¶sssand besteht. Die Insel ist autofrei und bekannt fÃ¼r ihre einzigartige Mundart.",
      hu: "Susak az Adriai-tenger geolÃ³giai kÃ¼lÃ¶nlegessÃ©ge, mivel szinte teljesen sÃ¡rga lÃ¶szhomokbÃ³l Ã¡ll. A sziget autÃ³mentes, Ã©s egyedi dialektusÃ¡rÃ³l ismert.",
      ro: "Susak este o curiozitate geologicÄƒ Ã®n Marea AdriaticÄƒ, fiind formatÄƒ aproape Ã®n Ã®ntregime din nisip de loess galben. Insula este fÄƒrÄƒ mașini și celebrÄƒ pentru dialectul sÄƒu.",
      ...
      es: "Susak es una peculiaridad geológica en el Adriático, ya que consiste casi totalmente en arena de loess amarilla. La isla no tiene coches y es conocida por su dialecto único.",
      pt: "Susak é uma particularidade geológica no Adriático, pois consiste quase inteiramente em areia de loess amarela. A ilha não tem carros e é conhecida pelo seu dialeto único.",
      fr: "Susak est une curiosité géologique de l'Adriatique, car elle est presque entièrement composée de sable de loess jaune. L'île est sans voitures et réputée pour son dialecte unique.",
    },
    facts: {
      de: ["SandbÃ¶den sind bis zu 100 Meter dick", "Keine asphaltierten StraÃŸen auf der Insel", "Bewohner tragen traditionell sehr kurze Trachten", "GehÃ¶rt zur Inselgruppe der Cres-LoÅ¡inj-Inseln"],
      hu: ["A homokrÃ©teg vastagsÃ¡ga helyenkÃ©nt a 100 mÃ©tert is elÃ©ri", "Nincsenek aszfaltozott utak a szigeten", "A helyi nÃ©pviselet szokatlanul rÃ¶vid szoknyÃ¡rÃ³l hÃ­res", "A Cres-LoÅ¡inj szigetcsoporthoz tartozik"],
      ro: ["Straturile de nisip au o grosime de pÃ¢nÄƒ la 100 metri", "Nu existÄƒ drumuri asfaltate pe insulÄƒ", "Locuitorii poartÄƒ costume populare tradiționale scurte", "Face parte din arhipelagul Cres-LoÅ¡inj"],
      en: ["Sand layers are up to 100 meters thick", "There are no asphalt roads on the island", "Inhabitants wear traditionally very short folk costumes", "Part of the Cres-LoÅ¡inj island group"],
      es: ["Suelos de arena de hasta 100 metros de espesor", "Sin carreteras asfaltadas en la isla", "Los habitantes visten trajes tradicionales muy cortos", "Pertenece al archipiélago de las islas Cres-Lošinj"],
      pt: ["Solos de areia com até 100 metros de espessura", "Sem estradas alcatroadas na ilha", "Os habitantes usam trajes tradicionais muito curtos", "Pertence ao arquipélago das ilhas Cres-Lošinj"],
      fr: ["Sols sableux jusqu'à 100 mètres d'épaisseur", "Aucune route goudronnée sur l'île", "Les habitants portent des costumes traditionnels très courts", "Fait partie de l'archipel de Cres-Lošinj"],
    },
imageHint: "Susak island sandy paths yellow loess cliffs",
    descriptionAdvanced: {
      ...
      es: "Susak es una isla de arena única en la bahía de Kvarner, compuesta casi en su totalidad por loess amarillo y conocida por su aislamiento y tradiciones.",
      pt: "Susak é uma ilha de areia única na baía de Kvarner, composta quase totalmente por loess amarelo e conhecida pelo seu isolamento e tradições.",
      fr: "Susak est une île de sable unique dans la baie de Kvarner, presque entièrement constituée de loess jaune, et connue pour son isolement et ses traditions.",
    },
    factsAdvanced: {
      ...
      es: ["Sin coches en toda la isla", "Superficie de unos 3,8 kilómetros cuadrados", "Única isla de este tipo en el Adriático", "Conocida por el dialecto de Susak"],
      pt: ["Sem carros em toda a ilha", "Área de cerca de 3,8 quilómetros quadrados", "Única ilha deste tipo no Adriático", "Conhecida pelo dialeto de Susak"],
      fr: ["Aucune voiture sur toute l'île", "Superficie d'environ 3,8 kilomètres carrés", "Seule île de ce type dans l'Adriatique", "Réputée pour le dialecte de Susak"],
    },
    ...
    coords: [15.0678, 45.3611],
    description: {
      de: "Die KamaÄnik-Schlucht ist ein geschÃ¼tztes Landschaftsgebiet bei Vrbovsko. Ein hÃ¶lzerner Wanderweg fÃ¼hrt entlang des kristallklaren Baches bis zu seiner tiefen Quelle.",
      hu: "A KamaÄnik-szurdok Vrbovsko mellett talÃ¡lhatÃ³ vÃ©dett tÃ¡jegysÃ©g. Egy fÃ¡bÃ³l kÃ©szÃ¼lt sÃ©tÃ¡ny vezet a kristÃ¡lytiszta patak mentÃ©n annak mÃ©ly forrÃ¡sÃ¡ig.",
      ro: "Canionul KamaÄnik este o zonÄƒ protejatÄƒ lÃ¢ngÄƒ Vrbovsko. O potecÄƒ de lemn urmÄƒrește pÃ¢rÃ¢ul cu apÄƒ cristalinÄƒ pÃ¢nÄƒ la izvorul sÄƒu adÃ¢nc.",
      en: "The KamaÄnik Canyon is a protected landscape area near Vrbovsko. A wooden walkway leads along the crystal-clear stream to its deep blue karst spring.",
      es: "El cañón de Kamačnik es un área de paisaje protegido cerca de Vrbovsko. Un sendero de madera conduce a lo largo del arroyo cristalino hasta su profunda fuente.",
      pt: "O desfiladeiro de Kamačnik é uma área de paisagem protegida perto de Vrbovsko. Um caminho de madeira segue ao longo do riacho cristalino até à sua nascente profunda.",
      fr: "Le canyon de Kamačnik est une zone de paysage protégé près de Vrbovsko. Un sentier de randonnée en bois longe le ruisseau cristallin jusqu'à sa source profonde.",
    },
    facts: {
      de: ["Wanderweg ist etwa 3 Kilometer lang", "Die Quelle ist Ã¼ber 95 Meter tief", "MÃ¼ndet bei Vrbovsko in die Dobra", "Seit 2002 als geschÃ¼tzte Landschaft deklariert"],
      hu: ["A tanÃ¶svÃ©ny hossza kÃ¶rÃ¼lbelÃ¼l 3 kilomÃ©ter", "A forrÃ¡s mÃ©lysÃ©ge meghaladja a 95 mÃ©tert", "VrbovskÃ³nÃ¡l torkollik a Dobra folyÃ³ba", "2002 Ã³ta vÃ©dett tÃ¡jvÃ©delmi kÃ¶rzet"],
      ro: ["Traseul are o lungime de aproximativ 3 kilometri", "Izvorul are o adÃ¢ncime de peste 95 metri", "Se varsÄƒ Ã®n rÃ¢ul Dobra lÃ¢ngÄƒ Vrbovsko", "Declarat peisaj protejat din anul 2002"],
      ...
      es: ["El sendero tiene unos 3 kilómetros de largo", "La fuente tiene más de 95 metros de profundidad", "Desemboca en el Dobra cerca de Vrbovsko", "Declarado paisaje protegido desde 2002"],
      pt: ["A trilha tem cerca de 3 quilômetros de extensão", "A nascente tem mais de 95 metros de profundidade", "Desagua no Dobra perto de Vrbovsko", "Declarado paisagem protegida desde 2002"],
      fr: ["Le sentier de randonnée fait environ 3 kilomètres", "La source a plus de 95 mètres de profondeur", "Se jette dans la Dobra près de Vrbovsko", "Déclaré paysage protégé depuis 2002"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "El cañón de Kamačnik en Gorski Kotar es un área natural protegida donde un arroyo transparente fluye a través de un estrecho desfiladero hasta su fuente.",
      pt: "O canyon de Kamačnik em Gorski Kotar é uma área natural protegida onde um riacho cristalino flui através de um desfiladeiro estreito até à sua nascente.",
      fr: "Le canyon de Kamačnik, dans le Gorski Kotar, est une zone naturelle protégée où un ruisseau limpide coule à travers une gorge étroite jusqu'à sa source.",
    },
    factsAdvanced: {
      ...
      es: ["Longitud del sendero aprox. 3 km", "Desemboca en el río Dobra", "Reserva botánica especial", "La fuente tiene más de 95 metros de profundidad"],
      pt: ["Extensão da trilha aprox. 3 km", "Desagua no rio Dobra", "Reserva botânica especial", "A nascente tem mais de 95 metros de profundidade"],
      fr: ["Longueur du sentier d'environ 3 km", "Se jette dans la rivière Dobra", "Réserve botanique spéciale", "La source a plus de 95 mètres de profondeur"],
    },
  }
,
  {
    ...
    description: {
      ...
      es: "Este estrecho cañón en Gorski Kotar impresiona con sus paredes de roca empinadas y un arroyo rugiente. Pasarelas metálicas permiten el acceso a través de las profundas grietas de la roca.",
      pt: "Este estreito desfiladeiro em Gorski Kotar impressiona com paredes rochosas íngremes e um riacho impetuoso. Passarelas metálicas permitem o acesso através das profundas fendas na rocha.",
      fr: "Cet étroit canyon du Gorski Kotar impressionne par ses parois rocheuses abruptes et son ruisseau bouillonnant. Des passerelles métalliques permettent d'accéder aux profondes crevasses rocheuses.",
    },
    facts: {
      ...
      es: ["800 metros de longitud", "Región de Gorski Kotar", "Paredes de roca estrechas", "Arroyo Jasle"],
      pt: ["800 metros de comprimento", "Região de Gorski Kotar", "Paredes rochosas estreitas", "Riacho Jasle"],
      fr: ["800 mètres de long", "Région du Gorski Kotar", "Parois rocheuses étroites", "Ruisseau Jasle"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "El cañón de 800 metros de largo en Gorski Kotar está rodeado por paredes de roca de hasta 100 metros de altura. El arroyo Jasle formó esta reserva geomorfológica a lo largo de milenios.",
      pt: "O desfiladeiro de 800 metros de comprimento em Gorski Kotar está rodeado por paredes rochosas com até 100 metros de altura. O riacho Jasle formou esta reserva geomorfológica ao longo de milénios.",
      fr: "Ce canyon de 800 mètres de long dans le Gorski Kotar est entouré de parois rocheuses atteignant 100 mètres de haut. Le ruisseau Jasle a façonné cette réserve géomorphologique au fil des millénaires.",
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      es: "Una espectacular cascada de 70 metros de altura cae sobre la abertura de una cueva en un lago de color verde esmeralda. El lugar alberga la primera central hidroeléctrica de la región.",
      pt: "Uma espetacular cascata de 70 metros de altura despenha-se sobre a abertura de uma caverna num lago verde-esmeralda. O local abriga a primeira central hidroelétrica da região.",
      fr: "Une spectaculaire cascade de 70 mètres de haut se jette au-dessus de l'ouverture d'une grotte dans un lac vert émeraude. Le site abrite la première centrale hydroélectrique de la région.",
    },
    facts: {
      ...
      es: ["70 metros de caída", "Lago verde esmeralda", "Municipio de Skrad", "Sistema de cuevas"],
      pt: ["70 metros de queda", "Lago verde-esmeralda", "Município de Skrad", "Sistema de cavernas"],
      fr: ["70 mètres de chute", "Lac vert émeraude", "Commune de Skrad", "Système de grottes"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "Zeleni Vir (Remolino Verde) es una fuente natural cerca de Skradin, Croacia. El agua brota de una cueva kárstica y forma un lago esmeralda. El entorno es boscoso y parte del Parque Natural Krka. Zeleni Vir es un destino popular para excursionistas. La temperatura del agua es de unos 10 grados Celsius todo el año.",
      pt: "Zeleni Vir (Vórtice Verde) é uma nascente natural perto de Skradin, Croácia. A água brota de uma caverna cárstica e forma um lago esmeralda. A área envolvente é densamente arborizada e faz parte do Parque Natural Krka. Zeleni Vir é um destino popular para caminhantes. A temperatura da água é de cerca de 10 graus Celsius durante todo o ano.",
      fr: "Zeleni Vir (Tourbillon Vert) est une source naturelle située près de Skradin, en Croatie. L'eau jaillit d'une grotte karstique et forme un lac émeraude. Les environs sont boisés et font partie du parc naturel de Krka. Zeleni Vir est une destination prisée des randonneurs. La température de l'eau est d'environ 10 degrés Celsius toute l'année.",
    },
    factsAdvanced: {
    ...
    }, image: "/poi-images/croatia-zeleni-vir-nature-v2.webp"},
  {
    ...
    description: {
      ...
      es: "Este profundo manantial kárstico en el Parque Nacional Risnjak forma un lago azul profundo y tranquilo bajo altos acantilados. Es una de las fuentes más profundas y enigmáticas de Croacia.",
      pt: "Esta profunda nascente cárstica no Parque Nacional Risnjak forma um lago azul profundo e tranquilo sob altas falésias. É uma das fontes mais profundas e enigmáticas da Croácia.",
      fr: "Cette source karstique profonde du parc national de Risnjak forme un lac bleu profond et calme sous de hautes falaises. Elle compte parmi les sources les plus profondes et les plus mystérieuses de Croatie.",
    },
    facts: {
      ...
      es: ["154 metros de profundidad de buceo", "Parque Nacional Risnjak", "Agua de color turquesa", "Fenómeno kárstico"],
      pt: ["154 metros de profundidade de mergulho", "Parque Nacional Risnjak", "Água de cor turquesa", "Fenómeno cárstico"],
      fr: ["154 mètres de profondeur de plongée", "Parc National de Risnjak", "Eau turquoise", "Phénomène karstique"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "La fuente del Kupa en el Parque Nacional Risnjak es un lago kárstico de más de 150 m de profundidad. Es una de las fuentes más caudalosas y profundas de la zona kárstica croata.",
      pt: "A nascente do Kupa no Parque Nacional Risnjak é um lago cárstico com mais de 150 m de profundidade. É uma das fontes mais caudalosas e profundas da zona cárstica croata.",
      fr: "La source de la Kupa, dans le parc national de Risnjak, est un lac karstique de plus de 150 m de profondeur. Elle est l'une des sources les plus abondantes et les plus profondes de la région karstique croate.",
    },
    factsAdvanced: {
      ...
      es: ["Profundidad: más de 154 metros", "Parte del Parque Nacional Risnjak desde 1953", "Altitud de la fuente: 321 m", "Monumento natural protegido desde 1963"],
      pt: ["Profundidade: mais de 154 metros", "Parte do Parque Nacional Risnjak desde 1953", "Altitude da nascente: 321 m", "Monumento natural protegido desde 1963"],
      fr: ["Profondeur : plus de 154 mètres", "Fait partie du Parc National de Risnjak depuis 1953", "Altitude de la source : 321 m", "Monument naturel protégé depuis 1963"],
    }, image: "/poi-images/croatia-kupa-source-nature-v2.webp"},
  {
    ...
    description: {
      ...
      es: "Una impresionante fuente kárstica vertical protegida como monumento hidrológico. El agua helada y cristalina sale a la superficie en una profunda cuenca de color azul verdoso.",
      pt: "Uma impressionante nascente cárstica vertical, protegida como monumento hidrológico. A água gelada e cristalina emerge à superfície numa bacia profunda de tons azul-esverdeados.",
      fr: "Une impressionnante source karstique verticale protégée en tant que monument hydrologique. L'eau glacée et cristalline remonte à la surface dans un bassin profond aux tons bleu-vert.",
    },
    facts: {
      ...
      es: ["248 metros de profundidad", "Monumento hidrológico", "Alpes Dináricos", "Agua cristalina"],
      pt: ["248 metros de profundidade", "Monumento hidrológico", "Alpes Dináricos", "Água cristalina"],
      fr: ["248 mètres de profondeur", "Monument hydrologique", "Alpes Dinariques", "Eau cristalline"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "La fuente kárstica en la región de Lika, cerca de Donja Suvaja, alcanza una profundidad confirmada de 248 metros. Desde 1968, este lago de origen con agua a 9 grados es un monumento natural.",
      pt: "A nascente cárstica na região de Lika, perto de Donja Suvaja, atinge uma profundidade confirmada de 248 metros. Desde 1968, este lago de nascente com água a 9 graus é um monumento natural.",
      fr: "La source karstique de la région de Lika, près de Donja Suvaja, atteint une profondeur confirmée de 248 mètres. Depuis 1968, ce lac de source dont l'eau est à 9 degrés est classé monument naturel.",
    },
    factsAdvanced: {
      ...
      es: ["La profundidad máxima alcanzada por buceadores hasta ahora es de 248 metros.", "La fuente se encuentra a una altitud de 396 metros sobre el nivel del mar.", "La temperatura del agua permanece constante entre 9 y 10 °C.", "En 1968, la fuente kárstica fue protegida como monumento natural.", "El manantial se encuentra en la parte croata de la región de Lika.", "El río Una forma más adelante la frontera con Bosnia y Herzegovina."],
      pt: ["A profundidade máxima atingida por mergulhadores até agora é de 248 metros.", "A nascente está localizada a uma altitude de 396 metros acima do nível do mar.", "A temperatura da água permanece constante entre 9 e 10 °C.", "Em 1968, a nascente cárstica foi protegida como monumento natural.", "A bacia da nascente situa-se na parte croata da região de Lika.", "O rio Una forma, mais adiante, a fronteira com a Bósnia e Herzegovina."],
    ...
    }, image: "/poi-images/croatia-una-spring-nature-v2.webp"},
  {
    ...
    description: {
      ...
      es: "Este enorme lago de agua dulce en la isla de Cres es un fenómeno natural extraordinario. Su fondo se encuentra muy por debajo del nivel del mar, lo que lo convierte en una criptodepresión.",
      pt: "Este enorme lago de água doce na ilha de Cres é um fenómeno natural extraordinário. O seu fundo situa-se muito abaixo do nível do mar, o que o torna uma criptodepressão.",
      fr: "Cet immense lac d'eau douce sur l'île de Cres est un phénomène naturel extraordinaire. Son fond se situe bien en dessous du niveau de la mer, ce qui en fait une cryptodépression.",
    },
    facts: {
      ...
      es: ["74 metros de profundidad", "Reserva de agua dulce", "Isla de Cres", "Criptodepresión"],
      pt: ["74 metros de profundidade", "Reservatório de água doce", "Ilha de Cres", "Criptodepressão"],
      fr: ["74 mètres de profondeur", "Réservoir d'eau douce", "Île de Cres", "Cryptodépression"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "El lago Vransko en la isla de Cres es una criptodepresión con una profundidad máxima de 74 metros. El lago de agua dulce de 5,5 kilómetros cuadrados abastece de agua potable a la región.",
      pt: "O lago Vransko na ilha de Cres é uma criptodepressão com uma profundidade máxima de 74 metros. O lago de água doce de 5,5 quilómetros quadrados abastece a região com água potável.",
      fr: "Le lac Vransko sur l'île de Cres est une cryptodépression d'une profondeur maximale de 74 mètres. Ce lac d'eau douce de 5,5 kilomètres carrés alimente la région en eau potable.",
    },
    factsAdvanced: {
      ...
      es: ["La superficie del agua está a 13 metros sobre el nivel del mar.", "El punto más profundo del lago está a 74 metros bajo la superficie del agua.", "El fondo del lago está a 61 metros bajo el nivel del mar (criptodepresión).", "El cuerpo de agua se extiende sobre una superficie de 5,5 kilómetros cuadrados.", "El lago contiene un volumen de agua de unos 220 millones de metros cúbicos.", "El acceso a la zona de la orilla está estrictamente prohibido por razones de protección del agua potable."],
      pt: ["A superfície da água está 13 metros acima do nível do mar.", "O ponto mais profundo do lago encontra-se a 74 metros abaixo da superfície da água.", "O fundo do lago situa-se 61 metros abaixo do nível do mar (criptodepressão).", "A massa de água estende-se por uma área de 5,5 quilómetros quadrados.", "O lago contém um volume de água de cerca de 220 milhões de metros cúbicos.", "O acesso à zona marginal é estritamente proibido por razões de proteção da água potável."],
    ...
    }, image: "/poi-images/croatia-vrana-lake-cres-nature-v2.webp"},
  {
    ...
    description: {
      ...
      es: "Un idílico valle de montaña en las montañas Papuk, conocido por sus lagos y la impresionante cascada Skakavac. Es uno de los destinos de excursión más populares de Eslavonia.",
      pt: "Um vale de montanha idílico nas montanhas Papuk, conhecido pelos seus lagos e pela impressionante cachoeira Skakavac. É um dos destinos de excursão mais populares da Eslavônia.",
      fr: "Une vallée de montagne idyllique dans les montagnes de Papuk, connue pour ses lacs et l'impressionnante cascade de Skakavac. C'est l'une des destinations d'excursion les plus populaires de Slavonie.",
    },
    facts: {
      ...
      es: ["Cascada Skakavac", "Montañas Papuk", "Dos lagos artificiales", "Parque del Conde Janković"],
      pt: ["Cachoeira Skakavac", "Montanhas Papuk", "Dois lagos artificiais", "Parque do Conde Janković"],
      fr: ["Cascade de Skakavac", "Montagnes de Papuk", "Deux lacs artificiels", "Parc du Comte Janković"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "El bosque parque Jankovac en las montañas Papuk se encuentra a 475 metros de altitud. Bosques de hayas, dos embalses y la cascada Skakavac, de 35 metros de altura, caracterizan esta reserva protegida desde 1955.",
      pt: "A floresta parque Jankovac nas montanhas Papuk situa-se a 475 metros de altitude. Florestas de faias, duas albufeiras e a cachoeira Skakavac, com 35 metros de altura, caracterizam esta reserva protegida desde 1955.",
      fr: "La forêt-parc de Jankovac, dans les montagnes de Papuk, se situe à 475 mètres d'altitude. Des forêts de hêtres, deux réservoirs et la cascade de Skakavac, haute de 35 mètres, caractérisent cette réserve protégée depuis 1955.",
    },
    factsAdvanced: {
      ...
      es: ["El parque forestal se encuentra a una altitud media de 475 metros.", "La cascada Skakavac cae por una pared de roca de 35 metros de altura.", "La zona fue declarada oficialmente parque forestal protegido en 1955.", "Llamado así por el noble Josip Janković, que vivió aquí en el siglo XIX.", "El valle alberga dos lagos creados por el hombre.", "La zona se encuentra dentro del Geoparque Papuk, un geoparque de la UNESCO."],
      pt: ["O parque florestal situa-se a uma altitude média de 475 metros.", "A cachoeira Skakavac desce por uma parede de rocha com 35 metros de altura.", "A área foi oficialmente declarada parque florestal protegido em 1955.", "Nomeado em homenagem ao nobre Josip Janković, que viveu aqui no século XIX.", "O vale abriga dois lagos criados pelo homem.", "A zona encontra-se dentro do Geoparque Papuk, um geoparque da UNESCO."],
      fr: ["Le parc forestier se situe à une altitude moyenne de 475 mètres.", "La cascade de Skakavac tombe d'une paroi rocheuse de 35 mètres de haut.", "La zone a été officiellement classée forêt-parc protégée en 1955.", "Nommée d'après le noble Josip Janković, qui vivait ici au XIXe siècle.", "La vallée abrite deux lacs créés par l'homme.", "La zone se trouve dans le Géoparc de Papuk, un géoparc de l'UNESCO."],
    }, image: "/poi-images/croatia-jankovac-valley-nature-v2.webp"},
  {
    ...
    description: {
      ...
      es: "Un archipiélago de 13 islas al noroeste de Dubrovnik, de las cuales solo tres están habitadas. Las islas son conocidas por su exuberante vegetación mediterránea y calas escondidas.",
      pt: "Um arquipélago de 13 ilhas a noroeste de Dubrovnik, das quais apenas três são habitadas. As ilhas são conhecidas pela sua vegetação mediterrânica luxuriante e enseadas escondidas.",
      fr: "Un archipel de 13 îles au nord-ouest de Dubrovnik, dont seulement trois sont habitées. Les îles sont connues pour leur végétation méditerranéenne luxuriante et leurs criques cachées.",
    },
    facts: {
      ...
      es: ["13 islas en total", "3 islas habitadas", "Cerca de Dubrovnik", "Flora mediterránea"],
      pt: ["13 ilhas no total", "3 ilhas habitadas", "Perto de Dubrovnik", "Flora mediterrânica"],
      fr: ["13 îles au total", "3 îles habitées", "Près de Dubrovnik", "Flore méditerranéenne"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "Las islas Elaphiti son un grupo de islas frente a la costa de Dubrovnik en el mar Adriático. Constan de 13 islas, de las cuales las más grandes son Koločep, Lopud y Šipan. Las islas son conocidas por su naturaleza virgen, playas de arena y olivares. Forman parte de la reserva natural y son populares para excursiones de un día. La población vive principalmente del turismo y la pesca.",
      pt: "As ilhas Elaphiti são um grupo de ilhas ao largo da costa de Dubrovnik, no mar Adriático. São compostas por 13 ilhas, sendo as maiores Koločep, Lopud e Šipan. As ilhas são conhecidas pela sua natureza intocada, praias de areia e olivais. Fazem parte da reserva natural e são populares para passeios de um dia. A população vive principalmente do turismo e da pesca.",
      fr: "Les îles Élaphites sont un archipel situé au large de Dubrovnik, dans la mer Adriatique. Elles se composent de 13 îles, dont les plus grandes sont Koločep, Lopud et Šipan. Les îles sont connues pour leur nature préservée, leurs plages de sable et leurs oliveraies. Elles font partie de la réserve naturelle et sont prisées pour des excursions d'une journée. La population vit principalement du tourisme et de la pêche.",
    },
    factsAdvanced: {
      ...
      es: ["El grupo de islas tiene 13 islas.", "Koločep mide 3,5 km².", "Lopud tiene una superficie de 4,6 km².", "Šipan es la más grande con 6,2 km².", "La distancia a Dubrovnik es de 10 km.", "La población de las islas es de unos 800 habitantes."],
      pt: ["O grupo de ilhas tem 13 ilhas.", "Koločep tem 3,5 km².", "Lopud tem uma área de 4,6 km².", "Šipan é a maior com 6,2 km².", "A distância até Dubrovnik é de 10 km.", "A população das ilhas é de cerca de 800 pessoas."],
      fr: ["L'archipel compte 13 îles.", "Koločep mesure 3,5 km².", "Lopud a une superficie de 4,6 km².", "Šipan est la plus grande avec 6,2 km².", "La distance jusqu'à Dubrovnik est de 10 km.", "La population des îles est d'environ 800 habitants."],
    }, image: "/poi-images/croatia-elafiti-islands-nature-v2.webp"},
  {
    ...
    description: {
      ...
      es: "Un espectacular monumento geomorfológico en el Parque Natural de Učka con extrañas torres de piedra caliza. El cañón ofrece vistas dramáticas y es un paraíso para los escaladores.",
      pt: "Um espetacular monumento geomorfológico no Parque Natural de Učka, com bizarras torres de calcário. O desfiladeiro oferece vistas dramáticas e é um paraíso para os escaladores.",
      fr: "Un spectaculaire monument géomorphologique dans le parc naturel d'Učka avec d'étranges tours de calcaire. Le canyon offre des vues spectaculaires et constitue un paradis pour les grimpeurs.",
    },
    facts: {
      ...
      es: ["Torres de caliza hasta 100m", "Parque Natural Učka", "Monumento geomorfológico", "Zona de escalada"],
      pt: ["Torres de calcário até 100m", "Parque Natural Učka", "Monumento geomorfológico", "Área de escalada"],
      fr: ["Tours de calcaire jusqu'à 100m", "Parc naturel d'Učka", "Monument géomorphologique", "Site d'escalade"],
    },
    ...
    descriptionAdvanced: {
      ...
      es: "Vela Draga es un cañón de piedra caliza en el Parque Natural de Učka, conocido por sus torres de roca de hasta 100 m de altura. El cañón se formó por erosión y alberga hallazgos fósiles.",
      pt: "Vela Draga é um canyon de calcário no Parque Natural de Učka, conhecido pelas suas torres rochosas com até 100 m de altura. O desfiladeiro foi formado pela erosão e abriga vestígios fósseis.",
      fr: "Vela Draga est un canyon calcaire situé dans le parc naturel d'Učka, célèbre pour ses tours rocheuses atteignant 100 m de haut. Le canyon a été formé par l'érosion et abrite des découvertes fossiles.",
    },
    factsAdvanced: {
      ...
      es: ["Altura de las torres de roca: hasta 100 m", "Monumento geomorfológico desde 1963", "Longitud del cañón: aprox. 3,5 km", "Parte del Parque Natural Učka desde 1999"],
      pt: ["Altura das torres rochosas: até 100 m", "Monumento geomorfológico desde 1963", "Comprimento do canyon: aprox. 3,5 km", "Parte do Parque Natural Učka desde 1999"],
      fr: ["Hauteur des tours rocheuses : jusqu'à 100 m", "Monument géomorphologique depuis 1963", "Longueur du canyon : env. 3,5 km", "Fait partie du parc naturel d'Učka depuis 1999"],
    },
