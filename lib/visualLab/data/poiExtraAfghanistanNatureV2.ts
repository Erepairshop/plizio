...
export const poiExtraAfghanistanNatureV2: POI[] = [
  {
    ...
    descriptionAdvanced: {
      de: "Das Pamir-Gebirge, auch 'Dach der Welt' genannt, erstreckt sich über Tadschikistan, Kirgisistan, Afghanistan und China. Es erreicht Höhen von über 7000 m, der höchste Gipfel ist der Kongur (7649 m) in China. Die Pamir-Region ist durch Hochplateaus und tiefe Täler geprägt. Sie ist Quellgebiet bedeutender Flüsse wie des Amu Darya. Das Klima ist kontinental mit kalten Wintern.",
      hu: "A Pamir-hegység, a 'Világ teteje', Tadzsikisztán, Kirgizisztán, Afganisztán és Kína területén húzódik. Legmagasabb csúcsa a Kongur (7649 m) Kínában. A régiót magas fennsíkok és mély völgyek jellemzik. Számos nagy folyó, mint az Amu-darja forrásvidéke. Éghajlata kontinentális, hideg telekkel.",
      ro: "Munții Pamir, numiți și 'Acoperișul lumii', se întind în Tadjikistan, Kîrgîzstan, Afganistan și China. Cel mai înalt vârf este Kongur (7649 m) în China. Regiunea are platouri înalte și văi adânci. Este zona de origine a unor râuri importante precum Amu Darya. Clima este continentală, cu ierni reci.",
      en: "The Pamir Mountains, known as the 'Roof of the World', span Tajikistan, Kyrgyzstan, Afghanistan, and China. The highest peak is Kongur (7,649 m) in China. The region features high plateaus and deep valleys. It is the source of major rivers like the Amu Darya. The climate is continental with cold winters.",
    },
    factsAdvanced: {
      de: ["höchster Gipfel Kongur (7649 m)", "Quellgebiet des Amu Darya", "Ausdehnung über vier Länder", "kontinentales Klima", "durchschnittliche Höhe über 4000 m", "Gletscherfläche ca. 12.000 km²"],
      hu: ["legmagasabb csúcs Kongur (7649 m)", "az Amu-darja forrásvidéke", "négy ország területén fekszik", "kontinentális éghajlat", "átlagmagasság 4000 m felett", "gleccserterület kb. 12.000 km²"],
      ro: ["cel mai înalt vârf Kongur (7649 m)", "zona de origine a râului Amu Darya", "se întinde în patru țări", "climă continentală", "altitudine medie peste 4000 m", "suprafață glaciară de cca 12.000 km²"],
      en: ["highest peak Kongur (7,649 m)", "source of Amu Darya River", "spans four countries", "continental climate", "average elevation above 4,000 m", "glacier area about 12,000 km²"],
    },
  },  {
...
}, image: "/poi-images/afghanistan-wakhan-national-park-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Wakhan-Nationalpark wurde 2014 gegründet und liegt im Wakhan-Korridor im Nordosten Afghanistans. Er umfasst etwa 10.000 km² und beherbergt seltene Tierarten wie den Schneeleoparden und den Marco-Polo-Argali. Die Landschaft reicht von trockenen Steppen bis zu Gletschern. Der Park ist einer der am höchsten gelegenen der Welt, mit Durchschnittshöhen über 4000 m. Die lokale Bevölkerung besteht hauptsächlich aus Wakhi und Kirgisen.",
      hu: "A Vaháni Nemzeti Parkot 2014-ben hozták létre Afganisztán északkeleti részén, a Vahán-folyosón. Területe kb. 10.000 km², ritka állatfajoknak ad otthont, mint a hópárduc és a Marco Polo-argali. A táj száraz sztyeppéktől gleccserekig változik. A világ egyik legmagasabban fekvő nemzeti parkja, átlagmagassága 4000 m felett. A helyi lakosok többsége vakhi és kirgiz.",
      ro: "Parcul Național Wakhan a fost înființat în 2014 și este situat în Coridorul Wakhan, nord-estul Afganistanului. Acoperă aproximativ 10.000 km² și găzduiește specii rare precum leopardul de zăpadă și argaliul Marco Polo. Peisajul variază de la stepe aride la ghețari. Este unul dintre cele mai înalte parcuri naționale din lume, cu altitudini medii peste 4000 m. Populația locală este formată în principal din wakhi și kîrgîzi.",
      en: "Wakhan National Park, established in 2014, is located in the Wakhan Corridor of northeastern Afghanistan. Covering approximately 10,000 km², it hosts rare species like snow leopards and Marco Polo sheep. The landscape ranges from dry steppes to glaciers. It is one of the highest national parks globally, with average elevations above 4,000 m. The local population consists mainly of Wakhi and Kyrgyz people.",
    },
    factsAdvanced: {
      de: ["gegründet 2014", "Fläche ca. 10.000 km²", "beherbergt Schneeleoparden", "Durchschnittshöhe über 4000 m", "liegt im Wakhan-Korridor", "Bevölkerung: Wakhi und Kirgisen"],
      hu: ["2014-ben alapították", "területe kb. 10.000 km²", "hópárducok élőhelye", "átlagmagasság 4000 m felett", "a Vahán-folyosón található", "lakosság: vakhi és kirgiz"],
      ro: ["înființat în 2014", "suprafață cca 10.000 km²", "găzduiește leoparzi de zăpadă", "altitudine medie peste 4000 m", "situat în Coridorul Wakhan", "populație: wakhi și kîrgîzi"],
      en: ["established in 2014", "area about 10,000 km²", "hosts snow leopards", "average elevation above 4,000 m", "located in Wakhan Corridor", "population: Wakhi and Kyrgyz"],
    },
  },  {
    ...
    descriptionAdvanced: {
      de: "Der Nuristan-Nationalpark ist eine von Afghanistan geplante Schutzzone in der Provinz Nuristan. Er soll die artenreichen Wälder des Hindukusch schützen, darunter Zedern und Eichen. Der Park beheimatet den Afghanischen Schneefink und andere seltene Vögel. Die Region ist bergig und schwer zugänglich. Das Gebiet war historisch unter dem Namen Kafiristan bekannt, bevor es im 19. Jahrhundert zum Islam konvertierte.",
      hu: "A Nurisztáni Nemzeti Park egy tervezett védett terület Afganisztán Nurisztán tartományában. Célja a Hindukus fajgazdag erdeinek, köztük cédrusok és tölgyek védelme. Itt él az afgán hópinty és más ritka madarak. A vidék hegyvidéki és nehezen megközelíthető. Történelmileg Kafirisztánként ismerték, mielőtt a 19. században áttért az iszlámra.",
      ro: "Parcul Național Nuristan este o arie protejată planificată în provincia Nuristan din Afganistan. Ar trebui să protejeze pădurile bogate ale Hindukushului, inclusiv cedri și stejari. Parcul adăpostește cinteza de zăpadă afgană și alte păsări rare. Regiunea este muntoasă și greu accesibilă. Zona era cunoscută istoric ca Kafiristan înainte de convertirea la islam în secolul al XIX-lea.",
      en: "Nuristan National Park is a planned protected area in Nuristan Province, Afghanistan. It aims to protect the biodiverse forests of the Hindu Kush, including cedars and oaks. The park hosts the Afghan snow finch and other rare birds. The region is mountainous and difficult to access. Historically known as Kafiristan, it converted to Islam in the 19th century.",
    },
    factsAdvanced: {
      de: ["geplant, noch nicht offiziell gegründet", "liegt in der Provinz Nuristan", "schützt Zedern- und Eichenwälder", "Heimat des Afghanischen Schneefinks", "historisch Kafiristan genannt", "Konversion zum Islam im 19. Jahrhundert"],
      hu: ["tervezett, még nem hivatalos", "Nurisztán tartományban található", "cédrus- és tölgyerdőket véd", "afgán hópinty élőhelye", "történelmi neve Kafirisztán", "a 19. században tért át az iszlámra"],
  ...
  },
  {
...
}, image: "/poi-images/afghanistan-amudarja-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Amu Darya (früher Oxus) ist mit einer Länge von 2400 km einer der längsten Flüsse Zentralasiens. Er entspringt im Pamir-Gebirge in Afghanistan und Tadschikistan und mündet in den Aralsee. Der Fluss bildet große Teile der Grenze zwischen Afghanistan und Tadschikistan sowie Usbekistan. Er ist essentiell für die Bewässerung in der Region, aber stark durch Wasserentnahme belastet.",
      hu: "Az Amu-darja (korábban Oxus) 2400 km hosszával Közép-Ázsia egyik leghosszabb folyója. A Pamir-hegységben ered Afganisztánban és Tadzsikisztánban, és az Aral-tóba torkollik. A folyó nagy része határt képez Afganisztán, Tadzsikisztán és Üzbegisztán között. Létfontosságú az öntözéshez, de a vízkivétel miatt erősen terhelt.",
      ro: "Amu Darya (cunoscut anterior ca Oxus) este unul dintre cele mai lungi râuri din Asia Centrală, cu 2400 km. Izvorăște din Munții Pamir în Afganistan și Tadjikistan și se varsă în Marea Aral. Râul formează o mare parte a graniței dintre Afganistan, Tadjikistan și Uzbekistan. Este esențial pentru irigații, dar este puternic afectat de captarea apei.",
      en: "The Amu Darya (formerly Oxus) is one of Central Asia's longest rivers, at 2,400 km. It rises in the Pamir Mountains in Afghanistan and Tajikistan and flows into the Aral Sea. The river forms much of the border between Afghanistan, Tajikistan, and Uzbekistan. It is vital for irrigation but heavily affected by water withdrawal.",
    },
    factsAdvanced: {
      de: ["Länge 2400 km", "entspringt im Pamir", "mündet in den Aralsee", "Grenzfluss zwischen Afghanistan, Tadschikistan, Usbekistan", "früher Oxus genannt", "starke Wasserentnahme für Bewässerung"],
      hu: ["hossza 2400 km", "a Pamirban ered", "az Aral-tóba ömlik", "határfolyó Afganisztán, Tadzsikisztán és Üzbegisztán között", "korábbi neve Oxus", "erős vízkivétel öntözés céljából"],
      ro: ["lungime 2400 km", "izvorăște din Pamir", "se varsă în Marea Aral", "râu de graniță între Afganistan, Tadjikistan, Uzbekistan", "cunoscut anterior ca Oxus", "captare puternică de apă pentru irigații"],
      en: ["length 2,400 km", "rises in the Pamirs", "empties into the Aral Sea", "border river between Afghanistan, Tajikistan, Uzbekistan", "formerly called Oxus", "heavy water withdrawal for irrigation"],
    },
  },  {
...
}, image: "/poi-images/afghanistan-helmand-river-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Helmand (oder Hilmend) ist mit 1150 km der längste Fluss Afghanistans. Er entspringt im Hindukusch westlich von Kabul und fließt nach Südwesten zum Hamun-See an der iranischen Grenze. Der Fluss wird intensiv für die Bewässerung in den Provinzen Helmand und Kandahar genutzt. Die landwirtschaftliche Abhängigkeit vom Helmand hat zu Wasserkonflikten mit dem Iran geführt.",
      hu: "A Helmand (vagy Hilmend) Afganisztán leghosszabb folyója, 1150 km hosszú. A Hindukusban ered, Kabultól nyugatra, és délnyugat felé folyik a Hamun-tóba az iráni határnál. Intenzíven használják öntözésre Helmand és Kandahár tartományokban. A folyótól való mezőgazdasági függőség vízkonfliktusokhoz vezetett Iránnal.",
      ro: "Helmand (sau Hilmend) este cel mai lung râu din Afganistan, cu 1150 km. Izvorăște din Hindukush, la vest de Kabul, și curge spre sud-vest către Lacul Hamun la granița cu Iranul. Este intens folosit pentru irigații în provinciile Helmand și Kandahar. Dependența agricolă de Helmand a dus la conflicte pentru apă cu Iranul.",
      en: "The Helmand (or Hilmend) is Afghanistan's longest river, at 1,150 km. It rises in the Hindu Kush west of Kabul and flows southwest to the Hamun Lake on the Iranian border. It is heavily used for irrigation in Helmand and Kandahar provinces. Agricultural dependence on the Helmand has led to water conflicts with Iran.",
    },
    factsAdvanced: {
      de: ["Länge 1150 km", "längster Fluss Afghanistans", "entspringt im Hindukusch", "mündet in den Hamun-See", "wichtig für Bewässerung in Helmand und Kandahar", "Wasserkonflikte mit Iran"],
      hu: ["hossza 1150 km", "Afganisztán leghosszabb folyója", "a Hindukusban ered", "a Hamun-tóba torkollik", "fontos öntözéshez Helmandban és Kandahárban", "vízkonfliktusok Iránnal"],
      ro: ["lungime 1150 km", "cel mai lung râu al Afganistanului", "izvorăște din Hindukush", "se varsă în Lacul Hamun", "important pentru irigații în Helmand și Kandahar", "conflicte pentru apă cu Iranul"],
      en: ["length 1,150 km", "longest river in Afghanistan", "rises in the Hindu Kush", "empties into Hamun Lake", "important for irrigation in Helmand and Kandahar", "water conflicts with Iran"],
    },
  },  {
    ...
    }, image: "/poi-images/afghanistan-hari-rud-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Hari Rud (oder Herat Rud) ist ein etwa 1100 km langer Fluss in Afghanistan, Turkmenistan und Iran. Er entspringt im Hindukusch in der Provinz Ghor und fließt westlich durch Herat. Der Fluss versickert in der Wüste Karakum in Turkmenistan. In der Region um Herat wird das Wasser intensiv für die Landwirtschaft genutzt. Der Hari Rud ist Teil des endorheischen Beckens des Tedschen.",
      hu: "A Hari Rud (vagy Herat Rud) kb. 1100 km hosszú folyó Afganisztánban, Türkmenisztánban és Iránban. A Hindukusban ered Ghór tartományban, és nyugat felé folyik Heráton keresztül. A folyó a Karakum-sivatagban végződik Türkmenisztánban. Herát környékén intenzíven használják mezőgazdasági öntözésre. A Hari Rud a Tedshen endorheikus medence része.",
      ro: "Hari Rud (sau Herat Rud) este un râu de aproximativ 1100 km în Afganistan, Turkmenistan și Iran. Izvorăște din Hindukush în provincia Ghor și curge spre vest prin Herat. Râul se pierde în deșertul Karakum din Turkmenistan. Apele sale sunt folosite intens pentru agricultură în jurul Heratului. Hari Rud face parte din bazinul endoreic al Tedjenului.",
      en: "The Hari Rud (or Herat Rud) is a river about 1,100 km long in Afghanistan, Turkmenistan, and Iran. It rises in the Hindu Kush in Ghor Province and flows west through Herat. The river ends in the Karakum Desert of Turkmenistan. Its water is heavily used for agriculture around Herat. The Hari Rud is part of the endorheic Tedjen basin.",
    },
    factsAdvanced: {
      de: ["Länge etwa 1100 km", "entspringt im Hindukusch", "fließt durch Herat", "versickert in der Karakum-Wüste", "wichtig für Bewässerung in der Region Herat", "endorheisches Becken des Tedschen"],
      hu: ["hossza kb. 1100 km", "a Hindukusban ered", "Heráton keresztül folyik", "a Karakum-sivatagban végződik", "fontos öntözéshez Herát környékén", "a Tedshen endorheikus medencéjének része"],
      ro: ["lungime cca 1100 km", "izvorăște din Hindukush", "curge prin Herat", "se pierde în deșertul Karakum", "important pentru irigații în zona Herat", "bazin endoreic al Tedjenului"],
      en: ["length about 1,100 km", "rises in the Hindu Kush", "flows through Herat", "ends in the Karakum Desert", "important for irrigation around Herat", "part of the endorheic Tedjen basin"],
    },
  },
  {
    ...
    }, image: "/poi-images/afghanistan-kabul-river-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Kabul-Fluss ist mit 700 km der wichtigste Fluss im Osten Afghanistans. Er entspringt im Hindukusch nahe dem Unai-Pass und fließt durch Kabul und dann nach Osten, wo er bei Attock in Pakistan in den Indus mündet. Der Fluss ist stark verschmutzt, da er Abwässer aus Kabul aufnimmt. Er liefert Wasser für die Bewässerung im Kabul-Becken und für die Stromerzeugung.",
      hu: "A Kabul folyó 700 km hosszával Kelet-Afganisztán legfontosabb folyója. A Hindukusban, az Unai-hágó közelében ered, áthalad Kabulon, majd kelet felé folyik, és Attocknál (Pakisztán) ömlik az Indusba. A folyó erősen szennyezett, mivel befogadja Kabul szennyvizét. Vizet biztosít öntözéshez a Kabul-medencében és villamosenergia-termeléshez.",
      ro: "Râul Kabul, cu 700 km, este cel mai important râu din estul Afganistanului. Izvorăște din Hindukush lângă Pasul Unai, curge prin Kabul și apoi spre est, vărsându-se în Indus la Attock, Pakistan. Râul este puternic poluat, deoarece primește ape uzate din Kabul. Furnizează apă pentru irigații în bazinul Kabul și pentru generarea de electricitate.",
      en: "The Kabul River, 700 km long, is the most important river in eastern Afghanistan. It rises in the Hindu Kush near the Unai Pass, flows through Kabul, then east to join the Indus at Attock, Pakistan. The river is heavily polluted, receiving sewage from Kabul. It provides water for irrigation in the Kabul basin and for hydropower.",
    },
    factsAdvanced: {
      de: ["Länge 700 km", "entspringt am Unai-Pass", "mündet in den Indus in Pakistan", "stark verschmutzt durch Abwässer aus Kabul", "wichtig für Bewässerung und Wasserkraft", "durchfließt die Stadt Kabul"],
      hu: ["hossza 700 km", "az Unai-hágónál ered", "Pakisztánban ömlik az Indusba", "erősen szennyezett Kabul szennyvizétől", "fontos öntözéshez és vízenergiához", "keresztülfolyik Kabul városán"],
      ro: ["lungime 700 km", "izvorăște la Pasul Unai", "se varsă în Indus în Pakistan", "puternic poluat de apele uzate din Kabul", "important pentru irigații și hidroenergie", "traversează orașul Kabul"],
      en: ["length 700 km", "rises at Unai Pass", "joins the Indus in Pakistan", "heavily polluted from Kabul sewage", "important for irrigation and hydropower", "flows through Kabul city"],
    },
  },
  {
    ...
    }, image: "/poi-images/afghanistan-pandschschir-river-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Pandschschir (oder Panjshir) ist ein 350 km langer Fluss im Nordosten Afghanistans. Er entspringt im Hindukusch und fließt durch das Pandschschir-Tal, bevor er in den Kabul mündet. Der Fluss ist bekannt für seine smaragdgrüne Farbe und seine Schluchten. Das Tal war während der sowjetischen Besatzung und des Bürgerkriegs eine strategisch wichtige Hochburg der Mudschaheddin. Heute wird Wasserkraft genutzt.",
      hu: "A Pandzsirs (vagy Panjshir) 350 km hosszú folyó Afganisztán északkeleti részén. A Hindukusban ered, átfolyik a Pandzsirs-völgyön, majd a Kabulba ömlik. A folyó smaragdzöld színéről és szurdokairól ismert. A völgy stratégiai fontosságú volt a szovjet megszállás és a polgárháború idején a mudzsahedinok kezében. Ma vízenergiát hasznosítanak.",
      ro: "Râul Panjshir (sau Pandschir) are 350 km lungime în nord-estul Afganistanului. Izvorăște din Hindukush și curge prin Valea Panjshir înainte de a se vărsa în Kabul. Râul este cunoscut pentru culoarea sa verde smarald și chei. Valea a fost o fortăreață strategică a mujahedinilor în timpul ocupației sovietice și al războiului civil. Astăzi este folosit pentru hidroenergie.",
      en: "The Panjshir (or Panjsher) River is 350 km long in northeastern Afghanistan. It rises in the Hindu Kush and flows through the Panjshir Valley before joining the Kabul. The river is known for its emerald green color and gorges. The valley was a strategic mujahideen stronghold during the Soviet occupation and civil war. Hydropower is now utilized.",
    },
    factsAdvanced: {
      de: ["Länge 350 km", "entspringt im Hindukusch", "mündet in den Kabul", "smaragdgrüne Farbe", "strategisches Tal während des Krieges", "Wasserkraftnutzung"],
      hu: ["hossza 350 km", "a Hindukusban ered", "a Kabulba ömlik", "smaragdzöld színű", "stratégiai völgy a háború alatt", "vízenergia hasznosítás"],
      ro: ["lungime 350 km", "izvorăște din Hindukush", "se varsă în Kabul", "culoare verde smarald", "vale strategică în timpul războiului", "utilizare hidroenergetică"],
      en: ["length 350 km", "rises in the Hindu Kush", "joins the Kabul River", "emerald green color", "strategic valley during war", "hydropower use"],
    },
  },
  {
    ...
    }, image: "/poi-images/afghanistan-arghandab-river-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Arghandab ist ein 400 km langer Fluss im Süden Afghanistans. Er entspringt im Hindukusch und fließt durch Kandahar, bevor er in den Helmand mündet. Der Fluss ist wichtig für die Bewässerung der Obstgärten um Kandahar, insbesondere für Granatäpfel und Trauben. Während der Kriege war er ein strategisches Hindernis.",
      hu: "Az Arghandab 400 km hosszú folyó Afganisztán déli részén. A Hindukusban ered, áthalad Kandaháron, majd a Helmandba ömlik. A folyó fontos a Kandahár környéki gyümölcsösök öntözéséhez, különösen a gránátalma és a szőlő számára. A háborúk során stratégiai akadály volt.",
      ro: "Râul Arghandab are 400 km lungime în sudul Afganistanului. Izvorăște din Hindukush, curge prin Kandahar și se varsă în Helmand. Este important pentru irigarea livezilor din jurul Kandaharului, în special rodii și struguri. În timpul războaielor a fost un obstacol strategic.",
      en: "The Arghandab River is 400 km long in southern Afghanistan. It rises in the Hindu Kush, flows through Kandahar, and joins the Helmand River. It is crucial for irrigating orchards around Kandahar, particularly pomegranates and grapes. During wars, it served as a strategic barrier.",
    },
    factsAdvanced: {
      de: ["Länge 400 km", "fließt durch Kandahar", "mündet in den Helmand", "wichtig für Obstkulturen (Granatäpfel, Trauben)", "strategische Bedeutung in Konflikten", "entspringt im Hindukusch"],
      hu: ["hossza 400 km", "Kandaháron folyik keresztül", "a Helmandba ömlik", "fontos gyümölcstermesztéshez (gránátalma, szőlő)", "stratégiai jelentőségű konfliktusokban", "a Hindukusban ered"],
      ro: ["lungime 400 km", "curge prin Kandahar", "se varsă în Helmand", "important pentru culturi de fructe (rodii, struguri)", "importanță strategică în conflicte", "izvorăște din Hindukush"],
      en: ["length 400 km", "flows through Kandahar", "joins the Helmand River", "important for fruit crops (pomegranates, grapes)", "strategic importance in conflicts", "rises in the Hindu Kush"],
    },
  },
  {
    ...
    }, image: "/poi-images/afghanistan-koktscha-river-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Koktscha (oder Kokcha) ist ein 320 km langer Nebenfluss des Amu Darya im Nordosten Afghanistans. Er entspringt im Hindukusch und fließt durch Badachschan, bekannt für seine Lapislazuli-Minen. Der Fluss wird für Bewässerung und Goldwäscherei genutzt. Die Region ist reich an Mineralien.",
      hu: "A Kokcsa (vagy Kokcha) 320 km hosszú mellékfolyója az Amu-darjának Afganisztán északkeleti részén. A Hindukusban ered, és áthalad Badahsánon, amely híres lapis lazuli bányáiról. A folyót öntözésre és aranymosásra használják. A régió gazdag ásványi anyagokban.",
      ro: "Râul Kokcha (sau Koktscha) este un afluent de 320 km al Amu Darya în nord-estul Afganistanului. Izvorăște din Hindukush și curge prin Badakhshan, cunoscut pentru minele sale de lapis lazuli. Râul este folosit pentru irigații și exploatare auriferă. Regiunea este bogată în minerale.",
      en: "The Kokcha (or Koktscha) River is a 320 km tributary of the Amu Darya in northeastern Afghanistan. It rises in the Hindu Kush and flows through Badakhshan, famous for its lapis lazuli mines. The river is used for irrigation and gold panning. The region is rich in minerals.",
    },
    factsAdvanced: {
      de: ["Länge 320 km", "Nebenfluss des Amu Darya", "fließt durch Badachschan", "Lapislazuli-Bergbau in der Region", "Goldwäscherei", "entspringt im Hindukusch"],
      hu: ["hossza 320 km", "az Amu-darja mellékfolyója", "Badahsaron folyik át", "lapis lazuli bányászat a régióban", "aranymosás", "a Hindukusban ered"],
      ro: ["lungime 320 km", "afluent al Amu Darya", "curge prin Badakhshan", "exploatare de lapis lazuli în regiune", "căutare de aur", "izvorăște din Hindukush"],
      en: ["length 320 km", "tributary of Amu Darya", "flows through Badakhshan", "lapis lazuli mining in the region", "gold panning", "rises in the Hindu Kush"],
    },
  },
  {
    ...
    }, image: "/poi-images/afghanistan-murgab-river-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Murghab (oder Murgab) ist ein 850 km langer Fluss in Afghanistan und Turkmenistan. Er entspringt im Hindukusch und fließt nach Nordwesten, wo er in der Wüste Karakum versickert. Der Fluss ist wichtig für die Bewässerung in der Provinz Faryab. Das Murghab-Delta beherbergt seltene Vogelarten. Die Wasserführung schwankt stark saisonal.",
      hu: "A Murghab (vagy Murgab) 850 km hosszú folyó Afganisztánban és Türkmenisztánban. A Hindukusban ered, és északnyugat felé folyva a Karakum-sivatagban tűnik el. Fontos az öntözés számára Faryab tartományban. A Murghab-delta ritka madárfajoknak ad otthont. Vízhozama erősen szezonális.",
      ro: "Râul Murghab (sau Murgab) are 850 km lungime în Afganistan și Turkmenistan. Izvorăște din Hindukush și curge spre nord-vest, pierzându-se în deșertul Karakum. Este important pentru irigații în provincia Faryab. Delta Murghab găzduiește specii rare de păsări. Debitul variază puternic sezonier.",
      en: "The Murghab (or Murgab) River is 850 km long in Afghanistan and Turkmenistan. It rises in the Hindu Kush and flows northwest, dissipating in the Karakum Desert. It is important for irrigation in Faryab Province. The Murghab delta hosts rare bird species. Its flow varies greatly seasonally.",
    },
    factsAdvanced: {
      de: ["Länge 850 km", "entspringt im Hindukusch", "versickert in der Karakum-Wüste", "wichtig für Bewässerung in Faryab", "Delta mit seltenen Vogelarten", "starke saisonale Schwankungen"],
      hu: ["hossza 850 km", "a Hindukusban ered", "a Karakum-sivatagban tűnik el", "fontos öntözéshez Faryabban", "delta ritka madárfajokkal", "erős szezonális ingadozás"],
      ro: ["lungime 850 km", "izvorăște din Hindukush", "se pierde în deșertul Karakum", "important pentru irigații în Faryab", "delta cu specii rare de păsări", "variații sezoniere puternice"],
      en: ["length 850 km", "rises in the Hindu Kush", "dissipates in the Karakum Desert", "important for irrigation in Faryab", "delta with rare bird species", "strong seasonal variation"],
    },
  },
  {
    ...
    }, image: "/poi-images/afghanistan-schah-foladi-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Shah Foladi (oder Shah Fouladi) ist mit 5143 m der höchste Berg des Baba-Gebirges in Zentralafghanistan. Er liegt in der Provinz Bamiyan und ist Teil des Hindukusch. Der Berg ist bekannt für seine alpine Flora. Die Region um den Berg ist dünn besiedelt. In der Nähe befinden sich die Buddha-Statuen von Bamiyan.",
      hu: "A Shah Foladi (vagy Shah Fouladi) 5143 m magas, a Baba-hegység legmagasabb pontja Közép-Afganisztánban. Bamijan tartományban található, a Hindukus része. A hegy híres alpesi flórájáról. A környék ritkán lakott. Közelében találhatók a bamijani Buddha-szobrok.",
      ro: "Shah Foladi (sau Shah Fouladi) este cu 5143 m cel mai înalt munte din Munții Baba din Afganistanul central. Situat în provincia Bamyan, face parte din Hindukush. Muntele este cunoscut pentru flora sa alpină. Regiunea este slab populată. În apropiere se află statuile lui Buddha de la Bamyan.",
      en: "Shah Foladi (or Shah Fouladi) is the highest peak of the Baba Mountains in central Afghanistan, at 5,143 m. It lies in Bamyan Province and is part of the Hindu Kush. The mountain is noted for its alpine flora. The area is sparsely populated. Nearby are the Bamyan Buddha statues.",
    },
    factsAdvanced: {
      de: ["Höhe 5143 m", "höchster Gipfel des Baba-Gebirges", "liegt in der Provinz Bamiyan", "alpine Flora", "dünn besiedelte Region", "nahe den Buddha-Statuen von Bamiyan"],
      hu: ["magassága 5143 m", "a Baba-hegység legmagasabb pontja", "Bamijan tartományban fekszik", "alpesi növényzet", "ritkán lakott terület", "a bamijani Buddha-szobrok közelében"],
      ro: ["altitudine 5143 m", "cel mai înalt vârf al Munților Baba", "situat în provincia Bamyan", "floră alpină", "regiune slab populată", "în apropierea statuilor lui Buddha de la Bamyan"],
      en: ["elevation 5,143 m", "highest peak of Baba Mountains", "located in Bamyan Province", "alpine flora", "sparsely populated region", "near the Bamyan Buddha statues"],
    },
  },
  {
    ...
    }, image: "/poi-images/afghanistan-zorkulsee-nature-v2.webp",
    descriptionAdvanced: {
      de: "Der Zorkul-See (auch Sir-i-kol) ist ein hochgelegener See im Pamir-Gebirge an der Grenze zwischen Afghanistan und Tadschikistan. Er liegt auf einer Höhe von etwa 4100 m und ist bis zu 20 km lang. Der See ist Quellgebiet des Amu Darya. Er ist Teil des Wakhan-Korridors und ein wichtiges Feuchtgebiet für Zugvögel. Die Region ist extrem kalt und abgelegen.",
      hu: "A Zorkul-tó (vagy Sir-i-kol) egy magasan fekvő tó a Pamir-hegységben, Afganisztán és Tadzsikisztán határán. Körülbelül 4100 m magasságban található, hossza eléri a 20 km-t. A tó az Amu-darja forrásvidéke. Része a Vahán-folyosónak, fontos vizes élőhely a vonuló madarak számára. A régió rendkívül hideg és elszigetelt.",
      ro: "Lacul Zorkul (sau Sir-i-kol) este un lac de altitudine în Munții Pamir, la granița dintre Afganistan și Tadjikistan. Situat la aproximativ 4100 m altitudine, are o lungime de până la 20 km. Lacul este zona de origine a Amu Darya. Face parte din Coridorul Wakhan și este o zonă umedă importantă pentru păsările migratoare. Regiunea este extrem de rece și izolată.",
      en: "Lake Zorkul (or Sir-i-kol) is a high-altitude lake in the Pamir Mountains on the Afghanistan-Tajikistan border. It lies at about 4,100 m and is up to 20 km long. The lake is a source of the Amu Darya. It is part of the Wakhan Corridor and an important wetland for migratory birds. The region is extremely cold and remote.",
    },
    factsAdvanced: {
      de: ["Höhe ca. 4100 m", "Länge bis zu 20 km", "Quellgebiet des Amu Darya", "liegt im Wakhan-Korridor", "wichtiges Feuchtgebiet für Zugvögel", "Grenzsee zwischen Afghanistan und Tadschikistan"],
      hu: ["magassága kb. 4100 m", "hossza legfeljebb 20 km", "az Amu-darja forrásvidéke", "a Vahán-folyosó része", "fontos vizes élőhely vonuló madaraknak", "határtó Afganisztán és Tadzsikisztán között"],
      ro: ["altitudine cca 4100 m", "lungime de până la 20 km", "zonă de origine a Amu Darya", "parte a Coridorului Wakhan", "zonă umedă importantă pentru păsări migratoare", "lac de graniță între Afganistan și Tadjikistan"],
      en: ["elevation about 4,100 m", "length up to 20 km", "source of Amu Darya", "part of Wakhan Corridor", "important wetland for migratory birds", "border lake between Afghanistan and Tajikistan"],
    },
  },
  {
    ...
    facts: {
      ...
      ,
        ...
        factsAdvanced: { multi4: ["Western extension of the Hindu Kush range", "Located in central Afghanistan, primarily Bamiyan Province", "Highest peak: Shah Foladi (5,143 m)", "Source of Afghanistan's major rivers: Helmand, Hari Rud, Kabul", "Considered the 'water tower' of Afghanistan", "Homeland of the Hazara ethnic group", "Characterized by a semi-arid, alpine climate", "Name translates to 'Grandfather Mountains'"] },
         image: "/poi-images/afghanistan-koh-e-baba-nature-v2.webp"}
    ]
;
