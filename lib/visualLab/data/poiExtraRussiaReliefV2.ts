...
,
  {
    ...
    coordinates: { lat: 44.9333, lng: 135.5 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Der Sikhote-Alin-Pass ist ein Gebirgspass im Sikhote-Alin-Gebirge im Fernen Osten Russlands. Der Pass liegt auf etwa 800 Metern Höhe und verbindet die Küstenregion mit dem Landesinneren. Er ist bekannt für seine reiche Biodiversität, darunter der Amur-Tiger. Der Pass ist Teil des Sikhote-Alin-Naturreservats, das zum UNESCO-Welterbe gehört. Die Landschaft ist geprägt von dichten Wäldern und felsigen Gipfeln.",
      hu: "A Szihote-Alin-hágó a Távol-Keleten található Szihote-Alin hegységben. Magassága kb. 800 méter, összeköti a partvidéket a belső területekkel. Híres gazdag biodiverzitásáról, beleértve az amuri tigrist. Az UNESCO világörökség részét képező Szihote-Alin Természetvédelmi Terület része. A tájat sűrű erdők és sziklás csúcsok jellemzik.",
      ro: "Pasul Sikhote-Alin este un pas montan în Munții Sikhote-Alin din Extremul Orient al Rusiei. Situat la aproximativ 800 de metri altitudine, face legătura între coastă și interior. Este renumit pentru biodiversitatea sa, inclusiv tigrul Amur. Face parte din Rezervația Naturală Sikhote-Alin, inclusă în Patrimoniul Mondial UNESCO. Peisajul este dominat de păduri dense și vârfuri stâncoase.",
      en: "The Sikhote-Alin Pass is a mountain pass in the Sikhote-Alin range in the Russian Far East, at an elevation of about 800 meters. It connects the coastal region with the interior. The area is renowned for its biodiversity, including the endangered Amur tiger. The pass lies within the Sikhote-Alin Nature Reserve, a UNESCO World Heritage site. The landscape features dense forests and rugged peaks.",
    },
    factsAdvanced: {
      de: ["Passhöhe etwa 800 Meter.", "Länge des Passwegs ca. 15 Kilometer.", "Teil des UNESCO-Welterbes Sikhote-Alin (seit 2001).", "Reservatsfläche 4.301 km².", "Vorkommen von 50 Säugetierarten.", "Jährlicher Niederschlag über 1.000 mm."],
      hu: ["A hágó magassága kb. 800 méter.", "A hágóút hossza kb. 15 km.", "Az UNESCO világörökség része (2001 óta).", "A rezervátum területe 4301 km².", "50 emlősfaj előfordulása.", "Éves csapadék mennyisége meghaladja az 1000 mm-t."],
      ro: ["Altitudine pas cca 800 metri.", "Lungime drum de trecere cca 15 km.", "Parte a Patrimoniului Mondial UNESCO Sikhote-Alin (din 2001).", "Suprafața rezervației 4.301 km².", "Prezența a 50 de specii de mamifere.", "Precipitații anuale peste 1.000 mm."],
      en: ["Pass elevation approx. 800 meters.", "Pass road length approx. 15 km.", "UNESCO World Heritage Sikhote-Alin (since 2001).", "Reserve area 4,301 km².", "Home to 50 mammal species.", "Annual rainfall over 1,000 mm."],
    },
  },
  {
  ...
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Jergeni-Hochebene ist eine hügelige Region im Südwesten Russlands, östlich der Wolga und nördlich des Kaukasus. Sie erstreckt sich über etwa 350 km von Nordwesten nach Südosten. Die durchschnittliche Höhe beträgt 100–200 m, mit maximalen Erhebungen um 220 m. Das Relief wird von niedrigen Hügeln und flachen Tälern geprägt, die von Steppenvegetation bedeckt sind. Die Hochebene besteht hauptsächlich aus tertiären und quartären Sedimenten, darunter Sande, Tone und Karbonate. Die Region ist landwirtschaftlich genutzt, vor allem für den Anbau von Weizen und Sonnenblumen. Die Jergeni-Hochebene entwässert in die Wolga und den Manytsch. Aufgrund des trockenen Kontinentalklimas fallen nur 300–400 mm Niederschlag jährlich.",
      hu: "A Jergenyi-dombság Oroszország délnyugati részén, a Volgától keletre és a Kaukázustól északra található. Hossza mintegy 350 km északnyugat-délkeleti irányban. Átlagos magassága 100-200 méter, a legmagasabb pontok 220 m körüliek. A felszínt alacsony dombok és lapos völgyek tagolják, melyeket sztyeppei növényzet borít. A dombság harmad- és negyedidőszaki üledékes kőzetekből, homokból, agyagból és karbonátokból épül fel. A terület mezőgazdasági művelés alatt áll, főként búzát és napraforgót termesztenek. A Jergenyi a Volga és a Manycs folyók vízgyűjtőjéhez tartozik. A száraz kontinentális éghajlat miatt évente csak 300-400 mm csapadék hull.",
      ro: "Podișul Yergeni este o regiune deluroasă din sud-vestul Rusiei, la est de Volga și la nord de Caucaz. Se întinde pe aproximativ 350 km de la nord-vest la sud-est. Altitudinea medie este de 100-200 m, cu maxime în jurul a 220 m. Relieful este format din dealuri joase și văi largi, acoperite cu vegetație de stepă. Podișul este compus din sedimente terțiare și cuaternare, inclusiv nisipuri, argile și carbonați. Zona este utilizată agricol, în principal pentru grâu și floarea-soarelui. Yergeni drenează în Volga și Manych. Clima continentală aridă aduce doar 300-400 mm precipitații anuale.",
      en: "The Yergeni Upland is a hilly region in southwestern Russia, east of the Volga River and north of the Caucasus. It stretches roughly 350 km from northwest to southeast. Average elevations range from 100 to 200 m, with maximum around 220 m. The landscape consists of low hills and shallow valleys, covered by steppe vegetation. The upland is underlain by Tertiary and Quaternary sediments, including sands, clays, and carbonates. Agriculture is prominent, with wheat and sunflowers as main crops. The Yergeni drains into the Volga and Manych rivers. The climate is dry continental, with 300–400 mm annual precipitation.",
    },
    factsAdvanced: {
      de: ["Die Jergeni-Hochebene erstreckt sich über eine Länge von etwa 350 km.", "Die maximale Höhe beträgt rund 220 m.", "Die jährliche Niederschlagsmenge liegt zwischen 300 und 400 mm.", "Die Durchschnittstemperatur im Januar beträgt -6 °C, im Juli +24 °C.", "Die landwirtschaftliche Nutzfläche umfasst etwa 70 % der Region.", "Die Hauptflüsse sind der Jergeninka und der Kara-Sal."],
      hu: ["A Jergenyi-dombság hossza körülbelül 350 km.", "A legmagasabb pont kb. 220 méter.", "Az éves csapadékmennyiség 300-400 mm.", "A januári átlaghőmérséklet -6 °C, a júliusi +24 °C.", "A mezőgazdasági terület a régió mintegy 70%-át teszi ki.", "A fő folyók a Jergenyinka és a Kara-Szal."],
      ro: ["Podișul Yergeni se întinde pe aproximativ 350 km lungime.", "Altitudinea maximă este de aproximativ 220 m.", "Precipitațiile anuale sunt între 300 și 400 mm.", "Temperatura medie în ianuarie este de -6 °C, în iulie +24 °C.", "Suprafața agricolă reprezintă circa 70% din regiune.", "Principalele râuri sunt Yergeninka și Kara-Sal."],
      en: ["The Yergeni Upland extends for about 350 km.", "Maximum elevation is around 220 m.", "Annual precipitation ranges from 300 to 400 mm.", "Mean January temperature is -6 °C, July +24 °C.", "Agricultural land accounts for about 70% of the region.", "Main rivers are the Yergeninka and Kara-Sal."],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Don-Ebene ist eine ausgedehnte Tiefebene im europäischen Teil Russlands, die sich entlang des mittleren und unteren Don erstreckt. Sie bedeckt eine Fläche von etwa 250.000 km² und liegt zwischen der Mittelrussischen Platte im Westen und der Wolgaplatte im Osten. Die Höhen variieren zwischen 100 und 200 m, wobei der tiefste Punkt bei etwa 50 m liegt. Die Ebene besteht aus quartären Ablagerungen, hauptsächlich Löss und Flusssedimenten. Sie ist eines der wichtigsten landwirtschaftlichen Gebiete Russlands, bekannt für den Anbau von Weizen, Mais und Zuckerrüben. Der Don fließt mäandrierend durch die Ebene und bildet zahlreiche Altarme. Das Klima ist gemäßigt kontinental mit kalten Wintern (-10 °C im Januar) und warmen Sommern (+20 °C im Juli).",
      hu: "A Don-alföld Oroszország európai részén, a Középső-orosz-hátság és a Volgamenti-hátság között terül el, a Don folyó mentén. Területe mintegy 250 000 km². Tengerszint feletti magassága 100-200 méter, legalacsonyabb pontja körülbelül 50 m. Az alföld negyedidőszaki üledékekből, főként löszből és folyami hordalékból épül fel. Oroszország egyik legfontosabb mezőgazdasági régiója, ahol búzát, kukoricát és cukorrépát termesztenek. A Don kanyargósan folyik az alföldön, számos holtágat képezve. Az éghajlat mérsékelten kontinentális, hideg telekkel (januárban -10 °C) és meleg nyarakkal (júliusban +20 °C).",
      ro: "Câmpia Donului este o întinsă câmpie din partea europeană a Rusiei, situată de-a lungul râului Don mijlociu și inferior. Acoperă o suprafață de aproximativ 250.000 km² și se află între Podișul Central Rusesc la vest și Podișul Volga la est. Altitudinile variază între 100 și 200 m, punctul cel mai jos fiind în jurul a 50 m. Câmpia este formată din depozite cuaternare, în principal loess și sedimente fluviale. Este una dintre cele mai importante zone agricole ale Rusiei, cunoscută pentru grâu, porumb și sfeclă de zahăr. Donul curge meandrat prin câmpie, formând numeroase brațe moarte. Clima este temperat-continentală, cu ierni reci (-10 °C în ianuarie) și veri calde (+20 °C în iulie).",
      en: "The Don Plain is a vast lowland in European Russia, stretching along the middle and lower Don River. It covers about 250,000 km² between the Central Russian Upland to the west and the Volga Upland to the east. Elevations range from 100 to 200 m, with the lowest point around 50 m. The plain is composed of Quaternary deposits, mainly loess and river sediments. It is one of Russia's most important agricultural regions, known for wheat, corn, and sugar beets. The Don River meanders across the plain, forming numerous oxbow lakes. The climate is temperate continental, with cold winters (-10 °C in January) and warm summers (+20 °C in July).",
    },
    factsAdvanced: {
      de: ["Die Don-Ebene erstreckt sich über etwa 250.000 km².", "Der tiefste Punkt liegt bei etwa 50 m über dem Meeresspiegel.", "Die jährliche Niederschlagsmenge beträgt 400–600 mm.", "Die Durchschnittstemperatur im Januar beträgt -10 °C, im Juli +20 °C.", "Die landwirtschaftliche Nutzfläche beträgt rund 60 % der Gesamtfläche.", "Der Don ist etwa 1.870 km lang, davon fließen 1.500 km durch die Ebene."],
      hu: ["A Don-alföld területe mintegy 250 000 km².", "A legalacsonyabb pont kb. 50 m tengerszint feletti magasságban van.", "Az éves csapadékmennyiség 400-600 mm.", "A januári átlaghőmérséklet -10 °C, a júliusi +20 °C.", "A mezőgazdasági terület a teljes terület mintegy 60%-a.", "A Don folyó hossza kb. 1.870 km, ebből 1.500 km folyik az alföldön."],
      ro: ["Câmpia Donului acoperă aproximativ 250.000 km².", "Cel mai jos punct este la circa 50 m deasupra nivelului mării.", "Precipitațiile anuale sunt între 400 și 600 mm.", "Temperatura medie în ianuarie este de -10 °C, în iulie +20 °C.", "Suprafața agricolă reprezintă circa 60% din total.", "Râul Don are aproximativ 1.870 km lungime, dintre care 1.500 km străbat câmpia."],
      en: ["The Don Plain covers about 250,000 km².", "The lowest point is around 50 m above sea level.", "Annual precipitation is 400–600 mm.", "Mean January temperature is -10 °C, July +20 °C.", "Agricultural land accounts for about 60% of the total area.", "The Don River is about 1,870 km long, with 1,500 km flowing through the plain."],
    },
  },
  {
    ...
    coordinates: { lat: 55.0, lng: 114.0 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Das Witim-Plateau ist eine Hochebene im südlichen Ostsibirien, östlich des Baikalsees. Es liegt auf einer Höhe von 800–1.200 m und erstreckt sich über ca. 200.000 km². Das Plateau wird von kristallinen Gesteinen des Präkambriums unterlagert und ist von Bergen und tief eingeschnittenen Tälern durchzogen. Die wichtigsten Flüsse sind der Witim und seine Nebenflüsse. Das Gebiet ist stark bewaldet, hauptsächlich mit Lärchen und Kiefern. Das Klima ist extrem kontinental mit sehr kalten Wintern (Durchschnitt -30 °C) und milden Sommern (+15 °C). Die Bevölkerungsdichte ist extrem niedrig, die Wirtschaft basiert auf Bergbau (Gold, Uran) und Forstwirtschaft. Das Plateau liegt in der Zeitzone Irkutsk (UTC+8).",
      hu: "A Vitim-fennsík Kelet-Szibéria déli részén, a Bajkál-tótól keletre terül el. Magassága 800-1200 méter, területe mintegy 200 000 km². A fennsík prekambriumi kristályos kőzetekből áll, és hegyekkel, mély völgyekkel tagolt. Legfontosabb folyói a Vitim és mellékfolyói. A területet főként vörösfenyő- és fenyőerdők borítják. Az éghajlat szélsőségesen kontinentális, nagyon hideg telekkel (átlag -30 °C) és enyhe nyarakkal (+15 °C). A népsűrűség rendkívül alacsony, a gazdaság a bányászatra (arany, urán) és erdőgazdálkodásra épül. A fennsík az irkutszki időzónában fekszik (UTC+8).",
      ro: "Podisul Vitim este un platou înalt din sudul Siberiei de Est, la est de Lacul Baikal. Altitudinea este între 800 și 1.200 m, iar suprafața de circa 200.000 km². Platoul este format din roci cristaline precambriene și este străbătut de munți și văi adânci. Râurile principale sunt Vitim și afluenții săi. Zona este puternic împădurită, cu predominanță de larice și pini. Clima este puternic continentală, cu ierni foarte reci (medie -30 °C) și veri blânde (+15 °C). Densitatea populației este extrem de scăzută; economia se bazează pe minerit (aur, uraniu) și silvicultură. Platoul se află în fusul orar Irkutsk (UTC+8).",
      en: "The Vitim Plateau is a highland region in southern East Siberia, east of Lake Baikal. It lies at elevations of 800–1,200 m and covers about 200,000 km². The plateau is underlain by Precambrian crystalline rocks and is dissected by mountains and deep valleys. Major rivers include the Vitim and its tributaries. The area is heavily forested, mainly with larch and pine. The climate is extremely continental, with very cold winters (averaging -30 °C) and mild summers (+15 °C). Population density is extremely low; the economy relies on mining (gold, uranium) and forestry. The plateau lies in the Irkutsk time zone (UTC+8).",
    },
    factsAdvanced: {
      de: ["Das Witim-Plateau bedeckt eine Fläche von etwa 200.000 km².", "Die Höhen liegen zwischen 800 und 1.200 m.", "Die Durchschnittstemperatur im Januar beträgt -30 °C, im Juli +15 °C.", "Der Witim-Fluss ist etwa 1.837 km lang.", "Die Region verfügt über bedeutende Goldvorkommen, die jährlich mehrere Tonnen produzieren.", "Die Bevölkerungsdichte liegt unter 1 Einwohner pro km²."],
      hu: ["A Vitim-fennsík területe mintegy 200 000 km².", "A magasság 800 és 1200 méter között van.", "A januári átlaghőmérséklet -30 °C, a júliusi +15 °C.", "A Vitim folyó hossza körülbelül 1 837 km.", "A régió jelentős aranylelőhelyekkel rendelkezik, évente több tonnát termelnek.", "A népsűrűség 1 fő/km² alatt van."],
      ro: ["Podisul Vitim acoperă o suprafață de circa 200.000 km².", "Altitudinile sunt între 800 și 1.200 m.", "Temperatura medie în ianuarie este de -30 °C, în iulie +15 °C.", "Râul Vitim are aproximativ 1.837 km lungime.", "Regiunea deține zăcăminte importante de aur, cu producție anuală de câteva tone.", "Densitatea populației este sub 1 locuitor pe km²."],
      en: ["The Vitim Plateau covers about 200,000 km².", "Elevations range from 800 to 1,200 m.", "Mean January temperature is -30 °C, July +15 °C.", "The Vitim River is about 1,837 km long.", "The region has significant gold deposits, producing several tonnes annually.", "Population density is below 1 person per km²."],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Turgai-Hohlweg ist eine etwa 600 km lange Senke im Nordwesten Kasachstans und Südwesten Russlands, die den Ural mit dem Aralsee verbindet. Die Breite variiert zwischen 20 und 200 km. Die Höhen liegen meist zwischen 100 und 200 m. Die Senke entstand während der Jura- und Kreidezeit und ist mit mesozoischen und känozoischen Sedimenten gefüllt. Früher floss der Turgai-Fluss durch den Hohlweg, heute ist er weitgehend trocken. Der Hohlweg ist eine wichtige biogeografische Barriere und Wanderroute für Steppentiere. Die Vegetation ist typisch für Trockensteppen mit Federgras und Wermut. Das Klima ist kontinental mit heißen Sommern und kalten Wintern. Die Region wird für extensive Viehzucht genutzt.",
      hu: "A Turgai-árok egy mintegy 600 km hosszú mélyedés Kazahsztán északnyugati részén és Oroszország délnyugati részén, amely az Urált az Aral-tóval köti össze. Szélessége 20 és 200 km között változik. A magasság általában 100-200 méter. Az árok a jura és kréta időszakban keletkezett, és mezozoos-kainozoos üledékekkel töltődött fel. Korábban a Turgai folyó folyt át rajta, ma már nagyrészt száraz. Az árok fontos biogeográfiai akadály és vándorlási útvonal a sztyeppei állatok számára. A növényzet tipikus sztyeppei, tollfűvel és ürömmel. Az éghajlat kontinentális, forró nyarakkal és hideg telekkel. A területet extenzív állattenyésztésre használják.",
      ro: "Culoarul Turgai este o depresiune lungă de aproximativ 600 km în nord-vestul Kazahstanului și sud-vestul Rusiei, care leagă Munții Ural de Marea Aral. Lățimea variază între 20 și 200 km. Altitudinile sunt în general între 100 și 200 m. Culoarul s-a format în Jurasic și Cretacic și este umplut cu sedimente mezozoice-cenozoice. Anterior, râul Turgai curgea prin el, dar acum este în mare parte secat. Culoarul este o importantă barieră biogeografică și rută de migrație pentru animalele de stepă. Vegetația este tipică de stepă uscată, cu păiuș și pelin. Clima este continentală, cu veri fierbinți și ierni reci. Zona este utilizată pentru creșterea extensivă a animalelor.",
      en: "The Turgai Hollow is a depression about 600 km long in northwestern Kazakhstan and southwestern Russia, connecting the Urals with the Aral Sea. Its width ranges from 20 to 200 km. Elevations are mostly between 100 and 200 m. The hollow formed during the Jurassic and Cretaceous periods and is filled with Mesozoic-Cenozoic sediments. The Turgai River once flowed through it but is now largely dry. The hollow is an important biogeographic barrier and migration route for steppe animals. Vegetation is typical dry steppe with feather grass and wormwood. The climate is continental, with hot summers and cold winters. The area is used for extensive livestock grazing.",
    },
    factsAdvanced: {
      de: ["Der Turgai-Hohlweg ist etwa 600 km lang.", "Die Breite variiert zwischen 20 und 200 km.", "Die Höhe liegt meist zwischen 100 und 200 m.", "Die Sedimentfüllung erreicht Mächtigkeiten von bis zu 2.000 m.", "Jährlich fallen nur 200–300 mm Niederschlag.", "Die Durchschnittstemperatur im Juli beträgt +24 °C, im Januar -14 °C."],
      hu: ["A Turgai-árok hossza mintegy 600 km.", "Szélessége 20 és 200 km között változik.", "A magasság általában 100-200 méter.", "Az üledékréteg vastagsága elérheti a 2000 métert.", "Az éves csapadékmennyiség mindössze 200-300 mm.", "A júliusi átlaghőmérséklet +24 °C, a januári -14 °C."],
      ro: ["Culoarul Turgai are aproximativ 600 km lungime.", "Lățimea variază între 20 și 200 km.", "Altitudinea este în general între 100 și 200 m.", "Grosimea sedimentelor atinge până la 2.000 m.", "Precipitațiile anuale sunt doar 200-300 mm.", "Temperatura medie în iulie este +24 °C, iar în ianuarie -14 °C."],
      en: ["The Turgai Hollow is about 600 km long.", "Its width ranges from 20 to 200 km.", "Elevations are mostly between 100 and 200 m.", "Sediment thickness reaches up to 2,000 m.", "Annual precipitation is only 200–300 mm.", "Mean July temperature +24 °C, January -14 °C."],
    },
  },
  {
    ...
    coordinates: { lat: 68.5, lng: 158.0 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Die Kolyma-Niederung ist eine ausgedehnte Tiefebene im Nordosten Sibiriens, zwischen dem Kolyma-Gebirge im Westen und der Küste des Arktischen Ozeans im Osten. Sie erstreckt sich über etwa 1.000 km in Nord-Süd-Richtung und etwa 600 km in Ost-West-Richtung. Die Höhen liegen meist unter 100 m, weite Teile sind sumpfig. Das Gebiet besteht aus quartären Ablagerungen, die auf Permafrostboden ruhen. Die wichtigsten Flüsse sind die Kolyma und ihre Nebenflüsse. Die Vegetation ist typische Tundra mit Moosen, Flechten und Zwergsträuchern. Das Klima ist arktisch kontinental mit sehr kalten Wintern (-30 °C bis -40 °C) und kurzen, kühlen Sommern (+10 °C). Die Bevölkerung ist sehr gering, hauptsächlich indigene Gruppen wie Tschuktschen und Ewenen.",
      hu: "A Kolima-alföld Északkelet-Szibéria egy hatalmas síksága, a Kolima-hegységtől nyugatra és az Északi-sarkvidék partjától keletre. Észak-déli irányban mintegy 1000 km, kelet-nyugati irányban 600 km. A magasság általában 100 m alatt van, nagy része mocsaras. A terület negyedidőszaki üledékekből áll, amelyek állandóan fagyott talajon (permafroszt) nyugszanak. Legfontosabb folyói a Kolima és mellékfolyói. A növényzet tipikus tundra, mohákkal, zuzmókkal és törpecserjékkel. Az éghajlat sarkvidéki kontinentális, nagyon hideg telekkel (-30 °C és -40 °C között) és rövid, hűvös nyarakkal (+10 °C). A népesség nagyon alacsony, főként őslakos csoportok, mint a csukcsok és az evenek.",
      ro: "Câmpia Kolâma este o întinsă câmpie din nord-estul Siberiei, între Munții Kolâma la vest și coasta Oceanului Arctic la est. Se întinde pe aproximativ 1.000 km nord-sud și 600 km est-vest. Altitudinile sunt în general sub 100 m, mari porțiuni fiind mlăștinoase. Zona este formată din depozite cuaternare care se sprijină pe permafrost. Principalele râuri sunt Kolâma și afluenții săi. Vegetația este tundră tipică, cu mușchi, licheni și arbuști pitici. Clima este arctică continentală, cu ierni foarte reci (-30 °C până la -40 °C) și veri scurte și răcoroase (+10 °C). Populația este foarte redusă, în principal grupuri indigene precum ciukcii și evenii.",
      en: "The Kolyma Lowland is a vast lowland in northeastern Siberia, between the Kolyma Mountains to the west and the Arctic Ocean coast to the east. It stretches about 1,000 km north-south and 600 km east-west. Elevations are generally below 100 m, with large areas of marshland. The area is underlain by Quaternary sediments on permafrost. Major rivers are the Kolyma and its tributaries. Vegetation is typical tundra, with mosses, lichens, and dwarf shrubs. The climate is arctic continental, with very cold winters (-30 °C to -40 °C) and short, cool summers (+10 °C). The population is very sparse, mainly indigenous groups like Chukchi and Evens.",
    },
    factsAdvanced: {
      de: ["Die Kolyma-Niederung erstreckt sich über etwa 1.000 km in Nord-Süd-Richtung.", "Die Breite beträgt bis zu 600 km.", "Der tiefste Punkt liegt nahe dem Meeresspiegel.", "Der Permafrost erreicht eine Tiefe von bis zu 500 m.", "Die jährliche Niederschlagsmenge beträgt weniger als 300 mm.", "Die Kolyma ist etwa 2.129 km lang."],
      hu: ["A Kolima-alföld észak-déli irányban mintegy 1000 km hosszú.", "Szélessége eléri a 600 km-t.", "A legalacsonyabb pont a tengerszint közelében van.", "A permafroszt vastagsága elérheti az 500 métert.", "Az éves csapadék kevesebb mint 300 mm.", "A Kolima folyó hossza körülbelül 2 129 km."],
      ro: ["Câmpia Kolâma se întinde pe aproximativ 1.000 km nord-sud.", "Lățimea ajunge până la 600 km.", "Cel mai jos punct este aproape de nivelul mării.", "Permafrostul atinge grosimi de până la 500 m.", "Precipitațiile anuale sunt sub 300 mm.", "Râul Kolâma are aproximativ 2.129 km lungime."],
      en: ["The Kolyma Lowland stretches about 1,000 km north-south.", "Width reaches up to 600 km.", "The lowest point is near sea level.", "Permafrost thickness reaches up to 500 m.", "Annual precipitation is less than 300 mm.", "The Kolyma River is about 2,129 km long."],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Jamal-Halbinsel liegt im Nordwesten Sibiriens und ragt in die Karasee hinein. Sie erstreckt sich über etwa 700 km von Süden nach Norden und ist bis zu 240 km breit. Die Halbinsel ist flach, die Höhen liegen meist unter 50 m, mit einigen Hügeln bis zu 80 m. Sie besteht aus quartären Sedimenten und ist von Permafrost durchzogen. Die Vegetation besteht aus arktischer Tundra mit Moosen, Flechten und Gräsern. Die Jamal-Halbinsel ist bekannt für ihre riesigen Erdgasvorkommen, die seit den 1970er Jahren erschlossen werden. Das Klima ist streng arktisch mit langen, kalten Wintern (-25 °C im Durchschnitt) und kurzen, kühlen Sommern (+5 °C). Die indigene Bevölkerung der Nenzen betreibt traditionell Rentierhaltung.",
      hu: "A Jamal-félsziget Nyugat-Szibéria északi részén található, és a Kara-tengerbe nyúlik. Hossza mintegy 700 km észak-déli irányban, szélessége legfeljebb 240 km. A félsziget sík, magassága általában 50 m alatt van, néhány domb eléri a 80 m-t. Negyedidőszaki üledékekből áll, és permafroszt jellemzi. Növényzete sarkvidéki tundra, mohákkal, zuzmókkal és füvekkel. A Jamal-félsziget hatalmas földgázmezőiről ismert, amelyeket az 1970-es évek óta hasznosítanak. Az éghajlat szigorúan sarkvidéki, hosszú, hideg telekkel (átlag -25 °C) és rövid, hűvös nyarakkal (+5 °C). Az őslakos nyenyecek hagyományosan rénszarvastartással foglalkoznak.",
      ro: "Peninsula Yamal se află în nord-vestul Siberiei și se proiectează în Marea Kara. Se întinde pe aproximativ 700 km de la sud la nord și până la 240 km lățime. Peninsula este plată, altitudinile fiind de obicei sub 50 m, cu unele dealuri până la 80 m. Este formată din sedimente cuaternare și este acoperită de permafrost. Vegetația este tundră arctică, cu mușchi, licheni și ierburi. Peninsula Yamal este cunoscută pentru uriașele zăcăminte de gaze naturale, exploatate încă din anii 1970. Clima este aspru arctică, cu ierni lungi și reci (medie -25 °C) și veri scurte și răcoroase (+5 °C). Populația indigenă neneț se ocupă în mod tradițional cu creșterea renilor.",
      en: "The Yamal Peninsula is located in northwestern Siberia, projecting into the Kara Sea. It extends about 700 km north-south and up to 240 km wide. The peninsula is flat, with elevations mostly below 50 m, and some hills reaching 80 m. It consists of Quaternary sediments underlain by permafrost. Vegetation is arctic tundra, with mosses, lichens, and grasses. The Yamal Peninsula is known for its giant natural gas fields, developed since the 1970s. The climate is severe arctic, with long, cold winters (average -25 °C) and short, cool summers (+5 °C). The indigenous Nenets people traditionally practice reindeer herding.",
    },
    factsAdvanced: {
      de: ["Die Jamal-Halbinsel ist etwa 700 km lang.", "Die maximale Breite beträgt 240 km.", "Die höchste Erhebung liegt bei etwa 80 m.", "Das Bovanenkowo-Gasfeld ist eines der größten in Russland, mit Reserven von über 4 Billionen m³.", "Die Durchschnittstemperatur im Juli beträgt +5 °C, im Januar -25 °C.", "Die indigene Bevölkerung umfasst etwa 10.000 Nenzen."],
      hu: ["A Jamal-félsziget hossza körülbelül 700 km.", "A maximális szélesség 240 km.", "A legmagasabb pont kb. 80 méter.", "A Bovanenkovói gázmező Oroszország egyik legnagyobbja, több mint 4 billió m³ tartalékkal.", "A júliusi átlaghőmérséklet +5 °C, a januári -25 °C.", "Az őslakos nyenyecek száma mintegy 10 000 fő."],
      ro: ["Peninsula Yamal are aproximativ 700 km lungime.", "Lățimea maximă este de 240 km.", "Cel mai înalt punct este la circa 80 m.", "Câmpul de gaze Bovanenkovo este unul dintre cele mai mari din Rusia, cu rezerve de peste 4 trilioane m³.", "Temperatura medie în iulie este de +5 °C, iar în ianuarie de -25 °C.", "Populația indigenă neneț numără aproximativ 10.000 de persoane."],
      en: ["The Yamal Peninsula is about 700 km long.", "Maximum width is 240 km.", "The highest point is around 80 m.", "The Bovanenkovo gas field is one of Russia's largest, with reserves over 4 trillion m³.", "Mean July temperature is +5 °C, January -25 °C.", "The indigenous Nenets population numbers about 10,000."],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Oka-Don-Ebene liegt im europäischen Teil Russlands, zwischen den Flüssen Oka im Norden und Don im Süden. Sie erstreckt sich über etwa 500 km von Norden nach Süden und ist bis zu 300 km breit. Die Höhen variieren zwischen 100 und 200 m, mit sanften Hügeln und weiten Tälern. Die Ebene besteht aus quartären Sedimenten, hauptsächlich Löss und Flusssanden. Sie ist eine bedeutende Agrarregion, in der Weizen, Roggen und Kartoffeln angebaut werden. Die Oka und der Don sind durch Kanäle mit der Wolga verbunden. Das Klima ist gemäßigt kontinental mit mäßig kalten Wintern (-10 °C) und warmen Sommern (+20 °C). Städte wie Tula und Lipezk liegen in dieser Ebene.",
      hu: "Az Oka-Don-alföld Oroszország európai részén, az Oka folyótól északon és a Dontól délen terül el. Észak-déli irányban mintegy 500 km, szélessége legfeljebb 300 km. A magasság 100-200 méter között változik, enyhe dombokkal és széles völgyekkel. Az alföld negyedidőszaki üledékekből, főként löszből és folyami homokból áll. Jelentős mezőgazdasági régió, ahol búzát, rozst és burgonyát termesztenek. Az Okát és a Dont csatornák kötik össze a Volgával. Az éghajlat mérsékelten kontinentális, mérsékelten hideg telekkel (-10 °C) és meleg nyarakkal (+20 °C). Olyan városok találhatók itt, mint Tula és Lipeck.",
      ro: "Câmpia Oka-Don se află în partea europeană a Rusiei, între râurile Oka la nord și Don la sud. Se întinde pe aproximativ 500 km nord-sud și până la 300 km lățime. Altitudinile variază între 100 și 200 m, cu dealuri line și văi largi. Câmpia este formată din sedimente cuaternare, în principal loess și nisipuri fluviale. Este o importantă regiune agricolă, cultivându-se grâu, secară și cartofi. Oka și Don sunt legate de Volga prin canale. Clima este temperat-continentală, cu ierni moderat de reci (-10 °C) și veri calde (+20 °C). Orașe precum Tula și Lipetsk se află în această câmpie.",
      en: "The Oka-Don Plain is located in European Russia, between the Oka River to the north and the Don River to the south. It extends about 500 km north-south and up to 300 km wide. Elevations range from 100 to 200 m, with gentle hills and broad valleys. The plain is composed of Quaternary sediments, mainly loess and river sands. It is a major agricultural region, growing wheat, rye, and potatoes. The Oka and Don are connected to the Volga via canals. The climate is temperate continental, with moderately cold winters (-10 °C) and warm summers (+20 °C). Cities such as Tula and Lipetsk are located on this plain.",
    },
    factsAdvanced: {
      de: ["Die Oka-Don-Ebene erstreckt sich über etwa 500 km in Nord-Süd-Richtung.", "Die maximale Breite beträgt 300 km.", "Die Höhen liegen zwischen 100 und 200 m.", "Die landwirtschaftliche Nutzfläche beträgt rund 70 % der Region.", "Die Dichte der Flüsse beträgt 0,5–0,7 km pro km².", "Die Stadt Lipezk hat etwa 500.000 Einwohner."],
      hu: ["Az Oka-Don-alföld észak-déli irányban mintegy 500 km hosszú.", "A maximális szélesség 300 km.", "A magasság 100 és 200 méter között van.", "A mezőgazdasági terület a régió mintegy 70%-át teszi ki.", "A folyósűrűség 0,5-0,7 km/km².", "Lipeck városának kb. 500 000 lakosa van."],
      ro: ["Câmpia Oka-Don se întinde pe aproximativ 500 km nord-sud.", "Lățimea maximă este de 300 km.", "Altitudinile sunt între 100 și 200 m.", "Suprafața agricolă reprezintă circa 70% din regiune.", "Densitatea rețelei hidrografice este de 0,5-0,7 km/km².", "Orașul Lipetsk are aproximativ 500.000 de locuitori."],
      en: ["The Oka-Don Plain stretches about 500 km north-south.", "Maximum width is 300 km.", "Elevations range between 100 and 200 m.", "Agricultural land accounts for about 70% of the region.", "River density is 0.5-0.7 km per km².", "The city of Lipetsk has about 500,000 inhabitants."],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Die Taimyr-Niederung liegt im Norden Sibiriens auf der Taimyr-Halbinsel und grenzt an die Karasee und die Laptewsee. Sie erstreckt sich über etwa 1.000 km von Westen nach Osten und 500 km von Norden nach Süden. Die Höhen liegen meist unter 50 m, mit Ausnahme einiger Hügel. Das Gebiet ist von Permafrost durchzogen und besteht aus quartären Sedimenten. Die Vegetation ist arktische Tundra und polare Wüste. Der Taimyrsee, der größte See in der Region, liegt hier. Das Klima ist extrem arktisch mit sehr kalten Wintern (Durchschnitt -30 °C) und kurzen, kühlen Sommern (max. +10 °C). Die Region ist nahezu unbewohnt, mit Ausnahme weniger wissenschaftlicher Stationen. Die Taimyr-Niederung ist ein wichtiges Brutgebiet für Zugvögel.",
      hu: "A Tajmir-alföld Észak-Szibériában, a Tajmir-félszigeten található, a Kara-tenger és a Laptyev-tenger mellett. Nyugat-keleti irányban mintegy 1000 km, észak-déli irányban 500 km. A magasság általában 50 m alatt van, kivéve néhány dombot. A területet permafroszt jellemzi, és negyedidőszaki üledékekből áll. Növényzete sarkvidéki tundra és sarki sivatag. Itt található a Tajmir-tó, a régió legnagyobb tava. Az éghajlat szélsőségesen sarkvidéki, nagyon hideg telekkel (átlag -30 °C) és rövid, hűvös nyarakkal (max. +10 °C). A régió szinte lakatlan, néhány tudományos állomás kivételével. A Tajmir-alföld fontos költőhely a vándormadarak számára.",
      ro: "Câmpia Taimîr se află în nordul Siberiei, pe Peninsula Taimîr, la Marea Kara și Marea Laptev. Se întinde pe aproximativ 1.000 km vest-est și 500 km nord-sud. Altitudinile sunt în general sub 50 m, cu excepția unor dealuri. Zona este acoperită de permafrost și formată din sedimente cuaternare. Vegetația este tundră arctică și deșert polar. Lacul Taimîr, cel mai mare lac din regiune, se găsește aici. Clima este extrem de arctică, cu ierni foarte reci (medie -30 °C) și veri scurte și reci (max. +10 °C). Regiunea este aproape nelocuită, cu excepția câtorva stații științifice. Câmpia Taimîr este o importantă zonă de cuibărit pentru păsările migratoare.",
      en: "The Taimyr Lowland is located in northern Siberia on the Taimyr Peninsula, bordering the Kara Sea and Laptev Sea. It extends about 1,000 km east-west and 500 km north-south. Elevations are mostly below 50 m, except for some hills. The area is underlain by permafrost and composed of Quaternary sediments. Vegetation is arctic tundra and polar desert. Lake Taimyr, the largest lake in the region, lies here. The climate is severely arctic, with very cold winters (average -30 °C) and short, cool summers (max +10 °C). The region is nearly uninhabited, except for a few scientific stations. The Taimyr Lowland is an important breeding ground for migratory birds.",
    },
    factsAdvanced: {
      de: ["Die Taimyr-Niederung erstreckt sich über etwa 1.000 km in Ost-West-Richtung.", "Die maximale Breite beträgt 500 km.", "Der Taimyrsee hat eine Fläche von ca. 4.560 km².", "Die Durchschnittstemperatur im Januar beträgt -30 °C, im Juli +5 °C.", "Jährlich fallen weniger als 300 mm Niederschlag.", "Die Region beherbergt die nördlichsten Populationen von Lemmingen."],
      hu: ["A Tajmir-alföld kelet-nyugati irányban mintegy 1000 km hosszú.", "A maximális szélesség 500 km.", "A Tajmir-tó területe kb. 4 560 km².", "A januári átlaghőmérséklet -30 °C, a júliusi +5 °C.", "Az éves csapadék kevesebb mint 300 mm.", "A régió a lemmingek legészakibb populációinak ad otthont."],
      ro: ["Câmpia Taimîr se întinde pe aproximativ 1.000 km est-vest.", "Lățimea maximă este de 500 km.", "Lacul Taimîr are o suprafață de circa 4.560 km².", "Temperatura medie în ianuarie este de -30 °C, iar în iulie de +5 °C.", "Precipitațiile anuale sunt sub 300 mm.", "Regiunea găzduiește cele mai nordice populații de lemingi."],
      en: ["The Taimyr Lowland extends about 1,000 km east-west.", "Maximum width is 500 km.", "Lake Taimyr has an area of about 4,560 km².", "Mean January temperature is -30 °C, July +5 °C.", "Annual precipitation is less than 300 mm.", "The region hosts the northernmost populations of lemmings."],
    },
  },
  {
    ...
    coordinates: { lat: 70.0, lng: 108.0 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Das Anabar-Plateau liegt im Norden Sibiriens, östlich der Mündung der Lena. Es ist ein Hochland mit Höhen zwischen 400 und 700 m, maximal etwa 905 m. Das Plateau besteht aus präkambrischen Gesteinen, insbesondere Graniten und Gneisen, und ist stark von Flüssen zerschnitten. Die wichtigsten Flüsse sind der Anabar und der Popigai. Die Vegetation ist borealer Nadelwald (Taiga) im Süden und Waldtundra im Norden. Das Klima ist subarktisch mit langen, kalten Wintern (-30 °C) und kurzen, milden Sommern (+12 °C). Das Gebiet ist reich an Diamantvorkommen, die in Kimberlit-Schloten vorkommen. Die Bevölkerungsdichte ist extrem gering, hauptsächlich leben hier Dolganen und Ewenken.",
      hu: "Az Anabar-fennsík Észak-Szibériában, a Léna torkolatától keletre található. Magassága 400 és 700 méter között van, a legmagasabb pont kb. 905 m. A fennsík prekambriumi kőzetekből, főként gránitból és gneiszből áll, és erősen tagolt folyóvölgyekkel. Fontos folyói az Anabar és a Popigaj. A növényzet délen boreális tűlevelű erdő (tajga), északon erdős tundra. Az éghajlat szubarktikus, hosszú, hideg telekkel (-30 °C) és rövid, enyhe nyarakkal (+12 °C). A terület gazdag gyémántlelőhelyekben, amelyek kimberlitcsövekben fordulnak elő. A népsűrűség rendkívül alacsony, főként dolgánok és evenek lakják.",
      ro: "Podisul Anabar se află în nordul Siberiei, la est de gura râului Lena. Este o regiune înaltă, cu altitudini între 400 și 700 m, maximul atingând circa 905 m. Podișul este format din roci precambriene, în special granit și gnais, puternic fragmentate de râuri. Principalele râuri sunt Anabar și Popigai. Vegetația este pădure boreală de conifere (taiga) în sud și pădure-tundră în nord. Clima este subarctică, cu ierni lungi și reci (-30 °C) și veri scurte și blânde (+12 °C). Zona este bogată în zăcăminte de diamante, care apar în conducte de kimberlit. Densitatea populației este extrem de scăzută, locuită în principal de dolgani și evenki.",
      en: "The Anabar Plateau is located in northern Siberia, east of the Lena River mouth. It is a highland with elevations between 400 and 700 m, reaching up to about 905 m. The plateau consists of Precambrian rocks, mainly granites and gneisses, heavily dissected by rivers. Major rivers are the Anabar and Popigai. Vegetation is boreal coniferous forest (taiga) in the south and forest-tundra in the north. The climate is subarctic, with long, cold winters (-30 °C) and short, mild summers (+12 °C). The area is rich in diamond deposits, occurring in kimberlite pipes. Population density is extremely low, mainly Dolgans and Evenks.",
    },
    factsAdvanced: {
      de: ["Die maximale Höhe des Anabar-Plateaus beträgt etwa 905 m.", "Die Fläche wird auf rund 100.000 km² geschätzt.", "Die Durchschnittstemperatur im Januar beträgt -30 °C, im Juli +12 °C.", "Jährlich fallen 300–400 mm Niederschlag.", "Die Popigai-Meteoritenstruktur liegt im Nordosten des Plateaus.", "Die Diamantvorkommen werden seit den 1950er Jahren abgebaut."],
      hu: ["Az Anabar-fennsík legmagasabb pontja kb. 905 méter.", "Területe mintegy 100 000 km².", "A januári átlaghőmérséklet -30 °C, a júliusi +12 °C.", "Az éves csapadék 300-400 mm.", "A Popigaj-meteoritkráter a fennsík északkeleti részén található.", "A gyémántlelőhelyeket az 1950-es évek óta bányásszák."],
      ro: ["Altitudinea maximă a Podișului Anabar este de circa 905 m.", "Suprafața este estimată la aproximativ 100.000 km².", "Temperatura medie în ianuarie este de -30 °C, în iulie +12 °C.", "Precipitațiile anuale sunt de 300-400 mm.", "Structura de impact Popigai se află în nord-estul podișului.", "Zăcămintele de diamante sunt exploatate din anii 1950."],
      en: ["The maximum elevation of the Anabar Plateau is about 905 m.", "Its area is estimated at around 100,000 km².", "Mean January temperature is -30 °C, July +12 °C.", "Annual precipitation is 300–400 mm.", "The Popigai impact structure lies in the northeastern part of the plateau.", "Diamond deposits have been mined since the 1950s."],
    },
  },
  {
    ...
    coordinates: { lat: 65.0, lng: 115.0 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Das Wiljui-Plateau liegt im östlichen Sibirien, im Einzugsgebiet der Wiljui, einem Nebenfluss der Lena. Es erstreckt sich über etwa 1.000 km von Westen nach Osten und ist bis zu 500 km breit. Die Höhen liegen meist zwischen 300 und 700 m, mit maximalen Gipfeln um 900 m. Das Plateau besteht aus mesozoischen Sedimentgesteinen, vor allem Sandsteinen und Kalksteinen, die von Basaltdecken überlagert werden. Die Region ist reich an Kohle-, Erdöl- und Erdgasvorkommen. Die Vegetation ist borealer Nadelwald. Das Klima ist stark kontinental mit kalten Wintern (-35 °C) und warmen Sommern (+18 °C). Die Bevölkerungsdichte ist gering, die Wirtschaft basiert auf Bergbau und Forstwirtschaft.",
      hu: "A Viljuj-fennsík Kelet-Szibériában, a Viljuj folyó vízgyűjtőjében található, amely a Léna mellékfolyója. Nyugat-keleti irányban mintegy 1000 km, szélessége legfeljebb 500 km. A magasság általában 300-700 méter, a legmagasabb csúcsok elérik a 900 m-t. A fennsík mezozoos üledékes kőzetekből, főként homokkőből és mészkőből áll, amelyeket bazalttakarók fednek. A régió gazdag szén-, kőolaj- és földgázlelőhelyekben. A növényzet boreális tűlevelű erdő. Az éghajlat erősen kontinentális, hideg telekkel (-35 °C) és meleg nyarakkal (+18 °C). A népsűrűség alacsony, a gazdaság a bányászatra és erdőgazdálkodásra épül.",
      ro: "Podisul Vilyui se află în Siberia de Est, în bazinul râului Vilyui, un afluent al Lenei. Se întinde pe aproximativ 1.000 km de la vest la est și până la 500 km lățime. Altitudinile sunt în principal între 300 și 700 m, cu vârfuri maxime în jurul a 900 m. Podișul este format din roci sedimentare mezozoice, în principal gresii și calcare, acoperite de straturi de bazalt. Zona este bogată în zăcăminte de cărbune, petrol și gaze naturale. Vegetația este pădure boreală de conifere. Clima este puternic continentală, cu ierni reci (-35 °C) și veri calde (+18 °C). Densitatea populației este scăzută, economia bazându-se pe minerit și silvicultură.",
      en: "The Vilyuy Plateau is located in eastern Siberia, in the basin of the Vilyuy River, a tributary of the Lena. It extends about 1,000 km west-east and up to 500 km wide. Elevations are mostly between 300 and 700 m, with maximum peaks around 900 m. The plateau consists of Mesozoic sedimentary rocks, mainly sandstones and limestones, overlain by basalt sheets. The region is rich in coal, oil, and natural gas deposits. Vegetation is boreal coniferous forest. The climate is strongly continental, with cold winters (-35 °C) and warm summers (+18 °C). Population density is low, with an economy based on mining and forestry.",
    },
    factsAdvanced: {
      de: ["Das Wiljui-Plateau erstreckt sich über etwa 1.000 km in Ost-West-Richtung.", "Die maximale Breite beträgt 500 km.", "Die höchste Erhebung erreicht etwa 900 m.", "Das Gebiet enthält bedeutende Kohlevorkommen mit Reserven von über 50 Milliarden Tonnen.", "Die Durchschnittstemperatur im Januar beträgt -35 °C, im Juli +18 °C.", "Der Wiljui-Stausee hat eine Fläche von rund 2.170 km²."],
      hu: ["A Viljuj-fennsík kelet-nyugati irányban mintegy 1000 km hosszú.", "A maximális szélesség 500 km.", "A legmagasabb pont eléri a 900 m-t.", "A régió jelentős szénkészletekkel rendelkezik, amely meghaladja az 50 milliárd tonnát.", "A januári átlaghőmérséklet -35 °C, a júliusi +18 °C.", "A Viljuj-víztározó területe kb. 2 170 km²."],
      ro: ["Podisul Vilyui se întinde pe aproximativ 1.000 km est-vest.", "Lățimea maximă este de 500 km.", "Cel mai înalt punct atinge circa 900 m.", "Zona deține rezerve importante de cărbune, peste 50 de miliarde de tone.", "Temperatura medie în ianuarie este de -35 °C, în iulie +18 °C.", "Lacul de acumulare Vilyui are o suprafață de aproximativ 2.170 km²."],
      en: ["The Vilyuy Plateau extends about 1,000 km east-west.", "Maximum width is 500 km.", "The highest point reaches about 900 m.", "The area contains significant coal reserves, over 50 billion tonnes.", "Mean January temperature is -35 °C, July +18 °C.", "The Vilyuy Reservoir has an area of about 2,170 km²."],
    },
  },
  {
    ...
    coordinates: { lat: 56.5, lng: 116.0 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Das Witim-Gebirge ist eine Bergkette im südlichen Ostsibirien, die sich nordöstlich des Baikalsees erstreckt. Es verläuft etwa 400 km von Südwesten nach Nordosten. Die Gipfelhöhen liegen zwischen 1.000 und 1.600 m, der höchste Punkt ist der Gipfel Golets mit etwa 1.800 m. Das Gebirge besteht aus präkambrischen und paläozoischen Gesteinen, darunter Granite, Gneise und Schiefer. Es ist dicht von Taiga bewaldet. Die wichtigsten Flüsse sind der Witim und seine Quellflüsse. Das Klima ist extrem kontinental mit sehr kalten Wintern (-30 °C) und milden Sommern (+15 °C). Das Gebirge ist reich an Goldvorkommen, die seit dem 19. Jahrhundert abgebaut werden. Die Bevölkerungsdichte ist sehr gering.",
      hu: "A Vitim-hegység egy hegyvonulat Kelet-Szibéria déli részén, a Bajkál-tótól északkeletre. Hossza mintegy 400 km délnyugat-északkeleti irányban. A csúcsok magassága 1000 és 1600 méter között van, a legmagasabb pont a Golets-csúcs kb. 1800 m. A hegység prekambriumi és paleozoos kőzetekből, gránitból, gneiszből és palából áll. Sűrű tajga borítja. Legfontosabb folyói a Vitim és forrásfolyói. Az éghajlat szélsőségesen kontinentális, nagyon hideg telekkel (-30 °C) és enyhe nyarakkal (+15 °C). A hegység gazdag aranylelőhelyekben, amelyeket a 19. század óta bányásznak. A népsűrűség nagyon alacsony.",
      ro: "Munții Vitim sunt un lanț muntos în sudul Siberiei de Est, la nord-est de Lacul Baikal. Se întinde pe aproximativ 400 km de la sud-vest la nord-est. Înălțimile vârfurilor sunt între 1.000 și 1.600 m, punctul cel mai înalt fiind vârful Golets cu circa 1.800 m. Munții sunt formați din roci precambriene și paleozoice, inclusiv granit, gnais și șisturi. Sunt acoperiți de taiga deasă. Râurile principale sunt Vitim și afluenții săi superiori. Clima este extrem de continentală, cu ierni foarte reci (-30 °C) și veri blânde (+15 °C). Munții sunt bogați în zăcăminte de aur, exploatate încă din secolul al XIX-lea. Densitatea populației este foarte scăzută.",
      en: "The Vitim Range is a mountain range in southern East Siberia, northeast of Lake Baikal. It extends about 400 km from southwest to northeast. Peak elevations range from 1,000 to 1,600 m, with the highest point being Golets Peak at about 1,800 m. The range is composed of Precambrian and Paleozoic rocks, including granites, gneisses, and schists. It is densely forested with taiga. Major rivers include the Vitim and its headwaters. The climate is extremely continental, with very cold winters (-30 °C) and mild summers (+15 °C). The range is rich in gold deposits, mined since the 19th century. Population density is very low.",
    },
    factsAdvanced: {
      de: ["Das Witim-Gebirge erstreckt sich über etwa 400 km Länge.", "Der höchste Gipfel, Golets, erreicht etwa 1.800 m.", "Die durchschnittliche Höhe der Kämme beträgt etwa 1.200 m.", "Der Goldbergbau begann in den 1840er Jahren.", "Die jährliche Niederschlagsmenge beträgt 500–700 mm.", "Die Durchschnittstemperatur im Januar beträgt -30 °C, im Juli +15 °C."],
      hu: ["A Vitim-hegység hossza mintegy 400 km.", "A legmagasabb csúcs, a Golets, kb. 1800 méter.", "A gerincek átlagos magassága kb. 1200 méter.", "Az aranybányászat az 1840-es években kezdődött.", "Az éves csapadékmennyiség 500-700 mm.", "A januári átlaghőmérséklet -30 °C, a júliusi +15 °C."],
      ro: ["Munții Vitim au o lungime de aproximativ 400 km.", "Cel mai înalt vârf, Golets, atinge circa 1.800 m.", "Altitudinea medie a crestelor este de aproximativ 1.200 m.", "Exploatarea aurului a început în anii 1840.", "Precipitațiile anuale sunt de 500-700 mm.", "Temperatura medie în ianuarie este de -30 °C, în iulie +15 °C."],
      en: ["The Vitim Range extends about 400 km in length.", "The highest peak, Golets, reaches about 1,800 m.", "Average ridge elevation is about 1,200 m.", "Gold mining began in the 1840s.", "Annual precipitation is 500–700 mm.", "Mean January temperature is -30 °C, July +15 °C."],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Der Salair-Kamm ist ein niedriges Gebirge im Süden Westsibiriens, das sich über etwa 300 km von Nordosten nach Südwesten erstreckt. Die Gipfelhöhen liegen zwischen 400 und 600 m, mit einer maximalen Höhe von 621 m. Der Kamm besteht aus paläozoischen Gesteinen, darunter Kalksteine, Sandsteine und Schiefer. Die Region ist bekannt für ihre Erzvorkommen, insbesondere Eisen und Gold. Die Vegetation ist hauptsächlich Nadel- und Mischwald. Der Kamm trennt die Westsibirische Tiefebene vom Kusnezker Becken. Das Klima ist kontinental mit kalten Wintern (-17 °C) und warmen Sommern (+18 °C). Die Bevölkerungsdichte ist gering, die Wirtschaft basiert auf Bergbau und Holzwirtschaft.",
      hu: "A Szalair-hegység egy alacsony hegyvonulat Nyugat-Szibéria déli részén, amely mintegy 300 km hosszan húzódik északkelet-délnyugati irányban. A csúcsok magassága 400-600 méter, a legmagasabb pont 621 m. A hegység paleozoos kőzetekből, mészkőből, homokkőből és palából áll. A régió híres ércelőfordulásairól, különösen vasról és aranyról. A növényzet főként tű- és vegyes erdő. A hegység elválasztja a Nyugat-szibériai-alföldet a Kuznyecki-medencétől. Az éghajlat kontinentális, hideg telekkel (-17 °C) és meleg nyarakkal (+18 °C). A népsűrűség alacsony, a gazdaság a bányászatra és fakitermelésre épül.",
      ro: "Munții Salair sunt un lanț muntos joasă din sudul Siberiei de Vest, întinzându-se pe aproximativ 300 km de la nord-est la sud-vest. Înălțimile vârfurilor sunt între 400 și 600 m, cu un maxim de 621 m. Lanțul este compus din roci paleozoice, inclusiv calcare, gresii și șisturi. Zona este cunoscută pentru zăcămintele de minereuri, în special fier și aur. Vegetația este preponderent pădure de conifere și mixtă. Lanțul separă Câmpia Siberiei de Vest de Bazinul Kuznețk. Clima este continentală, cu ierni reci (-17 °C) și veri calde (+18 °C). Densitatea populației este scăzută, economia bazându-se pe minerit și exploatare forestieră.",
      en: "The Salair Range is a low mountain range in southern West Siberia, stretching about 300 km from northeast to southwest. Peak heights range from 400 to 600 m, with a maximum of 621 m. The range is composed of Paleozoic rocks, including limestones, sandstones, and shales. The region is known for its ore deposits, particularly iron and gold. Vegetation is mainly coniferous and mixed forest. The range separates the West Siberian Plain from the Kuznetsk Basin. The climate is continental, with cold winters (-17 °C) and warm summers (+18 °C). Population density is low, with an economy based on mining and timber.",
    },
    factsAdvanced: {
      de: ["Der Salair-Kamm erstreckt sich über etwa 300 km.", "Die maximale Höhe beträgt 621 m.", "Die durchschnittliche Höhe liegt bei 400–500 m.", "Die Eisenerzreserven werden auf 500 Millionen Tonnen geschätzt.", "Jährlich fallen 500–600 mm Niederschlag.", "Die Durchschnittstemperatur im Januar beträgt -17 °C, im Juli +18 °C."],
      hu: ["A Szalair-hegység hossza mintegy 300 km.", "A legmagasabb pont 621 m.", "Az átlagos magasság 400-500 méter.", "A vasérckészletet 500 millió tonnára becsülik.", "Az éves csapadék 500-600 mm.", "A januári átlaghőmérséklet -17 °C, a júliusi +18 °C."],
      ro: ["Munții Salair au o lungime de aproximativ 300 km.", "Altitudinea maximă este de 621 m.", "Altitudinea medie este de 400-500 m.", "Rezervele de minereu de fier sunt estimate la 500 de milioane de tone.", "Precipitațiile anuale sunt de 500-600 mm.", "Temperatura medie în ianuarie este de -17 °C, iar în iulie de +18 °C."],
      en: ["The Salair Range extends about 300 km.", "Maximum elevation is 621 m.", "Average elevation is 400–500 m.", "Iron ore reserves are estimated at 500 million tonnes.", "Annual precipitation is 500–600 mm.", "Mean January temperature is -17 °C, July +18 °C."],
    },
  },
  {
    ...
    coordinates: { lat: 63.0, lng: 150.0 },
    description: {
    ...
    descriptionAdvanced: {
      de: "Das Kolyma-Gebirge liegt im Nordosten Sibiriens und erstreckt sich über etwa 1.300 km von Nordwesten nach Südosten. Die Gipfelhöhen liegen zwischen 1.000 und 2.000 m, der höchste Punkt ist der Berg Gora Nevskaya mit etwa 2.400 m. Das Gebirge besteht aus mesozoischen und känozoischen Gesteinen, darunter Sandsteine, Schiefer und Vulkangestein. Die Vegetation variiert von Taiga im Süden bis zur Tundra im Norden. Das Klima ist subarktisch mit sehr kalten Wintern (-35 °C) und kurzen, kühlen Sommern (+10 °C). Die Region ist reich an Gold, Silber und Zinn, die seit den 1930er Jahren abgebaut werden. Der Bergbau hat die Landschaft stark geprägt, viele Siedlungen entstanden während des Gulag-Systems.",
      hu: "A Kolima-hegység Északkelet-Szibériában található, és mintegy 1300 km hosszan húzódik északnyugat-délkeleti irányban. A csúcsok magassága 1000 és 2000 méter között van, a legmagasabb pont a Gora Nevszkaja kb. 2400 m. A hegység mezozoos és kainozoos kőzetekből, homokkőből, palából és vulkáni kőzetekből áll. A növényzet déliben tajga, északon tundra. Az éghajlat szubarktikus, nagyon hideg telekkel (-35 °C) és rövid, hűvös nyarakkal (+10 °C). A régió gazdag aranyban, ezüstben és ónban, amelyeket az 1930-as évek óta bányásznak. A bányászat erősen átalakította a tájat, számos település a gulágrendszer idején jött létre.",
      ro: "Munții Kolâma se află în nord-estul Siberiei și se întind pe aproximativ 1.300 km de la nord-vest la sud-est. Înălțimile vârfurilor sunt între 1.000 și 2.000 m, punctul cel mai înalt fiind Muntele Gora Nevskaya cu circa 2.400 m. Munții sunt formați din roci mezozoice și cenozoice, inclusiv gresii, șisturi și roci vulcanice. Vegetația variază de la taiga în sud la tundră în nord. Clima este subarctică, cu ierni foarte reci (-35 °C) și veri scurte și reci (+10 °C). Regiunea este bogată în aur, argint și staniu, exploatate încă din anii 1930. Mineritul a transformat puternic peisajul, multe așezări apărând în timpul sistemului Gulag.",
      en: "The Kolyma Range is located in northeastern Siberia, stretching about 1,300 km from northwest to southeast. Peak elevations range from 1,000 to 2,000 m, with the highest point being Gora Nevskaya at about 2,400 m. The range consists of Mesozoic and Cenozoic rocks, including sandstones, shales, and volcanic rocks. Vegetation varies from taiga in the south to tundra in the north. The climate is subarctic, with very cold winters (-35 °C) and short, cool summers (+10 °C). The region is rich in gold, silver, and tin, mined since the 1930s. Mining has heavily transformed the landscape, with many settlements established during the Gulag system.",
    },
    factsAdvanced: {
      de: ["Das Kolyma-Gebirge erstreckt sich über etwa 1.300 km Länge.", "Der höchste Gipfel, Gora Nevskaya, erreicht rund 2.400 m.", "Die Breite des Gebirges beträgt bis zu 300 km.", "Die Goldproduktion in der Region betrug im 20. Jahrhundert mehrere tausend Tonnen.", "Die Durchschnittstemperatur im Januar beträgt -35 °C, im Juli +10 °C.", "Das Gebirge liegt in der Zeitzone Magadan (UTC+11)."],
      hu: ["A Kolima-hegység hossza mintegy 1300 km.", "A legmagasabb csúcs, a Gora Nevszkaja, kb. 2400 m.", "A hegység szélessége eléri a 300 km-t.", "A régió aranytermelése a 20. században több ezer tonna volt.", "A januári átlaghőmérséklet -35 °C, a júliusi +10 °C.", "A hegység a magadani időzónában fekszik (UTC+11)."],
      ro: ["Munții Kolâma au o lungime de aproximativ 1.300 km.", "Cel mai înalt vârf, Gora Nevskaya, atinge circa 2.400 m.", "Lățimea lanțului ajunge până la 300 km.", "Producția de aur în regiune a fost de câteva mii de tone în secolul XX.", "Temperatura medie în ianuarie este de -35 °C, în iulie +10 °C.", "Munții se află în fusul orar Magadan (UTC+11)."],
      en: ["The Kolyma Range extends about 1,300 km in length.", "The highest peak, Gora Nevskaya, reaches about 2,400 m.", "The width of the range is up to 300 km.", "Gold production in the region totaled several thousand tonnes in the 20th century.", "Mean January temperature is -35 °C, July +10 °C.", "The range lies in the Magadan time zone (UTC+11)."],
    },
  },
  {
    ...
    descriptionAdvanced: {
      de: "Das Turgai-Plateau liegt im Nordwesten Kasachstans und im Süden Russlands, zwischen dem Ural und dem Aralsee. Es ist eine flache Hochebene mit Höhen zwischen 200 und 400 m. Die Fläche beträgt etwa 300.000 km². Das Plateau besteht aus mesozoischen und känozoischen Sedimenten, die von Steppenvegetation bedeckt sind. Die wichtigsten Flüsse sind der Turgai und der Irgis. Das Klima ist kontinental mit heißen Sommern (+25 °C) und kalten Wintern (-15 °C). Die Landwirtschaft wird durch Trockenheit eingeschränkt, hauptsächlich wird extensive Viehzucht betrieben. Das Plateau ist reich an Bodenschätzen wie Bauxit und Phosphoriten. Die Bevölkerungsdichte ist gering.",
      hu: "A Turgai-fennsík Kazahsztán északnyugati részén és Oroszország déli részén, az Urál és az Aral-tó között található. Egy sík fennsík 200-400 méteres magassággal. Területe mintegy 300 000 km². A fennsík mezozoos és kainozoos üledékekből áll, amelyeket sztyeppei növényzet borít. A legfontosabb folyók a Turgai és az Irgiz. Az éghajlat kontinentális, forró nyarakkal (+25 °C) és hideg telekkel (-15 °C). A mezőgazdaságot korlátozza a szárazság, főként extenzív állattenyésztés folyik. A fennsík gazdag ásványkincsekben, például bauxitban és foszforitban. A népsűrűség alacsony.",
      ro: "Podisul Turgai se află în nord-vestul Kazahstanului și sudul Rusiei, între Munții Ural și Marea Aral. Este un platou neted cu altitudini între 200 și 400 m. Suprafața este de aproximativ 300.000 km². Platoul este format din sedimente mezozoice și cenozoice, acoperite de vegetație de stepă. Râurile principale sunt Turgai și Irgiz. Clima este continentală, cu veri fierbinți (+25 °C) și ierni reci (-15 °C). Agricultura este limitată de secetă, practicându-se în principal creșterea extensivă a animalelor. Platoul este bogat în resurse minerale, precum bauxit și fosforiți. Densitatea populației este scăzută.",
      en: "The Turgai Plateau is located in northwestern Kazakhstan and southern Russia, between the Urals and the Aral Sea. It is a flat highland with elevations between 200 and 400 m. The area is about 300,000 km². The plateau consists of Mesozoic and Cenozoic sediments, covered by steppe vegetation. Major rivers are the Turgai and Irgiz. The climate is continental, with hot summers (+25 °C) and cold winters (-15 °C). Agriculture is limited by aridity, mainly extensive livestock grazing. The plateau is rich in mineral resources such as bauxite and phosphorites. Population density is low.",
    },
    factsAdvanced: {
      de: ["Das Turgai-Plateau bedeckt eine Fläche von etwa 300.000 km².", "Die Höhen liegen zwischen 200 und 400 m.", "Der Turgai-Fluss ist etwa 800 km lang.", "Die jährliche Niederschlagsmenge beträgt 200–300 mm.", "Die Durchschnittstemperatur im Juli beträgt +25 °C, im Januar -15 °C.", "Die Phosphoritreserven werden auf 500 Millionen Tonnen geschätzt."],
      hu: ["A Turgai-fennsík területe mintegy 300 000 km².", "A magasság 200 és 400 méter között van.", "A Turgai folyó hossza kb. 800 km.", "Az éves csapadék 200-300 mm.", "A júliusi átlaghőmérséklet +25 °C, a januári -15 °C.", "A foszforitkészletet 500 millió tonnára becsülik."],
      ro: ["Podisul Turgai acoperă o suprafață de aproximativ 300.000 km².", "Altitudinile sunt între 200 și 400 m.", "Râul Turgai are aproximativ 800 km lungime.", "Precipitațiile anuale sunt de 200-300 mm.", "Temperatura medie în iulie este de +25 °C, iar în ianuarie de -15 °C.", "Rezervele de fosforiți sunt estimate la 500 de milioane de tone."],
      en: ["The Turgai Plateau covers about 300,000 km².", "Elevations range from 200 to 400 m.", "The Turgai River is about 800 km long.", "Annual precipitation is 200–300 mm.", "Mean July temperature is +25 °C, January -15 °C.", "Phosphorite reserves are estimated at 500 million tonnes."],
    },
  }
];
