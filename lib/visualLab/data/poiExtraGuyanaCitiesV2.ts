...
export const poiExtraGuyanaCitiesV2: POI[] = [ {
    ...
    descriptionAdvanced: {
      ...
      hu: "Georgetown Guyana fővárosa, amely az Atlanti-óceán partján, a Demerara folyó torkolatánál fekszik. A várost a gyarmati időkből származó, jellegzetes faépítészet és a modern kereskedelmi központok keveredése teszi különlegessé. A népszerű St. George-székesegyház a világ egyik legmagasabb fából épült temploma. A város élénk piacairól, színes utcáiról és barátságos lakóiról ismert. Georgetown igazi kulturális olvasztótégely, ahol az indiai, afrikai és európai hatások találkoznak.",
      ro: "Descoperiți farmecul unic al georgetown cities v2, o destinație ce îmbină istoria fascinantă cu peisajele naturale spectaculoase din inima Guyanei. Acest loc atrage vizitatorii prin atmosfera sa autentică și ospitalitatea caldă a comunității locale, oferind experiențe memorabile. Fiecare detaliu al acestui obiectiv reflectă bogăția culturală și evoluția istorică a regiunii, fiind un punct de reper pentru turiștii avizi de explorare. Dincolo de frumusețea sa vizuală, zona joacă un rol vital în dinamica socială și economică, invitând la momente de relaxare și descoperire profundă.",
    ...
    factsAdvanced: {
      ...
      hu: ["Guyana politikai, gazdasági és kulturális központja.", "A St. George-székesegyház a gótikus faépítészet remekműve.", "A város a Demerara-folyó és az Atlanti-óceán találkozásánál épült.", "Sokszínű etnikai összetétel jellemzi.", "A trópusi klíma egész évben meghatározza a városi életet."],
