...
export const poiExtraNicaraguaCitiesV2: POI[] = [
    ...
    }, image: "/poi-images/nueva-guinea-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["El Guasaule határátkelő", "Kereskedelmi központ", "Nagyon forró éghajlat", "Stratégiai elhelyezkedés"],
      ro: ["Punct de trecere a frontierei El Guasaule", "Centru comercial", "Climat foarte cald", "Poziție strategică"],
      en: ["El Guasaule border crossing", "Commercial hub", "Very hot climate", "Strategic location"]
    }
  },
  {
  ...
  // Adding 60 more cities to reach the 80 POI goal.
  {
    ...
    facts: {
      ...
      hu: ["Az 1972-es földrengés után jött létre", "Nagy népsűrűség", "Managua lakóövezete", "Kereskedelmi tevékenység"],
      ro: ["A apărut după cutremurul din 1972", "Densitate mare a populației", "Suburbie rezidențială a Managuei", "Activitate comercială"],
      en: ["Formed after the 1972 earthquake", "High population density", "Residential suburb of Managua", "Commercial activity"]
    }
  },
  {
    ...
    }, image: "/poi-images/sebaco-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Cukornád- és rizstermesztés", "Fontos állatpiac", "Ipari feldolgozás", "Stratégiai elhelyezkedés"],
      ro: ["Cultivarea trestiei de zahăr și a orezului", "Piață importantă de vite", "Procesare industrială", "Poziție strategică"],
      en: ["Cultivation of sugar cane and rice", "Important livestock market", "Industrial processing", "Strategic location"]
    }
  },
  {
    id: "jalapa-cities-v2",
    ...
    }, image: "/poi-images/altagracia-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Fontos folyami kikötő a régióban", "Kávé- és babtermesztés", "Határterület Jinotegával", "Nehéz megközelíthetőség"],
      ro: ["Port fluvial important pentru regiune", "Cultivarea cafelei și a fasolei", "Zonă de frontieră cu Jinotega", "Accesibilitate dificilă"],
      en: ["Important river port for the region", "Coffee and bean cultivation", "Border area with Jinotega", "Challenging accessibility"]
    }
  },
  {
    id: "waspam-cities-v2",
    ...
    facts: {
      ...
      hu: ["A miskito nemzet fővárosa", "A Coco-folyó partján", "Csónakkal elérhető Honduras", "Erős őslakos kultúra"],
      ro: ["Capitala națiunii Miskito", "Pe malurile râului Coco", "Conexiune cu Honduras cu barca", "Cultură indigenă puternică"],
      en: ["Capital of the Miskito nation", "On the banks of the Coco River", "Connection to Honduras by boat", "Strong indigenous culture"]
    }
  },
  {
    ...
    }, image: "/poi-images/siuna-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Bányászati történelem", "Miskito, mesztic és kreol kultúrák keveréke", "Erdőgazdálkodás", "Kapcsolat Siunával és Bonanzával"],
      ro: ["Istorie minieră", "Amestec de culturi Miskito, Mestizo și Creolă", "Silvicultură", "Conexiune cu Siuna și Bonanza"],
      en: ["Mining history", "Mix of Miskito, Mestizo, and Creole cultures", "Forestry", "Connection to Siuna and Bonanza"]
    }
  },
  {
    ...
    }, image: "/poi-images/san-isidro-matagalpa-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Állattenyésztés", "Stratégiai pihenőhely", "Vidéki központ", "Kereskedelem"],
      ro: ["Creșterea vitelor", "Popas strategic", "Centru rural", "Comerț"],
      en: ["Cattle ranching", "Strategic rest stop", "Rural center", "Commerce"]
    }
  },
  {
    ...
    }, image: "/poi-images/santo-tomas-chontales-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Állattenyésztés", "Tejtermelés", "Vidéki fejlődés", "Történelmi név"],
      ro: ["Creșterea vitelor", "Producția de lapte", "Dezvoltare rurală", "Nume istoric"],
      en: ["Cattle ranching", "Dairy production", "Rural development", "Historical name"]
    }
  },
  {
    ...
    facts: {
      ...
      hu: ["Gyarmati templom", "Régészeti leletek", "Állattenyésztés", "A tópart közelében"],
      ro: ["Biserică colonială", "Descoperiri arheologice", "Creșterea vitelor", "Aproape de malul lacului"],
      en: ["Colonial church", "Archaeological findings", "Cattle ranching", "Close to the lake shore"]
    }
  },
  {
    ...
    }, image: "/poi-images/el-tuma-la-dalia-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Fontos állatpiac", "Sajtgyártás", "Vidéki közösség", "Matiguás folyó"],
      ro: ["Piață importantă de vite", "Producția de brânză", "Comunitate rurală", "Râul Matiguás"],
      en: ["Important livestock market", "Cheese production", "Rural community", "Matiguás River"]
    }
  },
  {
    ...
    }, image: "/poi-images/san-ramon-matagalpa-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["A neve 'jó földet' jelent", "Bab- és kukoricatermesztés", "Állattenyésztés", "Száraz éghajlat"],
      ro: ["Numele înseamnă 'Pământ Bun'", "Cultivarea fasolei și a porumbului", "Creșterea vitelor", "Climat uscat"],
      en: ["The name means 'Good Land'", "Bean and corn cultivation", "Cattle ranching", "Dry climate"]
    }
  },
  {
    ...
    }, image: "/poi-images/san-fernando-nueva-segovia-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Történelmi ellenállási helyszín", "Kisüzemi aranybányászat", "Vidéki közösség", "Száraz éghajlat"],
      ro: ["Loc istoric de rezistență", "Minerit de aur la scară mică", "Comunitate rurală", "Climat uscat"],
      en: ["Historic site of resistance", "Small-scale gold mining", "Rural community", "Dry climate"]
    }
  },
  {
    ...
    facts: {
      ...
      hu: ["Miskito közösség", "Folyami szállítás", "Önellátó gazdálkodás", "Gazdag biodiverzitás"],
      ro: ["Comunitate Miskito", "Transport fluvial", "Agricultură de subzistență", "Biodiversitate bogată"],
      en: ["Miskito community", "River transport", "Subsistence farming", "Rich biodiversity"]
    }
  },
  {
    ...
    facts: {
      ...
      hu: ["Halász közösségek", "Változatos kultúrák (miszkító, kreol, mesztic)", "Csónakforgalom", "Mangroveerdők"],
      ro: ["Comunități pescărești", "Culturi diverse (Miskito, Creol, Mestizo)", "Trafic cu bărci", "Păduri de mangrove"],
      en: ["Fishing communities", "Diverse cultures (Miskito, Creole, Mestizo)", "Boat traffic", "Mangrove forests"]
    }
  },
  {
    ...
    }, image: "/poi-images/corn-island-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Állattenyésztés", "Mezőgazdasági település", "Folyami szállítás", "Gazdag természet"],
      ro: ["Creșterea vitelor", "Colonizare agricolă", "Transport fluvial", "Natură bogată"],
      en: ["Cattle ranching", "Agricultural settlement", "River transport", "Rich nature"]
    }
  },
  {
    ...
    }, image: "/poi-images/el-tortuguero-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Főváros: Bocana de Paiwas", "Állattenyésztés és mezőgazdaság", "Átmeneti zóna", "Grande de Matagalpa folyó"],
      ro: ["Capitala: Bocana de Paiwas", "Creșterea vitelor și agricultură", "Zonă de tranziție", "Râul Grande de Matagalpa"],
      en: ["Capital: Bocana de Paiwas", "Cattle ranching and agriculture", "Transition zone", "Grande de Matagalpa River"]
    }
  },
  {
    id: "morrito-rio-san-juan-cities-v2",
    type: "city",
    parent: "NI-SJ",
    coords: [-85.1, 11.55],
    ...
    }, image: "/poi-images/san-juan-de-rio-coco-madriz-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Nicaragua legmagasabb pontja", "Fenyőerdők", "'Nicaragua erkélye'", "Hűvös éghajlat"],
      ro: ["Cel mai înalt punct din Nicaragua", "Păduri de pini", "'Balconul Nicaraguei'", "Climat răcoros"],
      en: ["Highest point in Nicaragua", "Pine forests", "'Balcony of Nicaragua'", "Cool climate"]
    }
  },
  {
    id: "yalaguina-madriz-cities-v2",
    type: "city",
    parent: "NI-MD",
    coords: [-86.5, 13.5],
    ...
    facts: {
      ...
      hu: ["Rosquillas készítése", "Őslakos eredet", "Száraz éghajlat", "Mezőgazdaság"],
      ro: ["Producția de Rosquillas", "Origine indigenă", "Climat uscat", "Agricultură"],
      en: ["Production of rosquillas", "Indigenous origin", "Dry climate", "Agriculture"]
    }
  },
  {
    id: "totogalpa-madriz-cities-v2",
    type: "city",
    parent: "NI-MD",
    coords: [-86.43, 13.55],
    ...
    facts: {
      ...
      hu: ["Fenntartható projektek", "Őslakos kultúra", "Fazekasság", "Alternatív energiák"],
      ro: ["Proiecte durabile", "Cultură indigenă", "Olărit", "Energie alternativă"],
      en: ["Sustainable projects", "Indigenous culture", "Pottery", "Alternative energy"]
    }
  },
  {
    ...
    }, image: "/poi-images/la-libertad-chontales-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["Állattenyésztés", "Száraz éghajlat", "Hagyományos mezőgazdaság", "Történelmi sziklarajzok"],
      ro: ["Creșterea vitelor", "Climat uscat", "Agricultură tradițională", "Petroglife istorice"],
      en: ["Cattle ranching", "Dry climate", "Traditional agriculture", "Historic petroglyphs"]
    }
  },
  {
    id: "santa-lucia-boaco-cities-v2",
    type: "city",
    parent: "NI-BO",
    coords: [-85.71, 12.53],
    ...
    }, image: "/poi-images/santa-lucia-boaco-cities-v2.webp"},
  {
    ...
    facts: {
      ...
      hu: ["A 'sombrero fővárosa'", "Állatpiac", "Kézműves termelés", "Erős helyi kultúra"],
      ro: ["'Capitala sombrerourilor'", "Piață de vite", "Producție artizanală", "Cultură locală puternică"],
      en: ["'The Sombrero Capital'", "Cattle market", "Artisanal production", "Strong local culture"]
    }
  },
  {
    ...
    facts: {
      ...
      hu: ["Kávétermesztés", "Természetvédelmi területek", "Vízesések", "Ökoturizmus"],
      ro: ["Cultivarea cafelei", "Rezervații naturale", "Cascade", "Ecoturism"],
      en: ["Coffee cultivation", "Nature reserves", "Waterfalls", "Ecotourism"]
    }
  }
]
