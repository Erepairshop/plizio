...
export const ukraineCountry: POI = {
  ...
  factsAdvanced: {
    de: [
      "Die ukrainische Verfassung von 1710 gilt als eine der ältesten demokratischen Verfassungen der Welt.",
      "Die Ukraine ist ein Gründungsmitglied der Vereinten Nationen.",
      "Das Land verfügt über die drittgrößte Kohlenstoffvorkommen in Europa.",
      "Die traditionsreiche Stickkunst 'Wyschywanka' hat regionale Muster, die Geschichten erzählen.",
      "Das ukrainische Alphabet basiert auf dem kyrillischen System und umfasst 33 Buchstaben."
    ],
    hu: [
      "Az 1710-es ukrán alkotmány a világ egyik legrégebbi demokratikus alkotmányának számít.",
      "Ukrajna az Egyesült Nemzetek Szervezetének alapító tagja.",
      "Az ország rendelkezik Európa harmadik legnagyobb szénkészletével.",
      "A hagyományos 'Visivanka' hímzésminták regionális mintázatokkal bírnak, amelyek történeteket mesélnek el.",
      "Az ukrán ábécé a cirill rendszeren alapul és 33 betűből áll."
    ],
    ro: [
      "Constituția ucraineană din 1710 este considerată una dintre cele mai vechi constituții democratice din lume.",
      "Ucraina este membru fondator al Organizației Națiunilor Unite.",
      "Țara deține a treia cea mai mare rezervă de cărbune din Europa.",
      "Arta tradițională a broderiei 'Vișivanka' are modele regionale care spun povești.",
      "Alfabetul ucrainean se bazează pe sistemul chirilic și cuprinde 33 de litere."
    ],
    en: [
      "The Ukrainian constitution of 1710 is considered one of the oldest democratic constitutions in the world.",
      "Ukraine is a founding member of the United Nations.",
      "The country holds the third-largest coal reserves in Europe.",
      "The traditional embroidery art 'Vyshyvanka' features regional patterns that tell stories.",
      "The Ukrainian alphabet is based on the Cyrillic system and contains 33 letters."
    ]
  },
