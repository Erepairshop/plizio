...
export const poiExtraHondurasLifeV2: POI[] = [
  {
    id: "la-tigra-national-park-life-v2",
    type: "forest",
    parent: "HN",
    coords: [-87.15, 14.15],
    ...
    description: {
      ...
      ro: "Un parc de padure de ceata aproape de Tegucigalpa.",
      en: "A cool cloud forest park near Tegucigalpa."
    },
    facts: {
      de: ["Beliebtes Wanderziel.", "Schutzt wichtige Wasserquellen.", "Nahe der Hauptstadt."],
    ...
    descriptionAdvanced: {
      de: "La Tigra liegt als k?hler Nebelwald ?stlich von Tegucigalpa und wirkt eher wie ein Wasserreservoir mit Wegen als wie ein klassischer Ausflugspunkt. Zwischen Moosen, Farnen und dichten Baumkronen sieht man, wie wichtig das Schutzgebiet f?r die Trinkwasserversorgung der Hauptstadt ist. Wer hier geht, erlebt Höhenluft, steile Pfade und ein Waldst?ck, das in wenigen Stunden von Stadtl?rm zu Vogelrufe wechselt. F?r den Plizio-Lehrplan passt das zu Geografie K7: Schutzgebiete und Wassereinzugsgebiete.",
      ...
      ro: "Parcul National La Tigra este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc de padure de ceata aproape de Tegucigalpa. În același timp destinatie populara de drumetie. Pe lângă acestea protejeaza izvoare de apa. În zonă aproape de capitala. Astfel, Parcul National La Tigra se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "La Tigra National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A cool cloud forest park near Tegucigalpa. At the same time popular hiking area. In addition protects key water sources. In the surrounding area close to the capital. In this way, La Tigra National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O zona protejata de padure montana la sud de capitala.",
      en: "A mountainous forest reserve south of the capital."
    },
    facts: {
      de: ["Nebelwald und Pinien.", "Wichtiger Wasserspeicher.", "Beliebt bei Forschern."],
    ...
    descriptionAdvanced: {
      de: "Die Uyuca-Reserve ist kleiner und wissenschaftlicher als viele andere Parks in Honduras, doch gerade das macht sie spannend. Auf dem Bergkamm wachsen feuchte Waldreste, die Forscher und Studierende seit Jahren wegen ihrer Pflanzenvielfalt beobachten. Der Ort liegt nahe der Hauptstadtregion, bleibt aber deutlich ruhiger als La Tigra. Wer genau hinsieht, merkt schnell, dass hier nicht die große Aussicht, sondern Bodenfeuchte, Baumarten und Mikroklima die eigentliche Geschichte erz?hlen. F?r den Plizio-Lehrplan passt das zu Biologie K6: Lebensräume und Anpassungen.",
      ...
      ro: "Rezervatia biologica Uyuca este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O zona protejata de padure montana la sud de capitala. În același timp padure de ceata si pini. Pe lângă acestea rezervor important de apa. În zonă populara printre cercetatori. Astfel, Rezervatia biologica Uyuca se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Uyuca Biological Reserve is a notable location in Honduras that reflects the country's geographic and cultural diversity. A mountainous forest reserve south of the capital. At the same time cloud forest and pine woods. In addition important water reservoir. In the surrounding area popular with researchers. In this way, Uyuca Biological Reserve fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un parc montan popular deasupra Lacului Yojoa.",
      en: "A popular mountain park above Lake Yojoa."
    },
    facts: {
      de: ["Kuehle Luft und Aussicht.", "Wandern und Vogelbeobachtung.", "Teil des Nationalparks."],
    ...
    descriptionAdvanced: {
      de: "Cerro Azul Me?mbar verbindet Bergwald und Blick auf den Lago de Yojoa, und genau dieser ?bergang macht den Park so lesenswert. Auf den H?ngen wechseln Kiefern, feuchte Waldst?cke und offene Stellen, die das Klima der Cordillera sichtbar machen. Der Park wirkt wie ein Lehrbuch f?r Höhenstufen: unten warmere Luft, oben dichter Wald und dazu der See als klimatischer Gegenpol. F?r den Plizio-Lehrplan passt das zu Geografie K7: Relieftypen und Höhenstufen.",
      ...
      ro: "Cerro Azul Meambar este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc montan popular deasupra Lacului Yojoa. În același timp aer racoros si privelisti. Pe lângă acestea drumetii si birdwatching. În zonă parte din parc national. Astfel, Cerro Azul Meambar se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Cerro Azul Meambar is a notable location in Honduras that reflects the country's geographic and cultural diversity. A popular mountain park above Lake Yojoa. At the same time cool air and views. In addition hiking and birdwatching. In the surrounding area part of a national park. In this way, Cerro Azul Meambar fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Cea mai importanta zona de padure de ceata din vestul Hondurasului.",
      en: "Honduras's key cloud forest area in the west."
    },
    facts: {
      de: ["Sehr artenreich.", "Quellgebiet vieler Flusse.", "Hohe Gipfel und tiefe Schluchten."],
    ...
    descriptionAdvanced: {
      de: "Celaque ist der Park der h?chsten Berge des Landes, und schon deshalb hat er in Honduras einen besonderen Rang. Das Gelände steigt schnell an, die Wege werden rau, und die Wolken h?ngen oft tief ?ber dem Wald. Hier geht es weniger um schnellen Durchgang als um Ausdauer, Orientierung und den Respekt vor einem Gebirge, das Wasser speichert und ganze T?ler beeinflusst. F?r den Plizio-Lehrplan passt das zu Geografie K7: Gebirge, Klima und Wasserspeicher.",
      ...
      ro: "Parcul National Celaque este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Cea mai importanta zona de padure de ceata din vestul Hondurasului. În același timp foarte bogat in specii. Pe lângă acestea sursa pentru multe rauri. În zonă varfuri inalte si vai adanci. Astfel, Parcul National Celaque se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Celaque National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. Honduras's key cloud forest area in the west. At the same time very species-rich. In addition source of many rivers. In the surrounding area high peaks and deep valleys. In this way, Celaque National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O padure montana racoroasa in muntii Cortes.",
      en: "A cool mountain forest in the hills of Cortes."
    },
    facts: {
      de: ["Viele endemische Arten.", "Beliebt bei Biologen.", "Dichter Wolkenwald."],
    ...
    descriptionAdvanced: {
      de: "Cusuco liegt im Nordwesten des Landes und steht f?r hochgelegenes, feuchtes Bergland mit einer bemerkenswerten Tierwelt. Der Weg in den Park führt durch Zonen, in denen der Wald dicht, dunkel und von Nebel durchzogen ist. Gerade die Mischung aus schwer zugänglichen H?ngen, Orchideen, Amphibien und seltenen V?geln macht den Ort f?r Naturbeobachtung interessant. F?r den Plizio-Lehrplan passt das zu Biologie K7: Artenvielfalt und Schutzgebiete.",
      ...
      ro: "Parcul National Cusuco este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O padure montana racoroasa in muntii Cortes. În același timp multe specii endemice. Pe lângă acestea popular printre biologi. În zonă padure de ceata deasa. Astfel, Parcul National Cusuco se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Cusuco National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A cool mountain forest in the hills of Cortes. At the same time many endemic species. In addition popular with biologists. In the surrounding area dense cloud forest. In this way, Cusuco National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O mare padure tropicala si de ceata aproape de La Ceiba.",
      en: "A large rainforest and cloud forest near La Ceiba."
    },
    facts: {
      de: ["Beliebt zum Wandern.", "Reiche Vogelwelt.", "Kombiniert Berge und Flusse."],
    ...
    descriptionAdvanced: {
      de: "Pico Bonito ist ein Park, in dem sich die steilen Berge direkt ?ber den Flachlandz?gen der Karibikküste erheben. Das Gelände ist wild, wasserreich und von Flüssen durchschnitten, die aus den Höhen in Richtung Küste laufen. Wer den Park besucht, sieht schnell, dass hier Regenwald, Bergwald und Flusslandschaften eng miteinander verflochten sind. F?r den Plizio-Lehrplan passt das zu Geografie K7: Wasserläufe, Relief und Regenwald.",
      ...
      ro: "Parcul National Pico Bonito este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O mare padure tropicala si de ceata aproape de La Ceiba. În același timp popular pentru drumetii. Pe lângă acestea fauna de pasari bogata. În zonă imbina munti si rauri. Astfel, Parcul National Pico Bonito se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Pico Bonito National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A large rainforest and cloud forest near La Ceiba. At the same time popular for hiking. In addition rich birdlife. In the surrounding area combines mountains and rivers. In this way, Pico Bonito National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O gradina tropicala uriasa langa Tela.",
      en: "A vast tropical garden near Tela."
    },
    facts: {
      de: ["Beruhmt fur Palmen.", "Wichtiger Lernort.", "Sehr artenreiche Pflanzenwelt."],
    ...
    descriptionAdvanced: {
      de: "Lancetilla ist kein typischer Wildpark, sondern ein botanisches Arbeitsfeld mit langen Wegen, Sammlungen und alten Pflanzungen nahe Tela. Der Garten zeigt, wie international Pflanzenforschung in Honduras geworden ist: Palmen, Tropenb?ume und Versuchsflächen stehen neben schattigen Abschnitten, in denen man sehr langsam gehen muss, um etwas zu sehen. F?r den Plizio-Lehrplan passt das zu Biologie K6: Pflanzenvielfalt und botanische Sammlungen.",
      ...
      ro: "Gradina botanica Lancetilla este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O gradina tropicala uriasa langa Tela. În același timp faimos pentru palmieri. Pe lângă acestea loc important de invatare. În zonă flora foarte bogata. Astfel, Gradina botanica Lancetilla se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Lancetilla Botanical Garden is a notable location in Honduras that reflects the country's geographic and cultural diversity. A vast tropical garden near Tela. At the same time famous for palms. In addition important learning site. In the surrounding area very rich plant life. In this way, Lancetilla Botanical Garden fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un parc de coasta cu mangrove, lagune si padure de plaja.",
      en: "A coastal park with mangroves, lagoons, and beach forest."
    },
    facts: {
      de: ["Nahe Tela gelegen.", "Wichtig fur Vogel.", "Schutzt Kuestenlebensraume."],
    ...
    descriptionAdvanced: {
      de: "Der Jeannette-Kawas-Park verbindet Mangroven, Lagunen und Küstenräume an der Karibik. Auf engem Raum wechseln Wasserflächen, Küstenwald und offene Ufer, sodass der Besuch eher wie ein Wechsel der Lebensräume als wie ein Spaziergang wirkt. Der Name erinnert an die Umweltschützerin Jeannette Kawas und gibt dem Ort eine politische wie ?kologische Dimension. F?r den Plizio-Lehrplan passt das zu Geografie K7: Küsten?kosysteme und Naturschutz.",
      ...
      ro: "Parcul National Jeannette Kawas este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc de coasta cu mangrove, lagune si padure de plaja. În același timp aproape de tela. Pe lângă acestea important pentru pasari. În zonă protejeaza habitatele de coasta. Astfel, Parcul National Jeannette Kawas se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Jeannette Kawas National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A coastal park with mangroves, lagoons, and beach forest. At the same time near tela. In addition important for birds. In the surrounding area protects coastal habitats. In this way, Jeannette Kawas National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O zona de coasta protejata intre mare si mangrove.",
      en: "A protected coastal area between sea and mangroves."
    },
    facts: {
      de: ["Bootstouren sind beliebt.", "Reich an Wasservogeln.", "Teil der Karibikkueste."],
    ...
    descriptionAdvanced: {
      de: "Punta Izopo zeigt die Karibikküste mit Mangrovenkan?len, Sandflächen und einem dichten G?rtel aus feuchtem Wald. Das Gebiet ist vom Wasser geprägt, und genau dadurch wird die Tierwelt reich: V?gel, Fische und Reptilien teilen sich denselben Raum, nur auf unterschiedlichen Ebenen. Wer dort unterwegs ist, merkt, dass Küstenschutz in Honduras nicht abstrakt ist, sondern direkt mit Uferlinien und ?berschwemmungszonen zu tun hat. F?r den Plizio-Lehrplan passt das zu Geografie K7: Küstenschutz und Mangroven.",
      ...
      ro: "Parcul National Punta Izopo este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O zona de coasta protejata intre mare si mangrove. În același timp tururile cu barca sunt populare. Pe lângă acestea bogata in pasari de apa. În zonă parte din coasta caraibiana. Astfel, Parcul National Punta Izopo se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Punta Izopo National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A protected coastal area between sea and mangroves. At the same time boat tours are popular. In addition rich in waterbirds. In the surrounding area part of the caribbean coast. In this way, Punta Izopo National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O zona umeda cu mangrove si canale pe coasta de nord.",
      en: "A wetland with mangroves and canals on the north coast."
    },
    facts: {
      de: ["Wichtig fur Manatis.", "Bootsfahrt durch Kanale.", "Sehr ruhige Naturzone."],
    ...
    descriptionAdvanced: {
      de: "Cuero y Salado ist ein Feuchtgebiet aus Kan?len, Mangroven und S??wasserzonen, das man oft besser per kleiner Bahn oder Boot als zu Fu? versteht. Der Ort gehört zu den klassischsten Naturräumen an der Nordküste, weil hier Wasserwege die Bewegung bestimmen und nicht umgekehrt. Besonders stark ist der Kontrast zwischen ruhigen Kan?len und dem dichten Pflanzenwuchs am Rand. F?r den Plizio-Lehrplan passt das zu Geografie K6: Feuchtgebiete und Flussm?ndungen.",
      ...
      ro: "Rezervatia salbatica Cuero y Salado este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O zona umeda cu mangrove si canale pe coasta de nord. În același timp important pentru lamantini. Pe lângă acestea plimbare cu barca pe canale. În zonă zona naturala foarte linistita. Astfel, Rezervatia salbatica Cuero y Salado se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Cuero y Salado Wildlife Refuge is a notable location in Honduras that reflects the country's geographic and cultural diversity. A wetland with mangroves and canals on the north coast. At the same time important for manatees. In addition boat rides through canals. In the surrounding area very quiet nature zone. In this way, Cuero y Salado Wildlife Refuge fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O zona protejata de insule si recife in largul coastei de nord.",
      en: "A protected island and reef area off the north coast."
    },
    facts: {
      de: ["Bekannt fur Korallen.", "Kleine Inseln und klares Wasser.", "Beliebt bei Schnorchlern."],
    ...
    descriptionAdvanced: {
      de: "Cayos Cochinos ist ein Schutzgebiet aus kleinen Inseln und Riffen, in dem das Meer selbst das wichtigste Landschaftselement bleibt. Das Wasser ist hier nicht nur Kulisse, sondern Lebensraum, Transportweg und Schutzraum zugleich. Wer das Reservat besucht, erlebt eine sehr klare Trennung zwischen Land und Wasser, aber auch eine enge ?kologische Verbindung durch Korallen, Seegras und Fischschw?rme. F?r den Plizio-Lehrplan passt das zu Biologie K7: Meeres?kosysteme und Inselräume.",
      ...
      ro: "Rezervatia marina Cayos Cochinos este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O zona protejata de insule si recife in largul coastei de nord. În același timp cunoscuta pentru corali. Pe lângă acestea insule mici si apa limpede. În zonă populara pentru snorkeling. Astfel, Rezervatia marina Cayos Cochinos se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Cayos Cochinos Marine Reserve is a notable location in Honduras that reflects the country's geographic and cultural diversity. A protected island and reef area off the north coast. At the same time known for coral reefs. In addition small islands and clear water. In the surrounding area popular with snorkelers. In this way, Cayos Cochinos Marine Reserve fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un mic centru marin axat pe conservare si educatie.",
      en: "A small marine center focused on conservation and education."
    },
    facts: {
      de: ["Informiert uber Rifftiere.", "Gut fur Familien.", "Nahe an der West Bay."],
    ...
    descriptionAdvanced: {
      de: "Das Roat?n Marine Science Center ist stärker Lernort als Postkartenmotiv. Hier geht es um Meeresbiologie, Rettung von Tieren und den Alltag eines Forschungs- und Bildungsstandorts auf einer Insel, die selbst vom Tourismus lebt. Besucher sehen, wie eng Schutzarbeit, Aufkl?rung und lokale Wirtschaft miteinander verknüpft sind. Gerade f?r Kinder und Schulgruppen ist das ein guter Ort, um das Karibikmeer nicht nur zu bestaunen, sondern zu verstehen. F?r den Plizio-Lehrplan passt das zu Biologie K6: Meerestiere und Naturschutz.",
      ...
      ro: "Centrul de stiinte marine Roatan este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un mic centru marin axat pe conservare si educatie. În același timp ofera informatii despre vietuitoarele recifului. Pe lângă acestea bun pentru familii. În zonă aproape de west bay. Astfel, Centrul de stiinte marine Roatan se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Roatan Marine Science Center is a notable location in Honduras that reflects the country's geographic and cultural diversity. A small marine center focused on conservation and education. At the same time teaches about reef animals. In addition good for families. In the surrounding area near west bay. In this way, Roatan Marine Science Center fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un parc din Roatan cunoscut pentru iguane si testoase.",
      en: "A Roatan park known for iguanas and turtles."
    },
    facts: {
      de: ["Tierbegegnungen fur Besucher.", "Kurze Wege und viel Schatten.", "Beliebt bei Kindern."],
    ...
    descriptionAdvanced: {
      de: "Arch's Iguana and Marine Park kombiniert Reptilienpflege mit Küstenbezug und ist damit typisch f?r die kleinere, direkte Naturschutzarbeit auf Roat?n. Der Park ist vor allem f?r seine Leguane bekannt, doch der maritime Bezug zeigt, dass Insel?kologie immer mehrere Ebenen hat: Landtiere, Uferzonen und das Meer sind hier keine getrennten Welten. F?r den Plizio-Lehrplan passt das zu Biologie K5: Tiere, Lebensräume und Schutz.",
      ...
      ro: "Arch's Iguana and Marine Park este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc din Roatan cunoscut pentru iguane si testoase. În același timp interactiuni cu animale. Pe lângă acestea trasee scurte si multa umbra. În zonă popular pentru copii. Astfel, Arch's Iguana and Marine Park se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Arch's Iguana and Marine Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A Roatan park known for iguanas and turtles. At the same time close animal encounters. In addition short paths and plenty of shade. In the surrounding area popular with children. In this way, Arch's Iguana and Marine Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un refugiu cunoscut in Roatan pentru lenesi si maimute.",
      en: "A well-known animal refuge in Roatan with sloths and monkeys."
    },
    facts: {
      de: ["Eher klein und familienfreundlich.", "Naher Kontakt zu Tieren.", "Wichtig fur Bildung."],
    ...
    descriptionAdvanced: {
      de: "Daniel Johnson's Sloth and Monkey Hangout ist einer der Orte auf Roat?n, an denen Besucher Tiere sehr nah erleben, ohne den Bildungsaspekt zu verlieren. Faultiere und Affen sind hier die Stars, aber die eigentliche Aufgabe liegt in Erklärung, Pflege und respektvollem Umgang mit Wildtieren. Der Ort zeigt auch, wie stark Honduras im Naturtourismus auf kleine, spezialisierte Einrichtungen setzt. F?r den Plizio-Lehrplan passt das zu Biologie K3: Tiere beobachten und Verhalten verstehen.",
      ...
      ro: "Daniel Johnson Sloth and Monkey Hangout este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un refugiu cunoscut in Roatan pentru lenesi si maimute. În același timp mic si potrivit pentru familii. Pe lângă acestea contact apropiat cu animalele. În zonă important pentru educatie. Astfel, Daniel Johnson Sloth and Monkey Hangout se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Daniel Johnson Sloth and Monkey Hangout is a notable location in Honduras that reflects the country's geographic and cultural diversity. A well-known animal refuge in Roatan with sloths and monkeys. At the same time small and family-friendly. In addition close contact with animals. In the surrounding area important for education. In this way, Daniel Johnson Sloth and Monkey Hangout fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un proiect de protectie pentru iguane in Copan Ruinas.",
      en: "A conservation project for iguanas in Copan Ruinas."
    },
    facts: {
      de: ["Schutzt Reptilien.", "Beliebt bei Schulgruppen.", "Nahe den Maya-Ruinen."],
    ...
    descriptionAdvanced: {
      de: "Die Iguana Research and Breeding Station in Cop?n ist ein kleiner, aber wichtiger Baustein des Artenschutzes. Hier geht es nicht um große Flächen, sondern um gezielte Zucht, Beobachtung und Aufkl?rung rund um Leguane und andere Reptilien. Der Ort passt gut zu einer Stadt wie Cop?n Ruinas, in der Archäologie und Naturtourismus nebeneinander stehen. F?r den Plizio-Lehrplan passt das zu Biologie K6: Reptilien und Schutzprogramme.",
      ...
      ro: "Centrul de cercetare a iguanelor Copan este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un proiect de protectie pentru iguane in Copan Ruinas. În același timp protejeaza reptilele. Pe lângă acestea popular printre grupurile scolare. În zonă aproape de ruinele maya. Astfel, Centrul de cercetare a iguanelor Copan se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Iguana Research Station Copan is a notable location in Honduras that reflects the country's geographic and cultural diversity. A conservation project for iguanas in Copan Ruinas. At the same time protects reptiles. In addition popular with school groups. In the surrounding area near the maya ruins. In this way, Iguana Research Station Copan fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un parc de excursie deasupra Tegucigalpei, cu zoo si privelisti.",
      en: "A day-trip park above Tegucigalpa with a zoo and views."
    },
    facts: {
      de: ["Beliebt am Wochenende.", "Grosses Stadtpanorama.", "Familienfreundliche Wege."],
    ...
    descriptionAdvanced: {
      de: "El Picacho ?berragt Tegucigalpa und ist einer der Orte, an denen Stadt und Berg direkt ineinander greifen. Der Weg hinauf führt aus dem Verkehrsraum in eine höhere, k?hlere Zone mit Aussicht, Skulpturen und Freizeitflächen. Gerade dieser Wechsel macht den Park f?r Familien und Besucher interessant: Er ist Stadtpark, Aussichtspunkt und Naherholungsraum zugleich. F?r den Plizio-Lehrplan passt das zu Geografie K5: Stadtlandschaft und Relief.",
      ...
      ro: "Parcul El Picacho este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc de excursie deasupra Tegucigalpei, cu zoo si privelisti. În același timp popular in weekend. Pe lângă acestea panorama mare asupra orasului. În zonă trasee potrivite pentru familii. Astfel, Parcul El Picacho se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "El Picacho Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A day-trip park above Tegucigalpa with a zoo and views. At the same time popular on weekends. In addition wide city panorama. In the surrounding area family-friendly paths. In this way, El Picacho Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un muzeu interactiv pentru copii in Tegucigalpa.",
      en: "An interactive children's museum in Tegucigalpa."
    },
    facts: {
      de: ["Lernen durch Spiel.", "Beliebt bei Schulklassen.", "Innenattraktion bei jedem Wetter."],
    ...
    descriptionAdvanced: {
      de: "Chiminike ist kein Naturpark, sondern ein Lernort f?r Kinder in Tegucigalpa, der Wissenschaft, Alltag und Entdecken miteinander verbindet. Die Räume sind so gebaut, dass Fragen wichtiger sind als reine Information: anfassen, ausprobieren, vergleichen. Genau deshalb funktioniert Chiminike gut als Gegenpol zu klassischen Museen, weil die Inhalte spielerisch und gleichzeitig klar strukturiert sind. F?r den Plizio-Lehrplan passt das zu Sachkunde K3: Forschen und Wahrnehmen.",
      ...
      ro: "Chiminike este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un muzeu interactiv pentru copii in Tegucigalpa. În același timp invatare prin joc. Pe lângă acestea popular printre clasele scolare. În zonă atractie indoor in orice vreme. Astfel, Chiminike se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Chiminike is a notable location in Honduras that reflects the country's geographic and cultural diversity. An interactive children's museum in Tegucigalpa. At the same time learning through play. In addition popular with school classes. In the surrounding area indoor attraction in any weather. In this way, Chiminike fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Cea mai importanta piata din centrul vechi al Tegucigalpei.",
      en: "The main square of Tegucigalpa's historic center."
    },
    facts: {
      de: ["Treffpunkt im Zentrum.", "Umgeben von Kolonialbauten.", "Lebendiger Stadtraum."],
    ...
    descriptionAdvanced: {
      de: "Der zentrale Park von Tegucigalpa ist weniger ein großer Naturraum als ein städtischer Treffpunkt mit Funktion. Er ordnet die Innenstadt, bringt Wege zusammen und steht in direkter Beziehung zu Kirche, Rathaus und Alltagsverkehr. Wer dort sitzt oder durchgeht, sieht die Hauptstadt nicht als abstraktes Verwaltungszentrum, sondern als lebendigen Ort mit Märkten, Schatten, B?nken und kurzen Wegen. F?r den Plizio-Lehrplan passt das zu Geografie K4: Stadtzentrum und ?ffentliche Räume.",
      ...
      ro: "Parcul central Tegucigalpa este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Cea mai importanta piata din centrul vechi al Tegucigalpei. În același timp punct de intalnire central. Pe lângă acestea inconjurat de cladiri coloniale. În zonă spatiu urban animat. Astfel, Parcul central Tegucigalpa se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Tegucigalpa Central Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. The main square of Tegucigalpa's historic center. At the same time central meeting point. In addition surrounded by colonial buildings. In the surrounding area lively urban space. In this way, Tegucigalpa Central Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un parc urban popular cu vedere spre Tegucigalpa.",
      en: "A popular city park with views over Tegucigalpa."
    },
    facts: {
      de: ["Kurze Spazierwege.", "Gut fur Picknicks.", "Bekannte Aussichtspunkte."],
    ...
    descriptionAdvanced: {
      de: "Cerro Juana La?nez ist ein Stadth?gel, der Tegucigalpa ?berblickt und zugleich eine grüne Pause im dichten Stadtgewebe bietet. Die H?nge machen sichtbar, wie stark die Hauptstadt topografisch geprägt ist: Straßen, Treppen und Aussichtspunkte reagieren direkt auf den Berg. Als Park ist der Ort interessant, weil er Freizeit, Natur und Urbanit?t an einem einzigen Hang zusammenzieht. F?r den Plizio-Lehrplan passt das zu Geografie K5: Stadt und H?gellandschaft.",
      ...
      ro: "Parcul Cerro Juana Lainez este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc urban popular cu vedere spre Tegucigalpa. În același timp trasee scurte. Pe lângă acestea bun pentru picnic. În zonă puncte de belvedere cunoscute. Astfel, Parcul Cerro Juana Lainez se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Cerro Juana Lainez Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A popular city park with views over Tegucigalpa. At the same time short walking paths. In addition good for picnics. In the surrounding area known viewpoints. In this way, Cerro Juana Lainez Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O gradina zoologica prietenoasa pentru familii in orasul industrial.",
      en: "A family-friendly zoo in the industrial city."
    },
    facts: {
      de: ["Beliebt bei Kindern.", "Stadtnahe Lage.", "Tierbeobachtung ohne lange Fahrt."],
    ...
    descriptionAdvanced: {
      de: "Der Zoo von San Pedro Sula ist ein urbaner Lernort, an dem Familien Tiere in einem klaren, leicht erreichbaren Rahmen sehen k?nnen. In einer Stadt, die industriell und gesch?ftig ist, bietet der Zoo einen Gegenpol aus Beobachtung, Ruhe und p?dagogischem Blick. Wichtig ist dabei weniger Spektakel als N?he zu Arten, die Kinder sonst nur aus B?chern kennen. F?r den Plizio-Lehrplan passt das zu Biologie K3: Tiere und Lebensräume in der Stadt.",
      ...
      ro: "Gradina zoologica San Pedro Sula este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O gradina zoologica prietenoasa pentru familii in orasul industrial. În același timp popular pentru copii. Pe lângă acestea locatie aproape de oras. În zonă observarea animalelor fara drum lung. Astfel, Gradina zoologica San Pedro Sula se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "San Pedro Sula Zoo is a notable location in Honduras that reflects the country's geographic and cultural diversity. A family-friendly zoo in the industrial city. At the same time popular with children. In addition close to the city center. In the surrounding area animal viewing without a long trip. In this way, San Pedro Sula Zoo fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Cel mai mare lac din Honduras, cu viata de pasari bogata.",
      en: "Honduras's largest lake with rich birdlife."
    },
    facts: {
      de: ["Top-Ort fur Vogelbeobachtung.", "Beliebt bei Wochenendausfluegen.", "Umgeben von Bergen."],
    ...
    descriptionAdvanced: {
      de: "Der Lago de Yojoa ist der bekannteste Binnensee des Landes und gleichzeitig ein Knotenpunkt zwischen Bergen, Feuchtgebieten und Fischerei. Seine Ufer zeigen, wie stark Wasser Landschaft, Wirtschaft und Freizeit prägt. Rund um den See liegen D?rfer, Restaurants, Reservate und Vogelräume nebeneinander, sodass der Ort mehr ist als nur ein sch?nes Panorama. F?r den Plizio-Lehrplan passt das zu Geografie K7: Seen, Nutzung und ?kosysteme.",
      ...
      ro: "Lacul Yojoa este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Cel mai mare lac din Honduras, cu viata de pasari bogata. În același timp loc de top pentru birdwatching. Pe lângă acestea popular pentru excursii de weekend. În zonă inconjurat de munti. Astfel, Lacul Yojoa se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Lake Yojoa is a notable location in Honduras that reflects the country's geographic and cultural diversity. Honduras's largest lake with rich birdlife. At the same time top birdwatching site. In addition popular for weekend trips. In the surrounding area surrounded by mountains. In this way, Lake Yojoa fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O laguna mare in zona de coasta Mosquitia.",
      en: "A large lagoon in the Mosquitia coastal world."
    },
    facts: {
      de: ["Wichtig fuer Fischerei.", "Reich an Vögeln und Fischen.", "Sehr abgelegene Region."],
    ...
    descriptionAdvanced: {
      de: "Die Laguna de Caratasca liegt im Mosquitia-Gebiet und f?hlt sich wie eine weite Wasserwelt aus Lagunen, Kan?len und Küstenräumen an. Hier sind Bewegung und Orientierung stark vom Wasser abhängig, und genau das macht den Ort so charakteristisch f?r den Nordosten Hondurass. Er ist landschaftlich stiller als die bekannteren Parks, aber ?kologisch extrem wichtig. F?r den Plizio-Lehrplan passt das zu Geografie K7: Küstenlagunen und Feuchtgebiete.",
      ...
      ro: "Laguna Caratasca este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O laguna mare in zona de coasta Mosquitia. În același timp importanta pentru pescuit. Pe lângă acestea bogata in pasari si pesti. În zonă regiune foarte izolata. Astfel, Laguna Caratasca se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Caratasca Lagoon is a notable location in Honduras that reflects the country's geographic and cultural diversity. A large lagoon in the Mosquitia coastal world. At the same time important for fishing. In addition rich in birds and fish. In the surrounding area very remote region. In this way, Caratasca Lagoon fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O zona umeda de coasta in nord-estul Hondurasului.",
      en: "A coastal wetland in northeastern Honduras."
    },
    facts: {
      de: ["Mischung aus Suess- und Salzwasser.", "Wichtiger Fischlebensraum.", "Ruhige Naturkulisse."],
    ...
    }, image: "/poi-images/laguna-de-guaimoreto-life-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "O laguna ingusta pe coasta caraibiana, aproape de Tela.",
      en: "A narrow lagoon on the Caribbean coast near Tela."
    },
    facts: {
      de: ["Bootstouren sind beliebt.", "Mangroven und Wasserwege.", "Grosser Naturwert."],
    ...
    }, image: "/poi-images/laguna-de-los-micos-life-v2.webp"},
  {
    ...
    description: {
      ...
      ro: "Un parc de coasta cu padure tropicala, mangrove si plaja.",
      en: "A coastal park with rainforest, mangroves, and beach."
    },
    facts: {
      de: ["Beliebt fuer Naturtouren.", "Schutzt viele Vogelarten.", "Teil der Nordkueste."],
    ...
    descriptionAdvanced: {
      de: "Punta Sal ist ein Küstenpark mit schmalen Landstreifen, Wald, Strand und Blick auf die Karibik. Er zeigt, wie empfindlich die Grenze zwischen Land und Meer ist: wenige Meter entscheiden ?ber Vegetation, Boden und Nutzung. Der Park ist deshalb nicht nur ein Ausflugsziel, sondern auch ein praktisches Beispiel f?r Küstenschutz in einer Region mit Druck durch Tourismus und Naturereignisse. F?r den Plizio-Lehrplan passt das zu Geografie K7: Küstenformen und Schutzräume.",
      hu: "A Punta Sal Nemzeti Park (Park Nacional Jeannette Kawas) egy páratlan szépségű, tengerparti és vizes élőhely Tela (Atlántida megye) nyugati részén. A park nevét Jeannette Kawas hondurasi környezetvédő tiszteletére kapta, akit 1995-ben gyilkoltak meg, miután hevesen küzdött a park területének pálmaolaj-ültetvényekké és illegális fakitermeléssé történő átalakítása ellen. A rezervátum elképesztő sokszínűséggel bír: találhatók itt fehér homokos, pálmafás karibi strandok, kiterjedt mangroveerdők (Los Micos lagúna), sziklás félszigetek és korallzátonyok. A park otthont ad tengeri teheneknek (manátusz), több tengeri teknősfajnak, bőgőmajmoknak és több száz madárfajnak. A Jeannette Kawas Park Honduras egyik leglátogatottabb ökoturisztikai célpontja, a természetvédelemért hozott áldozat szimbóluma. Élővilág K8 — tengerparti természetvédelem.",
      ro: "Parcul National Punta Sal este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc de coasta cu padure tropicala, mangrove si plaja. În același timp popular pentru tururi in natura. Pe lângă acestea protejeaza multe specii de pasari. În zonă parte din coasta de nord. Astfel, Parcul National Punta Sal se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Punta Sal National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A coastal park with rainforest, mangroves, and beach. At the same time popular for nature trips. In addition protects many bird species. In the surrounding area part of the north coast. In this way, Punta Sal National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O padure protejata aproape de coasta caraibiana.",
      en: "A protected forest near the Caribbean coast."
    },
    facts: {
      de: ["Wichtiger Lebensraum.", "Ruhig und wenig erschlossen.", "Gut fur Naturbeobachtung."],
    ...
    descriptionAdvanced: {
      de: "El Chile ist eine biologische Reserve, die vor allem durch ihre Bergw?lder und die ruhige Lage auff?llt. Anders als große Nationalparks wirkt sie eher wie ein Schutzraum f?r kontinuierliche Beobachtung als f?r schnellen Durchgang. Gerade das macht Reserven wie diese so wichtig: Sie sichern Wasser, Pflanzenvielfalt und R?ckzugsräume f?r Tiere, auch wenn sie selten im Reisef?hrer ganz oben stehen. F?r den Plizio-Lehrplan passt das zu Biologie K6: Schutzgebiete und Artenvielfalt.",
      ...
      ro: "Rezervatia biologica El Chile este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O padure protejata aproape de coasta caraibiana. În același timp habitat important. Pe lângă acestea linistit si putin exploatat. În zonă bun pentru observarea naturii. Astfel, Rezervatia biologica El Chile se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "El Chile Biological Reserve is a notable location in Honduras that reflects the country's geographic and cultural diversity. A protected forest near the Caribbean coast. At the same time important habitat. In addition quiet and lightly developed. In the surrounding area good for nature observation. In this way, El Chile Biological Reserve fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Un parc de munte cu padure si nopti racoroase.",
      en: "A highland park with forest and cool nights."
    },
    facts: {
      de: ["Beliebt zum Zelten.", "Frisches Bergklima.", "Schutzgebiet fuer Wildtiere."],
    ...
    descriptionAdvanced: {
      de: "Die Monta?a de Yoro ist ein gebirgiges Schutzgebiet, in dem Wald, Feuchtigkeit und Höhenlage die Landschaft bestimmen. Yoro ist in Honduras auch kulturell aufgeladen, doch im Park selbst geht es um H?nge, Quellgebiete und k?hle Waldst?cke, die den Nordteil des Landes prägen. Der Ort eignet sich gut, um Berg?kologie nicht nur ?ber Gipfel, sondern ?ber Wasserspeicherung und Vegetationswechsel zu erklären. F?r den Plizio-Lehrplan passt das zu Geografie K7: Bergwald und Wasserkreislauf.",
      ...
      ro: "Parcul National Montana de Yoro este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. Un parc de munte cu padure si nopti racoroase. În același timp popular pentru campare. Pe lângă acestea climat montan racoros. În zonă arie protejata pentru fauna. Astfel, Parcul National Montana de Yoro se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Montana de Yoro National Park is a notable location in Honduras that reflects the country's geographic and cultural diversity. A highland park with forest and cool nights. At the same time popular for camping. In addition fresh mountain climate. In the surrounding area protected wildlife area. In this way, Montana de Yoro National Park fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O zona de padure montana la vest de Comayagua.",
      en: "A mountain forest area west of Comayagua."
    },
    facts: {
      de: ["Kuehler als die Ebene.", "Wichtige Wassereinzugsgebiete.", "Beliebt fuer Wanderungen."],
    ...
    descriptionAdvanced: {
      de: "Die Monta?a de Comayagua steht f?r das Hochland westlich des berühmten Tals und f?r eine Landschaft, in der Landwirtschaft, Wald und Siedlungen eng nebeneinander liegen. Der Name klingt schlicht, doch dahinter verbirgt sich ein wichtiges Berg- und Wassergebiet, das lokale Klimazonen und Wege prägt. Wer die Höhenz?ge betrachtet, versteht besser, warum Comayagua historisch und geografisch so gut vernetzt ist. F?r den Plizio-Lehrplan passt das zu Geografie K6: Hochlandräume und Nutzung.",
      ...
      ro: "Muntii Comayagua este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O zona de padure montana la vest de Comayagua. În același timp mai racoros decat campia. Pe lângă acestea zone hidrografice importante. În zonă popular pentru drumetii. Astfel, Muntii Comayagua se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Comayagua Mountains is a notable location in Honduras that reflects the country's geographic and cultural diversity. A mountain forest area west of Comayagua. At the same time cooler than the lowlands. In addition important watershed area. In the surrounding area popular for hikes. In this way, Comayagua Mountains fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O rezerva forestiera izolata in vestul Hondurasului.",
      en: "A remote forest reserve in western Honduras."
    },
    facts: {
      de: ["Wenige Strassen.", "Ruhige Berglandschaft.", "Wichtig fur Wasser und Tiere."],
    ...
    descriptionAdvanced: {
      de: "Opalaca ist eine biologische Reserve im westlichen Bergland, deren Wert vor allem in ihrer stillen Kontinuit?t liegt. Nebelwald, Quellbereiche und abgelegene H?nge verbinden sich hier zu einem Schutzraum, der f?r viele Menschen kaum sichtbar, f?r das ?kosystem aber entscheidend ist. Solche Reserven sind wichtig, weil sie nicht nur Arten halten, sondern auch Wasser und Boden stabilisieren. F?r den Plizio-Lehrplan passt das zu Biologie K7: Nebelwald und Schutzmanagement.",
      ...
      ro: "Rezervatia Opalaca este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O rezerva forestiera izolata in vestul Hondurasului. În același timp putine drumuri. Pe lângă acestea peisaj montan linistit. În zonă important pentru apa si animale. Astfel, Rezervatia Opalaca se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "Opalaca Reserve is a notable location in Honduras that reflects the country's geographic and cultural diversity. A remote forest reserve in western Honduras. At the same time few roads reach it. In addition quiet mountain landscape. In the surrounding area important for water and wildlife. In this way, Opalaca Reserve fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "O rezervatie forestiera in nord-estul zonei interioare.",
      en: "A forest reserve in the northeastern interior."
    },
    facts: {
      de: ["Dichte Waldbedeckung.", "Lebensraum fuer Wildtiere.", "Wichtiges Schutzgebiet."],
    ...
    descriptionAdvanced: {
      de: "La Muralla ist eine biologische Reserve im Nordosten des Zentralhochlands und wirkt wie eine natürliche Mauer aus Wald und Höhenz?gen. Der Name beschreibt den Eindruck sehr gut: bergig, geschlossen, feucht und klar vom Umland abgesetzt. F?r Besucher ist das ein Raum, in dem man die Logik von Schutzgebieten direkt lesen kann: Je stärker das Gelände gegliedert ist, desto empfindlicher sind Wege, Wasserläufe und Waldkanten. F?r den Plizio-Lehrplan passt das zu Geografie K7: Relief und Naturschutz.",
      ...
      ro: "Rezervatia La Muralla este un punct remarcabil al Hondurasului, care reflectă diversitatea geografică și culturală a țării. O rezervatie forestiera in nord-estul zonei interioare. În același timp acoperire forestiera densa. Pe lângă acestea habitat pentru fauna salbatica. În zonă arie importanta de protectie. Astfel, Rezervatia La Muralla se încadrează firesc în imaginea de ansamblu a Hondurasului, arătând cât de strâns sunt legate natura, istoria și economia în țară.",
      en: "La Muralla Reserve is a notable location in Honduras that reflects the country's geographic and cultural diversity. A forest reserve in the northeastern interior. At the same time dense forest cover. In addition habitat for wildlife. In the surrounding area important protection area. In this way, La Muralla Reserve fits naturally into the wider picture of Honduras, showing how closely linked nature, history and economy are across the country."
    },
    factsAdvanced: {
...
,
  {
    id: "honduras-reserva-biologica-montecillos-life-v2",
    type: "wildlife",
    name: { de: "Reserva Biológica Montecillos", hu: "Montecillos Biológiai Rezervátum", ro: "Rezervația Biologică Montecillos", en: "Montecillos Biological Reserve" },
    coordinates: { lat: 14.3667, lng: -87.8 },
    description: {
      de: "Dieses Schutzgebiet liegt in der Bergregion Zentral-Honduras und bewahrt subtropische Nebelwälder. Es dient als Lebensraum für zahlreiche endemische Pflanzen- und Vogelarten.",
      hu: "Ez a védett terület Honduras középső hegyvidékén található, szubtrópusi köderdőket őriz. Számos endemikus növény- és madárfaj élőhelyéül szolgál.",
      ro: "Această arie protejată este situată în regiunea montană din centrul Hondurasului și conservă păduri subtropicale de nori. Servește drept habitat pentru numeroase specii de plante și păsări endemice.",
      en: "This protected area is located in the mountainous region of central Honduras and preserves subtropical cloud forests. It serves as a habitat for numerous endemic plant and bird species.",
    },
    facts: {
      de: ["Höhe bis zu 2.000 Meter", "Wichtiges Wassereinzugsgebiet", "Schutzstatus seit 1987", "Hohe Artenvielfalt an Farnen"],
      hu: ["Akár 2000 méteres magasság", "Fontos vízgyűjtő terület", "1987 óta védett", "Gazdag páfrányfajokban"],
      ro: ["Altitudine de până la 2.000 metri", "Zonă hidrografică importantă", "Statut de protecție din 1987", "Diversitate ridicată de ferigi"],
      en: ["Elevation up to 2,000 meters", "Important watershed area", "Protected status since 1987", "High diversity of ferns"],
    },
    imageHint: "Montecillos cloud forest mountains",
  },
  {
    id: "honduras-parque-nacional-montana-de-botaderos-life-v2",
    type: "park",
    name: { de: "Nationalpark Montaña de Botaderos", hu: "Montaña de Botaderos Nemzeti Park", ro: "Parcul Național Montaña de Botaderos", en: "Montaña de Botaderos National Park" },
    coordinates: { lat: 15.35, lng: -86.5167 },
    description: {
      de: "Der Nationalpark schützt ein wichtiges Waldgebiet in der Provinz Colón. Er ist für seine unberührten Primärwälder und Wasserquellen bekannt.",
      hu: "A nemzeti park egy fontos erdőterületet véd Colón tartományban. Ismert érintetlen őserdeiről és vízforrásairól.",
      ro: "Parcul național protejează o zonă forestieră importantă în provincia Colón. Este cunoscut pentru pădurile sale primare neatinse și pentru izvoarele de apă.",
      en: "The national park protects an important forest area in Colón province. It is known for its pristine primary forests and water sources.",
    },
    facts: {
      de: ["Größe ca. 56.000 Hektar", "Wichtiger Korridor für Wildtiere", "Etabliert zum Schutz lokaler Quellen", "Geografisch isoliertes Gebiet"],
      hu: ["Kb. 56 000 hektár terület", "Fontos vadvilági folyosó", "Helyi források védelmére létrehozva", "Földrajzilag izolált terület"],
      ro: ["Dimensiune aprox. 56.000 hectare", "Coridor important pentru fauna sălbatică", "Creat pentru protecția izvoarelor locale", "Zonă izolată geografic"],
      en: ["Size approx. 56,000 hectares", "Important wildlife corridor", "Established to protect local springs", "Geographically isolated area"],
    },
    imageHint: "dense jungle landscape Honduras",
  },
  {
    id: "honduras-reserva-biologica-el-cacao-life-v2",
    type: "wildlife",
    name: { de: "Reserva Biológica El Cacao", hu: "El Cacao Biológiai Rezervátum", ro: "Rezervația Biologică El Cacao", en: "El Cacao Biological Reserve" },
    coordinates: { lat: 14.9333, lng: -87.8333 },
    description: {
      de: "Diese biologische Reserve in der Nähe von Comayagua schützt lokale Waldökosysteme. Sie spielt eine Rolle bei der Erhaltung der lokalen Biodiversität.",
      hu: "Ez a Comayagua melletti biológiai rezervátum a helyi erdei ökoszisztémákat védi. Szerepet játszik a helyi biodiverzitás megőrzésében.",
      ro: "Această rezervație biologică de lângă Comayagua protejează ecosistemele forestiere locale. Joacă un rol în conservarea biodiversității locale.",
      en: "This biological reserve near Comayagua protects local forest ecosystems. It plays a role in the conservation of local biodiversity.",
    },
    facts: {
      de: ["Schutz von Bergwaldgebieten", "Lebensraum für kleine Säugetiere", "Teil der zentralen Gebirgszüge", "Eingeschränkter menschlicher Zugang"],
      hu: ["Hegyvidéki erdők védelme", "Kisemlősök élőhelye", "A központi hegyláncok része", "Korlátozott emberi hozzáférés"],
      ro: ["Protecția zonelor de pădure montană", "Habitat pentru mamifere mici", "Parte a lanțurilor muntoase centrale", "Acces uman limitat"],
      en: ["Protection of mountain forest areas", "Habitat for small mammals", "Part of central mountain ranges", "Limited human access"],
    },
    imageHint: "tropical mountain forest Honduras",
  },
  {
    id: "honduras-reserva-natural-carabali-life-v2",
    type: "park",
    name: { de: "Reserva Natural Carabalí", hu: "Carabalí Természetvédelmi Terület", ro: "Rezervația Naturală Carabalí", en: "Carabalí Natural Reserve" },
    coordinates: { lat: 13.5, lng: -87.1 },
    description: {
      de: "Im Süden Hondurans gelegen, umfasst dieses Schutzgebiet trockene Waldzonen. Es dient dem Erhalt von Arten, die an das semiaride Klima angepasst sind.",
      hu: "Honduras déli részén található, ez a védett terület száraz erdőzónákat foglal magában. A félszáraz éghajlathoz alkalmazkodott fajok megőrzését szolgálja.",
      ro: "Situată în sudul Hondurasului, această arie protejată cuprinde zone forestiere uscate. Servește la conservarea speciilor adaptate la climatul semiarid.",
      en: "Located in southern Honduras, this protected area includes dry forest zones. It serves to preserve species adapted to the semi-arid climate.",
    },
    facts: {
      de: ["Trockenwald-Ökosystem", "Präsenz von Kaktusarten", "Saisonal geprägte Vegetation", "Wichtig für lokale Avifauna"],
      hu: ["Száraz erdő ökoszisztéma", "Kaktuszfajok jelenléte", "Szezonális jellegű növényzet", "Fontos a helyi madárvilág számára"],
      ro: ["Ecosistem de pădure uscată", "Prezența speciilor de cactus", "Vegetație cu caracter sezonier", "Importantă pentru avifauna locală"],
      en: ["Dry forest ecosystem", "Presence of cactus species", "Seasonally characterized vegetation", "Important for local avifauna"],
    },
    imageHint: "dry forest landscape southern Honduras",
  },
  {
    id: "honduras-refugio-de-vida-silvestre-la-quebrada-life-v2",
    type: "wildlife",
    name: { de: "Refugio de Vida Silvestre La Quebrada", hu: "La Quebrada Vadvédelmi Rezervátum", ro: "Refugiul de Faună Sălbatică La Quebrada", en: "La Quebrada Wildlife Refuge" },
    coordinates: { lat: 15.65, lng: -88.1667 },
    description: {
      de: "Dieses Reservat konzentriert sich auf den Schutz von Feuchtgebieten und Uferzonen. Es ist ein wichtiger Beobachtungsort für Wasservögel.",
      hu: "Ez a rezervátum a vizes élőhelyek és a part menti zónák védelmére összpontosít. Fontos megfigyelőhely a vízi madarak számára.",
      ro: "Această rezervație se concentrează pe protecția zonelor umede și a zonelor riverane. Este un punct important de observare pentru păsările acvatice.",
      en: "This reserve focuses on the protection of wetlands and riparian zones. It is an important observation point for water birds.",
    },
    facts: {
      de: ["Schutz von Wasser-Ökosystemen", "Vielfältige Wasservogelarten", "Saisonal überflutete Flächen", "Lokale Naturschutzinitiative"],
      hu: ["Vízi ökoszisztémák védelme", "Változatos vízi madárfajok", "Szezonálisan elárasztott területek", "Helyi természetvédelmi kezdeményezés"],
      ro: ["Protecția ecosistemelor acvatice", "Specii diverse de păsări acvatice", "Zone inundate sezonier", "Inițiativă locală de conservare"],
      en: ["Protection of aquatic ecosystems", "Diverse water bird species", "Seasonally flooded areas", "Local conservation initiative"],
    },
    imageHint: "wetland marsh Honduras",
  },
  {
    id: "honduras-parque-nacional-montana-de-la-flor-life-v2",
    type: "park",
    name: { de: "Nationalpark Montaña de la Flor", hu: "Montaña de la Flor Nemzeti Park", ro: "Parcul Național Montaña de la Flor", en: "Montaña de la Flor National Park" },
    coordinates: { lat: 15.0167, lng: -87.1833 },
    description: {
      de: "Dieser Nationalpark schützt ein bergiges Gebiet mit ausgedehnten Kiefern- und Eichenwäldern. Er ist auch von kultureller Bedeutung für die indigene Bevölkerung.",
      hu: "Ez a nemzeti park kiterjedt fenyő- és tölgyerdőkkel borított hegyvidéki területet véd. Kulturális jelentőséggel is bír az őslakos lakosság számára.",
      ro: "Acest parc național protejează o zonă muntoasă cu păduri întinse de pini și stejari. Are, de asemenea, o importanță culturală pentru populația indigenă.",
      en: "This national park protects a mountainous area with extensive pine and oak forests. It is also of cultural importance to the indigenous population.",
    },
    facts: {
      de: ["Kiefer-Eichen-Mischwald", "Hohe biologische Diversität", "Kulturelles Erbe der Tolupan", "Bergiges Terrain über 1.500m"],
      hu: ["Fenyő-tölgy vegyes erdő", "Magas biológiai diverzitás", "A tolupánok kulturális öröksége", "1500m feletti hegyvidéki terep"],
      ro: ["Pădure mixtă de pini și stejari", "Diversitate biologică ridicată", "Moștenirea culturală a tribului Tolupan", "Teren muntos de peste 1.500m"],
      en: ["Pine-oak mixed forest", "High biological diversity", "Cultural heritage of the Tolupan", "Mountainous terrain above 1,500m"],
    },
    imageHint: "pine forest mountains Honduras",
  },
  {
    id: "honduras-reserva-biologica-opalaca-v2-life-v2",
    type: "wildlife",
    name: { de: "Reserva Biológica Opalaca II", hu: "Opalaca II Biológiai Rezervátum", ro: "Rezervația Biologică Opalaca II", en: "Opalaca II Biological Reserve" },
    coordinates: { lat: 14.4333, lng: -88.1333 },
    description: {
      de: "Ergänzend zum ersten Schutzgebiet bewahrt dieser Bereich ungestörte Ökosysteme im westlichen Bergland. Die Region zeichnet sich durch hohe endemische Artenzahlen aus.",
      hu: "Az első védett terület kiegészítéseként ez a terület a nyugati hegyvidék zavartalan ökoszisztémáit őrzi. A régiót magas endemikus fajszám jellemzi.",
      ro: "Ca o completare a primei arii protejate, această zonă conservă ecosisteme netulburate în zona montană de vest. Regiunea se caracterizează prin numere ridicate de specii endemice.",
      en: "Complementing the first protected area, this zone preserves undisturbed ecosystems in the western highlands. The region is characterized by high numbers of endemic species.",
    },
    facts: {
      de: ["Nebelwald-Habitate", "Wichtiges Schutzgebiet für Amphibien", "Teil der Cordillera de Opalaca", "Über 1.800 Meter hoch"],
      hu: ["Köderdő élőhelyek", "Fontos védett terület kétéltűek számára", "Az Opalaca-hegylánc része", "1800 méter feletti magasság"],
      ro: ["Habitate de pădure de nori", "Arie protejată importantă pentru amfibieni", "Parte a Cordilierilor Opalaca", "Peste 1.800 metri altitudine"],
      en: ["Cloud forest habitats", "Important protected area for amphibians", "Part of the Cordillera de Opalaca", "Over 1,800 meters high"],
    },
    imageHint: "cloud forest ridge Honduras",
  },
  {
    id: "honduras-parque-nacional-cerro-azul-life-v2",
    type: "park",
    name: { de: "Nationalpark Cerro Azul", hu: "Cerro Azul Nemzeti Park", ro: "Parcul Național Cerro Azul", en: "Cerro Azul National Park" },
    coordinates: { lat: 14.9, lng: -88.35 },
    description: {
      de: "Dieser Park umfasst ein ausgeprägtes Bergmassiv und schützt ausgedehnte Waldgebiete. Er ist ein kritischer Lebensraum für diverse Vogelarten.",
      hu: "Ez a park egy markáns hegytömböt foglal magában és kiterjedt erdőterületeket véd. Kritikus élőhely a különféle madárfajok számára.",
      ro: "Acest parc cuprinde un masiv muntos pronunțat și protejează zone forestiere extinse. Este un habitat critic pentru diverse specii de păsări.",
      en: "This park encompasses a distinct mountain massif and protects extensive forest areas. It is a critical habitat for diverse bird species.",
    },
    facts: {
      de: ["Massiv in Copán", "Dichte Waldvegetation", "Schutz vor Erosion", "Wanderrouten vorhanden"],
      hu: ["Hegytömb Copánban", "Sűrű erdei növényzet", "Erozó elleni védelem", "Túraútvonalak vannak"],
      ro: ["Masiv în Copán", "Vegetație forestieră densă", "Protecție împotriva eroziunii", "Trasee de drumeție disponibile"],
      en: ["Massif in Copán", "Dense forest vegetation", "Erosion protection", "Hiking routes available"],
    },
    imageHint: "Cerro Azul mountains landscape",
  },
  {
    id: "honduras-reserva-biologica-el-chile-v2-life-v2",
    type: "wildlife",
    name: { de: "Reserva Biológica El Chile II", hu: "El Chile II Biológiai Rezervátum", ro: "Rezervația Biologică El Chile II", en: "El Chile II Biological Reserve" },
    coordinates: { lat: 14.65, lng: -86.85 },
    description: {
      de: "Ein geschütztes Berggebiet nahe der Region Francisco Morazán. Die Reserve dient dem Erhalt von Ökosystemen, die für den Wasserhaushalt zentral sind.",
      hu: "Védett hegyvidéki terület a Francisco Morazán régió közelében. A rezervátum a vízháztartás szempontjából központi ökoszisztémák megőrzését szolgálja.",
      ro: "O zonă montană protejată lângă regiunea Francisco Morazán. Rezervația servește la conservarea ecosistemelor centrale pentru gestionarea apei.",
      en: "A protected mountain area near the Francisco Morazán region. The reserve serves to conserve ecosystems that are central to water management.",
    },
    facts: {
      de: ["Wichtiges Wassereinzugsgebiet", "Bergwald-Vegetation", "Schutz gefährdeter Arten", "Nördlich von Tegucigalpa"],
      hu: ["Fontos vízgyűjtő terület", "Hegyvidéki erdei növényzet", "Veszélyeztetett fajok védelme", "Tegucigalpától északra"],
      ro: ["Zonă hidrografică importantă", "Vegetație de pădure montană", "Protecția speciilor periclitate", "La nord de Tegucigalpa"],
      en: ["Important watershed", "Mountain forest vegetation", "Protection of endangered species", "North of Tegucigalpa"],
    },
    imageHint: "mountain forest ridge Honduras",
  },
  {
    id: "honduras-parque-nacional-pico-pijol-v2-life-v2",
    type: "park",
    name: { de: "Nationalpark Pico Pijol II", hu: "Pico Pijol II Nemzeti Park", ro: "Parcul Național Pico Pijol II", en: "Pico Pijol II National Park" },
    coordinates: { lat: 15.15, lng: -87.65 },
    description: {
      de: "Eine Erweiterung der Schutzmaßnahmen am Pico Pijol. Das Gebiet umfasst wertvolle Feuchtwälder, die für ihre Artenvielfalt bekannt sind.",
      hu: "A Pico Pijol védelmi intézkedéseinek kiterjesztése. A terület értékes, biodiverzitásáról ismert nedves erdőket foglal magában.",
      ro: "O extindere a măsurilor de protecție la Pico Pijol. Zona cuprinde păduri umede valoroase, cunoscute pentru biodiversitatea lor.",
      en: "An extension of protection measures at Pico Pijol. The area includes valuable humid forests known for their biodiversity.",
    },
    facts: {
      de: ["Schutz von Nebelwäldern", "Hohe Niederschlagsmengen", "Vielfältige Flora", "Schwieriges Terrain"],
      hu: ["Köderdők védelme", "Magas csapadékmennyiség", "Változatos flóra", "Nehéz terep"],
      ro: ["Protecția pădurilor de nori", "Cantități mari de precipitații", "Floră diversă", "Teren dificil"],
      en: ["Protection of cloud forests", "High precipitation levels", "Diverse flora", "Difficult terrain"],
    },
    imageHint: "misty mountain forest Honduras",
  },
  {
    id: "honduras-jardin-botanico-dame-la-mano-life-v2",
    type: "park",
    name: { de: "Botanischer Garten Dame la Mano", hu: "Dame la Mano Botanikus Kert", ro: "Grădina Botanică Dame la Mano", en: "Dame la Mano Botanical Garden" },
    coordinates: { lat: 15.58, lng: -87.65 },
    description: {
      de: "Ein kleinerer botanischer Garten, der sich auf einheimische Pflanzenarten konzentriert. Er dient der Bildung und dem Schutz lokaler botanischer Vielfalt.",
      hu: "Kisebb botanikus kert, amely az őshonos növényfajokra összpontosít. Oktatási célokat szolgál és védi a helyi botanikai sokféleséget.",
      ro: "O grădină botanică mai mică, concentrată pe speciile de plante native. Servește educației și protecției diversității botanice locale.",
      en: "A smaller botanical garden focusing on native plant species. It serves for education and the protection of local botanical diversity.",
    },
    facts: {
      de: ["Sammlung einheimischer Flora", "Bildungseinrichtung", "Pflege lokaler Arten", "Zugänglich für Besucher"],
      hu: ["Őshonos flóra gyűjteménye", "Oktatási intézmény", "Helyi fajok gondozása", "Látogatók számára nyitott"],
      ro: ["Colecție de floră nativă", "Instituție educativă", "Îngrijirea speciilor locale", "Accesibilă pentru vizitatori"],
      en: ["Collection of native flora", "Educational institution", "Care of local species", "Accessible to visitors"],
    },
    imageHint: "tropical botanical garden Honduras",
  },
  {
    id: "honduras-reserva-ecologica-san-pedro-life-v2",
    type: "wildlife",
    name: { de: "Ökologisches Reservat San Pedro", hu: "San Pedro Ökológiai Rezervátum", ro: "Rezervația Ecologică San Pedro", en: "San Pedro Ecological Reserve" },
    coordinates: { lat: 15.45, lng: -88.02 },
    description: {
      de: "Dieses Reservat schützt ein wichtiges Waldgebiet nahe San Pedro Sula. Es dient als Rückzugsort für Wildtiere in einer stark entwickelten Region.",
      hu: "Ez a rezervátum egy fontos erdőterületet véd San Pedro Sula közelében. Menedékként szolgál a vadvilág számára egy erősen fejlett régióban.",
      ro: "Această rezervație protejează o zonă forestieră importantă lângă San Pedro Sula. Servește ca refugiu pentru fauna sălbatică într-o regiune puternic dezvoltată.",
      en: "This reserve protects an important forest area near San Pedro Sula. It serves as a retreat for wildlife in a highly developed region.",
    },
    facts: {
      de: ["Städtisches Schutzgebiet", "Wanderwege für Bildung", "Vielfältige Fauna", "Naturschutz-Hotspot"],
      hu: ["Városi védett terület", "Tanösvények", "Változatos fauna", "Természetvédelmi hotspot"],
      ro: ["Arie protejată urbană", "Trasee educaționale", "Faună diversă", "Hotspot de conservare"],
      en: ["Urban protected area", "Educational hiking trails", "Diverse fauna", "Conservation hotspot"],
    },
    imageHint: "green forest edge near city",
  },
  {
    id: "honduras-refugio-vida-silvestre-puca-life-v2",
    type: "wildlife",
    name: { de: "Wildtierreservat Puca", hu: "Puca Vadvédelmi Rezervátum", ro: "Refugiul de Faună Sălbatică Puca", en: "Puca Wildlife Refuge" },
    coordinates: { lat: 14.7, lng: -88.5 },
    description: {
      de: "Das Puca-Schutzgebiet bewahrt Gebirgsökosysteme im Westen. Es ist Teil einer Kette von Schutzgebieten, die für Wanderwildtiere wichtig sind.",
      hu: "A Puca védett terület a nyugati hegyvidéki ökoszisztémákat őrzi. Annak a védett területek alkotta láncnak a része, amely fontos a vándorló állatok számára.",
      ro: "Aria protejată Puca conservă ecosistemele montane din vest. Este parte dintr-un lanț de arii protejate importante pentru fauna migratoare.",
      en: "The Puca protected area preserves mountain ecosystems in the west. It is part of a chain of protected areas important for migratory wildlife.",
    },
    facts: {
      de: ["Bergklima-Habitate", "Korridor für Wildtiere", "Erhaltung der Biodiversität", "Südlich von Copán"],
      hu: ["Hegyvidéki klíma élőhelyek", "Vadvilági folyosó", "Biodiverzitás megőrzése", "Copántól délre"],
      ro: ["Habitate de climat montan", "Coridor pentru fauna sălbatică", "Conservarea biodiversității", "La sud de Copán"],
      en: ["Mountain climate habitats", "Wildlife corridor", "Biodiversity conservation", "South of Copán"],
    },
    imageHint: "mountainous wildlife reserve",
  },
  {
    id: "honduras-parque-nacional-montana-yoro-v2-life-v2",
    type: "park",
    name: { de: "Nationalpark Montaña de Yoro II", hu: "Montaña de Yoro II Nemzeti Park", ro: "Parcul Național Montaña de Yoro II", en: "Montaña de Yoro II National Park" },
    coordinates: { lat: 15.2, lng: -87.3 },
    description: {
      de: "Eine Erweiterung des bestehenden Schutzgebiets in Yoro. Das Gebiet schützt intakte Bergwälder und ist wichtig für den lokalen Wasserhaushalt.",
      hu: "A már meglévő yorói védett terület kiterjesztése. A terület ép hegyi erdőket véd és fontos a helyi vízháztartás szempontjából.",
      ro: "O extindere a ariei protejate existente în Yoro. Zona protejează păduri montane intacte și este importantă pentru managementul local al apei.",
      en: "An expansion of the existing protected area in Yoro. The area protects intact mountain forests and is important for local water management.",
    },
    facts: {
      de: ["Schutz von Kiefernwäldern", "Hohe biologische Vielfalt", "Wasserquelle für Region", "Bergland"],
      hu: ["Fenyőerdők védelme", "Magas biológiai diverzitás", "Vízforrás a régió számára", "Hegyvidék"],
      ro: ["Protecția pădurilor de pini", "Diversitate biologică ridicată", "Sursă de apă pentru regiune", "Zonă montană"],
      en: ["Protection of pine forests", "High biological diversity", "Water source for region", "Mountain land"],
    },
    imageHint: "pine forest landscape Yoro",
  },
  {
    id: "honduras-reserva-biologica-la-muralla-v2-life-v2",
    type: "wildlife",
    name: { de: "Reserva Biológica La Muralla II", hu: "La Muralla II Biológiai Rezervátum", ro: "Rezervația Biologică La Muralla II", en: "La Muralla II Biological Reserve" },
    coordinates: { lat: 15.1, lng: -86.7 },
    description: {
      de: "Ein zusätzliches Schutzgebiet in der Nähe des Kerns von La Muralla. Es bewahrt seltene Pflanzenarten und ist Rückzugsort für den Quetzal.",
      hu: "További védett terület a La Muralla magja közelében. Ritka növényfajokat őriz és menedékhely a quetzal számára.",
      ro: "O arie protejată suplimentară lângă nucleul La Muralla. Conservă specii rare de plante și este un refugiu pentru quetzal.",
      en: "An additional protected area near the core of La Muralla. It preserves rare plant species and is a retreat for the quetzal.",
    },
    facts: {
      de: ["Nebelwald-Refugium", "Quetzal-Beobachtungsgebiet", "Wichtige Pflanzenvielfalt", "Staatlich geschützt"],
      hu: ["Köderdő menedék", "Quetzal megfigyelő terület", "Fontos növényi diverzitás", "Államilag védett"],
      ro: ["Refugiu de pădure de nori", "Zonă de observare a quetzalului", "Diversitate botanică importantă", "Protejat de stat"],
      en: ["Cloud forest refuge", "Quetzal observation area", "Important plant diversity", "State-protected"],
    },
    imageHint: "quetzal bird cloud forest",
  },
  {
    id: "honduras-reserva-natural-cerro-de-plata-life-v2",
    type: "wildlife",
    name: { de: "Naturreservat Cerro de Plata", hu: "Cerro de Plata Természetvédelmi Terület", ro: "Rezervația Naturală Cerro de Plata", en: "Cerro de Plata Natural Reserve" },
    coordinates: { lat: 14.85, lng: -87.1 },
    description: {
      de: "Dieses Reservat schützt eine Bergkette mit unterschiedlichen Waldtypen. Es ist ein wichtiger Ort für die lokale Forschung und ökologische Studien.",
      hu: "Ez a rezervátum egy változatos erdei típusokkal rendelkező hegyláncot véd. Fontos helyszín a helyi kutatások és ökológiai tanulmányok számára.",
      ro: "Această rezervație protejează un lanț muntos cu diverse tipuri de pădure. Este un loc important pentru cercetarea locală și studii ecologice.",
      en: "This reserve protects a mountain range with different forest types. It is an important location for local research and ecological studies.",
    },
    facts: {
      de: ["Forschungsgebiet", "Mischwald", "Hohe topographische Varianz", "Regionale Biodiversität"],
      hu: ["Kutatóterület", "Vegyes erdő", "Magas topográfiai variancia", "Regionális biodiverzitás"],
      ro: ["Zonă de cercetare", "Pădure mixtă", "Varianță topografică ridicată", "Biodiversitate regională"],
      en: ["Research area", "Mixed forest", "High topographical variance", "Regional biodiversity"],
    },
    imageHint: "forested mountain range Honduras",
  },
  {
    id: "honduras-humedales-de-la-costa-sur-life-v2",
    type: "park",
    name: { de: "Feuchtgebiete der Südküste", hu: "Déli partvonal vizes élőhelyei", ro: "Zonele Umede ale Coastei de Sud", en: "South Coast Wetlands" },
    coordinates: { lat: 13.3, lng: -87.4 },
    description: {
      de: "Ein umfangreiches System aus Mangroven und Feuchtgebieten an der Pazifikküste. Diese Zonen sind entscheidend für die Fischzucht und den Küstenschutz.",
      hu: "Mangrovék és vizes élőhelyek kiterjedt rendszere a csendes-óceáni partvidéken. Ezek a zónák kritikusak a halászat és a partvédelem szempontjából.",
      ro: "Un sistem extins de mangrove și zone umede pe coasta Pacificului. Aceste zone sunt cruciale pentru pescuit și protecția costieră.",
      en: "An extensive system of mangroves and wetlands on the Pacific coast. These zones are crucial for fishing and coastal protection.",
    },
    facts: {
      de: ["Großes Mangroven-Ökosystem", "Wichtig für die Fischerei", "Hohe ökologische Dynamik", "Sturmflutschutz"],
      hu: ["Nagy mangrove ökoszisztéma", "Fontos a halászat számára", "Magas ökológiai dinamika", "Vihardagály elleni védelem"],
      ro: ["Ecosistem mare de mangrove", "Important pentru pescuit", "Dinamica ecologică ridicată", "Protecție împotriva furtunilor"],
      en: ["Large mangrove ecosystem", "Important for fishing", "High ecological dynamics", "Storm surge protection"],
    },
    imageHint: "mangrove forest coast Honduras",
  },
  {
    id: "honduras-reserva-ecologica-de-guajiquiro-life-v2",
    type: "wildlife",
    name: { de: "Ökologisches Reservat Guajiquiro", hu: "Guajiquiro Ökológiai Rezervátum", ro: "Rezervația Ecologică Guajiquiro", en: "Guajiquiro Ecological Reserve" },
    coordinates: { lat: 14.15, lng: -87.85 },
    description: {
      de: "Dieses Gebiet umfasst Waldflächen in einer hochgelegenen Region. Es bietet Lebensraum für spezifische Flora der honduranischen Hochländer.",
      hu: "Ez a terület magas fekvésű régióban elterülő erdőket foglal magában. Élőhelyet biztosít a hondurasi felföldek specifikus flórája számára.",
      ro: "Această zonă cuprinde suprafețe forestiere într-o regiune de mare altitudine. Oferă habitat pentru flora specifică a ținuturilor înalte honduriene.",
      en: "This area encompasses forest lands in a high-altitude region. It provides habitat for specific flora of the Honduran highlands.",
    },
    facts: {
      de: ["Hochland-Habitate", "Kiefern-Dominanz", "Wichtig für regionale Fauna", "Berglage"],
      hu: ["Felföldi élőhelyek", "Fenyő dominancia", "Fontos a regionális fauna számára", "Hegyvidéki elhelyezkedés"],
      ro: ["Habitate de ținut înalt", "Dominanța pinilor", "Important pentru fauna regională", "Poziție montană"],
      en: ["Highland habitats", "Pine dominance", "Important for regional fauna", "Mountain location"],
    },
    imageHint: "highland pine forest Honduras",
  },
  {
    id: "honduras-jardin-etnobotanico-el-pinos-life-v2",
    type: "park",
    name: { de: "Ethnobotanischer Garten El Pinos", hu: "El Pinos Etnobotanikus Kert", ro: "Grădina Etnobotanică El Pinos", en: "El Pinos Ethnobotanical Garden" },
    coordinates: { lat: 14.1, lng: -87.2 },
    description: {
      de: "Ein spezialisierter Garten, der traditionell genutzte Pflanzen der indigenen Gemeinschaften zeigt. Er ist ein Zentrum für kulturelle und pflanzliche Bildung.",
      hu: "Speciális kert, amely bemutatja az őslakos közösségek hagyományosan használt növényeit. A kulturális és növényi oktatás központja.",
      ro: "O grădină specializată care prezintă plantele folosite tradițional de comunitățile indigene. Este un centru pentru educație culturală și botanică.",
      en: "A specialized garden showing traditionally used plants of indigenous communities. It is a center for cultural and botanical education.",
    },
    facts: {
      de: ["Traditionelles Wissen", "Heilpflanzen-Sammlung", "Kulturelle Erhaltung", "Lehrpfade vorhanden"],
      hu: ["Hagyományos tudás", "Gyógynövény gyűjtemény", "Kulturális megőrzés", "Tanösvények vannak"],
      ro: ["Cunoștințe tradiționale", "Colecție de plante medicinale", "Conservare culturală", "Trasee educaționale disponibile"],
      en: ["Traditional knowledge", "Medicinal plant collection", "Cultural preservation", "Educational trails available"],
    },
    imageHint: "ethnobotanical garden plants",
  }
];
