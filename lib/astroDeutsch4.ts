...
export const K4_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore",  icon: "🔍", label: { de: "Kasus entdecken",   en: "Case Explorer",    hu: "Eset felfedező",    ro: "Explorer cazuri"   } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match",  icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort", icon: "⚡", label: { de: "Blitzrunde", en: "Speed Round", hu: "Villámkör", ro: "Rundă rapidă" } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Dativ entdecken",   en: "Dative Explorer",  hu: "Dativ felfedező",   ro: "Explorer Dativ"    } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs",  icon: "🚀", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "pattern-finish", icon: "🕳️", label: { de: "Schwarzes Loch", en: "Black Hole", hu: "Fekete lyuk", ro: "Gaură neagră" } },
    ],
    svgX: 80, svgY: 440,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Zeitformen entdecken", en: "Tense Explorer", hu: "Igeidő felfedező", ro: "Explorer timpuri" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter",  icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "count-catch", icon: "📝", label: { de: "Übungsblatt", en: "Worksheet", hu: "Feladatlap", ro: "Fișă de lucru" } },
    ],
    svgX: 240, svgY: 360,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Wortarten entdecken", en: "Word Class Explorer", hu: "Szófaj felfedező", ro: "Explorer clase" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",  icon: "🕳️", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match", icon: "⚡", label: { de: "Speedrunde",        en: "Speed Round",      hu: "Gyors kör",         ro: "Rundă rapidă"      } },
    ],
    svgX: 90, svgY: 270,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Satzglieder entdecken", en: "Sentence Part Explorer", hu: "Mondatrész felfedező", ro: "Explorer propoziție" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "bubble-choice",  icon: "🚀", label: { de: "Sterne verbinden",  en: "Star Match",          hu: "Csillag párosítás", ro: "Potrivire stele" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort", icon: "🕳️", label: { de: "Schwarzes Loch", en: "Black Hole", hu: "Fekete lyuk", ro: "Gaură neagră" } },
    ],
    svgX: 220, svgY: 195,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Satzarten entdecken", en: "Clause Explorer", hu: "Mondattípus felfedező", ro: "Explorer tipuri" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match",  icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",         hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "pattern-finish", icon: "🎨", label: { de: "Übungsblatt", en: "Worksheet", hu: "Feladatlap", ro: "Fișă de lucru" } },
    ],
    svgX: 100, svgY: 125,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Verben entdecken",  en: "Verb Explorer",    hu: "Ige felfedező",     ro: "Explorer verbe"    } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs",  icon: "🚀", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "count-catch", icon: "⚡", label: { de: "Speedrunde",        en: "Speed Round",      hu: "Gyors kör",         ro: "Rundă rapidă"      } },
    ],
    svgX: 230, svgY: 55,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Rechtschreib-Entdecker", en: "Spelling Explorer", hu: "Helyesírás felfedező", ro: "Explorer ortografie" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter",  icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match", icon: "🕳️", label: { de: "Schwarzes Loch", en: "Black Hole", hu: "Fekete lyuk", ro: "Gaură neagră" } },
    ],
    svgX: 80, svgY: -20,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔍", label: { de: "Alles Entdecken",   en: "Review Explorer",  hu: "Összefoglaló felfedező", ro: "Explorer recapitulare" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",  icon: "🕳️", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort", icon: "✏️", label: { de: "Lückentext", en: "Gap Fill", hu: "Hiánypótlás", ro: "Completare goluri" } },
    ],
    svgX: 190, svgY: -90,
  },
];
