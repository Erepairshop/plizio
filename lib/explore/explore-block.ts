...
const CONTINENT_NAME: Record<string, Record<ExploreLang, string>> = {
  "europe-map": { de: "Europa", hu: "Európa", ro: "Europa", en: "Europe", fr: "Europe", tr: "Avrupa", hr: "Europa", it: "Europa" },
  "northamerica-map": { de: "Nordamerika", hu: "Észak-Amerika", ro: "America de Nord", en: "North America", fr: "Amérique du Nord", tr: "Kuzey Amerika", hr: "Sjeverna Amerika", it: "Nord America" },
  "southamerica-map": { de: "Südamerika", hu: "Dél-Amerika", ro: "America de Sud", en: "South America", fr: "Amérique du Sud", tr: "Güney Amerika", hr: "Južna Amerika", it: "Sud America" },
  "africa-map": { de: "Afrika", hu: "Afrika", ro: "Africa", en: "Africa", fr: "Afrique", tr: "Afrika", hr: "Afrika", it: "Africa" },
  "asia-map": { de: "Asien", hu: "Ázsia", ro: "Asia", en: "Asia", fr: "Asie", tr: "Asya", hr: "Azija", it: "Asia" },
  "oceania-map": { de: "Ozeanien", hu: "Óceánia", ro: "Oceania", en: "Oceania", fr: "Océanie", tr: "Okyanusya", hr: "Oceanija", it: "Oceania" },
};
...
const COPY: Record<ExploreLang, { discover: (c: string) => string; moreIn: (c: string) => string; sectionTitle: string }> = {
  ...
  it: { discover: (c) => `Scopri altri luoghi in ${c}`, moreIn: (c) => `Altri luoghi in ${c}`, sectionTitle: "Esplora con Plizio" },
};

function _langFallback(lang: ExploreLang): ExploreLang { return lang === "tr" ? "de" : lang === "fr" ? "en" : lang === "hr" ? "en" : lang; }
function _lk(lang: ExploreLang): ExploreLang { return (["de","hu","ro","en","fr","tr","hr","it"].includes(lang) ? lang : "en") as ExploreLang; }
