...
function generateHumanismus(seed: number = 702): CurriculumQuestion[] {
  ...
  const mcqPool: [string, string, string[]][] = [
    ...
    ["Was dachten sie über das Individuum?", "Jeder ist einzigartig und wertvoll", ["Werkzeug des Staates", "Alle gleich", "Einzelner zählt nichts", "Nur Reiche"]],
...
function generateSturmBastille(seed: number = 718): CurriculumQuestion[] {
  ...
  const mcqPool: [string, string, string[]][] = [
    ...
    ["Volks-Forderung?", "Brot und Mitsprache", ["Krieg", "Druckverbot", "Gefängnisbau", "Gold"]],
