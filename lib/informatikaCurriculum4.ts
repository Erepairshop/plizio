...
export const INFO_K4_CURRICULUM: KemiaTheme[] = [
  {
    ...
    color: "#3B82F6",
    subtopics: [
      { id: "info_k4_t01", name: { de: "Scratch Einführung", en: "Scratch Introduction", hu: "Scratch bevezetés", ro: "Introducere Scratch" }, questions: [], hasGenerator: false },
      { id: "info_k4_t02", name: { de: "Blockbasierte Programmierung", en: "Block-based Programming", hu: "Blokkalapú programozás", ro: "Programare bazată pe blocuri" }, questions: [], hasGenerator: false },
      { id: "info_k4_t03", name: { de: "Algorithmus-Begriff", en: "Algorithm Concept", hu: "Algoritmus fogalma", ro: "Conceptul de algoritm" }, questions: [], hasGenerator: false },
      { id: "info_k4_t04", name: { de: "Anweisungs-Sequenz", en: "Instruction Sequence", hu: "Utasítássorozat", ro: "Secvență de instrucțiuni" }, questions: [], hasGenerator: false },
      { id: "info_k4_t05", name: { de: "Schleife (Loop)", en: "Loop", hu: "Ciklus (Loop)", ro: "Buclă (Loop)" }, questions: [], hasGenerator: false },
    ],
  },
  {
    id: "info_k4_logika",
    ...
    color: "#10B981",
    subtopics: [
      { id: "info_k4_t06", name: { de: "Bedingung (If)", en: "Condition (If)", hu: "Feltétel (If)", ro: "Condiție (If)" }, questions: [], hasGenerator: false },
      { id: "info_k4_t07", name: { de: "Variable", en: "Variable", hu: "Változó", ro: "Variabilă" }, questions: [], hasGenerator: false },
      { id: "info_k4_t08", name: { de: "Input / Output", en: "Input / Output", hu: "Bemenet / Kimenet", ro: "Intrare / Ieșire" }, questions: [], hasGenerator: false },
      { id: "info_k4_t09", name: { de: "Sprite / Animation (Scratch)", en: "Sprite / Animation (Scratch)", hu: "Szereplő / Animáció (Scratch)", ro: "Personaj / Animație (Scratch)" }, questions: [], hasGenerator: false },
      { id: "info_k4_t10", name: { de: "Musik-Loop", en: "Music Loop", hu: "Zenei ciklus", ro: "Buclă muzicală" }, questions: [], hasGenerator: false },
    ],
  },
  {
    ...
    color: "#F59E0B",
    subtopics: [
      { id: "info_k4_t11", name: { de: "Foto-Editing Grundlagen", en: "Photo Editing Basics", hu: "Képszerkesztés alapjai", ro: "Bazele editării foto" }, questions: [], hasGenerator: false },
      { id: "info_k4_t12", name: { de: "Video-Editing Grundlagen", en: "Video Editing Basics", hu: "Videószerkesztés alapjai", ro: "Bazele editării video" }, questions: [], hasGenerator: false },
      { id: "info_k4_t13", name: { de: "PowerPoint fortgeschritten", en: "Advanced PowerPoint", hu: "Haladó PowerPoint", ro: "PowerPoint avansat" }, questions: [], hasGenerator: false },
      { id: "info_k4_t14", name: { de: "Präsentations-Regeln", en: "Presentation Rules", hu: "Prezentációs szabályok", ro: "Reguli de prezentare" }, questions: [], hasGenerator: false },
      { id: "info_k4_t15", name: { de: "Recherche (Suchbegriffe)", en: "Research (Search Terms)", hu: "Keresés (Keresőszavak)", ro: "Cercetare (Termeni de căutare)" }, questions: [], hasGenerator: false },
    ],
  },
  {
    ...
    color: "#8B5CF6",
    subtopics: [
      { id: "info_k4_t16", name: { de: "Wikipedia Kids", en: "Wikipedia Kids", hu: "Gyerek Wikipédia", ro: "Wikipedia Kids" }, questions: [], hasGenerator: false },
      { id: "info_k4_t17", name: { de: "Quelle — ist sie vertrauenswürdig?", en: "Source — is it reliable?", hu: "Forrás — megbízható?", ro: "Sursa — este de încredere?" }, questions: [], hasGenerator: false },
      { id: "info_k4_t18", name: { de: "Digitaler Fußabdruck", en: "Digital Footprint", hu: "Digitális lábnyom", ro: "Amprenta digitală" }, questions: [], hasGenerator: false },
      { id: "info_k4_t19", name: { de: "Sicherheit: starkes Passwort", en: "Security: Strong Password", hu: "Biztonság: erős jelszó", ro: "Securitate: Parolă puternică" }, questions: [], hasGenerator: false },
      { id: "info_k4_t20", name: { de: "Cybermobbing", en: "Cyberbullying", hu: "Számítógépes zaklatás", ro: "Hărțuire cibernetică" }, questions: [], hasGenerator: false },
    ],
  },
  {
    ...
    color: "#EC4899",
    subtopics: [
      { id: "info_k4_t21", name: { de: "Screenshot erweitert", en: "Advanced Screenshot", hu: "Haladó képernyőkép", ro: "Captură de ecran avansată" }, questions: [], hasGenerator: false },
      { id: "info_k4_t22", name: { de: "Cloud Grundlagen (Drive)", en: "Cloud Basics (Drive)", hu: "Felhő alapok (Drive)", ro: "Bazele Cloud (Drive)" }, questions: [], hasGenerator: false },
      { id: "info_k4_t23", name: { de: "Zusammenarbeit (Docs)", en: "Collaboration (Docs)", hu: "Együttműködés (Docs)", ro: "Colaborare (Docs)" }, questions: [], hasGenerator: false },
      { id: "info_k4_t24", name: { de: "Erste HTML", en: "First HTML", hu: "Első HTML", ro: "Primul HTML" }, questions: [], hasGenerator: false },
      { id: "info_k4_t25", name: { de: "Kreatives Projekt", en: "Creative Project", hu: "Kreatív projekt", ro: "Proiect creativ" }, questions: [], hasGenerator: false },
    ],
  }
];
