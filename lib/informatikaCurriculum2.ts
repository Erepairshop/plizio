...
export const INFO_K2_CURRICULUM: KemiaTheme[] = [
  {
    ...
    color: "#3B82F6",
    subtopics: [
      { id: "info_k2_t01", name: { de: "Symbole", en: "Icons", hu: "Ikonok", ro: "Pictograme" }, questions: [], hasGenerator: true },
      { id: "info_k2_t02", name: { de: "Schreibtisch", en: "Desktop", hu: "Asztal", ro: "Desktop" }, questions: [], hasGenerator: true },
      { id: "info_k2_t03", name: { de: "Ordner und Dateien", en: "Folders and Files", hu: "Mappák és fájlok", ro: "Dosare și fișiere" }, questions: [], hasGenerator: true },
      { id: "info_k2_t04", name: { de: "Doppelklick", en: "Double Click", hu: "Dupla kattintás", ro: "Dublu clic" }, questions: [], hasGenerator: true },
      { id: "info_k2_t05", name: { de: "Drag & Drop", en: "Drag & Drop", hu: "Fogd és vidd", ro: "Trage și plasează" }, questions: [], hasGenerator: true },
    ],
  },
  {
    ...
    color: "#10B981",
    subtopics: [
      { id: "info_k2_t06", name: { de: "Rechtsklick", en: "Right Click", hu: "Jobb kattintás", ro: "Clic dreapta" }, questions: [], hasGenerator: true },
      { id: "info_k2_t07", name: { de: "Großbuchstaben / Kleinbuchstaben", en: "Uppercase / Lowercase", hu: "Nagybetűk és kisbetűk", ro: "Majuscule / Minuscule" }, questions: [], hasGenerator: true },
      { id: "info_k2_t08", name: { de: "Zahlen-Tasten", en: "Number Keys", hu: "Számgombok", ro: "Taste numerice" }, questions: [], hasGenerator: true },
      { id: "info_k2_t09", name: { de: "Backspace / Delete", en: "Backspace / Delete", hu: "Törlés gombok", ro: "Taste de ștergere" }, questions: [], hasGenerator: true },
      { id: "info_k2_t10", name: { de: "Einfacher Texteditor", en: "Simple Text Editor", hu: "Egyszerű szövegszerkesztő", ro: "Editor de text simplu" }, questions: [], hasGenerator: true },
    ],
  },
  {
    ...
    color: "#F59E0B",
    subtopics: [
      { id: "info_k2_t11", name: { de: "Text speichern", en: "Save Text", hu: "Szöveg mentése", ro: "Salvare text" }, questions: [], hasGenerator: true },
      { id: "info_k2_t12", name: { de: "Datei öffnen", en: "Open File", hu: "Fájl megnyitása", ro: "Deschidere fișier" }, questions: [], hasGenerator: true },
      { id: "info_k2_t13", name: { de: "Malprogramm (Paint)", en: "Drawing Program (Paint)", hu: "Rajzprogram (Paint)", ro: "Program de desen (Paint)" }, questions: [], hasGenerator: true },
      { id: "info_k2_t14", name: { de: "Werkzeuge (Pinsel, Radiergummi)", en: "Tools (Brush, Eraser)", hu: "Eszközök (Ecset, Radír)", ro: "Instrumente (Pensulă, Radieră)" }, questions: [], hasGenerator: true },
      { id: "info_k2_t15", name: { de: "Zeichnung speichern", en: "Save Drawing", hu: "Rajz mentése", ro: "Salvare desen" }, questions: [], hasGenerator: true },
    ],
  },
  {
    id: "info_k2_funkciok",
    ...
    color: "#8B5CF6",
    subtopics: [
      { id: "info_k2_t16", name: { de: "Farben beim Zeichnen", en: "Colors in Drawing", hu: "Színek a rajzolásnál", ro: "Culori în desen" }, questions: [], hasGenerator: true },
      { id: "info_k2_t17", name: { de: "Drucken Grundlagen", en: "Printing Basics", hu: "Nyomtatás alapjai", ro: "Bazele imprimării" }, questions: [], hasGenerator: true },
      { id: "info_k2_t18", name: { de: "Kopieren / Einfügen", en: "Copy / Paste", hu: "Másolás és beillesztés", ro: "Copiere / Lipire" }, questions: [], hasGenerator: true },
      { id: "info_k2_t19", name: { de: "Papierkorb", en: "Recycle Bin", hu: "Lomtár", ro: "Coș de reciclare" }, questions: [], hasGenerator: true },
      { id: "info_k2_t20", name: { de: "Suchen (Strg+F)", en: "Search (Ctrl+F)", hu: "Keresés", ro: "Căutare (Ctrl+F)" }, questions: [], hasGenerator: true },
    ],
  },
  {
    id: "info_k2_kreativ",
    ...
    color: "#EC4899",
    subtopics: [
      { id: "info_k2_t21", name: { de: "Spielend lernen", en: "Learning by Playing", hu: "Játékos tanulás", ro: "Învățare prin joc" }, questions: [], hasGenerator: true },
      { id: "info_k2_t22", name: { de: "Audioprogramm", en: "Audio Program", hu: "Audióprogram", ro: "Program audio" }, questions: [], hasGenerator: true },
      { id: "info_k2_t23", name: { de: "Bilder aus dem Internet", en: "Images from the Internet", hu: "Képek az internetről", ro: "Imagini de pe internet" }, questions: [], hasGenerator: true },
      { id: "info_k2_t24", name: { de: "Form / Größe im Bild", en: "Shape / Size in Image", hu: "Forma és méret a képen", ro: "Formă / Dimensiune în imagine" }, questions: [], hasGenerator: true },
      { id: "info_k2_t25", name: { de: "Gruppieren", en: "Grouping", hu: "Csoportosítás", ro: "Grupare" }, questions: [], hasGenerator: true },
    ],
  }
];
