...
export const WORLD_ZONES: WorldZone[] = [
  { id: "mountain", name: "Hegyvidék", emoji: "🏔️", games: ["numberpath", "pathbuilder", "topicsort", "pipeflow", "deductiongrid", "timeecho", "shadowswitch", "minisudoku"], color: "#64748b", glow: "rgba(100,116,139,0.4)" },
  ...
  { id: "desert",   name: "Sivatag",   emoji: "🏜️", games: ["mathtest", "numberrush", "signaldecoder"],    color: "#f59e0b", glow: "rgba(245,158,11,0.4)" },
