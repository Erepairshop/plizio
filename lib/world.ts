...
export const WORLD_ZONES: WorldZone[] = [
  { id: "mountain", name: "Hegyvidék", emoji: "🏔️", games: ["kodex", "wordscramble"], color: "#64748b", glow: "rgba(100,116,139,0.4)" },
  ...
  { id: "forest",   name: "Erdő",      emoji: "🌲", games: ["mathtest", "numberrush"], color: "#22c55e", glow: "rgba(34,197,94,0.4)" },
  { id: "desert",   name: "Sivatag",   emoji: "🏜️", games: ["wordhunt", "sequencerush"], color: "#f59e0b", glow: "rgba(245,158,11,0.4)" },
  { id: "volcano",  name: "Vulkán",    emoji: "🌋", games: ["milliomos", "quickpick"], color: "#ef4444", glow: "rgba(239,68,68,0.4)" },
];
...
/** Egy zóna akkor érhető el, ha az előtte lévő teljesítve van, vagy ez az első. */
