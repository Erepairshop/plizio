...
export const WORLD_ZONES: WorldZone[] = [
  { id: "mountain", name: "Hegyvidék", emoji: "🏔️", games: ["numberpath", "pathbuilder", "topicsort", "pipeflow", "deductiongrid", "timeecho", "shadowswitch", "minisudoku", "signaldecoder"], color: "#64748b", glow: "rgba(100,116,139,0.4)" },
