...
export function generateIslandQuestionsInfoK1(island: IslandDef, count = 10) {
  return generateIslandQuestions(island, getInfoK1Questions, count);
}

export function generateCheckpointQuestionsInfoK1(testId: string, count = 15) {
  return generateCheckpointQuestions(INFO_K1_CHECKPOINT_TOPICS, testId, getInfoK1Questions, count);
}
