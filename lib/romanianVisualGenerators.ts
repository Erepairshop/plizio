...
const FEHLER_ORTOGRAFIE: FehlerItem[] = [
  ...
  { words: ["El", "a", "sințit", "frig", "afară."], errorIndex: 2, hint: "Corect: simțit.", question: "Găsește cuvântul scris greșit:" },
  ...
  // â/î errors
  { words: ["Mîine", "mergem", "la", "bunici."], errorIndex: 0, hint: "Corect: mâine (cu â în interior).", question: "Găsește cuvântul scris greșit:" },
...
const FAMILIE_CUVINTE_POOL: FamilieCuvintItem[] = [
  ...
  { stamm: "copil", options: ["copilărie", "copilăros", "adult", "copilăresc", "copilași", "bătrân"], correctIndices: [0, 1, 3, 4] },
...
const CRATIMA_FEHLER: FehlerItem[] = [
  { words: ["Eu", "mam", "dus", "la", "școală."], errorIndex: 1, hint: "Corect: m-am (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Ion", "sa", "trezit", "devreme."], errorIndex: 1, hint: "Corect: s-a (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Ei", "sau", "jucat", "în", "parc."], errorIndex: 1, hint: "Corect: s-au (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Noi", "neam", "întors", "acasă."], errorIndex: 1, hint: "Corect: ne-am (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Ana", "ia", "dat", "un", "cadou."], errorIndex: 1, hint: "Corect: i-a (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Ea", "intro", "zi", "a", "plecat."], errorIndex: 1, hint: "Corect: într-o (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Eu", "nam", "văzut", "filmul."], errorIndex: 1, hint: "Corect: n-am (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Tu", "vam", "așteptat", "mult."], errorIndex: 1, hint: "Corect: v-am (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Ea", "lam", "chemat", "pe", "Ion."], errorIndex: 1, hint: "Corect: l-am (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Maria", "mia", "spus", "adevărul."], errorIndex: 1, hint: "Corect: mi-a (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["El", "nui", "acasă", "acum."], errorIndex: 1, hint: "Corect: nu-i (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Am", "jucat", "dea", "baba-oarba."], errorIndex: 2, hint: "Corect: de-a (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Copilul", "cel", "bun", "sa", "întors."], errorIndex: 3, hint: "Corect: s-a (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Mama", "iam", "trimis", "o", "scrisoare."], errorIndex: 1, hint: "Corect: i-am (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
  { words: ["Noi", "vam", "scris", "o", "scrisoare."], errorIndex: 1, hint: "Corect: v-am (cu cratimă)", question: "Găsește cuvântul scris fără cratimă:" },
];
