...
export const PHYSIK_K5_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",              icon: "⭐", label: { en: "Forces Match",        hu: "Erők párosítása",         de: "Kraft-Paare",              ro: "Perechi forțe"          } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",              icon: "🕳️", label: { en: "Forces Challenge",    hu: "Erők kihívása",           de: "Kraft-Herausforderung",    ro: "Provocare forțe"        } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",            icon: "🌪️", label: { en: "Weight Sort",        hu: "Súly rendezése",          de: "Gewicht sortieren",        ro: "Sortează greutate"      } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",              icon: "🚀", label: { en: "Weight Quiz",         hu: "Súly kvíz",               de: "Gewichtsquiz",             ro: "Quiz greutate"          } },
    ],
    svgX: 90, svgY: 440,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",              icon: "🚀", label: { en: "Measurement Quiz",    hu: "Mérés kvíz",              de: "Messungsquiz",             ro: "Quiz măsurare"          } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",              icon: "⭐", label: { en: "Measure Match",       hu: "Mérés párosítása",        de: "Messungs-Paare",           ro: "Perechi măsurare"       } },
    ],
    svgX: 220, svgY: 360,
  },
  {
    ...
    missions: [
      ...
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle",              icon: "🕳️", label: { en: "Energy Challenge",    hu: "Energia kihívása",        de: "Energie-Herausforderung",  ro: "Provocare energie"      } },
    ],
    svgX: 100, svgY: 280,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",            icon: "🌪️", label: { en: "Energy Sort",        hu: "Energia rendezése",       de: "Energie sortieren",        ro: "Sortează energie"       } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "gap-fill-story",              icon: "🚀", label: { en: "Conversion Quiz",     hu: "Átalakulás kvíz",         de: "Umwandlungsquiz",          ro: "Quiz conversie"         } },
    ],
    svgX: 230, svgY: 200,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",              icon: "⭐", label: { en: "Heat Match",          hu: "Hő párosítása",           de: "Wärme-Paare",              ro: "Perechi căldură"        } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",              icon: "🕳️", label: { en: "Heat Challenge",      hu: "Hő kihívása",             de: "Wärme-Herausforderung",    ro: "Provocare căldură"      } },
    ],
    svgX: 120, svgY: 120,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",            icon: "🌪️", label: { en: "Light Sort",         hu: "Fény rendezése",          de: "Licht sortieren",          ro: "Sortează lumină"        } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",              icon: "⭐", label: { en: "Optics Match",        hu: "Optika párosítása",       de: "Optik-Paare",              ro: "Perechi optică"         } },
    ],
    svgX: 210, svgY: 40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain",              icon: "🚀", label: { en: "Sound Quiz",          hu: "Hang kvíz",               de: "Schallquiz",               ro: "Quiz sunet"             } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",              icon: "🕳️", label: { en: "Sound Challenge",     hu: "Hang kihívása",           de: "Schall-Herausforderung",   ro: "Provocare sunet"        } },
    ],
    svgX: 100, svgY: -40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",              icon: "⭐", label: { en: "Magnetic Match",      hu: "Mágneses párosítás",      de: "Magnet-Paare",             ro: "Perechi magnetic"       } },
