...
export const PHYSIK_K5_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Forces",        hu: "Erők tanulása",           de: "Kräfte lernen",            ro: "Înveți forțe"           } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Gravity",       hu: "Gravitáció tanulása",      de: "Schwerkraft lernen",      ro: "Înveți gravitație"      } },
      ...
      { id: "m3", category: "challenge", gameType: "star-match",   icon: "⭐", label: { en: "Weight Match",       hu: "Súly párosítása",         de: "Gewicht-Paare",          ro: "Perechi greutate"       } },
    ],
    svgX: 90, svgY: 440,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Measurement",   hu: "Mérés tanulása",          de: "Messung lernen",         ro: "Înveți măsurare"        } },
      { id: "m2", category: "build",     gameType: "star-match",   icon: "⭐", label: { en: "Measurement Match",   hu: "Mérés párosítása",        de: "Messungs-Paare",         ro: "Perechi măsurare"       } },
      { id: "m3", category: "challenge", gameType: "black-hole",   icon: "🕳️", label: { en: "Measure Challenge",   hu: "Mérés kihívása",          de: "Mess-Herausforderung",   ro: "Provocare măsurare"     } },
    ],
    svgX: 220, svgY: 360,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Energy",        hu: "Energia tanulása",        de: "Energie lernen",         ro: "Înveți energie"         } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Conversion",     hu: "Átalakulás tanulása",     de: "Umwandlung lernen",      ro: "Înveți conversie"       } },
      { id: "m2", category: "build",     gameType: "gravity-sort", icon: "🌪️", label: { en: "Conversion Sort",    hu: "Átalakulás rendezése",    de: "Umwandlung sortieren",   ro: "Sortează conversie"     } },
      { id: "m3", category: "challenge", gameType: "star-match",   icon: "⭐", label: { en: "Conversion Match",    hu: "Átalakulás párosítása",   de: "Umwandlungs-Paare",      ro: "Perechi conversie"      } },
    ],
    svgX: 230, svgY: 200,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Heat",          hu: "Hő tanulása",             de: "Wärme lernen",           ro: "Înveți căldură"         } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Light",         hu: "Fény tanulása",           de: "Licht lernen",           ro: "Înveți lumină"          } },
      ...
      { id: "m3", category: "challenge", gameType: "star-match",   icon: "⭐", label: { en: "Light Match",         hu: "Fény párosítása",         de: "Licht-Paare",            ro: "Perechi lumină"         } },
    ],
    svgX: 210, svgY: 40,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Sound",         hu: "Hang tanulása",           de: "Schall lernen",          ro: "Înveți sunet"           } },
      { id: "m2", category: "build",     gameType: "star-match",   icon: "⭐", label: { en: "Sound Match",         hu: "Hang párosítása",         de: "Schall-Paare",           ro: "Perechi sunet"          } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",   icon: "🔍", label: { en: "Learn Magnetism",     hu: "Mágnesesség tanulása",    de: "Magnetismus lernen",     ro: "Înveți magnetism"       } },
      { id: "m2", category: "build",     gameType: "gravity-sort", icon: "🌪️", label: { en: "Magnetic Sort",      hu: "Mágneses rendezése",      de: "Magnet sortieren",       ro: "Sortează magnetic"      } },
      { id: "m3", category: "challenge", gameType: "star-match",   icon: "⭐", label: { en: "Magnetic Match",      hu: "Mágneses párosítása",     de: "Magnet-Paare",           ro: "Perechi magnetic"       } },
    ],
    svgX: 190, svgY: -100,
  },
];
