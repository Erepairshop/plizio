...
export const G7_Generators_Hungarian = {
  ...
  hangvaltozas_typing: generateHangvaltozas_typing,
  "jovenényszó_haladó": generateJovenenyszszo,
  "jovenényszó_haladó_typing": generateJovenenyszszo_typing,
  "erveles_haladó": generateErvelesHalado,
  "erveles_haladó_typing": generateErvelesHalado_typing,
  "meggyozes_haladó": generateMeggyozesHalado,
  "meggyozes_haladó_typing": generateMeggyozesHalado_typing,
  stilusretegek: generateStilustorzetegek,
  stilusretegek_typing: generateStilustorzetegek_typing,
  szovegstilus: generateSzovegstilus,
  szovegstilus_typing: generateSzovegstilus_typing,
  tajnyelv: generateTajnyelv,
  tajnyelv_typing: generateTajnyelv_typing,
  ervelo_szoveg: generateErveloSzoveg,
  ervelo_szoveg_typing: generateErveloSzoveg_typing,
  tobbsz_osszetett: generateTobbszoroszszeretett,
  tobbsz_osszetett_typing: generateTobbszoroszszeretett_typing,
  verbalis: generateKommunikacioVerbalis,
  verbalis_typing: generateKommunikacioVerbalis_typing,
  mediaszoveg: generateMediaszoveg,
  mediaszoveg_typing: generateMediaszoveg_typing,
