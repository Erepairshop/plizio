import type { StarholdEventDefinition, StarholdState, StarholdEventId, StarholdModuleId, LocalizedString, StarholdPendingEvent, AvatarTraitId, StarholdAvatarAnswer } from "../types";
import { clamp, pushJournal } from "../shared";
import { GRAVITAS_TEXT } from "../content";
import { isDemoChapter } from "../chapter";
import { nextRandom } from "../rng";
import { AVATAR_TRAIT_TITLES, createAvatarPreparationEvent, appendAvatarAnswer, createAvatarProfile } from "./avatar";
import { createRepairChallenge } from "./repair";
...
export const STARHOLD_EVENTS: StarholdEventDefinition[] = [
  {
