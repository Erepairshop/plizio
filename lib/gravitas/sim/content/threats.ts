...
export const THREATS_TEXT = {
  ...
  meteorShower: { en: "Meteor Shower", hu: "Meteorzápor", de: "Meteorzápor", ro: "Ploaie de meteoriți" },
  ...
  finalWaveSpike: { en: "Stabilizer spike. Brace the shell.", hu: "Stabilizátor-tüske. Rögzítsd a testet.", de: "Stabilisatorspitze. Hülle sihern.", ro: "Vârf de stabilizator. Fixează corpul." },
