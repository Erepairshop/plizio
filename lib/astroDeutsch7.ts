...
export const K7_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore",  icon: "🪐", label: { de: "Konjunktiv I Quiz", en: "Subjunctive I Quiz", hu: "Konjunktív I kvíz", ro: "Quiz conjunctiv I" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore",  icon: "🪐", label: { de: "Passiv-Modal-Quiz", en: "Modal Passive Quiz", hu: "Modális szenvedő",  ro: "Quiz pasiv modal"  } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore",  icon: "🪐", label: { de: "Stilmittel-Quiz",   en: "Figures Quiz",     hu: "Stílus kvíz",       ro: "Quiz figuri"       } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore",  icon: "🪐", label: { de: "Temporal-Quiz",     en: "Temporal Quiz",    hu: "Időhatározói kvíz", ro: "Quiz temporale"    } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz", icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
  ...
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush", icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle", icon: "🌪️", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort", hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
    ],
    svgX: 190, svgY: -90,
  },
];
