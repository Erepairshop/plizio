...
// F = ma, weight = m × g, friction, v = d/t, a = Δv/Δt
...
function generateBernoulliTyping(lang = "en", seed = 0): CurriculumTyping[] {
  return [createTyping("forces", "bernoulli", q4("Bernoulli Principle?", "Bernoulli principle?", "Bernoulli elv?", "Principiul Bernoulli?", lang), 
    ...
    [q4("q = ½ρv²; wenn v=0 → Staudruck = P; Bernoulli-Energiegröße", "q = ½ρv²; when v=0 → stagnation pressure = P; Bernoulli energy term", "q = ½ρv²; ha v=0 → stagnációs nyomás = P; Bernoulli-energia tag", "q = ½ρv²; când v=0 → presiune de stagnare = P; termen Bernoulli", lang)]),
