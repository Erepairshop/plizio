...
const EN_THEMES: Record<number, ENThemeDef[]> = {
  ...
  4: [
    { key: 'g4_numbers', name: 'Numbers & Number System', color: '#3B82F6', icon: '🔢', topics: [
      { key: 'largeNumbers', name: 'Large Numbers (up to 1,000,000)', color: '#93C5FD', icon: '🔢', generators: [G4.placeValue, G4.placeValueBig, G4.largeNumbers] },
      { key: 'placeValueSystem', name: 'Place Value System', color: '#60A5FA', icon: '🔢', generators: [G4.placeValue, G4.placeValueBig, G4.largeNumbers] },
      { key: 'numberLineOrder', name: 'Number Line & Ordering Numbers', color: '#3B82F6', icon: '📊', generators: [G4.sequence, G4.roundingG4, G3.sequence] },
      { key: 'rounding', name: 'Rounding (10s, 100s, 1000s, 10,000s)', color: '#06B6D4', icon: '🔄', generators: [G4.roundingG4, G4.roundTo10000] },
      { key: 'place_value', name: 'Interactive Place Value Table', color: '#6366F1', icon: '🔢', generators: [] },
      { key: 'number_line', name: 'Rounding on the Number Line', color: '#14B8A6', icon: '🎯', generators: [] },
    ]},
    { key: 'g4_calc10000', name: 'Calculations up to 10,000', color: '#0EA5E9', icon: '🔢', topics: [
      { key: 'add10000', name: 'Addition up to 10,000', color: '#38BDF8', icon: '➕', generators: [G4.addTo10000, G4.mentalAdd10000] },
      { key: 'sub10000', name: 'Subtraction up to 10,000', color: '#0EA5E9', icon: '➖', generators: [G4.subTo10000, G4.mentalAdd10000] },
      { key: 'complete10000', name: 'Complete to 10,000', color: '#0284C7', icon: '🎯', generators: [G4.ergaenze10000] },
      { key: 'mental10000', name: 'Mental Arithmetic (round numbers)', color: '#0369A1', icon: '🧠', generators: [G4.mentalAdd10000] },
    ]},
    { key: 'g4_calc100000', name: 'Calculations up to 100,000', color: '#6366F1', icon: '🔢', topics: [
      { key: 'add100000', name: 'Addition up to 100,000', color: '#818CF8', icon: '➕', generators: [G4.addTo100000, G4.writtenAddLarge] },
      { key: 'sub100000', name: 'Subtraction up to 100,000', color: '#6366F1', icon: '➖', generators: [G4.subTo100000, G4.writtenSubLarge] },
      { key: 'place100000', name: 'Place Value up to 100,000', color: '#4F46E5', icon: '🔢', generators: [G4.placeValueBig, G4.largeNumbers] },
      { key: 'round100000', name: 'Round to 10,000s', color: '#4338CA', icon: '🔄', generators: [G4.roundTo10000, G4.roundingG4] },
    ]},
    { key: 'g4_coreops', name: 'Basic Operations', color: '#10B981', icon: '➕', topics: [
      { key: 'addSub', name: 'Addition & Subtraction (written)', color: '#34D399', icon: '➕', generators: [G4.addTo10000, G4.subTo10000, G4.addTo100000, G4.subTo100000] },
      { key: 'mul', name: 'Multiplication (written)', color: '#22C55E', icon: '✖️', generators: [G4.writtenMul, G4.writtenMulB] },
      { key: 'div', name: 'Division (written)', color: '#10B981', icon: '➗', generators: [G4.writtenDiv, G4.writtenDivB, G4.divTwoDigit] },
      { key: 'div_simple', name: 'Simple Division', color: '#10B981', icon: '➗', generators: [G4.divSimple] },
      { key: 'estimation', name: 'Estimate & Check', color: '#059669', icon: '🎯', generators: [G4.roundingG4, G4.roundTo10000, G4.mentalAdd10000] },
    ]},
    { key: 'g4_patterns', name: 'Number Patterns & Thinking', color: '#8B5CF6', icon: '🧩', topics: [
      { key: 'numberPatterns', name: 'Number Patterns & Sequences', color: '#A78BFA', icon: '🔗', generators: [G4.sequence, G3.sequence] },
      { key: 'strategies', name: 'Strategies (completing, mental math)', color: '#8B5CF6', icon: '🧠', generators: [G4.ergaenze10000, G4.mentalAdd10000, G4.roundingG4] },
      { key: 'sequence', name: 'Pattern Recognition Game', color: '#8B5CF6', icon: '🔗', generators: [] },
    ]},
    { key: 'g4_measurement', name: 'Measurement & Units', color: '#F59E0B', icon: '⚖️', topics: [
      { key: 'length', name: 'Length (mm, cm, m, km)', color: '#FBBF24', icon: '📏', generators: [G4.unitLengths, G4.unitLengthsWord] },
      { key: 'weight', name: 'Weight (g, kg, t)', color: '#F59E0B', icon: '⚖️', generators: [G4.weightOnly] },
      { key: 'time', name: 'Time (s, min, h, days)', color: '#EAB308', icon: '⏱️', generators: [G4.timeWord] },
      { key: 'moneyCalc', name: 'Money (€ , ct)', color: '#CA8A04', icon: '💰', generators: [G4.moneyWord] },
      { key: 'convertUnits', name: 'Convert Units', color: '#D97706', icon: '🔄', generators: [G4.units, G4.unitLengths, G4.weightOnly] },
      { key: 'drawing', name: 'Drawing Lengths & Shapes', color: '#06B6D4', icon: '✏️', generators: [] },
      { key: 'measuring', name: 'Measure with a Ruler', color: '#0EA5E9', icon: '📏', generators: [] },
      { key: 'clock_reading', name: 'Read the Clock', color: '#06D6D4', icon: '⏰', generators: [] },
      { key: 'timeline', name: 'Time Duration & Timeline', color: '#0D9488', icon: '⏱️', generators: [] },
      { key: 'money', name: 'Money & Shopping', color: '#22C55E', icon: '💰', generators: [] },
    ]},
    { key: 'g4_geometry', name: 'Geometry', color: '#EC4899', icon: '📐', topics: [
      { key: 'segments', name: 'Measure & Draw Line Segments', color: '#F472B6', icon: '📏', generators: [G4.perimeterOnly, G4.areaOnly] },
      { key: 'setSquare', name: 'Set Square (angles, parallels)', color: '#EC4899', icon: '📐', generators: [G4.winkelTyp, G4.winkelKlasse, G4.dreieckWinkel] },
      { key: 'compass', name: 'Compass (circle, radius)', color: '#DB2777', icon: '⭕', generators: [G4.circleSimple] },
      { key: 'symmetry', name: 'Symmetry & Reflection', color: '#BE185D', icon: '🪞', generators: [G4.symmetrieAchsen] },
      { key: 'angle', name: 'Draw & Measure Angles', color: '#EF4444', icon: '📐', generators: [] },
      { key: 'circle_draw', name: 'Draw a Circle with a Compass', color: '#F97316', icon: '⭕', generators: [] },
      { key: 'symmetry_game', name: 'Symmetry Reflection Game', color: '#EC4899', icon: '🪞', generators: [] },
    ]},
    { key: 'g4_area_perimeter', name: 'Area & Perimeter', color: '#F97316', icon: '📏', topics: [
      { key: 'perimeter', name: 'Perimeter (rectangle, square)', color: '#FB923C', icon: '📏', generators: [G4.perimeterOnly] },
      { key: 'area', name: 'Calculate Area', color: '#F97316', icon: '📐', generators: [G4.areaOnly] },
      { key: 'grid_area', name: 'Grid Counting: Area & Perimeter', color: '#F59E0B', icon: '📐', generators: [] },
      { key: 'fraction_pizza', name: 'Fractions with Pizza Models', color: '#F59E0B', icon: '🍕', generators: [] },
    ]},
    { key: 'g4_data', name: 'Data & Charts', color: '#06B6D4', icon: '📊', topics: [
      { key: 'tables', name: 'Read & Fill Tables', color: '#22D3EE', icon: '📈', generators: [G4.word1, G4.word2, G4.word3] },
      { key: 'charts', name: 'Read & Create Charts', color: '#06B6D4', icon: '📊', generators: [G4.word1, G4.word3, G4.volumeWord] },
    ]},
    { key: 'g4_wordproblems', name: 'Word Problems', color: '#EF4444', icon: '📖', topics: [
      { key: 'basicWordProblems', name: 'Basic Operation Problems', color: '#F87171', icon: '📖', generators: [G4.word1, G4.word2, G4.word3] },
      { key: 'measureWordProblems', name: 'Measurement & Money Problems', color: '#EF4444', icon: '📏', generators: [G4.volumeWord, G4.moneyWord, G4.unitLengthsWord] },
      { key: 'multiStep', name: 'Multi-step Problems', color: '#DC2626', icon: '🔢', generators: [G4.word1, G4.word2, G4.word3] },
    ]},
    { key: 'g4_astro_aliases', name: 'AstroMath Aliases', color: '#6366F1', icon: '🚀', topics: [
      ...
      { key: 'word',        name: 'Word Problems', color: '#EF4444', icon: '📖', generators: [G4.word1, G4.word2, G4.word3] },
    ]},
  ],
  5: [
...
const DE_THEMES: Record<number, ENThemeDef[]> = {
  ...
  6: [
    ...
    { key: 'g6_ratio', name: 'Verhältnis & Proportionen', color: '#10B981', icon: '⚡', topics: [
      ...
      { key: 'g6_ratio_inv',     name: 'Umgekehrte Proportionalität',             color: '#059669', icon: '↔️', generators: [G6.inverseRatio] },
...
const HU_THEMES: Record<number, ENThemeDef[]> = {
  ...
  2: [
    ...
    { key: 'g2_addition', name: 'Összeadás', color: '#10B981', icon: '➕', topics: [
      ...
      { key: 'g2_missing_add', name: 'Hiányzó tag megkeresése',           color: '#6EE7B7', icon: '❓', generators: [G2.missingAddend, G2.missing100] },
    ]},
    { key: 'g2_subtraction', name: 'Kivonás', color: '#EF4444', icon: '➖', topics: [
      ...
      { key: 'g2_sub_visual', name: 'Szemléletes kivonás (tárgyak megszámlálása)', color: '#FECACA', icon: '🍪', generators: [G2.countSub] },
    ]},
    { key: 'g2_mul', name: 'Szorzás alapjai', color: '#F59E0B', icon: '✖️', topics: [
      ...
      { key: 'g2_mul_visual', name: 'Szemléletes szorzás (tömbök)',            color: '#FEF3C7', icon: '🎯', generators: [G2.mulVisual, G2.mulGroup] },
    ]},
  ...
  4: [
    { key: 'g4_zahlen', name: 'Számok és számrendszer', color: '#3B82F6', icon: '🔢', topics: [
      { key: 'grosseZahlen', name: 'Nagy számok (1 000 000-ig)', color: '#93C5FD', icon: '🔢', generators: [G4.placeValue, G4.placeValueBig, G4.largeNumbers] },
      { key: 'stellenwert', name: 'Helyiértékrendszer', color: '#60A5FA', icon: '🔢', generators: [G4.placeValue, G4.placeValueBig, G4.largeNumbers] },
      { key: 'zahlenstrahl', name: 'Számegyenes és számok rendezése', color: '#3B82F6', icon: '📊', generators: [G4.sequence, G4.roundingG4, G3.sequence] },
      { key: 'runden', name: 'Kerekítés (10-esre, 100-asra, 1000-esre, 10 000-esre)', color: '#06B6D4', icon: '🔄', generators: [G4.roundingG4, G4.roundTo10000] },
      { key: 'place_value', name: 'Interaktív helyiértéktábla', color: '#6366F1', icon: '🔢', generators: [] },
      { key: 'number_line', name: 'Kerekítés a számegyenesen', color: '#14B8A6', icon: '🎯', generators: [] },
    ]},
    { key: 'g4_rechnen10000', name: 'Műveletek 10 000-ig', color: '#0EA5E9', icon: '🔢', topics: [
      { key: 'add10000', name: 'Összeadás 10 000-ig', color: '#38BDF8', icon: '➕', generators: [G4.addTo10000, G4.mentalAdd10000] },
      { key: 'sub10000', name: 'Kivonás 10 000-ig', color: '#0EA5E9', icon: '➖', generators: [G4.subTo10000, G4.mentalAdd10000] },
      { key: 'ergaenzen10000', name: 'Kiegészítés 10 000-re', color: '#0284C7', icon: '🎯', generators: [G4.ergaenze10000] },
      { key: 'kopfrechn10000', name: 'Fejszámolás (kerek számok)', color: '#0369A1', icon: '🧠', generators: [G4.mentalAdd10000] },
    ]},
    { key: 'g4_rechnen100000', name: 'Műveletek 100 000-ig', color: '#6366F1', icon: '🔢', topics: [
      { key: 'add100000', name: 'Összeadás 100 000-ig', color: '#818CF8', icon: '➕', generators: [G4.addTo100000, G4.writtenAddLarge] },
      { key: 'sub100000', name: 'Kivonás 100 000-ig', color: '#6366F1', icon: '➖', generators: [G4.subTo100000, G4.writtenSubLarge] },
      { key: 'stellen100000', name: 'Helyiérték 100 000-ig', color: '#4F46E5', icon: '🔢', generators: [G4.placeValueBig, G4.largeNumbers] },
      { key: 'runden100000', name: 'Kerekítés 10 000-esekre', color: '#4338CA', icon: '🔄', generators: [G4.roundTo10000, G4.roundingG4] },
    ]},
    { key: 'g4_grundrechenarten', name: 'Alapműveletek', color: '#10B981', icon: '➕', topics: [
      { key: 'addSub', name: 'Összeadás és kivonás (írásban)', color: '#34D399', icon: '➕', generators: [G4.addTo10000, G4.subTo10000, G4.addTo100000, G4.subTo100000] },
      { key: 'mul', name: 'Szorzás (írásban)', color: '#22C55E', icon: '✖️', generators: [G4.writtenMul, G4.writtenMulB] },
      { key: 'div', name: 'Osztás (írásban)', color: '#10B981', icon: '➗', generators: [G4.writtenDiv, G4.writtenDivB, G4.divTwoDigit] },
      { key: 'div_simple', name: 'Egyszerű osztás', color: '#10B981', icon: '➗', generators: [G4.divSimple] },
      { key: 'ueberschlagen', name: 'Becslés és közelítő számítás', color: '#059669', icon: '🎯', generators: [G4.roundingG4, G4.roundTo10000, G4.mentalAdd10000] },
    ]},
    { key: 'g4_struktur', name: 'Számstruktúra és gondolkodás', color: '#8B5CF6', icon: '🧩', topics: [
      { key: 'zahlenfolgen', name: 'Számsorozatok és minták', color: '#A78BFA', icon: '🔗', generators: [G4.sequence, G3.sequence] },
      { key: 'rechenstrategien', name: 'Számolási stratégiák', color: '#8B5CF6', icon: '🧠', generators: [G4.ergaenze10000, G4.mentalAdd10000, G4.roundingG4] },
      { key: 'sequence', name: 'Mintafelismerő játék', color: '#8B5CF6', icon: '🔗', generators: [] },
    ]},
    { key: 'g4_groessen', name: 'Mértékek és mérés', color: '#F59E0B', icon: '⚖️', topics: [
      { key: 'laenge', name: 'Hosszúság (mm, cm, m, km)', color: '#FBBF24', icon: '📏', generators: [G4.unitLengths, G4.unitLengthsWord] },
      { key: 'gewicht', name: 'Tömeg (g, kg, t)', color: '#F59E0B', icon: '⚖️', generators: [G4.weightOnly] },
      { key: 'zeit', name: 'Idő (mp, perc, óra, nap)', color: '#EAB308', icon: '⏱️', generators: [G4.timeWord] },
      { key: 'geld', name: 'Pénz', color: '#CA8A04', icon: '💰', generators: [G4.moneyWord] },
      { key: 'umwandeln', name: 'Mértékegységek átváltása', color: '#D97706', icon: '🔄', generators: [G4.units, G4.unitLengths, G4.weightOnly] },
      { key: 'zeichnen', name: 'Rajzolás: hosszúságok és alakzatok', color: '#06B6D4', icon: '✏️', generators: [] },
      { key: 'messen', name: 'Mérés vonalzóval', color: '#0EA5E9', icon: '📏', generators: [] },
      { key: 'uhrzeit', name: 'Óraleolvasás', color: '#06D6D4', icon: '⏰', generators: [] },
      { key: 'timeline', name: 'Időtartam és idővonal', color: '#0D9488', icon: '⏱️', generators: [] },
      { key: 'money', name: 'Pénz és vásárlás', color: '#22C55E', icon: '💰', generators: [] },
    ]},
    { key: 'g4_geo', name: 'Geometria', color: '#EC4899', icon: '📐', topics: [
      { key: 'strecken', name: 'Szakaszok mérése és rajzolása', color: '#F472B6', icon: '📏', generators: [G4.perimeterOnly, G4.areaOnly] },
      { key: 'geodreieck', name: 'Szögek és párhuzamosok', color: '#EC4899', icon: '📐', generators: [G4.winkelTyp, G4.winkelKlasse, G4.dreieckWinkel] },
      { key: 'zirkel', name: 'Körző: kör és sugár', color: '#DB2777', icon: '⭕', generators: [G4.circleSimple] },
      { key: 'symmetrie', name: 'Szimmetria és tükrözés', color: '#BE185D', icon: '🪞', generators: [G4.symmetrieAchsen] },
      { key: 'angle', name: 'Szögek rajzolása és mérése', color: '#EF4444', icon: '📐', generators: [] },
      { key: 'circle_draw', name: 'Kör rajzolása körzővel', color: '#F97316', icon: '⭕', generators: [] },
      { key: 'symmetry', name: 'Szimmetriai tükrözés', color: '#EC4899', icon: '🪞', generators: [] },
    ]},
    { key: 'g4_flaeche', name: 'Terület és kerület', color: '#F97316', icon: '📏', topics: [
      { key: 'umfang', name: 'Kerület (téglalap, négyzet)', color: '#FB923C', icon: '📏', generators: [G4.perimeterOnly] },
      { key: 'flaeche', name: 'Területszámítás', color: '#F97316', icon: '📐', generators: [G4.areaOnly] },
      { key: 'grid_area', name: 'Terület és kerület rácson', color: '#F59E0B', icon: '📐', generators: [] },
      { key: 'fraction_pizza', name: 'Törtek pizza-modellel', color: '#F59E0B', icon: '🍕', generators: [] },
    ]},
    { key: 'g4_daten', name: 'Adatok és diagramok', color: '#06B6D4', icon: '📊', topics: [
      { key: 'tabellen', name: 'Táblázatok olvasása és kitöltése', color: '#22D3EE', icon: '📈', generators: [G4.word1, G4.word2, G4.word3] },
      { key: 'diagramme', name: 'Diagramok olvasása és készítése', color: '#06B6D4', icon: '📊', generators: [G4.word1, G4.word3, G4.volumeWord] },
    ]},
    { key: 'g4_sachaufgaben', name: 'Szöveges feladatok', color: '#EF4444', icon: '📖', topics: [
      { key: 'grundAufgaben', name: 'Alapműveletes szöveges feladatok', color: '#F87171', icon: '📖', generators: [G4.word1, G4.word2, G4.word3] },
      { key: 'messAufgaben', name: 'Méréses és pénzes feladatok', color: '#EF4444', icon: '📏', generators: [G4.volumeWord, G4.moneyWord, G4.unitLengthsWord] },
      { key: 'mehrschritt', name: 'Többlépéses feladatok', color: '#DC2626', icon: '🔢', generators: [G4.word1, G4.word2, G4.word3] },
    ]},
    { key: 'g4_astro_aliases', name: 'AstroMath aliasok', color: '#6366F1', icon: '🚀', topics: [
      ...
      { key: 'fracArith', name: 'Törtek összeadása és kivonása', color: '#8B5CF6', icon: '½', generators: [G4.fractionAdd, G4.fractionSub] },
      { key: 'geo', name: 'Terület és kerület', color: '#FBBF24', icon: '📐', generators: [G4.geometry, G4.geometryB] },
  ...
  5: [
    ...
    { key: 'g5_frac', name: 'Törtek', color: '#6366F1', icon: '½', topics: [
      ...
      { key: 'g5_frac_mixed',   name: 'Vegyes számok',                            color: '#A5B4FC', icon: '🍕', generators: [G5.mixedNumber] },
  ...
  6: [
    ...
    { key: 'g6_ratio', name: 'Arány & Arányosság', color: '#10B981', icon: '⚡', topics: [
      ...
      { key: 'g6_ratio_inv',     name: 'Fordított arányosság',               color: '#059669', icon: '↔️', generators: [G6.inverseRatio] },
...
const RO_THEMES: Record<number, ENThemeDef[]> = {
  ...
  2: [
    ...
    { key: 'g2_addition', name: 'Adunare', color: '#10B981', icon: '➕', topics: [
      ...
      { key: 'g2_missing_add', name: 'Termenul lipsă',                        color: '#6EE7B7', icon: '❓', generators: [G2.missingAddend, G2.missing100] },
    ]},
    { key: 'g2_subtraction', name: 'Scădere', color: '#EF4444', icon: '➖', topics: [
      ...
      { key: 'g2_sub_visual', name: 'Scădere vizuală (numărare obiecte)', color: '#FECACA', icon: '🍪', generators: [G2.countSub] },
    ]},
    { key: 'g2_mul', name: 'Înmulțire (noțiuni de bază)', color: '#F59E0B', icon: '✖️', topics: [
      ...
      { key: 'g2_mul_visual', name: 'Înmulțire vizuală (tablouri)',     color: '#FEF3C7', icon: '🎯', generators: [G2.mulVisual, G2.mulGroup] },
    ]},
  ...
  4: [
    { key: 'g4_zahlen', name: 'Numere și sistem numeric', color: '#3B82F6', icon: '🔢', topics: [
      { key: 'grosseZahlen', name: 'Numere mari (până la 1 000 000)', color: '#93C5FD', icon: '🔢', generators: [G4.placeValue, G4.placeValueBig, G4.largeNumbers] },
      { key: 'stellenwert', name: 'Valoare pozițională', color: '#60A5FA', icon: '🔢', generators: [G4.placeValue, G4.placeValueBig, G4.largeNumbers] },
      { key: 'zahlenstrahl', name: 'Axa numerică și ordonarea numerelor', color: '#3B82F6', icon: '📊', generators: [G4.sequence, G4.roundingG4, G3.sequence] },
      { key: 'runden', name: 'Rotunjire (la 10, 100, 1000, 10 000)', color: '#06B6D4', icon: '🔄', generators: [G4.roundingG4, G4.roundTo10000] },
      { key: 'place_value', name: 'Tabel interactiv al valorii poziționale', color: '#6366F1', icon: '🔢', generators: [] },
      { key: 'number_line', name: 'Rotunjire pe axa numerică', color: '#14B8A6', icon: '🎯', generators: [] },
    ]},
    { key: 'g4_rechnen10000', name: 'Calcule până la 10 000', color: '#0EA5E9', icon: '🔢', topics: [
      { key: 'add10000', name: 'Adunare până la 10 000', color: '#38BDF8', icon: '➕', generators: [G4.addTo10000, G4.mentalAdd10000] },
      { key: 'sub10000', name: 'Scădere până la 10 000', color: '#0EA5E9', icon: '➖', generators: [G4.subTo10000, G4.mentalAdd10000] },
      { key: 'ergaenzen10000', name: 'Completare până la 10 000', color: '#0284C7', icon: '🎯', generators: [G4.ergaenze10000] },
      { key: 'kopfrechn10000', name: 'Calcul mental (numere rotunde)', color: '#0369A1', icon: '🧠', generators: [G4.mentalAdd10000] },
    ]},
    { key: 'g4_rechnen100000', name: 'Calcule până la 100 000', color: '#6366F1', icon: '🔢', topics: [
      { key: 'add100000', name: 'Adunare până la 100 000', color: '#818CF8', icon: '➕', generators: [G4.addTo100000, G4.writtenAddLarge] },
      { key: 'sub100000', name: 'Scădere până la 100 000', color: '#6366F1', icon: '➖', generators: [G4.subTo100000, G4.writtenSubLarge] },
      { key: 'stellen100000', name: 'Valoare pozițională până la 100 000', color: '#4F46E5', icon: '🔢', generators: [G4.placeValueBig, G4.largeNumbers] },
      { key: 'runden100000', name: 'Rotunjire la zeci de mii', color: '#4338CA', icon: '🔄', generators: [G4.roundTo10000, G4.roundingG4] },
    ]},
    { key: 'g4_grundrechenarten', name: 'Operații de bază', color: '#10B981', icon: '➕', topics: [
      { key: 'addSub', name: 'Adunare și scădere (în scris)', color: '#34D399', icon: '➕', generators: [G4.addTo10000, G4.subTo10000, G4.addTo100000, G4.subTo100000] },
      { key: 'mul', name: 'Înmulțire (în scris)', color: '#22C55E', icon: '✖️', generators: [G4.writtenMul, G4.writtenMulB] },
      ...
      { key: 'ueberschlagen', name: 'Estimare și verificare', color: '#059669', icon: '🎯', generators: [G4.roundingG4, G4.roundTo10000, G4.mentalAdd10000] },
    ]},
    { key: 'g4_struktur', name: 'Structuri numerice și gândire', color: '#8B5CF6', icon: '🧩', topics: [
      { key: 'zahlenfolgen', name: 'Șiruri de numere și modele', color: '#A78BFA', icon: '🔗', generators: [G4.sequence, G3.sequence] },
      { key: 'rechenstrategien', name: 'Strategii de calcul', color: '#8B5CF6', icon: '🧠', generators: [G4.ergaenze10000, G4.mentalAdd10000, G4.roundingG4] },
      { key: 'sequence', name: 'Joc de recunoaștere a modelelor', color: '#8B5CF6', icon: '🔗', generators: [] },
    ]},
    { key: 'g4_groessen', name: 'Măsuri și măsurare', color: '#F59E0B', icon: '⚖️', topics: [
      { key: 'laenge', name: 'Lungime (mm, cm, m, km)', color: '#FBBF24', icon: '📏', generators: [G4.unitLengths, G4.unitLengthsWord] },
      { key: 'gewicht', name: 'Greutate (g, kg, t)', color: '#F59E0B', icon: '⚖️', generators: [G4.weightOnly] },
      { key: 'zeit', name: 'Timp (s, min, h, zile)', color: '#EAB308', icon: '⏱️', generators: [G4.timeWord] },
      { key: 'geld', name: 'Bani', color: '#CA8A04', icon: '💰', generators: [G4.moneyWord] },
      { key: 'umwandeln', name: 'Conversia unităților', color: '#D97706', icon: '🔄', generators: [G4.units, G4.unitLengths, G4.weightOnly] },
      { key: 'zeichnen', name: 'Desenare: lungimi și forme', color: '#06B6D4', icon: '✏️', generators: [] },
      { key: 'messen', name: 'Măsurare cu rigla', color: '#0EA5E9', icon: '📏', generators: [] },
      { key: 'uhrzeit', name: 'Citirea ceasului', color: '#06D6D4', icon: '⏰', generators: [] },
      { key: 'timeline', name: 'Durată și linie a timpului', color: '#0D9488', icon: '⏱️', generators: [] },
      { key: 'money', name: 'Bani și cumpărături', color: '#22C55E', icon: '💰', generators: [] },
    ]},
    { key: 'g4_geo', name: 'Geometrie', color: '#EC4899', icon: '📐', topics: [
      { key: 'strecken', name: 'Măsurarea și desenarea segmentelor', color: '#F472B6', icon: '📏', generators: [G4.perimeterOnly, G4.areaOnly] },
      { key: 'geodreieck', name: 'Unghiuri și paralele', color: '#EC4899', icon: '📐', generators: [G4.winkelTyp, G4.winkelKlasse, G4.dreieckWinkel] },
      { key: 'zirkel', name: 'Compas: cerc și rază', color: '#DB2777', icon: '⭕', generators: [G4.circleSimple] },
      { key: 'symmetrie', name: 'Simetrie și reflexie', color: '#BE185D', icon: '🪞', generators: [G4.symmetrieAchsen] },
      { key: 'angle', name: 'Desenarea și măsurarea unghiurilor', color: '#EF4444', icon: '📐', generators: [] },
      { key: 'circle_draw', name: 'Desenează un cerc cu compasul', color: '#F97316', icon: '⭕', generators: [] },
      { key: 'symmetry', name: 'Joc de simetrie', color: '#EC4899', icon: '🪞', generators: [] },
    ]},
    { key: 'g4_flaeche', name: 'Arie și perimetru', color: '#F97316', icon: '📏', topics: [
      { key: 'umfang', name: 'Perimetru (dreptunghi, pătrat)', color: '#FB923C', icon: '📏', generators: [G4.perimeterOnly] },
      { key: 'flaeche', name: 'Calculul ariei', color: '#F97316', icon: '📐', generators: [G4.areaOnly] },
      { key: 'grid_area', name: 'Arie și perimetru pe grilă', color: '#F59E0B', icon: '📐', generators: [] },
      { key: 'fraction_pizza', name: 'Fracții cu model de pizza', color: '#F59E0B', icon: '🍕', generators: [] },
    ]},
    { key: 'g4_daten', name: 'Date și diagrame', color: '#06B6D4', icon: '📊', topics: [
      { key: 'tabellen', name: 'Citirea și completarea tabelelor', color: '#22D3EE', icon: '📈', generators: [G4.word1, G4.word2, G4.word3] },
      { key: 'diagramme', name: 'Citirea și crearea diagramelor', color: '#06B6D4', icon: '📊', generators: [G4.word1, G4.word3, G4.volumeWord] },
    ]},
    { key: 'g4_sachaufgaben', name: 'Probleme', color: '#EF4444', icon: '📖', topics: [
      { key: 'grundAufgaben', name: 'Probleme cu operații de bază', color: '#F87171', icon: '📖', generators: [G4.word1, G4.word2, G4.word3] },
      { key: 'messAufgaben', name: 'Probleme cu măsuri și bani', color: '#EF4444', icon: '📏', generators: [G4.volumeWord, G4.moneyWord, G4.unitLengthsWord] },
      { key: 'mehrschritt', name: 'Probleme în mai mulți pași', color: '#DC2626', icon: '🔢', generators: [G4.word1, G4.word2, G4.word3] },
    ]},
    { key: 'g4_astro_aliases', name: 'Aliasuri AstroMath', color: '#6366F1', icon: '🚀', topics: [
      ...
      { key: 'fracArith', name: 'Adunare și scădere fracții', color: '#8B5CF6', icon: '½', generators: [G4.fractionAdd, G4.fractionSub] },
      { key: 'geo', name: 'Arie și perimetru', color: '#FBBF24', icon: '📐', generators: [G4.geometry, G4.geometryB] },
  ...
  5: [
    ...
    { key: 'g5_frac', name: 'Fracții', color: '#6366F1', icon: '½', topics: [
      ...
      { key: 'g5_frac_mixed',   name: 'Numere mixte',                              color: '#A5B4FC', icon: '🍕', generators: [G5.mixedNumber] },
  ...
  6: [
    ...
    { key: 'g6_ratio', name: 'Rapoarte & Proporții', color: '#10B981', icon: '⚡', topics: [
      ...
      { key: 'g6_ratio_inv',     name: 'Proporționalitate inversă',           color: '#059669', icon: '↔️', generators: [G6.inverseRatio] },
