...
const EN_THEMES: Record<number, ENThemeDef[]> = {
  ...
  5: [
    { key: 'g5_zahlen', name: 'Numbers & Number System', color: '#3B82F6', icon: '🔢', topics: [
      { key: 'g5_z_million',  name: 'Natural Numbers up to 1,000,000',            color: '#60A5FA', icon: '🔢', generators: [G5.largeNumbers] },
      { key: 'g5_z_read',    name: 'Reading and Writing Numbers',                  color: '#93C5FD', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_z_compare', name: 'Comparing Numbers  (< · > · =)',               color: '#2563EB', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_z_order',   name: 'Ordering Numbers',                             color: '#1D4ED8', icon: '📊', generators: [G5.largeNumbers] },
      { key: 'g5_z_place',   name: 'Place Value',                                  color: '#3B82F6', icon: '🧱', generators: [G5.largeNumbers] },
      { key: 'g5_z_expand',  name: 'Expanded Form',                               color: '#60A5FA', icon: '🧩', generators: [G5.largeNumbers] },
      { key: 'g5_z_line',    name: 'Number Line',                                  color: '#93C5FD', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_z_neighbor','name': 'Neighboring Numbers',                        color: '#BFDBFE', icon: '↔️', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_round', name: 'Rounding & Estimation', color: '#06B6D4', icon: '🎯', topics: [
      { key: 'g5_rnd_10',    name: 'Rounding to Tens',                             color: '#22D3EE', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_100',   name: 'Rounding to Hundreds',                         color: '#06B6D4', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_1000',  name: 'Rounding to Thousands',                        color: '#0891B2', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_large', name: 'Rounding to Larger Places (10,000 · 100,000)', color: '#0E7490', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_est',   name: 'Estimation',                                   color: '#155E75', icon: '🤔', generators: [G5.roundHundreds] },
    ]},
    { key: 'g5_add', name: 'Addition', color: '#EF4444', icon: '➕', topics: [
      { key: 'g5_add_mental', name: 'Mental Addition',                             color: '#FCA5A5', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_add_written','name': 'Written Addition',                          color: '#EF4444', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_add_check',  name: 'Checking (Proof)',                            color: '#DC2626', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_add_word',   name: 'Word Problem (Addition)',                     color: '#B91C1C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_sub', name: 'Subtraction', color: '#F97316', icon: '➖', topics: [
      { key: 'g5_sub_mental', name: 'Mental Subtraction',                          color: '#FDBA74', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_sub_written','name': 'Written Subtraction',                       color: '#F97316', icon: '➖', generators: [G5.largeNumbers] },
      { key: 'g5_sub_check',  name: 'Checking (Proof)',                            color: '#EA580C', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_sub_word',   name: 'Word Problem (Subtraction)',                  color: '#C2410C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_mul', name: 'Multiplication', color: '#10B981', icon: '✖️', topics: [
      { key: 'g5_mul_mental', name: 'Mental Multiplication',                       color: '#6EE7B7', icon: '🧠', generators: [G5.orderOfOps, G5.orderOfOpsB] },
      { key: 'g5_mul_written','name': 'Written Multiplication (multi-digit)',       color: '#10B981', icon: '✖️', generators: [G5.orderOfOpsC] },
      { key: 'g5_mul_round',  name: 'Multiplying Round Numbers  (20 × 30)',        color: '#059669', icon: '🔄', generators: [G5.orderOfOps] },
      { key: 'g5_mul_pow10',  name: '×10, ×100, ×1000',                            color: '#047857', icon: '🔟', generators: [G5.orderOfOps] },
      { key: 'g5_mul_word',   name: 'Word Problem (Multiplication)',               color: '#065F46', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_div', name: 'Division', color: '#8B5CF6', icon: '➗', topics: [
      { key: 'g5_div_mental', name: 'Mental Division',                             color: '#C4B5FD', icon: '🧠', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_rem',    name: 'Division with Remainder',                     color: '#A78BFA', icon: '➗', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_written','name': 'Written Division',                          color: '#8B5CF6', icon: '📝', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_pow10',  name: '÷10, ÷100',                                  color: '#7C3AED', icon: '🔟', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_word',   name: 'Word Problem (Division)',                     color: '#6D28D9', icon: '📖', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_frac', name: 'Fractions', color: '#6366F1', icon: '½', topics: [
      { key: 'g5_frac_concept', name: 'Numerator and Denominator',                 color: '#818CF8', icon: '½', generators: [G5.fractionAdd] },
      { key: 'g5_frac_visual',  name: 'Representing Fractions',                    color: '#A5B4FC', icon: '🍕', generators: [G5.fractionAdd] },
      { key: 'g5_frac_compare', name: 'Comparing Fractions',                       color: '#6366F1', icon: '⚖️', generators: [G5.fractionAdd, G5.fractionSub] },
      { key: 'g5_frac_simplify','name': 'Simplifying Fractions',                   color: '#4F46E5', icon: '✂️', generators: [G5.gcd] },
      { key: 'g5_frac_equiv',   name: 'Equivalent Fractions  (2/4 = 1/2)',         color: '#4338CA', icon: '🔄', generators: [G5.fractionAdd] },
    ...
    { key: 'g5_decimal', name: 'Decimal Numbers', color: '#14B8A6', icon: '🔟', topics: [
      { key: 'g5_dec_concept', name: 'Reading and Writing Decimals',               color: '#5EEAD4', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_dec_compare', name: 'Comparing Decimals',                         color: '#14B8A6', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_dec_line',    name: 'Decimals on the Number Line',                color: '#0D9488', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_dec_add',     name: 'Adding Decimals',                            color: '#0F766E', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_dec_sub',     name: 'Subtracting Decimals',                       color: '#115E59', icon: '➖', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_units', name: 'Units of Measurement', color: '#F59E0B', icon: '📏', topics: [
      { key: 'g5_units_len',  name: 'Length  (km · m · cm · mm)',                  color: '#FCD34D', icon: '📏', generators: [G5.wordOps] },
      { key: 'g5_units_mass', name: 'Weight/Mass  (t · kg · g)',                   color: '#FBBF24', icon: '⚖️', generators: [G5.wordOps] },
      { key: 'g5_units_time', name: 'Time  (year · month · week · day · h · min · s)', color: '#F59E0B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_units_area', name: 'Area Units  (m² · cm²)',                      color: '#D97706', icon: '⬜', generators: [G5.geoRectArea] },
      { key: 'g5_units_money','name': 'Money  (€ · cents)',                        color: '#B45309', icon: '💶', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_geo', name: 'Geometry', color: '#EAB308', icon: '📐', topics: [
      { key: 'g5_geo_shapes', name: 'Properties of Shapes',                        color: '#FDE047', icon: '🔷', generators: [G5.geoRectArea] },
      { key: 'g5_geo_coord',  name: 'Coordinate System',                           color: '#EAB308', icon: '🗺️', generators: [G5.geoRectArea] },
      { key: 'g5_geo_nets',   name: 'Nets and Views',                              color: '#CA8A04', icon: '📦', generators: [G5.geoRectArea] },
    ]},
    { key: 'g5_angles', name: 'Angles', color: '#6366F1', icon: '∠', topics: [
      { key: 'g5_ang_concept', name: 'Angle Concepts',                             color: '#818CF8', icon: '∠', generators: [G4.winkelTyp] },
      { key: 'g5_ang_types',   name: 'Types of Angles  (acute · right · obtuse)',  color: '#6366F1', icon: '📐', generators: [G4.winkelKlasse] },
      { key: 'g5_ang_measure', name: 'Measuring Angles',                           color: '#4F46E5', icon: '📏', generators: [G4.winkelTyp] },
      { key: 'g5_ang_draw',    name: 'Drawing Angles',                             color: '#4338CA', icon: '✏️', generators: [G4.dreieckWinkel] },
    ]},
    { key: 'g5_perim', name: 'Perimeter', color: '#34D399', icon: '🔲', topics: [
      { key: 'g5_peri_shapes', name: 'Perimeter of Shapes',                        color: '#6EE7B7', icon: '🔲', generators: [G5.geoRectPerimeter, G5.geoSquarePerimeter] },
      { key: 'g5_peri_rect',   name: 'Rectangle and Square Perimeter',            color: '#34D399', icon: '⬜', generators: [G5.geoRectPerimeter] },
      { key: 'g5_peri_comp',   name: 'Compound Shapes',                           color: '#059669', icon: '🔷', generators: [G5.geoRectPerimeter] },
    ]},
    { key: 'g5_area', name: 'Area', color: '#FBBF24', icon: '⬛', topics: [
      { key: 'g5_area_sqcm',  name: 'Square Centimeters  (cm²)',                   color: '#FDE68A', icon: '⬛', generators: [G5.geoRectArea] },
      { key: 'g5_area_rect',  name: 'Area of a Rectangle',                        color: '#FBBF24', icon: '⬜', generators: [G5.geoRectArea] },
      { key: 'g5_area_square','name': 'Area of a Square',                         color: '#F59E0B', icon: '🟨', generators: [G5.geoRectArea] },
      { key: 'g5_area_conv',  name: 'Converting Area Units  (m² ↔ cm²)',           color: '#D97706', icon: '🔄', generators: [G5.geoRectArea] },
    ]},
    ...
    { key: 'g5_stats', name: 'Charts & Statistics', color: '#10B981', icon: '📊', topics: [
      { key: 'g5_stat_read',  name: 'Reading and Interpreting Charts',             color: '#6EE7B7', icon: '📊', generators: [G5.mean] },
      { key: 'g5_stat_mean',  name: 'Mean (Average)',                              color: '#10B981', icon: '📈', generators: [G5.mean] },
      { key: 'g5_stat_table', name: 'Tables and Frequencies',                      color: '#059669', icon: '📋', generators: [G5.mean] },
    ]},
    { key: 'g5_word', name: 'Word Problems', color: '#EF4444', icon: '📖', topics: [
      { key: 'g5_word_add',   name: 'Word Problems · Addition',                    color: '#FCA5A5', icon: '➕', generators: [G5.wordOps] },
      { key: 'g5_word_sub',   name: 'Word Problems · Subtraction',                 color: '#F87171', icon: '➖', generators: [G5.wordOps] },
      { key: 'g5_word_mul',   name: 'Word Problems · Multiplication',              color: '#EF4444', icon: '✖️', generators: [G5.wordOps] },
      { key: 'g5_word_div',   name: 'Word Problems · Division',                    color: '#DC2626', icon: '➗', generators: [G5.wordDiscount] },
      { key: 'g5_word_multi', name: 'Multi-step Problems',                         color: '#B91C1C', icon: '🔗', generators: [G5.wordDiscount, G5.wordOps] },
      { key: 'g5_word_time',  name: 'Time Word Problems',                          color: '#991B1B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_word_money', name: 'Money Word Problems',                         color: '#7F1D1D', icon: '💶', generators: [G5.wordDiscount] },
    ]},
  ],
  6: [
...
const DE_THEMES: Record<number, ENThemeDef[]> = {
  ...
  5: [
    { key: 'g5_zahlen', name: 'Zahlen und Zahlensystem', color: '#3B82F6', icon: '🔢', topics: [
      { key: 'g5_z_million',  name: 'Natürliche Zahlen bis 1 000 000',      color: '#60A5FA', icon: '🔢', generators: [G5.largeNumbers] },
      { key: 'g5_z_read',    name: 'Zahlen lesen und schreiben',             color: '#93C5FD', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_z_compare', name: 'Zahlen vergleichen  (< · > · =)',       color: '#2563EB', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_z_order',   name: 'Zahlen ordnen',                          color: '#1D4ED8', icon: '📊', generators: [G5.largeNumbers] },
      { key: 'g5_z_place',   name: 'Stellenwerte',                           color: '#3B82F6', icon: '🧱', generators: [G5.largeNumbers] },
      { key: 'g5_z_expand',  name: 'Zahlen zerlegen  (Stellenwertschreibweise)', color: '#60A5FA', icon: '🧩', generators: [G5.largeNumbers] },
      { key: 'g5_z_line',    name: 'Zahlenstrahl',                           color: '#93C5FD', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_z_neighbor','name': 'Vor- und Nachfolger',                  color: '#BFDBFE', icon: '↔️', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_round', name: 'Runden und Schätzen', color: '#06B6D4', icon: '🎯', topics: [
      { key: 'g5_rnd_10',    name: 'Runden auf Zehner',                      color: '#22D3EE', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_100',   name: 'Runden auf Hunderter',                   color: '#06B6D4', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_1000',  name: 'Runden auf Tausender',                   color: '#0891B2', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_large', name: 'Runden auf größere Stellen (10 000, 100 000)', color: '#0E7490', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_est',   name: 'Schätzen',                               color: '#155E75', icon: '🤔', generators: [G5.roundHundreds] },
    ]},
    { key: 'g5_add', name: 'Addition', color: '#EF4444', icon: '➕', topics: [
      { key: 'g5_add_mental', name: 'Kopfrechnen (Addition)',                 color: '#FCA5A5', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_add_written','name': 'Schriftliche Addition',                color: '#EF4444', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_add_check',  name: 'Probe und Überprüfen',                  color: '#DC2626', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_add_word',   name: 'Sachaufgabe (Addition)',                 color: '#B91C1C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_sub', name: 'Subtraktion', color: '#F97316', icon: '➖', topics: [
      { key: 'g5_sub_mental', name: 'Kopfrechnen (Subtraktion)',              color: '#FDBA74', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_sub_written','name': 'Schriftliche Subtraktion',             color: '#F97316', icon: '➖', generators: [G5.largeNumbers] },
      { key: 'g5_sub_check',  name: 'Probe und Überprüfen',                  color: '#EA580C', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_sub_word',   name: 'Sachaufgabe (Subtraktion)',              color: '#C2410C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_mul', name: 'Multiplikation', color: '#10B981', icon: '✖️', topics: [
      { key: 'g5_mul_mental', name: 'Kopfrechnen (Multiplikation)',           color: '#6EE7B7', icon: '🧠', generators: [G5.orderOfOps, G5.orderOfOpsB] },
      { key: 'g5_mul_written','name': 'Schriftliche Multiplikation',          color: '#10B981', icon: '✖️', generators: [G5.orderOfOpsC] },
      { key: 'g5_mul_round',  name: 'Runde Zahlen multiplizieren (20 · 30)', color: '#059669', icon: '🔄', generators: [G5.orderOfOps] },
      { key: 'g5_mul_pow10',  name: '×10, ×100, ×1000',                      color: '#047857', icon: '🔟', generators: [G5.orderOfOps] },
      { key: 'g5_mul_word',   name: 'Sachaufgabe (Multiplikation)',           color: '#065F46', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_div', name: 'Division', color: '#8B5CF6', icon: '➗', topics: [
      { key: 'g5_div_mental', name: 'Kopfrechnen (Division)',                 color: '#C4B5FD', icon: '🧠', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_rem',    name: 'Division mit Rest',                      color: '#A78BFA', icon: '➗', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_written','name': 'Schriftliche Division',                color: '#8B5CF6', icon: '📝', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_pow10',  name: '÷10, ÷100',                             color: '#7C3AED', icon: '🔟', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_word',   name: 'Sachaufgabe (Division)',                 color: '#6D28D9', icon: '📖', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_frac', name: 'Brüche', color: '#6366F1', icon: '½', topics: [
      { key: 'g5_frac_concept', name: 'Zähler und Nenner',                   color: '#818CF8', icon: '½', generators: [G5.fractionAdd] },
      { key: 'g5_frac_visual',  name: 'Brüche darstellen',                   color: '#A5B4FC', icon: '🍕', generators: [G5.fractionAdd] },
      { key: 'g5_frac_compare', name: 'Brüche vergleichen',                  color: '#6366F1', icon: '⚖️', generators: [G5.fractionAdd, G5.fractionSub] },
      { key: 'g5_frac_simplify','name': 'Brüche kürzen (Vereinfachen)',       color: '#4F46E5', icon: '✂️', generators: [G5.gcd] },
      { key: 'g5_frac_equiv',   name: 'Gleichwertige Brüche  (2/4 = 1/2)',   color: '#4338CA', icon: '🔄', generators: [G5.fractionAdd] },
    ...
    { key: 'g5_decimal', name: 'Dezimalzahlen', color: '#14B8A6', icon: '🔟', topics: [
      { key: 'g5_dec_concept', name: 'Dezimalzahlen lesen und schreiben',    color: '#5EEAD4', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_dec_compare', name: 'Dezimalzahlen vergleichen',            color: '#14B8A6', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_dec_line',    name: 'Dezimalzahlen am Zahlenstrahl',        color: '#0D9488', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_dec_add',     name: 'Dezimalzahlen addieren',               color: '#0F766E', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_dec_sub',     name: 'Dezimalzahlen subtrahieren',           color: '#115E59', icon: '➖', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_units', name: 'Maßeinheiten', color: '#F59E0B', icon: '📏', topics: [
      { key: 'g5_units_len',  name: 'Längenmaße  (km · m · cm · mm)',        color: '#FCD34D', icon: '📏', generators: [G5.wordOps] },
      { key: 'g5_units_mass', name: 'Gewicht/Masse  (t · kg · g)',           color: '#FBBF24', icon: '⚖️', generators: [G5.wordOps] },
      { key: 'g5_units_time', name: 'Zeitmaße  (Jahr · Monat · Woche · Tag · h · min · s)', color: '#F59E0B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_units_area', name: 'Flächenmaße  (m² · cm²)',              color: '#D97706', icon: '⬜', generators: [G5.geoRectArea] },
      { key: 'g5_units_money','name': 'Geldrechnung  (€ · Cent)',            color: '#B45309', icon: '💶', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_geo', name: 'Geometrie', color: '#EAB308', icon: '📐', topics: [
      { key: 'g5_geo_shapes', name: 'Eigenschaften ebener Figuren',          color: '#FDE047', icon: '🔷', generators: [G5.geoRectArea] },
      { key: 'g5_geo_coord',  name: 'Koordinatensystem',                     color: '#EAB308', icon: '🗺️', generators: [G5.geoRectArea] },
      { key: 'g5_geo_nets',   name: 'Netze und Ansichten',                   color: '#CA8A04', icon: '📦', generators: [G5.geoRectArea] },
    ]},
    { key: 'g5_angles', name: 'Winkel', color: '#6366F1', icon: '∠', topics: [
      { key: 'g5_ang_concept', name: 'Winkel: Grundbegriffe',                color: '#818CF8', icon: '∠', generators: [G4.winkelTyp] },
      { key: 'g5_ang_types',   name: 'Winkelarten  (spitz · recht · stumpf)', color: '#6366F1', icon: '📐', generators: [G4.winkelKlasse] },
      { key: 'g5_ang_measure', name: 'Winkel messen (Geodreieck)',           color: '#4F46E5', icon: '📏', generators: [G4.winkelTyp] },
      { key: 'g5_ang_draw',    name: 'Winkel zeichnen',                      color: '#4338CA', icon: '✏️', generators: [G4.dreieckWinkel] },
    ]},
    { key: 'g5_perim', name: 'Umfang', color: '#34D399', icon: '🔲', topics: [
      { key: 'g5_peri_shapes', name: 'Umfang von Figuren',                   color: '#6EE7B7', icon: '🔲', generators: [G5.geoRectPerimeter, G5.geoSquarePerimeter] },
      { key: 'g5_peri_rect',   name: 'Umfang Rechteck und Quadrat',         color: '#34D399', icon: '⬜', generators: [G5.geoRectPerimeter] },
      { key: 'g5_peri_comp',   name: 'Zusammengesetzte Figuren',            color: '#059669', icon: '🔷', generators: [G5.geoRectPerimeter] },
    ]},
    { key: 'g5_area', name: 'Flächeninhalt', color: '#FBBF24', icon: '⬛', topics: [
      { key: 'g5_area_sqcm',  name: 'Quadratzentimeter (cm²)',              color: '#FDE68A', icon: '⬛', generators: [G5.geoRectArea] },
      { key: 'g5_area_rect',  name: 'Flächeninhalt Rechteck',               color: '#FBBF24', icon: '⬜', generators: [G5.geoRectArea] },
      { key: 'g5_area_square','name': 'Flächeninhalt Quadrat',              color: '#F59E0B', icon: '🟨', generators: [G5.geoRectArea] },
      { key: 'g5_area_conv',  name: 'Flächenmaße umrechnen  (m² ↔ cm²)',   color: '#D97706', icon: '🔄', generators: [G5.geoRectArea] },
    ]},
    ...
    { key: 'g5_stats', name: 'Diagramme und Statistik', color: '#10B981', icon: '📊', topics: [
      { key: 'g5_stat_read',  name: 'Diagramme lesen und auswerten',        color: '#6EE7B7', icon: '📊', generators: [G5.mean] },
      { key: 'g5_stat_mean',  name: 'Mittelwert (Durchschnitt)',            color: '#10B981', icon: '📈', generators: [G5.mean] },
      { key: 'g5_stat_table', name: 'Tabellen und Häufigkeiten',            color: '#059669', icon: '📋', generators: [G5.mean] },
    ]},
    { key: 'g5_word', name: 'Sachaufgaben', color: '#EF4444', icon: '📖', topics: [
      { key: 'g5_word_add',   name: 'Sachaufgaben · Addition',              color: '#FCA5A5', icon: '➕', generators: [G5.wordOps] },
      { key: 'g5_word_sub',   name: 'Sachaufgaben · Subtraktion',           color: '#F87171', icon: '➖', generators: [G5.wordOps] },
      { key: 'g5_word_mul',   name: 'Sachaufgaben · Multiplikation',        color: '#EF4444', icon: '✖️', generators: [G5.wordOps] },
      { key: 'g5_word_div',   name: 'Sachaufgaben · Division',              color: '#DC2626', icon: '➗', generators: [G5.wordDiscount] },
      { key: 'g5_word_multi', name: 'Mehrstufige Aufgaben',                 color: '#B91C1C', icon: '🔗', generators: [G5.wordDiscount, G5.wordOps] },
      { key: 'g5_word_time',  name: 'Zeitaufgaben',                         color: '#991B1B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_word_money', name: 'Geldaufgaben',                         color: '#7F1D1D', icon: '💶', generators: [G5.wordDiscount] },
    ]},
  ],
  6: [
...
const HU_THEMES: Record<number, ENThemeDef[]> = {
  ...
  5: [
    { key: 'g5_zahlen', name: 'Számok és számrendszer', color: '#3B82F6', icon: '🔢', topics: [
      { key: 'g5_z_million',  name: 'Természetes számok millióig',                color: '#60A5FA', icon: '🔢', generators: [G5.largeNumbers] },
      { key: 'g5_z_read',    name: 'Számok olvasása és írása',                    color: '#93C5FD', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_z_compare', name: 'Összehasonlítás  (< · > · =)',                color: '#2563EB', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_z_order',   name: 'Rendezés',                                    color: '#1D4ED8', icon: '📊', generators: [G5.largeNumbers] },
      { key: 'g5_z_place',   name: 'Helyiérték',                                  color: '#3B82F6', icon: '🧱', generators: [G5.largeNumbers] },
      { key: 'g5_z_expand',  name: 'Felbontás helyiértékek szerint',              color: '#60A5FA', icon: '🧩', generators: [G5.largeNumbers] },
      { key: 'g5_z_line',    name: 'Számegyenes',                                 color: '#93C5FD', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_z_neighbor','name': 'Szomszédos számok',                         color: '#BFDBFE', icon: '↔️', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_round', name: 'Kerekítés és becslés', color: '#06B6D4', icon: '🎯', topics: [
      { key: 'g5_rnd_10',    name: 'Kerekítés tízesre',                           color: '#22D3EE', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_100',   name: 'Kerekítés százasra',                          color: '#06B6D4', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_1000',  name: 'Kerekítés ezresre',                           color: '#0891B2', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_large', name: 'Kerekítés nagyobb helyiértékre (10 000, 100 000)', color: '#0E7490', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_est',   name: 'Becslés',                                     color: '#155E75', icon: '🤔', generators: [G5.roundHundreds] },
    ]},
    { key: 'g5_add', name: 'Összeadás', color: '#EF4444', icon: '➕', topics: [
      { key: 'g5_add_mental', name: 'Fejben összeadás',                           color: '#FCA5A5', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_add_written','name': 'Írásbeli összeadás',                       color: '#EF4444', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_add_check',  name: 'Ellenőrzés (próba)',                         color: '#DC2626', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_add_word',   name: 'Szöveges feladat (összeadás)',               color: '#B91C1C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_sub', name: 'Kivonás', color: '#F97316', icon: '➖', topics: [
      { key: 'g5_sub_mental', name: 'Fejben kivonás',                             color: '#FDBA74', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_sub_written','name': 'Írásbeli kivonás',                         color: '#F97316', icon: '➖', generators: [G5.largeNumbers] },
      { key: 'g5_sub_check',  name: 'Ellenőrzés (próba)',                         color: '#EA580C', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_sub_word',   name: 'Szöveges feladat (kivonás)',                 color: '#C2410C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_mul', name: 'Szorzás', color: '#10B981', icon: '✖️', topics: [
      { key: 'g5_mul_mental', name: 'Fejbeli szorzás',                            color: '#6EE7B7', icon: '🧠', generators: [G5.orderOfOps, G5.orderOfOpsB] },
      { key: 'g5_mul_written','name': 'Írásbeli szorzás (többjegyű)',              color: '#10B981', icon: '✖️', generators: [G5.orderOfOpsC] },
      { key: 'g5_mul_round',  name: 'Kerek számok szorzása  (20 × 30)',           color: '#059669', icon: '🔄', generators: [G5.orderOfOps] },
      { key: 'g5_mul_pow10',  name: '×10, ×100, ×1000',                           color: '#047857', icon: '🔟', generators: [G5.orderOfOps] },
      { key: 'g5_mul_word',   name: 'Szöveges feladat (szorzás)',                 color: '#065F46', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_div', name: 'Osztás', color: '#8B5CF6', icon: '➗', topics: [
      { key: 'g5_div_mental', name: 'Fejbeli osztás',                             color: '#C4B5FD', icon: '🧠', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_rem',    name: 'Maradékos osztás',                           color: '#A78BFA', icon: '➗', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_written','name': 'Írásbeli osztás',                          color: '#8B5CF6', icon: '📝', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_pow10',  name: '÷10, ÷100',                                 color: '#7C3AED', icon: '🔟', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_word',   name: 'Szöveges feladat (osztás)',                  color: '#6D28D9', icon: '📖', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_frac', name: 'Törtek', color: '#6366F1', icon: '½', topics: [
      { key: 'g5_frac_concept', name: 'Számlál és nevező',                        color: '#818CF8', icon: '½', generators: [G5.fractionAdd] },
      { key: 'g5_frac_visual',  name: 'Törtek ábrázolása',                        color: '#A5B4FC', icon: '🍕', generators: [G5.fractionAdd] },
      ...
      { key: 'g5_frac_equiv',   name: 'Egyenlő törtek  (2/4 = 1/2)',              color: '#4338CA', icon: '🔄', generators: [G5.fractionAdd] },
    ...
    { key: 'g5_decimal', name: 'Tizedes számok', color: '#14B8A6', icon: '🔟', topics: [
      { key: 'g5_dec_concept', name: 'Tizedes számok fogalma, olvasása, írása',   color: '#5EEAD4', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_dec_compare', name: 'Tizedes számok összehasonlítása',           color: '#14B8A6', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_dec_line',    name: 'Tizedes számok a számegyenesen',            color: '#0D9488', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_dec_add',     name: 'Tizedes számok összeadása',                 color: '#0F766E', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_dec_sub',     name: 'Tizedes számok kivonása',                   color: '#115E59', icon: '➖', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_units', name: 'Mértékegységek', color: '#F59E0B', icon: '📏', topics: [
      { key: 'g5_units_len',  name: 'Hossz  (km · m · cm · mm)',                 color: '#FCD34D', icon: '📏', generators: [G5.wordOps] },
      { key: 'g5_units_mass', name: 'Súly/Tömeg  (t · kg · g)',                  color: '#FBBF24', icon: '⚖️', generators: [G5.wordOps] },
      { key: 'g5_units_time', name: 'Idő  (év · hónap · hét · nap · h · perc · s)', color: '#F59E0B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_units_area', name: 'Terület  (m² · cm²)',                       color: '#D97706', icon: '⬜', generators: [G5.geoRectArea] },
      { key: 'g5_units_money','name': 'Pénz  (Ft · fillér  /  € · cent)',        color: '#B45309', icon: '💶', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_geo', name: 'Geometria', color: '#EAB308', icon: '📐', topics: [
      { key: 'g5_geo_shapes', name: 'Síkidomok tulajdonságai',                    color: '#FDE047', icon: '🔷', generators: [G5.geoRectArea] },
      { key: 'g5_geo_coord',  name: 'Koordináta-rendszer',                        color: '#EAB308', icon: '🗺️', generators: [G5.geoRectArea] },
      { key: 'g5_geo_nets',   name: 'Hálók és nézetek',                           color: '#CA8A04', icon: '📦', generators: [G5.geoRectArea] },
    ]},
    ...
    { key: 'g5_perim', name: 'Kerület', color: '#34D399', icon: '🔲', topics: [
      ...
      { key: 'g5_peri_comp',   name: 'Összetett alakzatok kerülete',             color: '#059669', icon: '🔷', generators: [G5.geoRectPerimeter] },
    ]},
    { key: 'g5_area', name: 'Terület', color: '#FBBF24', icon: '⬛', topics: [
      ...
      { key: 'g5_area_square','name': 'Négyzet területe',                        color: '#F59E0B', icon: '🟨', generators: [G5.geoRectArea] },
      { key: 'g5_area_conv',  name: 'Területmértékek váltása  (m² ↔ cm²)',       color: '#D97706', icon: '🔄', generators: [G5.geoRectArea] },
    ]},
    ...
    { key: 'g5_stats', name: 'Diagramok és statisztika', color: '#10B981', icon: '📊', topics: [
      { key: 'g5_stat_read',  name: 'Diagramok olvasása és értelmezése',         color: '#6EE7B7', icon: '📊', generators: [G5.mean] },
      { key: 'g5_stat_mean',  name: 'Átlag (középérték)',                         color: '#10B981', icon: '📈', generators: [G5.mean] },
      { key: 'g5_stat_table', name: 'Táblázatok és gyakoriság',                  color: '#059669', icon: '📋', generators: [G5.mean] },
    ]},
    { key: 'g5_word', name: 'Szöveges feladatok', color: '#EF4444', icon: '📖', topics: [
      { key: 'g5_word_add',   name: 'Szöveges feladatok · összeadás',            color: '#FCA5A5', icon: '➕', generators: [G5.wordOps] },
      { key: 'g5_word_sub',   name: 'Szöveges feladatok · kivonás',              color: '#F87171', icon: '➖', generators: [G5.wordOps] },
      { key: 'g5_word_mul',   name: 'Szöveges feladatok · szorzás',              color: '#EF4444', icon: '✖️', generators: [G5.wordOps] },
      { key: 'g5_word_div',   name: 'Szöveges feladatok · osztás',               color: '#DC2626', icon: '➗', generators: [G5.wordDiscount] },
      { key: 'g5_word_multi', name: 'Többlépéses feladatok',                     color: '#B91C1C', icon: '🔗', generators: [G5.wordDiscount, G5.wordOps] },
      { key: 'g5_word_time',  name: 'Időszámítás',                               color: '#991B1B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_word_money', name: 'Pénzszámítás',                              color: '#7F1D1D', icon: '💶', generators: [G5.wordDiscount] },
    ]},
  ],
  6: [
...
const RO_THEMES: Record<number, ENThemeDef[]> = {
  ...
  5: [
    { key: 'g5_zahlen', name: 'Numere și sistemul numeric', color: '#3B82F6', icon: '🔢', topics: [
      { key: 'g5_z_million',  name: 'Numere naturale până la 1 000 000',           color: '#60A5FA', icon: '🔢', generators: [G5.largeNumbers] },
      { key: 'g5_z_read',    name: 'Citirea și scrierea numerelor',                color: '#93C5FD', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_z_compare', name: 'Compararea numerelor  (< · > · =)',            color: '#2563EB', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_z_order',   name: 'Ordonarea numerelor',                          color: '#1D4ED8', icon: '📊', generators: [G5.largeNumbers] },
      { key: 'g5_z_place',   name: 'Valoarea pozițională',                         color: '#3B82F6', icon: '🧱', generators: [G5.largeNumbers] },
      { key: 'g5_z_expand',  name: 'Descompunerea numerelor',                      color: '#60A5FA', icon: '🧩', generators: [G5.largeNumbers] },
      { key: 'g5_z_line',    name: 'Axa numerelor',                               color: '#93C5FD', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_z_neighbor','name': 'Vecinii unui număr',                         color: '#BFDBFE', icon: '↔️', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_round', name: 'Rotunjire și estimare', color: '#06B6D4', icon: '🎯', topics: [
      { key: 'g5_rnd_10',    name: 'Rotunjire la zeci',                            color: '#22D3EE', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_100',   name: 'Rotunjire la sute',                            color: '#06B6D4', icon: '🎯', generators: [G5.roundHundreds] },
      { key: 'g5_rnd_1000',  name: 'Rotunjire la mii',                             color: '#0891B2', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_large', name: 'Rotunjire la ordine superioare (10 000, 100 000)', color: '#0E7490', icon: '🎯', generators: [G5.largeNumbers] },
      { key: 'g5_rnd_est',   name: 'Estimare',                                     color: '#155E75', icon: '🤔', generators: [G5.roundHundreds] },
    ]},
    { key: 'g5_add', name: 'Adunare', color: '#EF4444', icon: '➕', topics: [
      { key: 'g5_add_mental', name: 'Calcul mintal (adunare)',                     color: '#FCA5A5', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_add_written','name': 'Adunare scrisă',                            color: '#EF4444', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_add_check',  name: 'Verificare (probă)',                          color: '#DC2626', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_add_word',   name: 'Problemă (adunare)',                          color: '#B91C1C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_sub', name: 'Scădere', color: '#F97316', icon: '➖', topics: [
      { key: 'g5_sub_mental', name: 'Calcul mintal (scădere)',                     color: '#FDBA74', icon: '🧠', generators: [G5.largeNumbers] },
      { key: 'g5_sub_written','name': 'Scădere scrisă',                            color: '#F97316', icon: '➖', generators: [G5.largeNumbers] },
      { key: 'g5_sub_check',  name: 'Verificare (probă)',                          color: '#EA580C', icon: '✅', generators: [G5.largeNumbers] },
      { key: 'g5_sub_word',   name: 'Problemă (scădere)',                          color: '#C2410C', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_mul', name: 'Înmulțire', color: '#10B981', icon: '✖️', topics: [
      { key: 'g5_mul_mental', name: 'Calcul mintal (înmulțire)',                   color: '#6EE7B7', icon: '🧠', generators: [G5.orderOfOps, G5.orderOfOpsB] },
      { key: 'g5_mul_written','name': 'Înmulțire scrisă (mai multe cifre)',         color: '#10B981', icon: '✖️', generators: [G5.orderOfOpsC] },
      { key: 'g5_mul_round',  name: 'Înmulțirea numerelor rotunde  (20 × 30)',     color: '#059669', icon: '🔄', generators: [G5.orderOfOps] },
      { key: 'g5_mul_pow10',  name: '×10, ×100, ×1000',                            color: '#047857', icon: '🔟', generators: [G5.orderOfOps] },
      { key: 'g5_mul_word',   name: 'Problemă (înmulțire)',                        color: '#065F46', icon: '📖', generators: [G5.wordOps] },
    ]},
    { key: 'g5_div', name: 'Împărțire', color: '#8B5CF6', icon: '➗', topics: [
      { key: 'g5_div_mental', name: 'Calcul mintal (împărțire)',                   color: '#C4B5FD', icon: '🧠', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_rem',    name: 'Împărțire cu rest',                           color: '#A78BFA', icon: '➗', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_written','name': 'Împărțire scrisă',                          color: '#8B5CF6', icon: '📝', generators: [G5.orderOfOpsD] },
      { key: 'g5_div_pow10',  name: '÷10, ÷100',                                  color: '#7C3AED', icon: '🔟', generators: [G5.orderOfOpsB] },
      { key: 'g5_div_word',   name: 'Problemă (împărțire)',                        color: '#6D28D9', icon: '📖', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_frac', name: 'Fracții', color: '#6366F1', icon: '½', topics: [
      { key: 'g5_frac_concept', name: 'Numărător și numitor',                      color: '#818CF8', icon: '½', generators: [G5.fractionAdd] },
      { key: 'g5_frac_visual',  name: 'Reprezentarea fracțiilor',                  color: '#A5B4FC', icon: '🍕', generators: [G5.fractionAdd] },
      ...
      { key: 'g5_frac_equiv',   name: 'Fracții echivalente  (2/4 = 1/2)',          color: '#4338CA', icon: '🔄', generators: [G5.fractionAdd] },
    ...
    { key: 'g5_decimal', name: 'Numere zecimale', color: '#14B8A6', icon: '🔟', topics: [
      { key: 'g5_dec_concept', name: 'Citirea și scrierea zecimalelor',            color: '#5EEAD4', icon: '📝', generators: [G5.largeNumbers] },
      { key: 'g5_dec_compare', name: 'Compararea zecimalelor',                     color: '#14B8A6', icon: '⚖️', generators: [G5.largeNumbers] },
      { key: 'g5_dec_line',    name: 'Zecimale pe axa numerelor',                 color: '#0D9488', icon: '📏', generators: [G5.largeNumbers] },
      { key: 'g5_dec_add',     name: 'Adunare zecimale',                           color: '#0F766E', icon: '➕', generators: [G5.largeNumbers] },
      { key: 'g5_dec_sub',     name: 'Scădere zecimale',                           color: '#115E59', icon: '➖', generators: [G5.largeNumbers] },
    ]},
    { key: 'g5_units', name: 'Unități de măsură', color: '#F59E0B', icon: '📏', topics: [
      { key: 'g5_units_len',  name: 'Lungime  (km · m · cm · mm)',                color: '#FCD34D', icon: '📏', generators: [G5.wordOps] },
      { key: 'g5_units_mass', name: 'Greutate/Masă  (t · kg · g)',                color: '#FBBF24', icon: '⚖️', generators: [G5.wordOps] },
      { key: 'g5_units_time', name: 'Timp  (an · lună · săpt. · zi · h · min · s)', color: '#F59E0B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_units_area', name: 'Arii  (m² · cm²)',                           color: '#D97706', icon: '⬜', generators: [G5.geoRectArea] },
      { key: 'g5_units_money','name': 'Bani  (lei · bani  /  € · cenți)',         color: '#B45309', icon: '💶', generators: [G5.wordDiscount] },
    ]},
    { key: 'g5_geo', name: 'Geometrie', color: '#EAB308', icon: '📐', topics: [
      { key: 'g5_geo_shapes', name: 'Proprietățile figurilor plane',               color: '#FDE047', icon: '🔷', generators: [G5.geoRectArea] },
      { key: 'g5_geo_coord',  name: 'Sistemul de coordonate',                      color: '#EAB308', icon: '🗺️', generators: [G5.geoRectArea] },
      { key: 'g5_geo_nets',   name: 'Rețele și vedere',                           color: '#CA8A04', icon: '📦', generators: [G5.geoRectArea] },
    ]},
    ...
    { key: 'g5_perim', name: 'Perimetru', color: '#34D399', icon: '🔲', topics: [
      ...
      { key: 'g5_peri_comp',   name: 'Figuri compuse',                            color: '#059669', icon: '🔷', generators: [G5.geoRectPerimeter] },
    ]},
    { key: 'g5_area', name: 'Arie', color: '#FBBF24', icon: '⬛', topics: [
      ...
      { key: 'g5_area_square','name': 'Aria pătratului',                          color: '#F59E0B', icon: '🟨', generators: [G5.geoRectArea] },
      { key: 'g5_area_conv',  name: 'Conversii arii  (m² ↔ cm²)',                 color: '#D97706', icon: '🔄', generators: [G5.geoRectArea] },
    ]},
    ...
    { key: 'g5_stats', name: 'Diagrame și statistică', color: '#10B981', icon: '📊', topics: [
      { key: 'g5_stat_read',  name: 'Citirea și interpretarea diagramelor',        color: '#6EE7B7', icon: '📊', generators: [G5.mean] },
      { key: 'g5_stat_mean',  name: 'Medie (valoare medie)',                       color: '#10B981', icon: '📈', generators: [G5.mean] },
      { key: 'g5_stat_table', name: 'Tabele și frecvențe',                         color: '#059669', icon: '📋', generators: [G5.mean] },
    ]},
    { key: 'g5_word', name: 'Probleme', color: '#EF4444', icon: '📖', topics: [
      { key: 'g5_word_add',   name: 'Probleme · adunare',                         color: '#FCA5A5', icon: '➕', generators: [G5.wordOps] },
      { key: 'g5_word_sub',   name: 'Probleme · scădere',                         color: '#F87171', icon: '➖', generators: [G5.wordOps] },
      { key: 'g5_word_mul',   name: 'Probleme · înmulțire',                       color: '#EF4444', icon: '✖️', generators: [G5.wordOps] },
      { key: 'g5_word_div',   name: 'Probleme · împărțire',                       color: '#DC2626', icon: '➗', generators: [G5.wordDiscount] },
      { key: 'g5_word_multi', name: 'Probleme cu mai mulți pași',                 color: '#B91C1C', icon: '🔗', generators: [G5.wordDiscount, G5.wordOps] },
      { key: 'g5_word_time',  name: 'Probleme cu timp',                           color: '#991B1B', icon: '⏱️', generators: [G5.wordOps] },
      { key: 'g5_word_money', name: 'Probleme cu bani',                           color: '#7F1D1D', icon: '💶', generators: [G5.wordDiscount] },
    ]},
  ],
  6: [
