...
export function generateFrictionTyping(lang: string = "en", seed: number = 0): CurriculumQuestion[] {
  return [
    ...
    createTyping("forces", "friction", q4("Was schafft Reibung zwischen Oberflächen?", "What creates friction between surfaces?", "Mi okozza a súrlódást a felületek között?", "Ce creează frecare între suprafețe?", "rough", "raue", "durva", "aspru", "Unebenheiten", "egyenetlenségek", "nereguli"]),
