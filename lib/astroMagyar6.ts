...
export const O6_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",  icon: "🪐", label: { hu: "Mondattípusok", en: "Sentence Types", de: "Satztypen", ro: "Tipuri de propoziții" } },
      { id: "m2", category: "build",     gameType: "gravity-sort", icon: "🪨", label: { hu: "Mondatok rendezése", en: "Sentence Sorting", de: "Satz-Sortierung", ro: "Sortare propoziții" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "star-match", icon: "⭐", label: { hu: "Szóképek párosítása", en: "Figure Matching", de: "Figuren-Match", ro: "Potrivire figuri" } },
      { id: "m2", category: "build",     gameType: "black-hole", icon: "🕳️", label: { hu: "Fekete lyuk", en: "Black Hole", de: "Schwarzes Loch", ro: "Gaură neagră" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "speed-round", icon: "⚡", label: { hu: "Szó verseny", en: "Word Race", de: "Wort-Rennen", ro: "Cursă cuvinte" } },
      { id: "m2", category: "build",     gameType: "star-match", icon: "⭐", label: { hu: "Szó párosítás", en: "Word Pairing", de: "Wort-Zuordnung", ro: "Potrivire cuvinte" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz", icon: "🪐", label: { hu: "Nyelvcsaládok", en: "Language Families", de: "Sprachfamilien", ro: "Familii limbă" } },
      { id: "m2", category: "build",     gameType: "star-match", icon: "⭐", label: { hu: "Nyelvek párosítása", en: "Language Pairing", de: "Sprachen-Match", ro: "Potrivire limbi" } },
      { id: "m3", category: "challenge", gameType: "gravity-sort", icon: "🪨", label: { hu: "Nyelvek rendezése", en: "Language Sorting", de: "Sprachen-Sortierung", ro: "Sortare limbi" } },
    ],
    svgX: 90, svgY: 270,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "speed-round", icon: "⚡", label: { hu: "Érvelés villám", en: "Argument Rush", de: "Argument-Blitz", ro: "Asalt argumente" } },
      { id: "m2", category: "build",     gameType: "orbit-quiz", icon: "🪐", label: { hu: "Érv kvíz", en: "Argument Quiz", de: "Argument-Quiz", ro: "Quiz argumente" } },
      { id: "m3", category: "challenge", gameType: "black-hole", icon: "🕳️", label: { hu: "Fekete lyuk", en: "Black Hole", de: "Schwarzes Loch", ro: "Gaură neagră" } },
    ],
    svgX: 220, svgY: 195,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz", icon: "🪐", label: { hu: "Szöveg kvíz", en: "Text Quiz", de: "Text-Quiz", ro: "Quiz text" } },
      { id: "m2", category: "build",     gameType: "gravity-sort", icon: "🪨", label: { hu: "Szövegek rendezése", en: "Text Sorting", de: "Text-Sortierung", ro: "Sortare texte" } },
      { id: "m3", category: "challenge", gameType: "speed-round", icon: "⚡", label: { hu: "Villámkör", en: "Speed Round", de: "Blitzrunde", ro: "Rundă rapidă" } },
    ],
    svgX: 100, svgY: 125,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "black-hole", icon: "🕳️", label: { hu: "Helyesírás fekete lyuk", en: "Spelling Black Hole", de: "Orthographie-Loch", ro: "Gaură ortografie" } },
      { id: "m2", category: "build",     gameType: "star-match", icon: "⭐", label: { hu: "Szavak párosítása", en: "Word Pairing", de: "Wort-Zuordnung", ro: "Potrivire cuvinte" } },
      { id: "m3", category: "challenge", gameType: "orbit-quiz", icon: "🪐", label: { hu: "Helyesírás kvíz", en: "Spelling Quiz", de: "Orthographie-Quiz", ro: "Quiz ortografie" } },
    ],
    svgX: 230, svgY: 55,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz", icon: "🪐", label: { hu: "Esszé típusok", en: "Essay Types", de: "Essay-Typen", ro: "Tipuri eseu" } },
      { id: "m2", category: "build",     gameType: "gravity-sort", icon: "🪨", label: { hu: "Esszék rendezése", en: "Essay Sorting", de: "Essay-Sortierung", ro: "Sortare eseuri" } },
      { id: "m3", category: "challenge", gameType: "speed-round", icon: "⚡", label: { hu: "Villámkör", en: "Speed Round", de: "Blitzrunde", ro: "Rundă rapidă" } },
    ],
    svgX: 80, svgY: -20,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "star-match", icon: "⭐", label: { hu: "Vegyes párosítás", en: "Mixed Pairing", de: "Gemischtes Match", ro: "Potrivire mixtă" } },
      { id: "m2", category: "build",     gameType: "orbit-quiz", icon: "🪐", label: { hu: "Nagy kvíz", en: "Grand Quiz", de: "Großes Quiz", ro: "Quiz mare" } },
      { id: "m3", category: "challenge", gameType: "gravity-sort", icon: "🪨", label: { hu: "Végső rendezés", en: "Final Sort", de: "Letzte Sortierung", ro: "Sortare finală" } },
    ],
    svgX: 190, svgY: -90,
  },
];
