...
export const PHYSIK_K7_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",                 icon: "⭐", label: { en: "Speed Match",          hu: "Sebesség párosítása",      de: "Geschwindigkeits-Paare",    ro: "Perechi viteză"          } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",                 icon: "🕳️", label: { en: "Speed Challenge",     hu: "Sebesség kihívása",        de: "Geschwindigkeits-Challenge", ro: "Provocare viteză"        } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",               icon: "🌪️", label: { en: "Forces Sort",         hu: "Erők rendezése",           de: "Kräfte sortieren",         ro: "Sortează forțe"          } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",                 icon: "🚀", label: { en: "Newton Quiz",         hu: "Newton kvíz",              de: "Newton-Quiz",              ro: "Quiz Newton"             } },
    ],
    svgX: 90, svgY: 440,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",                 icon: "🚀", label: { en: "Work Quiz",           hu: "Munka kvíz",               de: "Arbeitsquiz",              ro: "Quiz lucru"              } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",                 icon: "⭐", label: { en: "Power Match",         hu: "Teljesítmény párosítása",  de: "Leistungs-Paare",          ro: "Perechi putere"          } },
    ],
    svgX: 220, svgY: 360,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain",                 icon: "⭐", label: { en: "Energy Match",        hu: "Energia párosítása",       de: "Energie-Paare",            ro: "Perechi energie"         } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle",                 icon: "🕳️", label: { en: "Energy Challenge",    hu: "Energia kihívása",         de: "Energie-Challenge",        ro: "Provocare energie"        } },
    ],
    svgX: 100, svgY: 280,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",               icon: "🌪️", label: { en: "Optics Sort",         hu: "Optika rendezése",         de: "Optik sortieren",          ro: "Sortează optică"         } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "gap-fill-story",                 icon: "🚀", label: { en: "Lenses Quiz",        hu: "Lencsék kvíz",             de: "Linsen-Quiz",              ro: "Quiz lentile"            } },
    ],
    svgX: 230, svgY: 200,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",                 icon: "⭐", label: { en: "Instrument Match",    hu: "Eszköz párosítása",        de: "Instrument-Paare",         ro: "Perechi instrument"      } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",                 icon: "🕳️", label: { en: "Eye Challenge",      hu: "Szem kihívása",            de: "Augen-Challenge",          ro: "Provocare ochi"          } },
    ],
    svgX: 120, svgY: 120,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",               icon: "🌪️", label: { en: "Heat Sort",          hu: "Hő rendezése",             de: "Wärme sortieren",          ro: "Sortează căldură"        } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",                 icon: "⭐", label: { en: "Thermo Match",       hu: "Termodinamika párosítása", de: "Thermodynamik-Paare",      ro: "Perechi termodynamică"   } },
    ],
    svgX: 210, svgY: 40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain",                 icon: "🚀", label: { en: "Wave Quiz",          hu: "Hullám kvíz",              de: "Wellen-Quiz",              ro: "Quiz undă"               } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",                 icon: "🕳️", label: { en: "Spectrum Challenge",  hu: "Spektrum kihívása",        de: "Spektrum-Challenge",       ro: "Provocare spectru"       } },
    ],
    svgX: 100, svgY: -40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",                 icon: "⭐", label: { en: "Space Match",         hu: "Űr párosítása",            de: "Weltall-Paare",            ro: "Perechi spațiu"          } },
