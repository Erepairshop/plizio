...
function gen_cratima_avansata_c4(seed: number): CurriculumQuestion[] {
  ...
  const questionPool = [
    ...
    { q: "Cuvântul 'vice-rector' se scrie:", c: "cu cratimă", w: ["fără cratimă", "ca un singur cuvânt", "cu spațiu"] },
    ...
    { q: "Cuvântul 'vest-nord-vest' se scrie:", c: "cu cratimă la fiecare componentă", w: ["vestnordvest", "vest nord vest", "Vest-Nord-Vest"] },
    { q: "Cum se scrie corect pronumele atașat?", c: "ți-am dat", w: ["tiam dat", "ți am dat", "tiam-dat"] },
...
function gen_punctuatie_c4(seed: number): CurriculumQuestion[] {
  ...
  const questionPool = [
    ...
    { q: "Punct și virgulă (;) se folosește:", c: "între propoziții semicoordonate", w: ["în enumerări simple", "după vocativ", "înaintea ghilimelelor"] },
    { q: "Parentezele () se pun în jurul:", c: "informațiilor secundare", w: ["titlurilor", "vorbirii directe", "enumerărilor"] },
    { q: "Liniuța de întrerupere (-) se scrie:", c: "fără spații în jur", w: ["cu spații în jur", "cu cratimă", "cu liniuță lungă"] },
    ...
    { q: "Ghilimelele simple '' se folosesc pentru:", c: "citate în interiorul unui citat", w: ["citate principale", "titluri", "dialog"] },
    { q: "Care este punctuația corectă pentru un citat în interiorul altui citat?", c: "Se folosesc ghilimele simple în interiorul ghilimelelor", w: ["Se folosesc doar ghilimele duble", "Se folosesc paranteze ()", "Nu se folosesc ghilimele"] },
