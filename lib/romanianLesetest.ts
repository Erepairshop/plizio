...
// ─── CLASA 8 ─── (500-700 cuvinte · complexitate ridicată, analiză, eseuri)
const PASSAGES_CLASA_8: ReadingPassage[] = [
  {
    title: "Lecția de loialitate: Dincolo de instinct",
    text: "Relația dintre om și câine a fost adesea idealizată în literatură și cinematografie, însă realitatea trăită alături de un companion canin depășește orice scenariu ficțional prin profunzimea și complexitatea sa emoțională. Câinele meu, un Border Collie pe nume Argo, nu este doar un animal de companie, ci o oglindă a propriilor mele stări sufletești și un catalizator al maturizării mele. Border Collie este o rasă recunoscută pentru inteligența sa prodigioasă, dar Argo aduce ceva în plus: o empatie aproape telepatică. Într-o lume dominată de interacțiuni superficiale și digitale, prezența lui Argo reprezintă o ancoră în realitatea senzorială și afectivă. El nu are nevoie de cuvinte pentru a comunica; o simplă înclinare a capului sau o privire fixă sunt suficiente pentru a exprima o întreagă gamă de intenții. Loialitatea sa nu este una oarbă, ci pare a fi rezultatul unui parteneriat bazat pe respect reciproc și înțelegere. Îmi amintesc de o perioadă dificilă, marcată de stresul examenelor de capacitate, când Argo a refuzat să se mai joace, preferând să stea nemișcat lângă biroul meu ore în șir, oferindu-mi o susținere tăcută dar esențială. Această capacitate de a sacrifica propriile nevoi ludice pentru a fi alături de celălalt este o formă de altruism care ne provoacă să ne reevaluăm propria definiție a umanității. Mai mult, responsabilitatea de a îngriji o ființă atât de inteligentă m-a învățat disciplina și rigoarea. Plimbările zilnice, indiferent de condițiile meteorologice, nu sunt doar exerciții fizice, ci momente de meditație activă și de reconectare cu ritmurile naturii. Argo m-a învățat că loialitatea înseamnă prezență constantă, iar iubirea necondiționată este cel mai prețios dar pe care îl putem primi sau oferi. În final, Argo nu este doar 'câinele meu', ci un maestru discret al empatiei, care mă ajută să devin o versiune mai bună și mai atentă a mea însumi.",
    questions: [
      { type: "mcq", question: "Ce rasă este câinele Argo și pentru ce este recunoscută?", options: ["Golden Retriever - blândețe", "Border Collie - inteligență prodigioasă", "Ciobănesc German - pază", "Labrador - energie"], correct: 1 },
      { type: "mcq", question: "Cum este descrisă comunicarea lui Argo în text?", options: ["Zgomotoasă și agitată", "Exclusiv prin comenzi vocale", "Prin gesturi subtile și priviri pline de intenție", "Inexistentă"], correct: 2 },
      { type: "mcq", question: "Ce a învățat naratorul din responsabilitatea de a îngriji câinele?", options: ["Doar să se joace mai mult", "Disciplina, rigoarea și altruismul", "Să ignore vremea de afară", "Să devină un dresor profesionist"], correct: 1 },
      { type: "mcq", question: "Ce rol a avut Argo în perioada examenelor naratorului?", options: ["L-a distras de la învățat", "A oferit o susținere tăcută și esențială", "A ros cărțile de curs", "A dormit în altă cameră"], correct: 1 },
      { type: "mcq", question: "Care este concluzia naratorului despre Argo?", options: ["Este un simplu animal", "Este un maestru discret al empatiei", "Este o povară pentru familie", "Este un câine de pază feroce"], correct: 1 },
      { type: "typing", question: "Cum se numește câinele din text?", answer: "Argo" },
      { type: "typing", question: "Ce rasă de câine este menționată în text?", answer: "Border Collie" },
      { type: "typing", question: "Ce calitate a rasei Border Collie este evidențiată?", answer: "inteligența" }
    ],
  },
  {
    title: "Sanctuarul verde: O incursiune în filozofia pădurii",
    text: "Pădurea nu este doar un ansamblu de arbori și vegetație, ci un organism complex, un sistem viu care respiră și comunică prin rețele invizibile. O zi petrecută în inima pădurii se transformă rapid dintr-o simplă plimbare într-o experiență metafizică de regăsire a sinelui. Pe măsură ce pășești pe covorul de frunze moarte, simți cum zgomotul civilizației se estompează, fiind înlocuit de o liniște densă, vibrând de viață ascunsă. Arborii seculari, cu coroanele lor ce par să susțină cerul, impun un respect tăcut, amintindu-ne de efemeritatea existenței umane în raport cu timpul biologic al naturii. Biologii vorbesc astăzi despre 'Wood Wide Web', rețeaua de micorize prin care arborii schimbă nutrienți și informații, o formă de solidaritate vegetală care ar trebui să ne servească drept model. În pădure, fiecare element are un rol precis: de la mușchiul care indică nordul, până la ciocănitoarea care acționează ca un sanitar al pădurii. Observarea atentă a acestui ecosistem ne dezvăluie o ordine perfectă, un echilibru fragil pe care intervenția umană brutală îl poate distruge iremediabil. Aerul ionizat, mirosul de rășină și sunetul vântului printre cetini au un efect terapeutic dovedit, reducând nivelul de cortizol și clarificând gândurile. Pădurea ne învață răbdarea; un stejar are nevoie de decenii pentru a ajunge la maturitate, o lecție prețioasă într-o epocă a gratificării instantanee. În acest sanctuar verde, omul nu este un stăpân, ci un oaspete care trebuie să învețe din nou alfabetul naturii. Protejarea pădurilor nu este doar o necesitate ecologică, ci o datorie morală față de propria noastră sănătate spirituală și față de generațiile viitoare care merită să cunoască magia acestui univers nealterat.",
    questions: [
      { type: "mcq", question: "Ce concept științific este menționat pentru a descrie comunicarea arborilor?", options: ["Internetul vegetal", "Wood Wide Web (rețeaua de micorize)", "Fotosinteza colectivă", "Sistemul nervos al pădurii"], correct: 1 },
      { type: "mcq", question: "Cum este descris efectul terapeutic al pădurii asupra omului?", options: ["Crește nivelul de energie artificială", "Reduce cortizolul și clarifică gândurile", "Producerea de adrenalină", "Nu are niciun efect dovedit"], correct: 1 },
      { type: "mcq", question: "Ce lecție importantă ne oferă creșterea unui stejar?", options: ["Lecția vitezei", "Lecția răbdării", "Lecția competiției", "Lecția adaptării rapide"], correct: 1 },
      { type: "mcq", question: "Care este rolul omului în pădure, conform textului?", options: ["Stăpân absolut", "Exploatator de resurse", "Oaspete care trebuie să învețe alfabetul naturii", "Observator indiferent"], correct: 2 },
      { type: "mcq", question: "De ce este protejarea pădurii considerată o datorie morală?", options: ["Pentru a vinde lemnul mai târziu", "Pentru sănătatea spirituală și generațiile viitoare", "Pentru a construi parcuri de distracții", "Pentru a mări suprafața agricolă"], correct: 1 },
      { type: "typing", question: "Cum se numește rețeaua subterană de comunicare a arborilor?", answer: "Wood Wide Web" },
      { type: "typing", question: "Ce hormon al stresului este redus prin timpul petrecut în pădure?", answer: "cortizolul" },
      { type: "typing", question: "Ce pasăre este numită 'sanitarul pădurii'?", answer: "ciocănitoarea" }
    ],
  },
  {
    title: "Rădăcini și aripi: Bunicii și satul de altădată",
    text: "Vizita la bunicii de la țară reprezintă, pentru un adolescent de paisprezece ani, o călătorie în timp, o confruntare între modernitatea tehnologizată și tradiția ancestrală. Satul românesc, deși aflat într-un proces dureros de transformare, păstrează încă nuclee de autenticitate în curțile bunicilor noștri. Casa lor, cu pridvorul de lemn și grădina plină de flori de vară, este un spațiu al siguranței absolute. Bunicii sunt depozitarii unei înțelepciuni care nu se învață din manuale, ci din contactul direct cu pământul și cu ciclurile naturii. Bunicul, cu mâinile sale aspre ca scoarța de stejar, îmi povestește despre vremea când satul era un organism viu, unde ajutorul reciproc era legea nesfârșită a comunității. Bunica, în schimb, transformă gesturile cotidiene în ritualuri: frământatul pâinii, culesul plantelor de leac sau țesutul la război sunt activități care poartă în ele amprenta a zeci de generații. Există însă o melancolie difuză în privirea lor, văzând cum casele vecine rămân pustii și cum tinerii aleg mirajul orașelor străine. Această discrepanță între valorile lor statornice și dinamismul adesea haotic al lumii mele mă face să reflectez la propria identitate. Bunicii nu îmi oferă doar hrană sănătoasă și aer curat, ci îmi oferă 'rădăcini' – sentimentul apartenenței la un neam și la o istorie. În același timp, încurajările lor îmi oferă 'aripi' pentru a-mi urma propriul drum, amintindu-mi mereu de unde am plecat. Satul bunicilor este locul unde învăț că progresul nu trebuie să însemne uitare, ci o construcție nouă pe o fundație solidă. Plecarea de la ei este întotdeauna marcată de promisiunea de a reveni, nu doar ca vizitator, ci ca păstrător al unei moșteniri spirituale inestimabile.",
    questions: [
      { type: "mcq", question: "Cum este descrisă casa bunicilor în text?", options: ["O clădire modernă și rece", "Un spațiu al siguranței absolute, cu pridvor de lemn", "O ruină abandonată", "Un muzeu de istorie"], correct: 1 },
      { type: "mcq", question: "Ce reprezintă bunicii pentru narator?", options: ["Sursă de bani", "Depozitarii unei înțelepciuni ancestrale", "Oameni care nu înțeleg prezentul", "Simpli rude îndepărtate"], correct: 1 },
      { type: "mcq", question: "Ce cauzează melancolia bunicilor?", options: ["Vremea rea", "Pustiirea satului și plecarea tinerilor", "Lipsa tehnologiei", "Munca prea grea"], correct: 1 },
      { type: "mcq", question: "Ce metaforă folosește autorul pentru a descrie darul bunicilor?", options: ["Bani și haine", "Rădăcini și aripi", "Cărți și caiete", "Pâine și sare"], correct: 1 },
      { type: "mcq", question: "Care este lecția principală pe care naratorul o învață la sat?", options: ["Că agricultura este plictisitoare", "Că progresul nu trebuie să însemne uitare", "Că orașul este mai bun", "Că tradiția este inutilă"], correct: 1 },
      { type: "typing", question: "Din ce material este făcut pridvorul casei?", answer: "lemn" },
      { type: "typing", question: "Ce activitate a bunicii este menționată ca fiind un ritual?", answer: "frământatul pâinii" },
      { type: "typing", question: "Cum se numește satul în care locuiesc bunicii (generic)?", answer: "satul românesc" }
    ],
  },
  {
    title: "Pragul maturității: Prima zi de școală în clasa a VIII-a",
    text: "Prima zi de școală în clasa a VIII-a nu mai are inocența primelor clase primare, ci este marcată de o gravitate subtilă și de presiunea primului mare examen al vieții. Curtea școlii, deși plină de aceleași zâmbete și buchete de flori, pare acum un spațiu al deciziilor majore. Ne privim colegii și observăm nu doar schimbările fizice, ci și o maturizare a discursului și a preocupărilor. Clasa a VIII-a este un an al bilanțului și al proiecțiilor de viitor. Profesorii, care până mai ieri ne păreau doar ghizi în lumea cunoașterii, devin acum antrenori riguroși pentru Evaluarea Națională. Discursurile festive de la deschidere pun accent pe responsabilitate, perseverență și gestionarea stresului. Există o camaraderie aparte care se naște în acest ultim an de gimnaziu, o solidaritate a celor care știu că în curând drumurile lor se vor despărți spre licee diferite. Emoția nu mai este legată de necunoscutul rechizitelor noi, ci de incertitudinea opțiunilor de viitor. Fiecare oră de curs capătă o greutate sporită, iar pauzele devin spații de dezbatere despre medii de admitere și profiluri de studiu. Totuși, dincolo de presiunea academică, această zi este și una a recunoștinței pentru anii petrecuți împreună, pentru prieteniile consolidate și pentru profesorii care ne-au modelat caracterul. Este pragul dintre copilăria protejată și adolescența asumată. Prima zi de școală ne reamintește că educația nu este doar despre acumularea de informații, ci despre formarea capacității de a face alegeri conștiente. Pășim în clasă cu hotărârea de a transforma acest ultim an într-o reușită, conștienți că efortul de acum va deschide porțile viitorului nostru.",
    questions: [
      { type: "mcq", question: "Ce sentiment domină prima zi de școală în clasa a VIII-a?", options: ["Inocență totală", "Gravitate subtilă și presiunea examenelor", "Indiferență", "Plictiseală"], correct: 1 },
      { type: "mcq", question: "Cum se schimbă rolul profesorilor în acest an?", options: ["Devin mai relaxați", "Devin antrenori riguroși pentru Evaluarea Națională", "Nu se schimbă deloc", "Devin mai absenți"], correct: 1 },
      { type: "mcq", question: "Ce tip de solidaritate apare între elevi?", options: ["Solidaritatea împotriva școlii", "Solidaritatea celor care se pregătesc de despărțire spre licee diferite", "O competiție agresivă", "Nu există solidaritate"], correct: 1 },
      { type: "mcq", question: "Care este principala temă a discuțiilor din pauze?", options: ["Jocurile video", "Mediile de admitere și profilurile de liceu", "Vacanța de vară", "Mâncarea de la cantină"], correct: 1 },
      { type: "mcq", question: "Ce reprezintă clasa a VIII-a în parcursul unui elev?", options: ["Un an de odihnă", "Pragul dintre copilăria protejată și adolescența asumată", "O repetiție a clasei a VII-a", "Sfârșitul educației"], correct: 1 },
      { type: "typing", question: "Cum se numește examenul de la finalul clasei a VIII-a?", answer: "Evaluarea Națională" },
      { type: "typing", question: "Ce calitate este menționată ca fiind esențială în discursurile festive?", answer: "responsabilitatea" },
      { type: "typing", question: "În ce clasă sunt elevii din text?", answer: "clasa a VIII-a" }
    ],
  },
  {
    title: "Geometria sacră a tradiției: Paștele în Bucovina",
    text: "Sărbătoarea Paștelui în Bucovina depășește dimensiunea pur religioasă, devenind un spectacol al artei populare și al spiritualității profunde. Elementul central, care atrage admirația întregii lumi, este oul încondeiat – o adevărată bijuterie a geometriei sacre. Tehnica 'scrierii' ouălor cu ceară de albine necesită o precizie chirurgicală și o cunoaștere a simbolisticii ancestrale. Fiecare linie, punct sau formă geometrică are o semnificație: spicul de grâu pentru belșug, calea rătăcită pentru labirintul vieții sau crucea pentru credință. Culorile folosite, obținute tradițional din plante, vorbesc și ele: roșul pentru sânge și viață, galbenul pentru lumină și soare, negrul pentru eternitate. În Săptămâna Mare, satele bucovinene devin ateliere de creație unde bunicile transmit nepoatelor secretele acestui meșteșug. Dincolo de estetică, Paștele este marcat de ritualuri riguroase: curățenia sufletească prin post, sfințirea coșului pascal în dimineața Învierii și masa în familie unde ciocnitul ouălor devine un liant social. Atmosfera din noaptea de Înviere, când mii de lumânări se aprind în jurul mănăstirilor pictate, este de o solemnitate copleșitoare. Tradiția nu este aici un simplu vestigiu al trecutului, ci o formă de rezistență culturală și o modalitate de a păstra legătura cu divinitatea. Pentru tineri, participarea la aceste obiceiuri reprezintă o lecție de identitate și respect față de munca migăloasă a înaintașilor. Bucovina reușește să conserve acest echilibru fragil între sacru și profan, oferind lumii o lecție despre cum frumosul poate deveni o formă de rugăciune. Oul încondeiat rămâne simbolul acestei regiuni, o metaforă a vieții care renaște prin artă și credință.",
    questions: [
      { type: "mcq", question: "Care este elementul central al tradiției de Paște în Bucovina?", options: ["Cozonacul", "Oul încondeiat", "Iepurașul de Paște", "Mielul la proțap"], correct: 1 },
      { type: "mcq", question: "Ce material se folosește pentru 'scrierea' ouălor?", options: ["Vopsea acrilică", "Ceară de albine", "Cerneală", "Ulei"], correct: 1 },
      { type: "mcq", question: "Ce simbolizează 'spicul de grâu' pe un ou încondeiat?", options: ["Moartea", "Belșugul", "Soarele", "Apa"], correct: 1 },
      { type: "mcq", question: "Cum sunt obținute culorile tradiționale pentru ouă?", options: ["Din magazin", "Din plante", "Din minerale", "Din fructe de mare"], correct: 1 },
      { type: "mcq", question: "Ce reprezintă tradiția pentru locuitorii Bucovinei?", options: ["O povară", "O formă de rezistență culturală și legătură cu divinitatea", "O metodă de a face bani", "Un simplu spectacol pentru turiști"], correct: 1 },
      { type: "typing", question: "În ce regiune a României se află mănăstirile pictate menționate?", answer: "Bucovina" },
      { type: "typing", question: "Ce culoare simbolizează eternitatea pe ouăle încondeiate?", answer: "negrul" },
      { type: "typing", question: "Cum se numește tehnica decorării ouălor?", answer: "încondeiere" }
    ],
  },
  {
    title: "Oglinzile timpului: Personajele literaturii române moderne",
    text: "Literatura română modernă oferă o galerie fascinantă de personaje care nu sunt doar figuri de hârtie, ci arhetipuri ale condiției umane în contexte istorice turbulente. Analiza unor personaje precum Ilie Moromete din romanul lui Marin Preda sau Ion al lui Liviu Rebreanu ne permite să înțelegem mecanismele psihologice ale țăranului român aflat la răscrucea dintre tradiție și modernitate. Ilie Moromete reprezintă 'țăranul filozof', un spirit contemplativ care încearcă să păstreze unitatea familiei și a pământului prin ironie și disimulare. Drama sa este cea a contemplativului strivit de o istorie agresivă care nu mai are răbdare. Pe de altă parte, Ion este exponentul pasiunii devoratoare pentru pământ, o forță a naturii care își subordonează întreaga existență instinctului de posesiune. Conflictul său interior între 'glasul pământului' și 'glasul iubirii' este universal și tragic. În poezia lui Nichita Stănescu, personajul devine eul liric care explorează limitele limbajului și ale cunoașterii, transformând cuvântul în 'necuvânt'. Modernitatea acestor scriitori constă în capacitatea de a crea caractere complexe, contradictorii, care refuză simplificările morale. Studiul acestor personaje în clasa a VIII-a ne dezvoltă gândirea critică și empatia, învățându-ne să privim dincolo de aparențe. Ei sunt oglinzi în care ne reflectăm propriile dileme morale și sociale. Literatura devine astfel un laborator de analiză a sufletului uman, oferindu-ne instrumentele necesare pentru a naviga într-o lume tot mai complexă. Înțelegerea acestor destine literare este esențială pentru formarea unei culturi generale solide și pentru definirea propriilor noastre valori într-o societate în continuă schimbare.",
    questions: [
      { type: "mcq", question: "Cine este autorul romanului 'Moromeții'?", options: ["Liviu Rebreanu", "Marin Preda", "Ion Creangă", "Mihai Eminescu"], correct: 1 },
      { type: "mcq", question: "Cum este caracterizat Ilie Moromete în text?", options: ["Un țăran violent", "Un țăran filozof și contemplativ", "Un om de afaceri", "Un politician"], correct: 1 },
      { type: "mcq", question: "Care sunt cele două 'glasuri' care îl chinuie pe Ion?", options: ["Glasul banilor și al puterii", "Glasul pământului și glasul iubirii", "Glasul mamei și al tatălui", "Glasul mării și al muntelui"], correct: 1 },
      { type: "mcq", question: "Ce concept poetic a introdus Nichita Stănescu?", options: ["Poezia pură", "Necuvintele", "Simbolismul", "Pașoptismul"], correct: 1 },
      { type: "mcq", question: "De ce este important studiul acestor personaje?", options: ["Pentru a lua note mari", "Pentru dezvoltarea gândirii critice și a empatiei", "Pentru a învăța istorie", "Pentru a memora date"], correct: 1 },
      { type: "typing", question: "Cine a scris romanul 'Ion'?", answer: "Liviu Rebreanu" },
      { type: "typing", question: "Cum se numește personajul principal din 'Moromeții'?", answer: "Ilie Moromete" },
      { type: "typing", question: "Ce poet modern este menționat în text?", answer: "Nichita Stănescu" }
    ],
  },
  {
    title: "Metafora drumului: Călătoria cu trenul ca experiență socială",
    text: "Călătoria cu trenul a reprezentat întotdeauna mai mult decât o simplă deplasare dintr-un punct A în punctul B; ea este o metaforă a vieții și un spațiu privilegiat de observație socială. Într-un compartiment de tren, destine complet diferite se intersectează pentru câteva ore, creând o micro-societate temporară. Ritmul sacadat al roților pe șine induce o stare de reverie, favorizând introspecția sau, dimpotrivă, dialogul neașteptat cu străinii. Gara, cu forfota ei caracteristică, este pragul dintre stabilitate și aventură, un loc al despărțirilor dureroase și al regăsirilor euforice. Pe fereastra trenului, peisajul se derulează ca un film documentar despre geografia și istoria țării: de la satele uitate de lume, la zonele industriale dezafectate sau la măreția munților. Trenul ne oferă luxul timpului – timpul de a citi, de a gândi sau pur și simplu de a privi. În epoca vitezei și a zborurilor low-cost, trenul rămâne o opțiune pentru cei care vor să savureze drumul, nu doar destinația. Există o poezie a călătoriei pe șine, de la ceaiul băut în pahare de sticlă, până la lumina apusului care se reflectă în geamurile prăfuite. Din punct de vedere sociologic, trenul este un egalizator; oameni din medii sociale diferite împart același spațiu limitat, fiind obligați la o formă minimă de curtoazie și toleranță. Călătoria cu trenul ne învață răbdarea și ne reamintește că drumul în sine este la fel de important ca țelul final. Este o experiență care ne conectează la realitatea concretă a lumii, departe de ecranele telefoanelor, oferindu-ne șansa de a vedea România 'la firul ierbii'.",
    questions: [
      { type: "mcq", question: "Ce reprezintă călătoria cu trenul conform textului?", options: ["O pierdere de timp", "O metaforă a vieții și un spațiu de observație socială", "O metodă periculoasă de transport", "O activitate exclusiv pentru turiști"], correct: 1 },
      { type: "mcq", question: "Ce stare induce ritmul sacadat al roților?", options: ["Agitație extremă", "O stare de reverie și introspecție", "Somn profund", "Frică"], correct: 1 },
      { type: "mcq", question: "Cum este descrisă gara în text?", options: ["Un loc plictisitor", "Pragul dintre stabilitate și aventură", "O clădire inutilă", "Un centru comercial"], correct: 1 },
      { type: "mcq", question: "De ce este trenul considerat un 'egalizator'?", options: ["Pentru că toate biletele costă la fel", "Pentru că oameni din medii diferite împart același spațiu", "Pentru că merge cu viteză constantă", "Pentru că toți pasagerii dorm"], correct: 1 },
      { type: "mcq", question: "Ce ne învață călătoria cu trenul?", options: ["Să fim grăbiți", "Răbdarea și importanța drumului în sine", "Să folosim telefonul mai mult", "Să evităm străinii"], correct: 1 },
      { type: "typing", question: "Ce băutură este menționată ca fiind băută în pahare de sticlă?", answer: "ceaiul" },
      { type: "typing", question: "Cum se numește locul unde se oprește trenul?", answer: "gara" },
      { type: "typing", question: "Ce tip de transport este considerat mai rapid dar mai puțin poetic decât trenul?", answer: "avionul" }
    ],
  },
  {
    title: "Simfonia albă: Reflecții filozofice asupra iernii",
    text: "Iarna nu este doar un anotimp al frigului și al zăpezii, ci o perioadă de asceză a naturii, un timp al introspecției și al tăcerii fertile. După efervescența primăverii, arșița verii și melancolia toamnei, iarna instalează o ordine monocromă care obligă la esențializare. Zăpada, cu albul ei imaculat, acoperă imperfecțiunile lumii, oferind un nou început, cel puțin la nivel vizual. În filozofia naturii, iarna reprezintă somnul necesar regenerării; sub stratul protector de nea, viața pulsează discret, pregătindu-și viitoarea explozie. Pentru om, iarna este anotimpul interiorității. Zilele scurte și nopțile lungi ne îndeamnă să ne retragem în spațiul protector al casei și al propriilor gânduri. Este timpul poveștilor, al lecturii și al planurilor de viitor. Gerul, deși ostil la prima vedere, are o funcție purificatoare, curățând aerul și pământul. Sărbătorile de iarnă aduc o lumină spirituală necesară în mijlocul întunericului fizic, reamintindu-ne de importanța căldurii umane și a solidarității. Există o estetică a iernii care rezidă în detaliu: geometria unică a fulgului de nea, florile de gheață de pe ferestre sau siluetele grafice ale copacilor despuiați de frunze. Iarna ne învață să prețuim resursele, să fim răbdători și să înțelegem că moartea aparentă a naturii este doar o etapă a ciclului etern al vieții. Ea este un test al rezilienței și o invitație la simplitate. Într-o lume care fuge de tăcere și de frig, iarna ne oferă șansa de a ne reîntâlni cu noi înșine în liniștea deplină a unui peisaj înzăpezit. Este, în esență, o lecție despre speranță: știm că oricât de lungă și grea ar fi iarna, primăvara va veni inevitabil.",
    questions: [
      { type: "mcq", question: "Ce reprezintă iarna în filozofia naturii?", options: ["Sfârșitul definitiv al vieții", "Somnul necesar regenerării", "O eroare a climei", "Un timp al distrugerii"], correct: 1 },
      { type: "mcq", question: "Cum este descris efectul vizual al zăpezii?", options: ["Murdărește orașul", "Acoperă imperfecțiunile lumii, oferind un nou început", "Este orbitor și periculos", "Este plictisitor"], correct: 1 },
      { type: "mcq", question: "Ce funcție are gerul conform textului?", options: ["Doar de a ne îmbolnăvi", "O funcție purificatoare, curățând aerul și pământul", "De a distruge plantele", "Nu are nicio funcție"], correct: 1 },
      { type: "mcq", question: "Ce ne învață iarna despre ciclul vieții?", options: ["Că totul se termină repede", "Că moartea aparentă este doar o etapă a regenerării", "Că natura este ostilă omului", "Că trebuie să plecăm în țările calde"], correct: 1 },
      { type: "mcq", question: "Care este lecția finală a iernii?", options: ["Lecția disperării", "Lecția speranței (primăvara va veni inevitabil)", "Lecția singurătății", "Lecția economisirii banilor"], correct: 1 },
      { type: "typing", question: "Ce fenomen desenează forme pe ferestre iarna?", answer: "florile de gheață" },
      { type: "typing", question: "Ce culoare domină peisajul de iarnă?", answer: "albul" },
      { type: "typing", question: "Cum se numește somnul naturii în timpul iernii?", answer: "regenerare" }
    ],
  },
];
