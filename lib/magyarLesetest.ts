...
// ─── 3–8. OSZTÁLY: TODO Szövegek később kerülnek hozzáadásra
  ...
  8: [
    {
      id: "m8_1",
      title: "Ady Endre és a magyar ugar – A modernitás hajnala",
      text: "A 20. század hajnalán a magyar irodalmi élet állóvizét egy hatalmas erejű szellemi földrengés kavarta fel: 1906-ban megjelent Ady Endre Új versek című kötete. Ez a pillanat nem csupán egy új költő fellépését jelentette, hanem a magyar líra radikális megújulását, a modernitás visszavonhatatlan betörését. Ady szakított a 19. század végére ellaposodott népnemzeti irányzattal, és egy olyan szimbolista, látomásos költészetet teremtett, amely egyszerre volt európai és mélyen magyar. A kötet egyik legfontosabb motívuma a 'magyar ugar', amely a korabeli Magyarország elmaradottságának, szellemi restségének és kilátástalanságának metaforája lett. Ady számára az ugar nem csupán a földet jelentette, hanem azt a fojtogató közeget, amelyben a tehetség és a haladás elvész. Versei, mint A magyar Ugaron vagy A Hortobágy poétája, éles kritikát fogalmaztak meg a feudális maradványokkal terhelt társadalommal szemben. Ady költészete azonban nemcsak politikai és társadalmi lázadás volt, hanem az egyéni lélek vívódásainak, a halálközelségnek és az istenkeresésnek a megnyilvánulása is. Szerelmi lírája, a Léda-asszonyhoz írt versek, szakítottak a korábbi idilli hangvétellel; a szerelem nála diszharmonikus, küzdelmes és gyakran kegyetlen érzésként jelent meg. Ady fellépése heves ellenállást váltott ki a konzervatív körökből, akik érthetetlenséggel, erkölcstelenséggel és hazafiatlansággal vádolták. Ugyanakkor a haladó értelmiség, a Nyugat folyóirat köré csoportosuló írók és költők benne látták a nemzet ébresztőjét. Ady zsenialitása abban rejlett, hogy képes volt a magyar sorskérdéseket egyetemes érvényű szimbólumokba önteni. Nyelvezete, amely a bibliai próféták hangját ötvözte a párizsi szimbolizmus vívmányaival, teljesen új regisztert nyitott a magyar nyelvben. Bár élete rövid és betegségekkel terhelt volt, hatása a magyar kultúrára felbecsülhetetlen. Ő tette lehetővé, hogy a magyar irodalom ismét szinkronba kerüljön a világgal, és olyan kérdéseket tegyen fel, amelyekre a válaszokat ma is keressük. Ady nem csupán egy költő volt, hanem egy korszak névadója, akinek alakja köré kultusz épült, és akinek sorai ma is ugyanolyan elemi erővel hatnak, mint száz évvel ezelőtt.",
      questions: [
        { type: "mcq", question: "Melyik évben jelent meg Ady Endre korszakalkotó kötete, az Új versek?", options: ["1896", "1906", "1919", "1933"], correct: 1 },
        { type: "mcq", question: "Mit jelképez Ady költészetében a 'magyar ugar' metaforája?", options: ["A mezőgazdaság fejlődését", "A magyar táj szépségét", "A társadalmi és szellemi elmaradottságot", "A paraszti élet idilljét"], correct: 2 },
        { type: "mcq", question: "Milyen stílusirányzat hatása érezhető leginkább Ady modern líráján?", options: ["Klasszicizmus", "Realizmus", "Szimbolizmus", "Barokk"], correct: 2 },
        { type: "mcq", question: "Hogyan ábrázolja Ady a szerelmet a Léda-versekben?", options: ["Harmonikus és boldog érzésként", "Küzdelmes, diszharmonikus kapcsolatként", "Plátói és elérhetetlen vágyként", "Egyszerű és hétköznapi eseményként"], correct: 1 },
        { type: "mcq", question: "Melyik folyóirat köré csoportosult a haladó magyar értelmiség Ady korában?", options: ["Huszadik Század", "Napkelet", "Nyugat", "Válasz"], correct: 2 },
        { type: "typing", question: "Hogy hívták Ady Endre múzsáját, akihez szerelmi verseit írta?", answer: ["Léda", "Brüll Adél"] },
        { type: "typing", question: "Melyik városban ismerkedett meg Ady a modern európai művészettel?", answer: ["Párizs", "Párizsban"] },
        { type: "typing", question: "Mi volt a konzervatív körök egyik fő vádja Ady ellen?", answer: ["érthetetlenség", "erkölcstelenség", "hazafiatlanság"] },
      ],
    },
    {
      id: "m8_2",
      title: "József Attila: A Dunánál – Történelem és sorsközösség",
      text: "József Attila a magyar irodalom egyik legtragikusabb sorsú, mégis legzseniálisabb alakja, akinek költészete a 20. századi ember egzisztenciális szorongásait, társadalmi kiszolgáltatottságát és a teljesség utáni vágyát fogalmazza meg. Egyik legfontosabb és legmélyebb gondolati verse, A Dunánál, 1936-ban született, a Szép Szó folyóirat számára. A vers a Duna partján ülő költő látomásával indul, ahol a folyó nemcsak egy földrajzi kép, hanem az idő és a történelem hömpölygő folyamának szimbóluma. József Attila ebben a művében a nemzeti és az egyetemes emberi sorsközösség kérdéseit elemzi. A költő felismeri, hogy az egyén nem választható el őseitől: 'Én úgy vagyok, hogy már százezer éve / nézem, amit hirtelen meglátok.' Ez a gondolat a kollektív emlékezet és a genetikai folytonosság kifejezése. A vers második részében a közép-európai népek – magyarok, románok, szlávok – közös sorsára hívja fel a figyelmet. A Duna menti népek történelme tele van harccal és viszálykodással, de a költő szerint eljött az idő a megbékélésre: 'A harcot, amelyet őseink vívtak, / békévé oldja az emlékezés.' József Attila víziója szerint a múlt bűneit és fájdalmait nem elfelejteni kell, hanem közös munkával és megértéssel feloldani. A vers híres záróképe – 'A Dunának, mely múlt, jelen s jövendő, / egymást ölelik lágy hullámai' – a megbékélés és az összefogás szükségességét hirdeti. A költő számára a munka, a rend és a szabadság elválaszthatatlan fogalmak. József Attila nyelvezete ebben a versben rendkívül fegyelmezett, mégis képszerű; a filozófiai mélység és a lírai érzékenység tökéletes egyensúlyban van. A Dunánál nemcsak a magyar irodalom, hanem az európai humanizmus egyik alapműve is, amely a mai napig aktuális üzenetet hordoz a Duna-völgyi népek számára. A költő, aki egész életében kereste a helyét a világban és a társadalomban, ebben a versben találta meg a legmagasabb rendű választ: az emberi méltóság és a közös felelősség vállalását.",
      questions: [
        { type: "mcq", question: "Melyik folyóirat számára írta József Attila A Dunánál című versét?", options: ["Nyugat", "Szép Szó", "Válasz", "Magyar Csillag"], correct: 1 },
        { type: "mcq", question: "Mit jelképez a Duna a versben?", options: ["A természet erejét", "Az időt és a történelem folyamát", "A magyar határokat", "A gyermekkori emlékeket"], correct: 1 },
        { type: "mcq", question: "Milyen népek megbékélését szorgalmazza a költő a versben?", options: ["A nyugat-európai népekét", "A Duna menti népekét (magyarok, románok, szlávok)", "Az amerikai és európai népekét", "Csak a magyar nemzetét"], correct: 1 },
        { type: "mcq", question: "Mit jelent a versben a 'százezer éve nézem' kifejezés?", options: ["A költő nagyon öreg", "A kollektív emlékezetet és az ősökkel való folytonosságot", "A költő unalmát", "A tudományos megfigyelést"], correct: 1 },
        { type: "mcq", question: "Mi a vers záró üzenete a szöveg szerint?", options: ["A háború elkerülhetetlensége", "A megbékélés és az összefogás szükségessége", "A magány dicsérete", "A múlt teljes elfelejtése"], correct: 1 },
        { type: "typing", question: "Melyik évben született A Dunánál című vers?", answer: ["1936"] },
        { type: "typing", question: "Milyen fogalmakat tart a költő elválaszthatatlannak a szöveg szerint?", answer: ["munka, rend, szabadság", "munka, rend és szabadság"] },
        { type: "typing", question: "Mi oldja békévé a harcot a vers szerint?", answer: ["az emlékezés", "emlékezés"] },
      ],
    },
    {
      id: "m8_3",
      title: "1956: A szabadság tizenhárom napja",
      text: "1956. október 23-a a magyar történelem egyik legmeghatározóbb és legtisztább pillanata, amikor egy nemzet mondott nemet a sztálinista diktatúrára és a szovjet megszállásra. A forradalom az egyetemi ifjúság békés tüntetésével kezdődött Budapesten, amelyhez hamarosan a város lakosságának százezrei csatlakoztak. A követelések – amelyeket a 16 pontban foglaltak össze – a szovjet csapatok kivonását, szabad választásokat, sajtószabadságot és Nagy Imre kormányfővé nevezését tartalmazták. Az események akkor fordultak fegyveres felkelésbe, amikor az Államvédelmi Hatóság (ÁVH) tüzet nyitott a Magyar Rádió épületénél gyülekező tömegre. A forradalom napjai alatt a nemzet egysége megrendítő volt: munkástanácsok alakultak, a hadsereg jelentős része átállt a felkelők mellé, és a lyukas zászló a szabadság egyetemes jelképévé vált. Nagy Imre kormánya, engedve a nép akaratának, bejelentette a többpártrendszer visszaállítását és Magyarország semlegességét, kilépve a Varsói Szerződésből. A szabadság napjai azonban rövidek voltak. November 4-én hajnalban a szovjet hadsereg hatalmas túlerővel indított általános támadást Budapest és a vidéki városok ellen. A 'Forgószél' hadművelet célja a forradalom vérbe fojtása és a szovjetbarát rend helyreállítása volt. Bár a szabadságharcosok – a 'pesti srácok' – hősiesen ellenálltak a túlerőnek, a küzdelem reménytelen volt. A forradalmat követő megtorlás kegyetlen volt: több száz embert, köztük Nagy Imre miniszterelnököt is kivégezték, tízezreket börtönöztek be, és közel kétszázezer magyar kényszerült elhagyni hazáját. 1956 emléke a Kádár-korszak évtizedei alatt elfojtott és eltorzított volt, de a nép szívében tovább élt. A forradalom jelentősége túlmutatott Magyarország határain: ez volt az első repedés a szovjet tömb falán, amely megmutatta a világnak, hogy a szabadságvágyat nem lehet tartósan elnyomni. 1956 hősei ma a nemzeti identitásunk tartóoszlopai, akiknek áldozata nélkül nem jöhetett volna létre a független és demokratikus Magyarország 1989-ben.",
      questions: [
        { type: "mcq", question: "Melyik eseménnyel kezdődött a forradalom 1956. október 23-án?", options: ["Fegyveres támadással", "Az egyetemi ifjúság békés tüntetésével", "Szovjet bevonulással", "Nagy Imre beszédével a rádióban"], correct: 1 },
        { type: "mcq", question: "Mi vált a forradalom és a szabadság egyetemes jelképévé?", options: ["A vörös csillag", "A lyukas zászló", "A sarló és kalapács", "A fehér galamb"], correct: 1 },
        { type: "mcq", question: "Melyik katonai szövetségből jelentette be Magyarország kilépését Nagy Imre?", options: ["NATO", "Varsói Szerződés", "Európai Unió", "ENSZ"], correct: 1 },
        { type: "mcq", question: "Mi volt a szovjet támadás fedőneve november 4-én?", options: ["Barbarossa", "Forgószél", "Vihar", "Tavaszi ébredés"], correct: 1 },
        { type: "mcq", question: "Körülbelül hány magyar hagyta el az országot a forradalom leverése után?", options: ["Tízezer", "Százezer", "Kétszázezer", "Félmillió"], correct: 2 },
        { type: "typing", question: "Ki volt a forradalom mártír miniszterelnöke?", answer: ["Nagy Imre"] },
        { type: "typing", question: "Hogy hívták a forradalom ellen harcoló rettegett politikai rendőrséget?", answer: ["ÁVH", "Államvédelmi Hatóság"] },
        { type: "typing", question: "Melyik évben rehabilitálták a forradalom hőseit és kiáltották ki a köztársaságot?", answer: ["1989"] },
      ],
    },
    {
      id: "m8_4",
      title: "Esterházy Péter és a posztmodern játékosság",
      text: "Esterházy Péter a kortárs magyar irodalom egyik legmeghatározóbb és nemzetközileg is legismertebb alakja volt, aki alapjaiban változtatta meg a magyar próza nyelvét és szerkezetét. Fellépése a 70-es évek végén, a Termelési-regény című művével, a posztmodern fordulat kezdetét jelentette Magyarországon. Esterházy szakított a hagyományos, lineáris történetmeséléssel és a mindentudó narrátor tekintélyével. Számára az írás nem a valóság tükrözése, hanem egy intellektuális játék a nyelvvel és az irodalmi hagyománnyal. Művei tele vannak idézetekkel, utalásokkal (intertextualitás), iróniával és önreflexióval. Gyakran mondják, hogy Esterházy nem történeteket írt, hanem mondatokat; nála a nyelv nem eszköz, hanem maga a téma. Legmonumentálisabb alkotása a Harmonia cælestis, amelyben családja, a történelmi Esterházy-ház történetét dolgozza fel, de nem hagyományos krónikaként, hanem mozaikszerűen, az 'édesapa' alakja köré építve. A mű megjelenése után derült ki, hogy édesapja ügynök volt a Kádár-rendszerben, amire az író a Javított kiadás című könyvével válaszolt, szembesítve a családi legendáriumot a fájdalmas valósággal. Esterházy stílusa egyszerre volt arisztokratikus és népi, emelkedett és trágár, komoly és végtelenül szórakoztató. Hitt abban, hogy az irodalom feladata nem az igazság kimondása, hanem a kérdezés és a szabadság megélése a nyelven keresztül. Hatása a későbbi írógenerációkra felbecsülhetetlen; ő tette lehetővé, hogy a magyar irodalom megszabaduljon a politikai és erkölcsi tanítómester szerepétől, és visszanyerje esztétikai autonómiáját. Esterházy Péter halálával egy korszak zárult le, de mondatai, amelyekben a magyar nyelv minden gazdagsága és humora benne van, továbbra is a kortárs kultúra alapkövei maradnak. Olvasása kihívás, de egyben hatalmas kaland is, amely arra tanít, hogy a világ sokszínű, ellentmondásos és legfőképpen: elmesélhető.",
      questions: [
        { type: "mcq", question: "Melyik művével indította el Esterházy Péter a posztmodern fordulatot a 70-es években?", options: ["Harmonia cælestis", "Termelési-regény", "Javított kiadás", "Fancsikó és Pinta"], correct: 1 },
        { type: "mcq", question: "Mi jellemzi leginkább Esterházy írói stílusát?", options: ["Lineáris történetmesélés", "Nyelvi játékosság, irónia és intertextualitás", "Szigorú realizmus", "Kizárólag politikai üzenetek"], correct: 1 },
        { type: "mcq", question: "Melyik történelmi család történetét dolgozza fel a Harmonia cælestis?", options: ["Hunyadi", "Rákóczi", "Esterházy", "Széchenyi"], correct: 2 },
        { type: "mcq", question: "Hogyan reagált az író arra a felfedezésre, hogy édesapja ügynök volt?", options: ["Letagadta a tényeket", "Megírta a Javított kiadás című művét", "Abbahagyta az írást", "Pert indított az állam ellen"], correct: 1 },
        { type: "mcq", question: "Mi az 'intertextualitás' jelentése Esterházy művészetében?", options: ["Képek használata a szövegben", "Más művekből vett idézetek és utalások beépítése", "Kizárólag párbeszédekből álló szöveg", "Idegen nyelvű szavak mellőzése"], correct: 1 },
        { type: "typing", question: "Hogy hívják Esterházy Péter legmonumentálisabb, családregényét?", answer: ["Harmonia cælestis"] },
        { type: "typing", question: "Melyik irodalmi irányzathoz sorolják Esterházy munkásságát?", answer: ["posztmodern"] },
        { type: "typing", question: "Mi volt Esterházy szerint az irodalom feladata az igazság kimondása helyett?", answer: ["kérdezés", "szabadság megélése"] },
      ],
    },
    {
      id: "m8_5",
      title: "A holokauszt Magyarországon – Emlékezet és felelősség",
      text: "A magyar történelem egyik legsötétebb fejezete a második világháború alatti holokauszt, amely során közel félmillió magyar állampolgárt fosztottak meg jogaitól, vagyonától, majd végül az életétől is. A folyamat nem 1944-ben kezdődött, hanem már a 20-as és 30-as évek zsidótörvényeivel, amelyek fokozatosan kirekesztették a zsidóságnak minősített magyarokat a társadalmi és gazdasági életből. A tragédia azonban Magyarország 1944. március 19-i német megszállása után vált totálissá. A Sztójay-kormány és a magyar közigazgatás aktív közreműködésével megkezdődött a vidéki zsidóság gettósítása, majd deportálása. Néhány hónap alatt több mint 430 ezer embert szállítottak marhavagonokban az auschwitz-birkenaui megsemmisítő táborba, ahol többségüket azonnal gázkamrákba küldték. A budapesti zsidóság deportálását Horthy Miklós kormányzó júliusban leállította, de az októberi nyilas hatalomátvétel után újabb borzalmak következtek: a Duna-parti kivégzések és a halálmenetek. A holokauszt nemcsak a zsidóság, hanem az egész magyar nemzet tragédiája, hiszen az ország elveszítette tehetséges művészeit, tudósait, iparosait és százezernyi ártatlan polgárát. Az emlékezetpolitika fontos része a szembenézés a felelősséggel: bár a német megszállók irányították a folyamatot, a magyar államgépezet segítsége nélkül ilyen gyors és hatékony népirtás nem lett volna lehetséges. Ugyanakkor emlékeznünk kell az embermentőkre is – mint Raoul Wallenberg, Carl Lutz vagy a névtelen magyar segítők –, akik saját életüket kockáztatva mentettek meg ezreket. A holokauszt tanulsága az emberi jogok sérthetetlensége és a gyűlöletbeszéd elleni fellépés szükségessége. Az áldozatok emléknapja, április 16-a, arra figyelmeztet minket, hogy a közöny és a kirekesztés hova vezethet. A múlt feldolgozása és az oktatás a legjobb eszköz arra, hogy ilyen szörnyűség soha többé ne ismétlődhessen meg.",
      questions: [
        { type: "mcq", question: "Melyik esemény után vált totálissá a zsidóság üldözése Magyarországon?", options: ["A háború kitörésekor", "Magyarország német megszállása után (1944. március 19.)", "A trianoni béke után", "A Szovjetunió megtámadásakor"], correct: 1 },
        { type: "mcq", question: "Hova deportálták a vidéki magyar zsidóság többségét?", options: ["Munkaszolgálatra", "Auschwitz-Birkenau megsemmisítő táborába", "Szibériába", "Amerikába"], correct: 1 },
        { type: "mcq", question: "Ki állította le a budapesti zsidóság deportálását 1944 júliusában?", options: ["Szálasi Ferenc", "Horthy Miklós", "Adolf Hitler", "Sztójay Döme"], correct: 1 },
        { type: "mcq", question: "Melyik svéd diplomata mentett meg több ezer zsidót Budapesten?", options: ["Carl Lutz", "Raoul Wallenberg", "Angelo Rotta", "Jane Haining"], correct: 1 },
        { type: "mcq", question: "Mikor tartják a holokauszt magyarországi áldozatainak emléknapját?", options: ["Október 23-án", "Április 16-án", "Január 27-én", "Március 15-én"], correct: 1 },
        { type: "typing", question: "Melyik párt került hatalomra 1944 októberében, fokozva a terrort?", answer: ["Nyilaskeresztes Párt", "nyilasok", "Nyilas"] },
        { type: "typing", question: "Hogy hívták a zsidó férfiak kényszermunkáját a hadseregben?", answer: ["munkaszolgálat"] },
        { type: "typing", question: "Mi a holokauszt egyik legfontosabb tanulsága a szöveg szerint?", answer: ["emberi jogok sérthetetlensége", "gyűlöletbeszéd elleni fellépés"] },
      ],
    },
    {
      id: "m8_6",
      title: "Radnóti Miklós: Erőltetett menet – Humanizmus a pokolban",
      text: "Radnóti Miklós a magyar líra egyik legtisztább hangú költője, akinek életműve a klasszikus forma és a modern tragikum tökéletes szintézise. Költészete a 30-as évek végétől a fenyegetettség, a fasizmus és a közelgő halál árnyékában született. Zsidó származása miatt többször hívták be munkaszolgálatra, utoljára a szerbiai Borba, ahol embertelen körülmények között dolgozott a rézbányákban. Itt írta utolsó verseit, amelyeket egy kis kockás füzetben, a Bori noteszben őrzött meg. Az Erőltetett menet, amely 1944 szeptemberében született, a világirodalom egyik legmegrázóbb dokumentuma az emberi kitartásról és a reményről. A vers formája a nibelungi sor, amelynek lüktetése a menetelő katonák fáradt, botladozó lépteit idézi. A költemény egy belső párbeszéd: az egyik hang a kétségbeesésé, amely a halált megváltásként, pihenésként látja, a másik hang pedig az életé, amely a hazatérés, a szerelem és az otthon békéje után vágyakozik. Radnóti látomása az otthonról – a szilvalekvárfőzésről, a kert nyugalmáról és feleségéről, Fanniról – nem csupán nosztalgia, hanem az emberi méltóság megőrzésének eszköze a barbárság közepette. A vers híres fordulata – 'De lásd, mégis felkelek' – a humanizmus diadala a pusztulás felett. Radnóti nemcsak áldozat volt, hanem tanú is, aki kötelességének érezte, hogy pontosan és művészien dokumentálja kora borzalmait. Halála után, a tömegsírból előkerült notesz versei (a Razglednicák, az Erőltetett menet, a Hetedik ecloga) a magyar irodalom legféltettebb kincsei közé tartoznak. Radnóti sorsa a magyar értelmiség tragédiája: egy költő, aki a magyar kultúra és nyelv szerelmese volt, de akit éppen az a haza taszított ki és pusztított el, amelyhez ezer szállal kötődött. Emléke a tiszta erkölcs és a művészi felelősség örök példája.",
      questions: [
        { type: "mcq", question: "Hogy hívták azt a füzetet, amelyben Radnóti utolsó verseit őrizte?", options: ["Szerbiai napló", "Bori notesz", "Erőltetett menet", "Razglednicák"], correct: 1 },
        { type: "mcq", question: "Milyen versformát használt Radnóti az Erőltetett menetben a menetelés ritmusának érzékeltetésére?", options: ["Hexameter", "Nibelungi sor", "Szapphói strófa", "Alexandrin"], correct: 1 },
        { type: "mcq", question: "Miről szól az Erőltetett menet belső párbeszéde?", options: ["Két katona vitájáról", "A kétségbeesés és az életigenlés/remény küzdelméről", "A háború stratégiájáról", "A természet szépségéről"], correct: 1 },
        { type: "mcq", question: "Ki volt Radnóti felesége és múzsája, akihez verseit írta?", options: ["Léda", "Gyarmati Fanni", "Vágó Márta", "Kozmutza Flóra"], correct: 1 },
        { type: "mcq", question: "Melyik versciklus darabjai dokumentálják a költő utolsó útját?", options: ["Eclogák", "Razglednicák", "Himnuszok", "Dalok"], correct: 1 },
        { type: "typing", question: "Melyik szerbiai város melletti munkatáborban dolgozott Radnóti?", answer: ["Bor", "Borban"] },
        { type: "typing", question: "Milyen gyümölcs lekvárjának főzését idézi fel az otthoni idillben?", answer: ["szilva", "szilvalekvár"] },
        { type: "typing", question: "Hogy hívják a vers híres fordulatát, amely a kitartást jelzi?", answer: ["De lásd, mégis felkelek"] },
      ],
    },
    {
      id: "m8_7",
      title: "A rendszerváltás Magyarországon (1989) – A demokrácia visszatérése",
      text: "Az 1989-es esztendő a 'csodák éve' volt Közép-Kelet-Európában, amikor a szovjet típusú egypártrendszerek kártyavárként omlottak össze, és Magyarország is visszatért a demokrácia és a piacgazdaság útjára. A folyamat nem egyik napról a másikra történt, hanem a 80-as évek gazdasági válsága és a társadalmi elégedetlenség érlelte meg. A magyar rendszerváltás egyik legfontosabb jellemzője a 'tárgyalásos' jelleg volt: az Ellenzéki Kerekasztal és az állampárt (MSZMP) képviselői a Nemzeti Kerekasztal-tárgyalásokon állapodtak meg a békés átmenet jogi kereteiről. Az év szimbolikus eseménye volt június 16-án Nagy Imre és mártírtársainak újratemetése, amelyen százezrek vettek részt a Hősök terén, és amely a múltal való szembenézés és a nemzeti megbékélés pillanata lett. Szeptemberben Magyarország megnyitotta határait a keletnémet menekültek előtt, ami döntő lökés volt a berlini fal leomlásához és a vasfüggöny lebontásához. 1989. október 23-án, a forradalom évfordulóján kikiáltották a Magyar Köztársaságot, véget vetve a népköztársaság korszakának. Az első szabad választásokat 1990 tavaszán tartották, amelyet a Magyar Demokrata Fórum (MDF) nyert meg, és Antall József lett a rendszerváltás utáni első felelős miniszterelnök. A rendszerváltás nemcsak politikai, hanem mély társadalmi és gazdasági változást is hozott: megjelent a magántulajdon, a szólásszabadság és a gyülekezési jog. Bár az átmenet sokak számára gazdasági nehézségekkel és bizonytalansággal járt, Magyarország visszanyerte szuverenitását, és megkezdődött az integráció az európai közösségbe. 1991 júniusában az utolsó szovjet katona is elhagyta az országot, amivel teljessé vált a függetlenség. A rendszerváltás öröksége a mai napig meghatározza mindennapjainkat; a demokratikus intézmények és a jogállamiság keretei ekkor jöttek létre, lehetőséget adva egy szabadabb és nyitottabb társadalom felépítésére.",
      questions: [
        { type: "mcq", question: "Melyik évben zajlott a magyarországi rendszerváltás döntő része?", options: ["1956", "1968", "1989", "2004"], correct: 2 },
        { type: "mcq", question: "Mi jellemezte a magyar rendszerváltás folyamatát?", options: ["Véres polgárháború", "Tárgyalásos, békés átmenet", "Külföldi katonai beavatkozás", "A királyság visszaállítása"], correct: 1 },
        { type: "mcq", question: "Melyik szimbolikus esemény történt 1989. június 16-án a Hősök terén?", options: ["A köztársaság kikiáltása", "Nagy Imre és mártírtársainak újratemetése", "Az első szabad választás", "A határok megnyitása"], correct: 1 },
        { type: "mcq", question: "Ki lett a rendszerváltás utáni első szabadon választott miniszterelnök?", options: ["Kádár János", "Antall József", "Horn Gyula", "Orbán Viktor"], correct: 1 },
        { type: "mcq", question: "Melyik napon kiáltották ki a Magyar Köztársaságot 1989-ben?", options: ["Március 15-én", "Augusztus 20-án", "Október 23-án", "November 4-én"], correct: 2 },
        { type: "typing", question: "Hogy hívták az ellenzéki csoportok összefogását a tárgyalásokon?", answer: ["Ellenzéki Kerekasztal"] },
        { type: "typing", question: "Melyik ország menekültjei előtt nyitotta meg Magyarország a határt 1989-ben?", answer: ["NDK", "Kelet-Németország", "keletnémet"] },
        { type: "typing", question: "Melyik évben hagyta el az utolsó szovjet katona Magyarországot?", answer: ["1991"] },
      ],
    },
    {
      id: "m8_8",
      title: "Örkény István és az abszurd: Egyperces novellák",
      text: "Örkény István a 20. századi magyar próza és dráma egyik legeredetibb alkotója, aki a groteszk és az abszurd látásmód bevezetésével új utakat nyitott az irodalomban. Világhírét az Egyperces novellák című kötetének köszönheti, amelyben a tömörség, a szikár stílus és a meghökkentő logika uralkodik. Örkény szerint az 'egypercesek' olyan írások, amelyeknek a rövidsége nem a tartalom szegénységét, hanem a sűrítettségét jelenti. A szerző híres 'Használati utasítása' szerint a novellák azért rövidek, mert az embernek kevés az ideje, de a megértésükhöz szükség van az olvasó fantáziájára és aktív közreműködésére. Örkény groteszk világa a hétköznapi és a képtelen, a tragikus és a komikus elemeket ötvözi. Nála a legabszurdabb helyzetek is természetesnek tűnnek, és fordítva: a hétköznapi dolgok válnak félelmetessé vagy nevetségessé. Egyik leghíresebb novellája, az In memoriam dr. K. H. G., a holokauszt borzalmát mutatja be egy abszurd párbeszéden keresztül, ahol a művelt fogoly és a műveletlen őr közötti szakadék a halálba vezet. Drámáiban, mint a Tóték vagy a Macskajáték, a kiszolgáltatottságot, a hatalom természetét és az emberi kapcsolatok törékenységét elemzi. A Tóték a háború hátországában játszódik, ahol egy család minden megaláztatást elvisel egy őrnagytól, remélve, hogy ezzel megmenthetik fiuk életét a fronton. Örkény humora nem felhőtlen; az ő nevetése mögött mindig ott van a részvét és a felismerés fájdalma. Művészete a 20. századi magyar sors, a háborúk és diktatúrák tapasztalatából táplálkozik, de egyetemes érvényű kérdéseket tesz fel az emberi létezésről. Örkény arra tanít, hogy a világot nemcsak érteni, hanem elviselni is csak humorral és iróniával lehet. Az 'egypercesek' ma is népszerűek, mert tükröt tartanak elénk, amelyben felismerhetjük saját esendőségünket és a világ abszurditását.",
      questions: [
        { type: "mcq", question: "Melyik műfaj megteremtése fűződik Örkény István nevéhez?", options: ["A családregény", "Az egyperces novella", "A történelmi eposz", "A szonettkoszorú"], correct: 1 },
        { type: "mcq", question: "Mi jellemzi a groteszk látásmódot Örkény műveiben?", options: ["Kizárólag vidám és felhőtlen humor", "A tragikus és a komikus elemek meghökkentő ötvözése", "Szigorú tudományos leírás", "A természet utánzása"], correct: 1 },
        { type: "mcq", question: "Mit kér Örkény az olvasótól a 'Használati utasításban'?", options: ["Hogy ne olvassa el a novellákat", "Hogy használja a fantáziáját és működjön közre", "Hogy tanulja meg kívülről a szöveget", "Hogy csak egy percig gondolkodjon"], correct: 1 },
        { type: "mcq", question: "Melyik drámája játszódik a háború hátországában, egy őrnagy és egy család között?", options: ["Macskajáték", "Tóték", "Pisti a vérzivatarban", "Vérrokonok"], correct: 1 },
        { type: "mcq", question: "Miről szól az In memoriam dr. K. H. G. című novella?", options: ["Egy orvosi felfedezésről", "A holokauszt borzalmáról egy abszurd párbeszéden keresztül", "Egy vidám kirándulásról", "A magyar nyelv szépségéről"], correct: 1 },
        { type: "typing", question: "Hogy hívják Örkény István híres rövidprózai gyűjteményét?", answer: ["Egyperces novellák", "Egypercesek"] },
        { type: "typing", question: "Milyen érzelem van jelen Örkény nevetése mögött a szöveg szerint?", answer: ["részvét", "fájdalom", "részvét és fájdalom"] },
        { type: "typing", question: "Melyik állat szerepel Örkény másik híres drámájának címében?", answer: ["macska", "Macskajáték"] },
      ],
    },
  ],
};
