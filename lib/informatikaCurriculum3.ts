...
export const INFO_K3_CURRICULUM: KemiaTheme[] = [
  {
    ...
    color: "#3B82F6",
    subtopics: [
      { id: "info_k3_t01", name: { de: "Das Internet", en: "The Internet", hu: "Az Internet", ro: "Internetul" }, questions: [], hasGenerator: true },
      { id: "info_k3_t02", name: { de: "Browser", en: "Browser", hu: "Böngésző", ro: "Browser" }, questions: [], hasGenerator: true },
      { id: "info_k3_t03", name: { de: "URL (Adresse)", en: "URL (Address)", hu: "URL (Cím)", ro: "URL (Adresă)" }, questions: [], hasGenerator: true },
      { id: "info_k3_t04", name: { de: "Erste Suche", en: "First Search", hu: "Első keresés", ro: "Prima căutare" }, questions: [], hasGenerator: true },
      { id: "info_k3_t05", name: { de: "Link / Hyperlink", en: "Link / Hyperlink", hu: "Link / Hiperhivatkozás", ro: "Link / Hiperlink" }, questions: [], hasGenerator: true },
    ],
  },
  {
    ...
    color: "#10B981",
    subtopics: [
      { id: "info_k3_t06", name: { de: "Google Grundlagen", en: "Google Basics", hu: "Google alapok", ro: "Bazele Google" }, questions: [], hasGenerator: true },
      { id: "info_k3_t07", name: { de: "YouTube Kids", en: "YouTube Kids", hu: "YouTube Kids", ro: "YouTube Kids" }, questions: [], hasGenerator: true },
      { id: "info_k3_t08", name: { de: "E-Mail (Idee)", en: "E-Mail (Basics)", hu: "E-mail (Alapok)", ro: "E-mail (Baze)" }, questions: [], hasGenerator: true },
      { id: "info_k3_t09", name: { de: "Chat Grundlagen", en: "Chat Basics", hu: "Chat alapok", ro: "Bazele Chat-ului" }, questions: [], hasGenerator: true },
      { id: "info_k3_t10", name: { de: "Word — Schreiben", en: "Word — Writing", hu: "Word — Írás", ro: "Word — Scriere" }, questions: [], hasGenerator: true },
    ],
  },
  {
    ...
    color: "#F59E0B",
    subtopics: [
      { id: "info_k3_t11", name: { de: "Schriftgröße / Stil", en: "Font Size / Style", hu: "Betűméret / Stílus", ro: "Dimensiune font / Stil" }, questions: [], hasGenerator: true },
      { id: "info_k3_t12", name: { de: "Titel / Absatz", en: "Title / Paragraph", hu: "Cím / Bekezdés", ro: "Titlu / Paragraf" }, questions: [], hasGenerator: true },
      { id: "info_k3_t13", name: { de: "Liste", en: "List", hu: "Lista", ro: "Listă" }, questions: [], hasGenerator: true },
      { id: "info_k3_t14", name: { de: "Tabelle Grundlagen", en: "Table Basics", hu: "Táblázat alapok", ro: "Bazele tabelelor" }, questions: [], hasGenerator: true },
      { id: "info_k3_t15", name: { de: "Excel — Zellen", en: "Excel — Cells", hu: "Excel — Cellák", ro: "Excel — Celule" }, questions: [], hasGenerator: true },
    ],
  },
  {
    ...
    color: "#8B5CF6",
    subtopics: [
      { id: "info_k3_t16", name: { de: "Einfache Rechnung", en: "Simple Calculation", hu: "Egyszerű számítás", ro: "Calcul simplu" }, questions: [], hasGenerator: true },
      { id: "info_k3_t17", name: { de: "PowerPoint — Folie", en: "PowerPoint — Slide", hu: "PowerPoint — Dia", ro: "PowerPoint — Diapozitiv" }, questions: [], hasGenerator: true },
      { id: "info_k3_t18", name: { de: "Bild einfügen", en: "Insert Image", hu: "Kép beszúrása", ro: "Inserare imagine" }, questions: [], hasGenerator: true },
      { id: "info_k3_t19", name: { de: "Druckvorschau", en: "Print Preview", hu: "Nyomtatási kép", ro: "Previzualizare imprimare" }, questions: [], hasGenerator: true },
      { id: "info_k3_t20", name: { de: "PDF Idee", en: "PDF Basics", hu: "PDF alapok", ro: "Bazele PDF" }, questions: [], hasGenerator: true },
    ],
  },
  {
    id: "info_k3_halado",
    ...
    color: "#EC4899",
    subtopics: [
      { id: "info_k3_t21", name: { de: "Dateiformate (.docx .jpg)", en: "File Formats (.docx .jpg)", hu: "Fájlformátumok (.docx .jpg)", ro: "Formate de fișiere (.docx .jpg)" }, questions: [], hasGenerator: true },
      { id: "info_k3_t22", name: { de: "Zip / Komprimieren", en: "Zip / Compress", hu: "Zip / Tömörítés", ro: "Zip / Comprimare" }, questions: [], hasGenerator: true },
      { id: "info_k3_t23", name: { de: "Screenshot", en: "Screenshot", hu: "Képernyőkép (Screenshot)", ro: "Captură de ecran" }, questions: [], hasGenerator: true },
      { id: "info_k3_t24", name: { de: "Lesezeichen", en: "Bookmark", hu: "Könyvjelző", ro: "Marcaj" }, questions: [], hasGenerator: true },
      { id: "info_k3_t25", name: { de: "Rechtschreibprüfung", en: "Spell Check", hu: "Helyesírás-ellenőrző", ro: "Verificare ortografică" }, questions: [], hasGenerator: true },
    ],
  }
];
...
export function getInfoK3Questions(subtopicIds: string[], count?: number, countryCode?: string): KemiaQuestion[] {
