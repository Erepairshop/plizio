...
export const K7_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Sort Phrases/Clauses",    hu: "Rendezd: szintagma/záradék",   de: "Phrasen/Klauseln sortieren",    ro: "Sortează: fraze/clauze"        } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Match Sentence Types",  hu: "Párosítsd a mondattípusokat",      de: "Satztypen zuordnen",       ro: "Potrivește tipuri propoziții"   } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Fill Tense/Voice",     hu: "Töltsd ki az igeidőt/hangot",        de: "Tempus/Stimme ausfüllen",     ro: "Completează timp/diateza"      } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any, icon: "🪐", label: { en: "Fill Punctuation", hu: "Töltsd ki a jeleket",   de: "Satzzeichen einfügen", ro: "Completează punctuația" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Match Figurative",      hu: "Párosítsd a képleteseket", de: "Figürliches zuordnen", ro: "Potrivește figurat"     } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Sort Academic/Casual", hu: "Rendezd: tudományos/beszéd",   de: "Akademisch/Umgangssprache sortieren", ro: "Sortează: academic/casual"      } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Build Arguments",   hu: "Építs érveléseket",    de: "Argumente bauen",   ro: "Construiți argumente"     } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Match Clause Types",  hu: "Párosítsd a záradéktípusokat",    de: "Klauseltypen zuordnen",  ro: "Potrivește tipuri clauze"      } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k7-explore" as any,  icon: "🪐", label: { en: "Sort Verbals",     hu: "Rendezd az igeneeveket",        de: "Verbale sortieren",      ro: "Sortează verbale"        } },
