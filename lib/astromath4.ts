...
export const G4_ISLANDS: IslandDef[] = [
  ...
  },
  {
    ...
    topicKeys: ["mul"],
    missions: [
      { id: "m1", gameType: "orbit-quiz", icon: "🚀", label: { en: "Multiply Quiz A", hu: "Szorzás kvíz A",   de: "Malrechnen A",    ro: "Quiz înmulțire A" } },
  ...
  },
  {
    ...
    topicKeys: ["div"],
    missions: [
      { id: "m1", gameType: "orbit-quiz", icon: "🚀", label: { en: "Division Quiz A", hu: "Osztás kvíz A",   de: "Divisionsquiz A", ro: "Quiz împărțire A" } },
      { id: "m2", gameType: "black-hole", icon: "🕳️", label: { en: "Black Hole",      hu: "Fekete lyuk",     de: "Schwarzes Loch",  ro: "Gaura neagră"     } },
      { id: "m3", gameType: "star-match", icon: "⭐", label: { en: "Star Match",      hu: "Csillagpárosítás", de: "Sternenpaare",   ro: "Perechi stele"    } },
    ],
    svgX: 240, svgY: 360,
  },
  {
    ...
    topicKeys: ["frac"],
    missions: [
      { id: "m1", gameType: "orbit-quiz", icon: "🚀", label: { en: "Fraction Quiz",   hu: "Törtek kvíz",     de: "Bruchquiz",       ro: "Quiz fracții"     } },
