...
export const G2_Generators_Hungarian = {
  ...
  "szofajok/nevelő": genArticles,
  "szofajok/nevuto": genPostpositions,
  "helyesiras/ly_j": genLyJDistinction,
  "helyesiras/rovid_hosszu": genShortLongVowels,
  "helyesiras/maganhangzo_harmonia": genVowelHarmony,
  "helyesiras/hosszu_massalhangzo": genLongConsonants,
  "mondat/mondatfajtak": genSentenceTypes,
  "mondat/mondatresz": genSentenceParts,
  "mondat/szorend": genWordOrder,
  "szo/osszetetel": genCompoundWords,
  "szo/kepzok": genAffixes,
  "szo/tobbesszam": genPluralForms,
  "szo/kotojelek": genHyphenation,
  ...
  "szokincs/termeszet": genNatureVocab,
  "szokincs/sport": genSportsVocab,
  "olvasas/szokincs": genReadingVocab,
  "olvasas/szovegertes": genReadingComprehension,
  "olvasas/mesek": genStoryElements,
};
