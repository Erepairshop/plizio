...
export const INFO_K1_CURRICULUM: KemiaTheme[] = [
  {
    ...
    color: "#3B82F6",
    subtopics: [
      { id: "info_k1_t01", name: { de: "Was ist ein Computer?", en: "What is a computer?", hu: "Mi a számítógép?", ro: "Ce este un computer?" }, questions: [], hasGenerator: false },
      { id: "info_k1_t02", name: { de: "Der Bildschirm", en: "The screen", hu: "A képernyő", ro: "Ecranul" }, questions: [], hasGenerator: false },
      { id: "info_k1_t03", name: { de: "Die Maus (Linksklick)", en: "The mouse (left click)", hu: "Az egér (balklikk)", ro: "Mouse-ul (click stânga)" }, questions: [], hasGenerator: false },
      { id: "info_k1_t04", name: { de: "Die Tastatur", en: "The keyboard", hu: "A billentyűzet", ro: "Tastatura" }, questions: [], hasGenerator: false },
      { id: "info_k1_t05", name: { de: "Einschalten / Ausschalten", en: "Turn on / Turn off", hu: "Bekapcsolás / Kikapcsolás", ro: "Pornire / Oprire" }, questions: [], hasGenerator: false },
    ],
  },
  {
    ...
    color: "#10B981",
    subtopics: [
      { id: "info_k1_t06", name: { de: "Ein Spiel starten", en: "Start a game", hu: "Egy játék indítása", ro: "Începe un joc" }, questions: [], hasGenerator: false },
      { id: "info_k1_t07", name: { de: "Das Spiel beenden", en: "Close the game", hu: "A játék bezárása", ro: "Închide jocul" }, questions: [], hasGenerator: false },
      { id: "info_k1_t08", name: { de: "Lautstärke", en: "Volume", hu: "Hangerő", ro: "Volum" }, questions: [], hasGenerator: false },
      { id: "info_k1_t09", name: { de: "Musik hören", en: "Listen to music", hu: "Zene hallgatása", ro: "Ascultă muzică" }, questions: [], hasGenerator: false },
      { id: "info_k1_t10", name: { de: "Video anschauen", en: "Watch a video", hu: "Videó nézése", ro: "Urmărește un videoclip" }, questions: [], hasGenerator: false },
    ],
  },
  {
    id: "info_k1_media",
    ...
    color: "#F59E0B",
    subtopics: [
      { id: "info_k1_t11", name: { de: "Bild öffnen", en: "Open a picture", hu: "Kép megnyitása", ro: "Deschide o imagine" }, questions: [], hasGenerator: false },
      { id: "info_k1_t12", name: { de: "Einfaches Malen", en: "Simple drawing", hu: "Egyszerű rajzolás", ro: "Desen simplu" }, questions: [], hasGenerator: false },
      { id: "info_k1_t13", name: { de: "Farben", en: "Colors", hu: "Színek", ro: "Culori" }, questions: [], hasGenerator: false },
      { id: "info_k1_t14", name: { de: "Richtig sitzen", en: "Sit properly", hu: "Helyes ülés", ro: "Stai corect" }, questions: [], hasGenerator: false },
      { id: "info_k1_t15", name: { de: "Max 30 Minuten Bildschirmzeit", en: "Max 30 minutes screen time", hu: "Max 30 perc képernyőidő", ro: "Maxim 30 de minute timp pe ecran" }, questions: [], hasGenerator: false },
    ],
  },
  {
    id: "info_k1_egeszseg",
    ...
    color: "#EF4444",
    subtopics: [
      { id: "info_k1_t16", name: { de: "Augenschutz", en: "Eye protection", hu: "Szemvédelem", ro: "Protecția ochilor" }, questions: [], hasGenerator: false },
      { id: "info_k1_t17", name: { de: "Das Passwort ist geheim", en: "The password is secret", hu: "A jelszó titkos", ro: "Parola este secretă" }, questions: [], hasGenerator: false },
      { id: "info_k1_t18", name: { de: "Mit Fremden im Internet reden? Nein!", en: "Talk to strangers on the internet? No!", hu: "Idegenekkel beszélgetni az interneten? Nem!", ro: "Vorbești cu străini pe internet? Nu!" }, questions: [], hasGenerator: false },
      { id: "info_k1_t19", name: { de: "Eltern fragen", en: "Ask parents", hu: "Szülőket megkérdezni", ro: "Întreabă părinții" }, questions: [], hasGenerator: false },
      { id: "info_k1_t20", name: { de: "Ein freundliches Bild", en: "A friendly picture", hu: "Egy barátságos kép", ro: "O imagine prietenoasă" }, questions: [], hasGenerator: false },
    ],
  },
  {
    ...
    color: "#8B5CF6",
    subtopics: [
      { id: "info_k1_t21", name: { de: "Stift vs. Computer", en: "Pen vs. Computer", hu: "Ceruza vs. Számítógép", ro: "Pix vs. Computer" }, questions: [], hasGenerator: false },
      { id: "info_k1_t22", name: { de: "Ein/Aus", en: "On/Off", hu: "Be/Ki", ro: "Pornit/Oprit" }, questions: [], hasGenerator: false },
      { id: "info_k1_t23", name: { de: "Computer sauber halten", en: "Keep the computer clean", hu: "A számítógép tisztán tartása", ro: "Păstrează computerul curat" }, questions: [], hasGenerator: false },
      { id: "info_k1_t24", name: { de: "Lieblingsfigur", en: "Favorite character", hu: "Kedvenc figura", ro: "Personaj preferat" }, questions: [], hasGenerator: false },
      { id: "info_k1_t25", name: { de: "Kreatives Spiel", en: "Creative game", hu: "Kreatív játék", ro: "Joc creativ" }, questions: [], hasGenerator: false },
    ],
  },
];
