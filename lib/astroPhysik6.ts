...
export const PHYSIK_K6_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",                 icon: "⭐", label: { en: "Machines Match",       hu: "Gépek párosítása",        de: "Maschinen-Paare",          ro: "Perechi mașini"           } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",                 icon: "🕳️", label: { en: "Machines Challenge",   hu: "Gépek kihívása",          de: "Maschinen-Herausforderung",ro: "Provocare mașini"         } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",               icon: "🌪️", label: { en: "Wheel Sort",          hu: "Kerék rendezése",         de: "Rad sortieren",            ro: "Sortează roată"           } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",                 icon: "🚀", label: { en: "Wheel Quiz",          hu: "Kerék kvíz",              de: "Radquiz",                  ro: "Quiz roată"               } },
    ],
    svgX: 90, svgY: 440,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",                 icon: "🚀", label: { en: "Pressure Quiz",       hu: "Nyomás kvíz",             de: "Druckquiz",                ro: "Quiz presiune"            } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",                 icon: "⭐", label: { en: "Pressure Match",      hu: "Nyomás párosítása",       de: "Druck-Paare",              ro: "Perechi presiune"         } },
    ],
    svgX: 220, svgY: 360,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain",                 icon: "🕳️", label: { en: "Hydraulics Quiz",    hu: "Hidraulika kvíz",         de: "Hydraulikquiz",            ro: "Quiz hidraulică"          } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle",                 icon: "⭐", label: { en: "Buoyancy Match",      hu: "Felhajtóerő párosítása",  de: "Auftrieb-Paare",           ro: "Perechi flotabilitate"    } },
    ],
    svgX: 100, svgY: 280,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",               icon: "🌪️", label: { en: "Circuits Sort",       hu: "Áramkörök rendezése",     de: "Stromkreise sortieren",    ro: "Sortează circuite"        } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "gap-fill-story",                 icon: "🚀", label: { en: "Circuits Quiz",       hu: "Áramkörök kvíz",          de: "Stromkreisquiz",           ro: "Quiz circuite"            } },
    ],
    svgX: 230, svgY: 200,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",                 icon: "⭐", label: { en: "Current Match",       hu: "Áram párosítása",         de: "Strom-Paare",              ro: "Perechi curent"           } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",                 icon: "🕳️", label: { en: "Safety Challenge",    hu: "Biztonság kihívása",      de: "Sicherheits-Herausforderung",ro: "Provocare siguranță"      } },
    ],
    svgX: 120, svgY: 120,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",               icon: "🌪️", label: { en: "Density Sort",        hu: "Sűrűség rendezése",       de: "Dichte sortieren",         ro: "Sortează densitate"       } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",                 icon: "⭐", label: { en: "Archimedes Match",    hu: "Arkhimédész párosítása",  de: "Archimedes-Paare",         ro: "Perechi Arhimede"         } },
    ],
    svgX: 210, svgY: 40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain",                 icon: "🚀", label: { en: "Energy Transfer Quiz", hu: "Energiaátvitel kvíz",       de: "Energieübertragungsquiz",  ro: "Quiz transfer energie"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",                 icon: "🕳️", label: { en: "Efficiency Challenge", hu: "Hatékonyság kihívása",     de: "Effizienz-Herausforderung", ro: "Provocare eficiență"     } },
    ],
    svgX: 100, svgY: -40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",                 icon: "⭐", label: { en: "Wave Match",          hu: "Hullámok párosítása",     de: "Wellen-Paare",             ro: "Perechi unde"             } },
