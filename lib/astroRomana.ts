...
export const C1_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match",     icon: "⭐", label: { ro: "Potrivire stele",     en: "Star Match",         hu: "Csillag párosítás", de: "Sterne verbinden"  } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort",     icon: "🚀", label: { ro: "Quiz alfabetul",      en: "Alphabet Quiz",      hu: "Ábécé kvíz",        de: "Alphabet Quiz"     } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs",     icon: "⭐", label: { ro: "Potrivire stele",     en: "Star Match",         hu: "Csillag párosítás",  de: "Sterne verbinden"  } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "pattern-finish",     icon: "🕳️", label: { ro: "Gaură neagră",       en: "Black Hole",         hu: "Fekete lyuk",        de: "Schwarzes Loch"    } },
    ],
    svgX: 80, svgY: 440,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter",     icon: "⭐", label: { ro: "Potrivire stele",     en: "Star Match",         hu: "Csillag párosítás",    de: "Sterne verbinden"  } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "count-catch",     icon: "🚀", label: { ro: "Quiz silabe",         en: "Syllable Quiz",      hu: "Szótag kvíz",          de: "Silben Quiz"       } },
    ],
    svgX: 240, svgY: 360,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",     icon: "⭐", label: { ro: "Potrivire stele",     en: "Star Match",          hu: "Csillag párosítás",  de: "Sterne verbinden"  } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match",     icon: "🚀", label: { ro: "Quiz cuvinte",        en: "Words Quiz",          hu: "Szó kvíz",           de: "Wörter Quiz"       } },
    ],
    svgX: 90, svgY: 270,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "bubble-choice",     icon: "⭐", label: { ro: "Potrivire stele",      en: "Star Match",          hu: "Csillag párosítás",  de: "Sterne verbinden"  } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort",     icon: "🚀", label: { ro: "Quiz propoziție",      en: "Sentence Quiz",       hu: "Mondat kvíz",        de: "Satz Quiz"         } },
    ],
    svgX: 220, svgY: 195,
  },
  {
  ...
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs",     icon: "⭐", label: { ro: "Potrivire stele",      en: "Star Match",         hu: "Csillag párosítás",   de: "Sterne verbinden"         } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "count-catch",     icon: "🚀", label: { ro: "Quiz majuscule",       en: "Capitals Quiz",      hu: "Nagybetű kvíz",       de: "Großbuchstaben Quiz"      } },
    ],
    svgX: 230, svgY: 55,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter",     icon: "⭐", label: { ro: "Potrivire stele",      en: "Star Match",         hu: "Csillag párosítás",      de: "Sterne verbinden"    } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match",     icon: "🚀", label: { ro: "Quiz antonime",        en: "Opposites Quiz",     hu: "Ellentét kvíz",          de: "Gegensätze Quiz"     } },
    ],
    svgX: 80, svgY: -20,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",     icon: "⭐", label: { ro: "Potrivire stele",     en: "Star Match",         hu: "Csillag párosítás", de: "Sterne verbinden" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort",     icon: "🕳️", label: { ro: "Gaură neagră finală", en: "Black Hole Final",   hu: "Záró fekete lyuk",   de: "Schwarzes Loch"    } },
    ],
    svgX: 190, svgY: -90,
  },
];
