...
export const K4_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-pronoun-explorer" as any,  icon: "🪐", label: { en: "Pronoun Match",  hu: "Névmás párosítás", de: "Pronomen-Match",   ro: "Potrivire pronume" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-modal-explorer" as any,  icon: "🪐", label: { en: "Modal Fill",    hu: "Módja kitöltés",   de: "Modal-Füllung",   ro: "Umplere modale" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs",  icon: "🌪️", label: { en: "Star Match",     hu: "Csillag párosítás", de: "Stern-Match",     ro: "Potrivire stele"   } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-adjective-k4-explorer" as any,  icon: "🪐", label: { en: "Build Sent.",   hu: "Mondat építés",   de: "Satz-Bau",        ro: "Construire propoziții" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-sentence-k4-explorer" as any,  icon: "🪐", label: { en: "Sent. Rush",    hu: "Mondat roham",     de: "Satz-Ansturm",    ro: "Asalt propoziții" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",  icon: "✏️", label: { en: "Star Match",     hu: "Csillag párosítás", de: "Stern-Match",     ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match",  icon: "⚡", label: { en: "Speed Round",    hu: "Villámkör",       de: "Blitzrunde",  ro: "Rundă rapidá"      } },
    ],
    svgX: 90, svgY: 270,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-speech-explorer" as any,  icon: "🪐", label: { en: "Punctuation Fill", hu: "Írásjel kitöltés",  de: "Interpunktion-Füllung", ro: "Umplere punctuație" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-capital-explorer" as any,  icon: "🪐", label: { en: "Commonly Confused", hu: "Összetéveszthető szavak", de: "Häufig verwechselt", ro: "Cuvinte confundate" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match",  icon: "🔗", label: { en: "Star Match",     hu: "Csillag párosítás", de: "Stern-Match",     ro: "Potrivire stele"   } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-synonym-explorer" as any,  icon: "🪐", label: { en: "Sort Synonyms",  hu: "Szinonimák rendezése", de: "Synonyme sortieren", ro: "Sortare sinonime" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-context-explorer" as any,  icon: "🪐", label: { en: "Context Fill",   hu: "Kontextus kitöltés", de: "Kontext-Füllung",   ro: "Umplere context" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter",  icon: "🚀", label: { en: "Star Match",     hu: "Csillag párosítás", de: "Stern-Match",     ro: "Potrivire stele"   } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en4-big-test-explorer" as any,  icon: "🪐", label: { en: "Final Quiz",     hu: "Záró kvíz",        de: "Final-Quiz",      ro: "Quiz final"        } },
