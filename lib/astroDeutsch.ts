...
export const K1_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      ...
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort",      icon: "⚡", label: { de: "Wort-Blitz",        en: "Word Blitz",       hu: "Szóvillám",         ro: "Blitz cuvinte"     } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      ...
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "pattern-finish",       icon: "🏃", label: { de: "Buchstabier-Rennen", en: "Spell Race",       hu: "Betűzés verseny",   ro: "Cursă de litere"   } },
    ],
    svgX: 80, svgY: 440,
  },
  {
    ...
    missions: [
      ...
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "count-catch",    icon: "🗂️", label: { de: "Kategorie-Rush",    en: "Category Rush",    hu: "Kategória roham",   ro: "Categorie rapidă"  } },
    ],
    svgX: 240, svgY: 360,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",  icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match",         icon: "📝", label: { de: "Lückentext",         en: "Gap Fill",         hu: "Hiánypótlás",       ro: "Completare goluri" } },
    ],
    svgX: 90, svgY: 270,
  },
  {
  ...
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match",  icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "pattern-finish",       icon: "⚡", label: { de: "Wort-Blitz",        en: "Word Blitz",       hu: "Szóvillám",         ro: "Blitz cuvinte"     } },
    ],
    svgX: 100, svgY: 125,
  },
  {
  ...
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",  icon: "⭐", label: { de: "Sterne verbinden",  en: "Star Match",       hu: "Csillag párosítás", ro: "Potrivire stele"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort",       icon: "🏃", label: { de: "Finale Sprint",      en: "Final Sprint",     hu: "Záró sprint",       ro: "Sprint final"      } },
    ],
    svgX: 190, svgY: -90,
  },
];
