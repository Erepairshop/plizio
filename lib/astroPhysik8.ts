...
export const PHYSIK_K8_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",              icon: "⭐", label: { en: "Ohm Match",            hu: "Ohm párosítása",          de: "Ohm-Paare",                   ro: "Perechi Ohm"                } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",              icon: "🕳️", label: { en: "Resistance Challenge", hu: "Ellenállás kihívása",      de: "Widerstands-Herausforderung", ro: "Provocare rezistență"       } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",            icon: "🌪️", label: { en: "Power Sort",          hu: "Teljesítmény rendezése",   de: "Leistung sortieren",        ro: "Sortează putere"            } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",              icon: "🚀", label: { en: "Energy Quiz",         hu: "Energia kvíz",            de: "Energiequiz",               ro: "Quiz energie"               } },
    ],
    svgX: 90, svgY: 440,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",              icon: "🚀", label: { en: "Semiconductor Quiz",   hu: "Félvezeték kvíz",         de: "Halbleiter-Quiz",           ro: "Quiz semiconductori"        } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",              icon: "⭐", label: { en: "Diode Match",         hu: "Dióda párosítása",        de: "Dioden-Paare",              ro: "Perechi diodă"              } },
    ],
    svgX: 220, svgY: 360,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain",              icon: "⭐", label: { en: "EM Match",            hu: "EM párosítása",           de: "EM-Paare",                  ro: "Perechi EM"                 } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle",              icon: "🕳️", label: { en: "Induction Challenge", hu: "Indukció kihívása",        de: "Induktions-Herausforderung", ro: "Provocare inducție"         } },
    ],
    svgX: 100, svgY: 280,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",            icon: "🌪️", label: { en: "Power Devices Sort", hu: "Eszközök rendezése",       de: "Geräte sortieren",          ro: "Sortează dispozitive"       } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "gap-fill-story",              icon: "🚀", label: { en: "Transformer Quiz",   hu: "Transzformátor kvíz",     de: "Transformator-Quiz",        ro: "Quiz transformator"         } },
    ],
    svgX: 230, svgY: 200,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",              icon: "⭐", label: { en: "Particle Match",     hu: "Részecskék párosítása",    de: "Teilchen-Paare",            ro: "Perechi particule"          } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "timeline-slider",              icon: "🕳️", label: { en: "Decay Challenge",     hu: "Bomlás kihívása",         de: "Zerfall-Herausforderung",   ro: "Provocare dezintegrare"    } },
    ],
    svgX: 120, svgY: 120,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz",            icon: "🌪️", label: { en: "Fission Sort",       hu: "Hasadás rendezése",       de: "Spaltung sortieren",        ro: "Sortează fisiune"           } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank",              icon: "⭐", label: { en: "Nuclear Match",      hu: "Atommag párosítása",      de: "Kern-Paare",                ro: "Perechi nucleare"           } },
    ],
    svgX: 210, svgY: 40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain",              icon: "🚀", label: { en: "Quantum Quiz",        hu: "Kvantum kvíz",            de: "Quanten-Quiz",              ro: "Quiz cuantic"               } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "mcq4-explanation",              icon: "🕳️", label: { en: "Relativity Challenge", hu: "Relativitás kihívása",     de: "Relativitäts-Herausforderung", ro: "Provocare relativitate"     } },
    ],
    svgX: 100, svgY: -40,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",              icon: "⭐", label: { en: "Energy Match",        hu: "Energia párosítása",      de: "Energie-Paare",             ro: "Perechi energie"            } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle",            icon: "🌪️", label: { en: "Final Sort",         hu: "Végső rendezés",          de: "Abschlusssortierung",       ro: "Sortare finală"             } },
    ],
    svgX: 190, svgY: -100,
  },
];
