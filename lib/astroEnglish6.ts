...
export const K6_ISLANDS: IslandDef[] = [
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",  icon: "🪐", label: { en: "Agreement Quiz",   hu: "Egyezés kvíz",      de: "Kongruenz-Quiz",    ro: "Quiz acord"         } },
      { id: "m2", category: "build",     gameType: "star-match",  icon: "⭐", label: { en: "Star Match",       hu: "Csillag párosítás", de: "Stern-Match",        ro: "Potrivire stele"    } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",  icon: "🪐", label: { en: "Clause Quiz",      hu: "Záradék kvíz",      de: "Klausel-Quiz",      ro: "Quiz clauze"        } },
      { id: "m2", category: "build",     gameType: "star-match",  icon: "⭐", label: { en: "Star Match",       hu: "Csillag párosítás", de: "Stern-Match",        ro: "Potrivire stele"    } },
      { id: "m3", category: "challenge", gameType: "black-hole",  icon: "🕳️", label: { en: "Black Hole",      hu: "Fekete lyuk",       de: "Schwarzes Loch",    ro: "Gaură neagră"       } },
    ],
    svgX: 100, svgY: 280,
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "orbit-quiz",  icon: "🪐", label: { en: "Rhetoric Quiz",    hu: "Retorika kvíz",     de: "Rhetorik-Quiz",     ro: "Quiz retorică"      } },
      { id: "m2", category: "build",     gameType: "star-match",  icon: "⭐", label: { en: "Star Match",       hu: "Csillag párosítás", de: "Stern-Match",        ro: "Potrivire stele"    } },
      { id: "m3", category: "challenge", gameType: "speed-round", icon: "⚡", label: { en: "Speed Round",      hu: "Villámkör",        de: "Blitzrunde",        ro: "Rundă rapidă"       } },
    ],
    svgX: 200, svgY: -120,
