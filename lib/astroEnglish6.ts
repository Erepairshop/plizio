...
export const K6_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Fill Pronoun Cases",     hu: "Töltsd ki a névmás eseteket",       de: "Pronomen Fälle einfügen",     ro: "Completează cazuri pronume"       } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Sort Pronoun Types",   hu: "Rendezd a névmás típusokat",      de: "Pronomentypen sortieren",    ro: "Sortează tipuri pronume"         } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match", icon: "🏁", label: { en: "Practice", hu: "Gyakorlás", de: "Üben", ro: "Practică" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "fill-blank", icon: "🕳️", label: { en: "Challenge", hu: "Kihívás", de: "Herausforderung", ro: "Provocare" } },
    ],
    svgX: 80, svgY: 440,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Build Complex",    hu: "Építs összetett mondatokat",       de: "Komplexe bauen",         ro: "Construiți complex"    } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Match Clauses",      hu: "Párosítsd a záradékokat",      de: "Klauseln zuordnen",      ro: "Potrivește clauze"        } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Sort by Word Parts",  hu: "Rendezd a szórészek szerint",    de: "Nach Wortteilen sortieren",    ro: "Sortează după cuvinte"       } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush", icon: "🚀", label: { en: "Practice", hu: "Gyakorlás", de: "Üben", ro: "Practică" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Match Analogies",      hu: "Párosítsd az analógiákat",     de: "Analogien zuordnen",   ro: "Potrivește analogii"     } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Fill Academic",    hu: "Töltsd ki az akadémiai szavakat",   de: "Akademisch ausfüllen",   ro: "Completează academic"      } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "true-false-blitz", icon: "🏃", label: { en: "Practice", hu: "Gyakorlás", de: "Üben", ro: "Practică" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any, icon: "🪐", label: { en: "Fill Punctuation", hu: "Töltsd ki a jeleket",   de: "Satzzeichen einfügen", ro: "Completează punctuația"    } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "word-chain", icon: "📝", label: { en: "Practice", hu: "Gyakorlás", de: "Üben", ro: "Practică" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "english-k6-explore" as any,  icon: "🪐", label: { en: "Sort Formal/Informal",    hu: "Rendezd: formális/informális",     de: "Formal/Informal sortieren",     ro: "Sortează: formal/informal"      } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush", icon: "⚡", label: { en: "Practice", hu: "Gyakorlás", de: "Üben", ro: "Practică" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle", icon: "⭐", label: { en: "Challenge", hu: "Kihívás", de: "Herausforderung", ro: "Provocare" } },
    ],
    svgX: 200, svgY: -120,
