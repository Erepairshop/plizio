...
export const K6_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-pronoun-k6-explorer" as any,  icon: "🪐", label: { en: "Fill Pronoun Cases",     hu: "Töltsd ki a névmás eseteket",       de: "Pronomen Fälle einfügen",     ro: "Completează cazuri pronume"       } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-pronoun-precision-explorer" as any,  icon: "🪐", label: { en: "Sort Pronoun Types",   hu: "Rendezd a névmás típusokat",      de: "Pronomentypen sortieren",    ro: "Sortează tipuri pronume"         } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-sentence-structure-explorer" as any,  icon: "🪐", label: { en: "Build Complex",    hu: "Építs összetett mondatokat",       de: "Komplexe bauen",         ro: "Construiți complex"    } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-complex-clause-explorer" as any,  icon: "🪐", label: { en: "Match Clauses",      hu: "Párosítsd a záradékokat",      de: "Klauseln zuordnen",      ro: "Potrivește clauze"        } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-word-builder-explorer" as any,  icon: "🪐", label: { en: "Sort by Word Parts",  hu: "Rendezd a szórészek szerint",    de: "Nach Wortteilen sortieren",    ro: "Sortează după cuvinte"       } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-vocabulary-explorer" as any,  icon: "🪐", label: { en: "Match Analogies",      hu: "Párosítsd az analógiákat",     de: "Analogien zuordnen",   ro: "Potrivește analogii"     } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-academic-k6-explorer" as any,  icon: "🪐", label: { en: "Fill Academic",    hu: "Töltsd ki az akadémiai szavakat",   de: "Akademisch ausfüllen",   ro: "Completează academic"      } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-punctuation-k6-explorer" as any, icon: "🪐", label: { en: "Fill Punctuation", hu: "Töltsd ki a jeleket",   de: "Satzzeichen einfügen", ro: "Completează punctuația"    } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en6-rhetoric-explorer" as any,  icon: "🪐", label: { en: "Sort Formal/Informal",    hu: "Rendezd: formális/informális",     de: "Formal/Informal sortieren",     ro: "Sortează: formal/informal"      } },
