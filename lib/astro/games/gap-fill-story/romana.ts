...
export const rounds: GapFillStoryRound[] = [
  ...
  },
  {
    ...
    story: {
      ...
      ro: "Apa este un {{0}} chimic format din doi atomi de hidrogen și un atom de {{1}}. Acești atomi sunt ținuți împreună de {{2}} chimice. Apa este esențială pentru toate formele cunoscute de {{3}}."
    },
    blanks: [
      {
        index: 0,
