...
export const K2_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-noun-explorer" as any,    icon: "🪐", label: { en: "Noun Sort",     hu: "Főnév rendezés",   de: "Substantiv-Sortierung", ro: "Sortare substantive" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match",  icon: "✏️", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-verb-explorer" as any,     icon: "🪐", label: { en: "Verb Fill",     hu: "Ige kitöltés",     de: "Verb-Füllung",    ro: "Umplere verbe" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs",  icon: "⭐", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "pattern-finish",  icon: "⚡", label: { en: "Speed Round",    hu: "Villámkör",       de: "Blitzrunde",  ro: "Rundă rapidă"      } },
    ],
    svgX: 80, svgY: 440,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-adjective-explorer" as any, icon: "🪐", label: { en: "Adj. Rush",     hu: "Melléknév roham",  de: "Adjektiv-Ansturm", ro: "Asalt adjective" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter",  icon: "🔗", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "count-catch", icon: "🕳️", label: { en: "Black Hole",    hu: "Fekete lyuk",        de: "Schwarzes Loch",      ro: "Gaură neagră"      } },
    ],
    svgX: 240, svgY: 360,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-sentence-explorer" as any, icon: "🪐", label: { en: "Build Sent.",   hu: "Mondat építés",   de: "Satz-Bau",        ro: "Construire propoziții" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",  icon: "🏁", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match",  icon: "🪨", label: { en: "Gravity Sort",    hu: "Gravitációs rendezés",       de: "Schwerkraft-Sortierung",  ro: "Sortare gravitațională"      } },
    ],
    svgX: 90, svgY: 270,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-vowel-explorer" as any,   icon: "🪐", label: { en: "Vowel Spell",   hu: "Magánhangzó helyesírás", de: "Vokal-Schreib", ro: "Literare vocale" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "bubble-choice",  icon: "📊", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort", icon: "⚡", label: { en: "Speed Round",    hu: "Villámkör",        de: "Blitzrunde",      ro: "Rundă rapidá"      } },
    ],
    svgX: 220, svgY: 195,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-prefix-explorer" as any, icon: "🪐", label: { en: "Match Prefix",  hu: "Előtag párosítás", de: "Präfix-Match",      ro: "Potrivire prefixe" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match",  icon: "🚀", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-meaning-explorer" as any,     icon: "🪐", label: { en: "Vocab Fill",    hu: "Szókincs kitöltés", de: "Wortschatz-Füllung", ro: "Umplere vocabular" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs",  icon: "📝", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-grammar-review-explorer" as any,  icon: "🪐", label: { en: "Grammar Quiz",   hu: "Grammatika kvíz",  de: "Grammatik-Quiz",  ro: "Quiz gramatică"    } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter", icon: "🏃", label: { en: "Orbit Quiz",   hu: "Pálya kvíz", de: "Umlaufbahn-Quiz", ro: "Quiz orbital" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match",  icon: "🪨", label: { en: "Gravity Sort",    hu: "Gravitációs rendezés",       de: "Schwerkraft-Sortierung",  ro: "Sortare gravitațională"      } },
    ],
    svgX: 80, svgY: -20,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "en2-big-test-explorer" as any,  icon: "🪐", label: { en: "Final Quiz",     hu: "Záró kvíz",        de: "Final-Quiz",      ro: "Quiz final"        } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap",  icon: "⚡", label: { en: "Orbit Quiz",     hu: "Pálya kvíz", de: "Umlaufbahn-Quiz",     ro: "Quiz orbital"   } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort", icon: "⭐", label: { en: "Star Match",    hu: "Csillag párosítás",        de: "Stern-Match",      ro: "Potrivire stele"      } },
    ],
    svgX: 190, svgY: -90,
  },
];
