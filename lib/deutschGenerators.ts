...
const PASSIV_SAETZE: { aktiv: string; passiv: string; f1: string; f2: string }[] = [
  ...
  { aktiv: "Man untersucht den Patienten.",passiv: "Der Patient wird untersucht.",  f1: "Der Patient wurde untersucht.",  f2: "Der Patient ist untersucht."  },
...
const NEBENSATZ_TYPEN: { satz: string; typ: string; f: string[] }[] = [
  ...
  { satz: "Er rannte, damit er den Bus erwischte.", typ: "Finalsatz",  f: ["Kausalsatz",    "Konzessivsatz","Konditionalsatz"] },
