...
export function generateIslandQuestionsInfoK2(island: IslandDef, count = 10) {
  return generateIslandQuestions(island, getInfoK2Questions, count);
}

export function generateCheckpointQuestionsInfoK2(testId: string, count = 15) {
  return generateCheckpointQuestions(INFO_K2_CHECKPOINT_TOPICS, testId, getInfoK2Questions, count);
}
