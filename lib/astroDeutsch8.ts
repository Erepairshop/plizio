...
export const K8_ISLANDS: IslandDef[] = [
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore",  icon: "📚", label: { de: "Entdecken", en: "Explore", hu: "Felfedezés", ro: "Explorare" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "speed-match",  icon: "🕳️", label: { de: "Planetenquiz",       en: "Orbit Quiz",          hu: "Bolygó kvíz",        ro: "Quiz planetar"      } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore",  icon: "🌟", label: { de: "Entdecken", en: "Explore", hu: "Felfedezés", ro: "Explorare" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "category-rush",  icon: "🚀", label: { de: "Planetenquiz",       en: "Orbit Quiz",          hu: "Bolygó kvíz",        ro: "Quiz planetar"      } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sort-puzzle",  icon: "⭐", label: { de: "Stern-Paare",       en: "Star Match",          hu: "Csillag párosítás",  ro: "Potrivire stele"    } },
    ],
    svgX: 190, svgY: -90,
  },
];
