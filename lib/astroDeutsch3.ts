...
export const K3_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🌳", label: { de: "Plural entdecken",  en: "Discover Plurals",  hu: "Többes szám felfedezés", ro: "Descoperă pluralul" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match", icon: "🚀", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "✂️", label: { de: "Verben entdecken",  en: "Discover Verbs",    hu: "Igék felfedezése",      ro: "Descoperă verbele"  } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs", icon: "⭐", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "📊", label: { de: "Steigerung entdecken", en: "Discover Comparison", hu: "Fokozás felfedezése", ro: "Descoperă gradarea" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter", icon: "🚀", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔎", label: { de: "Satzglieder entdecken", en: "Discover Sentence Parts", hu: "Mondatrészek felfedezése", ro: "Descoperă propoziția" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap", icon: "🕳️", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",   hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match", icon: "⚡", label: { de: "Blitzrunde", en: "Speed Round", hu: "Villámkör", ro: "Rundă rapidă" } },
    ],
    svgX: 90, svgY: 270,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🕰️", label: { de: "Zeitformen entdecken", en: "Discover Tenses",    hu: "Igeidők felfedezése",   ro: "Descoperă timpurile" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "bubble-choice", icon: "🕳️", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort", icon: "📝", label: { de: "Übungsblatt", en: "Worksheet", hu: "Feladatlap", ro: "Fișă de lucru" } },
    ],
    svgX: 220, svgY: 195,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "📜", label: { de: "Vergangenheit entdecken", en: "Discover Past Tense", hu: "Múlt idő felfedezése", ro: "Descoperă trecutul" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "tap-match", icon: "🚀", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "pattern-finish", icon: "⚡", label: { de: "Blitzrunde", en: "Speed Round", hu: "Villámkör", ro: "Rundă rapidă" } },
    ],
    svgX: 100, svgY: 125,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔤", label: { de: "Schreibung entdecken", en: "Discover Spelling",   hu: "Helyesírás felfedezése", ro: "Descoperă ortografia" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "memory-pairs", icon: "⭐", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "count-catch", icon: "📝", label: { de: "Übungsblatt", en: "Worksheet", hu: "Feladatlap", ro: "Fișă de lucru" } },
    ],
    svgX: 230, svgY: 55,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🔡", label: { de: "Zeichensetzung entdecken", en: "Discover Punctuation", hu: "Írásjelek felfedezése", ro: "Descoperă punctuația" } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "shape-spotter", icon: "🚀", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "sound-match", icon: "⚡", label: { de: "Blitzrunde", en: "Speed Round", hu: "Villámkör", ro: "Rundă rapidă" } },
    ],
    svgX: 80, svgY: -20,
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "deutsch-explore", icon: "🌟", label: { de: "Große Entdeckung",      en: "Big Discovery",    hu: "Nagy felfedezés",       ro: "Marea descoperire"  } },
      { id: "m2", category: "build",     gameType: "m2", gameKey: "quick-tap", icon: "🕳️", label: { de: "Schwerkraft-Sortierung", en: "Gravity Sort",    hu: "Gravitációs rendezés", ro: "Sortare gravitațională" } },
      { id: "m3", category: "challenge", gameType: "m3", gameKey: "drag-sort", icon: "🔀", label: { de: "Satz-Puzzle", en: "Sentence Scramble", hu: "Mondat keverő", ro: "Amestec propoziții" } },
    ],
    svgX: 190, svgY: -90,
  },
];
