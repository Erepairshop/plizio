...
export const O3_ISLANDS: IslandDef[] = [
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "memory-pair" as any, icon: "🧠", label: { hu: "Memória",   en: "Reading",    de: "Lesen",       ro: "Lectură"    } },
  ...
  },
  {
    ...
    missions: [
      { id: "m1", category: "explore",   gameType: "picture-word" as any, icon: "🖼️", label: { hu: "Szókincs",   en: "Reading",    de: "Lesen",       ro: "Lectură"    } },
