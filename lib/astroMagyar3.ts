...
export const O3_ISLANDS: IslandDef[] = [
  {
    ...
    missions: [
      ...
      { id: "m3", category: "challenge", gameType: "sentence-builder", icon: "🏗️", label: { hu: "Mondatépítő",   en: "Challenge",  de: "Herausforderung", ro: "Provocare"   } },
    ],
    svgX: 160, svgY: 530,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "orbit-quiz", icon: "🪐", label: { hu: "Gyakorol", en: "Build",  de: "Satzbau",     ro: "Construcție" } },
      { id: "m3", category: "challenge", gameType: "sentence-builder", icon: "🏗️", label: { hu: "Mondatépítő",   en: "Challenge",  de: "Herausforderung", ro: "Provocare"   } },
    ],
    svgX: 80, svgY: 440,
  },
  {
    ...
    missions: [
      ...
      { id: "m2", category: "build",     gameType: "sentence-builder", icon: "🏗️", label: { hu: "Mondatépítő", en: "Sort",       de: "Sortierung", ro: "Sortare"   } },
